...
### Beispiel 1: Überprüfen der Verfügbarkeit eines Kusto-Datenbanknamens, der verwendet wird
```powershell
...
Der obige Befehl gibt zurück, ob im Cluster "testnewkustocluster" eine Kusto-Datenbank mit dem Namen "mykustodatabase" vorhanden ist.

### Beispiel 2: Überprüfen der Verfügbarkeit eines nicht verwendeten Kusto-Datenbanknamens
```powershell
...
Der obige Befehl gibt zurück, ob im Cluster "testnewkustocluster" eine Kusto-Datenbank mit dem Namen "mykustodatabase2" vorhanden ist.
...
### -Typ
Der Typ der Ressource, beispielsweise Microsoft. Kusto/-Cluster/-Datenbanken.
