...
### Beispiel 2: Abrufen einer bestimmten Kusto-Datenbank nach Namen
```powershell
...
Der obige Befehl gibt die Kusto-Datenbank mit dem Namen "mykustodatabase" im Cluster "testnewkustocluster" zurück, die in der Ressourcengruppe "testrg" gefunden wurde.
