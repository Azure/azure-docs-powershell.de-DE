...
### Beispiel 1: Erstellen eines Kusto-Clusters principalAssignment
```powershell
...
Der obige Befehl erstellt einen Kusto-Cluster principalAssignment
...
### -Prinzipal-Nr
Die Prinzipal-ID, die dem Cluster Prinzipal zugewiesen ist.
