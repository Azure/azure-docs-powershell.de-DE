...
### Beispiel 1: Auflisten aller folgenden Datenbanken
```powershell
...
Der obige Befehl listet alle Datenbanken auf, die im Besitz dieses Clusters sind und von einem anderen Cluster gefolgt sind.
