...
## Beschreibung
Erstellen eines Netzwerkregel Objekts in der aktuellen PowerShell-Sitzung
...
Erstellen eines VirtualNetwork-Regelsatzes
...
### -IPRule
Geben Sie an, IPRule zu erstellen.
...
Ressourcen-ID eines Subnets, beispielsweise:/Subscriptions/{SubscriptionId}/resourceGroups/{resourceGroupName}/Providers/Microsoft.Network/virtualNetworks/{vnetName}/Subnets/{subnetName}.
...
### -VirtualNetworkRule
Geben Sie an, VirtualNetworkRule zu erstellen.
