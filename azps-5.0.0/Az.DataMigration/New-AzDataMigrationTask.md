...
## Beschreibung
Das New-AzDataMigrationTask-Cmdlet erstellt datenmigrationsaufgaben. Dieses Cmdlet übernimmt Parameter für den Aufgabentyp Enumerator, die Azure-Ressourcengruppe, den Namen des zugeordneten Azure Database Migration Service und Project als Eingabe. 
...
### -MigrationValidation 
Aufgaben Antwortobjekt durch Validierungs Aufruf, optional, aber empfohlen.
...
### -Wait
Gibt an, ob der Vorgang beendet werden soll. Wenn das Flag gesetzt ist, überprüft alle Sekunden, bis die Aufgabe abgeschlossen ist, und kehren Sie zu den Aufgabeneigenschaften zurück, bei denen die Ausgabe oder der Fehler überprüft werden kann. 
```yaml
