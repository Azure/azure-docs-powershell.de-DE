...
### -DeliverySchema
Das Schema, das verwendet werden soll, wenn Ereignisse an das Ziel übertragen werden. Mögliche Werte sind: eventgridschema, CustomInputSchema oder cloudeventv01schema. Der Standardwert ist CustomInputSchema.
...
### -Domänenname
Der Name der Ereignis Raster Domäne, in der das Ereignisabonnement erstellt werden soll.
