...
## Beschreibung
Das Cmdlet **Remove-AzAutomationDscConfiguration** entfernt APS-Konfigurationen (Desired State Configuration, DSC) aus Azure Automation.

## Beispiele

### Beispiel 1

Entfernt DSC-Konfigurationen aus der Automatisierung. automatisch
