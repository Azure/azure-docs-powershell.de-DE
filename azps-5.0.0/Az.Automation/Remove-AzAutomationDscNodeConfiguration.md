...
## Beschreibung
Das Cmdlet **Remove-AzAutomationDscNodeConfiguration** entfernt Metadaten aus APS-Knoten Konfigurationen (Desired State Configuration, DSC) in Azure Automation.
...
Entfernt Metadaten aus DSC-Knoten Konfigurationen in der Automatisierung. automatisch
...
Gibt den Namen eines Automatisierungs Kontos an, das die DSC-Knoten Konfigurationen enthält, für die dieses Cmdlet Metadaten entfernt.
...
### -IgnoreNodeMappings
Gibt an, dass dieses Cmdlet Knoten Zuordnungen ignoriert.
...
### -Name
Gibt den Namen der DSC-Knoten Konfiguration an, für die dieses Cmdlet Metadaten entfernt.
...
Dieses Cmdlet entfernt Metadaten für DSC-Knoten Konfigurationen in der Ressourcengruppe, die dieser Parameter angibt.
