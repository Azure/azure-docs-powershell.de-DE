...
## Beschreibung
Das Cmdlet " **Satz-AzIntegrationAccountCertificate** " ändert ein Integrations Kontozertifikat.
...
### Beispiel 1: Ändern eines Integrations Kontozertifikats
```
...
Mit diesem Befehl wird das Integrations Kontozertifikat in der angegebenen Ressourcengruppe geändert.
