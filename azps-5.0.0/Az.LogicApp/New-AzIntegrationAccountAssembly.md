...
## Beschreibung
Das Cmdlet " **Get-AzIntegrationAccountAssembly** " erstellt eine neue Assembly in einem Integrations Konto.
...
Erstellt eine neue Assembly unter Verwendung der lokalen Datei, die sich im Dateipfad befindet, der in "$localAssemblyFilePath" enthalten ist.
...
Erstellt eine neue Assembly mit einem Byte-Array, das in "$assemblyContent" enthalten ist.
...
Erstellt eine neue Assembly unter Verwendung der Bytedaten, die sich unter der URL "$assemblyUrl" befinden. Dies ist die empfohlene Methode zum Erstellen von großformatigen Assemblys.
