...
## Beschreibung
Das Cmdlet " **Satz-AzIntegrationAccountAgreement** " ändert eine Integration-Kontovereinbarung.
...
### Beispiel 1: Aktualisieren einer Integration-Kontovereinbarung
```powershell
...
Dieser Befehl aktualisiert eine Integration-Kontovereinbarung in der angegebenen Azure-Ressourcengruppe.

### Beispiel 2

Ändert eine Integration-Kontovereinbarung. automatisch
...
### -Agreementtype
Gibt den Typ der Integrations Kontovereinbarung an.
