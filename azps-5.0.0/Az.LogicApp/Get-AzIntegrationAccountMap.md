...
## Beschreibung
Das Cmdlet " **Get-AzIntegrationAccountMap** " Ruft die Integration-Kontozuordnung aus einer Ressourcengruppe ab.
...
### Beispiel 1: Abrufen einer Integrations Kontozuordnung
```
...
Dieser Befehl ruft eine Integration-Kontozuordnung mit dem Namen IntegrationAccountMap47 in der angegebenen Ressourcengruppe ab.

### Beispiel 2: Abrufen von Integrations Kontozuordnungen nach dem Namen des Integrations Kontos
```
...
Mit diesem Befehl werden die Integrations Kontozuordnungen nach dem Namen des Integrations Kontos abgerufen.
...
### -MapType
Der Zuordnungstyp des Integrations Kontos.
...
### -Name
Gibt den Namen für das Integrations Konto an.
