...
## Synopsis
Wiederherstellen/Zurücksetzen eines Volumes auf einen seiner Snapshots
...
## Beschreibung
Wiederherstellen/Zurücksetzen eines Volumes auf die im Snapshot-Parameter angegebene Momentaufnahme
...
Mit diesem Befehl wird die Lautstärke "myvolume" wieder in einen der Snapshots des 7d6e4069-6c78-6c61-7bf6-c60968e45fbf
...
### -Inputobject
Das zu entfernende Volume-Objekt
...
### -PassThru
Gibt zurück, ob das angegebene Volume erfolgreich wiederhergestellt/zurückgesetzt wurde.
...
### -Poolobject
Das Pool-Objekt, das das zu entfernende Volume enthält
...
### -Snapshot-Nr
Snapshot-Nr des Schnappschusses.
UUID V4, mit der der Snapshot identifiziert wird
