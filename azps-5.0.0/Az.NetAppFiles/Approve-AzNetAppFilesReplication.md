...
## Beschreibung
Genehmigen der Replikationsverbindung auf dem Quelldatenträger
...
Dieser Befehl genehmigt die Replikation auf MyAnfVolume.

## Parameter

### -Kontoname
Der Name des ANF-Kontos des Replikations Quelldatenträgers
...
Die Dateisystem-ID des Ziel Datenschutz-Volumes
...
### -Inputobject
Das ANF-Quellvolumen Objekt, das das Replikationsziel autorisiert hat
...
### -Name
Der Name des ANF-Replikations Quelldatenträgers
...
### -PassThru
Gibt zurück, ob die Replikations Autorisierung des angegebenen Volumes durchgeführt wurde.
...
### -Poolname
Der Name des ANF-Pools des Replikations Quelldatenträgers
...
### -ResourceGroupName
Die Ressourcengruppe des ANF-Replikations Quelldatenträgers
...
### -Resourcen-Nr
Die Ressourcen-ID des ANF-Replikations Quelldatenträgers
