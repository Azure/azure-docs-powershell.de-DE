...
Dieser Befehl setzt die Anf-Replikationsverbindung auf dem Volume "MyDestinationAnfVolume" fort.

## Parameter

### -Kontoname
Der Name des ANF-Kontos des Replikations Datenträgers
...
### -Inputobject
Das für die erneute Synchronisierung zu replizierende Zielvolumen Objekt
...
### -Name
Der Name des ANF-Replikationsziel Datenträgers
...
### -PassThru
Zurückgeben, ob eine erneute Synchronisierung des angegebenen Replikations Datenträgers durchgeführt wurde
...
### -Poolname
Der Name des ANF-Pools des Replikations Datenträgers
...
### -ResourceGroupName
Die Ressourcengruppe des ANF-Replikationsziel Datenträgers
...
### -Resourcen-Nr
Die Ressourcen-ID des ANF-Replikationsziel Datenträgers
