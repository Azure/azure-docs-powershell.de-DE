...
### Beispiel 1 Abrufen von API-Schlüsseln für eine Application Insights-Ressource
```
...
Rufen Sie die API-Schlüssel für Application Insights für die Ressource "Test" in der Ressourcengruppe "testgroup" ab.

### Beispiel 2 Abrufen eines bestimmten API-Schlüssels für eine Application Insights-Ressource
```
...
Holen Sie sich einen bestimmten API-Schlüssel für Application Insights, der die ID "dd173f38-4fd1-4c75-8af5-9 9c29aa0f867" für die Ressource "Test" in der Ressourcengruppe "testgroup" enthält.

## Parameter

### -ApiKeyId
API-Schlüssel-ID für Application Insights.
