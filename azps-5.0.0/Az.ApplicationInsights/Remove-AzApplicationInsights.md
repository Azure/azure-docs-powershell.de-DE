...
### Beispiel 1 Entfernen einer Application Insights-Ressource
```
PS C:\> Remove-AzApplicationInsights -ResourceGroupName "testgroup" -Name "test" -PassThru
True
```

Entfernen einer Application Insights-Ressource mit dem Namen "Test" in der Ressourcengruppe "Testgruppe"
