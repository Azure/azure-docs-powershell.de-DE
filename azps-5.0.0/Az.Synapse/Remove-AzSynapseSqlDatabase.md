...
## Beschreibung
Das Cmdlet **Remove-AzSynapseSqlPool** löscht permanent eine Azure Synapse Analytics SQL-Datenbank.
...
Dieser Befehl löscht eine Azure Synapse Analytics SQL-Datenbank.
...
Mit diesem Befehl wird eine Azure Synapse Analytics SQL-Datenbank durch Pipeline gelöscht.
...
### -Inputobject
SQL-Datenbankeingabe Objekt, in der Regel durch die Pipeline übergeben.
