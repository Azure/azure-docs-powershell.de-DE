...
## Beschreibung
Mit dem Cmdlet **Start-AzSynapseTrigger** wird ein Trigger in einem Arbeitsbereich gestartet. Wenn sich der Trigger im Zustand "stopped" befindet, startet das Cmdlet den Trigger und ruft schließlich Pipelines basierend auf seiner Definition auf. Wenn sich der Trigger bereits im Zustand "Started" befindet, hat dieses Cmdlet keine Auswirkungen.
...
Startet einen Trigger namens ContosoTrigger im Arbeitsbereich ContosoWorkspace through-Pipeline.
