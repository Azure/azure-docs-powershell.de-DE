...
## Beschreibung
Das **Wait-AzSynapseSparkJob-** Cmdlet wartet darauf, dass ein Azure Synapse-Analyse Auftrag abgeschlossen wird.
...
Dieser Befehl wartet auf den Auftrag mit der angegebenen ID, um ihn abzuschließen.
...
### -SparkJobObject
Spark Job Input-Objekt, in der Regel durch die Pipeline übergeben.
...
### -TimeoutInSeconds
Die maximale Wartezeit, bevor ein Fehler auftritt. Der Standardwert ist "nie Timeout".
...
Das Abrufintervall zwischen überprüft den Auftragsstatus in Sekunden.
