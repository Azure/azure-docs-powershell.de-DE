...
## Beschreibung
Das Cmdlet " **Get-AzSynapseSparkJob** " erhält eine Azure Synapse Analytics Spark-Aufgabe.
...
Mit diesem Befehl wird der Auftrag mit der angegebenen Anwendungs-ID abgerufen.
...
Dieser Befehl ruft alle Aufträge unter einem Spark-Pool durch Pipeline ab.
