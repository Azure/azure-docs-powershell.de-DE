...
## Beschreibung
Mit dem Cmdlet **Remove-AzSynapseSqlPool** wird ein Azure Synapse Analytics SQL-Pool endgültig gelöscht.
...
Mit diesem Befehl wird ein Azure Synapse Analytics SQL-Pool gelöscht.
...
Dieser Befehl löscht einen Azure Synapse Analytics SQL-Pool durch Pipeline.
...
Mit diesem Befehl wird ein Azure Synapse Analytics SQL-Pool mit der angegebenen Ressourcen-ID gelöscht.
