...
## Beschreibung
Mit dem Cmdlet **Remove-AzSynapseSparkPool** wird ein Azure Synapse Analytics-Spark-Pool endgültig gelöscht.
...
Mit diesem Befehl wird ein Azure Synapse Analytics-Spark-Pool gelöscht.
...
Mit diesem Befehl wird ein Azure Synapse Analytics-Spark-Pool durch Pipeline gelöscht.
...
Mit diesem Befehl wird ein Azure Synapse Analytics-Spark-Pool mit einer Ressourcen-ID gelöscht.
