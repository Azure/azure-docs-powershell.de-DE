...
## Beschreibung
Das Cmdlet **Remove-AzServiceBusSubscription** entfernt das Abonnement für ein Thema aus dem angegebenen ServiceBus-Namespace.
...
Entfernt das Abonnement, das über die Arm-ID bereitgestellt wird, in $ResourceId/String for-Resourcen-Parameter 
...
### -Resourcen-Nr
Service Bus-Abonnement-Ressourcen-ID
