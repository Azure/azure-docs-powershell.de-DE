...
## Beschreibung
Das Cmdlet " **Satz-AzServiceBusGeoDRConfigurationFailOver** " ruft Geo Dr-Failover auf und konfiguriert den Alias so, dass er auf den sekundären Namespace verweist.
...
Ruft das Failover für den Alias "SampleDRConfigName" auf, konfiguriert und verweist auf den sekundären Namespace "SampleNamespace_Secondary".
