...
## Synopsis
Aktualisieren eines dedizierten HSM im angegebenen Abonnement.
...
### Beispiel 1: Aktualisieren des Parameter Tags des dedizierten HSM nach Name
```powershell
...
Dieser Befehl aktualisiert das Parameter-Tag des dedizierten HSM nach Namen.

### Beispiel 2: Aktualisieren des Parameter Tags des dedizierten HSM nach Objekt
```powershell
...
Dieser Befehl aktualisiert das Parameter-Tag des dedizierten HSM nach Objekt.
