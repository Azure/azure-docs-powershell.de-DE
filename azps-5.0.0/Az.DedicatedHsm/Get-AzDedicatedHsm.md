...
## Synopsis
Ruft das angegebene Azure dedizierte HSM ab.
...
### Beispiel 1: Abrufen aller dedizierten HSM unter einem Abonnement
```powershell
...
Dieser Befehl ruft alle dedizierten HSM-Abonnements unter einem Abonnement ab.

### Beispiel 2: Abrufen aller dedizierten HSM unter einer Ressourcengruppe.
```powershell
...
### Beispiel 3: Abrufen eines dedizierten HSM nach Namen
```powershell
...
Dieser Befehl ruft einen dedizierten HSM-Namen ab.

### Beispiel 4: Abrufen eines dedizierten HSM nach Objekt
```powershell
...
Mit diesem Befehl wird ein dediziertes HSM nach Objekt abgerufen.
...
### -ResourceGroupName
Der Name der Ressourcengruppe, zu der das dedizierte HSM gehört.
