...
### Beispiel 1: Erstellen einer neuen virtuellen MySQL Server-Netzwerkregel
```powershell
...
Mit diesen Cmdlets wird eine MySQL Server-Regel für virtuelles Netzwerk erstellt.
