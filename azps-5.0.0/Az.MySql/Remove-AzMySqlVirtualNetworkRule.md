...
### Beispiel 1: Entfernen der Regel des MySQL-Server-virtuellen Netzwerks nach Namen
```powershell
PS C:\> Remove-AzMySqlVirtualNetworkRule -Name vnet -ResourceGroupName PowershellMySqlTest-ServerName mysql-test

```

Dieses Cmdlet entfernt die MySQL-Server-Regel für virtuelles Netzwerk nach Namen.

### Beispiel 2: Entfernen der Regel für das virtuelle MySQL Server-Netzwerk nach Identität
```powershell
...
Mit diesen Cmdlets wird die virtuelle MySQL-Netzwerkregel nach Identität entfernt.
