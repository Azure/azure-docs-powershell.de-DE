...
### Beispiel 1: Neustarten von MySQL Server nach Ressourcengruppe und Servername
```powershell
PS C:\> Restart-AzMySqlServer -ResourceGroupName PowershellMySqlTest -Name mysql-test

```

Mit diesem Cmdlet wird der MySQL-Server nach Ressourcengruppe und Servername neu gestartet.

### Beispiel 2: Neustarten von MySQL Server nach Identität
```powershell
...
Mit diesen Cmdlets wird der MySQL-Server nach Identität neu gestartet.
