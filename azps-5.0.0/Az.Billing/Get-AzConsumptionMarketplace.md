...
## Beschreibung
Das Cmdlet " **Get-AzConsumptionMarketplace** " ruft Marktplätze des Abonnements ab.

## Beispiele

### Beispiel 1: Abrufen der Marktplatz Nutzung
```powershell
...
### Beispiel 2: Abrufen der Marketplace-Nutzung mit dem Datumsbereich
```powershell
...
### Beispiel 3: Abrufen der Marketplace-Nutzung von BillingPeriodName
```powershell
...
### Beispiel 4: Abrufen der Marktplatz Nutzung mit instanceName-Filter
```powershell
...
### -BillingPeriodName
Name eines bestimmten Abrechnungszeitraums, um den Marktplatz zu erhalten, der zugeordnet werden soll.
...
### -Enddate
Das Enddatum (in UTC) der zu filternden Marktplätze.
...
### -InstanceId
Die Instanz-ID der zu filternden Marktplätze.
...
### -InstanceName
Der Instanzname der zu filternden Marktplätze.
...
### -ResourceGroup
Die Ressourcengruppe der zu filternden Marktplätze.
...
### -StartDate
Das Startdatum (in UTC) der zu filternden Marktplätze.
...
### Microsoft. Azure. Commands. Verbrauch. Models. PSMarketplace
