...
### -Inputobject
Gibt den Replikationsserver an, für den die Migration initiiert werden muss.
...
### -TargetObjectID
Gibt den replcating-Server an, für den die Migration initiiert werden muss.
...
Inputobject <IMigrationItem> : gibt den Replikationsserver an, für den die Migration initiiert werden muss. Das Serverobjekt kann mit dem Get-AzMigrateServerReplication-Cmdlet abgerufen werden.
