...
## Synopsis
Beendet die Replikation für den migrierten Server.
...
Erneutes Synchronisieren nach ID.
...
### -ForceRemove
Gibt an, ob die Replikation gewaltsam entfernt werden muss.
...
### -Inputobject
Gibt das Computerobjekt des replizierenden Servers an.
...
### -TargetObjectID
Gibt den replcating-Server an, für den der replicatio deaktiviert werden muss.
Die ID sollte mit dem Get-AzMigrateServerReplication-Cmdlet abgerufen werden.
...
Inputobject <IMigrationItem> : gibt das Computerobjekt des replizierenden Servers an.
  ...
  - `[ProviderSpecificDetail <IMigrationProviderSpecificSettings>]`: Benutzerdefinierte Einstellungen für den Migrations Anbieter.
