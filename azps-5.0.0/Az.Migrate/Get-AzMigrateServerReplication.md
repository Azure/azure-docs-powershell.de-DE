...
## Synopsis
Ruft die Details des replizierenden Servers ab.
...
### Beispiel 2: alle in Project nach ID auflisten.
```powershell
...
### Beispiel 2: alle in Project nach Name auflisten.
```powershell
...
### -ProjectName
Gibt das Azure-Projekt migrieren im aktuellen Abonnement an.
...
### -TargetObjectID
Gibt den replizierenden Server an.
