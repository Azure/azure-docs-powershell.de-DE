...
## Synopsis
Abrufen aller ermittelten Server in einem Migrationsprojekt
...
Abrufen aller Server in einem Migrationsprojekt
...
Besorgen Sie sich einen Server in einem Projekt Migrieren nach Namen.
Name ist ein eindeutiger Parameter für einen Server.
...
Auflisten aller Server für eine Appliance in einem Projekt

### Beispiel 4: Abrufen einer Appliance
```powershell
...
Besorgen Sie sich einen Server für eine Appliance in einem Projekt.
Name ist ein eindeutiger Parameter für einen Server.
...
Listen Sie Server in einem Projekt migrieren auf, und Filtern Sie Antworten mit dem Anzeigenamen.

### Beispiel 6: auflisten in einer Appliance und Filtern nach Anzeigename
```powershell
...
Listen Sie Server für eine Appliance in einem Projekt migrieren auf, und Filtern Sie Antworten mit dem Anzeigenamen.

## Parameter

### -Appliancename
Gibt den Namen der Appliance an.
Diese wird einer Website intern zugeordnet.
...
Hierbei handelt es sich um einen internen Namen.
