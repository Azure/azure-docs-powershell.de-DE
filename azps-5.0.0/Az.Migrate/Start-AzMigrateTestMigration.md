...
## Synopsis
Startet die Testmigration für den replizierenden Server.
...
### -TestNetworkID
Aktualisiert die virtuelle Netzwerk-ID innerhalb des Ziels Azure-Abonnements, die für die Testmigration verwendet werden soll.
...
Inputobject <IMigrationItem> : gibt den Replikationsserver an, für den die Testmigration initiiert werden muss. Das Serverobjekt kann mit dem Get-AzMigrateServerReplication-Cmdlet abgerufen werden.
