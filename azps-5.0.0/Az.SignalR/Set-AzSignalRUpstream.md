...
### Einrichten von zwei geordneten Upstream-Vorlagen
```powershell
...
Die folgende JSON steht für den tatsächlichen Vorlagensatz. 
...
### Alle Upstream-Einstellungen löschen
```powershell
...
### -Clear
Deaktivieren Sie alle Upstream-Einstellungen.
...
### -Vorlage
Vorlagenelement (e) für Upstream-Einstellungen.
Erforderlicher Schlüssel: UrlTemplate.
Optionale Schlüssel: HubPattern, EventPattern, CategoryPattern.
Beispiel für die Verwendung der splatting-Syntax zum Übergeben von Vorlagenparameter: @ {UrlTemplate = ' http://host-connections1.com ', HubPattern = ' Chat '; EventPattern = ' Broadcast '}, @ {UrlTemplate = ' http://host-connections2.com '}
...
[Verwenden von splatting zum Übergeben von Parametern an Befehle in PowerShell](https://docs.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_splatting?view=powershell-7)
