...
## Beschreibung
Das Cmdlet " **festlegen-AzDataLakeAnalyticsCatalogItemAclEntry** " fügt einen Eintrag (ACE) in der Zugriffssteuerungsliste (ACL) eines Katalog-oder Katalogelements in Data Lake Analytics hinzu oder ändert ihn.

## Beispiele

### Beispiel 1: Ändern von Benutzerberechtigungen für einen Katalog
```powershell
...
Mit diesem Befehl wird der Katalog-ACE für Patti Fuller so geändert, dass Sie über Leseberechtigungen verfügt.

### Beispiel 2: Ändern von Benutzerberechtigungen für eine Datenbank
```powershell
...
Mit diesem Befehl wird der Datenbank-ACE für Patti Fuller so geändert, dass Sie über Leseberechtigungen verfügt.

### Beispiel 3: Ändern anderer Berechtigungen für einen Katalog
```powershell
...
Mit diesem Befehl wird der Katalog-ACE für other geändert, um über Leseberechtigungen zu verfügen.

### Beispiel 4: Ändern anderer Berechtigungen für eine Datenbank
```powershell
...
### Beispiel 5: Ändern der Benutzer Besitzer Berechtigungen für einen Katalog
```powershell
...
Dieser Befehl legt die Berechtigung "Besitzer" für das zu lesende Konto fest.

### Beispiel 6: Ändern der Benutzer Besitzer Berechtigungen für eine Datenbank
```powershell
...
Dieser Befehl legt die Berechtigung "Besitzer" für die zu lesende Datenbank fest.
...
### -Gruppe
Festlegen des ACL-Eintrags für den Katalog für Gruppe.
...
### -GroupOwner
Festlegen des ACL-Eintrags für den Katalog für den Gruppenbesitzer
...
### -ObjectID
Die Identität des Benutzers, der gesetzt werden soll.
...
### -Sonstige
Festlegen des ACL-Eintrags für Catalog für andere.
...
### -User
ACL-Eintrag für Catalog für Benutzer festlegen
...
### -UserOwner
Festlegen des ACL-Eintrags für Catalog für Benutzer Besitzer
