...
## Beschreibung
Mit diesem Cmdlet werden die Sicherheitsdomänen Daten eines verwalteten HSM zur Wiederherstellung gesichert.
...
Dieser Befehl ruft das verwaltete HSM mit dem Namen testmhsm ab und speichert eine Sicherungskopie dieser verwalteten HSM-Sicherheitsdomäne in der angegebenen Ausgabedatei.

## Parameter

### -Zertifikate
Pfade zu den Zertifikaten, die zum Verschlüsseln der Sicherheitsdomänen Daten verwendet werden.
...
### -OutputPath
Geben Sie den Pfad an, in den Sicherheitsdomänen Daten heruntergeladen werden sollen.
