...
Erstellt ein Zertifikatrichtlinien Objekt im Arbeitsspeicher. automatisch
...
### Beispiel 3: Erstellen eines Subject Alternative Name (oder San)-Zertifikats
...
### -CertificateTransparency
Gibt an, ob die Zertifikat Transparenz für dieses Zertifikat/den Aussteller aktiviert ist. Wenn keine Angabe erfolgt, lautet der Standardwert "wahr".
...
### -Curve
Gibt den Namen der elliptischen Kurve des Schlüssels des Zertifikats an.
...
### -DnsName
Gibt die DNS-Namen im Zertifikat an. Alternative Subjektnamen (SANs) können als DNS-Namen angegeben werden.
...
> [!NOTE]
> Wenn Sie ein Komma (,) oder einen Punkt (.) innerhalb einer Eigenschaft des `SubjectName` Parameters verwenden müssen, müssen Sie das Eigenschaftsfeld in Anführungszeichen setzen. So können Sie beispielsweise O = "contoso, Ltd." verwenden. im Feld Organisations Name.
