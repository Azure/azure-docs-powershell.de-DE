...
### -NetworkBlock
Der Adressblock sollte in VNet sowohl in Ihrem Abonnement als auch lokal eindeutig sein.
Stellen Sie sicher, dass das CIDR-Format mit (a. b. c. d/X) übereinstimmt, wobei a, b, c, D zwischen 0 und 255 und X zwischen 0 und 22 liegt.
...
### -NsxtPassword
Optional: Festlegen des NSX-T Manager-Kennworts beim Erstellen der privaten Cloud
...
### -VcenterPassword
Optional: Festlegen des vCenter Admin-Kennworts beim Erstellen der privaten Cloud
