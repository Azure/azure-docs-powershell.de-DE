...
### -Keyvault-Nr.
Die Ressourcen-ID des Azure-Schlüssel Tresors, der dem Batch Konto zugeordnet ist.
...
### -KeyVaultUrl
Die URL des Azure-Schlüssel Tresors, der dem Batch Konto zugeordnet ist.
...
### -PoolAllocationMode
Der Zuordnungsmodus zum Erstellen von Pools im Stapelverarbeitungs Konto.
...
### -PublicNetworkAccess
Der Zugriffstyp für das öffentliche Netzwerk
