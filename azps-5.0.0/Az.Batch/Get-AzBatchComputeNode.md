...
## Beschreibung
Das Cmdlet " **Get-AzBatchComputeNode** " ruft Azure Batch Compute-Knoten aus einem Pool ab.
...
Dieser Befehl ruft den Pool mit der ID-Pool07 mithilfe des Get-AzBatchPool-Cmdlets ab.
