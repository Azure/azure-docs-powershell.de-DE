...
## Beschreibung
Das New-AzRoleDefinition-Cmdlet erstellt eine benutzerdefinierte Rolle in Azure Role-Based Zugriffssteuerung.
...
Verwenden Sie Get-AzProviderOperation, um den Vorgang für Azure-Ressourcenanbieter abzurufen, die mithilfe von Azure RBAC gesichert werden können.
...
3) NotDataActions: die Gruppe von Vorgängen, die aus den Daten Aktionen ausgeschlossen werden muss, um die effektiven Daten Aktionen für die benutzerdefinierte Rolle zu ermitteln.
