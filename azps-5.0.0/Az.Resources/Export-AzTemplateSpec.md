...
## Beschreibung
Exportiert eine bestimmte Vorlagen Spezifikationsversion in das lokale Dateisystem.
...
Exportiert Version "v 1.0" der Vorlagenspezifikation mit dem Namen "MyTemplateSpec" innerhalb der Ressourcengruppe "myRG" in den lokalen Ausgabeordner "V1".
...
Exportiert Version "v 1.0" der Vorlagenspezifikation mit dem Namen "MyTemplateSpec" innerhalb der Ressourcengruppe "myRG" des Abonnement- \{ subId \} in den lokalen Ausgabeordner "V1".
...
### -OutputFolder
Der Pfad zu dem Ordner, in dem die Vorlage spec-Version ausgegeben wird.
...
### -Version
Die Version der Vorlagenspezifikation, die exportiert werden soll.
