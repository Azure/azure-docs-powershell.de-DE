...
Der erste Befehl ruft mithilfe des Get-AzPolicyDefinition-Cmdlets eine Richtliniendefinition mit dem Namen VMPolicyDefinition ab.
Der Befehl speichert Sie in der $PolicyDefinition-Variablen.
Mit dem zweiten Befehl wird die Richtliniendefinition entfernt, die durch die Eigenschaft " **Resourcen** " von $PolicyDefinition identifiziert wurde.
...
### -ID
Gibt die vollqualifizierte Ressourcen-ID für die Richtliniendefinition an, die vom Cmdlet entfernt wird.
...
### -Inputobject
Das zu entfernende Richtlinien Definitionsobjekt, das von einem anderen Cmdlet ausgegeben wurde.
...
### -ManagementGroupName
Der Name der Verwaltungsgruppe der zu löschenden Richtliniendefinition.
...
### -Name
Gibt den Namen der Richtliniendefinition an, die vom Cmdlet entfernt wird.
...
### -Abonnement-Nr
Die Abonnement-ID der Richtliniendefinition, die gelöscht werden soll.
