...
Beschreibungen können eine beliebige gültige Zeichenfolge sein, die Sie für die diferentiate verwenden.  
Wenn Bedingung festgelegte Bedingung ist, muss Version auch festgesetzt werden, aber wenn Sie eine Bedingung aktualisieren, die nicht erforderlich ist.
Die Bedingungs Version kann von 1,0 auf 2,0 aktualisiert werden, kann aber nicht zurückgestuft werden. Seien Sie vorsichtig, da 2,0 nicht mit 1,0 retrocompatible ist.
...
### -Eingabefeld
Dateiname mit einer einzelnen Rollendefinition
