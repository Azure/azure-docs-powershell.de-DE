...
## Beschreibung
Das Cmdlet " **Unregister-AzResourceProvider** " hebt die Registrierung eines Azure-Ressourcenanbieters auf.

## Beispiele

### Beispiel 1: Aufheben der Registrierung des Ressourcenanbieters mit ProviderNamespace

```powershell
PS C:\>Unregister-AzResourceProvider -ProviderNamespace "Microsoft.support"
```

Mit diesem Befehl wird der Ressourcenanbieter "Microsoft. Support" aufgehoben.
