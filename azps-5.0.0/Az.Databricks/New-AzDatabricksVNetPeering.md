...
## Synopsis
Erstellt vNet-Peering für Workspace.
...
Dieser Befehl erstellt ein vnet-Peering für databricks.

## Parameter

### -AllowForwardedTraffic
Ob der weitergeleitete Datenverkehr von den VMS im lokalen virtuellen Netzwerk im virtuellen Remotenetzwerk zugelassen/nicht zulässig ist.
...
### -AllowGatewayTransit
Wenn Gateway-Links im virtuellen Remotenetzwerk verwendet werden können, um eine Verknüpfung mit diesem virtuellen Netzwerk herzustellen.
...
Gibt an, ob die VMs im lokalen virtuellen Netzwerkbereich auf die VMs im Remotespeicher des virtuellen Netzwerks zugreifen können.
...
Eine Liste der Adressblöcke, die für dieses virtuelle Netzwerk in der CIDR-Notation reserviert sind.
...
### -UseRemoteGateway
Wenn Remote-Gateways in diesem virtuellen Netzwerk verwendet werden können.
