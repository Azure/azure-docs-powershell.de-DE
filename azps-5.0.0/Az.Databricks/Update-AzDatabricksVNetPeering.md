...
## Synopsis
Aktualisieren Sie vNet-Peering für Workspace.
...
### Beispiel 1: Aktualisieren von AllowForwardedTraffic von vnet-Peering
```powershell
...
Dieser Befehl aktualisiert AllowForwardedTraffic des vnet-Peerings.

### Beispiel 2: Aktualisieren von AllowForwardedTraffic von vnet-Peering nach Objekt
```powershell
...
Dieser Befehl aktualisiert AllowForwardedTraffic von vnet-Peering nach Objekt.

## Parameter

### -AllowForwardedTraffic
[System. Management. Automation. Switchparameter] gibt an, ob der weitergeleitete Datenverkehr von den VMS im lokalen virtuellen Netzwerk im virtuellen Remotenetzwerk zugelassen/nicht zulässig ist.
...
### -AllowGatewayTransit
[System. Management. Automation. Switchparameter], wenn Gateway-Links im virtuellen Remotenetzwerk verwendet werden können, um eine Verknüpfung mit diesem virtuellen Netzwerk herzustellen.
...
[System. Management. Automation. Switchparameter] unabhängig davon, ob die VMs im lokalen virtuellen Netzwerkbereich auf die VMs im Remotespeicher des virtuellen Netzwerks zugreifen können.
...
### -UseRemoteGateway
[System. Management. Automation. Switchparameter], wenn Remote Gateways in diesem virtuellen Netzwerk verwendet werden können.
Wenn das Flag auf "true" festgelegt ist und allowGatewayTransit auf Remote Peering ebenfalls wahr ist, verwendet virtuelles Netzwerkgateways des virtuellen Remotenetzwerks für die Übertragung.
Dieses Flag kann nur von einem Peering auf "true" festgelegt werden.
Dieses Flag kann nicht gesetzt werden, wenn virtuelles Netzwerk bereits über ein Gateway verfügt.
