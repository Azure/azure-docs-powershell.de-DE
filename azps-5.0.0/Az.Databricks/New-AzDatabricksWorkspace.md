...
### Beispiel 2: Erstellen eines databricks-Arbeitsbereichs mit einem angepassten virtuellen Netzwerk
```powershell
...
Mit diesem Befehl wird ein databricks-Arbeitsbereich mit angepasstem virtuellen Netzwerk in einer Ressourcengruppe erstellt.

### Beispiel 3: Erstellen eines databricks-Arbeitsbereichs mit enable Encryption
```powershell
...
Mit diesem Befehl wird ein databricks-Arbeitsbereich erstellt und für die Verschlüsselung vorbereitet.
Weitere Einstellungen für die Verschlüsselung finden Sie in den Beispielen Update-AzDatabricksWorkspace.
...
Ein boolescher Wert, der angibt, ob das dBFS-Root-Dateisystem mit der sekundären Verschlüsselungsebene mit Platt Form verwalteten Schlüsseln für Daten im Ruhezustand aktiviert wird.
