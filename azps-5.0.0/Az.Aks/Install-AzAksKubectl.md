...
### -Ziel
Der Pfad, auf dem kubectl installiert werden soll.
Standardmäßige Installation in ~/.Azure-kubectl/
...
### -DownloadFromMirror
Von Mirror-Website herunterladen: https://mirror.azure.cn/kubernetes/kubectl/
...
### -Force
Vorhandene kubectl ohne Eingabeaufforderung überschreiben
...
### -Version
Die zu installierende Version von kubectl, beispielsweise "v 1.17.2".
Standardwert: aktuell
