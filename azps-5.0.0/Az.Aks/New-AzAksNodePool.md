...
### Erstellen eines Knoten Pools mit Standardparametern
```powershell
...
### -Clusterobject
Geben Sie das Clusterobjekt an, in dem der Knoten Pool erstellt werden soll.
...
### -Force
Erstellen eines Knoten Pools, auch wenn er bereits vorhanden ist
...
### -OsType
OsType, der zum Angeben des Betriebssystemtyps verwendet werden soll.
...
ScaleSetEvictionPolicy, das zum Angeben von Räumungs Richtlinien für den Skalierungs Satz der virtuellen Maschine mit niedriger Priorität verwendet werden soll.
Standard zum Löschen.
...
### -ScaleSetPriority
ScaleSetPriority, das zum Angeben der Skalierungs Priorität für den virtuellen Computer verwendet werden soll.
Standardmäßig auf normal.
...
### -VmSetType
Stellt Typen eines Knoten Pools dar.
