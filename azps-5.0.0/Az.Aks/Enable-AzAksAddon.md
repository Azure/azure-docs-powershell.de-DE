...
Aktivieren Sie die Addons `HttpApplicationRouting` ,, `Monitoring` `AzurePolicy` `VirtualNode` und `KubeDashboard` für AKS.
...
### -WorkspaceResourceId
Die Ressourcen-ID des Arbeitsbereichs der Überwachung.
