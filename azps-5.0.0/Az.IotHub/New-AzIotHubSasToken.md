...
## Beschreibung
Für Geräte-SAS-Token wird der Richtlinienparameter nur für den Zugriff auf die Geräteregistrierung verwendet. Daher sollte die Richtlinie Lesezugriff auf die Registrierung haben.
Für viele Hub-Token ist die Richtlinie Teil der SAS.
...
Generieren Sie ein viel Hub-SAS-Token mithilfe der iothubowner-Richtlinie und des Primärschlüssels.
...
Generieren Sie mithilfe der registryRead-Richtlinie und des sekundären Schlüssels ein viel-Hub-SAS-Token.
...
Generieren Sie ein Device SAS-Token mithilfe der iothubowner-Richtlinie für den Zugriff auf die {iothub_name}-Geräteregistrierung.
...
Generieren Sie ein Modul-SAS-Token mithilfe der iothubowner-Richtlinie für den Zugriff auf die {iothub_name}-Geräteregistrierung.
...
### -Dauer
Zukünftiges Ablaufdatum (in Sekunden) des zu generierenden Tokens.
Standard ist 3600.
