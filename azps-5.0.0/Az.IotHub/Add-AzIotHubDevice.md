...
## Beschreibung
Erstellen Sie ein Gerät mit einem anderen Autorisierungs in einem viel Hub.
...
Erstellen eines Edge-fähigen viel Geräts mit Standard Autorisierung (freigegebener privater Schlüssel).
...
Erstellen Sie ein viel Gerät mit einer Root-CA-Autorisierung mit deaktiviertem Status und Grund.
...
Erstellen Sie ein Edge-fähiges viel-Gerät, und fügen Sie ihm untergeordnete Geräte hinzu.
...
Erstellen Sie ein viel Gerät, und legen Sie das übergeordnete Gerät ein.
...
### -Kinder
Liste der untergeordneten Geräte hinzufügen (durch Kommas getrennt) enthält nur nicht-Edge-Geräte.
...
### -Status
Einrichten des Gerätestatus bei der Erstellung
