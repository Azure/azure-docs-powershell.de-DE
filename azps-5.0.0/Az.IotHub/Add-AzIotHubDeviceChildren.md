...
## Beschreibung
Fügen Sie die angegebene durch Kommas getrennte Liste der nicht-Edge-Geräte-IDs als untergeordnete Elemente des angegebenen Edge-Geräts hinzu.
...
Hinzufügen von nicht-Edge-Geräten als untergeordnete Elemente zum Edge-Gerät unabhängig davon ist das nicht-Edge-Gerät bereits ein untergeordnetes Element eines anderen Edge-Geräts.

## Parameter

### -Kinder
Liste der untergeordneten Geräte (durch Kommas getrennt) enthält nur nicht-Edge-Geräte.
