...
## Beschreibung
Fügen Sie einen neuen Endpunkt in Ihrem viel-Hub hinzu. Informationen zu den unterstützten Endpunkten finden Sie unter https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-devguide-endpoints
...
Fügen Sie einen neuen Endpunkt "E2" vom Typ EventHub zu einem "myiothub"-Knoten hinzu.
...
Fügen Sie einen neuen Endpunkt "S1" vom Typ AzureStorageContainer zu einem "myiothub"-Knoten hinzu.

## Parameter

### -ConnectionString
Verbindungszeichenfolge des Routing Endpunkts
...
Ressourcengruppe der Endpunkt Ressource
...
Abonnement-Nr der Endpunkt Ressource
...
### -Encoding
Wählen Sie das Format aus, in dem Sie Ihre Daten weiterleiten möchten. Sie können JSON oder Avro auswählen. Die Standardeinstellung ist auf Avro eingestellt.
