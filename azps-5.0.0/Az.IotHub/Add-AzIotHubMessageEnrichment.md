...
## Beschreibung
Sie können bis zu 10 Nachrichten-Bereicherung pro viel Hub hinzufügen. Diese werden als Anwendungseigenschaften zu Nachrichten hinzugefügt, die an ausgewählte Endpunkte (n) gesendet wurden.
...
Fügen Sie eine neue Bereicherung mit dem Schlüssel "newkey" und dem Wert "neuer Wert" hinzu. Diese neue Bereicherung wird auf die Endpunkte "endpoint1" und "endpoint2" angewendet.
...
### -Endpunkt
Endpunkt (e) zum Anwenden von Anreicherung auf.
...
### -Taste
Der Schlüssel der Bereicherung.
