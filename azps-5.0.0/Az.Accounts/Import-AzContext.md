...
## Beschreibung
Das Import-AzContext-Cmdlet lädt Authentifizierungsinformationen aus einer Datei, um die Azure-Umgebung und den Kontext zu definieren.
...
In diesem Beispiel wird ein Kontext aus einer JSON-Datei ausgewählt, die an das Cmdlet übergeben wird. Diese JSON-Datei kann aus Save-AzContext erstellt werden.
...
### -Path
Gibt den Pfad zu Kontextinformationen an, die mithilfe von Save-AzContext gespeichert werden.
