...
### Beispiel 1: Deaktivieren des Kontexts für das AutoSpeichern
```powershell
...
Deaktivieren Sie in dieser PowerShell-Sitzung die autospeichernden Azure-Anmeldeinformationen. automatisch
