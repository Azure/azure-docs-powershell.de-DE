...
## Beschreibung
Das Cmdlet **New-AzDataBoxEdgeRole** erstellt eine neue Rolle für ein Daten Feld-Edge-Gerät.
...
### -ConnectionString
So stellen Sie Verbindungszeichenfolgen bereit
...
### -Deviceproperty
So stellen Sie Geräteeigenschaften bereit
...
### -EncryptionKey
Verschlüsselungsschlüssel des Edge-Geräts
...
Bitte geben Sie die Verbindungszeichenfolge des Geräts an.
...
Zugriffstaste des viel Edge-Geräts
...
Bitte geben Sie die Verbindungszeichenfolge des Edge-Geräts an.
...
### -Plattform
Bereitstellen der Plattform für Ex: Linux
...
### -RoleStatus
Bereitstellen des Status aktivieren/deaktivieren
