...
## Synopsis
Abrufen oder Auflisten von App-Konfigurations speichern.
...
Dieser Befehl listet alle App-Konfigurationsspeicher unter einem Abonnement auf.
...
Dieser Befehl listet alle App-Konfigurationsspeicher unter einer Ressourcengruppe auf.

### Beispiel 3: Abrufen eines App-Konfigurationsspeichers nach Name
```powershell
...
Mit diesem Befehl wird ein App-Konfigurationsspeicher nach Namen abgerufen.

### Beispiel 4: Abrufen eines App-Konfigurationsspeichers nach Pipeline
```powershell
...
Mit diesem Befehl wird ein App-Konfigurationsspeicher nach Pipeline abgerufen.
