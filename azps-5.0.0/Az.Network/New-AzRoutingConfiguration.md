...
Die Hub-Route-Tabelle, die dieser Routingkonfiguration zugeordnet ist.
...
### -ID
Die Liste der Ressourcen-IDs aller Hub-Route-Tabellen zum Ankündigen der Routen für die PropagatedRouteTables-Eigenschaft.
...
### -Label
Die Liste der Beschriftungen für die PropagatedRouteTables-Eigenschaft.
...
[Neu – AzStaticRoute](./New-AzStaticRoute.md)
...
[Neu – AzVirtualHubVnetConnection](./New-AzVpnConnection.md)
