...
## Beschreibung
Das Cmdlet **New-AzLoadBalancerRuleConfig** erstellt eine Regelkonfiguration für ein Azure Load Balancer.

## Beispiele

### Beispiel 1: Erstellen einer Regelkonfiguration für ein Azure Load Balancer
```powershell
