...
## Beschreibung
Das Cmdlet " **festlegen-AzApplicationGatewaySslPolicy** " ändert die SSL-Richtlinie eines Anwendungs Gateways.
...
Dieser zweite Befehl ändert die SSL-Richtlinie in einen vordefinierten Richtlinientypen und Richtliniennamen AppGwSslPolicy20170401.

## Parameter

### -ApplicationGateway
Gibt das Anwendungsgateway der SSL-Richtlinie an, die von diesem Cmdlet geändert wird.
...
SSL-Verschlüsselungs Pakete werden in der angegebenen Reihenfolge für Application Gateway aktiviert.
...
Gibt an, welche Protokolle deaktiviert sind.
...
### -MinProtocolVersion
Minimale Version des SSL-Protokolls, das auf dem Anwendungs-Gateway unterstützt werden soll
