...
Name: workspaceEndpoint Typ: MMAWorkspaceMachine-Ressourcen-Nr:/Subscriptions/00000000-0000-0000-0000-000000000000/ResourceGroups/myresourceGroup/Providers/Microsoft.OperationalInsights/Workspaces/myworkspace-Adresse: Scope: {"include": [{"Address": "Win-P0HGNDO2S1B"}]}
...
### -AzureSubnet
Azure-Subnet-Endpunkt Schalter
...
### -CoverageLevel
Test Abdeckung für den Endpunkt.
Unterstützte Werte sind Standard, Low, BelowAverage, Average, AboveAvergae, Full.
...
### -ExcludeItem
Liste der Elemente, die vom Endpunkt Bereich ausgeschlossen werden müssen.
...
### -ExternalAddress
Endpunkt Schalter für externe Adressen.
...
### -IncludeItem
Liste der Elemente, die in den endpont-Bereich aufgenommen werden müssen.
...
### -MMAWorkspaceMachine
MMA-Arbeitsbereichs Computer Endpunkt Schalter
...
### -MMAWorkspaceNetwork
MMA-Workspace-Netzwerkendpunkt Schalter
