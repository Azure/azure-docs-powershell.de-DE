...
Dadurch werden 2 öffentliche IPS an der Firewall erstellt, die mit dem virtuellen Hub verbunden ist. Dadurch wird die IP-Adresse im Back-End erstellt. Die IP-Webdienste können nicht explizit für eine neue Firewall bereitgestellt werden.
...
Dadurch wird eine neue öffentliche IP-Adresse auf der Firewall erstellt, indem $publicIp 1, $publicIp 2, die bereits auf der Firewall vorhanden sind, beibehalten wird.

## Parameter

### -Adressen
Die öffentlichen IP-Adressen der Firewall, die mit einem Hub verbunden ist
...
### -Anzahl
Die Anzahl der öffentlichen IP-Adressen
