...
## Beschreibung
Mit dem Cmdlet **Remove-AzP2sVpnGateway** können Sie ein vorhandenes P2SVpnGateway unter VirtualHub entfernen. Alle Punkte für die Konnektivität der Website Clients können nach dem Entfernen von P2SVpnGateway nicht mehr ausgeführt werden.
...
### -Inputobject
Das p2sVpnGateway-Objekt, das gelöscht werden soll.
...
### -Resourcen-Nr
Die Azure-Ressourcen-ID für die p2sVpnGateway, die gelöscht werden soll.
