...
```
Das obige wird eine neue Routingkonfiguration erstellen und statische Routen in der Routingkonfiguration mit dem nächsten Hop als angegebene IP-Adresse erstellen. Diese Routingkonfiguration kann dann als Parameter-RoutingConfiguration an den Befehl New-AzVirtualHubVnetConnection übergeben werden.
