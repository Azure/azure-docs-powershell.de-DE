...
## Beschreibung
Das Cmdlet " **Get-AzFirewall** " ruft mindestens eine Firewall in einer Ressourcengruppe ab.
...
### 3: Abrufen aller Firewalls mit Filterung
```
...
### 4: Abrufen einer Firewall und anschließendes Hinzufügen einer Anwendungsregel Sammlung zur Firewall
```
...
### 5: Abrufen einer Firewall und anschließendes Hinzufügen einer Netzwerkregel Sammlung zur Firewall
```
$azFw=Get-AzFirewall -Name "azFw" -ResourceGroupName "rgName"
...
### 6: Abrufen einer Firewall und anschließendes Abrufen einer APP-Regelsammlung nach Namen aus der Firewall
```
$azFw=Get-AzFirewall -Name "azFw" -ResourceGroupName "rgName"
...
### 7: Abrufen einer Firewall und Abrufen einer Netzwerkregel Sammlung nach Namen aus der Firewall
```
$azFw=Get-AzFirewall -Name "azFw" -ResourceGroupName "rgName"
...
### 8: Abrufen einer Firewall und anschließendes Entfernen einer Anwendungsregel Sammlung nach Namen aus der Firewall
```
$azFw=Get-AzFirewall -Name "azFw" -ResourceGroupName "rgName"
...
### 9: Abrufen einer Firewall und Entfernen einer Netzwerkregel Sammlung nach Namen aus der Firewall
```
$azFw=Get-AzFirewall -Name "azFw" -ResourceGroupName "rgName"
