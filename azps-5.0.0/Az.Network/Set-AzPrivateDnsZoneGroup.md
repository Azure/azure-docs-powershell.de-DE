...
## Beschreibung
Das Cmdlet " **Satz-AzPrivateDnsZoneGroup** " aktualisiert die DNS-Zonengruppe.
...
Obiges Beispiel aktualisiert die DNS-Zonengruppe mit dem Namen dnsgroup1 mit einem neuen dnsconfig, das mit einer anderen DNS-Zone verknüpft ist.
...
Eine Sammlung privater DNS-Zonenkonfigurationen der privaten DNS-Zonengruppe.
