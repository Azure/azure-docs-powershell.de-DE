...
In der obigen Abbildung wird eine Ressourcengruppe, virtuelles WAN in Ost-USA, in der Ressourcengruppe "nonlinkSite" in Azure erstellt. 

Anschließend wird ein VpnSite erstellt, um einen Kunden Zweig darzustellen und mit dem virtuellen WAN zu verknüpfen.

Eine IPSec-Verbindung kann dann mit dieser Verzweigung und einem VpnGateway mit dem Befehl New-AzVpnConnection eingerichtet werden.
...
Das obige wird eine Ressourcengruppe, virtuelles WAN und einen VpnSite mit 1 VpnSiteLinks in Ost-USA in der Ressourcengruppe "Multilink" in Azure erstellen.

### Beispiel 3

Erstellt eine neue Azure VpnSite-Ressource. automatisch
...
### -BgpAsn
Der BGP ASN für diesen VpnSite.
...
### -BgpPeeringAddress
Die BGP-Peering-Adresse für diesen VpnSite.
...
### -BgpPeeringWeight
Das BGP-Peering Gewicht für dieses VpnSite.
...
### -DeviceVendor
Der Gerätehersteller des Remote-VPN-Geräts.
...
### -IPAddress
Die IPAddress für diesen VpnSite.
...
### -O365Policy
Die Office 365 Traffic-Breakout-Richtlinie für diesen VpnSite.
...
### -VirtualWan
Das VirtualWan, mit dem dieser VpnSite verbunden werden muss.
...
### -VirtualWanName
Der Name des VirtualWan, mit dem dieser VpnSite verbunden werden muss.
...
Der Ressourcengruppenname des VirtualWan, mit dem dieser VpnSite verbunden sein muss.
...
### -VpnSiteLink
Die Liste der VpnSiteLinks, die dieser VpnSite.
