...
## Synopsis
Löschen Sie eine Hub-Route-Tabellen Ressource, die einem VirtualHub zugeordnet ist.
...
## Beschreibung
Aktualisiert die angegebene Routingtabelle, die dem angegebenen virtuellen Hub zugeordnet ist, mit den bereitgestellten Routen oder Etiketten.
...
Mit diesem Befehl wird die Hub-Route-Tabelle des virtuellen Hubs gelöscht.
...
### -Inputobject
Die vhubroutetable-Ressource, die aktualisiert werden soll.
...
### -Resourcen-Nr
Die Ressourcen-ID der vhubroutetable-Ressource, die aktualisiert werden soll.
...
### -Route
Die Liste der Routen für diese Arbeitsplan Tabelle.
