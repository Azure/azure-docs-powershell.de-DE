...
## Beschreibung
Das Cmdlet **Update-AzVpnConnection** aktualisiert eine VPN-Verbindung.  
Die VPN-Verbindung erstellt eine IPSec-Verbindung, die ein VPN-Gateway mit einem Remote-Kunden Zweig verbindet, der in Azure als VPN-Website dargestellt wird.
...
Die Verbindung wird dann mit dem Befehl Set-AzVpnConnection auf einen neuen IpSecPolicy aktualisiert.
...
Die Verbindung wird dann aktualisiert, um einen neuen freigegebenen Schlüssel mithilfe des Secure String-Konstrukts zu haben.
...
### -Inputobject
Das zu Aktualisier VpnConnection-Objekt.
...
### -Resourcen-Nr
Die Ressourcen-ID des zu löschenden VpnConnection-Objekts.
...
Verwenden Sie für diese Verbindung richtlinienbasierte Datenverkehrs Auswahl.
...
Die Liste der VpnSiteLinkConnections, die dieser VpnConnection haben muss.
