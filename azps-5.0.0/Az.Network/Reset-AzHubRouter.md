...
## Synopsis
Setzt die RoutingState einer VirtualHub-Ressource zurück.
...
## Beschreibung
Setzt den Routingstatus einer vorhandenen VirtualHub-Ressource nur dann zurück, wenn der Routingstatus des virtuellen Hubs nicht bereitgestellt wird.
...
Zurücksetzen des Routing Zustands des virtuellen Hubs mithilfe der zugehörigen Quell-Nr.
...
Ein vorhandenes virtuelles Hub-Objekt kann abgerufen und dann als Eingabeobjekt an Reset-AzHubRouter übergeben werden.
