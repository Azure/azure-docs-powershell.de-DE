...
## Beschreibung
Das Cmdlet **Remove-AzApplicationGatewayAuthenticationCertificate** entfernt ein Authentifizierungszertifikat von einem Azure Application Gateway.

## Beispiele

### Beispiel 1: Entfernen eines Authentifizierungszertifikats von einem Anwendungsgateway
```
...
Der zweite Befehl entfernt das Authentifizierungszertifikat mit dem Namen cert01 aus dem Anwendungsgateway.
Der dritte Befehl aktualisiert das Anwendungsgateway.

## Parameter

### -ApplicationGateway
Gibt den Namen des Anwendungs Gateways an, von dem dieses Cmdlet ein Authentifizierungszertifikat entfernt.
...
### -Name
Gibt den Namen des Authentifizierungszertifikats an, das vom Cmdlet entfernt wird.
