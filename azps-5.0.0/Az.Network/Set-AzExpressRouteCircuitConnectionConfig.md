...
## Beschreibung
Das Cmdlet " **Satz-AzExpressRouteCircuitConnectionConfig** " aktualisiert eine in private Peering erstellte Schaltkreis Verbindungskonfiguration für einen Express Route-Schaltkreis. So können Sie zwei Express-Route-Schaltkreise über Regionen oder Abonnements hinweg Peering.
Beachten Sie, dass Sie vor dem Ausführen von **AzExpressRouteCircuitConnectionConfig** die Schaltkreis Verbindung mithilfe von **Add-AzExpressRouteCircuitConnectionConfig** hinzufügen müssen. Nachdem Sie " **AzExpressRouteCircuitPeeringConfig** " ausgeführt haben, müssen Sie auch das Set-AzExpressRouteCircuit-Cmdlet aufrufen, um die Konfiguration zu aktivieren.


## Beispiele

### Beispiel 1: Aktualisieren einer Leitungs Verbindungsressource auf einen vorhandenen Express Route-Schaltkreis
```
...
### Beispiel 2: Einrichten einer Leitungs Verbindungskonfiguration mithilfe von Piping an einen vorhandenen Express Route-Schaltkreis
```
$circuit_peer = Get-AzExpressRouteCircuit -Name $peeringCircuitName -ResourceGroupName $rg
...
### -AddressPrefix
Ein minimaler/29 Kunden Adressraum zum Erstellen von VxLan-Tunneln zwischen Express-Route-Schaltkreisen für IPv4-Tunnels.
oder mindestens 125 Kunden Adressraum zum Erstellen von VxLan-Tunneln zwischen Express-Route-Schaltkreisen für IPv6-Tunnels.
