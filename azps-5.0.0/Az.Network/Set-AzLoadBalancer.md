...
## Beschreibung
Das Cmdlet " **Satz-AzLoadBalancer** " aktualisiert ein Lastenausgleichsmodul.
...
### -LoadBalancer
Gibt ein Load Balancer-Objekt an, das den Zustand darstellt, in dem das Load Balancer festgelegt werden soll.
