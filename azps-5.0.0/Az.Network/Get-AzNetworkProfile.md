...
## Beschreibung
Das Cmdlet " **Get-AzNetworkProfile** " Ruft eine vorhandene Netzwerkprofil Ressource auf oberster Ebene ab
...
Dadurch wird das Netzwerkprofil-Np1 in der Ressourcengruppe abgerufen RG1
...
Damit werden die Netzwerkprofile abgerufen, die mit "NP" beginnen.
...
### -Resourcen-Nr
Die Azure Resource Manager-ID des Netzwerkprofils.
