...
### Beispiel 4: Abrufen einer Liste von Anwendungs Gateways in einem Abonnement mithilfe von Filtern
```
...
Dieser Befehl ruft eine Liste aller Anwendungs Gateways im Abonnement ab, die mit "ApplicationGateway01" beginnen, und speichert Sie in der $AppGwList-Variablen.
