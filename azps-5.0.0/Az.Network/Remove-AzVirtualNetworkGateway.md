...
### Beispiel 1: Löschen eines virtuellen Netzwerkgateways
```powershell
Remove-AzVirtualNetworkGateway -Name myGateway -ResourceGroupName myRG
```

Löscht das Objekt des virtuellen Netzwerkgateways mit dem Namen "mygateway" innerhalb der Ressourcengruppe "myRG" Hinweis: Sie müssen zunächst alle Verbindungen mit dem virtuellen Netzwerkgateway mithilfe des Cmdlets **Remove-AzVirtualNetworkGatewayConnection** löschen.
...
### -Name
Gibt den Namen des virtuellen Netzwerkgateways an, das vom Cmdlet entfernt wird.
...
### -ResourceGroupName
Gibt den Namen der Ressourcengruppe an, die das virtuelle Netzwerkgateway enthält.
