...
## Beschreibung
Das Cmdlet **Remove-AzVirtualNetwork** entfernt ein Azure-virtuelles Netzwerk.
...
In diesem Beispiel wird ein virtuelles Netzwerk in einer Ressourcengruppe erstellt und anschließend sofort gelöscht. Verwenden Sie das Flag-Force, um die Eingabeaufforderung beim Löschen des virtuellen Netzwerks zu unterdrücken.
...
### -Name
Gibt den Namen des virtuellen Netzwerks an, das vom Cmdlet entfernt wird.
