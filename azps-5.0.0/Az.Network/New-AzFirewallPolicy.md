...
## Beschreibung
Das Cmdlet **New-AzFirewallPolicy** erstellt eine Azure-Firewall-Richtlinie.
...
In diesem Beispiel wird eine Azure Firewall-Richtlinie erstellt.
...
In diesem Beispiel wird eine Azure-Firewall-Richtlinie mit dem Intel-Modus "Bedrohung" erstellt.

### Beispiel 3:3. Erstellen einer leeren Richtlinie mit der ThreatIntel-Whitelist
```powershell
...
In diesem Beispiel wird eine Azure-Firewall-Richtlinie mit einer Bedrohung für Intel-Whitelist erstellt
