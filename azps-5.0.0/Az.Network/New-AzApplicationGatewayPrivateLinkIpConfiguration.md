...
## Synopsis
Erstellt eine IP-Konfiguration, die mit der PrivateLink-Konfiguration verknüpft werden soll.
...
## Beschreibung
Das Cmdlet **New-AzApplicationGatewayPrivateLinkIpConfiguration** erstellt eine IP-Konfiguration, die mit der PrivateLink-Konfiguration für ein Azure Application Gateway verknüpft werden soll.

## Beispiele

### Beispiel 1: PrivateLink IP-Konfiguration
```powershell
PS C:\> $PrivateLinkIpConfiguration = New-AzApplicationGatewayPrivateLinkIpConfiguration -Name "ipConfig01" -Subnet $subnet -Primary
```

Mit diesem Befehl wird eine PrivateLink-IP-Konfiguration mit dem Namen "ipConfig01" erstellt, die das Ergebnis in der Variablen mit dem Namen $PrivateLinkIpConfiguration speichert. 
...
### – Primär
Geben Sie an, dass die IP-Konfiguration primär ist.
...
### -PrivateIpAddress
Die private IP-Adresse des IPKonfigurationsdateiAddress, wenn eine statische Zuweisung erwünscht ist.
