...
## Beschreibung
Das **AzApplicationGatewayFirewallPolicySetting** erstellt eine Richtlinieneinstellung für eine Firewall-Richtlinie.
...
Der Befehl erstellt eine Richtlinieneinstellung mit dem Status als $enabledState, Modus als $enabledMode, RequestBodyCheck als falsch, FileUploadLimitInMb als $fileUploadLimitInMb und MaxRequestBodySizeInKb als $ $maxRequestBodySizeInKb.
Das neue policySettings wird in $Condition gespeichert.
...
Deaktiviert die requestBodyCheck in den Richtlinieneinstellungen der Firewall-Richtlinie.
...
### -MaxFileUploadInMb
Maximale Datei Uploadgröße in MB.
...
MaxRequestBodySizeInKb in den Richtlinieneinstellungen der Firewall-Richtlinie.
...
### -Modus
Firewallmodus in den Richtlinieneinstellungen der Firewall-Richtlinie.
...
### -Bundesland
Statusvariable in den Richtlinieneinstellungen der Firewall-Richtlinie.
