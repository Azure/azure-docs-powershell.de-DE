...
## Synopsis
Erstellt eine Hub-Route-Tabellen Ressource, die einem VirtualHub zugeordnet ist.
...
## Beschreibung
Erstellt die angegebene Routingtabelle, die dem angegebenen virtuellen Hub mit den bereitgestellten Routen und den Beschriftungen zugeordnet ist.
...
Mit diesem Befehl wird eine Hub-Route-Tabelle des virtuellen Hubs erstellt.
...
### -ParentResourceId
Die Ressourcen-ID der virtuellen Hub-Ressource.
