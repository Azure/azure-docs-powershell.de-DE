...
## Beschreibung
Mit dem Cmdlet **Add-AzLoadBalancerOutboundRuleConfig** wird eine ausgehende Regelkonfiguration zu einem Azure Load Balancer hinzugefügt.
...
Der zweite Befehl verwendet den Pipelineoperator, um das Load Balancer in $SLB an **Add-AzLoadBalancerOutboundRuleConfig** zu übergeben, wodurch dem Lastenausgleichsmodul eine ausgehende Regelkonfiguration hinzugefügt wird.
