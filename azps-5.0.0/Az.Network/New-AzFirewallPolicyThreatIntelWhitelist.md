...
## Beschreibung
Mit dem Cmdlet " **New-AzFirewallPolicyThreatIntelWhitelist** " wird ein Intel Whitelist-Bedrohungs Objekt erstellt, das beim Erstellen oder Festlegen einer Azure Firewall-Richtlinie verwendet werden kann.
...
In diesem Beispiel wird eine Intel Whitelist mit einer FQDN-Whitelist mit einem Eintrag und einer IP-Adressen-Whitelist mit zwei Einträgen erstellt.
