...
## Beschreibung
Das Cmdlet " **Satz-AzApplicationGatewayHttpListener** " ändert einen HTTP-Listener für ein Azure Application-Gateway.
...
### Beispiel 2: Hinzufügen eines HTTPS-Listener mit SSL und Hostnamen
```
PS C:\>$AppGw = Get-AzApplicationGateway -Name "ApplicationGateway01" -ResourceGroupName "ResourceGroup01"
