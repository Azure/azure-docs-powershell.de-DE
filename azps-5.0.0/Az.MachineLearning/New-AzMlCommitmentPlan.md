...
Erstellt einen neuen Azure Machine Learning Commitment Plan mit dem Namen "MyCommitmentPlanName" in der Gruppe "myresourcegroup" und in der Region Süd-Zentralamerika. In diesem Beispiel wird die SKU-DevTest/-Standard verwendet, was bedeutet, dass die Ressourcen, die vom Commitment-Plan bereitgestellt werden, durch die Grenzwerte von DevTest/Standard definiert werden. Das SkuCapacity in diesem Beispiel ist 1, was bedeutet, dass die Kosten des Plans 1X die Kosten von DevTest und die Ressourcen, die der Plan enthält, 1X sind, was DevTest bietet.
