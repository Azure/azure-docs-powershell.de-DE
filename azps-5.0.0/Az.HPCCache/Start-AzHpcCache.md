...
## Beschreibung
Mit dem Cmdlet **Start-AzHpcCache** wird ein Azure HPC-Cache gestartet.
...
### -Force
Gibt an, dass das Cmdlet Sie nicht zur Bestätigung auffordert. Standardmäßig werden Sie von diesem Cmdlet aufgefordert, zu bestätigen, dass Sie den Cache starten möchten.
