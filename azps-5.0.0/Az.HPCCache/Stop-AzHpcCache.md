...
## Beschreibung
Mit dem Cmdlet " **Stop-AzHpcCache** " wird ein Azure HPC-Cache beendet.
...
### -Force
Gibt an, dass das Cmdlet Sie nicht zur Bestätigung auffordert. Standardmäßig werden Sie von diesem Cmdlet aufgefordert, zu bestätigen, dass Sie den Cache beenden möchten.
...
### -ResourceGroupName
Name der Ressourcengruppe, unter der der Cache beendet werden soll.
