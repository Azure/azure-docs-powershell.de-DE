...
## Beschreibung
Das Entfernen eines Server Endpunkts ist ein zerstörerischer Vorgang. Dieser Server Standort beendet die Synchronisierung. Dieser Vorgang sollte nicht zum Beheben von Synchronisierungsproblemen ausgeführt werden. Wenn dieser Server Standort (einschließlich seiner Dateien) erneut zur gleichen Synchronisierungsgruppe wie ein Serverendpunkt hinzugefügt wird, kann dies zu Konfliktdateien und anderen unbeabsichtigten Folgen führen. Dieser Befehl ist nur für die Außerbetriebnahme vorgesehen.
...
### -Inputobject
ServerEndpoint-Eingabeobjekt, das normalerweise durch die Pipeline übergeben wird.
