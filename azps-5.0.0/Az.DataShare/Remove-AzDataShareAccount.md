...
## Beschreibung
Das Cmdlet **Remove-AzDataShareAccount** entfernt ein DataShare-Konto.
...
Mit diesem Befehl wird das DataShare-Kontonamens WikiADS aus der Ressourcengruppe ADS entfernt.
...
### -Inputobject
Das Azure-Datenfreigabe-Kontoobjekt.
