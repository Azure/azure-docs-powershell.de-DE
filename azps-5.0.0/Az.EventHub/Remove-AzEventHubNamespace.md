...
## Beschreibung
Das Remove-AzEventHubNamespace-Cmdlet entfernt den angegebenen Event Hubs-Namespace und löscht ihn.
...
### Beispiel 5: Resourcen-using-Pipeline:
```powershell
PS C:\> Get-AzResource -ResourceType Microsoft.EventHub/Namespaces | Remove-AzEventHubNamespace
```

### Beispiel 6: Resourcen-using-Zeichenfolge:
```powershell
...
### -Resourcen-Nr
EventHubs-Namespace-Ressourcen-ID
