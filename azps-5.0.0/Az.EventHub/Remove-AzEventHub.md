...
## Beschreibung
Das Remove-AzEventHub-Cmdlet entfernt und löscht den angegebenen Ereignis-Hub aus dem angegebenen Namespace.
...
Entfernt den Ereignis \` -Hub \` -MyEventHubName.
...
### Beispiel 3: Inputobject mit Piping:
```powershell
...
### Beispiel 5: Resourcen-using-Zeichenfolge:
```powershell
