...
## Beschreibung
Das Cmdlet " **Satz-AzEventHubGeoDRConfigurationFailOver** " ruft Geo Dr-Failover auf und konfiguriert den Alias so, dass er auf den sekundären Namespace verweist.
