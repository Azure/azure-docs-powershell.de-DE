...
## Synopsis
Abrufen von Sicherheitseinstellungen im Azure Security Center
...
## Beschreibung
Das Get-AzSecuritySetting-Cmdlet erhalten Sicherheitseinstellungen im Azure Security Center.
...
Ruft eine MCAS-Datenexport Einstellung ab   
...
### -SettingName
Name der Einstellung. (MCAS/WDATP)
