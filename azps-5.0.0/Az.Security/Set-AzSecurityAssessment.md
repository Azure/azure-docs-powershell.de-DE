...
## Synopsis
Erstellen oder Aktualisieren eines Ergebnisses für die Sicherheitsbewertung für eine Ressource
...
## Beschreibung
Erstellen oder Aktualisieren eines Sicherheits Bewertungsergebnisses für eine Ressource kann verwendet werden, um den Status eines vorhandenen Ergebnisses zu ändern oder zusätzliche Daten hinzuzufügen.
kann nur für "CustomerManaged"-Bewertungstypen und erst nach dem Erstellen der übereinstimmenden Bewertungs Metadaten verwendet werden.
...
Kennzeichnet das Abonnement Ergebnis als "fehlerhaft" für die Beurteilung des Typs "4FB6C0A0-1137-42C7-A1C7-4BD37C91DE8D" – Weitere Details zum Bewertungstyp finden Sie unter dem assessmentMetadata-Typ.

## Parameter

### -AdditionalData
Daten, die dem Bewertungsergebnis zugeordnet sind, um bessere Untersuchungen oder Status Klarheit zu erzielen.
...
### -StatusCause
Progremmatic-Code für die Ursache des Bewertungsergebnisses.
...
### -Statuscode
Progremmatic-Code für das Ergebnis der Bewertung.
kann "gesund", "ungesund" oder "NotApplicable" sein
...
### -StatusDescription
Menschliche lesbare Beschreibung der Ursache des Bewertungsergebnisses.
