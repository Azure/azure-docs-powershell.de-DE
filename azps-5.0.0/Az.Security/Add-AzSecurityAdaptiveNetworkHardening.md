...
## Synopsis
Erzwingt die angegebenen Regeln für die in der Anforderung aufgelisteten NSG (en).
...
## Beschreibung
Adaptive Netzwerk Härten werden automatisch vom Azure Security Center berechnet, verwenden Sie dieses Cmdlet, um die angegebenen Regeln für die in der Anforderung aufgelisteten NSG (s) zu erzwingen.
...
Der Name der adaptiven Netzwerk Härtungs Ressource.
...
Die Azure-Ressourcen-IDs der effektiven Netzwerk Sicherheitsgruppen, die mit den erstellten Sicherheitsregeln aus den Regeln für adaptive Netzwerk Härtung aktualisiert werden.
