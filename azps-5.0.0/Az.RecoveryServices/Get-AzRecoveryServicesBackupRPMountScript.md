...
## Beschreibung
Das Get-AzRecoveryServicesBackupRPMountScript-Cmdlet lädt ein Skript herunter, das die Volumes des Wiederherstellungspunkts auf dem Computer einhängt, auf dem es ausgeführt wird.

## Beispiele

### Beispiel 1: Bereitstellen eines Wiederherstellungspunkts
```powershell
...
Wenn das Skript ausgeführt wird, werden die Dateien des Wiederherstellungspunkts $Rp 0 bereitgestellt. \[\]

### Beispiel 2

Lädt ein Skript herunter, um alle Dateien des Wiederherstellungspunkts bereitzustellen. automatisch
...
### -Path
Der Speicherort, an dem die Datei im Fall einer Datei Wiederherstellung heruntergeladen werden soll. Wenn-path nicht angegeben wird, wird die Skriptdatei im aktuellen Verzeichnis heruntergeladen.
