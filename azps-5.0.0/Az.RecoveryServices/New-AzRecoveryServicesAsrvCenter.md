...
## Beschreibung
Mit dem Cmdlet **New-AzRecoveryServicesAsrvCenter** wird ein vCenter Server hinzugefügt, in dem die geschützten Elemente erkannt werden. Mit diesem Cmdlet wird der vCenter Server für die Ermittlung mit dem Konfigurationsserver registriert.
...
Fügt einen vCenter Server hinzu, um geschützte Elemente zu erkennen. automatisch
...
### -Konto
Konto für Benutzeranmeldeinformationen
...
### -Stoff
ASR-Fabric, die dem Konfigurationsserver entspricht.
...
### -IpOrHostName
IPv4-Adresse oder FQDN des vCenter-Servers.
...
### -Port
Der TCP-Port auf dem vCenter Server, der für die Erkennung verwendet werden soll.
