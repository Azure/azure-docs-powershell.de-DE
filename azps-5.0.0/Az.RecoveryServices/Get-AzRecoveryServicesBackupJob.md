...
```
Das erste Cmdlet ruft das Vault-Objekt ab. Das zweite Cmdlet speichert alle AzureVM-Aufträge im angegebenen Tresor, die in den letzten 2 Tagen in $Jobs abgeschlossen wurden. Ändern Sie den Wert des BackupManagementType-Parameters in MAB, um MAB-Agent-Aufträge abzurufen.
