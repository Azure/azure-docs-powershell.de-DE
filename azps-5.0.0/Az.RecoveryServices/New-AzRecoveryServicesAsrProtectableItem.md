...
## Beschreibung
Das **New-AzRecoveryServicesAsrProtectableItem** fügt ein neues geschütztes Element zur Liste der ermittelten geschützten Elemente in einem Schutzcontainer innerhalb eines ASR-Fabrics hinzu (gilt nur für den VMware Fabric-Typ).

## Beispiele

### Beispiel 1

Hinzufügen (ermitteln) eines physikalischen Servers zur Liste der geschützten Elemente automatisch
...
### -FriendlyName
Anzeigename für das zu schützende Element.
...
### -IPAddress
Die IP-Adresse des geschützten Elements.
...
### -OSType
Betriebssystemtyp (Windows/Linux) des geschützten Elements.
...
### -ProtectionContainer
ASR-Schutzcontainer Objekt, dem das zu schützende Element hinzugefügt werden soll.
...
### -Bestätigen
Zur Bestätigung bestätigen, bevor Sie das Cmdlet ausführen.
