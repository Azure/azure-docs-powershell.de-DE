...
## Beschreibung
Das Cmdlet **New-AzRecoveryServicesAsrRecoveryPlan** erstellt eine Azure Site Recovery, einen Wiederherstellungsplan im Speicher für Wiederherstellungsdienste.
...
Startet den Wiederherstellungsplan-Erstellungsvorgang für Azure Zone, um replizierte Elemente zu Zonen und gibt den ASR-Auftrag zurück, der zum Nachvollziehen des Vorgangs verwendet wird.

## Parameter

### -Azure
Parameter Switch gibt das Szenario für Azure to Azure Disaster Recovery, Recovery Plan Creation an.
...
### -AzureZoneToZone
Parameter Switch gibt an, dass das replizierte Element im Azure Zone to Zone-Szenario erstellt wird.
...
### -PrimaryZone
Gibt die primäre Verfügbarkeit Zone der Replikations geschützten Elemente an, die Teil dieses Wiederherstellungsplans sind.
