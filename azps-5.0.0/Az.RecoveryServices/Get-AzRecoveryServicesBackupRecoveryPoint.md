...
Mit dem ersten Befehl wird Vault-Objekt auf Grundlage von vaultname abgerufen. Der zweite Befehl ruft das Datum vor sieben Tagen ab und speichert es dann in der $StartDate-Variablen.
Der dritte Befehl ruft das heutige Datum ab und speichert es dann in der $EndDate Variablen.
Der vierte Befehl ruft AzureVM-Sicherungs Container ab und speichert Sie in der $Container-Variablen. Der fünfte Befehl ruft das Sicherungselement auf Grundlage von workloadtype, Vault-Funktion ab und speichert es dann in der $BackupItem-Variablen.
