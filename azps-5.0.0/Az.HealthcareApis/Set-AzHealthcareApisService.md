...
## Synopsis
Aktualisiert einen vorhandenen healthcareApis-fhir-Dienst.
...
### Beispiel 1: aktualisiert den vorhandenen healthcareapis-Dienst mit dem Namen MyService in der Ressourcengruppe myresourcegroup mit dem cosmosdb OfferThroughput = 500.
...
### Beispiel 2: aktualisiert den vorhandenen healthcareapis-Dienst mit dem Namen MyService in der Ressourcengruppe myresourcegroup mit dem cosmosdb OfferThroughput = 500.
...
### -Zielgruppe
HealthcareApis FhirService-Zielgruppe.
...
### -CorsMethod
HealthcareApis FhirService-Liste der cors-Methoden.
...
### -CorsOrigin
HealthcareApis FhirService cors Origins. HealthcareApis Fhir-Dienstliste mit cors Herkunft. Geben Sie URLs von Ursprungs Websites an, die auf diese API zugreifen können, oder verwenden Sie *, um von einer beliebigen Website aus Zugriff zu ermöglichen.
...
HealthcareApis FhirService CorsCredentials nicht zulässig.
...
Deaktivieren der verwalteten Identität
...
Name des HealthcareApis-Fhir-Dienst Export speicherkontos
...
### -Inputobject
HealthcareApis fhir-Dienst, der von Get-AzHealthcareApisFhirService geleitet wird.
...
### -ResourceGroupName
Name der HealthcareApis-Dienst Ressourcengruppe.
