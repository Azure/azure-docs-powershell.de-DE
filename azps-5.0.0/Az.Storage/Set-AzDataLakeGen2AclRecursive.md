...
## Beschreibung
Das Cmdlet " **Set-AzDataLakeGen2AclRecursive** " legt ACL rekursiv für den angegebenen Pfad fest. Die Eingabe-ACL ersetzt die ursprüngliche ACL vollständig.

## Beispiele

### Beispiel 1: setzen Sie ACL rekursiv auf einem directiry
```
...
Mit diesem Befehl wird zunächst ein ACL-Objekt mit 3 ACL-Einträgen erstellt und dann ACL rekursiv für ein Verzeichnis festgelegt.

### Beispiel 2: Einrichten von ACL rekursiv auf einem root-directiry von Dateisystem
```
...
Mit diesem Befehl wird ACL zunächst rekursiv auf ein Stammverzeichnis festgelegt und ist fehlgeschlagen, und dann mit ContinuationToken fortgesetzt, nachdem der Benutzer die fehlerhafte Datei repariert hat.

### Beispiel 3: Einrichten von ACL rekursiv Chunk nach Chunk
```
$token = $null
...
Dieses Skript legt ACL-rescursively für Verzeichnis Chunk nach Chunk fest, wobei die Chunkgröße als BatchSize * MaxBatchCount. Chunk Size ist 200 in diesem Skript.

### Beispiel 4: setzen Sie ACL rekursiv auf ein Verzeichnis und ContinueOnFailure, und führen Sie dann eine nach dem anderen aus Fehlern fort.
```
...
Mit diesem Befehl wird ACL zunächst rekursiv auf ein Verzeichnis mit ContinueOnFailure festgelegt, und einige Elemente sind fehlgeschlagen, und dann werden die fehlerhaften Elemente nacheinander fortgesetzt.
