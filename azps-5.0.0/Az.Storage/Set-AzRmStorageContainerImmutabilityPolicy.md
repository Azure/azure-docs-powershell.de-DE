...
## Beschreibung
Das Cmdlet " **Satz-AzRmStorageContainerImmutabilityPolicy** " erstellt oder aktualisiert ImmutabilityPolicy eines Speicher-BLOB-Containers
...
Dieser Befehl aktualisiert ImmutabilityPolicy eines Speicher-BLOB-Containers mit dem Speichercontainer Objekt dreimal: zuerst bis ImmutabilityPeriod 12 Tage ohne ETag, dann auf ImmutabilityPeriod 9 Tage mit ETag, schließlich aktiviert AllowProtectedAppendWrite.
...
Diese Eigenschaft kann nur für freigegebene zeitbasierte Aufbewahrungsrichtlinien geändert werden. Wenn diese Eigenschaft aktiviert ist, können neue Blöcke in ein Append-BLOB geschrieben werden, wobei der Schutz und die Compliance unveränderlich sind. Es können nur neue Blöcke hinzugefügt und vorhandene Blöcke nicht geändert oder gelöscht werden.
