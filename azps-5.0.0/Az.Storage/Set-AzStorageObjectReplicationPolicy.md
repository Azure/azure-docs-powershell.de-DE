...
## Beschreibung
Das Cmdlet " **festlegen-AzStorageObjectReplicationPolicy** " erstellt oder aktualisiert die angegebene Objekt Replikationsrichtlinie in einem Speicherkonto.

## Beispiele

### Beispiel 1: Festlegen von Objekt Replikationsrichtlinien auf Ziel-und Quellkonto
```
...
Dieser Befehl legt die Objekt Replikationsrichtlinie auf das Ziel-und das Quellkonto fest.
Erstellen Sie zunächst zwei Richtlinien Regeln für die Objektreplikation, und legen Sie die Richtlinie mit dem Konto 2 Regeln für Ziel fest. Legen Sie dann die Objekt Replikationsrichtlinie vom Zielkonto auf Quellkonto ab.
...
### -DestinationAccount
Objekt Replikationsrichtlinien DestinationAccount
...
### -Inputobject
Objekt Replikationsrichtlinien Objekt, das auf das angegebene Konto festgelegt werden soll.
...
### -Richtlinien-Nr
Objekt Replikationsrichtlinien-ID. Es sollte eine GUID oder "Default" sein.
Wenn die Richtlinien-ID nicht eingegeben wird, wird "Standard" verwendet, was bedeutet, dass eine neue Richtlinie erstellt und die ID der neuen Richtlinie in der erstellten Richtlinie zurückgegeben wird.
...
### -Rule
Regeln für Objekt Replikationsrichtlinien.
...
### -SourceAccount
Objekt Replikationsrichtlinien SourceAccount
