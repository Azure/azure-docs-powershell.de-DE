...
## Beschreibung
Mit dem Cmdlet **Get-AzDataLakeGen2ItemContent können Sie** eine Datei in einem Dateisystem in einem Azure-Speicherkonto herunterladen.
...
### Beispiel 1: Herunterladen einer Datei ohne Aufforderung
```
...
### Beispiel 2: Abrufen einer Datei und anschließende Pipeline zum Herunterladen der Datei in eine lokale Datei
```
...
Dieser Befehl ruft zuerst eine Datei und dann Pipeline ab, um die Datei in eine lokale Datei herunterzuladen.
...
### -Force
Erzwingen, dass das vorhandene BLOB oder die vorhandene Datei überschrieben wird
...
### -Inputobject
Azure datalake Gen2-Element Objekt, das heruntergeladen werden soll.
