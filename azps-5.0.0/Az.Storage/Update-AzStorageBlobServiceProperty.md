...
### Beispiel 1: Einrichten des BLOB-Diensts DefaultServiceVersion auf 2018-03-28
```
...
Dieser Befehl legt die DefaultServiceVersion des BLOB-Diensts auf 2018-03-28 fest.
...
Dieser Befehl aktiviert changefeed beim BLOB-Dienst einer Speicherkonto-Änderungs Feed-Unterstützung im Azure BLOB-Speicher, indem ein GPv2-oder BLOB-Speicherkonto für alle Ereignisse zum Erstellen, ändern oder Löschen von BLOB-Ebenen überwacht wird. Anschließend wird ein geordnetes Protokoll der Ereignisse für die BLOBs ausgegeben, die im $blobchangefeed Container im Speicherkonto gespeichert sind. Die serialisierten Änderungen werden als Apache Avro-Datei beibehalten und können asynchron und inkrementell verarbeitet werden.

### Beispiel 3: Aktivieren der Versionsverwaltung für den BLOB-Dienst eines speicherkontos
```
...
### -DefaultServiceVersion
Standardmäßige Dienst Version zum Festlegen
...
### -EnableChangeFeed
Aktivieren Sie die Protokollierung der Änderungs Zufuhr für das Speicherkonto, indem Sie auf $true festlegen, Protokollierung der Änderungs Zufuhr durch Festlegen auf $false deaktivieren.
...
### -IsVersioningEnabled
Ruft ab oder legt fest, dass die Versionsverwaltung aktiviert ist, wenn Sie auf true festgelegt ist.
