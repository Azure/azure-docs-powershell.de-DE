...
## Beschreibung
Das Cmdlet " **Satz-AzStorageAccount** " ändert ein Azure Storage-Konto.
...
### Beispiel 10: Aktualisieren eines speicherkontos durch Aktivieren von Azure-Dateien Aad DS-Authentifizierung.
```
...
Der Befehl Aktualisieren eines speicherkontos durch Aktivieren von Azure-Dateien Aad DS-Authentifizierung.

### Beispiel 11: Aktualisieren eines speicherkontos durch Aktivieren von "Dateien" Active Directory-Domänendienst Authentifizierung und Anzeigen der Authentifizierungseinstellung "Datei Identität basiert"
```
...
Der Befehl aktualisiert ein Speicherkonto durch Aktivieren der Active Directory-Domänendienst Authentifizierung für Azure-Dateien und zeigt dann die Einstellung "Datei identitätsbasierte Authentifizierung" an.

### Beispiel 12: Einrichten von MinimumTlsVersion und AllowBlobPublicAccess
```
...
Wenn Sie die Zugriffsebene ändern, kann dies zu zusätzlichen Gebühren führen. Weitere Informationen finden Sie unter [Azure-BLOB-Speicher: heiße und kühle Speicherebenen](http://go.microsoft.com/fwlink/?LinkId=786482).
...
Zulassen oder Verweigern des öffentlichen Zugriffs auf alle Blobs oder Container im Speicherkonto.
...
### -MinimumTlsVersion
Die minimale TLS-Version, die bei Speicheranforderungen zulässig ist.
