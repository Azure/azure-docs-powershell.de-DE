...
## Beschreibung
Das Cmdlet " **Get-AzStorageObjectReplicationPolicy** " erstellt eine Objekt Replikationsrichtlinien Regel, die in Set-AzStorageObjectReplicationPolicy-Cmdlet verwendet wird.

## Beispiele

### Beispiel 1: Erstellen einer Objekt Replikationsrichtlinien Regel mit nur Quell-und Ziel Konto und Anzeigen der zugehörigen Eigenschaften
```
...
Mit diesem Befehl wird eine Objekt Replikationsrichtlinien Regel mit nur Quell-und Ziel Konto erstellt, und die zugehörigen Eigenschaften werden angezeigt.

### Beispiel 2: Erstellen einer Objekt Replikationsrichtlinien Regel mit allen Eigenschaften und Anzeigen der zugehörigen Eigenschaften
```
...
Mit diesem Befehl wird eine Objekt Replikationsrichtlinien Regel mit allen Eigenschaften und deren Eigenschaften angezeigt.
...
### -MinCreationTime
BLOBs, die nach dem Zeitpunkt erstellt wurden, werden in das Ziel repliziert.
...
### -SourceContainer
Der Name des Quellcontainers, von dem repliziert werden soll.
