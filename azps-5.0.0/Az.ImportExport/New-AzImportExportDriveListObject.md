...
## Synopsis
Erstellen Sie ein driverlist-Objekt für DataObjects.
...
### Beispiel 1: Erstellen einer neuen Laufwerkliste für DataObjects-Auftrag
```powershell
...
Diese Cmdlets erstellen eine neue drivelist für DataObjects-Auftrag.
...
### -BytesSucceeded
Bytes, die für das Laufwerk erfolgreich übertragen wurden.
...
### -CopyStatus
Der detaillierte Status des Daten Übertragungsprozesses.
Dieses Feld wird in der Antwort erst zurückgegeben, wenn sich das Laufwerk im Status "übertragen" befindet.
...
### -DriveHeaderHash
Der Hashwert des Laufwerk Headers.
...
### -Laufwerks-Nr
Die Hardware-Seriennummer des Laufwerks ohne Leerzeichen.
...
### -ErrorLogUri
Ein URI, der auf das BLOB verweist, das das Fehlerprotokoll für den Daten Übertragungsvorgang enthält.
...
### -ManifestUri
Ein URI, der auf das BLOB verweist, das die Laufwerk Manifestdatei enthält.
...
### -PercentComplete
Prozentsatz für das Laufwerk abgeschlossen.
...
### -Bundesland
Der aktuelle Zustand des Laufwerks.
...
### -VerboseLogUri
Ein URI, der auf das BLOB verweist, das das ausführliche Protokoll für den Daten Übertragungsvorgang enthält.
...
### Microsoft. Azure. PowerShell. Cmdlets. DataObjects. Models. Api20161101. IDriveStatus
