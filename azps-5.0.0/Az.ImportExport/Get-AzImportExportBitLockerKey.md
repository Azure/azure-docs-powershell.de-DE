...
## Synopsis
Gibt die BitLocker-Schlüssel für alle Laufwerke des angegebenen Auftrags zurück.
...
### Beispiel 1: Auflisten aller BitLocker-Schlüssel in angegebenen DataObjects-Aufträgen
```powershell
...
Dieses Cmdlet listet alle BitLocker-Schlüssel in angegebenen DataObjects-Aufträgen auf.
...
### Microsoft. Azure. PowerShell. Cmdlets. DataObjects. Models. Api20161101. IDriveBitLockerKey
