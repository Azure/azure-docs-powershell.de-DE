...
## Beschreibung
Das Cmdlet **enable-AzCdnCustomDomain** ermöglicht die sichere HTTPS-Zustellung einer benutzerdefinierten CDN-Domäne.
...
Aktivieren Sie die HTTPS-Zustellung der benutzerdefinierten Domäne.
