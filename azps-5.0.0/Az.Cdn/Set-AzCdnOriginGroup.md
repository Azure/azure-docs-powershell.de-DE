...
## Beschreibung
Set-AzCdnOriginGroup aktualisiert die angegebene Ursprungsgruppe innerhalb des angegebenen Endpunkts. 
...
```
Mit diesem Cmdlet wird die ProbeIntervalInSeconds-Eigenschaft in der Gruppe Ursprung aktualisiert. 
