...
## Beschreibung
Das Cmdlet **enable-AzCdnCustomDomainHttps** ermöglicht die sichere HTTPS-Zustellung einer benutzerdefinierten CDN-Domäne.
...
Aktivieren Sie die sichere Zustellung der benutzerdefinierten Domäne.
