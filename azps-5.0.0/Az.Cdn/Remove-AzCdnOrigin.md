...
## Beschreibung
Remove-AzCdnOrigin löscht einen CDN-Ursprung aus dem angegebenen Endpunkt. Wenn der Ursprung der einzige Ursprung innerhalb des angegebenen Endpunkts ist, schlägt der Löschvorgang fehl, da mindestens 1 Ursprung benötigt wird. 
...
```
Mit diesem Cmdlet wird der angegebene Ursprung vom angegebenen Endpunkt entfernt. 

## Parameter

### -CdnOrigin
Das CDN-Ursprungsobjekt.
