...
Mit diesem Cmdlet wird ein neuer CDN-Ursprung für den angegebenen Endpunkt erstellt. Dabei wird der angegebene Hostname als Ursprung verwendet. 
...
### -HttpsPort
Azure CDN-Ursprungs HTTPS-Port.
...
### -OriginHostHeader
Azure CDN-Ursprungshost Header.
...
### -PrivateLinkLocation
Azure CDN Origin-Speicherort für private Links.
...
Azure CDN Origin-Ressourcen-ID für private Links.
