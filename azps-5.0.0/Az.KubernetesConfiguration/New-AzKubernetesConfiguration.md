...
## Synopsis
Erstellen Sie eine neue Kubernetes-Quell Code Verwaltungskonfiguration.
...
### Beispiel 1: Erstellen eines Konfigurations für kubernetes-Cluster
```powershell
...
Mit diesem Befehl wird ein Konfigurations für kubernetes-Cluster erstellt.
...
### -ClusterScoped
Bei Übergabe wird der Bereich der Konfiguration auf Cluster gesetzt (Standard ist Namespace).
...
### -EnableHelmOperator
Option zum Aktivieren des Helms-Operators für diese git-Konfiguration.
...
Überschreibung der Werte für das Steuer Diagramm des Operators
...
Die Version des Operators Helm-Diagramms.
...
Instanzname des Operators – identifizieren der jeweiligen Konfiguration.
...
Maximal zulässige alphanumerische Zeichen in 253 Kleinbuchstaben, Bindestrich und Punkt.
...
### -OperatorParameters
Alle Parameter für die Operator Instanz im Zeichenfolgenformat
...
### -RepositoryUrl
Die URL des SourceControl-Repositorys.
