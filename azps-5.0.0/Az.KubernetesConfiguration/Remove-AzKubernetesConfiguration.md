...
## Synopsis
Dadurch wird die YAML-Datei gelöscht, die zum Einrichten der Quellcodeverwaltungs-Konfiguration verwendet wird, wodurch die zukünftige Synchronisierung aus dem Quell-Repo gestoppt wird.
...
### Beispiel 1: Entfernen eines Konfigurations des kubernetes-Clusters nach Name
```powershell
...
Mit diesem Befehl wird ein Konfigurations des kubernetes-Clusters nach Name entfernt.

### Beispiel 2: Entfernen eines Konfigurations des kubernetes-Clusters nach Objekt
```powershell
...
Dieser Befehl entfernt eine Konfigurations des kubernetes-Clusters nach Objekt.
