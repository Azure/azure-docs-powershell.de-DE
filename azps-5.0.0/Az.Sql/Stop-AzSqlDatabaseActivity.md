...
## Beschreibung
Mit dem Cmdlet " **Stop-AzSqlDatabaseActivity** " wird der asynchrone Aktualisierungsvorgang für die Datenbank abgebrochen.

## Beispiele

### Beispiel 1: Abbrechen des asynchronen Updates-Vorgangs in der Datenbank
```
...
Mit diesem Befehl wird der asynchrone Aktualisierungsvorgang für die Datenbank abgebrochen.
