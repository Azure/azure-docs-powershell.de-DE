...
Legt die Failover-Richtlinie einer Instanzen-failovergruppe auf "manuell" durch Verrohrung in der Gruppe Failover fest.

## Parameter

### -AllowReadOnlyFailoverToPrimary
Ob Ausfälle auf dem sekundären Server ein automatisches Failover des schreibgeschützten Endpunkts auslösen sollten.
...
### -Inputobject
Das zu bestimmende Instanzen-Failover-Gruppenobjekt
...
### -Resourcen-Nr
Die Ressourcen-ID der zu bestimmenden Instanz-failovergruppe.
