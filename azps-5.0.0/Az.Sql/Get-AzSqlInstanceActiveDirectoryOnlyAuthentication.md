...
## Beschreibung
Das Cmdlet " **Get-AzSqlInstanceActiveDirectoryOnlyAuthentication** " ruft nur die Azure Active Directory (Azure AD)-Authentifizierungsanforderung für eine verwaltete AzureSQL-Instanz im aktuellen Abonnement ab.
...
Dieser Befehl ruft nur die Azure Active Directory (Azure AD)-Authentifizierungsanforderung für eine verwaltete AzureSQL-Instanz mit dem Namen ManagedInstance01 ab, die einer Ressourcengruppe namens ResourceGroup01 zugeordnet ist.
...
### -InstanceName
Der Name der verwalteten Azure SQL-Instanz, in der sich nur die Azure Active Directory-Authentifizierung befindet.
