...
Eine der beiden Bereiche in der Gruppe "Instanzen-Failover" kann verwendet werden, um den Befehl auszuführen. Die zurückgegebenen Werte geben den Zustand der verwalteten Instanzen in diesem Bereich hinsichtlich der Instanz-failovergruppe wieder.
