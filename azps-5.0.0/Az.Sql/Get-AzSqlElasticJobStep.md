...
## Beschreibung
Das Get-AzSqlElasticJobStep-Cmdlet ruft einen oder mehrere Auftragsschritte von einem Auftrag ab.

## Beispiele

### Beispiel 1: Abrufen eines Auftragsschritts aus einem Auftrag
```powershell
