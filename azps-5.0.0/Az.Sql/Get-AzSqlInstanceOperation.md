...
## Beschreibung
Das Get-AzSqlInstanceOperation-Cmdlet ruft Informationen zu den Vorgängen in einer verwalteten SQL-Instanz ab. Sie können alle Vorgänge in einer verwalteten Instanz anzeigen oder einen bestimmten Vorgang anzeigen, indem Sie den Vorgangsnamen angeben.

## Beispiele

### Beispiel 1: Abrufen aller Instanzen Vorgänge
```powershell
...
Dieser Befehl ruft alle Vorgänge einer verwalteten SQL-Instanz ab.

### Beispiel 2: Abrufen eines bestimmten Vorgangs
```powershell
...
Dieser Befehl ruft den Vorgang mit dem Namen "5870c6d8-6703-4b27-8AE4-687b4ca7caea" auf einer verwalteten SQL-Instanz ab.

### Beispiel 3: Verwenden der Vorgangs Ressourcen-ID
```powershell
...
Dieser Befehl ruft den Vorgang mit der ID "/Subscriptions/a8c9a924-06c0-4bde-9788-e7b1370969e1/resourceGroups/ps3753/Providers/Microsoft.SQL/managedInstances/ps3698/Operations/5870c6d8-6703-4b27-8AE4-687b4ca7caea" ab.
...
### -Resourcen-Nr
Der Ressourcenbezeichner des verwalteten Instanzen Vorgangs.
