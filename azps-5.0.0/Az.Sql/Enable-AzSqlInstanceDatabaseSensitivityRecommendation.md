...
## Beschreibung
Das Enable-AzSqlInstanceDatabaseSensitivityRecommendation-Cmdlet ermöglicht Vertraulichkeits Empfehlungen für Spalten in der Azure SQL-Datenbank für verwaltete Instanzen.

## Beispiele

### Beispiel 1: Aktivieren von Vertraulichkeits Empfehlungen für eine bestimmte Spalte in einer Azure SQL-Datenbank mit verwalteten Instanzen.
```powershell
...
### Beispiel 2: Aktivieren von Vertraulichkeits Empfehlungen für eine bestimmte Spalte in einer Azure SQL-Datenbank mit verwalteten Instanzen mit Piping.
```powershell
