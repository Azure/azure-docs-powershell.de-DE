...
## Beschreibung
Das Cmdlet **New-AzSqlDatabaseCopy** erstellt eine Kopie einer Azure SQL-Datenbank, in der die Momentaufnahme der Daten zur aktuellen Zeit verwendet wird. Verwenden Sie dieses Cmdlet anstelle des Start-AzSqlDatabaseCopy-Cmdlets, um eine einmalige Datenbankkopie zu erstellen. Dieses Cmdlet gibt das **Daten Bank** Objekt der Kopie zurück.
Hinweis: Verwenden Sie das New-AzSqlDatabaseSecondary-Cmdlet, um die Geo-Replikation für eine Datenbank zu konfigurieren.
...
Erstellt eine Kopie einer SQL-Datenbank, die den Snapshot zum aktuellen Zeitpunkt verwendet. automatisch
...
### -ComputeGeneration
Die COMPUTE-Generierung, die der neuen Kopie zugewiesen werden soll.
...
### -CopyServerName
Gibt den Namen des SQL-Servers an, der die Kopie hostet.
...
### -DatabaseName
Gibt den Namen der SQL-Datenbank an, die kopiert werden soll.
...
### -ElasticPoolName
Gibt den Namen des elastischen Pools an, in dem die Kopie zugewiesen werden soll.
...
### -Servername
Gibt den Namen des SQL-Servers an, der die zu kopierende Datenbank enthält.
...
Gibt den Namen des Dienst Ziels an, das der Kopie zugewiesen werden soll.
...
### -Tags
Gibt die Schlüssel-Wert-Paare in Form einer Hashtabelle an, die der Azure SQL-Datenbankkopie zugeordnet werden soll. Beispiel: @ {Key0 = "value0"; key1 = $NULL; key2 = "Value2"}
...
### -VCore
Die Vcore-Nummern der Azure SQL-Datenbankkopie.
