...
## Beschreibung
Das Cmdlet " **Get-AzSqlServerActiveDirectoryAdministrator** " Ruft Informationen zu einem Azure Active Directory (Azure AD)-Administrator für einen AzureSQL-Server im aktuellen Abonnement ab.
