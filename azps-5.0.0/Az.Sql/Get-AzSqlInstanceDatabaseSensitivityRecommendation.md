...
## Beschreibung
Das Get-AzSqlInstanceDatabaseSensitivityRecommendation-Cmdlet gibt die empfohlenen Informationstypen und Vertraulichkeits Bezeichnungen von Spalten in der Datenbank Azure SQL Managed instance zurück.

## Beispiele

### Beispiel 1: Abrufen empfohlener Informationstypen und Vertraulichkeits Beschriftungen einer Azure SQL-Datenbank mit verwalteten Instanzen.
```powershell
...
### Beispiel 2: Abrufen empfohlener Informationstypen und Vertraulichkeits Beschriftungen einer Azure SQL-Datenbank mit verwalteten Instanzen mithilfe von Piping.
```powershell
