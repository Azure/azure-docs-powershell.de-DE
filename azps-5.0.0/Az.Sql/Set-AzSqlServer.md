...
## Beschreibung
Das Cmdlet " **Satz-AzSqlServer** " ändert die Eigenschaften eines Azure SQL-Datenbankservers.
...
Mit diesem Befehl wird das Administratorkennwort auf dem AzureSQL-Server mit dem Namen Server01 zurückgesetzt.

### Beispiel 2

Ändert die Eigenschaften eines SQL-Datenbankservers. automatisch
...
### -PublicNetworkAccess
Akzeptiert ein Flag, aktiviert/deaktiviert, um anzugeben, ob der Zugriff auf den öffentlichen Netzwerkserver zulässig ist oder nicht.
Wenn diese Option deaktiviert ist, können nur Verbindungen, die über private links erfolgen, auf diesen Server zugreifen.
...
### -Server Version vom
Gibt die Version an, für die dieses Cmdlet den Server ändert. Die zulässigen Werte für diesen Parameter lauten: 2,0 und 12,0.
...
### -SqlAdministratorPassword
Gibt ein neues Kennwort als **SecureString** für den Datenbankserver-Administrator an. Verwenden Sie das Get-Credential-Cmdlet, um eine **SecureString** -Anwendung zu erhalten. Wenn Sie weitere Informationen wünschen, geben Sie `Get-Help
...
### -Tags
Gibt ein Wörterbuch mit Tags an, die dieses Cmdlet dem Server anordnet. Schlüssel-Wert-Paare in Form einer Hashtabelle, die als Tags auf dem Server definiert ist. Beispiel: @ {Key0 = "value0"; key1 = $NULL; key2 = "Value2"}
