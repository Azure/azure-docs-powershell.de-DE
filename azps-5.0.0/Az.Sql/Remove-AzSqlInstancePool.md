...
## Beschreibung
Mit dem Cmdlet **Remove-AzSqlInstancePool** wird ein Azure SQL-Instanzen Pool entfernt.

## Beispiele

### Beispiel 1: Entfernen eines Instanzen Pools
```powershell
PS C:\> Remove-AzSqlInstancePool -ResourceGroup resourcegroup01 -Name instancePool0
```

### Beispiel 2: Entfernen eines Instanzen Pools anhand des Ressourcenbezeichners
```powershell
...
### Beispiel 3: Entfernen eines Instanzen Pools durch ein Instanzen Pool Objekt
```powershell
...
Dieser Befehl entfernt einen Instanz Pool mit dem Namen instancePool0.
...
### -Inputobject
Das zu entfernende Instanz Pool-Objekt.
...
### -Resourcen-Nr
Die zu entfernende Ressourcen-ID des Instanzen Pools.
