...
## Beschreibung
Das Cmdlet **enable-AzSqlInstanceActiveDirectoryOnlyAuthentication** ermöglicht die Azure Active Directory (Azure AD) only-Authentifizierungsanforderung für eine AzureSQL-verwaltete Instanz im aktuellen Abonnement.
...
Dieser Befehl aktiviert die Azure Active Directory (Azure AD) only-Authentifizierungsanforderung für eine verwaltete AzureSQL-Instanz mit dem Namen ManagedInstance01, die einer Ressourcengruppe namens ResourceGroup01 zugeordnet ist.
