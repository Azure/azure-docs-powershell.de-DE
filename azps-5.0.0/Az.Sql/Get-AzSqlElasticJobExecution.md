...
## Beschreibung
Das Get-AzSqlElasticJobExecution-Cmdlet ruft mindestens eine Auftragsausführung ab.

## Beispiele

### Beispiel 1: Ruft eine oder mehrere Auftragsausführungen in allen Aufträgen ab.
```powershell
...
### Beispiel 2: Ruft mindestens eine Auftragsausführung für einen Auftrag ab.
```powershell
PS C:\> $agent = Get-AzSqlElasticJobAgent -ResourceGroupName rg -ServerName elasticjobserver -Name agent
...
Ruft mindestens eine Auftragsausführung ab. automatisch
