...
## Beschreibung
Das Disable-AzSqlDatabaseSensitivityRecommendation-Cmdlet deaktiviert Vertraulichkeits Empfehlungen für Spalten in der Datenbank.

## Beispiele

### Beispiel 1: Deaktivieren von Vertraulichkeits Empfehlungen für eine bestimmte Spalte in einer Azure SQL-Datenbank.
```powershell
...
### Beispiel 2: Deaktivieren Sie die Vertraulichkeits Empfehlungen für Spalten, die in einer Azure SQL-Datenbank mithilfe von Piping Vertraulichkeits Empfehlungen aufweisen.
```powershell
...
### Beispiel 3: Deaktivieren von Vertraulichkeits Empfehlungen für eine bestimmte Spalte in einer Azure SQL-Datenbank mithilfe von Piping.
```powershell
