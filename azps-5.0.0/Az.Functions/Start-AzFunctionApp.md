...
### Beispiel 1: Rufen Sie eine Funktions-APP mit dem Namen ab, und starten Sie Sie.
```powershell
PS C:\> Get-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName | Start-AzFunctionApp
```

Dieser Befehl ruft eine Funktions-APP mit dem Namen ab und startet Sie.

### Beispiel 2: Starten einer Funktions-APP mit dem Namen.
```powershell
PS C:\> Start-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName
```

Mit diesem Befehl wird eine Funktions-APP mit dem Namen gestartet.
