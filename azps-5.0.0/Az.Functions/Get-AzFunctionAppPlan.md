...
### Beispiel 1: Abrufen aller Funktions-APP-Pläne.
```powershell
...
### Beispiel 2: Abrufen von Funktions-APP-Plänen nach Ressourcengruppennamen.
```powershell
...
Dieser Befehl ruft Funktions-APP-Pläne nach dem Namen der Ressourcengruppe ab.

### Beispiel 3: Abrufen von Funktions-APP-Plänen für die angegebenen Abonnements.
```powershell
...
### Beispiel 4: Abrufen von Funktions-APP-Plänen nach Standort.
```powershell
...
Dieser Befehl ruft Funktions-APP-Pläne nach Position ab.
...
### -Standort
Der Speicherort des Funktions-APP-Plans.
