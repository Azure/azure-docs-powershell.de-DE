...
### Beispiel 1: Abrufen der Speicherorte, an denen Premium für Windows verfügbar ist. Wenn keine Parameter angegeben werden, wird "plantype" auf "Premium" festgelegt, und OSType ist auf "Windows" festgelegt.
```powershell
...
### Beispiel 2: Abrufen der Speicherorte, an denen Premium für Linux verfügbar ist.
```powershell
...
### Beispiel 3: Abrufen der Speicherorte, an denen der Verbrauch für Windows verfügbar ist.
```powershell
...
Dieser Befehl ruft die Speicherorte ab, an denen der Verbrauch für Windows verfügbar ist.
...
### -OSType
Der Typ des Betriebssystems für den Service Plan.
...
### -Plantype
Der Plantyp.
Gültige Eingaben: Verbrauch oder Prämie
