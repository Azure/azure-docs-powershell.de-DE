...
### Beispiel 1: Abrufen aller Funktions-apps.
```powershell
...
### Beispiel 2: Abrufen von Funktions-apps nach Namen.
```powershell
...
### Beispiel 3: Abrufen von Funktions-apps nach Ressourcengruppennamen.
```powershell
...
### Beispiel 4: Abrufen von Funktions-Apps für die angegebenen Abonnements
```powershell
...
### Beispiel 5: Abrufen von Funktions-apps nach Standort.
```powershell
...
### -IncludeSlot
Verwenden Sie diese Option, um anzugeben, ob Bereitstellungs Steckplätze in Ergebnisse eingeschlossen werden sollen.
...
### -Standort
Der Speicherort der Funktions-APP.
