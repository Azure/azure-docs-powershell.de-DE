...
## Synopsis
 Ruft eine andere Instanz einer Trigger-Ausführung auf.
...
## Beschreibung
Der Befehl **Invoke-AzDataFactoryV2TriggerRun** startet eine andere Instanz eines Triggers, der mit einer neuen Trigger-Lauf-ID ausgeführt wird.
...
```
Startet eine andere Instanz eines Triggers, der mit einer neuen Trigger-Lauf-ID ausgeführt wird, wobei dieselbe windowStartTime und windowEndTime wie der ursprüngliche Trigger ausgeführt werden.
