...
## Synopsis
Beendet einen Trigger, der in einer Data Factory ausgeführt wird.
...
## Beschreibung
Das Cmdlet **Stop-AzDataFactoryV2TriggerRun** beendet einen Trigger, der in einer mit dem Triggernamen und der Trigger Run-ID angegebenen Daten Factory ausgeführt wird.
Wird derzeit nur für TumblingWindowTriggers im WaitingOnDependency-Zustand unterstützt.
...
Dieser Befehl beendet den Trigger, der mit der ID ' 08586002468005888497807248799CU16 ' im Factory-WikiADF ausgeführt wird.
