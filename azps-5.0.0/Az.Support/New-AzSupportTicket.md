...
### Beispiel 15: Erstellen eines Kontingent Unterstützungs Tickets zur Erhöhung des Kontingents für Azure SQL-verwaltete Instanz. Verwenden Sie Get-AzSupportService und Get-AzSupportProblemClassification, um korrekte GUIDs für die Problem Klassifikation des Kontingents für SQL Managed instance Service abzurufen.
```powershell
...
### Beispiel 16: Erstellen Sie ein Support Ticket, indem Sie einzelne Kundenkontakt Parameter anstelle des CustomerContactDetail-Objekts angeben. 
```powershell
...
### Beispiel 17: Erstellen eines Support Tickets mit der Anforderung einer Antwort von Azure auf 24 x 7. 
```powershell
