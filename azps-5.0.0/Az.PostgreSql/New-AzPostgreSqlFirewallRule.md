...
### Beispiel 1: Erstellen einer neuen PostgreSQL-Server Firewall-Regel
```powershell
...
Diese Cmdlets erstellen eine Firewall-Regel für den PostgreSQL-Server.

### Beispiel 2: Erstellen einer neuen PostgreSQL-Firewallregel mithilfe von-ClientIPAddress.
```powershell
...
Diese Cmdlets erstellen eine PostgreSQL-Firewallregel mithilfe von-ClientIPAddress.

### Beispiel 3: Erstellen einer neuen PostgreSQL-Firewall-Regel, um alle IPS zuzulassen
```powershell
...
Diese Cmdlets erstellen eine neue PostgreSQL-Firewallregel, damit alle IPS zugelassen werden.
