...
### Beispiel 1: Auflisten aller Konfigurationen in PostgreSQL Server
```powershell
...
Dieses Cmdlet listet alle Konfigurationen auf dem angegebenen PostgreSQL-Server auf.

### Beispiel 2: Abrufen der angegebenen PostgreSQL-Konfiguration nach Name
```powershell
...
Dieses Cmdlet erhält die angegebene PostgreSQL-Konfiguration nach Namen.
