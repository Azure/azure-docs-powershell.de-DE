...
### Beispiel 1: Entfernen der virtuellen Netzwerkregel des PostgreSQL-Servers nach Namen
```powershell
PS C:\> Remove-AzPostgreSqlVirtualNetworkRule -Name vnet -ResourceGroupName PostgreSqlTestRG -ServerName PostgreSqlTestServer

```

Dieses Cmdlet entfernt die virtuelle PostgreSQL-Server-Netzwerkregel nach Namen.

### Beispiel 2: Entfernen der virtuellen Netzwerkregel des PostgreSQL-Servers nach Identität
```powershell
...
Mit diesen Cmdlets wird die virtuelle Netzwerkregel des PostgreSQL-Servers nach Identität entfernt.
