...
### Beispiel 1: Wiederherstellen des PostgreSQL-Servers mithilfe der georeplica-Wiederherstellung
```powershell
...
Dieses Cmdlet stellt den PostgreSQL-Server mithilfe der georeplica-Wiederherstellung wieder her.
