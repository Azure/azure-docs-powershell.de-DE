...
### Beispiel 1: Aktualisieren der virtuellen PostgreSQL-Netzwerkregel nach Namen
```powershell
...
Dieses Cmdlet aktualisiert die virtuelle PostgreSQL-Netzwerkregel nach Namen.

### Beispiel 2: Aktualisieren der virtuellen PostgreSQL-Netzwerkregel nach Identität.
```powershell
...
Diese Cmdlets aktualisieren die virtuelle PostgreSQL-Netzwerkregel nach Identität.
...
### -Subnet-Nr
Die Arm-Ressourcen-ID des virtuellen Netzwerk-Subnets.
