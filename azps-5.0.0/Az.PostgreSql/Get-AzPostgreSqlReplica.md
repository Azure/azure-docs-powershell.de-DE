...
### Beispiel 1: Abrufen des PostgreSQL-Server Replikats nach Ressourcengruppe und Servername
```powershell
...
Dieses Cmdlet ruft das Replikat des PostgreSQL-Servers nach Ressourcengruppe und Servername ab.
