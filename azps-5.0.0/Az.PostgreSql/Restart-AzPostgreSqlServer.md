...
### Beispiel 1: Neustart des PostgreSQL-Servers nach Ressourcengruppe und Servername
```powershell
PS C:\> Restart-AzPostgreSqlServer -ResourceGroupName PostgreSqlTestRG -Name PostgreSqlTestServer

```

Mit diesem Cmdlet wird der PostgreSQL-Server nach Ressourcengruppe und Servername neu gestartet.

### Beispiel 2: Neustarten des PostgreSQL-Servers nach Identität
```powershell
...
Mit diesen Cmdlets wird der PostgreSQL-Server nach Identität neu gestartet.
