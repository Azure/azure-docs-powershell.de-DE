...
### Beispiel 1: Abrufen von Mandanten Zugriffs-Konfigurationsschlüsseln
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementTenantAccessSecret -Context $apimContext
```

Dieser Befehl ruft die Konfigurationsschlüssel für den Mandanten Zugriff für den angegebenen Kontext ab.
