...
## Beschreibung
Das Cmdlet **New-AzApiManagementDiagnostic** erstellt eine diagnostische Entität entweder im globalen Bereich oder in einem bestimmten API-Bereich.

## Beispiele

### Beispiel 1: Erstellen einer neuen globalen Bereichs Diagnose
```powershell
...
In diesem Beispiel wird eine diagnostische Entität im globalen Bereich erstellt.

### Beispiel 2: Erstellen einer Diagnose im API-Bereich
```powershell
PS D:\github\azure-powershell> $context = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
Im obigen Beispiel wird eine Diagnose für die API erstellt `httpbin` , um die Kopfzeile und 100 Byte des Texts in Protokollierung zu protokollieren `azuremonitor` .
...
### -Diagnose-Nr
Der Bezeichner der Diagnostics-Entität.
Dieser Parameter ist optional.
