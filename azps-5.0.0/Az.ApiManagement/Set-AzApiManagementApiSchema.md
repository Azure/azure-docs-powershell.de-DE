...
## Beschreibung
Das Cmdlet " **Satz-AzApiManagementApiSchema** " ändert ein Azure API Management-API-Schema.
...
Ändert ein API-Schema. automatisch
...
### -Resourcen-Nr
Arm-Resourcen-Diagnose-oder API-Schema Dieser Parameter ist erforderlich.
