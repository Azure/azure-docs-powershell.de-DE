...
## Beschreibung
Das Cmdlet " **Satz-AzApiManagementOpenIdConnectProvider** " ändert einen OpenID Connect-Anbieter in Azure API-Verwaltung.

## Beispiele

### Beispiel 1: Ändern des Client Geheimnisses für einen Anbieter
```powershell
...
Der Befehl gibt einen Client Schlüssel für den Anbieter an.

### Beispiel 2

Ändert einen OpenID Connect-Anbieter. automatisch
...
Gibt eine ID für den Anbieter an, die von diesem Cmdlet geändert wird.
...
### -PassThru
Gibt an, dass dieses Cmdlet die **PsApiManagementOpenIdConnectProvider** zurückgibt, die von diesem Cmdlet geändert werden.
