...
## Beschreibung
Das Cmdlet " **Get-AzApiManagementGatewayHostnameConfiguration** " ruft alle oder eine bestimmte Hostname-Konfiguration für das vorhandene Gateway ab.

## Beispiele

### Beispiel 1: Abrufen aller Hostnamen-Konfigurationen für das Gateway
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementGatewayHostnameConfiguration -Context $apimContext  -GatewayId "0123456789"
```

Dieser Befehl ruft alle Hostnamen-Konfigurationen für ein "0123456789"-Gateway ab.

### Beispiel 2: Abrufen einer Hostname-Konfiguration für das Gateway
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
Dieser Befehl ruft die "123"-Hostname-Konfiguration für ein "0123456789"-Gateway ab.
