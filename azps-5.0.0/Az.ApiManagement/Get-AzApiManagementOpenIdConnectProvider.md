...
## Beschreibung
Das Cmdlet " **Get-AzApiManagementOpenIdConnectProvider** " erhält OpenID Connect-Anbieter in der Azure-API-Verwaltung.
ClientSecret wird nicht in Ergebnisdetails eingeschlossen. Verwenden **Sie Get-AzApiManagementOpenIdConnectProviderClientSecret** , um Client Secret zu erhalten.
...
Dieser Befehl ruft den Anbieter ab, der die ID OICProvider01.
