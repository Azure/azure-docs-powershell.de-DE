...
## Beschreibung
Das Cmdlet **New-AzApiManagementNamedValue** erstellt eine Azure API-Verwaltung **mit dem Namen Value**.
...
### Beispiel 2: Erstellen eines benannten Werts, der einen geheimen Wert aufweist
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>New-AzApiManagementNamedValue -Context $apimContext -NamedValueId "Property12" -Name "Secret Property" -Value "Secret Property Value" -Secret
```

Mit diesem Befehl wird ein **benannter Wert** erstellt, der über einen verschlüsselten Wert verfügt.
...
### -NamedValueId
Bezeichner des neuen benannten Werts.
...
### -Tag
Tags, die mit dem benannten Wert verknüpft werden sollen.
Dieser Parameter ist optional.
