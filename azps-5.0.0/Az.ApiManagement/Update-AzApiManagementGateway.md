...
## Beschreibung
Das Cmdlet **Update-AzApiManagementGateway** konfiguriert ein API-Verwaltungs Gateway.
...
### -PassThru
Wenn angegeben, wird Instanz des Microsoft. Azure. Commands. ApiManagement. Servicemanagement. Models. PsApiManagementGateway-Typs, der das geänderte Gateway darstellt.
...
### -Resourcen-Nr
Arm-Quell Code des Gateways. Dieser Parameter ist erforderlich.
