...
Das Cmdlet **New-AzApiManagementApiRelease** erstellt eine API-Version für eine API-Revision im API-Verwaltungskontext. Eine Version wird verwendet, um die API-Revision als aktuelle Revision zu erstellen.
