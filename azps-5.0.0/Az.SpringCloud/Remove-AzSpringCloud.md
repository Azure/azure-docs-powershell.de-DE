...
### Beispiel 1: Entfernen des Spring Cloud-Diensts nach Name
```powershell
PS C:\> Remove-AzSpringCloud -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service
```

Entfernen Sie den Spring Cloud-Dienst nach Namen.

### Beispiel 2: Entfernen des Spring Cloud-Diensts aus Pipe
```powershell
PS C:\> Get-AzSpringCloud -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service | Remove-AzSpringCloud
```

Entfernen Sie den Spring Cloud-Dienst aus Pipe.
