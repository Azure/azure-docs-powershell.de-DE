...
### Beispiel 1: Aktualisieren des Spring Cloud-Diensts nach Name
```powershell
...
Aktualisieren Sie den Spring Cloud-Dienst nach Namen.

### Beispiel 2: Aktualisieren des Spring Cloud-Diensts aus Pipe
```powershell
...
Aktualisieren Sie den Spring Cloud-Dienst von Pipe.
...
### -Standort
Die Geo-Position der Ressource.
...
### -TraceAppInsightInstrumentationKey
Instrumentations Schlüssel für Ziel Anwendungs Insight
...
### -TraceEnabled
Gibt an, ob die Ablaufverfolgungsfunktion aktiviert werden soll
