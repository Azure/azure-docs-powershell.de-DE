...
### Beispiel 1: Abrufen der Deploymeng-App für die Frühlings Wolke nach Namen.
```powershell
...
Holen Sie sich die APP Deploymeng für die Frühlings Wolke nach Namen.

### Beispiel 2: Auflisten der gesamten Bereitstellung unter einer bestimmten app für die Frühlings Wolke
```powershell
...
Auflisten der gesamten Bereitstellung unter einer bestimmten app für die Frühlings Wolke
...
### -Version
Version der aufzulistenden Bereitstellungen
