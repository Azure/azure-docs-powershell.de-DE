...
## Beschreibung
Das Cmdlet **Remove-AzStreamAnalyticsInput** löscht eine Eingabe aus einem Datenstrom Analyse Auftrag in Azure asynchron.
...
Dieser Befehl entfernt die Eingabe EventStream aus StreamingJob.
...
### -Name
Gibt den Namen der zu entfernenden Azure-Stream-Analyse Eingabe an.
