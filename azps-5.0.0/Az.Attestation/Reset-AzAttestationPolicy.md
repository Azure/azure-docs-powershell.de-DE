...
Wenn der Bescheinigungs Anbieter *pshtest* für die Verwendung des isolierten Vertrauensmodells konfiguriert ist, setzen Sie die Richtlinie auf den Standardwert für Tee-Typ *SgxEnclave* , indem Sie eine signierte Richtlinie einschließen.
