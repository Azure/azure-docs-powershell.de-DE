...
## Beschreibung
Erstellen Sie registrierte Lieferavise für Peering-Objekte.

## Beispiele

### Abrufen von Peering und Erstellen eines registrierten ASN
```powershell
PS C:\>$peering = Get-AzPeering -ResourceGroupName $resourceGroupName -Name $name
PS C:\>$peering | New-AzPeeringRegisteredAsn -Name $asnName -Asn $asn
```

Rufen Sie das Peering ab, dem Sie einen registrierten ASN hinzufügen möchten. Übergeben Sie diese dann an die Unifiedgroup.

### Verwenden der Peering-Quell Codeerstellung zum Erstellen eines registrierten ASN-Codes
```powershell
