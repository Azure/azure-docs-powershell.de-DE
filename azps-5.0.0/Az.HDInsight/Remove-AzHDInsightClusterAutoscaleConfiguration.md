...
## Beschreibung
Das Cmdlet **Remove-AzHDInsightClusterAutoscaleConfiguration** entfernt die AutoScale-Konfiguration des HDInsight-Clusters.

## Beispiele

### Beispiel 1: Entfernen der AutoScale-Konfiguration des HDInsight-Clusters
```powershell
...
Dieser Befehl entfernt die AutoScale-Konfiguration des HDInsight-Clusters.
