...
## Beschreibung
Das Cmdlet " **Get-AzStackEdgeJob** " Ruft die aktiven Aufträge auf einem Stack-Edge-Gerät ab. Sie können den Parameter Name erwähnen, um Details zu einem bestimmten Job abzurufen.
