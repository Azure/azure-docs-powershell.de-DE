...
## Beschreibung
Mit dem Cmdlet **Get-AzStackEdgeDevice werden** die Informationen zu den verfügbaren Stack Edge-Geräten abgerufen. Sie können den Namen des Geräts zusammen mit dem Namen der Ressourcengruppe angeben, um die Informationen auf einem bestimmten Gerät abzurufen. 
...
### -Alert
Abrufen der Warnungen auf dem Stack Edge/Gateway-Gerät
