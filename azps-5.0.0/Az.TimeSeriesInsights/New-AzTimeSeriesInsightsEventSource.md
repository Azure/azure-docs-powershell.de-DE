...
### Beispiel 1: Erstellen einer eventhub-Ereignisquelle unter der angegebenen Umgebung
```powershell
...
Mit diesem Befehl wird eine eventhub-Ereignisquelle unter der angegebenen Umgebung erstellt.

### Beispiel 2: Erstellen einer iothub-Ereignisquelle unter der angegebenen Umgebung
```powershell
...
Mit diesem Befehl wird eine iothub-Ereignisquelle unter der angegebenen Umgebung erstellt.

## Parameter

### -ConsumerGroupName
Der Name der Consumer-Gruppe des Event/viele-Hubs, die die Partitionen enthält, aus denen Ereignisse gelesen werden.
...
### -KeyName
Der Name des SAS-Schlüssels, der dem Zeitreihen Insights-Dienst Zugriff auf den Event/viel-Hub gewährt.
...
### -ServiceBusNameSpace
Der Name des ServiceBus, der den Ereignis-Hub enthält.
...
### -SharedAccessKey
Der Wert der freigegebenen Zugriffstaste, die dem Zeitreihen Einblicke-Dienst Lesezugriff auf den Ereignis/viele-Hub gewährt.
