...
### Beispiel 1: Erstellen eines referenzdatensatzes für eine bestimmte Umgebung  
```powershell
...
Dieser Befehl erstellt einen Verweisdaten Satz für eine bestimmte Umgebung.

## Parameter

### -DataStringComparisonBehavior
Das Vergleichsverhalten des referenzdatensatzes kann mithilfe dieser Eigenschaft eingestellt werden.
Standardmäßig ist der Wert "Ordinal", was bedeutet, dass der Vergleich der Groß-/Kleinschreibung beim Verknüpfen von Referenzdaten mit Ereignissen oder beim Hinzufügen neuer Referenzdaten erfolgt.
Wenn "OrdinalIgnoreCase" gesetzt ist, wird der Vergleich der Groß-/Kleinschreibung verwendet.
...
### -KeyProperty
Die Liste der Schlüsseleigenschaften für den Verweisdaten Satz.
Informationen zum Erstellen finden Sie unter Abschnitt "Notizen" für Eigenschaften von keyProperty und Erstellen einer Hashtabelle.
...
### -Name
Der Name des referenzdatensatzes.
...
KeyProperty <IReferenceDataSetKeyProperty [] >: die Liste der Schlüsseleigenschaften für den Verweisdaten Satz.
