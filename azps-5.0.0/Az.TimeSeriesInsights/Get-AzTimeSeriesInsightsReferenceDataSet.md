...
### Beispiel 1: Auflisten aller Verweisdaten Sätze unter der angegebenen Umgebung
```powershell
...
Dieser Befehl listet alle Referenzdatensätze in der angegebenen Umgebung auf.

### Beispiel 2: Abrufen eines angegebenen Verweisdaten Satzes nach Name
```powershell
...
Dieser Befehl ruft einen angegebenen Verweisdaten Satz ab.

### Beispiel 3: Abrufen eines angegebenen Verweisdaten Satzes nach Objekt
```powershell
