...
## Beschreibung
Das Cmdlet **Add-AzLogProfile** erstellt ein Protokoll Profil.
...
Erstellt ein neues Aktivitätsprotokoll Profil. automatisch
...
Gültige Werte: führen Sie die folgenden Cmdlets aus, um die aktuelle Liste der Speicherorte abzurufen. Get-AzLocation | Auswählen von DisplayName
