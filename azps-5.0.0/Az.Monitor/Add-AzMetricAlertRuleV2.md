...
## Synopsis
Hinzufügen oder Aktualisieren einer metrischen, nicht klassischen v2-basierten Warnungsregel
...
Mit diesem Befehl wird eine metrische Warnungsregel für alle virtuellen Computer im Abonnement erstellt, die in eastus enthalten sind.

### Beispiel 3: Deaktivieren einer Metrik-Warnungsregel
```powershell
...
Wenn Sie eine komplexere Metrik-Warnungsregel erstellen möchten, die die Auswahl von Dimensionswerten oder mehrere Kriterien umfasst, können Sie die Hilfsprogramm [-Cmdlets New-AzMetricAlertRuleV2DimensionSelection](https://docs.microsoft.com/en-us/powershell/module/az.monitor/new-azmetricalertrulev2dimensionselection) und [New-AzMetricAlertRuleV2Criteria](https://docs.microsoft.com/en-us/powershell/module/az.monitor/new-azmetricalertrulev2criteria)verwenden.

Über den Satz von Cmdlets wird eine metrische Warnungsregel mit Bemaßungen erstellt.

## Parameter

### -ActionGroup
Die Gruppe ' Aktion ' für Regel
...
### -ActionGroupId
Die Gruppen-ID der Aktion für Regel
...
### -Beschreibung
Die Beschreibung der Metrik-Warnungsregel
...
### -DisableRule
Das Flag zum Deaktivieren der Regel (Status)
...
### -Häufigkeit
Die Auswertungs Häufigkeit für Regel
...
### -Name
Der Name der Metrik-Warnungsregel
...
### -Schweregrad
Der Schweregrad für die Metrik-Warnungsregel
...
### -TargetResourceId
Die Ziel Ressourcen-ID für Regel
...
### -TargetResourceRegion
Der Ziel Ressourcenbereich für Regel
...
### -TargetResourceType
Der Typ der Zielressource für Regel
