...
Aktualisieren des Bereichs "privater Link" mit dem Namen "scope_name" unter Ressourcengruppe "rg_name", um das Tag "Schlüssel: Wert" zu verwenden
...
Aktualisieren des Bereichs "privater Link" mit der Ressourcen-ID zum Verwenden des Tags "Schlüssel: Wert"
...
Aktualisieren des Bereichs "privater Link" mit dem Bereich "Eingabe privater Link", um das Tag "Schlüssel: Wert" zu verwenden
