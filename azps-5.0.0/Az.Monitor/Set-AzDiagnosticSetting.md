...
### Beispiel 5: Aktivieren einer Zeit Körnung und mehrerer Kategorien
```powershell
...
### Beispiel 6: Verwenden von Pipeline
```powershell
PS C:\>Get-AzDiagnosticSetting -ResourceId "Resource01" | Set-AzDiagnosticSetting -Enabled $True -Category Category1,Category2
```

Dieser Befehl verwendet die PowerShell-Pipeline, um eine Diagnose Einstellung (keine Änderung vorgenommen) festzulegen.
...
### -EnableMetrics
Der Wert, der angibt, ob die diagnostischen Metriken aktiviert oder deaktiviert werden sollen
...
Kennzeichnung, die besagt, dass der Export nach l.a. in einer ressourcenspezifischen Tabelle erfolgen muss, a.k.a. dedizierte oder feste Schematabelle, im Gegensatz zur **standardmäßigen** dynamischen Schematabelle namens **AzureDiagnostics**.

Dieses Argument ist nur wirksam, wenn das Argument **-Workspace-** Nr ebenfalls angegeben wird.
...
### -Arbeitsbereichs-Nr
Die Ressourcen-ID des Protokollanalyse Arbeitsbereichs zum Senden von Protokollen/Metriken an
