...
## Synopsis
Updates oder Angebote für den privaten Store.
...
## Beschreibung
Aktualisiert oder erstellt ein Angebot für den privaten Speicher, das unter MANDANTENBEREICH erstellt wurde.
...
Erstellt Angebot mit privaten + öffentlichen Plänen für privaten Store, die unter MANDANTENBEREICH erstellt wurden. 
...
Erstellt Angebot mit privaten Plänen nur für privaten Store, der unter Abonnement Bereich erstellt wurde. 
...
Updates bieten private + öffentliche Pläne für private Stores, die unter MANDANTENBEREICH erstellt wurden. ETag wird benötigt.
...
Updates bieten für privaten Store nur private Pläne, die unter Abonnementumfang erstellt wurden. ETag wird benötigt.
...
### -ETag
Azure Marketplace-privateStore-ETag-Angebot für Update
...
Erforderliche Azure Marketplace-privateStore-spezifische Plan-IDs-Einschränkung
