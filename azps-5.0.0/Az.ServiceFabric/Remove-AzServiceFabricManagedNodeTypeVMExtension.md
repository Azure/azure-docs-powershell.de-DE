...
## Beschreibung
Entfernen Sie die VM-Erweiterung vom Knotentyp nach Namen. Verwenden Sie [Get-AzServiceFabricManagedNodeType](./Get-AzServiceFabricManagedNodeType.md) , und schauen Sie sich die VmExtensions-Eigenschaft an, um die aktuelle Erweiterung des Knotentyps anzuzeigen.
...
Entfernen Sie die Erweiterung vom Knotentyp nach Namen.
...
Entfernen Sie die Erweiterung aus dem Knotentyp mit dem Namen mit Piping.
