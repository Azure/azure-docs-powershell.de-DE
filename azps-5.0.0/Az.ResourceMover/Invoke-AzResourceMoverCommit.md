...
### Beispiel 1: Überprüfen des dependecies vor dem Commit der Ressourcen
```powershell
...
Überprüfen Sie die dependecies vor dem Commit der Ressourcen.

### Beispiel 2: Commit der Gruppe von Ressourcen in der Move-Sammlung unter Verwendung von "MoveResource Name" als Eingabe
```powershell
...
Commit der Gruppe von Ressourcen in der Move-Sammlung unter Verwendung von "MoveResource Name" als Eingabe

### Beispiel 3: Commit der Gruppe von Ressourcen in der Move-Sammlung mit "SourceARMID" als Eingabe
```powershell
...
Commit der Gruppe von Ressourcen in der Move-Sammlung mit "SourceARMID" als Eingabe
