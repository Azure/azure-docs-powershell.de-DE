...
### Beispiel 1: Überprüfen Sie die dependecies vor dem Initiieren von Move für die Ressourcen.
```powershell
...
Überprüfen Sie die dependecies, bevor Sie Move für die Ressourcen initiieren.

### Beispiel 2: Initiieren der Bewegung für den Satz von Ressourcen in der Move-Sammlung unter Verwendung von "MoveResource Name" als Eingabe
```powershell
...
Initiieren Sie die Bewegung für die Gruppe von Ressourcen in der Move-Sammlung unter Verwendung von "MoveResource Name" als Eingabe.

### Beispiel 3: Initiieren der Bewegung für den Satz von Ressourcen in der Move-Sammlung mit "SourceARMID" als Eingabe
```powershell
...
Initiieren Sie die Bewegung für den Satz von Ressourcen in der Move-Sammlung mit "SourceARMID" als Eingabe.
