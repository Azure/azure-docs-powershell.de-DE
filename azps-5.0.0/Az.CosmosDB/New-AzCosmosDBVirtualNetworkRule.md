...
### -ID
Ressourcen-ID eines Subnets, beispielsweise:/Subscriptions/{SubscriptionId}/resourceGroups/{GroupName}/Providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}/Subnets/{subnetName}
...
Boolescher Wert, der angibt, ob eine Firewall-Regel erstellt werden soll, bevor das virtuelle Netzwerk den vnet-Dienstendpunkt aktiviert hat.
