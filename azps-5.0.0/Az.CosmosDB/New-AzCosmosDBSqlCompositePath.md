...
## Synopsis
Erstellt ein neues Objekt vom Typ PSCompositePath. Sie kann als Parameterwert für "AzCosmosDBSqlContainer" übergeben werden.
...
## Beschreibung
Das Objekt, das dem CompositePath der SQL-API entspricht.
