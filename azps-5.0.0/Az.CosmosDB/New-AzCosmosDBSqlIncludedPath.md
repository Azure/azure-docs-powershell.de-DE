...
## Synopsis
Erstellt ein neues Objekt vom Typ PSIncludedPath. Sie kann als Parameterwert für "AzCosmosDBSqlContainer" übergeben werden.
...
## Beschreibung
Das Objekt, das dem IncludedPath der SQL-API entspricht.
