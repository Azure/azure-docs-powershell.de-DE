...
## Synopsis
Ruft die CosmosDB MongoDB-Sammlung ab.
...
## Beschreibung
Das Cmdlet " **Get-AzCosmosDBMongoDBCollection** " Ruft die CosmosDB MongoDB-Sammlung ab.
...
Das Ressourcenobjekt enthält MongoIndexes, _rid, _ts _etag Eigenschaften.
...
In diesem Beispiel wird die ShardKey der abgerufenen Sammlung abgerufen.
