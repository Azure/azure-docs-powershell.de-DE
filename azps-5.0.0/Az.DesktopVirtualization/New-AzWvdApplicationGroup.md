...
### Beispiel 1: Erstellen einer virtuellen Windows-Desktop Anwendung mit Namen
```powershell
...
Mit diesem Befehl wird eine Windows Virtual Desktop-Anwendungsgruppe in einer Ressourcengruppe erstellt.

### Beispiel 2: Erstellen einer Windows-virtuellen Desktop Anwendung mit Namen
```powershell
PS C:\> New-AzWvdApplicationGroup -ResourceGroupName ResourceGroupName `
                            -Name ApplicationGroupName `
                            -Location 'eastus' `
...
Der Ressourcentyp von ApplicationGroup.
...
### -Beschreibung
Beschreibung von ApplicationGroup.
...
### -HostPoolArmPath
HostPool Path von ApplicationGroup.
