...
### Beispiel 1: Aktualisieren eines Windows Virtual Desktop-Worksapce nach Name
```powershell
...
Dieser Befehl aktualisiert einen virtuellen Windows-Desktop Arbeitsbereich in einer Ressourcengruppe.

## Parameter

### -ApplicationGroupReference
Liste der Anwendungs Gruppenlinks
