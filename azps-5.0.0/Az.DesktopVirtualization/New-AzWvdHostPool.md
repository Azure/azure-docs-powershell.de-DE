...
### Beispiel 1: Erstellen einer virtuellen Windows-Desktop-HostPool nach Namen
```powershell
...
### -Ablaufzeit
Ablaufzeit des Registrierungs Tokens.
...
### -MaxSessionLimit
Die maximale Sitzungs Grenze von HostPool.
...
Der Typ des bevorzugten Anwendungsgruppen Typs, standardmäßig für die Desktop Anwendungsgruppe
...
Die Base64-codierte Zeichenfolge des Registrierungs Tokens.
...
### -SsoContext
Pfad zu keyvault mit ssoContext Secret
...
### -VMTemplate
VM-Vorlage für sessionhosts-Konfiguration in hostpool.
