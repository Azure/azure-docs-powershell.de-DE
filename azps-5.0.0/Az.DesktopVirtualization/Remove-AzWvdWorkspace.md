...
### Beispiel 1: Löschen eines virtuellen Windows-Desktop-Worksapce nach Name
```powershell
PS C:\> Remove-AzWvdWorksapce -ResourceGroupName ResourceGroupName -Name WorkspaceName
```

Dieser Befehl löscht einen virtuellen Windows-Desktop Arbeitsbereich in einer Ressourcengruppe.
