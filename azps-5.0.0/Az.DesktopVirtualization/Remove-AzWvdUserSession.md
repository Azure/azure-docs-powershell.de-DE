...
### Beispiel 1: Löschen eines virtuellen Windows-Desktop-UserSession nach Name
```powershell
...
Dieser Befehl löscht einen virtuellen Windows-Desktop-UserSession in einem Sitzungs Host.
...
### -Force
Flag erzwingen, um sich bei userSession anzumelden.
