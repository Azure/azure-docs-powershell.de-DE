...
### Beispiel 1: Abrufen einer Windows-virtuellen Desktop Anwendung nach Namen
```powershell
...
Dieser Befehl ruft eine virtuelle Windows-Desktop Anwendung in einer Applicaton-Gruppe ab.

### Beispiel 2: Auflisten von Windows-virtuellen Desktop Anwendungen
```powershell
...
Dieser Befehl listet die virtuellen Windows-Desktop Anwendungen in einer Applicaton-Gruppe auf.
