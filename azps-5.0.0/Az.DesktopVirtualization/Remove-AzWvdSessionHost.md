...
### Beispiel 1: Löschen eines virtuellen Windows-Desktop-SessionHost nach Name
```powershell
PS C:\> Remove-AzWvdSessionHost -ResourceGroupName ResourceGroupName -HostPoolName HostPoolName -Name SessionHostName
```

Dieser Befehl löscht einen virtuellen Windows-Desktop-SessionHost in einem Host Pool.
...
### -Force
Flag erzwingen, um sessionHost Löschung zu erzwingen, auch wenn userSession vorhanden ist.
