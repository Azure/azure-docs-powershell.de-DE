...
### Beispiel 1: Trennen einer Windows Virtual Desktop-UserSession nach Namen
```powershell
PS C:\> Disconnect-AzWvdUserSession -ResourceGroupName ResourceGroupName -HostPoolName HostPoolName -SessionHostName SessionHostName -Id 2
```

Dieser Befehl trennt die Verbindung mit einem Windows Virtual Desktop-UserSession in einem Sitzungs Host.
