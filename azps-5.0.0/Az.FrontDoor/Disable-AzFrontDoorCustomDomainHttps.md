...
## Beschreibung
Das **AzFrontDoorCustomDomainHttps deaktiviert** HTTPS für eine benutzerdefinierte Domäne.

## Beispiele

### Beispiel 1: Deaktivieren Sie HTTPS für eine benutzerdefinierte Domäne mit FrontDoorName und ResourceGroupName.
```powershell
...
Deaktivieren Sie HTTPS für eine benutzerdefinierte Domäne "frontendpointname1-Custom-XYZ" mit FrontDoorName als "frontdoor1" und ResourceGroupName als "resourcegroup1".

### Beispiel 2: Deaktivieren Sie HTTPS für eine benutzerdefinierte Domäne mit dem PSFrontendEndpoint-Objekt.
```powershell
...
Deaktivieren Sie HTTPS für eine benutzerdefinierte Domäne mit dem PSFrontendEndpoint-Objekt.

### Beispiel 3: Deaktivieren Sie HTTPS für eine benutzerdefinierte Domäne mit der Resourcen-Funktion.
```powershell
...
Deaktivieren Sie HTTPS für eine benutzerdefinierte Domäne "frontendpointname1-Custom-XYZ" mit der Option "$ResourceId".
...
### -Resourcen-Nr
Ressourcen-ID des Front-Door-Endpunkts zum Deaktivieren von HTTPS
