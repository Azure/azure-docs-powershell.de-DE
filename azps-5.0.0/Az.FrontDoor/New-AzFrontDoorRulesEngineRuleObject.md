...
Verwenden Sie das Cmdlet "New-AzFrontDoorRulesEngineActionObject", um ein PSRulesEngineAction-Objekt zu erstellen, das an den "-action"-Parameter übergeben wird.
Verwenden Sie das Cmdlet "New-AzFrontDoorRulesEngineMatchConditionObject", um ein PSRulesEngineMatchCondition-Objekt zu erstellen, das an den "-MatchCondition"-Parameter übergeben wird.
...
Erstellen Sie ein neues PSRulesEngineRule-Objekt, und demonstrieren Sie, wie die unter Felder angezeigt werden.
...
Erwarten Sie die Ausgabe, wenn Sie einen ungültigen Prioritätswert übergeben.

## Parameter

### – Aktion
Aktionen, die für die Anforderung und die Antwort auszuführen sind, wenn alle Übereinstimmungsbedingungen erfüllt sind.
...
### -MatchCondition
Eine Liste der Übereinstimmungsbedingungen, die erfüllt werden müssen, damit die Aktionen dieser Regel ausgeführt werden können. Wenn keine Übereinstimmungsbedingungen erfüllt sind, werden die Aktionen immer ausgeführt.
...
Diese Regel ist eine Übereinstimmung, wenn das Regelmodul die restlichen Regeln weiterhin ausführt oder beendet.
Mögliche Werte sind Continue und Stop.
Wenn diese nicht vorhanden ist, wird standardmäßig fortgesetzt.
...
### -Name
Ein Name, der auf diese bestimmte Regel verweisen soll.
...
### Microsoft. Azure. Commands. Haustür. Models. PSRulesEngineRule
