...
Tolles ein neues PSRulesEngineMatchCondition-Objekt.
...
### -Matchwert
Vergleichen Sie die Werte mit der Übereinstimmung.
Der Operator gilt für jeden Wert hier mit oder Semantik.
Wenn einer der Variablen mit dem angegebenen Operator übereinstimmt, wird diese übereinstimmungsbedingung als Übereinstimmung angesehen.
...
### -NegateCondition
Beschreibt, ob es sich um eine Negations Bedingung handelt.
...
Mögliche Werte sind any, IPMatch, geomatch, EQUAL, Contains, LessThan, GreaterThan, LessThanOrEqual, GreaterThanOrEqual, beginntmitder, EndsWith.
...
### -Auswahl
Der Name des Selektors in RequestHeader oder RequestBody, der zugeordnet werden soll.
...
### -Transform
Liste der Transformationen, die vor dem Abgleich angewendet werden. Mögliche einzelne Transformationswerte sind Kleinbuchstaben, Großbuchstaben, trimmen, UrlDecode, UrlEncode, RemoveNulls.
...
### Microsoft. Azure. Commands. Haustür. Models. PSRulesEngineMatchCondition
