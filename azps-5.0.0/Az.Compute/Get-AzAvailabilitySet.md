...
Dieser Befehl ruft den Verfügbarkeits Satz mit dem Namen AvailabilitySet03 in der Ressourcengruppe mit dem Namen ResourceGroup11 ab.
...
### Beispiel 3: Abrufen aller Verfügbarkeits Sätze mit Filterung
```
...
Dieser Befehl ruft alle Verfügbarkeits Sätze in der Ressourcengruppe mit dem Namen "ResourceGroup11" ab, die mit "AvailabilitySet0" beginnen.

### Beispiel 4: Abrufen aller Verfügbarkeits Sätze mit dem Namen ab AvailabilitySet0
```
...
Dieser Befehl ruft alle Verfügbarkeits Sätze ab, die mit "AvailabilitySet0" beginnen.
