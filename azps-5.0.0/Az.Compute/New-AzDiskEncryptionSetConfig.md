...
Erstellt den Festplatten-Verschlüsselungs Satz mit dem angegebenen aktiven Schlüssel im Schlüsselspeicher.
...
### -EncryptionType
Verwenden Sie diese Einstellung, um den Verschlüsselungstyp des Datenträger Verschlüsselungs Satzes festzulegen. Die verfügbaren Werte lauten: "EncryptionAtRestWithPlatformKey", "EncryptionAtRestWithCustomerKey".
...
### -IdentityType
Der Typ der verwalteten Identität, die von der DiskEncryptionSet verwendet wird. Nur SystemAssigned wird unterstützt.
...
### -KeyUrl
URL, der auf den aktiven Schlüssel in keyvault zeigt
...
### -SourceVaultId
Die Ressourcen-ID des keyvaults mit dem aktiven Schlüssel.
