...
Dieser Befehl unterbricht den automatischen Reparaturdienst auf der VMSS "vmss1" in der Ressourcengruppe "RG".
...
Dieser Befehl setzt den automatischen Reparaturdienst auf der VMSS "vmss1" in der Ressourcengruppe "RG" fort.

## Parameter

### – Aktion
Die auszuführende Aktion.  Mögliche Werte sind: Resume, Suspend.
...
### -Inputobject
Das lokale Objekt des Skalierungs Satzes der virtuellen Maschine.
...
### -VMScaleSetName
Der Name des Skalierungs Satzes für den virtuellen Computer.
