...
### -DiskMBpsReadOnly
Der Gesamtdurchsatz (Mbit/s), der für alle VMs zulässig ist, wenn der freigegebene Datenträger als ReadOnly bereitgestellt wird. Mbit/s bedeutet, dass Millionen von Bytes pro Sekunde-MB hier die ISO-Notation von Potenzen von 10 verwenden.
...
### -MaxSharesCount
Die maximale Anzahl von VMS, die gleichzeitig an den Datenträger angefügt werden können. Der Wert größer als 1 gibt einen Datenträger an, der gleichzeitig auf mehreren VMS bereitgestellt werden kann.
