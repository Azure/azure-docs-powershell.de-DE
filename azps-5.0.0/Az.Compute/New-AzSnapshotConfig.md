...
## Beschreibung
Mit dem Cmdlet **New-AzSnapshotConfig** wird ein konfigurierbares Snapshot-Objekt erstellt.
...
Der erste Befehl erstellt ein lokales leeres snapshotobjekt mit der Größe 5GB in Standard_LRS Speicher Kontotyp.  Darüber hinaus wird der Windows-Betriebssystemtyp festgelegt und die Verschlüsselungseinstellungen aktiviert.
Der zweite und der dritte Befehl legen die Einstellungen für den Datenträgerverschlüsselungsschlüssel und den Schlüssel Verschlüsselungsschlüssel für das Snapshot-Objekt fest.
...
Erstellt ein konfigurierbares Snapshot-Objekt. automatisch
...
### -DiskEncryptionKey
Gibt das Datenträgerverschlüsselungsschlüssel Objekt für einen Schnappschuss an.
...
### -Imagereference
Gibt den Bildverweis auf einen Schnappschuss an.
...
### -Inkrementell
Gibt einen inkrementellen Snapshot an. Inkrementelle Schnappschüsse auf demselben Datenträger belegen weniger Speicherplatz als vollständige Snapshots und können unterschieden werden.
...
### -KeyEncryptionKey
Gibt den Schlüssel Verschlüsselungsschlüssel für einen Schnappschuss an.
