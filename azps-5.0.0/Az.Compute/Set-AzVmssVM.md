...
## Beschreibung
Das Cmdlet " **Satz-AzVmssVM** " ändert den Zustand einer Virtual Machine Scale Sets (VMSS)-Instanz.

## Beispiele

### Beispiel 1

Ändert den Zustand einer VMSS-Instanz. automatisch
...
### -PerformMaintenance
Gibt an, dass dieses Cmdlet die Wartung auf einem virtuellen Computer im VMSS ausführt.
...
Gibt an, dass dieses Cmdlet einen virtuellen Computer im VMSS erneut bereitstellt.
...
### -SimulateEviction
Gibt an, dass dieses Cmdlet die Entfernung von Spot Virtual Machine in einem VM-Skalierungs Satz simuliert.
Die Räumung erfolgt innerhalb von 30 Minuten nach dem Aufruf der API.
