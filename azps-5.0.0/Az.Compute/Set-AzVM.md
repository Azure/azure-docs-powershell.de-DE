...
## Beschreibung
Das Cmdlet " **Satz-AzVM** " kennzeichnet einen virtuellen Computer als generalisiert.
...
### -Erneute Anwendung
So wenden Sie den virtuellen Computer erneut an.
...
### -SimulateEviction
Gibt an, dass dieses Cmdlet die Entfernung von Spot Virtual Machine simuliert.
