...
## Beschreibung
Das Cmdlet " **Get-AzVM** " Ruft die Modellansicht oder die Instanzen Ansicht eines virtuellen Azure-Computers ab.
...
Geben Sie den *Status* -Parameter an, um die Instanzen Ansicht eines virtuellen Computers anstelle der Modellansicht abzurufen, die standardmäßig ist.
...
### Beispiel 6: Abrufen aller virtuellen Computer mithilfe der Filterung
```
