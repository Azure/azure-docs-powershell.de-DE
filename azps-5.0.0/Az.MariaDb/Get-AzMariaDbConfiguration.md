...
ms.locfileid: "94179117"
---
# <span data-ttu-id="10783-101">Get-AzMariaDbConfiguration</span><span class="sxs-lookup"><span data-stu-id="10783-101">Get-AzMariaDbConfiguration</span></span>

## <span data-ttu-id="10783-102">Synopsis</span><span class="sxs-lookup"><span data-stu-id="10783-102">SYNOPSIS</span></span>
<span data-ttu-id="10783-103">Ruft Informationen zu einer Serverkonfiguration ab.</span><span class="sxs-lookup"><span data-stu-id="10783-103">Gets information about a configuration of server.</span></span>

## <span data-ttu-id="10783-104">Syntax</span><span class="sxs-lookup"><span data-stu-id="10783-104">SYNTAX</span></span>

### <span data-ttu-id="10783-105">Liste (Standard)</span><span class="sxs-lookup"><span data-stu-id="10783-105">List (Default)</span></span>
```
Get-AzMariaDbConfiguration -ResourceGroupName <String> -ServerName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### <span data-ttu-id="10783-106">Erhalten</span><span class="sxs-lookup"><span data-stu-id="10783-106">Get</span></span>
```
Get-AzMariaDbConfiguration -Name <String> -ResourceGroupName <String> -ServerName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### <span data-ttu-id="10783-107">GetViaIdentity</span><span class="sxs-lookup"><span data-stu-id="10783-107">GetViaIdentity</span></span>
```
Get-AzMariaDbConfiguration -InputObject <IMariaDbIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

## <span data-ttu-id="10783-108">Beschreibung</span><span class="sxs-lookup"><span data-stu-id="10783-108">DESCRIPTION</span></span>
<span data-ttu-id="10783-109">Ruft Informationen zu einer Serverkonfiguration ab.</span><span class="sxs-lookup"><span data-stu-id="10783-109">Gets information about a configuration of server.</span></span>

## <span data-ttu-id="10783-110">Beispiele</span><span class="sxs-lookup"><span data-stu-id="10783-110">EXAMPLES</span></span>

### <span data-ttu-id="10783-111">Beispiel 1: Auflisten der gesamten Konfiguration unter einem MariaDB</span><span class="sxs-lookup"><span data-stu-id="10783-111">Example 1: List all configuration under a MariaDB</span></span>
```powershell
...
<span data-ttu-id="10783-112">Dieser Befehl listet alle Konfigurationen unter einem MariaDB auf.</span><span class="sxs-lookup"><span data-stu-id="10783-112">This command lists all configuration under a MariaDB.</span></span>

### <span data-ttu-id="10783-113">Beispiel 2: Abrufen einer Konfiguration von MariaDB</span><span class="sxs-lookup"><span data-stu-id="10783-113">Example 2: Get a configuration of MariaDB</span></span>
```powershell
...
<span data-ttu-id="10783-114">Dieser Befehl ruft eine Konfiguration von MariaDB ab.</span><span class="sxs-lookup"><span data-stu-id="10783-114">This command gets a configuration of MariaDB.</span></span>

## <span data-ttu-id="10783-115">Parameter</span><span class="sxs-lookup"><span data-stu-id="10783-115">PARAMETERS</span></span>

### <span data-ttu-id="10783-116">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="10783-116">-DefaultProfile</span></span>
<span data-ttu-id="10783-117">Die für die Kommunikation mit Azure verwendeten Anmeldeinformationen, das Konto, den Mandanten und das Abonnement.</span><span class="sxs-lookup"><span data-stu-id="10783-117">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="10783-118">-Inputobject</span><span class="sxs-lookup"><span data-stu-id="10783-118">-InputObject</span></span>
<span data-ttu-id="10783-119">Zu Erstell-Parameter des Parameters, lesen Sie den Abschnitt "Notizen" für Inputobject-Eigenschaften, und erstellen Sie eine Hashtabelle.</span><span class="sxs-lookup"><span data-stu-id="10783-119">Identity Parameter To construct, see NOTES section for INPUTOBJECT properties and create a hash table.</span></span>
...
### <span data-ttu-id="10783-120">-Name</span><span class="sxs-lookup"><span data-stu-id="10783-120">-Name</span></span>
<span data-ttu-id="10783-121">Der Name der Serverkonfiguration.</span><span class="sxs-lookup"><span data-stu-id="10783-121">The name of the server configuration.</span></span>
...
### <span data-ttu-id="10783-122">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="10783-122">-ResourceGroupName</span></span>
<span data-ttu-id="10783-123">Der Name der Ressourcengruppe, die die Ressource enthält.</span><span class="sxs-lookup"><span data-stu-id="10783-123">The name of the resource group that contains the resource.</span></span>
<span data-ttu-id="10783-124">Sie können diesen Wert über die Azure Resource Manager-API oder das Portal abrufen.</span><span class="sxs-lookup"><span data-stu-id="10783-124">You can obtain this value from the Azure Resource Manager API or the portal.</span></span>
...
### <span data-ttu-id="10783-125">-Servername</span><span class="sxs-lookup"><span data-stu-id="10783-125">-ServerName</span></span>
<span data-ttu-id="10783-126">Der Name des Servers.</span><span class="sxs-lookup"><span data-stu-id="10783-126">The name of the server.</span></span>
...
### <span data-ttu-id="10783-127">-Abonnement-Nr</span><span class="sxs-lookup"><span data-stu-id="10783-127">-SubscriptionId</span></span>
<span data-ttu-id="10783-128">Die Abonnement-ID, die ein Azure-Abonnement bezeichnet.</span><span class="sxs-lookup"><span data-stu-id="10783-128">The subscription ID that identifies an Azure subscription.</span></span>
...
### <span data-ttu-id="10783-129">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="10783-129">CommonParameters</span></span>
<span data-ttu-id="10783-130">Dieses Cmdlet unterstützt die allgemeinen Parameter:-Debug,-Fehler Aktion,-ErrorVariable,-InformationVariable,-Variable,-Puffer,-PipelineVariable,-Verbose,-Warning-Aktion und-WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="10783-130">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="10783-131">Weitere Informationen finden Sie unter [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span><span class="sxs-lookup"><span data-stu-id="10783-131">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="10783-132">Eingaben</span><span class="sxs-lookup"><span data-stu-id="10783-132">INPUTS</span></span>

### <span data-ttu-id="10783-133">Microsoft. Azure. PowerShell. Cmdlets. MariaDb. Models. IMariaDbIdentity</span><span class="sxs-lookup"><span data-stu-id="10783-133">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.IMariaDbIdentity</span></span>

## <span data-ttu-id="10783-134">Ausgaben</span><span class="sxs-lookup"><span data-stu-id="10783-134">OUTPUTS</span></span>

### <span data-ttu-id="10783-135">Microsoft. Azure. PowerShell. Cmdlets. MariaDb. Models. Api20180601Preview. IConfiguration</span><span class="sxs-lookup"><span data-stu-id="10783-135">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.Api20180601Preview.IConfiguration</span></span>

## <span data-ttu-id="10783-136">Notizen</span><span class="sxs-lookup"><span data-stu-id="10783-136">NOTES</span></span>

<span data-ttu-id="10783-137">Aliase</span><span class="sxs-lookup"><span data-stu-id="10783-137">ALIASES</span></span>

<span data-ttu-id="10783-138">komplexe Parameter Eigenschaften</span><span class="sxs-lookup"><span data-stu-id="10783-138">COMPLEX PARAMETER PROPERTIES</span></span>

<span data-ttu-id="10783-139">Wenn Sie die unten beschriebenen Parameter erstellen möchten, erstellen Sie eine Hashtabelle mit den entsprechenden Eigenschaften.</span><span class="sxs-lookup"><span data-stu-id="10783-139">To create the parameters described below, construct a hash table containing the appropriate properties.</span></span> <span data-ttu-id="10783-140">Wenn Sie Informationen zu Hashtabellen erhalten, führen Sie Get-Help about_Hash_Tables aus.</span><span class="sxs-lookup"><span data-stu-id="10783-140">For information on hash tables, run Get-Help about_Hash_Tables.</span></span>


<span data-ttu-id="10783-141">Inputobject <IMariaDbIdentity> : Identity-Parameter</span><span class="sxs-lookup"><span data-stu-id="10783-141">INPUTOBJECT <IMariaDbIdentity>: Identity Parameter</span></span>
  - <span data-ttu-id="10783-142">`[ConfigurationName <String>]`: Der Name der Serverkonfiguration.</span><span class="sxs-lookup"><span data-stu-id="10783-142">`[ConfigurationName <String>]`: The name of the server configuration.</span></span>
  - <span data-ttu-id="10783-143">`[DatabaseName <String>]`: Der Name der Datenbank.</span><span class="sxs-lookup"><span data-stu-id="10783-143">`[DatabaseName <String>]`: The name of the database.</span></span>
  - <span data-ttu-id="10783-144">`[FirewallRuleName <String>]`: Der Name der Server Firewall-Regel.</span><span class="sxs-lookup"><span data-stu-id="10783-144">`[FirewallRuleName <String>]`: The name of the server firewall rule.</span></span>
  - <span data-ttu-id="10783-145">`[Id <String>]`: Ressourcen Identitäts Pfad</span><span class="sxs-lookup"><span data-stu-id="10783-145">`[Id <String>]`: Resource identity path</span></span>
  - <span data-ttu-id="10783-146">`[LocationName <String>]`: Der Name des Standorts.</span><span class="sxs-lookup"><span data-stu-id="10783-146">`[LocationName <String>]`: The name of the location.</span></span>
  - <span data-ttu-id="10783-147">`[ResourceGroupName <String>]`: Der Name der Ressourcengruppe, die die Ressource enthält.</span><span class="sxs-lookup"><span data-stu-id="10783-147">`[ResourceGroupName <String>]`: The name of the resource group that contains the resource.</span></span> <span data-ttu-id="10783-148">Sie können diesen Wert über die Azure Resource Manager-API oder das Portal abrufen.</span><span class="sxs-lookup"><span data-stu-id="10783-148">You can obtain this value from the Azure Resource Manager API or the portal.</span></span>
  - <span data-ttu-id="10783-149">`[SecurityAlertPolicyName <SecurityAlertPolicyName?>]`: Der Name der Sicherheits Warnungs Richtlinie.</span><span class="sxs-lookup"><span data-stu-id="10783-149">`[SecurityAlertPolicyName <SecurityAlertPolicyName?>]`: The name of the security alert policy.</span></span>
  - <span data-ttu-id="10783-150">`[ServerName <String>]`: Der Name des Servers.</span><span class="sxs-lookup"><span data-stu-id="10783-150">`[ServerName <String>]`: The name of the server.</span></span>
  - <span data-ttu-id="10783-151">`[SubscriptionId <String>]`: Die Abonnement-ID, die ein Azure-Abonnement bezeichnet.</span><span class="sxs-lookup"><span data-stu-id="10783-151">`[SubscriptionId <String>]`: The subscription ID that identifies an Azure subscription.</span></span>
  - <span data-ttu-id="10783-152">`[VirtualNetworkRuleName <String>]`: Der Name der Regel für das virtuelle Netzwerk.</span><span class="sxs-lookup"><span data-stu-id="10783-152">`[VirtualNetworkRuleName <String>]`: The name of the virtual network rule.</span></span>

## <span data-ttu-id="10783-153">Verwandte Links</span><span class="sxs-lookup"><span data-stu-id="10783-153">RELATED LINKS</span></span>
