...
### Beispiel 1: Auflisten aller MariaDB unter Abonnements
```powershell
...
Dieser Befehl listet alle MariaDB unter Abonnements auf.
...
Dieser Befehl listet alle MariaDB unter einer Ressourcengruppe auf.

### Beispiel 3: Abrufen eines MariaDB
```powershell
