...
Verwenden Sie stattdessen Update-AzMariaDbServer, wenn Sie AdministratorLoginPassword, SKU usw. aktualisieren möchten.
...
### Beispiel 1: Aktualisieren der MariaDB-Konfiguration
```powershell
