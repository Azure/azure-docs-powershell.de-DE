...
## Synopsis
Löscht einen HDInsight-Cluster aus einem Abonnement.
...
Das Cmdlet **Remove-AzureHDInsightCluster** löscht den angegebenen HDInsight-Dienst Cluster aus einem Abonnement.
...
### Beispiel 1: Entfernen eines Clusters
```
PS C:\>Remove-AzureHDInsightCluster -Name "HDICluster"
```

Dieser Befehl löscht den HDInsight-Cluster mit dem Namen HDICluster.
...
### -Name
Gibt den Namen des zu entfernenden HDInsight-Clusters an.
...
### -Abonnement
Gibt das Abonnementkonto an, das den zu entfernenden HDInsight-Cluster enthält.
