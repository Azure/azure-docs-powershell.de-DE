...
## Synopsis
Ruft Informationen zu den verfügbaren Erweiterungen für gehostete Dienste ab.
...
## Beschreibung
Das Cmdlet " **Get-AzureServiceAvailableExtension** " Ruft Informationen zu den neuesten verfügbaren Erweiterungen für gehostete Dienste ab.

## Beispiele

### Beispiel 1: Abrufen verfügbarer Erweiterungen
```
...
Dieser Befehl ruft alle verfügbaren Erweiterungen ab.

### Beispiel 2: Abrufen von Erweiterungen in einem angegebenen Namespace
```
...
Dieser Befehl ruft die Erweiterungen mit einem angegebenen Namen in einem angegebenen Namespace ab.

### Beispiel 3: Abrufen einer bestimmten Version einer Erweiterung
```
...
Dieser Befehl ruft Informationen zu einer bestimmten Version einer Erweiterung ab.

## Parameter

### -Allversions
Gibt an, dass dieses Cmdlet alle Versionen einer Erweiterung abruft.
