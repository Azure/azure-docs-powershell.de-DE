...
## Synopsis
Fügt eine Cloud-Diensterweiterung zu einer Bereitstellung hinzu.
...
## Beschreibung
Das Cmdlet " **Satz-AzureServiceExtension** " fügt eine Cloud-Diensterweiterung zu einer Bereitstellung hinzu.

## Beispiele

### Beispiel 1: Hinzufügen eines Cloud-Diensts zu einer Bereitstellung
```
...
Dieser Befehl fügt einen clouddienst zu einer Bereitstellung hinzu.

### Beispiel 2: Hinzufügen eines Cloud-Diensts zu einer Bereitstellung für eine bestimmte Rolle
```
...
Dieser Befehl fügt einen clouddienst zu einer Bereitstellung für eine bestimmte Rolle hinzu.
...
### -ThumbprintAlgorithm
Gibt den Hashalgorithmus für den Fingerabdruck an, der mit dem Fingerabdruck verwendet wird, um das Zertifikat zu identifizieren.
