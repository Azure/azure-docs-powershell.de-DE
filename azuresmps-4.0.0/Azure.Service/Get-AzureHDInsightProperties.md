...
## Synopsis
Ruft Eigenschaften ab, die für einen HDInsight-Dienst spezifisch sind.
...
Das Cmdlet " **Get-AzureHDInsightProperties** " Ruft Eigenschaften ab, die für einen Azure HDInsight-Dienst spezifisch sind, beispielsweise eine Liste der verfügbaren Azure-Bereiche, HDInsight-Cluster Versionen und verfügbarer Rechenkapazität.

## Beispiele

### Beispiel 1: Abrufen von HDInsight-Eigenschaften für ein Abonnement
```
PS C:\>$SubName = Get-AzureSubscription -Current | %{ $_.SubscriptionName }
PS C:\> Get-AzureHDInsightProperties -Subscription $SubName
```

Der erste Befehl ruft den Namen des aktuellen Azure-Abonnements ab und speichert ihn dann in der $SubName-Variablen.

Der zweite Befehl ruft die HDInsight-Eigenschaften für das Abonnement in $SubName ab.
...
### -Standorte
Gibt an, dass dieses Cmdlet die Liste der Azure-Bereiche abruft, in denen der HDInsight-Dienst verfügbar ist.
...
### -Abonnement
Gibt das Abonnement an, das die HDInsight-Eigenschaften enthält, die abgerufen werden sollen.
...
### -Versionen
Gibt an, dass dieses Cmdlet die Liste der HDInsight-Cluster Versionen abruft, die im Dienst für ein Abonnement zur Verfügung stehen.
