...
## Synopsis
Aktualisiert eine Azure Storage Access-Anmeldeinformationen.
...
## Beschreibung
Das Cmdlet " **Satz-AzureStorSimpleStorageAccountCredential** " aktualisiert eine vorhandene Azure Storage Access-Anmeldeinformationen für die Verwendung durch StorSimple OneSDK-Cmdlets.
Weitere Informationen dazu, wie StorSimple-Cmdlets mit Speicherkonten funktionieren, finden Sie im Hilfethema zum New-AzureStorSimpleStorageAccountCredential-Cmdlet.

## Beispiele

### Beispiel 1: Ändern von Anmeldeinformationen
```
...
Mit diesem Befehl werden die Speicherkonto Anmeldeinformationen mit dem Namen ContosoStorage01 so geändert, dass SSL nicht mehr erforderlich ist.
...
Dieses Cmdlet gibt ein **StorageAccountCredentialResponse** -Objekt zurück, wenn Sie den *WaitForComplete* -Parameter angeben.
