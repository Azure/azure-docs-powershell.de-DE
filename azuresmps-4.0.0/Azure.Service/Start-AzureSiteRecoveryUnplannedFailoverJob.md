...
## Beschreibung
Mit dem Cmdlet **Start-AzureSiteRecoveryUnplannedFailoverJob** wird das ungeplante Failover einer Azure Site Recovery Protection-Entität oder eines Wiederherstellungsplans gestartet.
Mit dem Cmdlet **Get-AzureSiteRecoveryJob** können Sie überprüfen, ob der Auftrag erfolgreich ist.

## Beispiele

### Beispiel 1: Starten eines ungeplanten Failover-Auftrags
```
...
Der erste Befehl ruft einen geschützten Container mit dem Cmdlet **Get-AzureSiteRecoveryProtectionContainer** ab und speichert ihn dann in der $ProtectionContainer-Variablen.
...
Der letzte Befehl startet das Failover für die geschützten Entitäten, die in $ProtectionEntity gespeichert sind, und gibt die Richtung des Failovers an.
...
Gibt an, dass die Aktion quellseitige Aktionen ausführen kann.
...
Gibt an, dass Quellwebsite Vorgänge ausgeführt werden können.
...
### -Primary
Gibt an, dass primäre Websiteaktionen erforderlich sind.
...
[Anfang-AzureSiteRecoveryTestFailoverJob](./Start-AzureSiteRecoveryTestFailoverJob.md)
