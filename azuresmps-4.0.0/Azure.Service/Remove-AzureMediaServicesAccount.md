...
## Synopsis
Entfernt das angegebene Azure Media Services-Konto.
...
Das Cmdlet **Remove-AzureMediaServicesAccount** entfernt ein Media Services-Konto.

## Beispiele

### Beispiel 1: Löschen eines Media Services-Kontos
```
...
### -Force
Wenn der Schalter *Force* angegeben wird, wird der Löschvorgang nicht bestätigt.
...
[Neu – AzureMediaServicesAccount](./New-AzureMediaServicesAccount.md)
