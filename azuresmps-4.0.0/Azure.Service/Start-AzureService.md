...
## Synopsis
Startet den angegebenen gehosteten Dienst in Windows Azure.
...
Das Cmdlet **Start-AzureService** startet den angegebenen gehosteten Dienst in Windows Azure, wenn sich der Dienst im Zustand Stopped befindet.
Beachten Sie, dass das Cmdlet **Publish-AzureServiceProject** automatisch versucht, den Dienst zu starten.
...
### -ServiceName
Gibt den Namen des gehosteten Diensts an, der gestartet werden soll.
Wenn kein Name angegeben ist, startet das Cmdlet den aktuellen gehosteten Dienst.
...
### -Slot
Gibt den Bereitstellungs Steckplatz an, in dem der Dienst gestartet werden soll, entweder Staging oder Production.
