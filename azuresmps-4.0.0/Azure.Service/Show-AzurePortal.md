...
## Synopsis
Zeigen Sie das Azure-Verwaltungs Portal an.
...
Das Cmdlet **Show-AzurePortal** zeigt das Azure-Verwaltungs Portal an.
...
In diesem Beispiel wird ein Browser im Azure-Portal geöffnet, in dem Informationen zu einer Website mit dem Namen "Meine Website" angezeigt werden.
...
### -Realm
Gibt die Organisations-ID an, die für die Verbundauthentifizierung verwendet werden soll, wenn das Azure-Portal angezeigt wird.
