...
## Synopsis
Entfernt eine vorhandene Add-on-Instanz.
...
Entfernt eine vorhandene Add-on-Instanz aus dem aktuellen Abonnement.
...
In diesem Beispiel wird ein Add-on namens myaddon aus dem aktuellen Abonnement entfernt.

## Parameter

### -Name
Gibt den Namen der Add-on-Instanz an, die entfernt werden soll.
