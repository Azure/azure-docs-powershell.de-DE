...
## Beschreibung
Mit dem Cmdlet " **Start-AzureSiteRecoveryCommitFailoverJob** " wird der Commit-Failoverprozess für ein Azure Site Recovery-Objekt nach einem Failover-Vorgang gestartet.

## Beispiele

### Beispiel 1: Starten eines Commit-Failover-Auftrags
```
...
Der erste Befehl ruft alle geschützten Container für das aktuelle Azure Site Recovery Vault mit dem Cmdlet **Get-AzureSiteRecoveryProtectionContainer** ab und speichert die Ergebnisse dann in der $Container Variablen.
...
Mit dem letzten Befehl wird der Failover-Auftrag für die in $Protected gespeicherten geschützten Objekte gestartet.
...
### -RecoveryPlan
Gibt ein Wiederherstellungsplan-Objekt an, für das der Auftrag gestartet werden soll.
