...
## Synopsis
Ruft die Erweiterung für die Cloud-Dienst Diagnose ab, die für alle Rollen oder benannten Rollen in einem bestimmten Bereitstellungs Steckplatz angewendet wurde.
...
## Beschreibung
Das Cmdlet " **Get-AzureServiceDiagnosticsExtension** " Ruft die Erweiterung für die Cloud-Dienst Diagnose ab, die für alle Rollen oder benannten Rollen in einem bestimmten Bereitstellungs Steckplatz angewendet wurde.

## Beispiele

### Beispiel 1: Abrufen der Dienst Diagnose Erweiterung 
```
PS C:\> Get-AzureServiceDiagnosticsExtension -ServiceName $Svc
```

Dieser Befehl ruft die Dienst Diagnose für einen Dienst über alle Rollen ab.
