...
## Synopsis
Erstellt eine Azure Virtual Gateway-Netzwerkverbindung.
...
## Beschreibung
Das Cmdlet **New-AzureVirtualNetworkGatewayConnection** erstellt eine Azure Virtual Gateway-Netzwerkverbindung.
...
### -EnableBgp
Aktiviert das Border Gateway Protocol (BGP).
...
Gibt einen Namen für die Gateway-Verbindung an.
...
Gibt den Typ der Gatewayverbindung an.
...
Gibt die ID eines virtuellen Netzwerkgateways an.
