...
In diesem Beispiel wird ein Add-on mit einer neuen Plan-ID und einem Werbe Code aktualisiert.
...
### -PassThru
Wenn angegeben, gibt das Cmdlet true zurück, wenn der Befehl erfolgreich ist, und false, wenn ein Fehler auftritt.
