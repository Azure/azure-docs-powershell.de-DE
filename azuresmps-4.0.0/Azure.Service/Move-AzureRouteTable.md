...
## Synopsis
Migriert eine Routingtabelle zum Azure Resource Manager-Stapel.
...
## Beschreibung
Das Cmdlet **Move-AzureRouteTable** migriert eine Routingtabelle zu einer Ressourcengruppe im Azure Resource Manager-Stapel.
...
### -Abort
Gibt an, dass dieses Cmdlet die Migration der Routingtabelle abbricht.
...
### -Commit
Gibt an, dass dieses Cmdlet die Migration der Routingtabelle startet.
...
### -Vorbereiten
Gibt an, dass dieses Cmdlet die Routingtabelle für die Migration vorbereitet.
...
### -RouteTableName
Gibt den Namen der Routingtabelle an, die von diesem Cmdlet migriert wird.
...
### -Validate
Gibt an, dass dieses Cmdlet die Routingtabelle für die Migration überprüft.
