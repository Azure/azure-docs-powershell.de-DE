...
## Synopsis
Legt Informationen für eine benutzerdefinierte Skripterweiterung Azure Virtual Machine fest.
...
## Beschreibung
Das Cmdlet " **Set-AzureVMCustomScriptExtension** " legt Informationen für eine benutzerdefinierte Skripterweiterung Azure Virtual Machine fest.

## Beispiele

### Beispiel 1: Einrichten von Informationen für eine benutzerdefinierte Skripterweiterung für einen virtuellen Computer
```
...
Dieser Befehl legt Informationen für eine benutzerdefinierte Skripterweiterung für einen virtuellen Computer fest.

### Beispiel 2: Einrichten von Informationen für eine benutzerdefinierte Skripterweiterung für einen virtuellen Computer mithilfe eines Dateipfad
```
...
Dieser Befehl legt Informationen für eine benutzerdefinierte Skripterweiterung für einen virtuellen Computer unter Verwendung mehrerer Datei-URLs fest.
...
### -Containername
Gibt den Containernamen im Speicherkonto an.
...
### -Run
Gibt den Befehl an, der von der Erweiterung auf dem virtuellen Computer ausgeführt wird.
Nur "powershell.exe" wird unterstützt.
...
Gibt den Speicherdienst Endpunkt an.
