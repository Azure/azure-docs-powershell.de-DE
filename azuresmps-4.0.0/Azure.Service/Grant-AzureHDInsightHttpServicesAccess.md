...
## Synopsis
Gewährt HTTP-Zugriff auf einen Cluster.
...
Das Cmdlet **Grant-AzureHDInsightHttpServicesAccess** gewährt HTTP-Zugriff auf einen Azure HDInsight-Cluster mithilfe von ODBC, Ambari, Oozie und Webdiensten.
...
Gibt einen Benutzernamen und ein Kennwort für den HTTP-Zugriff an.
...
### -Standort
Gibt den Azure-Bereich an, in dem sich ein Cluster befindet.
...
Dieses Cmdlet gewährt HTTP-Zugriff auf den Cluster, den dieser Parameter angibt.
...
### -Abonnement
Gibt das Abonnement an, das den HDInsight-Cluster enthält, dem Sie den Zugriff gewähren möchten.
