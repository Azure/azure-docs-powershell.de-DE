...
## Beschreibung
Das Cmdlet " **Get-AzureSiteRecoveryVM** " Ruft Informationen zu virtuellen Computern ab, die in Azure Site Recovery verwaltet werden.

## Beispiele

### Beispiel 1: Abrufen von Informationen zu einem virtuellen Computer
```
...
Der zweite Befehl ruft Informationen zu den virtuellen Computern in $ProtectionContainer ab.

## Parameter

### -ID
Gibt die ID des virtuellen Computers an, über den Informationen abgerufen werden sollen.
...
Gibt die ID eines geschützten Containers an, über den Informationen abgerufen werden sollen.
...
[Satz-AzureSiteRecoveryVM](./Set-AzureSiteRecoveryVM.md)
