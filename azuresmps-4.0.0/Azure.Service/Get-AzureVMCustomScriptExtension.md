...
## Synopsis
Ruft Informationen aus der benutzerdefinierten Skripterweiterung Azure Virtual Machine ab.
...
## Beschreibung
Das Cmdlet " **Get-AzureVMCustomScriptExtension** " Ruft Informationen aus einer benutzerdefinierten Azure-Skripterweiterung für virtuelle Maschinen ab.

## Beispiele

### Beispiel 1: Abrufen einer Azure Virtual Machine-Skripterweiterung
```
PS C:\> Get-AzureVMCustomScriptExtension -VM $VM;
```

Dieser Befehl ruft eine Azure Virtual Machine-Skripterweiterung ab, die in der Variablen $VM gespeichert ist.
