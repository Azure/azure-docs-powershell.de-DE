...
Das Cmdlet " **Get-AzureHDInsightJob** " Ruft aktuelle Azure HDInsight-Aufträge für einen angegebenen Cluster ab und zeigt diese in umgekehrter chronologischer Reihenfolge an.
...
Dieses Cmdlet ruft HDInsight-Aufträge ab, die auf dem Cluster ausgeführt werden, den dieser Parameter angibt.
...
### -Abonnement
Gibt das Abonnement an, das die HDInsight-Aufträge enthält, die abgerufen werden sollen.
