...
## Synopsis
Ändert eine interne Load Balancer-Konfiguration in einem Azure-Dienst.
...
## Beschreibung
Das Cmdlet " **Satz-AzureInternalLoadBalancer** " ändert eine interne Load Balancer-Konfiguration in einem Azure-Dienst.
...
Gibt den Namen des internen Lastenausgleichs an, den dieses Cmdlet ändert.
...
### -ServiceName
Gibt den Namen des Diensts an, in dem mit diesem Cmdlet ein interner Lastenausgleichsmechanismus geändert wird.
...
### -StaticVNetIPAddress
Gibt die IP-Adresse des virtuellen Netzwerks für ein internes Lastenausgleichsmodul an.
