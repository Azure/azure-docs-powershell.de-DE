...
## Synopsis
Erstellt ein Azure Virtual Network-Gateway.
...
## Beschreibung
Das Cmdlet **New-AzureVirtualNetworkGateway** erstellt ein Azure Virtual Network-Gateway.
...
### -Force
Azure Virtual Network Gateway-Erstellung nicht bestätigen
...
### -VnetId
Gibt die ID eines virtuellen Netzwerks an.
...
[Größe ändern – AzureVirtualNetworkGateway](./Resize-AzureVirtualNetworkGateway.md)
