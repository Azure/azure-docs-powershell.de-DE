...
## Synopsis
Startet virtuelle Computer neu.
...
Mit dem Cmdlet " **Restart-WAPackVM** " werden virtuelle Computer neu gestartet.
...
Der zweite Befehl startet den in $VirtualMachine gespeicherten virtuellen Computer neu.
