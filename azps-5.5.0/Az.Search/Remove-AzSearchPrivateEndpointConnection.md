...
## BESCHREIBUNG
**Remove-AzSearchPrivateEndpointConnection** removes the private endpoint connection from the Azure Cognitive Search service.
...
In diesem Beispiel wird eine private Endpunktverbindung nach Name aus dem Suchdienst entfernt.
