...
## BESCHREIBUNG
Das **Cmdlet "New-AzSearchAdminKey"** generiert einen Administratorschlüssel des Azure Cognitive Search-Diensts erneut.
...
Im Beispiel wird der Primärschlüssel des Azure Cognitive Search-Diensts erneut generiert.
...
### -KeyKind
Azure Cognitive Search Service Admin Key Kind (Primär/Sekundär).
