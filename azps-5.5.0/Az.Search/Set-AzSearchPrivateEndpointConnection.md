...
## BESCHREIBUNG
**Set-AzSearchPrivateEndpointConnection** aktualisiert die Verbindung des privaten Endpunkts mit dem Azure Cognitive Search-Dienst.
...
In diesem Beispiel wird der Status einer Privaten Endpunktverbindung des Azure Cognitive Search-Diensts so aktualisiert, dass er abgelehnt wird.
...
### -Name
Name der privaten Endpunktverbindung von Azure Cognitive Search Service
...
### -ResourceId
Ressourcen-ID des privaten Linksdiensts
...
### -Status
Dienstverbindungsstatus für private Verknüpfungen
