...
### Beispiel 1: Aktualisieren der Quell-Cloud-Bereitstellung nach Name.
```powershell
...
Aktualisieren Sie die Bereitstellung der Quell-Cloud nach Name.
...
Aktualisieren Sie die Bereitstellung der Quellwolke von Pipe aus.
