...
### Beispiel 1: Aktualisieren des Clouddiensts "Frühling" nach Name.
```powershell
...
Aktualisieren Sie den Spring Cloud Service nach Name.

### Beispiel 2: Aktualisieren des Quell-Cloud-Diensts von Pipe.
```powershell
...
Aktualisieren Sie den Spring Cloud Service über Pipe.
...
### -TraceAppInsightInstrumentationKey
Zielanwendungsinblick-Instrumentationsschlüssel
...
### -TraceEnabled
Gibt an, ob die Ablaufverfolgungsfunktion aktiviert ist
