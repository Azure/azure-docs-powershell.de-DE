...
## SYNOPSIS
Fragt die von Azure Resource Manager verwalteten Ressourcen ab.
...
Einfache Ressourcenabfrage, die eine Teilmenge der Ressourcenfelder anfordert.
...
```
Eine Abfrage mit allen virtuellen Computern, die keine verwalteten Datenträger verwenden, und die Anzeigenamen des Abonnements enthält.
...
```
Eine Abfrage, die die Anzahl der Ressourcen nach Mandanten- und Abonnementanzeigenamen anlistet.
...
### -Abonnement
Abonnements zum Ausführen von Abfragen.
...
### -First
Die maximale Anzahl von Zurücksendungsobjekten. Zulässige Werte: 1-5000.
