...
## BESCHREIBUNG
Das **Cmdlet "New-AzKeyVault"** erstellt einen Schlüsseltresor in der angegebenen Ressourcengruppe. Dieses Cmdlet erteilt dem derzeit angemeldeten Benutzer außerdem berechtigungen zum Hinzufügen, Entfernen oder Auflisten von Schlüsseln und geheimen Daten im Schlüsseltresor.
...
Sofern angegeben, können Datenaktionen über rollenbasierte Zugriffssteuerung (Role Based Access Control, RBAC) autorisiert werden. Dann werden die in den Tresoreigenschaften angegebenen Zugriffsrichtlinien ignoriert. Beachten Sie, dass Verwaltungsaktionen immer mit RBAC autorisiert sind.
