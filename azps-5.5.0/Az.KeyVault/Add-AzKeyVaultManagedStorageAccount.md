...
## BESCHREIBUNG
Richtet ein vorhandenes Azure -Speicherkonto mit Schlüsseltresor für Speicherkontoschlüssel ein, die vom Schlüsseltresor verwaltet werden sollen. Das Speicherkonto muss bereits vorhanden sein. Die Speicherschlüssel werden dem Aufrufer niemals zur Verfügung stehen.
...
### -Destimperiod
Zeitraum. Wenn die automatische erneut generierte Taste aktiviert ist, gibt dieser Wert die Zeitspanne an, nach der die inaktiven Keygets des verwalteten Speicherkontos automatisch neu generiert und zum neuen aktiven Schlüssel werden.
