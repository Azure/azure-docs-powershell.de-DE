...
## BESCHREIBUNG
Exportiert die Sicherheitsdomänendaten eines verwalteten HSM für den Import auf einem anderen HSM.
...
Dieser Befehl ruft den verwalteten HSM-benannten Testmhsm ab und speichert eine Sicherung dieser verwalteten HSM-Sicherheitsdomäne in der angegebenen Ausgabedatei.

## PARAMETERS

### -Zertifikate
Pfade zu den Zertifikaten, die zum Verschlüsseln der Daten der Sicherheitsdomäne verwendet werden.
...
### -Force
Geben Sie an, ob eine vorhandene Datei überschrieben werden soll.
...
### -OutputPath
Geben Sie den Pfad an, auf den Sicherheitsdomänendaten heruntergeladen werden.
...
### -PassThru
Bei Angabe wird ein boolescher Wert zurückgegeben, wenn das Cmdlet erfolgreich ist.
