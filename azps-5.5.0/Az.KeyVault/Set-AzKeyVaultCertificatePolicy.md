...
## BESCHREIBUNG
Das **Cmdlet Set-AzKeyVaultCertificatePolicy** erstellt oder aktualisiert die Richtlinie für ein Zertifikat in einem Schlüsseltresor.
...
Mit diesem Befehl wird die Richtlinie für das Zertifikat "TestCert01" im Schlüsseltresor ContosoKV01 bestimmt.

## PARAMETERS

### -CertificateTransparency
Gibt an, ob für dieses Zertifikat/den Aussteller Zertifikattransparenz aktiviert ist. falls nicht angegeben, ist der Standardwert "true".
`-IssuerName` muss beim Festlegen dieser Eigenschaft angegeben werden.
...
### -EmailAtNumberOfDaysBeforeExpiry
Gibt die Anzahl von Tagen vor dem Ablauf an, um den Beginn der automatischen Verlängerung zu beginnen.
...
### -IssuerName
Gibt den Namen des Ausstellers für dieses Zertifikat an.
