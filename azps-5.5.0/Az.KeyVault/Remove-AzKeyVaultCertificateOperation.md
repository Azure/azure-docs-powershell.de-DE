...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzKeyVaultCertificateOperation"** löscht einen Zertifikatvorgang aus einem Schlüsseltresor.

## BEISPIELE

### Beispiel 1: Entfernen eines Zertifikatvorgangs
```powershell
...
Mit diesem Befehl wird der Zertifikatvorgang mit dem Namen "TestCert01" aus dem Schlüsseltresor von ContosoKV01 entfernt, ohne dass zur Bestätigung aufgefordert wird.
