...
## BESCHREIBUNG
Dieses Cmdlet aktualisiert den Zustand eines in Azure verwalteten HSM.
...
Aktualisiert Tags für den verwalteten Hsm, der `$hsmName` in der Ressourcengruppe benannt `$resourceGroupName` wird.
...
Aktualisiert Tags für das verwaltete Hsm mithilfe der Pipingsyntax.
