...
## BESCHREIBUNG
Der **Befehl "Update-AzKeyVaultNetworkRuleSet"** aktualisiert die Für den angegebenen Schlüsseltresor geltenden Netzwerkregeln. 
...
Mit diesem Befehl wird der Netzwerkregelnsatz im Tresor mit dem Namen "myVault" für den angegebenen IP-Bereich und das virtuelle Netzwerk aktualisiert, sodass die Netzwerkregel für Azure Services umgangen werden kann.
...
### -Bypass
Gibt die Umgehung einer Netzwerkregel an.
...
### -DefaultAction
Gibt die Standardaktion einer Netzwerkregel an.
