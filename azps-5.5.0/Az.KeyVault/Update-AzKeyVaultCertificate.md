...
### Beispiel 1: Ändern der einem Zertifikat zugeordneten Tags
```powershell
...
Der erste Befehl weist der Variablen ein Array von Schlüssel-Wert-Paaren $Tags zu.
Der zweite Befehl legt den Tagwert des Zertifikats namens "TestCert01" als $Tags.
...
### -Enable
Wenn vorhanden, aktivieren Sie ein Zertifikat, wenn der Wert wahr ist.
Deaktivieren Sie ein Zertifikat, wenn der Wert falsch ist.
Wenn dieser Wert nicht angegeben wird, bleibt der vorhandene Wert des Status "Aktiviert/Deaktiviert" des Zertifikats unverändert.
...
Wenn dieser Schalter angegeben ist, geben Sie das Zertifikatobjekt zurück.
...
### -Tag
Eine Hashtable, die Zertifikattags darstellt.
Wenn nichts angegeben wird, bleiben die vorhandenen Tags des Sertificate unverändert.
...
### -Version
Zertifikatversion.
Das Cmdlet erstellt den FQDN eines Zertifikats aus dem Namen des Tresors, der aktuell ausgewählten Umgebung, dem Zertifikatnamen und der Zertifikatversion.
