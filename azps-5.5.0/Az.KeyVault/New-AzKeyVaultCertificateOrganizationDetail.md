...
## BESCHREIBUNG
Das **Cmdlet "New-AzKeyVaultCertificateOrganizationDetail"** erstellt ein Speicherzertifikat-Organisationsdetailobjekt.

## BEISPIELE

### Beispiel 1: Erstellen eines Organisationsdetailseobjekts
```powershell
...
Der erste Befehl erstellt ein Detailobjekt des Zertifikatadministrators und speichert es dann in der $AdminDetails Variable.
Der zweite Befehl erstellt ein Objekt für die Zertifikatorganisation und speichert es dann in der $OrgDetails Variable.

## PARAMETERS

### -AdministratorDetails
Gibt die Administratoren der Zertifikatorganisation an.
