...
### Beispiel 2: Entfernen eines Schlüsseltresor aus einer bestimmten Ressourcengruppe
```powershell
...
### Beispiel 3: Entfernen eines verwalteten HSM
```powershell
...
Mit diesem Befehl wird der verwaltete hsm namens "testManagedHsm" aus Ihrem aktuellen Abonnement entfernt.
