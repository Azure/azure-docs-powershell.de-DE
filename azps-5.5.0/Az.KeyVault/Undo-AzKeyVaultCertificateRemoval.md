...
## BESCHREIBUNG
Das **Cmdlet "Undo-AzKeyVaultCertificateRemoval"** stellt ein zuvor gelöschtes Zertifikat wiederher.
...
Mit diesem Befehl wird das zuvor gelöschte Zertifikat "MyCertificate" in einen aktiven und verwendbaren Zustand wiederhergestellt.
...
### -Name
Zertifikatname.
Das Cmdlet erstellt den FQDN eines Zertifikats aus dem Namen des Tresors, der aktuell ausgewählt ist, sowie den Namen des Zertifikats.
