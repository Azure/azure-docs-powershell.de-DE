...
## BESCHREIBUNG
Ruft einen schlüsseltresor verwalteten Azure Storage Account ab, wenn der Name des Kontos angegeben ist und die Kontoschlüssel vom angegebenen Tresor verwaltet werden. Wenn der Kontoname nicht angegeben ist, werden alle Konten aufgelistet, deren Schlüssel vom angegebenen Tresor verwaltet werden.

## BEISPIELE

### Beispiel 1: Auflisten aller verwalteten Speicherkonten im Schlüsseltresor
```powershell
...
Listet alle Konten auf, deren Schlüssel vom Tresor "myvault" verwaltet werden.
...
Ruft die Details des verwalteten Speicherkontos "mystorageaccount" im Schlüsseltresor ab, wenn dessen Schlüssel vom Tresor "myvault" verwaltet werden.

### Beispiel 3: Auflisten aller im Schlüsseltresor verwalteten Speicherkonten mithilfe der Filterung
```powershell
...
Listet alle Konten auf, deren Schlüssel vom Tresor "myvault" verwaltet werden und mit "Test" beginnen.
