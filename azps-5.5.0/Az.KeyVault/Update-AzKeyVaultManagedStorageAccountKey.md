...
## BESCHREIBUNG
Generiert den angegebenen Schlüssel des im Schlüsseltresor verwalteten Azure -Speicherkontos erneut und legt den Schlüssel als aktiven Schlüssel fest. Der Schlüsseltresor proxys den Aufruf von Azure Resource Manager, um den Schlüssel erneut zu erstellen. Der Aufrufer muss Berechtigungen zum erneuten Generieren von Schlüsseln für ein bestimmtes Azure -Speicherkonto besitzen.

## BEISPIELE

### Beispiel 1: Erneutererieren eines Schlüssels
```powershell
...
Generiert "key1" des Kontos "mystorageaccount" erneut und legt "key1" als aktives Konto des verwalteten Key Vault Azure Storage Account fest.
...
### -KeyName
Name des Speicherkontoschlüssels zum erneuten Erstellen und Aktivieren.
