...
## BESCHREIBUNG
Das Set-AzPrivateDnsRecordSet cmdlet aktualisiert einen Datensatzsatz im Privaten Azure-DNS-Dienst von einem lokalen RecordSet-Objekt. Sie können ein "RecordSet"-Objekt als Parameter oder mithilfe des Pipelineoperators übergeben. Sie können den Parameter "Bestätigen" und $ConfirmPreference Windows PowerShell, um zu steuern, ob sie vom Cmdlet zur Bestätigung aufgefordert werden. Der Datensatzsatz wird nicht aktualisiert, wenn er seit dem Abrufen des lokalen "RecordSet"-Objekts in Azure Private DNS geändert wurde. Dies bietet Schutz für gleichzeitige Änderungen. Sie können dieses Verhalten mithilfe des Parameters "Overwrite" unterdrücken, der den Datensatzsatz unabhängig von gleichzeitigen Änderungen aktualisiert.
