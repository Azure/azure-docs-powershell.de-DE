...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzPrivateDnsVirtualNetworkLink"** löscht einen Privaten Domain Name System (DNS)-Link dauerhaft aus einer angegebenen Ressourcengruppe.
...
Alternativ können Sie die DNS-Zone mit einem **PSPrivateDnsVirtualNetworkLink-Objekt** angeben, das über die Pipeline oder den *Linkparameter übergeben* wird.
