...
## BESCHREIBUNG
Das **Cmdlet Set-AzCdnOrigin** aktualisiert einen Azure Content Delivery Network (CDN)-Origin-Server.
...
### -CdnOrigin
Gibt den Ursprungsserver an, der von diesem Cmdlet aktualisiert wird.
