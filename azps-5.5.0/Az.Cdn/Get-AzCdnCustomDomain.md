...
## BESCHREIBUNG
Das **Cmdlet "Get-AzCdnCustomDomain"** ruft eine benutzerdefinierte Azure Content Delivery Network (CDN)-Domäne und die zugehörigen Einstellungen ab.
...
### -CdnEndpoint
Gibt das CDN-Endpunktobjekt an, dessen Mitglied die benutzerdefinierte Domäne ist.
...
Der Name der benutzerdefinierten Domäne unterscheidet sich vom Hostnamen der benutzerdefinierten Domäne.
