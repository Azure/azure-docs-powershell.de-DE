...
## BESCHREIBUNG
Das **Cmdlet "Unpublish-AzCdnEndpointContent"** entfernt den Inhalt von einem Azure Content Delivery Network (CDN)-Endpunkt.
...
### -CdnEndpoint
Gibt den Endpunkt an, der von diesem Cmdlet gelöscht wird.
...
### -EndpointName
Gibt den Namen des Endpunkts an, der von diesem Cmdlet gelöscht wird.
...
### -PurgeContent
Gibt ein Array relativer Pfade für den Inhalt auf dem Ursprungsserver an, der von diesem Cmdlet gelöscht wird.
