...
### -EnabledState
Gibt an, ob Integritätssonden für Back-End-Funktionen aktiviert werden sollen, die unter Back-End-Pools definiert sind. Integritätstest können nur deaktiviert werden, wenn ein einzelnes aktiviertes Back-End im einzelnen aktivierten Back-End-Pool verfügbar ist.
...
### -HealthProbeMethod
Konfiguriert, welche HTTP-Methode verwendet werden soll, um die unter "Back-EndPools" definierten Back-End-Back-Ends zu finden.
...
### -Protocol
Für diese Sonde zu verwendende Protokollschema Standardwert ist HTTP
