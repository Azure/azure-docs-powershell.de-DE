...
## BESCHREIBUNG
Das **Cmdlet Set-AzFrontDlasten aktualisiert** den Lastenausgleich bei Front Door. Wenn keine Eingabeparameter angegeben werden, werden alte Parameter aus der vorhandenen Eingangstür verwendet.

## BEISPIELE

### Beispiel 1: Aktualisieren eines vorhandenen Eingangstürchens mit "FrontD anderenName" und "ResourceGroupName".
```powershell
...
ein vorhandenes FrontDoor aktualisieren.

### Beispiel 2: Aktualisieren eines vorhandenen "Front Door"-Objekts mit dem PsFrontD verdingungsobjekt.
```powershell
...
### Beispiel 3: Aktualisieren einer vorhandenen Eingangstür mit ResourceId
```powershell
...
### Beispiel 4: Aktualisieren der Back-EndPoolSetting-Eigenschaft EnforceCertificateNameCheck eines vorhandenen Eingangstors mit dem Parameter "-DisableCertificateNameCheck"
Das zu aktualisierende Front Door kann mit "Front selbstname" und "ResourceGroupName", "PSFrontDsource"-Objekt oder "ResourceId" identifiziert werden. (Beispiel: Siehe oben in drei Beispielen) Im folgenden Beispiel wird das "PSFrontD dann"-Objekt verwendet.
...
### -Back-EndPool
Für Routingregel verfügbare Back-End-Pools.
...
Gibt an, ob die Überprüfung des Zertifikatnamens für https-Anforderungen an alle Back-End-Pools deaktiviert werden soll. Keine Auswirkung auf Nicht-HTTPS-Anforderungen.
...
### -EnabledState
Betriebsstatus des Lastenausgleichs für die Eingangstür.
...
### -HealthProbeSetting
Integritätstesteinstellungen, die dieser Instanz von Front Door zugeordnet sind.
...
Einstellungen für den Lastenausgleich, die dieser Front Door-Instanz zugeordnet sind.
...
### -Name
Der Name der Eingangstür, die aktualisiert werden soll.
...
### -ResourceId
Ressourcen-ID der zu aktualisierende Eingangstür
...
### -RoutingRule
Diesem FrontDrouting zugeordnete Routingregeln
...
### -Tag
Die Tags werden der FrontDasso zugeordnet.
