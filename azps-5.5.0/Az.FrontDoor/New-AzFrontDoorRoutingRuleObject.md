...
### -CustomFragment
Fragment, das der Umleitungs-URL hinzugefügt werden soll. Fragment ist der Teil der URL, der hinter "#" steht. Schließen Sie nicht die Datei "#" ein.
...
### -CustomQueryString
Der Satz von Abfragezeichenfolgen, die in die Umleitungs-URL gesetzt werden sollen. Durch das Festlegen dieses Werts werden alle vorhandenen Abfragezeichenfolgen ersetzt. leer lassen, um die eingehende Abfragezeichenfolge zu erhalten. Die Abfragezeichenfolge muss sich in <key>=<value> formatieren. Das erste? und & werden automatisch hinzugefügt. Fügen Sie sie daher nicht in den Vorder-/Hintergrund ein, sondern trennen Sie mehrere Abfragezeichenfolgen durch &.
