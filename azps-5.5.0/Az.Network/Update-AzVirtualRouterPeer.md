...
## BESCHREIBUNG
Das **Cmdlet "Update-AzVirtualRouterPeer"** aktualisiert einen VirtualRouter Peer auf ein Azure VirtualRouter
...
### -InputObject
Das Eingabeobjekt des virtuellen Router-Peers.
...
### -PeerName
Der Name des Peers des virtuellen Routers.
...
### -ResourceGroupName
Der Ressourcengruppenname des virtuellen Routers/Peers.
...
### -ResourceId
Die Id der Peerressource des virtuellen Routers.
...
### -VirtualRouterName
Der virtuelle Router, auf dem Peer vorhanden ist.
