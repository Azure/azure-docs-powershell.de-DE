...
## BESCHREIBUNG
Das **Cmdlet "Set-AzApplicationGatewayCustomError"** aktualisiert einen benutzerdefinierten Fehler in einem http-Listener eines Anwendungsgateways.

## BEISPIELE

### Beispiel 1: Aktualisiert einen benutzerdefinierten Fehler eines Http-Listeners.
```powershell
...
Dieser Befehl aktualisiert den benutzerdefinierten Fehler des Http-Statuscodes 502 im http-Listener-$listener 01 und gibt den aktualisierten Listener zurück.

## PARAMETERS

### -CustomErrorPageUrl
Url der Fehlerseite des Kundenfehlers des Anwendungsgateways.
