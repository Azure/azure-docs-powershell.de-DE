...
## SYNOPSIS
Erstellen oder Auflisten von Websites, die mit Ressourcen des virtuellen Geräts (Network Virtual Appliance) verbunden sind.
...
## BESCHREIBUNG
Die Get-AzVirtualApplianceSite ruft Websites ab oder listet Websites auf, die mit einer oder mehreren Ressourcen für virtuelle Network Appliance verbunden sind.
...
Holen Sie sich eine Websiteressource für virtuelle Geräte.
...
Listen Sie Ressourcen für virtuelle Geräte in einer virtuellen Network Appliance auf.
...
Die virtuelle Network Appliance, an die die Website angefügt ist.
...
### -ResourceId
Die Ressourcen-ID der Website des virtuellen Geräts.
