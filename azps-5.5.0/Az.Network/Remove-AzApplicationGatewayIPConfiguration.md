...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzApplicationGatewayIPConfiguration"** entfernt eine IP-Konfiguration von einem Azure-Anwendungsgateway.

## BEISPIELE

### Beispiel 1: Entfernen einer IP-Konfiguration von einem Azure-Anwendungsgateway
```
...
Mit dem zweiten Befehl wird die IP-Konfiguration namens Subnetz02 aus dem Anwendungsgateway entfernt, das in $AppGw.

## PARAMETERS

### -ApplicationGateway
Gibt das Anwendungsgateway an, von dem eine IP-Konfiguration entfernt werden soll.
