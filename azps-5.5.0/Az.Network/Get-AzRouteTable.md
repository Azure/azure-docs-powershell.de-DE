...
## BESCHREIBUNG
Das **Get-AzRouteTable-Cmdlet** ruft Azure-Routentabellen ab.
Sie können eine einzelne Routentabelle oder alle Routentabellen in einer Ressourcengruppe oder in Ihrem Abonnement erhalten.
...
Dieser Befehl ruft die Routentabelle namens "RouteTable01" in der Ressourcengruppe mit dem Namen "ResourceGroup11" ab.

### Beispiel 2: Auflisten von Routentabellen mithilfe von Filtern
```
...
Dieser Befehl ruft alle Routentabellen ab, deren Name mit "RouteTable" beginnt.
...
### -Name
Gibt den Namen der Routentabelle an, die dieses Cmdlet erhält.
...
### -ResourceGroupName
Gibt den Namen der Ressourcengruppe an, die die Routentabellen enthält, die dieses Cmdlet erhält.
