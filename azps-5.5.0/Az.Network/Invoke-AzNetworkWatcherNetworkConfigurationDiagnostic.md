...
## BESCHREIBUNG
Das Invoke-AzNetworkWatcherNetworkConfigurationDiagnostic cmdlet ruft die Netzwerkkonfigurationsdiagnosesitzung für angegebene Netzwerkprofile für die Zielressource auf.
...
### -TargetResourceId
Die ID der Zielressource, die die Netzwerkkonfigurationsdiagnose ausführen soll.
Gültige Optionen sind VM, NetworkInterface, VMSS/NetworkInterface und Application Gateway.
...
Akzeptierte Werte sind "Normal", "Minimum", "Voll".
