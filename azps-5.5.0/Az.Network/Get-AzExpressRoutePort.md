...
## BESCHREIBUNG
Das **Get-AzExpressRoutePort-Cmdlet** wird verwendet, um ein "ExpressRoutePort"-Objekt aus Ihrem Abonnement abzurufen. Das zurückgegebene Expressrouteportobjekt kann als Eingabe für andere Cmdlets verwendet werden, die mit ExpressRoutePort funktionieren.
...
Ruft das "ExpressRoutePort"-Objekt mit $PortName in der Ressourcengruppe oder $rg Abonnement ab.
