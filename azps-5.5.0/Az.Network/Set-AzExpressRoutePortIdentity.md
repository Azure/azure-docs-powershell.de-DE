...
## BESCHREIBUNG
Das **Cmdlet Set-AzExpressRoutePortIdentity** aktualisiert ein lokales Azure ExpressRoutePort-Objekt. Verwenden **Sie Set-AzExpressRoutePort,** um es ExpressRoutePort zuzuordnen.
