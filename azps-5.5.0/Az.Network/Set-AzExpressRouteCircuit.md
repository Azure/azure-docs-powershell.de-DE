...
## BESCHREIBUNG
Das **Cmdlet Set-AzExpressRouteCircuit** speichert den geänderten "ExpressRoute"-Schaltkreis in Azure.

## BEISPIELE

### Beispiel 1: Ändern des ServiceKey eines ExpressRoute-Schaltkreises
```
