...
## BESCHREIBUNG
Das **Cmdlet "Add-AzLoadBalancerOutboundRuleConfig"** fügt einem Azure Load Balancer eine ausgehende Regelkonfiguration hinzu.
...
Der zweite Befehl verwendet den Pipelineoperator, um den Lastenausgleich in $slb an **Add-AzLoadBalancerOutboundRuleConfig** zu übergeben, wodurch dem Lastenausgleich eine ausgehende Regelkonfiguration hinzugefügt wird.
