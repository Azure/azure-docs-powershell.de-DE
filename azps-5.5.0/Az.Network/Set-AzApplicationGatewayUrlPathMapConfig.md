...
## BESCHREIBUNG
Das **Cmdlet Set-AzApplicationGatewayUrlPathMapConfig** legt die Konfiguration für ein Array von URL-Pfadzuordnungen zu einem Back-End-Serverpool fest.
...
Mit dem zweiten Befehl wird die URL-Pfadzuordnung namens "map01" im Anwendungsgateway aktualisiert.
Mit dem dritten Befehl wird das Anwendungsgateway aktualisiert.

## PARAMETERS

### -ApplicationGateway
Gibt das Anwendungsgateway an, zu dem dieses Cmdlet eine Konfiguration der URL-Pfadzuordnung legt.
...
### -Name
Gibt den Namen der URL-Pfadzuordnung an, für den dieses Cmdlet die Konfiguration vorgibt.
...
Beachten Sie, dass bei den Pfadregeln die Reihenfolge beachtet wird. Sie werden in der Reihenfolge ihrer Angabe angewendet.
