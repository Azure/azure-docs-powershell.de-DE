...
Zuerst erstellen wir ein Virtual Hub Route-Objekt und verwenden es zum Erstellen einer Ressource der Tabelle "Virtual Hub Route". Anschließend legen wir diese Routentabelleressource mithilfe des Befehls "Set-AzVirtualHub" auf den virtuellen Set-AzVirtualHub.
...
### -RouteTable
Die diesem virtuellen Hub zugeordneten Routentabellen.
