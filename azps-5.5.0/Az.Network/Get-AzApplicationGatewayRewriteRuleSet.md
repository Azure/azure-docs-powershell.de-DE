...
### Beispiel 1: Einen bestimmten Regelsatz "Neu schreiben" erhalten
```
...
Der zweite Befehl ruft den Neuschreibregelsatz mit dem Namen "RuleSet01" vom Anwendungsgateway ab, das in der Variablen namens "$AppGW.
