...
Mit dem oben angegebenen Befehl wird ein VHubRoute-Objekt mit "nextHop" als angegebener Firewall erstellt, das dann einer "VHubRouteTable"-Ressource hinzugefügt werden kann.
...
Mit dem obigen Befehl wird ein VHubRoute-Objekt erstellt, bei dem "nextHop" als angegebener hubVnetConnection verwendet wird, der dann einer "VHubRouteTable"-Ressource hinzugefügt werden kann.
...
```
Die oben aufgeführten Befehle erhalten die RoutingConfiguration eines bereits vorhandenen AzVHubRoute und fügen dann eine statische Route für die Verbindung hinzu. Wenn Sie aber hoffen, eine neue Verbindung mit der statischen Route zu erstellen, lesen Sie hier Beispiel [1.](New-AzRoutingConfiguration.md)
## PARAMETERS
