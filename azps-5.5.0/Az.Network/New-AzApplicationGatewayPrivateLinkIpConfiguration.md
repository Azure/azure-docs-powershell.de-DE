...
## SYNOPSIS
Erstellt eine IP-Konfiguration, die der Konfiguration von PrivateLink zugeordnet werden soll.
...
## BESCHREIBUNG
Das **Cmdlet "New-AzApplicationGatewayPrivateLinkIpConfiguration"** erstellt eine Ip-Konfiguration, die der PrivatenLink-Konfiguration für ein Azure-Anwendungsgateway zugeordnet wird.
...
Mit diesem Befehl wird eine PrivateLink-IP-Konfiguration namens "ipConfig01" erstellt, in der das Ergebnis in der Variablen namens "$PrivateLinkIpConfiguration. 
...
### -PrivateIpAddress
Die private IP-Adresse der ipConfiguration, wenn eine statische Zuweisung gewünscht wird.
