...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzVirtualNetwork"** entfernt ein virtuelles Azure-Netzwerk.

## BEISPIELE

### 1: Erstellen und Löschen eines virtuellen Netzwerks
```
...
In diesem Beispiel wird ein virtuelles Netzwerk in einer Ressourcengruppe erstellt und dann sofort gelöscht. Verwenden Sie das Kennzeichen "-Force", um die Eingabeaufforderung beim Löschen des virtuellen Netzwerks zu unterdrücken.
...
### -Name
Gibt den Namen des virtuellen Netzwerks an, das von diesem Cmdlet entfernt wird.
...
### -ResourceGroupName
Gibt den Namen der Ressourcengruppe an, die das virtuelle Netzwerk enthält, das von diesem Cmdlet entfernt wird.
