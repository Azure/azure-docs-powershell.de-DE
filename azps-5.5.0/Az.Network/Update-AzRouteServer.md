...
## BESCHREIBUNG
Mit **dem Cmdlet "Update-AzRouteServer"** wird der Verzweigungs-zu-Verzweigungsverkehr auf einen Azure RouteServer umgeleitet.
...
```
So aktivieren Sie Verzweigungs-zu-Verzweigungsverkehr für den Routeserver.

### Beispiel 1
```powershell
PS C:\>  Update-AzRouteServer -ResourceGroupName $rgname -RouteServerName $routeServerName
```
So deaktivieren Sie den Verzweigungs-zu-Verzweigungsverkehr für den Routeserver.

## PARAMETERS

### -AllowBranchToBranchTraffic
Kennzeichnen, um Verzweigungs-zu-Verzweigungsdatenverkehr für den Routeserver zu ermöglichen.
