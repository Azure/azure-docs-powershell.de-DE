...
## BESCHREIBUNG
Das **Cmdlet "Set-AzFirewallPolicyRuleCollectionGroup"** aktualisiert eine Regelsammlungsgruppe in einer Azure-Firewallrichtlinie.
...
In diesem Beispiel wird eine Regelsammlungsgruppe in der Firewallrichtlinie $fp

### Beispiel 2

speichert eine geänderte Gruppe der Azure-Firewallrichtlinien-Regelsammlung. (automatisch generiert)
