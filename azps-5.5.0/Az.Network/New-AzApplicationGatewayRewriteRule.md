...
## BESCHREIBUNG
**Das Cmdlet "New-AzApplicationGatewayRewriteRule"** erstellt eine Neuschreibregel für ein Azure-Anwendungsgateway.

## BEISPIELE

### Beispiel 1: Erstellen einer Neuschreibregel für ein Anwendungsgateway
```powershell
PS C:\> $rule = New-AzApplicationGatewayRewriteRule -Name rule1 -ActionSet $action -RuleSequence 101 -Condition $condition
```

Dieser Befehl erstellt eine Neuschreibungsregel namens "Regel1" und speichert das Ergebnis in der Variablen namens $rule.

## PARAMETERS

### -ActionSet
ActionSet der Neuschreibungsregel
...
### -Bedingung
Bedingung für die auszuführende Neuschreibregel
...
### -RuleSequence
Die Regelreihenfolge dieser Neuschreibungsregel im Neuschreibregelsatz
