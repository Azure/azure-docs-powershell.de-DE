...
## BESCHREIBUNG
Das Get-AzNetworkWatcherConnectionMonitorReport cmdlet gibt den Bericht zu den neuesten Verbindungszuständen zurück.

## BEISPIELE

### Beispiel 1: Erhalten der letzten Verbindungsmomentaufnahme des Verbindungsmonitors nach Name am angegebenen Speicherort
```
...
In diesem Beispiel fragen wir die neuesten Verbindungszustände des angegebenen Verbindungsmonitors ab.
...
### -ResourceId
Ressourcen-ID des Verbindungsmonitors.
...
## HINWEISE
Schlüsselwörter: azure, azurerm, arm, resource, connectivity, management, manager, network, networking, network watcher, connection monitor
