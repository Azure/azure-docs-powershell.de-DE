...
## SYNOPSIS
Erstellt eine neue Angriffserkennung für die Firewallrichtlinie von Azure, die der Firewallrichtlinie zugeordnet werden soll.
...
### Beispiel 1: 1. Erstellen der Angriffserkennung mit Modus
```powershell
PS C:\> New-AzFirewallPolicyIntrusionDetection -Mode "Alert"
```

In diesem Beispiel wird die Angriffserkennung mit dem Warnungsmodus (Erkennung) erstellt.

### Beispiel 2: 2. Erstellen der Angriffserkennung mit Signaturüberschreibungen
```powershell
...
### Beispiel 3: 3. Erstellen einer Firewallrichtlinie mit konfigurierter Angriffserkennung mit Einstellung für die Umgehung des Datenverkehrs
```powershell
...
### -SignatureOverride
Liste bestimmter Signaturzustände.
