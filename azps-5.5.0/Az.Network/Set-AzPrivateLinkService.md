...
In diesem Beispiel wird ein privater Linkdienst namens "mypls" erstellt. Anschließend ersetzt sie die ipConfigurations durch das speicherinte ipConfiguratiuon-Objekt. Das Set-AzPrivateLinkService cmdlet wird dann verwendet, um den geänderten Dienststatus für private Links auf der Dienstseite zu schreiben. 
...
### -PrivateLinkService
Gibt ein privates Verknüpfungsdienstobjekt an, das den Zustand darstellt, auf den der private Linkdienst festgelegt werden soll.
