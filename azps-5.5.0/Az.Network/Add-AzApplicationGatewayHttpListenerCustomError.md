...
## BESCHREIBUNG
Das **Cmdlet "Add-AzApplicationGatewayCustomError"** fügt einem http-Listener eines Anwendungsgateways einen benutzerdefinierten Fehler hinzu.

## BEISPIELE

### Beispiel 1: Fügt der Http-Listener-Ebene einen benutzerdefinierten Fehler hinzu.
```powershell
...
Dieser Befehl fügt dem http-Listener-$listener 01 einen benutzerdefinierten Fehler mit dem Http-Statuscode 502 hinzu und gibt den aktualisierten Listener zurück.
