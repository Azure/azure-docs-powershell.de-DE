...
Dieser Befehl erstellt eine neue öffentliche IP-Präfixressource. 
...
### -CustomIpPrefix
Das CustomIpPrefix, dem dieses PublicIpPrefix zugeordnet wird
...
### -SKU
Der Name des öffentlichen IP-Präfix-SKU.
...
### -Tier
Die öffentlichen IP-Präfix-SKU-Ebenen.
