...
## BESCHREIBUNG
Das **Cmdlet "Get-AzPrivateDnsZoneGroup"** ruft eine oder mehrere private DNS-Zonengruppen ab.

## BEISPIELE

### Beispiel 1: Abrufen der privaten Gruppe der DNS-Zone
```powershell
...
Im vorstehenden Beispiel wird eine private DNS-Zonengruppe namens "dnsgroup1" in der Ressourcengruppe "rg" (rg) bekommt.
