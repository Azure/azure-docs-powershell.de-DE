...
## BESCHREIBUNG
Das **Cmdlet "Set-AzPrivateDnsZoneGroup"** aktualisiert die DNS-Zonengruppe.
...
Im obigen Beispiel wird die DNS-Zonengruppe "dnsgroup1" mit einer neuen Dnsconfig aktualisiert, die mit einer anderen DNS-Zone verknüpft ist.
