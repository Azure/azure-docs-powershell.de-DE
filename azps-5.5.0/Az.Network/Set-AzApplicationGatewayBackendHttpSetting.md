...
## BESCHREIBUNG
Das Set-AzApplicationGatewayBackendHttpSetting aktualisiert die Back-End-HTTP -Einstellungen (Hypertext Transfer Protocol) für ein Azure-Anwendungsgateway.
...
Der zweite Befehl aktualisiert die HTTP-Einstellungen des Anwendungsgateways in der $AppGw-Variable, um Port 88 zu verwenden, das HTTP-Protokoll, und ermöglicht cookiebasierte Affinität.
...
### -ApplicationGateway
Gibt ein Anwendungsgatewayobjekt an, dem dieses Cmdlet die Back-End-HTTP-Einstellungen zu ordnet.
...
### -Probe
Gibt eine Sonde an, die den Back-End-HTTP-Einstellungen zugeordnet werden soll.
...
### -ProbeId
Gibt die ID der Sonde an, die den Back-End-HTTP-Einstellungen zugeordnet werden soll.
