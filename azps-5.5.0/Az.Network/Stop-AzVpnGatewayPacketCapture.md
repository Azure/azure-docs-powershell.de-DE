...
## SYNOPSIS
Beendet den Paketerfassungsvorgang auf einem Vpn-Gateway.
...
## BESCHREIBUNG
Beendet den Paketerfassungsvorgang auf einem Vpn-Gateway und hochgeladen das Ergebnis auf den angegebenen SasUrl-Speichercontainer.
...
### -InputObject
Das Vpn-Gateway-Objekt, in dem die Paketaufzeichnung gestartet werden soll.
...
### -Name
Der Name des Vpn-Gateways, in dem die Paketaufzeichnung gestartet werden soll.
...
### -ResourceId
Die Azure-Ressourcen-ID des VpnGateways, in dem die Paketerfassung gestartet werden soll.
...
### -SasUrl
SAS-URL-Paketerfassung auf dem Vpn-Gateway.
