...
## BESCHREIBUNG
Das **Cmdlet Set-AzApplicationGatewayAuthenticationCertificate** aktualisiert ein Authentifizierungszertifikat für ein Azure-Anwendungsgateway.

## BEISPIELE

### Beispiel 1: Aktualisieren eines Authentifizierungszertifikats
```
...
Der erste Befehl ruft das Anwendungsgateway namens "appGwName" ab und speichert das Ergebnis in der $appgw Variable.
Der zweite Befehl aktualisiert das Authentifizierungszertifikat mit dem Namen "cert01" im Anwendungsgateway.
Mit dem dritten Befehl wird das Anwendungsgateway aktualisiert.

## PARAMETERS

### -ApplicationGateway
Gibt den Namen des Anwendungsgateways an, für das dieses Cmdlet ein Authentifizierungszertifikat aktualisiert.
...
### -CertificateFile
Gibt den Pfad der Authentifizierungszertifikatdatei an, mit der dieses Cmdlet das Zertifikat aktualisiert.
...
### -Name
Gibt den Namen des Authentifizierungszertifikats an, das von diesem Cmdlet aktualisiert wird.
