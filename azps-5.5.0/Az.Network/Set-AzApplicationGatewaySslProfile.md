...
## SYNOPSIS
Aktualisiert das Ssl-Profil für ein Anwendungsgateway.
...
## BESCHREIBUNG
Das **Cmdlet Set-AzApplicationGatewaySslProfile** aktualisiert das Ssl-Profil für ein Azure-Anwendungsgateway.
...
Der erste Befehl ruft das Anwendungsgateway namens ApplicationGateway01 ab, das zur Ressourcengruppe "ResourceGroup01" gehört, und speichert es in der $AppGw Variable. Der zweite Befehl aktualisiert das ssl-Profil des Anwendungsgateways in der $AppGw-Variable, um die Konfiguration der Clientauthentisierung auf den neuen Wert zu aktualisieren, der in der Datei $newclientconfig.
