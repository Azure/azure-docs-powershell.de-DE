...
## BESCHREIBUNG
Das **Cmdlet "Get-AzExpressRouteCrossConnectionARPTable"** ruft die ARP-Tabelle aus beiden Schnittstellen einer ExpressRoute-Kreuzverbindung ab. Die TABELLE ARP enthält eine Zuordnung der IPv4-Adresse zur MAC-Adresse für ein bestimmtes Peering. Sie können die ARP-Tabelle verwenden, um die Layer-2-Konfiguration und -Konnektivität zu überprüfen.

## BEISPIELE

### Beispiel 1: Anzeigen der TABELLE ARP für einen ExpressRoute-Peer
```
