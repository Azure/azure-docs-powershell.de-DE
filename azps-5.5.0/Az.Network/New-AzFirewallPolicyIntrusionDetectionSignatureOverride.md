...
## SYNOPSIS
Erstellt eine neue Außerkraftsetzung der Signaturüberschreibung der Azure-Firewall-Richtlinieneindringerkennung.
...
## BESCHREIBUNG
Das **Cmdlet "New-AzFirewallPolicyIntrusionDetectionSignatureOverride"** erstellt ein Überschreibungsobjekt für die Signatur der Azure-Firewallrichtlinie.

## BEISPIELE

### Beispiel 1: 1. Erstellen der Angriffserkennung mit Signaturüberschreibungen
```powershell
PS C:\> $signatureOverride = New-AzFirewallPolicyIntrusionDetectionSignatureOverride -Id "123456798" -Mode "Deny"
PS C:\> New-AzFirewallPolicyIntrusionDetection -Mode "Alert" -SignatureOverride $signatureOverride
```
In diesem Beispiel wird die Angriffserkennung mit einer bestimmten Signaturüberschreibung in den Verweigernmodus erstellt.
