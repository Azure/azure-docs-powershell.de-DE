...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzNetworkInterfaceTapConfig"** entfernt eine Azure-Anzapfkonfiguration aus einer Netzwerkschnittstellenliste.

## BEISPIELE

### Beispiel 1: Entfernen einer Tippkonfiguration
```
PS C:\>Remove-AzNetworkInterfaceTapConfig -Name "TapConfiguration" -NetworkInterfaceName "NetworkInterface1" -ResourceGroup "ResourceGroup1"
```

Mit diesem Befehl wird die TapConfiguration aus NetworkInterface1 in einer Ressourcengruppe "ResourceGroup1" entfernt.
...
### -InputObject
Verweis auf NetworkInterfaceTapConfig.
...
### -ResourceId
NetworkInterfaceTapConfig-Ressourcen-ID.
