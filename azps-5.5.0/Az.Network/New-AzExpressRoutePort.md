...
## BESCHREIBUNG
Das **Cmdlet "New-AzExpressRoutePort"** erstellt einen Azure ExpressRoutePort
...
### -BandwidthInGbps
Bandbreite der in Gbps verfügbaren ports
...
### -Kapselung
Kapselungsmethode für physische Ports.
...
### -Identity
Vom Benutzer zugewiesene Identität zum Lesen der MacSec-Konfiguration
...
### -Link
Die Gruppe physischer Verknüpfungen der "ExpressRoutePort"-Ressource
...
### -PeeringLocation
Der Name des Peeringstandorts, dem der ExpressRoutePort physisch zugeordnet ist.
