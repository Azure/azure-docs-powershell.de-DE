...
Löscht das Objekt des virtuellen Netzwerkgateways mit dem Namen "myGateway" in der Ressourcengruppe "myRG". Hinweis: Sie müssen zuerst alle Verbindungen mit dem virtuellen Netzwerkgateway mithilfe des **Cmdlets "Remove-AzVirtualNetworkGatewayConnection"** löschen.
...
### -Name
Gibt den Namen des virtuellen Netzwerkgateways an, das von diesem Cmdlet entfernt wird.
