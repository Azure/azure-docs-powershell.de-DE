...
## BESCHREIBUNG
Das **Cmdlet "Add-AzApplicationGatewayHttpListener"** fügt einem Anwendungsgateway einen HTTP-Listener hinzu.
...
Der erste Befehl ruft das Anwendungsgateway ab und speichert es in der $AppGw Variable. Mit dem zweiten Befehl wird der HTTP-Listener dem Anwendungsgateway hinzufügt.
...
Der zweite Befehl fügt den Listener, der das HTTPS-Protokoll verwendet, dem Anwendungsgateway hinzu.
...
Muss angegeben werden, wenn HTTPS als Listenerprotokoll ausgewählt wird.
