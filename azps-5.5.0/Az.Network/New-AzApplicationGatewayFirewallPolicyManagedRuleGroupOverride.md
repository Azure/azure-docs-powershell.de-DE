...
## BESCHREIBUNG
Die **Neue-AzApplicationGatewayFirewallPolicyManagedRuleGroupOverride** erstellt einen Eintrag für die RegelGroupOverride in einem managedRuleSet für eine Firewallrichtlinie.
...
Erstellt einen Eintrag "RuleGroupOverride" mit dem Gruppennamen $ruleName und Regeln als $rule 1, $rule 2. Weist die gleiche Zuordnung zu $overrideEntry
...
### -RuleGroupName
Geben Sie den Regelgruppennamen in einem Eintrag zur Außerkraftsetzung der Regelgruppe an.
