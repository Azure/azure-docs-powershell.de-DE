...
## SYNOPSIS
Erstellt eine neue Einstellung für die Umgehung des Datenverkehrs in der Azure-Firewall-Richtlinienerkennung.
...
## BESCHREIBUNG
Das **Cmdlet "New-AzFirewallPolicyIntrusionDetectionBypassTraffic"** erstellt ein Datenverkehrsobjekt für die Umgehung des Datenverkehrs durch die Azure Firewall Policy Bypass.

## BEISPIELE

### Beispiel 1: 1. Erstellen von Umgehungsverkehr mit einer bestimmten Port- und Quelladresse
```powershell
...
In diesem Beispiel wird die Angriffserkennung mit Einstellung für die Umgehung des Datenverkehrs erstellt.
...
### -Beschreibung
Beschreibung der Umgehungseinstellung
...
### -DestinationAddress
Liste der Ziel-IP-Adressen oder -Bereiche.
...
### -DestinationPort
Liste der Zielports oder -bereiche.
...
### -Protocol
Umgehungseinstellungsprotokoll.
...
### -SourceAddress
Liste der IP-Quelladressen oder -bereiche.
...
### -SourceIpGroup
Liste der IpGroup-Quellgruppen.
