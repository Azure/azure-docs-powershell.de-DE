...
In diesem Beispiel wird eine Threat Intel Whitelist erstellt, die eine FQDN-Whitelist mit zwei Einträgen und eine Ip-Adress-Whitelist mit zwei Einträgen enthält.
