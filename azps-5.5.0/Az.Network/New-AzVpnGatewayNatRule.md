...
## SYNOPSIS
Erstellt eine NAT-Regel in einem VpnGateway, die vpnSiteLinkConnection zugeordnet werden kann.
...
## BESCHREIBUNG
Erstellt eine NAT-Regel in einem VpnGateway, die vpnGateway zugeordnet werden kann.
...
Im vorstehenden Beispiel wird eine Ressourcengruppe, ein virtuelles WAN, ein virtuelles Netzwerk, ein virtueller Hub erstellt. Anschließend erstellen wir VpnGateway unter diesem virtuellen Hub. Verwenden Sie dann den folgenden Befehl: New-AzVpnGatewayNatRule, NAT rule can be createdand associated to created VpnGateway.
...
### -ParentResourceId
Die Ressourcen-ID des übergeordneten VpnGateway für diese NAT-Regel.
