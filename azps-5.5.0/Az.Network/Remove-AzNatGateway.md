...
## BESCHREIBUNG
Nat Gatewayressource entfernen
...
### -Force
Fordern Sie keine Bestätigung an, wenn Sie die Ressource löschen möchten.
...
### -Name
Name der Nat-Gateway-Ressource.
...
### -ResourceId
Dem Nat Gateway zugeordnete Ressourcen-ID.
