...
## BESCHREIBUNG
**Set-AzNetworkInterfaceTapConfig** aktualisiert eine Anzapfkonfiguration für eine Netzwerkschnittstelle.

## BEISPIELE

### Beispiel 1: Festlegen der TapConfiguration mit dem aktualisierten Namen "TapConfig"
```
...
Konfiguration von "NetworkInterface-Anzapfen"
