...
Im vorstehenden Beispiel wird eine Ressourcengruppe "testRG" in der Region "West US" und ein virtuelles Azure-WAN in dieser Ressourcengruppe in Azure erstellt. VirtualWan wird mit neuen Eigenschaften aktualisiert.

## PARAMETERS

### -AllowBranchToBranchTraffic
"Branch-to-Branch-Datenverkehr für VirtualWan zulassen" aus.
...
Lassen Sie vnet den vnet-Datenverkehr für VirtualWan zu.
...
### -InputObject
Das virtuelle wan-Objekt, das geändert werden soll
