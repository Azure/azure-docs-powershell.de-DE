...
## SYNOPSIS
Ruft einen RouteServer-Peer in einem Azure RouteServer ab.
...
## BESCHREIBUNG
Das **Cmdlet "Get-AzRouteServerPeer"** ruft einen Peer in einem Azure RouteServer ab.
...
### -ResourceId
ResourceId des Routenserver-Peers.
