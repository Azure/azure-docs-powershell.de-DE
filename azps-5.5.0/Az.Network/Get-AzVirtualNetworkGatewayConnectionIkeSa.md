...
## SYNOPSIS
Erhalten von IKE-Sicherheitszuordnungen einer virtuellen Netzwerkgatewayverbindung
...
## BESCHREIBUNG
Das **Cmdlet "Get-AzVirtualNetworkGatewayConnectionIkeSa"** gibt die IKE-Sicherheitszuordnungen Ihrer Verbindung basierend auf dem Verbindungsnamen und dem Namen der Ressourcengruppe zurück.
Wenn das **Cmdlet "Get-AzVirtualNetworkGatewayConnection"** ohne Angabe des Parameters "-Name" ausgegeben wird, werden in der Ausgabe die IKE-Sicherheitszuordnungen nicht angezeigt.
...
Gibt die IKE-Sicherheitszuordnungen für die virtuelle Netzwerkgatewayverbindung mit dem Namen "myTyp" in der Ressourcengruppe "myRG" zurück.
...
### -Name
Der Name der virtuellen Netzwerkgateway-Verbindung, für die IKE SAs abgerufen werden müssen.
...
### -ResourceId
Die Azure-Ressourcen-ID der Virtuellen Netzwerkgatewayverbindung, für die IKE SAs abgerufen werden müssen.
