...
## BESCHREIBUNG
Das **Cmdlet "Get-AzExpressRouteCircuitStat"** ruft Verkehrsstatistiken für einen "ExpressRoute"-Schaltkreis ab. Die Statistiken umfassen die Anzahl der gesendeten und empfangenen Bytes über die primären und sekundären Routen.

## BEISPIELE

### Beispiel 1: Anzeigen der Verkehrsstatistiken für einen ExpressRoute-Peer
```
