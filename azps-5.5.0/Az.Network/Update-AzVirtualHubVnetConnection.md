...
Im vorstehenden Beispiel wird eine Ressourcengruppe, ein virtuelles WAN, ein virtuelles Netzwerk und ein virtueller Hub in zentralen USA in dieser Ressourcengruppe in Azure erstellt. Außerdem wird eine virtuelle Netzwerkverbindung erstellt, bei der es sich um ein Peer des virtuellen Netzwerks mit dem virtuellen Hub handelt. Diese virtuelle Netzwerkverbindung wird dann aktualisiert, um die Internetsicherheit zu aktivieren.
