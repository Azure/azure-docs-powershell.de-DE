...
## BESCHREIBUNG
Erstellt eine ressourcenressource. Dazu benötigen Sie eine öffentliche IP-Adresse und ein VirtualNetwork. In diesem VirtualNetwork muss ein Subnetz mit dem Namen "AzureBastionSubnet" vorhanden sein. Die Pubic -IP-Adresse muss mit SKU Standard erstellt werden.
...
### -ResourceGroupName
Der Name der Ressourcengruppe, in der Sie eine Gruppe erstellen müssen.
