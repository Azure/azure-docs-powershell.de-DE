...
ms.locfileid: "100172764"
---
# New-AzApplicationGatewayProbeConfig

## SYNOPSIS
Erstellt eine Integritätsinteprobe.
...
## BESCHREIBUNG
Das New-AzApplicationGatewayProbeConfig A0 erstellt eine Integritätsinteprobe.

## BEISPIELE

### Beispiel 1: Beispiel1: Erstellen einer Integritätsinteprobe
```powershell
PS C:\>New-AzApplicationGatewayProbeConfig -Name "Probe03" -Protocol Http -HostName "contoso.com" -Path "/path/custompath.htm" -Interval 30 -Timeout 120 -UnhealthyThreshold 8
```

Dieser Befehl erstellt eine Integritätstest namens "Probe03" mit HTTP-Protokoll, einem Intervall von 30 Sekunden, einem Timeout von 120 Sekunden und einem fehlerhaften Schwellenwert von 8 Wiederholungen.

### Beispiel 2

Erstellt eine Integritätsinteprobe. (automatisch generiert)
