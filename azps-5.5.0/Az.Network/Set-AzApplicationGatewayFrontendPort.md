...
## BESCHREIBUNG
Das **Cmdlet "Set-AzApplicationGatewayFrontendPort"** ändert einen Front-End-Port für ein Anwendungsgateway.

## BEISPIELE

### Beispiel 1: Festlegen des Front-End-Ports eines Anwendungsgateways auf 80
```
...
Der zweite Befehl ändert das Gateway in $AppGw port 80 für den Front-End-Port namens "FrontEndPort01".

## PARAMETERS

### -ApplicationGateway
Gibt das Anwendungsgatewayobjekt an, dem dieses Cmdlet den Front-End-Port zu ordnet.
