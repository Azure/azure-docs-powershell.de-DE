...
Mit diesen Befehlen wird das Anwendungsgateway mit den Einstellungen in der Variablen $AppGw aktualisiert und das aktualisierte Gateway in der variablen $UpdatedAppGw gespeichert.

## PARAMETERS

### -ApplicationGateway
Gibt ein Anwendungsgatewayobjekt an, das den Zustand darstellt, in dem das Anwendungsgateway festgelegt werden soll.
