...
## BESCHREIBUNG
Das **Cmdlet "Get-AzVirtualNetwork"** ruft ein oder mehrere virtuelle Netzwerke n einer Ressourcengruppe ab.
...
Dieser Befehl ruft das virtuelle Netzwerk "MyVirtualNetwork" in der Ressourcengruppe "TestResourceGroup" ab.

### 2: Auflisten virtueller Netzwerke mithilfe von Filtern
```
