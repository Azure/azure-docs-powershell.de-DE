...
Bei einem Azure -VPN-Gateway handelt es sich um eine softwaredefinierte Konnektivität zwischen Standort- und Websiteverbindungen innerhalb von VirtualHub. Die Größe dieses Gateways wird basierend auf der vom Benutzer angegebenen Skalierungseinheit geändert und skaliert. Eine Verbindung kann von einer Verzweigung/Website, die als "VPN-Website" bezeichnet wird, zum skalierbaren Gateway eingerichtet werden. Jede Verbindung besteht aus 2 Active-Active Tunneln.
