...
In diesem Beispiel wird einem virtuellen Gateway mit dem Namen "ContosoVirtualGateway" ein Clientstammzertifikat hinzufügt.
...
Dabei wird eine Ausgabe ähnlich der folgenden angezeigt (beachten Sie, dass die tatsächliche Ausgabe viel mehr Textzeilen enthält als im hier gezeigten abgekürzten Beispiel): ----- BEGIN CERTIFICATE ----- MIIC13FAAXC3671Auij9HHgUNEW8343NMJklo09982CVVFAw8w ----- END CERTIFICATE ----- The PublicCertData is made up of all the lines between the first line (----- BEGIN CERTIFICATE -----) and the last line (----- END CERTIFICATE -----) in the file.
