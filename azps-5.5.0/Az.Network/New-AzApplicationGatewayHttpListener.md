...
Mit diesem Befehl wird ein HTTP-Listener erstellt, der das AUSLADEN von SSL verwendet und das Zertifikat in der Variablen $SSLCert 01 enthält.
...
Mit diesem Befehl wird ein HTTP-Listener erstellt, der das SSL-Ausladen verwendet und das $SSLCert 01-Zertifikat zusammen mit zwei HostNamen in der Variablen anfordert.
Der Befehl speichert das Ergebnis in der Variablen namens $Listener.
