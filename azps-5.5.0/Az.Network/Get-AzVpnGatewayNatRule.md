...
## SYNOPSIS
Ruft eine NAT-Regel ab, die vpnGateway zugeordnet ist.
...
Im vorstehenden Beispiel wird eine Ressourcengruppe, ein virtuelles WAN, ein virtuelles Netzwerk, ein virtueller Hub und ein VpnGateway & nat-Regel erstellt, die vpngateway zugeordnet ist.
Anschließend ruft sie die NAT-Regel unter Verwendung des Namens der NAT-Regel ab.
...
### -ParentObject
Das übergeordnete VpnGateway für dieses VpnGatewayNatRule.
...
### -ParentResourceId
Die Ressourcen-ID des übergeordneten VpnGateways für dieses VpnGatewayNatRule.
