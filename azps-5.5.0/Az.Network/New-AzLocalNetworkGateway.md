...
## BESCHREIBUNG
Das lokale Netzwerkgateway ist das Objekt, das Ihr VPN-Gerät lokal darstellt.
Das **Cmdlet "New-AzLocalNetworkGateway"** erstellt das Objekt, das Ihr lokales Gateway darstellt, basierend auf dem Namen, dem Ressourcengruppennamen, dem Standort und der IP-Adresse des Gateways sowie dem Adresspräfix des lokalen Netzwerks, das eine Verbindung mit Azure herstellen wird.

## BEISPIELE

### Beispiel 1: Erstellen eines lokalen Netzwerkgateways
```powershell
New-AzLocalNetworkGateway -Name myLocalGW -ResourceGroupName myRG -Location "West US" -GatewayIpAddress 23.99.221.164 -AddressPrefix "10.5.51.0/24"
```

Erstellt das Objekt des lokalen Netzwerkgateways mit dem Namen "myLocalGW" innerhalb der Ressourcengruppe "myRG" am Standort "WEST US" mit der IP-Adresse "23.99.221.164" und dem Adresspräfix "10.5.51.0/24" lokal.
...
### -Fqdn
FQDN des lokalen Netzwerkgateways.
