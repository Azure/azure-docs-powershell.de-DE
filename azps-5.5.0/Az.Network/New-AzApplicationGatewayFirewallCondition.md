...
## BESCHREIBUNG
**"New-AzApplicationGatewayFirewallCondition"** erstellt eine Übereinstimmungsbedingung für die benutzerdefinierte Firewallregel.
...
Der Befehl erstellt eine neue Übereinstimmungsbedingung mithilfe der in der $variable definierten Übereinstimmungsvariablen, der Operator ist "Contains" und "negation condition is false", "Transfroms", einschließlich Kleinbuchstaben und "trim", der Übereinstimmungswert "abc" und "cde". Die neue Übereinstimmungsbedingung wird in $condition.
