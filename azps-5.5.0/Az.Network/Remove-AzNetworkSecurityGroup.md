...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzNetworkSecurityGroup"** entfernt eine Azure-Netzwerksicherheitsgruppe.

## BEISPIELE

### Beispiel 1: Entfernen einer Netzwerksicherheitsgruppe
```
PS C:\>Remove-AzNetworkSecurityGroup -Name "NSG-FrontEnd" -ResourceGroupName "TestRG"
```

Mit diesem Befehl wird die Sicherheitsgruppe namens NSG-FrontEnd in der Ressourcengruppe "TestRG" entfernt.
...
### -Name
Gibt den Namen der Netzwerksicherheitsgruppe an, die von diesem Cmdlet entfernt wird.
...
### -ResourceGroupName
Gibt den Namen einer Ressourcengruppe an, aus der mit diesem Cmdlet eine Netzwerksicherheitsgruppe entfernt wird.
