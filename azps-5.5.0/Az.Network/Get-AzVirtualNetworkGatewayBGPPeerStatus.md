...
## BESCHREIBUNG
Mit diesem Befehl werden die BGP-Peers aufgezählt, mit deren Peer ein virtuelles Azure-Netzwerkgateway konfiguriert ist. Der Status jedes Peers wird ebenfalls angegeben.
...
Ruft die BGP-Peers für das virtuelle Azure-Netzwerkgateway namens "gatewayName" in der Ressourcengruppe "resourceGroup" ab.
Diese Beispielausgabe zeigt einen verbundenen BGP-Peer mit einer IP von 10.0.0.254.
...
### -Peer
DIE IP des Peers, für den der Status abgerufen werden soll
