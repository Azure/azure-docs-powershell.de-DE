...
## SYNOPSIS
Entfernt eine NAT-Regel, die vpnGateway zugeordnet ist.
...
Im vorstehenden Beispiel wird eine Ressourcengruppe, ein virtuelles WAN, ein virtuelles Netzwerk, ein virtueller Hub, vpnGateway und eine diesem VpnGateway zugeordnete NAT-Regel erstellt.
Anschließend wird die NAT-Regel unter Verwendung des Namens der NAT-Regel entfernt.
