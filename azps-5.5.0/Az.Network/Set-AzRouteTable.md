...
Dieser Befehl ruft die Routentabelle mit dem Namen "RouteTable01" mithilfe Get-AzRouteTable ab.
Der Befehl übergibt diese Tabelle mithilfe des Pipelineoperators Add-AzRouteConfig an das Add-AzRouteConfig Cmdlet.
**Add-AzRouteConfig** fügt die Route "Route07" hinzu und übergibt das Ergebnis an das aktuelle Cmdlet, das die Tabelle entsprechend Ihren Änderungen aktualisiert.

### Beispiel 2: Ändern der Route
...
Der erste Befehl ruft die Routentabelle mit dem Namen "rtName" ab und speichert sie in der $rt Variable.
...
### -RouteTable
Gibt ein Routentabellesobjekt an, das den Zustand darstellt, auf den die Routentabelle festgelegt werden soll.
