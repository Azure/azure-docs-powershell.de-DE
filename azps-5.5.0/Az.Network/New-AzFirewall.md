...
### Beispiel 14: Erstellen einer Firewall mit EINEM DNS-Proxy und DNS-Servern
```powershell
$rgName = "resourceGroupName"
$vnet = Get-AzVirtualNetwork -ResourceGroupName $rgName -Name "vnet"
$pip = Get-AzPublicIpAddress -ResourceGroupName $rgName -Name "publicIpName"
...
### -PrivateRange
Die privaten IP-Bereiche, für die kein Datenverkehr vom SNAT verwendet wird
...
### -PublicIpAddress
Mindestens eine öffentliche IP-Adresse. Die öffentlichen IP-Adressen müssen die Standard-SKU verwenden und derselben Ressourcengruppe wie die Firewall angehören.
