...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzRelayNamespace"** entfernt den Namespace aus der angegebenen Ressourcengruppe.
...
Entfernt den Namespace `TestNameSpace-Relay1` "Relay" aus der angegebenen Ressourcengruppe. `Default-ServiceBus-WestUS`
