...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzNotificationHubAuthorizationRule"** entfernt eine Sas (Shared Access Signature)-Autorisierungsregel aus einem Benachrichtigungshub.
Autorisierungsregeln verwalten den Zugriff auf Ihre Benachrichtigungshubs durch die Erstellung von Links als URIs, basierend auf unterschiedlichen Berechtigungsstufen.
...
Mit diesem Befehl wird die Autorisierungsregel "ListenRule" aus dem Benachrichtigungshub "ContosoExternalHub" entfernt.
