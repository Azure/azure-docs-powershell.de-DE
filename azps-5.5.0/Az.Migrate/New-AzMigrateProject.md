...
Methode zum Erstellen eines neuen Migrationprojekts.
...
Informationen zum Erstellen finden Sie im Abschnitt NOTES zu EIGENSCHAFTENeigenschaften und zum Erstellen einer Hashtabelle.
...
EIGENSCHAFT: <IMigrateProjectProperties> Gibt die Projekteigenschaften an.
  - `[ProvisioningState <ProvisioningState?>]`: Bereitstellungszustand des Projekts "Migrieren".
  - `[RegisteredTool <String[]>]`: Ruft die Liste der Tools ab, die für das Projekt zum Migrieren registriert sind, oder legt sie fest.
