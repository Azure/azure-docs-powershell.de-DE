...
### Beispiel 1: Erstellen einer Zuordnung
```powershell
...
### -MappingName
Name der Schutzcontainerzuordnung.
...
Anbieterspezifische Eingabe für die Kopplung.
...
Der Name des eindeutigen Zielschutzescontainers.
...
PROVIDERSPECIFICINPUT <IReplicationProviderSpecificContainerMappingInput> : Anbieterspezifische Eingabe für die Kopplung.
