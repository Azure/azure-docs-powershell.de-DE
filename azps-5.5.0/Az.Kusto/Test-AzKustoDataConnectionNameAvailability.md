...
### Beispiel 1: Überprüfen der Verfügbarkeit eines Datenverbindungsnamens, der verwendet wird
```powershell
...
Der oben aufgeführte Befehl gibt zurück, ob eine Datenverbindung mit dem Namen "mykustodataconnection" in der Datenbank "mykustodatabase" vorhanden ist.

### Beispiel 2: Überprüfen der Verfügbarkeit eines nicht verwendeten Datenverbindungsnamens
```powershell
...
Der oben aufgeführte Befehl gibt zurück, ob eine Datenverbindung mit dem Namen "mydataconnection" in der Datenbank "mykustodatabase" vorhanden ist.
...
### -Type
Der Ressourcentyp "Microsoft.Kusto/Cluster/Databases/dataConnections".
