...
### Beispiel 1: Erstellen einer neuen Datenbank in Kusto nach Namen
```powershell
...
Mit dem oben angegebenen Befehl wird eine neue "kusto"-Datenbank mit dem Namen "mykustodatabase" im vorhandenen Cluster "testnewkustocluster" erstellt, der in der Ressourcengruppe "testrg" gefunden wurde.
