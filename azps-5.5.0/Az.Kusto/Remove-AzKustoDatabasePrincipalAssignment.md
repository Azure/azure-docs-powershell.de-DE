...
### Beispiel 1: Löschen einer vorhandenen PrincipalAssignment für eine Kusto-Datenbank nach Name
```powershell
...
Der obige Befehl löscht das PrincipalAssignment namens "kustoprincipal1" in der "mykustodatabase" der Kusto-Datenbank.
