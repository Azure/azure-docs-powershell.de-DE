...
## BESCHREIBUNG
Aktualisiert eine vorhandene Verpflichtungsplanressource. Beachten Sie, dass die meisten Eigenschaften des Verpflichtungsplans unveränderlich sind und nicht geändert werden können. Zu den Eigenschaften, die geändert werden können, gehören SKU (sodass Sie den Verpflichtungsplan von einer SKU zu einer anderen migrieren können) und Tags.

## BEISPIELE

### Beispiel 1: Aktualisieren eines Verpflichtungsplans
```
...
### -Sku1
Die Kapazität der SKU, die beim Aktualisieren des Azure ML-Verpflichtungsplans verwendet werden kann.
...
### -SkuName
Der Name der SKU, die beim Aktualisieren des Azure ML-Verpflichtungsplans verwendet werden soll.
...
### -SkuTier
Die Stufe der SKU, die beim Aktualisieren des Azure ML-Verpflichtungsplans verwendet werden soll.
...
### -Tag
Tags für die Ressourcen des Verpflichtungsplans.
