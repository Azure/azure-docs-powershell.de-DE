...
### Beispiel 2: Aktualisieren auf Grundlage einer Webdienstinstanz
```
...
### -Keys
Aktualisiert einen oder beide der Zugriffstasten, mit deren Hilfe Aufrufe an die Laufzeit-APIs des Diensts authentifiziert werden.
