...
### Beispiel 1: Neustarten der Rolleninstanz eines Clouddiensts
```powershell
PS C:\> Restart-AzCloudService -ResourceGroupName "ContosOrg" -CloudServiceName "ContosoCS" -RoleInstanceName "ContosoFrontEnd_IN_0"
```

Mit diesem Befehl wird die Rolleninstanz mit ContosoFrontEnd_IN_0 des Clouddiensts "ContosoCS" neu gestartet, der zur Ressourcengruppe "ContosOrg" gehört.
