...
### Beispiel 1: Entfernen einer Clouddienstrolleinstanz
```powershell
PS C:\> Remove-AzCloudServiceInstance -ResourceGroup "ContosOrg" -CloudServiceName "ContosoCS" -RoleInstance "ContosoFrontEnd_IN_0"
```

Mit diesem Befehl wird die Rolleninstanz namens ContosoFrontEnd_IN_0 des Clouddiensts "ContosoCS" entfernt, der zur Ressourcengruppe "ContosOrg" gehört.
