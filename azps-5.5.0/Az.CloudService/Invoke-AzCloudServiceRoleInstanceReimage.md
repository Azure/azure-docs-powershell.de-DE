...
### Beispiel 1: Neubilden der Rolleninstanz eines Clouddiensts
```powershell
...
Dieser Befehl reimages rolleninstanz namens ContosoFrontEnd_IN_0 des Clouddiensts "ContosoCS", der zur Ressourcengruppe "ContosOrg" gehört.
