...
### Beispiel 1: Neubilden von Rolleninstanzen des Clouddiensts
```powershell
...
Dieser Befehl reimages 2 Rolleninstanzen ContosoFrontEnd_IN_0 und ContosoBackEnd_IN_1 des Clouddiensts "ContosoCS", der zur Ressourcengruppe "ContosOrg" gehört.

### Beispiel 2: Neuimagen aller Rollen des Clouddiensts
```powershell
PS C:\> Invoke-AzCloudServiceReimage -ResourceGroupName "ContosOrg" -CloudServiceName "ContosoCS" -RoleInstance "*"
```

Dieser Befehl reimages alle Rolleninstanzen des Clouddiensts "ContosoCS", der zur Ressourcengruppe "ContosOrg" gehört.
