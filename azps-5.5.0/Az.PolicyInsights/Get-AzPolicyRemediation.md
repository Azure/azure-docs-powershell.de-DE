...
## BESCHREIBUNG
Das **Cmdlet "Get-AzPolicyRemediation"** ruft alle Richtlinienbehebungen in einem Bereich oder einer bestimmten Wartung ab.

## BEISPIELE

### Beispiel 1: Alle Richtlinienbehebungen im aktuellen Abonnement erhalten
```
PS C:\> Select-AzSubscription -Subscription "My Subscription"
PS C:\> Get-AzPolicyRemediation
```

Dieser Befehl ruft alle Korrekturen ab, die bei oder unter einem Abonnement mit dem Namen "Mein Abonnement" erstellt wurden.

### Beispiel 2: Erhalten einer bestimmten Richtlinienbehebung und der Bereitstellungsdetails
```
PS C:\> Get-AzPolicyRemediation -ResourceGroupName "myResourceGroup" -Name "remediation1" -IncludeDetail
```

Dieser Befehl ruft die Wartung mit dem Namen 'remediation1' aus der Ressourcengruppe 'myResourceGroup' ab. Die Details der ressourcen, die behoben werden sollen, werden einbezogen.

### Beispiel 3: Erhalten von 10 Richtlinienbehebungen in einer Verwaltungsgruppe mit optionalen Filtern
```
...
Dieser Befehl ruft maximal 10 Richtlinienbehebungen von einer Verwaltungsgruppe namens "mg1" ab. Es werden nur Richtlinienbehebungen für die angegebene Richtlinienzuweisung abgerufen.
...
### -IncludeDetail
Fügen Sie Details zu den Bereitstellungen ein, die durch die Wartung erstellt wurden.
...
### -Scope
Umfang der Ressource. Beispiel: '/subscriptions/{subscriptionId}/resourceGroups/{rgName}'.
