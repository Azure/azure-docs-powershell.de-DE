...
## BESCHREIBUNG
Das **Cmdlet "Get-AzDataShareProviderSubscription"** ruft auf Anbieterseite Informationen zu Abonnements für Endverbraucher ab. Wenn Sie die Untergeordnete Freigabe-ID angeben, ruft dieses Cmdlet Informationen zum Freigabeabonnement ab. Wenn Sie die ID für das Freigabeabonnement nicht angeben, ruft dieses Cmdlet Informationen zu allen Abonnements für Consumer Share ab, die der Freigabe zugeordnet sind.
...
Diese Befehle enthalten Informationen über das Abonnement für die Freigabe von Endverbrauchern, das der Freigabe von AdsShare im WikiAds des Datenfreigabekontos zugeordnet ist.

## PARAMETERS

### -AccountName
Azure DataShare-Kontoname.
...
### -ResourceGroupName
Die Ressourcengruppe des Azure DataShare-Kontos.
...
### -ResourceId
Die Ressourcen-ID der Freigabe
...
### -ShareSubscriptionId
Die ID des Abonnements für Verbraucherfreigaben
