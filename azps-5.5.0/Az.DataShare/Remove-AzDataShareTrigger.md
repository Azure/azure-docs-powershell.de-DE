...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzDataShareTrigger"** entfernt einen Datenfreigabetrigger.
...
Mit diesen Befehlen wird ein Trigger mit dem Namen "AdsTrigger" aus dem AdsShareSubscription-Freigabeabonnement entfernt. 
...
### -ResourceId
Die Ressourcen-ID des Azure Data Share Triggers
