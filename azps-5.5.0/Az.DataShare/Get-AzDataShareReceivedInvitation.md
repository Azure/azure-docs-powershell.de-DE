...
## BESCHREIBUNG
Das **Cmdlet "Get-AzDataShareReceivedInvitation"** enthält Informationen zu allen Einladungen, die der Verbraucher erhalten hat. Wenn Sie einen Ort oder eine Einladungs-ID bereitstellen, enthält dieses Cmdlet Informationen zu Einladungen an einem bestimmten Ort oder über die Einladungs-ID. Andernfalls wird eine Liste der Einladungen angezeigt, die an den Verbraucher gesendet wurden.
...
Dieser Commant stellt Informationen zu Einladungen von Endverbrauchern zur Verfügung.
...
### -Location
Speicherort für Einladungen zur Freigabe von Azure-Daten.
