...
### Beispiel 1: Entfernen der PostgreSql-Firewallregel nach Name
```powershell
...
Dieses Cmdlet entfernt die PostgreSql-Firewallregel nach Name.

### Beispiel 2: Entfernen der PostgreSql-Firewallregel nach Identität
```powershell
...
Diese Cmdlets entfernen die PostgreSql-Firewallregel nach Identität.
