...
INPUTOBJECT <IServerAutoGenerated> : Der Server für die Verbindungszeichenfolge
  ...
  - `[AdministratorLoginPassword <String>]`: Das Administratoranmeldungskennwort (für die Servererstellung erforderlich).
  ...
  - `[HaEnabled <HaEnabledEnum?>]`: Wert für "Anzahl der Zählungen" kann aktiviert oder deaktiviert werden
  ...
  - `[PropertiesTag <IServerPropertiesTags>]`: Anwendungsspezifische Metadaten in Form von Schlüssel-Wert-Paaren.
    - `[(Any) <String>]`: Dies gibt an, dass diesem Objekt beliebige Eigenschaften hinzugefügt werden können.
  - `[SkuName <String>]`: Der Name der SKU, in der Regel Stufe + Familie + Kerne, z. B. Standard_D4s_v3.
  - `[SkuTier <SkuTier?>]`: Die Ebene der jeweiligen SKU, z. B. "Auftplatzierbar".
  - `[SourceServerName <String>]`: Der PostgreSQL-Quellservername, aus dem Sie wiederherstellen möchten.
