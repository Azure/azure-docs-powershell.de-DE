...
Testverbindung durch die Ressourcengruppe und den Servernamen
...
### -DatabaseName
Der Name der zu verbindende Datenbank.
...
### -InputObject
Der Server, auf dem die Verbindung hergestellt werden soll.
...
### -Name
Der Name des Servers, auf den die Verbindung hergestellt werden soll.
...
INPUTOBJECT <IPostgreSqlIdentity> : Der Server, auf dem eine Verbindung hergestellt werden soll.
