...
### Beispiel 1: Aktualisieren des PostgreSqlservers nach Ressourcengruppe und Servername
```powershell
...
Mit diesem Cmdlet wird der Server von PostgreSql nach Ressourcengruppe und Servername aktualisiert.

### Beispiel 2: Aktualisieren des PostgreSql-Servers nach Identität.
```powershell
...
Dieses Cmdlet aktualisiert den PostgreSql Server nach Identität.
...
Der Standardwert ist "TLSEnforcementDisabled.accepted": TLS1_0, TLS1_1, TLS1_2, TLSEnforcementDisabled.
...
### -Sku1
Die Skalierungs-/Outkapazität, die die Recheneinheiten des Servers darstellt.
...
### -SkuTier
Die Stufe der jeweiligen SKU, z. B. "Standard".
