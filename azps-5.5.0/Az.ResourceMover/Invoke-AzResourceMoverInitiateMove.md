...
Überprüfen Sie die Abhängigkeiten, bevor Sie das Verschieben für die Ressourcen initiieren.

### Beispiel 2: Initiieren des Verschiebens für die Gruppe von Ressourcen in der Sammlung "Verschieben" mit "MoveResource-Name" als Eingabe
```powershell
