...
### Beispiel 2: Initiieren der Vorbereitung für die Gruppe von Ressourcen in der Sammlung "Verschieben" mithilfe von "MoveResource-Name" als Eingabe
```powershell
...
Initiieren Sie die Vorbereitung auf die Gruppe von Ressourcen in der Sammlung "Verschieben", indem Sie "MoveResource-Name" als Eingabe verwenden.
...
Initiieren Sie die Vorbereitung für die Gruppe von Ressourcen in der Sammlung "Verschieben" mit "SourceARMID".
