...
## BESCHREIBUNG
Das Remove-AzDataMigrationService cmdlet entfernt eine Instanz des Azure-Datenbankmigrationsdiensts aus Azure. Durch das Bereitstellen des Parameters "DeleteRunningTask" werden alle Azure Database Migration Service-Aufgaben entfernt, die dem Dienst zugeordnet sind, der entfernt wird. 
...
Im vorstehenden Beispiel wird eine Instanz des Azure-Datenbankmigrationsdiensts namens TestService entfernt, die in einer Azure-Ressourcengruppe namens "MyResourceGroup" enthalten ist.
...
### -Name
Der Name des Datenbankmigrationsdiensts.
