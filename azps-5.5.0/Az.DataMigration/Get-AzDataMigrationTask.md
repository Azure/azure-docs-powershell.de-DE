...
## BESCHREIBUNG
Das Get-AzDataMigrationTask ruft die Eigenschaften ab, die einer Migrationsaufgabe des Azure Database Migration Service zugeordnet sind.
...
Das oben gezeigte Beispiel veranschaulicht die Verwendung des Cmdlets Get-AzDataMigrationTask Zum Abrufen der Eigenschaften, die einer Migrationsaufgabe des Azure Database Migration Service zugeordnet sind, basierend auf dem Aufgabennamen, der als Eingabeparameter übergeben wird.
...
Das beispiel oben veranschaulicht die Verwendung des Get-AzDataMigrationTask-Cmdlets zum Abrufen aller Migrationsaufgaben, die mit dem als Eingabeparameter übergebenen "PSProject"-Objekt verknüpft sind.
...
### -ResultType
Erweitern der Ausgabe eines bestimmten Ergebnistyps
