...
## BESCHREIBUNG
Das **Cmdlet "New-AzIntegrationAccountAgreement"** erstellt eine Vereinbarung für ein Integrationskonto.
Dieses Cmdlet gibt ein Objekt zurück, das die Vereinbarung für das Integrationskonto darstellt.
Geben Sie den Namen des Integrationskontos, den Namen der Ressourcengruppe, den Namen des Vertrags, den Typ, den Partnernamen, Partnerqualifizierer und Vertragsinhalte an.
...
### Beispiel 1: Erstellen eines Vertrags für ein Integrationskonto
```powershell
...
Mit diesem Befehl wird eine Vereinbarung für ein Integrationskonto in der angegebenen Azure-Ressourcengruppe erstellt.

### Beispiel 2

Erstellt einen Integrationskontovertrag. (automatisch generiert)
...
### -AgreementContent
Gibt Vertragsinhalt im JavaScript Object Notation (JSON)-Format für den Vertrag an.
Geben Sie entweder diesen Parameter oder den *Parameter "AgreementContentFilePath"* an.
...
Gibt den Dateipfad des Vertragsinhalts für den Vertrag an.
Geben Sie entweder diesen Parameter oder den *Parameter "AgreementContent"* an.
...
### -AgreementName
Gibt einen Namen für den Vertrag für das Integrationskonto an.
...
### -AgreementType
Gibt den Typ des Vertrags für das Integrationskonto an. Die zulässigen Werte für diesen Parameter sind:
- X12 
- AS2
- Edifact
...
Gibt einen Namensidentitätsqualifizierer für den Gastpartner an.
...
Der Wert für den Gastidentitätsqualifizierer für den Integrationskontovertrag.
...
### -GuestPartner
Gibt den Namen des Gastpartners an.
...
Gibt einen Namensidentitätsqualifizierer für den Hostpartner an.
...
Der Hostidentitätsqualifiziererwert für den Integrationskontovertrag.
...
### -HostPartner
Gibt den Namen des Hostpartners an.
...
### -Metadata
Gibt ein Metadatenobjekt für die Vereinbarung an.
