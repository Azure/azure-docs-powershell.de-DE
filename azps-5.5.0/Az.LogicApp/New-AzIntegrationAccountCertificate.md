...
## BESCHREIBUNG
Das **Cmdlet "New-AzIntegrationAccountCertificate"** erstellt ein Integrationskontozertifikat.
Dieses Cmdlet gibt ein Objekt zurück, das das Zertifikat des Integrationskontos darstellt.
Geben Sie den Namen des Integrationskontos, den Namen der Ressourcengruppe, den Zertifikatnamen, den Schlüsselnamen, die Schlüsselversion und die Schlüsseltresor-ID an.
...
### Beispiel 1: Erstellen eines Zertifikats für ein Integrationskonto
```
...
Mit diesem Befehl wird das Zertifikat für das Integrationskonto in der angegebenen Ressourcengruppe erstellt.

## PARAMETERS

### -CertificateName
Gibt einen Namen für das Zertifikat für das Integrationskonto an.
