...
## BESCHREIBUNG
Das **Cmdlet "Set-AzIntegrationAccount"** ändert ein Integrationskonto.
Dieses Cmdlet gibt ein Objekt zurück, das das Integrationskonto darstellt.
...
### Beispiel 1: Ändern eines Integrationskontos
```
...
Mit diesem Befehl wird ein Integrationskonto namens "IntegrationAccount31" in der angegebenen Ressourcengruppe geändert.
