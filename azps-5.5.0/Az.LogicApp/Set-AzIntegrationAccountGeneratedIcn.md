...
## BESCHREIBUNG
Das Set-AzIntegrationAccountGeneratedIcn-Cmdlet aktualisiert ein vorhandenes, für ein Integrationskonto generiertes Interchange Control Number (ICN) und gibt ein Objekt zurück, das die generierte Austauschsteuerelementnummer des Integrationskontos darstellt.
Verwenden Sie dieses Cmdlet, um die generierte Austauschsteuerelementnummer eines Integrationskontos zu aktualisieren.
Sie können die generierte Nummer eines Austauschsteuerelements für ein Integrationskonto aktualisieren, indem Sie den Namen des Integrationskontos, den Namen der Ressourcengruppe und den Namen des Vertrags angeben.
