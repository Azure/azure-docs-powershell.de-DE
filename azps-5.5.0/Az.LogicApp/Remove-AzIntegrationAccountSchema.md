...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzIntegrationAccountSchema"** entfernt ein Schema für ein Integrationskonto aus einer Ressourcengruppe.
...
### Beispiel 1: Entfernen eines Schemas für ein Integrationskonto
```
...
Mit diesem Befehl wird das Schema eines Integrationskontos namens "IntegrationAccountSchema43" entfernt.
