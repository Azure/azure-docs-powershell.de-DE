...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzIntegrationAccountCertificate"** entfernt ein Integrationskontozertifikat aus einer Ressourcengruppe.
...
### Beispiel 1: Entfernen eines Zertifikats für ein Integrationskonto
```
...
Mit diesem Befehl wird das Zertifikat für das Integrationskonto namens "IntegrationAccount31" entfernt.
