...
## BESCHREIBUNG
Mit **dem Cmdlet "Remove-AzLogicApp"** wird eine Logik-App mithilfe des Features "Logik-Apps" aus einer Ressourcengruppe entfernt.
...
Mit diesem Befehl wird eine Logik-App aus einer Ressourcengruppe entfernt.
Der Befehl enthält den *Force-Parameter,* der verhindert, dass Sie vom Befehl zur Bestätigung aufgefordert werden.
...
### -Name
Gibt den Namen der Logik-App an, die von diesem Cmdlet entfernt wird.
