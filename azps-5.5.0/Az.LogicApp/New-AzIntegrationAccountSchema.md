...
Geben Sie den Namen des Integrationskontos, den Namen der Ressourcengruppe, den Schemanamen und die Schemadefinition an.
...
### Beispiel 1: Erstellen des Schemas für das Integrationskonto
```
...
Mit diesem Befehl wird das Schema für das Integrationskonto namens "IntegrationAccountSchema1" in der angegebenen Ressourcengruppe erstellt.
...
### -SchemaName
Gibt einen Namen für das Schema des Integrationskontos an.
