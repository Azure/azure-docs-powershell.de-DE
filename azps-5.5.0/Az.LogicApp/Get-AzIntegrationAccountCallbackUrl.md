...
## BESCHREIBUNG
Das **Cmdlet "Get-AzIntegrationAccountCallbackUrl"** ruft eine Rückruf-URL für das Integrationskonto aus einer Ressourcengruppe ab.
Dieses Cmdlet gibt ein **CallbackUrl-Objekt** zurück, das die Rückruf-URL des Integrationskontos darstellt.
Geben Sie den Namen des Integrationskontos und den Namen der Ressourcengruppe an.
...
### Beispiel 1: Aufrufen der Rückruf-URL für ein Integrationskonto
```
...
Dieser Befehl ruft eine Rückruf-URL für das Integrationskonto ab.
