...
Erstellt einen Ereignishubs-Namespace "MyNamespaceName" am angegebenen geografischen Standort "MyLocation", in der Ressourcengruppe \` \` \` \` \` "MyResourceGroupName" mit \` "Kafka" und "AutoInflate" aktiviert.
