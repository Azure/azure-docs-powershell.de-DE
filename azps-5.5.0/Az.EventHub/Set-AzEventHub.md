...
Aktualisiert den Vom \` MyEventHubName des \` \` MyCreatedEventHub-Objekts dargestellten Ereignishub, indem \` die Eigenschaften "CaptureDescription" festgelegt werden.
...
Aktualisiert den Ereignishub MyEventHubName, der durch das \` \` \` MyCreatedEventHub-Objekt dargestellt wird, und setzt den Aufbewahrungszeitraum für Nachrichten auf 4 Tage und die Anzahl der Partitionen auf \` 2.
