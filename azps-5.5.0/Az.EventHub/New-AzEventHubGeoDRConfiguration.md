...
## BESCHREIBUNG
Das **Cmdlet "New-AzEventHubGeoDRConfiguration"** erstellt einen neuen Alias (Notfallwiederherstellungskonfiguration)
...
Erstellt einen Alias "SampleDRConfigName" mit dem primären Namespace "SampleNamespace_Primary" mit dem sekundären Namespace "SampleNamespace_Secondary"

## PARAMETERS

### -AlternateName
AlternateName erforderlich, wenn der Name der Dr-Konfiguration mit dem primären Namespace identisch ist
