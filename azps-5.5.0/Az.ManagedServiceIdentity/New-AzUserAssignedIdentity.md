...
Um der Identität Azure Resource Manager-Tags hinzuzufügen, verwenden Sie das Set-AzResource Cmdlet.

## BEISPIELE

### Beispiel 1
Dieses Beispiel-Cmdlet erstellt eine neue "Benutzer zugewiesene Identität" mit der **Namen-ID1** unter **"Ressourcengruppe PSRG"** am Speicherort der Ressourcengruppe.
...
### Beispiel 2
Mit diesem Beispiel-Cmdlet wird unter der Ressourcengruppe **"PSRG"** in der Region "westus" eine neue "Benutzer zugewiesene Identität" mit der **Namen-ID1** erstellt.
