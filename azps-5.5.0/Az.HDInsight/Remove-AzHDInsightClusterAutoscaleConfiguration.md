...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzHDInsightClusterAutoscaleConfiguration"** entfernt die Autoskalenkonfiguration des HDInsight-Cluster.

## BEISPIELE

### Beispiel 1: Entfernen der Autoskalenkonfiguration des Cluster "HDInsight".
```powershell
...
Mit diesem Befehl wird die Konfiguration der Automatischskala des Cluster "HDInsight" entfernt.
