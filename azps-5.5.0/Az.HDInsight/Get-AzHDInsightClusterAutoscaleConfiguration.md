...
## BESCHREIBUNG
Das **Cmdlet "Get-AzHDInsightClusterAutoscaleConfiguration"** ruft die Autoskalenkonfiguration des Cluster "HDInsight" ab.

## BEISPIELE

### Beispiel 1: Holen Sie sich die Konfiguration der Automatischskala des HDInsight-Cluster.
```powershell
...
Dieser Befehl ruft die Konfiguration der Automatischskala des Cluster "HDInsight" ab.
