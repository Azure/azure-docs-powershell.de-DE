...
Mit dem zweiten Befehl wird ein Azure-Endpunkt namens "contoso" aus dem profil entfernt, das in der $TrafficManagerProfile.
Mit diesem Befehl wird nur das lokale Objekt geändert.

Der letzte Befehl aktualisiert das Datenverkehrs-Manager-Profil mit dem Namen ContosoProfile so, dass es dem lokalen Wert in $TrafficManagerProfile.
