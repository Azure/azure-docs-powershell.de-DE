...
## Beschreibung
In den Themen in diesem Abschnitt werden die Azure -PowerShell-Cmdlets für Azure Data Lake Store im Azure Resource Manager -Framework (ARM) dokumentiert. Die Cmdlets sind im Namespace "Microsoft.Azure.Commands.DataLakeStore" vorhanden. Diese Cmdlets funktionieren nur mit Azure Data Lake Storage Gen1-Konten.
...
Versucht, einen vom Benutzer verwalteten Schlüsseltresor für die Verschlüsselung des angegebenen Data Lake Store-Kontos zu aktivieren.
...
Ruft die Oktalberechtigung für eine Datei oder einen Ordner im Data Lake Store ab.
...
Löscht ein Data Lake Store-Konto endgültig.

### [Remove-AzDataLakeStoreFirewallRule](Remove-AzDataLakeStoreFirewallRule.md)
Entfernt die angegebene Firewallregel im angegebenen Data Lake Store.
...
Die ACL einer Datei oder eines Ordners im Data Lake Store wird entfernt.
...
Entfernt die angegebene Virtuelle Netzwerkregel im angegebenen Data Lake Store.
...
Ändert die angegebene Firewallregel im angegebenen Data Lake Store.
...
Ändert die Oktalberechtigung einer Datei oder eines Ordners im Data Lake Store.
...
Überprüft das Vorhandensein eines Data Lake Store-Kontos.

### [Test-AzDataLakeStoreItem](Test-AzDataLakeStoreItem.md)
Überprüft das Vorhandensein einer Datei oder eines Ordners im Data Lake Store.
