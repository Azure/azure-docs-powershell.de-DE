...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzDataLakeStoreItemAcl"** löscht die Zugriffssteuerungsliste (Access Control List, ACL) einer Datei oder eines Ordners im Data Lake Store.
...
Mit diesem Befehl wird die ACL für das Stammverzeichnis für das Konto ContosoADL entfernt.
...
### -Path
Gibt den Data Lake Store-Pfad des Elements an, beginnend mit dem Stammverzeichnis (/).
