...
Mit diesem Befehl wird die TestSource.csv aus dem Data Lake Store in C:\Test.csv mit der Parallelität 4 heruntergeladen.
...
### -Parallelität
Gibt die Anzahl der Dateien oder Abschnitte an, die parallel heruntergeladen werden sollen. Der Standardwert wird als beste Leistung basierend auf den Systemspezifikationen berechnet.
...
Dies verursacht, dass das System versucht, aus der letzten Datei, die nicht vollständig heruntergeladen wurde, fortgesetzt zu werden.
