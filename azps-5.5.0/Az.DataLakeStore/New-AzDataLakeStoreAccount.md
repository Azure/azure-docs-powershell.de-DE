...
Mit diesem Befehl wird ein Data Lake Store-Konto mit dem Namen ContosoADL für den Standort "Ost US 2" erstellt.

## PARAMETERS

### -DefaultGroup
Gibt die Objekt-ID der Gruppe "AzureActive Directory" an, die als Standardgruppenbesitzer für neue Dateien und Ordner verwendet werden soll.
...
### -Location
Gibt den Für das Konto zu verwendenden Speicherort an.
