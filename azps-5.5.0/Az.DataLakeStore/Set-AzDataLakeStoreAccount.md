...
## BESCHREIBUNG
Das **Cmdlet "Set-AzDataLakeStoreAccount"** ändert ein Data Lake Store-Konto.

## BEISPIELE

### Beispiel 1: Hinzufügen einer Markierung zu einem Konto
```powershell
PS C:\>Set-AzDataLakeStoreAccount -Name "ContosoADL" -Tags @{"stage"="production"}
```

Mit diesem Befehl wird dem Data Lake Store-Konto mit dem Namen ContosoADL das angegebene Tag hinzufügt.

### Beispiel 2

Ändert ein Data Lake Store-Konto. (automatisch generiert)
...
### -DefaultGroup
Gibt die ID einer AzureActive Directory-Gruppe an.
...
### -KeyVersion
Wenn der Verschlüsselungstyp dem Benutzer zugewiesen ist, kann der Benutzer seine Schlüsselversion mit diesem Parameter drehen.
...
Sie können Tags verwenden, um ein Data Lake Store-Konto aus anderen Azure-Ressourcen zu identifizieren.
