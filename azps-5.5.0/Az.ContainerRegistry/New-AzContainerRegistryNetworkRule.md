...
## BESCHREIBUNG
Erstellen Sie ein Netzwerkregelobjekt in der aktuellen Powershell-Sitzung.
...
Erstellen Sie einen virtuellen Netzwerkregelsatz.

## PARAMETERS

### -Aktion
Die Aktion einer Netzwerkregel.
...
Nur die IPV4-Adresse ist zulässig.
...
### -IPRule
Angeben, dass "IPRule" erstellt wird.
...
### -VirtualNetworkRule
Geben Sie an, dass VirtualNetworkRule erstellt wird.
