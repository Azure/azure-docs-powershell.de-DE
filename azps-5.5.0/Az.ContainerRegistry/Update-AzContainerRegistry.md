...
## BESCHREIBUNG
Das Update-AzContainerRegistry aktualisiert eine Containerregistrierung.
...
### Beispiel 2: Festlegen des von einer angegebenen Containerregistrierung verwendeten Speicherkontos
```powershell
...
Mit diesem Befehl wird die angegebene Containerregistrierung so festgelegt, dass ein vorhandenes Speicherkonto \` "mystorageaccount" \` im selben Abonnement verwendet wird.
...
### -NetworkRuleSet
Die für eine Containerregistrierung festgelegte Netzwerkregel.
