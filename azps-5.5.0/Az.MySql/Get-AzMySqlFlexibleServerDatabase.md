...
### Beispiel 1: Erhalten einer MeineSql-Datenbank nach Ressourcenname
```powershell
...
Dieses Cmdlet ruft den Server "MySql" nach dem Ressourcennamen ab.

### Beispiel 2: Erhalten von MySql-Datenbanken nach Identität
```powershell
...
### Beispiel 3: Listet alle MeineSql-Datenbanken auf dem angegebenen Server auf.
```powershell
...
Dieses Cmdlet listet alle MySql-Server auf, die den Server angegeben haben.
