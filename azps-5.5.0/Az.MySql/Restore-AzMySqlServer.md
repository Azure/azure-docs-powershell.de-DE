...
### Beispiel 1: Wiederherstellen eines Server in MySql mithilfe von GeoReplica Restore
```powershell
...
Dieses Cmdlet stellt den Server von MySql mithilfe von "GeoReplica Restore" wieder zum Einsatz.
...
Diese Cmdlets stellen den Server von MySql mithilfe der PointInTime Restore wieder zur Wiederherstellen.
