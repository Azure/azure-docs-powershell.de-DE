...
Dieses Cmdlet mit Parametermaster(eingabeobjekt) erstellt eine neue MySql-Serverreplikate.
...
### -Master
Das Quellserverobjekt, aus dem eine Replikaterstellung erstellt werden soll.
