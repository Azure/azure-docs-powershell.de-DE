...
### Beispiel 1: Neustarten des Servers nach Ressourcenname
```powershell
PS C:\> Restart-AzMySqlFlexibleServer -ResourceGroupName PowershellMySqlTest -Name mysql-test
```

Neustarten des Servers nach Name

### Beispiel 2: Neustarten des Servers nach Identität
```powershell
...
Neustarten des Servers nach Identität
