...
### Beispiel 1: Entfernen der MySql-Firewallregel nach Name
```powershell
PS C:\> Remove-AzMySqlFirewallRule -Name rule -ResourceGroupName PowershellMySqlTest -ServerName mysql-test

```

Mit diesem Cmdlet wird die MySql-Firewallregel nach Name entfernt.

### Beispiel 2: Entfernen der MySql-Firewallregel nach Identität
```powershell
...
Mit diesen Cmdlets wird die MySql-Firewallregel nach Identität entfernt.
