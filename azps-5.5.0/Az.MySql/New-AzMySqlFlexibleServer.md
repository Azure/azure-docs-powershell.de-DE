...
Dieses Cmdlet erstellt einen flexiblen MySql-Server mit Standardwerten, stellt den Server in einem neuen virtuellen Netzwerk zur Verfügung, und es wird ein Subnetz an den Server delegiert.
Die Standardwerte für den Speicherort sind "USA 2", "SKU" Standard_B1ms, "SKU-Stufe" ist "Burstable", und die Speichergröße ist "10GiB".
...
Dieses Cmdlet erstellt einen flexiblen MySql-Server, der mit angegebenen IP-Adressen geöffnet wird.
...
### -HighAvailability
Aktivieren oder Deaktivieren des Hochverfügbarkeitsfeatures
