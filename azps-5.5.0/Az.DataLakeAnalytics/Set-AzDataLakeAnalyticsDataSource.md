...
## BESCHREIBUNG
Das **Cmdlet "Set-AzDataLakeAnalyticsDataSource"** ändert die Details einer Datenquelle eines Azure Data Lake Analytics-Kontos.

## BEISPIELE

### Beispiel 1: Ändern des Zugriffsschlüssels für eine Datenquelle
```
PS C:\>Set-AzDataLakeAnalyticsDataSource -Account "ContosoAdlAccount" -Blob "contosowasb" -AccessKey "...newaccesskey..."
```

Mit diesem Befehl wird der Zugriffsschlüssel geändert, der für eine Azure Blob Storage-Datenquelle gespeichert ist.

## PARAMETERS

### -AccessKey
Gibt den neuen Zugriffsschlüssel der Azure Blob Storage-Datenquelle an.
