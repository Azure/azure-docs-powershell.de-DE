...
## BESCHREIBUNG
Das **Cmdlet "Add-AzDataLakeAnalyticsDataSource"** fügt einem Azure Data Lake Analytics-Konto eine Datenquelle hinzu.
...
Mit diesem Befehl wird eine Data Lake Store-Datenquelle zu einem Data Lake Analytics-Konto addiert.

### Beispiel 2

Fügt einem Data Lake Analytics-Konto eine Datenquelle hinzu. (automatisch generiert)
...
### -AccessKey
Gibt den Zugriffsschlüssel für das hinzuzufügende Azure-Blob-Speicherkonto an.
...
### -BLOB
Gibt den Namen des Azure Blob Storage-Kontos an, das hinzugefügt werden soll.
...
### -DataLakeStore
Gibt den Namen des hinzuzufügenden Azure Data Lake Store-Kontos an.
