...
### Beispiel 1: Erstellen eines neuen "DriveList"-Auftrags für "ImportExport"
```powershell
...
Diese Cmdlets erstellen einen neuen DriveList für ImportExport-Auftrag.

## PARAMETERS

### -BitLockerKey
Der Zum Verschlüsseln des Laufwerks verwendete BitLocker-Schlüssel.
...
### -CopyStatus
Detaillierter Status zum Datenübertragungsprozess.
Dieses Feld wird erst in der Antwort zurückgegeben, wenn sich das Laufwerk im Zustand "Übertragen" befindet.
...
### -DriveHeaderHash
Der Hashwert für die Laufwerkkopfzeile.
...
### -DriveId
Die Seriennummer des Laufwerks ohne Leerzeichen.
...
### -ErrorLogUri
Ein URI, der auf das BLOB verweist, das das Fehlerprotokoll für den Datenübertragungsvorgang enthält.
...
### -ManifestHash
Der base16-codierte #A0 der Manifestdatei auf dem Laufwerk.
...
### -ManifestUri
Ein URI, der auf das BLOB verweist, das die Laufwerkmanifestdatei enthält.
...
### -PercentComplete
Prozentsatz der Fertigstellung für das Laufwerk.
...
### -VerboseLogUri
Ein URI, der auf das BLOB verweist, das das ausführliche Protokoll für den Datenübertragungsvorgang enthält.
