...
## BESCHREIBUNG
Das New-AzAnalysisServicesServer A0 erstellt einen neuen Analysis Services-Server.
...
Erstellt einen Server mit dem Namen "Testserver" in der Azure-Region West-US und in der Ressourcengruppe "testresourcegroup". Die SKU-Ebene für den Server ist S1.
...
### -Administrator
Eine Zeichenfolge, die eine durch Kommas getrennte Liste der Benutzer oder Gruppen darstellt, die als Administratoren auf dem Server festgelegt werden sollen. Die Benutzer oder Gruppen müssen im UPN-Format angegeben werden, z. B. user@contoso.comgroups@contoso.com
