...
## BESCHREIBUNG
Das Remove-AzAnalysisServicesServer cmdlet löscht eine Instanz des Analysis Services-Servers.
...
Mit diesem Befehl wird der server benannte Testserver in der Testgruppe der Ressourcengruppe entfernt.
