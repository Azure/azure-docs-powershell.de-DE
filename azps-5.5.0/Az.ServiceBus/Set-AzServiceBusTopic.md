...
## BESCHREIBUNG
Das **Cmdlet "Set-AzServiceBusTopic"** aktualisiert ein Beschreibungsobjekt für ein Service Bus-Thema im angegebenen Namespace "Service Bus".
...
Aktualisiert das angegebene Thema mit einer neuen Beschreibung im angegebenen Namespace. In diesem Beispiel wird die **Eigenschaft "EnableExpress"** auf **"true" aktualisiert.** 
...
### -InputObject
Definition des ServiceBus-Themas.
