...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzServiceBusSubscription"** entfernt das Abonnement eines Themas aus dem angegebenen Namespace "Service Bus".
...
Entfernt das Abonnement `SB-TopicSubscription-Example1` des Themas `SB-Topic_exampl1` im angegebenen Namespace "Service `SB-Example1` Bus".

### Beispiel 2: InputObject – Verwenden der Variable:
```powershell
...
Entfernt das Abonnement, das über ARM-ID in $resourceid/Zeichenfolge für den Parameter "-ResourceId" bereitgestellt wurde. 
...
### -ResourceId
Ressourcen-ID des Service Busabonnements
