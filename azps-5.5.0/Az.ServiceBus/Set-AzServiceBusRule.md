...
## BESCHREIBUNG
Das **Cmdlet "Set-AzServiceBusRule"** aktualisiert die Beschreibung für die angegebene Regel des angegebenen Abonnements.
...
Aktualisiert den Sql-Ausdruck **"mysqlexpression='condition"** der Regel `SBRule` des Abonnements in `SBSubscription` "Topic". `SBTopic`
...
### -InputObject
Definition von ServiceBus-Regeln.
