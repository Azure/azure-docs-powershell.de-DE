...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzServiceBusQueue"** entfernt die Warteschlange aus dem angegebenen Service Bus-Namespace.
...
Entfernt die Service `SB-Queue_exampl1` Buswarteschlange aus dem `SB-Example1` Namespace.

### Beispiel 2: InputObject – Verwenden einer Variablen:
```powershell
PS C:\> $inputobject = Get-AzServiceBusQueue <params>
PS C:\> Remove-AzServiceBusQueue -InputObject $inputobject
```

Entfernt die service bus-Warteschlange, die im Parameter $inputobject "-InputObject" bereitgestellt wurde.

### Beispiel 3: InputObject – Verwenden der Piping:
```powershell
PS C:\>  Get-AzServiceBusQueue <params> | Remove-AzServiceBusQueue
```

### Beispiel 4: ResourceId – Verwenden einer Variablen:
```powershell
PS c:\> $resourceid = Get-AzServiceBusQueue <params>
PS C:\> Remove-AzServiceBusQueue -ResourceId $resourceid.Id
```

Entfernt die Service Buswarteschlange, die in der ARM-ID in $resourceid/Zeichenfolge für den Parameter "-ResourceId" angegeben ist.

### Beispiel 5: ResourceId – Übergeben als Zeichenfolge:
```powershell
...
### -ResourceId
Ressourcen-ID der Service Buswarteschlange
