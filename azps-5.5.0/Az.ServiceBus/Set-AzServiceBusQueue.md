...
## BESCHREIBUNG
Das **Cmdlet "Set-AzServiceBusQueue"** aktualisiert die Beschreibung für die Service Bus-Warteschlange im angegebenen Service Bus-Namespace.
...
Aktualisiert die angegebene Warteschlange mit einer neuen Beschreibung im angegebenen Namespace. In diesem Beispiel wird die **Eigenschaft "DeadOrderringOnMessageExpiration"** auf **"true"** und **"SupportOrdering"** auf **"true" aktualisiert.**
