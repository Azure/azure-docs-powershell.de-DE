...
## BESCHREIBUNG
Das **Cmdlet "New-AzServiceBusNamespace"** erstellt einen neuen Service Bus-Namespace. Sobald das Namespaceressourcenmanifest erstellt wurde, kann es unveränderlich sein. Dieser Vorgang ist "idempotent".
