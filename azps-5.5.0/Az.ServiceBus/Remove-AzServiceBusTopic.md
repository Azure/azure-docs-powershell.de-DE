...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzServiceBusTopic"** entfernt das Thema aus dem angegebenen Namespace "Service Bus".
...
Entfernt das Thema `SB-Topic_exampl1` aus dem `SB-Example1` Namespace.
...
### Beispiel 4: ResourceId mit Variable:
```powershell
PS C:\> $resourceid = Get-AzServiceBusTopic <params>
PS C:\> Remove-AzServiceBusTopic -ResourceId $resourceid.Id
```

### Beispiel 5: ResourceId mithilfe des Zeichenfolgenwerts
```powershell
...
### -ResourceId
Ressourcen-ID des Dienstbusthemas
