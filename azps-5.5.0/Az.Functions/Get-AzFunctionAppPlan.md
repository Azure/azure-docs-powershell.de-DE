...
### Beispiel 1: Alle Funktions-App-Pläne erhalten.
```powershell
...
Dieser Befehl ruft alle Funktions-App-Pläne ab.

### Beispiel 2: Erhalten von Funktions-App-Plänen nach dem Namen der Ressourcengruppe.
```powershell
...
Mit diesem Befehl werden Funktions-App-Pläne nach Dem Namen der Ressourcengruppe angezeigt.

### Beispiel 3: Erhalten von Funktions-App-Plänen für die angegebenen Abonnements.
```powershell
...
Dieser Befehl ruft Funktions-App-Pläne für die angegebenen Abonnements ab.

### Beispiel 4: Erhalten von Funktions-App-Plänen nach Ort.
```powershell
...
Dieser Befehl ruft Funktions-App-Pläne nach Ort ab.
...
### -Location
Die Position des Funktions-App-Plans.
