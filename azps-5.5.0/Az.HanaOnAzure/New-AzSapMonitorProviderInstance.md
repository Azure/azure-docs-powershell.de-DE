...
## SYNOPSIS
Erstellt eine Anbieterinstanz für das angegebene Abonnement, die angegebene Ressourcengruppe, den Namen von SapMonitor und den Ressourcennamen.
...
### Beispiel 1: Erstellen einer Instanz des SAP-Monitors nach Zeichenfolge für HANA
```powershell
...
Mit diesem Befehl wird eine Instanz des SAP Monitors nach Zeichenfolge für HANA erstellt.

### Beispiel 2: Erstellen einer Instanz des SAP-Monitors nach Schlüsseltresor für HANA
```powershell
...
Dieser Befehl erstellt eine Instanz des SAP-Monitors nach Schlüsseltresor für HANA.

### Beispiel 3: Erstellen einer Instanz des SAP-Monitors nach Wörterbuch für PrometheusHaCluster
```powershell
...
Mit diesem Befehl wird eine Instanz des SAP Monitor nach Wörterbuch für PrometheusHaCluster erstellt.

### Beispiel 4: Erstellen einer Instanz des SAP-Monitors nach Wörterbuch für PrometheusOS
```powershell
...
Dieser Befehl erstellt eine Instanz des SAP-Monitors nach Wörterbuch für PrometheusOS.

### Beispiel 5: Erstellen einer Instanz des SAP-Monitors nach Wörterbuch für MsSqlServer
```powershell
...
Dieser Befehl erstellt eine Instanz des SAP-Monitors nach Wörterbuch für MsSqlServer.

### Beispiel 6: Erstellen einer Instanz des SAP-Monitors nach Wörterbuch für SapHana
```powershell
...
Dieser Befehl erstellt eine Instanz des SAP-Monitors nach Wörterbuch für SapHana.
...
### -HanaDatabaseName
Der Datenbankname der SAP HANA-Instanz.
...
Das Kennwort der Datenbank der SAP HANA-Instanz.
...
Ressourcen-ID des Schlüsseltresor, der die HANA-Anmeldeinformationen enthält.
...
Geheimer Bezeichner des geheimen Schlüsseltresor, der die HANA-Anmeldeinformationen enthält.
...
### -HanaDatabaseSqlPort
Der SQL Port der Datenbank der SAP HANA-Instanz.
...
Der Benutzername der Datenbank der SAP HANA-Instanz.
...
### -HanaHostname
Der Hostname der SAP HANA-Instanz.
...
### -InstanceProperty
Die Eigenschaft der HANA-Instanz.
...
Unterstützte Werte sind: "SapHana".
