...
### Beispiel 1: Entfernen der Instanz des SAP Monitor nach Name
```powershell
PS C:\> Remove-AzSapMonitorProviderInstance -ResourceGroupName nancyc-hn1 -SapMonitorName ps-spamonitor-t01 -Name ps-sapmonitorins-t02

```

Mit diesem Befehl wird die Instanz des SAP Monitor nach Name entfernt.

### Beispiel 2: Entfernen der Instanz eines SAP Monitor nach Objekt
```powershell
...
Mit diesem Befehl wird die Instanz des SAP Monitor nach Objekt entfernt.
