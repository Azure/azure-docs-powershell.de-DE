...
## BESCHREIBUNG
Entfernen Sie eine Blaupause, die einem Abonnement zugewiesen wurde.
...
Entfernen Sie die mit dem Namen angegebene Blaupausenzuweisung aus dem angegebenen Abonnement. Das Cmdlet fordert vor dem Ausführen des Befehls zur Bestätigung auf.
...
### -PassThru
Wenn dies festgelegt ist, gibt das Cmdlet ein Objekt zurück, das die entfernte "Blueprint"-Zuweisung darstellt. Standardmäßig generiert dieses Cmdlet keine Ausgabe.
