...
## BESCHREIBUNG
Das **Cmdlet "New-AzHpcCacheStorageTarget"** fügt dem Azure -HPC-Cache ein Speicherziel hinzu.
...
### -Force
Zeigt an, dass sie vom Cmdlet nicht zur Bestätigung aufgefordert werden. Dieses Cmdlet fordert Sie standardmäßig auf zu bestätigen, dass Sie den Cache leeren möchten.
...
### -ResourceGroupName
"Name der Ressourcengruppe, unter der Sie ein Speicherziel für einen bestimmten Cache erstellen möchten.
