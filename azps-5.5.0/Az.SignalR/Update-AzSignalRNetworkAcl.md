...
## SYNOPSIS
Aktualisieren Sie die Netzwerk-ACL eines SignalR-Diensts.
...
## BESCHREIBUNG
Aktualisieren Sie die Netzwerk-ACL eines SignalR-Diensts, einschließlich der Standardaktion und der Netzwerk-Acls für öffentliche und private Verbindungen.

## BEISPIELE

### RESTAPI zulassen, ClientConnection für öffentliches Netzwerk und Standardaktion auf "Verweigern" festlegen
```powershell
...
### Clientverbindung und Serververbindung für eine private Endpunktverbindung zulassen
```powershell
...
### Clientverbindung für öffentliches Netzwerk und private Endpunktverbindung verweigern
```powershell
...
### -DefaultAction
Standardaktion von SignalR-Netzwerk-ACLs, entweder zulassen oder verweigern. Es entscheidet, ob Netzwerk-ACLs verweigert oder Netzwerk-ACLs wirksam werden. Wenn beispielsweise die Standardaktion zulässig ist, kommt es nur auf die Verweigern-ACLs an.
...
### -PrivateEndpointName
Namen der privaten Endpunkte, die aktualisiert werden sollen
...
Die Standardeinstellung wird verwendet, wenn sie nicht angegeben wird.
