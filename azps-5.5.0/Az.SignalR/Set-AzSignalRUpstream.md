...
Der folgende JSON stellt die tatsächlichen Vorlagen dar. 
...
[So wird's ausgeführt: Verwenden der Plattform zum Übergeben von Parametern an Befehle in PowerShell](https://docs.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_splatting?view=powershell-7)
