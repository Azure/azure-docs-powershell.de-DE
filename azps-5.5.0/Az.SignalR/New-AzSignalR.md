...
## BESCHREIBUNG
Erstellen Sie einen SignalR-Dienst.
Die folgenden Werte werden für die Parameter verwendet, wenn diese nicht angegeben werden:
* `ResourceGroupName`: die standardmäßige Ressourcengruppe, die von `Set-AzDefault -ResourceGroupName` festgelegt ist.
...
### -AllowedOrigin
Die zulässigen Ursprünge für den SignalR-Dienst. Wenn Sie alle zulassen möchten, verwenden Sie "*", und entfernen Sie alle anderen Ursprünge aus der Liste. Schrägstriche sind als Teil der Domäne oder nach TLD nicht zulässig.
...
### -Location
Der Standort des SignalR-Diensts. Der Speicherort der Ressourcengruppe wird verwendet, wenn dieser nicht angegeben wird.
...
### -ResourceGroupName
Der Name der Ressourcengruppe. Die Standardeinstellung wird verwendet, wenn sie nicht angegeben wird.
...
### -UnitCount
Die Anzahl der SignalR-Serviceeinheiten, von 1 bis 10. Der Standardwert ist "1".
