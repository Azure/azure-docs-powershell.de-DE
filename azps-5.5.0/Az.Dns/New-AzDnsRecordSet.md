...
Wenn bereits ein übereinstimmender **Eintrag** vorhanden ist (derselbe Name und Datensatztyp), müssen Sie den Parameter *"Overwrite"* angeben. Andernfalls erstellt das Cmdlet kein neues **RecordSet.**
...
### Beispiel 9: Erstellen eines "RecordSet"-Eintrags am Anpunkt der Zone
```
PS C:\> $Records = @()
PS C:\> $Records += New-AzDnsRecordConfig -Ipv4Address 1.2.3.4
...
Der *Parameter "Bestätigen"* mit dem Wert $False Bestätigungsaufforderung unterdrückt.
