...
## BESCHREIBUNG
Mit diesem Befehl wird ein Rollup des Speichersynchronisierungsserverzertifikats ausgeführt, mit dem die Serveridentität für den Speichersynchronisierungsdienst beschrieben wird. Dies ist für Problembehandlungsszenarien gedacht. Beim Aufrufen dieses Befehls wird das Serverzertifikat ersetzt und der Speichersynchronisierungsdienst aktualisiert, bei dem dieser Server ebenfalls registriert ist, indem der öffentliche Teil des Schlüssels übermittelt wird. Da ein neues Zertifikat generiert wird, wird auch die Ablaufzeit dieses Zertifikats aktualisiert. Dieser Befehl kann auch zum Aktualisieren eines abgelaufenen Zertifikats verwendet werden. Dies kann geschehen, wenn ein Server über einen längeren Zeitraum offline ist.
...
Mit diesem Befehl wird ein Rollup des lokalen Serverzertifikats ausgeführt und der entsprechende Speichersynchronisierungsdienst auf sichere Weise über die neue Identität des Servers informiert.
