...
## BESCHREIBUNG
Mit diesem Befehl wird der angegebene Cloudendpunkt aus einer Synchronisierungsgruppe gelöscht. Die Verweise auf den Cloudendpunkt werden von diesem Prozess nicht für die Freigabe der Azure-Datei verwendet. Dieser Befehl ist nur für die Außerbetriebnahme vorgesehen. Das Entfernen eines Cloudendpunkts ist ein truktiver Vorgang. Serverendpunkte können nur synchronisiert werden, wenn mindestens ein Cloudendpunkt vorhanden ist. Dieser Vorgang sollte nicht zum Beheben von Synchronisierungsproblemen ausgeführt werden. Wenn diese Azure-Dateifreigabe erneut derselben Synchronisierungsgruppe als Cloudendpunkt hinzugefügt wird, kann sie zu Konfliktdateien und anderen unbeabsichtigten Folgen führen.
