...
## BESCHREIBUNG
Das New-AzSqlVMGroup erstellt eine Gruppe von Azure SQL virtuellen Computer.
...
Erstellt eine neue Azure SQL Gruppe virtueller Computer mit "test-group vm" in der Ressourcengruppe "ResourceGroup01".
$profile ist ein Objekt vom Typ "Microsoft.Azure.Management.SqlVirtualMachine.Models.WsfcDomainProfile".
...
Name, der zum Erstellen des Clusters verwendet wird
...
Name, der für den Betriebssystemcluster verwendet wird
...
### -DomainFqdn
Vollqualifizierter Name der Domäne
...
Optionaler Pfad für Dateifreigaben
...
### -Name
SQL gruppenname des virtuellen Computers.
...
### -Offer
SQL gruppenangebot für virtuelle Computer.
...
### -OuPath
Organisationseinheitspfad, in dem Knoten und Cluster vorhanden sind
...
### -SKU
SQL des Gruppeneditionstyps des virtuellen Computers.
...
### -SqlServiceAccount
Name, unter SQL der der Dienst auf allen teilnehmenden SQL virtuellen Computern im Cluster ausgeführt wird.
...
Primärschlüssel des Speicherkontos
...
### -Tag
Die Tags, die der Gruppe SQL virtuellen Computer zugeordnet werden.
