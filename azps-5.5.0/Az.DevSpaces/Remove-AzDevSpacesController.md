...
Löschen Sie einen DevSpaces-Controller namens devSpaceControllerName.
...
### -InputObject
Ein PSController-Objekt, das normalerweise über die Pipeline übergeben wird.
...
### -PassThru
Gibt "true" zurück, wenn "delete" erfolgreich ist.
