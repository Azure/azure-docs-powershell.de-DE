...
### Beispiel 1: Auflisten aller Zugriffsrichtlinien in einer bestimmten Umgebung
```powershell
...
Dieser Befehl listet alle Zugriffsrichtlinien in einer angegebenen Umgebung auf.
