...
Mit diesem Befehl wird ein verwalteter Bildvertreiber erstellt.

### Beispiel 2: Erstellen eines VHD-Händlers
```powershell
...
Dieser Befehl erstellt einen VHD-Händler.

### Beispiel 3: Erstellen eines freigegebenen Bildvertreibers
```powershell
...
Mit diesem Befehl wird ein freigegebener Bildvertreiber erstellt.
...
### -ExcludeFromLatest
Flag, das angibt, ob die erstellte Bildversion von der neuesten Version ausgeschlossen werden soll.
...
### -GalleryImageId
Ressourcen-ID des Bilds "Freigegebene Bildergalerie".
...
### -ImageId
Ressourcen-ID des Bilds für verwalteten Datenträger.
...
### -Location
Der Speicherort von Azure für das Bild sollte übereinstimmen, wenn das Bild bereits vorhanden ist.
...
Als verwaltetes Datenträgerabbild verteilen.
...
### -ReplicationRegion
Eine Liste der Bereiche, in die das Bild repliziert wird.
...
### -StorageAccountType
Speicherkontotyp, der zum Speichern des freigegebenen Bilds verwendet wird.
