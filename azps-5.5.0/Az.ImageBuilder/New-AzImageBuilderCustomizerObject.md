...
### -CustomizerName
Anzeigename, der Kontext zu den Durchschritten dieses Anpassungsschritts bietet.
...
Es kann genau ein "scriptUri"- oder "inline"-Wert angegeben werden.
...
Es kann sich um einen Github-Link, einen SAS-URI für Azure Storage usw.
