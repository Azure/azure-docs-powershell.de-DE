...
## BESCHREIBUNG
Das **Cmdlet "Update-AzNetAppFilesAccount"** ändert eine ANF Active Directory-Konfiguration.
...
Dieser Befehl führt eine Aktualisierung für die angegebene Active Directory-Konfiguration aus und ändert den Benutzernamen in die angegebene Konfiguration.
...
### -AccountObject
Das Konto für das Active Directory-Objekt
...
### -ActiveDirectoryId
Die ID des ANF-Active Directory
...
### -AdName
Name des Active Directory-Computers.
Dieser optionale Parameter wird nur beim Erstellen von Kerberos-Volume
...
### -BackupOperator
Benutzer, die der Active Directory-Gruppe "Integrierter Sicherungsoperator" hinzugefügt werden sollen.
Eine Liste mit eindeutigen Benutzernamen ohne Domänenbezeichner
...
### -Dns
Durch Kommas getrennte Liste der DNS-Server-IP-Adressen (nur IPv4) für die Active Directory-Domäne
...
### -InputObject
Das zu entfernende Active Directory-Objekt
...
### -KdcIP
Kdc-Server-IP-Adressen für den Active Directory-Computer.
Dieser optionale Parameter wird nur beim Erstellen von Kerberos verwendet.
...
### -OrganizationalUnit
Organisationseinheit im Windows Active Directory
...
Wenn LDAP über SSL/TLS aktiviert ist, muss das selbst signierte Stammzertifizierungsstellenzertifikat des Active Directory-Zertifikatdiensts base64-codiert sein. Dieser optionale Parameter wird nur für duales Protokoll mit LDAP-Benutzerzuordnungsvolumen verwendet.
...
### -Site
Die Active Directory-Website, auf die der Dienst die Domänencontrollerermittlung auf
...
### -SmbServerName
Der Name von NetANJAS des SMB-Servers.
Dieser Name wird als Computerkonto im Ad registriert und zum
