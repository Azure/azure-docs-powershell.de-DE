...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzNetAppFilesPool"** löscht einen ANF-Pool.
...
Mit diesem Befehl wird der ANF-Pool "MyAnfPool" gelöscht.
...
### -AccountObject
Das Kontoobjekt, das den zu entfernenden Pool enthält
...
### -PassThru
Zurückgeben, ob der angegebene Pool erfolgreich entfernt wurde
...
### -ResourceGroupName
Die Ressourcengruppe des ANF-Pools
