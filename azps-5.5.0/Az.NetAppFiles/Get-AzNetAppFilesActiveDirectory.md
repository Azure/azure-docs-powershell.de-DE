...
## BESCHREIBUNG
Das **Cmdlet "Get-AzNetAppFilesActiveDirectory"** ruft Details zu einer Active Directory-Konfiguration für ANF-Konten ab.
...
Dieser Befehl ruft die Ad-Konfiguration namens "MyADConfigName" für das Azure NetApp Files (ANF)-Konto mit dem Namen "MyAnfAccount" ab.
