...
## BESCHREIBUNG
Das **Cmdlet "Get-AzNetAppFilesVolume"** ruft Details zu einem ANF-Volume ab.

## BEISPIELE

### Beispiel 1: Erhalten einer ANF-Lautstärke
```
...
Dieser Befehl ruft das Volume "MyAnfVolume" aus dem Pool "MyAnfPool" ab. 
...
### -PoolObject
Das Poolobjekt mit dem zurückzukehrenden Volume
