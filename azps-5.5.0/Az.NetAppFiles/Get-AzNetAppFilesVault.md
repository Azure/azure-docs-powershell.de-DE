...
## BESCHREIBUNG
Das **Cmdlet "Get-AzNetAppFilesVault"** ruft die Liste der Sicherungstresor eines ANF-Kontos ab.
...
Dieser Befehl ruft eine Liste der Sicherungstresor für das Azure NetappFiles (ANF)-Konto "MyAnfAccount" ab.
