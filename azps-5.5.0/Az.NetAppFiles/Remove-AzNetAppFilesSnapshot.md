...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzNetAppFilesSnapshot"** löscht eine ANF-Momentaufnahme.
...
Mit diesem Befehl wird die ANF-Momentaufnahme "MyAnfSnapshot" gelöscht.
...
### -PassThru
Rückgabe, ob das angegebene Volume erfolgreich entfernt wurde
...
### -ResourceGroupName
Die Ressourcengruppe der ANF-Momentaufnahme
...
### -VolumeObject
Das Volumenobjekt mit der zu entfernenden Momentaufnahme
