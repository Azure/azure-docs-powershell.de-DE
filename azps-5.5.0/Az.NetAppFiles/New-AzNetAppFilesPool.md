...
## BESCHREIBUNG
Das **Cmdlet "New-AzNetAppFilesPool"** erstellt einen ANF-Pool.

## BEISPIELE

### Beispiel 1: Erstellen eines ANF-Pools
```
...
Mit diesem Befehl wird der neue ANF-Pool "MyAnfPool" im Konto "MyAnfAccount" erstellt.
...
### -AccountObject
Das Konto für das neue Poolobjekt
