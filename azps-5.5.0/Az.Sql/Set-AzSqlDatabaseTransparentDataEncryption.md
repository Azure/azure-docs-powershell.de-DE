...
## BESCHREIBUNG
Das **Cmdlet "Set-AzSqlDatabaseTransparentDataEncryption"** ändert die Eigenschaft "Transparent Data Encryption (TDE)" einer Azure SQL-Datenbank.
...
Mit diesem Befehl wird TDE für die Datenbank mit dem Namen "Database01" auf dem Server "Server01" aktiviert.
...
### -State
Gibt den Wert der Eigenschaft "TDE" an.
