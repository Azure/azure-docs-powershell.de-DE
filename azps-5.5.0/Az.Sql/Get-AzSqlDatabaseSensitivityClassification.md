...
## BESCHREIBUNG
Das Get-AzSqlDatabaseSensitivityClassification-Cmdlet gibt die aktuellen Informationstypen und Vertraulichkeitsbeschriftungen von Spalten in der Azure SQL zurück.

## BEISPIELE

### Beispiel 1: Erhalten aktueller Informationstypen und Vertraulichkeitsbeschriftungen einer Azure SQL-Datenbank.
```powershell
...
### Beispiel 2: Aktuelle Informationstypen und Vertraulichkeitsbeschriftungen einer Azure SQL Datenbank mit Piping erhalten.
```powershell
...
### Beispiel 3: Erhalten des aktuellen Informationstyps und der Vertraulichkeitsbezeichnung einer bestimmten Spalte einer Azure SQL-Datenbank.
```powershell
...
### Beispiel 4: Erhalten des aktuellen Informationstyps und der Vertraulichkeitsbeschriftung einer bestimmten Spalte einer Azure SQL mithilfe von Piping.
```powershell
