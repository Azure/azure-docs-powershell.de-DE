...
## BESCHREIBUNG
Das **Cmdlet "Clear-AzSqlDatabaseAdvancedThreatProtectionSetting"** entfernt die erweiterten Threat Protection-Einstellungen aus einer AzureAzure SQL-Datenbank.
Um dieses Cmdlet zu verwenden, geben Sie die *Parameter "ResourceGroupName"* und *"ServerName"* an, um die Datenbank zu identifizieren, aus der die Einstellungen mit diesem Cmdlet entfernt werden.

## BEISPIELE

### Beispiel 1: Entfernen erweiterter Threat Protection-Einstellungen für eine Datenbank
```
...
Mit diesem Befehl werden die erweiterten Threat Protection-Einstellungen aus einer Datenbank namens "Database01" auf dem Server "Server01" entfernt.

## PARAMETERS

### -DatabaseName
Gibt den Namen einer Datenbank an, in der die erweiterten Threat Protection-Einstellungen entfernt werden sollen.
