...
## BESCHREIBUNG
Das **Cmdlet "Get-AzSqlSyncSchema"** gibt Informationen zum Synchronisierungsschema einer Memberdatenbank oder Hubdatenbank zurück.
...
### Beispiel 2: Erhalten des Synchronisierungsschemas für eine Hubdatenbank und Erweitern von Tabellen
```powershell
...
Dieser Befehl ruft das Synchronisierungsschema für die Hubdatenbank in der Synchronisierungsgruppe "syncGroup01" ab und erweitert die Eigenschaft "Tabellen".
...
Dieser Befehl ruft das Synchronisierungsschema für die Memberdatenbank im Synchronisierungsmember01 ab.
