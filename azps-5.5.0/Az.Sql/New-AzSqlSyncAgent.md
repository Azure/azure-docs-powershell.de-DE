...
## BESCHREIBUNG
Das **Cmdlet "New-AzSqlSyncAgent"** erstellt einen Azure SQL-Agent.
...
Mit diesem Befehl wird ein Synchronisierungs-Agent für einen Azure SQL erstellt.
...
### -SyncDatabaseResourceID
Die Ressourcen-ID der Synchronisierungsmetadatendatenbank.
