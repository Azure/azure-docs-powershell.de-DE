...
### Beispiel 2: Deaktivieren der Überwachungsrichtlinie für den Blob Storage von Microsoft für Supportvorgänge eines Azure SQL Server
```powershell
...
### Beispiel 5: Aktivieren der Überwachungsprotokollanalyserichtlinie der Microsoft Support Operations Auditing eines Azure SQL Server
```powershell
...
### Beispiel 8: Deaktivieren des Sendens von Überwachungsdatensätzen eines Azure SQL-Servers an blob storage und ermöglichen das Senden zur Protokollanalyse.
```powershell
