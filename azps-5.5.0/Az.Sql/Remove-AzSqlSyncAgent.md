...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzSqlSyncAgent"** entfernt einen Azure SQL-Agent.
...
Mit diesem Befehl wird der Azure SQL-Synchronisierungs-Agent namens "syncAgent01" entfernt.
