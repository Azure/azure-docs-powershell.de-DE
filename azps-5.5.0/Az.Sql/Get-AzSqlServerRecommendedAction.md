...
## BESCHREIBUNG
Das **Cmdlet "Get-AzSqlServerRecommendedAction"** ruft eine oder mehrere empfohlene Aktionen für einen Azure SQL Server ab.

## BEISPIELE

### Beispiel 1: Erhalten einer Liste aller empfohlenen Aktionen für einen bestimmten Berater
```
...
Dieser Befehl ruft eine Liste aller empfohlenen Aktionen für den SQL Server Ratgeber "CreateIndex" ab, der für den Server mit dem Namen "wi-runner-australia-east" verfügbar ist.
...
Dieser Befehl ruft eine empfohlene Aktion namens IR_ \[ test_schema \] _ \[ test_table_0.0361551 _6C7AE8CC9C87E7FD5893 vom Ratgeber \] "CreateIndex" ab.

## PARAMETERS

### -AdvisorName
Gibt den Namen des Beraters an, für den dieses Cmdlet Aktionen anfordern soll.
...
### -ServerName
Gibt den Namen des Servers an, dem der Berater angehört.
