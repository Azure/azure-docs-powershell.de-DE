...
### -ResourceGroupName
Gibt den Namen der Ressourcengruppe an, der dieses Cmdlet den Server zu weist.
...
Geben Sie 2.0 zum Erstellen eines Servers der Version 11 oder 12.0 zum Erstellen eines Servers der Version 12 an.
...
Gibt die Anmeldeinformationen SQL Datenbankserveradministrator für den neuen Server an. Zum Abrufen eines **"PSCredential"-Objekts** verwenden Sie das Get-Credential-Cmdlet. Weitere Informationen erhalten Sie, wenn Sie " `Get-Help
Get-Credential` eingeben" aus.
