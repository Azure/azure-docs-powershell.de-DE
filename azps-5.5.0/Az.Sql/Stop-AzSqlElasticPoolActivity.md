...
## BESCHREIBUNG
Das **Cmdlet "Stop-AzSqlElasticPoolActivity"** bricht den asynchronen Aktualisierungsvorgang für einen Pool aus.

## BEISPIELE

### Beispiel 1: Abbrechen des asynchronen Aktualisierungsvorgangs für einen Pool
```
...
Dieser Befehl bricht den Vorgang für asynchrone Updates im Pool ab.
