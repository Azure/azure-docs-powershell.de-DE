...
## BESCHREIBUNG
Das Get-AzSqlElasticJobTargetExecution cmdlet ruft eine oder mehrere Ausführungen von Auftragszielen aus einer Auftragsausführung ab.

## BEISPIELE

### Beispiel 1: Ruft eine oder mehrere Ausführungszielausführungen eines Auftrags ab.
```powershell
...
### Beispiel 2: Ruft eine oder mehrere Ausführungszielausführungen eines Auftrags ab – Filtern nach Schrittname
```powershell
PS C:\> $je = Get-AzSqlElasticJobExecution -ResourceGroupName rg -ServerName elasticjobserver -AgentName agent -JobName job1 -JobExecutionId 3bcfc912-20b2-411d-a2b7-6265d13fe272
...
### -ParentObject
Das Ausführungsobjekt des Auftrags.
