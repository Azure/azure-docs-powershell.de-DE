...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzSqlDatabase"** entfernt eine Azure SQL Datenbank.
Dieses Cmdlet wird auch vom Dienst SQL Server Stretch Database in Azure unterstützt.

## BEISPIELE

### Beispiel 1: Entfernen einer Datenbank von einem Azure SQL Server
```
PS C:\>Remove-AzSqlDatabase -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -DatabaseName "Database01"
```

Mit diesem Befehl wird die Datenbank mit dem Namen "Database01" von Server Server01 entfernt.
