...
## BESCHREIBUNG
Das **Cmdlet "Get-AzSqlServerFirewallRule"** ruft Firewallregeln für einen Azure SQL Datenbankserver ab.
Wenn Sie den Namen einer Firewallregel angeben, ruft dieses Cmdlet Informationen zu dieser bestimmten Firewallregel ab.

## BEISPIELE

### Beispiel 1: Alle Regeln für einen Server erhalten
```
...
### Beispiel 2: Erhalten aller Regeln für einen Server mithilfe von Filtern
```
...
Dieser Befehl ruft alle Firewallregeln für den Server namens Server01 ab, die mit "Regel" beginnen.
...
### -FirewallRuleName
Gibt den Namen der Firewallregel an.
