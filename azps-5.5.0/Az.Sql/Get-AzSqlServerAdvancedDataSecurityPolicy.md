...
## BESCHREIBUNG
Das **Cmdlet "Get-AzSqlServerAdvancedDataSecurityPolicy"** ruft die Advanced Data Security-Richtlinie eines Servers ab.

## BEISPIELE

### Beispiel 1: Ruft advanced Data Security für Server ab
```powershell
...
### Beispiel 2: Ruft die advanced Data Security des Servers von einer Serverressource ab.
```powershell
