...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzSqlServerMSSupportAudit"** entfernt die Überwachungseinstellungen eines Azure SQL Server.
Verwenden Sie zum Verwenden des Cmdlets die Parameter *"ResourceGroupName"* und *"ServerName",* um den Server zu identifizieren.

## BEISPIELE

### Beispiel 1: Entfernen der Überwachungseinstellungen eines Azure SQL Supportvorgängen
```powershell
