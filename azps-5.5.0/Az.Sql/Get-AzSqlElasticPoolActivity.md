...
## BESCHREIBUNG
Das **Cmdlet "Get-AzSqlElasticPoolActivity"** ruft den Status von Vorgängen in einem Pool für ein Azure SQL ab.
Sie können den Status von Poolerstellungs- und Konfigurationsupdates sehen.

## BEISPIELE

### Beispiel 1: Anzeigen des Status von Vorgängen für einen Pool mit Pool
```
PS C:\>Get-AzSqlElasticPoolActivity -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -ElasticPoolName "ElasticPool01"
```

Dieser Befehl ruft den Status der Vorgänge für den Pool mit dem Namen "PoolsPool01" ab.
