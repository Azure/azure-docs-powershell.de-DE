...
## BESCHREIBUNG
Das **Cmdlet "Get-AzSqlElasticPool"** ruft Pool und deren Eigenschaftswerte ab.
Geben Sie den Namen eines vorhandenen Poolpools an, um die Eigenschaftswerte nur für den Pool zu sehen.

## BEISPIELE

### Beispiel 1: Alle Schwimmschwimmpools erhalten
```
...
Dieser Befehl ruft alle Schwimmpools auf dem Server mit dem Namen Server01 ab.

### Beispiel 2: Einen bestimmten Pool erhalten
```
...
Dieser Befehl ruft den Pool mit dem Namen "PoolsPool0127" auf dem Server mit dem Namen "Server01" ab.

### Beispiel 3: Erhalten von Metriken für einen Azure SQL-Datenbankpool
```
...
Dieser Befehl gibt Metriken für einen Azure SQL Datenbankpool namens "Poolpool01" zurück.

### Beispiel 4: Alle Schwimmpools mithilfe von Filterung erhalten -Poolname "Poolpool*"
```
PS C:\>Get-AzSqlElasticPool -ResourceGroupName "ResourceGroup01" -ServerName "Server01"
ResourceId        : /subscriptions/00000000-0000-0000-0000-000000000001/resourceGroups/resourcegroup01/providers/Microsoft.Sql/servers/server01/elasticPools/elasticpool01
ResourceGroupName : resourcegroup01
...
Dieser Befehl ruft alle Schwimmpools auf dem Server mit dem Namen Server01 ab, die mit "Poolpool" beginnen.
...
### -PoolName
Gibt den Namen des Poolpools an, den dieses Cmdlet erhält.
...
### -ResourceGroupName
Gibt den Namen der Ressourcengruppe an, die den Pool enthält, den dieses Cmdlet erhält.
...
### -ServerName
Gibt den Namen des Servers an, der den Pool enthält, den dieses Cmdlet erhält.
