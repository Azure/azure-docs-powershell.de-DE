...
Mit diesem Befehl wird eine Firewallregel mit dem Namen "Rule01" auf dem Server "Server01" erstellt.
...
Wenn Sie Azure IPs den Zugriff auf den Server gestatten möchten, sollte dieser Parameter in einem separaten Cmdlet-Aufruf verwendet werden, der die Parameter *"FirewallRuleName",* *"StartIpAddress"* und *"EndIpAddress"* nicht verwendet.
