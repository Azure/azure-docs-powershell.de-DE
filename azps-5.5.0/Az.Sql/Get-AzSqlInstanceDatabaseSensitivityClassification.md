...
### Beispiel 1: Aktuelle Informationstypen und Vertraulichkeitsbezeichnungen einer Azure SQL Instanzdatenbank erhalten.
```powershell
...
### Beispiel 2: Aktuelle Informationstypen und Vertraulichkeitsbeschriftungen einer Azure SQL Verwaltete Instanzdatenbank mit Piping erhalten.
```powershell
...
### Beispiel 3: Erhalten des aktuellen Informationstyps und der Vertraulichkeitsbezeichnung einer bestimmten Spalte einer Azure SQL Verwaltete Instanzdatenbank.
```powershell
...
### Beispiel 4: Erhalten des aktuellen Informationstyps und der Vertraulichkeitsbezeichnung einer bestimmten Spalte einer Azure SQL Instanzdatenbank mithilfe von Piping.
```powershell
