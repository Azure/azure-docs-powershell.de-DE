...
Die Anforderung zum Exportstatus der Datenbank wird möglicherweise gesendet, um Statusinformationen für diese Anforderung abzurufen.
Dieses Cmdlet wird auch vom Dienst SQL Server Stretch Database in Azure unterstützt.

> [!IMPORTANT]
> Um dieses Cmdlet verwenden zu können, muss die Firewall auf Azure SQL Server so konfiguriert werden, dass "Azure-Dienste und -Ressourcen den Zugriff auf diesen Server erlauben" konfiguriert werden. Wenn dies nicht konfiguriert ist, werden Fehler vom "GatewayTimeout" angezeigt.
...
Der Standardwert ist SQL, wenn kein Authentifizierungstyp festgelegt ist.
Die zulässigen Werte für diesen Parameter sind:
- Sql.
SQL Authentifizierung.
Legen Sie *"AdministratorLogin"* und *"AdministratorLoginPassword"* auf den SQL und das Kennwort des Administrators fest. 
- ADPassword.
Azure Active Directory-Authentifizierung.
Legen *Sie "AdministratorLogin"* und *"AdministratorLoginPassword"* auf den Azure AD-Administratorbenutzernamen und das Kennwort fest.
...
### -ResourceGroupName
Gibt den Namen der Ressourcengruppe für den Server SQL Datenbankserver an.
...
Die zulässigen Werte für diesen Parameter sind:
- StorageAccessKey.
Für diesen Wert wird ein Speicherkontoschlüssel verwendet. 
- SharedAccessKey.
Für diesen Wert wird ein SAS (Shared Access Signature)-Schlüssel verwendet.
...
### -StorageUri
Gibt den BLOB-Link als URL zur Datei "BACPAC" an.
