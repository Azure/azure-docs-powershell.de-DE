...
## BESCHREIBUNG
Das **Cmdlet "New-AzSqlElasticPool"** erstellt einen Datenbankpool für eine Azure SQL Datenbank.
...
Mit diesem Befehl wird ein Pool mit dem Namen "Poolpool01" der Standarddienststufe erstellt. Der Server mit dem Namen "server01", der einer Azure-Ressourcengruppe namens "ResourceGroup01" zugewiesen ist, hostet den Pool im Pool. Der Befehl gibt die Werte der "DTU"-Eigenschaft für den Pool und die Datenbanken im Pool an.
...
Mit diesem Befehl wird ein Pool mit dem Namen "Poolpool01" auf der Dienstebene "GengeralPurpose" erstellt. Der Server mit dem Namen "server01", der einer Azure-Ressourcengruppe namens "ResourceGroup01" zugewiesen ist, hostet den Pool im Pool. Der Befehl gibt die vCore-Eigenschaftswerte für den Pool und die Datenbanken im Pool an.
...
- Standard. 5 DTUs
- Standard. 100 DTUs
- Premium. 125 DTUs Details zu gültigen Werten finden Sie in der Tabelle für den jeweiligen Größenpool in Pool [in Pool-Schwimmen.](https://docs.microsoft.com/azure/sql-database/sql-database-elastic-pool)
...
Details dazu, welche Werte gültig sind, finden Sie in der Tabelle für ihren speziellen Größenpool in [Pool in Schwimmpools.](https://docs.microsoft.com/azure/sql-database/sql-database-elastic-pool)
...
### -PoolName
Gibt den Namen des Poolpools an, den dieses Cmdlet erstellt.
