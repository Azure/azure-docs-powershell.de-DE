...
## BESCHREIBUNG
Das Invoke-AzSqlElasticPoolFailover über ein Cmdlet über einen Pool im Pool. Nach dem Ausführen dieses Cmdlets erfolgt der Failover für alle Datenbanken im Pool des Pool.
...
Mit diesem Befehl wird ein Failover des Pool mit dem Namen "FailoverPool01" auf dem Server "Server01" ausgeführt.  Dies bedeutet, dass der Failover für alle Datenbanken im Pool mit dem Namen "FailoverPool01" erfolgt.
