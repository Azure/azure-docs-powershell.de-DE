...
## BESCHREIBUNG
Das **Cmdlet "Get-AzSqlDatabase"** ruft eine oder mehrere Azure SQL aus einem Azure SQL Database Server ab.
Dieses Cmdlet wird auch vom Dienst SQL Server Stretch Database in Azure unterstützt.

## BEISPIELE

### Beispiel 1: Alle Datenbanken auf einem Server erhalten
```
...
### Beispiel 2: Erhalten einer Datenbank nach Namen auf einem Server
```
...
### Beispiel 3: Erhalten aller Datenbanken auf einem Server mithilfe von Filtern
```
