...
## BESCHREIBUNG
Das Add-AzSqlElasticJobTarget Cmdlet fügt einer Zielgruppe eine Zielressource hinzu.

## BEISPIELE

### Beispiel 1: Hinzufügen eines Serverziels
```powershell
...
### Beispiel 2: Hinzufügen eines Datenbankziels
```powershell
PS C:\> $tg = Get-AzSqlElasticJobTargetGroup -ResourceGroupName rg -ServerName elasticjobserver -Name tg1
...
### Beispiel 3: Hinzufügen eines Ziels für einen Pool
```powershell
...
### Beispiel 4: Hinzufügen eines Shardzuordnungsziels
```powershell
PS C:\> $tg = Get-AzSqlElasticJobTargetGroup -ResourceGroupName rg -ServerName elasticjobserver -Name tg1
...
Fügt einer Zielgruppe ein Ziel (Server, Pool, Datenbank und Shardkarte) hinzu.
