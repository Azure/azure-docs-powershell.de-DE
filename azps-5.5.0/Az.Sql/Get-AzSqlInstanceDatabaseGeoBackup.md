...
## BESCHREIBUNG
Das **Cmdlet "Get-AzSqlInstanceDatabaseGeoBackup"** ruft redundante Sicherungen von Azure SQL-Datenbanken aus einer verwalteten Azure SQL-Datenbankinstanz ab.

## BEISPIELE

### Beispiel 1: Alle redundanten Datenbanksicherungen für eine Instanz erhalten
```
...
Dieser Befehl ruft alle redundanten Datenbanksicherungen für die Instanz namens "managedInstance1" ab.

### Beispiel 2: Erhalten einer redundanten Datenbanksicherung nach Name für eine verwaltete Instanz
```
...
Dieser Befehl ruft eine redundante Datenbanksicherung namens "managedDatabase1" aus einer Instanz namens "managedInstance1" ab.

### Beispiel 3: Erhalten aller redundanten Datenbanksicherungen für eine Instanz mithilfe von Filtern
```
...
Dieser Befehl ruft alle redundanten Datenbanksicherungen für die Instanz namens "managedInstance1" ab, die mit "managedDatabase" beginnen.
