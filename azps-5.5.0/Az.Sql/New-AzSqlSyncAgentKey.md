...
## BESCHREIBUNG
Das **Cmdlet "New-AzSqlSyncAgentKey"** erstellt einen Azure SQL-Agent-Schlüssel.

## BEISPIELE

### Beispiel 1: Erstellen eines Synchronisierungs-Agent-Schlüssels für einen Azure SQL-Agent.
```
PS C:\> New-AzSqlSyncAgentKey -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -SyncAgentName "SyncAgent01"
SyncAgentKey                  : Key
```

Dieser Befehl erstellt einen Synchronisierungs-Agent-Schlüssel für einen Azure SQL-Agent.
