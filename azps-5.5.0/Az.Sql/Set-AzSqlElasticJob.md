...
## BESCHREIBUNG
Das cmdlet Set-AzSqlElasticJob aktualisiert einen Auftrag

## BEISPIELE

### Beispiel 1: Aktualisiert einen Auftrag so, dass er ab jetzt eine Stunde beginnt, und wird alle 1 Stunde wiederholt.
```powershell
...
### -Enable
Das Kennzeichen, mit dem angegeben wird, dass der Kunde diesen Auftrag aktivieren möchte.
...
### -IntervalCount
Die Anzahl der Periodenintervalle
...
### -IntervalType
Der Intervalltyp "Terminserie" – Kann "Minute", "Stunde", "Tag", "Woche", "Monat" sein.
...
### -RunOnce
Das Kennzeichen zur Angabe, dass der Auftrag einmal ausgeführt wird
