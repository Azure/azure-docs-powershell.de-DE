...
## BESCHREIBUNG
Das **Cmdlet "Get-AzSqlServerDisasterRecoveryConfiguration"** ruft SQL Wiederherstellungskonfiguration des Datenbankserversystems ab.
...
### -ServerName
Gibt den Namen SQL Datenbankservers an.
