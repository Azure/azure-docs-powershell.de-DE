...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzSqlInstancePool"** entfernt einen Azure SQL-Instanzpool.
...
### Beispiel 2: Entfernen eines Instanzpools durch dessen Ressourcenbezeichner
```powershell
...
Mit diesem Befehl wird ein Instanzpool namens "instancePool0" entfernt.
