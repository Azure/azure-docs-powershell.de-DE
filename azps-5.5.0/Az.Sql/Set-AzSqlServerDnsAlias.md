...
## BESCHREIBUNG
Dieser Befehl aktualisiert den Server, auf den der Alias verweisen soll. Dieser Befehl muss ausgestellt werden, während Er bei einem Abonnement angemeldet ist, auf dem sich der neue Server befindet, auf den der Alias verweisen soll.
