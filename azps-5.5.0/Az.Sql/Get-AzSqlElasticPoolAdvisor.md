...
## BESCHREIBUNG
Das **Cmdlet "Get-AzSqlElasticPoolAdvisor"** ruft mindestens einen Azure SQL Poolratgeber für einen Azure SQL Pool ab.

## BEISPIELE

### Beispiel 1: Auflisten aller Berater für den angegebenen Pool
```
...
Der Befehl ruft alle Berater für den Pool mit dem Namen WIPool ab.

### Beispiel 2: Einen einzigen Berater für den angegebenen Pool erhalten
```
...
Dieser Befehl ruft den Berater "CreateIndex" für den Pool mit dem Namen "WIPoolPool" ab.
...
Dieser Befehl ruft alle Berater für den Pool mit den empfohlenen Aktionen ab, die in der Antwort enthalten sind.
...
### Beispiel 5: Auflisten aller Berater für den angegebenen Pool mit Filterung
```
...
Der Befehl ruft alle Berater für den Pool mit dem Namen WIPool auf, die mit dem Buchstaben "d" beginnen.
...
### -PoolName
Gibt den Namen des Poolpools an, für den dieses Cmdlet den Berater anfordert.
...
Zeigt an, dass das Cmdlet die empfohlenen Aktionen des Beraters in der Antwort enthält.
...
### -ResourceGroupName
Gibt den Namen der Ressourcengruppe des Servers an, der diesen Pool enthält.
...
### -ServerName
Gibt den Namen des Servers an, auf dem sich der Pool des Pool befindet.
...
## HINWEISE
* Schlüsselwörter: azure, azurerm, arm, resource, management, manager, sql,pool, mssql, advisor
