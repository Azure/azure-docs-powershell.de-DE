...
### Beispiel 5: Verschlüsseln der Anmeldeinformationen für den odBC-verknüpften Dienst
```
...
Verwenden Sie für einen lokalen dienst, der mit dem Dateisystem verknüpft ist, den Dienst "Local" oder "localhost", wenn sich das Dateisystem auf dem Gatewaycomputer befindet. Wenn sich das Dateisystem auf einem anderen Server als dem Gatewaycomputer befindet, verwenden Sie den \\ \\ Servernamen.
