...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzDataFactoryLinkedService"** entfernt einen verknüpften Dienst aus Azure Data Factory.
...
Mit diesem Befehl wird der verknüpfte Dienst "LinkedServiceTest" aus der Daten factory namens WikiADF entfernt.
...
Mit diesem Cmdlet wird ein verknüpfter Dienst aus der von diesem Parameter angegebenen Daten factory entfernt.
...
### -Force
Gibt an, dass mit diesem Cmdlet ein verknüpfter Dienst entfernt wird, ohne dass Sie zur Bestätigung aufgefordert werden.
...
### -Name
Gibt den Namen des verknüpften Diensts an, der entfernt werden soll.
...
Dieses Cmdlet entfernt einen verknüpften Dienst aus der Gruppe, die dieser Parameter angibt.
