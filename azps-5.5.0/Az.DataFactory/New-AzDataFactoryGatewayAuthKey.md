...
## BESCHREIBUNG
Das **Cmdlet "New-AzDataFactoryGatewayAuthKey"** erstellt den Gatewayauthentifizierungsschlüssel für ein angegebenes Azure Data Factory-Gateway.
Mit diesem Schlüssel registrieren Sie das Gateway bei einem Clouddienst.

## BEISPIELE

### Beispiel 1: Erstellen eines Authentifizierungsschlüssels für das Gateway für Schlüssel1
```
...
Mit diesem Befehl wird ein Authentifizierungsschlüssel von Schlüssel1 für das Daten factorygateway namens "MyGateway" erstellt.
...
### -KeyName
Der Name des Gateway-Authentifizierungsschlüssels, der erneut generiert werden soll, entweder "key1" oder "key2".
