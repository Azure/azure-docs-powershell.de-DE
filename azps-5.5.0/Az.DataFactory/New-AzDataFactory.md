...
## BESCHREIBUNG
Das **Cmdlet "New-AzDataFactory"** erstellt eine Datenfactory mit dem angegebenen Ressourcengruppennamen und -ort.
...
Mit diesem Befehl wird eine Daten factory namens WikiADF in der Ressourcengruppe namens ADF am Speicherort "WestUS" erstellt.
...
### -Force
Gibt an, dass dieses Cmdlet eine vorhandene Daten factory ersetzt, ohne dass Sie zur Bestätigung aufgefordert werden.
...
### -Location
Gibt den Speicherort für die Daten factory an, z. B. "WestUS" oder "EastUS".
...
### -Name
Gibt den Namen der zu erstellenden Daten factory an.
