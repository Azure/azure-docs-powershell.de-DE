...
## SYNOPSIS
 Ruft eine andere Instanz einer Triggerauslösung auf.
...
## BESCHREIBUNG
Der **Befehl "Invoke-AzDataFactoryV2TriggerRun"** startet eine andere Instanz eines Triggers, der mit einer neuen Trigger-Ausführungs-ID ausgeführt wird.
...
```
Startet eine weitere Instanz eines Triggers, die mit einer neuen Trigger-Ausführungs-ID ausgeführt wird, und behaltung die gleiche windowStartTime- und windowEndTime-Ausführung wie der ursprüngliche Trigger.
...
### -PassThru
Wenn angegeben, wird für den Fall, dass der Vorgang erfolgreich ausgeführt wird, das Cmdlet "true" geschrieben.
