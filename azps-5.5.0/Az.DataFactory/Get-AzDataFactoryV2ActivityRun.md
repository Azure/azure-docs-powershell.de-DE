...
## BESCHREIBUNG
Das **Cmdlet "Get-AzDataFactoryV2ActivityRun"** ruft Informationen zu den Ausführungsläufen in Azure Data Factory für den angegebenen Pipelinelauf ab, der im angegebenen Zeitrahmen ausgeführt wurde. Darüber hinaus können Sie Filter für den Aktivitätsnamen, den namen des verknüpften Diensts, der die Ausführung ausgeführt hat, und den Status der Ausführung angeben.

## BEISPIELE

### Beispiel 1: Alle Aktivitäten für einen Pipelinelauf ausführen
```
...
Dieser Befehl ruft Details zu allen Aktivitäten ab, die bei der Ausführung der Pipeline mit der ID "f288712d-fb08-4cb8-96ef-82d3b9b30621" zwischen "2017-09-01" und "2017-09-30" passiert sind.
...
### -RunStartedAfter
Der Zeitpunkt, zu dem oder nach dem die Ausführung der Pipeline gestartet wurde.
...
### -RunStartedBefore
Der Zeitpunkt, zu dem oder vor dem die Ausführung der Pipeline gestartet wurde.
...
### -Status
Der Status der Pipeline wird ausgeführt.
