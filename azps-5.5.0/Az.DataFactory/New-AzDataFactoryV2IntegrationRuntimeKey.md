...
## BESCHREIBUNG
Das Cmdlet **"New-AzDataFactoryV2IntegrationRuntimeKey"** generiert den Integrationslaufzeitschlüssel erneut mit dem Schlüsselnamen, der durch den Parameter "KeyName" angegeben wird. Der vorherige Schlüssel ist ungültig.

## BEISPIELE

### Beispiel 1: Generieren eines neuen Schlüssels für eine Integrationslaufzeit
```
...
Das Cmdlet generiert den Schlüssel "authKey2" für die Integrationslaufzeit mit dem Namen "test-selfhost-ir".
...
### -KeyName
Der Name des Authentifizierungsschlüssels der selbst gehosteten Integrationslaufzeit.
