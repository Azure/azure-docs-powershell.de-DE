...
### Beispiel 2: Aktualisieren des Status eines Supporttickets.
```powershell
...
### Beispiel 3: Aktualisieren sie die Kontaktdetails eines Supporttickets, indem Sie das Kontaktobjekt angeben.
```powershell
...
### Beispiel 4: Aktualisieren des Schweregrads eines Supporttickets durch Piping des Supportticketobjekts.
```powershell
...
### Beispiel 6: Aktualisieren des Status eines Supporttickets durch Piping des Supportticketobjekts.
```powershell
...
Aktualisieren Sie die Kontaktdetails auf SupportTicket.
...
Dies muss ein gültiger Code für andere Sprachen für eine der hier aufgeführten unterstützten Sprachen https://azure.microsoft.com/support/faq/ sein.
...
### -InputObject
SupportTicket-Ressourcenobjekt, das von diesem Cmdlet aktualisiert wird.
