...
## BESCHREIBUNG
Ruft die Liste der Supporttickets ab. Wenn Sie keine Parameter angeben, werden alle Supporttickets abgerufen. Sie können die Supporttickets auch mithilfe des Parameters "Filter" nach "Status" oder "CreatedDate" filtern. Im Folgenden finden Sie einige Beispiele für Filterwerte, die Sie angeben können.
