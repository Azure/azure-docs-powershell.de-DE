...
## BESCHREIBUNG
Das **Get-AzVMSize-Cmdlet** wird für virtuelle Computergrößen verfügbar.
...
### -VMName
Gibt den Namen des virtuellen Computers an, der von diesem Cmdlet die verfügbaren Größen für virtuelle Computer für Größenänderung erhält.
