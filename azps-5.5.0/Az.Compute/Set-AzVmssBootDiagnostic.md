...
## BESCHREIBUNG
Legt das Profil der Startdiagnose für die Skalierungssatz des virtuellen Computers fest.

## BEISPIELE

### Beispiel 1: Festlegen der Profileigenschaft für die Startdiagnose für eine VMSS
```
...
Mit diesem Befehl wird die Profileigenschaft für die Startdiagnose für die VMSS namens "ContosoVMSS" bestimmt.
...
Sie können das cmdlet New-AzVmssConfig zum Erstellen des Objekts verwenden.
