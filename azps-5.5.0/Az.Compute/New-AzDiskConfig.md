...
### -DiskMBpsReadOnly
"description": "Der Gesamtdurchsatz (MBps), der für alle VMs zulässig ist, die den freigegebenen Datenträger wie "ReadOnly" speichern. MBps bedeutet Millionen von Bytes pro Sekunde – MB verwendet hier die ISO-Notation mit den Powers von 10.
...
Ein Lun ist erforderlich, wenn die Quelle der Kopie eine der Datenträger im Katalogbild ist. wenn null ist, wird der Betriebssystemdatenträger des Bilds kopiert.
