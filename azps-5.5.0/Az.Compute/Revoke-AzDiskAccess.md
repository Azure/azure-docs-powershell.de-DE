...
## BESCHREIBUNG
Das **Cmdlet Revoke-AzDiskAccess** widerruft den Zugriff auf einen Datenträger.
...
Widerrufen des Zugriffs auf den Datenträger mit dem Namen "Disk01" in der Ressourcengruppe mit dem Namen 'ResourceGroup01'
