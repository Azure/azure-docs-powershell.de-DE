...
Mit diesem Befehl wird ein Host der angegebenen SKU in der angegebenen Hostgruppe und dem angegebenen Speicherort erstellt.
...
Gibt an, ob der Host bei einem Fehler automatisch ersetzt werden soll. Der Wert ist standardmäßig auf "true" festgelegt, wenn sie nicht angegeben wird.
...
### -LicenseType
Gibt den Softwarelizenztyp an, der auf die auf dem Host bereitgestellten VMs angewendet wird. Mögliche Werte: "None", "Windows_Server_Hybrid" und "Windows_Server_Perpetual.  Der Standardwert ist "None".
...
### -PlatformFaultDomain
Gibt die Anzahl der Plattformfehlerdomäne des Hosts an.  Dann ist der Minimalwert 0 und der Maximalwert 2.
