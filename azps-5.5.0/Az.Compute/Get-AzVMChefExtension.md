...
## BESCHREIBUNG
Das **Cmdlet "Get-AzVM VirtualExtension"** ruft Informationen zur Erweiterung "Chef" ab, die auf einem virtuellen Computer installiert ist.

## BEISPIELE

### Beispiel 1: Details der Erweiterung "Chef" für einen virtuellen Windows-Computer
```
...
### Beispiel 2: Details der Erweiterung "Chef" für einen virtuellen Linux-Computer
```
...
### -Status
Gibt an, dass dieses Cmdlet nur die Instanzansicht der Erweiterung "Chef" erhält.
...
### -Windows
Gibt an, dass dieses Cmdlet für einen virtuellen Computer in Windows verwendet wird.
