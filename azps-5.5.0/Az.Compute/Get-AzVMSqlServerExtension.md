...
Dieser Befehl ruft den virtuellen Computer "ContosoVM22" im Dienst Service08 mithilfe des cmdlets Get-AzVM ab.
...
### Beispiel 3: Festlegen der Einstellungen für eine bestimmte SQL Server Version
```
