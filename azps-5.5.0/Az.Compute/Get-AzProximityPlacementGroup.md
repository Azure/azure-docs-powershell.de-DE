...
## BESCHREIBUNG
Dieses Cmdlet wird Ressourcen der Näherungsplatzierungsgruppe(en) erhalten oder auflisten.
...
Dieser Befehl ruft die Näherungsplatzierungsgruppe ab.
...
In diesem Befehl werden alle Näherungsplatzierungsgruppen unter der angegebenen Ressourcengruppe aufgeführt.
...
In diesem Befehl werden alle Näherungsplatzierungsgruppen unter dem Abonnement aufgeführt.

## PARAMETERS

### -ColocationStatus
Zeigt den Standortstatus einer Ressource in der Näherungsplatzierungsgruppe an.
...
### -ResourceId
Die Ressourcen-ID für die Näherungsplatzierungsgruppe.
