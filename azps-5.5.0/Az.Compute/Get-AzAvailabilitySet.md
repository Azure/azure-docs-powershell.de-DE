...
## BESCHREIBUNG
Das **Cmdlet "Get-AzAvailabilitySet"** ruft Die Verfügbarkeitssätze von Azure in einer Ressourcengruppe ab.
Sie können den Namen eines bestimmten Verfügbarkeitssets angeben, den Sie erhalten möchten.

## BEISPIELE

### Beispiel 1: Einen bestimmten Verfügbarkeitssatz erhalten
```
...
Dieser Befehl ruft den Verfügbarkeitssatz namens "AvailabilitySet03" in der Ressourcengruppe mit dem Namen "ResourceGroup11" ab.

### Beispiel 2: Alle Verfügbarkeitssätze erhalten
```
...
Dieser Befehl ruft alle Verfügbarkeitssätze in der Ressourcengruppe mit dem Namen "ResourceGroup11" ab.

### Beispiel 3: Erhalten aller Verfügbarkeitssätze mit Filterung
```
...
Dieser Befehl ruft alle Verfügbarkeitssätze in der Ressourcengruppe mit dem Namen "ResourceGroup11" ab, die mit "AvailabilitySet0" beginnen.

### Beispiel 4: Alle Verfügbarkeitssätze mit Name ab "AvailabilitySet0" erhalten
```
...
Dieser Befehl ruft alle Verfügbarkeitssätze ab, die mit "AvailabilitySet0" beginnen.
...
### -Name
Gibt den Namen eines Verfügbarkeitssets an, den dieses Cmdlet erhält.
