...
## BESCHREIBUNG
Das **Cmdlet "Stop-AzVM"** beendet einen virtuellen Azure-Computer.
...
Dieser Befehl stoppt den virtuellen Computer mit dem Namen "VirtualMachine07" in ResourceGroup11.
...
### -SkipShutdown
So fordern Sie das Herunterfahren einer nicht kulanzvollen VM an, wenn die VM bereitgestellt wird.
...
### -StayProvisioned
Das Cmdlet stoppt alle virtuellen Computer innerhalb der VMSS, verrät diese jedoch nicht. Das Konto wird für die beendeten virtuellen Computer belastet.
