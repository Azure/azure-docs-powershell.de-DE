...
### -FileName
Gibt den Namen der Skriptdatei an. Wenn die Datei im Azure-BLOB-Speicher gespeichert ist, wird beim Dateinamenwert die Zwischenschreibung beachtet. Bei den Dateinamen von Dateien, die im Azure File Storage gespeichert sind, wird die Kleinschreibung nicht beachtet.
