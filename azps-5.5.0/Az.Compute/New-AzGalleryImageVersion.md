...
Erstellen Sie eine Katalogbildversion mit Datenträgerbildverschlüsselung.
...
### -DataDiskImage
Datenträgerbilder für Daten.   z. B. @{Source = @{Id=<source_id>}; Lun=1; SizeInGB = 100; HostCaching = "ReadOnly" }
...
### -OSDiskImage
Abbild des Betriebssystemdatenträgers, z. B. @{Source = @{Id=<source_id>}; SizeInGB = 100; HostCaching = "ReadOnly" }
...
Das Datum des Lebenszyklusendes der Katalogbildversion.
...
Wenn dies festgelegt ist, wird diese Bildversion von virtuellen Computern, die mit der neuesten Version der Bilddefinition bereitgestellt wurden, nicht verwendet.
...
### -ReplicaCount
Die Anzahl der Replikate der Bildversion, die pro Region erstellt werden soll.
...
### -SourceImageId
Die ID des Quellbilds, aus dem die Bildversion erstellt werden soll.
...
### -StorageAccountType
Gibt den Speicherkontotyp an, der zum Speichern des Bilds verwendet werden soll. Diese Eigenschaft ist nicht updatable. Verfügbare Werte sind Standard_LRS, Standard_ZRS und Premium_LRS.
...
### -TargetRegion
Die Zielbereiche, in die die Bildversion repliziert werden soll.
