...
### -Beschreibung
Die Beschreibung der Bilddefinitionsressource des Katalogs. 
...
### -DisallowedDiskType
Die unzulässigen Datenträgertypen.
...
### -EndOfLifeDate
Das Datum des Lebenszyklusendes der Katalogbilddefinition
...
### -Eula
Die Vereinbarung "Eula" für die Bilddefinition der Galerie.
...
### -InputObject
Das Bilddefinitionsobjekt aus dem PS Gallery-Katalog.
...
### -MaximumMemory
Das Maximum des empfohlenen Arbeitsspeichers
...
### -MinimumMemory
Das Minimum des empfohlenen Speichers
...
### -PrivacyStatementUri
Der URI der Datenschutzbestimmungen.
...
### -PurchasePlanProduct
Die Produkt-ID für den Kaufplan.
...
Die Herausgeber-ID für den Kaufplan.
...
### -ResourceId
Die Ressourcen-ID für die Bilddefinition
