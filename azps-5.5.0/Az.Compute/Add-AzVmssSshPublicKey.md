...
## BESCHREIBUNG
Das Cmdlet **"Add-AzVmssSshPublicKey"** fügt die öffentlichen Schlüssel hinzu, die Sie für die Verbindung mit virtuellen Computern des Virtual Machine Scale Set (VMSS) über Secure Shell (SSH) verwenden können.

## BEISPIELE

### Beispiel 1: Hinzufügen eines öffentlichen SSH-Schlüssels zu VMSS
```
...
In diesem Beispiel wird der VMSS ein öffentlicher SSH-Schlüssel hinzufügt.
...
### -KeyData
Gibt einen öffentlichen SSH RSA-Schlüssel an.
