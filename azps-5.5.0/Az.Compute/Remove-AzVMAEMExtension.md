...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzVMAEMExtension"** entfernt die Azure Enhanced Monitoring (AEM)-Erweiterung von einem virtuellen Computer.

## BEISPIELE

### Beispiel 1: Entfernen der Erweiterung AEM
```
PS C:\> Remove-AzVMAEMExtension -ResourceGroupName "ResourceGroup11" -VMName "contoso-server"
```

Mit diesem Befehl wird die Erweiterung AEM für den virtuellen Computer "contoso-server" entfernt.
...
### -Name
Gibt den Namen des virtuellen Computers an, von dem dieses Cmdlet die Erweiterung AEM entfernt.
...
Mit diesem Cmdlet wird die Erweiterung AEM von diesem virtuellen Computer entfernt.
