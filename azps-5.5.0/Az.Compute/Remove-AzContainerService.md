...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzContainerService"** entfernt einen Containerdienst aus Ihrem Azure-Konto.

## BEISPIELE

### Beispiel 1: Entfernen eines Containerdiensts
```
PS C:\> Remove-AzContainerService -ResourceGroupName "ResourceGroup17" -Name "CSResourceGroup17"
```

Mit diesem Befehl wird der Containerdienst namens CSResourceGroup17 entfernt.
...
### -Name
Gibt den Namen des Containerdiensts an, den dieses Cmdlet entfernt.
...
### -ResourceGroupName
Gibt die Ressourcengruppe des Containerdiensts an, den dieses Cmdlet entfernt.
