...
## BESCHREIBUNG
Das **Cmdlet "New-AzVMDataDisk"** erstellt ein lokales Datenspeicherobjekt für einen virtuellen Computer oder eine Vmss VM.
...
Der nächste Befehl erstellt ein Datenträgerobjekt mit dem verwalteten Datenträger.
...
Der letzte Befehl aktualisiert die Vmss VM, indem ein neuer Datenträger hinzugefügt wird.

### Beispiel 2

Erstellt ein lokales Datendatenträgerobjekt für einen virtuellen Computer oder eine Vmss VM. (automatisch generiert)
...
### -Zwischenspeichern
Zwischenspeicherung des Virtuellen Computerdatenträgers.
...
### -CreateOption
Die Erstellungsoption des Virtuellen Computerdatenträgers.
...
### -DiskEncryptionSetId
Id des verwalteten Verschlüsselungssatzs des virtuellen Computers.
...
### -DiskSizeInGB
Die Größe des Datenträgers des virtuellen Computers in GB.
...
### -Lun
Der Lun des Virtuellen Computerdatenträgers.
...
### -ManagedDiskId
Die ID des virtuellen Computers, auf dem der Datenträger verwaltet wurde.
...
### -Name
Der Name des Virtuellen Computerdatenträgers.
...
### -SourceImageUri
Der Quellbild-URI des Betriebssystemdatenträgers des virtuellen Computers.
...
### -VhdUri
Der Vhd-URI des virtuellen Computerdatenträgers.
