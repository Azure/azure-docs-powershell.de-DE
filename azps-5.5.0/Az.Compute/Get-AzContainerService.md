...
## BESCHREIBUNG
Das **Cmdlet "Get-AzContainerService"** ruft einen Containerdienst ab.
Sie können die Eigenschaften eines Containerdiensts anzeigen, die den Zustand, die Anzahl der Master und Agents sowie den vollqualifizierten Domänennamen des Master- und Agentdiensts umfassen.

## BEISPIELE

### Beispiel 1: Erhalten eines Containerdiensts
```
...
Dieser Befehl ruft einen Containerdienst namens CSResourceGroup17 ab.

### Beispiel 2: Alle Containerdienste erhalten
```
...
Dieser Befehl ruft alle Containerdienste im Abonnement ab.

### Beispiel 3: Alle Containerdienste in der Ressourcengruppe erhalten
```
...
Dieser Befehl ruft alle Containerdienste in ResourceGroup17 ab.

### Beispiel 4: Alle Containerdienste mithilfe von Filter erhalten
```
...
Dieser Befehl ruft alle Containerdienste ab "CSResourceGroup1" ab.
...
### -Name
Gibt den Namen des Containerdiensts an, den dieses Cmdlet erhält.
...
### -ResourceGroupName
Gibt die Ressourcengruppe des Containerdiensts an, den dieses Cmdlet erhält.
