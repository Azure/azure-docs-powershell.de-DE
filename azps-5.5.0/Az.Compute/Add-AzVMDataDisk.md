...
Mit dem zweiten Befehl wird dem virtuellen Computer, der auf dem Computer gespeichert ist, $VirtualMachine.
...
Der Befehl weist dem virtuellen Computer einen Namen und eine Größe zu.
Mit den nächsten beiden Befehlen werden den Variablen Pfade für das Datenbild bzw. die Datenträger $DataImageUri $DataDiskUri Datenträgern zugewiesen.
...
Dieser Ansatz wird verwendet, um die Lesbarkeit der folgenden Befehle zu verbessern.
Der letzte Befehl fügt dem virtuellen Computer, der auf der Festplatte gespeichert ist, einen $VirtualMachine.
Der Befehl gibt den Namen und Speicherort des Datenträgers sowie weitere Eigenschaften des Datenträgers an.
