...
Verknüpfter IoT-Hub mit einem Azure IoT Hub-Gerätebereitstellungsdienst mit AllocationWeight und ApplyAllocationPolicy.

## PARAMETERS

### -AllocationWeight
Gewichtung der Zuordnung des IoT Hub
...
### -ApplyAllocationPolicy
Ein boolescher Wert, der angibt, ob eine Zuweisungsrichtlinie auf den IoT Hub angewendet werden soll
...
Verbindungszeichenfolge der Iot-Hub-Ressource.
