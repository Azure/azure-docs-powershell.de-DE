...
### Beispiel 1: Löschen eines virtuellen Windows-Desktoparbeitsbereichs nach Name
```powershell
PS C:\> Remove-AzWvdWorkspace -ResourceGroupName ResourceGroupName -Name WorkspaceName
```

Mit diesem Befehl wird ein virtueller Windows-Desktoparbeitsbereich in einer Ressourcengruppe gelöscht.
