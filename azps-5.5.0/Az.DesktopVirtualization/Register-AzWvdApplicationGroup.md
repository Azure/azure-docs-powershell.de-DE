...
### Beispiel 1: Registrieren einer Gruppe für virtuelle Windows-Desktopanwendung
```powershell
...
Mit diesem Befehl wird eine Gruppe für virtuelle Windows-Desktopanwendung für einen Arbeitsbereich registriert.
