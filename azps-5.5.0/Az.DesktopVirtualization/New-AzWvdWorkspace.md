...
Dieser Befehl erstellt einen virtuellen Windows-Desktoparbeitsbereich in einer Ressourcengruppe.

### Beispiel 2: Erstellen eines virtuellen Desktoparbeitsbereichs für Windows nach Name
```powershell
PS C:\> New-AzWvdWorkspace -ResourceGroupName ResourceGroupName `
                        -Name WorkspaceName `
                        -Location 'eastus' `
...
### -ApplicationGroupReference
Liste der ApplicationGroup-Ressourcen-IDs.
