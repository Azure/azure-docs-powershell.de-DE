...
### Beispiel 1: Erhalten eines "MSIX Package by Name"
```powershell
...
Dieser Befehl ruft ein "MSIX Package" in einem HostPool ab.
...
Mit diesem Befehl werden die MSIX-Pakete in einem HostPool aufgeführt.
