...
### Beispiel 1: Erhalten einer Virtuellen Desktopanwendungsgruppe für Windows nach Name
```powershell
...
Dieser Befehl ruft eine Windows Virtual Desktop ApplicationGroup in einer Ressourcengruppe ab.

### Beispiel 2: Auflisten der Virtuellen Desktopanwendungsgruppe von Windows
```powershell
...
Dieser Befehl listet eine Windows Virtual Desktop ApplicationGroups in einer Ressourcengruppe auf.
...
Gültige Eigenschaften zum Filtern sind applicationGroupType.
