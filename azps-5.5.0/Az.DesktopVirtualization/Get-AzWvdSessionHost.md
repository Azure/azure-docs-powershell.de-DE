...
### Beispiel 1: Erhalten eines virtuellen Windows-Desktop-SessionHosts nach Name
```powershell
...
Dieser Befehl ruft einen virtuellen Windows-Desktop-SessionHost in einem Hostpool ab.

### Beispiel 2: Auflisten von SessionHosts für den virtuellen Windows-Desktop
```powershell
...
Dieser Befehl enthält eine Windows Virtual Desktop SessionHosts in einem Hostpool.
