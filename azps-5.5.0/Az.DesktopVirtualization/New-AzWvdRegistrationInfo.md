...
### Beispiel 1: Erstellen eines Tokens für die Registrierung des virtuellen Windows-Desktops
```powershell
...
Mit diesem Befehl wird ein Windows Virtual Desktop Registration Token in einem Hostpool erstellt.
