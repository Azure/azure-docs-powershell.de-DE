...
### Beispiel 1: Aktualisieren eines Windows Virtual Desktop HostPools nach Name
```powershell
...
Mit diesem Befehl wird ein Windows Virtual Desktop HostPool in einer Ressourcengruppe aktualisiert.
...
### -MaxSessionLimit
Die maximale Sitzungsgrenze von HostPool.
...
Der Typ der bevorzugten Anwendungsgruppe, Standardeinstellung "Desktopanwendungsgruppe"
...
### -SsoadfsAuthority
URL des ADFS-Kundenservers zum Signieren von WVD-SSO-Zertifikaten.
...
### -SsoClientId
ClientId für die registrierte Vertrauende Partei, die zum Ausstellen von WVD-SSO-Zertifikaten verwendet wird.
...
Pfad zu Azure KeyVault, der den geheimen Schlüssel für die Kommunikation mit ADFS speichert.
...
### -SsoContext
Pfad zu Keyvault, der den geheimen Schlüssel "ssoContext" enthält.
...
### -SsoSecretType
Der Typ des einzelnen Zeichens für den geheimen Typ.
...
Ist die Gültigkeitsprüfungsumgebung.
