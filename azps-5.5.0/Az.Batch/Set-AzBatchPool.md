...
## BESCHREIBUNG
Das **Cmdlet "Set-AzBatchPool"** aktualisiert die Eigenschaften eines Pools im Azure Batch-Dienst.
Verwenden Sie das Get-AzBatchPool-Cmdlet, um ein **PSCloudPool-Objekt zu** erhalten.
Ändern Sie die Eigenschaften dieses Objekts, und verwenden Sie dann das aktuelle Cmdlet, um Ihre Änderungen an den Batchdienst zu commiten.
...
Der erste Befehl ruft einen Pool mithilfe von **"Get-AzBatchPool"** ab und speichert ihn dann in der $Pool Variable.
Mit den nächsten drei Befehlen wird die Startaufgabesspezifikation für das $Pool geändert.
Der letzte Befehl aktualisiert den Batchdienst so, dass er dem lokalen Objekt in der $Pool.
...
### -Pool
Gibt den **PSCloudPool an,** für den dieses Cmdlet den Batchdienst aktualisiert.
