...
## BESCHREIBUNG
Das **Cmdlet "Restart-AzBatchComputeNode"** startet den angegebenen Rechenknoten neu.

## BEISPIELE

### Beispiel 1: Neustarten eines Rechenknotens
```
PS C:\>Restart-AzBatchComputeNode -PoolId "MyPool" -Id "tvm-3257026573_2-20150813t200938z" -BatchContext $Context
```

Dieser Befehl startet den Rechenknoten mit der ID "tvm-3257026573_2-20150813t200938z" im MyPool-Pool neu.

### Beispiel 2: Neustarten aller Rechenknoten in einem Pool
```
PS C:\>Get-AzBatchComputeNode -PoolId "MyPool" -BatchContext $Context | Restart-AzBatchComputeNode -BatchContext $Context
```

Mit diesem Befehl wird jeder Rechenknoten im MyPool-Pool neu gestartet.
...
### -ComputeNode
Gibt das **PSComputeNode-Objekt** an, das den neu zu startenden Computeknoten darstellt.
...
### -ID
Gibt die ID des neu zu startenden Rechenknotens an.
...
### -PoolId
Gibt die ID des Pools an, der den Rechenknoten enthält.
...
### -RebootOption
Gibt an, wann der Knoten neu gestartet werden soll und was mit den derzeit ausgeführten Aufgaben zu tun ist.
Die Standardeinstellung ist "Erneut festlegen".
