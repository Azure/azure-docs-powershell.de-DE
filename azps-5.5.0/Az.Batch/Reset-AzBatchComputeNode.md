...
## BESCHREIBUNG
Das **Cmdlet "Reset-AzBatchComputeNode"** installiert das Betriebssystem auf dem angegebenen Rechenknoten erneut.
...
Dieser Befehl reimages the compute node with ID "tvm-3257026573_2-20150813t200938z" in the pool named MyPool.
...
Dieser Befehl reimages jeden Rechenknoten im Pool namens "MyPool".
...
### -ComputeNode
Gibt das **PSComputeNode-Objekt** an, das den zu reimagedenden Computeknoten darstellt.
...
### -ID
Gibt die ID des zu reimagedenden Computeknotens an.
...
### -ReimageOption
Gibt an, wann der Knoten neu nachbebildert werden soll und was mit derzeit ausgeführten Aufgaben zu tun ist.
