...
## BESCHREIBUNG
Das **Cmdlet "Set-AzBatchTask"** aktualisiert die Eigenschaften einer Aufgabe im Azure Batch-Dienst.
...
Der erste Befehl ruft eine Aufgabe mithilfe von **"Get-AzBatchTask"** ab und speichert sie dann in der $Task Variable.
Mit den nächsten beiden Befehlen werden die Einschränkungen des Vorgangs in $Task.
Der letzte Befehl aktualisiert den Batchdienst so, dass er dem lokalen Objekt in der $Task.
...
### -Task
Gibt den **PSCloudTask an, für** den dieses Cmdlet den Batchdienst aktualisiert.
