...
## BESCHREIBUNG
Das **Cmdlet "Enable-AzBatchJob"** aktiviert einen Azure Batch-Auftrag.
Nachdem Sie einen Auftrag aktiviert haben, können neue Aufgaben ausgeführt werden.

## BEISPIELE

### Beispiel 1: Aktivieren eines Stapelauftrags
```
PS C:\>Enable-AzBatchJob -Id "Job-000001" -BatchContext $Context
```

Dieser Befehl aktiviert den Auftrag mit der ID Job-000001.
