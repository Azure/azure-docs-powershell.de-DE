...
## BESCHREIBUNG
Das **Cmdlet "Disable-AzBatchJob"** deaktiviert einen Azure Batch-Auftrag.
Nachdem Sie einen Auftrag aktiviert haben, können neue Aufgaben ausgeführt werden.
Mit deaktivierten Aufträgen werden keine neuen Aufgaben ausgeführt.
Sie können einen deaktivierten Auftrag später aktivieren.

## BEISPIELE

### Beispiel 1: Deaktivieren eines Stapelauftrags
```
PS C:\>Disable-AzBatchJob -Id "Job-000001" -DisableJobOption "Terminate" -BatchContext $Context
```

Mit diesem Befehl wird der Auftrag mit der ID Job-000001 deaktiviert.
Der Befehl beendet aktive Aufgaben für den Auftrag.
...
### -DisableJobOption
Gibt an, was mit aktiven Aufgaben zu tun ist, die mit dem Auftrag verknüpft sind, den dieses Cmdlet deaktiviert.
Gültige Werte sind:
- Requeue
- Beenden
- Warte
