...
## BESCHREIBUNG
Das **Cmdlet "New-AzBatchComputeNodeUser"** erstellt ein Benutzerkonto für einen Azure Batch-Rechenknoten.
...
Mit diesem Befehl wird ein Benutzerkonto für den Rechenknoten erstellt, der die ID ComputeNode01 besitzt.
Der Knoten befindet sich in dem Pool mit der ID MyPool01.
Der Benutzername ist "TestUser", das Kennwort ist "Password", das Konto läuft in sieben Tagen ab, und das Konto verfügt über Administratoranmeldeinformationen.

### Beispiel 2: Erstellen eines Benutzerkontos auf einem Rechenknoten mithilfe der Pipeline
```
PS C:\>Get-AzBatchComputeNode "MyPool01" -ComputeNodeId "ComputeNode01" -BatchContext $Context | New-AzBatchComputeNodeUser -Name "TestUser" -Password "Password" -BatchContext $Context
```

Dieser Befehl ruft den Computeknoten "ComputeNode01" mit dem **Cmdlet "Get-AzBatchComputeNode"** ab.
Dieser Knoten befindet sich in dem Pool mit der ID MyPool01.
Der Befehl übergibt diesen Rechenknoten mithilfe des Pipelineoperators an das aktuelle Cmdlet.
Mit dem Befehl wird ein Benutzerkonto erstellt, das den Benutzernamen "TestUser" und das Kennwort "Password" hat.
...
### -ComputeNode
Gibt den Rechenknoten als ein **PSComputeNode-Objekt** an, für das dieses Cmdlet ein Benutzerkonto erstellt.
...
### -ComputeNodeId
Gibt die ID des Rechenknotens an, für den dieses Cmdlet ein Benutzerkonto erstellt.
...
### -IsAdmin
Gibt an, dass das Cmdlet ein Benutzerkonto mit Administratoranmeldeinformationen erstellt.
...
### -PoolId
Gibt die ID des Pools an, der den Rechenknoten enthält, für den das Benutzerkonto erstellt werden soll.
