...
## BESCHREIBUNG
Das **Cmdlet "New-AzBatchAccount"** erstellt ein Azure -Batchkonto für die angegebene Ressourcengruppe und den angegebenen Speicherort.
...
Mit diesem Befehl wird ein Batchkonto namens "pfuller" erstellt, indem die Ressourcengruppe "ResourceGroup03" am Speicherort "USA, Westen" verwendet wird.
...
Batchkontonamen müssen zwischen 3 und 24 Zeichen lang sein und dürfen nur Zahlen und Kleinbuchstaben enthalten.
...
### -KeyVaultId
Die Ressourcen-ID des Azure-Schlüsseltresor, der dem Batchkonto zugeordnet ist.
...
### -KeyVaultUrl
Die URL des Azure-Schlüsseltresor, der dem Batchkonto zugeordnet ist.
...
### -Location
Gibt die Region an, in der dieses Cmdlet das Konto erstellt.
...
### -PoolAllocationMode
Der Zuordnungsmodus zum Erstellen von Pool im Batchkonto.
