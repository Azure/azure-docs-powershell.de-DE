...
Mit diesem Befehl wird das Zertifikat mit dem angegebenen Druckabdruck entfernt.
...
Dieser Befehl ruft alle aktiven Zertifikate mithilfe des cmdlets Get-AzBatchCertificate ab.
Der Befehl übergibt die aktiven Zertifikate mithilfe des Pipelineoperators an das aktuelle Cmdlet.
Mit diesem Cmdlet wird jedes Zertifikat entfernt.
...
### -Thumbprint
Gibt den Fingerabdruck des Zertifikats an, das von diesem Cmdlet gelöscht wird.
