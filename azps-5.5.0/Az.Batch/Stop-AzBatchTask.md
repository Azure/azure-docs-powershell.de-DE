...
Mit diesem Befehl wird eine Aufgabe beendet, die die ID "Task23" unter dem Auftrag mit der ID Job-000001 hat.
...
### Beispiel 2: Beenden einer Batchaufgabe mithilfe der Pipeline
```
PS C:\>Get-AzBatchTask -JobId "Job-000001" -Id "Task26" -BatchContext $Context | Stop-AzBatchTask -BatchContext $Context
```

Mit diesem Befehl wird die Aufgabe "Batch" mit der ID Task26 in dem Auftrag mit der ID Job-000001 mithilfe des cmdlets Get-AzBatchTask batchen.
Der Befehl übergibt diese Aufgabe mithilfe des Pipelineoperators an das aktuelle Cmdlet.
Der Befehl beendet diese Aufgabe.
...
### -ID
Gibt die ID der Aufgabe an, die dieses Cmdlet beendet.
...
### -Task
Gibt die Aufgabe an, die dieses Cmdlet beendet.
