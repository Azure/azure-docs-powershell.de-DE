...
Der zweite Befehl weist den ID Pool22 der **Eigenschaft "PoolId"** des Objekts in $PoolInformation.
...
Der Batchdienst führt die Aufgabe "Auftragsvorbereitung" für einen Rechenknoten aus, bevor er Aufgaben dieses Auftrags für den Berechnungsknoten startet.
...
### -OnAllTasksComplete
Gibt eine Aktion an, die vom Stapeldienst ausgeführt wird, wenn sich alle Aufgaben im Auftrag im Status "Abgeschlossen" befinden.
