...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzBatchJobSchedule"** entfernt einen Auftragszeitplan in Azure Batch.

## BEISPIELE

### Beispiel 1: Löschen eines Stapelauftragszeitplans
```
PS C:\>Remove-AzBatchJobSchedule -Id "MyJobSchedule" -BatchContext $Context
```

Mit diesem Befehl wird der Auftragszeitplan mit der ID "MeinJobSchedule" gelöscht.
...
Mit diesem Befehl wird der Auftragszeitplan mit der ID "MyJobSchedule" mithilfe des cmdlets Get-AzBatchJobSchedule erhalten.
Der Befehl übergibt diesen Auftragszeitplan mithilfe des Pipelineoperators an das aktuelle Cmdlet.
Dieser Auftragszeitplan wird mit dem Befehl gelöscht.
...
### -ID
Gibt die ID des zu entfernenden Auftragsplans an.
