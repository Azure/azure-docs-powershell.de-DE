...
## BESCHREIBUNG
Das Set-AzAttestationPolicy cmdlet legt die Richtlinie von einem Mandanten in Azure Attestation fest.
...
Legt die benutzerdefinierte Richtlinie für den TEE-Typ *"SgxEnzente* for Attestation Provider *pshtest"* mit einem Textrichtlinienformat (Standard) fest.
...
Legt die benutzerdefinierte Richtlinie für den TEE-Typ *"SgxEnffee* for Attestation Provider *pshtest"* mithilfe eines JWT-Richtlinienformats fest.
...
Dieses Cmdlet legt die Nachweisrichtlinie für den Mandanten fest, den dieser Parameter angibt.
...
### -Policy
Gibt das fest zu setzende Richtliniendokument an.  Das Richtlinienformat kann Text oder JSON Web Token (JWT) sein.
...
### -PolicyFormat
Gibt das Format für die Richtlinie an, entweder Text oder JWT (JSON-Webtoken).  Das Standardrichtlinienformat ist "Text".
...
Es werden vier Umgebungstypen unterstützt: SgxEncomponene, OpenEnsdatum, CyResComponent und VBSEnsdatume.
