...
## SYNOPSIS
Löscht eine IoT-Zentralanwendung.
...
## BESCHREIBUNG
Löscht eine vorhandene IoT-Zentralanwendung.

## BEISPIELE

### Beispiel 1 Delete and IoT Central Application
```powershell
PS C:\> Remove-AzIotCentralApp -ResourceGroupName "MyResourceGroupName" -Name "MyAppResourceName"
```

Löscht die bereitgestellte IoT-Zentralanwendung.
