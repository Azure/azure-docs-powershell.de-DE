...
Aktivieren Sie die `HttpApplicationRouting` Add-Ons `Monitoring` , und `AzurePolicy` für `VirtualNode` `KubeDashboard` aks.
...
### -WorkspaceResourceId
Ressourcen-ID des Arbeitsbereichs für Überwachung.
