...
### Importieren und Zusammenführen der Konfigurationskonfiguration von Kubectl
```
...
### -Admin
Holen Sie sich die Kubectl-Konfiguration "clusterAdmin" anstelle des standardmäßigen "clusterUser".
...
Verwenden Sie "-", um YAML stattdessen zum Drucken zu drucken.
...
### -Force
Import Kubernetes config, auch wenn dies die Standardkonfiguration ist
...
### -PassThru
Gibt "true" zurück, wenn der Importvorgang erfolgreich ist.
