...
### Beispiel 1: Aktualisieren eines verbundenen Kubernets
```powershell
...
Mit diesem Befehl werden verbundene Kubernets aktualisiert.

### Beispiel 2: Aktualisieren eines verbundenen Kubernets nach Objekt
```powershell
...
Mit diesem Befehl werden verbundene Kubernets nach Objekt aktualisiert.
