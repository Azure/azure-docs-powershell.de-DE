...
## SYNOPSIS
Gibt die Eigenschaften des angegebenen verbundenen Cluster zurück, einschließlich Name, Identität, Eigenschaften und weiteren Clusterdetails.
...
### Beispiel 1: Alle verbundenen Kubernets unter einem Abonnement erhalten
```powershell
...
Dieser Befehl ruft alle verbundenen Kubernets unter einem Abonnement ab.

### Beispiel 2: Alle verbundenen Kubernets unter der Ressourcengruppe
```powershell
...
Dieser Befehl ruft alle verbundenen Kubernets unter der Ressourcengruppe ab.

### Beispiel 3: Erhalten eines verbundenen Kubernets
```powershell
...
Dieser Befehl ruft verbundene Kubernets ab.

### Beispiel 4: Erhalten eines verbundenen Kubernets nach Objekt
```powershell
...
### -ClusterName
Der Name des Kubernetes-Cluster, für den "get" aufgerufen wird.
...
### Microsoft.Azure.PowerShell.Cmdlets.ConnectedConnecternetes.Models.IConnectedKoppelernetesIdentity

## AUSGABEN

### Microsoft.Azure.PowerShell.Cmdlets.ConnectedConnecternetes.Models.Api202001Preview.IConnectedCluster
...
INPUTOBJECT <IConnectedKubernetesIdentity> : Identity Parameter
  - `[ClusterName <String>]`: Der Name des Kubernetes-Cluster, für den "get" aufgerufen wird.
