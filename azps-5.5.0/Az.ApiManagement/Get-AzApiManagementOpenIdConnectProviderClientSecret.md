...
### Beispiel 1: Erhalten eines geheimen Anbieterclients mithilfe einer ID
```
...
Dieser Befehl ruft einen geheimen Clientgeheimnis des Anbieters ab, der die ID OICProvider01 besitzt.
...
Id eines OpenID Connect-Anbieters.
Dieser Parameter ist erforderlich.
