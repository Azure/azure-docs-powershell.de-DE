...
## BESCHREIBUNG
Das **Cmdlet "Add-AzApiManagementApiToGateway"** fügt einem Gateway eine Azure API-Verwaltungs-API hinzu.
...
Mit diesem Befehl wird die angegebene API dem angegebenen Gateway hinzufügt.
...
### -ProvisioningState
Bereitstellungszustand (Erstellt).
Dieser Parameter ist optional.
