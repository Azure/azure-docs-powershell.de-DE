...
### Beispiel 1: Erstellen und Initialisieren einer Instanz von PsApiManagementCustomHostNameConfiguration mithilfe eines Zertifikats aus einer Datei
```powershell
...
Mit diesem Befehl wird eine Instanz von **"PsApiManagementCustomHostNameConfiguration** for Portal" erstellt und initialisiert. Anschließend erstellt er einen neuen ApiManagement-Dienst mit benutzerdefinierter Hostnamenkonfiguration.

### Beispiel 2: Erstellen und Initialisieren einer Instanz von PsApiManagementCustomHostNameConfiguration mithilfe eines Geheimschlüssels aus der KeyVault-Ressource
```powershell
...
### -DefaultSslBinding
Bestimmt, ob der Wert ein geheimer Wert ist und verschlüsselt werden soll.
