...
## BESCHREIBUNG
Das **Cmdlet "Get-AzApiManagementApiRevision"** ruft die Details aller Überarbeitungen einer API ab.

## BEISPIELE

### Beispiel 1: Abrufen aller API-Überarbeitungen einer API
```powershell
...
Dieser Befehl ruft die ganze API-Überarbeitung der angegebenen API für einen bestimmten ApiManagement-Kontext ab.

## PARAMETERS

### -ApiId
API-Id, deren Überarbeitungen wir auflisten möchten.
...
### -ApiRevision
Revisions-ID der jeweiligen API-Überarbeitung. Dieser Parameter ist optional.
