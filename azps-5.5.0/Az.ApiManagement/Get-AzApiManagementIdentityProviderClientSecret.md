...
### Beispiel 1: Den Geheimen Clientgeheimnis des AAD-Typidentitätsanbieters erhalten
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\> Get-AzApiManagementIdentityProviderClientSecret -Context $apimContext -Type Aad
```

Ruft den geheimen Clientgeheimnis der Identitätsanbieterkonfiguration von Azure Active Directory ab.
