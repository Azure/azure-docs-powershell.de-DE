...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzApiManagementAuthorizationServer"** entfernt einen Azure API Management-Autorisierungsserver.
...
Mit diesem Befehl wird der angegebene API Management Authorization Server entfernt.
Da der *Parameter "Force"* angegeben wird, ist keine Bestätigung erforderlich.
