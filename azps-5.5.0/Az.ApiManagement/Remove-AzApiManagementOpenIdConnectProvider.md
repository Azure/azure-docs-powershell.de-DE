...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzApiManagementOpenIdConnectProvider"** entfernt einen OpenID Connect-Anbieter für Azure API Management.
...
Mit diesem Befehl wird ein Anbieter entfernt, der über die ID OICProvider01 verfügt.
