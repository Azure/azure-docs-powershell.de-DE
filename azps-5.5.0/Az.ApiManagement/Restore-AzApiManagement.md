...
## BESCHREIBUNG
Das **Cmdlet "Restore-AzApiManagement"** stellt einen API-Verwaltungsdienst aus der angegebenen Sicherung wieder her, die sich in einem Azurestorage-BLOB befinden.
...
Mit diesem Befehl wird ein API-Verwaltungsdienst aus dem Azure-Speicher-BLOB wiederhergestellt.
...
### -SourceBlobName
Gibt den Namen des Azure Storage Backup Source BLOB an.
...
### -SourceContainerName
Gibt den Namen des Azure Storage Backup Source Containers an.
...
### -StorageContext
Gibt den Kontext der Speicherverbindung an.
