...
### -ApiRevision
Bezeichner der API-Überarbeitung. Dieser Parameter ist optional. Wenn nichts angegeben wird, wird der Vorgang aus der derzeit aktiven API-Überarbeitung entfernt.
...
### -PassThru
Gibt an, dass dieses Cmdlet den Wert "$True, wenn es erfolgreich ist, oder den Wert "$False" zurückgibt.
