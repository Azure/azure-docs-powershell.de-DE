...
### Beispiel 1: Generieren eines freigegebenen Zugriffstokens für einen Git-Benutzer
```powershell
...
Mit diesem Skript wird der Git-Benutzer im Dienst "ApiManagement" konfiguriert und ein Token für gemeinsam genutzten Zugriff generiert, der den für 8 Stunden gültigen Primärschlüssel verwendet.
...
### -Expiry
Ablauf des Tokens.
Wenn nichts angegeben wird, läuft das Token nach 8 Stunden ab.
...
### -UserId
Id eines vorhandenen Benutzers.
Dieser Parameter ist erforderlich.
