...
### -Format
Gibt das Format der Richtlinie an. Bei Verwendung `application/vnd.ms-azure-apim.policy+xml` müssen in der Richtlinie enthaltene Ausdrücke mit einem XML-Escape-Code erstellt werden. Wenn sie `application/vnd.ms-azure-apim.policy.raw+xml` verwendet **wird, muss** für die Richtlinie kein XML-Escape-Code verwendet werden.
