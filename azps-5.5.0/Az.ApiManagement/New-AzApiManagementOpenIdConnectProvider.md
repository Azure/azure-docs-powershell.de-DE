...
## BESCHREIBUNG
Das **Cmdlet "New-AzApiManagementOpenIdConnectProvider"** erstellt einen OpenID Connect-Anbieter in Azure API Management.
...
Mit diesem Befehl wird ein OpenID **Connect-Anbieter namens** "Contoso OpenID Connect Provider" erstellt.

### Beispiel 2

Erstellt einen OpenID Connect-Anbieter. (automatisch generiert)
