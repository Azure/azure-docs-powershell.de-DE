...
### Beispiel 1: Alle Produkte erhalten
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementProduct -Context $apimContext
```

Mit diesem Befehl werden alle API-Verwaltungsprodukte abrufen.

### Beispiel 2: Produkt nach ID erhalten
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementProduct -Context $apimContext -ProductId "0123456789"
```

Mit diesem Befehl wird ein API-Verwaltungsprodukt nach ID abrufen.
...
### -ProductId
Gibt den Bezeichner des zu suchden Produkts an.
...
### -Title
Gibt den Titel des zu suchenden Produkts an.
Falls angegeben, versucht das Cmdlet, das Produkt nach Titel zu erhalten.
