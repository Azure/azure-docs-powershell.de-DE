...
## BESCHREIBUNG
Das **Cmdlet "Set-AzApiManagementLogger"** ändert die Einstellungen eines Azure API-Verwaltungsprotokollgers. 

## BEISPIELE

### Beispiel 1: Ändern des EreignisHub-Protokollgers
```powershell
...
Mit diesem Befehl wird ein Protokoller mit dem ID Logger123 geändert.

### Beispiel 2

Ändert einen API-Verwaltungsprotokollger. (automatisch generiert)
...
### -ConnectionString
Gibt eine Azure-Ereignishubs-Verbindungszeichenfolge an, die Senderichtlinienrechte enthält.
...
### -IsBuffered
Gibt an, dass die Datensätze im Protokollger vor der Veröffentlichung gepuffert werden.
Wenn Datensätze gepuffert werden, werden sie alle 15 Sekunden oder immer dann an Ereignishubs gesendet, wenn der Puffer 256 KB an Nachrichten empfängt.
...
### -LoggerId
Gibt die ID des zu aktualisierenden Protokollgers an.
