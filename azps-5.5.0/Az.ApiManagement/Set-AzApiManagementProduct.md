...
## BESCHREIBUNG
Das **Cmdlet "Set-AzApiManagementProduct"** legt die Produktdetails für die API-Verwaltung fest.

## BEISPIELE

### Beispiel 1: Aktualisieren der Produktdetails
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Set-AzApiManagementProduct -Context $apimContext -ProductId "0123456789" -Title "Starter" -Description "Starter Product" -LegalTerms "Free for all" -SubscriptionRequired $True -State "NotPublished"
```

Mit diesem Befehl werden die Produktdetails der API-Verwaltung aktualisiert, ein Abonnement erforderlich und die Veröffentlichung anschließend wieder aufheben.

## PARAMETERS

### -ApprovalRequired
Gibt an, ob das Abonnement des Produkts genehmigt werden muss.
...
### -LegalTerms
Gibt die rechtlichen Nutzungsbedingungen des Produkts an.
...
Der Standardwert für diesen Parameter ist "None".
...
### -Title
Gibt den Produkttitel an, den dieses Cmdlet legt.
