...
Das **Cmdlet "Remove-AzAzureRmApiManagementVersionSet"** entfernt einen vorhandenen API-Versionssatz.

## BEISPIELE

### Beispiel 1: Entfernen eines API-Versionssets
```powershell
...
### -ApiVersionSetId
Bezeichner des API-Versionssatz.
