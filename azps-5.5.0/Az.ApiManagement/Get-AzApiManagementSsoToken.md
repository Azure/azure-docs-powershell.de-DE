...
## BESCHREIBUNG
Das **Cmdlet "Get-AzApiManagementSsoToken"** gibt einen Link (URL) zurück, der ein Einmaliges Anmelden (Single Sign-On, SSO)-Token zu einem bereitgestellten Verwaltungsportal eines API-Verwaltungsdiensts enthält.
