...
## BESCHREIBUNG
Das **Cmdlet "New-AzApiManagementOperation"** erstellt einen API-Vorgang.
...
Dieser Befehl erstellt einen API-Verwaltungsvorgang.
...
In diesem Beispiel wird ein API-Verwaltungsvorgang mit Anforderungs- und Antwortdetails erstellt.

## PARAMETERS

### -ApiId
Gibt den Bezeichner des API-Verwaltungsvorgangs an.
...
### -ApiRevision
Bezeichner der API-Überarbeitung. Dieser Parameter ist optional. Wenn dieser Vorgang nicht angegeben wird, wird er an die derzeit aktive API-Überarbeitung angefügt.
...
### -Name
Gibt den Anzeigenamen eines neuen API-Verwaltungsvorgangs an.
...
### -Responses
Gibt ein Array möglicher Reaktionen auf DEN API-Verwaltungsvorgang an.
...
### -TemplateParameters
Gibt ein Array von Parametern an, das im Parameter *"UrlTemplate" definiert ist.*
Wenn Sie diesen Parameter nicht angeben, wird ein Standardwert generiert, der auf *"UrlTemplate" basiert.*
