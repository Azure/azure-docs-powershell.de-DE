...
## BESCHREIBUNG
Das **Cmdlet "Get-AzApiManagementAuthorizationServerClientSecret"** ruft den geheimen Clientgeheimnis des Azure API Management Authorization Servers ab.

## BEISPIELE

### Beispiel 1: Einen angegebenen Autorisierungsserverclient geheim nach ID erhalten
```
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementAuthorizationServerClientSecret -Context $ApiMgmtContext -ServerId "0123456789"
```

Dieser Befehl ruft den angegebenen geheimen Schlüssel des Autorisierungsservers ab.
...
Bei Angabe wird versucht, den Autorisierungsserver nach dem Bezeichner zu finden.
Dieser Parameter ist erforderlich.
...
### -ServerId
Id des Autorisierungsservers.
Wenn angegeben, wird der Autorisierungsserver nach dem Bezeichner suchen.
