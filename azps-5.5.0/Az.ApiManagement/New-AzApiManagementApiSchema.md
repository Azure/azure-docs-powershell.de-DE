...
### Beispiel 1: Erstellen eines neuen Schemas für die umfangreiche API "Swagger Petstore"
```powershell
...
Das Cmdlet **"New-AzApiManagementApiSchema"** erstellt oder aktualisiert das Schema des `swagger-petstore-extensive` aPI.
...
Dateipfad des API-Schemadokuments. Dieser Parameter ist erforderlich: "-SchemaDocument" wird nicht angegeben.
