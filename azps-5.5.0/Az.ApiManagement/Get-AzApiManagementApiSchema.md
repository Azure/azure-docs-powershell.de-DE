...
Dieser Befehl ruft alle API-Schemas ab, die einer API für `swagger-petstore-extensive` einen bestimmten ApiManagement-Kontext zugeordnet sind.
...
Dieser Befehl ruft das API-Schema ab, `5cc9cf67e6ed3b1154e638bd` das einer API für einen `swagger-petstore-extensive` bestimmten ApiManagement-Kontext zugeordnet ist.

## PARAMETERS

### -ApiId
API-ID, nach der Sie suchen.
Wenn diese Angabe angegeben ist, wird versucht, die API nach der ID zu erhalten.
...
### -ResourceId
Arm Resource Identifier eines API-Schemas. Wenn angegeben, wird versucht, das API-Schema nach dem Bezeichner zu finden. Dieser Parameter ist erforderlich.
