...
Erstellt eine Registrierungsdefinition nach "roleDefinitionId"- und "principalId"-Werten, die direkt angegeben werden.
...
Erstellt oder aktualisiert eine Registrierungsdefinition mit Autorisierungsdetails.
...
Aktualisiert eine Registrierungsdefinition mit Autorisierungsdetails und dem Namen der Registrierungsdefinition.

## PARAMETERS

### -Authorization
Die Liste der Autorisierungszuordnungen mit principalId - roleDefinitionId.
...
### -DisplayName
Der Anzeigename der Registrierungsdefinition.
...
### -ManagedByTenantId
Der ManagedBy-Mandantenbezeichner.
...
### -Name
Der eindeutige Name der Registrierungsdefinition.
...
### -PrincipalId
Der ManagedBy Principal Identifier.
...
### -RoleDefinitionId
Der Rollendefinitionsbezeichner zum Erteilen von Berechtigungen für den Prinzipalbezeichner.
