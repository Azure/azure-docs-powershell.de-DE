...
## BESCHREIBUNG
Das **Cmdlet "Stop-AzDeploymentManagerRollout"** beendet den aktuellen Rollout und gibt ein Objekt zurück, das den aktuellen Status des Rollouts darstellt.
...
Beachten Sie, dass ein angehaltenes Rollout nicht fortgesetzt oder neu gestartet werden kann. Sie können nur ein neues Rollout erstellen.
...
Dieser Befehl stoppt das Rollout "ContosoRollout" in der ContosoResourceGroup. 
...
Mit diesem Befehl wird das Rollout "ContosoRollout" in der ContosoResourceGroup beendet.
...
Dieser Befehl stoppt ein Rollout, dessen Name und Ressourcengruppe den Eigenschaften "Name" bzw. "ResourceGroupName" des $rolloutObject entsprechen.
...
### -InputObject
Das Rollout, das entfernt werden soll.
