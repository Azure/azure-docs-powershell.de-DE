...
### Beispiel 1: Standardmäßig wird eine AzDigitalTwinsInstance erstellt.
```powershell
...
Standardmäßiges Erstellen einer AzDigitalTwinsInstance

### Beispiel 2: Erstellen eines AzDigitalTwinsInstance von AzDigitalTwins-Objekt.
```powershell
...
Erstellen eines AzDigitalTwinsInstance von AzDigitalTwins-Objekt
...
Informationen zum Erstellen finden Sie im Abschnitt "NOTES" für "DIGITALTWINSCREATE"-Eigenschaften und zum Erstellen einer Hashtabelle.
...
DIGITALTWINSCREATE <IDigitalTwinsDescription> : Die Beschreibung des DigitalTwins-Diensts.
  - `Location <String>`: Der Ressourcenspeicherort.
  - `[Tag <IDigitalTwinsResourceTags>]`: Die Ressourcentags.
