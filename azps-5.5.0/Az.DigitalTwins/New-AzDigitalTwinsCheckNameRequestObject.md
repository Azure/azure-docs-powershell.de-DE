...
### Beispiel 1: Erstellen eines DigitalTwinsCheckNameRequestObject nach Name
```powershell
...
Erstellen eines DigitalTwinsCheckNameRequestObject nach Name
