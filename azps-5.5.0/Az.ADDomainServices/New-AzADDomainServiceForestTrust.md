...
### Beispiel 1: Erstellen von ServiceForestTrust für ADDomain
```powershell
...
Erstellen von ServiceForestTrust für ADDomain
...
### -TrustedDomainFqdn
FQDN der vertrauenswürdigen Domäne.
