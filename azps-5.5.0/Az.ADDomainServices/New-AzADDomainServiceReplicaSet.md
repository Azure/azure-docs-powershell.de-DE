...
### Beispiel 1: Create ReplicaSet for AdDomain
```powershell
...
### -SubnetId
Der Name des virtuellen Netzwerks, in dem Domain Services bereitgestellt werden.
Die ID des Subnetzes, in dem Domänendienste bereitgestellt werden.
