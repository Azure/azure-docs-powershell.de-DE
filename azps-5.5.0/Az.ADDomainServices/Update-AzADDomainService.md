...
### Beispiel 2: Aktualisieren von AzADDomainService von Inputobject
```powershell
...
Aktualisieren von AzADDomainService von Inputobject
...
Ein Kennzeichen, um festzustellen, ob "SyncKerberosPasswords" aktiviert oder deaktiviert ist.
...
Ein Kennzeichen, um zu bestimmen, ob "SyncNtlmPasswords" aktiviert oder deaktiviert ist.
...
Ein Kennzeichen, um festzustellen, ob "SyncOnPremPasswords" aktiviert oder deaktiviert ist.
...
### -FilteredSync
Flag "Aktiviert" oder "Deaktiviert", um die gruppenbasierte gefilterte Synchronisierung zu aktivieren
...
### -ForestTrust
Liste der Einstellungen für "Ressource: Gesamtstruktur zum Erstellen" finden Sie im Abschnitt "NOTES" zu FORESTTRUST-Eigenschaften und erstellen eine Hashtabelle.
...
Ein Kennzeichen, mit dem Sie feststellen können, ob der Sichere LDAP-Zugriff über das Internet aktiviert oder deaktiviert ist.
...
### -LdapSettingLdaps
Ein Kennzeichen, mit dem Sie feststellen können, ob Secure LDAP aktiviert oder deaktiviert ist.
...
Das Zertifikat, das zum Konfigurieren von sicherem LDAP erforderlich ist.
...
Das Kennwort zum Entschlüsseln der bereitgestellten Pfxdatei für sichere LDAP-Zertifikate.
...
Sollten Administratoren des Domänencontrollers benachrichtigt werden?
...
### -ReplicaSet
Liste der zu erstellenden ReplicaSets finden Sie im Abschnitt NOTES zu DEN #A0 und zum Erstellen einer Hashtabelle.
...
FORESTTRUST <IForestTrust[]>: Liste der Einstellungen für die Ressourcen gesamtstruktur
  ...
  - `[TrustDirection <String>]`: Vertrauensstellungsrichtung
  - `[TrustPassword <String>]`: Kennwort vertrauenswürdig
  - `[TrustedDomainFqdn <String>]`: FQDN der vertrauenswürdigen Domäne

INPUTOBJECT <IAdDomainServicesIdentity> : Identity Parameter
  - `[DomainServiceName <String>]`: Der Name des Domänendiensts.
  - `[Id <String>]`: Ressourcenidentitätspfad
  - `[ResourceGroupName <String>]`: Der Name der Ressourcengruppe im Abonnement des Benutzers. Beim Namen wird die Groß-/Kleinschreibung nicht beachtet.
...
REPLICASET <IReplicaSet[]>: List of ReplicaSets
  ...
  - `[SubnetId <String>]`: Der Name des virtuellen Netzwerks, für das Domain Services bereitgestellt werden. Die ID des Subnetzes, in dem Domänendienste bereitgestellt werden. /virtualNetwork/vnetName/subnets/subnetName.
