...
## BESCHREIBUNG
Das **Cmdlet "Set-AzAutomationCertificate"** ändert die Konfiguration eines Zertifikats in der Azure-Automatisierung.
...
Der zweite Befehl ändert das Zertifikat "ContosoCertificate".
