...
## BESCHREIBUNG
Dieses Cmdlet hat eine Aktualisierungskonfiguration der Software für die Azure-Automatisierung entfernt.

## BEISPIELE

### Beispiel 1
In diesem Beispiel wird gezeigt, wie Sie "MyUpdateConfiguration" aus einem Automatisierungskonto entfernen.
...
### -Name
Name der softwareupdatekonfiguration, die entfernt werden soll.
...
### -PassThru
PassThru gibt ein Objekt zurück, das das Element darstellt, mit dem Sie arbeiten. Standardmäßig generiert dieses Cmdlet keine Ausgabe.
...
Die zu entfernende Softwareupdatekonfiguration.
