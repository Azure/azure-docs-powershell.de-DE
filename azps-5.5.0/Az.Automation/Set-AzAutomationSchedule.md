...
## BESCHREIBUNG
Das **Cmdlet "Set-AzAutomationSchedule"** ändert einen Zeitplan in der Azure-Automatisierung.
...
Mit diesem Befehl wird die Beschreibung des Zeitplans namens "Schedule01" geändert.

## PARAMETERS

### -AutomationAccountName
Gibt den Namen eines Automatisierungskontos an, für das dieses Cmdlet einen Zeitplan ändert.
...
### -IsEnabled
Gibt an, ob dieses Cmdlet den Zeitplan aktiviert.
...
### -Name
Gibt den Namen für den Zeitplan an, den dieses Cmdlet ändert.
...
### -ResourceGroupName
Gibt den Namen einer Ressourcengruppe an, für die dieses Cmdlet einen Zeitplan ändert.
