...
## BESCHREIBUNG
Dieses Cmdlet gibt eine Liste der ausgeführten Computer zurück. Jede Ausführung eines Softwareupdates löst eine Ausführung eines Computers für jeden Zielcomputer für die Softwareupdatekonfiguration aus. Übergeben Sie zum Ausführen eines bestimmten Computers den Id-Parameter. Sie können alle ausgeführten Computer, alle für einen bestimmten Computer ausgeführten, mit einem bestimmten Status ausgeführt werden, indem Sie die entsprechenden Parameter übergeben.

## BEISPIELE

### Beispiel 1
Dieses Beispiel gibt alle fehlgeschlagenen Computer zurück, die für den angegebenen virtuellen Azure-Computer ausgeführt werden.
...
### -ID
ID des ausgeführten Softwareupdatecomputers.
...
### -SoftwareUpdateRun
Das Softwareupdate wird ausgeführt.
...
### -SoftwareUpdateRunId
ID des ausgeführten Softwareupdates.
...
### -Status
Status des ausgeführten Computers.
...
### -TargetComputer
zielcomputer für den ausgeführten Computer.
Kann entweder ein Nicht-Computername oder eine Azure VM-Ressourcen-ID sein.
