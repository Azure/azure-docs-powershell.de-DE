...
## BESCHREIBUNG
Das **Cmdlet "Get-AzAutomationDscNodeConfigurationDeployment"** stellt eine Konfiguration des Knotens "APS Desired State Configuration (DSC)" in der Azure Automation bereit.

## BEISPIELE

### Beispiel 1: Alle Bereitstellungszeitpläne erhalten
```
...
### Beispiel 2: Erstellen eines Bereitstellungszeitplans
```
...
### -JobScheduleId
Gibt die Auftragsplan-ID eines vorhandenen geplanten Bereitstellungsauftrags an.
