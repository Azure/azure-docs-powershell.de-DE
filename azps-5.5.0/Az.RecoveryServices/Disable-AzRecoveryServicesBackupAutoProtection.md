...
## BESCHREIBUNG
Das **Cmdlet "Disable-AzRecoveryServicesBackupAutoProtection"** deaktiviert den Schutz für ein behebbares Element.
...
Das erste Cmdlet ruft den Sicherungscontainer vom Typ "AzureVMAppContainer" ab.  Das zweite Cmdlet ruft den schützenden BackupItem ab und deaktiviert den automatischen Schutz.

### Beispiel 2

Deaktiviert die automatische Sicherung für ein schützendes Element. (automatisch generiert)
...
### -WorkloadType
Arbeitsauslastungstyp der Ressource. Der aktuell unterstützte Wert ist "MSSQL"
