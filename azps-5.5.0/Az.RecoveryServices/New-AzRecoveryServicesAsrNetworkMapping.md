...
## BESCHREIBUNG
Das **Cmdlet "New-AzRecoveryServicesAsrNetworkMapping"** startet den Vorgang zum Erstellen einer ASR-Netzwerkzuordnung zwischen zwei Netzwerken und gibt das Objekt des ASR-Auftrags für den ASR-Auftrag zurück, mit dem der Vorgang nachverfolgt wird.
...
Startet den Vorgang zum Erstellen von Netzwerkzuordnungen unter Verwendung des angegebenen Namens, der primären Netzwerke und der Wiederherstellungsnetzwerke und gibt einen ASR-Auftrag zum Nachverfolgen des Vorgangs zurück.
...
Startet die Netzwerkzuordnung für den Erstellungsvorgang unter Verwendung des angegebenen Namens, der primären Netzwerke und der Wiederherstellungsnetzwerke und gibt einen ASR-Auftrag zurück, um den Vorgang nachverfolgt (Azure-zu-Azure-Szenario).

## PARAMETERS

### -AzureToAzure
Zum Erstellen eines AzureToAzure-Szenarios kennzeichnen.
...
### -Name
Name der zu erstellende ASR-Netzwerkzuordnung.
...
Gibt die virtuelle Azure-Netzwerk-ID des primären Netzwerks für die Zuordnung an.
...
Gibt die Azure-Netzwerk-ID der Wiederherstellung für die Netzwerkzuordnung an.
...
### -RecoveryNetwork
Gibt das Wiederherstellungsnetzwerkobjekt für die ASR-Netzwerkzuordnung an.
