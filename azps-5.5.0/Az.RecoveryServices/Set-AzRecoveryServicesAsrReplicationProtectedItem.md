...
Startet den Vorgang der Aktualisierung der NIC für replikationsgeschützte Elemente (zur Verwendung für wiederhergestellte vm )-Einstellungen unter Verwendung der angegebenen Parameter und gibt den ASR-Auftrag zurück, mit dem der Vorgang nachverfolgt wird.
...
Startet den Vorgang zum Aktualisieren des durch die Replikation geschützten Elements, für das "noc tp" ausgewählt wurde, das beschleunigte Netzwerk auf wiederherstellungs-VM(für Azure zu Azure-Notfallwiederherstellung).
...
Das Wörterbuch der Datenträgerressourcen-ID für die Datenträgerverschlüsselung, für das die ARM festgelegt ist.
...
### -EnableAcce inNetworkingOnRecovery
Gibt die angegebene NIC für die Wiederherstellungs-VM an, nachdem failoverbeschleunigtes Netzwerk verwendet wurde.
...
Gibt die Verfügbarkeitszone für replikationsgeschützte Elemente nach dem Failover an.
