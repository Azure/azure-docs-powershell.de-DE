...
## BESCHREIBUNG
Das **Cmdlet "New-AzRecoveryServicesAsrPolicy"** erstellt eine Azure-Websitewiederherstellungsreplikationsrichtlinie.
Die Replikationsrichtlinie wird verwendet, um Replikationseinstellungen anzugeben, z. B. die Replikationshäufigkeit und die Anzahl der Wiederherstellungspunkte.
...
Startet den Vorgang zum Erstellen einer Replikationsrichtlinie mit den angegebenen Parametern und gibt den ASR-Auftrag zurück, mit dem der Vorgang nachverfolgt wird.
...
Gibt die Häufigkeit (in Stunden) an, mit der in der Anwendung konsistente Wiederherstellungspunkte erstellt werden.
...
### -AzureToAzure
"Parameter wechseln" gibt das Szenario für die Erstellung von Azure-zu-Azure-Richtlinien an.
...
### -AzureToVMware
"Switch"-Parameter gibt das Szenario für die Erstellung von Richtlinien "azure zu vMWare" an.
...
### -HyperVToAzure
Parameter zum Angeben der Richtlinie zum Replizieren virtueller Hyper-V-Computer auf Azure verwenden
...
Bewahren Sie die Wiederherstellungspunkte für einen bestimmten Zeitraum in Stunden auf.
...
Er darf nicht später als 24 Stunden ab Dem Beginn des Auftrags sein.
...
### -VmmToVmm
Der Parameter zum Angeben der Richtlinie soll verwendet werden, um zwischen Hyper-V-Websites zu replizieren, die von einem VMM-Server verwaltet werden.
...
### -VMwareToAzure
Parameter zum Angeben, dass die erstellte Replikationsrichtlinie verwendet wird, um virtuelle VMware-Computer und/oder physische Server in Azure zu replizieren.
