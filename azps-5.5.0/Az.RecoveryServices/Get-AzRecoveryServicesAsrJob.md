...
## BESCHREIBUNG
Das **Cmdlet "Get-AzRecoveryServicesAsrJob"** ruft Azure-Websitewiederherstellungsaufträge ab.
...
Gibt alle Aufträge für ein bestimmtes ASR-Objekt zurück(verweisen Sie auf das ASR-Objekt, z. B. auf das replizierte Element oder den Wiederherstellungsplan durch seine ID).) 
