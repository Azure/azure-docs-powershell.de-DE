...
## BESCHREIBUNG
Das Undo-AzRecoveryServicesBackupItemDeletion-Cmdlet setzt ein soft-deleted-Element in einen Zustand zurück, in dem der Schutz beendet wird, die Daten aber für immer erhalten bleiben.
...
Der dritte Befehl deaktiviert den Sicherungsschutz für das Element in $PI 0 und versetzt das Element in einen \[ \] Softdeleted-Zustand.
Der vierte Befehl ruft das Element ab, das sich in einem Softdeletedzustand befindet.
