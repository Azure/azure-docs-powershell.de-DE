...
## BESCHREIBUNG
Das **Cmdlet "Add-AzRecoveryServicesAsrReplicationProtectedItemDisk"** fügt den Datenträger zum Schutz für den bereits geschützten virtuellen Azure-Computer hinzu.
...
Starten Sie den Vorgang, um die angegebene Datenträgerkonfiguration zu Ihrem Schutz hinzuzufügen.
...
Starten Sie den Vorgang, um die angegebene Datenträgerkonfiguration zu Ihrem Schutz hinzuzufügen. Durch die Pipette geschütztes Element für die Eingabereplikation.

## PARAMETERS

### -AzureToAzureDiskReplicationConfiguration
Gibt die Datenträgerkonfiguration an, die für den Datenträgerschutz für das Notfallwiederherstellungsszenario von Azure zu Azure verwendet wird.
...
### -InputObject
Das Eingabeobjekt für das Cmdlet: Das asR-replikationsgeschützte Elementobjekt, das dem neuen Datenträger entspricht, der geschützt werden soll.
