...
## BESCHREIBUNG
Das **Cmdlet "Update-AzRecoveryServicesAsrProtectionContainerMapping"** aktualisiert die angegebene Azure Site Recovery Protection-Containerzuordnung.
...
### -AutomationAccountId
Gibt die automatisierungskonto-ID an, die für die automatische Verwendung von Benutzerdefinierten verwendet wird.
...
### -AzureToAzure
Gibt den Container "Azure-zu-Azure-Schutz" an.
...
### -InputObject
Objekt für die Schutzcontainerzuordnung.
