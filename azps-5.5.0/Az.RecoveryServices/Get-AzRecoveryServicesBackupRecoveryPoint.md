...
Der erste Befehl ruft das Tresorobjekt basierend auf "vaultName" ab. Der zweite Befehl ruft das Datum von vor sieben Tagen ab und speichert es dann in der $StartDate Variable.
Der dritte Befehl ruft das aktuelle Datum ab und speichert ihn dann in der $EndDate Variable.
Der vierte Befehl ruft die AzureVM-Sicherungscontainer ab und speichert sie in der $Container Variable. Der fünfte Befehl ruft das Sicherungselement basierend auf workloadType, vaultId und speichert es dann in der $BackupItem Variable.
Der letzte Befehl ruft ein Array mit Wiederherstellungspunkten für das Element in $BackupItem ab und speichert sie dann in $RP Variable.
