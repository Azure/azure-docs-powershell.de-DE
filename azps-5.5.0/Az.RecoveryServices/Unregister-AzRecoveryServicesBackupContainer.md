...
Bevor Sie die Registrierung eines Containers aufheben können, müssen Sie alle mit diesem Container verknüpften geschützten Daten löschen.
...
### Beispiel 1: Aufheben der Registrierung eines Windows Server aus dem Tresor
```powershell
...
Der erste Befehl ruft den im Tresor registrierten server01.contoso.com A0 ab und speichert ihn dann in der $Cont Variable.
Mit dem zweiten Befehl wird die Registrierung des angegebenen Windows Server aus dem Azure Backup Vault aufgehoben.

### Beispiel 2

Die Registrierung eines Windows Server- oder anderen Containers aus dem Tresor wird aufgehoben. (automatisch generiert)
...
Verwenden Sie **zum** Abrufen eines Sicherungscontainerobjekts das Get-AzRecoveryServicesBackupContainer Cmdlet.
