...
Wenn die Richtlinien-ID nicht vorhanden ist oder das Sicherungselement keine Richtlinie zugeordnet ist, erwartet dieser Befehl eine Richtlinien-ID.
...
Das dritte Cmdlet legt die Sicherungsschutzrichtlinie für den ARM virtuellen Computer V2VM fest und verwendet dazu die Richtlinie in $Pol.
...
### -ExclusionDisksList
Liste der Disk-LUNs, die in der Sicherung ausgeschlossen werden sollen, und die restlichen werden automatisch einbezogen.
