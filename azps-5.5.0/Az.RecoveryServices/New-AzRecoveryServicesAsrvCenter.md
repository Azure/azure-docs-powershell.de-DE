...
## BESCHREIBUNG
Das **Cmdlet "New-AzRecoveryServicesAsrvCenter"** fügt einen vCenter-Server hinzu, auf dem geschützten Elemente ermittelt werden können. Dieses Cmdlet registriert den vCenter-Server für die Ermittlung beim Konfigurationsserver.
...
Fügt einen vCenter-Server hinzu, um die geschützten Elemente zu ermitteln. (automatisch generiert)
...
### -Konto
Benutzeranmeldeinformationen Konto.
...
### -IpOrHostName
Die IPv4-Adresse oder der FQDN des vCenter-Servers.
...
### -Name
Ein Anzeigename für den vCenter-Server.
...
### -Port
Der TCP-Port auf dem vCenter-Server, der für die Ermittlung verwendet werden soll.
