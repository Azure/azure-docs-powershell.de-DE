...
## BESCHREIBUNG
Mit diesem Befehl kann Azure Backup die Ressource in einen Sicherungscontainer konvertieren, der dann im angegebenen Tresor für Wiederherstellungsdienste registriert wird. Der Azure Backup Service kann dann Workloads des angegebenen Workloadtyps innerhalb dieses Containers ermitteln, um später geschützt zu werden.
...
Das Cmdlet registriert eine azure VM als Container für die MSSQL-Workload.

## PARAMETERS

### -BackupManagementType
Die Klasse der geschützten Ressourcen. Derzeit wird für dieses Cmdlet AzureWorkload unterstützt.
...
### -Force
Erzwingen des Registrierungscontainers (Bestätigungsdialogfeld wird verhindert). Dieser Parameter ist optional.
...
### -WorkloadType
Arbeitsauslastungstyp der Ressource. Der aktuell unterstützte Wert ist AzureVM, WindowsServer, AzureFiles, MSSQL.
