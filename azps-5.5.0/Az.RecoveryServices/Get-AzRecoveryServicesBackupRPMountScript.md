...
### -Path
Speicherort, an den die Datei im Falle einer Dateiwiederherstellung heruntergeladen werden soll. Wenn "-Path" nicht angegeben wird, wird die Skriptdatei im aktuellen Verzeichnis heruntergeladen.
