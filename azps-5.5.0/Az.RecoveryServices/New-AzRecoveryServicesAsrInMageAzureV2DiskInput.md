...
## BESCHREIBUNG
Erstellt ein Datenträgerzuordnungsobjekt, das einen virtuellen vMWare-Computerdatenträger dem Cachespeicherkonto und dem Ziel verwalteten Datenträgertyp (Wiederherstellungsregion) zuzuordnen, der zum Replizieren des Datenträgers verwendet wird.
...
Erstellen Sie ein Datenträgerzuordnungsobjekt für virtuelle vMWare-Computerdatenträger, die repliziert werden sollen. Wird beim Aktivieren des Schutzes für vMWare-Computer verwendet.
...
### -DiskId
Geben Sie die DiskId des Datenträgers an, dem diese Zuordnung entspricht.
...
### -DiskType
Gibt den Wiederherstellungsdatenträgertyp an.
