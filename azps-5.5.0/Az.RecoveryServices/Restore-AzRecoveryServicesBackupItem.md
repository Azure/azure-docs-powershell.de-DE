...
> [!IMPORTANT]
> Standardmäßig werden mit der Azure VM-Sicherung alle Datenträger gesichert. Sie können relevante Datenträger selektiv sichern, indem Sie die Parameter "exclusionList" oder "InclusionList" während "Enable-Backup" verwenden. Die Option zum selektiven Wiederherstellen von Datenträgern ist nur verfügbar, wenn sie selektiv gesichert wurden.
...
Der vierte Befehl ruft das aktuelle Datum ab und speichert es dann in der $EndDate Variable.
Der fünfte Befehl ruft eine Liste mit Wiederherstellungspunkten für das spezifische Sicherungselement ab, nach $StartDate und $EndDate.
Der sechste Befehl speichert die Liste der Datenträger, die in der wiederhergestellten VariablenDiskLUN wiederhergestellt werden sollen.
...
Verwenden Sie diesen Schalter, um die regionübergreifende Wiederherstellung in den sekundären Bereich auszulösen.
