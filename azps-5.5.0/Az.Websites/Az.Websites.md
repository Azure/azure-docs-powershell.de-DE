...
# Az.Websites-Modul
## Beschreibung
ARM (Azure-Ressourcen-Manager) Web App- und App-Serviceplan-Befehle.
...
New-AzWebAppContainerPSSession erstellt eine neue Remote-PowerShell-Sitzung im Windows-Container, der auf einer bestimmten Website oder einem bestimmten Slot und in einer bestimmten Ressourcengruppe angegeben ist.
