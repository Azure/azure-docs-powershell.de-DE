...
## SYNOPSIS
Importieren Sie ein ZERTIFIKAT aus dem Schlüsseltresor in eine Web App.
...
## BESCHREIBUNG
Das **Cmdlet "Import-AzWebAppKeyVaultCertificate"** importiert ein ZERTIFIKAT aus dem Schlüsseltresor in eine Web App.
...
Mit diesem Befehl wird ein -SSL-Zertifikat aus dem Schlüsseltresor in eine Web App importiert.
...
Mit diesem Befehl wird ein ZERTIFIKAT aus dem Schlüsseltresor mithilfe der Ressourcen-ID in eine Web App importiert (normalerweise, wenn sich der Schlüsseltresor in einem anderen Abonnement befindet).

## PARAMETERS

### -CertName
KeyVaultCertName des in keyvault erstellten Zertifikats
...
### -ResourceGroupName
Der Name der WebApp-Ressourcengruppe.
