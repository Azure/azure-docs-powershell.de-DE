...
## BESCHREIBUNG
Das **Cmdlet "Set-AzWebAppSlotConfigName"** kennzeichnet "App-Einstellungen" und "Verbindungszeichenfolgen" als Sloteinstellungen.
...
Mit diesem Befehl werden alle App-Einstellungen und Verbindungszeichenfolgen für die Web App ContosoWebApp entfernt, die der Ressourcengruppe "Default-Web-WestUS" zugeordnet sind.

### Beispiel 2

Legen Sie Web App Slot-Konfigurationsnamen ein. (automatisch generiert)
...
### -AppSettingNames
Zeichenfolgenarray für App-Einstellungennamen
...
Zeichenfolgennamen der Verbindung ( String Array)
...
Option "Alle Namen von Apps entfernen"
...
Option "Alle Verbindungszeichenfolgennamen entfernen"
