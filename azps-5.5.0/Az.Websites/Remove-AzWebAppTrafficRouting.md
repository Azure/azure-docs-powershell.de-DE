...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzWebAppTrafficRouting"** entfernt eine Routingregel aus einem Azure Web App-Slot.

## BEISPIELE

### Beispiel 1 Entfernt die spezifische Routingregel aus dem Webapp-Slot.
```powershell
PS C:\> Remove-AzWebAppTrafficRouting -ResourceGroupName "Default-Web-WestUS" -WebAppName "ContosoSite"  -RuleName 'Stg'
```

Mit diesem Befehl wird eine Routingregel für einen bestimmten Webappplatz entfernt.
