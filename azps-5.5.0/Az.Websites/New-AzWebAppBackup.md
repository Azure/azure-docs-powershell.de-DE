...
Erstellt eine Sicherung der angegebenen App "ContosoWebApp", die sich in der Ressourcengruppe "Default-Web-WestUS" in https://storageaccount.file.core.windows.net

### Beispiel 2

Das New-AzWebAppBackup erstellt eine Azure Web App-Sicherung. (automatisch generiert)
