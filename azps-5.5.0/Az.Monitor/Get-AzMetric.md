...
Dieser Befehl ruft die metrischen Werte für "website3" mit einem Zeitmass von 1 Minute ab.
...
### Beispiel 4: Erhalten einer zusammengefassten Ausgabe für eine angegebene Metrik mit angegebenem Dimensionsfilter
```
...
Mit diesem Befehl wird die Ausgabe für die Metrik "PageViews" mit dem angegebenen Dimensionsfilter und Aggregationstyp zusammengefasst.
...
### -DetailedOutput
Zeigt an, dass dieses Cmdlet eine detaillierte Ausgabe anzeigt.
...
### -MetricFilter
Gibt den metrischen Dimensionsfilter an, für den Metriken abgefragt werden.
...
### -MetricNamespace
Gibt den metrischen Namespace an, für den Metriken abgefragt werden.
...
### -OrderBy
Gibt die Aggregation an, die für die Sortierung der Ergebnisse und die Richtung der Sortierung zu verwenden ist (Beispiel: Summe asc).
...
### -TimeGrain
Gibt das Zeitmask der Metrik als **"TimeSpan"-Objekt** im Format "hh:mm:ss" an.
...
### -Top
Gibt die maximale Anzahl der abzurufenden Datensätze an (standard:10), die mit einem $filter.
