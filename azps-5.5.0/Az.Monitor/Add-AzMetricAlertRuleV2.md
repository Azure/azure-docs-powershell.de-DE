...
## BESCHREIBUNG
Fügt eine auf **V2 basierende (nicht klassische) metrische Warnungsregel** hinzu oder aktualisiert diese. Die hinzugefügte Regel ist einer Ressourcengruppe zugeordnet und hat einen Namen. Dieses Cmdlet implementiert das ShouldProcess-Muster, d. h., es kann eine Bestätigung vom Benutzer anfordern, bevor die Ressource tatsächlich erstellt, geändert oder entfernt wird.
...
### -TargetResourceRegion
Die Zielressourcenregion für die Regel
