...
## SYNOPSIS
Ruft die Zuordnung(en) von Datensammlungsregel ab.
...
### Beispiel 1: Erhalten von Datensammlungsregelnzuordnungen nach Zielressourcen-ID (zugeordneter virtueller Computer)
```
...
Dieser Befehl listet alle Datensammlungsregeln für die angegebene Zielressourcen-ID (virtueller Computer) auf.
...
Dieser Befehl listet Datensammlungsregelnzuordnungen für die angegebene Ressourcengruppe und -regel auf.
...
Dieser Befehl listet die Zuordnungen von Datensammlungsregeln für das angegebene Eingabeobjekt auf.

### Beispiel 4: Erhalten einer Datensammlungsregelzuordnung nach Zielressourcen-ID (zugeordneter virtueller Computer) und Zuordnungsname
```
...
Mit diesem Befehl wird eine Datensammlungsregel zuordnung (eine Liste mit einem einzelnen Element) aufgeführt.
