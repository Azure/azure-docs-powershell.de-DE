...
## BESCHREIBUNG
Das Cmdlet **"New-AzMetricAlertRuleV2Criteria"** erstellt ein Objekt für lokale Metrikkriterien, das als [Eingabe-Add-AzMetricAlertRuleV2-Cmdlet](https://docs.microsoft.com/en-us/powershell/module/az.monitor/add-azmetricalertrulev2) verwendet wird, das eine neue metrische Warnungsregel erstellt.
...
Dieser Befehl erstellt ein einfaches metrisches Warnungskriterium, das in einer metrischen Warnungsregel verwendet werden kann.
...
### -FailedLocationCount
Die minimale Anzahl von fehlgeschlagenen Speicherorten zum Ausstellen einer Warnung.
