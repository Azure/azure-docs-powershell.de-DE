...
## BESCHREIBUNG
Das **Cmdlet "Get-AzAutoscaleSetting"** ruft alle Autoskaleneinstellungen ab, die einer Ressourcengruppe oder einer angegebenen Einstellung für die Autoskala zugeordnet sind.

## BEISPIELE

### Beispiel 1: Autoskalen-Einstellungen erhalten
```
...
Mit diesem Befehl werden die Einstellungen für die Automatische Skala der Ressourcengruppe "Standard-Web-OstUS" zugewiesen.

### Beispiel 2: Festlegen der Automatischen Skala nach Name
```
...
Dieser Befehl ruft die Einstellung für die Autoskala mit dem Namen "DefaultServerFarm-Default-Web-EastUS" ab.
...
### -DetailedOutput
Gibt an, dass bei diesem Vorgang alle Details in der Ausgabe angezeigt werden.
...
### -Name
Gibt den Namen der zu erhaltenden Einstellung an.
