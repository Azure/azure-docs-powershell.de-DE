...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzDataCollectionRule"** löscht eine Datensammlungsregel.
...
### Beispiel 1: Löschen einer Datensammlungsregel mit Parametern für Name und Ressourcengruppe
```
PS C:\>Remove-AzDataCollectionRule -ResourceGroupName "testgroup" -RuleName "testDcr"             
```

### Beispiel 2: Löschen einer Datensammlungsregel mit boolescher Name und Ressourcengruppe
```
...
### Beispiel 3: Löschen einer Datensammlungsregel aus InputObject
```
PS C:\>Get-AzDataCollectionRule -ResourceGroupName "testdcr" -RuleName "dcrFromPipe95" | Remove-AzDataCollectionRule
```

### Beispiel 4: Löschen einer Datensammlungsregel aus der Ressourcen-ID
```
