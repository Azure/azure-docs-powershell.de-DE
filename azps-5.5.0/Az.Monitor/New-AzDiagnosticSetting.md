...
## BESCHREIBUNG
Erstellen Sie das PSServiceDiagnosticSettings-Objekt.
Dies kann als Parameter `-InputObject` für `Set-AzDiagnosticSetting`
...
Erstellen Sie das PSServiceDiagnosticSettings-Objekt. Und erstellen Sie eine Diagnoseeinstellung für die Zielressource.

## PARAMETERS

### -DedicatedLogAnalyticsDestinationType
Der Wert, der angibt, ob (nach ODS) in ressourcenspezifische Ressourcen (sofern vorhanden) oder nach AzureDiagnostics exportiert werden soll (Standard, nicht vorhanden)
...
### -Einstellung
Metrische Einstellungen oder Protokolleinstellungen
