...
## BESCHREIBUNG
Das **Cmdlet "Get-AzAutoscaleHistory"** ruft den Ereignisverlauf ab, der sich auf eine Einstellung für die Autoskala bezogen hat.

## BEISPIELE

### Beispiel 1: Alle mit einem Abonnement verknüpften Ereignisse erhalten
```
PS C:\>Get-AzAutoscaleHistory -StartTime 2015-02-09T18:35:00 -EndTime 2015-02-09T18:40:00 -DetailedOutput
```

Mit diesem Befehl werden alle ereignisse im Zusammenhang mit der Autoskala des aktuellen Abonnements angezeigt.

### Beispiel 2: GetAutoscaleHistory für eine bestimmte Ressource
```
...
Dieser Befehl ruft alle Autoskalen-bezogenen Ereignisse ab, die einer bestimmten Ressource zugeordnet sind, die durch die ID der Ressource identifiziert wird (im Wesentlichen der ResourceUri).
...
### -ResourceId
Gibt die Ressourcen-ID an, der die Einstellung für die Automatische Skalierung zugeordnet ist.
...
### -Status
Gibt einen Filter nach Status an.
Dieser Parameter ist optional.
Der Fehler ist eine leere Zeichenfolge (d. h. kein Filter)
