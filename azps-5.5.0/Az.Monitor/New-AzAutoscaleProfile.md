...
Der erste Befehl erstellt eine Regel mit dem Namen "Anforderungen" und speichert sie dann in der $Rule Variable.
Der zweite Befehl erstellt ein Profil namens Profile01 mit einem festen Datum unter Verwendung der Regel in $Rule.
...
Der erste Befehl erstellt eine Regel mit dem Namen "Anforderungen" und speichert sie dann in der $Rule Variable.
Der zweite Befehl erstellt ein Profil namens "SecondProfileName" mit einem wiederkehrenden Zeitplan unter Verwendung der Regel in $Rule.
...
Der dritte Befehl erstellt anhand der Regeln in "Regel1" und "Regel2" ein Profil mit dem Namen "ProfileName" und speichert es dann in $Profile 1-Variable.
Der letzte Befehl erstellt ein Profil mit dem Namen "SecondProfileName" unter Verwendung der Regeln in "Rule1" und "Rule2" und speichert es dann in der $Profile 2-Variable.
...
Der erste Befehl erstellt eine Regel mit dem Namen "Anforderungen" und speichert sie dann in der $Rule Variable.
Der zweite Befehl erstellt ein Profil ohne einen Zeitplan oder ein festes Datum und speichert es dann in $Profile Variable.
...
### -RecurrenceFrequency
Gibt die Häufigkeit der Serie an.
