...
## SYNOPSIS
Ruft Informationen zur Modellansicht oder Instanzansicht eines Hybridcomputers ab.
...
Wenn das Abonnement nicht angegeben ist, verwendet es das Abonnement aus Ihrem aktuellen Azure PowerShell-Kontext.
...
Listen Sie alle verbundenen Computer in einer Ressourcengruppe auf.

### Beispiel 3: Erhalten eines verbundenen Computers in einer Ressourcengruppe nach Name
```powershell
...
Holen Sie sich einen verbundenen Computer in einer Ressourcengruppe nach Namen.
