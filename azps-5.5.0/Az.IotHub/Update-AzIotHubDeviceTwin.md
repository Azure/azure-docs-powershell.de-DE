...
## BESCHREIBUNG
Aktualisiert oder ersetzt ein Gerätegerät. Weitere https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-device-twins Informationen finden Sie hier.
...
Gibt das aktualisierte Geräteobjekt "." zurück.
...
Gibt das Gerät -Objekt mit aktualisierten gewünschten Eigenschaften zurück.
...
Gibt das Objekt "device" mit der Eigenschaft "updated tags" zurück.
...
Gibt das ersetzte Geräteobjekt zurück.
...
### -Desired
Fügen Sie die gewünschte Eigenschaft in einem Gerätegerät hinzu, oder aktualisieren Sie sie.
...
### -Partiell
Ermöglicht es, die Tags und gewünschten Eigenschaften eines Gerätegeräts nur teilweise zu aktualisieren.
...
### -Tag
Fügen Sie die Tageigenschaft in einem Gerätegerät hinzu, oder aktualisieren Sie sie.
