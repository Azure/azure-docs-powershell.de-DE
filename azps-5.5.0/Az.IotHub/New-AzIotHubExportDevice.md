...
## BESCHREIBUNG
Erstellt einen neuen Exportgeräteauftrag für IotHub.
Dadurch werden alle Geräte in den angegebenen Container exportiert. Informationen zum Generieren des SAS-URI finden Sie im folgenden Artikel.
https://docs.microsoft.com/azure/iot-hub/iot-hub-bulk-identity-mgmt#get-the-container-sas-uri .

## BEISPIELE

### Beispiel 1: Senden Sie eine Exportgeräteanforderung.
```
...
Erstellt eine neue Exportgeräteanforderung für IotHub "myiothub" mit Ausnahme der Schlüssel.
...
### -ExcludeKeys
Ermöglicht das Exportieren von Geräten ohne Schlüssel.
...
Der URI, in den der BLOB exportiert werden soll. 
