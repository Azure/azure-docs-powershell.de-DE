...
Senden eines Geräts an eine Cloudnachricht mithilfe des Standardtransporttyps.
...
Senden eines Geräts an eine Cloudnachricht.
...
### -Message
Nachrichtentext, der an IoT Hub gesendet werden soll.
