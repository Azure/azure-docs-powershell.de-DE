...
## BESCHREIBUNG
Fügen Sie eine angegebene durch Kommas getrennte Liste von nicht edge-Geräte-IDs als "Children" eines angegebenen Edgegeräts hinzu.
...
Fügen Sie Nicht-Edge-Geräte als untergeordnete Geräte zum Edgegerät hinzu, unabhängig davon, ob das Nicht-Edge-Gerät bereits untergeordnetes Gerät eines anderen Edgegeräts ist.

## PARAMETERS

### -Children
Die Liste untergeordneter Geräte (durch Kommas getrennt) schließt nur Geräte ein, die keine Edgegeräte sind.
...
### Microsoft.Azure.Commands.Management.IotHub.Models.PSDevice1
