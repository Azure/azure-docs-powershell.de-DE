...
### Beispiel 1: Auflisten aller Konfigurationen unter einer MariaDB
```powershell
...
Dieser Befehl listet alle Konfigurationen unter einer MariaDB auf.

### Beispiel 2: Erhalten einer Konfiguration von MariaDB
```powershell
