...
### Beispiel 1: Löschen des AzCostManagementExport nach Bereich und Name
```powershell
...
Löschen von "AzCostManagementExport by Scope" und "ExportName"

### Beispiel 2: Löschen des Objekts "AzCostManagementExport by Export"
```powershell
...
Löschen von "AzCostManagementExport by InputObject"
