...
## SYNOPSIS
Der Vorgang zum Erhalten des Ausführungsverlaufs eines Exports für den definierten Bereich und Exportnamen.
...
### Beispiel 1: Erhalten Von AzCostManagementExportExecutionHistory
```powershell
...
"AzCostManagementExportExecutionHistory By ExportName and Scope" erhalten

### Beispiel 2: Erhalten von "AzCostManagementExportExecutionHistory" von InputObject
```powershell
...
Holen Sie sich AzCostManagementExportExecutionHistory von InputObject
