...
## BESCHREIBUNG
Das **Cmdlet Invoke-AzStackEdgeDevice** ruft Aktionen zum Überprüfen, Herunterladen und Installieren der Updates auf dem Stack Edge-Gerät auf. Eine automatische Überprüfung wird täglich auf dem Gerät ausgeführt. Sie können die Überprüfung explizit auslösen, indem Sie dieses Cmdlet ausführen.
...
### -FetchUpdate
Lädt die Updates auf einem Stack Edge-/Gatewaygerät herunter.
...
### -InstallUpdate
Installiert die Updates auf dem Stack edge/gateway device.
...
### -ScanForUpdate
Sucht auf einem Stack edge-/gateway-Gerät nach Updates.
