...
## BESCHREIBUNG
Das **Cmdlet "Get-AzStackEdgeDevice"** ruft die Informationen zu den verfügbaren Stack Edge Devices ab. Sie können den Namen des Geräts zusammen mit dem Namen der Ressourcengruppe angeben, um die Informationen auf einem bestimmten Gerät zu erhalten. 
...
### -Alert
Abrufen der Benachrichtigungen auf dem Stack edge/gateway device
...
### -NetworkSetting
Ruft die Netzwerkeinstellungen des angegebenen Stack Edge-/Stack -Gatewaygeräts ab.
