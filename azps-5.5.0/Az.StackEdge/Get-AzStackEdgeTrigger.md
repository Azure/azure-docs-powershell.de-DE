...
## BESCHREIBUNG
Das **Cmdlet "Get-AzStackEdgeTriger"** ruft die Trigger für ein Gerät ab. Sie können den Namen im Cmdlet als Parameter angeben, um die Details eines bestimmten Triggers abrufen zu können.
