...
## BESCHREIBUNG
Das **Cmdlet "New-AzStackEdgeOrder"** erstellt eine neue Bestellung für ein Stack Edge-Gerät. Eine Stack Edge-Geräteressource muss zuerst erstellt werden, bevor eine Bestellung erstellt wird. Sie können Details wie Kontaktperson, Firmenname, E-Mail-Adresse, Adresse usw. als Parameter für die Erstellung der Bestellung angeben.
...
### -Email
Liste der E-Mails zum Empfang von Updates, Maximal 10 E-Mails werden akzeptiert
