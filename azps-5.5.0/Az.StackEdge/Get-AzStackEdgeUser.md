...
## BESCHREIBUNG
Das **Cmdlet "Get-AzStackEdgeUser"** listet die Benutzer auf, die für ein Stack Edge-Gerät konfiguriert sind. Sie können den Namen in Parametern erwähnen, um Details zu einem bestimmten Benutzer zu erhalten.
