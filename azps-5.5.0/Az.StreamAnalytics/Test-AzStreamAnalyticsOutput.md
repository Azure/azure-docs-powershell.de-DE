...
## BESCHREIBUNG
Das **Cmdlet "Test-AzStreamAnalyticsOutput"** testet die Fähigkeit von Stream Analytics, eine Verbindung mit einer Ausgabe herzustellen.
...
Dadurch wird der Verbindungsstatus der Ausgabe in StreamingJob getestet.
...
### -Name
Gibt den Namen der zu testden Azure Stream Analytics-Ausgabe an.
