...
## BESCHREIBUNG
Das **Cmdlet "Get-AzStreamAnalyticsJob"** listet alle Stream Analytics-Aufträge auf, die im Abonnement von Azure oder einer angegebenen Ressourcengruppe definiert wurden, oder ruft Auftragsinformationen zu einem bestimmten Auftrag innerhalb einer Ressourcengruppe ab.

## BEISPIELE

### BEISPIEL 1: Erhalten von Informationen zu allen Aufträgen in einem Abonnement
```
