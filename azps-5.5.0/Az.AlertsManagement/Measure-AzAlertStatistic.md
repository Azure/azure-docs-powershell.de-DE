...
## BESCHREIBUNG
**Das Cmdlet "Measure-AzAlertStatistic"** erhält Warnungszusammenfassungsdetails.
...
Fassen Sie die Anzahl der Warnungen nach Schweregrad und Status, nach dem Status "Aktiv" gefiltert, zusammen.
...
### -GroupBy
Zusammenfassen nach Eigenschaft
