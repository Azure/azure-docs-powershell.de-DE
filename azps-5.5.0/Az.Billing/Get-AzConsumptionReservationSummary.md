...
## BESCHREIBUNG
Das **Cmdlet "Get-AzConsumptionReservationSummary"** ruft Reservierungszusammenfassungen für tägliche oder monatliche Körner ab.

## BEISPIELE

### Beispiel 1: Erhalten von Reservierungszusammenfassungen mit Der Reservierungsauftrags-ID für monatliches Körnern
```powershell
...
### Beispiel 2: Erhalten von Reservierungszusammenfassungen mit Reservierungsauftrags-ID und Reservierungs-ID für monatsweises Körner
```powershell
...
### Beispiel 3: Erhalten von Reservierungszusammenfassungen mit Der Reservierungsauftrags-ID für den täglichen Datumsbereich
```powershell
...
### Beispiel 4: Erhalten von Reservierungszusammenfassungen mit Reservierungsauftrags-ID und Reservierungs-ID für den täglich bereitgestellten Datumsbereich
```powershell
...
### -EndDate
Die Enddaten (JJJJ-MM-DD in UTC) der Reservierungszusammenfassung, nur für tägliches Körner erforderlich.
...
### -Grain
Das Zeitmask der Reservierungszusammenfassung kann täglich oder monatlich sein.
...
### -ReservationId
Der Bezeichner einer Reservierung innerhalb eines Reservierungsauftrags.
...
### -StartDate
Die Startdaten (JJJJ-MM-DD in UTC) der Reservierungszusammenfassung, nur für tägliches Körner erforderlich.
