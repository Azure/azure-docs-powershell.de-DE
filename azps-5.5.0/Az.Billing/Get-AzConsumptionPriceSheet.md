...
### Beispiel 2: Erhalten von Preisblättern mit der Erweiterung "MeterDetails"
```powershell
...
### Beispiel 3: Preisblätter von BillingPeriodName erhalten
```powershell
...
### Beispiel 4: Erhalten der ersten fünf Datensätze von Preisblättern
```powershell
