...
## BESCHREIBUNG
Das Get-AzConsumptionBudget-Cmdlet ruft eine Liste der Budgets in einem Abonnement oder einer Ressourcengruppe ab.

## BEISPIELE

### Beispiel 1: Erhalten einer Liste der Budgets auf Abonnementebene
```powershell
...
### Beispiel 2: Erhalten einer Liste der Budgets auf Ressourcengruppenebene
```powershell
...
### Beispiel 3: Erhalten eines Budgets mit dem Budgetnamen auf Abonnementebene
```powershell
...
### Beispiel 4: Erhalten eines Budgets mit dem Budgetnamen auf Ressourcengruppenebene
```powershell
