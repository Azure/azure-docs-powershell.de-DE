...
### Beispiel 1: Erstellen eines neuen Bots
```powershell
...
Erstellen eines neuen Bots nach ResourceGroupName und ApplicationId

### Beispiel 2: Erstellen einer neuen Web App
```powershell
...
Erstellen einer neuen Web App nach "ResourceGroupName" und "ApplicationId"
