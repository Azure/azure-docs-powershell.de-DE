...
### Beispiel 2: BotService nach ResourceGroupName und Name erhalten
```powershell
...
### Beispiel 3: Alle BotServices nach ResourceGroupName erhalten
```powershell
...
Alle BotServices nach ResourceGroupName erhalten

### Beispiel 4: BotService von inputObject
```powershell
