...
Erstellt ein neues Ereignisabonnement "EventSubscription1" für das aktuell ausgewählte \` Azure-Abonnement, bei dem der angegebene Ereignishub \` als Ziel für Ereignisse verwendet wird. Für dieses Ereignisabonnement werden Standardfilter verwendet.
