...
### Beispiel 1: Aktualisieren eines Windows -IoT-Diensts nach Name
```powershell
...
Mit diesem Befehl werden Windows -IoT-Dienste nach Name aktualisiert.

### Beispiel 2: Aktualisieren eines Windows -IoT-Diensts per Pipeline
```powershell
...
Mit diesem Befehl werden Windows -IoT-Dienste per Pipeline aktualisiert.
...
Geben Sie nicht an, dass ein völlig neuer Windows IoT-Gerätedienst erstellt werden soll.
