...
## BESCHREIBUNG
Das **Cmdlet "Get-AzContainerGroup"** ruft eine angegebene Containergruppe oder alle Containergruppen in einer Ressourcengruppe oder im Abonnement ab.
...
### Beispiel 4: Ruft Containergruppen mit der Ressourcen-ID ab.
```
