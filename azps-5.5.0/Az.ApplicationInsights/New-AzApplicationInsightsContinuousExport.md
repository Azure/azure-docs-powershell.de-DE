...
### Beispiel 1 Erstellen einer neuen fortlaufenden Exportkonfiguration für eine Ressource für Anwendungseinblicke
```
...
Erstellen Sie eine neue Anwendungserkenntnisse fortlaufende Exportkonfiguration, um die Dokumenttypen "Anforderung" und "Ablaufverfolgung" zu speichern, die "Testcontainer" im Speicherkonto "teststorageaccount" in der Ressourcengruppe "Testgruppe" enthalten. Das SAS-Token muss gültig sein und über Schreibberechtigungen für den Container verfügen, andernfalls funktioniert das Feature für fortlaufende Exporte nicht. Wenn das SAS-Token abgelaufen ist, funktioniert das Feature für fortlaufende Exporte nicht mehr.
