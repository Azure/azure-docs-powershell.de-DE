...
### Beispiel 1: Abrufen von API-Schlüsseln für eine Ressource für Anwendungserkenntnisse
```
...
Abrufen von Api-Schlüsseln für Anwendungserkenntnisse für den Ressourcentest in der Ressourcengruppe "testGroup".

### Beispiel 2 Abrufen eines bestimmten API-Schlüssels für eine Ressource für Anwendungseinblicke
```
...
Erhalten Sie einen spezifischen API-Schlüssel für Anwendungserkenntnisse, der "dd173f38-4fd1-4c75-8af5-9 9c29aa0f867" für die Ressource "test" in der Ressourcengruppe "testGroup" ist.

## PARAMETERS

### -ApiKeyId
Anwendungseinblicke-API-Schlüssel-ID.
