...
### Beispiel 1: Entfernen einer Ressource für Anwendungserkenntnisse
```
PS C:\> Remove-AzApplicationInsights -ResourceGroupName "testgroup" -Name "test" -PassThru
True
```

Entfernen einer Anwendungserkenntnisseressource namens "Test" in der Ressourcengruppe "Testgruppe"
