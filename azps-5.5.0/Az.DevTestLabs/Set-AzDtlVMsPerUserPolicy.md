...
## BESCHREIBUNG
Das **Cmdlet "Set-AzDtlVMsPerUserPolicy"** legt die virtuellen Computer pro Benutzerrichtlinie einer Übungseinheit fest, mit der die maximal zulässige Anzahl virtueller Computer pro Benutzer festgelegt wird.
...
### -Disable
Gibt an, dass mit diesem Cmdlet die Richtlinie für die Übungseinheit deaktiviert wird.
...
### -LabName
Gibt den Namen der Übung an, für die dieses Cmdlet die virtuellen Computer pro Benutzerrichtlinie festgelegt.
