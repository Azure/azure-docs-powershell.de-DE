...
## BESCHREIBUNG
Das **Cmdlet "Set-AzDtlAutoStartPolicy"** legt die Richtlinie für den automatischen Start eines Labors fest, die es virtuellen Lab-Computern ermöglicht, für den automatischen Start geplant zu werden.
...
Legt die Richtlinie für den automatischen Start einer Übungseinheit in DevTest Labs fest. (automatisch generiert)
...
### -Tage
Gibt als Array die Wochentage an, an denen die virtuellen Computer des Labors gestartet werden müssen.
...
### -Disable
Gibt an, dass mit diesem Cmdlet die Richtlinie für die virtuellen Computer in der Übungseinheit deaktiviert wird.
...
### -Enable
Gibt an, dass dieses Cmdlet die Richtlinie für die virtuellen Computer in der Übungseinheit aktiviert.
...
### -LabName
Gibt den Namen der Übungseinheit an, für die dieses Cmdlet die Richtlinie für den automatischen Start festgelegt.
...
### -Time
Gibt die Zeit an, zu der die virtuellen Computer des Labors gestartet werden müssen.
