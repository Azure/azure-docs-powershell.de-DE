...
### Beispiel 1: Entfernen eines Speicherinblicks nach Name
```
...
Mit diesem Befehl wird der Speichereinblick mit dem Namen "MyStorageInsight" aus dem Arbeitsbereich "MyWorkspace" in der angegebenen Ressourcengruppe entfernt.
Der Befehl gibt den Parameter *"Force" nicht* an, daher fordert er Sie zur Bestätigung auf, bevor der Speicherinblick entfernt wird.

### Beispiel 2: Entfernen eines Speicherinblicks ohne Bestätigung
```
...
Der erste Befehl verwendet das Get-AzOperationalInsightsWorkspace Cmdlet, um den Arbeitsbereich "MyWorkspace" zu erhalten, und speichert ihn dann in der $Workspace Variable. Mit dem zweiten Befehl wird der Speichereinblick "MyStorageInsight" aus $Workspace A0 entfernt, ohne dass Sie zur Bestätigung aufgefordert werden.
...
### -WorkspaceName
Gibt den Namen des Arbeitsbereichs an, der die Speicherinblicke enthält.
