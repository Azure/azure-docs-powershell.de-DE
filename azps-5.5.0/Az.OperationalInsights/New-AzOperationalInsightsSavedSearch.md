...
## BESCHREIBUNG
Das **Cmdlet "New-AzOperationalInsightsSavedSearch"** erstellt eine neue gespeicherte Suche mit den angegebenen Parametern für den Arbeitsbereich.

## BEISPIELE

### Beispiel 1: Erstellen einer neuen gespeicherten Suche
```
...
Mit diesem Befehl wird eine neue gespeicherte Suche erstellt.

## PARAMETERS

### -Category
Gibt den Kategorienamen an.
...
### -DisplayName
Gibt den Anzeigenamen der gespeicherten Suche an.
...
### -FunctionAlias
Der Funktionsalias, wenn die Abfrage als Funktion dient.
...
### -FunctionParameter
Die optionalen Funktionsparameter, wenn die Abfrage als Funktion dient. Der Wert sollte das folgende Format haben: 'param-name1:type1 = default_value1, param-name2:type2 = default_value2'. Weitere Beispiele und die richtige Syntax finden Sie unter https://docs.microsoft.com/en-us/azure/kusto/query/functions/user-defined-functions .
...
### -Query
Gibt den Abfrageausdruck für die gespeicherte Suche an.
