...
## BESCHREIBUNG
Das **Cmdlet "New-AzOperationalInsightsWindowsEventDataSource"** fügt eine Datenquelle hinzu, die die Windows-Ereignisprotokolle von verbundenen Computern sammelt, auf denen das Betriebssystem Windows in Azure Operational Insights ausgeführt wird.

## BEISPIELE

### Beispiel 1: Erstellen einer System-Windows-Ereignisdatenquelle
```
$EventLogNames       = @()
...
### -CollectErrors
Zeigt an, dass Operational Insights Fehlermeldungen sammelt.
...
### -CollectWarnings
Gibt an, dass operationale Einblicke Warnmeldungen sammelt.
