...
### -IdentityType
identitätstyp, kann der Wert "SystemAssigned", "None" sein.
...
### -Location
Die geografische Region, für die der Cluster bereitgestellt wird.
...
### -Sku1
SKU Kapazität, Wert muss ein Vielfaches von 100 sein und im Bereich von 1000-2000 liegen.
...
### -SkuName
"SKU-Name" kann jetzt nur noch "CapacityReservation" sein.
