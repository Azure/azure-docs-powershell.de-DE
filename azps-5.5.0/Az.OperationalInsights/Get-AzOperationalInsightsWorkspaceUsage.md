...
## BESCHREIBUNG
Das **Cmdlet "Get-AzOperationalInsightsWorkspaceUsage"** ruft die Nutzungsdaten für einen Arbeitsbereich ab.
Dadurch wird angezeigt, wie viele Daten über einen bestimmten Zeitraum vom Arbeitsbereich analysiert wurden.
...
### Beispiel 2: Erhalten von Verwendungsdaten mithilfe der Pipeline
```
