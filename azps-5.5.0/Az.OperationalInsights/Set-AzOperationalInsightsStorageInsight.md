...
## BESCHREIBUNG
Das **Cmdlet "Set-AzOperationalInsightsStorageInsight"** ändert die Konfiguration eines Speichereinblicks.

## BEISPIELE

### Beispiel 1: Ändern eines Speicherinblicks nach Name
```
...
Mit diesem Befehl werden die Tabellen geändert, aus denen der Speichersichter "MeineStorageInsight" liest.

### Beispiel 2: Ändern eines Speicherinblicks mithilfe eines Arbeitsbereichsobjekts
```
...
Der zweite Befehl ändert die Container, aus denen der Speichersichter "MeineStorageInsight" liest.
...
### -Name
Gibt den Namen eines Speicherinblicks an.
...
### -Workspace
Gibt den Arbeitsbereich an, der die Speicherinblicke enthält.
