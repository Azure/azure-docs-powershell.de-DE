...
### Beispiel 1: Erstellen eines neuen Mitglieds
```powershell
...
Mit diesem Befehl wird ein neues Element erstellt.
...
### -Consortium
Ruft das Consortium für das neue Mitglied ab oder legt es fest.
...
Legt das Kennwort für das Verwaltungskonto des Managed Consortiums fest.
...
Ruft den Anzeigenamen des Mitglieds im Consortium ab.
...
### -ConsortiumRole
Erhält die Rolle des Mitglieds im Consortium.
...
### -FirewallRule
Ruft Firewallregeln ab oder legt diese fest. Informationen zu #A0 und zum Erstellen einer Hashtabelle finden Sie im Abschnitt "NOTES".
...
### -Location
Die GEO-Position des Kundendiensts.
...
### -Password
Legt das grundlegende Authentifizierungskennwort des Mitglieds fest.
...
### -Protocol
Ruft das protokoll ab oder legt es fest.
...
### -SKU
Ruft den Namen der SKU ab oder legt sie fest.
...
### -SkuTier
Ruft die SKU-Ebene ab oder legt sie fest.
...
### -ValidatorNodeSku1
Ruft die Knotenkapazität ab oder legt diese fest.
