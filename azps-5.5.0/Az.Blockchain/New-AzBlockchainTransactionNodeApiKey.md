...
### Beispiel 1: Neuer generieren Sie die API-Schlüssel für einen Transaktionsknoten mithilfe des Namens.
```powershell
...
Dieser Befehl generiert mithilfe von Name, Ressourcengruppe API-Schlüssel für einen Transaktionsknoten.

### Beispiel 2: Neuer generieren von API-Schlüsseln für einen Transaktionsknoten
```powershell
PS C:\> $keyPair = Get-AzBlockchainTransactionNodeApiKey -BlockchainMemberName dolauli001 -ResourceGroupName testgroup -TransactionNodeName tranctionnode001 
...
Dieser Befehl generiert mithilfe von idenity api keys für einen Transaktionsknoten.
