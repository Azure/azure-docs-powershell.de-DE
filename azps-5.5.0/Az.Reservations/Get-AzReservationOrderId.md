...
## BESCHREIBUNG
Hier erhalten Sie ids der `ReservationOrder` anwendbaren Daten, die auf dieses Abonnement angewendet werden können.
...
Angewendet für `ReservationOrder` Standardabonnement
...
### -SubscriptionId
ID des Abonnements, um die angewendeten s `ReservationOrder` zu erhalten
