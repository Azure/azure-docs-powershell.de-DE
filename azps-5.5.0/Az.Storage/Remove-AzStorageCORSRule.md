...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzStorageCORSRule"** entfernt die cross originübergreifende Ressourcenfreigabe (CROSSS) für einen Azure Storage-Dienst.
Mit diesem Cmdlet werden alle KORS-Regeln eines Speicherdiensttyps gelöscht.
Die Speicherdienste für dieses Cmdlet sind BLOB, Table, Queue und File.

## BEISPIELE

### Beispiel 1: Entfernen von KORS-Regeln für den BLOB-Dienst
```
PS C:\>Remove-AzStorageCORSRule -ServiceType Blob
```

Mit diesem Befehl werden DIE -KORS-Regeln für den Blob-Diensttyp entfernt.
...
Um den Speicherkontext zu erhalten, wird New-AzStorageContext Cmdlet verwendet.
...
### -ServiceType
Gibt den Azure Storage-Diensttyp an, für den dieses Cmdlet Regeln entfernt.
