...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzStorageFile"** löscht eine Datei.
...
Mit diesem Befehl wird die Datei mit dem Namen "ContosoFile22" aus der Dateifreigabe "ContosoShare06" gelöscht.

### Beispiel 2: Herunterladen einer Datei aus einer Dateifreigabe mithilfe eines Dateifreigabeobjekts
```
PS C:\>Get-AzStorageShare -Name "ContosoShare06" | Remove-AzStorageFile -Path "ContosoFile22"
```

Dieser Befehl verwendet das **Cmdlet "Get-AzStorageShare",** um die Dateifreigabe "ContosoShare06" zu erhalten, und übergibt dieses Objekt dann mithilfe des Pipelineoperators an das aktuelle Cmdlet.
Mit dem aktuellen Befehl wird die Datei mit dem Namen "ContosoFile22" aus "ContosoShare06" gelöscht.
...
Dieses Cmdlet entfernt eine Datei in dem Ordner, den dieser Parameter angibt.
...
Mit diesem Cmdlet wird die Datei in dem von diesem Parameter angegebenen Freigabe entfernt.
