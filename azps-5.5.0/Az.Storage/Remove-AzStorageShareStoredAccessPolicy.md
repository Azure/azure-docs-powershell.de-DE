...
### Beispiel 1: Entfernen einer gespeicherten Zugriffsrichtlinie von einer Azure Storage Share
```
PS C:\>Remove-AzStorageShareStoredAccessPolicy -ShareName "ContosoShare" -Policy "GeneralPolicy"
```

Mit diesem Befehl wird eine gespeicherte Zugriffsrichtlinie namens "GeneralPolicy" aus ContosoShare entfernt.
...
### -ShareName
Gibt den Speicherfreigabenamen an, für den dieses Cmdlet eine Richtlinie entfernt.
