...
Dieses Skript entfernt ACL rescursiv für Verzeichnisblöcke, mit der Abschnittsgröße "BatchSize * MaxBatchCount". Dieses Skript enthält eine Blockgröße von 50.000.

### Beispiel 4: Rekursives Entfernen des ACL für ein Verzeichnis und ContinueOnFailure und anschließendes Fortsetzen von Fehlern nach dem anderen
```
...
Mit diesem Befehl wird ACL zuerst rekursiv in ein Verzeichnis mit "ContinueOnFailure" entfernt, und bei einigen Elementen ist ein Fehler vorhanden, und die fehlgeschlagenen Elemente werden dann nach dem anderen fortgesetzt.
