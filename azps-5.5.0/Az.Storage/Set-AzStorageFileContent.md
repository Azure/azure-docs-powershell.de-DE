...
In diesem Beispiel werden mehrere Windows PowerShell und das aktuelle Cmdlet verwendet, um alle Dateien aus dem aktuellen Ordner in den Stammordner des Container "ContosoShare06" hochzuladen.
...
Das Ergebnis hat denselben Namen und dieselbe relative Position im Hinblick auf die anderen Dateien, die in diesem Beispiel hochgeladen werden.
Geben Sie weitere Informationen zu Skriptblöcken `Get-Help about_Script_Blocks` ein.
