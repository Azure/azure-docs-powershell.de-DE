...
## BESCHREIBUNG
Das **Cmdlet "Get-AzStorageFileServiceProperty"** ruft die Diensteigenschaften für Azure Storage File Services ab.

## BEISPIELE

### Beispiel 1: Erhalten der Azure Storage File Services-Eigenschaft eines angegebenen Speicherkontos
```powershell
...
Dieser Befehl ruft die Eigenschaft "File services" eines angegebenen Speicherkontos ab.
