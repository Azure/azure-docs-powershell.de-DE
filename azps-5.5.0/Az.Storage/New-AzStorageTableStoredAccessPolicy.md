...
Mit diesem Befehl wird eine Zugriffsrichtlinie mit dem Namen "Policy02" in der Speichertabelle namens "MyTable" erstellt.
...
Beachten Sie, dass es sich um eine Zeichenfolge wie `raud` "Lesen", "Hinzufügen", "Aktualisieren" und "Löschen" handelt.
