...
Dieser Befehl generiert ein Signaturtoken für den freigegebenen Zugriff, das über vollständige Berechtigungen für die Datei mit dem Namen "FilePath" verfügt.

### Beispiel 2: Generieren eines Tokens für eine Signatur für den freigegebenen Zugriff mit einem Zeitlimit
```
...
### -Policy
Gibt die Richtlinie für den gespeicherten Zugriff für eine Datei an.
