...
## BESCHREIBUNG
Das **Cmdlet "Disable-AzStorageBlobDeleteRetentionPolicy"** deaktiviert die Löschaufbewahrungsrichtlinie für den Azure Storage Blob-Dienst.

## BEISPIELE

### Beispiel 1: Deaktivieren der Löschaufbewahrungsrichtlinie für den Blob-Dienst
```
...
Dieser Befehl deaktiviert die Löschaufbewahrungsrichtlinie für den Blob-Dienst.
