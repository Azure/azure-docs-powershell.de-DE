...
## BESCHREIBUNG
Das **Cmdlet "Get-AzStorageServiceProperty"** ruft die Eigenschaften für Azure Storage Services ab.

## BEISPIELE

### Beispiel 1: Erhalten der Azure Storage Services-Eigenschaft des Blob-Diensts
```
