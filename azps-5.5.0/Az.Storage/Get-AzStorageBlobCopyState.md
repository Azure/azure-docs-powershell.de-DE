...
### Beispiel 3: Erhalten des Kopierstatus für ein BLOB in einem Container mithilfe der Pipeline
```
...
Der erste Befehl startet das Kopieren des BLOB "ContosoPlanning2015" in "ContosoPlanning2015_copy", und gibt das Deslosungs-BLOB-Objekt aus. Die zweite Befehlspipeline des Deslikations-BLOB-Objekts zu "Get-AzStorageBlobCopyState", um den Blob Copy-Zustand zu erhalten. 
