...
## BESCHREIBUNG
Das **Cmdlet "Get-AzStorageFileHandle"** listet Dateihandles einer Dateifreigabe, eines Dateiverzeichnisses oder einer Datei auf.

## BEISPIELE

### Beispiel 1: Rekursives Auflisten aller Dateihandles einer Dateifreigabe und Sortieren nach ClientIp und OpenTime
```
...
Dieser Befehl listet Dateihandles einer Dateifreigabe auf und sortiert die Ausgabe nach ClientIp und dann nach OpenTime.

### Beispiel 2: Rekursives Auflisten der ersten 2 Dateihandles eines Dateiverzeichnisses
```
...
Dieser Befehl listet die ersten beiden Dateihandles eines Dateiverzeichnisses rekursiv auf.

### Beispiel 3: Auflisten der 3. bis 6. Dateihandles für eine Datei
```
...
Dieser Befehl listet die 3. bis 6. Dateihandles einer Datei auf.
...
### -File
Das CloudFile-Objekt gibt die Datei an, um die Dateihandles auflisten zu können.
...
### -IncludeTotalCount
Meldet die Anzahl der Objekte im Datenset (eine ganze Zahl) gefolgt von den Objekten. Wenn das Cmdlet die Gesamtanzahl nicht ermitteln kann, wird "Unbekannte Gesamtzahl" zurückgegeben.
Derzeit führt dieser Parameter keine Anderen aus.
...
### -Skip
Ignoriert die ersten "n"-Objekte und ruft dann die übrigen Objekte ab.
