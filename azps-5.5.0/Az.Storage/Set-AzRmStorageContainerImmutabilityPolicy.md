...
Mit diesem Befehl wird "ImmutabilityPolicy" eines Speicher-BLOB-Containers drei Mal mit dem #A0 aktualisiert: Zuerst 12 Tage ohne etag auf ImmutabilityPeriod, dann 9 Tage mit etag, schließlich AllowProtectedAppendWrite aktiviert.
...
Mit diesem Befehl wird "ImmutabilityPolicy" eines Speicher-BLOB-Containers mit einem ImmutabilityPolicy-Objekt erweitert. "ImmutabilityPolicy erweitern" kann nur ausgeführt werden, nachdem ImmutabilityPolicy gesperrt wurde.
...
### -ImmutabilityPeriod
Zeitraum der Unveränderbarkeit seit der Erstellung in Tagen.
