...
Sie können ein Cloud-BLOB erstellen oder eines mit dem cmdlet Get-AzStorageBlob abrufen.
...
Sie können Cloud-BLOB-Container-Objekt erstellen oder das Get-AzStorageContainer verwenden.
...
### -SrcFile
Gibt ein **CloudFile-Objekt** an.
Sie können eine Clouddatei erstellen oder eine mit **"Get-AzStorageFile" abrufen.**
