...
## BESCHREIBUNG
Aktualisiert die Arbeitsbereichseinstellungen für das Abonnement.
Der konfigurierte Arbeitsbereich enthält die Sicherheitsdaten, die vom Azure Log Analytics-Agent gesammelt wurden, der in VMs innerhalb dieses Abonnements in VMs installiert ist.
...
Legt den Arbeitsbereich "securityuserws" so fest, dass er alle Sicherheitsdaten enthält, die vom Azure Log Analytics-Agent gesammelt wurden.
