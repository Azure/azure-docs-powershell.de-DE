...
ms.locfileid: "100165172"
---
# <span data-ttu-id="85806-101">Get-AzSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="85806-101">Get-AzSecurityAlert</span></span>

## <span data-ttu-id="85806-102">SYNOPSIS</span><span class="sxs-lookup"><span data-stu-id="85806-102">SYNOPSIS</span></span>
<span data-ttu-id="85806-103">Ruft Sicherheitswarnungen ab, die vom Azure Security Center erkannt wurden</span><span class="sxs-lookup"><span data-stu-id="85806-103">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="85806-104">SYNTAX</span><span class="sxs-lookup"><span data-stu-id="85806-104">SYNTAX</span></span>

### <span data-ttu-id="85806-105">SubscriptionScope (Standard)</span><span class="sxs-lookup"><span data-stu-id="85806-105">SubscriptionScope (Default)</span></span>
```
Get-AzSecurityAlert [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="85806-106">ResourceGroupScope</span><span class="sxs-lookup"><span data-stu-id="85806-106">ResourceGroupScope</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="85806-107">ResourceGroupLevelResource</span><span class="sxs-lookup"><span data-stu-id="85806-107">ResourceGroupLevelResource</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> -Name <String> -Location <String>
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="85806-108">SubscriptionLevelResource</span><span class="sxs-lookup"><span data-stu-id="85806-108">SubscriptionLevelResource</span></span>
```
Get-AzSecurityAlert -Name <String> -Location <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### <span data-ttu-id="85806-109">ResourceId</span><span class="sxs-lookup"><span data-stu-id="85806-109">ResourceId</span></span>
```
Get-AzSecurityAlert -ResourceId <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

## <span data-ttu-id="85806-110">BESCHREIBUNG</span><span class="sxs-lookup"><span data-stu-id="85806-110">DESCRIPTION</span></span>
<span data-ttu-id="85806-111">Ruft Sicherheitswarnungen ab, die vom Azure Security Center erkannt wurden</span><span class="sxs-lookup"><span data-stu-id="85806-111">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="85806-112">BEISPIELE</span><span class="sxs-lookup"><span data-stu-id="85806-112">EXAMPLES</span></span>

### <span data-ttu-id="85806-113">Beispiel 1</span><span class="sxs-lookup"><span data-stu-id="85806-113">Example 1</span></span>
```powershell
...
<span data-ttu-id="85806-114">Ruft alle Sicherheitswarnungen ab, die für Ressourcen in einem Abonnement erkannt wurden.</span><span class="sxs-lookup"><span data-stu-id="85806-114">Gets all the security alerts that were detected on resources inside a subscription</span></span>

### <span data-ttu-id="85806-115">Beispiel 2</span><span class="sxs-lookup"><span data-stu-id="85806-115">Example 2</span></span>
```powershell
...
<span data-ttu-id="85806-116">Ruft alle Sicherheitswarnungen ab, die für Ressourcen in der Ressourcengruppe "myService1" erkannt wurden.</span><span class="sxs-lookup"><span data-stu-id="85806-116">Gets all the security alerts that were detected on resources inside the "myService1" resource group</span></span>

### <span data-ttu-id="85806-117">Beispiel 3</span><span class="sxs-lookup"><span data-stu-id="85806-117">Example 3</span></span>
```powershell
...
<span data-ttu-id="85806-118">Ruft eine bestimmte Sicherheitswarnung ab, die für Ressourcen in der Ressourcengruppe "myService1" erkannt wurde</span><span class="sxs-lookup"><span data-stu-id="85806-118">Gets a specific security alert that were detected on resources inside the "myService1" resource group</span></span>

## <span data-ttu-id="85806-119">PARAMETERS</span><span class="sxs-lookup"><span data-stu-id="85806-119">PARAMETERS</span></span>

### <span data-ttu-id="85806-120">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="85806-120">-DefaultProfile</span></span>
<span data-ttu-id="85806-121">Die Anmeldeinformationen, das Konto, den Mandanten und das Abonnement, die für die Kommunikation mit Azure verwendet werden.</span><span class="sxs-lookup"><span data-stu-id="85806-121">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="85806-122">-Location</span><span class="sxs-lookup"><span data-stu-id="85806-122">-Location</span></span>
<span data-ttu-id="85806-123">"Ort" aus.</span><span class="sxs-lookup"><span data-stu-id="85806-123">Location.</span></span>
...
### <span data-ttu-id="85806-124">-Name</span><span class="sxs-lookup"><span data-stu-id="85806-124">-Name</span></span>
<span data-ttu-id="85806-125">Ressourcenname.</span><span class="sxs-lookup"><span data-stu-id="85806-125">Resource name.</span></span>
...
### <span data-ttu-id="85806-126">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="85806-126">-ResourceGroupName</span></span>
<span data-ttu-id="85806-127">Ressourcengruppenname.</span><span class="sxs-lookup"><span data-stu-id="85806-127">Resource group name.</span></span>
...
### <span data-ttu-id="85806-128">-ResourceId</span><span class="sxs-lookup"><span data-stu-id="85806-128">-ResourceId</span></span>
<span data-ttu-id="85806-129">Ressourcen-ID.</span><span class="sxs-lookup"><span data-stu-id="85806-129">Resource ID.</span></span>
...
### <span data-ttu-id="85806-130">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="85806-130">CommonParameters</span></span>
<span data-ttu-id="85806-131">Dieses Cmdlet unterstützt die allgemeinen Parameter: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction und -WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="85806-131">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="85806-132">Weitere Informationen finden Sie unter [about_CommonParameters.](http://go.microsoft.com/fwlink/?LinkID=113216)</span><span class="sxs-lookup"><span data-stu-id="85806-132">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="85806-133">EINGABEN</span><span class="sxs-lookup"><span data-stu-id="85806-133">INPUTS</span></span>

### <span data-ttu-id="85806-134">System.String</span><span class="sxs-lookup"><span data-stu-id="85806-134">System.String</span></span>

## <span data-ttu-id="85806-135">AUSGABEN</span><span class="sxs-lookup"><span data-stu-id="85806-135">OUTPUTS</span></span>

### <span data-ttu-id="85806-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="85806-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span></span>

## <span data-ttu-id="85806-137">HINWEISE</span><span class="sxs-lookup"><span data-stu-id="85806-137">NOTES</span></span>

## <span data-ttu-id="85806-138">LINKS ZU VERWANDTEN THEMEN</span><span class="sxs-lookup"><span data-stu-id="85806-138">RELATED LINKS</span></span>
