...
### Beispiel 1: Alle verfügbaren Features erhalten
```
...
### Beispiel 2: Informationen zu einem bestimmten Feature
```
...
### -FeatureName
Gibt den Namen des features an, das sie erhalten soll.
...
### -ListAvailable
Gibt an, dass dieses Cmdlet alle Features erhält.
...
### -ProviderNamespace
Gibt den Namespace an, für den dieses Cmdlet Anbieterfeatures erhält.
