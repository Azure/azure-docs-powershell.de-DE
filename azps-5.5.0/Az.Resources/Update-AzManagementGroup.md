...
## BESCHREIBUNG
Das **Cmdlet "Update-AzManagementGroup"** aktualisiert **"ParentId"** oder **"DisplayName"** für eine Verwaltungsgruppe.
...
### Beispiel 3: Aktualisieren einer Verwaltungsgruppe durch Piping des Objekts "PSManagementGroup"
```
...
### Beispiel 4: Aktualisieren des übergeordneten Elements einer Verwaltungsgruppe mithilfe von ParentObject
```
...
### -InputObject
Eingabeobjekt aus dem Aufruf von "Get"
