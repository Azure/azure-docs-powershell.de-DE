...
## BESCHREIBUNG
Das **Cmdlet "New-AzPolicyDefinition"** erstellt eine Richtliniendefinition, die eine Richtlinienregel im JavaScript Object Notation (JSON)-Format enthält.
...
Dieser Befehl erstellt eine Richtliniendefinition namens "LocationDefinition", die die in "C:\LocationPolicy.json" angegebene C:\LocationPolicy.jsenthält. Beispielinhalt für die LocationPolicy.jsdatei wird oben bereitgestellt.

### Beispiel 2: Erstellen einer parameterisierten Richtliniendefinition mithilfe von Inlineparametern
```
{
   "if": {
      "field": "location",
...
Dieser Befehl erstellt eine Richtliniendefinition namens "LocationDefinition", die die in "C:\LocationPolicy.json" angegebene C:\LocationPolicy.jsenthält. Die Parameterdefinition für die Richtlinienregel wird inline bereitgestellt.
...
Mit diesem Befehl wird eine Richtliniendefinition namens "VMPolicyDefinition" in der Verwaltungsgruppe "Dept42" erstellt.
...
Dieser Befehl erstellt eine Richtliniendefinition namens VMPolicyDefinition mit Metadaten, die angeben, dass die Kategorie "Virtual Machine" ist.
Der Befehl gibt die Richtlinie als Zeichenfolge im gültigen JSON-Format an.

### Beispiel 5: Erstellen einer Richtliniendefinition inline mit dem Modus
```
...
Dieser Befehl erstellt eine Richtliniendefinition namens "TagsPolicyDefinition" mit dem Modus "Indexed", der angibt, dass die Richtlinie nur für Ressourcentypen ausgewertet werden sollte, die Tags und Speicherort unterstützen.
...
### -Metadata
Die Metadaten für die Richtliniendefinition. Dabei kann es sich entweder um einen Pfad zu einem Dateinamen mit den Metadaten oder um die Metadaten als Zeichenfolge
...
### -Parameter
Die Parameterdeklaration für die Richtliniendefinition. Dabei kann es sich entweder um einen Pfad zu einem Dateinamen mit der Parameterdeklaration oder um die Parameterdeklaration als Zeichenfolge geben.
...
Sie können den Pfad einer JSON-Datei oder eine Zeichenfolge angeben, die die Richtlinie im JSON-Format enthält.
