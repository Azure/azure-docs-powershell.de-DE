...
Der Prinzipal kann ein Benutzer (SignInName- oder ObjectId-Parameter verwenden, um einen Benutzer zu identifizieren), eine Sicherheitsgruppe (mit dem ObjectId-Parameter zum Identifizieren einer Gruppe) oder ein Dienstprinzipal (verwenden Sie die Parameter "ServicePrincipalName" oder "ObjectId" zum Identifizieren eines "ServicePrincipal"-Werts) sein.
