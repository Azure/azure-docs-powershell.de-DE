...
## BESCHREIBUNG
Entfernen Sie den Knotentyp oder bestimmte Knoten innerhalb des Knotentyps. Wenn der Paremter "-NodeName" verwendet wird, werden nur angegebene Knoten entfernt.
...
Entfernen Sie zwei Knoten aus dem Knotentyp mit Piping.
...
Seien Sie vorsichtig, da dies zu Datenverlust führen kann, wenn zustandsbehaftete Workloads für die Knoten ausgeführt werden, oder den Cluster nach dem Opeario nicht genügend Startknoten enthalten.
