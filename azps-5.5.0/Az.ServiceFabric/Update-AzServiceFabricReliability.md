...
Mit diesem Befehl wird die Zuverlässigkeitsebene des primären Knotentyps in "Silver" geändert.

### Beispiel 2

Aktualisieren Sie die Zuverlässigkeitsstufen des primären Knotentyps in einem Cluster. (automatisch generiert)
