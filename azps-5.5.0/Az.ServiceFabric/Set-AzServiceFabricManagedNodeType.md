...
## SYNOPSIS
Legt Ressourceneigenschaften des Knotentyps fest, oder führen Sie Reimageaktionen für bestimmte Knotentypen des Knotentyps mit dem Parameter "-Reimage" aus.
...
### -PlacementProperty
Placement tags applied to nodes in the node type as key/value pairs, which can be used to indicate where certain services (workload) should run. Durch das Aktualisieren dieser Einstellung werden die aktuellen Werte überschrieben.
...
### -Reimage
Geben Sie an, dass Knoten für den Knotentyp neu abbilden werden.
