...
### Beispiel 1: Aktualisieren von HealthBot nach Ressourcengruppenname und Name
```powershell
...
Aktualisieren von HealthBot nach Ressourcengruppenname und Name

### Beispiel 2: Aktualisieren von HealthBot von InputObject
```powershell
...
Aktualisieren von HealthBot von InputObject
