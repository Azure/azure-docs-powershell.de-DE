...
## BESCHREIBUNG
Erstellen Sie registrierte ASNs für Peeringobjekte.

## BEISPIELE

### Peering erhalten und einen registrierten ASN erstellen
```powershell
PS C:\>$peering = Get-AzPeering -ResourceGroupName $resourceGroupName -Name $name
PS C:\>$peering | New-AzPeeringRegisteredAsn -Name $asnName -Asn $asn
```

Holen Sie sich das Peering, dem Sie einen registrierten ASN hinzufügen möchten. Übergeben Sie dies dann an das Commandlet.

### Verwenden der PeeringressourceId zum Erstellen eines registrierten Asns
```powershell
