...
Verwenden Get-AzPeeringLocation "-Kind" \<kind\> den Ortsnamen als Schlüssel.
...
### -SKU
Wählen Sie Basic_Direct_Free oder Premium_Direct_Free, es sei denn, Sie müssen explizit eine andere Option auswählen.
