...
## BESCHREIBUNG
Das **Cmdlet "Get-AzPowerBIWorkspaceCollectionAccessKey"** ruft die aktuellen Zugriffstasten ab, die einer Power BI-Arbeitsbereichssammlung zugeordnet sind.

## BEISPIELE

### Beispiel 1: Erhalten von Zugriffstasten
```
