...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzPowerBIWorkspaceCollection"** entfernt eine Power BI-Arbeitsbereichssammlung aus Ihrem Azure-Abonnement und der Ressourcengruppe.

## BEISPIELE

### Beispiel 1: Entfernen einer Arbeitsbereichssammlung
```
PS C:\>Remove-AzPowerBIWorkspaceCollection -ResourceGroupName "ResourceGroup17" -WorkspaceCollectionName "WCN11"
```

Mit diesem Befehl wird die Arbeitsbereichssammlung mit dem Namen WCN11 in der angegebenen Ressourcengruppe entfernt.
...
### -ResourceGroupName
Gibt den Namen der Ressourcengruppe an, aus der mit diesem Cmdlet eine Arbeitsbereichssammlung entfernt wird.
...
Gibt den Namen der Power BI-Arbeitsbereichssammlung an, die von diesem Cmdlet entfernt wird.
