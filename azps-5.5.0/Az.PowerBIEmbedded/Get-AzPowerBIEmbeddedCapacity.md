...
### ByCriptionOrResourceGroupOrSubscription (Standard)
```
...
## BESCHREIBUNG
Das Get-AzPowerBIEmbeddedCapacity cmdlet ruft die Details einer eingebetteten PowerBI-Kapazität ab.

## BEISPIELE

### Beispiel 1: Ressourcengruppenressourcen erhalten
```
...
Dieser Befehl ruft alle eingebetteten Azure PowerBI-Kapazität in der Ressourcengruppe namens testRG ab.

### Beispiel 2: Erhalten einer Kapazität
```
...
Mit diesem Befehl wird die eingebettete Azure PowerBI-Kapazität, die in der Ressourcengruppe "testRG" genannt wird, als Testkraft bezeichnet.
