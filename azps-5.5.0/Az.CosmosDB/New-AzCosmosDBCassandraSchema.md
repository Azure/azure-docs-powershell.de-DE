...
## SYNOPSIS
Erstellt ein neues Schema aus Demkka.
...
## BESCHREIBUNG
Das **neue Schema "New-AzCosmosDBCassschema"** erstellt ein neues Schema aus "DessDB Schema".
...
### -PartitionKey
Array von Zeichenfolgen, die Partition Keys enthalten.
