...
## SYNOPSIS
Holen Sie sich Das Kundenkonto.
...
## BESCHREIBUNG
Das **Cmdlet "Get-AzCosmosDBAccount"** ruft die Liste aller vorhandenen "Vorname"-Konten für einen bestimmten ResourceGroupName ab und ruft ein einzelnes "Durchlaufsdb"-Konto für einen bestimmten ResourceGroupName und AccountName ab.
...
Holen Sie sich das Dbdb-Datenbankkonto mit name databaseAccountName in ResourceGroup resourceGroupName.
