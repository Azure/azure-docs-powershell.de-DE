...
## BESCHREIBUNG
Das **Cmdlet "Set-AzSynapseSqlPoolTransparentDataEncryption"** ändert die Eigenschaft "Transparent Data Encryption (TDE)" eines Azure Synapse Analytics SQL Pool.
...
Dieser Befehl aktiviert TDE für den SQL "ContosoSqlPool" unter dem Arbeitsbereich "ContosoWorkspace".
...
### -State
Der Zustand "Azure Synapse Analytics Sql Pool Transparent Data Encryption".
