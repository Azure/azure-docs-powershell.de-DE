...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzSynapseSparkPool"** löscht einen Azure Synapse Analytics Spark-Pool endgültig.
...
Mit diesem Befehl wird ein Azure Synapse Analytics Spark-Pool über die Pipeline gelöscht.
