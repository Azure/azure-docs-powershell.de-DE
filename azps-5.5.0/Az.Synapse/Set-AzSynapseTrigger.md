...
Erstellen Sie im Arbeitsbereich "ContosoWorkspace" einen neuen Trigger namens "ContosoTrigger". Der Trigger wird im Zustand "Stopped" erstellt, was bedeutet, dass er nicht sofort gestartet wird. Ein Trigger kann mit dem `Start-AzDataFactoryV2Trigger` Cmdlet gestartet werden.
...
Erstellen Sie einen neuen Trigger namens "ContosoTrigger" im Arbeitsbereich "ContosoWorkspace" über die Pipeline. Der Trigger wird im Zustand "Stopped" erstellt, was bedeutet, dass er nicht sofort gestartet wird. Ein Trigger kann mit dem `Start-AzDataFactoryV2Trigger` Cmdlet gestartet werden.
