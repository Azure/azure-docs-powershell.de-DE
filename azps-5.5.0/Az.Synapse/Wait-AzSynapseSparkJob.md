...
## BESCHREIBUNG
Das **Cmdlet "Wait-AzSynapseSparkJob"** wartet auf den Abschluss eines Azure Synapse Analytics-Auftrags.
...
Dieser Befehl wartet auf den Abschluss des Auftrags mit der angegebenen ID.
...
### -SparkJobObject
Sparkauftragseingabeobjekt, das in der Regel über die Pipeline übergeben wird.
...
### -TimeoutInSeconds
Die maximale Wartezeit vor dem Fehler. Der Standardwert ist", dass "timeout" niemals verwendet wird.
...
Das Abfrageintervall zwischen der Überprüfung des Auftragsstatus in Sekunden.
