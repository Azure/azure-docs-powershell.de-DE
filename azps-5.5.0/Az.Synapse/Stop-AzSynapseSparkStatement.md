...
Dieser Befehl bricht die "Spark"-Anweisung mit der angegebenen "nachkomma"-ID ab.
...
Mit diesem Befehl wird die "Spark"-Anweisung mit der angegebenen "nachkomma"-ID über die Pipeline abgebrochen.
