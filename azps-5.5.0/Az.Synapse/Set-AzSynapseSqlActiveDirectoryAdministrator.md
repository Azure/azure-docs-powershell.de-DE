...
## BESCHREIBUNG
Das **Cmdlet "Set-AzSynapseSqlActiveDirectoryAdministrator"** stellt im aktuellen Abonnement einen Azure Active Directory (Azure AD)-Administrator für Azure Synapse Analytics Workspace bereit.
