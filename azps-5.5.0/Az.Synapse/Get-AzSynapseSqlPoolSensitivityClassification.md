...
### Beispiel 1: Aktuelle Informationstypen und Vertraulichkeitsbezeichnungen eines Azure Synapse SQL erhalten.
```powershell
...
### Beispiel 2: Erhalten aktueller Informationstypen und Vertraulichkeitsbeschriftungen eines Azure Synapse SQL pools mit Piping.
```powershell
