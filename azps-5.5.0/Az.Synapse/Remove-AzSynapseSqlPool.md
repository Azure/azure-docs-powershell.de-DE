...
## BESCHREIBUNG
Mit **dem Cmdlet "Remove-AzSynapseSqlPool"** wird ein Azure Synapse Analytics-SQL gelöscht.
...
Mit diesem Befehl wird ein Azure Synapse Analytics SQL gelöscht.
...
Mit diesem Befehl wird ein Azure Synapse Analytics SQL Pipeline gelöscht.
...
Mit diesem Befehl wird ein Azure Synapse Analytics SQL mit der angegebenen Ressourcen-ID gelöscht.
