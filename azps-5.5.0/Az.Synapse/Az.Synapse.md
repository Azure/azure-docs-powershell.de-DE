...
# Az.Synapse-Modul
## Beschreibung
In den Themen in diesem Abschnitt werden die Azure -PowerShell-Cmdlets für Azure Synapse Analytics dokumentiert.

## Az.Synapse-Cmdlets
### [Add-AzSynapseTriggerSubscription](Add-AzSynapseTriggerSubscription.md)
Abonnieren Sie den Ereignistrigger für Ereignisse externer Dienste.
...
Deaktiviert die erweiterte Datensicherheit in einem Arbeitsbereich.
...
Aktiviert Advanced Data Security in einem Arbeitsbereich.
...
Ruft Informationen zu Aktivitäten ab, die für einen Pipelinelauf ausgeführt werden.

### [Get-AzSynapseDataFlow](Get-AzSynapseDataFlow.md)
Ruft Informationen zu Datenflüssen im Arbeitsbereich ab.
...
Ruft Informationen zu Integrations-Runtime-Knoten ab.
...
Ruft Informationen zu Pipelineläufen ab.
...
Ruft eine Synapse Analytics-Rollendefinition ab.

### [Get-AzSynapseSparkJob](Get-AzSynapseSparkJob.md)
Ruft einen Synapse Analytics Spark-Auftrag ab.
...
Ruft eine Synapse Analytics Spark-Sitzung ab.
...
Ruft Informationen zu einem Azure AD-Administrator für Synapse Analytics Workspace ab.
...
Ruft die erweiterten Threat Protection-Einstellungen für einen Arbeitsbereich ab.

### [Get-AzSynapseSqlAuditSetting](Get-AzSynapseSqlAuditSetting.md)
Ruft die Überwachungseinstellungen eines Azure Synapse Analytics Workspace ab.

### [Get-AzSynapseSqlDatabase](Get-AzSynapseSqlDatabase.md)
Dieses Feature ist in einer eingeschränkten Vorschau verfügbar und kann anfänglich nur für bestimmte Abonnements verwendet werden. Ruft eine Synapse Analytics SQL ab.
...
Ruft die Überwachungseinstellungen eines Azure Synapse Analytics SQL ab.

### [Get-AzSynapseSqlPoolRestorePoint](Get-AzSynapseSqlPoolRestorePoint.md)
Ruft die unterschiedlichen Wiederherstellungspunkte ab, aus denen ein Synapse Analytics SQL wiederhergestellt werden kann.
...
Ruft den Zustand "TDE" für einen SQL ab.
...
Ruft die Sicherheitsrisikobewertungseinstellungen eines SQL ab.

### [Get-AzSynapseSqlVulnerabilityAssessmentSetting](Get-AzSynapseSqlVulnerabilityAssessmentSetting.md)
Ruft die Sicherheitsrisikobewertungseinstellungen eines Arbeitsbereichs ab.
...
Regenerieren Sie den selbst gehosteten Integrations-Runtime-Schlüssel erneut.
...
Dieses Feature ist in einer eingeschränkten Vorschau verfügbar und kann anfänglich nur für bestimmte Abonnements verwendet werden. Erstellt eine Synapse Analytics SQL Datenbank.
...
Entfernt einen Datenfluss aus dem Arbeitsbereich.
...
Löscht eine Synapse Analytics-Firewallregel.
...
Entfernt ein Notizbuch aus einem Arbeitsbereich.

### [Remove-AzSynapsePipeline](Remove-AzSynapsePipeline.md)
Entfernt eine Pipeline aus dem Arbeitsbereich.
...
Löscht einen Synapse Analytics Spark-Pool.

### [Remove-AzSynapseSqlActiveDirectoryAdministrator](Remove-AzSynapseSqlActiveDirectoryAdministrator.md)
Entfernt einen Azure AD-Administrator für Synapse Analytics Workspace.

### [Remove-AzSynapseSqlDatabase](Remove-AzSynapseSqlDatabase.md)
Dieses Feature ist in einer eingeschränkten Vorschau verfügbar und kann anfänglich nur für bestimmte Abonnements verwendet werden. Löscht eine Synapse Analytics SQL Datenbank.

### [Remove-AzSynapseSqlPool](Remove-AzSynapseSqlPool.md)
Löscht einen Synapse Analytics SQL Pool.
...
Entfernt die Informationstypen und Vertraulichkeitsbeschriftungen von Spalten im SQL Pool.

### [Remove-AzSynapseTrigger](Remove-AzSynapseTrigger.md)
Entfernt einen Trigger aus einem Arbeitsbereich.

### [Remove-AzSynapseTriggerSubscription](Remove-AzSynapseTriggerSubscription.md)
Kündigen des Auslösers des Ereignisses für externe Dienste

### [Remove-AzSynapseWorkspace](Remove-AzSynapseWorkspace.md)
Löscht einen Synapse Analytics-Arbeitsbereich.
...
Entfernt die Überwachungseinstellungen eines Azure Synapse Analytics Workspace.
...
Beseitigt die Sicherheitsrisikobewertungseinstellungen eines SQL Pool.

### [Reset-AzSynapseSqlVulnerabilityAssessmentSetting](Reset-AzSynapseSqlVulnerabilityAssessmentSetting.md)
Beseitigt die Einstellungen für die Bewertung von Sicherheitslücken in einem Arbeitsbereich.
...
Erstellt oder aktualisiert einen Datenfluss im Arbeitsbereich.

### [Set-AzSynapseDataset](Set-AzSynapseDataset.md)
Erstellt oder aktualisiert ein Dataset im Arbeitsbereich.
...
Verknüpft einen Datenspeicher oder einen Clouddienst mit einem Arbeitsbereich.
...
Erstellt eine Pipeline im Arbeitsbereich.
...
Legt die Informationstypen und Vertraulichkeitsbeschriftungen von Spalten im SQL fest.

### [Set-AzSynapseSqlPoolTransparentDataEncryption](Set-AzSynapseSqlPoolTransparentDataEncryption.md)
Ändert die "TDE"-Eigenschaft für SQL Pool.
...
Startet einen Trigger in einem Arbeitsbereich.

### [Stop-AzSynapsePipelineRun](Stop-AzSynapsePipelineRun.md)
Beendet die Ausführung einer Pipeline in einem Arbeitsbereich.

### [Stop-AzSynapseSparkJob](Stop-AzSynapseSparkJob.md)
Bricht einen Synapse Analytics Spark-Auftrag ab.
...
Beendet einen Trigger in einem Arbeitsbereich.
...
Setzt einen Synapse Analytics SQL aus.
...
Sucht nach dem Vorhandensein eines Synapse Analytics Spark-Pools.

### [Test-AzSynapseSqlDatabase](Test-AzSynapseSqlDatabase.md)
Dieses Feature ist in einer eingeschränkten Vorschau verfügbar und kann anfänglich nur für bestimmte Abonnements verwendet werden. Sucht nach dem Vorhandensein einer Synapse Analytics SQL Datenbank.
...
Überprüft, ob ein Synapse Analytics-Arbeitsbereich vorhanden ist.

### [Update-AzSynapseFirewallRule](Update-AzSynapseFirewallRule.md)
Aktualisiert eine Synapse Analytics-Firewallregel.
...
Aktualisiert einen Synapse Analytics Spark-Pool.

### [Update-AzSynapseSqlAdvancedThreatProtectionSetting](Update-AzSynapseSqlAdvancedThreatProtectionSetting.md)
Aktualisiert eine erweiterte Threat Protection-Einstellung in einem Arbeitsbereich.

### [Update-AzSynapseSqlDatabase](Update-AzSynapseSqlDatabase.md)
Dieses Feature ist in einer eingeschränkten Vorschau verfügbar und kann anfänglich nur für bestimmte Abonnements verwendet werden. Aktualisiert eine Synapse Analytics SQL Datenbank.
...
Legt eine erweiterte Threat Protection-Einstellung für einen SQL fest.

### [Update-AzSynapseSqlPoolVulnerabilityAssessmentSetting](Update-AzSynapseSqlPoolVulnerabilityAssessmentSetting.md)
Aktualisiert die Einstellungen für die Sicherheitsrisikobewertung eines SQL Pool.

### [Update-AzSynapseSqlVulnerabilityAssessmentSetting](Update-AzSynapseSqlVulnerabilityAssessmentSetting.md)
Aktualisiert die Einstellungen für die Sicherheitsrisikobewertung in einem Arbeitsbereich.
...
Wartet auf den Abschluss eines Synapse Analytics Spark-Auftrags.
