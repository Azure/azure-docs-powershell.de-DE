...
## BESCHREIBUNG
Das **Cmdlet "Start-AzSynapseTrigger"** startet einen Trigger in einem Arbeitsbereich. Wenn sich der Trigger im Zustand "Stopped" befindet, startet das Cmdlet den Trigger und ruft schließlich Pipelines basierend auf seiner Definition auf. Wenn sich der Trigger bereits im Zustand "Gestartet" befindet, hat dieses Cmdlet keine Auswirkung.
...
Startet einen Trigger namens "ContosoTrigger" im Arbeitsbereich "ContosoWorkspace".
...
Startet einen Trigger namens "ContosoTrigger" im Arbeitsbereich "ContosoWorkspace" über die Pipeline.
