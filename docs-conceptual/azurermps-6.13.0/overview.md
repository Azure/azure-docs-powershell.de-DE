...
- [Virtuelle Linux-Computer](https://docs.microsoft.com/azure/virtual-machines/linux/powershell-samples)
- [Virtuelle Windows-Computer](https://docs.microsoft.com/azure/virtual-machines/windows/powershell-samples)
