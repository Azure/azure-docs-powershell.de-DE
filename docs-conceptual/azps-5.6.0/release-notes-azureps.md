...
## <a name="560---march-2021"></a>5.6.0: März 2021
#### <a name="azaccounts"></a>Az.Accounts
* Azure.Identity aktualisiert, um ein Problem zu beheben, das dazu führte, dass bei „Connect-AzAccount“ bei Verwendung von ADFS-Anmeldeinformationen ein Fehler auftrat [Nr. 13560]

#### <a name="azautomation"></a>Az.Automation
* Problem behoben, dass die Zeichenfolge nicht korrekt serialisiert werden kann [Nr. 14215]
* Unterstützung für den Python3-Runbooktyp hinzugefügt

#### <a name="azcompute"></a>Az.Compute
* Parameter „-EnableHotpatching“ zum Cmdlet „Set-AzVMOperatingSystem“ für Windows-Computer hinzugefügt 
* Parameter „-PatchMode“ zu den Linux-Parametersätzen im Cmdlet „Set-AzVMOperatingSystem“ hinzugefügt 
* [Breaking Change] Breaking Changes für Benutzer in der öffentlichen Vorschau des Features für VM-Gast-Patches
    - Eigenschaft „RebootStatus“ aus dem Objekt „Microsoft.Azure.Management.Compute.Models.LastPatchInstallationSummary“ entfernt 
    - Eigenschaft „StartedBy“ aus dem Objekt „Microsoft.Azure.Management.Compute.Models.LastPatchInstallationSummary“ entfernt
    - Eigenschaft „Kbid“ im Objekt „Microsoft.Azure.Management.Compute.Models.VirtualMachineSoftwarePatchProperties“ in „KbId“ umbenannt 
    - Eigenschaft „patches“ im Objekt „Microsoft.Azure.Management.Compute.Models.VirtualMachineAssessPatchesResult“ in „availablePatches“ umbenannt 
    - Objekt „Microsoft.Azure.Management.Compute.Models.SoftwareUpdateRebootBehavior“ in „Microsoft.Azure.Management.Compute.Models.VMGuestPatchRebootBehavior“ umbenannt
    - Objekt „Microsoft.Azure.Management.Compute.Models.InGuestPatchMode“ in „Microsoft.Azure.Management.Compute.Models.WindowsVMGuestPatchMode“ umbenannt
* [Breaking Change] Alle ContainerService-Cmdlets entfernt. Die Containerdienst-API wurde im Januar 2020 eingestellt. 
...
* Authentifizierung für `Connect-AzContainerRegistry` korrigiert

#### <a name="azcosmosdb"></a>Az.CosmosDB
* „NetworkAclBypass“ und „NetworkAclBypassResourceIds“ für Datenbankkonto-Cmdlets eingeführt
* ServerVersion-Parameter für „Update-AzCosmosDBAccount“ eingeführt
* „BackupInterval“ und „BackupRetention“ für Datenbankkonto-Cmdlets eingeführt

#### <a name="azdatafactory"></a>Az.DataFactory
* ADF .NET SDK-Version auf 4.14.0 aktualisiert

#### <a name="azmigrate"></a>Az.Migrate
* Allgemeine Verfügbarkeit von Az.Migrate
* „Initialize-AzMigrateReplicationInfrastructure“ als Cmdlet in das Az.Migrate-Modul aus dem externen Skript integriert, das derzeit ausgeführt wird
* Einige Parameter von „New-AzMigrateServerReplication“, „New-AzMigrateDiskMapping“ so festgelegt, dass die Groß-/Kleinschreibung nicht beachtet werden muss
* Unterstützung für das Skalieren von Applianceänderungen hinzugefügt, um neue V3-Schlüssel zu verarbeiten

#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* NULL-Überprüfung für Zielspeicherkonto bei Dateifreigabewiederherstellung hinzugefügt

#### <a name="azresources"></a>Az.Resources
* Unterstützung für die Azure-Ressourcenbereitstellung in der Bicep-Sprache hinzugefügt
* Probleme mit TemplateSpec-Bereitstellungen in „New-AzTenantDeployment“ und „New-AzManagementGroupDeployment“ behoben
* Unterstützung für den Parameter „-QueryString“ in Cmdlets vom Typ „Test-Az*Deployments“ hinzugefügt
* Problem mit dynamischen Parametern behoben, das bei der Verwendung von „New-Az*Deployments“ mit „-QueryString“ auftrat
* Unterstützung für den Parameter „-TemplateParameterObject“ bei Verwendung des Parameters „-TemplateSpecId“ in Cmdlets vom Typ „New-Az*Deployments“ hinzugefügt
* Ungenaue Fehlermeldung korrigiert, die bei dem Versuch, eine nicht vorhandene Vorlagenspezifikation bereitzustellen, angezeigt wurde

#### <a name="azstorage"></a>Az.Storage
* Upgrade auf Microsoft.Azure.Management.Storage 19.0.0, um die neue API-Version 2021-01-01 zu unterstützen
* Unterstützte Ressourcenzugriffsregel in NetworkRuleSet
    - „Update-AzStorageAccountNetworkRuleSet“
    - „Add-AzStorageAccountNetworkRule“
    - Remove-AzStorageAccountNetworkRule
* Unterstützte Blobversion und unterstützter Anfügeblobtyp in der Verwaltungsrichtlinie
    - „Add-AzStorageAccountManagementPolicyAction“
    - New-AzStorageAccountManagementPolicyFilter
    - „Set-AzStorageAccountManagementPolicy“
* Unterstützung für das Erstellen/Aktualisieren von Konten mit AllowSharedKeyAccess
    - New-AzStorageAccount
    - Set-AzStorageAccount
* Unterstützung für das Erstellen eines Verschlüsselungsbereichs mit RequireInfrastructureEncryption
    - New-AzStorageEncryptionScope
* Unterstützung für das synchrone Kopieren von Blockblobs mit Verschlüsselungsbereich
    - Copy-AzStorageBlob
* Problem behoben, aufgrund dessen „Get-AzStorageBlobContent“ das falsche Verzeichnistrennzeichen unter Linux und MacOS verwendete [Nr. 14234]

#### <a name="azwebsites"></a>Az.Websites
* Option für benutzerdefiniertes Timeout für „Publish-AzWebApp“ eingeführt 
* Unterstützung für App Service-Umgebung hinzugefügt
...
### <a name="thanks-to-our-community-contributors"></a>Dank an unsere Mitwirkenden in der Community
* @alunmj,Kleinschreibung, Formatierungsänderungen (Nr. 14155)
* @chakra146, „Add-AzLoadBalancerInboundNatPoolConfig.md“ aktualisiert (Nr. 14231)
* Martin Ehrnst (@ehrnst), Tippfehler im Cmdlet korrigiert (Nr. 14112)
* Jan David Narkiewicz (@jdnark)
  * In den Beispielen wurden das Legacy-Cmdlet „New-AzAks“ und der Alias für „New-AzAksCluster“ verwendet. Beispiele für die Verwendung von „New-AzAksCluster“ (das auf dieser Dokumentationsseite behandelte Cmdlet) (Nr. 14088)
  * Tippfehler korrigiert: „SshKeyVaule“ in „SshKeyValue“ geändert (Nr. 14087)
* Ivan Kulezic (@kukislav), Beispiele für SQL MI-Wartungskonfiguration hinzugefügt (Nr. 14216)
* @webguynj, „Set-AzNetworkSecurityRuleConfig.md“ aktualisiert (Nr. 14176)
* Yannick Dils (@yannickdils), zusätzliche Befehlszeile zum Beispiel hinzugefügt, das die Änderungen auf den Lastenausgleich anwendet (Nr. 14185)

## <a name="550---february-2021"></a>5.5.0: Februar 2021
#### <a name="azaccounts"></a>Az.Accounts
* CloudError-Code in Ausnahme nachverfolgt
* Ereignis „ContextCleared“ bei der Ausführung von „Clear-AzContext“ ausgelöst

#### <a name="azaks"></a>Az.Aks
* Fehlermeldungen des Cmdlet-Fehlers optimiert
* Ausnahmebehandlung zur Verwendung von Azure PowerShell-Ausnahmen aktualisiert
* Problem behoben, aufgrund dessen Benutzer nicht den angegebenen Dienstprinzipal zum Erstellen eines Kubernetes-Clusters verwenden konnten [Nr. 13938]

#### <a name="azautomation"></a>Az.Automation
* Problem behoben, das bei der Verarbeitung von „PSCustomObject“ und „Array“ auftrat

#### <a name="azcompute"></a>Az.Compute
* Parameter „-EnableAutomaticUpgrade“ zu „Set-AzVmExtension“ und „Add-AzVmssExtension“ hinzugefügt
* FilterExpression-Parameter aus der Dokumentation zum Cmdlet „Get-AzVMImage“ entfernt 
* Hinweis zur Veraltung zu ContainerService-Cmdlets hinzugefügt:
    ...
    - Remove-AzContainerServiceAgentPoolProfile
    - Update-AzContainerService
* Parameter „-BurstingEnabled“ zu „New-AzDiskConfig“ und „New-AzDiskUpdateConfig“ hinzugefügt
* Parameter „-GroupByApplicationId“ und „-GroupByUserAgent“ zu Cmdlets „Export-AzLogAnalyticThrottledRequest“ und „Export-AzLogAnalyticRequestRateByInterval“ hinzugefügt
* Parameter „VMParameterSet“ zu Cmdlet „Get-AzVMExtension“ hinzugefügt Neuer Parameter „-VM“ zu diesem Parametersatz hinzugefügt 

#### <a name="azcontainerregistry"></a>Az.ContainerRegistry
* Cmdlets zu unterstützten Repository-, Manifest- und Tagvorgängen hinzugefügt:
...
Unterstützung von „-EnableNoPublicIP“ beim Erstellen eines Databricks-Arbeitsbereichs

#### <a name="azfrontdoor"></a>Az.FrontDoor
* FrontDoorId zu Eigenschaften hinzugefügt
* JSON-Ausschlüsse und RequestBodyCheck-Unterstützung zu verwalteten Regeln hinzugefügt

#### <a name="azhdinsight"></a>Az.HDInsight
* Neuer Parameter „-EnableComputeIsolation“ und „-ComputeIsolationHostSku“ zum Cmdlet „New-AzHDInsightCluster“ zur Unterstützung der Funktion „Isoliertes Compute“ hinzugefügt
* Eigenschaft „ComputeIsolationProperties“ und „ConnectivityEndpoints“ in der Klasse „AzureHDInsightCluster“ hinzugefügt

#### <a name="azkeyvault"></a>Az.KeyVault
* Unterstützung der Angabe von Schlüsseltyp und Kurvenname beim Importieren von Schlüsseln über eine BYOK-Datei

#### <a name="aznetwork"></a>Az.Network
* Neue Cmdlets hinzugefügt, um den alten Produktnamen „virtual router“ durch den neuen Namen „route server“ zu ersetzen
    - New-AzRouteServer
    - Get-AzRouteServer
    ...
    - Veraltungsattributwarnung zu alten Cmdlets hinzugefügt
* Fehlerbehebung in ExpressRouteLink MacSecConfig Neue Eigenschaft „SciState“ zu „PSExpressRouteLinkMacSecConfig“ hinzugefügt
* Formatlisten- und Formattabellenansichten für „Get-AzVirtualNetworkGatewayConnectionIkeSa“ aktualisiert

#### <a name="azpolicyinsights"></a>Az.PolicyInsights
* In PowerShell vorgenommene Änderungen zurückgezogen, durch die der Zeilengrenzwert für Anforderungen erhöht wurde Falsche Anweisung zur Unterstützung von Paging entfernt

#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* Grenzwerte für Richtlinienüberprüfung gemäß Sicherungsdienst geändert
* Zonenredundanz für Recovery Services-Tresore hinzugefügt 
* Azure Site Recovery-Unterstützung von Näherungsplatzierungsgruppen für Anbieter vom Typ „VMware zu Azure“ und „HyperV zu Azure“
* Azure Site Recovery-Unterstützung von Verfügbarkeitszonen für Anbieter vom Typ „VMware zu Azure“ und „HyperV zu Azure“
* Azure Site Recovery-Unterstützung von UseManagedDisk für den Anbieter vom Typ „HyperV zu Azure“

#### <a name="azresources"></a>Az.Resources
* Prinzipaltyp für „New-AzRoleAssignment“ und „Set-AzRoleAssignment“ entfernt, da aufgrund der aktuellen Zuordnung bei bestimmten Szenarien ein Fehler auftrat

#### <a name="azsql"></a>Az.Sql
* „MaintenanceConfigurationId“ zu „New-AzSqlDatabase“, „Set-AzSqlDatabase“, „New-AzSqlElasticPool“ und „Set-AzSqlElasticPool“ hinzugefügt
* Regression in „Set-AzSqlServerAudit“ bei Angabe des PredicateExpression-Arguments korrigiert

#### <a name="azstorage"></a>Az.Storage
* Unterstützung von RoutingPreference-Einstellungen beim Erstellen/Aktualisieren von Speicherkonten
    - New-AzStorageAccount
    - Set-AzStorageAccount
* Azure.Storage.Blobs auf 12.8.0 aktualisiert
* Azure.Storage.Files.Shares auf 12.6.0 aktualisiert
* Azure.Storage.Files.DataLake auf 12.6.0 aktualisiert

#### <a name="azwebsites"></a>Az.Websites
* Unterstützung für den Import eines Schlüsseltresorzertifikats zu WebApp hinzugefügt

### <a name="thanks-to-our-community-contributors"></a>Dank an unsere Mitwirkenden in der Community
* @atul-ram, „Set-AzEventHub.md“ aktualisiert (Nr. 13921)
* Christoph Bergmeister [MVP] (@bergmeister), Set-AzDataLakeGen2AclRecursive.md: Tippfehler korrigiert (directiry -> directory) (Nr. 14082)
* Alexander Schmidt (@devdeer-alex), fehlerhafter Link zu Anleitungen für Beiträge korrigiert (Nr. 14009)
* @JiangYuchun, „Get-AzApplicationGatewayAuthenticationCertificate.md“ aktualisiert (Nr. 13972)
* Sebastian Olsen (@Spacebjorn), Beispielbefehl korrigiert (Nr. 13901)

## <a name="540---january-2021"></a>5.4.0: Januar 2021
#### <a name="azaccounts"></a>Az.Accounts
* Anzeige der korrekten Clientanforderungs-ID in Debugmeldung [#13745]
* Allgemeinen Azure PowerShell Ausnahmetyp hinzugefügt
* Speicher-API 2019-06-01 unterstützt

#### <a name="azautomation"></a>Az.Automation
* Problem behoben, das dazu führte, dass die Beschreibung für Updateverwaltungszeitpläne nicht aufgefüllt wurde

#### <a name="azcosmosdb"></a>Az.CosmosDB
* Allgemeine Verfügbarkeit des Moduls „Az.CosmosDB“
* Aktualisierungsaufrufe durch das Cmdlet „New-AzCosmosDBAccount“ für bereits vorhandene Datenbankkonten eingeschränkt
* „AnalyticalStorageTTL“ in „SqlContainer“ eingeführt

#### <a name="aziothub"></a>Az.IotHub
* Regression im Zusammenhang mit der SAS-Tokengenerierung korrigiert

#### <a name="azkeyvault"></a>Az.KeyVault
* Problem im Modul für die Geheimnisverwaltung behoben

#### <a name="azlogicapp"></a>Az.LogicApp
* Problem behoben, das dazu führte, dass von „Get-AzLogicAppTriggerHistory“ und „'Get-AzLogicAppRunAction“ nur die erste Seite mit Ergebnissen abgerufen wurde [#9141]

#### <a name="azmonitor"></a>Az.Monitor
* Cmdlets für Datensammlungsregeln hinzugefügt: 
    - Get-AzDataCollectionRule
    - New-AzDataCollectionRule
    - Set-AzDataCollectionRule
    - Update-AzDataCollectionRule
    - Remove-AzDataCollectionRule
* Cmdlets für Zuordnungen von Datensammlungsregeln hinzugefügt:
...
* Cmdlets aktualisiert, um das Festlegen von „ConnectionMode“ für Verbindungen mit dem Gateway für virtuelle Netzwerke zu ermöglichen:
    - New-AzVirtualNetworkGatewayConnection
    - Set-AzVirtualNetworkGatewayConnection
* Cmdlet „New-AzFirewallPolicyApplicationRule“ aktualisiert:
    - Parameter „TargetUrl“ hinzugefügt
    - Parameter „TerminateTLS“ hinzugefügt
* Neue Cmdlets für Azure Firewall-Premiumfeatures hinzugefügt:
    - New-AzFirewallPolicyIntrusionDetection
    - New-AzFirewallPolicyIntrusionDetectionBypassTraffic
    - New-AzFirewallPolicyIntrusionDetectionSignatureOverride
* Cmdlet „New-AzFirewallPolicy“ aktualisiert:
    - Parameter „-SkuTier“ hinzugefügt
    - Parameter „-Identity“ hinzugefügt
    - Parameter „-UserAssignedIdentityId“ hinzugefügt
    - Parameter „-IntrusionDetection“ hinzugefügt
    - Parameter „-TransportSecurityName“ hinzugefügt
    - Parameter „-TransportSecurityKeyVaultSecretId“ hinzugefügt
* Neues Cmdlet zum Abrufen von IKE-Sicherheitszuordnungen für Verbindungen mit dem Gateway für virtuelle Netzwerke hinzugefügt:
    - Get-AzVirtualNetworkGatewayConnectionIkeSa
* Unterstützung mehrerer Authentifizierungen für „p2sVpnGateway“ hinzugefügt
    - „New-AzVpnServerConfiguration“ und „Update-AzVpnServerConfiguration“ aktualisiert, um das Festlegen mehrerer Authentifizierungsparameter zu ermöglichen
* Cmdlets „New-AzVpnGateway“ und „New-AzP2sVpnGateway“ aktualisiert:
    - Parameter „EnableRoutingPreferenceInternetFlag“ hinzugefügt

#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* Feature für regionsübergreifende Wiederherstellung hinzugefügt  
* Abrufen der Workloadkonfiguration blockiert, wenn es sich beim Zielelement um eine Verfügbarkeitsgruppe handelt

#### <a name="azresources"></a>Az.Resources
* Unterstützung des Parameters „-QueryString“ in Cmdlets vom Typ „New-Az*Deployments“ hinzugefügt

#### <a name="azsql"></a>Az.Sql
* Cmdlet „Start-AzSqlInstanceDatabaseLogReplay“ nun synchron, und Flag „-AsJob“ hinzugefügt

#### <a name="azstorage"></a>Az.Storage
* Folgendes Problem behoben: „ContinuationToken“ beim Auflisten von Blob mit „-IncludeVersion“ nie NULL
    - „Get-AzStorageBlob“

#### <a name="azwebsites"></a>Az.Websites
* Unterstützung für von App Service verwaltete Zertifikate hinzugefügt
...
### <a name="thanks-to-our-community-contributors"></a>Dank an unsere Mitwirkenden in der Community
* Ivan Akcheurov (@ivanakcheurov), Aktualisierung von „Set-AzSecurityWorkspaceSetting.md“ (#13877)
* @javiermarasco, Beispielaktualisierung (#13837)
* @jhaprakash26, Aktualisierung von „Set-AzVirtualNetwork.md“ (#13857)
* Michael Holmes (@MichaelHolmesWP), Aktualisierung von „New-AzStorageTableStoredAccessPolicy.md“ (#13871)
* Michael James (@mikejwhat), Ermöglichung der Rückgabe von mehr als 30 Ergebnissen mit „Get-AzLogicAppTriggerHistory“ und „Get-AzLogicAppRunAction“ (#13846)
* @Willem-J-an, Behebung eines Fehlers, der dazu führte, dass das Docker-Kennwort in „Set-AzWebApp(Slot)“ aus „appsettings“ entfernt wird (#13866)

## <a name="530---december-2020"></a>5.3.0: Dezember 2020
#### <a name="azaccounts"></a>Az.Accounts
* Problem der Nichtbeachtung des HTTP-Proxys in Windows PowerShell behoben [#13647]
* Debugprotokoll von zeitintensiven Vorgängen in generierten Modulen verbessert

#### <a name="azautomation"></a>Az.Automation
* Problem behoben, durch das Parameter von „Start-AzAutomationRunbook“ eine umschlossene PSObject-Zeichenfolge nicht in eine JSON-Zeichenfolge konvertieren können [#13240]
* Speicherortvervollständigung für das Cmdlet „New-AzAutomationUpdateManagementAzureQuery“ korrigiert

#### <a name="azcompute"></a>Az.Compute
* Neuen Parameter „VM“ im neuen Parametersatz „VMParameterSet“ zu den Cmdlets „Get-AzVMDscExtensionStatus“ und „Get-AzVMDscExtension“ hinzugefügt 

#### <a name="azdatabricks"></a>Az.Databricks
* Problem behoben, das dazu führen kann, dass „New-AzDatabricksVNetPeering“ vor der vollständigen Bereitstellung zurückgegeben wird (https://github.com/Azure/autorest.powershell/issues/610)

#### <a name="azdatafactory"></a>Az.DataFactory
* Befehl „Invoke-AzDataFactoryV2Pipeline“ für das Problem mit „Invoke-AzDataFactoryV2Pipeline“ korrigiert

#### <a name="azdesktopvirtualization"></a>Az.DesktopVirtualization
* Eigenschaft „StartVMOnConnect“ zum Hostpool hinzugefügt

#### <a name="azhdinsight"></a>Az.HDInsight
* Hinzugefügte Eigenschaften: „Fqdn“ und „EffectiveDiskEncryptionKeyUrl“ in der AzureHDInsightHostInfo-Klasse

#### <a name="azkeyvault"></a>Az.KeyVault
* Neuen Parameter „-AsPlainText“ zu „Get-AzKeyVaultSecret“ hinzugefügt, um das Geheimnis direkt im Nur-Text-Format zurückzugeben [#13630]
* Unterstützung für die selektive Wiederherstellung eines Schlüssels aus einer verwalteten vollständigen HSM-Sicherung [#13526]
* Einige kleinere Probleme behoben [#13583] [#13584]
* Fehlende Rückgabeobjekte von „Get-Secret“ im Modul „SecretManagement“ hinzugefügt
* Problem behoben, das dazu führen kann, dass der Tresor ohne Standardzugriffsrichtlinie erstellt wird [#13687]

#### <a name="azkusto"></a>Az.Kusto
* Die API-Version wurde auf 2020-09-18 aktualisiert.

#### <a name="aznetwork"></a>Az.Network
* Problem im Cmdlet zum Entfernen eines Peerings und einer Verbindung für das ExpressRouteCircuit-Szenario behoben
    - „Remove-AzExpressRouteCircuitPeeringConfig“ und „Remove-AzExpressRouteCircuitConnectionConfig“

#### <a name="azpolicyinsights"></a>Az.PolicyInsights
* Unterstützung für das Zurückgeben von paginierten Ergebnissen für „Get-AzPolicyState“ hinzugefügt

#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* Feature zum vorläufigen Löschen für SQL aktiviert
* Fehler beim Wiederherstellen einer SQL-Verfügbarkeitsgruppe behoben und Prüfung des Containernamens entfernt
* Format des Containernamens für Azure Files-Sicherungselement geändert
* Unterstützung für das CMK-Feature für Recovery Services-Tresor hinzugefügt

#### <a name="azresources"></a>Az.Resources
* NullRef-Ausnahme in „New-AzureManagedApplication“ und „Set-AzureManagedApplication“ behoben
* Azure Resource Manager SDK zur Verwendung der aktuellen allgemein verfügbaren DeploymentScripts-API-Version aktualisiert: 2020-10-01

#### <a name="azservicefabric"></a>Az.ServiceFabric
* „Add-AzServiceFabricNodeType“ korrigiert Knotentyp vor dem Erstellen einer VM-Skalierungsgruppe zum Service Fabric-Cluster hinzugefügt

#### <a name="azsql"></a>Az.Sql
* Parameterbeschreibung für den Befehl „InstanceFailoverGroup“ korrigiert
* Logik aktualisiert, in der „schemaName“, „tableName“ und „columnName“ aus der ID von SQL-Datenklassifizierungsbefehlen extrahiert werden
* Felder „Status“ und „StatusMessage“ in „Get-AzSqlDatabaseImportExportStatus“ entsprechend der Dokumentation korrigiert
* Überwachungs-Cmdlets für Microsoft-Supportvorgänge (DevOps) hinzugefügt: Get-AzSqlServerMSSupportAudit, Set-AzSqlServerMSSupportAudit, Remove-AzSqlServerMSSupportAudit

#### <a name="azstorage"></a>Az.Storage
* Unterstützung für das Erstellen, Aktualisieren, Abrufen und Auflisten des Verschlüsselungsbereichs eines Speicherkontos
    - New-AzStorageEncryptionScope
    - Update-AzStorageEncryptionScope
    - Get-AzStorageEncryptionScope
* Unterstützung für das Erstellen von Containern und Hochladen von Blobs mit Einstellung für den Verschlüsselungsbereich
    - New-AzRmStorageContainer
    - New-AzStorageContainer
    - „Set-AzStorageBlobContent“

### <a name="thanks-to-our-community-contributors"></a>Dank an unsere Mitwirkenden in der Community
* Andreas Wolter (@AndreasWolter): Marketingsprache entfernt, besserer Beispielfilter (#13671)
* Tidjani Belmansour (@BelRarr): Aktualisierung von „Get-AzBillingInvoice.md“ (#13634)
* David Klempfner (@DavidKlempfner):
  * Rechtschreibfehler korrigiert (#13677)
  * Aktualisierung von „PSMetricNoDetails.cs“ (#13676)
* @kilobyte97: Fehlerbehebung für das Remove-Cmdlet zum Löschen der Konfiguration (#13655)
* @kongou-ae: Aktualisierung von „Set-AzFirewall.md“ (#13727)
* @MasterKuat: Vertauschen von Titel und Code in der Dokumentation korrigiert (#13666)
* NickT (@nukeulis): Aktualisierung von „Set-AzContext.md“ (#13702)
* @PaulHCode: Aktualisierung von „Start-AzJitNetworkAccessPolicy.md“ – Beispiel zur Anzeige des richtigen Cmdlets korrigiert (#13713)
* Ryan Borstelmann (@ryanborMSFT): Abonnement-ID entfernt (#13715)
* Shashikant Shakya (@shshakya): Aktualisierung von „Set-AzSqlDatabase.md“ (#13674)
* Sebastian Olsen (@Spacebjorn): Aktualisierung von „Get-AzRecoveryServicesBackupItem.md“ (#13719)

## <a name="520---december-2020"></a>5.2.0: Dezember 2020
#### <a name="azaccounts"></a>Az.Accounts
* Die Zeitangabe „ExpiresOn“ kann nun über das unformatierte Token analysiert werden, wenn sie nicht über die zugrunde liegende Bibliothek abgerufen werden kann.
* Verbesserte Warnmeldung, wenn die interaktive Authentifizierung nicht verfügbar ist

#### <a name="azapimanagement"></a>Az.ApiManagement
* [Breaking Change] Bei „New-AzApiManagementProduct“ gilt standardmäßig kein Grenzwert für Abonnements.

#### <a name="azcompute"></a>Az.Compute
* „Get-AzVm“ wurde bearbeitet, um nach „-Name“ zu filtern, bevor die Drosselung aufgrund zu vieler Ressourcen überprüft wird. 
* Neues Cmdlet „Start-AzVmssRollingExtensionUpgrade“

#### <a name="azcontainerregistry"></a>Az.ContainerRegistry
* Unterstützter Parameter „Name“ und Wert aus Pipelineeingabe für „Get-AzContainerRegistryUsage“ [Nr. 13605]
* Verbesserte Ausnahmen für „Connect-AzContainerRegistry“

#### <a name="azdatafactory"></a>Az.DataFactory
* Version des ADF .NET SDK auf 4.13.0 aktualisiert

#### <a name="azhealthcareapis"></a>Az.HealthcareApis
* Unterstützung für kundenseitig verwaltete Schlüssel hinzugefügt

#### <a name="aziothub"></a>Az.IotHub
* Problem mit dem SAS-Token behoben

#### <a name="azkeyvault"></a>Az.KeyVault
* Beim Festlegen von Zugriffsrichtlinien für den Schlüsseltresor wird „all“ als Option unterstützt.
* Unterstützte neue Version des SecretManagement-Moduls [Nr. 13366]
* ByteArray, String, PSCredential und Hashtable für „SecretValue“ in SecretManagementModule unterstützt [Nr. 12190]
* [Breaking change] API-Oberfläche von Cmdlets in Bezug auf verwaltetes HSM neu gestaltet

#### <a name="azmonitor"></a>Az.Monitor
* Parameter „Rule“ von „New-AzAutoscaleProfile“ geändert, um eine leere Liste zu akzeptieren [Nr. 12903]
* Neue Cmdlets hinzugefügt, um das Erstellen von Diagnoseeinstellungen flexibler zu gestalten:
    * Get-AzDiagnosticSettingCategory
    * New-AzDiagnosticSetting
    * New-AzDiagnosticDetailSetting

#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* Text- und Parametersatzname für Cmdlet „Restore-AzRecoveryServicesBackupItem“ geändert

#### <a name="azresources"></a>Az.Resources
* Unterstützung für den Parameter „-Tag“ für „Set-AzTemplateSpec“ und „New-AzTemplateSpec“ hinzugefügt
* Unterstützung für die Taganzeige zum Standardformatierer für Vorlagenspezifikationen hinzugefügt 

#### <a name="azservicefabric"></a>Az.ServiceFabric
* Beispiel zu „Set-AzServiceFabricSetting“ mit Parameter „SettingsSectionDescription“ hinzugefügt
* Anwendungsbezogene Cmdlets aktualisiert, um hervorzuheben, dass die Unterstützung nur für per ARM bereitgestellte Ressourcen gilt
* Cmdlets „Add-AzureRmServiceFabricClusterCertificate“ und „Remove-AzureRmServiceFabricClusterCertificate“ für die Clusterzertifizierung als veraltet markiert

#### <a name="azsql"></a>Az.Sql
* SecondaryType zu Folgendem hinzugefügt: 
    - New-AzSqlDatabase
    - Set-AzSqlDatabase
    - New-AzSqlDatabaseSecondary
* HighAvailabilityReplicaCount zu Folgendem hinzugefügt: 
    - New-AzSqlDatabase
    - Set-AzSqlDatabase
* ReadReplicaCount als Alias von HighAvailabilityReplicaCount in folgenden Cmdlets festgelegt: 
    - New-AzSqlDatabase
    - Set-AzSqlDatabase

#### <a name="azstorage"></a>Az.Storage
* Unterstützte Größe für den Azure-Dateiupload: bis zu 4 TiB
    - „Set-AzStorageFileContent“
* Azure.Storage.Blobs auf 12.7.0 aktualisiert
* Azure.Storage.Files.Shares auf 12.5.0 aktualisiert
* Azure.Storage.Files.DataLake auf 12.5.0 aktualisiert

#### <a name="azstoragesync"></a>Az.StorageSync
* Feature für die Synchronisierung der Tiering-Richtlinie mit Downloadrichtlinie und lokalem Cachemodus hinzugefügt

#### <a name="azwebsites"></a>Az.Websites
* Vermeiden von doppelten Zugriffseinschränkungsregeln

### <a name="thanks-to-our-community-contributors"></a>Dank an unsere Mitwirkenden in der Community
* Andrew Dawson (@dawsonar802): „Get-AzKeyVaultCertificate.md“ aktualisiert – Abrufen des Zertifikats und Speichern als PFX-Abschnitt für die Verwendung mit PowerShell Core (Nr. 13557)
* @iviark, Updates für die APIs für das Gesundheitswesen (Powershell BYOK) (Nr. 13518)
* John Duckmanton (@johnduckmanton), Schreibweise von TagPatchOperation korrigiert (Nr. 13508)
* Michael James (@mikejwhat)
  * Hilfe zu „Get-AzLogicAppRunHistory“ bereinigt (Nr. 13513)
* Richard de Zwart (@mountain65)
  * „Update-AzAppConfigurationStore.md“ aktualisiert (Nr. 13485)
  * „New-AzCosmosDBAccount.md“ aktualisiert (Nr. 13490)
* @SteppingRazor, New-AzApiManagementProduct: Parameterstandardwert für „Change SubscriptionsLimit“ in „None“ geändert (Nr. 13457)
* Steve Burkett (@SteveBurkettNZ), Tippfehler für Parameter „WorkspaceResourceId“ im Beispiel korrigiert (Nr. 13589)

## <a name="510---november-2020"></a>5.1.0: November 2020
#### <a name="azaccounts"></a>Az.Accounts
* Problem behoben, das dazu führte, dass TenantId bei Verwendung von „Connect-AzAccount -DeviceCode“ unter Umständen nicht berücksichtigt wurde [Nr. 13477]
* Neues Cmdlet „Get-AzAccessToken“ hinzugefügt
* Problem behoben, das zu einem Fehler führte, wenn nicht auf den Benutzerprofilpfad zugegriffen werden konnte
* Problem behoben, das beim Ausführen von „Connect-AzAccount“ zu einem Fehler vom Typ „Write-Object“ führte [Nr. 13419]
* Parameter „ContainerRegistryEndpointSuffix“ hinzugefügt zu: Add-AzEnvironment, Set-AzEnvironment 
* Unterstützung für das Unterbrechen der Anmeldung durch Drücken von <kbd>STRG</kbd>+<kbd>C</kbd>
* Problem behoben, das dazu führte, dass „Connect-AzAccount -KeyVaultAccessToken“ nicht funktioniert [Nr. 13127]
* Nullverweis und Nichtbeachtung von Groß-/Kleinschreibung der Methode „Invoke-AzRestMethod“ korrigiert

#### <a name="azaks"></a>Az.Aks
* Problem behoben, aufgrund dessen Benutzer keinen Dienstprinzipal zum Erstellen eines neuen Kubernetes-Clusters verwenden konnten [Nr. 13012]

#### <a name="azappconfiguration"></a>Az.AppConfiguration
* Allgemeine Verfügbarkeit des Moduls „Az.AppConfiguration“

#### <a name="azdatafactory"></a>Az.DataFactory
* Verbesserte Fehlermeldung des Befehls „New-AzDataFactoryV2LinkedServiceEncryptedCredential“

#### <a name="azdatalakestore"></a>Az.DataLakeStore
* ADLS Dataplane SDK auf 1.2.4-alpha aktualisiert Änderungen: https://github.com/Azure/azure-data-lake-store-net/blob/preview-alpha/CHANGELOG.md#version-124-alpha

#### <a name="azdesktopvirtualization"></a>Az.DesktopVirtualization
* Neue MSIX-Paket-Cmdlets hinzugefügt und Anwendungs-Cmdlets aktualisiert

#### <a name="azeventhub"></a>Az.EventHub
* Clusterbefehle für EventHub-Cluster ohne Tags korrigiert
* Hilfetext für PartnerNamespace der AzEventHubGeoDRConfiguration-Befehle aktualisiert 

#### <a name="azhdinsight"></a>Az.HDInsight
* Parameter „ResourceProviderConnection“ und „PrivateLink“ zum Cmdlet „New-AzHDInsightCluster“ hinzugefügt, um ausgehende Relayverbindungen und das Feature für private Verbindungen zu unterstützen
* Parameter „AmbariDatabase“ zum Cmdlet „New-AzHDInsightCluster“ hinzugefügt, um das Feature für benutzerdefinierte Ambari-Datenbanken zu unterstützen
* Akzeptierter Wert „AmbariDatabase“ zum Parameter „MetastoreType“ des Cmdlets „Add-AzHDInsightMetastore“ hinzugefügt

#### <a name="aziothub"></a>Az.IotHub
* Zulässige Tags im Cmdlet „az iot hub create“

#### <a name="azkeyvault"></a>Az.KeyVault
* Unterstützung für die Aktualisierung des Key Vault-Tags

#### <a name="azlogicapp"></a>Az.LogicApp
* „Get-AzLogicAppRunHistory“ korrigiert, sodass nicht mehr nur die erste Seite mit Ergebnissen abgerufen wird

#### <a name="aznetwork"></a>Az.Network
* Folgende Cmdlets wurden aktualisiert: 
    - „New-AzLoadBalancerFrontendIpConfigCommand“, „Set-AzLoadBalancerFrontendIpConfigCommand“, „Add-AzLoadBalancerFrontendIpConfigCommand“:
        - Eigenschaft „PublicIpAddressPrefix“ hinzugefügt
        - Eigenschaft „PublicIpAddressPrefixId“ hinzugefügt
* Neue Eigenschaften zu den folgenden Cmdlets hinzugefügt, um den globalen Lastenausgleich zu ermöglichen
    - „New-AzLoadBalancer“:
        - Eigenschaft für SKU-Tarif hinzugefügt
    - „New-AzPuplicIpAddress“:
        - Eigenschaft für SKU-Tarif hinzugefügt
    - „New-AzPublicIpPrefix“:
        - Eigenschaft für SKU-Tarif hinzugefügt
    - „New-AzLoadBalancerBackendAddressConfig“:
        - Eigenschaft „LoadBalancerFrontendIPConfigurationId“ hinzugefügt
* Planung zur Einstellung von Warnungen für die folgenden Cmdlets aktualisiert: New-AzVirtualHubRoute, New-AzVirtualHubRouteTable, Add-AzVirtualHubRoute, Add-AzVirtualHubRouteTable, Get-AzVirtualHubRouteTable, Remove-AzVirtualHubRouteTable
* Planung zur Einstellung von Warnungen für das Argument „RouteTable“ für die folgenden Cmdlets aktualisiert: New-AzVirtualHub, Set-AzVirtualHub, Update-AzVirtualHub
* Argumente „-MinScaleUnits“ and „-MaxScaleUnits“ in „Set-AzExpressRouteGateway“ als optional festgelegt
* Neue Cmdlets zur Unterstützung der gegenseitigen Authentifizierung und von SSL-Profilen in Application Gateway hinzugefügt
...
#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* Angabe der Richtliniensicherungszeit in UTC
* Breaking Change-Warnung im Cmdlet „Get-AzRecoveryServicesBackupJobDetails“ geändert
* Hilfetext des Beispielskripts für das Cmdlet „Set-AzRecoveryServicesBackupProtectionPolicy“ aktualisiert

#### <a name="azresources"></a>Az.Resources
* Problem behoben, aufgrund dessen bei Verwendung von „Was-wäre-wenn“ zwei Ressourcengruppenbereiche mit unterschiedlicher Groß-/Kleinschreibung angezeigt wurden
* „Export-AzResourceGroup“ zur Verwendung des SDK aktualisiert
* Kulturinformationen zu Parse-Methoden hinzugefügt

#### <a name="azsql"></a>Az.Sql
* Probleme behoben, die dazu führten, dass „Set-AzSqlDatabaseAudit“ die Hyperscale-Datenbank nicht unterstützt hat und die Datenbankedition nicht bestimmt werden konnte
* „MaintenanceConfigurationId“ zu „New-AzSqlInstance“ und „Set-AzSqlInstance“ hinzugefügt
* Problem in „GetAzureSqlDatabaseReplicationLink.cs“ behoben, aufgrund dessen der Parameter „PartnerServerName“ anhand des Werts und nicht anhand des Schlüssels überprüft wurde

#### <a name="azwebsites"></a>Az.Websites
* Unterstützung für neue Features für die Zugriffseinschränkung hinzugefügt ServiceTag, multi-ip und http-headers

### <a name="thanks-to-our-community-contributors"></a>Dank an unsere Mitwirkenden in der Community
* John Q. Martin (@johnmart82): Informationen zu Firewallanforderungen hinzugefügt (Nr. 13385)
* Manikandan Duraisamy (@madurais-msft): Argument „PublicSubnetName“ korrigiert (Nr. 13417)
* @mahortas: Parameterwerte für „-HostNames“ aktualisiert (Nr. 13349)
* @MariachiForHire: Unterstützte TrafficAnalyticsInterval-Werte hinzugefügt (Nr. 13304)
* Michael James (@mikejwhat): Zulassen, dass von „Get-AzLogicAppRunHistory“ mehr als 30 Einträge zurückgegeben werden können (Nr. 13393)
* Shashikant Shakya (@shshakya): „Restore-AzSqlInstanceDatabase.md“ aktualisiert (Nr. 13404)

## <a name="500---october-2020"></a>5.0.0: Oktober 2020
#### <a name="azaccounts"></a>Az.Accounts
* [Breaking Change] „Get-AzProfile“ und „Select-AzProfile“ entfernt
* Azure Directory Authentication Library durch Microsoft Authentication Library (MSAL) ersetzt

#### <a name="azaks"></a>Az.Aks
* [Breaking Change] Parameteralias „ClientIdAndSecret“ in „New-AzAksCluster“ und „Set-AzAksCluster“ entfernt.
* [Breaking Change] Standardwert von „NodeVmSetType“ in „New-AzAksCluster“ von „AvailabilitySet“ in „VirtualMachineScaleSets“ geändert.
* [Breaking Change] Standardwert von „NetworkPlugin“ in „New-AzAksCluster“ von „None“ in „azure“ geändert.
* [Breaking Change] Parameter „NodeOsType“ in „New-AzAksCluster“ entfernt, da er nur einen Wert unterstützt (Linux).

#### <a name="azbilling"></a>Az.Billing
* Cmdlet „Get-AzBillingAccount“ hinzugefügt
* Cmdlet „Get-AzBillingProfile“ hinzugefügt
* Cmdlet „Get-AzInvoiceSection“ hinzugefügt
* Neue Parameter im Cmdlet „Get-AzBillingInvoice“ hinzugefügt
* Eigenschaften „DownloadUrlExpiry“, „Type“ und „BillingPeriodNames“ aus der Antwort des Cmdlets „Get-AzBillingInvoice“ entfernt

#### <a name="azcdn"></a>Az.Cdn
* Cmdlets zur Unterstützung der Funktionen für mehrere Ursprünge und private Verbindung hinzugefügt 

#### <a name="azcognitiveservices"></a>Az.CognitiveServices
* SDK auf 7.4.0-preview aktualisiert.

#### <a name="azcompute"></a>Az.Compute
* Parameter „-VmssId“ zu „New-AzVm“ hinzugefügt
* Parameter „PlatformFaultDomainCount“ dem Cmdlet „New-AzVmss“ hinzugefügt.
* Neues Cmdlet „Get-AzDiskEncryptionSetAssociatedResource“
* Optionale Parameter „Tier“ und „LogicalSectorSize“ dem Cmdlet „New-AzDiskConfig“ hinzugefügt. 
...
#### <a name="azdatabricks"></a>Az.Databricks
* Es wurde ein Problem behoben, bei dem es beim Aktualisieren des Databricks-Arbeitsbereichs `-EncryptionKeyVersion` zu einem Fehler kommen konnte.

#### <a name="azdatafactory"></a>Az.DataFactory
* Version des ADF .NET SDK auf 4.12.0 aktualisiert
* Version des SDK für den ADF-Verschlüsselungsclient auf 4.14.7587.7 aktualisiert
* Befehle „Stop-AzDataFactoryV2TriggerRun“ und „Invoke-AzDataFactoryV2TriggerRun“ hinzugefügt

#### <a name="azdesktopvirtualization"></a>Az.DesktopVirtualization
* Verwendung der „Location“-Eigenschaft für die Erstellung von ARM-Objekten der obersten Ebene obligatorisch gemacht.
        * `ApplicationGroupType` für `New-AzWvdApplicationGroup` obligatorisch gemacht.
        * `HostPoolArmPath` für `New-AzWvdApplicationGroup` obligatorisch gemacht.
        * `PreferredAppGroupType` für `New-AzWvdHostPool` hinzugefügt.

#### <a name="azfunctions"></a>Az.Functions
* [Breaking Change] Switch-Parameter „IncludeSlot“ aus allen Parametersätzen von „Get-AzFunctionApp“ entfernt (bis auf einen). Das Cmdlet unterstützt jetzt das Abrufen von Bereitstellungsslots in den Ergebnissen, wenn „-IncludeSlot“ angegeben ist. 
* „New-AzFunctionApp“ aktualisiert:
  - „-DisableApplicationInsights“ korrigiert, damit bei Angabe dieser Option kein Application Insights-Projekt erstellt wird. [#12728]
  - [Breaking Change] Unterstützung für die Erstellung von PowerShell 6.2-Funktions-Apps entfernt.
  - [Breaking Change] Es wurde festgelegt, dass in Functions-Version 3 von Windows für PowerShell-Funktions-Apps anstelle der Runtime-Standardversion 6.2 die Version 7.0 verwendet wird, wenn der Parameter „RuntimeVersion“ nicht angegeben ist.
  - [Breaking Change] Es wurde festgelegt, dass in Functions-Version 3 von Windows/Linux für Node-Funktions-Apps anstelle der Runtime-Standardversion 10 die Version 12 verwendet wird, wenn der Parameter „RuntimeVersion“ nicht angegeben ist.
  - [Breaking Change] Es wurde festgelegt, dass in Functions-Version 3 von Linux für Python-Funktions-Apps anstelle der Runtime-Standardversion 3.7 die Version 3.8 verwendet wird, wenn der Parameter „RuntimeVersion“ nicht angegeben ist.

#### <a name="azhdinsight"></a>Az.HDInsight
 * Für das Cmdlet „New-AzHDInsightCluster“:
     - Parameter „DefaultStorageAccountName“ durch „StorageAccountResourceId“ ersetzt
     - Parameter „DefaultStorageAccountKey“ durch „StorageAccountKey“ ersetzt
     - Parameter „DefaultStorageAccountType“ durch „StorageAccountType“ ersetzt
     - Parameter „PublicNetworkAccessType“ entfernt
     - Parameter „OutboundPublicNetworkAccessType“ entfernt
     - Neue Parameter hinzugefügt: „StorageFileSystem“ und „StorageAccountManagedIdentity“ zur Unterstützung von ADLSGen2
     - Neuen Parameter „EnableIDBroker“ zur Unterstützung des HDInsight-Identitätsbrokers hinzugefügt
     - Neue Parameter hinzugefügt: „KafkaClientGroupId“, „KafkaClientGroupName“ und „KafkaManagementNodeSize“ zur Unterstützung des Kafka-REST-Proxys
 * Für das Cmdlet „New-AzHDInsightClusterConfig“:
     - Parameter „DefaultStorageAccountName“ durch „StorageAccountResourceId“ ersetzt
     - Parameter „DefaultStorageAccountKey“ durch „StorageAccountKey“ ersetzt
     - Parameter „DefaultStorageAccountType“ durch „StorageAccountType“ ersetzt
     - Parameter „PublicNetworkAccessType“ entfernt
     - Parameter „OutboundPublicNetworkAccessType“ entfernt
* Für das Cmdlet „Set-AzHDInsightDefaultStorage“:
    - Parameter „StorageAccountName“ durch „StorageAccountResourceId“ ersetzt
* Für das Cmdlet „Add-AzHDInsightSecurityProfile“:
    - Parameter „Domain“ durch „DomainResourceId“ ersetzt
    - Obligatorische Verwendung für Parameter „OrganizationalUnitDN“ entfernt

#### <a name="azkeyvault"></a>Az.KeyVault
* [Breaking Change] Parameter „DisableSoftDelete“ in „New-AzKeyVault“ und „EnableSoftDelete“ in „Update-AzKeyVault“ als veraltet eingestuft
* [Breaking Change] Attribut „SecretValueText“ entfernt, um das direkte Anzeigen von „SecretValue“ zu vermeiden [#12266]
* Unterstützter neuer Ressourcentyp: Verwaltetes HSM
    - CRUD für Verwaltetes HSM und Cmdlets zur Nutzung von Schlüsseln für Verwaltetes HSM
    - Vollständige HSM-Sicherung/-Wiederherstellung, AES-Schlüsselerstellung, Sicherung/Wiederherstellung für Sicherheitsdomäne, RBAC

#### <a name="azmanagedservices"></a>Az.ManagedServices
* [Breaking Change] Namenskonventionen für Parameter und zugehörige Beispiele aktualisiert

#### <a name="aznetwork"></a>Az.Network
* [Breaking Change] Parameter „HostedSubnet“ entfernt und stattdessen „Subnet“ hinzugefügt
* Neue Cmdlets für Peerrouten des virtuellen Routers hinzugefügt
    - „Get-AzVirtualRouterPeerLearnedRoute“
    - „Get-AzVirtualRouterPeerAdvertisedRoute“
* New-AzFirewall-Cmdlet aktualisiert:
    - Parameter „-SkuTier“ hinzugefügt
    - Parameter „-SkuName“ hinzugefügt und „Sku“ als Alias festgelegt
    - Parameter „-Sku“ entfernt
* [Breaking Change] Argument „Connectionlink“ in „Start-AzVpnConnectionPacketCapture“ und „Stop-AzVpnConnectionPacketCapture“ als obligatorisch festgelegt
* [Breaking Change] „New-AzNetworkWatcherConnectionMonitorEndPointObject“ aktualisiert, um Parameter „-Filter“ zu entfernen
* [Breaking Change] Cmdlet „New-AzNetworkWatcherConnectionMonitorEndpointFilterItemObject“ durch „New-AzNetworkWatcherConnectionMonitorEndpointScopeItemObject“ ersetzt
* Cmdlet „New-AzNetworkWatcherConnectionMonitorEndPointObject“ aktualisiert:
    - Parameter „-Type“ hinzugefügt
    - Parameter „-CoverageLevel“ hinzugefügt
    - Parameter „-Scope“ hinzugefügt
* Cmdlet „New-AzNetworkWatcherConnectionMonitorProtocolConfigurationObject“ mit neuem Parameter „-DestinationPortBehavior“ aktualisiert

#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* Workloadwiederherstellung für „Mitwirkender“-Berechtigungen korrigiert.
* Neue Parametersätze und Validierungen für das Cmdlet „Restore-AzRecoveryServicesBackupItem“ hinzugefügt.

#### <a name="azresources"></a>Az.Resources
* Analysefehler korrigiert
* What-If-Cmdlets der ARM-Vorlage aktualisiert, um die Vorschaunachricht aus den Ergebnissen zu entfernen
* Problem behoben, bei dem es für Cmdlets für die Bereitstellung zu einem Absturz gekommen ist, wenn für „-WhatIf“ ein höherer Umfang festgelegt wurde [#13038]
* Problem behoben, bei dem bei Cmdlets für die Vorlagenbereitstellung die Groß-/Kleinschreibung für Vorlagenparameter nicht beibehalten wurde
* API-Standardversion für die Verwendung im Cmdlet „Export-AzResourceGroup“ hinzugefügt
* Cmdlets für Vorlagenspezifikationen hinzugefügt („Get-AzTemplateSpec“, „Set-AzTemplateSpec“, „New-AzTemplateSpec“, „Remove-AzTemplateSpec“, „Export-AzTemplateSpec“)
* Unterstützung für die Bereitstellung von Vorlagenspezifikationen mit vorhandenen Bereitstellungs-Cmdlets hinzugefügt (mit dem neuen Parameter „-TemplateSpecId“) 
* „Get-AzResourceGroupDeploymentOperation“ für die Verwendung des SDK aktualisiert
* Parameter „-ApiVersion“ aus „*-AzDeployment“-Cmdlets entfernt.

#### <a name="azsql"></a>Az.Sql
* Problem behoben, bei dem für „New-AzSqlDatabaseExport“ ein Fehler aufgetreten, wenn „networkIsolation“ nicht angegeben ist [#13097]
* Problem behoben, bei dem von „New-AzSqlDatabaseExport“ und „New-AzSqlDatabaseImport“ im Ergebnisobjekt nicht „OperationStatusLink“ zurückgegeben wurde [#13097]
* URL für Azure-Regionspaare in Sicherungsspeicher-Redundanzwarnungen aktualisiert 

#### <a name="azstorage"></a>Az.Storage
* Veraltete Eigenschaft „RestorePolicy.LastEnabledTime“ entfernt
    - „Enable-AzStorageBlobRestorePolicy“
    - „Disable-AzStorageBlobRestorePolicy“
    - „Get-AzStorageBlobServiceProperty“
    - „Update-AzStorageBlobServiceProperty“
* Änderung des Typs von „DaysAfterModificationGreaterThan“ von „int“ in „int?“
    - „Set-AzStorageAccountManagementPolicy“
    - „Get-AzStorageAccountManagementPolicy“
    - „Add-AzStorageAccountManagementPolicyAction“
    - „New-AzStorageAccountManagementPolicyRule“
* Unterstützung für Erstellung/Aktualisierung der Dateifreigabe mit Zugriffsebene
    - „New-AzRmStorageShare“
    - „Update-AzRmStorageShare“
* Unterstützung für rekursives Festlegen/Aktualisieren/Entfernen der ACL in Data Lake Gen2-Element 
    -  „Set-AzDataLakeGen2AclRecursive“ 
    -  „Update-AzDataLakeGen2AclRecursive“ 
    -  „Remove-AzDataLakeGen2AclRecursive“
* Unterstützung für Containerzugriffsrichtlinie mit neuer Berechtigung „x,t“
    -  „New-AzStorageContainerStoredAccessPolicy“
    -  „Set-AzStorageContainerStoredAccessPolicy“
* Ausgabe des Cmdlets zum Abrufen/Festlegen der Containerzugriffsrichtlinie durch Änderung des Berechtigungstyps der untergeordneten Eigenschaft von „enum“ in „String“
    -  „Get-AzStorageContainerStoredAccessPolicy“
    -  „Set-AzStorageContainerStoredAccessPolicy“
* Problem mit Beispielskript beim Festlegen der Verwaltungsrichtlinie mit JSON behoben
    -  „Set-AzStorageAccountManagementPolicy“

#### <a name="azwebsites"></a>Az.Websites
* Unterstützung für den Tarif „Premium V3“ hinzugefügt
* WebSites SDK auf 3.1.0 aktualisiert

### <a name="thanks-to-our-community-contributors"></a>Dank an unsere Mitwirkenden in der Community
* @atul-ram: „Get-AzDelegation.md“ aktualisiert (#13176)
* @dineshreddy007: Richtige Zuweisung der App-Rollen bei Stack HCI-Registrierung per WAC-Token. (#13249)
* @kongou-ae: „New-AzOffice365PolicyProperty.md“ aktualisiert (#13217)
* Lohith Chowdary Chilukuri (@Lochiluk): „Set-AzApplicationGateway.md“ aktualisiert (#13150)
* Matthew Burleigh (@mburleigh)
  * Links zu PowerShell-Cmdlets hinzugefügt, auf die im Dokument verwiesen wird (#13203)
  * Links zu PowerShell-Cmdlets hinzugefügt, auf die im Dokument verwiesen wird (#13190)
  * Links zu PowerShell-Cmdlets hinzugefügt, auf die im Dokument verwiesen wird (#13189)
  * Links zu Cmdlets hinzugefügt, auf die verwiesen wird (#13137)
  * Links zu PowerShell-Cmdlets hinzugefügt, auf die im Dokument verwiesen wird (#13204)
  * Links zu PowerShell-Cmdlets hinzugefügt, auf die im Dokument verwiesen wird (#13205)

## <a name="480---october-2020"></a>4.8.0: Oktober 2020
#### <a name="azaccounts"></a>Az.Accounts
* Ein Problem bei der DateTime-Analyse in allgemeinen Bibliotheken wurde behoben [#13045].

#### <a name="azcognitiveservices"></a>Az.CognitiveServices
* Das Cmdlet „New-AzCognitiveServicesAccountApiProperty“ wurde hinzugefügt.
* Der Parameter „ApiProperty“ für „New-AzCognitiveServicesAccount“ und „Set-AzCognitiveServicesAccount“ wird unterstützt.

#### <a name="azcompute"></a>Az.Compute
* Ein Problem in „Update-ASRRecoveryPlan“ wurde durch Auffüllen von Failovertypen behoben.
* Dem Cmdlet „Get-AzVmImage“ wurden die optionalen Parameter „-Top“ und „-OrderBy“ hinzugefügt. 

#### <a name="azdatabricks"></a>Az.Databricks
* Allgemeine Verfügbarkeit des Moduls „Az.Databricks“
* Unterstützung für das Peering virtueller Netzwerke wurde hinzugefügt.

#### <a name="azdatafactory"></a>Az.DataFactory
* Ein Tippfehler in Ausgabemeldungen wurde behoben.

#### <a name="azeventhub"></a>Az.EventHub
* Dem Cmdlet „Set-AzEventHubNetworkRuleSet“ wurde der optionale Switch-Parameter „TrustedServiceAccessEnabled“ hinzugefügt.

#### <a name="azhdinsight"></a>Az.HDInsight
* Es wurde eine Warnmeldung für die geplante Einstellung der Parameter „PublicNetworkAccessType“ und „OutboundPublicNetworkAccessType“ hinzugefügt.
* Es wurde eine Warnmeldung für die geplante Ersetzung des Parameters „DefaultStorageAccountName“ durch den Parameter „StorageAccountResourceId“ hinzugefügt.
* Es wurde eine Warnmeldung für die geplante Ersetzung des Parameters „DefaultStorageAccountKey“ durch den Parameter „StorageAccountKey“ hinzugefügt.
* Es wurde eine Warnmeldung für die geplante Ersetzung des Parameters „DefaultStorageAccountType“ durch den Parameter „StorageAccountType“ hinzugefügt.
* Es wurde eine Warnmeldung für die geplante Ersetzung des Parameters „DefaultStorageContainer“ durch den Parameter „StorageContainer“ hinzugefügt.
* Es wurde eine Warnmeldung für die geplante Ersetzung des Parameters „DefaultStorageRootPath“ durch den Parameter „StorageRootPath“ hinzugefügt.

#### <a name="aziothub"></a>Az.IotHub
* Die Geräte-SDKs wurden aktualisiert.

#### <a name="azkeyvault"></a>Az.KeyVault
* Das genaue Datum für die Entfernung der Eigenschaft „SecretValueText“ wurde angegeben.

#### <a name="azmanagedservices"></a>Az.ManagedServices
* Breaking Change-Warnungen zu Cmdlets für die Zuweisung und Definition von verwalteten Diensten wurden aktualisiert.

#### <a name="azmonitor"></a>Az.Monitor
* Der Fehler, dass die Warnmeldung nicht unterdrückt werden kann, wurde behoben. [#12889]
* Der Parameter „SkipMetricValidation“ wird in Warnungsregelkriterien unterstützt. Dadurch wird die Metrikvalidierung übersprungen, sodass eine Warnungsregel für eine benutzerdefinierte Metrik erstellt werden kann, die noch nicht ausgegeben wird.

#### <a name="aznetwork"></a>Az.Network
* Der VPNSite-Ressource wurde die Office365-Richtlinie hinzugefügt.
    - New-AzO365PolicyProperty

#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* Für Workloadsicherung wurde eine Überprüfung des Containernamens hinzugefügt.

#### <a name="azrediscache"></a>Az.RedisCache
* Für die Cmdlets „New-AzRedisCache“ und „Set-AzRedisCache“ tritt bei einem Berechtigungsproblem im Zusammenhang mit der Registrierung des Ressourcenanbieters „Microsoft.Cache“ kein Fehler mehr auf.

#### <a name="azsql"></a>Az.Sql
* „BackupStorageRedundancy“ wurde Folgendem hinzugefügt: 
    - Restore-AzureRmSqlDatabase
    - New-AzSqlDatabaseCopy
    - New-AzSqlDatabaseSecondary
* Für den Parameter „BackupStorageRedundancy“ wurde die Berücksichtigung der Groß-/Kleinschreibung für alle SQL DB-Verweise entfernt. 
* Die Namen von BackupStorageRedundancy-Warnmeldungen wurden aktualisiert.

#### <a name="azstorage"></a>Az.Storage
* Das Aktivieren/Deaktivieren/Abrufen von Eigenschaften für vorläufiges Löschen von Freigaben im Dateidienst eines Speicherkontos wird unterstützt.
    - Update-AzStorageFileServiceProperty
    - Get-AzStorageFileServiceProperty
* Das Auflisten von Dateifreigaben (einschließlich der gelöschten Freigaben eines Speicherkontos) sowie das Abrufen der Nutzung einer einzelnen Dateifreigabe werden unterstützt.
    - Get-AzRmStorageShare
* Das Wiederherstellen einer gelöschten Dateifreigabe wird unterstützt.
    - Restore-AzRmStorageShare
* Die Cmdlets zum Ändern von Blobdiensteigenschaften wurden geändert. Es werden nicht die ursprünglichen Eigenschaften vom Server abgerufen, sondern nur die geänderten Eigenschaften auf dem Server festgelegt.
    - Enable-AzStorageBlobDeleteRetentionPolicy
    - Disable-AzStorageBlobDeleteRetentionPolicy  
    - „Enable-AzStorageBlobRestorePolicy“
    - „Disable-AzStorageBlobRestorePolicy“
    - „Update-AzStorageBlobServiceProperty“
* Ein Hilfeproblem im Zusammenhang mit dem Standardwert des Parameters „-Kind“ für „New-AzStorageAccount“ wurde behoben [#12189].
* Ein Problem wurde behoben, indem ein Beispiel hinzugefügt wurde, um das Festlegen des korrekten Inhaltstyps beim Blobupload zu veranschaulichen [#12989].

## <a name="470---september-2020"></a>4.7.0: September 2020
#### <a name="azaccounts"></a>Az.Accounts
* Die anstehenden Breaking Change-Meldungen wurden formatiert.
* Azure.Core wurde auf 1.4.1 aktualisiert.

#### <a name="azaks"></a>Az.Aks
* Clientseitige Logik zur Parameterüberprüfung für „New-AzAksCluster“, „Set-AzAksCluster“ und „New-AzAksNodePool“ wurde hinzugefügt. [#12372]
* Unterstützung für Add-Ons in „New-AzAksCluster“ wurde hinzugefügt. [#11239]
* Die Cmdlets „Enable-AzAksAddOn“ und „Disable-AzAksAddOn“ für Add-Ons wurden hinzugefügt. [#11239]
* Der Parameter „GenerateSshKey“ für „New-AzAksCluster“ wurde hinzugefügt. [#12371]
* Die API-Version wurde auf 2020-06-01 aktualisiert.

#### <a name="azcognitiveservices"></a>Az.CognitiveServices
* Es werden zusätzliche rechtliche Bedingungen für bestimmte APIs angezeigt.

#### <a name="azcompute"></a>Az.Compute
* Der optionale Parameter „EncryptionType“ wurde zu „New-AzVmDiskEncryptionSetConfig“ hinzugefügt.
* Neue Cmdlets für den neuen Ressourcentyp: DiskAccess „Get-AzDiskAccess“, „New-AzDiskAccess“, „Get-AzDiskAccess“
* Optionale Parameter „-DiskAccessId“ und „-NetworkAccessPolicy“ wurden zu „New-AzSnapshotConfig“ hinzugefügt.
* Optionale Parameter „-DiskAccessIdessid“ und „-NetworkAccessPolicy“ wurden zu „New-AzDiskConfig“ hinzugefügt.
* Die Eigenschaft „PatchStatus“ wurde zur VirtualMachine-Instanzansicht hinzugefügt.
* Die Eigenschaft „VMHealth“ wurde zur Instanzansicht des virtuellen Computers hinzugefügt; dabei handelt es sich um das zurückgegebene Objekt, wenn „Get-AzVm“ mit „-Status“ aufgerufen wird.
* Das Feld „AssignedHost“ wurde den Instanzansichten „Get-AzVM“ und „Get-AzVmss“ hinzugefügt. Das Feld zeigt die Ressourcen-ID der Instanz des virtuellen Computers.
* Der optionale Parameter „-SupportAutomaticPlacement“ wurde zu „New-AzHostGroup“ hinzugefügt. 
* Der Parameter „-HostGroupId“ wurde zu „New-AzVm“ und „New-AzVmss“ hinzugefügt.

#### <a name="azdatafactory"></a>Az.DataFactory
* Die ADF .Net SDK-Version wurde auf 4.11.0 aktualisiert.

#### <a name="azeventhub"></a>Az.EventHub
* Neue Cluster-Cmdlets wurden hinzugefügt: „New-AzEventHubCluster“, „Set-AzEventHubCluster“, „Get-AzEventHubCluster“, „Remove-AzEventHubCluster“, „Get-AzEventHubClustersAvailableRegions“.
* Für Problem #10722 behoben: Fix für die ausschließliche Zuweisung von „Listen“ zu AuthorizationRule-Berechtigungen.

#### <a name="azfunctions"></a>Az.Functions
* Die Möglichkeit zum Erstellen von v2-Funktionen wurde in Regionen entfernt, in denen sie nicht unterstützt werden.
* PowerShell 6.2 wurde als veraltet markiert. Es wurde eine Warnung für den Fall hinzugefügt, dass ein Benutzer eine PowerShell 6.2-Funktions-App erstellt, die ihm rät, stattdessen eine PowerShell 7.0-Funktions-App zu erstellen.

#### <a name="azhdinsight"></a>Az.HDInsight
* Das Erstellen von Clustern mit Autoscale-Konfiguration wird jetzt unterstützt.
    - Ein neuer Parameter „AutoscaleConfiguration“ wurde zum Cmdlet „New-AzHDInsightCluster“ hinzugefügt.
* Der Betrieb von Clustern mit Autoscale-Konfiguration wird jetzt unterstützt.
    - Ein neues Cmdlet „Get-AzHDInsihgtClusterAutoscaleConfiguration“ wurde hinzugefügt.
    - Ein neues Cmdlet „New-AzHDInsihgtClusterAutoscaleConfiguration“ wurde hinzugefügt.
    - Ein neues Cmdlet „Set-AzHDInsihgtClusterAutoscaleConfiguration“ wurde hinzugefügt.
    - Ein neues Cmdlet „Remove-AzHDInsihgtClusterAutoscaleConfiguration“ wurde hinzugefügt.
    - Ein neues Cmdlet „New-AzHDInsihgtClusterAutoscaleScheduleCondition“ wurde hinzugefügt.

#### <a name="azkeyvault"></a>Az.KeyVault
* Unterstützung für RBAC-Autorisierung wurde hinzugefügt [#10557].
* Die Fehlerbehandlung in „Set-AzKeyVaultAccessPolicy“ wurde erweitert [#4007].

#### <a name="azkusto"></a>Az.Kusto
* Allgemeine Verfügbarkeit des Moduls „Az.Kusto“

#### <a name="aznetwork"></a>Az.Network
* [Breaking Change] Die nachfolgend aufgelisteten Cmdlets wurden aktualisiert, um die Ressourcen „virtueller Router“ und „virtueller Hub“ auf eine gemeinsame Grundlage zu stellen.
    - „'New-AzVirtualRouter“: 
        - Der Parameter „-HostedSubnet“ zur Unterstützung untergeordneter IP-Konfigurationsressourcen wurde hinzugefügt.
        - „-HostedGateway“ und „-HostedGatewayId“ wurden gelöscht.
    - „Get-AzVirtualRouter“:
        - Ein Parametersatz auf Abonnementebene wurde hinzugefügt.
    - „Remove-AzVirtualRouter“
    - „Add-AzVirtualRouterPeer“
    - „Get-AzVirtualRouterPeer“
    - „Remove-AzVirtualRouterPeer“
* Ein neues Cmdlet für den Azure Express Route-Port wurde hinzugefügt.
    - „New-AzExpressRoutePortLOA“
* Die Eigenschaft „RemoteBgpCommunities“ wurde der VirtualNetwork-Peeringressource hinzugefügt.
* Warnmeldung für „New-AzLoadBalancerFrontendIpConfig“, „New-AzPublicIpAddress“ und „New-AzPublicIpPrefix“ geändert
* „VpnGatewayIpConfigurations“ wurde zur Ausgabe „Get-AzVpnGateway“ hinzugefügt.
* Ein Fehler für „Set-AzApplicationGatewaySslCertificate“ wurde behoben [#9488].
* Der Parameter „AllowActiveFTP“ wurde zu „AzureFirewall“ hinzugefügt.
* Folgende Befehle für das Feature aktualisiert: Das Festlegen/Entfernen von Internetsicherheit wurde für VirtualWan P2SVpnGateway aktiviert.
- „New-AzP2sVpnGateway“ wurde aktualisiert: Der optionale Schalterparameter „EnableInternetSecurityFlag“ wurde hinzugefügt, den Kunden auf „True“ festlegen können, um Internetsicherheit für das „P2SVpnGateway“ zu aktivieren, die auf Point-to-Site-Clients angewendet wird.
- „Update-AzP2sVpnGateway“ wurde aktualisiert: Die optionalen Schalterparameter „EnableInternetSecurityFlag“ und „DisableInternetSecurityFlag“ wurden hinzugefügt, die Kunden auf „True/False“ festlegen können, um Internetsicherheit für das „P2SVpnGateway“ zu aktivieren/deaktivieren, die auf Point-to-Site-Clients angewendet wird.
* Das neue Cmdlet „Reset-AzP2sVpnGateway“ wurde hinzugefügt, mit dem Kunden ihr VirtualWan P2SVpnGateway für die Problembehandlung zurücksetzen/neu starten können.
* Das neue Cmdlet „Reset-AzVpnGateway“ wurde hinzugefügt, mit dem Kunden ihr VirtualWan VpnGateway für die Problembehandlung zurücksetzen/neu starten können.
* „Set-AzVirtualNetworkSubnetConfig“ wurde aktualisiert.
    - Die NSG- und Routingtabellen-Eigenschaften vom Subnetz werden auf NULL festgelegt, wenn sie in Parametern explizit festgelegt sind [#1548][#9718].

#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* Das Löschen des Status für Workload-Sicherungselemente wurde korrigiert.

#### <a name="azresources"></a>Az.Resources
* Die fehlende Überprüfung für „Set-AzRoleAssignment“ wurde hinzugefügt.
* Ein Breaking Change-Attribut wurde zum Parameter „SubscriptionId“ von „Get-AzResourceGroupDeploymentOperation“ hinzugefügt.
* Die ARM-Vorlage für What-If-Cmdlets wurde angezeigt, um „Ignore“-Ressourcenänderungen zuletzt anzuzeigen.
* Serialisierungsprobleme bei sicheren und Array-Parametern für Bereitstellungs-Cmdlets wurden behoben [#12773].

#### <a name="azservicefabric"></a>Az.ServiceFabric
* Es wurden neue Cmdlets für verwaltete Cluster und Knotentypen hinzugefügt:
...
* Das Service Fabric SDK wurde auf Version 1.2.0 aktualisiert, die die API-Version 2020-03-01 des Service Fabric-Ressourcenanbieters für das aktuelle Modell und die Vorschauversion 2020-01-01 für verwaltete Cluster verwendet.

#### <a name="azsql"></a>Az.Sql
* BackupStorageRedundancy wurde zu „New-AzSqlInstance“ und „Get-AzSqlInstance“ hinzugefügt.
* Das Cmdlet „Get-AzSqlServerActiveDirectoryOnlyAuthentication“ wurde hinzugefügt.
* Das Cmdlet „Enable-AzSqlServerActiveDirectoryOnlyAuthentication“ wurde hinzugefügt.
* Der Force-Parameter wurde zu „New-AzSqlInstance“ hinzugefügt.
* Cmdlets für den Protokollwiedergabedienst von verwalteten Datenbanken wurden hinzugefügt.
    - „Start-AzSqlInstanceDatabaseLogReplay“
    - „Get-AzSqlInstanceDatabaseLogReplay“
    - „Complete-AzSqlInstanceDatabaseLogReplay“
    - „Stop-AzSqlInstanceDatabaseLogReplay“
* Das Cmdlet „Get-AzSqlInstanceActiveDirectoryOnlyAuthentication“ wurde hinzugefügt.
* Das Cmdlet „Enable-AzSqlInstanceActiveDirectoryOnlyAuthentication“ wurde hinzugefügt.
* Cmdlet „Disable-AzSqlInstanceActiveDirectoryOnlyAuthentication“ hinzugefügt.
* Die Cmdlets „New-AzSqlDatabaseImport“ und „New-AzSqlDatabaseExport“ zum Unterstützen von Netzwerk-Isolationsfunktionen wurden hinzugefügt.
* Das Cmdlet „New-AzSqlDatabaseImportExisting“ wurde hinzugefügt.
* Datenbanken-Cmdlets wurden zum Unterstützen der Typangabe für den Sicherungsspeicher aktualisiert.
* Der Force-Parameter wurde zu „New-AzSqlDatabase“ hinzugefügt.
* Eine Warnung wurde für die BackupStorageRedundancy-Konfiguration in ausgewählten Regionen in „New-AzSqlDatabase“ hinzugefügt.
* Die ActiveDirectoryOnlyAuthentication-Cmdlets für Server und Instanz wurden aktualisiert und beinhalten jetzt „ResourceId“ und „InputObject“.

#### <a name="azstorage"></a>Az.Storage
* Ein Fehler beim Hochladen von Blobs wurde durch Upgrade auf Microsoft.Azure.Storage.DataMovement 2.0.0 behoben [#12220].
* Unterstützung für Point-in-Time-Wiederherstellung
    - „Enable-AzStorageBlobRestorePolicy“
    - „Disable-AzStorageBlobRestorePolicy“
    - „New-AzStorageBlobRangeToRestore“
    - „Restore-AzStorageBlobRange“
* Das Abrufen des Blob-Wiederherstellungsstatus von Speicherkonten durch Ausführen von „get-AzureRMStorageAccount“ mit dem Parameter „-IncludeBlobRestoreStatus“ wird unterstützt. 
    - „Get-AzureRMStorageAccount“
* Eine Breaking Change Warnmeldung für die anstehende Änderung der Cmdlet-Ausgabe wurde hinzugefügt.
    - „Get-AzStorageContainerStoredAccessPolicy“
    - „Set-AzStorageContainerStoredAccessPolicy“
    - „Set-AzStorageAccountManagementPolicy“
    - „Get-AzStorageAccountManagementPolicy“
    - „Add-AzStorageAccountManagementPolicyAction“
    - „New-AzStorageAccountManagementPolicyRule“
* Microsoft.Azure.Cosmos.Table SDK wurde auf 1.0.8 aktualisiert.

### <a name="thanks-to-our-community-contributors"></a>Dank an unsere Mitwirkenden in der Community
* Thomas Van Laere (@ThomVanL), Hinzufügen von Dockerfile-alpine-3.10 (#12911) 
* Lohith Chowdary Chilukuri (@Lochiluk), Aktualisierung von Remove-AzNetworkInterfaceIpConfig.md (#12807) 
* Roberth Strand (@roberthstrand), Get-AzResourceGroup: Neues Beispiel und Bereinigung (#12828) 
* Ravi Mishra (@inmishrar), Aktualisierung des Azure Web App-Runtime-Stacks auf DOTNETCORE (#12833) 
* @jack-education, Aktualisierung von „Set-AzVirtualNetworkSubnetConfig“, um das Entfernen von NSG und Routingtabelle aus Subnetzen zu ermöglichen (#12351) 
* @hagop-globanet, Aktualisierung von Add-AzApplicationGatewayCustomError.md (#12784) 
* Joshua Van Daalen (@greenSacrifice)
  * Aktualisierung der Schreibung von Eigenschaft auf Eigenschaft (#12821) 
  * Aktualisierung der New-AzResourceLock.md-Beispiele (#12806)
* Eragon Riddle (@eragonriddle), Berichtigter Parameterfeldname im Beispiel (#12825) 
* @rossifumax, Behobener Tippfehler in New-AzConfigurationAssignment.md (#12701)

## <a name="461---august-2020"></a>4.6.1: August 2020
#### <a name="azcompute"></a>Az.Compute
* Patch für Parameter „-EncryptionAtHost“ in „New-AzVm“, um den Standardwert „false“ zu entfernen [Nr. 12776]

## <a name="460---august-2020"></a>4.6.0: August 2020
#### <a name="azaccounts"></a>Az.Accounts
* Alle öffentlichen Cloudumgebungen geladen, wenn der Ermittlungsendpunkt keine standardmäßigen AzureCloud-Umgebungen oder anderen öffentlichen Umgebungen zurückgibt [Nr. 12633]
* SubscriptionPolicies in „Get-AzSubscription“ verfügbar gemacht [Nr. 12551]

#### <a name="azautomation"></a>Az.Automation
* Parameter „-RunOn“ zu „Set-AzAutomationWebhook“ hinzugefügt, um eine Hybrid Worker-Gruppe anzugeben

#### <a name="azcompute"></a>Az.Compute
* Parameter „-EncryptionAtHost“ zu „New-AzVm“, „New-AzVmss“, „New-AzVMConfig“, „New-AzVmssConfig“, „Update-AzVM“ und „Update-AzVmss“ hinzugefügt
* „SecurityProfile“ zu Rückgabeobjekt „Get-AzVM“ und „Get-AzVmss“ hinzugefügt
* Switch „-InstanceView“ als optionalen Parameter zu „Get-AzHostGroup“ hinzugefügt
* Neues Cmdlet „Invoke-AzVmPatchAssessment“ hinzugefügt

#### <a name="azdatafactory"></a>Az.DataFactory
* Fehlende Eigenschaften zur PSPipelineRun-Klasse hinzugefügt

#### <a name="azhdinsight"></a>Az.HDInsight
* Unterstützung für das Erstellen eines Clusters mit dem Feature für Verschlüsselung auf dem Host

#### <a name="azkeyvault"></a>Az.KeyVault
* Warnmeldungen für geplante Deaktivierung des vorläufigen Löschens hinzugefügt
* Warnmeldungen für die geplante Entfernung des Attributs „SecretValueText“ hinzugefügt

#### <a name="azmaintenance"></a>Az.Maintenance
* Optionale zeitplanbezogene Felder zu „New-AzMaintenanceConfiguration“ hinzugefügt
* Neues Cmdlet für „Get-AzMaintenancePublicConfiguration“ hinzugefügt

#### <a name="azmanagedservices"></a>Az.ManagedServices
* Breaking Change-Warnungen zu Cmdlets für die Zuweisung und Definition von verwalteten Diensten hinzugefügt

#### <a name="azmonitor"></a>Az.Monitor
* Parametersatz in „Set-AzDiagnosticSetting“ zur Trennung der Aktivierung von Protokollen und Metriken erweitert [Nr. 12482]
* Fehler für „Add-AzMetricAlertRuleV2“ behoben, der beim Abrufen einer Metrikwarnung aus der Pipeline auftrat

#### <a name="azresources"></a>Az.Resources
* Antwort auf „Get-AzPolicyAlias“ aktualisiert. Sie enthält nun Informationen dazu, ob der Alias von Azure Policy geändert werden kann.
* Neues Cmdlet „Set-AzRoleAssignment“ erstellt
* „Get-AzDeploymentManagementGroupWhatIfResult“ zum Abrufen von Was-wäre-wenn-Ergebnissen der ARM-Vorlage im Verwaltungsgruppenbereich hinzugefügt
* Neues Cmdlet „Get-AzTenantWhatIfResult“ zum Abrufen von Was-wäre-wenn-Ergebnissen der ARM-Vorlage im Mandantenbereich hinzugefügt
* Parameter „-WhatIf“ und „-Confirm“ für „New-AzManagementGroupDeployment“ und „New-AzTenantDeployment“ für die Verwendung von Was-wäre-wenn-Ergebnissen der ARM-Vorlage überschrieben
* Verhalten von „-WhatIf“ und „-Confirm“ für neue Bereitstellungs-Cmdlets korrigiert (abgestimmt auf „False“ und 
* Serialisierungsfehler für „-TemplateObject“ und „TemplateParameterObject“ behoben [Nr. 1528] [Nr. 6292]
* Breaking Change-Attribut zu „Get-AzResourceGroupDeploymentOperation“ für anstehende Ausgabetypänderung hinzugefügt

#### <a name="azsignalr"></a>Az.SignalR
* Fehler in Hilfedateien für „Restart-AzSignalR“ und „Update-AzSignalR behoben
* Cmdlets „Update-AzSignalRNetworkAcl“ und „Set-AzSignalRUpstream“ hinzugefügt

#### <a name="azstorage"></a>Az.Storage
* Unterstützung für die Beschleunigung von Blobabfragen
    -  Get-AzStorageBlobQueryResult
    -  New-AzStorageBlobQueryConfig
* Hilfedatei aktualisiert, ausführlichere Beschreibung hinzugefügt und Tippfehler korrigiert
    -  „Start-AzStorageBlobCopy“
    -  Get-AzDataLakeGen2Item
* Fehler beim Blobdownload behoben, der auftrat, wenn das zugehörige Unterverzeichnis nicht vorhanden ist [Nr. 12592]
    -  „Get-AzStorageBlobContent“
* Unterstützung für das Festlegen/Abrufen/Entfernen der Objektreplikationsrichtlinie für Speicherkonten
    - New-AzStorageObjectReplicationPolicyRule
    - Set-AzStorageObjectReplicationPolicy
    - Get-AzStorageObjectReplicationPolicy
    - Remove-AzStorageObjectReplicationPolicy
* Unterstützung für das Aktivieren/Deaktivieren des Änderungsfeeds für den Blobdienst eines Storage-Kontos
    - „Update-AzStorageBlobServiceProperty“

## <a name="450---august-2020"></a>4.5.0: August 2020
#### <a name="azaccounts"></a>Az.Accounts
* „Connect-AzAccount“ wurde aktualisiert und akzeptiert nun den Parameter „MaxContextPopulation“. [Nr. 9865]
* SubscriptionClient-Version auf 2019-06-01 aktualisiert und Anzeigen von Mandantendomänen [Nr. 9838]
* Unterstützung für Informationen des Home- und des managedBy-Mandanten des Abonnements
* Modulname, Versionsinformationen in Telemetriedaten korrigiert
* SqlDatabaseDnsSuffix und ServiceManagementUrl angepasst, wenn Umgebungsmetadatenendpunkt inkompatiblen Wert zurückgibt

#### <a name="azaks"></a>Az.Aks
* „ClientIdAndSecret“ bis „ServicePrincipalIdAndSecret“ entfernt und „ClientIdAndSecret“ als Alias festgelegt [Nr. 12381].
* „Get-AzAks“/„New-AzAks“/“Remove-AzAks“/„Set-AzAks“ bis „Get-AzAksCluster“/„New-AzAksCluster“/„Remove-AzAksCluster“/„Set-AzAksCluster“ entfernt und ursprüngliche Cmdlets als Alias festgelegt [Nr. 12373].

#### <a name="azapimanagement"></a>Az.ApiManagement
* Neues Cmdlet „Add-AzApiManagementApiToGateway“ hinzugefügt
* Neues Cmdlet „Get-AzApiManagementGateway“ hinzugefügt
* Neues Cmdlet „Get-AzApiManagementGatewayHostnameConfiguration“ hinzugefügt
* Neues Cmdlet „Get-AzApiManagementGatewayKey“ hinzugefügt
* Neues Cmdlet „New-AzApiManagementGateway“ hinzugefügt
* Neues Cmdlet „New-AzApiManagementGatewayHostnameConfiguration“ hinzugefügt
* Neues Cmdlet „New-AzApiManagementResourceLocationObject“ hinzugefügt
* Neues Cmdlet „Remove-AzApiManagementApiFromGateway“ hinzugefügt
* Neues Cmdlet „Remove-AzApiManagementGateway“ hinzugefügt
* Neues Cmdlet „Remove-AzApiManagementGatewayHostnameConfiguration“ hinzugefügt
* Neues Cmdlet „Update-AzApiManagementGateway“ hinzugefügt
* Neuer optionaler Parameter „[-GatewayId]“ zum Cmdlet „Get-AzApiManagementApi“ hinzugefügt

#### <a name="azcognitiveservices"></a>Az.CognitiveServices
* „Deny“ speziell als NetworkRules-Standardaktion verwendet

#### <a name="azfrontdoor"></a>Az.FrontDoor
* Problem behoben, aufgrund dessen eine Ausnahme ausgelöst wird, wenn Enum.Parse versucht, einen NULL-Wert in Enumerationswerte vom Typ „Enabled“ oder „Disabled“ umzuwandeln [Nr. 12344]

#### <a name="azhdinsight"></a>Az.HDInsight
* Unterstützung für das Erstellen eines Clusters mit dem Feature für Verschlüsselung während der Übertragung
    - Neuer Parameter „EncryptionInTransit“ zum Cmdlet „New-AzHDInsightCluster“ hinzugefügt
    - Neuer Parameter „EncryptionInTransit“ zum Cmdlet „New-AzHDInsightClusterConfig“ hinzugefügt
* Unterstützung für das Erstellen eines Clusters mit der Funktion für private Links:
    - Neue Parameter „PublicNetworkAccessType“ und „OutboundPublicNetworkAccessType“ zum Cmdlet „New-AzHDInsightCluster“ hinzugefügt
    - Neue Parameter „PublicNetworkAccessType“ und „OutboundPublicNetworkAccessType“ zum Cmdlet „New-AzHDInsightClusterConfig“ hinzugefügt
* Beim Aufruf von „New-AzHDInsightCluster“ oder „Get-AzHDInsightCluster“ werden Informationen zum virtuellen Netzwerk zurückgegeben.

#### <a name="aznetwork"></a>Az.Network
* Unterstützung für den AddressPrefixType-Parameter zu „Remove-AzExpressRouteCircuitConnectionConfig“ hinzugefügt
...
* Code geändert, um die Groß-/Kleinschreibung für die Parameter „AddressPrefixType“ und „PeerAddressType“ zu ignorieren
* Warnmeldung für „New-AzLoadBalancerFrontendIpConfig“, „New-AzPublicIpAddress“ und „New-AzPublicIpPrefix“ geändert

#### <a name="azoperationalinsights"></a>Az.OperationalInsights
* Option „-ForceDelete“ für „Remove-AzOperationalInsightsworkspace“ hinzugefügt
* Neues Cmdlet „Get-AzOperationalInsightsDeletedWorkspace“ hinzugefügt
* Neues Cmdlet „Restore-AzOperationalInsightsWorkspace“ hinzugefügt

#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* Ermittlung von Azure Backup-Containern/-Elementen verbessert

#### <a name="azresources"></a>Az.Resources
* Eigenschaften „Condition“, „ConditionVersion“ und „Description“ zu „New-AzRoleAssignment“ hinzugefügt
    - Dies enthielt alle relevanten Änderungen an den Datenmodellen.

#### <a name="azsql"></a>Az.Sql
* Potenzieller Fehler aufgrund der Nichtbeachtung von Groß-/Kleinschreibung beim Servernamen in „New-AzSqlServer“ und „Set-AzSqlServer“ behoben
* Fehler behoben, aufgrund dessen in „New-AzSqlDatabaseSecondary“ ein falscher Datenbankname für eine vorhandene Datenbank zurückgegeben wurde

#### <a name="azstorage"></a>Az.Storage
* Erstellen von Container-/Blob-SAS-Token mit neuer Berechtigung x,t unterstützt
    -  „New-AzStorageBlobSASToken“
    -  New-AzStorageContainerSASToken
* Erstellen von Konto-SAS-Token mit neuer Berechtigung x,t,f unterstützt
    -  New-AzStorageAccountSASToken
* Abrufen der Nutzung einer einzelnen Dateifreigabe unterstützt
    - Get-AzRmStorageShare

## <a name="440---july-2020"></a>4.4.0 – Juli 2020
#### <a name="azaccounts"></a>Az.Accounts
* Neues Cmdlet „Invoke-AzRestMethod“ hinzugefügt
* Ein Problem wurde behoben, das Authentifizierungsfehler in Szenarien mit mehreren Prozessen verursachen konnte, z. B. beim Ausführen mehrerer Azure PowerShell-Cmdlets mithilfe von „Start-Job“ [Nr. 9448].

#### <a name="azaks"></a>Az.Aks
* Fehler behoben: „Get-AzAks“ ruft nicht alle Cluster ab [Nr. 12296]

#### <a name="azanalysisservices"></a>Az.AnalysisServices
* Projektverweis auf Authentifizierung entfernt

#### <a name="azautomation"></a>Az.Automation
* Das Problem wurde behoben, dass die Zeichenfolge mit Escapezeichen nicht in das JSON-Objekt konvertiert werden kann.

#### <a name="azcompute"></a>Az.Compute
* Beim Verwenden von „New-azvmss“ ohne die Imageversion „latest“ wurde eine Warnung hinzugefügt.

#### <a name="azdatafactory"></a>Az.DataFactory
* Globale Parameter zu Data Factory hinzugefügt.

#### <a name="azeventgrid"></a>Az.EventGrid
* Zur Verwendung der API-Version 2020-06-01 aktualisiert.
* Neue Funktionen hinzugefügt:
    - Eingabezuordnung
    - Schema für Ereignisbereitstellung
    - Private Link
    - Cloud Event V10-Schema
    - Service Bus-Thema as Ziel
    - Azure-Funktion als Ziel
    - WebHook-Batchverarbeitung
    - Sicherer Webhook (AAD-Unterstützung)
    - IpFiltering
* Aktualisierte Cmdlets:
    - „New-AzEventGridSubscription“/„Update-AzEventGridSubscription“:
        - Neue optionale Parameter zur Unterstützung der Webhook-Batchverarbeitung hinzufügen.
        - Neue optionale Parameter zur Unterstützung der Batchverarbeitung gesicherter Webhooks mithilfe von AAD hinzufügen.
        - Neue Enumeration für den EndpointType-Parameter hinzufügen, um das Azure-Funktions-und Service Bus-Thema als neue Ziele zu unterstützen.
        - Neuen optionalen Parameter für das Zustellungsschema hinzufügen.
    - „New-AzEventGridTopic“/„Update-AzEventGridTopic“ und „New-AzEventGridDomain“/„Update-AzEventGridDomain“:
        - Neue optionale Parameter zur Unterstützung von IpFiltering hinzufügen.
    - „New-AzEventGridTopic“/„New-AzEventGridDomain“:
        - Neue optionale Parameter zur Unterstützung von Eingabezuordnung hinzufügen.

#### <a name="azfrontdoor"></a>Az.FrontDoor
* Modul zur Verwendung von API 2020-05-01 aktualisiert
* Unterstützung für private Links für Storage-, Keyvault- und Web App Service-Ressourcen hinzugefügt

#### <a name="azhdinsight"></a>Az.HDInsight
* Erstellen eines Clusters mit ADLSGen1/2-Speicher in nationalen Clouds unterstützt.

#### <a name="azmonitor"></a>Az.Monitor
* Fehler für „Get-AzDiagnosticSetting“ behoben, wenn Metriken oder Protokolle NULL sind [Nr. 12272]

#### <a name="aznetwork"></a>Az.Network
* Austausch von Parametern in VWan-HubVnet-Verbindung-korrigiert
* Neue Cmdlets für Sites von virtuellen Azure-Netzwerkgeräten hinzugefügt
    - „Get-AzVirtualApplianceSite“
    - „New-AzVirtualApplianceSite“
    - „Remove-AzVirtualApplianceSite“
    - „Update-AzVirtualApplianceSite“
    - „New-AzOffice365PolicyProperty“
* Neue Cmdlets für virtuelle Azure-Netzwerkgeräte hinzugefügt
...
* Onboarding für Application Gateway für gemeinsam verwendete Private Link-Cmdlets durchgeführt
* Onboarding für StorageSync für gemeinsam verwendete Private Link-Cmdlets durchgeführt
* Onboarding für SignalR für gemeinsam verwendete Private Link-Cmdlets durchgeführt

#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* Projektverweis auf Authentifizierung entfernt
* Azure Backup hat Cmdlets optimiert, um den Text genauer zu gestalten.
* Azure Backup hat Unterstützung für das Abrufen von MAB-Agent-Aufträgen mithilfe des Cmdlets „Get-AzRecoveryServicesBackupJob“ hinzugefügt.

#### <a name="azresources"></a>Az.Resources
* „Save-azresourcegroupdeploymenttemplate“ auf Verwendung des SDK aktualisiert.
* Cmdlet „Unregister-AzResourceProvider“ hinzugefügt.

#### <a name="azsql"></a>Az.Sql
* Unterstützung für Dienstprinzipal und Gastbenutzer im Cmdlet „Set-AzSqlInstanceActiveDirectoryAdministrator“ hinzugefügt
* Problem in Data Classification-Cmdlets behoben.
* Unterstützung für Azure SQL Managed Instance-Failover hinzugefügt: „Invoke-AzSqlInstanceFailover“

#### <a name="azstorage"></a>Az.Storage
* Problem behoben, dass UserAgent für einige Datenebenen-Cmdlets nicht hinzugefügt wurde.
* Erstellen/Aktualisieren eines Storage-Kontos mit „MinimumTlsVersion“ und „AllowBlobPublicAccess“ unterstützt
    -  New-AzStorageAccount
    -  Set-AzStorageAccount
* Aktivieren/Deaktivieren der Versionsverwaltung für Blobdienst eines Storage-Kontos unterstützen
    - „Update-AzStorageBlobServiceProperty“
* Auflisten von Blobs mit Blobversionen unterstützen
    - „Get-AzStorageBlob“
* Abrufen/Entfernen einer einzelnen Blob-Momentaufnahme oder Blobversion unterstützen
    - „Get-AzStorageBlob“
    - „Remove-AzStorageBlob“
* Pipeline aus Blobobjekt unterstützen, das aus Azure.Storage.Blobs V12 generiert wurde
    - „Get-AzStorageBlobContent“
    - „New-AzStorageBlobSASToken“
    - „Remove-AzStorageBlob“
    - „Set-AzStorageBlobContent“
...
#### <a name="azstoragesync"></a>Az.StorageSync
* Neue Version von StorageSync SDK für ApiVersion 2020-03-01 hinzugefügt
* Cmdlet „Update Storage Sync Service“ hinzugefügt
    - „Set-AzStorageSyncService“
* „IncomingTrafficPolicy“ und „PrivateEndpointConnections“ zu StorageSyncService-Cmdlets hinzugefügt.

#### <a name="azwebsites"></a>Az.Websites
* Unterstützung zur Durchführung von Vorgängen für Slots hinzugefügt, die sich nicht in der gleichen Ressourcengruppe wie der App Service-Plan befinden

## <a name="430---june-2020"></a>4.3.0 – Juni 2020
#### <a name="azaccounts"></a>Az.Accounts
* Standardmäßige Unterstützung der Einstellung der Erkennungsumgebung und das Hinzufügen der Umgebung über „Add-AzEnvironment“
* Aktualisieren von vorgeladenen Assemblys [#12024], [#11976]
* Assembly „Azure.Core“ aktualisiert
...
* Möglichkeit zum Festlegen der BatchAccount-Identität im Cmdlet „New-AzBatchAccount“ hinzugefügt

#### <a name="azcognitiveservices"></a>Az.CognitiveServices
* Anzeige von Kontofunktionen wird unterstützt.
* Ändern von PublicNetworkAccess wird unterstützt.

#### <a name="azcompute"></a>Az.Compute
* Parameter „SimulateEviction“ wurde den Cmdlets „Set-AzVM“ und „Set-AzVmssVM“ hinzugefügt.
* „Premium_LRS“ wurde zur Argumentvervollständigung des StorageAccountType-Parameters für das Cmdlet „New-AzGalleryImageVersion“ hinzugefügt.
* Unterstatus zu VMCustomScriptExtension hinzugefügt [#11297]
* „Delete“ wurde zur Argumentvervollständigung des EvictionPolicy-Parameters für die Cmdlets „New-AzVM“ und „New-AzVMConfig“ hinzugefügt.
* Name der neuen VM-Erweiterung für SAP korrigiert

#### <a name="azdatafactory"></a>Az.DataFactory
* ADF .Net-SDK-Version auf 4.9.0 aktualisiert

#### <a name="azeventhub"></a>Az.EventHub
* Parameter der verwalteten Identität zu Cmdlets „New-AzEventHubNamespace“ und „Set-AzEventHubNamespace“ hinzugefügt

#### <a name="azfunctions"></a>Az.Functions
* Unterstützung zum Erstellen von PowerShell 7.0- und Java 11-Funktions-Apps hinzugefügt

#### <a name="azhdinsight"></a>Az.HDInsight
* Listenhosts unterstützt und bestimmte Hosts des HDInsight-Clusters neu gestartet.

#### <a name="azhealthcareapis"></a>Az.HealthcareApis
* SDK-Version auf 1.1.0 aktualisiert
* Unterstützung für Exporteinstellungen und verwaltete Identität hinzugefügt

#### <a name="azmonitor"></a>Az.Monitor
* Eingabeobjektparameter für „Set-AzActivityLogAlert“ korrigiert
* InputObject-Parameter für „Set-AzActionGroup“ korrigiert [#10868]

#### <a name="aznetwork"></a>Az.Network
* Unterstützung für den AddressPrefixType-Parameter zu „Remove-AzExpressRouteCircuitConnectionConfig“ hinzugefügt
* Neue Cmdlets für „Azure FirewallPolicy“ hinzugefügt
    - „New-AzFirewallPolicyDnsSetting“
    - Unterstützung für Ziel-FQDN in Netzwerkregeln für Firewallrichtlinie
* Unterstützung für Back-End-Adresspool-Vorgänge hinzugefügt
    - „New-AzLoadBalancerBackendAddressConfig“
    - „New-AzLoadBalancerBackendAddressPool“
    - „Set-AzLoadBalancerBackendAddressPool“
    - „Remove-AzLoadBalancerBackendAddressPool“
    - „Get-AzLoadBalancerBackendAddressPool“
* Namensvalidierung für „New-AzIpGroup“ hinzugefügt
* Neue Cmdlets für „Azure FirewallPolicy“ hinzugefügt
    - „New-AzFirewallPolicyThreatIntelWhitelist“
* Folgende Befehle für das Feature aktualisiert: Festlegen/Entfernen von benutzerdefinierten DNS-Servern auf „VirtualWan P2SVpnGateway“.
    - „New-AzP2sVpnGateway“ aktualisiert: Der optionale Parameter „-CustomDnsServer“ wurde hinzugefügt, damit Kunden ihre DNS-Server angeben können, die auf „P2SVpnGateway“ festgelegt werden. Diese können von Point-to-Site-Clients verwendet werden.
    - „Update-AzP2sVpnGateway“ aktualisiert: Der optionale Parameter „-CustomDnsServer“ wurde hinzugefügt, damit Kunden ihre DNS-Server angeben können, die auf „P2SVpnGateway“ festgelegt werden. Diese können von Point-to-Site-Clients verwendet werden.
* „Update-AzVpnGateway“ aktualisiert:
    - Der optionale Parameter „-BgpPeeringAddress“ wurde hinzugefügt, damit Kunden ihre benutzerdefinierten BGSs angeben können, die auf „VpnGateway“ festgelegt werden.
* Neues Cmdlet hinzugefügt, um das Zurücksetzen des Routingstatus einer VirtualHub-Ressource zu unterstützen:
    - „Reset-AzHubRouter“
* Folgendes wurde basierend auf der aktuellen Swagger-Änderung für die Firewallrichtlinie aktualisiert:
    - Namen für „RuleGroup“, „RuleCollectionGroup“ und „RuleType“ geändert
    - Unterstützung für NAT-Regelsammlungen der Firewallrichtlinie zur Unterstützung mehrerer NAT-Regelsammlungen hinzugefügt
* [Breaking Change] Obligatorischer Parameter „SourceIpGroup“ für „New-AzFirewallPolicyApplicationRule“ und „New-AzFirewallPolicyNetworkRule“ wurde hinzugefügt.
* [Breaking Change] Parameter „New-AzFirewallPolicyApplicationRule“ korrigiert, „SourceAddress“ ist jetzt obligatorisch.
* [Breaking Change] Parameter „New-AzFirewallPolicyApplicationRule“ korrigiert, „SourceAddress“ ist jetzt obligatorisch.
* [Breaking Change] Obligatorische Parameter entfernt: „TranslatedAddress“, „TranslatedPort“ für „New-AzFirewallPolicyNatRuleCollection“.
* Neue Cmdlets zur Unterstützung von „PrivateLink“ auf Application Gateway hinzugefügt
...
* Neue Cmdlets für untergeordnete Ressource „HubRouteTables“ von „VirtualHub“ hinzugefügt.
    - „New-AzVHubRoute“
    - „New-AzVHubRouteTable“
    - „Get-AzVHubRouteTable“
    - „Update-AzVHubRouteTable“
    - „Remove-AzVHubRouteTable“
* Vorhandene Cmdlets aktualisiert, sodass sie den optionalen Eingabeparameter „RoutingConfiguration“ für benutzerdefiniertes Routing in „VirtualWan“ unterstützen.
...
#### <a name="azoperationalinsights"></a>Az.OperationalInsights
* Fehler behoben: „PSWorkspace“ implementiert „IOperationalInsightsWorkspace“ nicht [#12135]
* „pergb2018“ wurde dem gültigen Satz des Parameters „Sku“ in „Set-AzOperationalInsightsWorkspace“ hinzugefügt. 
* Der Alias „FunctionParameters“ für den Parameter „FunctionParameter“ wurde hinzugefügt.
    - New-AzOperationalInsightsSavedSearch
    - Set-AzOperationalInsightsSavedSearch

#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* Azure Backup hat Unterstützung für das Abrufen von MAB-Elementen hinzugefügt.
* Azure Site Recovery unterstützt Datenträgertyp „StandardSSD_LRS“.

#### <a name="azresources"></a>Az.Resources
* „UsageLocation“, „GivenName“, „Surname“, „AccountEnabled“, „MailNickname“, „Mail“ in „PSADUser“ hinzugefügt [#10526] [#10497]
* Problem behoben, dass „-Mail“ für „Get-AzADUser“ nicht funktioniert [#11981]
* Parameter „-ExcludeChangeType“ zu „Get-AzDeploymentWhatIfResult“ und „Get-AzResourceGroupDeploymentWhatIfResult“ hinzugefügt
* Parameter „-WhatIfExcludeChangeType“ zu „New-AzDeployment“ und „New-AzResourceGroupDeployment“ hinzugefügt
* Cmdlets von „Test-Az*Deployment“, sodass bessere Fehlermeldungen angezeigt werden
* Hilfemeldung für Parameter „-Name“ der Cmdlets „deployment create“ und „What-If“ korrigiert

#### <a name="azsql"></a>Az.Sql
* Unterstützung für Dienstprinzipal für Cmdlet „Set SQL Server Azure Active Directory Admin“ hinzugefügt
* Synchronisierungsproblem in Datenklassifizierungs-Cmdlets wurde behoben.
* Suchen von Benutzern nach E-Mail wird für „Set-AzSqlServerActiveDirectoryAdministrator“ unterstützt [#12192]

#### <a name="azstorage"></a>Az.Storage
* Erstellen eines Speicherkontos mit „RequireInfrastructureEncryption“ wird unterstützt
    -  New-AzStorageAccount
* Logik zum Laden von „Azure.Core to Az.Accounts“ verschoben

#### <a name="azwebsites"></a>Az.Websites
* Schutz zum Löschen der erstellten Web-App hinzugefügt, wenn die Wiederherstellung in „Restore-AzDeletedWebApp“ fehlgeschlagen ist
* „SourceWebApp.Location“ für „New-AzWebApp“ und „New-AzWebAppSlot“ hinzugefügt
* Fehler behoben, der das Ändern von Containereinstellungen in „Set-AzWebApp“ und „Set-AzWebAppSlot“ verhindert hat.
* Fehler beim Abrufen von „SiteConfig“ behoben, wenn „-Name“ für „Get-AzWebApp“ nicht angegeben ist
* Unterstützung zum Erstellen von ASP für Linux-Apps hinzugefügt
* Ausnahmen für den Ressourcengruppen übergreifenden Klonvorgang hinzugefügt

## <a name="420---june-2020"></a>4.2.0: Juni 2020
#### <a name="azaccounts"></a>Az.Accounts
* Problem behoben, das unter Umständen dazu geführt hat, dass Az Protokolle in Azure Automation- oder PowerShell-Aufträgen übersprungen hat [Nr. 11492]

#### <a name="azanalysisservices"></a>Az.AnalysisServices
* Assemblyversion der Cmdlets der Datenebene aktualisiert

#### <a name="azapimanagement"></a>Az.ApiManagement
* Assemblyversion der Dienstverwaltungs-Cmdlets aktualisiert

#### <a name="azbilling"></a>Az.Billing
* Assemblyversion der Nutzungs-Cmdlets aktualisiert

#### <a name="azcognitiveservices"></a>Az.CognitiveServices
* Unterstützung des PrivateEndpoint- und des PublicNetworkAccess-Steuerelements 

#### <a name="azdatafactory"></a>Az.DataFactory
* Assemblyversion der Data Factory v2-Cmdlets aktualisiert

#### <a name="azdatashare"></a>Az.DataShare
* Allgemeine Verfügbarkeit des Moduls „Az.DataShare“

#### <a name="azdesktopvirtualization"></a>Az.DesktopVirtualization
* Allgemeine Verfügbarkeit des Moduls „Az.DesktopVirtualization“

#### <a name="azoperationalinsights"></a>Az.OperationalInsights
* SDK auf 0.21.0 aktualisiert
* Optionale Parameter hinzugefügt zu: 
    - New-AzOperationalInsightsSavedSearch
    - Set-AzOperationalInsightsSavedSearch

#### <a name="azpolicyinsights"></a>Az.PolicyInsights
* Beispiel 3 für „Start-AzPolicyComplianceScan“ korrigiert

#### <a name="azpowerbiembedded"></a>Az.PowerBIEmbedded
* Assemblyversion der PowerBI-Cmdlets aktualisiert

#### <a name="azprivatedns"></a>Az.PrivateDns
* Formatierung der ausführlichen Ausgabezeichenfolge für „Remove-AzPrivateDnsRecordSet“ korrigiert

#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* Azure Site Recovery-Unterstützung für die Erstellung eines Wiederherstellungsplans für die Replikation zwischen Zonen per XML-Eingabe
* Assemblyversion der SiteRecovery- und Backup-Cmdlets aktualisiert

#### <a name="azresources"></a>Az.Resources
* Tail-Parameter zu den Cmdlets „Get-AzDeploymentScriptLog“ und „Save-AzDeploymentScriptLog“ hinzugefügt
* Die Output-Eigenschaft wurde formatiert und wird nun in der Ausgabe des Cmdlets „Get-AzDeploymentScript“ angezeigt.
* Parameter „-DeploymentScriptInputObject“ in „-DeploymentScriptObject“ umbenannt
* Fehlender Datei-/Zielname in Cmdlet-Meldungen korrigiert
* Assemblyversion der Resource Manager- und Tags-Cmdlets aktualisiert

#### <a name="azsql"></a>Az.Sql
* „UsePrivateLinkConnection“ zu „New-AzSqlSyncGroup“, „Update-AzSqlSyncGroup“, „New-AzSqlSyncMember“ und „Update-AzSqlSyncMember“ hinzugefügt
* „SyncMemberAzureDatabaseResourceId“ zu „New-AzSqlSyncMember“ und „Update-AzSqlSyncMember“ hinzugefügt
* Unterstützung für die Gastbenutzersuche zum SQL Server-Cmdlet für den Azure Active Directory-Administrator hinzugefügt

#### <a name="azstorage"></a>Az.Storage
* Assemblyversion der Cmdlets der Datenebene aktualisiert

## <a name="410---may-2020"></a>4.1.0 – Mai 2020
### <a name="highlights-since-the-last-release"></a>Highlights seit dem letzten Release
* Unterstützte PowerShell-Versionen: Windows PowerShell 5.1, PowerShell Core 6.2.4 oder höher, PowerShell 7
* Allgemeine Verfügbarkeit von Az.Functions 
* Veröffentlichung von Hauptversionen von Az.ApiManagement, Az.Batch, Az.Compute, Az.KeyVault, Az.Monitor, Az.Network, Az.OperationalInsights, Az.Resources und Az.Storage

#### <a name="azaccounts"></a>Az.Accounts
* „Add-AzEnvironment“ und „Set-AzEnvironment“ akzeptieren jetzt die Parameter „AzureSynapseAnalyticsEndpointResourceId“ und „AzureSynapseAnalyticsEndpointSuffix“.
* Assemblys zu Azure.Core wurden Az.Accounts hinzugefügt. Unterstützte PowerShell-Plattformen sind u. a. Windows PowerShell 5.1, PowerShell Core 6.2.4, PowerShell 7+

#### <a name="azaks"></a>Az.Aks
* API-Version wurde auf 2019-10-01 aktualisiert.
* Unterstützung für die Erstellung von AKS mit einem Windows-Container
* Neu verfügbare Cmdlets: „New-AzAksNodePool“, „Update-AzAksNodePool“, „Remove-AzAksNodePool“, „Get-AzAksNodePool“, „Install-AzAksKubectl“, „Get-AzAksVersion“

#### <a name="azapimanagement"></a>Az.ApiManagement
* „New-AzApiManagement“ und „Set-AzApiManagement“: Parameter [-AssignIdentity] wurde in [-SystemAssignedIdentity] umbenannt.
* „New-AzApiManagement“ und „Set-AzApiManagement“: Neuer Parameter hinzugefügt: [-UserAssignedIdentity <String[]>]
* „Get-AzApiManagementProperty“ wurde in „Get-AzApiManagementNamedValue“ umbenannt. Der Parameter PropertyId wurde in NamedValueId umbenannt.
* „New-AzApiManagementProperty“ wurde in „New-AzApiManagementNamedValue“ umbenannt. Der Parameter PropertyId wurde in NamedValueId umbenannt. 
* „Set-AzApiManagementProperty“ wurde in „Set-AzApiManagementNamedValue“ umbenannt. Der Parameter PropertyId wurde in NamedValueId umbenannt.
* „Remove-AzApiManagementProperty“ wurde in „Remove-AzApiManagementNamedValue“ umbenannt. Der Parameter PropertyId wurde in NamedValueId umbenannt.
* Neues Cmdlet „Get-AzApiManagementAuthorizationServerClientSecret“ hinzugefügt. „Get-AzApiManagementAuthorizationServer“ gibt keinen geheimen Clientschlüssel mehr zurück.
* Neues Cmdlet „Get-AzApiManagementNamedValueSecretValue“ hinzugefügt. „Get-AzApiManagementNamedValue“ gibt keinen Geheimniswert zurück.
* Neues Cmdlet „Get-AzApiManagementOpenIdConnectProviderClientSecret“ hinzugefügt. „Get-AzApiManagementOpenIdConnectProvider“ gibt keinen geheimen Clientschlüssel mehr zurück.
* Neues Cmdlet „Get-AzApiManagementSubscriptionKey“ hinzugefügt. „Get-AzApiManagementSubscription“ gibt keine Abonnementschlüssel mehr zurück.
* Neues Cmdlet „Get-AzApiManagementTenantAccessSecret“ hinzugefügt. „Get-AzApiManagementTenantAccess“ gibt keine Schlüssel mehr zurück.
* Neues Cmdlet „Get-AzApiManagementTenantGitAccessSecret“ hinzugefügt. „Get-AzApiManagementTenantGitAccess“ gibt keine Schlüssel mehr zurück.

#### <a name="azapplicationinsights"></a>Az.ApplicationInsights
* Parameter hinzugefügt: „RetentionInDays“, „PublicNetworkAccessForIngestion“, „PublicNetworkAccessForQuery“ für „New-AzApplicationInsights“
* Cmdlet „Update-AzApplicationInsights“ erstellt.
* Cmdlets für verknüpftes Speicherkonto erstellt.

#### <a name="azbatch"></a>Az.Batch
* Az.Batch für die Verwendung der Microsoft.Azure.Batch-SDK-Version 13.0.0 und der Microsoft.Azure.Management.Batch-SDK-Version 9.0.0 aktualisiert.
* Die Möglichkeit zum Auswählen der Art des hinzugefügten Zertifikats mithilfe des neuen Parameters „-CertificateKind“ wurde zu „New-AzBatchCertificate“ hinzugefügt.
* Eigenschaft „ApplicationPackages“ aus „PSApplication“ entfernt, die bislang immer „“ war.
...
* Beim Erstellen eines Pools mit „New-AzBatchPool“ kann die Eigenschaft „VirtualMachineImageId“ von „PSImageReference“ jetzt nur auf ein Bild in einer Shared Image Gallery verweisen.
* Wenn Sie einen Pool mit „New-AzBatchPool“ erstellen, kann der Pool mit der Eigenschaft „PublicIPAddressConfiguration“ von „PSNetworkConfiguration“ ohne eine öffentliche IP-Adresse bereitgestellt werden.
  - Die Eigenschaft „PublicIPs“ von „PSNetworkConfiguration“ wurde ebenfalls in „PSPublicIPAddressConfiguration“ verschoben. Diese Eigenschaft kann nur angegeben werden, wenn „IPAddressProvisioningType“ den Wert „UserManaged“ hat.

#### <a name="azcompute"></a>Az.Compute
* HostId-Parameter zum Cmdlet „Update-AzVM“ hinzugefügt.
* Hilfedokumente für die Cmdlets „New-AzVMConfig“, „New-AzVmssConfig“, „Update-AzVmss“, „Set-AzVMOperatingSystem“ und „Set-AzVmssOsProfile“ aktualisiert.
* Aktuelle Änderungen
    - Der FilterExpression-Parameter wurde aus dem Cmdlet „Get-AzVMImage“ entfernt.
    - Der AssignIdentity-Parameter wurde aus den Cmdlets „New-AzVmssConfig“, „New-AzVMConfig“ und „Update-AzVM“ entfernt.
    - AutomaticRepairMaxInstanceRepairsPercent wurde aus den Cmdlets „New-AzVmssConfig“ und „Update-AzVmss“ entfernt.
    - Die Eigenschaften AvailabilitySetsColocationStatus, VirtualMachinesColocationStatus und VirtualMachineScaleSetsColocationStatus wurden aus ProximityPlacementGroup entfernt.
    - Die Eigenschaft MaxInstanceRepairsPercent wurde aus AutomaticRepairsPolicy entfernt.
    - Die Typen von AvailabilitySets, VirtualMachines und VirtualMachineScaleSets wurden von IList<SubResource> in IList<SubResourceWithColocationStatus> geändert.
* Die Beschreibung für das Cmdlet „Get-AzVM“ wurde verbessert. 

#### <a name="azdatafactory"></a>Az.DataFactory
* CRUD von Datenfluss-Laufzeiteigenschaften in Managed IR unterstützt.

#### <a name="azfrontdoor"></a>Az.FrontDoor
* Neue Cmdlets zum Erstellen, Aktualisieren, Abrufen und Löschen von Front Door-Regelmodulobjekten hinzugefügt.
* Hilfs-Cmdlets für die Erstellung von Front Door-Regelmodulobjekten hinzugefügt.
* Regelmodulverweis auf Front Door-Routingregelobjekt hinzugefügt.
* Private Link-Parameter zum Front Door-Back-End-Objekt hinzugefügt.

#### <a name="azfunctions"></a>Az.Functions
* Allgemeine Verfügbarkeit des Moduls „Az.Functions“

#### <a name="azhdinsight"></a>Az.HDInsight
* Datenträgerverschlüsselung mit kundenseitig verwalteten Schlüsseln unterstützt.

#### <a name="azhealthcareapis"></a>Az.HealthcareApis
* Zugriffsrichtlinien verwenden nicht mehr den aktuellen Prinzipal als Standard.

#### <a name="aziothub"></a>Az.IotHub
* Cmdlet zum Aufrufen einer Abfrage in einem IoT-Hub zum Abrufen von Informationen mithilfe einer SQL-ähnlichen Sprache hinzugefügt.
* Problem behoben, dass „Add-AzIotHubDevice“ kein Edge-aktiviertes Gerät ohne untergeordnete Geräte erstellen konnte. [#11597]
* Cmdlet zum Generieren eines SAS-Tokens für IoT-Hub, -Gerät oder -Modul hinzugefügt.
* Cmdlet zum Aufrufen der Konfigurationsmetrikenabfrage hinzugefügt.
* Verwalten der automatischen skalierbaren Bereitstellung von IoT Edge. Die folgenden Cmdlets sind neu:
    - „Add-AzIotHubDeployment“
    - „Get-AzIotHubDeployment“
    - „Remove-AzIotHubDeployment“
    - „Set-AzIotHubDeployment“
* Cmdlet zum Hinzufügen einer IoT Edge-Bereitstellungsmetrikenabfrage hinzugefügt.
* Cmdlet zum Anwenden des Konfigurationsinhalts auf das angegebene Edge-Gerät hinzugefügt.

#### <a name="azkeyvault"></a>Az.KeyVault
* Zwei Aliase entfernt: „New-AzKeyVaultCertificateAdministratorDetails“ und „New-AzKeyVaultCertificateOrganizationDetails“
* Vorläufiges Löschen ist beim Erstellen eines Schlüsseltresors standardmäßig aktiviert.
* Netzwerkregeln können so festgelegt werden, dass der Zugriff von bestimmten Netzwerkstandorten beim Erstellen eines Schlüsseltresors gesteuert wird.
* Unterstützung für BYOK (Bring Your Own Key) hinzugefügt.
    - „Add-AzKeyVaultKey“ unterstützt die Erstellung eines Schlüsselaustauschschlüssels.
    - „Get-AzKeyVaultKey“ unterstützt das Herunterladen eines öffentlichen Schlüssels im PEM-Format.
* Abschnitt „KeyOps“ der Hilfedokumentation zu „Add-AzKeyVaultKey“ wurde aktualisiert.

#### <a name="azmonitor"></a>Az.Monitor
* Fehler bei „Set-AzDiagnosticSettings“ behoben. Aufbewahrungsrichtlinie gilt nicht für alle Kategorien. [#11589]
* WebTest-Verfügbarkeitskriterien für die Metrikwarnung V2 unterstützt.
    - „New-AzMetricAlertRuleV2Criteria“: Option zum Erstellen der Webtest-Verfügbarkeitskriterien hinzugefügt.
    - „Add-AzMetricAlertRuleV2“: Neue Webtest-Verfügbarkeitskriterien unterstützt.
* Redundante Definition für „RetentionPolicy“ in PSLogProfile entfernt. [#7608]
* Redundante in PSEventData definierte Eigenschaften entfernt. [#11353]
* „Get-AzLog“ in „Get-AzActivityLog“ umbenannt.

#### <a name="aznetwork"></a>Az.Network
* Breaking Change-Attribut hinzugefügt als Benachrichtigung, dass sich das Standardverhalten der Zone ändert.
    - „New-AzPublicIpAddress“
    - „New-AzPublicIpPrefix“
    - „New-AzLoadBalancerFrontendIpConfig“
* Unterstützung für die neue Ressource der obersten Ebene SecurityPartnerProvider hinzugefügt.
...
* „RequiredZoneNames“ für „PSPrivateLinkResource“ und „GroupId“ für „PSPrivateEndpointConnection“ hinzugefügt.
* Falscher Typ des Parameters SuccessThresholdRoundTripTimeMs für New-AzNetworkWatcherConnectionMonitorTestConfigurationObject korrigiert.
* VirtualWan-Cmdlets aktualisiert, sodass der Standardwert des Arguments AllowVnetToVnetTraffic auf True festgelegt wird.
    - „New-AzVirtualWan“
    - „Update-AzVirtualWan“
* Neue Cmdlets zur Unterstützung der DNS-Zonengruppe für den privaten Endpunkt hinzugefügt.
    - „New-AzPrivateDnsZoneConfig“
    - „Get-AzPrivateDnsZoneGroup“
    - „New-AzPrivateDnsZoneGroup“
    - „Set-AzPrivateDnsZoneGroup“
    - „Remove-AzPrivateDnsZoneGroup“
* Parameter „DNSEnableProxy“, „DNSRequireProxyForNetworkRules“ und „DNSServers“ zu „AzureFirewall“ hinzugefügt.
* Parameter „EnableDnsProxy“, „DnsProxyNotRequiredForNetworkRule“ und „DnsServer“ zu „AzureFirewall“ hinzugefügt.
    - Aktualisiertes Cmdlet:
        - New-AzFirewall

#### <a name="azoperationalinsights"></a>Az.OperationalInsights
* Legacycode zum Anwenden des neuen generierten SDK aktualisiert.
* Cmdlets aufgrund von veralteten APIs gelöscht.
...
* Parameter für „Set-AzOperationalInsightsWorkspace“ und „New-AzOperationalInsightsWorkspace“ hinzugefügt.
* Cmdlets für verknüpftes Speicherkonto erstellt.
* Cmdlets für Cluster und verknüpften Dienst erstellt.

#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* Azure Site Recovery: Unterstützung für den Schutz von virtuellen Computern der Näherungsplatzierungsgruppe für den Azure-zu-Azure-Anbieter hinzugefügt.
* Azure Site Recovery: Unterstützung für die Replikation zwischen Zonen hinzugefügt.
* Azure Backup: Unterstützung für die langfristige Aufbewahrung von Azure FileShare-Wiederherstellungspunkten hinzugefügt.
* Azure Backup: Eigenschaften für den Ausschluss von Datenträgern zur Ausgabe des Cmdlet „Get-AzRecoveryServicesBackupItem“ hinzugefügt.
* Privater Endpunkt für Tresoranmeldeinformationen für den Site Recovery-Dienst hinzugefügt.

#### <a name="azresources"></a>Az.Resources
* Warnmeldung zur verzögerten Ansicht beim Erstellen einer neuen Rollendefinition hinzugefügt.
* Richtlinien-Cmdlets geändert, sodass sie stark typisierte Objekte ausgeben.
* Parameter „-TenantLevel“ zum Cmdlet „Get-AzResourceLock“ hinzugefügt. [#11335]
* „Remove-AzResourceGroup -Id ResourceId“ korrigiert. [#9882]
* Neues Cmdlet zum Abrufen von Was-wäre-wenn-Ergebnissen der ARM-Vorlage im Ressourcengruppenbereich hinzugefügt: „Get-AzDeploymentResourceGroupWhatIfResult“
* Neues Cmdlet zum Abrufen von Was-wäre-wenn-Ergebnissen der ARM-Vorlage im Abonnementbereich hinzugefügt: „Get-AzDeploymentWhatIfResult“
   - Alias: „Get-AzSubscriptionDeploymentWhatIf“
* Parameter „-WhatIf“ und „-Confirm“ für „New-AzDeployment“ und „New-AzResourceGroupDeployment“ für die Verwendung von Was-wäre-wenn-Ergebnissen der ARM-Vorlage überschrieben.
* Meldung zur Einstellung der Unterstützung für „ApiVersion“ in Bereitstellungs-Cmdlets hinzugefügt.
* Funktion zum Anzeigen verbesserter Fehlermeldungen für Bereitstellungsfehler hinzugefügt.
* Protokollierung von correlationId bei Bereitstellungsfehlern hinzugefügt.
* Eigenschaft „error“ zur Bereitstellungsskriptausgabe hinzugefügt.
* NuGet-Microsoft.Azure.Management.ResourceManager auf „3.7.1-preview“ aktualisiert.
* Bestimmte Testfälle entfernt, da die Error-Eigenschaft in DeploymentValidateResult von NuGet 3.7.1-preview in schreibgeschützt geändert wurde.
* GenericResourceExpanded aus dem SDK ResourceManager 3.7.1-preview importiert.
* Tagunterstützung für alle Get-Cmdlets für die Bereitstellung hinzugefügt sowie
    - „New-AzDeployment“
...
#### <a name="azservicefabric"></a>Az.ServiceFabric
* Fehler beim Hinzufügen eines Zertifikats mithilfe von „--SecretIdentifier“ behoben, der den falschen Zertifikatfingerabdruck erhalten hat.
...
* Clientseitige Validierung des Parameters „RetentionDays“ aus dem Cmdlet „Set-AzSqlDatabaseBackupShortTermRetentionPolicy“ entfernt.
* Fehler beim Überwachen eines Speicherkontos in Vnet und Erstellen einer Rolle für den Mitwirkenden an Speicherblobdaten behoben.

#### <a name="azstorage"></a>Az.Storage
* „-AsJob“ hinzugefügt, um das Konto für das Cmdlet „Get-AzStorageAccount“ abzurufen/aufzulisten.
* KeyVersion als optional festgelegt, wenn das Speicherkonto mit KeyvaultEncryption aktualisiert wird, um die automatische Schlüsselrotation zu unterstützen.
    - Set-AzStorageAccount
* Fehler beim Entfernen des Azure-Dateiverzeichnisses mit der Pipeline behoben.
    - „Remove-AzStorageDirectory“
* Behoben [#9880]: Definition des DefaultAction-Werts für NetWorkRule in Übereinstimmung mit Swagger geändert.
    - „Update-AzStorageAccountNetworkRuleSet“
    - „Get-AzStorageAccountNetworkRuleSet“
* Behoben [#11624]: Doppelte Regeln werden beim Hinzufügen von NetworkRules übersprungen, um Serverfehler zu vermeiden.
    - „Add-AzStorageAccountNetworkRule“
* Microsoft.Azure.Cosmos.Table SDK auf 1.0.7 aktualisiert.
* Warnmeldung hinzugefügt, mit der der Benutzer darauf hingewiesen wird, eine erneute Auflistung mit ContinuationToken auszuführen, wenn nur ein Teil der Elemente in der Liste der DataLake Gen2-Elemente zurückgegeben wird.
    - Get-AzDataLakeGen2ChildItem
* Unterstützung für das Erstellen oder Aktualisieren eines Speicherkontos mit Active Directory Domain Service-Authentifizierung für Azure Files.
    -  New-AzStorageAccount
    -  Set-AzStorageAccount
* Unterstützung für das Hinzufügen und Auflisten von Kerberos-Schlüsseln des Speicherkontos.
    -  „New-AzStorageAccountKey“
    -  „Get-AzStorageAccountKey“
* Unterstützung für Failover für das Speicherkonto.
    - „Invoke-AzStorageAccountFailover“
* Hilfe zu „Get-AzStorageBlobCopyState“ aktualisiert.
* Hilfe zu „Get-AzStorageFileCopyState“ und „Start-AzStorageBlobCopy“ aktualisiert.
* Speicherclientbibliothek v12 in Cmdlets Queue und File integriert.
* Ausgabetyp von CloudFile in AzureStorageFile geändert. Die ursprüngliche Ausgabe wird zu einer untergeordneten Eigenschaft der neuen Ausgabe.
    - „Get-AzStorageFile“
    - „Remove-AzStorageFile“
    - „Get-AzStorageFileContent“
    - „Set-AzStorageFileContent“
    - „Start-AzStorageFileCopy“
* Ausgabetyp von CloudFileDirectory in AzureStorageFileDirectory geändert. Die ursprüngliche Ausgabe wird zu einer untergeordneten Eigenschaft der neuen Ausgabe.
    - „New-AzStorageDirectory“
    - „Remove-AzStorageDirectory“
* Ausgabetyp von CloudFileShare in AzureStorageFileShare geändert. Die ursprüngliche Ausgabe wird zu einer untergeordneten Eigenschaft der neuen Ausgabe.
    - „Get-AzStorageShare“
    - „New-AzStorageShare“
    - „Remove-AzStorageShare“
* Ausgabetyp von FileShareProperties in AzureStorageFileShare geändert. Die ursprüngliche Ausgabe wird zu einer untergeordneten Eigenschaft der neuen Ausgabe.
    - „Set-AzStorageShareQuota“

#### <a name="aztrafficmanager"></a>Az.TrafficManager
* Falscher Profilname in der ausführlichen Ausgabe von „DisableAzureTrafficManagerEndpoint“ korrigiert.

#### <a name="azwebsites"></a>Az.Websites
* Tippfehler in der Hilfe zu „Update-AzWebAppAccessRestrictionConfig“ korrigiert.
