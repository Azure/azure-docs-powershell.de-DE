...
## Synopsis
Abrufen eines bestimmten Katalogelements
...
Ruft das Katalogelement nach Name ab.

### Beispiel 2: Auflisten von Katalogelementen
```powershell
...
Listet alle Elemente auf, die im Azure Stack-Katalog verfügbar sind.
