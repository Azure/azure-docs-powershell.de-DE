...
Reparieren eines Knotens einer Skalierungseinheit
...
### -BareMetalNode
Beschreibung eines baren Metall Knotens, der für die Skalierungsoperation in einem Cluster verwendet wird.
Informationen zum Erstellen finden Sie unter Abschnitt "Notizen" für BAREMETALNODE-Eigenschaften und Erstellen einer Hashtabelle.
...
### -BiosVersion
BIOS-Version des physikalischen Computers.
...
### -MACAddress
Der Name der Mac-Adresse des Bare Metal-Knotens.
...
### -Modell
Modell des physikalischen Computers
...
### -Seriennummer
Die Seriennummer des physikalischen Computers.
...
### -Vendor
Hersteller des physikalischen Computers.
...
BAREMETALNODE <IBareMetalNodeDescription> : Identity-Parameter
  - `[BiosVersion <String>]`: BIOS-Version des physikalischen Computers.
  - `[BmciPv4Address <String>]`: BMC-Adresse des physikalischen Computers.
  - `[ClusterName <String>]`: Name des Clusters.
  - `[ComputerName <String>]`: Name des Computers.
  - `[MacAddress <String>]`: Name der Mac-Adresse des Bare Metal-Knotens.
  - `[Model <String>]`: Modell des physikalischen Computers.
  - `[SerialNumber <String>]`: Seriennummer des physikalischen Computers.
  - `[Vendor <String>]`: Anbieter des physikalischen Computers.
