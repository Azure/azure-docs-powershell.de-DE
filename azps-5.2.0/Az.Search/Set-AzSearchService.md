...
## BESCHREIBUNG
Das **Cmdlet Set-AzSearchService** ändert einen Azure Search-Dienst.
...
Im Beispiel werden die Partitions- und Replikatanzahl des Azure Search-Diensts in "2" geändert.
...
### -PartitionCount
Anzahl der Suchdienstpartitionen.
...
### -ReplicaCount
Anzahl der Suchdienstreplikate.
