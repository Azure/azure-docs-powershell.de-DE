...
## BESCHREIBUNG
Das **Cmdlet "New-AzSearchAdminKey"** generiert einen Administratorschlüssel des Azure Search-Diensts erneut.
...
Im Beispiel wird der Primärschlüssel des Azure Search Service erneut generiert.
...
### -KeyKind
Art des Suchdienstadministratorschlüssels (primär/sekundär).
