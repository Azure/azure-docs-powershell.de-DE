...
## SYNOPSIS
Ruft die Durchsatzeigenschaften von "TongoDB-Sammlung" ab.
...
## BESCHREIBUNG
Das **Cmdlet "Get-AzCosmosDBMongoDBCollectionThroughput"** ruft die Durchsatzeigenschaften der "MongoDB Collection" ab.
...
### -InputObject
Wenn diese Angaben angegeben sind, gibt das Cmdlet die Sammlung mit dem entsprechenden Durchsatzwert zurück.
...
### Microsoft.Azure.Commands.DiesDB.Models.PSMongoDBCollectionGetResults
