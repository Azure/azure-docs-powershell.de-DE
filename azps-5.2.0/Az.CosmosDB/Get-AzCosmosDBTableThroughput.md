...
## SYNOPSIS
Ruft den Durchsatz einer Tabelle "Untere Datenbank" ab.
...
## BESCHREIBUNG
Das **Cmdlet "Get-AzCosmosDBTableThroughput"** (Durchsatz) ruft den Durchsatz einer Tabelle mit DemosDB ab.
