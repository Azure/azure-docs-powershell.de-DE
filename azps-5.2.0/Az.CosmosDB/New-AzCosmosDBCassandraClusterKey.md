...
## SYNOPSIS
Erstellt einen neuen Clusterschlüssel aus Unternall.
...
## BESCHREIBUNG
Der **Neue-AzCosmosDBCasskonfigurationsclusterKey** erstellt einen neuen Clusterschlüssel aus Demkka.
...
### -Name
Name des Sternclusterschlüssels.
...
### -OrderBy
Sortierung des Clusterschlüssels aus Untereing.
Mögliche Werte sind: 'Asc', 'Desc'
...
### Microsoft.Azure.Commands.UmsDB.Models.PSClusterKey
