...
Der Parameter "LocationObject" erwartet, dass die Liste der aktuellen Speicherorte (eingeschlossene Failover-Prioritäten) von den neuen "LocationObjects" angefügt wird, die neuen Speicherorten entsprechend hinzugefügt werden.
