...
## SYNOPSIS
Erstellen Sie ein neues Standortobjekt (PSLocation) aus.
...
### -FailoverPriority
Failoverpriorität des Speicherorts.
...
### -IsZoneRedundant
Boolesch, um anzugeben, ob es sich bei dieser Region um einen AvailabilityZone-Bereich handelt.
...
### -LocationName
Der Name der Position in der Zeichenfolge.
...
### Microsoft.Azure.Commands.AllosDB.Models.PSLocation
