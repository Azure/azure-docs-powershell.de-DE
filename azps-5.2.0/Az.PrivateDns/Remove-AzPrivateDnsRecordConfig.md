...
In diesem Beispiel wird ein AAAA-Datensatz aus einem vorhandenen Datensatzsatz entfernt. Wenn dies der einzige Datensatz im Datensatzsatz ist, ist das Ergebnis ein leerer Datensatzsatz. Informationen zum vollständigen Entfernen eines Datensatzes finden Sie unter "Remove-AzPrivateDnsRecordSet".
...
In diesem Beispiel wird ein "MX"-Eintrag aus einem vorhandenen Datensatzsatz entfernt. Der Datensatzname "@" gibt einen Datensatzsatz an der Anschlagspitze der Zone an. Wenn dies der einzige Datensatz im Datensatzsatz ist, ist das Ergebnis ein leerer Datensatzsatz. Informationen zum vollständigen Entfernen eines Datensatzes finden Sie unter "Remove-AzPrivateDnsRecordSet".
