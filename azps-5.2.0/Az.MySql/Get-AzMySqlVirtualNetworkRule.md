...
### Beispiel 1: Listet alle Regeln für das virtuelle Netzwerk im angegebenen Server von MySql auf.
```powershell
...
Dieses Cmdlet listet alle Regeln für virtuelle Netzwerke im angegebenen Server von MySql auf.
