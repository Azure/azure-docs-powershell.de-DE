...
### Beispiel 1: Erstellen einer neuen virtuellen Netzwerkregel für den MySql server
```powershell
...
Diese Cmdlets erstellen eine virtuelle Netzwerkregel für den MySql-Server.
