...
### Beispiel 1: Aktualisieren der Regel für das virtuelle MySql-Netzwerk nach Name
```powershell
...
Dieses Cmdlet aktualisiert die MySql Virtual Network Rule nach Name.

### Beispiel 2: Aktualisieren der Regel für das virtuelle MySql-Netzwerk nach Identität.
```powershell
...
Mit diesen Cmdlets wird die MySql Virtual Network Rule nach Identität aktualisiert.
