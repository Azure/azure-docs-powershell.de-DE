...
### Beispiel 2: Erhalten der MySql -Serververbindungszeichenfolge nach Identität
```powershell
...
INPUTOBJECT <IServer> : Das Quellserverobjekt, aus dem eine Replikaterstellung erstellt werden soll.
