...
### Beispiel 1: Wiederherstellen eines MySql-Servers mithilfe von "GeoReplica Restore"
```powershell
...
Mit diesem Cmdlet wird der Server von MySql mithilfe von GeoReplica Restore wiederhergestellt.

### Beispiel 2: Wiederherstellen des Server von MySql mithilfe der PointInTime-Wiederherstellung
```powershell
