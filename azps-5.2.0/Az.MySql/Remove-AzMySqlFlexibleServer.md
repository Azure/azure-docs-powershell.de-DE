...
### Beispiel 1: Entfernen des Server "MySql" nach "resourceGroup" und dem Servernamen
```powershell
PS C:\> Remove-AzMySqlFlexibleServer -ResourceGroupName PowershellMySqlTest -Name mysql-test

```

Dieses Cmdlet entfernt "MySql-Server" nach "resourceGroup" und "Servername".

### Beispiel 2: Entfernen des Server "MySql" nach Identität
```powershell
...
Mit diesen Cmdlets wird der Server "MySql" nach Identität entfernt.
