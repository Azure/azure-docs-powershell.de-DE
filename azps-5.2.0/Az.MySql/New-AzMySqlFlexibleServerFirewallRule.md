...
### Beispiel 1: Erstellen einer neuen MySql -Server-Firewallregel
```powershell
...
Diese Cmdlets erstellen eine MySql-Server-Firewallregel.

### Beispiel 2: Erstellen einer neuen MySql-Firewallregel mit "-ClientIPAddress".
```powershell
...
Diese Cmdlets erstellen eine MySql-Firewallregel mit "-ClientIPAddress".

### Beispiel 3: Erstellen einer neuen MySql-Firewallregel, um alle IPs zu erlauben
```powershell
...
Mit diesen Cmdlets wird eine neue MySql-Firewallregel erstellt, damit alle IPs zulässig sind.

## PARAMETERS

### -AllowAll
Ist vorhanden, damit alle IPs von 0.0.0.0 bis 255.255.255.255 zulässig sind.
