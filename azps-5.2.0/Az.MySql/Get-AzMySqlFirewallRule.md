...
### Beispiel 1: Listet alle Firewallregeln im angegebenen Server von MySql auf.
```powershell
...
Dieses Cmdlet listet alle Firewallregeln auf dem angegebenen Server "MySql" auf.
