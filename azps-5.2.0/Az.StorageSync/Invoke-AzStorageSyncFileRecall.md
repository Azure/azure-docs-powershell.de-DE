...
## BESCHREIBUNG
Wenn die Cloud tiering auf einem Serverendpunkt (einem bestimmten Speicherort auf einem registrierten Server) aktiviert ist, kann dieser Befehl verwendet werden, um alle mehrstufigen Dateien auf den lokalen Datenträger zurückrufen. Es wird dringend empfohlen, die Cloud tiering auf diesem Serverendpunkt zu deaktivieren, bevor Sie den Rückruf starten. Wenn die Gestuftierung weiterhin besteht, kann der Rückruf dazu führen, dass andere Dateien mehrstufiger Werden, wodurch das gewünschte Ziel aller Inhalte, die sich auf dem lokalen Datenträger aufhalten, nicht erreicht werden können.
