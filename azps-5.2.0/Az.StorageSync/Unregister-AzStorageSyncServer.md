...
## BESCHREIBUNG
Mit diesem Befehl wird die Registrierung eines Servers vom Speichersynchronisierungsdienst aufgehoben. Warnung: Wenn Sie die Registrierung eines Servers aufheben, werden alle Serverendpunkte auf diesem Server überlappend gelöscht. Sie sollte nur aufgerufen werden, wenn Sie sicher sind, dass kein Pfad auf diesem Server mehr synchronisiert werden soll.
...
### -InputObject
RegisteredServer Input Object, das normalerweise über die Pipeline übergeben wird.
