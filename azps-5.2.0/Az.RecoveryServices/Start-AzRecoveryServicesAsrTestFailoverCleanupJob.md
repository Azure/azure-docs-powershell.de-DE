...
## BESCHREIBUNG
Das **Cmdlet "Start-AzRecoveryServicesAsrTestFailoverCleanupJob"** startet den Test-Failover-Bereinigungsvorgang für ein replikationsgeschütztes Element oder einen Wiederherstellungsplan, für das ein Test failover durchgeführt wurde.

## BEISPIELE

### Beispiel 1

Aufgabe zum Nachverfolgen der Bereinigung eines Test failover in einem Wiederherstellungsplan für eine Azure-Websitewiederherstellung.
...
Startet den Bereinigungsvorgang für den Test failover. (automatisch generiert)
...
### -RecoveryPlan
Wiederherstellungsplan zum Ausführen der Failoverbereinigung für den Test.
...
Replikationsgeschütztes Element zum Durchführen der Failoverbereinigung
...
### -ResourceId
Ressourcen-ID des replikationsgeschützten Elements/Wiederherstellungsplans zum Bereinigungstest-Failover.
