...
Startet den Vorgang zum Erstellen eines replikationsgeschützten Elements für das angegebene schützende ASR-Element und gibt den ASR-Auftrag zurück, mit dem der Vorgang nachverfolgt wird.
...
Startet den Vorgang zum Erstellen eines replikationsgeschützten Elements für das angegebene asR-geschützte Element, einschließlich selektiver Datenträger, und gibt den ASR-Auftrag zurück, mit dem der Vorgang (vmWare zu Azure-Szenario) mit ausgewählten Datenträgern nachverfolgt wird.
...
Gibt die Datenträgerkonfigurationseingabe für die vMWare-Datenträger-ID an, um vor bestimmten schützenden Elemente zu schützen.
...
Die ID des AvailabilitySet, auf den der Computer im Fall eines Failovers wiederhergestellt werden soll.
...
Geben Sie die von der Failover-VM im Zielwiederherstellungsbereich zu verwendende Näherungsplatzierungsgruppe-ID an.
...
### -RecoveryVmName
Name der wiederherstellungs-VM, die nach dem Failover erstellt wurde.
