...
## BESCHREIBUNG
Das **Cmdlet "New-AzRecoveryServicesAsrStorageClassificationMapping"** erstellt eine Speicherklassifizierungszuordnung für den Recovery Services-Tresor.
...
Startet den Vorgang zum Erstellen der Speicherklassifizierungszuordnung mit den angegebenen Parametern und gibt den ASR-Auftrag zurück, mit dem der Vorgang nachverfolgt wird.
...
### -Name
Gibt einen Namen für die Zuordnung der ASR-Speicherklassifizierung an.
...
Gibt das primäre AsR-Speicherklassifikationsobjekt für die Zuordnung an.
...
Gibt das Wiederherstellungs-ASR-Speicherklassifikationsobjekt für die Zuordnung an.
