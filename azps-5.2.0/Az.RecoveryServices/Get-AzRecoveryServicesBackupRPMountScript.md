...
## BESCHREIBUNG
Das Get-AzRecoveryServicesBackupRPMountScript-Cmdlet lädt ein Skript herunter, das die Volumen des Wiederherstellungspunkts auf dem Computer einlädigt, auf dem er ausgeführt wird.

## BEISPIELE

### Beispiel 1: Einhängen eines Wiederherstellungspunkts
```powershell
...
Wenn das Skript ausgeführt wird, werden die Dateien des Wiederherstellungspunkts mit $rp \[ 0\]

### Beispiel 2

Lädt ein Skript herunter, um alle Dateien des Wiederherstellungspunkts zu speichern. (automatisch generiert)
...
### -Path
Speicherort, an den die Datei im Fall einer Dateiwiederherstellung heruntergeladen werden soll. Wenn "-Path" nicht angegeben wird, wird die Skriptdatei im aktuellen Verzeichnis heruntergeladen.
