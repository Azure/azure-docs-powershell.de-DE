...
## Beschreibung
In diesem Thema werden Hilfethemen für die Azure Recovery Services-Cmdlets angezeigt.
...
Fügen Sie den Datenträger zum Schutz für den bereits geschützten virtuellen Azure-Computer hinzu.
...
Deaktiviert die automatische Sicherung für ein schützendes Element.
...
Bearbeitet einen Websitewiederherstellungsplan.

### [Enable-AzRecoveryServicesBackupAutoProtection](Enable-AzRecoveryServicesBackupAutoProtection.md)
Das **Cmdlet "Enable-AzRecoveryServicesBackupAutoProtection"** richtet den automatischen Schutz von aktuellen und zukünftigen SQL-DBs innerhalb der angegebenen Instanz mit der angegebenen Richtlinie ein.
...
Ruft die konfigurierten Benachrichtigungseinstellungen für die Azure-Websitewiederherstellung für den Tresor ab.
...
Ruft Informationen zu Websitewiederherstellungsnetzwerkzuordnungen für den aktuellen Tresor ab.
...
Ruft DIE ASR-Schutzcontainer im Wiederherstellungsdiensttresor ab.
...
Ruft einen Wiederherstellungsplan oder alle Wiederherstellungspläne im Wiederherstellungsdiensttresor ab.
...
Ruft die Zuordnungen der ASR-Speicherklassifizierung ab.
...
Ruft details of the vCenter servers registered for discovery on the Configuration server specified by the ASR fabric.
...
Ruft SCDPM- und Azure Backup Management Servers ab.
...
Dieser Befehl listet die Start- und Endpunkte der nicht aufgebrochenen Protokollkette des angegebenen Sicherungselements auf. Damit können Sie feststellen, ob der Zeitpunkt, in dem der Benutzer die DB wiederherstellen möchte, gültig ist.

### [Get-AzRecoveryServicesBackupRecoveryPoint](Get-AzRecoveryServicesBackupRecoveryPoint.md)
Ruft die Wiederherstellungspunkte für ein gesichertes Element ab.

### [Get-AzRecoveryServicesBackupRetentionPolicyObject](Get-AzRecoveryServicesBackupRetentionPolicyObject.md)
Ruft ein Basisobjekt für die Aufbewahrungsrichtlinie ab.

### [Get-AzRecoveryServicesBackupRPMountScript](Get-AzRecoveryServicesBackupRPMountScript.md)
Lädt ein Skript herunter, um alle Dateien des Wiederherstellungspunkts zu speichern.
...
Gibt die Eigenschaften eines Wiederherstellungsdiensttresor zurück.
...
Dieser Befehl löst die Ermittlung aller ungeschützten Elemente des angegebenen Workloadtyps im angegebenen Container aus. Wenn die Anwendung DB nicht automatisch geschützt ist, verwenden Sie diesen Befehl, um neue PSP zu ermitteln, sobald sie hinzugefügt werden, und mit dem Schutz fortzufahren.

### [New-AzRecoveryServicesAsrAzureToAzureDiskReplicationConfig](New-AzRecoveryServicesAsrAzureToAzureDiskReplicationConfig.md)
Erstellt ein Datenträgerzuordnungsobjekt für virtuelle Azure-Computer-Datenträger, die repliziert werden sollen.
...
Erstellt ein Datenträgerzuordnungsobjekt für virtuelle vMWare-Computerdatenträger, die repliziert werden sollen.
...
Erstellt eine Azure-Websitewiederherstellungsreplikationsrichtlinie.

### [New-AzRecoveryServicesAsrProtectableItem](New-AzRecoveryServicesAsrProtectableItem.md)
Fügen Sie einen physischen Server zur Liste der geschützten Elemente hinzu(Entdecken).

### [New-AzRecoveryServicesAsrProtectionContainer](New-AzRecoveryServicesAsrProtectionContainer.md)
Erstellt einen Azure Site Recovery Protection Container innerhalb des angegebenen Fabric.

### [New-AzRecoveryServicesAsrProtectionContainerMapping](New-AzRecoveryServicesAsrProtectionContainerMapping.md)
Erstellt eine Azure Site Recovery Protection-Containerzuordnung, indem die angegebene Replikationsrichtlinie dem angegebenen ASR-Schutzcontainer zugeordnet wird.
...
Erstellt eine ASR-Speicherklassifizierungszuordnung im Recovery Services-Tresor.

### [New-AzRecoveryServicesAsrvCenter](New-AzRecoveryServicesAsrvCenter.md)
Fügt einen vCenter-Server hinzu, auf dem die geschützten Elemente ermittelt werden können.

### [New-AzRecoveryServicesBackupProtectionPolicy](New-AzRecoveryServicesBackupProtectionPolicy.md)
Erstellt eine Sicherungsschutzrichtlinie.

### [New-AzRecoveryServicesVault](New-AzRecoveryServicesVault.md)
Erstellt einen neuen Wiederherstellungsdienste-Tresor.

### [Register-AzRecoveryServicesBackupContainer](Register-AzRecoveryServicesBackupContainer.md)
Das **Cmdlet Register-AzRecoveryServicesBackupContainer** registriert eine Azure VM für AzureWorkloads mit einem bestimmten WorkloadType.
...
Löscht die angegebene ASR-Netzwerkzuordnung aus dem Recovery Services-Tresor.

### [Remove-AzRecoveryServicesAsrPolicy](Remove-AzRecoveryServicesAsrPolicy.md)
Löscht die angegebene ASR-Replikationsrichtlinie aus dem Recovery Services-Tresor.
...
Löscht den angegebenen ASR-Wiederherstellungsplan aus dem Recovery Services-Tresor.

### [Remove-AzRecoveryServicesAsrReplicationProtectedItem](Remove-AzRecoveryServicesAsrReplicationProtectedItem.md)
Beendet/deaktiviert die Replikation für ein geschütztes Element der Azure-Websitewiederherstellungsreplikation.

### [Remove-AzRecoveryServicesAsrServicesProvider](Remove-AzRecoveryServicesAsrServicesProvider.md)
Löscht den angegebenen Azure Site Recovery Recovery Services-Anbieter aus dem Tresor der Wiederherstellungsdienste bzw. entregistert die Registrierung.

### [Remove-AzRecoveryServicesAsrStorageClassificationMapping](Remove-AzRecoveryServicesAsrStorageClassificationMapping.md)
Löscht die angegebene Zuordnung der ASR-Speicherklassifizierung.

### [Remove-AzRecoveryServicesAsrvCenter](Remove-AzRecoveryServicesAsrvCenter.md)
Entfernt den vCenter-Server aus dem ASR-Fabric und beendet die Suche virtueller Computer vom vCenter-Server.

### [Remove-AzRecoveryServicesBackupProtectionPolicy](Remove-AzRecoveryServicesBackupProtectionPolicy.md)
Löscht eine Sicherungsschutzrichtlinie aus einem Tresor.

### [Remove-AzRecoveryServicesVault](Remove-AzRecoveryServicesVault.md)
Löscht einen Wiederherstellungsdienste-Tresor.
...
Stellt die Daten und die Konfiguration eines Sicherungselements auf einem Wiederherstellungspunkt wieder her.
...
Legt den Tresorkontext der Wiederherstellungsdienste fest, der für nachfolgende Azure-Websitewiederherstellungsvorgänge in der aktuellen PowerShell-Sitzung verwendet wird.
...
Startet den Test-Failover-Bereinigungsvorgang.
...
Startet einen nicht geplanten Failovervorgang.
...
Die Registrierung eines Windows Server- oder anderen Containers aus dem Tresor wird aufgehoben.

### [Unregister-AzRecoveryServicesBackupManagementServer](Unregister-AzRecoveryServicesBackupManagementServer.md)
Die Registrierung eines SCDPM- oder Sicherungsservers aus dem Tresor wird aufgehoben.

### [Update-AzRecoveryServicesAsrMobilityService](Update-AzRecoveryServicesAsrMobilityService.md)
Aktualisierungen des Agent für Push mobility Service auf geschützte Computer.

### [Update-AzRecoveryServicesAsrNetworkMapping](Update-AzRecoveryServicesAsrNetworkMapping.md)
Aktualisiert die angegebene Netzwerkzuordnung für die Azure-Websitewiederherstellung.
...
Aktualisieren Sie die Containerzuordnung für den Azure-Websitewiederherstellungsschutz.

### [Update-AzRecoveryServicesAsrProtectionDirection](Update-AzRecoveryServicesAsrProtectionDirection.md)
Aktualisiert die Replikationsrichtung für das angegebene replikationsgeschützte Element oder den Wiederherstellungsplan. Wird verwendet, um ein repliziertes Element oder einen Wiederherstellungsplan erneut zu schützen/umgekehrt zu replizieren.

### [Update-AzRecoveryServicesAsrRecoveryPlan](Update-AzRecoveryServicesAsrRecoveryPlan.md)
Aktualisiert den Inhalt eines Azure-Websitewiederherstellungsplans.

### [Update-AzRecoveryServicesAsrServicesProvider](Update-AzRecoveryServicesAsrServicesProvider.md)
Aktualisiert (Aktualisierungsserver) die Vom Azure Site Recovery Services-Anbieter erhaltenen Informationen.

### [Update-AzRecoveryServicesAsrvCenter](Update-AzRecoveryServicesAsrvCenter.md)
Aktualisieren Sie die Discoverydetails für ein registriertes vCenter.
