...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzRecoveryServicesAsrServicesProvider"** entfernt den angegebenen Azure Site Recovery Services-Anbieter aus dem Tresor.
...
Startet das Löschen/Die Registrierung des angegebenen Azure Websitewiederherstellungsdienste-Anbieters und gibt den ASR-Auftrag zurück, mit dem der Vorgang nachverfolgt wird.
...
### -Force
Erzwingen Sie die Ausführung des Befehls, ohne eine zusätzliche Warnung bereitstellen zu müssen.
...
### -InputObject
Das Eingabeobjekt für das Cmdlet: Das ASR-Wiederherstellungsdienste-Anbieterobjekt, das dem zu löschende ASR-Wiederherstellungsdienste-Anbieter entspricht.
