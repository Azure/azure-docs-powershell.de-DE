...
## SYNOPSIS
Bricht einen laufenden Databoxauftrag ab, wenn sich der Auftrag in einem konfigurierbaren Zustand befindet.
...
## BESCHREIBUNG
Das **Cmdlet "Stop-AzDataBoxJob"** wird zum Abbrechen eines Databoxauftrags verwendet.
...
Bricht den angegebenen Datenboxauftrag ab.
...
Bricht den angegebenen Auftrag im Datenfeld ohne Bestätigung ohne Bestätigung ab.
...
### -Force
Beenden ohne Bestätigung erzwingen
...
### -InputObject
InputObject vom Typ PSDataBoxJob
