...
## BESCHREIBUNG
Das **Cmdlet "Set-AzSynapsePipeline"** erstellt eine Pipeline im Arbeitsbereich.
...
Mit diesem Befehl wird eine Pipeline namens "ContosoPipeline" im Arbeitsbereich "ContosoWorkspace" erstellt.
Der Befehl basiert auf Der Pipeline basiert auf Informationen in pipeline.jsDatei.
Diese Datei enthält Informationen zu Aktivitäten.
...
Mit diesem Befehl wird eine Pipeline namens "ContosoPipeline" im Arbeitsbereich namens "ContosoWorkspace" über die Pipeline erstellt.
Der Befehl basiert auf Informationen in der pipeline.jsDatei.
Diese Datei enthält Informationen zu Aktivitäten.
