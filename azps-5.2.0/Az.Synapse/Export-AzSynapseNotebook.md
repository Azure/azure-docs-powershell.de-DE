...
## BESCHREIBUNG
Das **Cmdlet "Export-AzSynapseNotebook"** exportiert ein Azure Synapse-Notizbuch in eine Notizbuchdatei (IPYNB). Der Name des Notizbuchs wird zum Namen der exportierten Datei. Wenn Sie den Namen eines Notizbuchs angeben, exportiert das Cmdlet dieses Notizbuch. Wenn Sie keinen Namen angeben, exportiert das Cmdlet alle Notizbücher im Arbeitsbereich.
...
Exportiert ein einzelnes Notizbuch namens "ContosoNotebook" im Arbeitsbereich "ContosoWorkspace" über die Pipeline in den Ordner "C:\Notebook".
...
### -OutputFolder
Der Ordner, in dem das Notizbuch abgelegt werden soll.
