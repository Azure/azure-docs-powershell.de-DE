...
## BESCHREIBUNG
Das **Cmdlet "Invoke-AzSynapseSparkStatement"** ruft eine Synapse Analytics Spark-Anweisung auf.
...
Mit diesen Befehlen wird eine Sparksitzung gestartet und dann über die Pipeline eine Inline -Spark-Anweisung aufgerufen.
...
Mit diesen Befehlen wird eine Sparksitzung gestartet und dann die Sparkanweisungen in einer Datei aufgerufen.
...
### -Response
Gibt an, dass eine vollständige Antwort zurückgeben werden soll.
