...
## BESCHREIBUNG
Das **Cmdlet "Start-AzSynapseTrigger"** startet einen Trigger in einem Arbeitsbereich. Wenn sich der Trigger im Zustand "Stopped" befindet, startet das Cmdlet den Trigger und ruft schließlich Basierend auf seiner Definition Pipelines auf. Wenn sich der Trigger bereits im Zustand "Gestartet" befindet, hat dieses Cmdlet keine Auswirkung.
