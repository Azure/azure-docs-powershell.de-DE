...
Den Überarbeitungsverlauf der spezifischen Reservierung erhalten
...
### -Reservierung
Objektparameter 'Pipe' für `Reservation` s
...
### -ReservationId
Reservierungs-ID des `Reservation` Verlaufs, der angezeigt werden soll
...
### -ReservationOrderId
"ReservationOrderId" für `ReservationOrder` das, das die `Reservation`
