...
## BESCHREIBUNG
Liste aller `ReservationOrder` S, auf die der Benutzer im aktuellen Mandanten zugreifen kann. Wenn der Parameter "ReservationOrderId" festgelegt ist, erhalten Sie diesen spezifischen "ReservationOrder".
