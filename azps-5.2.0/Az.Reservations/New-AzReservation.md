...
## BESCHREIBUNG
Eine Reservierungsinstanz kaufen und Vorteil erhalten
...
Nach der Berechnung des Preises könnte der Kunde einen Purcahse-Wert, den RI über "calculatePrice"
...
### -DisplayName
Anzeigename für den Benutzer, um die Reservierung einfach zu erkennen.
...
### -ReservationOrderId
ID des zu kaufenden Reservierungsauftrags, von az reservierungsreservierungsauftrag berechnen.
...
Der Typ der Ressource, für die die SKU bereitgestellt werden soll.
