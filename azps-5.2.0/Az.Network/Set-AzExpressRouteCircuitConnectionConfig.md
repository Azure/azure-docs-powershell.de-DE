...
### Beispiel 1: Aktualisieren einer Schaltkreisverbindungsressource für einen vorhandenen ExpressRoute-Schaltkreis
```
...
### Beispiel 2: Festlegen einer Verbindungskonfiguration mit einer Leitung auf einen vorhandenen ExpressRoute-Schaltkreis
```
$circuit_peer = Get-AzExpressRouteCircuit -Name $peeringCircuitName -ResourceGroupName $rg
