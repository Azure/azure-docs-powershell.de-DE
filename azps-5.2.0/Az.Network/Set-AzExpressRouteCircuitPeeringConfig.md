...
## BESCHREIBUNG
Mit **den Cmdlets "Set-AzExpressRouteCircuitPeeringConfig"** wird eine geänderte ExpressRoute-Peeringkonfiguration wieder in Azure gespeichert.

## BEISPIELE

### Beispiel 1: Ändern einer vorhandenen Peeringkonfiguration
```powershell
...
Speichert eine geänderte ExpressRoute-Peeringkonfiguration. (automatisch generiert)
...
### -ExpressRouteCircuit
Das ExpressRoute-Schaltkreisobjekt, das die zu ändernde Peeringkonfiguration enthält.
...
Der Routingregistrierungsname (ROUTING Registry Name, RIR/IRR), für den die AS-Nummer und die Präfixe registriert sind.
...
### -Name
Der Name der zu ändernden Peeringkonfiguration.
