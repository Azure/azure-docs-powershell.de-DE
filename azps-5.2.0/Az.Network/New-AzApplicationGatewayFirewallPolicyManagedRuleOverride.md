...
## BESCHREIBUNG
Die **Neue-AzApplicationGatewayFirewallPolicyManagedRuleOverride** erstellt einen "ruleOverride"-Eintrag.
...
Erstellt einen ruleOverride-Eintrag mit "RuleId" als $ruleId "State" als "Disabled".
...
### -RuleId
Geben Sie die Regel-ID im Eintrag "Regel außer Kraft" an.
...
### -State
Geben Sie die Regel-ID im Eintrag für die Außerkraftsetzungsregel an.
