...
### Beispiel 1: Entfernen eines Zertifikats zur Clientsperrung von einem virtuellen Netzwerkgateway
```powershell
...
Sie können Fingerabdrückinformationen für Ihre Zertifikate zurückgeben, indem Sie einen Windows PowerShell ähnlich dem folgenden verwenden: `Get-ChildItem -Path "Cert:\LocalMachine\Root"`
