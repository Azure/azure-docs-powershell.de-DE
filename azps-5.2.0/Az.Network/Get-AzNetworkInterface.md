...
### Beispiel 1: Alle Netzwerkschnittstellen erhalten
```
...
### Beispiel 2: Alle Netzwerkschnittstellen mit einem bestimmten Bereitstellungszustand erhalten
```
...
Mit diesem Befehl werden alle Netzwerkschnittstellen in der Ressourcengruppe "ResourceGroup1" mit dem Bereitstellungsstatus "Erfolgreich" ruft.

### Beispiel 3: Erhalten von Netzwerkschnittstellen mithilfe von Filtern
```
...
### -VirtualMachineIndex
Gibt den Index des virtuellen Computers für den Skalierungssatz des virtuellen Computers an, aus dem dieses Cmdlet Netzwerkschnittstellen erhält.
...
Gibt den Namen des Skalierungssets für den virtuellen Computer an, aus dem dieses Cmdlet Netzwerkschnittstellen erhält.
