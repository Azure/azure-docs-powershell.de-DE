...
## BESCHREIBUNG
Das **Cmdlet "Set-AzLoadBalancerInboundNatPoolConfig"** legt eine Konfiguration des eingehenden NAT-Pools für einen Lastenausgleich fest.

## BEISPIELE

### Beispiel 1: Festlegen
```powershell
...
### -EnableFloatingIP
Konfiguriert den Endpunkt eines virtuellen Computers für die unverankerte IP-Funktion, die zum Konfigurieren einer SQL AlwaysOn-Verfügbarkeitsgruppe erforderlich ist. Diese Einstellung ist erforderlich, wenn Sie SQL "AlwaysOn-Verfügbarkeitsgruppen" auf einem SQL verwenden. Diese Einstellung kann nach dem Erstellen des Endpunkts nicht mehr geändert werden.
...
Der Timeout für die TCP-Leerlaufverbindung. Der Wert kann zwischen 4 und 30 Minuten festgelegt werden. Der Standardwert ist 4 Minuten. Dieses Element wird nur verwendet, wenn das Protokoll auf TCP festgelegt ist.
