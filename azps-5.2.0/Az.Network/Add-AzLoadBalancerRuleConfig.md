...
## BESCHREIBUNG
Das **Cmdlet "Add-AzLoadBalancerRuleConfig"** fügt einem Azure Load Balancer eine Regelkonfiguration hinzu.
...
Der zweite Befehl verwendet den Pipelineoperator, um den Lastenausgleich in $slb an **Add-AzLoadBalancerRuleConfig** zu übergeben, wodurch die Regelkonfiguration "NewRule" hinzugefügt wird.
...
### -Back-EndPort
Gibt den Back-End-Port für Datenverkehr an, der durch eine Load Balancer-Regelkonfiguration abgestimmt wird.
...
Gibt die Dauer (in Minuten) an, für die der Unterhaltungsstatus im Lastenausgleich beibehalten wird.
...
Dieses Cmdlet fügt dem Lastenausgleich, den dieser Parameter angibt, eine Regelkonfiguration hinzu.
