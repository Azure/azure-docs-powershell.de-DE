...
## BESCHREIBUNG
Das **Cmdlet Set-AzApplicationGatewayBackendAddressPool** aktualisiert einen Back-End-Adresspool für ein Azure-Anwendungsgateway.
Back-End-Adressen können als IP-Adressen, vollqualifizierte Domänennamen (Fully Qualified Domain Names, FQDN) oder ALS IDs für die IP-Konfiguration angegeben werden.
...
Der erste Befehl ruft das Anwendungsgateway namens ApplicationGateway01 in der Ressourcengruppe "ResourceGroup01" ab und speichert es in der $AppGw Variable.
Mit dem zweiten Befehl wird der Back-End-Adresspool des Anwendungsgateways in $AppGw FQDNs aktualisiert.
...
Der zweite Befehl aktualisiert den Back-End-Adresspool des Anwendungsgateways in $AppGw mithilfe von IP-Adressen.

## PARAMETERS

### -ApplicationGateway
Gibt das Anwendungsgateway an, dem dieses Cmdlet den Back-End-Adresspool zu ordnet.
...
### -Back-EndFqdns
Gibt eine Liste der Back-End-IP-Adressen an, die als Back-End-Serverpool verwendet werden.
...
Dieser Back-End-Adresspool muss im Anwendungsgateway vorhanden sein.
