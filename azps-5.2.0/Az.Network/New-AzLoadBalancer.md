...
Beachten Sie, dass in diesem Beispiel nur gezeigt wird, wie ein globaler Lastenausgleich erstellt wird. Sie müssen es auch mit dem cmdlet New-AzLoadBalancerBackendAddressConfig konfigurieren, um dem Back-End-Adresspool die ipconfig-ID des regionalen Lastenausgleichs zuzuordnen.
...
### -InboundNatRule
Gibt eine Liste der Nat (Eingehende Netzwerkadressenübersetzung)-Regeln an, die einem Lastenausgleich zugeordnet werden sollen.
