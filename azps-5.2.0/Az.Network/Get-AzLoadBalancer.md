...
## BESCHREIBUNG
Das **Cmdlet "Get-AzLoadBalancer"** ruft einen oder mehrere Azure Load Balancer ab, die in einer Ressourcengruppe enthalten sind.

## BEISPIELE

### Beispiel 1: Ladenausgleich
```
...
Dieser Befehl ruft den Lastenausgleich mit dem Namen "MyLoadBalancer" ab.
Bevor Sie dieses Cmdlet ausführen können, muss ein Lastenausgleich vorhanden sein.

### Beispiel 2: Auflisten von Lastenausgleichslisten mithilfe von Filtern
```
...
Dieser Befehl ruft alle Lastenausgleichszeilen mit einem Namen ab, der mit "MyLoadBalancer" beginnt.
