...
## BESCHREIBUNG
Das **Cmdlet "Get-AzApplicationGatewayAuthenticationCertificate"** ruft ein Authentifizierungszertifikat für ein Azure-Anwendungsgateway ab.

## BEISPIELE

### Beispiel 1: Erhalten eines angegebenen Authentifizierungszertifikats
```
PS C:\> $appgw = Get-AzApplicationGateway -ResourceGroupName "rg" -Name "appGwName"
PS C:\> $pool = Get-AzApplicationGatewayBackendAddressPool -Name "pool01" -ApplicationGateway $appgw
```

Der erste Befehl ruft das Anwendungsgateway namens "appGwName" ab und speichert es in der $appgw Variable.
Der zweite Befehl ruft das Authentifizierungszertifikat namens "pool01" ab und speichert es in der $pool Variable.

## PARAMETERS

### -ApplicationGateway
Gibt den Namen des Anwendungsgateways an, für das dieses Cmdlet ein Authentifizierungszertifikat erhält.
