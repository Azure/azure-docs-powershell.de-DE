...
Mit dem oben angegebenen Befehl wird eine neue VpnServerConfiguration mit VpnAuthenticationType als Zertifikat erstellt.

### Beispiel 2

Erstellen Sie eine neue VpnServerConfiguration für die Punkt-zu-Website-Konnektivität. (automatisch generiert)
...
### -RadiusServerList
P2S Externe Server mit mehreren Radiusservern.
...
### -RadiusServerSecret
Geheimer Servergeheimnis des externen Radius von P2S.
...
Die Liste der Protokolle zum Tunneln von P2S-VPN-Clients.
...
Eine Liste der VpnClientCertificates, die zu widerrufenden Dateipfaden verwendet werden sollen
