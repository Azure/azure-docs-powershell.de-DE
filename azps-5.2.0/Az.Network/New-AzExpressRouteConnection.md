...
## BESCHREIBUNG
Erstellt eine ExpressRoute-Verbindung zwischen einem lokalen BGP-Schaltkreis-Peering und dem ExpressRoute-Gateway in einem virtuellen Hub.
...
Im vorstehenden Beispiel wird eine Ressourcengruppe, ein virtuelles WAN, ein virtuelles Netzwerk, ein virtueller Hub, ein ExpressRoute-Gateway und ein ExpressRoute-Schaltkreis mit privatem Peering in der Ressourcengruppe "testRG" in Azure in der Mitte der USA erstellt. Sobald das Gateway erstellt wurde, wird es mithilfe des Befehls "New-AzExpressRouteConnection mit dem ExpressRoute-Schaltkreis-Peering verbunden.
...
### -AuthorizationKey
Ein Schlüssel vom Besitzer des ExpressRoute-Schaltkreises, um in der Lage zu sein, eine Verbindung mit einem Gateway in einem anderen Abonnement herzustellen.
...
Die Ressourcen-ID des ExpressRoute Circuit Peerings, zu dem diese ExpressRoute-Gatewayverbindung erstellt werden soll.
...
Das übergeordnete ExpressRouteGateway für diese Verbindung.
...
### -RoutingWeight
Die Gewichtung für das Paketrouting, die dieser Verbindung zugewiesen werden muss.
