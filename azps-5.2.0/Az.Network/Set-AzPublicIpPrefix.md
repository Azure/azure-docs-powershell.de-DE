...
### Festlegen der Tags für das Präfix "Public IP"
```powershell
...
Der erste Befehl ruft ein vorhandenes öffentliches IP-Präfix ab, der zweite Befehl legt die Tageigenschaft fest, und der dritte Befehl aktualisiert das vorhandene Objekt.
