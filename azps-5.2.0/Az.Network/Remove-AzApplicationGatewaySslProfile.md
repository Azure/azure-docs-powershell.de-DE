...
## SYNOPSIS
Entfernt das Ssl-Profil von einem Anwendungsgateway.
...
Der erste Befehl ruft ein Anwendungsgateway namens ApplicationGateway01 ab, das zur Ressourcengruppe "ResourceGroup01" gehört, und speichert es in der $AppGw Variable. Mit dem zweiten Befehl wird das ssl-Profil mit dem Namen "SslProfile01" aus dem Anwendungsgateway entfernt, das in $AppGw.
