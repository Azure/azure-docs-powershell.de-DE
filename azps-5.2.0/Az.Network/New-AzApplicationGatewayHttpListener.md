...
Dieser Befehl erstellt einen HTTP-Listener namens Listener01 und speichert das Ergebnis in der Variablen namens $Listener.
...
Mit diesem Befehl wird ein HTTP-Listener erstellt, der das AUSLADEN von SSL verwendet und das Zertifikat in der Variablen $SSLCert 01 anfordert.
...
Mit diesem Befehl wird ein HTTP-Listener erstellt, der das SSL-Ausladen verwendet und das $SSLCert 01-Zertifikat zusammen mit zwei HostNames in der Variablen anfordert.
Der Befehl speichert das Ergebnis in der Variablen namens $Listener.
...
$firewallPolicy = New-AzApplicationGatewayFirewallPolicy -Name "wafPolicy1" -ResourceGroup "rgName" Auf eine Firewallrichtlinie, die mit dem obigen Befehlslet erstellt wurde, kann auf Pfadregelebene verwiesen werden. Der oben beschriebene Befehl würde eine Standardrichtlinieneinstellungen und verwaltete Regeln erstellen.
