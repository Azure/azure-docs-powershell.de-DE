...
## BESCHREIBUNG
**Das Cmdlet "Add-AzApplicationGatewayRequestRoutingRule"** erstellt eine Anforderungsroutingregel für ein Azure-Anwendungsgateway.

## BEISPIELE

### Beispiel 1: Erstellen einer Anforderungsroutingregel für ein Anwendungsgateway
```
...
Dieser Befehl erstellt eine einfache Anforderungsroutingregel namens "Regel01" und speichert das Ergebnis in der Variablen namens $Rule.

## PARAMETERS

### -BackendAddressPool
Gibt den Back-End-Adresspool als Objekt an, der von der Anforderungsroutingregel erstellt werden soll.
...
Gibt die Back-End-Adresspool-ID der zu erstellenden Anforderungsroutingregel an.
...
Gibt die Back-End-HTTP-Einstellungen als Objekt an, das von der Anforderungsroutingregel erstellt werden soll.
...
Gibt die Back-End-HTTP-Einstellungs-ID der zu erstellenden Anforderungsroutingregel an.
...
### -HttpListener
Gibt den Back-End-HTTP-Listener für die zu erstellende Anforderungsroutingregel an.
...
### -HttpListenerId
Gibt die Back-End-HTTP-Listener-ID für die zu erstellende Anforderungsroutingregel an.
...
### -Name
Gibt den Namen der Anforderungsroutingregel an, die von diesem Cmdlet erstellt wird.
