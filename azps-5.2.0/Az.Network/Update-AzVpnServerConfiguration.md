...
Mit dem oben angegebenen Befehl wird eine vorhandene VpnServerConfiguration mit VpnProtocol als IkeV2 aktualisiert.
...
### -InputObject
Das vpn-Server-Konfigurationsobjekt, das geändert werden soll
...
### -ResourceId
Die Azure-Ressourcen-ID für die Vpn-Server-Konfiguration.
