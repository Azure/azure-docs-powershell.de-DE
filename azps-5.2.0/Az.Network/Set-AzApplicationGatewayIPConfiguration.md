...
Der erste Befehl ruft das virtuelle Netzwerk VNet01 ab, das zur Ressourcengruppe "ResourceGroup01" gehört, und speichert es in der $VNet Variable.
Der zweite Befehl ruft die Subnetzkonfiguration namens Subnetz01 mithilfe $VNet und speichert sie in der $Subnet Variable.
Der dritte Befehl ruft ein Anwendungsgateway namens ApplicationGateway01 ab, das zur Ressourcengruppe "ResourceGroup01" gehört, und speichert es in der $AppGw Variable.
Mit dem vierten Befehl wird die IP-Konfiguration des anwendungsgateways, das in $AppGw gespeichert ist, auf die In-Subnetz-Konfiguration, die in $Subnet.
