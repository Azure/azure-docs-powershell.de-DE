...
Die Konfiguration wird dann mit diesem Befehlslet heruntergeladen.

Wenn das Befehlslet erfolgreich ist, wird die Downloadkonfiguration in das blob geschrieben, das von "SignedSasUrl" angegeben wird.
