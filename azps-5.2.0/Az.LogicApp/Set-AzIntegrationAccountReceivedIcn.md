...
## SYNOPSIS
Aktualisiert das Integrationskonto, für das die Interchange Control Number (ICN) in der Azure-Ressourcengruppe verwendet wird.
...
## BESCHREIBUNG
Das Set-AzIntegrationAccountGeneratedIcn Cmdlet aktualisiert ein vorhandenes Integrationskonto mit der Empfangenen Interchange Control Number (ICN) und gibt ein Objekt zurück, das die empfangene Interchangesteuerelementnummer des Integrationskontos darstellt.
...
Sie können mit diesem Befehl kein neues Integrationskonto erstellen, das die Nummer des Austauschsteuerelements erhält.
Wenn Sie die dynamischen Parameter verwenden möchten, geben Sie sie einfach in den Befehl ein, oder geben Sie ein Bindestrichzeichen(-) ein, um einen Parameternamen anzugeben, und drücken Sie dann wiederholt die TAB-TASTE, um die verfügbaren Parameter zu durchschreiben.
