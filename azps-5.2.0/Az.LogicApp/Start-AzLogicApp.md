...
Mit diesem Befehl wird die Logik-App in der Ressourcengruppe "ResourceGroup11" ausgeführt.
...
### -Name
Gibt den Namen der Logik-App an, die dieses Cmdlet startet.
...
### -ResourceGroupName
Gibt den Namen der Ressourcengruppe an, die die Logik-App enthält, die dieses Cmdlet startet.
...
### -TriggerName
Gibt den Namen des Triggers der Logik-App an, die dieses Cmdlet startet.
