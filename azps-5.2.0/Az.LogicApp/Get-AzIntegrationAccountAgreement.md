...
## BESCHREIBUNG
Das **Cmdlet "Get-AzIntegrationAccountAgreement"** ruft einen Integrationskontovertrag aus einer Azure-Ressourcengruppe ab.
...
### Beispiel 1: Erhalten einer Vereinbarung für ein Integrationskonto
```
...
Dieser Befehl ruft einen Integrationskontovertrag namens "IntegrationAccountAgreement06" ab.

### Beispiel 2: Erhalten von Integrationskontovereinbarungen nach Dem Namen der Ressourcengruppe
```
...
Dieser Befehl ruft die Verträge für das Integrationskonto nach dem Namen der Ressourcengruppe ab.

## PARAMETERS

### -AgreementName
Gibt den Namen eines Vertrags für ein Integrationskonto an.
