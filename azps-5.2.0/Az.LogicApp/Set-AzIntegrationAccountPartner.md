...
## BESCHREIBUNG
Das **Cmdlet "Set-AzIntegrationAccountPartner"** ändert einen Integrationskontopartner.
Dieses Cmdlet gibt ein Objekt zurück, das den Integrationskontopartner darstellt.
Geben Sie den Namen des Integrationskontos, den Namen der Ressourcengruppe und den Namen des Partners an.
...
### Beispiel 1: Ändern eines Integrationskontopartners
```powershell
...
Mit diesem Befehl wird der Integrationskontopartner "IntegrationAccountPartner22" in der angegebenen Ressourcengruppe geändert.

### Beispiel 2

Ändert einen Integrationskontopartner. (automatisch generiert)
...
### -BusinessIdentities
Gibt Geschäftsidentitäten für den Integrationskontopartner an.
...
### -PartnerName
Gibt den Namen des Integrationskontopartners an.
...
### -PartnerType
Gibt den Typ des Integrationskontos an.
