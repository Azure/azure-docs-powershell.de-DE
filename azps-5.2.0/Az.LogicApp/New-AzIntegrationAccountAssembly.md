...
Erstellt eine neue Assembly unter Verwendung der lokalen Datei, die sich im Dateipfad in "$localAssemblyFilePath" befindet.
...
Erstellt eine neue Assembly mit dem byte-Array, das in "$assemblyContent" enthalten ist.
...
Erstellt eine neue Assembly mithilfe der Bytedaten, die sich unter der URL "$assemblyUrl" befinden. Dies ist die vorgeschlagene Methode zum Erstellen großer Assemblys.
