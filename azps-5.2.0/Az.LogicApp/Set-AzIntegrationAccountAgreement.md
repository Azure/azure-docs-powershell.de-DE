...
## BESCHREIBUNG
Das **Cmdlet Set-AzIntegrationAccountAgreement** ändert eine Vereinbarung für ein Integrationskonto.
Dieses Cmdlet gibt ein Objekt zurück, das den Vertrag für das Integrationskonto darstellt.
Geben Sie den Namen des Integrationskontos, den Namen der Ressourcengruppe und den Vertragsnamen an.
...
### Beispiel 1: Aktualisieren einer Vereinbarung für ein Integrationskonto
```powershell
...
Mit diesem Befehl wird eine Vereinbarung für ein Integrationskonto in der angegebenen Azure-Ressourcengruppe aktualisiert.

### Beispiel 2

Ändert einen Vertrag für ein Integrationskonto. (automatisch generiert)
...
### -AgreementName
Gibt den Namen des Vertrags für das Integrationskonto an.
...
### -AgreementType
Gibt den Typ des Vertrags für das Integrationskonto an.
