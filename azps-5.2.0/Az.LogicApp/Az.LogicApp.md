...
# Az.LogicApp-Modul
## Beschreibung
In diesem Thema werden Hilfethemen für die Cmdlets für Logik-Apps angezeigt.
...
Ruft einen Vertrag für ein Integrationskonto ab.
...
Ruft die Rückruf-URL für das Integrationskonto ab.
...
Ruft Schemas für Integrationskonto ab.
...
Ruft die Auslöser einer Logik-App ab.

### [Get-AzLogicAppTriggerCallbackUrl](Get-AzLogicAppTriggerCallbackUrl.md)
Ruft eine Rückruf-URL für den Trigger der Logik-App ab.
...
Erstellt ein Zertifikat für das Integrationskonto.
...
Entfernt einen Vertrag für ein Integrationskonto.
...
Entfernt die Batchkonfiguration eines Integrationskontos.

### [Remove-AzIntegrationAccountCertificate](Remove-AzIntegrationAccountCertificate.md)
Entfernt ein Zertifikat für ein Integrationskonto aus einer Ressourcengruppe.
...
Dieses Cmdlet entfernt eine bestimmte empfangene Austauschsteuerelementnummer pro Vertrag und Steuerelementnummerwert.

### [Remove-AzIntegrationAccountSchema](Remove-AzIntegrationAccountSchema.md)
Entfernt ein Schema für ein Integrationskonto.
...
Ändert eine Vereinbarung für ein Integrationskonto.
...
Ändert das Zertifikat eines Integrationskontos.
