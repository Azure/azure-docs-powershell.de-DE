...
### Beispiel 2: Erstellt einen neuen Dienst für Azure-Gesundheitswesenapis mit dem Namen "MyService" in der Ressourcengruppe "MyResourceGroup" an einem Speicherort "westus2" mit einem Durchsatz des Abonnements "400" und dem Schlüsseltresorschlüssel-URI "https:// \<my-keyvault> \<my-key> .vault.azure.net/keys/"
```powershell
...
### -CorsMethod
HealthcareApis F vor der Dienstliste von "Cors".
