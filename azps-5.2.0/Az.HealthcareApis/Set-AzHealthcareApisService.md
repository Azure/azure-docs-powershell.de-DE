...
### Beispiel 2: Aktualisiert den vorhandenen Dienst "MyService" im Gesundheitswesen in der Ressourcengruppe "MyResourceGroup" mit dem "aktualisierungsdb OfferThroughput = 500" und dem Schlüsseltresorschlüssel -URI "https:// \<my-keyvault> \<my-key> .vault.azure.net/keys/"
...
### -CorsHeader
HealthcareApis F vordienst-Liste der Kors-Kopfzeilen.
...
### -KeyVaultKeyUri
HealthcareApis F vor DienstschnursKeyVaultKeyUri.
...
### -DisableMethProxy
HealthcareApis F vor dem DeaktivierenBenachrichtigungsservice.
...
### -EnableMethProxy
HealthcareApis FserviceService EnableApiProxy.
...
### -ResourceId
HealthcareApis F vor dem Dienst "ResourceId".
