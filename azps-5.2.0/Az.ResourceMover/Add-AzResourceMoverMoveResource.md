...
### Beispiel 1: Hinzufügen einer Ressource zur Sammlung "Verschieben".
```powershell
...
Hinzufügen einer Ressource zur Sammlung zum Verschieben innerhalb des angegebenen Abonnements
...
### -DependsOnOverride
Ruft die Außerkraftsetzungen der Verschieberessourcenabhängigkeiten ab oder legt sie fest.
Informationen zum Erstellen finden Sie im Abschnitt "NOTES" zu DEN DEPENDSONOVERRIDE-Eigenschaften und zum Erstellen einer Hashtabelle.
...
### -ExistingTargetId
Ruft die vorhandene Ziel-ID ARM der Ressource ab oder legt sie fest.
...
Der Ressourcentyp.
Der Wert kann z. B. "Microsoft.Compute/virtualMachines" sein.
...
Ruft den Zielressourcennamen ab oder legt den Namen fest.
...
### -SourceId
Ruft die Quell-ARM-ID der Ressource ab oder legt sie fest.
...
DEPENDSONOVERRIDE <IMoveResourceDependencyOverride[]>: Ruft Außerkraftsetzungen für die Abhängigkeiten der Verschieberessourcen ab oder legt sie fest.
  - `[Id <String>]`: Ruft die ARM der abhängigen Ressource ab oder legt sie fest.
  - `[TargetId <String>]`: Ruft die Ressourcen-ID ARM der "MoveResource" oder der ARM der abhängigen Ressource ab oder legt sie fest.
