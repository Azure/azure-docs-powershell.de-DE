...
## BESCHREIBUNG
Das Add-AzAttestationPolicySigner cmdlet fügt einen vertrauenswürdigen Richtlinien signer für einen Mandanten in Azure Attestation hinzu.
...
Fügen Sie einen vertrauenswürdigen Signer für den Atteestation-Anbieter namens *"pshtest" hinzu.*
...
### -Signer
Gibt das RFC7519-JSON-Webtoken an, das einen Anspruch namens "maa-policyCertificate" enthält, dessen Wert ein RFC7517 JSON-Webschlüssel ist, der einen neuen vertrauenswürdigen Signaturschlüssel enthält, den Sie hinzufügen möchten.
