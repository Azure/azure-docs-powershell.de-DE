...
## BESCHREIBUNG
Das Remove-AzAttestation cmdlet löscht den angegebenen Nachweis.
...
Löschen Sie den Nachweisanbieter namens *"pshtest3"* in der Ressourcengruppe *"psh-test-rg"* aus dem aktuellen Abonnement.
...
### -InputObject
Das zu löschende Nachweisobjekt.
...
### -Name
Gibt den Namen des zu entfernenden Nachweises an.
...
### -ResourceGroupName
Gibt den Namen der Ressourcengruppe an, die für den zu entfernenden Azure-Nachweis entfernt werden soll.
