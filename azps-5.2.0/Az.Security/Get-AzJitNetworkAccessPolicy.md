...
## BESCHREIBUNG
Mit Just In Time (JIT)-Netzwerkzugriffsrichtlinien können Sie eine Richtlinie definieren, mit der einfache Benutzer eine temporäre Netzwerkverbindung zu einer VM erstellen können.
...
In der Richtlinie sehen Sie auch die Verbindungsanforderung, die mit dieser Richtlinie hergestellt wurde. 
