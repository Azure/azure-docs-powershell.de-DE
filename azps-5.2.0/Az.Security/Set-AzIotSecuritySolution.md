...
## BESCHREIBUNG
Das Set-AzIotSecuritySolution erstellt oder aktualisiert eine bestimmte iot-Sicherheitslösung. Die Sicherheitslösung für das Internet (IoT) sammelt Sicherheitsdaten und Ereignisse von iot-Geräten und dem iot-Hub, um Bedrohungen zu verhindern und zu erkennen.
Der Name der iot-Sicherheitslösung sollte mit dem Namen des iot-Hubs identisch sein.
...
Erstellen Sie die neue iot-Sicherheitslösung "MySample" für den IoT-Hub mit der Ressourcen-ID "/subscriptions/XXXXXXXX-XXXX-XXXXX-XXXXXXXXXXXX/resourceGroups/MichalResourceGroup/providers/Microsoft.Devices/IotHubs/MySample" (der Name der Lösung sollte mit dem Namen des IoT-Hubs identisch sein)
