...
## BESCHREIBUNG
Das New-AzMapsAccountKey cmdlet generiert einen API-Schlüssel für ein Azure Maps-Konto erneut.
...
Generiert den primären API-Schlüssel für das Konto "MyAccount" in der Ressourcengruppe "MyResourceGroup" erneut.
