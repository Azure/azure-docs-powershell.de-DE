...
### Beispiel 1: Wiederherstellen eines PostgreSql-Servers mithilfe von GeoReplica Restore
```powershell
...
Dieses Cmdlet stellt den Server von PostgreSql mithilfe von GeoReplica Restore wieder zur Wiederherstellen wieder.

### Beispiel 2: Wiederherstellen des PostgreSql-Servers mithilfe der PointInTime-Wiederherstellung
```powershell
...
Diese Cmdlets stellen den Server von PostgreSql mithilfe der PointInTime-Wiederherstellung wieder zur Wiederherstellen.
