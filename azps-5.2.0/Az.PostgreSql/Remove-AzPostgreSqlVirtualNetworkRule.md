...
### Beispiel 1: Entfernen der virtuellen Netzwerkregel des PostgreSqlservers nach Name
```powershell
PS C:\> Remove-AzPostgreSqlVirtualNetworkRule -Name vnet -ResourceGroupName PostgreSqlTestRG -ServerName PostgreSqlTestServer

```

Dieses Cmdlet entfernt die virtuelle Netzwerkregel des PostgreSql-Servers nach Name.

### Beispiel 2: Entfernen der virtuellen Netzwerkregel des PostgreSqlservers nach Identität
```powershell
...
Mit diesen Cmdlets wird die virtuelle Netzwerkregel für den PostgreSqlserver nach Identität entfernt.
