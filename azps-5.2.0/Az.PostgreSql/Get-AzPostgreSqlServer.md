...
### Beispiel 1: Server von PostgreSql mit Standardkontext erhalten
```powershell
...
Dieses Cmdlet ruft "PostgreSql-Server" nach Ressourcengruppe und Servername ab.
...
### Beispiel 4: "PostgreSql-Server nach Identität erhalten"
```powershell
...
Diese Cmdletlisten ruft den PostgreSql-Server nach Identität ab.
