...
## BESCHREIBUNG
Mit diesem Cmdlet wird eine verwaltete Clusterressource ohne Knotentypen erstellt. Zum Bootstrapen des Clusters muss ein Primärknotentyp hinzugefügt werden. Verwenden Sie ["New-AzServiceFabricManagedNodeType".](./New-AzServiceFabricManagedNodeType.md)
...
Mit diesem Befehl wird eine Clusterressource mit einer Standard-SKU erstellt.
...
Mit diesem Befehl wird eine Clusterressource in zentraluseuap mit einem anfänglichen Administratorclientzertifikat und einer Standard-SKU erstellt.

## PARAMETERS

### -AdminPassword
Administratorkennwort für die virtuellen Computer.
...
Gemeinsamer Name des Clientzertifikats.
...
### -ClientCertIsAdmin
Wird verwendet, um anzugeben, ob das Clientzertifikat über Administratorebene verfügt.
...
Liste der Ausstellerdrückdrucke für das Clientzertifikat.
Wird nur in Kombination mit ClientCertCommonName verwendet.
...
Fingerabdruck des Clientzertifikats.
...
Wird nur verwendet, wenn der Upgrademodus manuell ist.
...
Endpunkt, der vom Reverseproxy verwendet wird.
...
### -SKU
Die Cluster-SKU, die Optionen sind "Standard": Sie hat mindestens drei Startknoten und lässt nur einen Knotentyp und "Standard" zu: Sie hat mindestens fünf Startknoten und lässt mehrere Knotentypen zu.
