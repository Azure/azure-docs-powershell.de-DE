...
## BESCHREIBUNG
Fügen Sie dem Knotentyp die Erweiterung "vm" hinzu. Dadurch wird die Erweiterung der nicht mehr vorhandenen Ressource "Virtual Machine Scale Set" hinzugefügt.
...
Mit diesem Befehl wird dem Knotentyp eine Erweiterung hinzugefügt.
...
Mit diesem Befehl wird dem Knotentyp eine Erweiterung mit Einstellungen und geschützten Einstellungen hinzugefügt.
...
Mit diesem Befehl wird dem Knotentyp eine Erweiterung mit Piping hinzugefügt.
...
### -ForceUpdateTag
Wenn ein Wert angegeben wird und sich vom vorherigen Wert abwechselt, ist der Erweiterungshandler gezwungen, auch dann zu aktualisieren, wenn sich die Erweiterungskonfiguration nicht geändert hat.
...
Dies kann das Get-AzVMImagePublisher cmdlet verwenden, um den Herausgeber zu erhalten.
...
Sie können das cmdlet Get-AzVMExtensionImageType, um den Erweiterungstyp zu erhalten.
