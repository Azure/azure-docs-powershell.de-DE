...
## BESCHREIBUNG
Erstellt eine Softwareupdatekonfiguration, die nach einem Zeitplan zum Aktualisieren einer Liste von Computern ausgeführt wird. Computer umfassen sowohl virtuelle Azure-Computer als auch Nicht-Az-Computer.

## BEISPIELE

### Beispiel 1
Erstellt einmal am Samstag 21:00 Uhr eine Softwareupdatekonfiguration, um wichtige Updates auf zwei virtuellen Windows Azure-Computern zu installieren. In diesem Beispiel ist die Aktualisierungsdauer auf 2 Stunden festgelegt.
...
### -AzureQuery
Dynamische Gruppen-Azure-Abfrage.
...
### -ExcludedKbNumber
KB-Nummern ausgeschlossener Aktualisierungen.
...
### -IncludedKbNumber
KB-Nummern enthaltener Updates.
...
Windows Update-Klassifizierungen enthalten.
...
### -Linux
Gibt an, dass die Softwareupdatekonfiguration für die Computer des Betriebssystems Linux verwendet wird.
...
### -Schedule
Planen sie das Objekt, das für die Softwareupdatekonfiguration verwendet wird.
...
### -Windows
Gibt an, dass die Softwareupdatekonfiguration für Die Computer des Betriebssystems Windows verwendet wird.
