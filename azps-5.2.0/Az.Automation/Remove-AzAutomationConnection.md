...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzAutomationConnection"** entfernt eine Verbindung aus der Azure-Automatisierung.
...
Mit diesem Befehl wird ein Zertifikat namens "ContosoConnection" im Automatisierungskonto namens "Contoso17" entfernt.

## PARAMETERS

### -AutomationAccountName
Gibt den Namen des Automatisierungskontos an, für das dieses Cmdlet eine Verbindung entfernt.
...
### -Name
Gibt den Namen der Verbindung an, die von diesem Cmdlet entfernt wird.
