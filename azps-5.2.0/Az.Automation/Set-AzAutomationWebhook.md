...
### Beispiel 1: Deaktivieren eines Webhook
```powershell
PS C:\>Set-AzAutomationWebhook -Name "Webhook01" -ResourceGroup "ResourceGroup01" -AutomationAccountName "AutomationAccount01" -IsEnabled $False
```

Mit diesem Befehl wird ein Webhook namens "Webhook01" im Automatisierungskonto mit dem Namen "AutomationAccount01" deaktiviert.
...
Dieser Befehl legt den Wert für "Run on" für den Webhook fest und erzwingt die Ausführung des Runbooks in einer Hybrid-Worker-Gruppe namens Windows.
...
Dieser Befehl aktualisiert den Run on-Wert für den Webhook und erzwingt die Ausführung des Runbook für einen Azure Runbook-Worker. 

## PARAMETERS

### -AutomationAccountName
Gibt den Namen eines Automatisierungskontos an, bei dem dieses Cmdlet einen Webhook ändert.
...
### -Name
Gibt einen Namen des Webhook an, den dieses Cmdlet ändert.
