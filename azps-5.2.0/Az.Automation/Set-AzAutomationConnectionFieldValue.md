...
## BESCHREIBUNG
Das **Cmdlet "Set-AzAutomationConnectionFieldValue"** ändert den Wert eines Felds in einer Verbindung in der Azure-Automatisierung.

## BEISPIELE

### Beispiel 1: Ändern eines Feldwerts in einer Verbindung
```
...
Mit diesem Befehl wird die Abonnement-ID für die Azure-Verbindung namens "ContosoConnection" im Automatisierungskonto namens "AutomationAccount01" geändert.

## PARAMETERS

### -AutomationAccountName
Gibt den Namen des Automatisierungskontos an, für das dieses Cmdlet ein Feld in einer Verbindung ändert.
...
### -Name
Gibt einen Namen für die Verbindung an, für die dieses Cmdlet ein Feld ändert.
...
### -ResourceGroupName
Gibt den Namen der Ressourcengruppe an, für die dieses Cmdlet ein Feld in einer Verbindung ändert.
