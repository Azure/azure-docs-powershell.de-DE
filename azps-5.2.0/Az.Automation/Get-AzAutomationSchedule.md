...
## BESCHREIBUNG
Das **Cmdlet "Get-AzAutomationSchedule"** ruft einen Azure-Automatisierungszeitplan ab.

## BEISPIELE

### Beispiel 1: Einen Zeitplan erhalten
```
PS C:\>Get-AzAutomationSchedule -AutomationAccountName "Contoso17" -Name "DailySchedule08" -ResourceGroupName "ResourceGroup01"
```

Dieser Befehl ruft den Zeitplan namens "DailySchedule08" ab.

## PARAMETERS

### -AutomationAccountName
Gibt den Namen eines Automatisierungskontos an, für das dieses Cmdlet einen Zeitplan erhalten soll.
