...
### Beispiel 15: Anzeigen von Richtlinienereignissen im aktuellen Abonnementbereich mit den Abfrageoptionen "Von" und "An"
```powershell
...
Der Befehl gibt nur die Anzahl der Richtlinienereigniseinträge zurück, die innerhalb der Eigenschaft "AdditionalProperties" zurückgegeben wird.
