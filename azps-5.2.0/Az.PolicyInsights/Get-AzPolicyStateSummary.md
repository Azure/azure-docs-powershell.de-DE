...
## BESCHREIBUNG
Ruft eine Zusammenfassung der neuesten Nummern des Richtlinienkonformitätsstatus in verschiedenen Bereichen ab, aufgeschlüsselt in Richtlinienzuweisungen und Richtliniendefinitionen. Sie enthält nur nicht kompatible Richtlinienzustände.

## BEISPIELE

### Beispiel 1: Aktuelle Zusammenfassung der nicht kompatiblen Richtlinienzustände im aktuellen Abonnementbereich erhalten
```powershell
...
### Beispiel 3: Holen Sie sich die neueste Zusammenfassung der nicht kompatiblen Richtlinienzustände im Bereich der Verwaltungsgruppe.
```powershell
...
### Beispiel 4: Erhalten der aktuellen Zusammenfassung nicht kompatibler Richtlinienzustände im Bereich "Ressourcengruppe" im aktuellen Abonnement
```powershell
...
### Beispiel 5: Erhalten der neuesten Zusammenfassung der nicht kompatiblen Richtlinienzustände im Bereich "Ressourcengruppe" im angegebenen Abonnement
```powershell
...
### Beispiel 11: Aktuelle Zusammenfassung der nicht kompatiblen Richtlinienzustände für eine Richtlinienzuweisung im aktuellen Abonnement erhalten
```powershell
...
### Beispiel 12: Aktuelle Zusammenfassung der nicht kompatiblen Richtlinienzustände für eine Richtlinienzuweisung im angegebenen Abonnement erhalten
```powershell
