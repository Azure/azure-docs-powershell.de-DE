...
Ruft die letzten Datensätze zum Richtlinienstatus ab, die am letzten Tag für die angegebene Ressource generiert wurden.
...
Ruft die neuesten Datensätze zum Richtlinienstatus ab, die am letzten Tag für alle Ressourcen (innerhalb des Mandanten im aktuellen Sitzungskontext) generiert wurden, die von der angegebenen Richtlinienzuweisung (die im Abonnement im aktuellen Sitzungskontext vorhanden ist) ausgeführt werden.
...
Ruft die neuesten Datensätze zum Richtlinienstatus ab, die am letzten Tag für alle Ressourcen im Abonnement im aktuellen Sitzungskontext generiert wurden. Der Befehl ordnet die Ergebnisse nach Zeitstempel und Eigenschaften von Richtlinienzuordnungsnamen an und nimmt nur die obersten 5 der in dieser Reihenfolge aufgelisteten Ergebnisse an.
...
Ruft die neuesten Datensätze zum Richtlinienstatus ab, die innerhalb des datumsbezogenen Bereichs generiert werden, der für alle Ressourcen innerhalb des Abonnements im aktuellen Sitzungskontext angegeben ist.
...
Der Befehl gibt nur die Anzahl der Richtlinienstatusdatensätze zurück, die innerhalb der Eigenschaft "AdditionalProperties" zurückgegeben wird.

### Beispiel 19: Erhalten der neuesten Richtlinienzustände im aktuellen Abonnementbereich mit Angeben der Gruppierung "Anwenden" mit Aggregation
```powershell
...
### Beispiel 21: Erhalten der neuesten Richtlinienzustände im aktuellen Abonnementbereich mit "Anwenden" für mehrere Gruppierungen
```powershell
...
Mindestens ein durch Kommas getrennte Spaltennamen mit einem optionalen "Desc" (Standard) oder "asc".
...
### -Select
Auswählen eines Ausdrucks mithilfe der OData-Notation.
Einen oder mehrere durch Kommas getrennte Spaltennamen.
