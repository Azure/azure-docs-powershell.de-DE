...
### Beispiel 1: Entfernen eines Windows -IoT-Diensts nach Name
```powershell
PS C:\> Remove-AzWindowsIotServicesDevice -Name wsi-t03 -ResourceGroupName azure-rg-test

```

Mit diesem Befehl werden Windows -IoT-Dienste nach Name entfernt.

### Beispiel 2: Entfernen eines Windows -IoT-Diensts per Pipeline
```powershell
...
Mit diesem Befehl wird ein Windows -IoT-Dienst per Pipeline entfernt.
