...
## BESCHREIBUNG
Das **Cmdlet "Set-AzManagedApplicationDefinition"** aktualisiert verwaltete Anwendungsdefinitionen
...
Mit diesem Befehl wird die Beschreibung der Definition verwalteter Anwendungen aktualisiert.

### Beispiel 2

Aktualisiert die Definition verwalteter Anwendungen. (automatisch generiert)
...
### -Authorization
Die Autorisierung für verwaltete Anwendungsdefinitionen.
Durch Kommas getrennte Autorisierungspaare in einem Format \<principalId\> von:\<roleDefinitionId\>
...
### -Beschreibung
Beschreibung der verwalteten Anwendungsdefinition
...
### -DisplayName
Anzeigename der verwalteten Anwendungsdefinition.
...
### -PackageFileUri
Der URI für verwaltete Anwendungsdefinitionspaketdateien.
