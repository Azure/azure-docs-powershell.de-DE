...
## BESCHREIBUNG
Das **Cmdlet "Save-AzManagementGroupDeploymentTemplate"**  speichert eine Bereitstellungsvorlage in einer JSON-Datei für eine Bereitstellung bei einer Verwaltungsgruppe.
...
### Beispiel 2: Erhalten einer Bereitstellung und Speichern der Vorlage
```
...
Dieser Befehl ruft die Bereitstellung "RolesDeployment" bei der Verwaltungsgruppe "myMG" ab und speichert die Vorlage.
