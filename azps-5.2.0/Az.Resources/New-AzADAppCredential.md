...
## BESCHREIBUNG
Das New-AzADAppCredential cmdlet kann zum Hinzufügen neuer Anmeldeinformationen oder zum Roll von Anmeldeinformationen für eine Anwendung verwendet werden.
Die Anwendung wird durch Angabe der Anwendungsobjekt-ID oder Anwendungs-ID identifiziert.

## BEISPIELE

### Beispiel 1: Erstellen einer neuen Anmeldeinformationen für eine Anwendung mithilfe eines Kennworts
...
Der vorhandenen Anwendung wird ein neues Kennwort mit der Objekt-ID '1f89cf81-0146-4f4e-beae-2007d0668416' hinzugefügt.

### Beispiel 2: Erstellen einer neuen Anmeldeinformationen für eine Anwendung mithilfe eines Zertifikats
...
### Beispiel 3: Erstellen einer neuen Anmeldeinformationen für eine Anwendung mithilfe der Piping
...
Ruft die Anwendung mit der Objekt-ID '1f89cf81-0146-4f4e-beae-2007d0668416' ab und gibt diese an die New-AzADAppCredential weiter, um eine neue Anmeldeinformationen für die Anwendung mit dem angegebenen Kennwort zu erstellen.

## PARAMETERS

### -ApplicationId
Die Anwendungs-ID der Anwendung, der die Anmeldeinformationen hinzugefügt werden.
...
### -ApplicationObject
Das Anwendungsobjekt, dem die Anmeldeinformationen hinzugefügt werden.
...
### -CertValue
Der Wert des "asymmetrischen" Anmeldeinformationstyps. Es stellt das 64-codierte Basiszertifikat dar.
...
### -EndDate
Das Effektive Enddatum der Verwendung der Anmeldeinformationen. Der Standardmäßige Enddatumswert liegt ein Jahr nach heute.  Bei Anmeldeinformationen vom Typ "asymmetrischer Art" muss dies auf das Datum oder vor dem Datum festgelegt werden, an dem das X509-Zertifikat gültig ist.
...
### -ObjectId
Die Objekt-ID der Anwendung, der die Anmeldeinformationen hinzugefügt werden.
...
### -StartDate
Das Effektive Startdatum der Nutzung der Anmeldeinformationen. Der Standardwert für das Startdatum ist "Heute". Bei Anmeldeinformationen vom Typ "asymmetrischer Art" muss dies auf das Datum oder nach dem Datum festgelegt werden, ab dem das X509-Zertifikat gültig ist.
