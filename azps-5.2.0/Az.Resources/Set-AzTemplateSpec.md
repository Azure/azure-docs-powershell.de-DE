...
## BESCHREIBUNG
Ändert eine Templace-Spezifikation. Wenn die Vorlagenspezifikation mit dem angegebenen Namen und/oder einer bestimmten Version noch nicht vorhanden ist, wird sie erstellt.

Beim Ändern des ARM-Vorlageninhalts einer Vorlagenspezifikation kann der Inhalt entweder aus einer unformatierten JSON-Zeichenfolge (mit dem Parametersatz **"UpdateVersionByNameFromJsonParameterSet")** oder aus einer angegebenen "JSON"-Datei (mit dem Parametersatz **"UpdateVersionByNameFromJsonFileParameterSet")** stammen.
...
Ändert Version "v1.0" eines Vorlagenspezifikationen namens "myTemplateSpec". Die angegebene Version $templateJson als Der Inhalt der ARM Version angezeigt. Wenn die Stammvorlagenspezifikation und/oder -version noch nicht vorhanden ist, werden sie erstellt.


**Hinweise:** 

* Die ARM Beispiel ist ein "No-Op"-Wert, da sie keine tatsächlichen Ressourcen enthält.
* Speicherort ist nur erforderlich, wenn die Vorlagenspezifikation noch nicht vorhanden ist
...
Ändert Version "v2.0" eines Vorlagenspezifikationen namens "myTemplateSpec". Bei der angegebenen Version wird der Inhalt aus der lokalen Datei "myTemplateContent.js" als Der Inhalt der ARM Version angezeigt. Wenn die Stammvorlagenspezifikation und/oder -version noch nicht vorhanden ist, werden sie erstellt.

**Hinweis:** Speicherort ist nur erforderlich, wenn die Vorlagenspezifikation noch nicht vorhanden ist
