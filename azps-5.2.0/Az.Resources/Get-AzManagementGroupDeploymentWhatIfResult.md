...
## BESCHREIBUNG
Das **Cmdlet "Get-AzManagementGroupDeploymentWhatIfResult"** ruft das ARM-What-If-Ergebnis für eine Vorlagenbereitstellung im angegebenen Bereich der Verwaltungsgruppe ab. Es gibt eine Liste mit Änderungen zurück, die angibt, welche Ressourcen aktualisiert werden, wenn die Bereitstellung angewendet wird, ohne Änderungen an echten Ressourcen vorzunehmen. Verwenden Sie den Parameter *"ResultFormat",* um das Format für das zurückgebende Ergebnis anzugeben.

## BEISPIELE

### Beispiel 1: Erhalten eines What-If Ergebnisses im Bereich der Managementgruppe
```powershell
...
Dieser Befehl ruft ein What-If Ergebnis im Bereich der Verwaltungsgruppe ab, indem eine benutzerdefinierte Vorlagendatei und eine Parameterdatei auf dem Datenträger verwendet werden.
...
### Beispiel 2: Erhalten eines What-If Ergebnisses im Bereich der Verwaltungsgruppe mit "ResourceIdOnly"
```powershell
PS C:\> Get-AzManagementGroupDeploymentWhatIfResult `
    -DeploymentName "deploy-01" `
    -Location "West US" `
