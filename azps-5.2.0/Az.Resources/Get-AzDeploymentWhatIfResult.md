...
Dieser Befehl ruft ein What-If im aktuellen Abonnementbereich ab, indem eine benutzerdefinierte Vorlagendatei und eine Parameterdatei auf dem Datenträger verwendet werden.
...
### Beispiel 2: Erhalten eines What-If im Abonnementbereich mit "ResourceIdOnly"
```powershell
PS C:\> Get-AzDeploymentWhatIfResult `
    -DeploymentName "deploy-01" `
    -Location "West US" `
