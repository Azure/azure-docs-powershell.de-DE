...
## BESCHREIBUNG
Erstellen Sie eine Geräteregistrierung bei einem Azure IoT Hub Device Provisioning Service.
...
Erstellen Sie eine Registrierung mit einem TPM-Nachweis.
...
Erstellen Sie eine Registrierung mit dem Nachweistyp "SymmetricKey" und dem anfänglichen Status".

## PARAMETERS

### -AllocationPolicy
Der Typ der Zuordnung für das dem Hub zugewiesene Gerät.
...
### -Desired
Anfangs gewünschte Eigenschaften.
...
### -EdgeEnabled
Kennzeichnung zur Aktivierung der Kante.
...
### -EndorsementKey
TPM-Empfehlungsschlüssel für ein TPM-Gerät.
...
### -PrimaryCAName
Der Name des primären Zertifizierungsstellenstammzertifikats.
Wenn ein Nachweis mit einem Stammzertifikat der Zertifizierungsstelle gewünscht wird, muss ein Stammzertifizierungsstellenname angegeben werden.
...
Basis-64-Darstellung von X509-Zertifikat-CER-Datei oder PEM-Dateipfad.
...
### -PrimaryKey
Der im Basis64-Format gespeicherte primäre symmetrische freigegebene Zugriffsschlüssel.
...
### -ProvisioningStatus
Registrierungseintrag aktivieren oder deaktivieren
...
### -RegistrationId
Registrierungs-ID für die individuelle Registrierung.
...
### -ReprovisionPolicy
Gerätedaten, die bei der erneuten Bereitstellung an einen anderen Iot Hub behandelt werden sollen.
...
### -SecondaryCAName
Der Name des Zertifikats für die sekundäre Stammzertifizierungsstelle.
Wenn ein Nachweis mit einem Stammzertifikat der Zertifizierungsstelle gewünscht wird, muss ein Stammzertifizierungsstellenname angegeben werden.
