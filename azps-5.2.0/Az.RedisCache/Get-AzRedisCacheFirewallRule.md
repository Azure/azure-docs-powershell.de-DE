...
## BESCHREIBUNG
Wenn **der Parameter "RuleName"** angegeben ist, ruft das **Cmdlet "Get-AzRedisCacheFirewallRule"** Details zur angegebenen Firewallregel im Azure Redis Cache ab. Wenn nur **"Name"** angegeben wird, sind bei diesem Vorgang alle Firewallregeln für diesen Redis-Cache verfügbar.
