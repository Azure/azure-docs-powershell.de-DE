...
## SYNOPSIS
Fügt einen Patchzeitplan hinzu.
...
## BESCHREIBUNG
Das **Cmdlet "New-AzRedisCachePatchSchedule"** fügt einem Cache in Azure Redis Cache einen Patchzeitplan hinzu.
...
### -Entries
Gibt ein Array von Zeitplänen an, das von diesem Cmdlet für einen Cache festgelegt wird. Um ein **"PSScheduleEntry"-Objekt** zu erhalten, verwenden Sie das New-AzRedisCacheScheduleEntry-Cmdlet.
