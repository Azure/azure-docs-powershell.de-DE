...
## BESCHREIBUNG
Löscht einen Azure Machine Learning-Verpflichtungsplan. Beachten Sie, dass Verpflichtungspläne mit Verpflichtungszuordnungen nicht gelöscht werden können. Verpflichtungszuordnungen können nur von der Zielressource gelöscht werden. Wenn Sie beispielsweise einen Azure Machine Learning-Webdienst löschen, wird auch die Verpflichtungs zuordnung gelöscht, die den Webdienst einem Verpflichtungsplan zu ordnet.

## BEISPIELE

### Beispiel 1: Löschen eines Verpflichtungsplans
```
...
### -MlCommitmentPlan
Das Machine Learning-Webdienstobjekt.
