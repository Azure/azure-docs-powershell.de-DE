...
Entfernt das "Event Grid Domain \` Topic1" \` unter \` "Domäne1" \` in der Ressourcengruppe \` "MyResourceGroupName". \`
...
### -ResourceId
Ressourcenbezeichner, der das Thema "Event Grid Domain" darstellt.
