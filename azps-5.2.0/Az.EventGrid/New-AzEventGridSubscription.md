...
Erstellt ein neues Ereignisabonnement \` "EventSubscription1" für einen \` EventHub-Namespace mit dem angegebenen Webhook-Zielendpunkt. `https://requestb.in/19qlscd1` Für dieses Ereignisabonnement werden Standardfilter verwendet.
...
### -DeliverySchema
Das Schema, das bei der Bereitstellung von Ereignissen an das Ziel verwendet wird. Die möglichen Werte sind: eventgridschema, CustomInputSchema oder cloudeventv01schema. Der Standardwert ist "CustomInputSchema".
...
### -ExpirationDate
Bestimmt den Ablauf von "DateTime" für das Ereignisabonnement, nach dem das Ereignisabonnement abläuft.
