...
Listet die ersten 25 Ereignisabonnements (sofern vorhanden) auf, die für den angegebenen EventHub-Namespace erstellt wurden, der die $odataFilter erfüllt. Wenn weitere Ergebnisse verfügbar sind, wird $result. "NextLink" wird nicht $null. Um die nächste Seite(n) mit Ereignisabonnements zu erhalten, wird erwartet, dass der Benutzer das Ereignis erneut aufruft Get-AzEventGridSubscription und das Ergebnis verwendet. NextLink aus dem vorherigen Anruf. Der Anrufer sollte beendet werden, wenn das Ergebnis vor sich geht. "NextLink" wird $null.
...
Listen Sie die ersten 100 Ereignisabonnements (sofern vorhanden) auf, die für die spezifische Ressourcengruppe erstellt wurden, die die $odataFilter erfüllt. Wenn weitere Ergebnisse verfügbar sind, wird $result. "NextLink" wird nicht $null. Um die nächste Seite(n) mit Ereignisabonnements zu erhalten, wird erwartet, dass der Benutzer das Ereignis erneut aufruft Get-AzEventGridSubscription und das Ergebnis verwendet. NextLink aus dem vorherigen Anruf. Der Anrufer sollte beendet werden, wenn das Ergebnis vor sich geht. "NextLink" wird $null.
