...
### -Customize
Gibt die Eigenschaften an, die verwendet werden, um die Anpassungsschritte des Bilds zu beschreiben, z. B. Bildquelle usw. Informationen zum Erstellen finden Sie im Abschnitt "NOTES" für "ANPASSEN"-Eigenschaften und zum Erstellen einer Hashtabelle.
...
Geben Sie "0" aus, um die standardmäßige Betriebssystemdatenträgergröße von Azure zu verwenden.
