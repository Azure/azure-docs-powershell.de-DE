...
### Beispiel 2: Alle Richtlinien für gespeicherten Zugriff in einer Speichertabelle erhalten
```
...
### -Policy
Gibt eine gespeicherte Zugriffsrichtlinie an, die die Berechtigungen für dieses Sasstoken (Shared Access Signature) enthält.
