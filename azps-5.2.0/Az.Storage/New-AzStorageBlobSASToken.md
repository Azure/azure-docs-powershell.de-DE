...
## BESCHREIBUNG
Das **Cmdlet "New-AzStorageBlobSASToken"** generiert ein SAS (Shared Access Signature)-Token für ein Azure-Speicher-BLOB.

## BEISPIELE

### Beispiel 1: Generieren eines BLOB-SAS-Tokens mit der vollständigen BLOB-Berechtigung
```
PS C:\>New-AzStorageBlobSASToken -Container "ContainerName" -Blob "BlobName" -Permission rwd
```

In diesem Beispiel wird ein BLOB-SAS-Token mit der vollständigen BLOB-Berechtigung generiert.
...
### Beispiel 3: Generieren eines Benutzeridentitäts-SAS-Tokens mit Speicherkontext basierend auf der OAuth-Authentifizierung
```
...
In diesem Beispiel wird ein BENUTZERidentitäts-BLOB-SAS-Token mit Speicherkontext generiert, der auf der OAuth-Authentifizierung basiert.
...
### -CloudBlob
Gibt das Objekt **"CloudBlob"** an.
Verwenden Sie zum **Abrufen eines CloudBlob-Objekts** [das Cmdlet "Get-AzStorageBlob".](./Get-AzStorageBlob.md)
...
Wenn der Speicherkontext auf der OAuth-Authentifizierung basiert, wird ein BENUTZERidentitäts-BLOB-SAS-Token generiert.
...
### -ExpiryTime
Gibt an, wann die Signatur für den freigegebenen Zugriff abläuft.
...
### -Permission
Gibt die Berechtigungen für ein Speicher-BLOB an. Beachten Sie, dass es sich um eine Zeichenfolge wie `rwd` "Lesen", "Schreiben" und "Löschen" handelt. 
