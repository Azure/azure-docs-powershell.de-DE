...
## BESCHREIBUNG
Das **Cmdlet "Stop-AzStorageBlobCopy"** beendet einen Kopiervorgang zum angegebenen Ziel-BLOB.
...
Dieser Befehl beendet den Kopiervorgang nach Name.
...
Dieser Befehl beendet den Kopiervorgang, indem der Container aus **"Get-AzStorageContainer"** an die Pipeline übergeben wird.
...
In diesem Beispiel wird der Kopiervorgang beendet, indem der Container an die Pipeline aus dem Get-AzStorageBlob übergeben wird.
...
### -CloudBlob
Gibt ein **CloudBlob-Objekt** aus der Azure Storage Client Library an.
...
Sie können den Kontext mithilfe des New-AzStorageContext erstellen.
...
### -Force
Beendet die aktuelle Kopieraufgabe für das angegebene BLOB ohne Bestätigungsaufforderung.
