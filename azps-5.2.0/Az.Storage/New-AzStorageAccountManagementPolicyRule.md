...
### Beispiel 1: Erstellt ein Verwaltungspolicy-Regelobjekt, das dann auf ein Speicherkonto festgelegt wird
```
...
Mit diesem Befehl wird ein Verwaltungspolicy-Regelobjekt erstellt, mit einem Verwaltungspolicy-Aktionsgruppesobjekt, das vier Aktionen enthält, ein Verwaltungspolicy-Regelfilterobjekt, und legen Sie die Regel dann auf ein Speicherkonto festgelegt.

## PARAMETERS

### -Action
Ein Objekt, das den Aktionssatz definiert.
Objekt mit Cmdlet-Add-AzureStorageAccountManagementPolicyAction
...
Objekt mit Cmdlet-New-AzureStorageAccountManagementPolicyFilter
...
### -Name
Ein Regelname kann eine beliebige Kombination alphanumerischer Zeichen enthalten.
Bei Regelnamen muss die Zwischen- und Kleinschreibung beachtet werden.
