...
## BESCHREIBUNG
Das **Cmdlet "Get-AzDataLakeGen2ItemContent"** heruntergeladen eine Datei in ein Filesystem in einem Azure-Speicherkonto.
...
### -CheckMd5
überprüfen Sie die md5sum-Kontrollkästchen.
...
### -Destination
Pfad des lokalen Zieldateipfads.
...
### -Force
Erzwingen des Überschreibens des vorhandenen BLOB oder der vorhandenen Datei
