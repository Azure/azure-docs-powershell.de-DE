...
### Beispiel 3: Generieren des Container-SAS-Tokens mit der Richtlinie für den freigegebenen Zugriff
```
...
### Beispiel 3: Generieren eines BENUTZERidentitätscontainer-SAS-Tokens mit Speicherkontext auf der Grundlage der OAuth-Authentifizierung
```
