...
## BESCHREIBUNG
Das **Cmdlet "Get-AzStorageContainerStoredAccessPolicy"** listet die gespeicherten Zugriffsrichtlinien für einen Azure -Speichercontainer auf.

## BEISPIELE

### Beispiel 1: Erhalten einer gespeicherten Zugriffsrichtlinie in einem Speichercontainer
```
PS C:\>Get-AzStorageContainerStoredAccessPolicy -Container "Container07" -Policy "Policy22"
```

Dieser Befehl ruft die Zugriffsrichtlinie mit dem Namen "Policy22" im Speichercontainer namens "Container07" ab.

### Beispiel 2: Alle Gespeicherten Zugriffsrichtlinien in einem Speichercontainer erhalten
```
PS C:\>Get-AzStorageContainerStoredAccessPolicy -Container "Container07"
```

Dieser Befehl ruft alle Zugriffsrichtlinien im Speichercontainer namens "Container07" ab.
...
### -Container
Gibt den Namen Ihres Azure -Speichercontainers an.
...
### -Policy
Gibt die Azure-Richtlinie für gespeicherten Zugriff an.
