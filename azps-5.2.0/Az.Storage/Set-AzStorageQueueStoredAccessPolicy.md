...
### Beispiel 1: Festlegen einer gespeicherten Zugriffsrichtlinie in der Warteschlange mit der vollen Berechtigung
```
PS C:\> Set-AzStorageQueueStoredAccessPolicy -Queue "MyQueue" -Policy "Policy07" -Permission arup
```

Mit diesem Befehl wird eine Zugriffsrichtlinie namens "Policy07" für die Speicherwarteschlange namens "MyQueue" definiert.
...
### -NoStartTime
Gibt an, dass für dieses Cmdlet die Startzeit auf eine $Null.
...
### -Permission
Gibt Berechtigungen in der Richtlinie für gespeicherten Zugriff für den Zugriff auf die Speicherwarteschlange an.
