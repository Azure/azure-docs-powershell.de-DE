...
2. Nach dem Failover wird der Speicherkontotyp in einen lokal redundanten Speicher konvertiert. Sie können Ihr Konto so konvertieren, dass georedundanter Speicher (Geo redundant Storage, GRS) verwendet wird.
