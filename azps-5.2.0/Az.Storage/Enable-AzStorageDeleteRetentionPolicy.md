...
## BESCHREIBUNG
Das **Cmdlet "Enable-AzStorageDeleteRetentionPolicy"** aktiviert die Löschaufbewahrungsrichtlinie für den Azure Storage Blob-Dienst.

## BEISPIELE

### Beispiel 1: Aktivieren der Löschaufbewahrungsrichtlinie für den Blob Service
```
C:\PS>Enable-AzStorageDeleteRetentionPolicy -RetentionDays 3
```

Dieser Befehl aktiviert die Löschaufbewahrungsrichtlinie für den Blob-Dienst und setzt gelöschte Blob-Aufbewahrungstage auf 3.
