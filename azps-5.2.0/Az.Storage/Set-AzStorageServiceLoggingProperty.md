...
## BESCHREIBUNG
Das **Cmdlet "Set-AzStorageServiceLoggingProperty"** ändert die Protokollierung für Azure Storage-Dienste.

## BEISPIELE

### Beispiel 1: Ändern der Protokolleigenschaften für den Blob-Dienst
```
C:\PS>Set-AzStorageServiceLoggingProperty -ServiceType Blob -LoggingOperations Read,Write -PassThru -RetentionDays 10 -Version 1.0
```

Mit diesem Befehl wird die Protokollierung in Version 1.0 für blob storage so geändert, dass Lese- und Schreibvorgänge enthalten sind.
...
Azure Storage Services protokolliert die Vorgänge, die mit diesem Parameter angegeben werden.
...
### -RetentionDays
Gibt die Anzahl der Tage an, für die der Azure Storage Service die protokollierten Informationen beibehalte.
