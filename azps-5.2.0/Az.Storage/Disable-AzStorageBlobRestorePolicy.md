...
## BESCHREIBUNG
Das **Cmdlet "Disable-AzStorageBlobRestorePolicy"** deaktiviert die Blob Restore Policy für den Azure Storage BLOB-Dienst.

## BEISPIELE

### Beispiel 1: Deaktiviert die Blob Restore Policy für den Azure Storage -BLOB-Dienst für ein Speicherkonto.
```powershell
PS C:\> Disable-AzStorageBlobRestorePolicy -ResourceGroupName "myresourcegoup" -StorageAccountName "mystorageaccount"
```

Mit diesem Befehl wird die Blob Restore Policy für den Azure Storage -BLOB-Dienst für ein Speicherkonto deaktiviert.
