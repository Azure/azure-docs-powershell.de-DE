...
## BESCHREIBUNG
Das **Cmdlet "Enable-AzStorageBlobDeleteRetentionPolicy"** aktiviert die Löschaufbewahrungsrichtlinie für den Azure Storage Blob-Dienst.

## BEISPIELE

### Beispiel 1: Aktivieren der Löschaufbewahrungsrichtlinie für den Blob-Dienst
```
...
Dieser Befehl aktiviert die Löschaufbewahrungsrichtlinie für den Blob-Dienst und setzt gelöschte Blob-Aufbewahrungstage auf 4.
...
### -RetentionDays
Legt die Anzahl der Aufbewahrungstage für "DeleteRetentionPolicy" fest.
