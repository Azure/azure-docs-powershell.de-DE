...
Wenn der neue Eintrag "ACL" mit demselben AccessControlType/EntityId/DefaultScope nicht in der Eingabe-ACL vorhanden ist, wird ein neuer "ACL"-Eintrag erstellt. Andern ende die Berechtigung eines vorhandenen ACL-Eintrags.
...
Dieser Befehl erstellt ein ACL-Objekt mit drei ACL-Einträgen (verwenden Sie den Parameter "-InputObject", um einem vorhandenen acl-Objekt einen Eintrag hinzuzufügen), und aktualisiert die ACL für ein Verzeichnis.
...
### -AccessControlType
Es gibt vier Typen: "Benutzer" gewährt dem Besitzer oder einem benannten Benutzer Rechte, "Gruppe" gewährt Rechte für die besitzende Gruppe oder eine benannte Gruppe, "mask" schränkt die Rechte ein, die benannten Benutzern und Den Mitgliedern von Gruppen gewährt werden, und "andere" gewährt Rechte für alle Benutzer, die in keinem der anderen Einträge gefunden werden.
...
### -DefaultScope
Legen Sie diesen Parameter so ein, dass der ACE zur Standard-ACL für ein Verzeichnis gehört. andernfalls ist der Bereich implizit, und der ACE gehört zur Zugriffs-ACL.
...
Für Einträge von AccessControlType"mask" und "other" wird es ausgelassen.
