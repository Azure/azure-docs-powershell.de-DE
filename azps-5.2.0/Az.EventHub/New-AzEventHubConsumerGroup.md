...
Erstellt die Consumergruppe \` "MyConsumerGroupName" im Ereignishub \` \` "MyEventHubName", der auf den Namespace "MyNamespaceName" mit der Ressourcengruppe \` \` \` \` "MyResourceGroupName" begrenzt \` ist.
...
### -UserMetadata
Benutzermetadaten für ConsumerGroup
