...
## BESCHREIBUNG
Das Set-AzEventHub cmdlet aktualisiert die Eigenschaften des angegebenen Ereignishubs.

## BEISPIELE

### Beispiel 1
Führen Sie die folgenden Schritte aus, um Eventhub mit den Eigenschaften der Aufnahmebeschreibung zu aktualisieren. 
...
Aktualisiert den Vom \` MyEventHubName des \` MyCreatedEventHub-Objekts dargestellten Ereignishub, indem der Aufbewahrungszeitraum für Nachrichten auf 4 Tage, die Anzahl der Partitionen auf 2 und die \` \` Eigenschaften "CaptureDescription" festgelegt werden.
...
Aktualisiert den Vom \` MyEventHubName des \` \` MyCreatedEventHub-Objekts dargestellten Ereignishub, indem der Aufbewahrungszeitraum für Nachrichten auf 4 Tage und die Anzahl der Partitionen auf \` 2 festgelegt wird.
