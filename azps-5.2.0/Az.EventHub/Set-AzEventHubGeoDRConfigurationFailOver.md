...
## BESCHREIBUNG
Das **Cmdlet "Set-AzEventHubGeoDRConfigurationFailOver"** ruft geo-DR-Failover auf und konfiguriert den Alias so neu, dass er auf den sekundären Namespace zeigt.
