...
### Beispiel 2: Entfernen einer benutzerdefinierten Anbieter zuordnung zur Piping
```powershell
...
Entfernen Einer benutzerdefinierten Anbieter zuordnung mit Piping und dem Feature "PassThru", um Erfolg oder Fehler anzuzeigen.
