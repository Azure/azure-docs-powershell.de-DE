...
## SYNOPSIS
Generiert einen Zugriffsschlüssel für den angegebenen Konfigurationsspeicher erneut.
...
### Beispiel 1: Neuer generierter Schlüssel eines App-Konfigurationsspeichers
```powershell
...
Dieser Befehl generiert den Schlüssel eines App-Konfigurationsspeichers erneut.

### Beispiel 2: Neuer generierter Schlüssel eines App-Konfigurationsspeichers nach Objekt
```powershell
...
Mit diesem Befehl wird der Schlüssel eines App-Konfigurationsspeichers nach Objekt neu generiert.
...
### -ID
Die ID des Schlüssels, der erneut generiert werden soll.
