...
## BESCHREIBUNG
Das **Cmdlet "Set-AzImageOsDisk"** legt die Datenträgereigenschaften des Betriebssystems für ein Bildobjekt fest.
...
Mit den nächsten drei Befehlen werden den Variablen $osDiskVhdUri, $dataDiskVhdUri 1 und $dataDiskVhdUri 2 Pfade des Betriebssystemdatenträgers zugewiesen.
...
### -Zwischenspeichern
Gibt den Cachemodus des Datenträgers an.
...
### -StorageAccountType
Speicherkontotyp des Betriebssystemabbilddatenträgers
