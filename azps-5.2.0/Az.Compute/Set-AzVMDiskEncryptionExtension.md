...
Linux: Der **Parameter VolumeType** ist erforderlich, wenn virtuelle Linux-Computer verschlüsselt werden. Er muss auf einen Wert ("Os", "Data" oder "All") festgelegt werden, der von der Linux-Verteilung unterstützt wird. 
...
### Beispiel 6: Aktivieren der Verschlüsselung mithilfe der Azure AD-Client-ID, client-cert thumbprint und wrap disk encryptionkey mithilfe des Schlüsselverschlüsselungsschlüssels
```
$RGName = "MyResourceGroup"
$VMName = "MyTestVM"
#The KeyVault must have enabledForDiskEncryption property set on it
