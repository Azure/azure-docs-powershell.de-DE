...
## BESCHREIBUNG
Das **Cmdlet "New-AzVmssIpTagConfig"** erstellt ein #A0 für eine Netzwerkschnittstelle eines Virtual Machine Scale Set (VMSS).
Geben Sie die Konfiguration dieses  Cmdlets als New-AzVmssIpConfig des New-AzVmssIpConfig an.
...
Dieser Befehl erstellt ein lokales IP-Tag-Objekt mit dem Typ "FirstPartyUsage" und dem Tag "Sql" und erstellt dann eine IP-Konfiguration mit diesem IP-Tag.
...
### -Tag
Gibt einen Wert für ein IP-Tag an.
