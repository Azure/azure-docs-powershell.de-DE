...
## BESCHREIBUNG
Das **Cmdlet "Add-AzImageDataDisk"** fügt einem Bildobjekt einen Datenträger hinzu.
...
Mit den nächsten drei Befehlen werden den Variablen $osDiskVhdUri, $dataDiskVhdUri 1 und $dataDiskVhdUri 2 Pfade des $dataDiskVhdUri Datenträgers zugewiesen.
...
### -BlobUri
Gibt die Verknüpfung des BLOB als URI an.
...
### -StorageAccountType
Der Speicherkontotyp des Datenabbilddatenträgers
