...
## BESCHREIBUNG
Das **Cmdlet "Set-AzVmssVM"** ändert den Zustand einer Virtual Machine Scale Set (VMSS)-Instanz.

## BEISPIELE

### Beispiel 1

Ändert den Zustand einer VMSS-Instanz. (automatisch generiert)
...
### -InstanceId
Gibt die ID der VMSS-Instanz an, für die dieses Cmdlet den Zustand ändert.
...
### -PerformMaintenance
Gibt an, dass dieses Cmdlet die Wartung auf einem virtuellen Computer auf der VMSS durchführt.
...
### -Redeploy
Gibt an, dass dieses Cmdlet einen virtuellen Computer in der VMSS erneut bereitstellen soll.
...
### -Reimage
Gibt an, dass dieses Cmdlet die Instanz der VMSS neu abbildt.
...
### -ReimageAll
Gibt an, dass das Cmdlet alle Datenträger in der INSTANZ VMSS neu abbildt.
...
### -ResourceGroupName
Gibt den Namen der Ressourcengruppe an, die die Instanz "VMSS" enthält.
...
### -SimulateEviction
Gibt an, dass dieses Cmdlet die Entfernung des virtuellen Spotcomputers in einem VM-Skalierungssatz simuliert.
