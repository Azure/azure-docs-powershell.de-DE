...
Mit den nächsten drei Befehlen werden den Variablen $osDiskVhdUri, $dataDiskVhdUri 1 und $dataDiskVhdUri 2 Pfade des $osDiskVhdUri Datenträgers zugewiesen. Dieser Ansatz ist nur zur Lesbarkeit der folgenden Befehle.
