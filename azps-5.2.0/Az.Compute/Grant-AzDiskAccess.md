...
## BESCHREIBUNG
Das **Cmdlet Grant-AzDiskAccess** gewährt Zugriff auf einen Datenträger.
...
Gewähren Sie Lesezugriff auf den Datenträger mit dem Namen "Disk01" in der Ressourcengruppe mit dem Namen "ResourceGroup01" für 60 Sekunden.
