...
### Beispiel 1: Erhalten der Versionen eines Erweiterungsbilds
```
...
Dieser Befehl ruft alle Versionen des Erweiterungsbilds für den angegebenen Speicherort, Herausgeber und Typ ab.

### Beispiel 2: Erhalten der Versionen eines Erweiterungsbilds mit filter over version
```
...
Mit diesem Befehl werden alle Versionen des Erweiterungsbilds für den angegebenen Speicherort, Den Herausgeber, Typ und die Version ab 12 ruft.

### Beispiel 3: Erhalten der Versionen eines Erweiterungsbilds mit filter over version
```
...
Dieser Befehl ruft alle Versionen des Erweiterungsbilds für den angegebenen Speicherort, Herausgeber, Typ und version ab.
...
### -PublisherName
Gibt den Namen eines Erweiterungsherausgebers an.
Verwenden Sie zum Abrufen eines Erweiterungsherausgebers das Get-AzVMImagePublisher-Cmdlet.
