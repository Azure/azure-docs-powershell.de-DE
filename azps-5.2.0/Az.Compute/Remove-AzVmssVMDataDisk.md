...
Der erste Befehl getsan existing Vmss VM, der vom Ressourcengruppennamen, dem Namen der vmss und der Instanz-ID angegeben wird.
...
Das Virtual Machine Scale Set VM-Profil.
