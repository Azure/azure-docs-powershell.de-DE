...
### -Enable
Gibt an, dass die automatische Sicherung SQL Server virtuellen Computers aktiviert ist.
...
### -FullBackupFrequency
Tägliche oder wöchentliche vollständige Sql Server-Sicherungshäufigkeit
