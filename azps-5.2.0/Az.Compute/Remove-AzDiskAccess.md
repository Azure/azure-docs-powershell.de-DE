...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzDiskAccess"** entfernt eine Datenträgerzugriffsressource.

## BEISPIELE

### Beispiel 1: Entfernen des Datenträgerzugriffs mit dem Standardparametersatz
```
PS C:\> Remove-AzDiskAccess -ResourceGroupName "ResourceGroup01" -Name "DiskAccess01"
```

Mit diesem Befehl wird der Datenträgerzugriff mit dem Namen "DiskAccess01" in der Ressourcengruppe "ResourceGroup01" entfernt.
...
### Beispiel 4: Entfernen des Datenträgerzugriffs durch Piping des Eingabeobjekts
```
PS C:\> Get-AzDiskAccess -ResourceGroupName "ResourceGroup01" -Name "DiskAccess01" | Remove-AzDiskAccess 
```

Mit diesem Befehl wird der Datenträgerzugriff entfernt, indem das InputObject-Objekt
