...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzVmssNetworkInterfaceConfiguration"** entfernt eine Netzwerkschnittstellenkonfiguration aus einem Virtual Machine Scale Set (VMSS).
...
Der erste Befehl ruft mit dem cmdlet Get-AzVmss einen VMSS ab und speichert ihn dann in der $VMSS Variable.
Der zweite Befehl entfernt die Netzwerkschnittstellenkonfiguration "ContosoVmssInterface02" aus dem Satz in $VMSS.
...
### -Name
Gibt den Namen der Netzwerkschnittstellenkonfiguration an, die von diesem Cmdlet entfernt wird.
