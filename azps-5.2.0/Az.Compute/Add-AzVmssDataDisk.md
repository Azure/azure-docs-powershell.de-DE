...
## BESCHREIBUNG
Das **Cmdlet "Add-AzVmssDataDisk"** fügt der Instanz des Virtual Machine Scale Set (VMSS) einen Datenträger hinzu.
...
### -DiskIOPSReadWrite
Gibt die Read-Write IOPS für den verwalteten Datenträger an. Sollte nur verwendet werden, wenn StorageAccountType UltraSSD_LRS. Ohne Angabe wird ein Standardwert basierend auf "diskSizeGB" zugewiesen.
...
### -DiskMBpsReadWrite
Gibt die Bandbreite in MB pro Sekunde für den verwalteten Datenträger an. Sollte nur verwendet werden, wenn StorageAccountType UltraSSD_LRS. Ohne Angabe wird ein Standardwert basierend auf "diskSizeGB" zugewiesen.
