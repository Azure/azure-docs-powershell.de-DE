...
### Beispiel 1: Entfernen eines Api-Schlüssels für Anwendungserkenntnisse für eine Ressource für Anwendungseinblicke
```
...
Entfernen Sie einen bestimmten API-Schlüssel für Anwendungserkenntnisse, der "dd173f38-4fd1-4c75-8af5-9 9c29aa0f867" für die Ressource "test" in der Ressourcengruppe "testGroup" ist.

## PARAMETERS

### -ApiKeyId
Api-Schlüssel-ID von Application Insights.
...
### -PassThru
Wenn angegeben, wird "true" für den Fall geschrieben, dass der Vorgang erfolgreich ist. Dieser Parameter ist optional. Der Standardwert ist "false".
