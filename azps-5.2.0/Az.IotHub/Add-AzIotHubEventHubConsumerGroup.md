...
## BESCHREIBUNG
Erstellt eine Consumergruppe in dem Eventhub, der dem angegebenen IotHub zugeordnet ist.

## BEISPIELE

### Beispiel 1: Hinzufügen einer Consumergruppe zum Telemetrieereignishub
```
...
Fügt dem Eventhub eine neue Consumergruppe mit dem Namen "myconsumergroup" für Telemetrieereignisse im iothub mit dem Namen "myiothub" hinzu.
...
Der Name der EventHub-Consumergruppe, die Sie hinzufügen möchten.
