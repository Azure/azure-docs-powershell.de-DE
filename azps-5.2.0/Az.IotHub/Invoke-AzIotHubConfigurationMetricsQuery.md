...
## BESCHREIBUNG
Auswerten einer benutzerdefinierten Ziel- oder Systemmetrik, die in einer IoT-Gerätekonfiguration definiert ist.
Es gibt vordefinierte Systemmetriken, die von Iot Hub berechnet werden und nicht angepasst werden können.
- "Targeted" gibt die Anzahl der Gerätegeräte an, die der Zielbedingung entsprechen.
- "Applied" hat die Anzahl der Gerätegeräte angegeben, die durch die Konfiguration geändert wurden. 
