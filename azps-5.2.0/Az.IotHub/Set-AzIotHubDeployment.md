...
## SYNOPSIS
Aktualisieren Sie die anpassbaren Felder der IoT Edge-Bereitstellung.
...
Hinweis: Der Konfigurationsinhalt kann nicht stumm änderbar sein. Zu den Konfigurationseigenschaften, die aktualisiert werden können, gehören "Bezeichnungen", "Metriken", "Priorität" und "targetCondition".
...
Ändern Sie die Priorität der IoT Edge-Bereitstellung, und aktualisieren Sie die Zielbedingung.
...
Aktualisieren Sie die Metriken und Bezeichnungen der IoT Edge-Bereitstellung.
...
### -Force
Ermöglicht das Ersetzen von Bereitstellungsobjekten, auch wenn es seit dem letzten Abruf aktualisiert wurde.
...
### -Label
Karte der Bezeichnungen, die auf die Zielbereitstellung angewendet werden sollen.
...
### -metrisch
Sammlung von Abfragen für die Definition von IoT Edge-Bereitstellungsmetriken.
...
### -Priority
Gewichtung der Bereitstellung bei Konkurrenzregeln (höchste Gewinne).
