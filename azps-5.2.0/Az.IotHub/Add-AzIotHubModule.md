...
## BESCHREIBUNG
Erstellen Sie ein Modul auf einem Ziel-IoT-Gerät mit einem anderen Autorisierungstyp in einem IoT-Hub.
...
Erstellen Sie ein Modul auf einem Ziel-IoT-Gerät mit Standardautorisierung (geteilter privater Schlüssel).
