...
Aktualisieren Sie die SKU auf S1 und die Einheiten für IotHub mit dem Namen "myiothub" auf 5.

### Beispiel 2 Aktualisieren der Ereignishubeigenschaften
```
PS C:\> Set-AzIotHub -ResourceGroupName "myresourcegroup" -Name "myiothub" -EventHubRetentionTimeInDays 4
```

Aktualisieren Sie die Aufbewahrungszeit der Telemetrie in Tagen auf 4 für IotHub namens "myiothub".

## PARAMETERS

### -CloudToDevice
Die Eigenschaften für die Befehlswarteschlange "Von der Cloud zum Gerät". 
...
Der Name des Containers, in den die Dateien hochgeladen werden.
...
Die maximale Übermittlungsanzahl für Dateiuploadbenachrichtigungen.  
...
Zeit zum Livewert für die Nachrichten in der Dateiuploadbenachrichtigungswarteschlange. 
...
### -FileUploadSasUriTtl
Es ist an der Zeit, für den SAS-URI, der für den Dateiupload generiert wird, zu leben. 
...
Die Speicherverbindungszeichenfolge zum Hochladen der Dateien. 
...
### -Routes
Für Routing zu verwendende Routen
...
### -RoutingProperties
Die Routingeigenschaften zum Weiterleiten von Nachrichten an externe Endpunkte 
