...
## BESCHREIBUNG
Das **Cmdlet "Get-AzBatchRemoteDesktopProtocolFile"** ruft eine Remotedesktopprotokolldatei (Remote Desktop Protocol, RDP) aus einem Rechenknoten ab und speichert sie als Datei oder in einem vom Benutzer bereitgestellten Datenstrom.

## BEISPIELE

### Beispiel 1: Herunterladen einer RDP-Datei von einem angegebenen Rechenknoten und Speichern der Datei
```
...
### Beispiel 2: Get an RDP file from a compute node and save the file by using the pipeline
```
PS C:\>Get-AzBatchComputeNode -PoolId "Pool06" -Id "ComputeNode02" -BatchContext $Context | Get-AzBatchRemoteDesktopProtocolFile -DestinationPath "C:\PowerShell\MyComputeNode02.rdp" -BatchContext $Context
```

Dieser Befehl ruft den Rechenknoten ab, der die ID ComputeNode02 im Pool mit dem ID Pool06 hat.
...
### Beispiel 3: Herunterladen einer RDP-Datei von einem angegebenen Rechenknoten und Direktes an einen Datenstrom
```
...
Der zweite Befehl ruft eine "RDP"-Datei aus dem Computeknoten ab, der die ID ComputeNode03 im Pool mit dem ID Pool06 enthält.
...
### -ComputeNode
Gibt einen Rechenknoten als ein **PSComputeNode-Objekt** an, auf den die .rdp-Datei verweist.
...
### -ComputeNodeId
Gibt die ID des Rechenknotens an, auf den die .rdp-Datei verweist.
...
### -DestinationPath
Gibt den Dateipfad an, unter dem dieses Cmdlet die RDP-Datei speichert.
...
Mit diesem Cmdlet wird dieser Datenstrom nicht geschlossen oder zurückspulen.
...
### -PoolId
Gibt die ID des Pools an, der den Rechenknoten enthält, von dem dieses Cmdlet eine RDP-Datei erhält.
