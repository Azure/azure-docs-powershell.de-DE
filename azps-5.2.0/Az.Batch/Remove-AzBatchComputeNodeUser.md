...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzBatchComputeNodeUser"** löscht ein Benutzerkonto aus einem Azure Batch-Computeknoten.

## BEISPIELE

### Beispiel 1: Löschen eines Benutzers aus einem Rechenknoten ohne Bestätigung
```
PS C:\>Remove-AzBatchComputeNodeUser -PoolId "Pool01" -ComputeNodeId "ComputeNode01" -Name "User14" -Force -BatchContext $Context
```

Mit diesem Befehl wird der Benutzer "User14" aus dem Computeknoten "ComputeNode01" gelöscht.
Der Rechenknoten befindet sich im Pool namens "Pool01".
...
### -ComputeNodeId
Gibt die ID des Rechenknotens an, für den dieses Cmdlet das Benutzerkonto löscht.
...
### -PoolId
Gibt die ID des Pools an, der den Rechenknoten enthält, für den das Benutzerkonto gelöscht werden soll.
