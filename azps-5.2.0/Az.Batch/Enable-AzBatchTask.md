...
## BESCHREIBUNG
Das **Cmdlet "Enable-AzBatchTask"** reaktiviert eine Aufgabe.
Wenn die Anzahl der Wiederholungen für eine Aufgabe aufgebraucht ist, kann sie mit diesem Cmdlet trotzdem ausgeführt werden.

## BEISPIELE

### Beispiel 1: Reaktivieren eines Vorgangs
```
PS C:\>Enable-AzBatchTask -JobId "Job7" -Id "Task2" -BatchContext $Context
```

Mit diesem Befehl wird der Vorgang "Aufgabe2" in Auftrag7 reaktiviert.
...
Mit diesem Befehl wird mithilfe des Cmdlets "Stapel" die Aufgabe "Batch" mit der ID "Aufgabe3" in dem Auftrag mit der ID "Auftrag8" Get-AzBatchTask.
...
### -ID
Gibt die ID der erneut zu aktivierenden Aufgabe an.
