...
## BESCHREIBUNG
Das **Cmdlet "Get-AzBatchJob"** ruft die Azure -Batchaufträge für das Batchkonto ab, das vom Parameter *"BatchAccountContext" angegeben* wird.
...
Mit diesem Befehl wird der Auftragszeitplan mit der ID "JobSchedule27" mithilfe des Cmdlets "Get-AzBatchJobSchedule" ruft.
