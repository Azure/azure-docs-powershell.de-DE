...
### Beispiel 1: Erhalten von Ressourcenstatistiken für alle Pool in einem Konto
```
...
Der letzte Befehl zeigt die **Eigenschaft "ResourceStatistics"** des $PoolStatistics.
