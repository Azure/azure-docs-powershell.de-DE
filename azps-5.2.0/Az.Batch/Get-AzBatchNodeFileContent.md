...
Die StdOut.txt Knotendatei ist der Aufgabe zugeordnet, die die ID Task01 für den Auftrag mit der ID Job01 enthält.
...
### Beispiel 5: Herunterladen einer Knotendatei von einem Rechenknoten und Speichern der Datei mithilfe der Pipeline
```
...
### -ComputeNodeId
Gibt die ID des Rechenknotens an, der die Knotendatei enthält, die von diesem Cmdlet zurückgegeben wird.
...
### -PoolId
Gibt die ID des Pools an, der den Rechenknoten enthält, der die Knotendatei enthält, die dieses Cmdlet erhält.
