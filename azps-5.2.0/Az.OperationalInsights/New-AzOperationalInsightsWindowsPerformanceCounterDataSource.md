...
## BESCHREIBUNG
Das **Cmdlet "New-AzOperationalInsightsWindowsPerformanceCounterDataSource"** fügt eine Windows-Leistungszähler-Datenquelle für verbundene Computer hinzu, auf denen das Betriebssystem Windows ausgeführt wird.
...
### -CounterName
Gibt den Namen eines Zählers an.
...
### -UseLegacyCollector
Verwenden Sie den legacy-Collector oder den Standardsammler.
...
### -Workspace
Gibt einen Arbeitsbereich an, in dem dieses Cmdlet arbeitet.
