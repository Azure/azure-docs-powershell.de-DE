...
## BESCHREIBUNG
Das **Cmdlet "Set-AzOperationalInsightsIntelligencePack"** aktiviert  das angegebene Intelligence Pack, wenn  "Enabled" auf $True und deaktiviert es, wenn "Enabled" auf "$False.

## BEISPIELE

### Beispiel 1: Festlegen von Intelligence Packs
```
PS C:\>Set-AzOperationalInsightsIntelligencePack -ResourceGroupName "ContosoResourceGroup" -WorkspaceName "ContosoWorkspace" -IntelligencePackName "ContosoWorkspace" -Enabled $True
```

Dieser Befehl aktiviert das angegebene Intelligence Pack.
...
Gibt den Namen des Intelligence Pack an.
