...
## BESCHREIBUNG
Das **Cmdlet "New-AzOperationalInsightsApplicationInsightsDataSource"** ermöglicht die Sammlung von Protokollen aus einer Application-Insights Anwendung.

## BEISPIELE

### Beispiel 1: Erstellen einer Datenquelle für Anwendungseinblicke im Arbeitsbereich
```
...
Mit diesem Befehl wird eine Datenquelle für Anwendungserkenntnisse einer bestimmten Anwendung in einem bestimmten Protokollanalysearbeitsbereich erstellt. Dies ermöglicht die Sammlung von Protokollen aus einer bestimmten Anwendung in den Protokollanalysearbeitsbereich.

### Beispiel 2: Erhalten eines Arbeitsbereichsobjekts und Erstellen einer Datenquelle für Anwendungseinblicke mit der Anwendungsressourcen-ID
```
...
Dieser Befehl veranschaulicht das Abrufen eines Log analytics-Arbeitsbereichsobjekts und das anschließende Übergeben der Ausgabe zum Erstellen einer zugeordneten Datenquelle für Anwendungseinblicke durch die Anwendungsressourcen-ID. 
...
Die verknüpfte Anwendungsressourcen-ID.
