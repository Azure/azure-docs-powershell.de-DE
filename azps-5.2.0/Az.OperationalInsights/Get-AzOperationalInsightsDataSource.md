...
Sie können eine Datenquelle angeben, die Sie erhalten möchten.
Sie können die Ergebnisse nach der Art der Datenquelle filtern.
...
### -Kind
Gibt die Art der zu erhaltenden Datenquellen an.
...
### -Name
Gibt den Namen einer datenquelle an, die sie erhalten soll.
...
### -ResourceGroupName
Gibt den Namen einer Ressourcengruppe an, die zu erhaltende Datenquellen enthält.
