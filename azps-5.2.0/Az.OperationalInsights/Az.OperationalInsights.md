...
## Beschreibung
In diesem Thema werden Hilfethemen für die Azure Operational Insights-Cmdlets angezeigt.
...
Beendet die Sammlung von benutzerdefinierten Protokollen von Linux-Computern.

### [Disable-AzOperationalInsightsLinuxPerformanceCollection](Disable-AzOperationalInsightsLinuxPerformanceCollection.md)
Beendet die Sammlung von Leistungszählern von Linux-Computern.
...
Startet die Sammlung benutzerdefinierter Protokolle von Linux-Computern.

### [Enable-AzOperationalInsightsLinuxPerformanceCollection](Enable-AzOperationalInsightsLinuxPerformanceCollection.md)
Startet die Sammlung von Leistungszählern von Linux-Computern.
...
Verknüpften Dienst für Arbeitsbereich erhalten oder auflisten
...
Gibt das Schema zurück, das einem Arbeitsbereich zugeordnet ist.

### [Get-AzOperationalInsightsStorageInsight](Get-AzOperationalInsightsStorageInsight.md)
Ruft Informationen zu einem Speicherinblick ab.
...
Erfassen Sie Protokolle aus einer Application-Insights Anwendung.

### [New-AzOperationalInsightsAzureActivityLogDataSource](New-AzOperationalInsightsAzureActivityLogDataSource.md)
Sammeln Sie das Azure-Aktivitätsprotokoll aus einem bestimmten Abonnement.
...
Erstellen eines verknüpften Speicherkontos für einen Arbeitsbereich
...
Sammelt Ereignisprotokolle von Computern, auf denen das Betriebssystem Windows ausgeführt wird.
...
Fügt die Datenquelle des Leistungszählers von Windows für verbundene Computer hinzu, auf denen das Betriebssystem Windows ausgeführt wird.
...
Dienstverknüpfung für Arbeitsbereich entfernen
...
Festlegen eines verknüpften Speicherkontos für einen Arbeitsbereich
...
Aktualisiert einen Speicher-Einblick.
