...
Mit diesem Befehl werden die SKU und die Tags des Arbeitsbereichs namens "MyWorkspace" in der Ressourcengruppe "ContosoResourceGroup" geändert.
...
Dieser Befehl verwendet das Cmdlet Get-AzOperationalInsightsWorkspace, um den Arbeitsbereich mit dem Namen "MyWorkSpace" zu erhalten, und übergibt ihn dann an das **Cmdlet "Set-AzOperationalInsightsWorkspace",** indem er den Pipelineoperator verwendet, um die SKU auf "Premium" zu setzen.
