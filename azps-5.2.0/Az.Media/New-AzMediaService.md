...
### Beispiel1: Erstellen eines Mediendiensts nur mit dem primären Speicherkonto
```
PS C:\># Variables
## Global
...
In diesem Beispiel wird gezeigt, wie Sie einen Mediendienst erstellen, bei dem nur das primäre Speicherkonto angegeben wird.
Dieses Skript verwendet mehrere andere Cmdlets.

### Beispiel 2: Erstellen eines Mediendiensts mit mehrerem Speicher
```
PS C:\># Variables
...
Dieses Beispiel zeigt, wie Sie einen Mediendienst mit mehreren Speicherkonten erstellen.
Dieses Skript verwendet mehrere andere Cmdlets.

## PARAMETERS

### -AccountName
Gibt den Namen des Mediendiensts an, den dieses Cmdlet erstellt.
...
### -Location
Gibt die Region an, in der dieses Cmdlet den Mediendienst erstellt.
...
### -ResourceGroupName
Gibt den Namen der Ressourcengruppe an, der der Mediendienst zugeordnet ist.
...
### -StorageAccountId
Gibt das Speicherkonto an, das dem Mediendienstkonto zugeordnet ist.
...
### -StorageAccounts
Gibt ein Array von Speicherkonten an, das dem Mediendienst zugeordnet werden soll.
...
### -Tag
Die Tags, die dem Mediendienstkonto zugeordnet sind.
