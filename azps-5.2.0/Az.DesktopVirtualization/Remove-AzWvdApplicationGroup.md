...
### Beispiel 1: Löschen einer Windows Virtual Desktop ApplicationGroup nach Name
```powershell
PS C:\> Remove-AzWvdApplicationGroup -ResourceGroupName ResourceGroupName -Name ApplicationGroupName
```

Mit diesem Befehl wird eine Windows Virtual Desktop ApplicationGroup in einer Ressourcengruppe gelöscht.
