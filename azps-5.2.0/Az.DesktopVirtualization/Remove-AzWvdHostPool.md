...
### Beispiel 1: Löschen eines Virtuellen Desktophostpools für Windows nach Name
```powershell
PS C:\> Remove-AzWvdHostPool -ResourceGroupName ResourceGroupName -Name HostPoolName
```

Mit diesem Befehl wird ein Windows Virtual Desktop HostPool in einer Ressourcengruppe gelöscht.
...
### -Force
Erzwingen Sie das Löschen von "sessionHost".
