...
### Beispiel 1: Aufheben der Registrierung einer Gruppe für virtuelle Windows-Desktopanwendung
```powershell
...
Mit diesem Befehl wird die Registrierung einer Gruppe der virtuellen Windows-Desktopanwendung in einem Arbeitsbereich aufgehoben.
