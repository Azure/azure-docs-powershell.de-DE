...
### Beispiel 1: Löschen eines virtuellen Windows-Desktop-SessionHosts nach Name
```powershell
PS C:\> Remove-AzWvdSessionHost -ResourceGroupName ResourceGroupName -HostPoolName HostPoolName -Name SessionHostName
```

Mit diesem Befehl wird sessionHost für den virtuellen Windows-Desktop in einem Hostpool gelöscht.
...
### -Force
Erzwingen Sie das Kennzeichen, um das Löschen von "sessionHost" auch dann zu erzwingen, wenn "userSession" vorhanden ist.
