...
## BESCHREIBUNG
Das **Cmdlet "Get-AzDataBoxEdgeUser"** listet die Benutzer auf, die für ein Datenfeld-Edgegerät konfiguriert sind. Sie können den Namen in Parametern erwähnen, um Details zu einem bestimmten Benutzer zu erhalten.
