...
### Beispiel 1: Herunterladen einer Funktions-App nach Name und Löschen der App.
```powershell
PS C:\> Get-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName | Remove-AzFunctionApp -Force
```

Dieser Befehl ruft eine Funktions-App nach Name ab und löscht sie.
...
### -Force
Erzwingt das Cmdlet, die Funktions-App ohne Bestätigungsaufforderung zu entfernen.
