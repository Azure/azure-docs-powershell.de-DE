...
### Beispiel 1: Erstellen Sie einen Windows Premium-App-Plan in Westeuropa mit einer Ausserfunktion von bis zu 10 Instanzen.
```powershell
...
Mit diesem Befehl wird ein Windows Premium-App-Plan in Westeuropa mit ausser geplatzten Funktionen bis zu 10 Instanzen erstellt.
...
### -WorkerType
Der Workertyp für den Plan.
Gültige Eingaben sind: Windows oder Linux.
