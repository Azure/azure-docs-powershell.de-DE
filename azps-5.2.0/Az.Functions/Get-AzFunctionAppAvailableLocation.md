...
### Beispiel 1: Hier erhalten Sie die Speicherorte, an denen Premium für Windows verfügbar ist. Wenn keine Parameter angegeben sind, wird "PlanType" auf "Premium" und "OSType" auf "Windows" festgelegt.
```powershell
