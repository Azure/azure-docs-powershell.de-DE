...
### Beispiel 1: Benennen Sie eine Funktions-App, und starten Sie sie.
```powershell
PS C:\> Get-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName | Start-AzFunctionApp
```

Dieser Befehl ruft eine Funktions-App nach Name ab und startet sie.

### Beispiel 2: Starten einer Funktions-App nach Name.
```powershell
PS C:\> Start-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName
```

Mit diesem Befehl wird eine Funktions-App nach Name gestartet.
