...
INPUTOBJECT <IAppServicePlan> : 
  ...
  - `[Capacity <Int32?>]`: Aktuelle Anzahl von Instanzen, die der Ressource zugeordnet sind.
  ...
  - `[IsSpot <Boolean?>]`: Ist <code>true</code> dies der Fall, besitzt dieser App-Serviceplan Spotinstanzen.
  ...
  - `[MaximumElasticWorkerCount <Int32?>]`: Maximal zulässige Anzahl von Arbeitskräften für diesen Serviceplan der App "Skalaenabled".
  - `[PerSiteScaling <Boolean?>]`: Wenn <code>true</code> apps, die diesem App Service Plan zugewiesen sind, unabhängig skaliert werden können.         Wenn <code>false</code> diesem App -Service-Plan zugewiesene Apps auf alle Instanzen des Plans skaliert werden.
  - `[Reserved <Boolean?>]`: Wenn Linux-App-Serviceplan <code>true</code> , <code>false</code> andernfalls.
