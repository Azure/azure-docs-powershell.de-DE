...
## BESCHREIBUNG
Das **Cmdlet "Add-AzKeyVaultCertificate"** beginnt mit der Registrierung für ein Zertifikat in einem Schlüsseltresor im Azure Key Vault.
...
Der erste Befehl verwendet das New-AzKeyVaultCertificatePolicy-Cmdlet, um eine Zertifikatrichtlinie zu erstellen, und speichert sie dann in der $Policy Variable.
Der zweite Befehl verwendet **"Add-AzKeyVaultCertificate",** um den Prozess zum Erstellen eines Zertifikats zu starten.
Der dritte Befehl verwendet das Get-AzKeyVaultCertificateOperation-Cmdlet, um den Vorgang abfragen, um zu überprüfen, ob er abgeschlossen ist.
Der letzte Befehl verwendet das Get-AzKeyVaultCertificate Cmdlet, um das Zertifikat zu erhalten.
...
### -Name
Gibt den Namen des hinzuzufügenden Zertifikats an.
