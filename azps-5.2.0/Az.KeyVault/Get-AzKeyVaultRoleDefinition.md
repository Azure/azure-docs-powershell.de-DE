...
Im Beispiel werden alle Rollen im Bereich "/schlüssel" aufgeführt.
...
Das Beispiel ruft die Rolle "Verwaltete HSM-Sicherung" ab und überprüft deren Berechtigungen.
...
### -RoleDefinitionName
Der Name der rollendefinition, die sie erhalten soll.
