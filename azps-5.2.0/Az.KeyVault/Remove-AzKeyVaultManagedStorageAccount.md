...
## BESCHREIBUNG
Entfernt die Zuordnung eines Azure -Speicherkontos vom Schlüsseltresor. Dadurch wird kein Azure -Speicherkonto entfernt, sondern die Kontoschlüssel werden von Azure Key Vault verwaltet. Alle zugeordneten SAS-Definitionen für den schlüsseltresor verwalteten Speicher werden ebenfalls entfernt.
...
### Beispiel 3: Endgültiges Löschen eines Schlüsseltresor, in dem das Azure Speicherkonto verwaltet wurde, und aller zugehörigen SAS-Definitionen aus einem für das soft delete aktivierten Tresor.
```powershell
...
Das erste Cmdlet entfernt das Azure -Speicherkonto "mystorageaccount" aus dem Schlüsseltresor "myvault" und verhindert, dass der Schlüsseltresor seine Schlüssel verwaltet. Das Konto "mystorageaccount" wird nicht entfernt. Alle diesem Konto zugeordneten SAS-Definitionen für verwalteten Speicher im Schlüsseltresor werden entfernt.
