...
Sie können das zu importierende Zertifikat mit einer der folgenden Methoden erstellen:
- Wird `Add-AzKeyVaultCertificate` verwendet, um eine Zertifikatsignaturanforderung zu erstellen und an eine Zertifizierungsstelle zu senden. Sieh https://docs.microsoft.com/en-us/azure/key-vault/certificates/create-certificate-signing-request
...
Der erste Befehl verwendet das ConvertTo-SecureString-Cmdlet, um ein sicheres Kennwort zu erstellen, und speichert es dann in $Password Variable.
Der zweite Befehl importiert das Zertifikat mit dem Namen "ImportCert01" in den Schlüsseltresor "Cos vaultsoKV01".
...
### -VaultName
Gibt den Schlüsseltresornamen an, in den dieses Cmdlet Zertifikate importiert.
...
[Erstellen und Zusammenführen von CSR im Schlüsseltresor](https://docs.microsoft.com/en-us/azure/key-vault/certificates/create-certificate-signing-request)