...
Außerdem werden alle in dieser Instanz enthaltenen Schlüssel gelöscht.
Beachten Sie: Obwohl die Angabe der Ressourcengruppe für dieses Cmdlet optional ist, sollten Sie dies für eine bessere Leistung tun.
...
Mit diesem Befehl wird der verwaltete Hsm namens "myhsm" aus Ihrem aktuellen Abonnement entfernt.

### Beispiel 2: Entfernen eines verwalteten HSM aus einer angegebenen Ressourcengruppe
```powershell
...
Mit diesem Befehl wird der verwaltete HSM mit dem Namen "myhsm" aus der Ressourcengruppe "myrg1" entfernt.
...
### -Force
Zeigt an, dass sie vom Cmdlet nicht zur Bestätigung aufgefordert werden.
Standardmäßig werden Sie von diesem Cmdlet aufgefordert zu bestätigen, dass Sie den verwalteten HSM löschen möchten.
...
### -Name
Gibt den Namen des verwalteten HSM an, der entfernt werden soll.
...
### -ResourceGroupName
Gibt den Namen der Ressourcengruppe an, die von Azure verwalteten HSM entfernt werden soll.
