...
## BESCHREIBUNG
**"Remove-AzUserAssignedIdentity"** löscht die angegebene vom Benutzer zugewiesene Identität.
...
Mit diesem Beispiel-Cmdlet wird die **Identitäts-ID1** unter der Ressourcengruppe **PSRG gelöscht.**
True
