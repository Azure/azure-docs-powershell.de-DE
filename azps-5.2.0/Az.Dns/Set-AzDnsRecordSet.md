...
Sie können dieses Verhalten mit dem Parameter *"Overwrite"* unterdrücken, der den Datensatzsatz unabhängig von gleichzeitigen Änderungen aktualisiert.
...
Der erste Befehl verwendet das Get-AzDnsRecordSet-Cmdlet, um den angegebenen Datensatzsatz zu erhalten, und speichert ihn dann in $RecordSet Variable.
...
Der Datensatzsatz wird nicht aktualisiert, wenn er in Azure DNS seit dem Abrufen des lokalen **"RecordSet"-Objekts** geändert wurde.
Dies bietet Schutz für gleichzeitige Änderungen.
