...
SOA-Einträge werden automatisch erstellt, wenn eine DNS-Zone erstellt wird, und beim Löschen der DNS-Zone automatisch gelöscht.
...
In diesem Beispiel wird ein AAAA-Datensatz aus einem vorhandenen Datensatzsatz entfernt.
Wenn dies der einzige Datensatz im Datensatzsatz ist, ist das Ergebnis ein leerer Datensatzsatz.
Informationen zum vollständigen Entfernen eines Datensatzes finden Sie unter "Remove-AzDnsRecordSet".
