...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzApiManagementApiFromProduct"** entfernt eine Azure API Management API aus einem Produkt.

## BEISPIELE

### Beispiel 1: Entfernen einer API aus einem Produkt
```
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Remove-AzApiManagementApiFromProduct -Context $ApiMgmtContext -ProductId "0123456789" -ApiId "0001" -PassThru
```

Mit diesem Befehl wird die angegebene API aus einem Produkt entfernt.
...
### -PassThru
Gibt an, dass dieses Cmdlet den Wert "$True, wenn es erfolgreich ist, oder andernfalls $False zurückgibt.
