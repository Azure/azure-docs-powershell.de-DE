...
## BESCHREIBUNG
Das **Cmdlet "Get-AzApiManagementGateway"** ruft das spezifische API-Verwaltungsgateway ab.

## BEISPIELE

### Beispiel 1: Alle Gateways erhalten
```
...
### Beispiel 2: Erhalten eines Gateways nach ID
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
### -GatewayId
Id eines Gateways.
Bei Angabe wird versucht, das Gateway nach dem Bezeichner zu finden.
