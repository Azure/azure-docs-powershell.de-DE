...
### -ApiRevision
Bezeichner der API-Überarbeitung. Dieser Parameter ist optional. Wenn keine Angabe erfolgt, erfolgt der Import auf die derzeit aktive Überarbeitung oder eine neue API.
...
### -ServiceUrl
Eine URL des Webdiensts, der die API verfügbar machen soll. Diese URL wird nur von Azure API Management verwendet und nicht öffentlich gemacht. Dieser Parameter ist optional. Sofern angegeben, setzt sie die im Dokument "Specifications" angegebene "ServiceUrl" außer Kraft.
