...
## BESCHREIBUNG
Das **Cmdlet "Set-AzApiManagementNamedValue"** ändert einen benannten Azure API Management-Wert.
...
### -PassThru
Wenn angegeben, wird die Instanz des Microsoft.Azure.Commands.ApiManagement.ServiceManagement.Models.PsApiManagementProperty-Typs, der die geänderte Eigenschaft darstellt, in die Ausgabe geschrieben.
