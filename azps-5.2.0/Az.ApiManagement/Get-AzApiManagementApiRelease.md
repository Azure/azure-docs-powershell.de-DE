...
### Beispiel 2: Abrufen der Versionsinformationen der jeweiligen API-Version
```powershell
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
### -ResourceId
Arm Resource Identifier einer API-Version. Bei Angabe wird versucht, die API Release nach dem Bezeichner zu finden. Dieser Parameter ist erforderlich.
