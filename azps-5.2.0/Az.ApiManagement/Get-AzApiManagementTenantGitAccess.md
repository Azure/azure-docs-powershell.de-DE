...
## BESCHREIBUNG
Das **Cmdlet "Get-AzApiManagementTenantGitAccess"** ruft die Git-Zugriffskonfiguration für einen Mandanten ab.
Die Tasten werden nicht in die Ergebnisdetails eingeschlossen. Um den geheimen Clientgeheimnis zu erhalten, verwenden **Sie "Get-AzApiManagementTenantGitAccessSecret".**

## BEISPIELE

### Beispiel 1: Mandantenzugriffskonfiguration erhalten
```powershell
