...
## BESCHREIBUNG
Das **Cmdlet "New-AzApiManagementApiVersionSet"** erstellt eine API-Versionssatzentität im Azure API-Verwaltungskontext.
...
Mit diesem Befehl wird ein API-Versionssatz erstellt, mit dem das Versionsschema und `Query` der Abfrageparameter verwendet `api-version` werden.

## PARAMETERS

### -ApiVersionSetId
Id für neue API-Versionssatz.
Dieser Parameter ist optional.
Wenn keine Angabe angegeben wird, wird ein Bezeichner generiert.
