...
Das Skript entfernt das Schema `2` aus der `echo-api` API, wenn nicht darauf verwiesen wird.

### Beispiel 2

Das Skript entfernt das Schema 2 aus der Api echo-api, wenn nicht darauf verwiesen wird. (automatisch generiert)
...
### -ResourceId
Arm ResourceId von ApiSchema. Dieser Parameter ist erforderlich.
