...
## BESCHREIBUNG
**Get-AzApiManagementOperation** ruft eine Liste oder einen angegebenen API-Vorgang ab.
...
### Beispiel 2: Abrufen eines API-Verwaltungsvorgangs nach Vorgangs-ID
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementOperation -Context $apimContext -ApiId $APIId -OperationId "Operation003"
```

Dieser Befehl ruft einen API-Verwaltungsvorgang mit der Vorgangs-ID "Operation0003" ab.
...
### -ApiRevision
Bezeichner der API-Überarbeitung. Dieser Parameter ist optional. Wenn diese Angabe nicht angegeben ist, wird der Vorgang aus der derzeit aktiven API-Überarbeitung abgerufen.
...
### -OperationId
Gibt den Vorgangsbezeichner an.
