...
### Beispiel 1: Festlegen des Status sowie der primären und sekundären Schlüssel für ein Abonnement
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Set-AzApiManagementSubscription -Context $apimContext -SubscriptionId -0123456789 -PrimaryKey "80450f7d0b6d481382113073f67822c1" -SecondaryKey "97d6112c3a8f48d5bf0266b7a09a761c" -State "Active"
```

Dieser Befehl legt den primären und sekundären Schlüssel für ein Abonnement fest und aktiviert ihn.
...
### -StateComment
Gibt den Kommentar zum Abonnementstatus an.
Der Standardwert dieses Parameters ist $Null.
