...
Mit diesem Befehl werden die Produktdetails der API-Verwaltung aktualisiert, ein Abonnement erforderlich, und die Veröffentlichung wird dann wieder aufheben.
...
### -LegalTerms
Gibt die rechtlichen Nutzungsbedingungen für das Produkt an.
