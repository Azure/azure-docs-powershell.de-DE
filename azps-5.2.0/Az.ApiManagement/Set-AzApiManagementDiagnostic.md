...
## BESCHREIBUNG
Das Cmdlet **"Set-AzApiManagementDiagnostic"** aktualisiert die Diagnose, die im globalen Bereich oder im Api-Bereich konfiguriert ist.
...
Dieser Befehl ändert den angegebenen Prozentsatz der Diagnoses sampling von 100 bis 50 %.

### Beispiel 2

Ändert eine API-Verwaltungsdiagnose im globalen Bereich oder api-Bereich. (automatisch generiert)
...
### -PassThru
Wenn angegeben, dann Instanz des Microsoft.Azure.Commands.ApiManagement.ServiceManagement.Models.PsApiManagementDiagnostic-Typs, der den festgelegten Diagnosetyp darstellt.
...
### -ResourceId
Arm ResourceId of Diagnostic or Api Diagnostic. Dieser Parameter ist erforderlich.
