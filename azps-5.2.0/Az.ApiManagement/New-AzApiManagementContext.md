...
## BESCHREIBUNG
Das **Cmdlet "New-AzApiManagementContext"** erstellt eine Instanz von **PsAzureApiManagementContext.**
Der Kontext wird für alle API-Verwaltungsdienst-Cmdlets verwendet.

## BEISPIELE

### Beispiel 1: Erstellen einer Instanz "PsApiManagementContext"
```
...
### -ResourceId
Arm Resource Identifier eines ApiManagement-Diensts. Dieser Parameter ist erforderlich.
