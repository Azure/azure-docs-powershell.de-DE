...
## BESCHREIBUNG
Das **Cmdlet "New-AzApiManagementGatewayHostnameConfiguration"** erstellt eine Hostnamenkonfigurierung für das vorhandene Gateway.
...
Mit diesem Befehl wird eine Konfiguration des Hostnamens "h01" für ein "g01"-Gateway erstellt.

## PARAMETERS

### -CertificateResourceId
Eine Ressourcen-ID für die vorhandene Zertifikat-ID. Dieser Parameter ist erforderlich.
...
Id des neuen Hostnamens des Gateways.
...
Flag zum Erzwingen von NegotiateClientCertificate.
Dieser Parameter ist optional.
