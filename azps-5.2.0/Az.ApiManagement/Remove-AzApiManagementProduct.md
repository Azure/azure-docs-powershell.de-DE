...
Wenn Sie diesen Parameter nicht festlegen und Abonnements vorhanden sind, wird eine Ausnahme ausgelöst.
...
### -PassThru
Gibt an, dass dieses Cmdlet den Wert "$True" (falls erfolgreich) oder den Wert "$False" zurückgibt, wenn ein Fehler auftritt.
