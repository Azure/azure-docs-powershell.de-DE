...
Mit diesem Skript wird der Git-Benutzer im Dienst "ApiManagement" konfiguriert, und es wird ein Token für gemeinsam genutzten Zugriff generiert, das den für 8 Stunden gültigen Primärschlüssel verwendet.
