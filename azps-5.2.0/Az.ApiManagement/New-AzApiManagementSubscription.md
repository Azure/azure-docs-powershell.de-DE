...
### Beispiel 2: Erstellen eines Abonnements für den ganzen Api-Bereich
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
### -AllowTracing
Kennzeichnung, die bestimmt, ob die Ablaufverfolgung auf Abonnementebene aktiviert werden kann. Dies ist ein optionaler Parameter, und der Standardwert ist $null.
...
Dieser Parameter muss 1 bis 300 Zeichen umfassen.
...
### -Scope
Der Umfang des Abonnements, unabhängig davon, ob es sich um den Api-Bereich /apis/{apiId} oder den Produktbereich /products/{productId} oder den globalen API-Bereich /apis oder den globalen Bereich /handelt. Dieser Parameter ist erforderlich.
...
Dieser Parameter wird generiert, wenn er nicht angegeben wird.
