...
## SYNOPSIS
Deaktivieren Sie eine Azure Advisor-Empfehlung.
...
## BESCHREIBUNG
Dies führt dazu, dass eine bestimmte Empfehlung für eine bestimmte Dauer oder unendlich verschoben werden kann.
...
Erstellen Sie einen Eintrag für den angegebenen Empfehlungsnamen mit einem Standard-Vornamen und Standardtagen als -1.
...
Für die angegebene Empfehlungs-ID wird ein Vorschlag erstellt.
...
Erstellen eines umstänglich, d. h. von Get-AzAdvisorRecommendation zu Disable-AzAdvisorRecommendation.
...
### -InputObject
Der von einem Aufruf zurückgegebene "PsAzureAdvisorResourceRecommendationBase" für Get-AzAdvisorRecommendation Powershell-Objekttyp.
...
### -ResourceId
Id der Empfehlung, die unterdrückt werden soll.
