...
## SYNOPSIS
Ruft den angegebenen azure-dedizierten HSM ab.
...
### Beispiel 1: Alle dedizierten HSM unter einem Abonnement erhalten
```powershell
...
Dieser Befehl ruft alle dedizierten HSM unter einem Abonnement ab.

### Beispiel 2: Alle dedizierten HSM unter einer Ressourcengruppe erhalten.
```powershell
...
Dieser Befehl ruft alle dedizierten HSM unter einer Ressourcengruppe ab.

### Beispiel 3: Erhalten eines dedizierten HSM nach Name
```powershell
...
Dieser Befehl ruft einen dedizierten HSM nach Name ab.

### Beispiel 4: Erhalten eines dedizierten HSM nach Objekt
```powershell
...
Dieser Befehl ruft einen dedizierten HSM nach Objekt ab.
...
### -ResourceGroupName
Der Name der Ressourcengruppe, zu der der dedizierte Hsm gehört.
...
### -Top
Maximale Anzahl der zu zurückgebende Ergebnisse.
...
INPUTOBJECT <IDedicatedHsmIdentity> : Identity Parameter
  ...
  - `[Name <String>]`: Name des dedizierten Hsm
  - `[ResourceGroupName <String>]`: Der Name der Ressourcengruppe, zu der die Ressource gehört.
