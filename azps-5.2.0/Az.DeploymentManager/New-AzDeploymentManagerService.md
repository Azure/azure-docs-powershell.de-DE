...
## BESCHREIBUNG
Das **Cmdlet "New-AzDeploymentManagerService"** erstellt einen Dienst unter einer Diensttopologie und gibt ein Objekt zurück, das den Dienst darstellt.
Geben Sie den Dienst nach seinem Namen, der Diensttopologie, in der er sich befindet, und dem Namen der Ressourcengruppe an. 

Das Cmdlet gibt ein Dienstobjekt zurück. Sie können dieses Objekt lokal ändern und dann Änderungen an dem Dienst mithilfe des cmdlets Set-AzDeploymentManagerService anwenden.
...
Erstellt einen neuen Dienst mit dem Namen "ContosoService1" unter der Diensttopologie "ContosoServiceTopology" in der Ressourcengruppe "ContosoResourceGroup" am Speicherort "USA, Mitte". Die "TargetLocation"-Eigenschaft gibt an, dass der Dienst "ContosoService1" in der Region "USA, Osten" im angegebenen Abonnement bereitgestellt werden soll.
...
### -ServiceTopologyName
Der Name der Diensttopologie, zu der dieser Dienst gehört.
...
### -TargetLocation
Bestimmt den Speicherort, an dem Ressourcen unter dem Dienst bereitgestellt werden.
