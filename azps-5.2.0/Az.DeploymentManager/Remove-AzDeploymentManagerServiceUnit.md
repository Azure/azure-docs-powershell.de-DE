...
Mit diesem Befehl wird eine Diensteinheit gelöscht, deren Name, Dienstname, Name der Diensttopologie und Ressourcengruppe den Eigenschaften "Name", "ServiceName", "ServiceTopologyName" bzw. "ResourceGroupName" der $serviceUnitObject entsprechen.
