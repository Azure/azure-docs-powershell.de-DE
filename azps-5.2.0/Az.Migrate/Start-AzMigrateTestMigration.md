...
## SYNOPSIS
Startet die Testmigration für den Replikatserver.
...
### -InputObject
Gibt den Replikatserver an, für den die Testmigration initiiert werden muss.
...
### -TestNetworkID
Aktualisiert die virtuelle Netzwerk-ID innerhalb des Azure-Zielabonnements, das für die Testmigration verwendet wird.
...
INPUTOBJECT : Gibt den Replikatserver an, für den <IMigrationItem> die Testmigration initiiert werden muss. Das Serverobjekt kann mit dem cmdlet Get-AzMigrateServerReplication abgerufen werden.
