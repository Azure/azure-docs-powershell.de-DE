...
DISKTOINCLUDE <IVMwareCbtDiskInput[]>: Gibt die Datenträger auf dem Quellserver an, die für die Replikation einbezogen werden sollen.
  ...
  - `IsOSDisk <String>`: Ein Wert, der angibt, ob der Datenträger der Betriebssystemdatenträger ist.
  - `LogStorageAccountId <String>`: Das Protokollspeicherkonto mit ARM ID.
