...
### Beispiel 1: Bereitstellen der Spring Cloud App nach Name.
```powershell
...
Holen Sie sich die App Deploymeng für die Frühlings-Cloud nach Name.

### Beispiel 2: Auflisten der Bereitstellung unter einer bestimmten Quell-Cloud-App.
```powershell
