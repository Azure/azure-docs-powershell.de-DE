...
### Beispiel 1: Aktualisieren der Spring Cloud App nach Name.
```powershell
...
Aktualisieren Sie die Spring Cloud App nach Name.

### Beispiel 2: Aktualisieren der Spring Cloud App über Pipe.
```powershell
...
Aktualisieren Sie die Spring Cloud App über Pipe.
