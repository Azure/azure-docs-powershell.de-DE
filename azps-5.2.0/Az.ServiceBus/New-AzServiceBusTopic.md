...
### -AutoDeleteOnIdle
Gibt das [TimeSpan-Leerlaufintervall](https://msdn.microsoft.com/library/system.timespan.aspx) an, nach dem das Thema automatisch gelöscht wird. Die Mindestdauer beträgt 5 Minuten.
...
Gibt die Dauer an, nach der die Nachricht abläuft, beginnend mit dem Senden der Nachricht an den Service Bus.
...
Gibt die ["TimeSpan"-Struktur](https://msdn.microsoft.com/library/system.timespan.aspx) an, die die Dauer des Doppelten Erkennungsverlaufs definiert. Der Standardwert ist 10 Minuten.
...
### -EnableExpress
Gibt an, ob Expressentitäten aktiviert sind. Eine Expresswarteschlange hält eine Nachricht vorübergehend im Arbeitsspeicher, bevor sie in beständigen Speicher geschrieben wird.
...
### -EnablePartitioning
Gibt an, ob das Thema auf mehrere Nachrichtenbroker aufgeteilt werden soll. 
...
### -SupportOrdering
Gibt an, ob das Thema Sortierung unterstützt.
