...
## BESCHREIBUNG
Das **Cmdlet "New-AzServiceBusNamespace"** erstellt einen neuen Service Bus-Namespace. Nachdem das Namespaceressourcenmanifest erstellt wurde, kann es unveränderlich sein. Dieser Vorgang ist "idempotent".
...
Erstellt einen neuen Service Bus-Namespace innerhalb der angegebenen Ressourcengruppe.
...
### -Location
Der Namespacespeicherort des Service Bus.
...
### -Sku1
Die Service Bus Premium-Namespacedurchsatzeinheiten, zulässige Werte 1 oder 2 oder 4
...
### -SkuName
Der Namespace-SKU-Name des Service Bus.
