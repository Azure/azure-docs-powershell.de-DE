...
## BESCHREIBUNG
Im Get-AzContainerRegistryWebhookEvent cmdlet werden alle Ereignisse eines Webhook aufgeführt.

## BEISPIELE

### Beispiel 1: Ruft alle Ereignisse eines Webhook ab.
```powershell
...
Ruft alle Ereignisse eines Webhook ab.
