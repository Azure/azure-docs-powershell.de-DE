...
## BESCHREIBUNG
Das Get-AzContainerRegistry-Cmdlet ruft eine angegebene Containerregistrierung oder alle Containerregistrierungen in einer Ressourcengruppe oder im Abonnement ab.

## BEISPIELE

### Beispiel 1: Erhalten einer angegebenen Containerregistrierung
```powershell
...
Dieser Befehl ruft die angegebene Containerregistrierung ab.

### Beispiel 2: Alle Containerregistrierungen in einer Ressourcengruppe erhalten
```powershell
...
Dieser Befehl ruft alle Containerregistrierungen in einer Ressourcengruppe ab.

### Beispiel 3: Alle Containerregistrierungen im Abonnement erhalten
```powershell
...
Dieser Befehl ruft alle Containerregistrierungen im Abonnement ab.
...
### -IncludeDetail
Zeigen Sie weitere Details zur Containerregistrierung an.
