...
## BESCHREIBUNG
Das Get-AzContainerRegistryReplication-Cmdlet ruft eine angegebene Replikation einer Containerregistrierung oder aller Replikationen einer Containerregistrierung ab.

## BEISPIELE

### Beispiel 1: Ruft eine angegebene Replikation einer Containerregistrierung ab.
```powershell
...
Ruft eine angegebene Replikation einer Containerregistrierung ab.

### Beispiel 2: Ruft alle Replikationen einer Containerregistrierung ab.
```powershell
...
Ruft alle Replikationen einer Containerregistrierung ab.
...
### -Name
Container-Registrierungsreplikationsname.
...
### -ResourceId
Die Ressourcen-ID der Containerregistrierungsreplikation
