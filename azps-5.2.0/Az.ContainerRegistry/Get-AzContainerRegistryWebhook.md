...
### Beispiel 1: Einen angegebenen Webhook einer Containerregistrierung erhalten
```powershell
...
Einen angegebenen Webhook einer Containerregistrierung erhalten

### Beispiel 2: Alle Webhooks einer Containerregistrierung erhalten
```powershell
...
Alle Webhooks einer Containerregistrierung erhalten

### Beispiel 3: Einen angegebenen Webhook einer Containerregistrierung mit Konfigurationsdetails erhalten
```powershell
...
Einen angegebenen Webhook einer Containerregistrierung mit Konfigurationsdetails erhalten
...
Erhalten Sie die Konfigurationsinformationen für einen Webhook.
