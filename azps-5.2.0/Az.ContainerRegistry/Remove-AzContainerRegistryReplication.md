...
## BESCHREIBUNG
Das Remove-AzContainerRegistryReplication cmdlet entfernt eine Containerregistrierungsreplikation.

## BEISPIELE

### Beispiel 1: Entfernt eine Containerregistrierungsreplikation.
```powershell
...
Standardmäßig wird der Standortname verwendet.
...
### -PassThru
Gibt an, dass dieses Cmdlet "true" zurückgibt, wenn das Entfernen erfolgreich war.
