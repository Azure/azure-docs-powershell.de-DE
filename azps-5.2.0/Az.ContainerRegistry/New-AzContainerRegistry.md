...
## BESCHREIBUNG
Das New-AzContainerRegistry erstellt eine Containerregistrierung.

## BEISPIELE

### Beispiel 1: Erstellen einer Containerregistrierung mit einem neuen Speicherkonto.
```powershell
...
Mit diesem Befehl wird eine Containerregistrierung mit einem neuen Speicherkonto in der Ressourcengruppe \` "MyResourceGroup" \` erstellt.

### Beispiel 2: Erstellen einer Containerregistrierung mit aktivierten Administratorbenutzern
```powershell
...
Dieser Befehl erstellt eine Containerregistrierung mit aktivierten Administratorbenutzern.
...
### -EnableAdminUser
Aktivieren Sie den Administratorbenutzer für die Containerregistrierung.
...
### -Tag
Container Registry Tags.Key-value-Paare in Form einer Hashtabelle.
