...
## BESCHREIBUNG
Das **Cmdlet "Set-AzDiagnosticSetting"** aktiviert oder deaktiviert jede "Grain" und "log category" für die bestimmte Ressource.
...
Mit diesem Befehl werden die Metrikkategorien "Kategorie1" und "Kategorie2" deaktiviert.
...
### Beispiel 5: Aktivieren einer Zeitmask und mehrerer Kategorien
```powershell
...
### Beispiel 6: Verwenden der Pipeline
```powershell
PS C:\>Get-AzDiagnosticSetting -ResourceId "Resource01" | Set-AzDiagnosticSetting -Enabled $True -Category Category1,Category2
```

Dieser Befehl verwendet die PowerShell-Pipeline, um eine Diagnoseeinstellung (ohne Änderung) festlegen.
...
### -EnableLog
Der Wert, der angibt, ob die Diagnoseprotokolle aktiviert oder deaktiviert werden sollen
...
### -EnableMetrics
Der Wert, der angibt, ob die Diagnosemetriken aktiviert oder deaktiviert werden sollen
...
Flag, das angibt, dass der Export nach LA in eine ressourcenspezifische Tabelle ,a.k.a. ausgeführt werden muss. dedizierte oder feste Schematabelle im  Gegensatz zur standardmäßigen dynamischen Schematabelle **"AzureDiagnostics".**
...
### -MetricCategory
Die Liste der metrischen Kategorien. Wenn keine Kategorie angegeben ist, gilt dieser Befehl für alle unterstützten Kategorien. 
...
### -Timegrain
Gibt die Zeitkörner an, die entsprechend dem Wert von "Enabled" für Metriken aktiviert oder deaktiviert *werden sollen.*
