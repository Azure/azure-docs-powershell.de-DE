...
**HINWEIS:** Wenn dieses Cmdlet mit ["Set-AzActivityLogAlert"](https://docs.microsoft.com/en-us/powershell/module/az.monitor/set-azactivitylogalert) verwendet wird, muss mindestens eines dieser Als Parameter übergebenen Objekte das Feld "Kategorie" enthalten. Andernfalls reagiert das Back-End mit 400 (BadRequest.)
