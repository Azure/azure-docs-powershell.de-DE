...
## SYNOPSIS
Abfragen der Verwendungsdaten für den definierten Bereich
...
### Beispiel 1: Aufrufen von AzCostManagementQuery nach Bereich
```powershell
...
Aufrufen von AzCostManagementQuery nach Bereich

### Beispiel 2: Aufrufen von AzCostManagementQuery nach Bereich mit Dimensionen
```powershell
...
Aufrufen von AzCostManagementQuery nach Bereich mit Dimensionen

## PARAMETERS

### -ConfigurationColumn
Array von Spaltennamen, die in die Abfrage eingeschlossen werden sollen.
...
### -DatasetAggregation
Wörterbuch des Aggregationsausdrucks, der in der Abfrage verwendet wird.
...
### -DatasetFilter
Verfügt über einen Filterausdruck, der in der Abfrage verwendet werden soll.
...
### -DatasetDataUlarity
Die Granularität der Zeilen in der Abfrage.
...
### -DatasetGrouping
Array von "Gruppieren nach Ausdruck", das in der Abfrage verwendet werden soll.
Informationen zum Erstellen finden Sie im Abschnitt "NOTES" zu #A0 und zum Erstellen einer Hashtabelle.
...
Dies kann "{externalSubscriptionId}" für verknüpftes Konto oder "{externalBillingAccountId}" für konsolidiertes Konto sein, das für Dimensions-/Abfragevorgänge verwendet wird.
...
Der mit Dimensions-/Abfragevorgängen verknüpfte externe Cloudanbietertyp.
...
### -Timeframe
Der Zeitrahmen für das Pulling von Daten für die Abfrage.
...
### -TimePeriodFrom
Das Startdatum, von dem Daten ab pullt werden.
...
### -TimePeriodTo
Das Enddatum, an das daten pullt werden soll.
...
DATASETFILTER <IQueryFilter> : Verfügt über einen Filterausdruck, der in der Abfrage verwendet werden soll.
  ...
  - `[Dimensions <IQueryComparisonExpression>]`: Verfügt über einen Vergleichsausdruck für eine Dimension
    ...
    - `Operator <OperatorType>`: Der zum Vergleich zu verwendende Operator.
...
DATASETGROUPING <IQueryGrouping[]>: Array der Gruppe nach Ausdruck, die in der Abfrage verwendet werden soll.
  - `Name <String>`: Der Name der zu gruppierende Spalte.
  - `Type <QueryColumnType>`: Hat den Typ der zu gruppierende Spalte.
