...
### Beispiel 1: Erhalten einer Umgebung für Zeitreiheneinblicke
```powershell
...
Dieser Befehl erhält eine Umgebung für Zeitreiheneinblicke.

### Beispiel 2: Auflisten aller Umgebungen für Einblicke in Zeitreihen
```powershell
...
Mit diesem Befehl werden alle Zeitreiheneinblickumgebungen in einer Ressourcengruppe aufgeführt.

### Beispiel 3: Erhalten einer Umgebung für Zeitreihenerkenntnisse nach Objekt
```powershell
...
Dieser Befehl ruft Umgebungen mit Zeitreiheneinblicken ab.
...
### -Expand
Das $expand=Status umfasst den Status der internen Dienste der Umgebung im Time Series Insights-Dienst.
