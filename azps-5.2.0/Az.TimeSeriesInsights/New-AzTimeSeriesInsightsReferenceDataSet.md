...
### Beispiel 1: Erstellen eines Referenzdatensets für eine bestimmte Umgebung  
```powershell
...
Mit diesem Befehl wird ein Referenzdatenset für eine bestimmte Umgebung erstellt.

## PARAMETERS

### -DataStringComparisonBehavior
Das Vergleichsverhalten des Schlüssels für das Referenzdatenset kann mit dieser Eigenschaft festgelegt werden.
Standardmäßig ist der Wert "Ordinal". Dies bedeutet, dass beim Verknüpfen von Referenzdaten mit Ereignissen oder beim Hinzufügen neuer Referenzdaten zwischen Groß- und Kleinschreibung ein Vergleich der Groß-/Kleinschreibung durchgeführt wird.
Wenn "OrdinalIgnoreCase" festgelegt wird, wird ein Vergleich ohne Ignoranz der Groß-/Kleinschreibung verwendet.
...
### -KeyProperty
Die Liste der Schlüsseleigenschaften für das Referenzdatenset.
Informationen zum Erstellen finden Sie im Abschnitt "NOTES" für Eigenschaften von "KEYPROPERTY", und erstellen Sie eine Hashtabelle.
...
### -Name
Der Name des Referenzdatensets.
...
KEYPROPERTY <IReferenceDataSetKeyProperty[]>: Die Liste der Schlüsseleigenschaften für das Referenzdatenset.
  - `[Name <String>]`: Der Name der Schlüsseleigenschaft.
  - `[Type <ReferenceDataKeyPropertyType?>]`: Der Typ der Schlüsseleigenschaft.
