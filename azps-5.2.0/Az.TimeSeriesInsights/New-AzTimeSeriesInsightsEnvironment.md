...
### Beispiel 1: Erstellen einer Umgebung für Einblicke in eine Gen1-Zeitreihe
```powershell
...
### Beispiel 2: Erstellen einer Umgebung für Einblicke in eine Gen2-Zeitreihe
```powershell
...
Mit diesem Befehl wird eine Umgebung zum Aufblick von Zeitreihen der Generation 2 erstellt.
...
Informationen zum Erstellen finden Sie im Abschnitt "NOTES" für "PARTITIONKEYPROPERTY"-Eigenschaften und erstellen eine Hashtabelle.
