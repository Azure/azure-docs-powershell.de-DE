...
### Beispiel 1: Erstellen einer PrincipalAssignment für eine Kusto-Clusterdatenbank
```powershell
...
Mit dem oben angegebenen Befehl wird eine PrincipalAssignment für die Kusto-Clusterdatenbank erstellt.
...
### -PrincipalId
Die dem Datenbankprinzipal zugewiesene Prinzipal-ID.
Es kann sich um eine E-Mail-Adresse, anwendungs-ID oder einen Namen für eine Sicherheitsgruppe geben.
