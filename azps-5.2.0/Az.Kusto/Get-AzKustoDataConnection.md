...
### Beispiel 1: Auflisten aller Datenverbindungen in einer bestimmten Datenbank
```powershell
...
Der oben aufgeführte Befehl gibt alle In-Kusto-Datenbanken im Cluster "testnewkustocluster" zurück, die in der Ressourcengruppe "testrg" gefunden wurden.

### Beispiel 2: Herstellen einer bestimmten Datenverbindung nach Name
```powershell
...
Der oben aufgeführte Befehl gibt die Datenverbindung namens "mykustodataconnection" in der Datenbank "mykustodatabase" des vorhandenen Cluster "testnewkustocluster" zurück, der in der Ressourcengruppe "testrg" gefunden wurde.
