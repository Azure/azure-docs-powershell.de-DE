...
Der obige Befehl aktualisiert die vorhandene EreignisHub-Datenverbindung mit dem Namen "myeventhubdc" für die Datenbank "mykustodatabase" im Cluster "testnewkustocluster".
...
Der obige Befehl aktualisiert die vorhandene EventGrid-Datenverbindung mit dem Namen "myeventgriddc" für die Datenbank "mykustodatabase" im Cluster "testnewkustocluster".
...
Der obige Befehl aktualisiert die vorhandene IotHub-Datenverbindung namens "myiothubdc" für die Datenbank "mykustodatabase" im Cluster "testnewkustocluster".
...
Mit dem obigen Befehl wird die vorhandene EreignisHub-Datenverbindung namens "myeventhubdc" für die Datenbank "mykustodatabase" im Cluster "testnewkustocluster" aktualisiert.
...
Der obige Befehl aktualisiert die vorhandene IotHub-Datenverbindung mit dem Namen "myiothubdc" für die Datenbank "mykustodatabase" im Cluster "testnewkustocluster".
...
Der Name des zu verarbeitende BLOB-Speicherereignistyps.
...
### -Compression
Der Komprimierungstyp für Ereignishubnachrichten.
...
### -ConsumerGroup
Die Consumergruppe "Ereignis/iot-Hub".
...
Optional kann jeder Nachricht das Datenformat hinzugefügt werden.
...
### -EventHubResourceId
Die Ressourcen-ID des Ereignishubs, der zum Erstellen einer Datenverbindung bzw. eines Ereignisrasters verwendet wird, ist für das Senden von Ereignissen konfiguriert.
...
### -IgnoreFirstRecord
Wenn dies auf "true" festgelegt ist, bedeutet dies, dass die Erfassung den ersten Datensatz jeder Datei ignorieren soll.
...
### -MappingRuleName
Die Zuordnungsregel, die zum Erfassung der Daten verwendet werden soll.
...
Optional können die Tabelleninformationen jeder Nachricht hinzugefügt werden.
