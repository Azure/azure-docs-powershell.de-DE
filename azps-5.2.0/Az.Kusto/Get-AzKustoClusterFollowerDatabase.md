...
### Beispiel 1: Auflisten aller gefolgten Datenbanken
```powershell
...
Der oben aufgeführte Befehl listet alle Datenbanken auf, die sich im Besitz dieses Cluster befinden und auf die ein anderer Cluster folgt.
