...
### Beispiel 1: Entfernen einer Liste von Spracherweiterungen aus einem Cluster
```powershell
PS C:\> Remove-AzKustoClusterLanguageExtension -ResourceGroupName testrg -ClusterName testnewkustocluster -Value (@{Name="R"})
```

Der oben aufgeführte Befehl entfernt eine Liste der Spracherweiterungen, die innerhalb von KQL-Abfragen ausgeführt werden können.
...
VALUE <ILanguageExtension[]>: Die Liste der Spracherweiterungen.
