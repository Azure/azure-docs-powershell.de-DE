...
### Beispiel 1: Auflisten aller PrincipalAssignment in einer Datenbank nach Name
```powershell
...
Der oben aufgeführte Befehl gibt alle PrincipalAssignment-Werte in der Datenbank "mykustodatabase" zurück, die im Cluster "testnewkustocluster" gefunden wurde.

### Beispiel 2: Erhalten einer bestimmten PrincipalAssignment in einer Datenbank nach Name
```powershell
...
Der oben aufgeführte Befehl gibt alle PrincipalAssignment namens "kustoprincipal1" in der Datenbank "mykustodatabase" zurück, die im Cluster "testnewkustocluster" gefunden wurde.
