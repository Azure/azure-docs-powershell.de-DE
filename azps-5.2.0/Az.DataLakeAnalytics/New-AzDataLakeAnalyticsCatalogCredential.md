...
## BESCHREIBUNG
Das New-AzDataLakeAnalyticsCatalogCredential erstellt neue Anmeldeinformationen, die in einem Azure Data Lake Analytics-Katalog zum Herstellen einer Verbindung mit externen Datenquellen verwendet werden können.

## BEISPIELE

### Beispiel 1: Erstellen von Anmeldeinformationen für einen Katalog mit Angabe von Host und Port
```
...
### Beispiel 2: Erstellen von Anmeldeinformationen für einen Katalog mit vollständiger URI
```
PS C:\> New-AzDataLakeAnalyticsCatalogCredential -AccountName "ContosoAdlAccount" `
                  -DatabaseName "databaseName" `
                  -CredentialName "exampleDbCred" `
...
### -DatabaseName
Gibt den Namen der Datenbank im Data Lake Analytics-Konto an, in der die Anmeldeinformationen gespeichert werden.
