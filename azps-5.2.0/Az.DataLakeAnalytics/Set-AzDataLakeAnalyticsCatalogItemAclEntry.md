...
## BESCHREIBUNG
Das **Cmdlet "Set-AzDataLakeAnalyticsCatalogItemAclEntry"** fügt in der Zugriffssteuerungsliste (Access Control List, ACL) eines Katalogs oder Katalogelements in Data Lake Analytics einen Eintrag hinzu oder ändert diesen.
...
Dieser Befehl ändert den Katalog-ACE für Deni Fuller, um Leseberechtigungen zu erhalten.
...
Mit diesem Befehl wird die Datenbank-ACE für Deni Fuller so geändert, dass leseberechtigungen vorhanden sind.
...
Dieser Befehl ändert den Katalog-ACE für andere, damit er Leseberechtigungen hat.
...
### Beispiel 5: Ändern der Benutzerbesitzerberechtigungen für einen Katalog
```powershell
...
Dieser Befehl legt die Berechtigung "Besitzer" für das Konto auf "Lesen" fest.

### Beispiel 6: Ändern der Benutzerbesitzerberechtigungen für eine Datenbank
```powershell
...
Dieser Befehl legt die Berechtigung "Besitzer" für die Datenbank auf "Lesen" fest.
...
### -Group
Festlegen des Eintrags "ACL" des Katalogs für die Gruppe
...
### -GroupOwner
Festlegen des Eintrags "ACL" des Katalogs für den Gruppenbesitzer.
...
### -ObjectId
Die Identität des benutzers, der festgelegt werden soll.
...
### -Sonstiges
Festlegen des Eintrags "ACL" des Katalogs für andere
...
### -User
Festlegen des Eintrags "ACL" des Katalogs für den Benutzer
...
### -UserOwner
Legen Sie den Eintrag "ACL" des Katalogs für den Benutzerbesitzer ein.
