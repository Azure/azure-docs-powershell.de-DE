...
## SYNOPSIS
Ruft eine Data Lake Analytics Job-Serie oder -Serie ab.
...
## BESCHREIBUNG
Die **Get-AzDataLakeAnalyticsJobRecurrence** ruft eine bestimmte Serie von Azure Data Lake Analytics Job oder eine Liste von Serien ab.
...
Dieser Befehl ruft die angegebene Aufgabenserie mit der ID '83cb7ad2-3523-4b82-b909-d478b0d8aea3' im Konto 'contosoadla' ab.
...
### -Konto
Der Name des Data Lake Analytics-Kontonamens, unter dem die Aufgabenserie abgerufen werden soll.
...
### -RecurrenceId
DIE ID der bestimmten Auftragsserie, für die Informationen zurücksenend werden.
...
### -SubmittedAfter
Ein optionaler Filter, der Eine/n-Serie(n) zurückgibt, die nur nach der angegebenen Zeit übermittelt wird.
...
### -SubmittedBefore
Ein optionaler Filter, der Eine/n-Serie(n) zurückgibt, die nur vor dem angegebenen Zeitpunkt übermittelt werden.
