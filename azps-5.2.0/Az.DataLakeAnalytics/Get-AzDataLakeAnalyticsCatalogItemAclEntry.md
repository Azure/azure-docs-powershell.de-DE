...
## BESCHREIBUNG
Das **Cmdlet "Get-AzDataLakeAnalyticsCatalogItemAclEntry"** ruft eine Liste von Einträgen (ACEs) in der Zugriffssteuerungsliste (Access Control List, ACL) eines Katalogs oder Katalogelements in Data Lake Analytics ab.

## BEISPIELE

### Beispiel 1: Erhalten der ACL für einen Katalog
```powershell
...
Dieser Befehl ruft die ACL für den Katalog des angegebenen Data Lake Analytics-Kontos ab.

### Beispiel 2: Erhalten des Eintrags "ACL" des Benutzerbesitzers für einen Katalog
```powershell
...
Dieser Befehl ruft den Eintrag "ACL" des Benutzerbesitzers für den Katalog des angegebenen Data Lake Analytics-Kontos ab.

### Beispiel 3: Erhalten des Eintrags "ACL" des Gruppenbesitzers für einen Katalog
```powershell
...
Dieser Befehl ruft den "ACL"-Eintrag des Gruppenbesitzers für den Katalog des angegebenen Data Lake Analytics-Kontos ab.

### Beispiel 4: Erhalten der ACL für eine Datenbank
```powershell
...
Dieser Befehl ruft die ACL für die Datenbank des angegebenen Data Lake Analytics-Kontos ab.

### Beispiel 5: Erhalten des Eintrags "ACL" des Benutzerbesitzers für eine Datenbank
```powershell
...
Dieser Befehl ruft den Eintrag "ACL" des Benutzerbesitzers für die Datenbank des angegebenen Data Lake Analytics-Kontos ab.

### Beispiel 6: Erhalten des Eintrags "ACL" des Gruppenbesitzers für eine Datenbank
```powershell
...
Dieser Befehl ruft den Eintrag "ACL" des Gruppenbesitzers für die Datenbank des angegebenen Data Lake Analytics-Kontos ab.
...
### -GroupOwner
Erhalten des Katalogeintrags "ACL" für den Gruppenbesitzer
...
### -ItemType
Gibt den Typ des/der Katalog- oder Katalogelement(en) an. Die zulässigen Werte für diesen Parameter sind:
- Katalog
- Datenbank
...
### -UserOwner
Erhalten Sie den Eintrag "ACL" des Katalogs für den Benutzerbesitzer.
