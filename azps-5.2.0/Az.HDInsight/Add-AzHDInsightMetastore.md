...
Mit diesem Befehl wird dem Cluster SQL Datenbankmetastore namens "ihr-hadoop-001" hinzugefügt.

### Beispiel 2: Hinzufügen einer benutzerdefinierten Datenbanken aus Denkmodellen zum Clusterkonfigurationsobjekt
```
PS C:\># Primary storage account info
PS C:\> $storageAccountResourceGroupName = "Group"
PS C:\> $storageAccountResourceId = "yourstorageaccountresourceid"
