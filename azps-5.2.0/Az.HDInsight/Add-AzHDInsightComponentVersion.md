...
## BESCHREIBUNG
Das Add-AzHDInsightComponentVersion cmdlet fügt eine Version für einen Dienst, der in einem Cluster ausgeführt wird, dem Azure HDInsight-Konfigurationsobjekt hinzu, das vom cmdlet New-AzHDInsightClusterConfig erstellt wurde.

## BEISPIELE

### Beispiel 1: Hinzufügen einer Version für Spark zum Clusterkonfigurationsobjekt.
```
...
Mit diesem Befehl wird die Version von Spark dem Cluster "HDInsight" namens "Ihre-Spark-001" hinzufügt.
