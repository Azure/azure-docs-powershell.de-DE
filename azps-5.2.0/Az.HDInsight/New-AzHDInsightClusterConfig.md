...
## BESCHREIBUNG
Das **Cmdlet "New-AzHDInsightClusterConfig"** erstellt ein nicht beibehaltenes Objekt, das eine Konfiguration des Azure -HDInsight-Cluster beschreibt.
...
### -EdgeNodeSize
Gibt die Größe des virtuellen Computers für den Edgeknoten an. Verwenden Get-AzVMSize für akzeptable Größen für virtuelle Computer, und sehen Sie sich die Preisseite von HDInsight an. Dieser Parameter ist nur für RServer-Cluster gültig.
...
Verwenden Get-AzVMSize für akzeptable Größen für virtuelle Computer, und sehen Sie sich die Preisseite von HDInsight an.
...
### -StruktureMetastore
Gibt den Metastore an, in dem Strukturmetadaten gespeichert werden.
...
### -OozieMetastore
Gibt den Metastore an, in dem die Metadaten von Oozie gespeichert werden.
...
Ruft die Ressourcen-ID des Speicherkontos ab oder legt diese fest.
...
### -StorageAccountType
Ruft den Typ des Standardspeicherkontos ab oder legt diesen Typ fest.
