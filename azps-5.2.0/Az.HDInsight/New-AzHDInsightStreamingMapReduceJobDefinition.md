...
## BESCHREIBUNG
Das **Cmdlet "New-AzHDInsightStreamingMapReduceJobDefinition"** definiert ein Auftragsobjekt für "Streaming MapReduce" zur Verwendung mit einem Azure HDInsight-Cluster.

## BEISPIELE

### Beispiel 1: Erstellen einer Auftragsdefinition für "Streaming MapReduce"
```
PS C:\># Cluster info
...
Mit diesem Befehl wird eine Auftragsdefinition für Streaming MapReduce erstellt.
...
### -CommandEnvironment
Gibt ein Array von Befehlszeilenumgebungsvariablen an, die festgelegt werden müssen, wenn ein Auftrag auf Workerknoten ausgeführt wird.
...
### -File
Gibt den Pfad zu einer Datei an, die eine Abfrage enthält, die ausgeführt werden soll.
...
### -Mapper
Gibt den Namen einer Mapper-Datei an.
...
### -Reducer
Gibt den Dateinamen "Reducer" an.
