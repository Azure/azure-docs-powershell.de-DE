...
Wenn Sie eine Ausgabe angeben, die bereits vorhanden ist, ohne den Parameter *"Force"* anzugeben, fragt das Cmdlet, ob die vorhandene Ausgabe ersetzt werden soll.
...
Mit diesem Befehl wird eine neue Ausgabe namens "Ausgabe" im Auftrag "StreamingJob" erstellt.
Wenn bereits eine Ausgabe mit diesem Namen definiert ist, fragt das Cmdlet, ob sie ersetzt werden soll.
...
Dieser Befehl ersetzt die Definition für "Ausgabe" im Auftrag "StreamingJob" ohne Bestätigung.
...
### -File
Gibt den Pfad zu einer JSON-Datei an, die die JSON-Darstellung der zu erstellenden Azure Stream Analytics-Ausgabe enthält.
...
### -Name
Gibt den Namen der Azure Stream Analytics-Ausgabe an, die erstellt werden soll.
