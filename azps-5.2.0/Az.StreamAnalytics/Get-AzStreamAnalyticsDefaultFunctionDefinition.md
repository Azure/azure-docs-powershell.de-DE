...
### -File
Gibt den Pfad einer JSON-Datei an, die die JavaScript Object Notation (JSON)-Darstellung des Anforderungstexts für die Anforderungsdefinitionsanforderung zum Abrufen enthält.
