...
### Beispiel 1: Get Consortiums.
```powershell
PS C:\> Get-AzBlockchainConsortium -Location eastus

```

Mit diesem Befehl werden die Consortiums unter einem Abonnement für einen bestimmten Standort aufgeführt.
...
### Microsoft.Azure.PowerShell.Cmdlets.Feeds.Models.Api20180601Preview.IConsortium
