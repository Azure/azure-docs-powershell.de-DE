...
## BESCHREIBUNG
Das **Cmdlet "Get-AzCognitiveServicesAccount"** ruft die bereitgestellten Cognitive Services-Konten in der Ressourcengruppe ab, die durch den *Parameter "ResourceGroupName" angegeben* wird.
Wenn Sie den Parameter *"ResourceGroupName"* nicht angeben, ruft dieses Cmdlet alle Cognitive Services-Konten für das aktuelle Abonnement ab.
...
### -Name
Gibt den Namen des zu erhaltenden Cognitive Services-Kontos an.
...
### -ResourceGroupName
Gibt den Namen der Ressourcengruppe an, der das Cognitive Services-Konto zugeordnet ist.
