...
## BESCHREIBUNG
Das **Cmdlet "New-AzSqlDatabaseSecondary"** ersetzt das cmdlet Start-AzSqlDatabaseCopy, wenn es zum Einrichten der Georeplikation für eine Datenbank verwendet wird. Es gibt das Verknüpfungsobjekt für die Georeplikation von der primären zur sekundären Datenbank zurück.
...
### Beispiel 2: Einrichten des aktiven Geo-Replication und Angeben des Namens der Partnerdatenbank, der sich vom Namen der Quelldatenbank unterscheiden soll
```powershell
$database = Get-AzSqlDatabase -DatabaseName $databasename -ResourceGroupName $primaryresourcegroupname -ServerName $primaryservername
...
### -AllowConnections
Gibt die Leseabsicht der sekundären Azure SQL an.
...
### -PartnerDatabaseName
Der Name der sekundären Datenbank, die erstellt werden soll.
...
Gibt den Namen der Azure-Ressourcengruppe an, der dieses Cmdlet die sekundäre Datenbank zu weist.
...
### -ServerName
Gibt den Namen des SQL Server der primären Datenbank SQL an.
...
### -Tags
Gibt die Schlüssel-Wert-Paare in Form einer Hashtabelle an, die der Verknüpfung SQL Datenbankreplikation zugeordnet werden soll. Beispiel: @{key0="value0";key1=$null;key2="value2"}
