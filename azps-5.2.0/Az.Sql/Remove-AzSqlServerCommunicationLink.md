...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzSqlServerCommunicationLink"** löscht eine Server-zu-Server-Kommunikationsverknüpfung für datenbankunverbindete Transaktionen in Azure SQL-Datenbank.
...
Mit diesem Befehl wird ein Server-zu-Server-Kommunikationslink namens Link01 auf ContosoServer17 gelöscht.
...
### -LinkName
Gibt den Namen der Serverkommunikationsverknüpfung an, die von diesem Cmdlet gelöscht wird.
...
Dieser Server enthält die Kommunikationsverknüpfung, die von diesem Cmdlet gelöscht wird.
