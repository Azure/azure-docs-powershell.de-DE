...
## BESCHREIBUNG
Das Disable-AzSqlInstanceDatabaseSensitivityRecommendation deaktiviert (schließt) Vertraulichkeitsempfehlungen für Spalten in der Azure SQL Instanzdatenbank.

## BEISPIELE

### Beispiel 1: Deaktivieren Sie Vertraulichkeitsempfehlungen für eine bestimmte Spalte in einer Azure SQL verwaltete Instanzdatenbank.
```powershell
...
### Beispiel 2: Deaktivieren Sie Vertraulichkeitsempfehlungen für Spalten, die Vertraulichkeitsempfehlungen in einer Azure SQL Verwaltete Instanzdatenbank mit Piping enthalten.
```powershell
...
### Beispiel 3: Deaktivieren sie Vertraulichkeitsempfehlungen für eine bestimmte Spalte in einer Azure SQL Verwaltete Instanzdatenbank mit Piping.
```powershell
