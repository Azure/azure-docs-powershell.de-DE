...
> [!IMPORTANT]
> Um dieses Cmdlet verwenden zu können, muss die Firewall auf Azure SQL Server so konfiguriert werden, dass "Azure-Dienste und -Ressourcen den Zugriff auf diesen Server erlauben" konfiguriert werden. Wenn dies nicht konfiguriert ist, werden Fehler beim GatewayTimeout angezeigt.
