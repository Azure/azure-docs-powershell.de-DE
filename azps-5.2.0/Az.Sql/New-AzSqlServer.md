...
Gibt die Anmeldeinformationen SQL Datenbankserveradministrator für den neuen Server an. Um ein **"PSCredential"-Objekt** zu erhalten, verwenden Sie das Get-Credential-Cmdlet. Weitere Informationen erhalten Sie, wenn Sie " `Get-Help
