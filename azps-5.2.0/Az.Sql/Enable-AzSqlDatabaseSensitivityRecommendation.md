...
## BESCHREIBUNG
Das Enable-AzSqlDatabaseSensitivityRecommendation ermöglicht Vertraulichkeitsempfehlungen für Spalten in der Datenbank.

## BEISPIELE

### Beispiel 1: Aktivieren von Vertraulichkeitsempfehlungen für eine bestimmte Spalte in einer Azure SQL-Datenbank.
```powershell
...
### Beispiel 2: Aktivieren von Vertraulichkeitsempfehlungen für eine bestimmte Spalte von Azure SQL mithilfe von Piping.
```powershell
