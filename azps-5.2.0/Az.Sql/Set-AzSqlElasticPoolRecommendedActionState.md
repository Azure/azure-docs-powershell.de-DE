...
## BESCHREIBUNG
Das **Cmdlet "Set-AzSqlElasticPoolRecommendedActionState"** aktualisiert den Status einer empfohlenen Aktion SQL Azure SQL Pool.
Dieses Cmdlet wendet eine empfohlene Aktion basierend auf dem neuen Zustand an, wird zurückgesetzt oder verworfen.
...
Mit diesem Befehl wird der Status der empfohlenen Aktion des Pool "IR_ \[ test_schema \] _ \[ test_table_0.0361551 \] _6C7AE8CC9C87E7FD5893 "Ausstehend" aktualisiert.
...
### -State
Gibt den Wert an, mit dem dieses Cmdlet den empfohlenen Aktionszustand aktualisiert.
