...
## BESCHREIBUNG
Das **Cmdlet "Get-AzSqlServerActiveDirectoryAdministrator"** ruft Informationen über einen Azure Active Directory (Azure AD)-Administrator für einen AzureSQL Server im aktuellen Abonnement ab.

## BEISPIELE

### Beispiel 1: Ruft Informationen zu einem Administrator für einen Server ab.
```
...
Dieser Befehl ruft Informationen über einen Azure -AD-Administrator für einen Server namens Server01 ab, der einer Ressourcengruppe mit dem Namen "ResourceGroup01" zugeordnet ist.
...
### -ResourceGroupName
Gibt den Namen der Ressourcengruppe an, der die SQL Server wird.
...
### -ServerName
Gibt den Namen der SQL Server an, für die dieses Cmdlet Informationen erhält.
