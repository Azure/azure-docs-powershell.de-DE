...
## BESCHREIBUNG
Das **Cmdlet "Set-AzSqlInstancePool"** ändert die Eigenschaften eines Azure SQL-Instanzpools.

## BEISPIELE

### Beispiel 1: Festlegen eines Instanzpoollizenztyps
```powershell
...
Dieser Befehl legt den Lizenztyp und/oder Tags für einen Instanzpool namens "instancePool0" fest.

### Beispiel 2: Festlegen eines Instanzpoollizenztyps mithilfe eines Instanzpoolobjekts
```powershell
...
Dieser Befehl legt den Lizenztyp und/oder Tags für einen Instanzpool mithilfe eines Instanzpoolobjekts fest.

### Beispiel 3: Festlegen eines Instanzpoollizenztyps mithilfe einer Ressourcen-ID des Instanzpools
```powershell
...
### -InputObject
Das Eingabeobjekt des Instanzpools.
...
### -LicenseType
Bestimmt, welcher Lizenztyp verwendet werden soll.
Mögliche Werte sind "BasePrice" (mit AHB-Rabatt) und "LicenseIncluded" (ohne AHB-Rabatt).
