...
## BESCHREIBUNG
Das Get-AzSqlElasticJob-Cmdlet erhält eine oder mehrere Aufträge

## BEISPIELE

### Beispiel 1: Erhält einen Auftrag
```powershell
...
Ruft eine oder mehrere Aufträge ab. (automatisch generiert)
