...
## BESCHREIBUNG
Das **Cmdlet "Get-AzSqlServerServiceObjective"** ruft die verfügbaren Dienstziele für einen Azure SQL Datenbankserver ab.

## BEISPIELE

### Beispiel 1: Erhalten von Dienstzielen
```
...
Dieser Befehl ruft die Dienstziele für den Server namens Server01 ab.

### Beispiel 2: Erhalten von Dienstzielen mithilfe der Filterung
```
...
Dieser Befehl ruft die Dienstziele für den Server namens Server01 ab, die mit "System" beginnen.

### Beispiel 3: Erhalten von Dienstzielen für einen Standort
```
...
Dieser Befehl ruft die Dienstziele für eine bestimmte Region von Azure ab.
...
### -Location
Der Name des Standorts, für den die Dienstziele festgelegt werden sollen.
...
Dieses Cmdlet ruft Dienstziele für einen SQL Datenbankserver ab, der dieser Ressource zugewiesen ist.
...
### -ServerName
Gibt den Namen einer SQL Datenbank SQL Datenbankserver an.
...
Gibt den Namen eines Dienstziels für einen Azure SQL Datenbankserver an.
