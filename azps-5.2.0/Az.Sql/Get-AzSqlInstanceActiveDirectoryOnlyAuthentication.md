...
## BESCHREIBUNG
Das **Cmdlet "Get-AzSqlInstanceActiveDirectoryOnlyAuthentication"** ruft im aktuellen Abonnement nur die Authentifizierungsanforderung für Azure Active Directory (Azure AD) für eine azureSQL-verwaltete Instanz ab.
...
Dieser Befehl ruft nur die Authentifizierungsanforderung für Azure Active Directory (Azure AD) für eine azureSQL-verwaltete Instanz namens "ManagedInstance01" ab, die einer Ressourcengruppe mit dem Namen "ResourceGroup01" zugeordnet ist.
