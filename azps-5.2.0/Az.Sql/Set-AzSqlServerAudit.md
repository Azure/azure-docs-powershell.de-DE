...
### Beispiel 7: Aktivieren der Protokollanalyseüberwachungsrichtlinie eines Azure SQL Servers
```powershell
...
### -StorageKeyType
Gibt an, welche der Speicherzugriffsschlüssel verwendet werden soll.
