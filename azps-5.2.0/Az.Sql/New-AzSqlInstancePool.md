...
## BESCHREIBUNG
Das **Cmdlet "New-AzSqlInstancePool"** erstellt einen Azure SQL-Instanzpool.
...
Mit diesem Befehl wird ein neuer Azure SQL Instanzpool erstellt.
...
### -ComputeGeneration
Die Berechnungsgenerierung für den Instanzpool.
...
### -Edition
Die Edition für den Instanzpool.
...
### -Location
Der Speicherort zum Erstellen des Instanzpools.
...
### -SubnetId
Die Subnetz-ID, die für die Erstellung des Instanzenpools verwendet werden soll.
