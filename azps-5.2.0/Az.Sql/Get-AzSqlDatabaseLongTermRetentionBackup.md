...
## BESCHREIBUNG
Das **Cmdlet "Get-AzSqlDatabaseLongTermRetentionBackup"** ruft alle langfristigen Aufbewahrungssicherungen für einen Speicherort, Server oder eine Datenbank ab oder ruft eine bestimmte langfristige Aufbewahrungssicherung ab.
...
Mit diesem Befehl werden alle langfristigen Aufbewahrungssicherungen für alle Datenbanken (die in Northeurope gespeichert oder gelöscht werden können) nur dann festgelegt, wenn der Server live ist.

### Beispiel 2: Alle Sicherungen für einen Speicherort unter einer Ressourcengruppe erhalten
```powershell
...
Dieser Befehl ruft alle langfristigen Aufbewahrungssicherungen für alle Datenbanken (die möglicherweise lebendig oder gelöscht werden) unter einer Ressourcengruppe in Northeurope ab.
...
Dieser Befehl ruft alle langfristigen Aufbewahrungssicherungen für Datenbank01 ab.
...
### -DatabaseState
Der Status der Datenbank, deren Sicherungen Sie suchen möchten, "Alive", "Deleted" oder "All".
...
### -InputObject
Das Datenbankobjekt, für das Sicherungen erstellt werden sollen.
...
Gibt an, ob sie nur die neueste Sicherung pro Datenbank erhalten soll oder nicht.
...
### -ResourceId
Die Datenbankressourcen-ID, für die Sicherungen erstellt werden sollen.
