...
### Beispiel 1: Auflisten aller Virtuellen Netzwerkregel unter einer MariaDB
```powershell
...
Dieser Befehl listet alle Regeln für virtuelle Netzwerke unter einer MariaDB auf.

### Beispiel 2: Erhalten einer Regel für ein virtuelles Netzwerk unter einer MariaDB
```powershell
...
Dieser Befehl ruft eine Regel für das virtuelle Netzwerk unter einer MariaDB ab.
