...
Dieser Befehl mit Parametereingabeobjekt erstellt einen Replikat-DB mit Parametereingabeobjekt für eine MariaDB.
...
MASTER: <IServer> Das Quellserverobjekt, aus dem sie wiederhergestellt werden soll.
