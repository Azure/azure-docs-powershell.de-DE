...
## BESCHREIBUNG
Sie können einen registrierten ASN erhalten oder auflisten.
...
Listen, die als "registriert" registriert sind.

### Wird asN für Peering nach Name registriert
```powershell
PS C:\> Get-AzPeeringRegisteredAsn -ResourceGroupName $resourceGroupName -PeeringName $peeringName -Name $registeredAsnName
```

Ruft asn registriertes Peering ab.
