...
## BESCHREIBUNG
Das **Cmdlet "Get-AzDataShareDataSet"** ruft Informationen zu Datensätzen ab, die bei einer Freigabe in einem Azure-Datenfreigabekonto hinzugefügt wurden. Wenn Sie den Namen des Datensets angeben, ruft dieses Cmdlet Informationen über das Datenset ab. Wenn Sie keinen Namen angeben, ruft dieses Cmdlet Informationen zu allen Datensätzen in einer Freigabe ab. I
...
Dieser Befehl zeigt Informationen zum Dataset AdsDataSet in "AdsShare teilen" im WikiAdsAccount des Azure-Datenfreigabekontos und der Ressourcengruppe ADS an.
