...
## BESCHREIBUNG
Das **Cmdlet "Get-AzDataShareAccount"** ruft Informationen zu Datenfreigabekonten in einer Azure-Abonnement-/Ressourcengruppe ab.
Wenn Sie den Namen eines Kontos angeben, ruft dieses Cmdlet Informationen zu diesem datshare-Konto ab.
Wenn Sie keinen Namen angeben, ruft dieses Cmdlet Informationen zu allen Datenfreigabekonten in einer Azure-Abonnement-/Ressourcengruppe ab.
