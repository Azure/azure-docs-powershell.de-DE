...
## BESCHREIBUNG
Das **Cmdlet "Stop-AzHpcCache"** beendet einen Azure HPC-Cache.
...
### -Force
Zeigt an, dass sie vom Cmdlet nicht zur Bestätigung aufgefordert werden. Standardmäßig werden Sie von diesem Cmdlet aufgefordert zu bestätigen, dass Sie den Cache beenden möchten.
...
### -ResourceGroupName
Name der Ressourcengruppe, unter der Sie den Cache beenden möchten.
