...
## BESCHREIBUNG
Das **Cmdlet "Update-AzHpcCache"** aktualisiert einen Azure HPC-Cache.
...
### -Force
Zeigt an, dass sie vom Cmdlet nicht zur Bestätigung aufgefordert werden. Dieses Cmdlet fordert Sie standardmäßig auf zu bestätigen, dass Sie den Cache aktualisieren möchten.
...
### -Upgrade
Führen Sie ein Upgrade von HpcCache durch.
