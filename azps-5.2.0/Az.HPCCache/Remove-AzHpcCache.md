...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzHpcCache"** entfernt einen Azure HPC-Cache.
...
### -Force
Zeigt an, dass sie vom Cmdlet nicht zur Bestätigung aufgefordert werden. Dieses Cmdlet fordert Sie standardmäßig auf zu bestätigen, dass Sie den Cache entfernen möchten.
...
### -ResourceGroupName
Name der Ressourcengruppe, unter der Sie den Cache entfernen möchten.
