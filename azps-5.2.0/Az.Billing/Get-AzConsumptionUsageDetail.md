...
## BESCHREIBUNG
Das **Cmdlet "Get-AzConsumptionUsageDetail"** ruft Nutzungsdetails des Abonnements ab. 

## BEISPIELE

### Beispiel 1: Nutzungsdetails mit der Erweiterung "MeterDetails" erhalten
```powershell
...
### Beispiel 2: Anzeigen von Nutzungsdetails mit Datumsbereich
```powershell
...
### Beispiel 3: Erhalten von Nutzungsdetails von BillingPeriodName mit InstanceName-Filter
```powershell
...
### -BillingPeriodName
Der Name eines bestimmten Abrechnungszeitraums, um die Nutzungsdetails zu erhalten, die damit in Verbindung kommen.
...
### -EndDate
Das Enddatum (in UTC) der zu filternden Nutzungen.
...
### -Expand
Erweitern Sie die Verwendungen basierend auf "MeterDetails" oder "AdditionalInfo".
...
### -IncludeMeterDetails
Fügen Sie die Details zum Zähler in die Verwendungen ein.
...
### -InstanceId
Die Instanz-ID der zu filternden Verwendungen.
...
### -InstanceName
Der Instanzname der zu filternden Verwendungen.
...
### -ResourceGroup
Die Ressourcengruppe der zu filternden Verwendungen.
...
### -StartDate
Das Startdatum (in UTC) der zu filternden Verwendungen.
...
### -Tag
Das Tag der zu filternden Verwendungen.
