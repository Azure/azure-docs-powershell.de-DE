...
## BESCHREIBUNG
Das **Cmdlet "Get-AzConsumptionMarketplace"** ruft Marketplaces des Abonnements ab.

## BEISPIELE

### Beispiel 1: Nutzung von Marketplaces
```powershell
...
### Beispiel 2: Erhalten der Marketplace-Nutzung mit Datumsbereich
```powershell
...
### Beispiel 3: Erhalten der Marketplace-Nutzung von BillingPeriodName
```powershell
...
### Beispiel 4: Get marketplace usage with InstanceName filter
```powershell
...
### -BillingPeriodName
Name eines bestimmten Abrechnungszeitraums, um den Marketplace zu erhalten, mit dem eine Verbindung zu verknüpfen ist.
...
### -EndDate
Das Enddatum (in UTC) der zu filternden Marketplaces.
...
### -InstanceId
Die Instanz-ID der zu filternden Marketplaces.
...
### -InstanceName
Der Instanzname der zu filternden Marketplaces.
...
### -ResourceGroup
Die Ressourcengruppe der zu filternden Marketplaces.
...
### -StartDate
Das Startdatum (in UTC) der zu filternden Marketplaces.
