...
### Beispiel 1: Erstellen eines vnet-Peerings für Databinnen und Daten
```powershell
...
Mit diesem Befehl wird ein vnet-Peering für Databinnen erstellt.

## PARAMETERS

### -AllowForwardedTraffic
Gibt an, ob der weitergeleitete Datenverkehr von den VMs im lokalen virtuellen Netzwerk im virtuellen Remotenetzwerk zugelassen bzw. nicht zugelassen wird.
...
Ob die VMs im lokalen virtuellen Netzwerkbereich auf die VMs im remote virtuellen Netzwerkbereich zugreifen können.
...
### -DatabidosVirtualNetworkId
Die ID des virtuellen Datennetzwerks.
...
### -Name
Der Name des vNet-Arbeitsbereichs-Peerings.
...
### -UseRemoteGateway
Remotegateways können in diesem virtuellen Netzwerk verwendet werden.
