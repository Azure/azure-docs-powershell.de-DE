...
### Beispiel 1: Entfernen eines Arbeitsbereichs "Databsdatum"
```powershell
PS C:\> Remove-AzDatabricksWorkspace -ResourceGroupName testgroup -Name databricks-test
```

Mit diesem Befehl wird ein Arbeitsbereich "Databungs" aus einer Ressourcengruppe entfernt.

### Beispiel 2: Entfernen eines Arbeitsbereichs "Databinnen" nach Objekt
```powershell
