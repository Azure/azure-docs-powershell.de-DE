...
## SYNOPSIS
Aktualisiert die CDN-Origin-Gruppe.
...
## BESCHREIBUNG
Set-AzCdnOriginGroup die angegebene Origin-Gruppe innerhalb des angegebenen Endpunkts aktualisiert. 
...
```
Dieses Cmdlet aktualisiert die Eigenschaft "ProbeIntervalInSeconds" in der Origin-Gruppe. 
