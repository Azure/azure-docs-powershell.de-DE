...
Durch das Festlegen dieses Werts werden alle vorhandenen Abfragezeichenfolgen ersetzt. leer lassen, um die eingehende Abfragezeichenfolge zu erhalten.
...
### -Destination
Definieren Sie die relative URL, auf die die oben genannten Anforderungen umgeschrieben werden sollen.
...
### -DestinationProtocol
Das Protokoll, das für die Umleitung verwendet werden soll.
...
### -HeaderActionType
Ob der Anforderungsheader oder der Antwortheader geändert werden soll
...
### -QueryParameter
Abfrageparameter zum Ein- oder Ausschließen (durch Kommas getrennt).
