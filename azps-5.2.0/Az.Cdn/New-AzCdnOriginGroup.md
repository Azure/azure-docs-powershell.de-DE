...
## SYNOPSIS
Erstellt eine neue CDN-Origin-Gruppe.
...
## BESCHREIBUNG
Die New-AzCdnOriginGroup erstellt eine neue Origin-Gruppe innerhalb des angegebenen Endpunkts. Wenn dies die erste Ursprungsgruppe für den Endpunkt ist, muss auch die Eigenschaft "DefaultOriginGroup" festgelegt werden.
...
```
Dieses Cmdlet erstellt eine neue Origin-Gruppe innerhalb des angegebenen Endpunkts. Dabei werden die angegebenen Origin-IDs als Ursprung verwendet.

## PARAMETERS

### -CdnOriginGroup
Das CDN-Origin-Gruppenobjekt.
...
### -OriginGroupName
Name der Azure CDN-Origin-Gruppe.
...
### -ProbePath
Der Pfad relativ zum Ursprung, der verwendet wird, um die Integrität des Ursprungs zu ermitteln.
