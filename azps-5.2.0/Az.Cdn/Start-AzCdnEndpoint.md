...
## BESCHREIBUNG
Das **Start-AzCdnEndpoint-Cmdlet** startet einen Azure Content Delivery Network (CDN)-Endpunkt.
...
### -EndpointName
Gibt den Namen des Endpunkts an, der mit diesem Cmdlet gestartet wird.
