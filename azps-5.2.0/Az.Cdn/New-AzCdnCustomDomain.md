...
## BESCHREIBUNG
Das **Cmdlet "New-AzCdnCustomDomain"** erstellt eine benutzerdefinierte Domäne für den Azure Content Delivery Network (CDN)-Endpunkt.
...
### -CdnEndpoint
Gibt das CDN-Endpunktobjekt an, dem die benutzerdefinierte Domäne hinzugefügt wird.
