...
Mit diesem Befehl wird das ACE für Denkton Fuller so geändert, dass alle Berechtigungen erteilt sind.

### Beispiel 2: Rekursives Ändern von Berechtigungen für einen ACE
```
...
### -Recurse
Gibt an, dass die ACL rekursiv in die untergeordneten Unterverzeichnisse und Dateien geändert werden soll.
