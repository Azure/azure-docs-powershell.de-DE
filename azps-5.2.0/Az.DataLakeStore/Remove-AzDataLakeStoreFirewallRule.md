...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzDataLakeStoreFirewallRule"** entfernt die angegebene Firewallregel im angegebenen Data Lake Store.

## BEISPIELE

### Beispiel 1: Entfernen einer Firewallregel aus einem Konto
```
PS C:\> Remove-AzDataLakeStoreFirewallRule -AccountName "ContosoADL" -Name MyFirewallRule
```

Entfernt die Firewallregel "MyFirewallRule" aus dem Konto "ContosoADL".
...
### -Name
Der Name der zu löschende Firewallregel.
...
### -ResourceGroupName
Gibt den Namen der Ressourcengruppe an, die das Konto enthält, aus dem die Firewallregel entfernt werden soll.
