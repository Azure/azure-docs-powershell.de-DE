...
## BESCHREIBUNG
Das **Cmdlet "Set-AzDataLakeStoreFirewallRule"** ändert die angegebene Firewallregel im angegebenen Data Lake Store.

## BEISPIELE

### Beispiel 1: Aktualisieren des Start- und End-IP-Bereichs für eine Firewallregel
```
...
Aktualisiert die Firewallregel "MyFirewallRule" im Konto "ContosoADL" auf einen Bereich von 127.0.0.1 bis 127.0.0.2

## PARAMETERS

### -Konto
Das Data Lake Store-Konto, um die Firewallregel in
...
### -ResourceGroupName
Gibt den Namen der Ressourcengruppe an, die das Konto enthält, für das die Firewallregel aktualisiert werden soll.
...
### -StartIpAddress
Start des gültigen IP-Bereichs für die Firewallregel
