...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzDataLakeStoreItemAclEntry"** entfernt einen Eintrag (ACE) aus der Zugriffssteuerungsliste (Access Control List, ACL) einer Datei oder eines Ordners im Data Lake Store.

## BEISPIELE

### Beispiel 1: Entfernen eines Benutzereintrags
```
...
Mit diesem Befehl wird der Benutzer-ACE für Ihni Fuller aus dem ContosoADL-Konto entfernt.

### Beispiel 2: Rekursives Entfernen eines Benutzereintrags
```
...
### Beispiel 3: Entfernen von Berechtigungen für ein ACE rekursiv mithilfe des Objekts "Acl"
```
...
Mit diesem Befehl wird der Benutzer-ACE fürGeleiteti Fuller aus dem Stamm entfernt und rekursiv aus allen Unterverzeichnissen und Dateien für das Konto ContosoADL entfernt.
...
### -AceType
Gibt den Typ des zu entfernenden ACE an.
...
### -Acl
Gibt das ACL-Objekt an, das die zu entfernenden Einträge enthält.
...
### -Parallelität
Die Anzahl von Dateien/Verzeichnissen, die parallel verarbeitet werden. Optional: Es wird ein angemessener Standardwert ausgewählt.
...
### -Default
Gibt an, dass mit diesem Vorgang der Standard-ACE aus dem angegebenen ACL entfernt wird.
...
### -ID
Gibt die Objekt-ID des AzureActive Directory-Benutzers, der Gruppe oder des Dienstprinzipal an, für den bzw. die ein ACE entfernt werden soll.
...
### -Path
Gibt den Data Lake Store-Pfad des Elements an, aus dem ein ACE entfernt werden soll, beginnend mit dem Stammverzeichnis (/).
...
### -Recurse
Gibt an, dass die ACL rekursiv in die untergeordneten Unterverzeichnisse und Dateien entfernt werden soll
...
### -ShowProgress
Wenn der Status erfolgreich ist, wird der Status angezeigt. Gilt nur, wenn die rekursive Entfernung des Acl erfolgt.
