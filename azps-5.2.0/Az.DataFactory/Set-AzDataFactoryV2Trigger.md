...
Erstellen Sie einen neuen Trigger namens "ScheduledTrigger" in der Daten factory "WikiADF". Der Trigger wird im Zustand "Stopped" erstellt, was bedeutet, dass er nicht sofort gestartet wird. Ein Trigger kann mit dem `Start-AzDataFactoryV2Trigger` Cmdlet gestartet werden.
