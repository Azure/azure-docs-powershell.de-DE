...
## BESCHREIBUNG
Das **Cmdlet "Stop-AzDataFactoryV2IntegrationRuntime"** beendet eine verwaltete dedizierte Integrationslaufzeit im Zustand "Started", die vom cmdlet Start-AzDataFactoryV2IntegrationRuntime gestartet wurde. Die Ressourcen werden freigegeben, und der Zustand wird auf "Stopped" (Beendet) umgelassen.

## BEISPIELE

### Beispiel 1: Beenden einer verwalteten Integrationslaufzeit im Zustand "Gestartet".
```
...
Die verwaltete Integrationslaufzeit "test-reserlved-ir" befindet sich im Zustand "Started". Nachdem Sie Stop-AzDataFactoryV2IntegrationRuntime cmdlet ausgeführt haben, werden die Ressourcen freigegeben, und der Zustand wird in "Stopped" (Beendet) transferiert.
