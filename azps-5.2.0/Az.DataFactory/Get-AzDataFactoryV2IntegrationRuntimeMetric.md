...
## BESCHREIBUNG
Das Get-AzDataFactoryV2IntegrationRuntimeMetric cmdlet ruft metrische Daten zur Integrationslaufzeit in einer Daten factory ab.

## BEISPIELE

### Beispiel 1: Get integration runtime metric
```
...
Dieser Befehl zeigt metrische Daten zur Integrationslaufzeit mit dem Namen "test-selfhost-ir" im Abonnement für die Ressourcengruppe mit dem Namen "rg-test-dfv2" und der Daten factory mit dem Namen "test-df-eu2" an.
