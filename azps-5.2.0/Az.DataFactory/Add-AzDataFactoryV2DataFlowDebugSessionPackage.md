...
## BESCHREIBUNG
Dieser Befehl fügt die Datenflussressource und deren Abhängigkeiten an die spezifische Debugsitzung an. Die Befehlssequenz für den Datenflussdebuggerworkflow sollte wie im folgenden Fall sein:
...
Fügen Sie das Datenflusspaket zur Debugsitzung "550effe4-93a3-485c-8525-eaf25259efbd" der "WikiADF"-Daten factory hinzu.
Die Datei "Pakcage" enthält eine Debugressource für den Datenfluss, eine Liste der Datasetdebugger-Neuzuordnung, eine Liste der verknüpften Dienstdebuggerressource, Debugeinstellungen und Sitzungs-ID. Zum Beispiel:
...
Der Parameter "SessionID" wird verwendet, um die vorhandene eigenschaft "sessionId" in der Paketdatei zu ersetzen.
...
### -PassThru
Wenn angegeben, wird "true" für den Fall geschrieben, dass der Vorgang erfolgreich ist. Dieser Parameter ist optional.
