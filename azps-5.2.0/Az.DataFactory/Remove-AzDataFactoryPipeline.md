...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzDataFactoryPipeline"** entfernt eine Pipeline aus Azure Data Factory.
...
### -Force
Zeigt an, dass mit diesem Cmdlet eine Pipeline entfernt wird, ohne dass Sie zur Bestätigung aufgefordert werden.
...
Mit diesem Cmdlet wird eine Pipeline aus der Gruppe entfernt, die dieser Parameter angibt.
