...
## BESCHREIBUNG
Das **Cmdlet "Get-AzDataFactoryV2IntegrationRuntimeNode"** ruft die Detailinformationen eines Integrationslaufzeitknotens ab.

## BEISPIELE

### Beispiel 1: Ruft die Detailinformationen eines Integrationslaufzeitknotens ab.
```
...
Das Cmdlet ruft Informationen des Knotens "Node_1" in der selbst gehosteten Integrationslaufzeit "test-selfhost-ir" in der Daten factory "test-df-eu2" ab.

### Beispiel 2: Ruft die Detailinformationen eines Integrationslaufzeitknotens zusammen mit der IP-Adresse ab.
```
...
Das Cmdlet ruft Informationen des Knotens "Node_1" in der selbst gehosteten Integrationslaufzeit "test-selfhost-ir" in der Daten factory 'test-df-eu2' ab, einschließlich der IP-Adresse.
...
### -IpAddress
Die IP-Adresse des Integrationslaufzeitknotens.
