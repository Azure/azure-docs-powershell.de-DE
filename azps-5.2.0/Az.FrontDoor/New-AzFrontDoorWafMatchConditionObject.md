...
### -NegateCondition
Beschreibt, ob dies eine neggate Bedingung oder kein Standardwert "false" ist.
...
Mögliche Werte sind: 'Any', 'IPMatch', 'GeoMatch', 'Equal', 'Contains', 'Less Durch', 'Greater Durch', 'LessMatchOrEqual', 'Greater SelbstQual', 'BeginsWith', 'EndsWith', 'RegEx'
...
### -Transformieren
Anzuwendende Transformationen. Mögliche Werte: "Kleinbuchstaben", "Großbuchstaben", "Kürzen", "UrlDecode", "UrlEncode", "RemoveNulls".
...
### Microsoft.Azure.Commands.FrontD selbst.Models.PSMatchCondition
