...
## BESCHREIBUNG
Das **Cmdlet "New-AzFrontDsource"** erstellt einen neuen Azure Front Door Load Balancer in der angegebenen Ressourcengruppe unter dem aktuellen Abonnement.

## BEISPIELE

### Beispiel 1: Erstellen einer Eingangstür basierend auf bestimmten Parametern.
```powershell
...
Erstellen Sie eine Eingangstür basierend auf bestimmten Parametern.
...
Einstellungen für alle Back-End-Pools
...
### -EnabledState
EnabledState des Lastenausgleichs von Front Door.
