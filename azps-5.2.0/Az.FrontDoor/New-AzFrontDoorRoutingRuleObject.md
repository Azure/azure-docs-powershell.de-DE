...
### -CustomQueryString
Der Satz von Abfragezeichenfolgen, die in die Umleitungs-URL gesetzt werden sollen. Durch festlegen dieses Werts wird jede vorhandene Abfragezeichenfolge ersetzt. leer lassen, um die eingehende Abfragezeichenfolge zu erhalten. Die Abfragezeichenfolge muss sich in <key>=<value> formatieren. Das erste? und & werden automatisch hinzugefügt. Fügen Sie sie daher nicht in den Vorder-/Hintergrund ein, sondern trennen Sie mehrere Abfragezeichenfolgen durch &.
...
### -DynamicCompression
Aktivieren der dynamischen Komprimierung für zwischengespeicherten Inhalt, wenn zwischengespeicherte Inhalte aktiviert sind
...
### -EnableCaching
Gibt an, ob zwischenspeichern für diese Route aktiviert werden soll. Der Standardwert ist falsch.
...
### -PatternToMatch
Die Routenmuster der Regel dürfen nur nach dem letzten /am Ende des Pfads * verfügen. Der Standardwert ist "/*".
...
### Microsoft.Azure.Commands.FrontDando.Models.PSRoutingRule
