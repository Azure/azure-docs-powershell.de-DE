...
## BESCHREIBUNG
Mit **"Disable-AzFrontDcustomDomainHttps"** wird HTTPS für eine benutzerdefinierte Domäne deaktiviert.

## BEISPIELE

### Beispiel 1: Deaktivieren von HTTPS für eine benutzerdefinierte Domäne mit "FrontD ganzname" und "ResourceGroupName".
```powershell
...
Deaktivieren Sie HTTPS für eine benutzerdefinierte Domäne "frontendpointname1-custom-xyz" mit "FrontD ganzname" als "frontd ganz 1" und "ResourceGroupName" als "resourcegroup1".

### Beispiel 2: Deaktivieren von HTTPS für eine benutzerdefinierte Domäne mit einem PSFrontendEndpoint-Objekt.
```powershell
...
Deaktivieren Sie HTTPS für eine benutzerdefinierte Domäne mit psFrontendEndpoint-Objekt.

### Beispiel 3: Deaktivieren von HTTPS für eine benutzerdefinierte Domäne mit ResourceId.
```powershell
...
Deaktivieren Sie HTTPS für eine benutzerdefinierte Domäne "frontendpointname1-custom-xyz" mit "ResourceId" als $resourceId.
...
### -ResourceId
Ressourcen-ID des Endpunkts von Eingangstüren zum Deaktivieren von https
