...
### Beispiel 1: Aktivieren von HTTPS für eine benutzerdefinierte Domäne mit FrontD selbstnamen und ResourceGroupName mithilfe von verwalteten Zertifikaten von Front Door.
```powershell
