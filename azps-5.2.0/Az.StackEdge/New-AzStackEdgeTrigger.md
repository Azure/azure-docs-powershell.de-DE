...
## BESCHREIBUNG
Das **Cmdlet "New-AzStackEdgeTrigger"** konfiguriert einen Trigger auf dem Stack Edge-Gerät. 
...
### -FileEvent
Übergeben sie diesen Parameter zum Konfigurieren des FileEvent-Triggers.
...
### -PeriodicTimerEvent
Übergeben Sie diesen Parameter zum Konfigurieren des PeriodicTimerEvent-Triggers.
...
### -RoleName
Berechnen sie die Rolle, anhand der Ereignisse ausgelöst werden.
...
### -Schedule
Regelmäßige Häufigkeit, mit der ein Timerereignis ausgelöst werden muss. Geben Sie einen Zeitplan in Tagen (zwischen 1 und 365), Stunden (zwischen 1 und 23) oder Minuten (zwischen 1 und 59) an.
...
### -ShareId
Im FileEvent Trigger zu übergebende Dateifreigabe-ID
...
### -ShareName
Dateifreigabe-ID, die in FileEvent Trigger übergeben werden soll
...
### -StartTime
Die Uhrzeit des Tages, die zu einem gültigen Auslöser führt. Der Zeitplan wird mit einem Bezug auf die bis zu Sekunden angegebene Zeit berechnet. Wenn keine Zeitzone angegeben wird, wird die Uhrzeit als in der Gerätezeitzone betrachtet. Der Wert wird immer als UTC-Uhrzeit zurückgegeben.
...
### -Topic
Thema, in dem regelmäßige Ereignisse auf einem IoT-Gerät veröffentlicht werden.
