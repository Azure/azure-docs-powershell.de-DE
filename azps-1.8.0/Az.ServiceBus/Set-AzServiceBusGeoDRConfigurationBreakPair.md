...
## Beschreibung
Das Cmdlet " **festlegen-AzServiceBusGeoDRConfigurationBreakPair** " deaktiviert die Disaster Recovery und beendet die Replikation von Änderungen von primären zu sekundären Namespaces.
...
### -Namespace
Namespace Name – primärer Namespace
