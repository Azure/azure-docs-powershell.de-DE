...
## Beschreibung
Der **Get-AzUserAssignedIdentity** ruft vorhandene Benutzer zugewiesene Identitäten ab.

## Beispiele

### Beispiel 1
Dieses Beispiel-Cmdlet ruft die dem Benutzer zugewiesene Identität mit dem Namen **id1** unter der Ressourcengruppe **PSRG**
...
### Beispiel 2
Dieses Beispiel-Cmdlet ruft alle Benutzer zugewiesenen Identitäten unter der Ressourcengruppe **PSRG**
...
### Beispiel 3
Dieses Beispiel-Cmdlet ruft alle Benutzer zugewiesenen Identitäten unter dem Abonnement ab.
