...
### Entfernen eines Signalisierungs Diensts
```powershell
...
### Entfernen aller Signalisierungs Dienste vom Kanal
```powershell
...
### -PassThru
Gibt "true" zurück, wenn die Entfernung erfolgreich abgeschlossen wurde.
