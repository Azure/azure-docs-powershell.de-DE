...
## Beschreibung
Das Remove-AzContainerRegistryReplication-Cmdlet entfernt eine Container Registrierungsreplikation.

## Beispiele

### Beispiel 1: entfernt eine Container Registrierungsreplikation.
```powershell
