...
## Beschreibung
Überprüfen Sie ein Zertifikat, indem Sie ein Verifizierungszertifikat hochladen, das den Bestätigungscode enthält, der durch Aufrufen von generieren-Verification-Code abgerufen wurde. Dies ist der letzte Schritt beim Nachweis des Besitz Prozesses.
...
Überprüfen Sie den Besitz des privaten Schlüssels "mein Zertifikat".
...
Überprüfen Sie den Besitz des privaten Schlüssels "myCertificate" mithilfe von Pipeline.
