...
## Beschreibung
Das Cmdlet **New-AzFrontDoor** erstellt ein neues Azure Front Door Load Balancer in der angegebenen Ressourcengruppe unter Aktuelles Abonnement.

## Beispiele

### Beispiel 1: Erstellen einer Haustür basierend auf bestimmten Parametern
```powershell
