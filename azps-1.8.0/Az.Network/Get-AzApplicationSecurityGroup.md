...
### Beispiel 4: Abrufen von Anwendungs Sicherheitsgruppen mithilfe von Filtern
```
...
Der obige Befehl gibt alle Anwendungs Sicherheitsgruppen zurück, die mit "MyApplicationSecurityGroup" beginnen.
