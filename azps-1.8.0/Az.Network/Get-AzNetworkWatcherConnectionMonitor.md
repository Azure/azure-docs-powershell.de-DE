...
### Beispiel 2: Abrufen von Verbindungs Monitoren mithilfe von Filtern
```
...
In diesem Beispiel erhalten wir alle Verbindungs Monitore in NetworkWatcher_centraluseuap, die mit "cm" beginnen.
