...
## Beschreibung
Das Remove-AzApplicationGatewaySslPolicy-Cmdlet entfernt die SSL-Richtlinie aus einem Azure Application Gateway.

## Beispiele

### Beispiel 1: Entfernen einer SSL-Richtlinie von einem Anwendungsgateway
```
PS C:\>$AppGW = Get-AzApplicationGateway -Name "ApplicationGateway01" -ResourceGroupName "ResourceGroup01"
PS C:\> $AppGW = Remove-AzApplicationGatewaySslPolicy -ApplicationGateway $AppGW
```

Dieser Befehl entfernt die SSL-Richtlinie aus dem Anwendungsgateway mit dem Namen ApplicationGateway01.

## Parameter

### -ApplicationGateway
Gibt das Anwendungsgateway an, von dem dieses Cmdlet die SSL-Richtlinie entfernt.
