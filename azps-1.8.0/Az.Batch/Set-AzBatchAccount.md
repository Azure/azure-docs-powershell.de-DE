...
## Beschreibung
Das Cmdlet " **Satz-AzBatchAccount** " aktualisiert ein Azure-Batch Konto.
Derzeit kann dieses Cmdlet nur Tags aktualisieren.

## Beispiele

### Beispiel 1: Aktualisieren der Tags in einem Stapelverarbeitungs Konto
```
...
### -Kontoname
Gibt den Namen des Batch Kontos an, das vom Cmdlet aktualisiert wird.
...
### -ResourceGroupName
Gibt die Ressourcengruppe des Kontos an, das vom Cmdlet aktualisiert wird.
