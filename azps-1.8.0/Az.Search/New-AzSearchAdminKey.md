...
## Beschreibung
Das Cmdlet **New-AzSearchAdminKey** generiert einen Administratorschlüssel des Azure-Suchdiensts erneut.
...
Im Beispiel wird der Primärschlüssel des Azure Search-Diensts erneut generiert.
...
### -Keykind
Suchdienstadministrator-Schlüsseltyp (Primär/Sekundär).
