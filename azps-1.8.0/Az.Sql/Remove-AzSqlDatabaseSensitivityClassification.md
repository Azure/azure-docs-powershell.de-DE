...
## Beschreibung
Das Remove-AzSqlDatabaseSensitivityClassification-Cmdlet entfernt die Informationstypen und Vertraulichkeits Bezeichnungen von Spalten in der Datenbank.

## Beispiele

### Beispiel 1: Entfernen des Informationstyps und der Vertraulichkeits Beschriftung einer Spalte in einer Azure SQL-Datenbank.
```powershell
...
### Beispiel 2: Entfernen Sie aktuelle Informationstypen und Vertraulichkeits Beschriftungen von Spalten in einer Azure SQL-Datenbank mithilfe von Piping.
```powershell
...
### Beispiel 3: Entfernen des Informationstyps und der Vertraulichkeits Beschriftung einer Spalte in einer Azure SQL-Datenbank mithilfe von Piping.
```powershell
