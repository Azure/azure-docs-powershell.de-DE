...
## Beschreibung
Das Cmdlet " **Get-AzSqlInstanceDatabaseGeoBackup** " Ruft eine oder mehrere Azure SQL-Datenbanken redundante Sicherungen aus einer Azure SQL-Datenbank-verwalteten Instanz ab.

## Beispiele

### Beispiel 1: Abrufen aller redundanten Datenbank-Backups für eine Instanz
```
...
Dieser Befehl ruft alle redundanten Datenbanksicherungen auf der Instanz mit dem Namen managedInstance1 ab.

### Beispiel 2: Abrufen einer redundanten Datenbank-Sicherung nach Namen in einer verwalteten Instanz
```
...
Dieser Befehl ruft eine redundante Datensicherung mit dem Namen managedDatabase1 aus einer Instanz mit dem Namen managedInstance1 ab.

### Beispiel 3: Abrufen aller redundanten Datenbank-Backups auf einer Instanz mithilfe von Filtern
```
...
Dieser Befehl ruft alle redundanten Datenbanksicherungen auf der Instanz mit dem Namen "managedInstance1" ab, die mit "managedDatabase" beginnen.
...
### -Name
Der Name der abzurufenden Instanzen Datenbank.
