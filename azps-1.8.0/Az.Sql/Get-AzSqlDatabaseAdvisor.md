...
## Beschreibung
Das Cmdlet " **Get-AzSqlDatabaseAdvisor** " Ruft einen oder mehrere Azure SQL-Daten Bank Ratgeber für eine Azure SQL-Datenbank ab.

## Beispiele

### Beispiel 1: Auflisten aller Ratgeber für die angegebene Datenbank
```
...
Dieser Befehl ruft alle Ratgeber für die Datenbank mit dem Namen WIRunner auf, die zum Server namens "Wi-Runner-Australia-East" gehört.

### Beispiel 2: Abrufen eines einzelnen Ratgebers für die angegebene Datenbank
```
...
Dieser Befehl ruft den Berater mit dem Namen CreateIndex für die Datenbank mit dem Namen WIRunner ab.
...
Dieser Befehl ruft alle Ratgeber für die Datenbank mit dem Namen "WIRunner" ab, wobei die empfohlenen Aktionen in der Antwort enthalten sind.
Da der Befehl den *ExpandRecommendedActions* -Parameter verwendet, ruft das Cmdlet die empfohlenen Aktionen mit der Antwort ab.
...
Dieser Befehl ruft den Berater mit dem Namen CreateIndex aus der Datenbank mit dem Namen WIRunner mit den empfohlenen Aktionen ab, die in der Antwort enthalten sind.
Da der Befehl den *ExpandRecommendedActions* -Parameter verwendet, ruft das Cmdlet die empfohlenen Aktionen mit der Antwort ab.

### Beispiel 5: Auflisten aller Ratgeber für die angegebene Datenbank mithilfe von Filtern
```
...
Dieser Befehl ruft alle Ratgeber für die Datenbank mit dem Namen WIRunner auf, die zum Server namens "Wi-Runner-Australia-East" gehören, und beginnen mit dem Buchstaben "d".
...
### -DatabaseName
Gibt den Namen der Datenbank an, für die dieses Cmdlet den Ratgeber anfordert.
...
Gibt an, dass dieses Cmdlet die empfohlenen Aktionen mit der Antwort abruft.
...
## Notizen
* Schlüsselwörter: Azure, azurerm, arm, Resource, Management, Manager, SQL, Datenbank, MSSQL, Ratgeber
