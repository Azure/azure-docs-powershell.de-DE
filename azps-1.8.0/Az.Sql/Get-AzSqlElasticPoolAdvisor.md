...
## Beschreibung
Das Cmdlet " **Get-AzSqlElasticPoolAdvisor** " Ruft einen oder mehrere Azure SQL Elastic Pool Advisor für einen Azure SQL-elastischen Pool ab.
...
### Beispiel 5: Auflisten aller Ratgeber für den angegebenen elastischen Pool mithilfe von Filtern
```
...
Der Befehl ruft alle Ratgeber für den elastischen Pool mit dem Namen "WIRunnerPool" auf, die mit dem Buchstaben "d" beginnen.
