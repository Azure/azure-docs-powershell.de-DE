...
### Beispiel 2: Abrufen aller Regeln für einen Server mithilfe von Filtern
```
...
Dieser Befehl ruft alle Firewallregeln für den Server mit dem Namen "Server01" ab, die mit "Rule" beginnen.
