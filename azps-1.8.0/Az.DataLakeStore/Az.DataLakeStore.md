...
## Beschreibung
In den Themen in diesem Abschnitt werden die Azure PowerShell-Cmdlets für Azure Data Lake Store im Azure Resource Manager (Arm)-Framework dokumentiert. Die Cmdlets sind im Microsoft. Azure. Commands. DataLakeStore-Namespace vorhanden.
...
Exportiert die Eigenschaften (Datenträgerverwendung und ACL) für die gesamte Struktur vom angegebenen Pfad zu einem Ausgabepfad.
...
### [Satz-AzDataLakeStoreFirewallRule](Set-AzDataLakeStoreFirewallRule.md)
Ändert die angegebene Firewall-Regel im angegebenen Data Lake Store.

### [Satz-AzDataLakeStoreItemAcl](Set-AzDataLakeStoreItemAcl.md)
...
### [Satz-AzDataLakeStoreItemExpiry](Set-AzDataLakeStoreItemExpiry.md)
Legt die Ablaufzeit für eine Datei in einem Azure Data Lake Store-Konto fest oder entfernt Sie.

### [Satz-AzDataLakeStoreItemOwner](Set-AzDataLakeStoreItemOwner.md)
Ändert den Besitzer einer Datei oder eines Ordners im Data Lake Store.

### [Satz-AzDataLakeStoreItemPermission](Set-AzDataLakeStoreItemPermission.md)
Ändert die Berechtigung Oktal einer Datei oder eines Ordners im Data Lake Store.

### [Satz-AzDataLakeStoreTrustedIdProvider](Set-AzDataLakeStoreTrustedIdProvider.md)
Ändert den angegebenen vertrauenswürdigen Identitätsanbieter im angegebenen Data Lake Store.

### [Satz-AzDataLakeStoreVirtualNetworkRule](Set-AzDataLakeStoreVirtualNetworkRule.md)
