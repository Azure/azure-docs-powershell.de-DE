...
## Synopsis
Aktualisiert einen Azure NetApp-Dateien (ANF)-Pool mit der neuen Datengruppe.
...
## Beschreibung
Mit dem Cmdlet **Update-AzNetAppFilesPool** wird ein ANF-Pool geändert.
...
Mit diesem Befehl wird der Anf-Pool "MyAnfPool" so geändert, dass er die angegebene Größe und Service Level hat.
...
### -Accountobject
Das Kontoobjekt, das den zu aktualisierbaren Pool enthält
...
### -Inputobject
Das zu aktualisierbare Pool-Objekt
