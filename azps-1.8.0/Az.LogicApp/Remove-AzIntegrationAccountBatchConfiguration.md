...
## Beschreibung
Das Cmdlet **Remove-AzIntegrationAccountBatchConfiguration** entfernt eine batchkonfiguration aus einem Integrations Konto.

## Beispiele

### Beispiel 1: Entfernen einer batchkonfiguration nach Parametern
```powershell
...
Entfernt die batchkonfiguration mit dem Namen "sampleBatchConfig", die sich im Integrations Konto "sampleIntegrationAccount" befindet.
...
### -PassThru
Gibt zurück, ob der Befehl erfolgreich war oder nicht.
