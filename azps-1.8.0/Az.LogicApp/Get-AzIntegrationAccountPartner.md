...
## Beschreibung
Das Cmdlet " **Get-AzIntegrationAccountPartner** " ruft Integrations Kontopartner aus einer Ressourcengruppe ab.
...
### Beispiel 1: Abrufen eines Integrations Kontopartners
```
...
Dieser Befehl ruft den Integrations Kontopartner mit dem Namen IntegrationAccountPartner22 ab.

### Beispiel 2: Abrufen eines Integrations Kontopartners mithilfe eines Integrations Kontonamens
```
...
Dieser Befehl ruft die Integrations Kontopartner für das Integrations Konto mit dem Namen IntegrationAccount31 ab.
