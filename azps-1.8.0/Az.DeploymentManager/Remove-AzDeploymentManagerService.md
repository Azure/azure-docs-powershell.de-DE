...
## Beschreibung
Das Cmdlet **Remove-AzDeploymentManagerService** löscht einen Dienst unter einer Dienst Topologie.
...
Dieser Befehl löscht einen Dienst mit dem Namen ContosoService1 in einer Dienst Topologie mit dem Namen ContosoServiceTopology im ContosoResourceGroup.

### Beispiel 2: Löschen eines Diensts mit dem Ressourcenbezeichner
```powershell
...
### Beispiel 3: Löschen eines Diensts mit dem Dienstobjekt
```powershell
PS C:\> Remove-AzDeploymentManagerService -InputObject $serviceObject
```

Mit diesem Befehl wird ein Dienst gelöscht, dessen Name, Dienst topologiename und ResourceGroup den Eigenschaften Name, ServiceTopologyName und ResourceGroupName der $serviceObject entsprechen.
