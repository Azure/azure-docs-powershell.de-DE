...
## Beschreibung
Ruft die Liste der Azure Advisor-Empfehlungen ab. Kann nach Kategorie, Ressourcen-ID, Name usw. gefiltert werden.
...
Type                 : Microsoft.Advisor/recommendations
```
Ruft die Liste aller Empfehlungen ab, die nach der kategorieleistung gefiltert werden.
...
### -ResourceGroupName
Name der ResourceGroup der Empfehlung
