...
## Beschreibung
Das Cmdlet " **Get-AzDataFactoryV2IntegrationRuntimeNode** " Ruft die Detailinformationen eines Integrationslauf Zeit Knotens ab.

## Beispiele

### Beispiel 1: Ruft die Detailinformationen eines Integrationslauf Zeit Knotens ab.
```
...
Das Cmdlet ruft Informationen über den Knoten "Node_1" in der selbst gehosteten Integrationslaufzeit "Test-SelfHost-IR" in Data Factory "Test-DF-EU2" ab.

### Beispiel 2: Ruft die Detailinformationen eines Integrationslauf Zeit Knotens zusammen mit der IP-Adresse ab.
```
...
Das Cmdlet ruft Informationen über den Knoten "Node_1" in der selbst gehosteten Integrationslaufzeit "Test-SelfHost-IR" in Data Factory "Test-DF-EU2" ab, einschließlich der IP-Adresse.
...
### -IPAddress
Die IP-Adresse des Integrationslauf Zeit Knotens.
