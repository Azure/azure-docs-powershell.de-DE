...
### Beispiel 1 Entfernen von eventhub consumergroup aus der Telemetrie-eventhub
```
...
Entfernt die verbrauchergroup mit dem Namen "myconsumergroup" aus dem IotHub "myiothub".
...
Name der EventHub-consumergruppe
