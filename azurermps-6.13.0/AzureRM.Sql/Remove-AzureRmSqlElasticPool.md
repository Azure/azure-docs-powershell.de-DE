...
## Beschreibung
Das Cmdlet **Remove-AzureRmSqlElasticPool** löscht einen Azure SQL-Datenbank-Elastic-Pool.

## Beispiele

### Beispiel 1: Löschen eines elastischen Pools
```
PS C:\>Remove-AzureRmSqlElasticPool -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -ElasticPoolName "ElasticPool01"
```

Dieser Befehl löscht einen elastischen Pool mit dem Namen ElasticPool01.
...
### -ElasticPoolName
Gibt den Namen des elastischen Pools an, den dieses Cmdlet löscht.
