...
## Beschreibung
Das Cmdlet " **Get-AzureRmSqlElasticPoolRecommendedAction** " Ruft eine oder mehrere Empfohlene Aktionen für einen Azure SQL Elastic Pool Advisor ab.
...
Dieser Befehl ruft eine Liste aller empfohlenen Aktionen des Ratgebers mit dem Namen CreateIndex ab, die für den elastischen Pool mit dem Namen WIRunnerPool verfügbar sind.
...
Dieser Befehl ruft die empfohlene Aktion mit dem Namen IR_ \[ test_schema \] _ \[ test_table_0 .0361551 \] _6C7AE8CC9C87E7FD5893 des Ratgebers mit dem Namen CreateIndex ab.
...
### -ElasticPoolName
Gibt den Namen des elastischen Pools an, für den dieses Cmdlet Empfohlene Aktionen anfordert.
