...
## Beschreibung
Das Cmdlet " **Get-AzureRmSqlDatabaseAuditingPolicy** " Ruft die Überwachungsrichtlinie einer Azure SQL-Datenbank ab.
...
### Beispiel 1: Abrufen der Überwachungsrichtlinie einer Azure SQL-Datenbank mit definierter Tabellen Überwachung
```
...
### Beispiel 2: Abrufen der Überwachungsrichtlinie einer Azure SQL-Datenbank mit definierter BLOB-Überwachung
```
PS C:\>Get-AzureRmSqlDatabaseAuditingPolicy -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -DatabaseName "Database01"
DatabaseName           : database01
AuditAction            : {}
