...
ms.locfileid: "93480057"
---
# <span data-ttu-id="fe730-101">Get-AzureRmSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="fe730-101">Get-AzureRmSecurityAlert</span></span>

## <span data-ttu-id="fe730-102">Synopsis</span><span class="sxs-lookup"><span data-stu-id="fe730-102">SYNOPSIS</span></span>
<span data-ttu-id="fe730-103">Ruft Sicherheitswarnungen ab, die vom Azure Security Center erkannt wurden.</span><span class="sxs-lookup"><span data-stu-id="fe730-103">Gets security alerts that were detected by Azure Security Center</span></span>

[!INCLUDE [migrate-to-az-banner](../../includes/migrate-to-az-banner.md)]

## <span data-ttu-id="fe730-104">Syntax</span><span class="sxs-lookup"><span data-stu-id="fe730-104">SYNTAX</span></span>

### <span data-ttu-id="fe730-105">SubscriptionScope (Standard)</span><span class="sxs-lookup"><span data-stu-id="fe730-105">SubscriptionScope (Default)</span></span>
```
Get-AzureRmSecurityAlert [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="fe730-106">ResourceGroupScope</span><span class="sxs-lookup"><span data-stu-id="fe730-106">ResourceGroupScope</span></span>
```
Get-AzureRmSecurityAlert -ResourceGroupName <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### <span data-ttu-id="fe730-107">ResourceGroupLevelResource</span><span class="sxs-lookup"><span data-stu-id="fe730-107">ResourceGroupLevelResource</span></span>
```
Get-AzureRmSecurityAlert -ResourceGroupName <String> -Name <String> -Location <String>
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="fe730-108">SubscriptionLevelResource</span><span class="sxs-lookup"><span data-stu-id="fe730-108">SubscriptionLevelResource</span></span>
```
Get-AzureRmSecurityAlert -Name <String> -Location <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### <span data-ttu-id="fe730-109">ResourceId</span><span class="sxs-lookup"><span data-stu-id="fe730-109">ResourceId</span></span>
```
Get-AzureRmSecurityAlert -ResourceId <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

## <span data-ttu-id="fe730-110">Beschreibung</span><span class="sxs-lookup"><span data-stu-id="fe730-110">DESCRIPTION</span></span>
<span data-ttu-id="fe730-111">Ruft Sicherheitswarnungen ab, die vom Azure Security Center erkannt wurden.</span><span class="sxs-lookup"><span data-stu-id="fe730-111">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="fe730-112">Beispiele</span><span class="sxs-lookup"><span data-stu-id="fe730-112">EXAMPLES</span></span>

### <span data-ttu-id="fe730-113">Beispiel 1</span><span class="sxs-lookup"><span data-stu-id="fe730-113">Example 1</span></span>
```powershell
...
<span data-ttu-id="fe730-114">Ruft alle Sicherheitswarnungen ab, die auf resoruces innerhalb eines Abonnements erkannt wurden.</span><span class="sxs-lookup"><span data-stu-id="fe730-114">Gets all the security alerts that were detected on resoruces inside a subscription</span></span>

### <span data-ttu-id="fe730-115">Beispiel 2</span><span class="sxs-lookup"><span data-stu-id="fe730-115">Example 2</span></span>
```powershell
...
<span data-ttu-id="fe730-116">Ruft alle Sicherheitswarnungen ab, die auf resoruces innerhalb der Ressourcengruppe "myService1" erkannt wurden.</span><span class="sxs-lookup"><span data-stu-id="fe730-116">Gets all the security alerts that were detected on resoruces inside the "myService1" resource group</span></span>

### <span data-ttu-id="fe730-117">Beispiel 3</span><span class="sxs-lookup"><span data-stu-id="fe730-117">Example 3</span></span>
```powershell
...
<span data-ttu-id="fe730-118">Ruft eine bestimmte Sicherheitswarnung ab, die auf resoruces innerhalb der Ressourcengruppe "myService1" erkannt wurde.</span><span class="sxs-lookup"><span data-stu-id="fe730-118">Gets a specific security alert that were detected on resoruces inside the "myService1" resource group</span></span>

## <span data-ttu-id="fe730-119">Parameter</span><span class="sxs-lookup"><span data-stu-id="fe730-119">PARAMETERS</span></span>

### <span data-ttu-id="fe730-120">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="fe730-120">-DefaultProfile</span></span>
<span data-ttu-id="fe730-121">Die für die Kommunikation mit Azure verwendeten Anmeldeinformationen, das Konto, den Mandanten und das Abonnement.</span><span class="sxs-lookup"><span data-stu-id="fe730-121">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="fe730-122">-Standort</span><span class="sxs-lookup"><span data-stu-id="fe730-122">-Location</span></span>
<span data-ttu-id="fe730-123">Lage.</span><span class="sxs-lookup"><span data-stu-id="fe730-123">Location.</span></span>
...
### <span data-ttu-id="fe730-124">-Name</span><span class="sxs-lookup"><span data-stu-id="fe730-124">-Name</span></span>
<span data-ttu-id="fe730-125">Ressourcenname</span><span class="sxs-lookup"><span data-stu-id="fe730-125">Resource name.</span></span>
...
### <span data-ttu-id="fe730-126">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="fe730-126">-ResourceGroupName</span></span>
<span data-ttu-id="fe730-127">Name der Ressourcengruppe.</span><span class="sxs-lookup"><span data-stu-id="fe730-127">Resource group name.</span></span>
...
### <span data-ttu-id="fe730-128">-Resourcen-Nr</span><span class="sxs-lookup"><span data-stu-id="fe730-128">-ResourceId</span></span>
<span data-ttu-id="fe730-129">Ressourcen-ID.</span><span class="sxs-lookup"><span data-stu-id="fe730-129">Resource ID.</span></span>
...
### <span data-ttu-id="fe730-130">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="fe730-130">CommonParameters</span></span>
<span data-ttu-id="fe730-131">Dieses Cmdlet unterstützt die allgemeinen Parameter:-Debug,-Fehler Aktion,-ErrorVariable,-InformationVariable,-Variable,-Puffer,-PipelineVariable,-Verbose,-Warning-Aktion und-WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="fe730-131">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="fe730-132">Weitere Informationen finden Sie unter about_CommonParameters ( https://go.microsoft.com/fwlink/?LinkID=113216) .</span><span class="sxs-lookup"><span data-stu-id="fe730-132">For more information, see about_CommonParameters (https://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="fe730-133">Eingaben</span><span class="sxs-lookup"><span data-stu-id="fe730-133">INPUTS</span></span>

### <span data-ttu-id="fe730-134">System. String</span><span class="sxs-lookup"><span data-stu-id="fe730-134">System.String</span></span>

## <span data-ttu-id="fe730-135">Ausgaben</span><span class="sxs-lookup"><span data-stu-id="fe730-135">OUTPUTS</span></span>

### <span data-ttu-id="fe730-136">Microsoft. Azure. Commands. Security. Models. alerts. PSSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="fe730-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span></span>

## <span data-ttu-id="fe730-137">Notizen</span><span class="sxs-lookup"><span data-stu-id="fe730-137">NOTES</span></span>

## <span data-ttu-id="fe730-138">Verwandte Links</span><span class="sxs-lookup"><span data-stu-id="fe730-138">RELATED LINKS</span></span>
