...
## Beschreibung
Das Set-AzureRmEventHubNamespace-Cmdlet aktualisiert die Eigenschaften des angegebenen Event Hubs-Namespace.
...
Aktualisiert den Zustand des Namespaces \` mynamespacename \` auf created.
