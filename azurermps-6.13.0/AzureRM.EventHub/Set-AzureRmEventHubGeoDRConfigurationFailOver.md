...
## Beschreibung
Das Cmdlet " **Satz-AzureRmEventHubGeoDRConfigurationFailOver** " envokes Geo Dr-Failover, und konfigurieren Sie den Alias so, dass er auf den sekundären Namespace verweist.
