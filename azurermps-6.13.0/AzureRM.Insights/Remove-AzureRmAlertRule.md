...
## Beschreibung
Das Cmdlet **Remove-AzureRmAlertRule** entfernt eine Warnungsregel.
Sie müssen den Namen der Warnungsregel und die Ressourcengruppe angeben, der Sie zugewiesen ist.
...
### Beispiel 1: Entfernen einer Warnungsregel
```
...
Dieser Befehl entfernt die Warnungsregel mit dem Namen myalert-7da64548-214d-42ca-b12b-b245bb8f0ac8 in der Ressourcengruppe Default-Web-centralus.
...
### -Name
Gibt den Namen der zu entfernenden Warnungsregel an.
...
### -ResourceGroupName
Gibt den Namen der Ressourcengruppe für die Warnungsregel an.
