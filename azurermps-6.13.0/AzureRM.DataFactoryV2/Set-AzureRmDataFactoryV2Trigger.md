...
Erstellen Sie einen neuen Trigger mit dem Namen "ScheduledTrigger" in der Data Factory "WikiADF". Der Trigger wird im Zustand "stopped" erstellt, was bedeutet, dass er nicht sofort gestartet wird. Ein Trigger kann mit dem Cmdlet gestartet werden `Start-AzureRmDataFactoryV2Trigger` .
