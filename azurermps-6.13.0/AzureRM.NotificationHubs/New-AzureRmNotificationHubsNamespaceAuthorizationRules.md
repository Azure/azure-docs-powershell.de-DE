...
Eine JSON-Datei ist eine Textdatei, die Syntax ähnlich der folgenden verwendet: {  
    ...
    "Rechte": \[  
        ...
        Senden  
    \]  
} Bei Verwendung in Verbindung mit dem Cmdlet **New-AzureRmNotificationHubsNamespaceAuthorizationRules** wird im vorherigen JSON-Beispiel eine Autorisierungsregel mit dem Namen ContosoAuthorizationRule erstellt, die Benutzern das Abhören und Senden von Rechten an den Namespace ermöglicht.
