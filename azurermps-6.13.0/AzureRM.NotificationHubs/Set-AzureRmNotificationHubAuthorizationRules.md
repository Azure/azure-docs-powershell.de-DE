...
Eine JSON-Datei ist eine Textdatei, die ähnlich wie diese Syntax verwendet wird: {"Name": "ContosoAuthorizationRule";  
  ...
  "Rechte": \[  
        ...
        Senden  
    \]  
  } Wenn in Verbindung mit dem New-AzureRmNotificationHubAuthorizationRules-Cmdlet verwendet wird, ändert das vorangehende JSON-Beispiel eine Autorisierungsregel mit dem Namen ContosoAuthorizationRule, um Benutzern das Abhören und Senden von Rechten an den Hub zu ermöglichen.
