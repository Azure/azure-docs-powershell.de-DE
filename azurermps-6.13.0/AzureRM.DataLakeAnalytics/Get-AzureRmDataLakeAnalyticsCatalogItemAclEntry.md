...
## Beschreibung
Das Cmdlet " **Get-AzureRmDataLakeAnalyticsCatalogItemAclEntry** " Ruft eine Liste von Einträgen (ACEs) in der Zugriffssteuerungsliste (ACL) eines Katalog-oder Katalogelements in Data Lake Analytics ab.
