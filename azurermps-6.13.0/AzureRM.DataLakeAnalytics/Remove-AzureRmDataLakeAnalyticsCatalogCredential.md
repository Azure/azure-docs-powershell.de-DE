...
## Beschreibung
Das Remove-AzureRmDataLakeAnalyticsCatalogCredential-Cmdlet löscht eine Azure Data Lake Analytics-Katalog Anmeldeinformationen.
...
Mit diesem Befehl werden die Anmeldeinformationen für den angegebenen Data Lake Analytics-Katalog entfernt.
...
### -DatabaseName
Gibt den Namen der Datenbank an, die die Anmeldeinformationen enthält.
...
### -PassThru
Gibt an, dass dieses Cmdlet nicht wartet, bis der Vorgang abgeschlossen ist.
...
Dies ist erforderlich, wenn der Anrufer nicht der Besitzer des Kontos ist.
...
### -Rekursiv
Gibt an, dass dieser Löschvorgang durchlaufen und auch alle Ressourcen, die von diesen Anmeldeinformationen abhängig sind, gelöscht und gelöscht werden soll.
