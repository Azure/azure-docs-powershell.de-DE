...
## Beschreibung
Das Cmdlet **Remove-AzureRmDataLakeAnalyticsDataSource** entfernt eine Datenquelle aus einem Azure Data Lake Analytics-Konto.

## Beispiele

### Beispiel 1: Entfernen einer Datenquelle
```
PS C:\>Remove-AzureRmDataLakeAnalyticsDataSource -Account "ContosoAdlAccount" -Blob "AzureStorage01"
```

Dieser Befehl entfernt die Datenquelle mit dem Namen AzureStorage01 aus dem Konto mit dem Namen ContosoAdlAccount.
...
### -BLOB
Gibt den Namen des zu entfernenden AzureBlob-speicherkontos an.
...
### -DataLakeStore
Gibt den Namen des AzureData Lake Store-Kontos an, das entfernt werden soll.
