...
## Beschreibung
Das Cmdlet " **Satz-AzureRmSchedulerJobCollection** " ändert eine Auftrags Sammlung in Azure Scheduler.
...
### -Standort
Gibt den Azure-Bereich an, in dem die Auftrags Sammlung vorhanden ist.
...
### -ResourceGroupName
Gibt die Ressourcengruppe der Auftrags Sammlung an.
