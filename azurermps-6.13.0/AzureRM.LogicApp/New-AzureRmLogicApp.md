...
## Beschreibung
Mit dem Cmdlet **New-AzureRmLogicApp** wird mithilfe des Features Logik-apps eine Logik-App erstellt.
Eine Logik-APP ist eine Sammlung von Aktionen oder Triggern, die in der Logik-App-Definition definiert sind.
Dieses Cmdlet gibt ein **Workflow** -Objekt zurück.
Sie können eine Logik-app erstellen, indem Sie einen Namen, einen Speicherort, eine Logik-App-Definition, eine Ressourcengruppe und einen Plan angeben.
Eine Logik-App-Definition und-Parameter werden in JSON (JavaScript Object Notation) formatiert.
...
### Beispiel 1: Erstellen einer Logik-App mithilfe von Definitions-und Parameterdatei Pfaden
```
...
Die Logik-app enthält die Definition und die Parameter, die von Dateipfaden angegeben werden.
...
Mit diesem Befehl wird eine Logik-app in der angegebenen Ressourcengruppen-Ressourcengruppe erstellt.
...
Dieser Befehl ruft die Ressourcengruppe mit dem Namen ResourceGroup11 mithilfe des Get-AzureRmResourceGroup-Cmdlets ab.
...
Der erste Befehl ruft die Logik-App mit dem Namen LogicApp03 mithilfe des Get-AzureRmLogicApp-Cmdlets ab.
Der Befehl speichert die Logik-app in der $Workflow-Variablen.
Mit dem zweiten Befehl wird eine neue Logik-App erstellt, die die Definition und die Parameter der in $Workflow gespeicherten Logik-App verwendet.
...
### -Definition
Gibt die Definition für Ihre Logik-App als ein Objekt oder eine Zeichenfolge im JSON-Format (JavaScript Object notataion) an.
...
### -Parameter
Gibt ein Parameter-Auflistungsobjekt für die Logik-APP an.
Angeben einer Hashtabelle, eines Wörterbuchs \<string\> oder eines Wörterbuchs \<string, WorkflowParameter\>
