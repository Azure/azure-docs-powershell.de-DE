...
## Beschreibung
Das Cmdlet **Remove-AzureRmIntegrationAccountMap** entfernt eine Integration-Kontozuordnung aus einer Ressourcengruppe.
...
### Beispiel 1: Entfernen einer Integration-Kontozuordnung
```
...
Dieser Befehl entfernt die Integrations Kontozuordnung mit dem Namen IntegrationAccountMap47.
...
### -MapName
Gibt den Namen der Integrations Kontozuordnung an.
