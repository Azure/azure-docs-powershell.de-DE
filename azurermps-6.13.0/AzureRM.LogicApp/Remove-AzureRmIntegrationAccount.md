...
## Beschreibung
Das Cmdlet **Remove-AzureRmIntegrationAccount** entfernt ein Integrations Konto aus einer Ressourcengruppe.
...
### Beispiel 1: Entfernen eines Integrations Kontos
```
PS C:\>Remove-AzureRmIntegrationAccount -ResourceGroupName "ResourceGroup11" -Name "IntegrationAccount31" -Force
```

Dieser Befehl entfernt ein Integrations Konto mit dem Namen IntegrationAccount31.
