...
## Beschreibung
Das Cmdlet " **Satz-AzureRmIntegrationAccountSchema** " ändert ein Schema des Integrations Kontos.
Dieses Cmdlet gibt ein Objekt zurück, das das Schema des Integrations Kontos darstellt.
Geben Sie den Namen des Integrations Kontos, den Ressourcengruppennamen und den Schemanamen an.
...
### Beispiel 1: Ändern eines Schemas für ein Integrations Konto
```
...
Mit diesem Befehl wird das Schema des Integrations Kontos mit dem Namen IntegrationAccountSchema43 geändert.
...
### -Schemaname
Gibt den Namen des Schemas für das Integrations Konto an.
