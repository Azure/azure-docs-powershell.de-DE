...
- Wochen 
- Monatliche 
- Erstellen Sie jährlich eine Aufbewahrungsrichtlinie für jede Art von Aufbewahrung, die Sie verwenden möchten.
...
- Freitag 
- Samstag 
- Sonntag geben Sie diesen Parameter an, wenn Sie die *WeeklyRetention* -, *MonthlyRetentionInWeeklyFormat* -und *YearlyRetentionInWeeklyFormat* -Parameter angeben.
