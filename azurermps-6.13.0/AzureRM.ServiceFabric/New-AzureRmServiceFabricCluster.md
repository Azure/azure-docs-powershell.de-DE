...
### System. String
Parameter: certificatedatei (ByValue), CertificateOutputFolder (ByValue), CertificateSubjectName (ByValue), keyvaultname (ByValue), KeyVaultResouceGroupName (ByValue), Position (ByValue), Name (ByValue), Parameterdatei (ByValue), SecondaryCertificateFile (ByValue), SecretIdentifier (ByValue), Vorlagendatei (ByValue), VmUserName (ByValue)

### System. Security. SecureString
Parameter: CertificatePassword (ByValue), SecondaryCertificatePassword (ByValue)

### System. Int32
Parameter: clusterisieren (ByValue)
