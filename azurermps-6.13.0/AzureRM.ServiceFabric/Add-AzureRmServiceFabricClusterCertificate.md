...
### -Certificatedatei
Der vorhandene Zertifikat Dateipfad.
...
Der Ordner des neuen Zertifikats, das erstellt werden soll.
...
### -SecretIdentifier
Die vorhandene Azure Key Vault Secret-URL.
...
### System. String
Parameter: certificatedatei (ByValue), CertificateOutputFolder (ByValue), CertificateSubjectName (ByValue), keyvaultname (ByValue), KeyVaultResouceGroupName (ByValue), SecretIdentifier (ByValue)
