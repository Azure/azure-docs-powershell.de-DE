...
## Beschreibung
Das Cmdlet **New-AzureRmVmssIpTagConfig** erstellt ein IP-Tag-Konfigurationsobjekt für eine Netzwerkschnittstelle eines virtuellen Computer-Skalierungs Satzes (VMSS).
Geben Sie die Konfiguration dieses Cmdlets als *IPTag* -Parameter des New-AzureRmVmssIpConfig-Cmdlets an.
