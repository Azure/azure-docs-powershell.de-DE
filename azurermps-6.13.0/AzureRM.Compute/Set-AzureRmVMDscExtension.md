...
## Beschreibung
Das Cmdlet " **festlegen-AzureRmVMDscExtension** " konfiguriert die Windows PowerShell-Erweiterung "desired state Configuration (DSC)" auf einem virtuellen Computer in einer Ressourcengruppe.
...
Die Sample.ps1.zip-Datei wurde zuvor mithilfe von **Publish-AzureRmVMDscConfiguration** hochgeladen.
...
Die Sample.ps1.zip wurde zuvor mithilfe von **Publish-AzureRmVMDscConfiguration** hochgeladen.

## Parameter

### -ArchiveBlobName
Gibt den Namen der Konfigurationsdatei an, die zuvor vom Publish-AzureRmVMDscConfiguration-Cmdlet hochgeladen wurde.
...
### -Version
Gibt die Version der DSC-Erweiterung an, auf die die Einstellungen Set-AzureRmVMDscExtension angewendet werden.
