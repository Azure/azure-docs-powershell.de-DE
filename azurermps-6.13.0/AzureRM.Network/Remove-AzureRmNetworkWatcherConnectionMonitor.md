...
## Beschreibung
Das Cmdlet Remove-AzureRmNetworkWatcherConnectionMonitor entfernt den angegebenen Verbindungsmonitor.

## Beispiele

### Beispiel 1: Entfernen des angegebenen Verbindungs Monitors
```
PS C:\> Remove-AzureRmNetworkWatcherConnectionMonitor -Location centraluseuap -Name cm
```

In diesem Beispiel wird der von Location und Name angegebene Verbindungsmonitor gelöscht.
