...
## Beschreibung
Das Cmdlet **New-AzureRmFirewall** erstellt eine Azure-Firewall.
...
In diesem Beispiel wurde eine Firewall erstellt, die die Ziel-IP und den Port aller Pakete übersetzte, die an 10.1.2.3:80 bis 10.2.3.4:8080 übertragen wurden.
