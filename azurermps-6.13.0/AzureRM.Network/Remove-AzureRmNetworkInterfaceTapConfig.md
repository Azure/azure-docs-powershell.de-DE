...
## Beschreibung
Das Cmdlet **Remove-AzureRmNetworkInterfaceTapConfig** entfernt eine Azure Tap-Konfiguration aus einer Netzwerkschnittstellen Liste.

## Beispiele

### Beispiel 1: Entfernen einer Tap-Konfiguration
```
...
Dieser Befehl entfernt die TapConfiguration aus NetworkInterface1 in einer Ressourcengruppe ResourceGroup1.
