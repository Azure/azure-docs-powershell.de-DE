...
## Beschreibung
Das Cmdlet " **Get-AzureRmDelegation** " Ruft die benannte Delegierung aus einem Subnetz ab. Wenn keine Delegierung benannt wird, gibt Sie alle Delegierungen im bereitgestellten Subnetz zurück.
