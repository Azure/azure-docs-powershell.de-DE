...
## Synopsis
Update-AzureRmVpnGateway aktualisiert ein skalierbares VPN-Gateway in den entsprechenden Zielzustand.
...
## Beschreibung
Update-AzureRmVpnGateway aktualisiert ein skalierbares VPN-Gateway in den entsprechenden Zielzustand. Eine AzureRmVpnGateway ist eine Software definierte Konnektivität für Website-zu-Standort-Verbindungen innerhalb des VirtualHub. Dieses Gateway ändert die Größe und skaliert basierend auf der vom Benutzer angegebenen Skalierungseinheit. Eine Verbindung kann über eine Verzweigung/Website, die als VPNSite bezeichnet wird, zum skalierbaren Gateway eingerichtet werden. Jede Verbindung besteht aus zwei Active-Active Tunneln
...
Nachdem das Gateway erstellt wurde, wird Set-AzureRmVpnGateway verwendet, um das Gateway auf 3 Skaleneinheiten zu aktualisieren.
