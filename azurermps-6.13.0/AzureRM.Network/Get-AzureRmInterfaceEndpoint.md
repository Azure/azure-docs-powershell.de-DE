...
## Synopsis
Das Get-AzureRmInterfaceEndpoint-Cmdlet ruft einen Schnittstellen Endpunkt ab.
...
## Beschreibung
Das Cmdlet " **Get-AzureRmInterfaceEndpoint** " Ruft einen Schnittstellen Endpunkt ab.
