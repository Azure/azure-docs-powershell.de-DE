...
## Beschreibung
Das Cmdlet " **Satz-AzureRmApplicationGatewayRequestRoutingRule** " ändert eine Anforderungs Routingregel.

## Beispiele

### Beispiel 1: Aktualisieren einer Anforderungs Routingregel
```
...
Der erste Befehl ruft das Anwendungsgateway mit dem Namen ApplicationGateway01 ab und speichert es in der $AppGw-Variablen.
Mit dem zweiten Befehl wird die Anforderungs Routingregel für das Anwendungsgateway so geändert, dass die in der $Setting-Variable angegebenen http-Einstellungen für das Back-End verwendet werden, ein in der $Listener-Variable festgelegter http-Listener und ein in der $Pool-Variable festgelegter Back-End-Adresspool.

## Parameter

### -ApplicationGateway
Gibt das Application Gateway-Objekt an, mit dem dieses Cmdlet eine Anforderungs Routingregel anordnet.
...
### -BackendAddressPool
Gibt den Back-End-Adresspool des Anwendungs Gateways an.
...
Gibt die ID des Back-End-Adresspools des Anwendungs Gateways an.
...
### -BackendHttpSettings
Gibt die http-Einstellungen des Application Gateway-Back-Ends an.
...
Gibt die ID des Back-End-HTTP-Einstellungen des Anwendungs Gateways an.
...
### -HttpListener
Gibt den Application Gateway http-Listener an.
...
### -HttpListenerId
Gibt die HTTP-Listener-ID des Application Gateway an.
...
### -Name
Gibt den Namen der Anforderungs Routingregel an, die von diesem Cmdlet geändert wird.
