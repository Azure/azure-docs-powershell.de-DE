...
## Beschreibung
Das Cmdlet " **Get-AzureRmVirtualNetworkTap** " Ruft einen virtuellen Azure-Netzwerk Hahn oder eine Liste mit Azure-virtuellen Netzwerk-TAPS in einer Ressourcengruppe ab.
