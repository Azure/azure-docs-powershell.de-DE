...
## Beschreibung
Das Cmdlet **New-AzureRmVirtualNetworkGatewayIpConfig** erstellt eine Konfiguration, die einem virtuellen Netzwerk Gateway mit einer (zuvor erstellten) öffentlichen IP-Adresse basierend auf der Subnetz-ID zugewiesen ist.

## Beispiele

### 1: Erstellen einer IP-Konfiguration für ein virtuelles Netzwerk Gateway
```
...
Konfiguriert ein virtuelles Netzwerk Gateway mit einer öffentlichen IP-Adresse. Die Variable $myGWsubnet wird mit dem Cmdlet **Get-AzureRmVirtualNetworkSubnetConfig** auf der "GatewaySubnet" im virtuellen Netzwerk abgerufen, in dem Sie ein virtuelles Netzwerk Gateway erstellen möchten. Die Variable $myGWpip wird mit dem Cmdlet **New-AzureRmPublicIpAddress** abgerufen.
