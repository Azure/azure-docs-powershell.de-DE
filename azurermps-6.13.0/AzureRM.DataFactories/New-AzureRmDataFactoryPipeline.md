...
## Beschreibung
Das Cmdlet **New-AzureRmDataFactoryPipeline** erstellt eine Pipeline in Azure Data Factory.
...
### -Datei
Gibt den vollständigen Pfad der JSON-Datei (JavaScript Object Notation) an, die die Beschreibung der Pipeline enthält.
