...
## Beschreibung
Das Remove-AzureRmAutomationSourceControl-Cmdlet entfernt eine Quellcodeverwaltung aus der Azure-Automatisierung.

## Beispiele

### Beispiel 1
Dieser Befehl entfernt das Automatisierungs Quellen-Steuerelement mit dem Namen VSTSNative im Konto mit dem Namen devAccount.
Mit diesem Befehl wird der *Force* -Parameter angegeben. Daher werden Sie nicht zur Bestätigung aufgefordert.
...
### -PassThru
PassThru gibt ein Objekt zurück, das das Element darstellt, mit dem Sie arbeiten.
