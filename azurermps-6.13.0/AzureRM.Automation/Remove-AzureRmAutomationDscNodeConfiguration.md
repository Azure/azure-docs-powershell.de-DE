...
## Beschreibung
Das Cmdlet **Remove-AzureRmAutomationDscNodeConfiguration** entfernt Metadaten aus APS-Knoten Konfigurationen (Desired State Configuration, DSC) in Azure Automation.
