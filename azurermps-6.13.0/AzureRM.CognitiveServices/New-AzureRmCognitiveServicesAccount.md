...
### -Typ
Gibt den Typ des zu erstellende Kontos an. Verwenden Sie `Get-AzureRmCognitiveServicesAccountType` das Cmdlet zum Abrufen der aktuellen akzeptablen Werte.
