...
## Beschreibung
Das Get-AzureRmMapsAccountKey-Cmdlet ruft die API-Schlüssel für ein bereitgestelltes Azure Maps-Konto ab.
...
Verwenden Sie New-AzureRmMapsAccountKey (New-AzureRmMapsAccountKey. MD), um einen Schlüssel neu zu generieren.
