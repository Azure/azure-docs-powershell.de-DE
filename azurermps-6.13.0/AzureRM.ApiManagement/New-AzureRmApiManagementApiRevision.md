...
Das Cmdlet **New-AzureRmApiManagementApiRevision** erstellt eine API-Revision für eine vorhandene API im API-Verwaltungskontext.

## Beispiele

### Beispiel 1: Erstellen einer API-Revision für eine API
```powershell
