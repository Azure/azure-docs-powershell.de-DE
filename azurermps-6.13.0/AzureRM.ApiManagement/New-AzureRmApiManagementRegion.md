...
## Beschreibung
Hilfsbefehl zum Erstellen einer Instanz von PsApiManagementRegion
Dieser Befehl ist mit New-AzureRmApiManagement Befehl zu verwenden.
...
Erstellt einen ApiManagement-Dienst für externe VpnType in der Region West Amerika mit einer zusätzlichen Region in Zentralamerika.

## Parameter

### -Kapazität
SKU-Kapazität des Azure API-Verwaltungsdiensts (zusätzlicher Bereich).
...
### -VirtualNetwork
Virtuelle Netzwerkkonfiguration des Azure API Management Deployment-Bereichs.
