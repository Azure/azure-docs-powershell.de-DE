...
## Beschreibung
Das Cmdlet **Remove-AzureRmApiManagementLogger** entfernt eine Azure API-Verwaltungs **Protokollierung**.

## Beispiele

### Beispiel 1: Entfernen einer Protokollierung
```
...
### -Protokollierungs-Nr
Gibt die ID der zu entfernenden Protokollierung an.
