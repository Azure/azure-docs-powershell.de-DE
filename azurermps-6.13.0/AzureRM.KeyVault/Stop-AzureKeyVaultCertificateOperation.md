...
## Beschreibung
Mit dem Cmdlet " **Stop-AzureKeyVaultCertificateOperation** " wird ein Zertifikat Vorgang im Azure Key Vault-Dienst abgebrochen.

## Beispiele

### Beispiel 1: Abbrechen eines Zertifikat Vorgangs
```powershell
...
Mit diesem Befehl wird der TestCert02-Zertifikat Vorgang abgebrochen.
