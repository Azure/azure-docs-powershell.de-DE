...
## Beschreibung
Das Cmdlet **Remove-AzureKeyVaultCertificateOperation** löscht einen Zertifikat Vorgang aus einem schlüsseltresor.

## Beispiele

### Beispiel 1: Entfernen eines Zertifikat Vorgangs
```powershell
...
Mit diesem Befehl wird der Zertifikat Vorgang mit dem Namen TestCert01 aus dem ContosoKV01-schlüsseltresor entfernt, ohne dass eine Bestätigung angefordert wird.
