...
## Beschreibung
Das Cmdlet **Update-AzureKeyVaultCertificate** ändert die bearbeitbaren Attribute eines Zertifikats.
...
### -Enable
Falls vorhanden, aktivieren Sie ein Zertifikat, wenn der Wert wahr ist.
Deaktivieren Sie ein Zertifikat, wenn der Wert falsch ist.
Wenn keine Angabe erfolgt, bleibt der vorhandene Wert des Zertifikats aktiviert/deaktiviert unverändert.
...
Wenn dieser Schalter angegeben ist, geben Sie Certificate-Objekt zurück.
...
### -Tag
Eine Hashtable, die Zertifikat Tags darstellt.
Wenn Sie nicht angegeben wird, bleiben die vorhandenen Tags des sertificate unverändert.
...
### -Version
Zertifikat Version.
Cmdlet erstellt den FQDN eines Zertifikats aus Vault-Name, aktuell ausgewählter Umgebung, Zertifikatsname und Zertifikat Version.
