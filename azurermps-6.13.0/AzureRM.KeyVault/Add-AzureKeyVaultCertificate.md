...
## Beschreibung
Mit dem Cmdlet **Add-AzureKeyVaultCertificate** wird der Vorgang der Registrierung für ein Zertifikat in einem schlüsseltresor im Azure Key Vault gestartet.
...
Der erste Befehl verwendet das New-AzureKeyVaultCertificatePolicy-Cmdlet, um eine Zertifikatrichtlinie zu erstellen, und speichert Sie dann in der $Policy-Variablen.
Der zweite Befehl verwendet **Add-AzureKeyVaultCertificate** , um den Prozess zum Erstellen eines Zertifikats zu starten.
Der dritte Befehl ruft mithilfe des Get-AzureKeyVaultCertificateOperation-Cmdlets den Vorgang ab, um zu überprüfen, ob er abgeschlossen ist.
Der endgültige Befehl verwendet das Get-AzureKeyVaultCertificate-Cmdlet zum Abrufen des Zertifikats.
...
Parameter: CertificatePolicy (ByValue)
