...
Informationen zum Erstellen finden Sie unter Abschnitt "Notizen" für ACQUIREDPLANDEFINITION-Eigenschaften und Erstellen einer Hashtabelle.
...
ACQUIREDPLANDEFINITION <IPlanAcquisition> : 
  - `[AcquisitionId <String>]`: Akquisitions-ID.
  - `[AcquisitionTime <DateTime?>]`: Erwerbszeit.
  - `[ExternalReferenceId <String>]`: Externer Verweisbezeichner.
  - `[Id <String>]`: Bezeichner im Kontext des Mandanten Abonnements.
  - `[PlanId <String>]`: Planen Sie den Bezeichner im Mandanten Abonnement Kontext.
  - `[ProvisioningState <ProvisioningState?>]`: Zustand der Bereitstellung.
