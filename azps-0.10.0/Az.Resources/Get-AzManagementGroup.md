...
### Beispiel 1: Abrufen aller Verwaltungsgruppen
```
...
### Beispiel 2: Abrufen einer bestimmten Verwaltungsgruppe
```
...
### Beispiel 3: Abrufen einer bestimmten Verwaltungsgruppe und der ersten Hierarchieebene
```
...
Mit dem `Expand` Flag kann man durch das Array navigieren `Children` und Details für jedes Kind abrufen. Gibt beispielsweise `Children[0]` Details für die Gruppe mit dem Anzeigenamen an `TestGroup1DisplayName` .

### Beispiel 4: Abrufen einer bestimmten Verwaltungsgruppe und aller organigrammfolie-Ebenen
```
...
### – Erweitern
Erweitern der Ausgabe, um die untergeordneten Elemente der Verwaltungsgruppe aufzulisten
...
### -Rekursiv
Rekursives Auflisten der untergeordneten Elemente der Verwaltungsgruppe
