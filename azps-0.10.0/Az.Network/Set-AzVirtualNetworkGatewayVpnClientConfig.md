...
## Beschreibung
Das Cmdlet " **Satz-AzVirtualNetworkVpnClientConfig** " konfiguriert den Client Adresspool für ein virtuelles Netzwerkgateway.
...
Der zweite Befehl im Beispiel verwendet dann das Cmdlet " **AzVirtualNetworkGatewayVpnClientConfig** ", um den Adresspool 10.0.0.0/16 zu ContosoVirtualGateway zuzuweisen.
...
Der zweite Befehl im Beispiel verwendet dann das Cmdlet " **AzVirtualNetworkGatewayVpnClientConfig** ", um den Adresspool 10.0.0.0/16 zu ContosoVirtualGateway zuzuweisen. Außerdem wird der externe RADIUS-Server "TestRadiusServer" konfiguriert, der für die Authentifizierung für VPN-Clients verwendet werden soll.
