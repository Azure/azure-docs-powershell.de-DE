...
## Beschreibung
Das Cmdlet " **Remove-AzDataBoxEdgeStorageAccount** " entfernt ein zugeordnetes Edge-Speicherkonto für ein Daten Feld-Edge-Gerät. Sie können den Namen des Edge-speicherkontos angeben, das als Parameter im Cmdlet entfernt werden soll.
