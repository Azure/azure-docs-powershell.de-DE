...
## Beschreibung
Das Cmdlet " **Get-AzDataBoxEdgeBandwidthSchedule** " Ruft die Informationen zu den Bandbreiten Zeitplänen ab. Sie können den Namen eines Zeitplans zusammen mit dem Namen der Ressourcengruppe und dem Gerätenamen angeben, um die Informationen zu einem bestimmten Bandbreiten Zeitplan abzurufen.
