...
### Beispiel 1: Resume-AzsUpdateRun nach Name und Updatename
```powershell
PS C:\> Resume-AzsUpdateRun -UpdateName northwest/Microsoft1.1907.0.10 -Name 45aaeb26-805b-495b-9c8c-d5da5542dbf4

```

Mit Unifiedgroup können Sie eine bestimmte Fehlgeschlagene Aktualisierung erneut ausführen.
Beachten Sie, dass die Update Version unbedingt größer als die aktuelle Version ist.
