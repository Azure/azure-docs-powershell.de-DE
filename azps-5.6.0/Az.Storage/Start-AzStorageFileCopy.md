...
### Beispiel 1: Starten des Kopiervorgangs von Datei zu Datei mithilfe von Freigabename und Dateinamen
```
...
Der Befehl gibt den Namen der Freigabe und den Dateinamen an.

### Beispiel 2: Starten des Kopiervorgangs von Blob in Datei mithilfe von Containername und Blobname
```
...
Der Befehl gibt den Containernamen und den Blobnamen an.

## PARAMETER

### -AbsoluteUri
Gibt den URI der Quelldatei an.
Wenn der Quellspeicherort eine Anmeldeinformationen erfordert, müssen Sie eine angeben.
...
Sie können ein Cloudblob erstellen oder mithilfe des cmdlets Get-AzStorageBlob abrufen.
...
Sie können cloudblob-Containerobjekt erstellen oder das Get-AzStorageContainer verwenden.
...
Sie können eine Clouddateifreigabe erstellen oder mithilfe des cmdlets Get-AzStorageShare abrufen.
