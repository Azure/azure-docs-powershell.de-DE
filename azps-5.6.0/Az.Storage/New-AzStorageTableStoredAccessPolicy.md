...
Mit diesem Befehl wird in der Speichertabelle "MyTable" eine Zugriffsrichtlinie mit dem Namen "Policy02" erstellt.
...
Beachten Sie, dass es sich um eine Zeichenfolge handelt, z. B. `raud` (für Lesen, Hinzufügen, Aktualisieren und Löschen).
