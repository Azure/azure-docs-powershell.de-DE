...
### Beispiel 1: Festlegen einer Richtlinie für den gespeicherten Zugriff in einem Speichercontainer mit voller Berechtigung
```
PS C:\>Set-AzStorageContainerStoredAccessPolicy -Container "MyContainer" -Policy "Policy06" -Permission rwdl
```

Mit diesem Befehl wird eine Zugriffsrichtlinie mit dem Namen "Policy06 für Speichercontainer" mit dem Namen "MyContainer" definiert.
...
### -NoStartTime
Legt die Startzeit fest, die $Null.
...
### -Permission
Gibt Berechtigungen in der Richtlinie für gespeicherten Zugriff an, um auf den Speichercontainer zu zugreifen.
