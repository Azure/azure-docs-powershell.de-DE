...
## SYNOPSIS
Kopieren Sie einen Blob synchron.
...
## BESCHREIBUNG
Das **Copy-AzStorageBlob-Cmdlet** kopiert einen Blob synchron und unterstützt derzeit nur block blob.
...
### Beispiel 2: Kopieren eines Blobs aus einem Blobobjekt
```
...
Der erste Befehl erstellt einen Blob-Uri des Quellblobs mit sas-Token der Berechtigung "rt". Der zweite Befehl kopiert den Quell-Blob-Uri in das Zielblob.

### Beispiel 4: Aktualisieren eines Blockblobverschlüsselungsbereichs
```
...
Mit diesem Befehl wird ein Blockblobverschlüsselungsbereich aktualisiert, indem er mit einem neuen Verschlüsselungsbereich in sich selbst kopiert wird.
...
### -EncryptionScope
Verschlüsselungsbereich, der beim Erstellen von Anforderungen an den Dest-Blob verwendet werden soll.
...
Gibt die Priorität an, mit der ein archiviertes Blob neu hydratisiert werden soll.
Gültige Werte sind Hoch/Standard.
