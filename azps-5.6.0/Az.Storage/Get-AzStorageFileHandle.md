...
## BESCHREIBUNG
Das **Get-AzStorageFileHandle-Cmdlet** enthält Dateihandles einer Dateifreigabe, eines Dateiverzeichnisses oder einer Datei.

## BEISPIELE

### Beispiel 1: Rekursiv alle Dateiziehpunkte für eine Dateifreigabe auflisten und nach ClientIp und OpenTime sortieren
```
...
Dieser Befehl listet Dateihandles für eine Dateifreigabe auf, und sortieren Sie die Ausgabe nach ClientIp und dann nach OpenTime.

### Beispiel 2: Rekursives Auflisten von ersten 2 Dateihandles in einem Dateiverzeichnis
```
...
Mit diesem Befehl werden die ersten zwei Dateiziehpunkte in einem Dateiverzeichnis rekursiv aufgeführt.
...
Mit diesem Befehl werden die 3. bis 6. Dateihandles für eine Datei aufgeführt.
...
### -Datei
Das CloudFile-Objekt hat angegeben, dass die Datei Dateihandles auflisten soll.
...
### -IncludeTotalCount
Gibt die Anzahl der Objekte im Datenset (eine ganze Zahl) gefolgt von den -Objekten an. Wenn das Cmdlet die Gesamtanzahl nicht ermitteln kann, gibt es "Unbekannte Gesamtanzahl" zurück.
Dieser Parameter führt zurzeit nichts aus.
