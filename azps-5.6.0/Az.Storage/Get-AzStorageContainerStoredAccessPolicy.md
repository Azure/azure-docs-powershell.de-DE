...
## SYNOPSIS
Ruft die Richtlinie für den gespeicherten Zugriff oder die Richtlinien für einen Azure-Speichercontainer ab.
...
## BESCHREIBUNG
Im **Cmdlet Get-AzStorageContainerStoredAccessPolicy** werden die gespeicherten Zugriffsrichtlinien oder Richtlinien für einen Azure-Speichercontainer aufgeführt.

## BEISPIELE

### Beispiel 1: Erhalten einer Richtlinie für den gespeicherten Zugriff in einem Speichercontainer
```
PS C:\>Get-AzStorageContainerStoredAccessPolicy -Container "Container07" -Policy "Policy22"
```

Dieser Befehl ruft die Zugriffsrichtlinie mit dem Namen Policy22 im Speichercontainer mit dem Namen Container07 ab.
