...
## SYNOPSIS
Ruft die Objektreplikationsrichtlinie eines Speicherkontos ab oder listet sie auf.
...
### Beispiel 1: Holen Sie sich eine Objektreplikationsrichtlinie mit einer bestimmten Richtlinien-ID, und zeigen Sie deren Regeln an.
```
...
Dieser Befehl ruft eine Objektreplikationsrichtlinie mit einer bestimmten Richtlinien-ID ab und zeigt dessen Regeln an.

### Beispiel 2:List object replication policy from a Storage account
```
...
Mit diesem Befehl werden Objektreplikationsrichtlinien aus einem Speicherkonto aufgeführt.
...
### -PolicyId
Objektreplikationsrichtlinien-ID.
