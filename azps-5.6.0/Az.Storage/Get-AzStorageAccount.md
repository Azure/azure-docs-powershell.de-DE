...
## BESCHREIBUNG
Das **Get-AzStorageAccount-Cmdlet** ruft ein angegebenes Speicherkonto oder alle Speicherkonten in einer Ressourcengruppe oder im Abonnement ab.
...
### Beispiel 4: Erhalten eines Speicherkontos mit seinem Blobwiederherstellungsstatus
```
...
Dieser Befehl ruft ein Speicherkonto mit seinem Blobwiederherstellungsstatus ab und zeigt den Status der Blobwiederherstellung an.
...
### -Name
Gibt den Namen des zu erhaltenden Speicherkontos an.
...
### -ResourceGroupName
Gibt den Namen der Ressourcengruppe an, die das zu erhaltende Speicherkonto enthält.
