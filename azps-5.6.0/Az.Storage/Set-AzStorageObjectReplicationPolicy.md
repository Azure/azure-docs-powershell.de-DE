...
Mit diesem Befehl wird die Objektreplikationsrichtlinie sowohl auf das Ziel- als auch auf das Quellkonto angewendet.
Erstellen Sie zuerst zwei Richtlinienregeln für die Objektreplikation, und legen Sie die Richtlinie mit den 2 Regeln auf das Zielkonto ab. Legen Sie dann die Objektreplikationsrichtlinie vom Zielkonto auf das Quellkonto ein.
...
### -DestinationAccount
Zielkonto für Objektreplikationsrichtlinien.
...
### -InputObject
Objektreplikationsrichtlinienobjekt auf Auf das angegebene Konto festlegen.
...
### -PolicyId
Objektreplikationsrichtlinien-ID. Es sollte eine GUID oder "Standard" sein.
Wenn Sie die PolicyId nicht eingeben, wird "standard" verwendet, was bedeutet, dass sie eine neue Richtlinie erstellt, und die ID der neuen Richtlinie wird in der erstellten Richtlinie zurückgegeben.
