...
### Beispiel 1: Festlegen einer richtlinie für gespeicherten Zugriff in einer Tabelle mit voller Berechtigung
```
PS C:\>Set-AzStorageTableStoredAccessPolicy -Table "MyTable" -Policy "Policy08" -Permission raud
```

Mit diesem Befehl wird eine Zugriffsrichtlinie mit dem Namen "Policy08 für Speichertabelle" mit dem Namen "MyTable" definiert.
...
### -NoStartTime
Gibt an, dass die Startzeit auf $Null.
