...
## BESCHREIBUNG
Das **Cmdlet Get-AzStorageAccountManagementPolicy** ruft die Verwaltungsrichtlinie eines Azure Storage-Kontos ab.

## BEISPIELE

### Beispiel 1: Holen Sie sich die Verwaltungsrichtlinie eines Speicherkontos.
```
