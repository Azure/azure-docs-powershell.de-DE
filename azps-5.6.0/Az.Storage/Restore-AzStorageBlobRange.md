...
## SYNOPSIS
Stellt ein Speicherkonto für bestimmte Blobbereiche wieder zur Verfügung.
...
## BESCHREIBUNG
Das **Cmdlet Restore-AzStorageBlobRange** stellt Blobs in einem Speicherkonto für bestimmte Blobbereiche wieder zur Verfügung.
Der Startbereich wird einbezogen, und der Endbereich wird in der Blobwiederherstellung ausgeschlossen.

## BEISPIELE

### Beispiel 1: Start stellt Blobs in einem Speicherkonto mit bestimmten Blobbereichen wieder zur Verfügung
```powershell
...
Mit diesem Befehl werden zuerst zwei Blobbereiche erstellt und anschließend blobs in einem Speicherkonto mit den 2 Blobbereichen von vor einem Tag wiederhergestellt. Der Benutzer kann Get-AzStorageAccount verwenden, um den Wiederherstellungsstatus zu einem späteren Zeitpunkt nachverfolgt.
...
Mit diesem Befehl werden alle Blobs in einem Speicherkonto vor 30 Minuten wiederhergestellt, und warten Sie, bis die Wiederherstellung abgeschlossen ist. Da das Wiederherstellen von Blobs sehr lange dauern kann, führen Sie sie im Back-End mit dem Parameter -Asjob aus, warten Sie dann, bis der Auftrag abgeschlossen ist, und zeigen Sie das Ergebnis an.

### Beispiel 3: Stellt Blobs nach Eingabeblobbereichen direkt wieder her, und warten Sie auf den Abschluss.
```powershell
...
Mit diesem Befehl werden Blobs in einem Speicherkonto von vor 1 Tag wiederhergestellt, indem 2 Blobbereiche direkt in das cmdlet Restore-AzStorageBlobRange werden. Dieser Befehl wartet, bis die Wiederherstellung abgeschlossen ist.
...
### -BlobRestoreRange
Der Blobbereich, der wiederhergestellt werden soll.
