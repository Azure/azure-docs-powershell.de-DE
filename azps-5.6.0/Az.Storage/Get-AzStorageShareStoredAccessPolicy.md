...
## BESCHREIBUNG
Das **Get-AzStorageShareStoredAccessPolicy-Cmdlet** ruft gespeicherte Zugriffsrichtlinien für eine Azure Storage-Freigabe ab.
Um eine bestimmte Richtlinie zu erhalten, geben Sie sie nach Name an.

## BEISPIELE

### Beispiel 1: Erhalten einer Richtlinie für den gespeicherten Zugriff in einer Freigabe
```
...
### Beispiel 2: Alle richtlinien für den gespeicherten Zugriff freigeben
```
...
### -ShareName
Gibt den Namen der Speicherfreigabe an, für den dieses Cmdlet Richtlinien erhält.
