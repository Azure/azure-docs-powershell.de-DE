...
## SYNOPSIS
Erstellt ein Blobabfragekonfigurationsobjekt, das in Get-AzStorageBlobQueryResult verwendet werden kann.
...
## BESCHREIBUNG
Das **Cmdlet New-AzStorageBlobQueryConfig** erstellt ein Blobabfragekonfigurationsobjekt, das in Get-AzStorageBlobQueryResult verwendet werden kann.
...
Dieser Befehl erstellt zuerst das Eingabekonfigurationsobjekt als CSV und das Ausgabekonfigurationsobjekt als json, und verwenden Sie dann die 2 Konfigurationen zum Abfragen des Blobs.

## PARAMETER

### -AsCsv
Geben Sie an, dass eine Blob Query-Konfiguration für CSV erstellt werden soll.
...
### -AsJson
Geben Sie an, dass eine Blob Query-Konfiguration für Json erstellt werden soll.
...
### -HasHeader
Optional.
Geben Sie an, dass die Daten Überschriften enthalten.
