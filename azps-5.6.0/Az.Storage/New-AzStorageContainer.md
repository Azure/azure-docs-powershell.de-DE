...
Mit diesem Befehl wird ein Speichercontainer mit dem Standardverschlüsselungsbereich als Myencryptscope erstellt und der Blobupload mit einem anderen Verschlüsselungsbereich in diesen Container vorverwendet.
...
Clients können Blobs im Container über eine anonyme Anforderung aufzählen, jedoch keine Container im Speicherkonto aufzählen. 
- Blob.
Ermöglicht den Lesezugriff auf Blobdaten im gesamten Container über eine anonyme Anforderung, bietet jedoch keinen Zugriff auf Containerdaten.
Clients können blobs im Container nicht mithilfe einer anonymen Anforderung aufzählen. 
- Aus.
Dies schränkt den Zugriff nur auf den Besitzer des Speicherkontos ein.
