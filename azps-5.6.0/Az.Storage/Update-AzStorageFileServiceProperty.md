...
### Beispiel 1: Aktivieren von Softdelete für die Dateifreigabe
```powershell
...
Dieser Befehl ermöglicht das Softdelete-Löschen der Dateifreigabe mit Aufbewahrungstagen als 5
...
Aktivieren Sie die Aufbewahrungsrichtlinie für das Speicherkonto freigeben, indem Sie auf $true festlegen und die Aufbewahrungsrichtlinie zum Löschen der Freigabe deaktivieren, indem Sie auf $false.
...
### -ShareRetentionDays
Legt die Anzahl der Aufbewahrungstage für die Freigabe DeleteRetentionPolicy fest.
Der Wert sollte nur festgelegt werden, wenn Sie die Aufbewahrungsrichtlinie zum Löschen der Freigabe aktivieren.
