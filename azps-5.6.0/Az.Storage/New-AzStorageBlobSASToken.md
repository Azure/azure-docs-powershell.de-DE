...
## SYNOPSIS
Generiert ein SAS-Token für einen Azure-Speicherblob.
...
## BESCHREIBUNG
Das **Cmdlet New-AzStorageBlobSASToken** generiert ein Sas-Token (Shared Access Signature) für ein Azure-Speicherblob.

## BEISPIELE

### Beispiel 1: Generieren eines Blob-SAS-Tokens mit vollständiger Blobberechtigung
```
PS C:\>New-AzStorageBlobSASToken -Container "ContainerName" -Blob "BlobName" -Permission rwd
```

In diesem Beispiel wird ein BLOB-SAS-Token mit vollständiger Blobberechtigung generiert.
...
### -Blob
Gibt den Namen des Speicherblobs an.
...
Zum Abrufen eines **CloudBlob-Objekts** verwenden Sie das [Get-AzStorageBlob-Cmdlet.](./Get-AzStorageBlob.md)
...
Wenn der Speicherkontext auf der OAuth-Authentifizierung basiert, wird ein Sastoken für benutzeridentitätsblob generiert.
...
### -Permission
Gibt die Berechtigungen für einen Speicherblob an. Beachten Sie, dass es sich um eine Zeichenfolge wie `rwd` (für Lesen, Schreiben und Löschen) handelt. 
