...
## SYNOPSIS
Ruft Protokolleigenschaften für Azure Storage-Dienste ab.
...
## BESCHREIBUNG
Das **Get-AzStorageServiceLoggingProperty-Cmdlet** ruft Protokolleigenschaften für Azure Storage-Dienste ab.

## BEISPIELE

### Beispiel 1: Protokollierungseigenschaften für den Blobdienst erhalten
```
C:\PS>Get-AzStorageServiceLoggingProperty -ServiceType Blob
```

Dieser Befehl ruft Protokolleigenschaften für den Blobspeicher ab.
