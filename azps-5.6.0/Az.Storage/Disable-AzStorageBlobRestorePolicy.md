...
## BESCHREIBUNG
Das **Cmdlet Disable-AzStorageBlobRestorePolicy** deaktiviert die Blob Restore-Richtlinie für den Azure Storage Blob-Dienst.

## BEISPIELE

### Beispiel 1: Deaktiviert die BlobWiederherstellungsrichtlinie für den Azure Storage Blob-Dienst in einem Speicherkonto
```powershell
PS C:\> Disable-AzStorageBlobRestorePolicy -ResourceGroupName "myresourcegoup" -StorageAccountName "mystorageaccount"
```

Mit diesem Befehl wird die Blob Restore-Richtlinie für den Azure Storage Blob-Dienst für ein Speicherkonto deaktiviert.
