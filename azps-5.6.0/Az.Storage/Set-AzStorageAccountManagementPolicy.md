...
### Beispiel 1: Erstellen oder Aktualisieren der Verwaltungsrichtlinie eines Speicherkontos mit ManagementPolicy-Regelobjekten.
```
...
Mit diesem Befehl werden zuerst 2 ManagementPolicy-Regelobjekte erstellt und dann die Verwaltungsrichtlinie eines Speicherkontos mit den 2 ManagementPolicy-Regelobjekten erstellt oder aktualisiert.
...
### Beispiel 3: Holen Sie sich die Verwaltungsrichtlinie aus einem Speicherkonto, und legen Sie sie dann auf ein anderes Speicherkonto festgelegt.
```
...
Mit diesem Befehl wird zuerst die Verwaltungsrichtlinie aus einem Speicherkonto und dann auf ein anderes Speicherkonto festgelegt.
...
### -Richtlinie
Festlegen des Verwaltungsrichtlinienobjekts
...
### -Regel
Die Regeln für Verwaltungsrichtlinien. Holen Sie sich das -Objekt New-AzStorageAccountManagementPolicyRule Cmdlet.
