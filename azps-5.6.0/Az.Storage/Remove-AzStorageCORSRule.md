...
Dieses Cmdlet löscht alle CORS-Regeln in einem Speicherdiensttyp.
Die Arten von Speicherdiensten für dieses Cmdlet sind Blob, Tabelle, Warteschlange und Datei.

## BEISPIELE

### Beispiel 1: Entfernen von CORS-Regeln für den Blobdienst
```
PS C:\>Remove-AzStorageCORSRule -ServiceType Blob
```

Mit diesem Befehl werden DIE REGELN für den Blobdiensttyp entfernt.
