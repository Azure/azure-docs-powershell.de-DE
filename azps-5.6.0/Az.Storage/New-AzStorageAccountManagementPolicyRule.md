...
Mit diesem Befehl wird ein ManagementPolicy-Regelobjekt erstellt, bei dem ein ManagementPolicy-Aktionsgruppenobjekt 4 Aktionen enthält, ein Filterobjekt für die ManagementPolicy-Regel, und legen Sie dann die Regel auf ein Speicherkonto festlegen.

## PARAMETER

### -Aktion
Ein -Objekt, das den Aktionssatz definiert.
Das Objekt mit cmdlet-Add-AzureStorageAccountManagementPolicyAction
...
### -Disabled
Die Regel ist deaktiviert, wenn sie festgelegt ist.
...
Das Objekt mit cmdlet-New-AzureStorageAccountManagementPolicyFilter
...
Bei Regelnamen wird die Zwischen- und Kleinschreibung beachtet.
