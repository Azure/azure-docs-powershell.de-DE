...
## SYNOPSIS
Entfernt den angegebenen Speicherblob.
...
## BESCHREIBUNG
Das **Cmdlet Remove-AzStorageBlob** entfernt den angegebenen Blob aus einem Speicherkonto in Azure.

## BEISPIELE

### Beispiel 1: Entfernen eines Speicherblobs nach Name
```
PS C:\>Remove-AzStorageBlob -Container "ContainerName" -Blob "BlobName"
```

Mit diesem Befehl wird ein blob entfernt, das durch seinen Namen identifiziert wurde.

### Beispiel 2: Entfernen eines Speicherblobs mithilfe der Pipeline
```
...
### Beispiel 3: Entfernen von Speicherblobs mithilfe der Pipeline
```
PS C:\>Get-AzStorageContainer -Container container* | Remove-AzStorageBlob -Blob "BlobName"
```

Bei diesem Befehl werden das Sternchen (*) und die Pipeline verwendet, um die Blobs oder Blobs abzurufen und dann zu entfernen.

### Beispiel 4: Entfernen einer einzelnen Blobversion
```
...
### Beispiel 5: Entfernen einer einzelnen Blobmomentaufnahme
```
...
### -Blob
Gibt den Namen des Blobs an, den Sie entfernen möchten.
...
Sie können das cmdlet Get-AzStorageContainer verwenden, um es zu erhalten.
...
### -DeleteSnapshot
Gibt an, dass alle Momentaufnahmen gelöscht werden, nicht aber das Basisblob.
Wenn dieser Parameter nicht angegeben ist, werden der Basisblob und seine Momentaufnahmen zusammen gelöscht.
...
Wenn nicht angegeben, liest das Cmdlet aus dem Standardprofil vor.
