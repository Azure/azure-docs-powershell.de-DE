...
## SYNOPSIS
Lädt einen Speicherblob herunter.
...
## BESCHREIBUNG
Das **Get-AzStorageBlobContent-Cmdlet** lädt den angegebenen Speicherblob herunter.
Wenn der Blobname für den lokalen Computer nicht gültig ist, löst dieses Cmdlet es automatisch auf, wenn dies möglich ist.

## BEISPIELE

### Beispiel 1: Herunterladen von Blobinhalten nach Name
```
...
### Beispiel 2: Herunterladen von Blobinhalten mithilfe der Pipeline
```
PS C:\>Get-AzStorageBlob -Container containername -Blob blobname | Get-AzStorageBlobContent
```

Dieser Befehl verwendet die Pipeline zum Suchen und Herunterladen von Blobinhalten.

### Beispiel 3: Herunterladen von Blobinhalten mithilfe der Pipeline und eines Platzhalterzeichens
```
PS C:\>Get-AzStorageContainer container* | Get-AzStorageBlobContent -Blob "cbox.exe" -Destination "C:\test"
```

In diesem Beispiel werden das Sternchen-Platzhalterzeichen und die Pipeline zum Suchen und Herunterladen von Blobinhalten verwendet.

### Beispiel 4: Holen Sie sich ein Blobobjekt, speichern Sie es in einer Variablen, und laden Sie dann Blobinhalte mit dem Blobobjekt herunter.
```
PS C:\>$blob = Get-AzStorageBlob -Container containername -Blob blobname 
PS C:\>Get-AzStorageBlobContent -CloudBlob $blob.ICloudBlob -Destination "C:\test"
```

In diesem Beispiel wird zuerst ein Blobobjekt heruntergeladen und in einer Variablen gespeichert, und dann Blobinhalt mit dem Blobobjekt heruntergeladen. 
...
### -Context
Gibt das Azure-Speicherkonto an, aus dem Sie Blobinhalte herunterladen möchten.
...
## NOTIZEN
* Wenn der Blobname für den lokalen Computer ungültig ist, löst dieses Cmdlet es automatisch auf, sofern dies möglich ist.
