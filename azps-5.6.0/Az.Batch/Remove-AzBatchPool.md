...
Sie werden zur Bestätigung aufgefordert, es sei denn, Sie verwenden den *Parameter Erzwingen.*
...
Mit diesem Befehl wird der Pool mit DER ID MyPool gelöscht.
Der Benutzer wird zur Bestätigung aufgefordert, bevor der Löschvorgang erfolgt.

### Beispiel 2: Löschen aller Batchpools mit Gewalt
```
PS C:\>Get-AzBatchPool -BatchContext $Context | Remove-AzBatchPool -Force -BatchContext $Context
```

Mit diesem Befehl werden alle Batchpools gelöscht.
Da der *Parameter Kraft* vorhanden ist, wird die Bestätigungsaufforderung unterdrückt.
