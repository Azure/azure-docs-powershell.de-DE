...
## BESCHREIBUNG
Das **Cmdlet Remove-AzBatchNodeFile** löscht eine Azure Batch-Knotendatei für eine Aufgabe oder einen Computeknoten.

## BEISPIELE

### Beispiel 1: Löschen einer Einer Aufgabe zugeordneten Datei
```
PS C:\>Remove-AzBatchNodeFile -JobId "Job-000001" -TaskId "Task26" -Path "wd\testFile.txt" -BatchContext $Context
```

Mit diesem Befehl wird die Knotendatei mit dem Namen wd\testFile.txt.
Diese Datei ist der Aufgabe zugeordnet, die die ID Task26 unter dem Auftrag Job-000001 hat.
...
Mit diesem Befehl wird die Knotendatei mit dem Namen startup\testFile.txt aus dem angegebenen Computeknoten im Pool gelöscht, der den ID-Pool07 enthält.
...
Dieser Befehl ruft die Knotendatei mithilfe von **Get-AzBatchNodeFile ab.**
Diese Datei ist der Aufgabe zugeordnet, die die ID Task26 unter dem Auftrag Job-000001 hat.
...
### -ComputeNodeId
Gibt die ID des Computeknotens an, der die Batchknotendatei enthält, die von diesem Cmdlet gelöscht wird.
...
### -Rekursiv
Gibt an, dass mit diesem Cmdlet der Ordner und alle Unterordner und Dateien unter dem angegebenen Pfad gelöscht werden.
