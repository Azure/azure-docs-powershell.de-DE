...
## BESCHREIBUNG
Das **Enable-AzBatchAutoScale-Cmdlet** ermöglicht die automatische Skalierung des angegebenen Pools.
...
Der zweite Befehl ermöglicht die automatische Skalierung für den Pool mit dem Namen "MyPool" mithilfe der Formel in $Formula.
