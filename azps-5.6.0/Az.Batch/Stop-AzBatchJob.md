...
## SYNOPSIS
Beendet einen Stapelverarbeitungsauftrag.
...
### Beispiel 1: Beenden eines Batchauftrags
```
PS C:\>Stop-AzBatchJob -Id "Job-000001" -TerminateReason "No more tasks to run" -BatchContext $Context
```

Mit diesem Befehl wird der Auftrag beendet, der den ID-Auftrag-000001 hat.
...
### -ID
Gibt die ID des Auftrags an, den dieses Cmdlet beendet.
...
### -TerminateReason
Gibt den Grund an, warum Sie sich entschieden haben, den Auftrag zu beenden.
