...
Mit diesem Befehl wird dem angegebenen Batchkonto mithilfe der Datei E:\Certificates\MyCert.cer ein Zertifikat hinzufügt.
...
Der erste Befehl liest die Daten aus der Datei "MyCert.pfx" in die $RawData vor.
Der zweite Befehl fügt dem angegebenen Batchkonto ein Zertifikat hinzu, indem die rohen Daten verwendet werden, die in $RawData.
...
Die Zertifikatdatei muss entweder im CER- oder PFX-Format vorliegen.
...
### -Kind
Die Art des zertifikats, das erstellt werden soll. Wenn dies nicht angegeben ist, wird angenommen, dass alle Zertifikate ohne Kennwort CER und alle Zertifikate mit Kennwort PFX sind.
...
### -RawData
Gibt die rohen Zertifikatdaten im CER- oder PFX-Format an.
