...
## SYNOPSIS
Beendet einen Stapelverarbeitungszeitplan.
...
### Beispiel 1: Beenden eines Auftragsplans
```
PS C:\>Stop-AzBatchJobSchedule -Id "JobSchedule17" -BatchContext $Context
```

Mit diesem Befehl wird der Auftragszeitplan beendet, der die ID JobSchedule17 hat.
...
### -ID
Gibt die ID des Auftragszeitplans an, den dieses Cmdlet beendet.
