...
## BESCHREIBUNG
Das **Cmdlet New-AzBatchTask** erstellt eine Azure Batch-Aufgabe unter dem Auftrag, der durch den *Parameter "JobId"* oder den *Parameter "Auftrag" angegeben* ist.
...
Mit diesem Befehl wird eine Aufgabe erstellt, die die ID Task23 unter dem Auftrag mit der ID Job-0000001 hat.
...
Mit diesem Befehl wird der Batchauftrag mit der ID Job-000001 mithilfe des **Get-AzBatchJob-Cmdlets** erhalten.
...
### Beispiel 3: Hinzufügen einer Aufgabensammlung zum angegebenen Auftrag mithilfe der Pipeline
```
...
Mit den nächsten beiden Befehlen werden **PSCloudTask-Objekte** mithilfe des New-Object erstellt.
Die Befehle speichern die Aufgaben in den Variablen $Task 01 und $Task 02.
Der letzte Befehl ruft den Batchauftrag ab, der den ID-Auftrag-000001 mit **Get-AzBatchJob hat.**
...
Der Befehl verwendet den kontextgespeicherten $Context.

### Beispiel 4: Hinzufügen einer Aufgabensammlung zum angegebenen Auftrag
```
PS C:\>$Context = Get-AzBatchAccountKey -AccountName "ContosoBatchAccount"
PS C:\> $Task01 = New-Object Microsoft.Azure.Commands.Batch.Models.PSCloudTask("Task23", "cmd /c dir /s")
PS C:\> $Task02 = New-Object Microsoft.Azure.Commands.Batch.Models.PSCloudTask("Task24", "cmd /c dir /s")
...
Mit den nächsten beiden Befehlen werden **PSCloudTask-Objekte** mithilfe des New-Object erstellt.
Die Befehle speichern die Aufgaben in den Variablen $Task 01 und $Task 02.
Mit dem letzten Befehl werden die in $Task 01 und $Task 02 gespeicherten Aufgaben unter dem Auftrag mit der ID Job-000001 addiert.
...
### -AffinityInformation
Gibt einen Ortshinweis an, den der Batchdienst zum Auswählen eines Knotens verwendet, auf dem die Aufgabe ausgeführt werden soll.
...
Die Einstellungen für ein Authentifizierungstoken, das die Aufgabe zum Ausführen von Batchdienstvorgängen verwenden kann.
Wenn dies festgelegt ist, stellt der Batchdienst der Aufgabe ein Authentifizierungstoken zur Verfügung, mit dem Batchdienstvorgänge authentifiziert werden können, ohne dass ein Kontozugriffsschlüssel erforderlich ist. Das Token wird über die Umgebungsvariable AZ_BATCH_AUTHENTICATION_TOKEN bereitgestellt. Die Vorgänge, die die Aufgabe mithilfe des Tokens durchführen kann, sind von den Einstellungen abhängig. Beispielsweise kann eine Aufgabe Auftragsberechtigungen anfordern, um dem Auftrag weitere Aufgaben hinzuzufügen oder den Status des Auftrags oder anderer Vorgänge zu überprüfen.
...
### -DependsOn
Gibt an, dass der Vorgang von anderen Vorgängen abhängt.
...
### -OutputFile
Ruft eine Liste der Dateien ab oder legt fest, die der Batchdienst nach dem Ausführen der Befehlszeile vom Computeknoten hochladen wird.
...
### -Aufgaben
Gibt die Auflistung der aufgaben an, die hinzugefügt werden sollen.
