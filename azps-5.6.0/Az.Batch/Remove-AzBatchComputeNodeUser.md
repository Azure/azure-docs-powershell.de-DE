...
### Beispiel 1: Löschen eines Benutzers aus einem Computeknoten ohne Bestätigung
```
PS C:\>Remove-AzBatchComputeNodeUser -PoolId "Pool01" -ComputeNodeId "ComputeNode01" -Name "User14" -Force -BatchContext $Context
```

Mit diesem Befehl wird der Benutzer mit dem Namen Benutzer14 aus dem Computeknoten "ComputeNode01" gelöscht.
Der Computeknoten befindet sich im Pool mit dem Namen Pool01.
...
### -ComputeNodeId
Gibt die ID des Computeknotens an, auf dem dieses Cmdlet das Benutzerkonto löscht.
...
### -PoolId
Gibt die ID des Pools an, der den Computeknoten enthält, für den das Benutzerkonto gelöscht werden soll.
