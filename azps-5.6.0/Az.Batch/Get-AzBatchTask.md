...
## BESCHREIBUNG
Das **Get-AzBatchTask-Cmdlet** ruft Azure Batch-Aufgaben für einen Batchauftrag ab.
...
Sie können den Parameter *Filter angeben,* um die Aufgaben zu erhalten, die einem OData-Filter (Open Data Protocol) entsprechen.
...
Dieser Befehl ruft die Aufgabe mit der ID Task03 unter Job01 ab.
Verwenden Sie Get-AzBatchAccountKey-Cmdlet, um der Variablen $Context Kontext zuzuordnen.

### Beispiel 2: Alle abgeschlossenen Vorgänge aus einem angegebenen Auftrag erhalten
```
...
Dieser Befehl ruft die abgeschlossenen Aufgaben aus dem Auftrag ab, der die ID Job02 hat.
...
Geben Sie einen Wert für diesen Parameter an, um zugeordnete Entitäten der Hauptentität zu erhalten.
...
Wenn Sie keinen Filter angeben, gibt dieses Cmdlet alle Vorgänge für das Batchkonto oder den Auftrag zurück.
...
### -MaxCount
Gibt die maximale Anzahl von Zurücksendaufgaben an.
