...
Verwenden Sie Get-AzBatchTask-Cmdlet, um ein **PSCloudTask-Objekt zu** erhalten.
...
Die nächsten beiden Befehle ändern die Einschränkungen der Aufgabe in $Task.
Der letzte Befehl aktualisiert den Batchdienst so, dass er dem lokalen Objekt in $Task.
