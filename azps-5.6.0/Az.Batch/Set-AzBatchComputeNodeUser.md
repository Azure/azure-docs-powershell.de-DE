...
## BESCHREIBUNG
Das **Cmdlet Set-AzBatchComputeNodeUser** ändert die Eigenschaften eines Benutzerkontos auf einem Azure Batch-Computeknoten.
...
Mit diesem Befehl wird das Benutzerkonto PFuller auf dem Computeknoten geändert, der die angegebene ID im Pool namens ContosoPool hat.
Mit dem Befehl werden das Kontokennwort und die Ablaufzeit geändert.
...
### -ComputeNodeId
Gibt die ID des Computeknotens an, auf dem dieses Cmdlet ausgeführt wird.
...
### -PoolId
Gibt die ID des Pools an, der den Computeknoten enthält, auf dem dieses Cmdlet ausgeführt wird.
