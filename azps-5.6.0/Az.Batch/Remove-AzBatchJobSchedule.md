...
## SYNOPSIS
Entfernt einen Stapelverarbeitungszeitplan.
...
### Beispiel 1: Löschen eines Stapelverarbeitungszeitplans
```
PS C:\>Remove-AzBatchJobSchedule -Id "MyJobSchedule" -BatchContext $Context
```

Mit diesem Befehl wird der Auftragszeitplan gelöscht, der die ID MyJobSchedule hat.
...
Dieser Befehl ruft den Auftragszeitplan ab, der die ID MyJobSchedule mit dem cmdlet Get-AzBatchJobSchedule hat.
Der Befehl übergibt diesen Auftragszeitplan mithilfe des Pipelineoperators an das aktuelle Cmdlet.
Mit dem Befehl wird dieser Auftragszeitplan gelöscht.
Da der Befehl den Parameter *"Erzwingen"* enthält, werden Sie nicht zur Bestätigung aufgefordert.
