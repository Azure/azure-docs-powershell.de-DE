...
Mit dem zweiten Befehl wird das Serienintervall für das -Objekt `$JobSchedule.Schedule` geändert.
Der letzte Befehl aktualisiert den Batchdienst so, dass er dem lokalen Objekt in $JobSchedule.
