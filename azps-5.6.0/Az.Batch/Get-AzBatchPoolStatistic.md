...
## SYNOPSIS
Ruft Poolzusammenfassungsstatistiken für ein Batchkonto ab.
...
## BESCHREIBUNG
Das **Get-AzBatchPoolStatistic-Cmdlet** ruft die Lebensdauerstatistiken für alle Pools im angegebenen Konto ab.
Statistiken werden über alle Pools aggregiert, die jemals im Konto vorhanden waren, von der Kontoerstellung bis zur letzten Aktualisierungszeit der Statistik.

## BEISPIELE

### Beispiel 1: Erhalten von Ressourcenstatistiken aller Pools in einem Konto
```
...
Der letzte Befehl zeigt die **ResourceStatistics-Eigenschaft** der $PoolStatistics.
