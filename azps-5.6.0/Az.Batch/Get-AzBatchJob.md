...
## SYNOPSIS
Ruft Batchaufträge für ein Batchkonto oder einen Projektzeitplan ab.
...
## BESCHREIBUNG
Das **Get-AzBatchJob-Cmdlet** ruft die Azure Batch-Aufträge für das vom *Parameter BatchAccountContext* angegebene Batchkonto ab.
Sie können den Parameter *Id* verwenden, um einen einzelnen Auftrag zu erhalten.
Sie können den Parameter *Filter* verwenden, um die Aufträge zu erhalten, die einem OData-Filter (Open Data Protocol) entsprechen.
...
Dieser Befehl ruft den Auftragszeitplan ab, der die ID JobSchedule27 mit dem cmdlet Get-AzBatchJobSchedule hat.
...
Um ein **PSCloudJobSchedule-Objekt zu** erhalten, verwenden Sie das Get-AzBatchJobSchedule Cmdlet.
...
### -MaxCount
Gibt die maximale Anzahl von Aufträgen an, die sie zurückgeben sollen.
