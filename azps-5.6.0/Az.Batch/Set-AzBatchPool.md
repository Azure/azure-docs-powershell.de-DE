...
Verwenden Sie Get-AzBatchPool-Cmdlet, um ein **PSCloudPool-Objekt zu** erhalten.
...
Der letzte Befehl aktualisiert den Batchdienst so, dass er dem lokalen Objekt in $Pool.
