...
Mit diesem Zeitplan werden Aufträge mit einem Serienintervall von einem Tag erstellt.
...
### -DisplayName
Gibt einen Anzeigenamen für den Auftragsterminplan an.
...
### -JobSpecification
Gibt die Details der Aufträge an, die dieses Cmdlet in den Auftragsplan einbegibt.
...
### -Metadaten
Gibt Metadaten als Schlüssel-Wert-Paare an, die dem Projektplan hinzugefügt werden.
