...
Löschen Sie einen Azure IoT Hub-Gerätebereitstellungsdienst "myiotdps".
...
Löschen Sie einen Azure IoT Hub-Gerätebereitstellungsdienst "myiotdps" mithilfe der Pipeline.
