...
## BESCHREIBUNG
Erstellen Sie eine Geräteregistrierung in einem Azure IoT Hub-Gerätebereitstellungsdienst.
...
Erstellen Sie eine Registrierung mit TPM-Nachweis.
...
### -RegistrationId
Individuelle Registrierungs-ID.
