...
## SYNOPSIS
Entfernt einen DSC-Knoten aus der Verwaltung durch ein Automatisierungskonto.
...
## BESCHREIBUNG
Das **Cmdlet "Unregister-AzAutomationDscNode"** entfernt einen APS Desired State Configuration (DSC)-Knoten aus der Verwaltung durch ein Azure Automation-Konto.
