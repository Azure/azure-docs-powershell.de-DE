...
## BESCHREIBUNG
Das **Get-AzAutomationSourceControlSyncJobOutput-Cmdlet** ruft die Ausgabe für einen Azure Automation Source Control-Synchronisierungsauftrag ab.

## BEISPIELE

### Beispiel 1
Dieser Befehl ruft die Ausgabe des Quellcodeverwaltungssynchronisierungsauftrags mit der ID 08d6d266-27b6-463c-beea-bc48a67ace15 für das Quellsteuerelement VSTSNative ab. 
...
### -JobId
Die Quellcodeverwaltungs-Synchronisierungsauftrags-ID.
...
### -Stream
Der Datenstromtyp.
Ist standardmäßig auf Any festgelegt.
