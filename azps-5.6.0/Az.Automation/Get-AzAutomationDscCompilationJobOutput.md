...
## SYNOPSIS
Ruft die Protokollierungsströme eines Automatisierungs-DSC-Kompilierungsauftrags ab.
...
## BESCHREIBUNG
Das **Get-AzAutomationDscCompilationJobOutput-Cmdlet** ruft die Datenstromdatensätze eines APS Desired State Configuration (DSC)-Kompilierungsauftrags in Azure Automation ab.

## BEISPIELE

### Beispiel 1: Erfassen der Protokolle für einen DSC-Kompilierungsauftrag
```
...
Der zweite Befehl ruft die Ausgabe des Kompilierungsauftrags für einen beliebigen Datenstrom für das erste Element des $Jobs ab.
...
### -ResourceGroupName
Gibt den Namen der Ressourcengruppe an, die den DSC-Kompilierungsauftrag enthält, für den dieses Cmdlet Datenstromeinträge erhält.
...
Dieses Cmdlet ruft Datenstromdatensätze ab, die nach diesem Zeitpunkt vom AUFTRAG für die DSC-Kompilierung ausgegeben werden.
