...
## SYNOPSIS
Ruft eine Liste der Konfigurationen von Azure-Automatisierungssoftwareupdates ab.
...
## BESCHREIBUNG
Die Get-AzAutomationSoftwareUpdateConfiguration gibt eine Liste der Softwareupdatekonfigurationen zurück. Um eine bestimmte Softwareupdatekonfiguration zu erhalten, geben Sie den Namenparameter an. Sie können auch Softwareupdatekonfigurationen für bestimmte virtuelle Azure-Computer auflisten, indem Sie die Azure-Ressourcen-ID für diesen virtuellen Computer angeben.

## BEISPIELE

### Beispiel 1
Holen Sie sich eine Azure Automation Software Update-Konfiguration nach Name.
