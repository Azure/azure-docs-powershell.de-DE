...
## BESCHREIBUNG
Das **Get-AzAutomationVariable-Cmdlet** ruft mindestens eine Azure-Automatisierungsvariable ab.
...
Der erste Befehl ruft eine Automatisierungsvariable namens Variable06 im Konto mit dem Namen Contoso17 ab.
Der Befehl speichert dieses Objekt in der $Variable-Variable.
Der zweite Befehl verwendet die Standardpunkt-Notation, um auf die **Werteigenschaft** $Variable.
