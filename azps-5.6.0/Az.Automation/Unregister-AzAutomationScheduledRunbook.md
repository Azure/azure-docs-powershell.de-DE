...
Mit diesem Befehl wird die Zuordnung zwischen dem Runbook "Runbk01" und dem Zeitplan "Runbk01Sched" entfernt.
...
### -JobScheduleId
Gibt die ID eines geplanten Runbooks an.
...
### -RunbookName
Gibt den Namen des Runbooks an, das dieses Cmdlet von einem Zeitplan abkoppelt.
...
### -ScheduleName
Gibt den Namen des Zeitplans an, aus dem dieses Cmdlet ein Runbook dissoziiert.
