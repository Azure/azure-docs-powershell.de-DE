...
## SYNOPSIS
Importiert ein Automatisierungslaufbuch.
...
## BESCHREIBUNG
Das **Import-AzAutomationRunbook-Cmdlet** importiert ein Azure Automation-Runbook. Geben Sie den Pfad zu einer wps_2-Skriptdatei (PS1) an, die für wps_2- und wps_2 Workflow-Runbooks, (.graphrunbook)-Datei für grafische Runbooks oder (PY)-Datei für Python 2-Runbooks importiert werden soll. Für wps_2 Workflow-Runbooks muss das Skript eine einzelne Workflowdefinition wps_2, die dem Namen der Datei entspricht.
...
Der zweite Befehl importiert ein grafisches Runbook namens GraphicalRunbook06 in das Automatisierungskonto mit dem Namen AutomationAccount01.
Der Befehl weist auch die tags zu, die in der $Tags.

### Beispiel 2

Importiert ein Automatisierungslaufbuch. (automatisch generiert)
...
### -Veröffentlicht
Gibt an, dass dieses Cmdlet das importierte Runbook veröffentlicht.
