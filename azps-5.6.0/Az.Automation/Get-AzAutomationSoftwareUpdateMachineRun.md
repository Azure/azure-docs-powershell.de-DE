...
## SYNOPSIS
Ruft eine Liste der Azure-Automatisierungssoftwareupdatekonfigurationscomputer ab.
...
## BESCHREIBUNG
Dieses Cmdlet gibt eine Liste der ausgeführten Computer zurück. Jeder Softwareupdatelauf löst einen Computerauslöser aus, der für jeden Softwareupdatekonfigurationszielcomputer ausgeführt wird. Um einen bestimmten Computer ausführen zu lassen, übergeben Sie den Parameter Id. Sie können alle Ausgeführten des Computers auflisten, alle für einen bestimmten Computer ausgeführt werden, und alle werden mit einem bestimmten Status ausgeführt, indem Sie die entsprechenden Parameter übergeben.

## BEISPIELE

### Beispiel 1
In diesem Beispiel werden alle fehlgeschlagenen Computerläufe für den angegebenen virtuellen Azure-Computer zurückgegeben.
...
### -SoftwareUpdateRunId
ID des Softwareupdates ausgeführt.
...
### -TargetComputer
zielcomputer für die Ausführung des Computers.
