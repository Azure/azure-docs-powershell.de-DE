...
## BESCHREIBUNG
Das **Cmdlet New-AzAutomationAccount** erstellt ein Azure Automation-Konto in einer Ressourcengruppe.
Ein Automatisierungskonto ist ein Container für Automatisierungsressourcen, der von den Ressourcen anderer Automatisierungskonten isoliert ist. Automatisierungsressourcen umfassen Runbooks, Dsc-Konfigurationen (Desired State Configuration), Aufträge und Ressourcen.
...
Mit diesem Befehl wird ein neues Automatisierungskonto namens ContosoAutomationAccount in der Region Ost-USA erstellt.
...
Verwenden Sie das cmdlet Get-AzLocation, um gültige Speicherorte zu erhalten.
