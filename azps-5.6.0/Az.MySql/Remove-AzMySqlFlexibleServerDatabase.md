...
### Beispiel 1: Entfernen der MySql-Datenbank nach Name
```powershell
PS C:\> Remove-AzMySqlFlexibleServerDatabase -Name databasetest -ResourceGroupName PowershellMySqlTest -ServerName mysql-test
```

Dieses Cmdlet entfernt die MySql-Datenbank nach Name.

### Beispiel 2: Entfernen der MySql-Datenbank nach Identität
```powershell
...
Diese Cmdlets entfernen die MySql-Datenbank nach Identität.
