...
In diesem Cmdlet werden alle Konfigurationen im angegebenen MySql-Server aufgeführt.

### Beispiel 2: Angegebene MySql-Konfiguration nach Name erhalten
```powershell
...
Dieses Cmdlet erhält die angegebene MySql-Konfiguration nach Name.

### Beispiel 3: Listenkonfiguration nach Identität
```powershell
...
Dieses Cmdlet erhält eine angegebene MySql-Konfiguration nach Identität.
