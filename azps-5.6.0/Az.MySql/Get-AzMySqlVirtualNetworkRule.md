...
### Beispiel 1: Listet alle Regeln für virtuelle Netzwerke im angegebenen MySql-Server auf.
```powershell
...
In diesem Cmdlet werden alle Regeln für virtuelle Netzwerke im angegebenen MySql-Server aufgeführt.
