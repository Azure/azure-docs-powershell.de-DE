...
### Beispiel 1: Wiederherstellen des MySql-Servers mithilfe von GeoReplica Restore
```powershell
...
Mit diesem Cmdlet wird der MySql-Server mithilfe von GeoReplica Restore wiederhergestellt.

### Beispiel 2: Wiederherstellen von MySql-Server mit PointInTime Restore
```powershell
