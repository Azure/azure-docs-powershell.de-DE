...
### Beispiel 1: Beenden des Servers nach Ressourcenname
```powershell
PS C:\> Stop-AzMySqlFlexibleServer -ResourceGroupName PowershellMySqlTest -Name mysql-test
```

Beenden des Servers nach Name

### Beispiel 2: Beenden des Servers nach Identität
```powershell
...
Beenden des Servers nach Identität
