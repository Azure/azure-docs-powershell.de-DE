...
### Beispiel 1: Neustarten des MySql-Servers nach Ressourcengruppe und Servername
```powershell
PS C:\> Restart-AzMySqlServer -ResourceGroupName PowershellMySqlTest -Name mysql-test

```

Dieses Cmdlet startet den MySql-Server nach Ressourcengruppe und Servername neu.

### Beispiel 2: Neustarten des MySql-Servers nach Identität
```powershell
...
Diese Cmdlets starten den MySql-Server nach Identität neu.
