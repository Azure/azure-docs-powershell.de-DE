...
Dieses Cmdlet ruft MySql-Server mit Standardkontext ab.

### Beispiel 2: Get MySql server by resource group and server name
```powershell
...
Dieses Cmdlet ruft MySql-Server nach Ressourcengruppe und Servernamen ab.

### Beispiel 3: Listet alle MySql-Server in einer angegebenen Ressourcengruppe auf.
```powershell
...
In diesem Cmdlet werden alle MySql-Server in der angegebenen Ressourcengruppe aufgeführt.

### Beispiel 4: Holen Sie sich den MySql-Server nach Identität
```powershell
...
Diese Cmdletlisten ruft MySql-Server nach Identität ab.
