...
Regenerieren Sie den Schlüssel, der dem \' Schlüssel1'\ der Domäne "Ereignisrasterdomäne1" \` in der \` Ressourcengruppe \` MyResourceGroupName \` entspricht.
...
Regenerieren Sie den Schlüssel, der schlüssel2'\ der Ereignisrasterdomäne Domäne1 in der Ressourcengruppe MyResourceGroupName entspricht, mit der \' \` \` \` \` vollständigen Ressourcen-ID.
