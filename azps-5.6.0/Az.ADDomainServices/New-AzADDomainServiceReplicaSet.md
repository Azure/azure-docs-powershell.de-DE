...
### Beispiel 1: Erstellen von ReplicaSet für AdDomain
```powershell
...
Erstellen von ReplicaSet für AdDomain

## PARAMETER

### -Location
Virtueller Netzwerkspeicherort.
...
### -SubnetId
Der Name des virtuellen Netzwerks, für das Domänendienste bereitgestellt werden.
Die ID des Subnetzes, für das Domänendienste bereitgestellt werden.
