...
### Beispiel 1: Erstellen eines Remotedesktoperweiterungsobjekts
```powershell
...
Mit diesem Befehl wird ein Remotedesktoperweiterungsobjekt erstellt, das zum Erstellen oder Aktualisieren eines Clouddiensts verwendet wird.
...
Anmeldeinformationen für die Remotedesktoperweiterung.
...
### -Expiration
Ablauf für Remotedesktoperweiterung.
...
### -Name
Name der Remotedesktoperweiterung.
...
### -TypeHandlerVersion
Remotedesktoperweiterungsversion.
