...
### Beispiel 1: Erhalten von Netzwerkschnittstellen unter einem Clouddienstnamen
```powershell
...
Ruft alle Netzwerkschnittstellen für einen bestimmten Clouddienstnamen ab.

### Beispiel 2: Erhalten von Netzwerkschnittstellen durch ein Clouddienstobjekt
```powershell
...
Ruft alle Netzwerkschnittstellen für ein bestimmtes Clouddienstobjekt ab.

### Beispiel 3: Holen Sie sich Netzwerkschnittstellen über ein Clouddienstobjekt und den Namen der Rolleninstanz.
```powershell
PS C:\> Get-AzCloudServiceNetworkInterfaces -CloudService $cs -RoleInstanceName WebRole1_IN_0

```

Ruft alle Netzwerkschnittstellen für ein bestimmtes Clouddienstobjekt und den Namen der Rolleninstanz ab.
