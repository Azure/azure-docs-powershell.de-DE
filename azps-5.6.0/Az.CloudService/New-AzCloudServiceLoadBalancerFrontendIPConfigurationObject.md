...
### Beispiel 1: Erstellen eines Frontend-IP-Konfigurationsobjekts für load balancer
```powershell
...
Mit diesem Befehl wird das Frontend-IP-Konfigurationsobjekt des Load Balancers erstellt, das zum Erstellen oder Aktualisieren eines Clouddiensts verwendet wird.
Weitere Informationen finden Sie unter New-AzCloudService.

## PARAMETER

### -Name
Name von FrontendIpConfigration.
