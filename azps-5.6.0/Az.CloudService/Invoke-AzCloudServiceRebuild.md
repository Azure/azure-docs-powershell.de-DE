...
### Beispiel 1: Neu erstellen von Rolleninstanzen des Clouddiensts
```powershell
...
### Beispiel 2: Neu erstellen aller Rollen des Clouddiensts
```powershell
PS C:\> Invoke-AzCloudServiceRebuild -ResourceGroupName "ContosOrg" -CloudServiceName "ContosoCS" -RoleInstance "*"
```

Mit diesem Befehl werden alle Rolleninstanzen des Clouddiensts namens ContosoCS neu erstellt, die zur Ressourcengruppe "ContosOrg" gehören.
