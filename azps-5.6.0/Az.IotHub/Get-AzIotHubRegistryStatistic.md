...
## BESCHREIBUNG
Ruft die RegistryStatistics für einen IotHub ab.
Dies enthält Informationen zur Anzahl der insgesamt aktivierten und deaktivierten Geräte in einem IotHub.

## BEISPIELE

### Beispiel 1 : "Registrierungsstatistik"
```
PS C:\> Get-AzIotHubRegistryStatistic -ResourceGroupName "myresourcegroup" -Name "myiothub"
```

Ruft die RegistryStatistics für den IotHub mit dem Namen "myiothub" ab.
