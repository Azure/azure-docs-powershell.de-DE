...
## BESCHREIBUNG
Fügen Sie einen neuen Endpunkt in Ihrem IoT Hub hinzu. Weitere Informationen zu den unterstützten Endpunkten finden Sie unter https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-endpoints
...
Fügen Sie einem "myiothub" IoT Hub einen neuen Endpunkt "E2" vom Typ EventHub hinzu.
...
### -Encoding
Wählen Sie das Format aus, in dem Sie Ihre Daten weiterrouten möchten. Sie können JSON oder AVRO auswählen. Die Standardeinstellung ist auf AVRO festgelegt.
