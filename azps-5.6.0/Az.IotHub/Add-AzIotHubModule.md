...
## BESCHREIBUNG
Erstellen Sie ein Modul auf einem IoT-Zielgerät mit einem anderen Autorisierungstyp in einem IoT Hub.
...
Erstellen Sie ein Modul auf einem IoT-Zielgerät mit Standardautorisierung (freigegebener privater Schlüssel).
