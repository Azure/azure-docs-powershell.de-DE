...
## SYNOPSIS
Abfragen eines IoT-Hubs mit einer leistungsfähigen SQL sprache.
...
## BESCHREIBUNG
Abfragen eines IoT Hubs mithilfe einer leistungsfähigen SQL-igen Sprache, um Informationen zu Geräte- und Modulzungen, Aufträgen und Nachrichtenrouting abzurufen.
Weitere https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-query-language Informationen finden Sie unter.
...
Abfragen aller Gerätezungsdaten in einem Azure IoT Hub.
...
Abfrage der top 2-Modul-Doppeldaten auf einem Zielgerät.
...
Standardmäßig verfügt die Abfrage über keine Obergrenze.
