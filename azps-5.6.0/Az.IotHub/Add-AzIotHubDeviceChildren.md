...
## SYNOPSIS
Fügen Sie dem Edgegerät Nicht-Edge-Geräte als untere Geräte hinzu.
...
## BESCHREIBUNG
Fügen Sie eine angegebene durch Kommas getrennte Liste der nicht edge-Geräte-ID als Unter-n des angegebenen Edgegeräts hinzu.
...
Fügen Sie dem Edgegerät Nicht-Edge-Geräte als untergeordnete Geräte hinzu, unabhängig davon, ob das Nicht-Edge-Gerät bereits ein Untergeordnetes eines anderen Edgegeräts ist.
