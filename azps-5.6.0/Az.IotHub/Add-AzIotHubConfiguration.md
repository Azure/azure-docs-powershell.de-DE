...
## SYNOPSIS
Fügen Sie eine automatische IoT-Geräteverwaltungskonfiguration in einem IoT-Zielhub hinzu.
...
## BESCHREIBUNG
Der Konfigurationsinhalt ist json und variiert je nach Geräte- oder Modulabsicht geringfügig. Gerätekonfigurationen sind in Form von {"deviceContent":{...}}
Modulkonfigurationen sind in Form von {"moduleContent":{...}}
Konfigurationen können mit vom Benutzer bereitgestellten Metriken für die Bedarfsauswertung definiert werden.
Benutzermetriken sind json und in Form von {"queries":{...}} oder {"metriken":{"queries":{...}}}.

Hinweis: Zielbedingung für Module muss mit "from devices.modules where" beginnen. Weitere https://docs.microsoft.com/azure/iot-hub/iot-hub-automatic-device-management Informationen finden Sie unter.
...
Erstellen Sie eine Gerätekonfiguration mit der Priorität 3, die unter der Bedingung gilt, dass ein Gerät in Gebäude 9 markiert ist und die Umgebung "Test" ist.
