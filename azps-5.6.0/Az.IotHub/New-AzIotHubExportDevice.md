...
## BESCHREIBUNG
Erstellt einen neuen Exportgeräteauftrag für den IotHub.
Dadurch werden alle Geräte in den angegebenen Container exportiert. Lesen Sie den folgenden Artikel zum Generieren des SAS-URI.
https://docs.microsoft.com/azure/iot-hub/iot-hub-bulk-identity-mgmt#get-the-container-sas-uri .

## BEISPIELE

### Beispiel 1: Problem einer Exportgeräteanforderung.
```
...
Erstellt eine neue Exportgeräteanforderung für den IotHub "myiothub" mit Ausnahme der Schlüssel.
