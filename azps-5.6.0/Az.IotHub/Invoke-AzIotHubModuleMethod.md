...
## BESCHREIBUNG
Rufen Sie eine Edgemodulmethode auf. Weitere https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-direct-methods Informationen finden Sie unter.
...
### -Name
Der Name der Methode, die auf diesem Gerätemodul aufgerufen werden soll.
...
### -Payload
Die Nutzlast für die Methode, die auf diesem Gerätemodul aufgerufen werden soll.
