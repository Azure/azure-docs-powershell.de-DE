...
## BESCHREIBUNG
Rufen Sie eine direkte Methode auf einem Gerät auf. Weitere https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-direct-methods Informationen finden Sie unter.
...
### -ConnectionTimeOut
Die Anzahl der Sekunden, die gewartet werden müssen, bis eine Verbindung erfolgreich hergestellt wurde.
...
### -ResponseTimeOut
Anzahl der Sekunden, die gewartet werden müssen, bis ein Ergebnis von der direkten Methode empfangen wird.
Der Standardwert ist 10.
