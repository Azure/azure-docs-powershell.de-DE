...
## SYNOPSIS
Rufen Sie den Failoverprozess für den IoT Hub für die Region für die geokoppelte Notfallwiederherstellung auf.
...
## BESCHREIBUNG
Es löst das Failover Ihres IoT-Hubs zum sekundären Speicherort aus. Diese Aktion verursacht Zeit- und Telemetrieverluste für Ihre Projektmappe. Dies ist ein langer Vorgang, der einige Minuten dauern kann. Gehen Sie bei der Verwendung mit Vorsicht vor.
...
### -PassThru
Ermöglicht das Zurückgeben des booleschen Objekts. Standardmäßig generiert dieses Cmdlet keine Ausgabe.
