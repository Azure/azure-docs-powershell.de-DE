...
## BESCHREIBUNG
Testen Sie eine bestimmte Route.
...
Testen Sie alle Routen mit der Quelle "DeviceMessages".
...
Testen Sie eine bestimmte Route, und zeigen Sie die Ursache des Fehlers an.
...
Testen Sie eine bestimmte Route mit AppProperty und SystemProperty.

## PARAMETER

### -AppProperty
App-Eigenschaften der Routennachricht
...
### -ShowError
Detaillierter Fehler anzeigen(falls vorhanden)
...
### -SystemProperty
Systemeigenschaften der Routenmeldung
