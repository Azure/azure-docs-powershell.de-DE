...
### Beispiel 1 Ruft alle Ereignishub-Consumergruppen für den Telemetrieereignishub ab.
```
PS C:\> Get-AzIotHubEventHubConsumerGroup -ResourceGroupName "myresourcegroup" -Name "myiothub"
```

Ruft alle Ereignishub-Consumergruppen für den Telemetrieereignishub für den Iothub mit dem Namen myiothub ab.
