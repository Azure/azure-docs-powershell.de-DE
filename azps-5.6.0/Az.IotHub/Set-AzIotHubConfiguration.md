...
## SYNOPSIS
Aktualisieren Sie die veränderbaren Felder der Konfigurationsregistrierung.
...
Weitere https://docs.microsoft.com/azure/iot-hub/iot-hub-automatic-device-management Informationen finden Sie unter.
...
### -Erzwingen
Ermöglicht das Ersetzen des Konfigurationsobjekts, auch wenn es seit dem letzten Abrufen aktualisiert wurde.
...
### -Metrisch
Abfragesammlung für die Definition von Konfigurationsmetriken.
...
### -Priorität
Gewichtung der Gerätekonfiguration im Falle konkurrierender Regeln (höchste Gewinne).
