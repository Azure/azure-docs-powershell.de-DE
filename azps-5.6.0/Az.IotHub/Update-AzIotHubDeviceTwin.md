...
## SYNOPSIS
Aktualisiert Tags und gewünschte Eigenschaften eines Gerätezungepaars.
...
## BESCHREIBUNG
Aktualisiert oder ersetzt einen Gerätezunge. Weitere https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-device-twins Informationen finden Sie unter.
...
Gibt das aktualisierte Gerätezungeobjekt zurück.
...
Gibt das Gerätezungeobjekt mit aktualisierten gewünschten Eigenschaften zurück.
...
Gibt das Gerätezungeobjekt mit der Eigenschaft "aktualisierte Tags" zurück.
...
Gibt das ersetzte Gerätezungeobjekt zurück.
...
### -Desired
Fügen Sie die gewünschte Eigenschaft in einem Gerätezunge hinzu, oder aktualisieren Sie sie.
...
### -Partielle
Ermöglicht es, die Tags und gewünschten Eigenschaften eines Gerätezungepaars nur teilweise zu aktualisieren.
...
### -Tag
Fügen Sie die Tagseigenschaft in einem Gerätezunge hinzu, oder aktualisieren Sie sie.
