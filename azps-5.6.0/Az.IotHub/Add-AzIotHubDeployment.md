...
## SYNOPSIS
Fügen Sie eine IoT Edge-Bereitstellung in einem Ziel-IoT Hub hinzu.
...
## BESCHREIBUNG
Edgebereitstellungen können mit benutzerdefinierten Metriken für die On-Demand-Auswertung erstellt werden.
...
Erstellen Sie eine Edgebereitstellung mit der Priorität 3, die unter der Bedingung gilt, dass ein Gerät in Gebäude 9 markiert ist und die Umgebung "Test" ist.
...
Erstellen Sie eine Edgebereitstellung mit Inhalten.
...
### -Metrisch
Abfragesammlung für die Definition von IoT Edge-Bereitstellungsmetriken.
...
### -Priorität
Gewicht der Bereitstellung im Falle konkurrierender Regeln (höchste Gewinne).
