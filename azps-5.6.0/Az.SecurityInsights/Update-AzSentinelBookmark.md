...
Sie können ein **Bookmark-Objekt** als Parameter oder mithilfe des Pipelineoperators übergeben oder alternativ die erforderlichen *BookmarkId-Parameter* angeben.
...
Der Befehl aktualisiert die Textmarke durch Festlegen der *Notes-Eigenschaft.*  Alle anderen Propreties bleiben gleich.
...
Der erste Befehl ruft die Bookmark by *BookmarkId* aus dem angegebenen Arbeitsbereich ab und speichert sie dann in der $Bookmark Variable.
Mit dem zweiten Befehl wird die Notes-Eigenschaft aktualisiert.   Alle anderen Propreties bleiben gleich.
...
### -DisplayName
Anzeigename der Lesezeichenregel.
...
### -IncidentInfo
Vorfallinformationen mit lesezeichen.
...
### -QueryResult
Abfrageergebnis mit Textmarken versehen.
