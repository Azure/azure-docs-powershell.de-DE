...
## BESCHREIBUNG
Das Remove-AzMapsAccount cmdlet löscht das angegebene Azure Maps-Konto.
...
Löscht das Konto MyAccount aus der Ressourcengruppe MyResourceGroup.
...
Löscht das angegebene Azure Maps-Konto.
...
### -PassThru
Geben Sie zurück, ob das angegebene Konto erfolgreich gelöscht wurde oder nicht.
