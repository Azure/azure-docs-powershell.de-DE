...
Im Beispiel werden die Partitionsanzahl und die Replikatanzahl des Azure Cognitive Search-Diensts in 2 geändert.
...
### -PublicNetworkAccess
(Optional) Zugriff auf öffentliches Netzwerk des Azure Cognitive Search Service (Aktiviert/Deaktiviert)
