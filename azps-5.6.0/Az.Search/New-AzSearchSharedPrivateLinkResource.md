...
## BESCHREIBUNG
Die **New-AzSearchSharedPrivateLinkResource** erstellt eine freigegebene private Linkressource für den Azure Cognitive Search-Dienst.
...
In diesem Beispiel wird eine freigegebene private Linkressource mit dem Blobdienst eines Speicherkontos für den Azure Cognitive Search-Dienst erstellt.
...
### -GroupId
Ressourcengruppen-ID für freigegebene private Verknüpfungen
...
Zielressourcen-ID für freigegebene private Links
...
### -ResourceRegion
(Optional) Ressourcenregion für freigegebene private Verknüpfungen
