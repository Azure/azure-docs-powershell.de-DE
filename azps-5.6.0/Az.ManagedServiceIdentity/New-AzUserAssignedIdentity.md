...
## SYNOPSIS
Erstellt eine neue vom Benutzer zugewiesene Identität oder aktualisiert eine vorhandene benutzer zugewiesene Identität.
...
## BESCHREIBUNG
Das **Cmdlet New-AzUserAssignedIdentity** erstellt eine neue Vom Benutzer zugewiesene Identität. Bei Verwendung mit einer bereits vorhandenen Identität wurde die Identität aktualisiert.
Wenn Sie der Identität Azure Resource Manager-Tags hinzufügen möchten, verwenden Sie das Set-AzResource cmdlet.

## BEISPIELE

### Beispiel 1
In diesem Beispiel-Cmdlet wird eine neue vom Benutzer zugewiesene Identität mit der **Namen-ID1** unter ressourcengruppe **PSRG** am Speicherort der Ressourcengruppe erstellt.
...
### Beispiel 2
In diesem Beispiel-Cmdlet wird unter der Ressourcengruppe **PSRG** in der Region Westus eine neue vom Benutzer zugewiesene Identität mit der **Namen-ID1** erstellt.
...
### -Location
Der Name der Azure-Region, in dem die Identität erstellt werden soll.
