...
### Beispiel 1
In diesem Beispiel-Cmdlet wird unter der Ressourcengruppe **PSRG** die vom Benutzer zugewiesene Identität mit der **Namen-ID1** angezeigt.
...
### Beispiel 3
In diesem Beispiel-Cmdlet werden alle benutzer zugewiesenen Identitäten unter dem Abonnement angezeigt.
