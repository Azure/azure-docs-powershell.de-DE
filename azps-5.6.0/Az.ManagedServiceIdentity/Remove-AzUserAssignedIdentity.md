...
## BESCHREIBUNG
Die **Remove-AzUserAssignedIdentity** löscht die angegebene benutzer zugewiesene Identität.
...
In diesem Beispiel-Cmdlet wird die **Identitäts-ID1** unter Ressourcengruppe **PSRG gelöscht.**
True
