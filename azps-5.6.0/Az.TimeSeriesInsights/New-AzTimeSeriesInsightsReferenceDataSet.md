...
### Beispiel 1: Erstellen eines Referenzdatensatzs für eine angegebene Umgebung  
```powershell
...
Mit diesem Befehl wird ein Referenzdatensatz für eine bestimmte Umgebung erstellt.

## PARAMETER

### -DataStringComparisonBehavior
Das Vergleichsverhalten des Referenzdatensatzschlüssels kann mit dieser Eigenschaft festgelegt werden.
Standardmäßig ist der Wert "Ordinal". Dies bedeutet, dass beim Verknüpfen von Referenzdaten mit Ereignissen oder beim Hinzufügen neuer Referenzdaten ein Vergleich mit groß-/kleinschreibungssensitiven Schlüsseln durchgeführt wird.
Wenn "OrdinalIgnoreCase" festgelegt ist, wird ein Vergleich der Groß-/Kleinschreibung verwendet.
...
### -KeyProperty
Die Liste der Schlüsseleigenschaften für den Referenzdatensatz.
Informationen zum Erstellen finden Sie im Abschnitt NOTIZEN zu KEYPROPERTY-Eigenschaften, und erstellen Sie eine Hashtabelle.
...
KEYPROPERTY <IReferenceDataSetKeyProperty[]>: Die Liste der Schlüsseleigenschaften für den Referenzdatensatz.
