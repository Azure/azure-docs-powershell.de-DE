...
### Beispiel 1: Erhalten einer Umgebung für Einblicke in Zeitreihen
```powershell
...
Dieser Befehl ruft eine Umgebung für Zeitreiheneinblicke ab.

### Beispiel 2: Listen aller Zeitreiheneinblickumgebungen
```powershell
...
### Beispiel 3: Erhalten einer Umgebung für Zeitreiheneinblicke nach Objekt
```powershell
...
Dieser Befehl ruft eine Zeitreiheneinblickumgebung ab.
...
### -Erweitern
Das $expand=status enthält den Status der internen Dienste der Umgebung im Dienst Zeitreiheneinblicke.
