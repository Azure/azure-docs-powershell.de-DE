...
### Beispiel 1: Auflisten aller Referenzdatensätze unter der angegebenen Umgebung
```powershell
...
Mit diesem Befehl werden alle Referenzdatensätze unter der angegebenen Umgebung aufgeführt.

### Beispiel 2: Erhalten eines angegebenen Referenzdatensatzs nach Name
```powershell
...
Dieser Befehl ruft einen angegebenen Referenzdatensatz ab.

### Beispiel 3: Erhalten eines angegebenen Bezugsdatensets nach Objekt
```powershell
...
### -Name
Der Name des Referenzdatensatzs für Zeitreiheneinblicke, der der angegebenen Umgebung zugeordnet ist.
