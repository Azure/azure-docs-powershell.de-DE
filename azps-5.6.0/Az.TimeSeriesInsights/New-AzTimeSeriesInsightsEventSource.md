...
### Beispiel 1: Erstellen einer Ereignisquelle unter der angegebenen Umgebung
```powershell
...
Mit diesem Befehl wird eine Ereignisquelle unter der angegebenen Umgebung erstellt.

### Beispiel 2: Erstellen einerOthubereignisquelle unter der angegebenen Umgebung
```powershell
...
### -KeyName
Der Name des SAS-Schlüssels, der dem Dienst Zeitreiheneinblicke Zugriff auf das Ereignis/den iot-Hub gewährt.
...
### -ServiceBusNameSpace
Der Name des Dienstbuss, der den Ereignishub enthält.
...
### -SharedAccessKey
Der Wert des freigegebenen Zugriffsschlüssels, der dem Dienst Zeitreiheneinblicke Lesezugriff auf das Ereignis/iot-Hub gewährt.
