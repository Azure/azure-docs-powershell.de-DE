...
## SYNOPSIS
Akzeptieren Sie Marketplace-Bedingungen.
...
### Beispiel 1: Erstellen einer vereinbarungskonfluenten Marketplace unter einem Abonnement
```powershell
...
Mit diesem Befehl wird eine konfluente Marketplace-Vereinbarung unter einem Abonnement erstellt.
...
### -PrivacyPolicyLink
Link zur Datenschutzrichtlinie des Herausgebers.
...
### -Publisher
Publisher-Bezeichnerzeichenfolge.
...
### -RetrieveDatetime
Datum und Uhrzeit in UTC, an dem die Bedingungen akzeptiert wurden.
Dies ist leer, wenn "Akzeptiert" falsch ist.
