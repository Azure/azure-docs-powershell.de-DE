...
## SYNOPSIS
Hier erhalten Sie die Eigenschaften einer bestimmten Organisationsressource.
...
### Beispiel 1: Auflisten aller kongenenten Organisationen unter einem Abonnement
```powershell
...
Mit diesem Befehl werden alle kongenenten Organisationen unter einem Abonnement aufgeführt.

### Beispiel 2: Auflisten aller kongenenten Organisationen unter einer Ressourcengruppe
```powershell
...
Mit diesem Befehl werden alle sich zusammenfeinden Organisationen unter einer Ressourcengruppe aufgeführt.

### Beispiel 3: Erhalten einer kongenenten Organisation nach Name
```powershell
...
Dieser Befehl ruft eine konfluente Organisation nach Name ab.

### Beispiel 4: Erhalten einer kongenenten Organisation per Pipeline
```powershell
...
Dieser Befehl ruft eine kongente Organisation per Pipeline ab.
