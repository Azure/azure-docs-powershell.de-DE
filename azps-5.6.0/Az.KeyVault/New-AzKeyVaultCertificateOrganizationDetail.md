...
## SYNOPSIS
Erstellt ein Detailobjekt der Speicherzertifikatorganisation.
...
## BESCHREIBUNG
Das **Cmdlet New-AzKeyVaultCertificateOrganizationDetail** erstellt ein Detailobjekt der Speicherzertifikatorganisation.

## BEISPIELE

### Beispiel 1: Erstellen eines Organisationsdetailses
```powershell
...
Mit dem ersten Befehl wird ein Detailobjekt des Zertifikatadministrators erstellt und dann in der $AdminDetails gespeichert.
Mit dem zweiten Befehl wird ein Detailobjekt der Zertifikatorganisation erstellt und dann in der $OrgDetails gespeichert.

## PARAMETER

### -AdministratorDetails
Gibt die Zertifikatorganisationsadministratoren an.
