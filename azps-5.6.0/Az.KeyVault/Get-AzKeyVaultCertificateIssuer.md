...
## BESCHREIBUNG
Das **Get-AzKeyVertificateIssuer-Cmdlet** ruft einen angegebenen Zertifikataussteller oder alle Zertifikataussteller für einen Schlüsseltresor im Azure Key Vault ab.

## BEISPIELE

### Beispiel 1: Erhalten eines Zertifikatausstellers
```powershell
...
Dieser Befehl ruft den Zertifikataussteller mit dem Namen TestIssuer01 ab.

### Beispiel 2: Auflisten von Zertifikatausstellern mithilfe von Filterung
```powershell
...
Dieser Befehl ruft die Zertifikataussteller ab, die mit "test" beginnen.
...
### -Name
Gibt den Namen des Zertifikatausstellers an, den Sie erhalten müssen.
