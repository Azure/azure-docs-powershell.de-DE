...
## SYNOPSIS
Erstellt ein Zertifikatrichtlinienobjekt im Arbeitsspeicher.
...
## BESCHREIBUNG
Das **Cmdlet New-AzKeyVaultCertificatePolicy** erstellt ein Zertifikatrichtlinienobjekt im Arbeitsspeicher für azure key vault.
...
Mit diesem Befehl wird eine Zertifikatrichtlinie erstellt, die sechs Monate lang gültig ist, und der Schlüssel zum Verlängern des Zertifikats wiederverwendet.

### Beispiel 2

Erstellt ein Zertifikatrichtlinienobjekt im Arbeitsspeicher. (automatisch generiert)
...
### Beispiel 3: Erstellen eines Zertifikats für alternativen Betreffnamen (oder SAN)
...
### -CertificateTransparency
Gibt an, ob die Zertifikattransparenz für dieses Zertifikat/Aussteller aktiviert ist. wenn nicht angegeben, ist die Standardeinstellung "true"
...
### -CertificateType
Gibt den Zertifikattyp für den Aussteller an.
...
### -Curve
Gibt den ausliptischen Kurvennamen des Schlüssels des Zertifikats an.
...
### -DnsName
Gibt die DNS-Namen im Zertifikat an. Alternative Subject Names (SANs) können als DNS-Namen angegeben werden.
...
### -KeyUsage
Gibt die wichtigsten Verwendungen im Zertifikat an.
...
### -RenewAtNumberOfDaysBeforeExpiry
Gibt die Anzahl der Tage vor Ablauf an, nach denen der automatische Prozess für die Zertifikatverlängerung beginnt.
...
### -RenewAtPercentageLifetime
Gibt den Prozentsatz der Lebensdauer an, nach dem der automatische Prozess für die Zertifikatverlängerung beginnt.
...
> [!NOTE]
> Wenn Sie ein Komma (,) oder einen Zeitraum (.) innerhalb einer Eigenschaft im Parameter verwenden müssen, müssen Sie das Eigenschaftenfeld `SubjectName` in Anführungszeichen setzen. Sie können z. B. O="Contoso, Ltd" verwenden. im Feld Organisationsname.
...
### System.Collections.generic.List'1[System.Security.Cryptography.X509Certificates.X509KeyUsageFlags, System.Security.Cryptography.X509Certificates, Version=4.2.1.0, Culture=neutral, PublicKeyToken=b03f5f7f111d50a3a]]
