...
## SYNOPSIS
Stellt einen gelöschten Schlüssel in einem Schlüsseltresor in einem aktiven Zustand wiederher.
...
Mit diesem Befehl wird der zuvor gelöschte Schlüssel "MyKey" in einem aktiven und verwendbaren Zustand wiederhergestellt.
