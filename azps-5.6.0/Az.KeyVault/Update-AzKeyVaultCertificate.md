...
Mit dem zweiten Befehl wird der Tagwert des Zertifikats mit dem Namen TestCert01 als $Tags.
...
Wenn nicht angegeben, bleibt der vorhandene Wert des Status "Aktiviert/Deaktiviert" des Zertifikats unverändert.
...
Wenn nicht angegeben, bleiben die vorhandenen Tags des Sertificates unverändert.
...
### -Version
Zertifikatversion.
Das Cmdlet erstellt den FQDN eines Zertifikats aus dem Tresornamen, der aktuell ausgewählten Umgebung, dem Zertifikatnamen und der Zertifikatversion.
