...
Mit diesem Befehl wird die Richtlinie für das TestCert01-Zertifikat im ContosoKV01-Schlüsseltresor bestimmt.
...
### -EmailAtNumberOfDaysBeforeExpiry
Gibt die Anzahl der Tage vor ablaufen an, wenn die automatische Verlängerung gestartet werden soll.
