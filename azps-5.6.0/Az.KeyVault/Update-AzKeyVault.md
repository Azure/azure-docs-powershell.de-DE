...
## SYNOPSIS
Aktualisieren Sie den Zustand eines Azure-Schlüsseltresor.
...
## BESCHREIBUNG
Dieses Cmdlet aktualisiert den Zustand eines Azure-Schlüsseltresor.
...
Aktiviert den Bereinigungsschutz mithilfe der Pipingsyntax.
...
### Beispiel 4: Bereinigen von Tags
```powershell
...
Aktivieren Sie die Funktionen zum Löschen des Schutzes für diesen Schlüsseltresor.
Nach der Aktivierung kann sie nicht mehr deaktiviert werden.
Es ist erforderlich, dass soft-delete aktiviert ist.
...
Aktivieren oder deaktivieren Sie diesen Schlüsseltresor, um Datenaktionen durch rollenbasiertes Zugriffssteuerelement (Role Based Access Control, RBAC) zu autorisieren.
