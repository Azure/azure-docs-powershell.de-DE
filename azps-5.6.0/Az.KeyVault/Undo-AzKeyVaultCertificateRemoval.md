...
## SYNOPSIS
Stellt ein gelöschtes Zertifikat in einem Schlüsseltresor in einem aktiven Zustand wiederher.
...
Mit diesem Befehl wird das zuvor gelöschte Zertifikat "MyCertificate" in einem aktiven und verwendbaren Zustand wiederhergestellt.
...
### -Name
Zertifikatname.
Das Cmdlet erstellt den FQDN eines Zertifikats aus dem Tresornamen, der aktuell ausgewählten Umgebung und dem Zertifikatnamen.
