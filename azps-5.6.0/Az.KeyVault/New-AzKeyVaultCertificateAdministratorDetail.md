...
## SYNOPSIS
Erstellt ein Detailobjekt des Arbeitsspeicherzertifikatsadministrators.
...
## BESCHREIBUNG
Das **Cmdlet New-AzKeyVaultCertificateAdministratorDetail** erstellt ein In-Memory-Zertifikatadministratordetails-Objekt.

## BEISPIELE

### Beispiel 1: Erstellen eines Zertifikatadministratordetailses
```
...
Mit diesem Befehl wird ein Detailobjekt des Arbeitsspeicherzertifikatadministrators erstellt und dann in der $AdminDetails gespeichert.
