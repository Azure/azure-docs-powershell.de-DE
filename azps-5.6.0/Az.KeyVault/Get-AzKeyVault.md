...
## BESCHREIBUNG
Das **Get-AzKeyVault-Cmdlet** ruft Informationen zu den wichtigsten Tresoren in einem Abonnement ab. Sie können alle Schlüsseltresorinstanzen in einem Abonnement anzeigen oder Die Ergebnisse nach einer Ressourcengruppe oder einem bestimmten Schlüsseltresor filtern.
Beachten Sie, dass die Angabe der Ressourcengruppe für dieses Cmdlet optional ist, wenn Sie einen einzelnen Schlüsseltresor erhalten, sie sollten dies jedoch tun, um die Leistung zu verbessern.

## BEISPIELE

### Beispiel 1: Alle Schlüsseltresor in Ihrem aktuellen Abonnement erhalten
```powershell
PS C:\> Get-AzKeyVault
...
### Beispiel 3: Erhalten von Schlüsseltresor in einer Ressourcengruppe
```powershell
...
### Beispiel 4: Alle gelöschten Schlüsseltresor in Ihrem aktuellen Abonnement
```powershell
...
### Beispiel 5: Erstellen eines gelöschten Schlüsseltresor
```powershell
...
Dieser Befehl ruft die gelöschten Schlüsseltresorinformationen mit dem Namen myvault4 in Ihrem aktuellen Abonnement und in der Region Westus ab.

### Beispiel 6: Erhalten von Schlüsseltresor mithilfe von Filtern
```powershell
PS C:\> Get-AzKeyVault -VaultName 'myvault*'
...
### -ResourceGroupName
Gibt den Namen der Ressourcengruppe an, die dem Schlüsseltresor oder den Schlüsseltresor zugeordnet ist, der abgefragt wird.
