...
Mit diesem Befehl werden alle Berechtigungen entfernt, die ein Benutzer für den Schlüsseltresor PattiFuller@contoso.com "Contoso03Vault" besitzt.  Wenn -PassThru angegeben ist, wird das KeyVault-Objekt zurückgegeben.
...
Mit diesem Befehl werden die Berechtigungen für den Microsoft.Compute-Ressourcenanbieter entfernt, um Geheiminformationen aus Contoso03Vault zu erhalten.
...
Wenn angegeben, deaktiviert das Abrufen von Geheiminformationen aus diesem Schlüsseltresor durch den Microsoft.Compute-Ressourcenanbieter, wenn in der Ressourcenerstellung auf verwiesen wird.
...
Wenn angegeben, deaktiviert das Abrufen von Geheimnissen aus diesem Schlüsseltresor durch azure disk encryption.
...
Wenn angegeben, wird das Abrufen von Geheiminformationen aus diesem Schlüsseltresor durch Azure Resource Manager deaktiviert, wenn in Vorlagen auf verwiesen wird.
...
### -ObjectId
Gibt die Objekt-ID des Benutzers oder Dienstprinzipals in Azure Active Directory an, für die Berechtigungen entfernt werden müssen.
...
Wenn nicht angegeben, sucht dieses Cmdlet nach dem Schlüsseltresor im aktuellen Abonnement.
...
Geben Sie die Anwendungs-ID an, die auch als Client-ID bezeichnet wird und für die Anwendung in Azure Active Directory registriert ist.
...
### -UserPrincipalName
Gibt den Benutzernamen des Benutzers an, dessen Zugriff Sie entfernen möchten.
