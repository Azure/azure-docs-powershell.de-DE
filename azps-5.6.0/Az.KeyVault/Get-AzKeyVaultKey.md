...
## SYNOPSIS
Ruft Schlüsseltresorschlüssel ab.
...
## BESCHREIBUNG
Das **Get-AzKeyVaultKey-Cmdlet** ruft Azure Key Vault-Schlüssel ab.
...
### Beispiel 2: Holen Sie sich die aktuelle Version eines Schlüssels
```powershell
...
Dieser Befehl ruft die aktuelle Version des Schlüssels test1 im Schlüsseltresor namens Contoso ab.
...
Dieser Befehl ruft alle Versionen mit dem Schlüssel "ITPfx" im Schlüsseltresor namens Contoso ab.
...
Dieser Befehl ruft eine bestimmte Version des Schlüssels test1 im Schlüsseltresor namens Contoso ab.
...
### Beispiel 5: Alle Schlüssel erhalten, die gelöscht, aber nicht für diesen Schlüsseltresor gelöscht wurden
```powershell
...
### Beispiel 6: Ruft den Schlüssel ITPfx ab, der für diesen Schlüsseltresor gelöscht, aber nicht gelöscht wurde.
```powershell
...
Dieser Befehl ruft den Schlüsseltest3 ab, der zuvor gelöscht, aber nicht gelöscht wurde, im Schlüsseltresor namens Contoso.
Dieser Befehl gibt Metadaten zurück, z. B. das Löschdatum und das geplante Löschdatum dieses gelöschten Schlüssels.

### Beispiel 7: Erhalten aller Schlüssel in einem Schlüsseltresor mithilfe von Filtern
```powershell
...
Dies ist ein Schritt zum Importieren von HSM-geschützten Schlüsseln in den Azure Key Vault. Sieh https://docs.microsoft.com/azure/key-vault/keys/hsm-protected-keys
...
Dieses Cmdlet erstellt den FQDN eines Schlüssels basierend auf dem Schlüsseltresornamen, der aktuell ausgewählten Umgebung, dem Schlüsselnamen und der Schlüsselversion.
