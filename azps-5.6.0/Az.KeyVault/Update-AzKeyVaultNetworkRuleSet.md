...
## SYNOPSIS
Aktualisiert den Netzwerkregelsatz für einen Schlüsseltresor.
...
## BESCHREIBUNG
Mit **dem Befehl Update-AzKeyVaultNetworkRuleSet** werden die Netzwerkregeln aktualisiert, die für den angegebenen Schlüsseltresor wirksam sind. 
...
Mit diesem Befehl wird das Netzwerkregelsatz im Tresor mit dem Namen "myVault" für den angegebenen IP-Bereich und das virtuelle Netzwerk aktualisiert, sodass die Netzwerkregel für Azure-Dienste umgangen werden kann.

### Beispiel 2

Aktualisiert den Netzwerkregelsatz für einen Schlüsseltresor. (automatisch generiert)
