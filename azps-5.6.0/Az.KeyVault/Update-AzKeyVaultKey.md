...
## BESCHREIBUNG
Das **Update-AzKeyVaultKey-Cmdlet** aktualisiert die bearbeitbaren Attribute eines Schlüssels in einem Schlüsseltresor.
...
Der erste Befehl erstellt ein **DateTime-Objekt** mithilfe des **Get-Date-Cmdlets.** Dieses Objekt gibt eine Zeit von zwei Jahren in der Zukunft an. Der Befehl speichert dieses Datum in der $Expires Variablen.
...
Der letzte Befehl ändert einen Schlüssel namens ITSoftware. Der Befehl aktiviert den Schlüssel, legt seine Ablaufzeit auf die in $Expires gespeicherte Zeit fest, und legt die Tags fest, die in einem $Tags.
...
### -Enable
Der Wert "true" aktiviert den Schlüssel, und der Wert "false" deaktiviert den Schlüssel.
Wenn nicht angegeben, bleibt der vorhandene aktivierte/deaktivierte Zustand unverändert.
...
### -Läuft ab
Die Ablaufzeit eines Schlüssels in DER UTC-Zeit.
Wenn nicht angegeben, bleibt die vorhandene Ablaufzeit des Schlüssels unverändert.
...
### -Name
Schlüsselname.
Das Cmdlet erstellt den FQDN eines Schlüssels aus dem Tresornamen, der aktuell ausgewählten Umgebung und des Schlüsselnamens.
...
Wenn nicht angegeben, bleibt das vorhandene NotBefore-Attribut des Schlüssels unverändert.
...
Wenn dieser Schalter angegeben ist, gibt das aktualisierte Schlüsselbündelobjekt zurück.
...
Wenn nicht angegeben, bleiben die vorhandenen Tags des Schlüssels unverändert.
...
### -Version
Schlüsselversion.
Das Cmdlet erstellt den FQDN eines Schlüssels aus dem Tresornamen, der aktuell ausgewählten Umgebung, des Schlüsselnamens und der Schlüsselversion.
