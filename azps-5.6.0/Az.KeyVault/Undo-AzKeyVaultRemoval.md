...
## SYNOPSIS
Stellt einen gelöschten Schlüsseltresor in einem aktiven Zustand wiederher.
...
Mit diesem Befehl wird der Schlüsseltresor "MyKeyVault", der zuvor aus der Region "eastus2" und der Ressourcengruppe "MyResourceGroup" gelöscht wurde, in einem aktiven und verwendbaren Zustand wiederhergestellt. Außerdem werden die Tags durch ein neues -Tag ersetzt.
...
### -Location
Gibt die ursprüngliche Azure-Region des gelöschten Tresors an.
