...
## BESCHREIBUNG
Das **Cmdlet Stop-AzKeyVaultCertificateOperation** bricht einen Zertifikatvorgang im Azure Key Vault-Dienst ab.

## BEISPIELE

### Beispiel 1: Abbrechen eines Zertifikatvorgangs
```powershell
...
Mit diesem Befehl wird der TestCert02-Zertifikatvorgang abgebrochen.
