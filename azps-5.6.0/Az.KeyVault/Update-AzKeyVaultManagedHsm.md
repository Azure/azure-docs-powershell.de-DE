...
## SYNOPSIS
Aktualisieren Sie den Zustand eines von Azure verwalteten HSM.
...
## BESCHREIBUNG
Dieses Cmdlet aktualisiert den Zustand eines von Azure verwalteten HSM.

## BEISPIELE

### Beispiel 1: Direktes Aktualisieren eines verwalteten Hsms
```powershell
...
Aktualisiert Tags für den verwalteten Hsm, der `$hsmName` in der Ressourcengruppe benannt `$resourceGroupName` ist.

### Beispiel 2: Aktualisieren eines verwalteten Hsms mithilfe von Piping
```powershell
