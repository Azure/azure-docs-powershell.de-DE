...
Erstellen eines neuen Direct Peerings mit einer einzigen Verbindung in der Anlage in Seattle mithilfe von PeerAsn 65000
...
### -DirectConnection
Erstellen Sie neue Direkte Verbindungen mit New-AzExchangePeeringConnection und Pipe zu diesem Befehl.
...
### -ExchangeConnection
Erstellen Sie neue Exchange-Verbindungen mit New-AzExchangePeeringConnection und Pipe zu diesem Befehl.
...
### -InputObject
Verwenden Get-AzLegacyPeering, um dieses Objekt abzurufen.
...
### -PeeringLocation
Der physische Speicherort, der sich von der Azure-Region ab unterscheiden kann.
Verwenden Get-AzPeeringLocation -Kind \<kind\> verwenden Sie Den Ortsnamen als Schlüssel.
...
### -Sku
Wählen Sie Basic_Direct_Free oder Premium_Direct_Free aus, es sei denn, sie werden explizit zum Auswählen einer anderen Option angegeben.
...
### -Tag
Die Tags, die dem Microsoft Peering Service zugeordnet werden.
