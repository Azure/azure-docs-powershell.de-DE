...
Erstellt ein Peeringdienstobjekt mit Anbieter- und Peeringspeicherort. Verwenden sie in der Konjuktion `Get-AzPeeringServiceProvider` mit und `Get-AzPeeringServiceLocation`
...
### -PeeringLocation
Der physische Speicherort, der sich von der Azure-Region ab unterscheiden kann. Verwenden Get-AzPeeringServiceLocation [-Land <country> ]
...
Verwenden Get-AzPeeringServiceProvider cmdlets für eine Liste
