...
## BESCHREIBUNG
Ruft die Peerings aus einem Abonnement, einer Ressourcengruppe oder nach Namen ab.
...
Ruft das Exchange-Peering mit dem Namen ab. `myExchangePeering1`
...
Ruft das Exchange-Peering basierend `myExchangePeering1` auf der Ressourcen-ID ab.
