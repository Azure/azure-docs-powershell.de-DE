...
### Beispiel 2: Herunterladen von AzDigitalTwinsEndpoint nach EndpointName
```powershell
...
AzDigitalTwinsEndpoint von EndpointName in ResourceGroup herunterladen

### Beispiel 3: "AzDigitalTwinsEndpoint nach "AzDigitalTwinsEndpoint"-Objekt
```powershell
...
AzDigitalTwinsEndpoint von 'AzDigitalTwinsEndpoint'-Objekt
