...
### Beispiel 1: Standardmäßig eine AzDigitalTwinsInstance erstellen.
```powershell
...
### Beispiel 2: Erstellen eines AzDigitalTwinsInstance von AzDigitalTwins-Objekts.
```powershell
...
Erstellen eines AzDigitalTwinsInstance by AzDigitalTwins-Objekts
...
Informationen zum Erstellen finden Sie im Abschnitt NOTIZEN für DIGITALTWINSCREATE-Eigenschaften, und erstellen Sie eine Hashtabelle.
