...
### Beispiel 1: Erstellen eines AzDigitalTwinsEndpoints für Eventhub
```powershell
...
Erstellen eines AzDigitalTwinsEndpoints für Eventhub durch connectionStringPrimaryKey

### Beispiel 2: Erstellen eines AzDigitalTwinsEndpoints für EventGrid
```powershell
...
Erstellen eines AzDigitalTwinsEndpoints für Eventhub nach TopicEndpoint und accessKey1

### Beispiel 3: Erstellen eines AzDigitalTwinsEndpoints für ServiceBus
```powershell
...
Erstellen eines AzDigitalTwinsEndpoints für ServicBus von PrimaryConnectionString
...
### -DeadLetterSecret
Geheimer Speicher für "Toter Brief".
...
Informationen zum Erstellen finden Sie im Abschnitt NOTIZEN für ENDPOINTDESCRIPTION-Eigenschaften, und erstellen Sie eine Hashtabelle.
...
### -EndpointType
Der Typ des Endpunkts "Digitale Partner"
...
ENDPOINTDESCRIPTION <IDigitalTwinsEndpointResource> : DigitalTwinsInstance-Endpunktressource.
  - `EndpointType <EndpointType>`: Der Typ des Endpunkts "Digitale Partner"
  - `[DeadLetterSecret <String>]`: Geheimer Aufbewahrungsgeheimnis für tote Briefe. Wird während des Lesens verschleiert.
