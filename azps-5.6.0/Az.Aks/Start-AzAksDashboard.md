...
## BESCHREIBUNG
Erstellen Sie einen Kubectl-SSH-Tunnel zum Dashboard des verwalteten Clusters. Der SSH-Tunnel wird in einem PowerShell-Auftrag namens Kubectl-Tunnel eingerichtet und kann durch Ausführen von gefunden `Get-Job` werden. Der Tunnel sollte über zugänglich [http://127.0.0.1:8001](http://127.0.0.1:8001) sein.

## BEISPIELE

### Starten eines SSH-Tunnels und Öffnen eines Browsers für das Kubernetes-Dashboard
```
...
### -ListenPort
Der Wiedergabeport für das Dashboard. Der Standardwert ist 8003.
...
### -PassThru
Cmdlet gibt den KubeTunnelJob zurück, wenn übergeben.
