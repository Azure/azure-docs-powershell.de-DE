...
Geben Sie den Dienst nach seinem Namen, der Diensttopologie, in der er sich befindet, und dem Ressourcengruppennamen an. 

Das Cmdlet gibt ein Dienstobjekt zurück. Sie können dieses Objekt lokal ändern und dann Änderungen auf den Dienst anwenden, indem Sie das cmdlet Set-AzDeploymentManagerService verwenden.
...
Erstellt einen neuen Dienst mit dem Namen ContosoService1 unter Diensttopologie ContosoServiceTopology in Der Ressourcengruppe ContosoResourceGroup am Speicherort Zentral USA. Die TargetLocation-Eigenschaft gibt an, dass der Dienst ContosoService1 in der Region Ost-USA im angegebenen Abonnement bereitgestellt werden soll.
...
Bestimmt das Abonnement, für das Ressourcen unter dem Dienst bereitgestellt werden sollen.
