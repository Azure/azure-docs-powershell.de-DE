...
### -MaxAnalyticsUnits
Die optionalen maximal unterstützten Analyseeinheiten zum Aktualisieren des Kontos.
...
### -MaxJobCount
Die optionalen maximal unterstützten Aufträge, die unter dem Konto zur gleichen Zeit ausgeführt werden, um sie zu festlegen.
...
### -QueryStoreRetention
Die optionale Anzahl von Tagen, die Auftragsmetadaten beibehalten werden, um im Konto festgelegt zu werden.
...
### -Tag
Eine Zeichenfolge, ein Zeichenfolgenwörterbuch mit Tags, die diesem Konto zugeordnet sind und die aktuelle Gruppe von Tags ersetzen sollten
