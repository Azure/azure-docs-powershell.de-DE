...
## BESCHREIBUNG
Das Set-AzDataLakeAnalyticsCatalogCredential cmdlet ändert ein Anmeldeinformationskennwort, das einem Azure Data Lake Analytics-Katalog zugeordnet ist.

## BEISPIELE

### Beispiel 1: Ändern des Kennworts einer Anmeldeinformationen, das einem Konto zugeordnet ist
```
...
Mit diesem Befehl wird das Kennwort für Anmeldeinformationen auf das kennwort festgelegt, das in NewPassword angegeben ist.
...
### -DatabaseHost
Gibt den Hostnamen der externen Datenquelle an, mit der die Anmeldeinformationen im Format mydatabase.contoso.com.
...
### -DatabaseName
Gibt den Namen der Datenbank im Data Lake Analytics-Konto mit den Anmeldeinformationen an.
