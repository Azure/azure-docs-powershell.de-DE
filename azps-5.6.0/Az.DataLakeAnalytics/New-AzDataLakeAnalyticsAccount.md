...
Zurzeit wird nur Ost-US 2 unterstützt.
...
### -MaxJobCount
Die optionalen maximal unterstützten Aufträge, die unter dem Konto gleichzeitig ausgeführt werden. Ist keine angegeben, wird standardmäßig 3 festgelegt.
...
### -QueryStoreRetention
Die optionale Anzahl von Tagen, an der die Auftragsmetadaten beibehalten werden. Wenn keine angegeben ist, ist die Standardeinstellung 30 Tage.
...
### -Tag
Ein Zeichenfolgenverzeichnis mit Tags, die diesem Konto zugeordnet sind
