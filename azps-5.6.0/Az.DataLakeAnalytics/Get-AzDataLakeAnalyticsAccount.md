...
## BESCHREIBUNG
Das **Get-AzDataLakeAnalyticsAccount-Cmdlet** ruft Informationen zu einem Azure Data Lake Analytics-Konto ab.

## BEISPIELE

### Beispiel 1: Informationen zu einem Data Lake Analytics-Konto
```
PS C:\>Get-AzDataLakeAnalyticsAccount -Name "ContosoAdlAccount"
```

Dieser Befehl ruft Informationen zum Konto mit dem Namen ContosoAdlAccount ab.
