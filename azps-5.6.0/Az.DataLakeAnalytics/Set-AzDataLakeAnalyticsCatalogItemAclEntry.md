...
## BESCHREIBUNG
Das **Cmdlet Set-AzDataLakeAnalyticsCatalogItemAclEntry** fügt einen Eintrag (ACE) in der Zugriffssteuerungsliste (Access Control List, ACL) eines Katalogs oder Katalogelements in Data Lake Analytics hinzu oder ändert diesen.
...
Mit diesem Befehl wird der Katalog-ACE für Patti Fuller so geändert, dass er Leseberechtigungen hat.
...
Mit diesem Befehl wird das Datenbank-ACE für Patti Fuller so geändert, dass leseberechtigungen vorhanden sind.
...
Mit diesem Befehl wird der Katalog-ACE für andere geändert, damit andere über Leseberechtigungen verfügen.
...
Mit diesem Befehl wird die Besitzerberechtigung für das Konto auf Lesen definiert.

### Beispiel 6: Ändern von Benutzerbesitzerberechtigungen für eine Datenbank
```powershell
...
Mit diesem Befehl wird die Berechtigung des Besitzers für die Datenbank auf Lesen definiert.
...
### -Gruppe
Festlegen des ACL-Eintrags des Katalogs für die Gruppe
...
### -GroupOwner
Festlegen des ACL-Eintrags des Katalogs für den Gruppenbesitzer
...
### -ObjectId
Die Identität des benutzers, den Sie festlegen müssen.
...
### -Sonstige
Legen Sie die ACL-Eintrag des Katalogs für andere festlegen.
...
### -User
Legen Sie die ACL-Eintrag des Katalogs für benutzer.
...
### -UserOwner
Legen Sie die ACL-Eintrag des Katalogs für den Benutzerbesitzer.
