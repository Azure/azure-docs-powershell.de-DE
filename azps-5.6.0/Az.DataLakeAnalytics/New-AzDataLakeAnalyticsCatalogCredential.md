...
## BESCHREIBUNG
Das New-AzDataLakeAnalyticsCatalogCredential-Cmdlet erstellt neue Anmeldeinformationen, die in einem Azure Data Lake Analytics-Katalog zum Herstellen einer Verbindung mit externen Datenquellen verwendet werden können.

## BEISPIELE

### Beispiel 1: Erstellen einer Anmeldeinformationen für einen Katalog mit Host und Port
```
...
### Beispiel 2: Erstellen einer Anmeldeinformationen für einen Katalog mit vollständigem URI
```
PS C:\> New-AzDataLakeAnalyticsCatalogCredential -AccountName "ContosoAdlAccount" `
                  -DatabaseName "databaseName" `
                  -CredentialName "exampleDbCred" `
