...
## BESCHREIBUNG
Das **Cmdlet Get-AzDataLakeAnalyticsCatalogItemAclEntry** ruft eine Liste der Einträge (ACEs) in der Zugriffssteuerungsliste (Access Control List, ACL) eines Katalogs oder Katalogelements in Data Lake Analytics ab.

## BEISPIELE

### Beispiel 1: Herunterladen der ACL für einen Katalog
```powershell
...
### Beispiel 2: Herunterladen des ACL-Eintrags des Benutzerbesitzers für einen Katalog
```powershell
...
Dieser Befehl ruft den ACL-Eintrag des Benutzerbesitzers für den Katalog des angegebenen Data Lake Analytics-Kontos ab.

### Beispiel 3: Herunterladen des ACL-Eintrags des Gruppenbesitzers für einen Katalog
```powershell
...
### Beispiel 5: Erhalten des ACL-Eintrags des Benutzerbesitzers für eine Datenbank
```powershell
...
Dieser Befehl ruft den ACL-Eintrag des Benutzerbesitzers für die Datenbank des angegebenen Data Lake Analytics-Kontos ab.

### Beispiel 6: Erhalten des ACL-Eintrags des Gruppenbesitzers für eine Datenbank
```powershell
...
Dieser Befehl ruft den ACL-Eintrag des Gruppenbesitzers für die Datenbank des angegebenen Data Lake Analytics-Kontos ab.
...
### -GroupOwner
ACL-Eintrag des Katalogs für gruppenbesitzer
...
### -UserOwner
Holen Sie sich den ACL-Eintrag des Katalogs für den Benutzerbesitzer.
