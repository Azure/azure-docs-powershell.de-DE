...
## BESCHREIBUNG
Das **Cmdlet Test-AzDataLakeAnalyticsCatalogItem** überprüft das Vorhandensein eines Azure Data Lake Analytics-Katalogelements.
...
Mit diesem Befehl wird überprüft, ob ein angegebenes Schemaelement vorhanden ist.
...
### -ItemType
Gibt den Katalogelementtyp des zu überprüfenden Elements an.
...
### -Path
Gibt den Pfad zum zu abrufenden Element oder den Pfad zum übergeordneten Element der elemente an, die sie abrufen möchten.
