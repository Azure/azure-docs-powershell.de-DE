...
## BESCHREIBUNG
Das **Add-AzDataLakeAnalyticsFirewallRule-Cmdlet** fügt einem Azure Data Lake Analytics-Konto eine Firewallregel hinzu.
...
Mit diesem Befehl wird die Firewallregel mit dem Namen "meine Firewallregel" aus dem Konto "ContosoAdlAcct" mit dem IP-Bereich 127.0.0.1 - 127.0.0.10 addiert.
