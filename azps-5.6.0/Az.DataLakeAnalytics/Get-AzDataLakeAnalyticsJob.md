...
### Beispiel 2: In der letzten Woche übermittelte Aufträge erhalten
```
...
### -Include
Gibt Optionen an, die den Typ der zusätzlichen Informationen angeben, die über den Auftrag abgerufen werden müssen.
...
### -Name
Gibt einen Namen an, der zum Filtern der Auftragslistenergebnisse verwendet werden soll.
Die zulässigen Werte für diesen Parameter sind:
- Keine
- DebugInfo
- Statistik
...
### -PipelineId
Eine optionale ID, die angibt, dass nur Aufträge teil der angegebenen Pipeline sind, sollte zurückgegeben werden.
...
### -RecurrenceId
Eine optionale ID, die angibt, dass nur Aufträge teil der angegebenen Serie sind, sollte zurückgegeben werden.
...
Verwenden Sie diesen Parameter, um das Ergebnis der Auftragsliste nach Aufträgen zu filtern, die nach dem angegebenen Datum übermittelt wurden.
...
### -SubmittedBefore
Gibt einen Datumsfilter an.
Verwenden Sie diesen Parameter, um das Ergebnis der Auftragsliste nach Aufträgen zu filtern, die vor dem angegebenen Datum übermittelt wurden.
...
Verwenden Sie diesen Parameter, um die Auftragslistenergebnisse nach Aufträgen zu filtern, die von einem bestimmten Benutzer übermittelt wurden.
...
### -Top
Ein optionaler Wert, der angibt, wie viele Aufträge zurückzukehren sind. Standardwert ist 500
