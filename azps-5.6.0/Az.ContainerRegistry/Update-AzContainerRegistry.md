...
Mit diesem Befehl wird die angegebene Containerregistrierung so festgelegt, dass ein vorhandenes Speicherkonto \` mystorageaccount \` im gleichen Abonnement verwendet wird.
