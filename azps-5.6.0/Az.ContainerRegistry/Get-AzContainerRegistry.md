...
## BESCHREIBUNG
Das Get-AzContainerRegistry-Cmdlet ruft eine angegebene Containerregistrierung oder alle Containerregistrierungsstellen in einer Ressourcengruppe oder im Abonnement ab.
...
### Beispiel 2: Alle Containerregistrierungsstellen in einer Ressourcengruppe erhalten
```powershell
...
Dieser Befehl ruft alle Containerregistrierungsstellen in einer Ressourcengruppe ab.

### Beispiel 3: Alle Containerregistrierungsstellen im Abonnement erhalten
```powershell
...
Dieser Befehl ruft alle Containerregistrierungsstellen im Abonnement ab.
...
### -IncludeDetail
Weitere Details zur Containerregistrierung anzeigen
