...
### -MatchValue
Match-Werte, die mit übereinstimmen.
Der Operator gilt für jeden Wert in hier mit ODER-Semantik.
Wenn eine der Variablen mit dem angegebenen Operator übereinstimmen sollte, wird diese Übereinstimmungsbedingung als Übereinstimmung betrachtet.
...
Mögliche Werte sind Any, IPMatch, GeoMatch, Equal, Contains, LessThan, GreaterThan, LessThanOrEqual, GreaterThanOrEqual, BeginsWith, EndsWith.
...
### -Selector
Name der Auswahl in RequestHeader oder RequestBody, die übereinstimmen soll
