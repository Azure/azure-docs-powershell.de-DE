...
Erstellen Sie eine Regelmodulaktion, und zeigen Sie, wie Sie die Eigenschaften der erstellten Regelmodulaktion anzeigen.

## PARAMETER

### -Back-EndPoolName
Der Name des Back-EndPools, zu dem diese Regel weitergeleitet wird
...
Fragment ist der Teil der URL, der nach #kommt.
...
### -CustomPath
Der vollständige Umleitungspfad.
Pfad darf nicht leer sein und muss mit /beginnen.
...
### -CustomQueryString
Die Gruppe der Abfragezeichenfolgen, die in der Umleitungs-URL platziert werden sollen.
Durch Festlegen dieses Werts wird jede vorhandene Abfragezeichenfolge ersetzt. lassen Sie leer, um die eingehende Abfragezeichenfolge zu erhalten.
Die Abfragezeichenfolge muss im Format \<key\> = \<value\> vorliegen.
Das erste ?
und & werden automatisch hinzugefügt, sodass Sie sie nicht in den Vordermann nehmen, sondern mehrere Abfragezeichenfolgen durch &.
...
### -DynamicCompression
Aktivieren der dynamischen Komprimierung für zwischengespeicherte Inhalte
...
### -ForwardingProtocol
Das Protokoll, das diese Regel verwendet, wenn Datenverkehr an Back-End-Ends weitergeleitet wird.
Standardwert ist MatchRequest
...
### -RequestHeaderAction
Eine Liste der Headeraktionen, die von der Anforderung von AFD auf den Ursprung angewendet werden sollen.
...
Eine Liste der Headeraktionen, die aus der Antwort von AFD auf den Client angewendet werden sollen.
