...
### Beispiel 1: Alle Frontend-Endpunkte in "Frontdoor1" von "Frontdoor1" der Ressourcengruppe "rg1" erhalten.
```powershell
...
Holen Sie sich alle Frontend-Endpunkte in "Frontdoor1" von Front Door, das Teil der Ressourcengruppe "rg1" ist.

### Beispiel 2: Erhalten des Frontend-Endpunkts mit dem Namen "frontdoor1-azurefd-net" in Front Door "frontdoor1", der Teil der Ressourcengruppe "rg1" ist
```powershell
...
Erhalten Sie einen Frontend-Endpunkt mit dem Namen "frontdoor1-azurefd-net" in Front Door "frontdoor1", der Teil der Ressourcengruppe "rg1" ist.
