...
## BESCHREIBUNG
Das **Cmdlet Remove-AzDataFactory** entfernt eine Datenfactory.

## BEISPIELE

### Beispiel 1: Entfernen einer Daten factory
```
...
Mit diesem Befehl wird die Daten factory mit dem Namen WikiADF aus der Ressourcengruppe mit dem Namen ADF entfernt.
...
### -Erzwingen
Gibt an, dass mit diesem Cmdlet eine Daten factory entfernt wird, ohne Sie zur Bestätigung auffordern zu müssen.
...
### -Name
Gibt den Namen der zu entfernenden Daten factory an.
...
Dieses Cmdlet entfernt eine Daten factory aus der Gruppe, die von diesem Parameter angegeben wird.
