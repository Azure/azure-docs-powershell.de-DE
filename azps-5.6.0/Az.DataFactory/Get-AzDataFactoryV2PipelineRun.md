...
## BESCHREIBUNG
Der **Befehl Get-AzDataFactoryV2PipelineRun** gibt Informationen zu den Ausgeführt für die angegebene Pipeline zurück. Wenn PipelineRunId angegeben ist, werden Details für die Ausführung mit dieser ID gezeigt. Wenn die PipelineRunId nicht angegeben ist, werden Informationen zu allen Ausgeführten für die Pipelines angezeigt, die zwischen den Werten von LastUpdatedAfter und LastUpdatedBefore ausgeführt wurden.

## BEISPIELE

### Beispiel 1: Informationen für einen Pipelinelauf erhalten
```
...
Dieser Befehl ruft Details zur Ausführung der Pipeline mit der ID "61eb095a-fe23-4591-8a97-fade6c65ca72" ab.
...
### -LastUpdatedAfter
Die Zeit, zu der oder nach der die Pipeline ausgeführt wurde, wurde im ISO8601-Format aktualisiert.
...
### -LastUpdatedBefore
Die Zeit, zu der oder vor der die Pipeline ausgeführt wurde, wurde im ISO8601-Format aktualisiert.
