...
## BESCHREIBUNG
Das **Cmdlet Stop-AzDataFactoryV2IntegrationRuntime** beendet eine verwaltete dedizierte Integrations-Runtime im Zustand "Started", die vom cmdlet Start-AzDataFactoryV2IntegrationRuntime wurde. Die Ressourcen werden freigegeben, und der Zustand wird an "Beendet" überträgt.

## BEISPIELE

### Beispiel 1: Beenden einer verwalteten Integrationslaufzeit im Status "Gestartet".
```
...
Die verwaltete Integrations-Runtime "test-reserlved-ir" befindet sich im Status "Gestartet". Nachdem sie Stop-AzDataFactoryV2IntegrationRuntime cmdlet ausgeführt haben, werden die Ressourcen freigegeben und der Zustand an "Beendet" überträgt.
