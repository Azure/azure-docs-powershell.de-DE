...
## BESCHREIBUNG
Das **Get-AzDataFactoryV2ActivityRun-Cmdlet** ruft Informationen zu den Ausführungsläufen in Azure Data Factory für den angegebenen Pipelinelauf ab, der im angegebenen Zeitrahmen ausgeführt wurde. Darüber hinaus können Sie Filter für aktivitätsnamen, verknüpften Dienstnamen, der die Ausführung ausgeführt hat, und den Status der Ausführung angeben.

## BEISPIELE

### Beispiel 1: Alle Aktivitäten für eine Pipeline ausführen
```
...
Dieser Befehl ruft Details zu allen Aktivitäten ab, die im Pipelinelauf mit der ID "f288712d-fb08-4cb8-96ef-82d3b9b30621" ausgeführt werden, die zwischen "2017-09-01" und "2017-09-30" passiert ist.
...
### -RunStartedAfter
Die Zeit, zu der oder nach der die Pipeline ausgeführt wurde.
...
### -RunStartedBefore
Der Zeitpunkt, zu dem oder vor dem die Pipeline ausgeführt wurde.
