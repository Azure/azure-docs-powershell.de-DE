...
## SYNOPSIS
Fügen Sie die Datenflussressource und deren Abhängigkeiten zu einer bestimmten Datenflussdebuggersitzung hinzu.
...
## BESCHREIBUNG
Mit diesem Befehl werden die Datenflussressource und deren Abhängigkeiten an die spezifische Debugsitzung anfügen Die PowerShell-Befehlssequenz für den Workflow für den Datenflussdebugger sollte wie die folgenden sein:
...
Hinzufügen eines Datenflusspakets zur Debugsitzung "550effe4-93a3-485c-8525-eaf25259efbd" der Daten factory "WikiADF".
Die Pakcagedatei enthält die Debugressource für den Datenfluss, eine Liste der Datasetdebuggerressource, eine Liste der verknüpften Dienstdebuggerressource, Debugeinstellungen und Sitzungs-ID. Zum Beispiel:
...
### -PassThru
Wenn angegeben wird, wird "true" geschrieben, wenn der Vorgang erfolgreich ist. Dieser Parameter ist optional.
