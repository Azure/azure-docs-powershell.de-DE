...
Mit diesem Befehl wird das Gateway namens ContosoGateway aus der Daten factory mit dem Namen WikiADF entfernt.

## PARAMETER

### -DataFactory
Gibt ein **PSDataFactory-Objekt** an.
Dieses Cmdlet entfernt ein Gateway aus der Daten factory, das dieser Parameter angibt.
...
### -Erzwingen
Gibt an, dass dieses Cmdlet ein Gateway entfernt, ohne Sie zur Bestätigung auffordern zu müssen.
...
Dieses Cmdlet entfernt ein Gateway, das zu der Gruppe gehört, die von diesem Parameter angegeben wird.
