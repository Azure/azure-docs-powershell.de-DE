...
## BESCHREIBUNG
Das **Cmdlet Stop-AzDataFactoryV2Trigger** beendet einen Trigger in einer Datenfactory. Wenn sich der Trigger im Zustand "Gestartet" befindet, beendet das Cmdlet den Trigger und ruft keine Pipelines mehr auf. Wenn sich der Trigger bereits im Zustand "Beendet" befindet, hat dieses Cmdlet keine Auswirkung. Wenn der Parameter Erzwingen angegeben ist, wird das Cmdlet vor dem Beenden des Triggers nicht aufgefordert.
