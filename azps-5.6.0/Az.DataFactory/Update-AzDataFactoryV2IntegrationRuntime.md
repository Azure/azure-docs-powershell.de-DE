...
## BESCHREIBUNG
Das **Cmdlet Update-AzDataFactoryV2IntegrationRuntime** aktualisiert die Eigenschaften der Integrationslaufzeit. Derzeit unterstützt das Cmdlet nur das Aktualisieren von "AutoUpdate" und "AutoUpdateDelayOffset" für selbst gehostete Integrations-Runtime.

## BEISPIELE

### Beispiel 1: Aktualisiert eine Integrationslaufzeit
```
...
### -AutoUpdate
Aktivieren oder deaktivieren Sie die automatische Aktualisierung der selbst gehosteten Integrations-Runtime.
...
Die Uhrzeit in Stunden des Tages für die automatische Aktualisierung der selbst gehosteten Integrations-Runtime.
