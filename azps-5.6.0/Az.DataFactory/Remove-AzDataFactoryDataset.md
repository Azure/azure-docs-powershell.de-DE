...
Mit diesem Befehl wird das Dataset mit dem Namen DAWikiAggregatedData aus der Daten factory mit dem Namen WikiADF entfernt.
Der Befehl gibt einen Wert von $True.

## PARAMETER

### -DataFactory
Gibt ein **PSDataFactory-Objekt** an.
Dieses Cmdlet entfernt ein Dataset aus der Daten factory, die von diesem Parameter angegeben wird.
...
### -Erzwingen
Gibt an, dass mit diesem Cmdlet ein Dataset entfernt wird, ohne sie zur Bestätigung auffordern zu müssen.
...
Dieses Cmdlet entfernt ein Dataset aus der Gruppe, die von diesem Parameter angegeben wird.
