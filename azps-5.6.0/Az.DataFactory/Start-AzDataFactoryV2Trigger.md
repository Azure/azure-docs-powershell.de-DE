...
## BESCHREIBUNG
Das **Cmdlet Start-AzDataFactoryV2Trigger** startet einen Trigger in einer Datenfactory. Wenn sich der Trigger im Zustand "Beendet" befindet, startet das Cmdlet den Trigger und ruft schließlich Pipelines basierend auf seiner Definition auf. Wenn sich der Trigger bereits im Zustand "Gestartet" befindet, hat dieses Cmdlet keine Auswirkung. Wenn der Parameter Erzwingen angegeben ist, wird das Cmdlet vor dem Starten des Triggers nicht aufgefordert.
