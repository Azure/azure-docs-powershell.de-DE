...
## BESCHREIBUNG
Aktualisiert die Arbeitsbereichseinstellungen für das Abonnement.
Der konfigurierte Arbeitsbereich enthält die Sicherheitsdaten, die vom Azure Log Analytics-Agent gesammelt wurden, der in VMs innerhalb dieses Abonnements installiert ist.
...
Legt den Arbeitsbereich "securityuserws" so fest, dass alle Vom Azure Log Analytics-Agent gesammelten Sicherheitsdaten gespeichert werden.
