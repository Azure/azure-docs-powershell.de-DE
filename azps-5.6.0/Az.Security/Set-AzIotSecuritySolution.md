...
## SYNOPSIS
Erstellen oder Aktualisieren einer IoT-Sicherheitslösung
...
## BESCHREIBUNG
Das Set-AzIotSecuritySolution-Cmdlet erstellt oder aktualisiert eine bestimmte iot-Sicherheitslösung. Die IoT-Sicherheitslösung sammelt Sicherheitsdaten und -Ereignisse von iot-Geräten und iot-Hubs, um Bedrohungen zu verhindern und zu erkennen.
...
Erstellen Sie eine neue iot-Sicherheitslösung "MySample" für IoT Hub mit der Ressourcen-ID "/subscriptions/XXXXXXXX-XXXXX-XXXXX-XXXXXXXXXXXX/resourceGroups/MichalResourceGroup/providers/Microsoft.Devices/IotHubs/MySample" (der Name der Lösung sollte mit dem Namen des IoT-Hubs identisch sein)
...
Entmaskerte IP-Protokollierung.
