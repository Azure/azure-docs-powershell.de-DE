...
ms.locfileid: "101932288"
---
# <span data-ttu-id="309d0-101">Get-AzSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="309d0-101">Get-AzSecurityAlert</span></span>

## <span data-ttu-id="309d0-102">SYNOPSIS</span><span class="sxs-lookup"><span data-stu-id="309d0-102">SYNOPSIS</span></span>
<span data-ttu-id="309d0-103">Ruft Sicherheitswarnungen ab, die vom Azure Security Center erkannt wurden</span><span class="sxs-lookup"><span data-stu-id="309d0-103">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="309d0-104">SYNTAX</span><span class="sxs-lookup"><span data-stu-id="309d0-104">SYNTAX</span></span>

### <span data-ttu-id="309d0-105">SubscriptionScope (Standard)</span><span class="sxs-lookup"><span data-stu-id="309d0-105">SubscriptionScope (Default)</span></span>
```
Get-AzSecurityAlert [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="309d0-106">ResourceGroupScope</span><span class="sxs-lookup"><span data-stu-id="309d0-106">ResourceGroupScope</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="309d0-107">ResourceGroupLevelResource</span><span class="sxs-lookup"><span data-stu-id="309d0-107">ResourceGroupLevelResource</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> -Name <String> -Location <String>
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="309d0-108">SubscriptionLevelResource</span><span class="sxs-lookup"><span data-stu-id="309d0-108">SubscriptionLevelResource</span></span>
```
Get-AzSecurityAlert -Name <String> -Location <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### <span data-ttu-id="309d0-109">ResourceId</span><span class="sxs-lookup"><span data-stu-id="309d0-109">ResourceId</span></span>
```
Get-AzSecurityAlert -ResourceId <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

## <span data-ttu-id="309d0-110">BESCHREIBUNG</span><span class="sxs-lookup"><span data-stu-id="309d0-110">DESCRIPTION</span></span>
<span data-ttu-id="309d0-111">Ruft Sicherheitswarnungen ab, die vom Azure Security Center erkannt wurden</span><span class="sxs-lookup"><span data-stu-id="309d0-111">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="309d0-112">BEISPIELE</span><span class="sxs-lookup"><span data-stu-id="309d0-112">EXAMPLES</span></span>

### <span data-ttu-id="309d0-113">Beispiel 1</span><span class="sxs-lookup"><span data-stu-id="309d0-113">Example 1</span></span>
```powershell
...
<span data-ttu-id="309d0-114">Ruft alle Sicherheitswarnungen ab, die für Ressourcen in einem Abonnement erkannt wurden</span><span class="sxs-lookup"><span data-stu-id="309d0-114">Gets all the security alerts that were detected on resources inside a subscription</span></span>

### <span data-ttu-id="309d0-115">Beispiel 2</span><span class="sxs-lookup"><span data-stu-id="309d0-115">Example 2</span></span>
```powershell
...
<span data-ttu-id="309d0-116">Ruft alle Sicherheitswarnungen ab, die für Ressourcen innerhalb der Ressourcengruppe "myService1" erkannt wurden.</span><span class="sxs-lookup"><span data-stu-id="309d0-116">Gets all the security alerts that were detected on resources inside the "myService1" resource group</span></span>

### <span data-ttu-id="309d0-117">Beispiel 3</span><span class="sxs-lookup"><span data-stu-id="309d0-117">Example 3</span></span>
```powershell
...
<span data-ttu-id="309d0-118">Ruft eine bestimmte Sicherheitswarnung ab, die für Ressourcen innerhalb der Ressourcengruppe "myService1" erkannt wurde</span><span class="sxs-lookup"><span data-stu-id="309d0-118">Gets a specific security alert that were detected on resources inside the "myService1" resource group</span></span>

## <span data-ttu-id="309d0-119">PARAMETER</span><span class="sxs-lookup"><span data-stu-id="309d0-119">PARAMETERS</span></span>

### <span data-ttu-id="309d0-120">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="309d0-120">-DefaultProfile</span></span>
<span data-ttu-id="309d0-121">Die Anmeldeinformationen, das Konto, den Mandanten und das Abonnement, die für die Kommunikation mit Azure verwendet werden.</span><span class="sxs-lookup"><span data-stu-id="309d0-121">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="309d0-122">-Location</span><span class="sxs-lookup"><span data-stu-id="309d0-122">-Location</span></span>
<span data-ttu-id="309d0-123">Ort.</span><span class="sxs-lookup"><span data-stu-id="309d0-123">Location.</span></span>
...
### <span data-ttu-id="309d0-124">-Name</span><span class="sxs-lookup"><span data-stu-id="309d0-124">-Name</span></span>
<span data-ttu-id="309d0-125">Ressourcenname.</span><span class="sxs-lookup"><span data-stu-id="309d0-125">Resource name.</span></span>
...
### <span data-ttu-id="309d0-126">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="309d0-126">-ResourceGroupName</span></span>
<span data-ttu-id="309d0-127">Name der Ressourcengruppe.</span><span class="sxs-lookup"><span data-stu-id="309d0-127">Resource group name.</span></span>
...
### <span data-ttu-id="309d0-128">-ResourceId</span><span class="sxs-lookup"><span data-stu-id="309d0-128">-ResourceId</span></span>
<span data-ttu-id="309d0-129">Ressourcen-ID.</span><span class="sxs-lookup"><span data-stu-id="309d0-129">Resource ID.</span></span>
...
### <span data-ttu-id="309d0-130">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="309d0-130">CommonParameters</span></span>
<span data-ttu-id="309d0-131">Dieses Cmdlet unterstützt die gängigen Parameter: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction und -WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="309d0-131">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="309d0-132">Weitere Informationen finden Sie unter [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span><span class="sxs-lookup"><span data-stu-id="309d0-132">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="309d0-133">EINGABEN</span><span class="sxs-lookup"><span data-stu-id="309d0-133">INPUTS</span></span>

### <span data-ttu-id="309d0-134">System.String</span><span class="sxs-lookup"><span data-stu-id="309d0-134">System.String</span></span>

## <span data-ttu-id="309d0-135">AUSGABEN</span><span class="sxs-lookup"><span data-stu-id="309d0-135">OUTPUTS</span></span>

### <span data-ttu-id="309d0-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="309d0-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span></span>

## <span data-ttu-id="309d0-137">NOTIZEN</span><span class="sxs-lookup"><span data-stu-id="309d0-137">NOTES</span></span>

## <span data-ttu-id="309d0-138">VERWANDTE LINKS</span><span class="sxs-lookup"><span data-stu-id="309d0-138">RELATED LINKS</span></span>
