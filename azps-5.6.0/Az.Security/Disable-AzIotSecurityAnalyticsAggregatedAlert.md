...
## BESCHREIBUNG
Das Disable-AzIotSecurityAnalyticsAggregatedAlert-Cmdlet schließt eine bestimmte aggragated-Benachrichtigung auf Geräten des iot-Hubs. Der Name der aggregierten Benachrichtigungen ist eine Kombination aus dem Warnungstyp und dem Benachrichtigungsaggragted-Datum, getrennt durch "/".
...
Schließen der aggregierten Benachrichtigung "IoT_SucessfulLocalLogin/2020-03-15" (name combined from alert type and its aggregated date) from the IoT security solution "MySolutionName" in resource group "MyResourceGroup"
