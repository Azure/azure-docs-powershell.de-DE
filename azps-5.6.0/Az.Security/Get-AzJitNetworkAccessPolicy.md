...
## BESCHREIBUNG
Mit just In Time (JIT)-Netzwerkzugriffsrichtlinien können Sie eine Richtlinie definieren, die es einfachen Benutzern ermöglicht, eine temporäre Netzwerkverbindung mit einer VM zu erstellen.
Die Richtlinie definiert, welche Ports, Protokoll- und Quell-IP-Adressen eine Verbindung mit einer VM anfordern können, und die maximale Dauer, bevor die Verbindung automatisch geschlossen wird.
In der Richtlinie sehen Sie auch die Verbindungsanforderung, die mit dieser Richtlinie gestellt wurde. 
...
Alle Zugriffspolizistinnen und -polizistinnen für das JIT-Netzwerk in einem Abonnement
...
Alle Zugriffspolisen für das JIT-Netzwerk in der Ressourcengruppe "myService1"
