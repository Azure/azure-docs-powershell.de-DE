...
## SYNOPSIS
Erstellen einer neuen benutzerdefinierten Warnungsregel für die Benachrichtigungsliste für Gerätesicherheit (IoT Security)
...
## BESCHREIBUNG
Das New-AzDeviceSecurityGroupDenylistCustomAlertRuleObject-Cmdlet erstellt eine neue Liste der verweigerten benutzerdefinierten Benachrichtigungsregeln für Gerätesicherheitsgruppe in der IoT-Sicherheitslösung.
...
Erstellen einer neuen benutzerdefinierten Warnungsregel für die Benachrichtigungsliste mit dem Typ "SomeRuleType" und status set to desable
