...
## SYNOPSIS
Löscht das angegebene Azure Dedicated HSM.
...
### Beispiel 1: Entfernen eines dedizierten HSM nach Name
```powershell
PS C:\> Remove-AzDedicatedHsm -Name hsm-7t2xaf -ResourceGroupName lucas-manual-test

```

Mit diesem Commnad wird ein Hardwaresicherheitsmodul (HSM) nach Name entfernt.

### Beispiel 2: Entfernen eines dedizierten HSM nach -Objekt
```powershell
...
Mit diesem Komma wird ein dediziertes HSM nach -Objekt entfernt.
...
### -Name
Der Name des zu löschende dedizierten HSM
...
INPUTOBJECT <IDedicatedHsmIdentity> : Identitätsparameter
