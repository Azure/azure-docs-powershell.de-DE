...
### Beispiel 2: Alle dedizierten HSM unter einer Ressourcengruppe.
```powershell
...
Dieser Befehl ruft einen dedizierten HSM nach Namen ab.
...
Dieser Befehl ruft ein Dediziertes HSM nach -Objekt ab.
...
### -Top
Maximale Anzahl von Ergebnissen, die zurücksennen.
