...
### -IdentitySource
vCenter Single Sign On Identity Sources (Einmaliges Anmelden bei Identitätsquellen) Informationen zum Erstellen finden Sie im Abschnitt NOTIZEN für IDENTITYSOURCE-Eigenschaften und Erstellen einer Hashtabelle.
...
IDENTITYSOURCE <IIdentitySource[]>: vCenter Single Sign On Identity Sources
  ...
  - `[BaseGroupDn <String>]`: Der unterscheide Basisname für Gruppen
  - `[BaseUserDn <String>]`: Der unterscheide Name der Basis für Benutzer
  - `[Domain <String>]`: Der Dnsname der Domäne
  - `[Name <String>]`: Der Name der Identitätsquelle
  - `[Password <String>]`: Das Kennwort des Active Directory-Benutzers mit einem Minimum an schreibgeschützten Zugriff auf Basis-DN für Benutzer und Gruppen.
  - `[PrimaryServer <String>]`: Primäre Server-URL
  - `[SecondaryServer <String>]`: URL des sekundären Servers
  - `[Ssl <SslEnum?>]`: Schützen der LDAP-Kommunikation mithilfe von SSL-Zertifikaten (LDAPS)
  - `[Username <String>]`: Die ID eines Active Directory-Benutzers mit einem Minimum an schreibgeschützten Zugriff auf Basis-DN für Benutzer und Gruppen
