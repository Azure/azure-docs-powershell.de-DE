...
### -AcceptEULA
AKZEPTIEREN SIE DIE EULA von AVS, der juristische Ausdruck wird ohne diesen Parameter bereitgestellt
...
### -NetworkBlock
Der Adressblock sollte für VNet in Ihrem Abonnement und lokal eindeutig sein.
Stellen Sie sicher, dass das CIDR-Format mit (A.B.C.D/X) konform ist, wobei A,B,C,D zwischen 0 und 255 und X zwischen 0 und 22 liegt.
...
### -NsxtPassword
Legen Sie optional das Kennwort für NSX-T Manager beim Erstellen der privaten Cloud
