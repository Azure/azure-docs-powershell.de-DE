...
## SYNOPSIS
Dadurch wird die YAML-Datei gelöscht, die zum Einrichten der Quellsteuerelementkonfiguration verwendet wird, um die zukünftige Synchronisierung aus dem Quell-Repository zu beenden.
...
### Beispiel 1: Entfernen einer Konfiguration des Kubernetes-Clusters nach Name
```powershell
...
Mit diesem Befehl wird eine Konfiguration des Kubernetes-Clusters nach Name entfernt.

### Beispiel 2: Entfernen einer Konfiguration von Kubernetes-Cluster nach Objekt
```powershell
...
Mit diesem Befehl wird eine Konfiguration des Kubernetes-Clusters nach Objekt entfernt.
