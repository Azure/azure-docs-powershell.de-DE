...
## SYNOPSIS
Erstellen Sie eine neue Kubernetes-Quellsteuerelementkonfiguration.
...
### Beispiel 1: Erstellen einer Konfiguration für den Kubernetes-Cluster
```powershell
...
### Beispiel 1: Erstellen einer Konfiguration für den Kubernetes-Cluster mit angeben von Paramter OperatorNamespace
```powershell
...
Mit diesem Befehl wird eine Konfiguration im neuen Operatornamespace für den Kubernetes-Cluster erstellt.
Hinweis: Eine Konfiguration in einem vorhandenen Operatornamespace kann nicht erstellt werden.
...
### -ClusterScoped
Wenn übergeben festgelegt wird, legen Sie den Bereich der Konfiguration auf Cluster (Standard ist nameSpace) ein.
...
Werte überschreiben für das Diagramm "Helm" des Operators.
...
Version des Operator -Diagramms "Helm".
...
### -OperatorNamespace
Der Namespace, auf dem dieser Operator installiert ist.
Maximal 253 alphanumerische Zeichen, Bindestriche und Perioden
