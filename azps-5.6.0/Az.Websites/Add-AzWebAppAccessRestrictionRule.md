...
Mit diesem Befehl wird einer Web App mit dem Namen ContosoSite, die zur Ressourcengruppe Default-Web-WestUS gehört, eine Zugriffseinschränkungsregel mit Priorität 200 und ip-Bereich hinzu.

### Beispiel 2: Hinzufügen einer Einschränkungsregel für den Endpunktzugriff für Subnetzdienste zu einer Web App
```
PS C:\>Add-AzWebAppAccessRestrictionRule -ResourceGroupName "Default-Web-WestUS" -WebAppName "ContosoSite" 
-Name SubnetRule -Priority 300 -Action Allow -SubnetName appgw-subnet -VirtualNetworkName corp-vnet
```

Dieser Befehl fügt einer Web App mit dem Namen ContosoSite, die zur Ressourcengruppe Default-Web-WestUS gehört, eine Zugriffseinschränkungsregel mit Der Priorität 300 und dem Subnetz-Appgw-Subnetz in corp-vnet hinzu.
...
Dieser Befehl fügt einer Web App mit dem Namen ContosoSite, die zur Ressourcengruppe Default-Web-WestUS gehört, eine Zugriffseinschränkungsregel mit Priorität 200 und ein Diensttag hinzu, das den IP-Bereich von Azure Front Door darstellt.
...
Dieser Befehl fügt einer Web App mit dem Namen ContosoSite, die zur Ressourcengruppe Default-Web-WestUS gehört, eine Zugriffseinschränkungsregel mit Priorität 200 und zwei IP-Bereichen hinzu.
...
Dieser Befehl fügt eine Zugriffseinschränkungsregel mit der Priorität 400 für Diensttag AzureFrontDoor.Back-End hinzu und schränkt den Zugriff nur auf http-Header bestimmter Werte zu einer Web App namens ContosoSite ein, die zur Ressourcengruppe Default-Web-WestUS gehört.
...
Geben Sie an, ob die Dienstendpunktregistrierung im Subnetz überprüft werden soll.
...
### -Priorität
Zugriffseinschränkungspriorität. Beispiel: 500.
...
### -TargetScmSite
Regel richtet sich an die Hauptwebsite oder Scm-Website.
