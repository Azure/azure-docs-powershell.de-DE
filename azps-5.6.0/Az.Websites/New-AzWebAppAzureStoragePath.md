...
## SYNOPSIS
Erstellt ein -Objekt, das einen Azure Storage-Pfad darstellt, der in einer Web App bereitgestellt werden soll. Er soll als Parameter (-AzureStoragePath) verwendet werden, Set-AzWebApp und Set-AzWebAppSlot
...
## BESCHREIBUNG
Erstellt ein -Objekt, das einen Azure Storage-Pfad repräsentiert, der in einer Web App bereitgestellt werden soll.
...
### -ShareName
Name der Freigabe, die an den Container ge mountt werden soll
...
Windows-Container unterstützen nur Azure-Dateien
