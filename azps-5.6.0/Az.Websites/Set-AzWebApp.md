...
## BESCHREIBUNG
Das **Set-AzWebApp-Cmdlet** legt eine Azure Web App fest.
...
Mit diesem Befehl wird der Appserviceplan geändert, der der Web App ContosoWebApp zugeordnet ist, die der Ressourcengruppe Default-Web-WestUS zugeordnet ist. Verwenden Sie den Link, um weitere Informationen zum Ändern des Appserviceplans und der damit verbundenen Einschränkungen zu erhalten.
...
Mit diesem Befehl wird HttpLoggingEnabled auf true für Web App ContosoWebApp festgelegt, die der Ressourcengruppe Default-Web-WestUS zugeordnet ist.
...
Im folgenden Beispiel wird eine Verbindungszeichenfolge mit dem Namen myConnectionString für Web App ContosoWebApp erstellt. Dadurch werden alle vorhandenen Verbindungszeichenfolgen für Web App ContosoWebApp ersetzt.
...
### -HttpsOnly
Aktivieren/Deaktivieren der Umleitung des datenverkehrs auf HTTPS in einer vorhandenen Azure WebApp oder FunctionApp
...
## NOTIZEN
Unten bereitgestelltes Cmdlet hilft Ihnen beim Aktualisieren von Azure Web App auf **DOTNETCORE**
...
Ersetzen Sie die Werte von Default-Web-WestUS durch den Ressourcengruppennamen der Webapp und ContosoWebApp durch den Webapp-Namen.
