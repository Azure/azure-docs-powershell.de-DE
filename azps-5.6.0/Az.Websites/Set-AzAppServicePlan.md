...
Mit diesem Befehl wird die Option PerSiteScaling im App Service-Plan namens ContosoASP auf true festgelegt, der zur Ressourcengruppe "Default-Web-WestUS" gehört.

### Beispiel 2

Legt einen Azure App Service-Plan fest. (automatisch generiert)
...
### -PerSiteScaling
Boolescher Wert pro Websiteskalierung
