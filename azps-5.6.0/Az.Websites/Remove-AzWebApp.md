...
## BESCHREIBUNG
Das **Cmdlet Remove-AzWebApp** entfernt eine Azure Web App, die die Ressourcengruppe und den Web App-Namen bereitgestellt hat.
...
Mit diesem Befehl wird die Azure Web App mit dem Namen ContosoSite entfernt, die zur Ressourcengruppe "Default-Web-WestUS" gehört.
