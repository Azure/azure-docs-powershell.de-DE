...
### Beispiel 1: Auflisten aller PrincipalAssignment in einer Datenbank nach Namen
```powershell
...
Der obige Befehl gibt alle PrincipalAssignment in der Datenbank "mykustodatabase" zurück, die im Cluster "testnewkustocluster" gefunden wurde.
...
Der obige Befehl gibt alle PrincipalAssignment mit dem Namen "kustoprincipal1" in der Datenbank "mykustodatabase" zurück, die im Cluster "testnewkustocluster" gefunden wurde.
