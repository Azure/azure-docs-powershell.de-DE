...
### Beispiel 1: Erstellen einer neuen EventHub-Datenverbindung
```powershell
...
Der obige Befehl erstellt eine neue EventHub-Datenverbindung mit dem Namen "myeventhubdc" für die Datenbank "mykustodatabase" im Cluster "testnewkustocluster".

### Beispiel 2: Erstellen einer neuen EventGrid-Datenverbindung
```powershell
...
Der obige Befehl erstellt eine neue EventGrid-Datenverbindung mit dem Namen "myeventgriddc" für die Datenbank "mykustodatabase" im Cluster "testnewkustocluster".

### Beispiel 3: Erstellen einer neuen IotHub-Datenverbindung
```powershell
...
Mit dem obigen Befehl wird eine neue IotHub-Datenverbindung namens "myiothubdc" für die Datenbank "mykustodatabase" im Cluster "testnewkustocluster" erstellt.
...
Der Name des zu verarbeitende Blobspeicherereignistyps.
...
### -ConsumerGroup
Die Ereignis-/iot-Hub-Consumergruppe.
...
### -EventHubResourceId
Die Ressourcen-ID des Ereignishubs, der zum Erstellen einer Datenverbindung/eines Ereignisrasters verwendet werden soll, ist für das Senden von Ereignissen konfiguriert.
...
### -EventSystemProperty
Systemeigenschaften des Ereignisses/iot-Hubs.
...
### -IgnoreFirstRecord
Wenn auf "true" festgelegt ist, gibt an, dass bei der Aufnahme der erste Datensatz jeder Datei ignoriert werden soll.
...
### -MappingRuleName
Die Zuordnungsregel, mit der die Daten aufgenommen werden sollen.
