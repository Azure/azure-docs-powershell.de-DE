...
### Beispiel 1: Listen aller Kusto-Clusterprinzipalzuweisungen
```powershell
...
### Beispiel 2: Ruft eine Kusto-Clusterprinzipalzuweisung nach Name ab.
```powershell
...
Der obige Befehl gibt das Kusto-ClusterprinzipalAssignment mit dem Namen "kustoprincipal1" im Cluster "testnewkustocluster" zurück.
