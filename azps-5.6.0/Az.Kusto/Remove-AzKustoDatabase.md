...
### Beispiel 1: Löschen einer vorhandenen Kusto-Datenbank nach Name
```powershell
PS C:\> Remove-AzKustoDatabase -ResourceGroupName testrg -ClusterName testnewkustocluster -Name mykustodatabase
```

Mit dem obigen Befehl wird die Kusto-Datenbank mit dem Namen "mykustodatabase" im Cluster "testnewkustocluster" gelöscht, der in der Ressourcengruppe "testrg" gefunden wurde.
