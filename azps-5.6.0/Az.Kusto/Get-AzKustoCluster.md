...
### Beispiel 2: Einen bestimmten Kusto-Cluster nach Name erhalten
```powershell
...
Der obige Befehl gibt den Kusto-Cluster mit dem Namen "testnewkustocluster" in der Ressourcengruppe "testrg" zurück.
