...
### Beispiel 1: Löschen einer vorhandenen Kusto-Datenbank PrincipalAssignment nach Name
```powershell
...
Mit dem obigen Befehl wird das PrincipalAssignment mit dem Namen "kustoprincipal1" in der Kusto-Datenbank "mykustodatabase" gelöscht.
