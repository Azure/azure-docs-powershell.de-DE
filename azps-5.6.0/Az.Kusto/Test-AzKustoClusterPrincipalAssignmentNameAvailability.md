...
### Beispiel 1: Überprüfen der Verfügbarkeit eines verwendeten Clusterprinzipalnamens
```powershell
...
Der obige Befehl gibt zurück, ob im Cluster "testnewkustocluster" ein PrincipalAssignment mit dem Namen "newprincipal" vorhanden ist.
