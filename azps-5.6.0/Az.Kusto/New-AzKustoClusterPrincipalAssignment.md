...
### Beispiel 1: Erstellen einer Kusto-Clusterprinzipalzuweisung
```powershell
...
Mit dem obigen Befehl wird ein Kusto-ClusterprinzipalAssignment erstellt.
...
Dabei kann es sich um eine Benutzer-E-Mail, anwendungs-ID oder einen Sicherheitsgruppennamen geben.
