...
### Beispiel 1: Liste berechtigter SKUs
```powershell
...
Der oben aufgeführte Befehl listet berechtigte SKUs auf.

### Beispiel 2: Liste der berechtigten SKUs für einen bestimmten Cluster
```powershell
...
Der oben aufgeführte Befehl listet berechtigte SKUs für bestimmte Cluster auf.
