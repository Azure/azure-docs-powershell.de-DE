...
Mit diesen Befehlen wird die Datenfreigabe mit dem Namen AdsShare aus dem Azure-Datenfreigabekonto WikiAds entfernt. 
...
Erforderlich: True Position: Named Default value: None Accept pipeline input: True (ByValue) Accept platzhalter characters: False
...
Erforderlich: True Position: Named Default value: None Accept pipeline input: False Accept platzhalter characters: False
...
yaml-Typ: Parametersätze für SwitchParameter: (Alle) Aliase: 

Erforderlich: False Position: Named Default value: None Accept pipeline input: False Accept platzhalter characters: False
...
Erforderlich: True Position: Named Default value: None Accept pipeline input: True (ByPropertyName) Accept platzhalter characters: False
...
yaml Type: SwitchParameter Parameter Sets: (All) Aliase: cf
...
yaml Type: SwitchParameter Parameter Sets: (All) Aliase: wi
