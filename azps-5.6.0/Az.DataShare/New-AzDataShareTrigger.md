...
## BESCHREIBUNG
Das **New-AzDataShareTrigger-Cmdlet** erstellt einen Trigger für das Freigabeabonnement für das angegebene Serienintervall und die Synchronisierungszeit unter azure data share account.
...
Mit diesem Befehl wird ein neuer Trigger AdsTrigger für das Share-Abonnement AdsShareSubscription mit einem täglichen Intervall von 9:00 Uhr erstellt.
...
### -Name
Name des Azure-Datenfreigabetriggers
...
### -RecurrenceInterval
Das Serienintervall für den Trigger (Tag oder Stunde)
