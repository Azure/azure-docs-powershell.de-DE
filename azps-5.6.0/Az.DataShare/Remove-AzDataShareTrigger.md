...
Mit diesen Befehlen wird ein Trigger namens AdsTrigger aus dem Share-Abonnement AdsShareSubscription entfernt. 
...
### -InputObject
Azure-Datenfreigabetriggerobjekt
...
### -ResourceId
Die Ressourcen-ID des Azure-Datenfreigabetriggers
