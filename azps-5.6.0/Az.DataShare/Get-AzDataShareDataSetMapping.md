...
## BESCHREIBUNG
Das **Get-AzDataShareDataSetMapping-Cmdlet** ruft Informationen zu einer bestimmten Datasetzuordnung ab, wenn der Name angegeben ist. Andernfalls werden Informationen zu allen Datasetzuordnungen in einem Freigabeabonnement angezeigt. 
...
```
 ...
 Mit diesem Befehl werden Informationen zu allen Datasetzuordnungen im Freigabeabonnement angezeigt.
...
### -ResourceId
Die Ressourcen-ID der Azure-Datensatzzuordnung.
