...
## BESCHREIBUNG
Das **Get-AzDataShareDataSet-Cmdlet** ruft Informationen zu Datensätzen ab, die in einer Freigabe in einem Azure-Datenfreigabekonto hinzugefügt wurden. Wenn Sie den Namen des Datensets angeben, ruft dieses Cmdlet Informationen zum Datenset ab. Wenn Sie keinen Namen angeben, ruft dieses Cmdlet Informationen zu allen Datensätzen in einer Freigabe ab. I
...
Mit diesem Befehl werden Informationen zum Datenset AdsDataSet in Share AdsShare im Azure-Datenfreigabekonto WikiAdsAccount und der Ressourcengruppe ADS angezeigt.
...
### -ResourceGroupName
Der Ressourcengruppenname des Azure-Datenfreigabekontos.
...
### -ResourceId
Die Ressourcen-ID des Azure-Datensets.
