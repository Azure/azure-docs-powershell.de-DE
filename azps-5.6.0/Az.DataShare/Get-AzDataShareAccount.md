...
## BESCHREIBUNG
Das **Get-AzDataShareAccount-Cmdlet** ruft Informationen zu Datenfreigabekonten in einer Azure-Abonnement-/Ressourcengruppe ab.
Wenn Sie den Namen eines Kontos angeben, erhält dieses Cmdlet Informationen zu diesem datshare-Konto.
...
### -ResourceId
Die Ressourcen-ID des Azure-Datenfreigabekontos.
