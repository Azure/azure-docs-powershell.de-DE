...
## BESCHREIBUNG
Das **New-AzDataBoxEdgeShare-Cmdlet** erstellt eine neue Freigabe auf dem Data Box Edge-Gerät.
...
### -ContainerName
Containername (Basierend auf dem angegebenen Datenformat stellt dies den Namen von Azure Files/Pageblob/Block blob dar)
...
### -DataFormat
Festlegen des Datenformats ex: PageBlob, BlobBlob
...
### -NFS
AccessProtocol beim Erstellen von Freigaben
...
### -UserAccessRight
Zugriff direkt zusammen mit vorhandenen Benutzernamen für den Zugriff auf #A0 bereitstellen, z. B. @(@{"Benutzername"="Benutzername-1";" AccessRight"="Read"}, @{"Benutzername"="Benutzername-2";" AccessRight"="Read"}, @{"Benutzername"="Benutzername-3";" AccessRight"="Custom"})
