...
## SYNOPSIS
Entfernt ein Data Box Edge-Gerät.
...
Beachten Sie, dass das Gerät erst gelöscht werden kann, nachdem Sie die Bestellung bestellt haben und bevor das Gerät von Microsoft für den Versand vorbereitet wurde.

Lesen Sie die Dokumentation zum Löschen der Ressource, bevor Sie dieses [Cmdlet verwenden.](https://docs.microsoft.com/azure/databox-online/data-box-edge-return-device#delete-the-resource)
