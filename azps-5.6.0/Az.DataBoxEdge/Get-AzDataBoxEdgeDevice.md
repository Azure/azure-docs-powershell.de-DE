...
## SYNOPSIS
Ruft die Informationen auf verfügbaren Data Box Edge-Geräten ab.
...
## BESCHREIBUNG
Das **Get-AzDataBoxEdgeDevice-Cmdlet** ruft die Informationen zu den verfügbaren Data Box Edge-Geräten ab. Sie können den Namen des Geräts zusammen mit dem Ressourcengruppennamen angeben, um die Informationen auf einem bestimmten Gerät zu erhalten. 
...
### -Warnung
Abrufen der Benachrichtigungen auf dem Edge-/Gatewaygerät des Datenfelds
