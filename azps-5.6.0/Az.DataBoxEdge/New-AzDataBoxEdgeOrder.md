...
## BESCHREIBUNG
Das **Cmdlet New-AzDataBoxEdgeOrder** erstellt eine neue Reihenfolge für ein Data Box Edge-Gerät. Eine Data Box Edge-Geräteressource muss zuerst erstellt werden, bevor sie einen Auftrag erstellt. Sie können Details wie Kontaktperson, Firmenname, E-Mail, Adresse usw. als Parameter für die Erstellung der Bestellung angeben.
