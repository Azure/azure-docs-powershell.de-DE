...
## BESCHREIBUNG
Das **Cmdlet New-AzDataBoxEdgeUser** erstellt einen neuen Benutzer für das Data Box Edge-Gerät. Die Erstellung von nur Benutzern vom Typ `Share` wird unterstützt.
...
### -Password
Kennwort als sichere Zeichenfolge angeben
