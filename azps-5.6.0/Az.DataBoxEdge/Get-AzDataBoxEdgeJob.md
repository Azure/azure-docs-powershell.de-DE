...
## BESCHREIBUNG
Das **Get-AzDataBoxEdgeJob-Cmdlet** ruft die aktiven Aufträge auf einem Data Box Edge-Gerät ab. Sie können den Parameter Name erwähnen, um Details zu einem bestimmten Auftrag zu erhalten.
...
### -Name
Name des Auftrags, allgemein eine GUID
