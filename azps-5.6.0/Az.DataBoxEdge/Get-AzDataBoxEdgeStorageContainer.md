...
## BESCHREIBUNG
Das **Get-AzDataBoxEdgeStorageContainer-Cmdlet** ruft den Speichercontainer für ein Edgespeicherkonto auf einem Data Box Edge-Gerät ab. Sie können den Namen als Parameter im Cmdlet angeben, um die Details eines bestimmten Speichercontainers zu erhalten. 
...
### -Name
Name des EdgeStorageContainers
