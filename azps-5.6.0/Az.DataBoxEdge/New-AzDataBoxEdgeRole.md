...
## BESCHREIBUNG
Das **Cmdlet New-AzDataBoxEdgeRole** erstellt eine neue Rolle für ein Data Box Edge-Gerät.
...
### -ConnectionString
So stellen Sie Verbindungszeichenfolgen zur Verfügung
...
### -DeviceProperty
So stellen Sie Geräteeigenschaften zur Verfügung
...
Bitte stellen Sie die Verbindungszeichenfolge des IOT-Geräts zur Verfügung.
...
Zugriffstaste des Iot Edge-Geräts
...
Geben Sie die Verbindungszeichenfolge des Edgegeräts an.
...
### -Platform
Stellen Sie die Plattform zur Verfügung, beispielsweise Linux.
