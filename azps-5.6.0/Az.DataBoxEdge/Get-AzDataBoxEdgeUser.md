...
## BESCHREIBUNG
Im **Cmdlet Get-AzDataBoxEdgeUser** werden die Benutzer aufgeführt, die für ein Data Box Edge-Gerät konfiguriert sind. Sie können den Namen in Parametern erwähnen, um Details zu einem bestimmten Benutzer zu erhalten.
