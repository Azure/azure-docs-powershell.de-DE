...
## SYNOPSIS
Ruft die Informationen zu den Bandbreitenplänen ab.
...
## BESCHREIBUNG
Das **Cmdlet Get-AzDataBoxEdgeBandwidthSchedule** ruft die Informationen zu den Bandbreitenplänen ab. Sie können den Namen eines Zeitplans zusammen mit dem Namen der Ressourcengruppe und dem Gerätenamen angeben, um Informationen zu einem bestimmten Bandbreitenzeitplan zu erhalten.
