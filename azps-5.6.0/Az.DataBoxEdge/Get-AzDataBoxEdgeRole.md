...
## BESCHREIBUNG
Das **Get-AzDataBoxEdgeRole-Cmdlet** ruft die verfügbaren IoT-Rollen für ein Data Box Edge-Gerät ab. Sie können den Parameter Name erwähnen, um die Details einer bestimmten IoT-Rolle zu erhalten.
