...
## BESCHREIBUNG
Das **Cmdlet New-AzRedisCacheKey** regeneriert den Zugriffsschlüssel eines Azure Redis Caches.

## BEISPIELE

### Beispiel 1: Neuerieren eines Primärschlüssels
```
...
Mit diesem Befehl wird der Primärschlüssel eines Redis-Caches neu generiert.

### Beispiel 2: Regenerieren eines Sekundärschlüssels
```
...
Mit diesem Befehl wird der Sekundärschlüssel eines Redis-Caches neu generiert.
...
### -KeyType
Gibt an, ob der primäre oder sekundäre Zugriffsschlüssel neu generiert werden soll.
...
### -Name
Gibt den Namen des Redis Cache an.
