...
## BESCHREIBUNG
Das **Export-AzRedisCache-Cmdlet** exportiert Daten aus Azure Redis Cache in einen Container.
...
Mit diesem Befehl werden Daten aus einer Azure Redis Cache-Instanz in den Container exportiert, der durch die SAS-URL angegeben wird.
...
### -Format
Gibt ein Format für den Blob an.
