...
### RESTAPI zulassen,ClientVerbinden für öffentliches Netzwerk zulassen und Standardaktion auf Verweigern festlegen
```powershell
...
### Zulassen der Client- und Serververbindung für eine private Endpunktverbindung
```powershell
...
### -DefaultAction
Standardaktion von SignalR-Netzwerk-ACLs, entweder zulassen oder verweigern. Sie entscheidet, ob Netzwerk-ACLs verweigert oder Netzwerk-ACLs zulässig sind. Wenn beispielsweise die Standardaktion zulässig ist, ist nur die Verweigern-ACLs wichtig.
...
### -PrivateEndpointName
Name(n) privater Endpunkte, die aktualisiert werden sollen
