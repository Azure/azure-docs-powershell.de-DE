...
## BESCHREIBUNG
Das Get-AzSubscription-Cmdlet ruft die Abonnement-ID, den Abonnementnamen und den Home-Mandanten für Abonnements ab, auf die das aktuelle Konto zugreifen kann.
...
Listen Sie alle Abonnements im angegebenen Mandanten auf, die für das aktuelle Konto autorisiert sind.
...
Dieser Befehl ruft das angegebene Abonnement ab und legt dann den aktuellen Kontext für die Verwendung fest. Alle nachfolgenden Cmdlets in dieser Sitzung verwenden standardmäßig das neue Abonnement (Contoso-Abonnement 1).
...
### -SubscriptionName
Gibt den Namen des zu erhaltenden Abonnements an.
...
### -TenantId
Gibt die ID des Mandanten an, der Abonnements enthält, die Sie erhalten müssen.
