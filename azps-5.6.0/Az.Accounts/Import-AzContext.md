...
## BESCHREIBUNG
Das Import-AzContext-Cmdlet lädt Authentifizierungsinformationen aus einer Datei, um die Azure-Umgebung und den Kontext zu festlegen.
...
In diesem Beispiel wird ein Kontext aus einem PSAzureProfile importiert, das an das Cmdlet übergeben wird.
...
### -Path
Gibt den Pfad zu Kontextinformationen an, der mit Save-AzContext gespeichert wurde.
