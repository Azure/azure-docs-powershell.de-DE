...
Deaktivieren Sie die automatische Speicherung für den aktuellen Benutzer.

### Beispiel 2

Deaktivieren Sie die automatische Speicherung von Azure-Anmeldeinformationen in dieser Powershellsitzung. (automatisch generiert)
