...
## BESCHREIBUNG
Das Set-AzContext-Cmdlet legt Authentifizierungsinformationen für Cmdlets fest, die Sie in der aktuellen Sitzung ausführen.
...
### -Erzwingen
Überschreiben Sie den vorhandenen Kontext mit demselben Namen( sofern vorhanden).
...
### -Abonnement
Der Name oder die ID des Abonnements, auf das der Kontext festgelegt werden soll. Dieser Parameter verfügt über Aliase zu -SubscriptionName und -SubscriptionId, daher kann aus Gründen der Übersichtlichkeit eines dieser Parameter anstelle von -Subscription verwendet werden, wenn Name bzw. ID angegeben werden.
