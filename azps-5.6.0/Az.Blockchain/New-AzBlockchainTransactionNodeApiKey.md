...
### Beispiel 1: Neu generieren von Api-Schlüsseln für einen Transaktionsknoten mithilfe des Namens.
```powershell
...
Mit diesem Befehl werden api keys für einen Transaktionsknoten mithilfe von Name, Ressourcengruppe generiert.

### Beispiel 2: Neu generieren von API-Schlüsseln für einen Transaktionsknoten
```powershell
PS C:\> $keyPair = Get-AzBlockchainTransactionNodeApiKey -BlockchainMemberName dolauli001 -ResourceGroupName testgroup -TransactionNodeName tranctionnode001 
...
Mit diesem Befehl werden api keys für einen Transaktionsknoten mithilfe von idenity generiert.
