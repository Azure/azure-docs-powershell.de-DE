...
### Beispiel 1: Entfernen eines Elements für die Blockkette
```powershell
PS C:\> Remove-AzBlockchainMember -Name dolauli001 -ResourceGroupName testgroup

```

Mit diesem Befehl wird ein Element der Blockkette entfernt.

### Beispiel 2: Entfernen eines Elements für die Blockkette
```powershell
...
### -Name
Name des Mitgliednamens der Blockkette
