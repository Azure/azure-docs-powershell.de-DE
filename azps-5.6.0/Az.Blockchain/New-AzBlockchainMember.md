...
### Beispiel 1: Erstellen eines neuen Mitglieds der Blockkette
```powershell
...
Mit diesem Befehl wird ein neues Element für die Blockkette erstellt.
...
### -Consortium
Ruft das Consortium für das Mitglied der Blockkette ab oder legt es fest.
...
Legt das Kennwort für das verwaltete Konsortialverwaltungskonto fest.
...
### -FirewallRule
Ruft Firewallregeln ab oder legt diese fest: Erstellen finden Sie im Abschnitt NOTIZEN für FIREWALLRULE-Eigenschaften und Erstellen einer Hashtabelle.
...
### -Location
Der GEO-Standort des Blockchain-Diensts.
...
### -Password
Legt das grundlegende Authentifizierungskennwort des Elements für die Auth fest.
...
### -Protocol
Ruft das Protokoll für die Blockkette ab oder legt es fest.
...
Ruft die Knotenkapazität ab oder legt sie fest.
