...
## SYNOPSIS
Aktualisieren sie eine vorhandene Rollenzuweisung.
...
## BESCHREIBUNG
Verwenden Sie den New-AzRoleAssignment, um eine vorhandene Aufgabe zu ändern.  
Beschreibungen können eine beliebige gültige Zeichenfolge sein. Verwenden Sie diese, um sie miteinander zu diferentiieren.  
wenn Bedingung festgelegt ist Bedingungsversion muss ebenfalls festgelegt werden, aber wenn Sie eine Bedingung aktualisieren, die nicht erforderlich ist.
Bedingungsversion kann von 1.0 auf 2.0 aktualisiert werden, kann aber nicht zurückgestuft werden. Vorsicht, da 2,0 nicht mit 1,0 rückkompatibler ist.
...
### -PassThru
Wenn angegeben, zeigt die aktualisierte Rollenzuweisung an
