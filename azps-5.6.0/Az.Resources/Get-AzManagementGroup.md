...
Mit der Kennzeichnung kann man durch das Array `Expand` navigieren und Details für jedes Untergeordnete `Children` erhalten. Geben Sie beispielsweise `Children[0]` Details für die Gruppe mit dem Anzeigenamen `TestGroup1DisplayName` an.
...
### -Erweitern
Erweitern der Ausgabe, um die Kinder der Verwaltungsgruppe auflisten
...
### -Rekursieren
Rekursiv auflisten der Kinder der Verwaltungsgruppe
