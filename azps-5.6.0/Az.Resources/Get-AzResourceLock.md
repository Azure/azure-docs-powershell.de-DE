...
## BESCHREIBUNG
Das **Get-AzResourceLock-Cmdlet** ruft Azure-Ressourcensperren ab.

## BEISPIELE

### Beispiel 1: Eine Sperre erhalten
```
...
### Beispiel 2: Erhalten von Sperren auf Ressourcengruppenebene oder höher
```
...
### -AtScope
Gibt an, dass dieses Cmdlet alle Sperren an oder oberhalb des angegebenen Bereichs zurückgibt.
Wenn Sie diesen Parameter nicht angeben, gibt das Cmdlet alle Sperren an, oberhalb oder unterhalb des Bereichs zurück.
