...
## SYNOPSIS
Ruft eine Vorlage What-If ergebnis für eine Bereitstellung im Ressourcengruppenbereich ab. 
...
## BESCHREIBUNG
Das **Get-AzResourceGroupDeploymentWhatIfResult-Cmdlet** ruft das ARM-What-If-Ergebnis für eine Vorlagenbereitstellung im angegebenen Ressourcengruppenbereich ab. Es gibt eine Liste mit Änderungen zurück, die angibt, welche Ressourcen aktualisiert werden, wenn die Bereitstellung angewendet wird, ohne Änderungen an echten Ressourcen vorzunehmen. Verwenden Sie den Parameter *ResultFormat,* um das Format für das zurückgebende Ergebnis anzugeben.

## BEISPIELE

### Beispiel 1: Erhalten eines What-If ergebnisses im Ressourcengruppenbereich
```powershell
...
Dieser Befehl ruft ein What-If des angegebenen Ressourcengruppenbereichs ab, indem eine benutzerdefinierte Vorlagendatei und eine Parameterdatei auf dem Datenträger verwendet werden.
...
### -ExcludeChangeType
Durch Kommas getrennte Ressourcenänderungstypen, die aus den Ergebnissen What-If werden sollen.
