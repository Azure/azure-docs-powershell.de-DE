...
Standardmäßig werden alle verweigerten Zuordnungen im ausgewählten Azure-Abonnement aufgeführt.
Verwenden Sie entsprechende Parameter zum Auflisten von Zuordnungen, die einem bestimmten Benutzer verweigert werden, oder zum Auflisten von Verweigerte Zuordnungen für eine bestimmte Ressourcengruppe oder Ressource.
...
## BESCHREIBUNG
Verwenden Sie den befehl Get-AzDenyAssignment, um alle verweigerten Zuordnungen auflisten, die für einen Bereich wirksam sind.
Ohne Parameter gibt dieser Befehl alle verweigerten Zuordnungen zurück, die unter dem Abonnement vorgenommen wurden.
Diese Liste kann mithilfe von Filterparametern für Denk- und Zuordnungsname und -bereich gefiltert werden.
...
Es ist standardmäßig für das ausgewählte Abonnement festgelegt.
Der Umfang der Verweigernzuordnung kann mit einer der folgenden Parameterkombinationen a angegeben werden.
Bereich – Dies ist der vollqualifizierte Bereich, der mit /subscriptions/ \<subscriptionId\> beginnt.
Dadurch werden zuordnungs verweigernde Zuordnungen gefiltert, die in diesem bestimmten Bereich wirksam sind, d. h. alle Zuordnungen in diesem Bereich und höher zu verweigern.
b.
ResourceGroupName – Name einer beliebigen Ressourcengruppe unter dem Abonnement.
Dadurch werden Zuordnungen gefiltert, die in der angegebenen Ressourcengruppe wirksam sind, d. h. alle Zuordnungen in diesem Bereich und höher zu verweigern.
c.
ResourceName, ResourceType, ResourceGroupName und (optional) ParentResource – Gibt eine bestimmte Ressource im Abonnement an und filtert Zuordnungen, die in diesem Ressourcenbereich wirksam sind.
Um zu ermitteln, welcher Zugriff für einen bestimmten Benutzer im Abonnement verweigert wird, verwenden Sie den Schalter ExpandPrincipalGroups.
Dadurch werden alle Dementenzuweisungen aufgeführt, die dem Benutzer und den Gruppen zugewiesen wurden, deren Mitglied der Benutzer ist.
...
Ruft alle dem Benutzer beim Scope testRG und höher vorgenommenen john.doe@contoso.com Dementzuweisungen ab.
...
Ruft alle Verweigertzuordnungen des angegebenen Dienstprinzipals ab.
...
Ruft Aufgaben im Websitebereich "website1" ab.
...
### -DenyAssignmentName
Name der Verweigerten Zuordnung.
...
Wenn angegeben, werden dem Benutzer und den Gruppen, deren Mitglied der Benutzer ist ( transitiv) direkt zugewiesene Verweigerte Zuordnungen zurückgegeben.
...
### -ID
Verweigern Sie die Zuordnungs-ID.
...
Filtert alle Dementenzuordnungen, die dem angegebenen Prinzipal vorgenommen werden.
...
Listen verweigern Zuordnungen, die in der angegebenen Ressourcengruppe wirksam sind.
Bei Verwendung in Verbindung mit den Parametern "ResourceName", "ResourceType" und "ParentResource" werden in der Befehlsliste Zuordnungen verweigert, die für Ressourcen innerhalb der Ressourcengruppe wirksam sind.
...
Filtert alle verweigerten Zuordnungen, die an die angegebene Azure AD-Anwendung vorgenommen werden.
...
Filtert alle Dementenzuweisungen, die dem angegebenen Benutzer vorgenommen werden.
