...
## BESCHREIBUNG
Das **Cmdlet Update-AzManagementGroup** aktualisiert **die ParentId** oder **DisplayName** für eine Verwaltungsgruppe.
...
### Beispiel 3: Aktualisieren einer Verwaltungsgruppe durch Piping des PSManagementGroup-Objekts
```
...
### Beispiel 4: Aktualisieren des übergeordneten Elements einer Verwaltungsgruppe mit dem ParentObject
```
