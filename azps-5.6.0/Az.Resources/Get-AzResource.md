...
Das **Get-AzResource-Cmdlet** ruft Azure-Ressourcen ab.
...
Dieser Befehl ruft alle Ressourcen ab, deren Ressourcengruppe sie in Wesen mit "andere" gehören.

### Beispiel 4: Alle Ressourcen mit einem angegebenen Namen erhalten
...
### -Name
Der Name der ressource(n), die abgerufen werden soll. Dieser Parameter unterstützt Platzhalter am Anfang und/oder Ende der Zeichenfolge.
...
### -ResourceGroupName
Die Ressourcengruppe, in der die abgerufenen Ressourcen gehören. Dieser Parameter unterstützt Platzhalter am Anfang und/oder Ende der Zeichenfolge.
...
### -ResourceType
Der Ressourcentyp der ressource(n), die abgerufen werden soll. Microsoft.Compute/virtualMachines beispielsweise
...
Ruft Ressourcen ab, die das angegebene Azure-Tag haben. Geben Sie eine Hashtabelle mit einem Namens- oder Namens- und Wertschlüssel ein. Platzhalterzeichen werden nicht unterstützt. Ein "Tag" ist ein Name-Wert-Paar, das Sie auf Ressourcen und Ressourcengruppen anwenden können. Verwenden Sie Kategorien, um Ihre Ressourcen zu kategorisieren, z. B. nach Abteilung oder Kostenstelle, oder um Notizen oder Kommentare zu den Ressourcen nachverfolgt zu werden. Wenn Sie einer Ressource ein Tag hinzufügen möchten, verwenden Sie den Parameter Tag der New-AzResource oder Set-AzResource cmdlets. Zum Erstellen eines vordefinierten Tags verwenden Sie das New-AzTag Cmdlet. Wenn Sie Hilfe zu #A0 in Windows PowerShell, führen Sie "Get-Help about_Hashtables" aus.
...
### -TagName
Der Schlüssel im Tag der abzurufende Ressource(n).
...
### -TagValue
Der Wert im Tag der abzurufende Ressource(en).
