...
## SYNOPSIS
Ruft eine Vorlage What-If Ergebnis für eine Bereitstellung im Mandantenbereich ab. 
...
### Beispiel 2: Erhalten eines What-If im Mandantenbereich mit ResourceIdOnly
```powershell
PS C:\> Get-AzTenantDeploymentWhatIfResult `
    -DeploymentName "deploy-01" `
    -Location "West US" `
