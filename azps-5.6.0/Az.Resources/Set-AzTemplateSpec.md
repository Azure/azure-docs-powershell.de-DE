...
Ändert Version "v1.0" einer Vorlagenspezifikation mit dem Namen "myTemplateSpec". Die angegebene Version enthält $templateJson als Inhalt der ARM Vorlage. Wenn die Stammvorlagenspezifikation und/oder -version noch nicht vorhanden ist, werden sie erstellt.


**Hinweise:** 

* Die ARM-Vorlage im Beispiel ist ein No-Op, da sie keine tatsächlichen Ressourcen enthält.
...
Ändert Version "v2.0" einer Vorlagenspezifikation mit dem Namen "myTemplateSpec". Die angegebene Version enthält den Inhalt aus der lokalen Datei "myTemplateContent.jsein" als Inhalt der ARM Vorlage. Wenn die Stammvorlagenspezifikation und/oder -version noch nicht vorhanden ist, werden sie erstellt.
...
### -TemplateFile
Der Dateipfad zur lokalen Azure Resource Manager-Vorlagen-JSON-Datei.
