...
## BESCHREIBUNG
Das **Set-AzResource-Cmdlet** ändert eine vorhandene Azure-Ressource.
...
Der erste Befehl ruft die Ressource namens ContosoSite mithilfe des cmdlets Get-AzResource ab und speichert sie dann in der $Resource Variablen.
Der zweite Befehl ändert eine Eigenschaft $Resource.
...
Der erste Befehl ruft die Ressourcen in der Ressourcengruppe testrg ab und speichert sie dann in $Resource Variablen.

Der zweite Befehl übernimmt jede dieser Ressourcen in der Ressourcengruppe und fügt ihnen ein neues Tag hinzu.
...
Verwenden Sie beispielsweise zum Angeben einer Datenbank das folgende Format: Name `/` der Servernamedatenbank
...
### -ODataQuery
Gibt einen OData-Stilfilter (Open Data Protocol) an.
...
### -UsePatchSemantics
Gibt an, dass für dieses Cmdlet ein HTTP-PATCH zum Aktualisieren des -Objekts anstelle eines HTTP-PUT verwendet wird.
