...
## BESCHREIBUNG
Aktualisiert einen vorhandenen Active Directory-Benutzer (Arbeits-/Schulkonto, auch bekannt als Organisations-ID).
Weitere Informationen finden Sie unter: https://msdn.microsoft.com/en-us/library/azure/ad/graph/api/users-operations#UpdateUser
...
### Beispiel 2: Aktualisieren des Anzeigenamens eines Benutzers mithilfe des Prinzipalnamens

```powershell
PS C:\> Update-AzADUser -UserPrincipalName foo@domain.com -DisplayName MyNewDisplayName
```

Aktualisiert den Anzeigenamen des Benutzers mit dem Benutzerprinzipalnamen ' ' in foo@domain.com "MyNewDisplayName".

### Beispiel 3: Aktualisieren des Anzeigenamens eines Benutzers mithilfe von Piping

```powershell
PS C:\> Get-AzADUser -ObjectId 155a5c10-93a9-4941-a0df-96d83ab5ab24 | Update-AzADUser -DisplayName MyNewDisplayName
```

Ruft den Benutzer mit der Objekt-ID '155a5c10-93a9-4941-a0df-96d83ab5ab24' ab und gibt diese an das Update-AzADUser-Cmdlet weiter, um den Anzeigenamen dieses Benutzers auf "MyNewDisplayName" zu aktualisieren.
...
### -ObjectId
Die Objekt-ID des zu aktualisierende Benutzers.
...
### -UPNOrObjectId
Der Benutzername oder die Objekt-ID des Benutzers, der aktualisiert werden soll.
...
### -UserPrincipalName
Der Benutzername des benutzers, der aktualisiert werden soll.
