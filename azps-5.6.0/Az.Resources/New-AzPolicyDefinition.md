...
Mit diesem Befehl wird eine Richtliniendefinition mit dem Namen LocationDefinition erstellt, die die richtlinienregel enthält, die in C:\LocationPolicy.jsfestgelegt ist. Beispielinhalt für LocationPolicy.jsdatei wird oben bereitgestellt.
...
Mit diesem Befehl wird eine Richtliniendefinition mit dem Namen LocationDefinition erstellt, die die richtlinienregel enthält, die in C:\LocationPolicy.jsfestgelegt ist. Die Parameterdefinition für die Richtlinienregel wird inline bereitgestellt.
...
Mit diesem Befehl wird eine Richtliniendefinition mit dem Namen VMPolicyDefinition in der Verwaltungsgruppe Dept42 erstellt.
...
Mit diesem Befehl wird eine Richtliniendefinition mit dem Namen VMPolicyDefinition mit Metadaten erstellt, die angeben, dass die Kategorie "Virtueller Computer" ist.
Der Befehl gibt die Richtlinie als Zeichenfolge im gültigen JSON-Format an.
...
Mit diesem Befehl wird eine Richtliniendefinition mit dem Namen TagsPolicyDefinition mit dem Modus "Indiziert" erstellt, der angibt, dass die Richtlinie nur für Ressourcentypen ausgewertet werden sollte, die Tags und Speicherort unterstützen.
