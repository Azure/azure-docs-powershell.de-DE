...
## BESCHREIBUNG
Erstellt eine neue Azure Active Directory-Anwendung. Im Folgenden sind die Berechtigungen aufgeführt, die zum Erstellen einer Anwendung erforderlich sind:
...
### Beispiel 2: Erstellen einer neuen AAD-Anwendung mit Kennwort.
...
Der Wert, der an gibt, ob es sich bei der Anwendung um einen einzelnen Mandanten oder mehrere Mandanten handelt.
...
Der Standardwert für das Enddatum ist ein Jahr ab heute. Bei "asymmetrischen" Typanmeldeinformationen muss dies auf am oder vor dem Datum festgelegt sein, an dem das X509-Zertifikat gültig ist.
...
Der Standardwert für das Startdatum ist heute. Bei "asymmetrischen" Typanmeldeinformationen muss dies auf am oder nach dem Datum festgelegt sein, ab dem das X509-Zertifikat gültig ist.
