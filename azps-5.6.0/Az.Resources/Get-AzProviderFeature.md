...
## BESCHREIBUNG
Das **Get-AzProviderFeature-Cmdlet** ruft den Featurenamen, den Anbieternamen und den Registrierungsstatus für Azure-Anbieterfeatures ab.
...
### Beispiel 2: Informationen zu einem bestimmten Feature erhalten
```
...
### -FeatureName
Gibt den Namen des zu erhaltenden Features an.
