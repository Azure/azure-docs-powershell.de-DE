...
## BESCHREIBUNG
Erstellt eine neue Version der Vorlagenspezifikation mit dem angegebenen ARM Vorlageninhalt. Der Inhalt kann entweder aus einer unformatierte JSON-Zeichenfolge (mit **dem Parametersatz FromJsonStringParameterSet)** oder aus einer angegebenen JSON-Datei (mit **dem Parametersatz FromJsonFileParameterSet)** stammen.  
...
Erstellt eine neue Version der Vorlagenspezifikation "v1.0" in einer Vorlagenspezifikation mit dem Namen "myTemplateSpec". Die angegebene Version enthält $templateJson als Inhalt der ARM Vorlage.

 **Hinweis:** Die ARM-Vorlage im Beispiel ist ein No-Op, da sie keine tatsächlichen Ressourcen enthält.
...
Erstellt eine neue Version der Vorlagenspezifikation "v2.0" in einer Vorlagenspezifikation mit dem Namen "myTemplateSpec". Die angegebene Version enthält den Inhalt aus der lokalen Datei "myTemplateContent.jsein" als Inhalt der ARM Vorlage.
...
### -Erzwingen
Bitten Sie nicht um Bestätigung, wenn Sie eine vorhandene Version überschreiben.
...
### -Tag
Hashtable von Tags für die neuen Vorlagenspezifikationenressourcen.
