...
## BESCHREIBUNG
Listet vorhandene Azure Active Directory-Anwendungen auf.
Das Anwendungssupup kann von ObjectId, ApplicationId, IdentifierUri oder DisplayName durchgeführt werden.
Wenn kein Parameter bereitgestellt wird, ruft er alle Anwendungen unter dem Mandanten ab.
...
### Beispiel 3 : URI "Anwendung nach Bezeichner" erhalten

```
PS C:\> Get-AzADApplication -IdentifierUri http://mySecretApp1
```

Ruft die Anwendung mit bezeichner-uri als " http://mySecretApp1 ab.
