...
Mit diesem Befehl wird der virtuelle Computer mit {ResourceId} gestartet.
...
Mit diesem Befehl wird der virtuelle Computer mit {ResourceId} beendet.
Der Befehl gibt den *Parameter Erzwingen* an, daher werden Sie nicht zur Bestätigung aufgefordert.
...
### -Aktion
Gibt den Namen der aktion an, die aufgerufen werden soll.
