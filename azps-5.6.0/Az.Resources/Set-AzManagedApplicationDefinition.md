...
### Beispiel 1: Beschreibung der Definition verwalteter Anwendungen aktualisieren
```powershell
...
### -Autorisierung
Die Autorisierung der verwalteten Anwendungsdefinition.
...
### -Beschreibung
Beschreibung der verwalteten Anwendung.
...
### -ID
Die vollqualifizierte Definitions-ID für verwaltete Anwendungen, einschließlich des Abonnements. z. B. /subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName
...
### -PackageFileUri
Der URI für das Paket für verwaltete Anwendungsdefinitionsdateien.
