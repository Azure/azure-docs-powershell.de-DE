...
Der Befehl speichert ihn in der $PolicySetDefinition-Variable.
Mit dem zweiten Befehl wird die Richtliniensatzdefinition entfernt, die durch die **ResourceId-Eigenschaft** von $PolicySetDefinition.
...
### -InputObject
Das Zu entfernende Richtliniensatzdefinitionsobjekt, das aus einem anderen Cmdlet ausgegeben wurde.
...
### -SubscriptionId
Die Abonnement-ID der zu löschende Richtliniensatzdefinition.
