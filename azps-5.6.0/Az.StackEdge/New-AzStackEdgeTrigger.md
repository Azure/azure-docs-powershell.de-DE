...
### -FileEvent
Übergeben Sie diesen Parameter zum Konfigurieren von FileEvent Trigger.
...
### -RoleName
Berechnen Sie die Rolle, anhand derer Ereignisse ausgelöst werden.
...
### -Zeitplan
Periodische Häufigkeit, bei der das Timerereignis ausgelöst werden muss. Geben Sie einen Zeitplan entweder in Tagen (zwischen 1 und 365), Stunden (zwischen 1 und 23) oder Minuten (zwischen 1 und 59) an.
...
### -ShareId
Dateifreigabe-ID, die im FileEvent-Trigger übergeben werden soll
...
### -StartTime
Die Uhrzeit des Tages, die zu einem gültigen Trigger führt. Der Zeitplan wird mit Bezug auf die bis zu Sekunden angegebene Zeit berechnet. Wird keine Zeitzone angegeben, wird die Uhrzeit als in der Gerätezeitzone betrachtet. Der Wert wird immer als UTC-Uhrzeit zurückgegeben.
...
### -Topic
Thema, in dem periodische Ereignisse auf einem IoT-Gerät veröffentlicht werden.
