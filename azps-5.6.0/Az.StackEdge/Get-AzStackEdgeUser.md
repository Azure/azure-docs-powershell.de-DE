...
## BESCHREIBUNG
Im **Cmdlet Get-AzStackEdgeUser** werden die Benutzer aufgeführt, die für ein Stack Edge-Gerät konfiguriert sind. Sie können den Namen in Parametern erwähnen, um Details zu einem bestimmten Benutzer zu erhalten.
