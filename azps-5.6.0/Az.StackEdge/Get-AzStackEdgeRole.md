...
## BESCHREIBUNG
Das **Get-AzStackEdgeRole-Cmdlet** ruft die verfügbaren IoT-Rollen für ein Stack Edge-Gerät ab. Sie können den Parameter Name erwähnen, um die Details einer bestimmten IoT-Rolle zu erhalten.
