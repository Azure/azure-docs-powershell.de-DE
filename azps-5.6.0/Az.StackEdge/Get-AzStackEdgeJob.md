...
## BESCHREIBUNG
Das **Get-AzStackEdgeJob-Cmdlet** ruft die aktiven Aufträge auf einem Stack Edge-Gerät ab. Sie können den Parameter Name erwähnen, um Details zu einem bestimmten Auftrag zu erhalten.
