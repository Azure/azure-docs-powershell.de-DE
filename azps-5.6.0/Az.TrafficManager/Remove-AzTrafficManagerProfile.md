...
Alternativ können Sie ein **TrafficManagerProfile-Objekt** mit dem *Parameter TrafficManagerProfile* angeben, oder Sie können die Pipeline verwenden.

## BEISPIELE

### Beispiel 1: Löschen eines profils, das nach Name angegeben ist
```
...
### -Name
Gibt den Namen des Traffic Manager-Profils an, das von diesem Cmdlet gelöscht wird.
...
Dieses Cmdlet löscht ein Traffic Manager-Profil in der Gruppe, die von diesem Parameter angegeben wird.
