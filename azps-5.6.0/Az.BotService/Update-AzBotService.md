...
### Beispiel 1: Aktualisieren des Bots nach Name und ResourceGroupName
```powershell
...
Aktualisieren des Bots nach Name und ResourceGroupName

### Beispiel 2: Aktualisieren des Bots nach InputObject
```powershell
...
Aktualisieren des Bots nach InputObject
...
Der Schlüssel "Application Insights"
...
### -Tag
Enthält Ressourcentags, die als Schlüssel-/Wertpaare definiert sind.
