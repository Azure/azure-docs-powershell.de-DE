...
### Beispiel 1: Löschen des BotService nach Name und ResourceGroupName
```powershell
PS C:\> Remove-AzBotService -Name youri-bot -ResourceGroupName youriBotTest

```

Löschen des BotService Nach Name und ResourceGroupName

### Beispiel 2: Löschen des BotService By InputObject
```powershell
