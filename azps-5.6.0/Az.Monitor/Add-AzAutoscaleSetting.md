...
## SYNOPSIS
Erstellt eine Einstellung für die automatische Skalierung.
...
## BESCHREIBUNG
Das **Add-AzAutoscaleSetting-Cmdlet** erstellt eine Einstellung für die automatische Skalierung.
...
Die ersten beiden Befehle verwenden [New-AzAutoscaleRule,](https://docs.microsoft.com/powershell/module/az.monitor/new-azautoscalerule) um zwei Regeln für die automatische Skalierung zu erstellen, $Rule 1 und $Rule 2.
Für den dritten und vierten Befehl wird [New-AzAutoscaleProfile](https://docs.microsoft.com/powershell/module/az.monitor/new-azautoscaleprofile) zum Erstellen von Profilen für die automatische Skalierung $Profile 1 und $Profile 2 mithilfe von $Rule 1 und $Rule 2 verwendet.
Der letzte Befehl erstellt mithilfe der Profile in $Profile 1 und $Profile 2 eine Einstellung für die automatische Skalierung.

## PARAMETER

### -AutoscaleProfile
Gibt eine Liste der Profile an, die der Einstellung "Autoscale" hinzugefügt werden, oder $Null, um kein Profil hinzuzufügen.
...
### -DisableSetting
Deaktiviert eine vorhandene Einstellung für die automatische Skalierung.
...
### -InputObject
Die vollständige Spezifikation eines AutoscaleSettings
...
### -Location
Gibt die Position der Einstellung für die automatische Skalierung an.
...
### -Name
Gibt den Namen der autoscale-Einstellung an, die erstellt werden soll.
...
### -ResourceGroupName
Gibt den Namen der Ressourcengruppe für die Ressource an, die der Einstellung Autoscale zugeordnet ist.
