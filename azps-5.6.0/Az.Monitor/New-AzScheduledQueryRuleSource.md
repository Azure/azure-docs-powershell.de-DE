...
## BESCHREIBUNG
Erstellt ein Objekt vom Typ "Quelle".
Dieses Objekt muss an den Befehl übergeben werden, mit dem die Protokollbenachrichtigungsregel erstellt wird.
...
### -AuthorizedResource
Liste der autorisierten Ressourcen für diese Benachrichtigung
...
### -DataSourceId
Die Datenquelle, in der diese Benachrichtigung erstellt wird
...
### -QueryType
Abfragetyp – aktuell unterstützte Werte: ResultCount
