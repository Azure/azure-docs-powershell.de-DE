...
## BESCHREIBUNG
Das **Cmdlet Set-AzDiagnosticSetting** aktiviert oder deaktiviert jedes Mal die Kategorie "Grain" und "Log" für die bestimmte Ressource.
...
### Beispiel 5: Aktivieren einer Zeitkörnung und mehrerer Kategorien
```powershell
PS C:\>Set-AzDiagnosticSetting -ResourceId "Resource01" -Enabled $True -Category Category1,Category2 -Timegrain PT1M
```

Dieser Befehl aktiviert nur Kategorie1, Kategorie2 und Zeitkörner PT1M.
Alle anderen Zeitkörner und -kategorien bleiben unverändert.

### Beispiel 6: Verwenden einer Pipeline
```powershell
PS C:\>Get-AzDiagnosticSetting -ResourceId "Resource01" | Set-AzDiagnosticSetting -Enabled $True -Category Category1,Category2
```

Dieser Befehl verwendet die PowerShell-Pipeline, um eine Diagnoseeinstellung (keine Änderung vorgenommen) zu setzen.

## PARAMETER

### -Category
Gibt die Liste der Zu aktivierenden oder zu deaktivierenden Protokollkategorien entsprechend dem Wert aktiviert *an.*
Wenn keine Kategorie angegeben ist, wird dieser Befehl für alle unterstützten Kategorien ausgeführt. 
...
Die Ereignishubautorisierungsregel-ID
...
Flag, das angibt, dass der Export nach LA in eine ressourcenspezifische Tabelle a.k.a. ausgeführt werden muss. dedizierte oder feste Schematabelle im  Gegensatz zur standardmäßigen dynamischen Schematabelle mit dem Namen **AzureDiagnostics**.

Dieses Argument ist nur wirksam, wenn auch das Argument **-workspaceId** angegeben wird.
...
### -Name
Der Name der Diagnoseeinstellung. Der Standardwert ist **Dienst**.
...
### -Timegrain
Gibt die Zeitkörner an, die für Metriken aktiviert oder deaktiviert werden sollen, entsprechend dem Wert von *Enabled*.
Wenn Sie keine Zeitkörnung angeben, wird dieser Befehl für alle verfügbaren Zeitkörner verwendet.
