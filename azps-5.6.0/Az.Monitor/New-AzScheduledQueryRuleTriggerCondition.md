...
## BESCHREIBUNG
Erstellt ein Objekt vom Typ Triggerbedingung.
Dieses Objekt muss an den Befehl übergeben werden, mit dem das Warnungsaktionsobjekt erstellt wird.
...
### -MetricTrigger
Triggerbedingung für metrikmetrische Abfrageregel
...
### -Threshold
Der Schwellenwert, über dem Benachrichtigung ausgelöst wird
...
### -ThresholdOperator
Der Schwellenwertoperator: GreaterThan, LessThan oder Equal
