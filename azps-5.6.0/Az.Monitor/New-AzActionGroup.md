...
## BESCHREIBUNG
Das **Cmdlet New-AzActionGroup** erstellt ein Referenzobjekt der Aktionsgruppe im Arbeitsspeicher.

## BEISPIELE

### Beispiel 1: Erstellen eines Referenzobjekts einer Aktionsgruppe im Arbeitsspeicher
```
