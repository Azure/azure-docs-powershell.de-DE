...
## BESCHREIBUNG
Aktualisiert eine Protokollbenachrichtigungsregel per PUT-Semantik
...
### Beispiel 2: Festlegen nach Eingabeobjekt
```powershell
...
### -Aktion
Warnungsaktion für die geplante Abfrageregel
...
### -Zeitplan
Zeitplan für geplante Abfrageregel
