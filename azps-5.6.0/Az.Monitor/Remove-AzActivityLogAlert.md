...
### Beispiel 2: Entfernen einer Aktivitätsprotokollbenachrichtigung mithilfe einer PSActivityLogAlertResource als Eingabe
```
...
Entfernt eine Aktivitätsprotokollbenachrichtigung mit einer PSActivityLogAlertResource als Eingabe.

### Beispiel 3: Entfernen des ActivityLogAlert mithilfe des Parameters ResourceId
```
PS C:\>Get-AzResource -ResourceGroupName "myResourceGroup" -Name "myLogAlert" | Remove-AzActivityLogAlert
```

Mit diesem Befehl wird der ActivityLogAlert mithilfe des Parameters ResourceId aus der Pipe entfernt.
