...
## SYNOPSIS
Erstellen von PSDiagnosticDetailSetting-Objekt, Typ kann Metrik oder Protokoll sein
...
## BESCHREIBUNG
Erstellen Sie PSMetricSettings oder PSLogSettings-Objekt. Sie können Kategorien mithilfe von `Get-AzDiagnosticSettingCategory` erhalten.
...
Erstellen Sie das PSLogSettings-Objekt.
...
### -Log
So erstellen Sie die Protokolleinstellung
...
### -RetentionInDays
Aufbewahrungstage für Aufbewahrungsrichtlinien
...
### -TimeGrain
Zeitgrain für Metrikeinstellung
