...
## SYNOPSIS
Fügt eine metrikbasierte Warnungsregel hinzu oder aktualisiert sie.
...
## BESCHREIBUNG
Das **Add-AzMetricAlertRule-Cmdlet** fügt eine metrikbasierte Warnungsregel hinzu oder aktualisiert sie.
...
### Beispiel 1: Hinzufügen einer Metrikwarnungsregel zu einer Website
```
...
Mit diesem Befehl wird eine Metrikwarnungsregel für eine Website erstellt.
...
Wenn die Regel vorhanden ist, wird sie einfach deaktiviert.
...
### -MetricName
Gibt den Namen der Metrik an, die von der Regel überwacht wird.
Geben Sie diesen Parameter nur für metrikbasierte Regeln an.
...
### -Threshold
Gibt den Schwellenwert der Regel an.
...
Gibt den Aggregationsoperator an, der auf das Zeitfenster angewendet werden soll, wenn die Regel ausgewertet wird.
