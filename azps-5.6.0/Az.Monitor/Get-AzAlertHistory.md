...
## SYNOPSIS
Ruft den Verlauf der klassischen Benachrichtigungsregeln ab.
...
## BESCHREIBUNG
Das **Get-AzAlertHistory-Cmdlet** ruft den Verlauf der klassischen Benachrichtigungsregeln ab, während sie aktiviert, deaktiviert, ausgelöst, aufgelöst und so weiter sind.
...
Dieser Befehl ruft den Benachrichtigungsverlauf für den angegebenen Zeitrahmen für das aktuelle Abonnement ab.

### Beispiel 2: Benachrichtigungsverlauf für eine angegebene Ressource erhalten
```
...
Dieser Befehl ruft die warnungsregelbezogenen Ereignisse für eine angegebene Ressource ab.
