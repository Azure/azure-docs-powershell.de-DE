...
## SYNOPSIS
Erstellt einen neuen Empfänger einer Aktionsgruppe.
...
## BESCHREIBUNG
Das **Cmdlet New-AzActionGroupReceiver** erstellt einen neuen Aktionsgruppeempfänger im Arbeitsspeicher.
...
### Beispiel 2: Erstellen sie einen neuen SMS-Empfänger im Arbeitsspeicher.
```
...
### Beispiel 3: Erstellen eines neuen Webhookempfängers im Arbeitsspeicher.
```
...
Erstellen eines AutomationRunbookReceivers
...
### -CountryCode
Gibt die Ländercode für den SMS-Empfänger an.
...
### -LogicAppReceiver
Erstellen einer LogicAppReceiver
...
### -Name
Gibt den Namen für den Empfänger an.
...
### -Region
der Itsm-Bereich dieses Empfängers
...
### -RoleId
Die Armrolle-ID des Empfängers
...
### -ServiceUri
Gibt den URI für den Webhookempfänger an.
...
### -UseAadAuth
das Flag zum Verwenden von Add Auth
...
Gibt an, ob ein allgemeines Warnungsschema verwendet werden soll. Dieser Wert wird für SMS, Azure App Push, ITSM und Voice Recievers nicht beachtet.
...
### -VoiceCountryCode
Die Ländercode des Sprachempfängers
...
### -WebhookReceiver
Gibt an, dass ein Webhookempfänger erstellt werden soll
...
### -WorkspaceId
die id des itsm-Arbeitsbereichs dieses Empfängers
