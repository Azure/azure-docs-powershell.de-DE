...
## SYNOPSIS
Fügt eine metrikbasierte V2-Warnungsregel (nicht klassisch) hinzu oder aktualisiert sie.
...
## BESCHREIBUNG
Fügt eine metrikbasierte **V2-Warnungsregel (nicht klassisch) hinzu** oder aktualisiert sie. Die hinzugefügte Regel ist einer Ressourcengruppe zugeordnet und hat einen Namen. Dieses Cmdlet implementiert das ShouldProcess-Muster, d. h. es kann eine Bestätigung vom Benutzer anfordern, bevor die Ressource tatsächlich erstellt, geändert oder entfernt wird.

## BEISPIELE

### Beispiel 1: Hinzufügen einer Metrikwarnungsregel zu einem virtuellen Computer
...
Mit diesem Befehl wird eine Metrikwarnungsregel für einen virtuellen Computer erstellt. $condition ist die Ausgabe des [Cmdlets New-AzMetricAlertRuleV2Criteria](https://docs.microsoft.com/powershell/module/az.monitor/new-azmetricalertrulev2criteria) und $act die Ausgabe des [New-AzActionGroup-Cmdlets.](https://docs.microsoft.com/powershell/module/az.monitor/new-azactiongroup)

### Beispiel 2: Hinzufügen einer Metrikwarnungsregel für alle virtuellen Computer in einem Abonnement
```powershell
...
Mit diesem Befehl wird eine Metrikwarnungsregel für alle virtuellen Computer im Abonnement erstellt, die sich in Eastus befinden.

### Beispiel 3: Deaktivieren einer Metrikwarnungsregel
```powershell
...
Mit diesem Befehl wird eine Metrikwarnungsregel deaktiviert. Hier wird die Ausgabe von [Get-AzMetricAlertRuleV2](https://docs.microsoft.com/powershell/module/az.monitor/get-azmetricalertrulev2) in [Add-AzMetricAlertRuleV2 verrohrt.](https://docs.microsoft.com/powershell/module/az.monitor/add-azmetricalertrulev2) 

### Beispiel 4: Hinzufügen einer Metrikwarnungsregel mit Dimensionen
...
Wenn Sie eine komplexere Metrikwarnungsregel erstellen möchten, z. B. eine, die das Auswählen von Dimensionswerten oder mehrere Kriterien enthält, können Sie die Hilfs cmdlets [New-AzMetricAlertRuleV2DimensionSelection](https://docs.microsoft.com/powershell/module/az.monitor/new-azmetricalertrulev2dimensionselection) und [New-AzMetricAlertRuleV2Criteria verwenden.](https://docs.microsoft.com/powershell/module/az.monitor/new-azmetricalertrulev2criteria)

Über einer Gruppe von Cmdlets wird eine Metrikwarnungsregel mit Dimensionen erstellt.

## PARAMETER

### -ActionGroup
Aktionsgruppe für Regel
...
### -ActionGroupId
Die Aktionsgruppe-ID für regel
...
### -Beschreibung
Beschreibung der Metrikwarnungsregel
...
### -DisableRule
Das Kennzeichen 'Regel deaktivieren' (Status)
...
### -Häufigkeit
Die Auswertungshäufigkeit für Regel
...
### -Name
Der Name der Metrikwarnungsregel
...
### -Schweregrad
Der Schweregrad für die Metrikwarnungsregel
...
### -TargetResourceId
Die Zielressourcen-ID für die Regel
...
### -TargetResourceRegion
Zielressourcenbereich für Regel
...
### -TargetResourceType
Der Zielressourcentyp für die Regel
