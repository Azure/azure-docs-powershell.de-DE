...
## BESCHREIBUNG
Das **Get-AzMetric-Cmdlet** ruft die Metrikwerte für eine angegebene Ressource ab.

## BEISPIELE

### Beispiel 1: Erhalten einer Metrik mit zusammengefasster Ausgabe
```
...
Dieser Befehl ruft die Metrikwerte für website3 mit einer Zeitkörnung von 1 Minute ab.

### Beispiel 2: Erhalten einer Metrik mit detaillierter Ausgabe
```
...
### Beispiel 3: Erhalten einer detaillierten Ausgabe für eine angegebene Metrik
```
...
Dieser Befehl ruft eine detaillierte Ausgabe für die Metrik Anforderungen ab.

### Beispiel 4: Zusammenfassung der Ausgabe für eine angegebene Metrik mit angegebenem Dimensionsfilter
```
...
Dieser Befehl ruft die Zusammenfassung der Ausgabe für die Metrik "PageViews" mit dem angegebenen Dimensionsfilter und Aggregationstyp ab.
...
### -EndTime
Gibt die Endzeit der Abfrage in der lokalen Zeit an.
...
### -MetricFilter
Gibt den Metrikdimensionsfilter an, nach dem Metriken abgefragt werden.
...
### -MetricNamespace
Gibt den Metriknamespace an, für den Metriken abgefragt werden.
...
### -OrderBy
Gibt die Aggregation an, die zum Sortieren von Ergebnissen verwendet werden soll, und die Sortierrichtung (Beispiel: Summe asc).
...
### -ResultType
Gibt den zurückgegebenen Ergebnistyp (Metadaten oder Daten) an.
...
### -TimeGrain
Gibt die Zeitkörnung der Metrik als **TimeSpan-Objekt** im Format hh:mm:ss an.
...
### -Top
Gibt die maximale Anzahl der abzurufenden Datensätze (standard:10) an, die mit dem $filter.
...
Weitere Informationen zu den unterstützten Metriken finden Sie unter: https://docs.microsoft.com/azure/azure-monitor/platform/metrics-supported
