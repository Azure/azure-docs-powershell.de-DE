...
## BESCHREIBUNG
Erstellen Sie das PSServiceDiagnosticSettings-Objekt.
Dies kann als `-InputObject` Parameter für `Set-AzDiagnosticSetting`
...
Der Wert, der angibt, ob (in ODS) in ressourcenspezifische (falls vorhanden) oder in AzureDiagnostics (Standard, nicht vorhanden) exportiert werden soll
...
### -Einstellung
Metrikeinstellungen oder Protokolleinstellungen
