...
## BESCHREIBUNG
Das **Cmdlet New-AzMetricAlertRuleV2Criteria** erstellt ein lokales Metrikkriterienobjekt, das als [Eingabe-Add-AzMetricAlertRuleV2-Cmdlet](https://docs.microsoft.com/powershell/module/az.monitor/add-azmetricalertrulev2) verwendet wird, das eine neue Metrikwarnungsregel erstellt.

## BEISPIELE

### Beispiel 1: Erstellen eines einfachen Metrikwarnkriteriums
...
Mit diesem Befehl werden einfache Metrikbenachrichtigungskriterien erstellt, die in einer Metrikwarnungsregel verwendet werden können.

### Beispiel 2: Erstellen eines dynamischen Metrikwarnkriteriums
...
Mit diesem Befehl werden dynamische Metrikbenachrichtigungskriterien erstellt, die in einer Metrikwarnungsregel verwendet werden können.

### Beispiel 3: Erstellen eines komplexeren Metrikwarnkriteriums
...
Diese Gruppe von Befehlen erstellt komplexere Metrikwarnkriterien, die die Dimensionsauswahl umfassen.

### Beispiel 4: Erstellen eines Webtestverfügbarkeitskriterien
...
Mit diesem Befehl werden webtestverfügbarkeitskriterien erstellt, die in einer Metrikwarnungsregel verwendet werden können.
...
### -DynamicThreshold
Parameter wechseln für die Verwendung des dynamischen Schwellenwerttyps
...
Die Gesamtanzahl der untersuchten Punkte
...
### -FailedLocationCount
Die Mindestanzahl fehlgeschlagener Speicherorte zum Ausstellen einer Benachrichtigung.
...
Die Vertraulichkeit der Regelbedingung
...
### -TimeAggregation
Der Aggregationsvorgang, der zum Rollup mehrerer Metrikwerte im Fensterintervall verwendet wird
...
### -ViolationCount
Die Mindestanzahl von Verletzungen, die innerhalb des ausgewählten Lookbackzeitfensters erforderlich sind, um eine Benachrichtigung zu ausgelöst
...
### -WebTest
Parameter wechseln für die Verwendung von Verfügbarkeitskriterien Typ
