...
## SYNOPSIS
API, um bestimmte Eigenschaften der verbundenen Clusterressource zu aktualisieren.
...
### Beispiel 1: Aktualisieren eines verbundenen Kubernetes
```powershell
...
Mit diesem Befehl wird ein verbundenes Kubernetes aktualisiert.

### Beispiel 2: Aktualisieren eines verbundenen Kubernetes nach Objekt
```powershell
