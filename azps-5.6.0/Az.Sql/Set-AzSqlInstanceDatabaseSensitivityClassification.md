...
## SYNOPSIS
Legt die Informationstypen und Vertraulichkeitsbeschriftungen von Spalten in der Azure SQL verwalteten Instanzdatenbank fest.
...
## BESCHREIBUNG
Das Set-AzSqlInstanceDatabaseSensitivityClassification-Cmdlet legt die Informationstypen und Vertraulichkeitsbeschriftungen von Spalten in der Azure SQL verwalteten Instanzdatenbank fest.

## BEISPIELE

### Beispiel 1: Festlegen von Informationstyp und Vertraulichkeitsbeschriftung einer Spalte in einer Azure SQL verwaltete Instanzdatenbank.
```powershell
...
### Beispiel 3: Festlegen von Informationstyp und Vertraulichkeitsbeschriftung einer Spalte in einer Azure SQL verwaltete Instanzdatenbank mithilfe von Piping.
```powershell
