...
## BESCHREIBUNG
Das **Get-AzSqlSyncAgentLinkedDatabase-Cmdlet** gibt Informationen zu SQL Server Datenbanken zurück, die von einem Synchronisierungs-Agent verknüpft wurden.

## BEISPIELE

### Beispiel 1: Die verknüpften SQL Server für einen Azure SQL-Synchronisierungs-Agent.

Das folgende Beispiel gibt die verknüpften SQL Server zurück, die von einem Azure SQL-Synchronisierungs-Agent verknüpft sind.
