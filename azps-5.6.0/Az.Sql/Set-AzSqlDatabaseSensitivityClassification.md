...
## BESCHREIBUNG
Das Set-AzSqlDatabaseSensitivityClassification-Cmdlet legt die Informationstypen und Vertraulichkeitsbeschriftungen von Spalten in der Datenbank fest.

## BEISPIELE

### Beispiel 1: Festlegen von Informationstyp und Vertraulichkeitsbeschriftung einer Spalte in einer Azure SQL Datenbank.
```powershell
...
### Beispiel 2: Festlegen empfohlener Informationstypen und Vertraulichkeitsbeschriftungen für Spalten in einer Azure SQL Datenbank.
```powershell
...
### Beispiel 3: Festlegen von Informationstyp und Vertraulichkeitsbeschriftung einer Spalte in einer Azure SQL mithilfe von Piping.
```powershell
...
Ein Objekt, das eine SQL Datenbanksensitivitätsklassifizierung darstellt.
