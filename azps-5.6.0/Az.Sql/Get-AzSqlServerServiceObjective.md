...
## BESCHREIBUNG
Das **Get-AzSqlServerServiceObjective-Cmdlet** ruft die verfügbaren Dienstziele für einen Azure SQL Datenbankserver ab.
...
Dieser Befehl ruft die Dienstziele für den Server mit dem Namen Server01 ab.

### Beispiel 2: Erhalten von Dienstzielen mithilfe von Filtern
```
...
Dieser Befehl ruft die Dienstziele für den Server mit dem Namen Server01 ab, der mit "System" beginnt.
...
Dieser Befehl ruft die Dienstziele für eine angegebene Azure-Region ab.
...
### -Servername
Gibt den Namen eines Datenbankservers SQL datenbank SQL an.
