...
## BESCHREIBUNG
Das **Get-AzSqlSyncMember-Cmdlet** gibt Informationen zu einem oder mehreren Azure SQL Datenbanksynchronisierungsmitgliedern zurück.
Geben Sie den Namen eines Synchronisierungsmitglieds an, um Informationen nur für dieses Synchronisierungsmitglied zu sehen.
...
### Beispiel 3: Erhalten aller Instanzen von Azure SQL Synchronisierungsmitglied, das einer Synchronisierungsgruppe mithilfe von Filterung zugewiesen wurde
```
...
Dieser Befehl ruft Informationen zu allen Azure SQL Database Sync Member ab, die der Synchronisierungsgruppe SyncGroup01 zugewiesen sind, die mit "SyncMember" beginnt.
