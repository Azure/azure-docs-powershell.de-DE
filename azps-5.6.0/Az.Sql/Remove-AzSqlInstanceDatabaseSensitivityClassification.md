...
## SYNOPSIS
Entfernt die Informationstypen und Vertraulichkeitsbeschriftungen von Spalten in der Azure SQL verwaltete Instanzdatenbank.
...
## BESCHREIBUNG
Das Remove-AzSqlInstanceDatabaseSensitivityClassification cmdlet entfernt die Informationstypen und Vertraulichkeitsbeschriftungen von Spalten in der Azure SQL verwaltete Instanzdatenbank.

## BEISPIELE

### Beispiel 1: Entfernen von Informationstyp und Vertraulichkeitsbeschriftung einer Spalte in einer Azure SQL verwaltete Instanzdatenbank.
```powershell
...
### Beispiel 2: Entfernen aktueller Informationstypen und Vertraulichkeitsbeschriftungen von Spalten in einer Azure SQL verwaltete Instanzdatenbank mit Piping.
```powershell
...
### Beispiel 3: Entfernen von Informationstyp und Vertraulichkeitsbeschriftung einer Spalte in einer Azure SQL verwaltete Instanzdatenbank mit Piping.
```powershell
