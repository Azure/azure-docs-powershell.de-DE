...
## SYNOPSIS
Ruft die SQL schlüssel einer verwalteten Instanz ab.
...
## BESCHREIBUNG
Das Get-AzSqlInstanceKeyVaultKey-Cmdlet ruft Informationen zu den Schlüsseltresorschlüsseln in einer verwalteten SQL ab. Sie können alle Schlüssel in einer verwalteten Instanz anzeigen oder einen bestimmten Schlüssel anzeigen, indem Sie die KeyId bereitstellen.
...
Dieser Befehl ruft alle Schlüssel des Schlüsseltresor für eine verwaltete SQL ab.
...
Dieser Befehl ruft den Schlüsseltresor mit der ID ' https://contoso.vault.azure.net/keys/contosokey/01234567890123456789012345678901 ' ab.

### Beispiel 3: Verwenden des Instanzobjekts
```powershell
...
### Beispiel 5: Verwenden von Piping
```powershell
PS C:\> $managedInstance = Get-AzSqlInstance -Name 'ContosoManagedInstanceName' -ResourceGroupName 'ContosoResourceGroup'
