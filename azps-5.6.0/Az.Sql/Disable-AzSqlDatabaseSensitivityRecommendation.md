...
## BESCHREIBUNG
Das Disable-AzSqlDatabaseSensitivityRecommendation-Cmdlet deaktiviert (schließt) Vertraulichkeitsempfehlungen für Spalten in der Datenbank.
...
### Beispiel 2: Deaktivieren von Vertraulichkeitsempfehlungen für Spalten mit Vertraulichkeitsempfehlungen in einer Azure SQL mit Piping.
```powershell
