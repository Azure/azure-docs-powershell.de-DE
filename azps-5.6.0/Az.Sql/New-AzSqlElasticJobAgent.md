...
## SYNOPSIS
Erstellt einen neuen flexiblen Job-Agent
...
## BESCHREIBUNG
Das New-AzSqlElasticJobAgent cmdlet erstellt einen neuen "Flexiblen Auftrag"-Agent.
...
Erstellt einen neuen Mitarbeiter für einen flexiblen Auftrag
...
### -DatabaseResourceId
Die Ressourcen-ID der Agentsteuerelementdatenbank
