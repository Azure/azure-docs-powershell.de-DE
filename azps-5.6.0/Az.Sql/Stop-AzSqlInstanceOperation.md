...
## BESCHREIBUNG
Das Stop-AzSqlInstanceOperation-Cmdlet beendet den Vorgang mit dem angegebenen Vorgangsnamen für eine SQL verwaltete Instanz.

## BEISPIELE

### Beispiel 1: Einen bestimmten Vorgang erhalten
```powershell
...
Mit diesem Befehl wird der Vorgang mit dem Namen "d0f5bef5-e2b1-4ef8-bb42-2e54073874f9" in einer verwalteten SQL beendet.

### Beispiel 2: Verwenden der Ressourcen-ID des Vorgangs
```powershell
...
### Beispiel 3: Verwenden des Vorgangsobjekts
```powershell
...
Dieser Befehl beendet den Vorgang mit $managedInstanceOperation.
...
### -ResourceId
Die Ressourcen-ID des zu beendende Vorgangsobjekts
