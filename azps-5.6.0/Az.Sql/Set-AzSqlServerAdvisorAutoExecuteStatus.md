...
## BESCHREIBUNG
Das **Cmdlet Set-AzSqlServerAdvisorAutoExecuteStatus** legt die Eigenschaft für die automatische Ausführung für einen Azure SQL Server-Berater fest.
...
Mit diesem Befehl wird der Status der automatischen Ausführung eines Advisors namens CreateIndex aktiviert.
...
### -AutoExecuteStatus
Gibt den Wert an, auf den dieses Cmdlet den Status der automatischen Ausführung aktualisiert.
