...
### Beispiel 1: Holen Sie sich empfohlene Informationstypen und Vertraulichkeitsbeschriftungen einer Azure SQL verwaltete Instanzdatenbank.
```powershell
...
### Beispiel 2: Erhalten Sie empfohlene Informationstypen und Vertraulichkeitsbeschriftungen einer Azure SQL verwaltete Instanzdatenbank mithilfe von Piping.
```powershell
