...
## SYNOPSIS
Deaktiviert die Azure AD-Authentifizierung nur für einen bestimmten SQL Server.
...
## BESCHREIBUNG
Das **Cmdlet Disable-AzSqlServerActiveDirectoryOnlyAuthentication** deaktiviert azure Active Directory (Azure AD) nur die Authentifizierungsanforderung für einen AzureSQL Server im aktuellen Abonnement.
