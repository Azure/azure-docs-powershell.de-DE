...
### Beispiel 1: Aktuelle Informationstypen und Vertraulichkeitsbeschriftungen einer Azure SQL-Datenbank.
```powershell
...
### Beispiel 2: Aktuelle Informationstypen und Vertraulichkeitsbeschriftungen einer Azure SQL Datenbank mit Piping.
```powershell
...
### Beispiel 3: Aktuelle Informationstyp- und Vertraulichkeitsbeschriftung einer bestimmten Spalte einer Azure SQL-Datenbank.
```powershell
...
### Beispiel 4: Aktuelle Informationstyp- und Vertraulichkeitsbeschriftung einer bestimmten Spalte einer Azure SQL-Datenbank mithilfe von Piping.
```powershell
