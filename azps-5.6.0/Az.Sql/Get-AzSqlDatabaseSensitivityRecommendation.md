...
## BESCHREIBUNG
Das Get-AzSqlDatabaseSensitivityRecommendation-Cmdlet gibt die empfohlenen Informationstypen und Vertraulichkeitsbeschriftungen von Spalten in der Datenbank zurück.

## BEISPIELE

### Beispiel 1: Erhalten empfohlener Informationstypen und Vertraulichkeitsbeschriftungen einer Azure SQL Datenbank.
```powershell
...
### Beispiel 2: Erhalten Sie empfohlene Informationstypen und Vertraulichkeitsbeschriftungen einer Azure SQL mithilfe von Piping.
```powershell
