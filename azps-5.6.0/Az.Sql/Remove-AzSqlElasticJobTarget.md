...
### Beispiel 3: Entfernen eines Ziels für einen Pool für einen Flexiblen Pool
```powershell
PS C:\> $tg = Get-AzSqlElasticJobTargetGroup -ResourceGroupName rg -ServerName elasticjobserver -Name tg1
...
Entfernt ein Ziel (Server, Pool, Datenbank und Shardzuordnung) aus einer Zielgruppe.

## PARAMETER

### -AgentName
SQL Name des Datenbank-Agents.
...
### -ElasticPoolName
Name des Zielnamens für einen Pool
