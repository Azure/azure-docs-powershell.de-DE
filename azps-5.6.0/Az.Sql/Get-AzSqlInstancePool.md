...
## BESCHREIBUNG
Das **Get-AzSqlInstancePool-Cmdlet** gibt Informationen zu einem oder mehreren Azure SQL Instanzpool zurück.
Geben Sie den Namen eines Instanzpools an, um Informationen nur für diesen Instanzpool zu sehen.

## BEISPIELE

### Beispiel 1: Alle Instanzpools für ein Kundenabonnement erhalten
```powershell
...
Dieser Befehl ruft Informationen zu allen Instanzpools innerhalb des Kundenabonnements ab.

### Beispiel 2: Alle Instanzpools über eine Ressourcengruppe hinweg erhalten
```powershell
...
Dieser Befehl ruft Informationen zu allen Instanzpools innerhalb der Ressourcengruppenressourcengruppe01 ab.

### Beispiel 3: Informationen zu einem Instanzpool erhalten
```powershell
...
Dieser Befehl ruft Informationen zur Instanzpoolinstanzpool0 ab.

### Beispiel 4: Informationen zu einem Instanzpool mithilfe der Ressourcen-ID des Instanzpools
```powershell
...
Dieser Befehl ruft Informationen zum Instanzpool mit seinem Ressourcenbezeichner ab.
