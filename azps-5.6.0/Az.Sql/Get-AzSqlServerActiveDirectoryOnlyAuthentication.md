...
## SYNOPSIS
Ruft nur azure AD-Authentifizierung für einen bestimmten SQL Server.
...
## BESCHREIBUNG
Das **Get-AzSqlServerActiveDirectoryOnlyAuthentication-Cmdlet** ruft azure Active Directory (Azure AD) nur die Authentifizierungsanforderung für einen AzureSQL Server im aktuellen Abonnement ab.
...
Dieser Befehl ruft azure active Directory (Azure AD) nur Authentifizierungsanforderungen für einen AzureSQL-Server namens Server01 ab, der einer Ressourcengruppe mit dem Namen ResourceGroup01 zugeordnet ist.
...
### -InputObject
Das SQL zu verwendende Serverobjekt.
...
### -Servername
Der Name der Azure-SQL Server azure Active Directory-Authentifizierung ist aktiviert.
