...
## SYNOPSIS
Entfernt einen Schlüsseltresorschlüssel aus einer SQL verwalteten Instanz
...
## BESCHREIBUNG
Das Remove-AzSqlInstanceKeyVaultKey cmdlet entfernt den Schlüsseltresorschlüssel aus der angegebenen verwalteten Instanz. Beachten Sie, dass SQL Berechtigungen der verwalteten Instanz für den Tresor des Schlüssels nicht geändert werden. Zum Ändern von Berechtigungen verwenden Sie Set-AzKeyVaultAccessPolicy. Beachten Sie, dass dieses Cmdlet keine Änderungen am Schlüsseltresor vor nimmt. Wenn Sie einen Schlüssel aus dem Schlüsseltresor entfernen möchten, verwenden Sie Remove-AzureKeyVaultKey.
...
Mit diesem Befehl wird der Schlüsseltresorschlüssel mit der ID ' https://contoso.vault.azure.net/keys/contosokey/01234567890123456789012345678901 ' aus der angegebenen verwalteten Instanz entfernt. 
