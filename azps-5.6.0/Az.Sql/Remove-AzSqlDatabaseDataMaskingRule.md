...
## SYNOPSIS
Entfernt eine Datenformatierungsregel aus einer Datenbank.
...
## BESCHREIBUNG
Das **Cmdlet Remove-AzSqlDatabaseDataMaskingRule** entfernt eine bestimmte Datenformatierungsregel aus einer Azure SQL Datenbank.
Sie können eine Datenformatierungsregel entfernen, indem Sie die Parameter *ResourceGroupName,* *ServerName,* *DatabaseName* und *RuleId* verwenden, um die Regel zu identifizieren, die von diesem Cmdlet entfernt wird.
...
Mit diesem Befehl wird der Regelname Rule01 entfernt, der für die Datenbankdatenbank01 definiert ist.
