...
## SYNOPSIS
Gibt Informationen zu Azure SQL virtuellen Cluster zurück.
...
## BESCHREIBUNG
Das **Get-AzSqlVirtualCluster-Cmdlet** gibt Informationen zu einem oder mehreren Azure SQL virtuellen Clustern zurück.
Geben Sie den Namen eines virtuellen Clusters an, um Informationen nur für diesen Cluster zu sehen.

## BEISPIELE

### Beispiel 1: Alle virtuellen Cluster, die einer Ressourcengruppe zugewiesen sind
```powershell
...
### Beispiel 2: Informationen zu bestimmten virtuellen Clustern
```
...
Dieser Befehl ruft Informationen zum virtuellen Cluster VirtualCluster1 in der Ressourcengruppe ResourceGroup01 ab.
