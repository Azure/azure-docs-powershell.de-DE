...
## SYNOPSIS
Ruft eine oder mehrere langfristige Aufbewahrungssicherungen ab.
...
## BESCHREIBUNG
Das **Get-AzSqlDatabaseLongTermRetentionBackup-Cmdlet** ruft alle langfristigen Aufbewahrungssicherungen für einen Speicherort, einen Server oder eine Datenbank ab oder ruft eine bestimmte langfristige Aufbewahrungssicherung ab.

## BEISPIELE

### Beispiel 1: Alle Sicherungen für einen Speicherort erhalten
```powershell
...
Dieser Befehl ruft alle langfristigen Aufbewahrungssicherungen für alle Datenbanken (die möglicherweise lebendig oder gelöscht werden) in Nordeuropa ab, die Ressourcengruppe wird nur festgelegt, wenn der Server live ist.

### Beispiel 2: Alle Sicherungen für einen Speicherort unter einer Ressourcengruppe
```powershell
...
Dieser Befehl ruft alle langfristigen Aufbewahrungssicherungen für alle Datenbanken (die möglicherweise lebendig oder gelöscht werden) unter einer Ressourcengruppe in Nordeuropa ab.

### Beispiel 3: Erhalten einer bestimmten langfristigen Aufbewahrungssicherung
```powershell
...
Dieser Befehl ruft die Sicherung mit dem Namen 601061b7-d10b-46e0-bf77-a2bfb16a6add;13165566655000000

### Beispiel 4: Alle langfristigen Aufbewahrungssicherungen für eine Datenbank erhalten
```powershell
...
Dieser Befehl ruft alle langfristigen Aufbewahrungssicherungen für Datenbank ab01

### Beispiel 5: Erhalten von langfristigen Aufbewahrungssicherungen mithilfe von Filtern
```powershell
...
### -DatabaseName
Der Name der Azure SQL Datenbank, aus der die Sicherung besteht.
...
### -DatabaseState
Der Zustand der Datenbank, deren Sicherungen Sie suchen möchten, Alive, Deleted oder All.
Standardwerte für "Alle"
...
### -InputObject
Das Datenbankobjekt, für das Sicherungen angezeigt werden sollen.
...
Ob sie nur die neueste Sicherung pro Datenbank erhalten möchten oder nicht.
...
### -ResourceId
Die Datenbankressourcen-ID zum Erhalten von Sicherungen.
...
### -Servername
Der Name des Azure-SQL Server, unter dem die Sicherungen angezeigt werden.
