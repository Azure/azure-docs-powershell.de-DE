...
## SYNOPSIS
Bricht den asynchronen Aktualisierungsvorgang in einem Pool mit einem flexiblen Pool ab.
...
## BESCHREIBUNG
Das **Cmdlet Stop-AzSqlElasticPoolActivity** beendet den asynchronen Aktualisierungsvorgang in einem Pool mit einem flexiblen Pool.

## BEISPIELE

### Beispiel 1: Abbrechen des asynchronen Aktualisierungsvorgangs für einen Pool mit einem flexiblen Pool
```
...
Mit diesem Befehl wird der asynchrone Aktualisierungsvorgang im Pool für die flexiblen Daten abgebrochen.
