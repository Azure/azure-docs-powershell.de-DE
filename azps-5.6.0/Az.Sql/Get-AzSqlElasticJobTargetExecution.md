...
## BESCHREIBUNG
Das Get-AzSqlElasticJobTargetExecution-Cmdlet ruft eine oder mehrere Auftragszielausführungen aus einer Auftragsausführung ab.
...
### Beispiel 2: Ruft eine oder mehrere Auftragszielausführungen aus einer Auftragsausführung ab – Filtern nach Schrittname
```powershell
PS C:\> $je = Get-AzSqlElasticJobExecution -ResourceGroupName rg -ServerName elasticjobserver -AgentName agent -JobName job1 -JobExecutionId 3bcfc912-20b2-411d-a2b7-6265d13fe272
...
### -Aktiv
Kennzeichnen Sie, um nach aktiven Ausführungsausführungen zu filtern.
...
### -Count
Anzahl gibt die höchste Anzahl von Ausführungsausführungen zurück.
...
### -CreateTimeMax
Filtern nach maximaler Erstellungszeit
...
### -ParentResourceId
Die Ressourcen-ID für die Auftragsausführung.
