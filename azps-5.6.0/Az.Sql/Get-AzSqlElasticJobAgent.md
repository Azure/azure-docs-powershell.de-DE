...
## SYNOPSIS
Ruft einen Azure SQL -Mitarbeiter für den flexiblen Auftrag ab
...
## BESCHREIBUNG
Das Get-AzSqlElasticJobAgent-Cmdlet erhält einen oder mehrere "Flexible Job"-Agents.
...
Ruft einen Mitarbeiter für einen flexiblen Auftrag ab.
