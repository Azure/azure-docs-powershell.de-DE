...
## SYNOPSIS
Aktiviert Vertraulichkeitsempfehlungen für Spalten (Empfehlungen sind standardmäßig für alle Spalten aktiviert) in der Datenbank.
...
## BESCHREIBUNG
Das Enable-AzSqlDatabaseSensitivityRecommendation-Cmdlet ermöglicht Vertraulichkeitsempfehlungen für Spalten in der Datenbank.
...
### Beispiel 2: Aktivieren von Vertraulichkeitsempfehlungen für eine bestimmte Spalte Azure SQL Datenbank mithilfe von Piping.
```powershell
