...
## BESCHREIBUNG
Das **Cmdlet Remove-AzSqlInstance** entfernt eine Azure SQL Datenbank verwaltete Instanz.

## BEISPIELE

### Beispiel 1: Entfernen der Instanz
```
PS C:\>Remove-AzSqlInstance -Name "managedInstance1" -ResourceGroupName "ResourceGroup01"
```

Mit diesem Befehl wird die Instanz mit dem Namen "managedInstance1" entfernt.
