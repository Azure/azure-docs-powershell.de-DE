...
## BESCHREIBUNG
Das **Get-AzSqlSyncGroupLog-Cmdlet** gibt die Protokolle einer Azure SQL Database Sync Group zurück.
...
### -EndTime
Die Endzeit der Abfrageprotokolle.
...
Gültige Werte sind: "Fehler", "Warnung", "Erfolg" und "Alles".
