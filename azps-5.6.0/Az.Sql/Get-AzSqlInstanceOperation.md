...
## BESCHREIBUNG
Das Get-AzSqlInstanceOperation-Cmdlet ruft Informationen zu den Vorgängen in einer verwalteten SQL ab. Sie können alle Vorgänge in einer verwalteten Instanz anzeigen oder einen bestimmten Vorgang anzeigen, indem Sie den Namen des Vorgangs bereitstellen.

## BEISPIELE

### Beispiel 1: Alle Instanzenvorgänge erhalten
```powershell
...
Dieser Befehl ruft den Vorgang mit dem Namen "5870c6d8-6703-4b27-8ae4-687b4ca7caea" auf einer verwalteten SQL ab.

### Beispiel 3: Verwenden der Ressourcen-ID des Vorgangs
```powershell
...
Dieser Befehl ruft den Vorgang mit id '/subscriptions/a8c9a924-06c0-4bde-9788-e7b1370969e1/resourceGroups/ps3753/providers ab./Microsoft.Sql/managedInstances/ps3698/operations/5870c6d8-6703-4b27-8ae4-687b4ca7caea'.
...
### -ResourceId
Ressourcenbezeichner für verwaltete Instanzen
