...
## SYNOPSIS
Ruft Azure SQL Server-DNS-Alias ab oder listet diese auf.
...
## BESCHREIBUNG
Holen Sie sich den spezifischen Azure SQL Server-DNS-Alias oder listet alle Server-DNS-Aliase für den Server auf.
...
Ruft server-DNS-Alias ab, der durch den Server- und Aliasnamen angegeben ist.
...
Listet alle Server-DNS-Aliase für den bestimmten Server auf, die mit "dnsaliasname" beginnen.
