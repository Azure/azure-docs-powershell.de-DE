...
## BESCHREIBUNG
Das **Cmdlet Set-AzSqlElasticPoolAdvisorAutoExecuteStatus** legt die Eigenschaft für die automatische Ausführung für einen Azure SQL -Poolratgeber fest.
...
Mit diesem Befehl wird der Status der automatischen Ausführung eines Beraters namens CreateIndex aktiviert.
...
### -AutoExecuteStatus
Gibt einen neuen Wert an, auf den dieses Cmdlet den Status der automatischen Ausführung aktualisiert.
