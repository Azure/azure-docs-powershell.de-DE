...
## BESCHREIBUNG
Das **Cmdlet Enable-AzSqlServerActiveDirectoryOnlyAuthentication** ermöglicht azure Active Directory (Azure AD) nur die Authentifizierungsanforderung für einen AzureSQL Server im aktuellen Abonnement.
...
Mit diesem Befehl wird nur die Authentifizierungsanforderung für Azure Active Directory (Azure AD) für einen AzureSQL-Server namens Server01 aktiviert, der einer Ressourcengruppe mit dem Namen ResourceGroup01 zugeordnet ist.
