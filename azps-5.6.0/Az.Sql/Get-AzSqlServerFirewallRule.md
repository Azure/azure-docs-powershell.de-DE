...
## BESCHREIBUNG
Das **Get-AzSqlServerFirewallRule-Cmdlet** ruft Firewallregeln für einen Azure SQL-Datenbankserver ab.
...
### Beispiel 2: Erhalten aller Regeln für einen Server mithilfe von Filterung
```
...
Dieser Befehl ruft alle Firewallregeln für den Server mit dem Namen Server01 ab, der mit "Regel" beginnt.
