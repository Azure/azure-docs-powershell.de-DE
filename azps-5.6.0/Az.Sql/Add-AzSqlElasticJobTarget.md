...
### Beispiel 3: Hinzufügen eines Ziels für einen Pool für einen Flexiblen Pool
```powershell
...
Fügt einer Zielgruppe ein Ziel (Server, Pool, Datenbank und Shardzuordnung) hinzu.
