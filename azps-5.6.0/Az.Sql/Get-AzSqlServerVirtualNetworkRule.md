...
## BESCHREIBUNG
Dieser Befehl ruft eine bestimmte Azure SQL Server Virtual Network Rule oder eine Liste der Azure SQL Server Regeln für virtuelles Netzwerk unter einem Server ab.
