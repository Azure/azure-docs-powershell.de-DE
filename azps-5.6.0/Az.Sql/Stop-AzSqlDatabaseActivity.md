...
## BESCHREIBUNG
Das **Cmdlet Stop-AzSqlDatabaseActivity** beendet den asynchronen Aktualisierungsvorgang für die Datenbank.

## BEISPIELE

### Beispiel 1: Abbrechen des asynchronen Aktualisierungsvorgangs in der Datenbank
```
...
Mit diesem Befehl wird der asynchrone Aktualisierungsvorgang in der Datenbank abgebrochen.
