...
## BESCHREIBUNG
Das **Cmdlet Set-AzSqlInstance** ändert die Eigenschaften einer Azure SQL Datenbank verwaltete Instanz.
...
### Beispiel 2: Ändern der vorhandenen Instanzhardwaregenerierung mithilfe eines neuen Werts für -ComputeGeneration
```powershell
...
Mit diesem Befehl werden vorhandene Instanzen mit neuen Werten für -AdministratorPassword, -LicenseType, -StorageSizeInGB und -VCore festgelegt.

### Beispiel 3: Festlegen vorhandener Instanzen mit neuen Werten für -AdministratorPassword, -LicenseType, -StorageSizeInGB und -VCore für eine Instanz in einem Instanzpool
```powershell
PS C:\>$InstancePassword = "Newpassword1234"
PS C:\> $SecureString = ConvertTo-SecureString $InstancePassword -AsPlainText -Force
...
Mit diesem Befehl werden vorhandene Instanzen mit neuen Werten für -AdministratorPassword, -LicenseType, -StorageSizeInGB und -VCore für eine Instanz in einem Instanzpool festgelegt.

### Beispiel 4: Aktualisieren der Wartungskonfiguration für vorhandene Instanzen
```powershell
...
Mit diesem Befehl wird die vorhandene Instanz mit Wartungskonfigurationseinstellungen MI_2

### Beispiel 5: Entfernen der Wartungskonfiguration aus einer vorhandenen Instanz
```powershell
...
Dieser Befehl setzt die Wartungskonfiguration auf die Standardeinstellung für vorhandene Instanzen zurück.
...
### -AssignIdentity
Generieren und zuweisen Sie eine Azure Active Directory-Identität für diese Instanz für die Verwendung mit wichtigen Verwaltungsdiensten wie Azure KeyVault.
