...
## SYNOPSIS
Gibt Informationen zu Azure SQL Verwaltete Instanz-Datenbank zurück.
...
## BESCHREIBUNG
Das **Get-AzSqlInstanceDatabase-Cmdlet** ruft eine oder mehrere Azure SQL-Datenbanken aus einer verwalteten Azure SQL-Datenbankinstanz ab.
...
Dieser Befehl ruft alle Datenbanken der Instanz mit dem Namen "managedInstance1" ab.
