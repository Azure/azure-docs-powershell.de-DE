...
## BESCHREIBUNG
Das **Get-AzSqlServer-Cmdlet** gibt Informationen zu einem oder mehreren Azure SQL Datenbankservern zurück.
Geben Sie den Namen eines Servers an, um Informationen nur für diesen Server eins zu sehen.

## BEISPIELE

### Beispiel 1: Alle Instanzen von Ressourcen SQL Server einer Ressourcengruppe zugewiesen
```
...
### Beispiel 3: Alle Instanzen von SQL Server im Abonnement
```
...
### Beispiel 4: Alle Instanzen von Ressourcen SQL Server mithilfe von Filtern einer Ressourcengruppe zugewiesen
```
...
Dieser Befehl ruft Informationen zu allen Azure SQL-Datenbankservern ab, die der Ressourcengruppe ResourceGroup01 zugewiesen sind, die mit "server" beginnen.
...
### -ResourceGroupName
Gibt den Namen der Ressourcengruppe an, denen Server zugewiesen sind.
