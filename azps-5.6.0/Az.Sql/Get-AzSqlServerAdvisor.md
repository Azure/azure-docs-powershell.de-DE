...
## BESCHREIBUNG
Das **Get-AzSqlServerAdvisor-Cmdlet** erhält einen oder mehrere Azure SQL Server-Berater für eine Azure-SQL Server.
...
Dieser Befehl ruft eine Liste aller Berater für den Server mit dem Namen wi-runner-australia-east ab, der zur Ressourcengruppe WIRunnersProd gehört.
...
Dieser Befehl ruft den Berater "CreateIndex" vom Server wi-runner-australia-east ab, dessen empfohlene Aktionen in der Antwort enthalten sind.

### Beispiel 5: List all the advisors for the server using filtering
```
...
Dieser Befehl ruft eine Liste aller Berater für den Server mit dem Namen wi-runner-australia-east ab, der zur Ressourcengruppe WIRunnersProd gehört, die mit dem Buchstaben "d" beginnen.
...
Gibt an, dass das Cmdlet die empfohlenen Aktionen der Berater enthält, die in der Antwort enthalten sind.
