...
## SYNOPSIS
Ändert den Server, auf den Azure SQL Server -DNS-Alias verweisen
...
## BESCHREIBUNG
Mit diesem Befehl wird der Server aktualisiert, auf den der Alias verweisen soll. Dieser Befehl muss ausgegeben werden, während er beim Abonnement angemeldet ist, auf dem sich der neue Server befindet, auf den der Alias verweisen soll.
...
Dieser Befehl aktualisiert den Alias, der zuvor auf "oldServer" zeigte, um auf "server newServer" zu verweisen.
...
### -SourceServerName
Der Name von Azure Sql Server, auf den der Alias derzeit verweisen soll.
