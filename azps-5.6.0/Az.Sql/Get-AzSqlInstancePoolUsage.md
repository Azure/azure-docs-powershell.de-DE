...
## BESCHREIBUNG
Das **Get-AzSqlInstancePoolUsage-Cmdlet** gibt Informationen zurück, die ein Azure SQL -Instanzpool verwendet.
...
Ruft die Verwendung für den Azure SQL-Instanzpoolinstanzpool0 ab.
...
Ruft die Verwendung für den Azure SQL-Instanzpoolinstanzpool0 mithilfe eines Instanzpoolobjekts ab.

### Beispiel 3: Ruft die Verwendung eines Azure SQL-Instanzpools mit einer Ressourcen-ID des Instanzpools ab.
```powershell
...
Ruft die Verwendung für den Azure SQL-Instanzpoolinstanzpool0 mithilfe eines Ressourcenbezeichners für den Instanzpool ab.

### Beispiel 3: Ruft die Verwendung eines Azure SQL-Instanzpools mit einer Aufschlüsselung der verwalteten Instanzennutzungen im Pool ab.
```powershell
...
Ruft die Verwendung für den Azure SQL-Instanzpoolinstanzpool0 zusammen mit den Verwendungen der verwalteten Instanzen in instancepool0 ab.
...
### -ExpandChildren
Kennzeichnung, die angibt, ob die Nutzung dieses Instanzpools mit der Nutzung der Kinder erweitert werden soll.
