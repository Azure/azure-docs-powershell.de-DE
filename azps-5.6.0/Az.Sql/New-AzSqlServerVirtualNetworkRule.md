...
## SYNOPSIS
Erstellt eine Azure SQL Server Virtual Network Rule. 
...
## BESCHREIBUNG
Erstellt eine Azure SQL Server Virtual Network Rule. Regeln für virtuelle Netzwerke werden verwendet, um die Azure SQL Server mit einem bestimmten virtuellen Netzwerk zu verbinden, um den Zugriff auf azure SQL Server nur im virtuellen Netzwerk verfügbar zu sein. 
