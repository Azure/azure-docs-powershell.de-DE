...
## BESCHREIBUNG
Das **Get-AzSqlServerAudit-Cmdlet** ruft die Überwachungseinstellungen eines Azure-SQL ab.
Geben Sie die *Parameter ResourceGroupName* und *ServerName an,* um den Server zu identifizieren.

## BEISPIELE

### Beispiel 1: Erhalten der Überwachungseinstellungen eines Azure SQL Server
```
...
### Beispiel 3: Erhalten der Überwachungseinstellungen eines Azure SQL Server
```
PS C:\>Get-AzSqlServerAudit -ResourceGroupName "resourcegroup01" -ServerName "server01"
ServerName                          : server01
ResourceGroupName                   : resourcegroup01
