...
## BESCHREIBUNG
Das **Cmdlet Set-AzSqlServerDisasterRecoveryConfiguration** ändert eine SQL Datenbankserverwiederherstellungskonfiguration.
...
### -AllowDataLoss
Gibt an, dass der Failovervorgang Datenverlust zulässt.
