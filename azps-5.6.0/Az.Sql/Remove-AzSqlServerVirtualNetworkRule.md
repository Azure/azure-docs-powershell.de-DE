...
## SYNOPSIS
Löscht eine Azure SQL Server Virtual Network Rule.
...
Löscht eine vorhandene Azure SQL Server Regel für virtuelles Netzwerk
...
Name der Azure Sql Server Virtual Network Rule
