...
## SYNOPSIS
Ruft die Georeplikationsverknüpfungen zwischen einer Azure SQL-Datenbank und einer Ressourcengruppe oder einer SQL Server.
...
## BESCHREIBUNG
Das **Get-AzSqlDatabaseReplicationLink-Cmdlet** ersetzt das **Get-AzSqlDatabaseCopy-Cmdlet.**
...
Ruft die Georeplikationsverknüpfungen zwischen einer Azure SQL-Datenbank und einer Ressourcengruppe oder einer SQL Server. (automatisch generiert)
...
### -DatabaseName
Gibt den Namen der datenbank SQL an, für die Links abgerufen werden sollen.
...
### -PartnerServerName
Gibt den Namen der Azure-SQL Server für den Partner an.
...
### -ResourceGroupName
Gibt den Namen der Azure-Ressourcengruppe für die Datenbank an, für die Links abgerufen werden sollen.
...
### -Servername
Gibt den Namen des SQL Server an, für den die Datenbank Verknüpfungen abrufen soll.
