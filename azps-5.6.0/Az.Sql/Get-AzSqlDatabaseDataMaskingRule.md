...
## SYNOPSIS
Ruft die Datenformatierungsregeln aus einer Datenbank ab.
...
## BESCHREIBUNG
Das **Get-AzSqlDatabaseDataMaskingRule-Cmdlet** ruft entweder eine bestimmte Datenformatierungsregel oder alle Datenformatierungsregeln für eine Azure SQL ab.
Um das Cmdlet zu verwenden, verwenden Sie die *Parameter ResourceGroupName,* *ServerName* und *DatabaseName,* um die Datenbank zu identifizieren, und geben Sie mit dem Parameter *RuleId* an, welche Regel dieses Cmdlet zurückgibt.
Wenn Sie RuleId nicht *bereitstellen,* werden alle Datenformatierungsregeln für diese Azure SQL zurückgegeben.
Dieses Cmdlet wird auch vom SQL Server Stretch Database Service in Azure unterstützt.

## BEISPIELE

### Beispiel 1: Alle Datenformatierungsregeln aus einer Datenbank erhalten
```
...
### Beispiel 2: Die Datenformatierungsregel wird in Schema "dbo", Tabelle "Tabelle1" und Spalte "Spalte1" definiert.
```
