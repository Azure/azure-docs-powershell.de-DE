...
### Beispiel 1: Ruft die verwaltete Instanz Advanced Data Security ab.
```powershell
...
### Beispiel 2: Ruft verwaltete Instanz Advanced Data Security von einer verwalteten Instanzressource ab.
```powershell
