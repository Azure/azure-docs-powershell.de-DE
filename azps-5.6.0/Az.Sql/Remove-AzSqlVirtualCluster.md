...
## SYNOPSIS
Entfernt einen azure SQL virtuellen Cluster.
...
## BESCHREIBUNG
Das **Cmdlet Remove-AzSqlVirtualCluster** entfernt ein Azure SQL virtuellen Cluster.
...
Mit diesem Befehl wird der virtuelle Cluster mit dem Namen VirtualCluster1 entfernt, der der Ressourcengruppe ResourceGroup01 zugewiesen ist.
