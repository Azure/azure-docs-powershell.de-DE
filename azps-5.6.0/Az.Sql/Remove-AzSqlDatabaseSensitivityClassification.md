...
### Beispiel 1: Entfernen von Informationstyp und Vertraulichkeitsbeschriftung einer Spalte in einer Azure SQL Datenbank.
```powershell
...
### Beispiel 3: Entfernen von Informationstyp und Vertraulichkeitsbeschriftung einer Spalte in einer Azure SQL mithilfe von Piping.
```powershell
