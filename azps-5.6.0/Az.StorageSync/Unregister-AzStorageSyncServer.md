...
## BESCHREIBUNG
Mit diesem Befehl wird die Registrierung eines Servers vom Speichersynchronisierungsdienst aufgehoben. Warnung: Das Aufheben der Registrierung eines Servers führt dazu, dass alle Serverendpunkte auf diesem Server kaskadiert werden. Sie sollte nur aufgerufen werden, wenn Sie sicher sind, dass kein Pfad mehr auf diesem Server synchronisiert werden soll.
...
Mit diesem Befehl wird die Registrierung des Servers aufgehoben, wodurch alle Serverendpunkte auf diesem Server cascading gelöscht werden.
