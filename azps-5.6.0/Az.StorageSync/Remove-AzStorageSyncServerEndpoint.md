...
## BESCHREIBUNG
Das Entfernen eines Serverendpunkts ist ein zerstörerischer Vorgang. Dieser Serverspeicherort beendet die Synchronisierung. Dieser Vorgang sollte nicht ausgeführt werden, um Synchronisierungsprobleme zu beheben. Wenn dieser Serverspeicherort (einschließlich der Dateien) derselben Synchronisierungsgruppe wie ein Serverendpunkt erneut hinzugefügt wird, kann dies zu Konfliktdateien und anderen unbeabsichtigten Folgen führen. Dieser Befehl ist nur für die Außerbetriebnahme vorgesehen.
