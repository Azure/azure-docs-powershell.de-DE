...
## BESCHREIBUNG
Mit diesem Befehl wird ein Azure File Sync-Cloudendpunkt erstellt. Ein Cloudendpunkt ist ein Verweis auf eine vorhandene Azure-Dateifreigabe. Sie stellt die Dateifreigabe dar und definiert die Teilnahme an der Synchronisierung aller Dateien in der Synchronisierungsgruppe, in der der Cloudendpunkt erstellt wurde.
...
Ein Cloudendpunkt ist ein integrales Mitglied einer Synchronisierungsgruppe. Dies ist ein Beispiel für das Erstellen eines Endpunkts innerhalb einer vorhandenen Synchronisierungsgruppe mit dem Namen "mySyncGroupName".
...
### -AzureFileShareName
Name der Speicherkontofreigabe (Name der Azure-Dateifreigabe)
...
### -Name
Name des Cloudendpunkts. Wenn sie über das Azure-Portal erstellt wird, wird Name auf den Namen der Azure-Datei festgelegt, auf die sie verweist.
