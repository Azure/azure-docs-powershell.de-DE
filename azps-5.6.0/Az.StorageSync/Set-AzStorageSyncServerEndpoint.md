...
## BESCHREIBUNG
Dieser Befehl ermöglicht Änderungen an den anpassbaren Parametern eines Serverendpunkts. Beispielsweise können Richtlinien für Cloud tiering und cloud tiering jederzeit geändert werden. Mehrere Aspekte eines Serverendpunkts, z. B. der lokale Pfad, können nach dem Erstellen des Serverendpunkts nicht geändert werden.
