...
## BESCHREIBUNG
Das Resume-AzAnalysisServicesServer-Cmdlet setzt eine Instanz des Analysis Services-Servers fort.
...
Mit diesem Befehl wird ein angehaltener Server mit dem Namen Testserver in der Testgruppe der Ressourcengruppe fortgesetzt.
