...
### Beispiel 1: Aktualisieren der Frühlings-Cloud-App nach Name.
```powershell
...
Aktualisieren Sie die Frühlings-Cloud-App nach Name.

### Beispiel 2: Aktualisieren der Quell-Cloud-App von pipe.
```powershell
...
Aktualisieren Sie die Frühlings-Cloud-App über pipe.
...
### -Location
Der GEO-Speicherort der Anwendung, immer identisch mit der übergeordneten Ressource
...
Mountpfad des beständigen Datenträgers
...
Mountpfad des temporären Datenträgers
