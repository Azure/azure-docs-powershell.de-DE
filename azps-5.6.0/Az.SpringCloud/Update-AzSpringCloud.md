...
### Beispiel 1: Aktualisieren des Quellwolkendiensts nach Name.
```powershell
...
### Beispiel 2: Aktualisieren des Quellwolkendiensts von pipe.
```powershell
...
Aktualisieren Sie den Frühlingswolkendienst über pipe.
...
### -Location
Der GEO-Speicherort der Ressource.
...
### -TraceAppInsightInstrumentationKey
Instrumentierungsschlüssel für die Zielanwendungserblicke
