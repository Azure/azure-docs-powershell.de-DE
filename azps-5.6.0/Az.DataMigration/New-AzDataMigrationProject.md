...
## BESCHREIBUNG
Das New-AzDataMigrationProject-Cmdlet erstellt ein neues Azure-Datenbankmigrationsdienstprojekt. Dieses Cmdlet enthält alle erforderlichen Parameter, z. B. den Namen der Azure-Ressourcengruppe, den Namen des Azure Data Migration Service, in dem ein neues Projekt erstellt werden soll, den Bereich, in dem das Projekt erstellt werden soll, den eindeutigen Namen des neuen Projekts, die Quell- und Zielverbindungsobjekte und das Zieltypobjekt als Eingabe für die Liste der zu migrierenden Datenbanken. Verwenden Sie New-AzDataMigrationConnectionInfo-Cmdlet, um ein neues ConnectionInfo-Objekt sowohl für die Quell- als auch für die Zielverbindungen zu erstellen. Die Liste von Microsoft.Azure.Management.DataMigration.Models.DatabaseInfo wird für ausgewählte Datenbanken erwartet. Dieses Objekt kann mithilfe eines cmdlets New-AzDataMigrationDatabaseInfo werden. 
...
Das vorstehende Beispiel zeigt, wie Sie ein neues Projekt mit dem Namen MyDMSProject erstellen, das sich in der Region "Usa, Mitte" unter der Azure Database Migration Service-Instanz mit dem Namen TestService befindet.
...
### -Location
Der Speicherort der Azure Database Migration Service-Instanz.
...
### -ServiceName
Der Name der Azure Database Migration Service-Instanz.
