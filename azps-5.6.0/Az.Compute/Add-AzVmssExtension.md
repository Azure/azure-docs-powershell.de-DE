...
## BESCHREIBUNG
Das **Add-AzVmssExtension-Cmdlet** fügt dem VmSS (Virtual Machine Scale Set) eine Erweiterung hinzu.
...
Dieser Befehl fügt dem VMSS eine Erweiterung mit einem Beispiel-Bash-Skript für einen Blobspeicher hinzu, und geben Sie die URL des Blobspeichers und des ausführbaren Befehls in Den Einstellungen und dem Sicherheitszugriff in geschützten Einstellungen an. 
...
### -ForceUpdateTag
Wenn ein Wert angegeben wird und sich vom vorherigen Wert abwechselt, wird der Erweiterungshandler gezwungen, zu aktualisieren, auch wenn sich die Erweiterungskonfiguration nicht geändert hat.
...
Sammlung von Erweiterungsnamen, nach der diese Erweiterung bereitgestellt werden muss.
...
Dies kann das [Get-AzVMImagePublisher-Cmdlet](./Get-AzVMImagePublisher.md) verwenden, um den Herausgeber zu erhalten.
...
Dieses Cmdlet verschlüsselt die öffentliche Konfiguration nicht.
...
Sie können das [Get-AzVMExtensionImageType-Cmdlet](./Get-AzVMExtensionImageType.md) verwenden, um den Erweiterungstyp zu erhalten.
...
Sie können das [Get-AzVMExtensionImage-Cmdlet](./Get-AzVMExtensionImage.md) verwenden, um die Version der Erweiterung zu erhalten.
...
Sie können die [New-AzVmssConfig verwenden,](./New-AzVmssConfig.md) um das -Objekt zu erstellen.
