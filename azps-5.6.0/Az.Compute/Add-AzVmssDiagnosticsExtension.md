...
## BESCHREIBUNG
Das **Cmdlet Add-AzVmssDiagnosticsExtension** fügt der VmSS-Instanz (Virtual Machine Scale Set) eine Diagnoseerweiterung hinzu.
...
Mit diesem Befehl wird dem VMSS eine Diagnoseerweiterung hinzufügt.
...
Führen Sie zum Abrufen der Version das [Get-AzVMExtensionImage-Cmdlet](./Get-AzVMExtensionImage.md) mit dem Wert Microsoft.Azure.Diagnostics für den *Parameter PublisherName* und IaaSDiagnostics für den Parameter *Type* aus.
