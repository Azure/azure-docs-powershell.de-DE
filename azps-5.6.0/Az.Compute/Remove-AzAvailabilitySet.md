...
## BESCHREIBUNG
Das **Cmdlet Remove-AzAvailabilitySet** entfernt einen Verfügbarkeitssatz aus Azure.

## BEISPIELE

### Beispiel 1: Entfernen eines Verfügbarkeitssets
```
PS C:\> Remove-AzAvailabilitySet -Name "AvailabilitySet03" -ResourceGroupName "ResourceGroup11"
```

Mit diesem Befehl wird ein Verfügbarkeitssatz mit dem Namen AvailabilitySet03 in der Ressourcengruppe "ResourceGroup11" entfernt.
...
### -Name
Der Name des Verfügbarkeitssatzs.
