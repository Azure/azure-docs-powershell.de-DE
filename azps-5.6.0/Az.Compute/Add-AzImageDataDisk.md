...
## BESCHREIBUNG
Das **Add-AzImageDataDisk-Cmdlet** fügt einem Bildobjekt einen Datenträger hinzu.
...
Mit den nächsten drei Befehlen werden pfade des Betriebssystemdatenträgers und zwei Datenträger den Variablen $osDiskVhdUri, $dataDiskVhdUri 1 und $dataDiskVhdUri 2 zugewiesen.
...
### -BlobUri
Gibt den Link als URI des Blobs an.
