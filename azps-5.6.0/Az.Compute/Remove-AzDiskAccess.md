...
### Beispiel 1: Entfernen des Festplattenzugriffs mit dem Standardparametersatz
```
...
### Beispiel 2: Entfernen des Festplattenzugriffs mithilfe der Ressourcen-ID
```
...
### Beispiel 4: Entfernen des Datenträgerzugriffs durch Piping Input Object
```
PS C:\> Get-AzDiskAccess -ResourceGroupName "ResourceGroup01" -Name "DiskAccess01" | Remove-AzDiskAccess 
```

Mit diesem Befehl wird der Datenträgerzugriff entfernt, indem das InputObject
...
### -InputObject
PowerShell-Datenträgerzugriffsobjekt
