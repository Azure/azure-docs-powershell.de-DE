...
## BESCHREIBUNG
Das Update-AzVmssInstance-Cmdlet startet ein manuelles Upgrade der angegebenen VMSS-Instanz (Virtual Machine Scale Set).
...
Mit diesem Befehl wird ein Upgrade des VMSS namens VMScaleSet001 gestartet, das die Instanz-ID 0 hat.
