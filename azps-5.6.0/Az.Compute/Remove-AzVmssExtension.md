...
## SYNOPSIS
Entfernt eine Erweiterung aus dem VMSS.
...
## BESCHREIBUNG
Das **Cmdlet Remove-AzVmssExtension** entfernt eine Erweiterung aus dem VmSS (Virtual Machine Scale Set).
...
Mit diesem Befehl wird die Erweiterungs-ID des VMSS entfernt, der zur Ressourcengruppe "Group002" gehört.
...
### -ID
Gibt die ID der Erweiterung an, die von diesem Cmdlet aus dem VMSS entfernt wird.
