...
## BESCHREIBUNG
Das **Cmdlet Set-AzVMADDomainExtension** fügt einem virtuellen Computer eine Azure Active Directory (AD)-Domänenerweiterung hinzu.
...
### -JoinOption
Gibt die Verknüpfungsoption an. Verknüpfungsoptionen finden Sie [unter fJoinOptions](https://docs.microsoft.com/windows/desktop/api/lmjoin/nf-lmjoin-netjoindomain)
...
Geben Sie den vollständigen Namen der Organisationseinheit in Anführungszeichen ein.
Der Standardwert ist die Standard-OU für Computerobjekte in der Domäne.
...
### -Neustart
Gibt an, dass mit diesem Cmdlet der virtuelle Computer neu gestartet wird.
Um die Änderung wirksam zu machen, ist häufig ein Neustart erforderlich.
