...
## BESCHREIBUNG
Das **Get-AzVM-Cmdlet** ruft die Modellansicht oder die Instanzansicht eines virtuellen Azure-Computers ab.
...
Geben Sie *den Parameter Status* an, um die Instanzansicht eines virtuellen Computers anstelle der Modellansicht zu erhalten, die die Standardansicht ist.

## BEISPIELE

### Beispiel 1: Modell- und Instanzansichtseigenschaften erhalten
```
...
Dieser Befehl ruft die Modellansichts- und Instanzansichtseigenschaften des virtuellen Computers mit dem Namen VirtualMachine07 ab.

### Beispiel 2: Anzeigen von Instanzansichtseigenschaften
```
...
Dieser Befehl ruft Eigenschaften für alle virtuellen Computer in der Ressourcengruppe "ResourceGroup11" ab.

### Beispiel 4: Alle virtuellen Computer in Ihrem Abonnement erhalten
```
PS C:\> Get-AzVM
...
### Beispiel 6: Verwenden der Filterung für alle virtuellen Computer
```
...
### -Location
Gibt einen Speicherort für die zu listenden virtuellen Computer an.
