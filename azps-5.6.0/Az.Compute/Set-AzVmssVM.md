...
## BESCHREIBUNG
Das **Cmdlet Set-AzVmssVM** ändert den Zustand einer VMSS-Instanz (Virtual Machine Scale Set).
...
### -PerformMaintenance
Gibt an, dass dieses Cmdlet die Wartung auf einem virtuellen Computer im VMSS durchführt.
...
### -Redeploy
Gibt an, dass mit diesem Cmdlet ein virtueller Computer im VMSS erneut bereitgestellt wird.
...
### -Reimage
Gibt an, dass dieses Cmdlet die VMSS-Instanz neu abbildt.
...
### -ReimageAll
Gibt an, dass das Cmdlet alle Datenträger in der VMSS-Instanz neu abbildt.
...
### -SimulateEviction
Gibt an, dass dieses Cmdlet die Räumung des virtuellen Spotcomputers in einem VM-Skalierungssatz simuliert.
Die Räumung erfolgt innerhalb von 30 Minuten nach dem Aufrufen der API.
