...
## SYNOPSIS
Erstellt ein konfigurierbares Datenträgerupdateobjekt.
...
## BESCHREIBUNG
Das **Cmdlet New-AzDiskUpdateConfig** erstellt ein konfigurierbares Datenträgerupdateobjekt.
...
Mit dem ersten Befehl wird ein lokales leeres Datenträgeraktualisierungsobjekt mit der Größe 10 GB in Premium_LRS Speicherkontotyp erstellt. Außerdem wird der Windows -Betriebssystemtyp festgelegt und Verschlüsselungseinstellungen aktiviert. Mit dem zweiten und dritten Befehl werden die Einstellungen für den Datenträgerverschlüsselungsschlüssel und die Schlüsselverschlüsselungsschlüssel für das Datenträgeraktualisierungsobjekt festgelegt.
...
### -DiskMBpsReadOnly
Der Gesamtdurchsatz (MBps), der für alle VMs zulässig ist, die den freigegebenen Datenträger als ReadOnly bereitstellen. MBps bedeutet Millionen von Bytes pro Sekunde – MB verwendet hier die ISO-Notation mit den Befugnissen 10.
...
### -MaxSharesCount
Die maximale Anzahl von VMs, die gleichzeitig an den Datenträger anfügen können. Der Wert größer als ein Wert gibt einen Datenträger an, der gleichzeitig auf mehreren VMs bereitgestellt werden kann.
