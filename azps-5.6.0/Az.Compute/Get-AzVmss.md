...
## BESCHREIBUNG
Das **Get-AzVmss-Cmdlet** ruft das Modell und die Instanzansicht eines VmSS (Virtual Machine Scale Set) ab.
Bei der Modellansicht handelt es sich um die vom Benutzer angegebenen Eigenschaften des Skalierungssatzs für virtuelle Computer.
Die Instanzansicht ist der Status der Instanzebene des Skalierungssatzs für virtuelle Computer.
Geben Sie den *Parameter InstanceView* an, um nur die Instanzansicht eines Skalierungssatzs für virtuelle Computer zu erhalten.
...
Dieser Befehl ruft die Eigenschaften des VMSS namens VMSS001 ab, das zur Ressourcengruppe "Group001" gehört.
Da der Befehl den *Parameter des InstanceView-Schalters* nicht anrät, ruft das Cmdlet die Modellansicht des Skalierungssets für virtuelle Computer ab.
...
Alle Vmss in der Ressourcengruppe "Group001"

### Beispiel 3: Alle Vmss in einem Abonnement erhalten
```
PS C:\> Get-AzVmss
...
Alle Vmss im Abonnement erhalten.

### Beispiel 4: Alle Vms mit Filterung erhalten
```
...
### -InstanceView
Gibt an, dass dieses Cmdlet nur die Instanzansicht des Skalierungssets für virtuelle Computer erhält.
...
### -OSUpgradeHistory
Gibt an, dass in diesem Cmdlet der Upgradeverlauf des Betriebssystems des Skalierungssets für virtuelle Computer aufgeführt ist.
