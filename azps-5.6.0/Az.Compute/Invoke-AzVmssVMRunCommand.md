...
## SYNOPSIS
Ausführen des Befehls auf der VIRTUELLEN Computer-Skalierungssatz-VM.
...
## BESCHREIBUNG
Rufen Sie einen Ausführungsbefehl auf der VM für den Skalierungssatz virtueller Computer auf.
...
### -InstanceId
Die Instanz-ID der Skalierungssatz-VM für virtuelle Computer.
...
### -ScriptPath
Pfad des skripts, das ausgeführt werden soll.  Wenn dieser Wert angegeben wird, überschreibt das angegebene Skript das Standardskript des Befehls.
...
### -VMScaleSetName
Der Name der Skalierungssatz-VM für virtuelle Computer.
