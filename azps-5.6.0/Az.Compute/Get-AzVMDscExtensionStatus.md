...
## BESCHREIBUNG
Das **Cmdlet Get-AzVMDscExtensionStatus** ruft den Status des Erweiterungshandlers Für die Gewünschte Zustandskonfiguration (Desired State Configuration, DSC) für einen virtuellen Computer in einer Ressourcengruppe ab.
Wenn eine Konfiguration angewendet wird, führt dieses Cmdlet zu einer einheitlichen Ausgabe mit Start-DscConfiguration cmdlet.
...
Das Set-AzVMDscExtension-Cmdlet legt diesen Namen auf Microsoft.Powershell.DSC fest. Dies ist derselbe Wert, der von **Get-AzVMDscExtensionStatus verwendet wird.**
Geben Sie diesen Parameter nur an, wenn Sie den Standardnamen im Cmdlet Festlegen geändert oder einen anderen Ressourcennamen in einer Resource Manager-Vorlage verwendet haben.
