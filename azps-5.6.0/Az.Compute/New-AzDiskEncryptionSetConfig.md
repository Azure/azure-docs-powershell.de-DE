...
## SYNOPSIS
Erstellt ein konfigurierbares Datenträgerverschlüsselungssatzobjekt.
...
### -EncryptionType
Verwenden Sie diese, um den Verschlüsselungstyp des Datenträgerverschlüsselungssatzs zu festlegen. Verfügbare Werte sind: "EncryptionAtRestWithPlatformKey", "EncryptionAtRestWithCustomerKey".
...
### -IdentityType
Der Typ der verwalteten Identität, der vom DiskEncryptionSet verwendet wird. Nur SystemAssigned wird unterstützt.
...
### -SourceVaultId
Ressourcen-ID des KeyVault, das den aktiven Schlüssel enthält.
