...
## SYNOPSIS
Erstellt ein lokales Datenträgerobjekt für einen virtuellen Computer oder eine Vmss-VM.
...
## BESCHREIBUNG
Das **Cmdlet New-AzVMDataDisk** erstellt ein lokales Datenträgerobjekt für einen virtuellen Computer oder eine Vmss VM.
...
Mit dem letzten Befehl wird die VM vmss aktualisiert, indem ein neuer Datenträger hinzugefügt wird.

### Beispiel 2

Erstellt ein lokales Datenträgerobjekt für einen virtuellen Computer oder eine Vmss-VM. (automatisch generiert)
...
### -Zwischenspeichern
Die Zwischenspeicherung des Datenträgers des virtuellen Computers.
...
### -CreateOption
Die Option zum Erstellen des Virtuellen Computerdatenträgers.
...
### -DiskEncryptionSetId
Die ID des vom virtuellen Computer verwalteten Datenträgerverschlüsselungssatzs.
...
### -Lun
Lun des Virtuellen Computerdatenträgers.
...
### -ManagedDiskId
Die ID des virtuellen Computers verwaltet.
...
### -Name
Der Name des Datenträgers des virtuellen Computers.
...
### -SourceImageUri
Der Quellbild-Uri des Betriebssystems des virtuellen Computers.
