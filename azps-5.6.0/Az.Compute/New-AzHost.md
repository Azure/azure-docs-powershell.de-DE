...
## BESCHREIBUNG
Dieses Cmdlet erstellt einen Host.
...
Gibt an, ob der Host bei einem Fehler automatisch ersetzt werden soll. Der Wert ist standardmäßig auf "true" festgelegt, wenn er nicht angegeben wird.
...
### -LicenseType
Gibt den Softwarelizenztyp an, der auf die VMs angewendet wird, die auf dem Host bereitgestellt werden. Mögliche Werte sind: Keine, Windows_Server_Hybrid und Windows_Server_Perpetual.  Der Standardwert ist "None".
...
### -PlatformFaultDomain
Gibt die Anzahl der Plattformfehlerdomäne des Hosts an.  Der Mindestwert ist dann 0, und der maximale Wert ist 2.
