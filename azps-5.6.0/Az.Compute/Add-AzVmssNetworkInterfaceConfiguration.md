...
## BESCHREIBUNG
Das **Cmdlet Add-AzVmssNetworkInterfaceConfiguration** fügt dem VmSS (Virtual Machine Scale Set) eine Netzwerkschnittstellenkonfiguration hinzu.
...
Gibt an, ob die Netzwerkschnittstelle mit beschleunigter Netzwerkverbindung aktiviert ist.
...
ID der Netzwerksicherheitsgruppe.
...
### -Primär
Gibt an, ob netzwerkschnittstellen, die aus der Netzwerkschnittstellenkonfiguration erstellt wurden, das primäre Netzwerkinformationscenter (NIC) des virtuellen Computers sein werden.
