...
Mit diesem Befehl wird dem VMSS-Objekt ein leerer Datenträger hinzufügt.

## PARAMETER

### -Zwischenspeichern
Gibt den Zwischenspeichertyp des Datenträgers an.
...
### -DiskIOPSReadWrite
Gibt die Read-Write IOPS für den verwalteten Datenträger an. Sollte nur verwendet werden, wenn StorageAccountType UltraSSD_LRS. Wenn nicht angegeben, wird ein Standardwert basierend auf diskSizeGB zugewiesen.
...
### -DiskMBpsReadWrite
Gibt die Bandbreite in MB pro Sekunde für den verwalteten Datenträger an. Sollte nur verwendet werden, wenn StorageAccountType UltraSSD_LRS. Wenn nicht angegeben, wird ein Standardwert basierend auf diskSizeGB zugewiesen.
