...
## BESCHREIBUNG
Das **Cmdlet Set-AzVmss** legt bestimmte Aktionen für den VmSS (Virtual Machine Scale Set) fest.
...
Mit diesem Befehl wird der VMSS namens ContosoVMSS, der zur Ressourcengruppe "ContosoGroup" gehört, erneut nachviert.

### Beispiel 2

Legt bestimmte Aktionen für einen angegebenen VMSS fest. (automatisch generiert)
...
### -PerformMaintenance
Gibt an, dass dieses Cmdlet die Wartung eines oder mehrere virtueller Computer im VMSS durchführt.
...
### -Redeploy
Gibt an, dass das Cmdlet einen oder mehrere virtuelle Computer im VMSS erneut bereitstellen kann.
...
### -Reimage
Gibt an, dass das Cmdlet das VMSS neu abbildt.
...
### -ReimageAll
Gibt an, dass das Cmdlet alle Datenträger im VMSS neu abbildt.
...
### -VMScaleSetName
Artiert den Namen des VMSS, für den dieses Cmdlet Aktionen legt.
