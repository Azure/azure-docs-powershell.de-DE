...
## SYNOPSIS
Ändert die TDE-Eigenschaft für einen SQL Pool.
...
## BESCHREIBUNG
Das **Cmdlet Set-AzSynapseSqlPoolTransparentDataEncryption** ändert die Eigenschaft Transparente Datenverschlüsselung (Transparent Data Encryption, TDE) eines Azure Synapse Analytics SQL Pool.
...
Mit diesem Befehl wird TDE für den SQL ContosoSqlPool unter dem Arbeitsbereich "ContosoWorkspace" aktiviert.
...
### -State
Der Zustand der transparenten Datenverschlüsselung in Azure Synapse Analytics Sql Pool.
