...
Dieser Befehl wartet, bis der Auftrag mit der angegebenen ID abgeschlossen ist.
...
### -SparkJobObject
Sparkauftragseingabeobjekt, das normalerweise über die Pipeline übergeben wird.
...
### -TimeoutInSeconds
Die maximale Wartezeit vor dem Fehler. Der Standardwert ist das Nie-Timeout.
...
Das Abrufintervall zwischen den Überprüfungen für den Auftragsstatus in Sekunden.
