...
## BESCHREIBUNG
Das Get-AzSynapseSqlPoolSensitivityClassification-Cmdlet gibt die aktuellen Informationstypen und Vertraulichkeitsbeschriftungen von Spalten im Azure Synapse-SQL zurück.
...
### Beispiel 2: Aktuelle Informationstypen und Vertraulichkeitsbeschriftungen eines Azure Synapse SQL mit Piping.
```powershell
...
### Beispiel 3: Aktuelle Informationstyp- und Vertraulichkeitsbeschriftung einer bestimmten Spalte eines Azure Synapse-SQL erhalten.
```powershell
...
### Beispiel 4: Aktuelle Informationstyp- und Vertraulichkeitsbeschriftung einer bestimmten Spalte eines Azure Synapse-SQL mit Piping.
```powershell
