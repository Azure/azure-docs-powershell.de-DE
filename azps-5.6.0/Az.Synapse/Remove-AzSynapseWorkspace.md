...
## BESCHREIBUNG
Das **Cmdlet Remove-AzSynapseWorkspace** löscht einen Azure Synapse Analytics-Arbeitsbereich endgültig.
...
Mit diesem Befehl wird ein Azure Synapse Analytics-Arbeitsbereich über eine Pipeline gelöscht.
...
Mit diesem Befehl wird ein Azure Synapse Analytics-Arbeitsbereich über eine Pipeline mit der angegebenen Ressourcen-ID gelöscht.
