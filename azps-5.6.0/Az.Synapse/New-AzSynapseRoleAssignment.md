...
## SYNOPSIS
Erstellt eine Synapse Analytics-Rollenzuordnung.
...
## BESCHREIBUNG
Das **Cmdlet New-AzSynapseRoleAssignment** erstellt eine Azure Synapse Analytics-Rollenzuordnung.
...
Mit diesem Befehl wird ContosoRole dem Benutzer zugewiesen, dessen Hauptname ContosoName ist.
...
Mit diesem Befehl wird ContosoRole dem Benutzer zugewiesen, dessen Hauptname contosoName über die Pipeline ist.
