...
## SYNOPSIS
Sendet einen Synapse Analytics Spark-Auftrag.
...
## BESCHREIBUNG
Das **Cmdlet Submit-AzSynapseSparkJob** sendet einen Synapse Analytics Spark-Auftrag.
...
Mit diesem Befehl wird ein Synapse Analytics Spark-Auftrag übermittelt.
...
Mit diesem Befehl wird ein PySpark-Auftrag von Synapse Analytics übermittelt.
...
### -Sprache
Sprache des zu übermittelnden Auftrags.
...
Erforderlich für Spark- und .NET Spark-Auftrag.
...
### -MainDefinitionFile
Die Hauptdatei, die für den Auftrag verwendet wird.
...
### -ReferenceFile
Zusätzliche Dateien, die als Referenz in der Hauptdefinitionsdatei verwendet werden. Durch Kommas getrennte Speicher-URI-Liste. z. B. " abfss://filesystem@account.dfs.core.windows.net/file1.txt , abfss://filesystem@account.dfs.core.windows.net/result/ "
