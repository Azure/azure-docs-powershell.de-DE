...
## BESCHREIBUNG
Das Enable-AzSynapseSqlPoolSensitivityRecommendation-Cmdlet aktiviert Vertraulichkeitsempfehlungen für Spalten im SQL-Pool.
...
### Beispiel 2: Aktivieren von Vertraulichkeitsempfehlungen für eine bestimmte Spalte Azure Synapse SQL mit Piping.
```powershell
