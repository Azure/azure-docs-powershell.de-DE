...
## BESCHREIBUNG
Das **Set-AzSynapseTrigger-Cmdlet** erstellt einen Trigger in einem Arbeitsbereich. Trigger werden im Zustand "Beendet" erstellt, d. h., sie beginnen nicht sofort mit dem Aufrufen von Pipelines, auf die sie verweisen.
...
Erstellen Sie im Arbeitsbereich ContosoWorkspace einen neuen Trigger namens ContosoTrigger. Der Trigger wird im Zustand "Beendet" erstellt, was bedeutet, dass er nicht sofort gestartet wird. Ein Trigger kann mit dem `Start-AzDataFactoryV2Trigger` Cmdlet gestartet werden.
...
Erstellen Sie einen neuen Trigger namens ContosoTrigger im Arbeitsbereich ContosoWorkspace über die Pipeline. Der Trigger wird im Zustand "Beendet" erstellt, was bedeutet, dass er nicht sofort gestartet wird. Ein Trigger kann mit dem `Start-AzDataFactoryV2Trigger` Cmdlet gestartet werden.
