...
## BESCHREIBUNG
Das **Cmdlet Start-AzSynapseTrigger** startet einen Trigger in einem Arbeitsbereich. Wenn sich der Trigger im Zustand "Beendet" befindet, startet das Cmdlet den Trigger und ruft schließlich Pipelines basierend auf seiner Definition auf. Wenn sich der Trigger bereits im Zustand "Gestartet" befindet, hat dieses Cmdlet keine Auswirkung.
