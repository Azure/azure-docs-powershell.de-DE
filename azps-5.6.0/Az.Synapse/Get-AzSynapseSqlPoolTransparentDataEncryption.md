...
## SYNOPSIS
Ruft den TDE-Zustand für einen SQL ab.
...
## BESCHREIBUNG
Das **Get-AzSynapseSqlPoolTransparentDataEncryption-Cmdlet** ruft den Zustand der Transparent Data Encryption (TDE) für einen Azure Synapse Analytics SQL ab.
...
Dieser Befehl ruft den Status von TDE für den SQL ContosoSqlPool unter dem Arbeitsbereich namens ContosoWorkspace ab.
