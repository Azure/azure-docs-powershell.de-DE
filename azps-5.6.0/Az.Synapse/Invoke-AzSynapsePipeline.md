...
## BESCHREIBUNG
Der **Befehl Invoke-AzSynapsePipeline** startet eine Ausführung für die angegebene Pipeline und gibt eine ID für diese Ausführung zurück. Diese GUID kann an **Get-AzSynapsePipelineRun** oder **Get-AzSynapseActivityRun** übergeben werden, um weitere Details zu diesem Ausführen zu erhalten.
...
Die Pipeline-Ausführungs-ID für den erneuten Ausführen.
Wenn die Ausführungs-ID angegeben wird, werden die Parameter der angegebenen Ausführung verwendet, um eine neue Ausführung zu erstellen.
