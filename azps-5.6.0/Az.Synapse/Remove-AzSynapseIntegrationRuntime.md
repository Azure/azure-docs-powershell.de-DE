...
## BESCHREIBUNG
Das **Cmdlet Remove-AzSynapseIntegrationRuntime** entfernt eine Integrationslaufzeit.
...
Mit diesem Befehl wird die Integrationslaufzeit mit dem Namen "test-reserved-ir" aus dem Arbeitsbereich namens ContosoWorkspace entfernt.
