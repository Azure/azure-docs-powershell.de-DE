...
## BESCHREIBUNG
Das Set-AzSynapseSqlPoolSensitivityClassification-Cmdlet legt die Informationstypen und Vertraulichkeitsbeschriftungen von Spalten im SQL fest.

## BEISPIELE

### Beispiel 1: Festlegen von Informationstyp und Vertraulichkeitsbeschriftung einer Spalte in einem Azure Synapse SQL Pool.
```powershell
...
### Beispiel 2: Festlegen empfohlener Informationstypen und Vertraulichkeitsbeschriftungen von Spalten in einem Azure Synapse SQL Pool.
```powershell
...
### Beispiel 3: Festlegen von Informationstyp und Vertraulichkeitsbeschriftung einer Spalte in einem Azure Synapse-SQL mithilfe von Piping.
```powershell
...
Ein Objekt, das eine SQL Pool-Vertraulichkeitsklassifizierung darstellt.
