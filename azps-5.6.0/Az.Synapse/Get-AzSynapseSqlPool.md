...
## BESCHREIBUNG
Das **Get-AzSynapseSqlPool-Cmdlet** ruft Informationen zu einem Azure Synapse Analytics SQL ab.
...
Dieser Befehl ruft alle SQL-Pools unter einem Arbeitsbereich über die Pipeline ab.
...
### -Version
[Dieses Feature befindet sich in einer eingeschränkten Vorschau und kann zunächst nur für bestimmte Abonnements verwendet werden.] Version von Synapse SQL Pool. Beispiel: 2 oder 3.
