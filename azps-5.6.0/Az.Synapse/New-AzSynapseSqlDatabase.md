...
## SYNOPSIS
Erstellt eine Synapse Analytics SQL Datenbank.
...
## BESCHREIBUNG
Das **Get-AzSynapseSqlDatabase-Cmdlet** ruft Informationen zu einer Azure Synapse Analytics-SQL ab.
...
Mit diesem Befehl wird eine Azure Synapse Analytics-SQL erstellt.
...
### -Sortierung
Die Sortierung definiert die Regeln zum Sortieren und Vergleichen von Daten und kann nach SQL Poolerstellung nicht geändert werden.
