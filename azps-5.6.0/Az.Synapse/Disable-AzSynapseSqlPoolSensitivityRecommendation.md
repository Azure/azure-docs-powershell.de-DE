...
### Beispiel 1: Deaktivieren von Vertraulichkeitsempfehlungen für eine bestimmte Spalte in einem Azure Synapse SQL Pool.
```powershell
...
### Beispiel 2: Deaktivieren von Vertraulichkeitsempfehlungen für Spalten mit Vertraulichkeitsempfehlungen in einem Azure Synapse SQL mit Piping.
```powershell
...
### Beispiel 3: Deaktivieren von Vertraulichkeitsempfehlungen für eine bestimmte Spalte in einem Azure Synapse SQL mit Piping.
```powershell
