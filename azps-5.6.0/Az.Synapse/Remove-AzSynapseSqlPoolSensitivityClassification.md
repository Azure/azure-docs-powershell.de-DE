...
## BESCHREIBUNG
Das Remove-AzSynapseSqlPoolSensitivityClassification cmdlet entfernt die Informationstypen und Vertraulichkeitsbeschriftungen von Spalten im SQL Pool.

## BEISPIELE

### Beispiel 1: Entfernen von Informationstyp und Vertraulichkeitsbeschriftung einer Spalte in einem Azure Synapse SQL Pool.
```powershell
...
### Beispiel 3: Entfernen von Informationstyp und Vertraulichkeitsbeschriftung einer Spalte in einem Azure Synapse SQL mit Piping.
```powershell
