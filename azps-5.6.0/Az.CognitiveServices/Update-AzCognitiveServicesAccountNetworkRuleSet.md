...
## BESCHREIBUNG
Das **Cmdlet Update-AzCognitiveServicesAccountNetworkRuleSet** aktualisiert die NetworkRule-Eigenschaft eines Cognitive Services-Kontos.
...
### Beispiel 3: Bereinigen von Regeln für NetworkRule eines Cognitive Services-Kontos
```
