...
## BESCHREIBUNG
Das **Get-AzCognitiveServicesAccountNetworkRuleSet-Cmdlet** ruft die NetworkRule-Eigenschaft eines Cognitive Services-Kontos ab.

## BEISPIELE

### Beispiel 1: Get NetworkRule-Eigenschaft eines angegebenen Cognitive Services-Kontos
```
