...
## BESCHREIBUNG
Das **Cmdlet Set-AzServiceBusGeoDRConfigurationFailOver ruft** das GEO DR-Failover auf und konfiguriert den Alias so, dass er auf den sekundären Namespace zeigt.
