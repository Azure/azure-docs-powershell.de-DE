...
## BESCHREIBUNG
Das **Cmdlet New-AzServiceBusTopic** erstellt ein neues Service Bus-Thema im angegebenen Service Bus-Namespace.
...
Erstellt ein neues Service Bus-Thema `SB-Topic_exampl1` im angegebenen Service Bus-Namespace. `SB-Example1`

### Beispiel 2

Erstellt ein neues Service Bus-Thema im angegebenen Service Bus-Namespace. (automatisch generiert)
...
### -AutoDeleteOnIdle
Gibt das [Zeitintervall im](https://msdn.microsoft.com/library/system.timespan.aspx) Leerlauf an, nach dem das Thema automatisch gelöscht wird. Die Mindestdauer beträgt 5 Minuten.
...
Gibt die Dauer an, nach der die Nachricht abläuft, beginnend mit dem Senden der Nachricht an Service Bus.
...
Gibt die [TimeSpan-Struktur](https://msdn.microsoft.com/library/system.timespan.aspx) an, die die Dauer des Duplikaterkennungsverlaufs definiert. Der Standardwert ist 10 Minuten.
...
### -EnableExpress
Gibt an, ob Express-Entitäten aktiviert sind. Eine Expresswarteschlange hält eine Nachricht vorübergehend im Arbeitsspeicher, bevor sie in beständigen Speicher geschrieben wird.
...
### -EnablePartitioning
Gibt an, ob das Thema für mehrere Nachrichtenbroker partitioniert werden soll. 
...
Gibt an, ob für das Thema eine Duplizierungserkennung erforderlich ist.
...
### -SupportOrdering
Gibt an, ob das Thema die Sortierung unterstützt.
