...
Entfernt die Service Bus-Warteschlange `SB-Queue_exampl1` aus dem -Namespace. `SB-Example1`

### Beispiel 2: InputObject – Verwenden der Variablen:
```powershell
PS C:\> $inputobject = Get-AzServiceBusQueue <params>
PS C:\> Remove-AzServiceBusQueue -InputObject $inputobject
```

Entfernt die im Parameter $inputobject für -InputObject bereitgestellte Dienstbuswarteschlange
...
### Beispiel 4: ResourceId – Verwenden der Variablen:
```powershell
PS c:\> $resourceid = Get-AzServiceBusQueue <params>
PS C:\> Remove-AzServiceBusQueue -ResourceId $resourceid.Id
```

Entfernt die Dienstbuswarteschlange, die in der ARM-ID in $resourceid/String für den Parameter -ResourceId bereitgestellt wird.
...
### -ResourceId
Dienstbuswarteschlange-Ressourcen-ID
