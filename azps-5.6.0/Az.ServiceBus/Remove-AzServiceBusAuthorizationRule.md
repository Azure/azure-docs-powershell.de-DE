...
## SYNOPSIS
Entfernt die Autorisierungsregel eines Service Bus-Namespaces oder einer Warteschlange oder eines Themas aus der angegebenen Ressourcengruppe.
...
## BESCHREIBUNG
Das **Cmdlet Remove-AzServiceBusAuthorizationRule** entfernt die Autorisierungsregel eines Service Bus-Namespaces oder einer Warteschlange oder eines Themas für die angegebene Ressourcengruppe.
...
Entfernt die `SBAuthoRule1` Autorisierungsregel des `SB-Example1` Namespaces aus der angegebenen Ressourcengruppe.
...
Entfernt die `SBAuthoRule1` Autorisierungsregel des Themas `SBTopic` aus der angegebenen Ressourcengruppe.
