...
## SYNOPSIS
Ruft die primären und sekundären Verbindungszeichenfolgen für den angegebenen Namespace oder Warteschlange oder Thema oder Alias (GeoDR-Konfigurationen) ab.
...
## BESCHREIBUNG
Das **Get-AzServiceBusKey-Cmdlet** gibt die primären und sekundären Verbindungszeichenfolgen für den angegebenen Namespace oder queue oder Topic or Alias (GeoDR Configurations) zurück.
