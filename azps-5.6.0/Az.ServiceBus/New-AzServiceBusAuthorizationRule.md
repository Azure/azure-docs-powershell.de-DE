...
## SYNOPSIS
Erstellt eine neue Autorisierungsregel für den angegebenen Service Bus, der namespace oder Queue oder Topic enthält.
...
## BESCHREIBUNG
Das **Cmdlet New-AzServiceBusAuthorizationRule** erstellt eine neue Autorisierungsregel für den angegebenen Service Bus-Namespace oder die angegebene Warteschlange oder das angegebene Thema.
...
Erstellt `AuthoRule1` mit den Rechten **"Anhören"** und **"Senden"** für den -Namespace `SB-Example1` .
...
Erstellt `AuthoRule1` mit den Rechten **"Anhören"** und "Senden" für das Thema  `SBTopic` .
