...
## SYNOPSIS
Regeneriert einen Zugriffsschlüssel für den angegebenen Konfigurationsspeicher.
...
### Beispiel 1: Neuerieren des Schlüssels eines App-Konfigurationsspeichers
```powershell
...
### Beispiel 2: Neuerieren des Schlüssels eines App-Konfigurationsspeichers nach Objekt
```powershell
