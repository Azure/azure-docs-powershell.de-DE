...
### Beispiel 1: Auflisten aller Speicherschlüssel eines App-Konfigurationsspeichers
```powershell
...
Mit diesem Befehl werden alle Speicherschlüssel eines App-Konfigurationsspeichers aufgeführt.
