...
Legt die benutzerdefinierte Richtlinie für den TEE-Typ *SgxEnclave* für Attestation Provider *pshtest* mithilfe eines Textrichtlinienformats (Standard) fest.
...
Legt die benutzerdefinierte Richtlinie für den TEE-Typ *SgxEnclave* für Attestation Provider *pshtest* mithilfe eines JWT-Richtlinienformats fest.
...
Dieses Cmdlet legt die Bestätigungsrichtlinie für den Mandanten fest, den dieser Parameter angibt.
...
### -Richtlinie
Gibt das zu erstellende Richtliniendokument an.  Das Richtlinienformat kann entweder Text oder JSON Web Token (JWT) sein.
...
### -PolicyFormat
Gibt das Format für die Richtlinie an, entweder Text oder JWT (JSON Web Token).  Das Standardrichtlinienformat ist Text.
...
Vier Arten von Umgebung werden unterstützt: SgxEnclave, OpenEnclave, CyResComponent und VBSEnclave.
