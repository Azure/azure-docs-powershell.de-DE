...
Entfernen Sie einen vertrauenswürdigen Signer für den Zertifizierungsanbieter mit dem Namen *pshtest*.
...
### -Signer
Gibt das RFC7519-JSON-Webtoken an, das einen Anspruch mit dem Namen "maa-policyCertificate" enthält, dessen Wert ein RFC7517-JSON-Webschlüssel ist, der einen zu entfernenden vertrauenswürdigen Signaturschlüssel enthält.
