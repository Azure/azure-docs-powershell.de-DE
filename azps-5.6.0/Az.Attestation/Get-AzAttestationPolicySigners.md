...
## BESCHREIBUNG
Das Get-AzAttestationPolicySigners-Cmdlet ruft die vertrauenswürdigen Richtlinien signierer von einem Mandanten in Azure Attestation ab.
...
Ruft die vertrauenswürdigen Richtlinien signer für den Zertifizierungsanbieter *pshtest* in der Ressourcengruppe *psh-test-rg ab.*  Beachten Sie, dass es für diesen Zertifizierungsanbieter keine vertrauenswürdigen Signierer gibt.
...
Ruft die vertrauenswürdigen Richtlinien signer für den Zertifizierungsanbieter *pshtest2* in der Ressourcengruppe *psh-test-rg ab.*  Beachten Sie, dass es einen vertrauenswürdigen Signer für diesen Zertifizierungsanbieter gibt.
...
Ruft die vertrauenswürdigen Richtlinien signierer für den Standardanbieter für Die Bestätigung in Location *Central US ab.*  Beachten Sie, dass es keine vertrauenswürdigen Signierer für den Standardanbieter für Attestation gibt.
...
### -DefaultProvider
Gibt an, dass dies die Anforderung an einen Standardprüfanbieter ist.
...
### -Location
Gibt den Speicherort des Standardprüfanbieters an.
...
### -Name
Gibt den Namen eines Bescheinigungsanbieters an.
