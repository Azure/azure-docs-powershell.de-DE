...
## BESCHREIBUNG
Das Remove-AzAttestation cmdlet löscht die angegebene Bestätigung.
...
Löschen Sie den Nachweisanbieter mit dem Namen *pshtest3* in der Ressourcengruppe mit dem Namen *psh-test-rg* aus dem aktuellen Abonnement.
...
### -InputObject
Das zu löschende Attestierungsobjekt.
...
### -Name
Gibt den Namen der zu entfernenden Bestätigung an.
...
### -ResourceGroupName
Gibt den Namen der Ressourcengruppe für azure attestation an, die entfernt werden soll.
