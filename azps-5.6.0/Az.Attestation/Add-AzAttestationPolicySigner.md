...
### -Signer
Gibt das RFC7519-JSON-Webtoken an, das einen Anspruch mit dem Namen "maa-policyCertificate" enthält, dessen Wert ein RFC7517-JSON-Webschlüssel ist, der einen neuen vertrauenswürdigen Signaturschlüssel enthält, der hinzugefügt werden soll.
