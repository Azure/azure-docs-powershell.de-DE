...
### Beispiel 1: Erstellen einer Windows Virtual Desktop ApplicationGroup nach Name
```powershell
...
### Beispiel 2: Erstellen einer Windows Virtual Desktop ApplicationGroup nach Name
```powershell
PS C:\> New-AzWvdApplicationGroup -ResourceGroupName ResourceGroupName `
                            -Name ApplicationGroupName `
                            -Location 'eastus' `
...
### -HostPoolArmPath
HostPool-Armpfad der ApplicationGroup.
