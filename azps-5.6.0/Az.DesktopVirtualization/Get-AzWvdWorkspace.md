...
### Beispiel 1: Herunterladen eines virtuellen Windows-Desktoparbeitsbereichs nach Name
```powershell
...
### Beispiel 2: Auflisten virtueller Windows-Desktoparbeitsräume
```powershell
...
Mit diesem Befehl werden virtuelle Windows-Desktoparbeitsräume in einer Ressourcengruppe aufgeführt.
