...
### Beispiel 1: Herunterladen einer Windows Virtual Desktop UserSession nach Name
```powershell
...
Mit diesem Befehl werden Windows Virtual Desktop UserSessions in einem Sitzungshost aufgeführt.
...
Mit diesem Befehl werden Windows Virtual Desktop UserSessions in einem Sitzungshost in einem Hostpool aufgeführt.
...
Gültige Eigenschaften zum Filtern sind benutzerprincipalname und sessionstate.
