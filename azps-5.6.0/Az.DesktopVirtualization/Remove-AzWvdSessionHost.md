...
### Beispiel 1: Löschen einer Windows Virtual Desktop SessionHost nach Name
```powershell
PS C:\> Remove-AzWvdSessionHost -ResourceGroupName ResourceGroupName -HostPoolName HostPoolName -Name SessionHostName
```

Mit diesem Befehl wird ein Windows Virtual Desktop SessionHost in einem Hostpool gelöscht.
...
### -Erzwingen
Erzwingen, dass das Löschen von sessionHost auch dann erzwingen wird, wenn userSession vorhanden ist.
