...
### Beispiel 1: Aktualisieren eines virtuellen Windows-Desktopdesktops
```powershell
...
Mit diesem Befehl wird ein virtueller Windows-Desktopdesktop in einer applicaton-Gruppe aktualisiert.
