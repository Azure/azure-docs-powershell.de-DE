...
### Beispiel 1: Erstellen eines virtuellen Windows-Desktoparbeitsbereichs nach Name
```powershell
...
Mit diesem Befehl wird ein virtueller Windows-Desktoparbeitsbereich in einer Ressourcengruppe erstellt.

### Beispiel 2: Erstellen eines virtuellen Windows-Desktoparbeitsbereichs nach Name
```powershell
PS C:\> New-AzWvdWorkspace -ResourceGroupName ResourceGroupName `
                        -Name WorkspaceName `
                        -Location 'eastus' `
