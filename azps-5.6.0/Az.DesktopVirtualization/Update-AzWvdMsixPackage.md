...
Mit diesem Befehl wird ein MSIX-Paket in einer HostPool aktualisiert.
...
### -DisplayName
Anzeigename für DAS MSIX-Paket.
...
### -FullName
Das versionsspezifische Paket mit dem vollständigen Namen des MSIX-Pakets innerhalb des angegebenen Hostpools
...
### -IsActive
Legen Sie eine Version des Pakets so vor, dass sie über hostpool hinweg aktiv ist.
