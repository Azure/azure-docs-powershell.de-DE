...
### Beispiel 1: Löschen eines virtuellen Windows-DesktophostPools nach Name
```powershell
PS C:\> Remove-AzWvdHostPool -ResourceGroupName ResourceGroupName -Name HostPoolName
```

Mit diesem Befehl wird ein virtueller Windows-DesktophostPool in einer Ressourcengruppe gelöscht.
...
### -Erzwingen
Erzwingen des Flag zum Löschen von sessionHost.
