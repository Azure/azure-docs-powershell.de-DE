...
### Beispiel 1: Herunterladen eines virtuellen Windows-Desktopdesktops nach Name
```powershell
...
Dieser Befehl ruft einen virtuellen Windows-Desktopdesktop in einer applicaton-Gruppe ab.

### Beispiel 2: Auflisten von virtuellen Windows-Desktopdesktops
```powershell
...
Dieser Befehl listetWindows Virtual Desktop Desktops in einer applicaton-Gruppe auf.
