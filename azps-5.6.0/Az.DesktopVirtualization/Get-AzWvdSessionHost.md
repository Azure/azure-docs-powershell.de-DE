...
### Beispiel 1: Herunterladen eines virtuellen Windows-Desktopsitzungshosts nach Name
```powershell
...
Dieser Befehl ruft einen virtuellen Windows-Desktopsitzungshost in einem Hostpool ab.

### Beispiel 2: Auflisten von virtuellen Windows-Desktopsitzungshosts
```powershell
...
Mit diesem Befehl werden windows Virtual Desktop SessionHosts in einem Hostpool aufgeführt.
