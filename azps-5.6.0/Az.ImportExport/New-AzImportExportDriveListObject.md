...
### Beispiel 1: Erstellen eines neuen DriveList for ImportExport-Auftrags
```powershell
...
Diese Cmdlets erstellen einen neuen DriveList for ImportExport-Auftrag.
...
### -BytesSucceeded
Bytes, die erfolgreich für das Laufwerk übertragen wurden.
...
Dieses Feld wird in der Antwort erst zurückgegeben, wenn sich das Laufwerk im Übertragungszustand befindet.
...
### -DriveHeaderHash
Der Hashwert der Laufwerkkopfzeile.
...
### -DriveId
Die Seriennummer der Hardware des Laufwerks ohne Leerzeichen.
...
### -ErrorLogUri
Ein URI, der auf den Blob verweist, der das Fehlerprotokoll für den Datenübertragungsvorgang enthält.
...
### -ManifestUri
Ein URI, der auf den Blob verweist, der die Laufwerkmanifestdatei enthält.
...
### -PercentComplete
Prozentsatz, der für das Laufwerk abgeschlossen wurde.
...
### -VerboseLogUri
Ein URI, der auf den Blob verweist, der das ausführliche Protokoll für den Datenübertragungsvorgang enthält.
