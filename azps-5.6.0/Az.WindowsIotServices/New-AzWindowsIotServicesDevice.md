...
### Beispiel 1: Erstellen eines neuen Windows IoT-Diensts
```powershell
...
Mit diesem Befehl wird ein neuer Windows IoT-Dienst erstellt.
...
Geben Sie nicht zum Erstellen eines neuen Windows IoT-Gerätediensts an.
