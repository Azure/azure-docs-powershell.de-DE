...
Das übliche Muster zum Ändern einer Eigenschaft besteht im Abrufen der Windows IoT-Gerätedienstmetadaten und Sicherheitsmetadaten, und kombinieren Sie sie dann mit den geänderten Werten in einem neuen Textkörper, um den Windows IoT-Gerätedienst zu aktualisieren.
...
Mit diesem Befehl wird ein Windows IoT-Dienst nach Name aktualisiert.
...
Mit diesem Befehl wird ein Windows IoT-Dienst per Pipeline aktualisiert.

## PARAMETER

### -AdminDomainName
Windows IoT Device Service OEM AAD-Domäne
...
### -BillingDomainName
Windows IoT Device Service ODM AAD-Domäne
...
### -Etag
Das Feld "Etag" *ist nicht* erforderlich.
...
Geben Sie nicht zum Erstellen eines brandneuen Windows IoT-Gerätediensts an.
Erforderlich, um einen vorhandenen Windows IoT-Gerätedienst zu aktualisieren.
...
### -Location
Die Azure-Region, in der sich die Ressource lebt
...
### -Hinweis
Windows IoT-Gerätedienstnotizen.
