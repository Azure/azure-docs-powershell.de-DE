...
### -Erzwingen
Gibt an, dass sie vom Cmdlet nicht zur Bestätigung aufgefordert werden. Standardmäßig werden Sie in diesem Cmdlet aufgefordert, zu bestätigen, dass Sie den Cache beenden möchten.
...
### -InputObject
Das cache-Objekt, das beendet werden soll.
