...
### Beispiel 1: Entfernen eines Databricks-Arbeitsbereichs
```powershell
PS C:\> Remove-AzDatabricksWorkspace -ResourceGroupName testgroup -Name databricks-test
```

Mit diesem Befehl wird ein Databricks-Arbeitsbereich aus einer Ressourcengruppe entfernt.

### Beispiel 2: Entfernen eines Databricks-Arbeitsbereichs nach Objekt
```powershell
