...
### Beispiel 1: Löschen von HealthBot nach ResourceGroupName und Name
```powershell
PS C:\> Remove-AzHealthBot -Name yourihealthbot -ResourceGroupName youriTest

```

Löschen von HealthBot nach ResourceGroupName und Name

### Beispiel 2: Löschen von HealthBot nach InputObject
```powershell
