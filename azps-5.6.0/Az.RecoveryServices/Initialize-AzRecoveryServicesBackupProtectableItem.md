...
## SYNOPSIS
Dieser Befehl löst die Ermittlung aller nicht geschützten Elemente des angegebenen Arbeitsauslastungstyps im angegebenen Container aus. Wenn die DB-Anwendung nicht automatisch geschützt ist, verwenden Sie diesen Befehl, um neue DBs zu ermitteln, sobald sie hinzugefügt werden, und fahren Sie mit dem Schutz fort.
...
## BESCHREIBUNG
das Cmdlet fragt nach bestimmten Workloads innerhalb eines Containers. Dadurch wird ein Vorgang ausgelöst, der schützende Elemente erstellt.
...
Dieser Befehl löst die Ermittlung aller nicht geschützten Elemente des angegebenen Arbeitsauslastungstyps im angegebenen Container aus. (automatisch generiert)
