...
## SYNOPSIS
Ruft die Eigenschaften eines geschützten Azure -Websitereplikationsschutzelementes ab.
...
## BESCHREIBUNG
Das **Get-AzRecoveryServicesAsrReplicationProtectedItem-Cmdlet** ruft die Eigenschaften aller oder des angegebenen ASR-Replikationsgeschützten Elements aus dem angegebenen ASR-Schutzcontainer ab.
...
Ruft die Eigenschaften eines geschützten Azure -Websitereplikationsschutzelementes ab. (automatisch generiert)
...
### -FriendlyName
Gibt den Anzeigenamen des zu erhaltenden replikationsgeschützten Elements an.
...
### -Name
Gibt den Namen des zu erhaltenden replikationsgeschützten Elements an.
...
### -ProtectableItem
Gibt ein ASR-beschützbares Elementobjekt an. Das Cmdlet ruft das geschützte Element für die ASR-Replikation ab, das dem angegebenen schützensbaren ELEMENT entspricht, wenn das Element geschützt ist.
...
### -ProtectionContainer
Gibt das ASR-Schutzcontainerobjekt des ASR-Schutzcontainers an, das dem replikationsgeschützten Element entspricht. 
