...
Startet den Replikationsrichtlinienerstellungsvorgang mit den angegebenen Parametern und gibt den ASR-Auftrag zurück, der zum Nachverfolgen des Vorgangs verwendet wird.
...
### -AzureToVMware
Der Parameter Switch gibt das Szenario für die Erstellung von Azure-zu-vMWare-Richtlinien an.
...
### -HyperVToAzure
Parameter zum Angeben der Richtlinie zum Replizieren virtueller Hyper-V-Computer in Azure verwenden
...
Behalten Sie die Wiederherstellungspunkte für eine bestimmte Zeit in Stunden bei.
...
### -VmmToVmm
Parameter zum Angeben der Richtlinie wechseln soll zum Replizieren zwischen Hyper-V-Websites verwendet werden, die von einem VMM-Server verwaltet werden.
...
### -VMwareToAzure
Parameter wechseln, mit dem angegeben wird, dass die zu erstellende Replikationsrichtlinie zum Replizieren virtueller VMware-Computer und/oder physischer Server in Azure verwendet wird.
