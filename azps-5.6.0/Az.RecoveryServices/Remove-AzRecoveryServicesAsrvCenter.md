...
## SYNOPSIS
Entfernt den vCenter-Server aus der ASR-Fabric und beendet die Suche nach virtuellen Computern vom vCenter-Server.
...
## BESCHREIBUNG
Das **Cmdlet Remove-AzRecoveryServicesAsrvCenter** entfernt den vCenter-Server aus der ASR-Fabric und beendet die Erkennung virtueller Computer vom vCenter-Server.
...
Entfernt den vCenter-Server aus der ASR-Fabric.

### Beispiel 2

Entfernt den vCenter-Server aus der ASR-Fabric und beendet die Suche nach virtuellen Computern vom vCenter-Server. (automatisch generiert)
...
### -Fabric
ASR-Fabricobjekt, das den Konfigurationsserver darstellt.
