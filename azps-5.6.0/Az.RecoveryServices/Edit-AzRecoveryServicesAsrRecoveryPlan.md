...
## SYNOPSIS
Bearbeitet einen Plan für die Websitewiederherstellung.

## SYNTAX

### Anfügegruppe (Standard)
```
...
Fügt eine Gruppe an den vorhandenen Azure Site Recovery-Plan an und gibt den aktualisierten Wiederherstellungsplan für den Arbeitsspeicher zurück. 

### Beispiel 2

Bearbeitet einen Plan für die Websitewiederherstellung. (automatisch generiert)
...
### -AddProtectedItem
Liste der geschützten Elemente für die ASR-Replikation, die der Gruppe des Wiederherstellungsplans im Wiederherstellungsplanobjekt hinzugefügt werden sollen.
...
### -AppendGroup
Parameter wechseln, um eine Wiederherstellungsplangruppe an das Wiederherstellungsplanobjekt anfügen.
...
### -Gruppe
Gibt eine Wiederherstellungsplangruppe an.
...
### -InputObject
Das zu bearbeitende ASR-Wiederherstellungsplanobjekt (Im Arbeitsspeichervorgang. Führen Sie zum Aktualisieren des Wiederherstellungsplans Update-AzASRRecoveryPlan mit dem bearbeiteten Wiederherstellungsplanobjekt aus.)
...
### -RemoveProtectedItem
Liste der geschützten ELEMENTE für die ASR-Replikation, die aus der Gruppe des Wiederherstellungsplans im Wiederherstellungsplanobjekt entfernt werden sollen.
