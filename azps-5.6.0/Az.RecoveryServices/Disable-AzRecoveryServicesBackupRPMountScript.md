...
## SYNOPSIS
Alle Dateien des Wiederherstellungspunkts werden nicht mehr gemountt.
...
## BESCHREIBUNG
Das Disable-AzRecoveryServicesBackupRPMountScript cmdlet demountet die Dateien des Wiederherstellungspunkts, die zuvor mithilfe des Get-AzRecoveryServicesBackupRPMountScript bereitgestellt wurden.

## BEISPIELE

### Beispiel 1: Demounten eines Wiederherstellungspunkts
```powershell
...
Alle Dateien des Wiederherstellungspunkts werden nicht mehr gemountt. (automatisch generiert)
