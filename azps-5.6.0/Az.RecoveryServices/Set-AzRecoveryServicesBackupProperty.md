...
## BESCHREIBUNG
Das **Cmdlet Set-AzRecoveryServicesBackupProperty** legt Sicherungsspeichereigenschaften für einen Recovery Services-Tresor fest.

## BEISPIELE

### Beispiel 1: Festlegen von GeoRedundant-Speicher für einen Tresor
```
...
Der zweite Befehl legt die Redundanz des Sicherungsspeichers für $Vault 01 auf GeoRedundant fest.

## PARAMETER

### -BackupStorageRedundancy
Gibt den Redundanztyp des Sicherungsspeichers an.
