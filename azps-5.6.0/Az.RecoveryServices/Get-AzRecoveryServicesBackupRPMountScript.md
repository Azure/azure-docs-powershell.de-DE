...
## SYNOPSIS
Lädt ein Skript herunter, um alle Dateien des Wiederherstellungspunkts zu mounten.
...
## BESCHREIBUNG
Das Get-AzRecoveryServicesBackupRPMountScript-Cmdlet lädt ein Skript herunter, das die Volumes des Wiederherstellungspunkts auf dem Computer einlädigt, auf dem er ausgeführt wird.
...
Lädt ein Skript herunter, um alle Dateien des Wiederherstellungspunkts zu mounten. (automatisch generiert)
...
### -Path
Speicherort, an dem die Datei im Fall der Dateiwiederherstellung heruntergeladen werden sollte. Wenn -Path nicht bereitgestellt wird, wird die Skriptdatei im aktuellen Verzeichnis heruntergeladen.
