...
Der erste Befehl ruft den Sicherungscontainer vom Typ AzureVM mit dem Namen pstestv2vm1 ab und speichert ihn dann in der $NamedContainer Variablen.
...
Gibt eine Ablaufzeit für den Wiederherstellungspunkt als DateTime-Objekt an, wenn nichts angegeben wird, dauert es den Standardwert von 30 Tagen. Gilt für VM, SQL (nur für Den vollständigen Sicherungstyp kopieren), AFS-Sicherungselemente.
