...
## BESCHREIBUNG
Das **Cmdlet New-AzRecoveryServicesAsrNetworkMapping** startet den Vorgang zum Erstellen einer ASR-Netzwerkzuordnung zwischen zwei Netzwerken und gibt das ASR-Auftragsobjekt für den ASR-Auftrag zurück, der zum Nachverfolgen des Vorgangs verwendet wird.
...
Startet den Vorgang zum Erstellen von Netzwerkzuordnungen unter Verwendung des angegebenen Namens, der primären Netzwerke und der Wiederherstellungsnetzwerke und gibt einen ASR-Auftrag zurück, um den Vorgang nachverfolgt zu werden.
...
Startet die Netzwerkzuordnung für den Erstellungsvorgang unter Verwendung des angegebenen Namens, der primären Netzwerke und der Wiederherstellungsnetzwerke und gibt einen ASR-Auftrag zurück, um den Vorgang nachverfolgt zu werden(Azure-zu-Azure-Szenario).

## PARAMETER

### -AzureToAzure
Kennzeichnen Sie, um ein AzureToAzure-Szenario zu erstellen.
...
### -PrimaryFabric
Gibt die ASR-Fabric an, in der die Zuordnung erstellt werden soll.
...
### -RecoveryFabric
Das Azure Site Recovery -Fabricobjekt, das der Azure-Wiederherstellungsregion entspricht.
