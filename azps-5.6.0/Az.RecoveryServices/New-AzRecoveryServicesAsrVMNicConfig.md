...
## SYNOPSIS
Erstellt eine ASR-NIC-Konfiguration, die die Failover- und Test failoverbezogenen Konfigurationsdetails enthält.
...
Erstellt ein ASRVmNicConfig-Objekt mit den für die NIC konfigurierten Failover- und Testfaiover-Netzwerkeinstellungen. Jede Eigenschaft, die nicht oben übergeben wird, wird aus dem übergebenen geschützten Element abgerufen.
...
Erstellt ein ASRVmNicConfig-Objekt mit den Test-Faiover-Netzwerkeinstellungen, die für die NIC-Umbenennung konfiguriert sind. Jede Eigenschaft, die nicht oben übergeben wird, wird aus dem übergebenen geschützten Element abgerufen.


### Beispiel 3

Erstellt eine ASR-NIC-Konfiguration, die die Failover- und Test failoverbezogenen Konfigurationsdetails enthält. (automatisch generiert)
...
Gibt an, ob das beschleunigte Netzwerk für die Test-Failover-NIC aktiviert ist.
...
Gibt den Namen der Testfa failover-NIC-Ressourcengruppe an.
...
### -TfoReuseExistingNic
Gibt an, ob eine vorhandene NIC während des Test failover verwendet werden kann.
...
### -TfoVMSubnetName
Gibt den Namen des Test-Failoversubnetzs an.
