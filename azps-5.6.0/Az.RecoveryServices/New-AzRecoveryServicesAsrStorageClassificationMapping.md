...
## BESCHREIBUNG
Das **Cmdlet New-AzRecoveryServicesAsrStorageClassificationMapping erstellt** eine Speicherklassifizierung, die den Recovery Services-Tresor zugeordnet.
...
Startet den Erstellungsvorgang für die Speicherklassifizierungszuordnung mit den angegebenen Parametern und gibt den ASR-Auftrag zurück, der zum Nachverfolgen des Vorgangs verwendet wird.
...
### -Name
Gibt einen Namen für die ASR-Speicherklassifizierungszuordnung an.
...
Gibt das primäre ASR-Speicherklassifizierungsobjekt für die Zuordnung an.
...
Gibt das Wiederherstellungs-ASR-Speicherklassifizierungsobjekt für die Zuordnung an.
