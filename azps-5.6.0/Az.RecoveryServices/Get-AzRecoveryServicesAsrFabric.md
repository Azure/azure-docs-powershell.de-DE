...
## SYNOPSIS
Hier erhalten Sie die Details zu einem Azure Site Recovery Fabric.
...
## BESCHREIBUNG
Das **Get-AzRecoveryServicesAsrFabric-Cmdlet** ruft die Eigenschaften eines angegebenen Azure Site Recovery Fabrics oder aller Azure Site Recovery -Fabrics in einem Wiederherstellungsdiensttresor ab.
...
Gibt alle Azure Site Recovery-Materialien im Tresor zurück.
...
### -FriendlyName
Suchen Sie nach dem ASR-Stoff unter dem Anzeigenamen des Fabrics.
...
### -Name
Suchen Sie nach dem ASR-Fabric nach dem Namen des Fabrics.
