...
## SYNOPSIS
Ruft Details zu Azure Websitewiederherstellungsereignissen im Tresor ab.
...
## BESCHREIBUNG
Das **Get-AzRecoveryServicesAsrEvent** ruft die Liste der Ereignisse im Tresor ab, die auf den angegebenen Auswahlfiltern basieren.
...
Liste des Ereignisses für betroffenes Objekt.
...
Liste des Ereignisses zwischen Startzeit und Endzeit, Schweregrad und Integritätstyp VmHealth.
...
### -EventType
Filtern Sie Ereignisse nach dem Ereignistyp.
...
### -Fabric
Filtern Sie Ereignisse nach dem angegebenen Fabric.
...
### -Schweregrad
Schweregrad des Ereignisses, nach dem gefiltert werden soll
...
### -StartTime
Gibt die Startzeit des Suchfensters an. Verwenden Sie diesen Parameter, um nur die Ereignisse zu erhalten, die nach dem angegebenen Zeitpunkt aufgetreten sind.
