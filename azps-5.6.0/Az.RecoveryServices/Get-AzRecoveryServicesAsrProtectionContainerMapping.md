...
## BESCHREIBUNG
Das **Get-AzRecoveryServicesAsrProtectionContainerMapping-Cmdlet** ruft Informationen über den Schutzcontainer zu Replikationsrichtlinienzuordnungen(Zuordnung) im Tresor für den angegebenen ASR-Schutzcontainer ab.
...
### -Name
Gibt den Namen der zu erhaltenden Schutzcontainerzuordnung an.
...
### -ProtectionContainer
Holen Sie sich Schutzcontainerzuordnungen, die dem angegebenen ASR-Schutzcontainerobjekt zugeordnet sind.
