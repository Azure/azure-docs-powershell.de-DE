...
## BESCHREIBUNG
Mit diesem Befehl kann Azure Backup die Ressource in einen Sicherungscontainer konvertieren, der dann im angegebenen Wiederherstellungsdienste-Tresor registriert ist. Der Azure Backup-Dienst kann dann Workloads des angegebenen Workloadtyps in diesem Container ermitteln, die später geschützt werden sollen.
...
Das Cmdlet registriert eine azure VM als Container für die MsSQL-Arbeitsauslastung.

## PARAMETER

### -BackupManagementType
Die Klasse der zu schützenden Ressourcen. Der für dieses Cmdlet unterstützte Wert ist derzeit AzureWorkload.
...
### -WorkloadType
Arbeitsauslastungstyp der Ressource. Der aktuelle unterstützte Wert ist AzureVM, WindowsServer, AzureFiles, MSSQL.
