...
## BESCHREIBUNG
Das **Cmdlet Set-AzEventHubGeoDRConfigurationFailOver ruft** das GEO DR-Failover auf und konfiguriert den Alias so, dass er auf den sekundären Namespace zeigt.
...
Ruft den Failover über alias "SampleDRConfigName" auf, konfiguriert und zeigt auf sekundären Namespace "SampleNamespace_Secondary"
