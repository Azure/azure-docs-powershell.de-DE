...
## BESCHREIBUNG
Das New-AzEventHubKey cmdlet regeneriert den primären oder sekundären SAS-Schlüssel für die angegebene Ereignishubautorisierungsregel.
...
Generiert den Primärschlüssel für die Autorisierungsregel \` MyAuthRuleName \` neu.
...
Regeneriert den Sekundärschlüssel für die Autorisierungsregel \` MyAuthRuleName \` .
