...
Löscht die Consumergruppe \` MyConsumerGroupName aus dem \` Ereignishub \` MyEventHubName , der auf \` den \` MyNamespaceName-Namespace \` festgelegt ist.
...
### Beispiel 4: ResourceId Using Variable
```powershell
PS C:\> $resourceid = Get-AzEventHubConsumerGroup <params>
PS C:\> Remove-AzEventHubConsumerGroup -ResourceId $resourceid.Id
```

### Beispiel 5: ResourceId Using string
```powershell
