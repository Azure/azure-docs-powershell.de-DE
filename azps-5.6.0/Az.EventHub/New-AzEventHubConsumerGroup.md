...
Erstellt die Consumergruppe \` MyConsumerGroupName im Ereignishub MyEventHubName , die auf den Namespace MyNamespaceName mit der Ressourcengruppe \` \` \` \` \` \` MyResourceGroupName festgelegt \` ist.
