...
## BESCHREIBUNG
Das Set-AzEventHubConsumerGroup-Cmdlet aktualisiert die angegebene Ereignishub-Consumergruppe.
...
Legt die Benutzermetadaten der Consumergruppe \` MyConsumerGroupName \` auf "Testing" fest.
