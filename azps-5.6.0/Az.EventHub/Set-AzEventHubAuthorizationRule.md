...
## BESCHREIBUNG
Das Set-AzEventHubAuthorizationRule cmdlet aktualisiert die angegebene Autorisierungsregel für den angegebenen Ereignishub.
...
Aktualisiert die Autorisierungsregel \` "MyAuthRuleName", um dem Ereignishub MyEventHubName , der durch den \` \` \` Namespace \` MyNamespaceName festgelegt ist, Manage-Rechte zu \` gewähren.
...
### -Rechte
Rechte, z. B. @("Hören";Senden","Verwalten")
