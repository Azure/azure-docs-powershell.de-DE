...
## BESCHREIBUNG
Das Set-AzEventHubNamespace cmdlet aktualisiert die Eigenschaften des angegebenen Event Hubs-Namespaces.
...
Aktualisiert die Tags für Namespace \` MyNamespaceName \` auf Erstellt.
...
Aktualisiert den Status des \` Namespaces MyNamespaceName mit \` aktivierter AutoInflate = und MaximumThroughputUnits = 10

### Beispiel 3

Aktualisiert den angegebenen Event Hubs-Namespace. (automatisch generiert)

```powershell <!-- Aladdin Generated Example --> 
Set-AzEventHubNamespace -Location 'WestUS' -Name MyNamespaceName -ResourceGroupName MyResourceGroupName -SkuName Basic
```

### Beispiel 5: Erstellen und Aktualisieren von Namespaces mit Identitätsverwaltung in einem Cluster 
```powershell
...
Bei aktivierter AutoInflate sollte der Wert zwischen 0 und 20 Durchsatzeinheiten sein.
...
### -SkuCapacity
Die Ereignishubdurchsatzeinheiten.
...
### -State
Namespace deaktivieren/aktivieren.
