...
### -Defines
Gibt Hadoop-Konfigurationswerte an, die festgelegt werden müssen, wenn der Auftrag ausgeführt wird.
...
### -Mapper
Gibt einen Mapperdateinamen an.
...
### -Reducer
Gibt einen Dateinamen von Reducer an.
