...
## BESCHREIBUNG
Das **Add-AzHDInsightConfigValue-Cmdlet** fügt eine Anpassung des Hadoop-Konfigurationswerts hinzu, z. B. core-site.xml oder hive-site.xml, und/oder eine Anpassung der freigegebenen Hive-Bibliothek an das hdInsight-Konfigurationsobjekt, das vom cmdlet New-AzHDInsightClusterConfig erstellt wurde.
...
Mit diesem Befehl wird dem Cluster mit dem Namen "your-hadoop-001" ein Hadoop-Konfigurationswert hinzufügt.
...
### -HiveSite
Gibt die Konfigurationen der Hive-Website dieses HDInsight-Clusters an.
...
### -Storm
Gibt die Konfigurationen der StormSite dieses HDInsight-Clusters an.
...
### -Tez
Gibt die Konfigurationen der Tez-Website dieses HDInsight-Clusters an.
...
### -Garn
Gibt die KONFIGURATIONEN der GARN-Website dieses HDInsight-Clusters an.
