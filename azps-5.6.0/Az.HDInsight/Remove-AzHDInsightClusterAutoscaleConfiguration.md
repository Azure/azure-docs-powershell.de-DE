...
## BESCHREIBUNG
Das **Cmdlet Remove-AzHDInsightClusterAutoscaleConfiguration** entfernt die Konfiguration der automatischen Skalierung des HDInsight-Clusters.

## BEISPIELE

### Beispiel 1: Entfernen Sie die Konfiguration der automatischen Skalierung des HDInsight-Clusters.
```powershell
...
Mit diesem Befehl wird die Konfiguration der automatischen Skalierung des HDInsight-Clusters entfernt.
