...
## BESCHREIBUNG
Dieses Cmdlet **Set-AzHDInsightClusterAutoscaleConfiguration** legt die Konfiguration der automatischen Skalierung eines Azure HDInsight-Clusters fest.

## BEISPIELE

### Beispiel 1: Festlegen der Konfiguration der ladebasierten automatischen Skalierung des HDInsight-Clusters
```powershell
...
Mit diesem Befehl wird die ladenbasierte Konfiguration der automatischen Skalierung eines Azure HDInsight-Clusters bestimmt.

### Beispiel 2: Festlegen der zeitplanbasierten automatischen Skalierung des HDInsight-Clusters
```powershell
...
Mit diesem Befehl wird die zeitplanbasierte Konfiguration der automatischen Skalierung des HDInsight-Clusters bestimmt.

### Beispiel 3: Festlegen der Konfiguration der automatischen Skalierung des HDInsight-Clusters, der auf einem anderen Cluster basiert, der die Konfiguration der automatischen Skalierung festgelegt hat
```powershell
...
Mit diesem Befehl wird die Konfiguration der automatischen Skalierung des HDInsight-Clusters auf Basis eines anderen Clusters bestimmt.
...
### -Zeitplan
Festlegen terminplanbasierter Parameter
