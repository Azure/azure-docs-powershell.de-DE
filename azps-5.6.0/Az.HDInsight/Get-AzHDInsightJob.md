...
## BESCHREIBUNG
Das **Get-AzHDInsightJob-Cmdlet** ruft die letzten Aufträge für einen angegebenen Azure HDInsight-Cluster in umgekehrter chronologischer Reihenfolge ab, mit dem neuesten Auftrag ganz oben in der Liste.
Erhalten Sie einen bestimmten Auftrag, indem Sie den *Parameter "JobId"* angeben.

## BEISPIELE

### Beispiel 1: Herunterladen der letzten Aufträge für einen angegebenen Azure HDInsight-Cluster
```
PS C:\># Cluster info
...
Dieser Befehl ruft alle aktuellen Aufträge für den Cluster mit dem Namen "your-hadoop-001" ab.
