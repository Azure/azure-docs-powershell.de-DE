...
## BESCHREIBUNG
Das **Cmdlet Get-AzHDInsightClusterAutoscaleConfiguration** ruft die Konfiguration der automatischen Skalierung des HDInsight-Clusters ab.

## BEISPIELE

### Beispiel 1: Herunterladen der Konfiguration für die automatische Skalierung des HDInsight-Clusters.
```powershell
...
Dieser Befehl ruft die Konfiguration der automatischen Skalierung des HDInsight-Clusters ab.
