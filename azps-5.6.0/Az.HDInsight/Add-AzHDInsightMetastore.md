...
## BESCHREIBUNG
Das **Add-AzHDInsightMetastore-Cmdlet** fügt dem vom cmdlet erstellten HDIn New-AzHDInsightClusterConfig sight-Konfigurationsobjekt einen Hive- oder Oozie-Metastore hinzu.
Ein Metastore ist eine SQL-Datenbank, die zum Speichern von Metadaten für Hive, Oozie oder beides verwendet werden kann.

## BEISPIELE

### Beispiel 1: Hinzufügen eines SQL-Datenbankmetspeichers zum Clusterkonfigurationsobjekt
```
...
Mit diesem Befehl wird SQL Datenbankmetastore zum Cluster mit dem Namen your-hadoop-001 hinzugefügt.

### Beispiel 2: Hinzufügen einer benutzerdefinierten "Ambari"-Datenbank zum Clusterkonfigurationsobjekt
```
PS C:\># Primary storage account info
PS C:\> $storageAccountResourceGroupName = "Group"
PS C:\> $storageAccountResourceId = "yourstorageaccountresourceid"
...
Mit diesem Befehl wird dem Cluster mit dem Namen "your-hadoop-002" eine benutzerdefinierte "Ambari-Datenbank" hinzugefügt.
