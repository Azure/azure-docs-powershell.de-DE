...
## BESCHREIBUNG
Das **Get-AzNotificationHubListKey-Cmdlet** gibt die primären und sekundären Verbindungszeichenfolgen einer Benachrichtigungshub-Sas-Autorisierungsregel (Shared Access Signature) zurück.
...
- Zeigen Sie Benutzer auf eine Ressource.
...
### -AuthorizationRule
Gibt den Namen einer Sas-Authentifizierungsregel (Shared Access Signature) an.
