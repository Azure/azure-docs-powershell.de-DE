...
## BESCHREIBUNG
Das **Cmdlet Remove-AzNotificationHubsNamespaceAuthorizationRule** entfernt eine Sas-Autorisierungsregel (Shared Access Signature) aus einem Benachrichtigungshubnamespace.
Autorisierungsregeln verwalten den Zugriff auf einen Namespace.
Dies erfolgt über die Erstellung von Links als URIs, die auf unterschiedlichen Berechtigungsstufen basieren.
Berechtigungsstufen können wie folgt sein: 
- Anhören
- Senden
