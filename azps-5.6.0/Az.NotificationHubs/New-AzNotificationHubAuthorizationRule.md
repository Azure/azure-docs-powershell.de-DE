...
## BESCHREIBUNG
Das **Cmdlet New-AzNotificationHubAuthorizationRule** erstellt eine Sas-Autorisierungsregel (Shared Access Signature) für den Benachrichtigungshub.
Autorisierungsregeln werden verwendet, um den Zugriff auf Ihre Benachrichtigungshubs zu verwalten.
Dies erfolgt durch erstellen von Links als URIs, die auf unterschiedlichen Berechtigungsstufen basieren.
...
Dieser Hub befindet sich im ContosoNamespace-Namespace und ist der Ressourcengruppe ContosoNotificationsGroup zugewiesen.
