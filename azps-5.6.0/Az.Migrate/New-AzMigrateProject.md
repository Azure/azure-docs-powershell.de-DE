...
Methode zum Erstellen eines neuen Migrierenprojekts.
...
Informationen zum Erstellen finden Sie im Abschnitt NOTIZEN zu EIGENSCHAFTENeigenschaften, und erstellen Sie eine Hashtabelle.
...
EIGENSCHAFT <IMigrateProjectProperties> : Gibt die Projekteigenschaften an.
  ...
  - `[RegisteredTool <String[]>]`: Ruft die Liste der tools ab, die für das Migrierenprojekt registriert sind, oder legt sie fest.
