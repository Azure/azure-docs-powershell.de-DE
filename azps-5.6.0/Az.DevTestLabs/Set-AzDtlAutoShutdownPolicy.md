...
## BESCHREIBUNG
Das **Cmdlet Set-AzDtlAutoShutdownPolicy** legt die Richtlinie für das automatische Herunterfahren einer Übungseinheit fest, durch die automatisch alle virtuellen Computer in der Übungseinheit zu einer bestimmten Tageszeit heruntergefahren werden.
...
### -Disable
Gibt an, dass das Cmdlet die Richtlinie in der Übungsumgebung deaktiviert.
...
### -Enable
Gibt an, dass das Cmdlet die Richtlinie in der Übungsumgebung aktiviert.
...
### -LabName
Gibt den Namen der Übungseinheit an, für die dieses Cmdlet die Richtlinie für das automatische Herunterfahren festgelegt hat.
