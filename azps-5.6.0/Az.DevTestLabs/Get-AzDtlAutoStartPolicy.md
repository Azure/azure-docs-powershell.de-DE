...
## BESCHREIBUNG
Das **Get-AzDtlAutoStartPolicy-Cmdlet** ruft die Richtlinie für den automatischen Start einer Übung ab, die virtuelle Computer des Labors für den automatischen Start plant.
Das Cmdlet gibt den aktivierten oder deaktivierten Status der Richtlinie sowie die Wochentage und Tageszeit zurück, die Sie festgelegt haben, damit virtuelle Computer der Übungsumgebung für den automatischen Start geplant werden können.
