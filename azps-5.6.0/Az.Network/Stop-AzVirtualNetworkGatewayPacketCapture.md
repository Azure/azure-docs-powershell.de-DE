...
## SYNOPSIS
Beendet den Paketaufnahmevorgang in einem Virtuellen Netzwerkgateway.
...
## BESCHREIBUNG
Beendet den Paketaufnahmevorgang auf einem Virtuellen Netzwerkgateway und hochgeladen das Ergebnis auf den angegebenen SasUrl des Speichercontainers.
...
### -InputObject
Das Objekt des virtuellen Netzwerkgateways, in dem die Paketaufnahme gestartet werden soll.
...
### -Name
Der Name des Virtuellen Netzwerkgateways, in dem die Paketaufnahme gestartet werden soll.
...
### -ResourceId
Die Azure-Ressourcen-ID des VirtualNetworkGateways, in dem die Paketaufnahme gestartet werden soll.
...
### -SasUrl
SAS-URL-Paketerfassung auf einem Gateway für virtuelle Netzwerke.
