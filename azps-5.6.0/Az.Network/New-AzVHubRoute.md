...
Der obige Befehl erstellt ein VHubRoute-Objekt mit nextHop als angegebene Firewall, die dann einer VHubRouteTable-Ressource hinzugefügt werden kann.
...
Mit dem obigen Befehl wird ein VHubRoute-Objekt mit nextHop als angegebenem hubVnetConnection erstellt, das dann einer VHubRouteTable-Ressource hinzugefügt werden kann.
...
```
Die oben genannten Befehle erhalten die RoutingConfiguration eines bereits vorhandenen AzVHubRoutes und fügen dann eine statische Route für die Verbindung hinzu. Wenn Sie aber auch hoffen, eine neue Verbindung mit der statischen Route zu erstellen, lesen Sie Beispiel 1 [hier.](New-AzRoutingConfiguration.md)
## PARAMETER
