...
## BESCHREIBUNG
**Das AzApplicationGatewayRewriteRuleCondition-Cmdlet** erstellt eine Neuschreibregelbedingung für ein Azure-Anwendungsgateway.
...
```
Dieser Befehl erstellt eine Bedingung in einer Neuschreibregel und speichert das Ergebnis in der Variablen namens $condition.
...
### -IgnoreCase
Festlegen dieses Kennzeichens zum Ignorieren von Fällen im Muster
...
### -Neggate
Festlegen dieses Kennzeichens zum Negieren der Bedingungsüberprüfung
...
### -Pattern
Muster, nach dem sie in der Variablenüberschrift suchen möchten
...
### -Variable
Name der Kopfzeile, die bedingungs festgelegt werden soll
