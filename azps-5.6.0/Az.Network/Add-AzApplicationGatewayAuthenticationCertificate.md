...
## BESCHREIBUNG
Das **Add-AzApplicationGatewayAuthenticationCertificate-Cmdlet** fügt einem Azure-Anwendungsgateway ein Authentifizierungszertifikat hinzu.
...
### -CertificateFile
Gibt den Pfad des Authentifizierungszertifikats an, das von diesem Cmdlet addiert wird.
