...
## BESCHREIBUNG
Das **Cmdlet Test-AzPrivateIPAddressAvailability** testet, ob eine angegebene private IP-Adresse in einem virtuellen Netzwerk verfügbar ist.
Dieses Cmdlet gibt eine Liste der verfügbaren privaten IP-Adressen zurück, wenn die angeforderte private IP-Adresse verwendet wird.
...
Dieser Befehl ruft ein virtuelles Netzwerk ab und verwendet den Pipelineoperator, um es an **Test-AzPrivateIPAddressAvailability** zu übergeben, wodurch überprüft wird, ob die angegebene private IP-Adresse verfügbar ist.
