...
Mit diesem Befehl wird eine Netzwerkschnittstelle mit dem Namen NetworkInterface001 mit einer dynamisch zugewiesenen privaten IP-Adresse aus Subnetz1 im virtuellen Netzwerk namens VirtualNetwork1 erstellt. Der Befehl weist der Netzwerkschnittstelle auch zwei DNS-Server zu. Die untergeordnete IPConfiguration-Ressource wird automatisch unter dem Namen IPConfiguration1 erstellt.
...
Der zweite Befehl erstellt eine IP-Netzwerkschnittstellenkonfiguration namens IPConfig1 und speichert die Konfiguration in der Variablen namens $IPconfig.
Mit dem dritten Befehl wird eine Netzwerkschnittstelle namens NetworkInterface1 erstellt, die die IN-IP-Konfiguration der Netzwerkschnittstelle verwendet, die in der Variablen namens $IPconfig.
...
Gibt eine Sammlung von Anwendungssicherheitsgruppeverweisen an, zu denen die IP-Konfiguration der Netzwerkschnittstelle gehören soll.
...
Mit der IP-Weiterleitung kann ein virtueller Computer Datenverkehr empfangen, der an andere Ziele adressiert ist.
...
Gibt die interne DNS-Namensbeschriftung für die neue Netzwerkschnittstelle an.
...
### -IpConfiguration
Gibt die IP-Konfiguration an, die von diesem Cmdlet für die Netzwerkschnittstelle verwendet wird.
...
Gibt eine eingehende NAT-Regelkonfiguration für einen Load Balancer an.
...
Gibt die ID einer eingehenden NAT-Regelkonfiguration für einen Load Balancer an.
