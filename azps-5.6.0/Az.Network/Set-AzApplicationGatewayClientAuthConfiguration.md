...
## SYNOPSIS
Ändert die Konfiguration der Clientauthentisierung eines Ssl-Profilobjekts.
...
## BESCHREIBUNG
Das **Cmdlet Set-AzApplicationGatewayClientAuthConfiguration** ändert die Clientauth-Konfiguration eines SSL-Profilobjekts.
...
Der erste Befehl ruft das Anwendungsgateway mit dem Namen ApplicationGateway01 in der Ressourcengruppe "ResourceGroup01" ab und speichert es in der $AppGw Variablen. Der zweite Befehl ruft das SSL-Profil mit dem Namen SslProfile01 für $AppGw ab und speichert die Einstellungen in der $profile Variablen. Mit dem letzten Befehl wird die Clientauth-Konfiguration des ssl-Profilobjekts geändert, das in $profile.
