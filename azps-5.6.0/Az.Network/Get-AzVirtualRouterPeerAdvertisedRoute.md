...
## SYNOPSIS
Listenrouten, die von einem bestimmten Peer für virtuelle Router angekündigt werden
...
## BESCHREIBUNG
Geben Sie einem virtuellen Router-Peer entweder nach Name oder Objekt eine Aufzählung von Routen an, die von einem bestimmten virtuellen Router an den Peer angekündigt werden.
...
### -PeerName
Peername des virtuellen Routers
...
### -ResourceGroupName
Name der Peerressourcengruppe des virtuellen Routers
