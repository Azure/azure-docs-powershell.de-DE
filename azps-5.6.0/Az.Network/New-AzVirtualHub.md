...
Mit dem vorstehenden Beispiel wird eine Ressourcengruppe "testRG", ein virtuelles WAN und ein virtueller Hub in West USA in dieser Ressourcengruppe in Azure erstellt. Der virtuelle Hub hat den Adressbereich "10.0.1.0/24".
...
Mit dem vorstehenden Beispiel wird eine Ressourcengruppe "testRG", ein virtuelles WAN und ein virtueller Hub in West USA in dieser Ressourcengruppe in Azure erstellt. Der virtuelle Hub hat den Adressbereich "10.0.1.0/24" und eine Routentabelle angefügt.
...
### -AddressPrefix
Die Adressbereichszeichenfolge für diesen virtuellen Hub.
...
### -HubVnetConnection
Die virtuellen Hubnetzwerkverbindungen, die diesem virtuellen Hub zugeordnet sind.
...
### -RouteTable
Die routentabelle, die diesem virtuellen Hub zugeordnet ist.
