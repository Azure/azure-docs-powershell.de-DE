...
In diesem Beispiel wird eine Sammlung mit einer Regel erstellt. Alle Datenverkehrsdaten, die den in $rule 1 identifizierten Bedingungen $rule werden als übersetzte Adresse und Portierung verwendet.
...
In diesem Beispiel wird eine neue NAT-Regelsammlung mit einer Regel erstellt, und dann wird die Regel nach Name ruft, indem die -Methode GetRuleByName für das Regelsammlungsobjekt aufruft. Der Regelname für die Methode GetRuleByName ist groß-/kleinschreibungsunabhängiger.
...
In diesem Beispiel wird eine neue NAT-Regelsammlung mit zwei Regeln erstellt und dann die erste Regel aus der Regelsammlung entfernt, indem die Methode RemoveRuleByName für das Regelsammlungsobjekt aufruft. Der Regelname für die Methode RemoveRuleByName ist groß- und kleinschreibungsunabhängiger.
