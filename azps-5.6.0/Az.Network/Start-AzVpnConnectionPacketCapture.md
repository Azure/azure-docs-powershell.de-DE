...
## SYNOPSIS
Startet den Paketaufnahmevorgang für eine Vpn-Verbindung.
...
### -FilterData
Filteroptionen zum Starten der Paketaufnahme bei einer Vpn-Verbindung.
...
### -InputObject
Das Vpn-Verbindungsobjekt, in dem die Paketaufnahme gestartet werden soll.
...
### -Name
Der Name der Vpn-Verbindung, in dem die Paketaufnahme gestartet werden soll.
...
### -ParentResourceName
Der Name des übergeordneten Vpngateways.
...
### -ResourceId
Die Azure-Ressourcen-ID der VpnConnection, in der die Paketaufnahme gestartet werden soll.
