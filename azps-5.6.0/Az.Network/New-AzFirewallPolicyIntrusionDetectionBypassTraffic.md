...
## SYNOPSIS
Erstellt eine neue Einstellung für die Erkennung von Datenverkehrsumgehungen durch Azure Firewall-Richtlinien
...
## BESCHREIBUNG
Das **Cmdlet New-AzFirewallPolicyIntrusionDetectionBypassTraffic** erstellt ein Azure Firewall Policy Intrusion Detection Bypass Traffic Object.
...
### -Beschreibung
Beschreibung der Einstellung umgehen.
...
### -Name
Umgehen des Einstellungsnamens.
...
### -Protocol
Umgehung des Einstellungsprotokolls.
...
### -SourceAddress
Liste der Quell-IP-Adressen oder -Bereiche.
