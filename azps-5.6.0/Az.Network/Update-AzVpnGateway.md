...
Ein Azure VPN-Gateway ist eine softwaredefinierte Konnektivität für Website-zu-Website-Verbindungen innerhalb des VirtualHub. Die Größe und Skalierung dieses Gateways wird basierend auf der vom Benutzer angegebenen Skalierungseinheit angepasst. Eine Verbindung kann von einer als VPN-Website bezeichneten Verzweigung/Website zum skalierbaren Gateway eingerichtet werden. Jede Verbindung besteht aus 2 Active-Active Tunneln
...
### -InputObject
Das zu ändernde Vpngatewayobjekt
...
### -ResourceId
Die Azure-Ressourcen-ID des vpnGateways, das geändert werden soll.
