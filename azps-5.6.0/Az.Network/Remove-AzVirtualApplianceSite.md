...
## SYNOPSIS
Entfernen Einer virtuellen Gerätewebsite aus einer Virtuellen Netzwerkgerätressource.
...
## BESCHREIBUNG
Mit Remove-AzVirtualApplianceSite befehl wird eine Virtual Appliance-Website aus einer Virtuellen Netzwerkgerätressource entfernt.
...
Die Ressourcen-ID der virtuellen Netzwerkgeräte, die dieser Website zugeordnet sind.
