...
## BESCHREIBUNG
Das **Cmdlet Remove-AzPrivateLinkService** entfernt einen privaten Linkdienst.
...
In diesem Beispiel wird ein privater Linkdienst mit dem Namen TestPrivateLinkService entfernt.
...
### -Erzwingen
Bitten Sie nicht um Bestätigung, wenn Sie eine Ressource löschen möchten
...
### -ResourceGroupName
Der Ressourcengruppenname des privaten Linkdiensts.
