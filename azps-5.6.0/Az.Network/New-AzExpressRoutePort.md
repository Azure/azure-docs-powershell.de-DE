...
## BESCHREIBUNG
Das **New-AzExpressRoutePort-Cmdlet** erstellt einen Azure ExpressRoutePort
...
### -BandwidthInGbps
Bandbreite der beschafften Ports in Gbps
...
### -Link
Der Satz physischer Links der ExpressRoutePort-Ressource
...
### -PeeringLocation
Der Name des Peeringspeicherorts, dem der ExpressRoutePort physisch zugeordnet ist.
