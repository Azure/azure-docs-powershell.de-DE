...
Nachdem das Gateway erstellt wurde, wird es über den Befehl New-AzExpressRouteConnection mit dem lokalen ExpressRoute-Schaltkreis verbunden.
...
Dieser Befehl zeigt alle Verbindungen in ExpressRoute "testExpressRoutegw" an, die mit "test" beginnen.
