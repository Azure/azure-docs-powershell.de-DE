...
## SYNOPSIS
Ruft die private Linkkonfiguration eines Anwendungsgateways ab.
...
## BESCHREIBUNG
Das **Cmdlet Get-AzApplicationGatewayPrivateLinkConfiguration** ruft die private Linkkonfiguration eines Anwendungsgateways ab.
...
Der zweite Befehl ruft die private Linkkonfiguration mit dem Namen privateLinkConfig01 aus $AppGw ab und speichert sie in der $PrivateLinkConfiguration Variablen.

### Beispiel 2: Eine Liste der Konfiguration privater Verknüpfungen
```powershell
PS C:\>$AppGw = Get-AzApplicationGateway -Name "ApplicationGateway01" -ResourceGroupName "ResourceGroup01"
...
Der erste Befehl ruft ein Anwendungsgateway namens ApplicationGateway01 aus der Ressourcengruppe "ResourceGroup01" ab und speichert es in der $AppGw Variablen.
Der zweite Befehl ruft alle privaten Linkkonfigurationen aus $AppGw und speichert sie in der $PrivateLinkConfigurations-Variable.
