...
## SYNOPSIS
Entfernt einen virtuellen Netzwerktipp.
...
## BESCHREIBUNG
Das **Cmdlet Remove-AzVirtualNetworkTap** entfernt einen Azure Virtual Network Tap.

## BEISPIELE

### Beispiel 1: Entfernen eines virtuellen Netzwerks
```
PS C:\>Remove-AzNetworkInterface -Name "VirtualNetworkTap1" -ResourceGroup "ResourceGroup1"
```

Mit diesem Befehl wird das VirtualNetworkTap1 in der Ressourcengruppe ResourceGroup1 entfernt.
...
### -InputObject
Verweis auf virtualNetworkTap-Ressource
