...
## BESCHREIBUNG
Das **Cmdlet Remove-AzCustomIpPrefix** entfernt ein CustomIpPrefix.
...
Entfernt das CustomIpPrefix mit name $prefixName aus der Ressourcengruppe $rgName
