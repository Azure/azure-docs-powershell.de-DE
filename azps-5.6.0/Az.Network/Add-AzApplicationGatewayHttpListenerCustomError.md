...
## BESCHREIBUNG
Das **Add-AzApplicationGatewayCustomError-Cmdlet** fügt einem Http-Listener eines Anwendungsgateways einen benutzerdefinierten Fehler hinzu.

## BEISPIELE

### Beispiel 1: Fügt der Http-Listenerebene benutzerdefinierten Fehler hinzu.
```powershell
