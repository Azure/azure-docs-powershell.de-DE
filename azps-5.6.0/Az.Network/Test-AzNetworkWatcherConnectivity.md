...
## SYNOPSIS
Gibt Konnektivitätsinformationen für eine angegebene Quell-VM und ein Ziel zurück.
...
## BESCHREIBUNG
Das Test-AzNetworkWatcherConnectivity-Cmdlet gibt Konnektivitätsinformationen für eine angegebene Quell-VM und ein Ziel zurück. Wenn die Verbindung zwischen Quelle und Ziel nicht hergestellt werden kann, gibt das Cmdlet Details zu dem Problem zurück.

## BEISPIELE

### Beispiel 1: Testen der Netzwerkwächterkonnektivität von einer VM zu einer Website
```powershell
...
In diesem Beispiel testen wir die Konnektivität von einer VM in Azure zu www.bing.com.

### Beispiel 2

Gibt Konnektivitätsinformationen für eine angegebene Quell-VM und ein Ziel zurück. (automatisch generiert)
...
### -DestinationAddress
Die IP-Adresse oder der URI der Ressource, zu der ein Verbindungsversuch vorgenommen wird.
...
### -DestinationId
Die ID der Ressource, zu der ein Verbindungsversuch vorgenommen wird.
...
### -DestinationPort
Port, für den die Verbindung überprüft wird.
...
Protokollkonfiguration, für die die Verbindung überprüft wird.
...
### -SourceId
Die ID der Ressource, von der eine Konnektivitätsprüfung initiiert wird.
...
### -SourcePort
Der Quellport, über den eine Konnektivitätsprüfung ausgeführt wird.
