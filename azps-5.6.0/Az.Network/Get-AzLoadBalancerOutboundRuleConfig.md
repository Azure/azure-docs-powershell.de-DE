...
## BESCHREIBUNG
Das **Get-AzLoadBalancerOutboundRuleConfig-Cmdlet** ruft eine ausgehende Regelkonfiguration oder eine Liste ausgehender Regelkonfigurationen in einem Load Balancer ab.

## BEISPIELE

### Beispiel 1: Erhalten einer ausgehenden Regelkonfiguration in einem Load Balancer
```powershell
...
Der zweite Befehl ruft die ausgehende Regelkonfiguration mit dem Namen MyRule ab, die diesem Lastenausgleich zugeordnet ist.
