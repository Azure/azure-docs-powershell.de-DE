...
## SYNOPSIS
Entfernt eine Azure-Firewallrichtlinie
...
## BESCHREIBUNG
Das **Cmdlet Remove-AzFirewallPolicy** entfernt eine Azure-Firewallrichtlinie.
...
In diesem Beispiel wird die Firewallrichtlinie mit dem Namen "firewallpolicy" in der Ressourcengruppe "TestRg" entfernt.
...
In diesem Beispiel wird die Firewallrichtlinie durch die ID entfernt.
...
In diesem Beispiel wird die Firewallrichtlinienrichtlinie $fp
