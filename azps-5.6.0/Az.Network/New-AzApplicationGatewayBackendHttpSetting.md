...
Mit diesem Befehl werden die Back-End-HTTP-Einstellungen mit dem Namen Einstellung01 für Port 80 mithilfe des HTTP-Protokolls erstellt, bei dem die cookiebasierte Affinität deaktiviert ist.
Die Einstellungen werden in der $Setting gespeichert.
