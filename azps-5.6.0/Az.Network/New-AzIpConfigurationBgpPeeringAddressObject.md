...
## SYNOPSIS
erstellt ein neues IpconfigurationBgpPeeringAddressObject
...
```
## BESCHREIBUNG
Das **New-AzIpConfigurationBgpPeeringAddressObject** erstellt ein IpConfigurationBgpPeeringAddressObject-Objekt, das die BgpPeeringAddresses-Eigenschaft in Ihrem virtuellen Netzwerkgateway bgpsettings darstellt.

## BEISPIELE

### 1: Erstellen eines AzIpConfigurationBgpPeeringAddressObject
```
...
Mit dem oben genannten Objekt wird ein IpConfigurationBgpPeeringAddressObject erstellt. Dieses neue Objekt wird für gw1ipconfBgp1 verwendet.
