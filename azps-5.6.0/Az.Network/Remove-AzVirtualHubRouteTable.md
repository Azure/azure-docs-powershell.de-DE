...
## SYNOPSIS
Löschen Sie eine Ressource für eine virtuelle Hubroutentabelle, die einem virtuellen Hub zugeordnet ist.
...
### -InputObject
Die virtualhubroutetable-Ressource, die entfernt werden soll.
...
### -ResourceId
Die Ressourcen-ID der virtualhubroutetable-Ressource, die entfernt werden soll.
