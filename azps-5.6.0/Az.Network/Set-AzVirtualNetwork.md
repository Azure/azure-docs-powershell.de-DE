...
In diesem Beispiel wird ein virtuelles Netzwerk namens TestResourceGroup mit zwei Subnetzen erstellt: frontendSubnet und back-EndSubnet. Anschließend wird das Back-EndSubnet-Subnetz aus der Speicherdarstellung des virtuellen Netzwerks entfernt. Das Set-AzVirtualNetwork-Cmdlet wird dann zum Schreiben des geänderten virtuellen Netzwerkzustands auf der Dienstseite verwendet. Wenn das Set-AzVirtualNetwork-Cmdlet ausgeführt wird, wird das backendSubnet entfernt.
