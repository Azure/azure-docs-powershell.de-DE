...
## SYNOPSIS
Erstellt eine IPSec-Verbindung, die ein VpnGateway mit einer Remotekundenverzweigung verbindet, die in RM als VpnSite dargestellt wird.
...
Mit dem vorstehenden Beispiel werden eine Ressourcengruppe, virtuelles WAN, virtuelles Netzwerk, virtueller Hub und eine VpnWebsite mit 1 VpnSiteLinks in West USA in der Ressourcengruppe "testRG" in Azure erstellt.
...
### -VpnSite
Die Remote-VPN-Website, mit der diese virtuelle Netzwerkverbindung des Hubs verbunden ist.
...
Die Liste der VpnSiteLinkConnections, über die diese VpnConnection verfügt.
