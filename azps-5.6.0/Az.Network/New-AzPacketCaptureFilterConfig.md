...
## SYNOPSIS
Erstellt ein neues Paketaufnahmefilterobjekt.
...
## BESCHREIBUNG
Das New-AzPacketCaptureFilterConfig-Cmdlet erstellt ein neues Paketaufnahmefilterobjekt. Dieses Objekt wird verwendet, um den Typ von Paketen einzuschränken, die während einer Paketaufnahmesitzung mithilfe der angegebenen Kriterien erfasst werden. Das New-AzNetworkWatcherPacketCapture-Cmdlet kann mehrere Filterobjekte akzeptieren, um komposierbare Aufnahmesitzungen zu aktivieren.
...
### -Protocol
Gibt das Protokoll an, nach dem gefiltert werden soll. Zulässige Werte "TCP", "UDP", "Any"
...
Remoteport Beispieleingaben: "80" für die Einzelporteingabe.
"80-85" für Bereich.
