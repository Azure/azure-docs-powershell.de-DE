...
## SYNOPSIS
Generiert und lädt das Vpn-Profil auf VirtualWan-VpnServerConfiguration Ebene für die Einrichtung des Point to-Websiteclients herunter.
...
## BESCHREIBUNG
Das **Get-AzVirtualWanVpnServerConfigurationVpnProfile-Cmdlet** ermöglicht ihnen das Generieren und Herunterladen des Vpn-Profils auf VirtualWan-VpnServerConfiguration Ebene für das Einrichten des Point to-Websiteclients. Dies ist für die Punkt-zu-Website-Konnektivität vom Punkt-zu-Website-Client zu Azure P2SVpnGateway erforderlich.
...
Der oben aufgeführte Befehl generiert und gibt die SAS-URL des Kunden zurück, um das Vpn-Profil auf VirtualWan-VpnServerConfiguration Ebene für das Einrichten des Websiteclients "Punkt auf" herunterzuladen.
...
Die VpnServerConfiguration, der dieser VirtualWan zugeordnet ist.
...
Die ID des Vpn Server-Configuraiton-Objekts, dem dieses virtuelle Wan zugeordnet wird.
