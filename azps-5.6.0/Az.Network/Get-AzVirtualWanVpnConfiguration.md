...
## SYNOPSIS
Ruft die Vpn-Konfiguration für eine Teilmenge der vpnSites ab, die über VpnConnections mit diesem WAN verbunden sind. Lädt die generierte Vpn-Konfiguration in einen vom Kunden angegebenen Speicherblobs hoch.
...
Mit dem vorstehenden Beispiel werden eine Ressourcengruppe, virtuelles WAN, virtuelles Netzwerk, virtueller Hub und eine VpnWebsite in West USA in der Ressourcengruppe "testRG" in Azure erstellt. Anschließend wird im virtuellen Hub ein VPN-Gateway mit zwei Skalierungseinheiten erstellt.

Nachdem das Gateway erstellt wurde, wird es mithilfe des Befehls New-AzVpnConnection mit der VpnSite verbunden.

Die Konfiguration wird dann mit diesem Commandlet heruntergeladen.

Wenn das Befehlslet erfolgreich ist, wird die Downloadkonfiguration in den Blob geschrieben, der durch signedSasUrl angegeben ist.
