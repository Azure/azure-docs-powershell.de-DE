...
### Beispiel 1: Aktualisieren eines vorhandenen SSL-Zertifikats auf dem Anwendungsgateway
```
...
### Beispiel 2: Aktualisieren eines vorhandenen SSL-Zertifikats mit KeyVault Secret (version-less secretId) im Application Gateway
```
...
Holen Sie sich den Geheimtipp, und aktualisieren Sie ein vorhandenes SSL-Zertifikat mithilfe `Set-AzApplicationGatewaySslCertificate` von .

### Beispiel 3: Aktualisieren eines vorhandenen SSL-Zertifikats mit KeyVault Secret im Anwendungsgateway
```
PS C:\> $secret = Get-AzKeyVaultSecret -VaultName "keyvault01" -Name "sslCert01"
...
### -ApplicationGateway
Gibt das Anwendungsgateway an, dem das SSL-Zertifikat (Secure Socket Layer) zugeordnet ist.
