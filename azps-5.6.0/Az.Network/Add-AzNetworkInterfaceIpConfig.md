...
## SYNOPSIS
Fügt einer Netzwerkschnittstelle eine IP-Konfiguration der Netzwerkschnittstelle hinzu.
...
## BESCHREIBUNG
Das **Add-AzNetworkInterfaceIpConfig-Cmdlet** fügt einer Azure-Netzwerkschnittstelle eine IP-Konfiguration der Netzwerkschnittstelle hinzu.
...
In diesem Beispiel erstellen wir eine neue Netzwerkschnittstelle MyNetworkInterface, die zu einem Subnetz im neuen virtuellen Netzwerk MyVNET gehört. Außerdem erstellen wir eine leere Anwendungssicherheitsgruppe MyASG, die den IP-Konfigurationen in der Netzwerkschnittstelle zugeordnet werden soll. Nachdem beide Objekte erstellt wurden, verknüpfen wir die Standard-IP-Konfiguration mit dem MyASG-Objekt. Schließlich erstellen wir eine neue IP-Konfiguration in der Netzwerkschnittstelle, die ebenfalls mit dem Sicherheitsgruppenobjekt der Anwendung verknüpft ist.
