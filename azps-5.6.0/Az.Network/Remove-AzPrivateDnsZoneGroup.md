...
## BESCHREIBUNG
Das **Cmdlet Remove-AzPrivateDnsZoneGroup** entfernt eine DNS-Zonengruppe. 
...
Im vorstehenden Beispiel wird ein DNS-Zonen-Grup mit dem Namen dnsgroup1 aus endpunkttest-pr-endpoint entfernt.
...
### -Name
Der Name der gruppe für private DNS-Zonen.
