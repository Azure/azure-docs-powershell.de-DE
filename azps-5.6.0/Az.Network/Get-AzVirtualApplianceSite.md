...
## SYNOPSIS
Erstellen oder Auflisten von Websites, die mit Ressourcen der virtuellen Netzwerkgeräte verbunden sind
...
## BESCHREIBUNG
Die Get-AzVirtualApplianceSite ruft Websites ab oder listet Websites auf, die mit einer oder mehreren Ressourcen der virtuellen Netzwerkgeräte verbunden sind.
...
Holen Sie sich eine Virtual Appliance-Websiteressource.
...
Listen Sie ressourcen der virtuellen Appliance in einer virtuellen Netzwerkgerät auf.
...
Die virtuelle Netzwerkgerät, der die Website angefügt ist.
...
### -ResourceId
Die Ressourcen-ID der Virtuellen Gerätewebsite.
