...
## BESCHREIBUNG
Mit **dem Cmdlet Remove-AzP2sVpnGateway** können Sie ein vorhandenes P2SVpnGateway unter VirtualHub entfernen. Nach dem Entfernen von P2SVpnGateway kann die Verbindung zu Websiteclients nicht mehr verwendet werden.
