...
## BESCHREIBUNG
Das **Cmdlet Set-AzApplicationGatewayWebApplicationFirewallConfiguration** ändert die Web Application Firewall (WAF)-Konfiguration eines Anwendungsgateways.
...
Der erste Befehl ruft das Anwendungsgateway mit dem Namen ApplicationGateway01 ab und speichert es dann in der $AppGw-Variable.
Der zweite Befehl aktiviert die Firewallkonfiguration für das in $AppGw gespeicherte Anwendungsgateway und legt den Firewallmodus auf "Detection", RuleSetType auf "OWASP" und die RuleSetVersion auf "3.0" fest.

## PARAMETER

### -ApplicationGateway
Gibt ein Anwendungsgatewayobjekt an.
Sie können das Get-AzApplicationGateway-Cmdlet verwenden, um ein Anwendungsgatewayobjekt zu erhalten.
