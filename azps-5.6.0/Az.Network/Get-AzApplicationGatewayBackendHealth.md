...
## BESCHREIBUNG
Das Get-AzApplicationGatewayBackendHealth-Cmdlet ruft den Zustand des Application Gateway-Back-Ends ab.
...
Dieser Befehl ruft den Back-End-Zustand des Anwendungsgateways mit dem Namen ApplicationGateway01 ab, das zur Ressourcengruppe "ResourceGroup01" gehört und es in der $BackendHealth speichert.
...
Dieser Befehl ruft den Back-End-Zustand (mit erweiterten Ressourcen) des Anwendungsgateways mit dem Namen ApplicationGateway01 ab, das zur Ressourcengruppe "ResourceGroup01" gehört und es in der Variablen $BackendHealth speichert.
