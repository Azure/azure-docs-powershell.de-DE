...
## BESCHREIBUNG
Das **Get-AzNetworkInterface-Cmdlet** ruft eine Azure-Netzwerkschnittstelle oder eine Liste der Azure-Netzwerkschnittstellen in einer Ressourcengruppe ab.
...
Dieser Befehl ruft alle Netzwerkschnittstellen in der Ressourcengruppe "ResourceGroup1" ab, für die der Bereitstellungszustand erfolgreich ist.
...
### -VirtualMachineIndex
Gibt den Virtuellen Computerindex des Skalierungssatzs für virtuelle Computer an, von dem dieses Cmdlet Netzwerkschnittstellen erhält.
...
Gibt den Namen des Skalierungssatzs für virtuelle Computer an, von dem dieses Cmdlet Netzwerkschnittstellen erhält.
