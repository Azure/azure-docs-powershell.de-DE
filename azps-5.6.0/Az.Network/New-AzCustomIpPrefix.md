...
## SYNOPSIS
Erstellt eine CustomIpPrefix-Ressource
...
## BESCHREIBUNG
Das **Cmdlet New-AzCustomIpPrefix** erstellt eine CustomIpPrefix-Ressource.
...
Mit diesem Befehl wird eine neue CustomIpPrefix-Ressource mit dem Namen $prefixName in der Ressourcengruppe $rgName mit einem Cidr von 40.40.40.0/24 in westus erstellt.
...
### -Location
Der CustomIpPrefix-Speicherort.
