...
## SYNOPSIS
Aktualisiert eine Expressroutenverbindung, die zwischen einem Expressroutengateway und einem lokalen Expressroutenkreis-Peering erstellt wurde.
...
## BESCHREIBUNG
Das **Set-AzExpressRouteConnection-Cmdlet** aktualisiert eine Expressroutenverbindung, die zwischen einem Expressroutengateway und einem lokalen Expressroutenkreis-Peering erstellt wurde.
...
Mit den vorstehenden Beispielen werden eine Ressourcengruppe, virtuelles WAN, virtuelles Netzwerk, virtueller Hub und eine ExpressRouteSite in West USA in der Ressourcengruppe "testRG" in Azure erstellt. Anschließend wird im virtuellen Hub ein ExpressRoute-Gateway mit zwei Skalierungseinheiten erstellt.

Nachdem das Gateway erstellt wurde, wird es mit dem lokalen ExpressRoute-Schaltkreis-Peering mithilfe des Befehls New-AzExpressRouteConnection verbunden.

Die Verbindung wird dann mithilfe des Befehls "RoutingWeight" Set-AzExpressRouteConnection aktualisiert.
...
### -AuthorizationKey
Der Autorisierungsschlüssel, der zum Erstellen der ExpressRoute-Gatewayverbindung verwendet werden soll.
