...
## BESCHREIBUNG
Das **Add-AzApplicationGatewayHttpListener-Cmdlet** fügt einem Anwendungsgateway einen HTTP-Listener hinzu.
...
Der erste Befehl ruft das Anwendungsgateway ab und speichert es in der $AppGw Variablen. Mit dem zweiten Befehl wird der HTTP-Listener zum Anwendungsgateway addiert.
...
Der zweite Befehl fügt den Listener, der das HTTPS-Protokoll verwendet, zum Anwendungsgateway hinzu.

### Beispiel 3: Hinzufügen eines HTTPS-Listeners mit SSL und HostNamen
```
PS C:\>$AppGw = Get-AzApplicationGateway -Name "ApplicationGateway01" -ResourceGroupName "ResourceGroup01"
...
Der erste Befehl ruft das Anwendungsgateway ab und speichert es in der $AppGw Variablen.
Mit dem zweiten Befehl wird der Listener, der das HTTPS-Protokoll mit SSL-Zertifikaten und HostNamen verwendet, zum Anwendungsgateway addiert.
...
### -Protocol
Gibt das Protokoll des HTTP-Listeners an.
...
Muss angegeben werden, wenn HTTPS als Listenerprotokoll ausgewählt ist.
...
### -SslCertificateId
Gibt die SSL-Zertifikat-ID des HTTP-Listeners an.
Muss angegeben werden, wenn HTTPS als Listenerprotokoll ausgewählt ist.
