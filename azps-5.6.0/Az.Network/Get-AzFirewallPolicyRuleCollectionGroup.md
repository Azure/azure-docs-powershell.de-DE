...
## SYNOPSIS
Ruft eine Azure Firewall-Richtlinienregelsammlungsgruppe ab.
...
## BESCHREIBUNG
Das **Cmdlet Get-AzFirewallPolicyRuleCollectionGroup** ruft die in einer Firewallrichtlinie erwähnte RuleCollectionGroup ab.
...
In diesem Beispiel wird die RegelsammlungSgruppe in der Firewallrichtlinienrichtlinie $fp

### Beispiel 2

Ruft eine Azure Firewall-Richtlinienregelsammlungsgruppe ab. (automatisch generiert)
