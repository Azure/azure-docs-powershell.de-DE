...
### Beispiel 1: Erstellen einer Firewallkonfiguration für ein Anwendungsgateway
```
...
Der zweite Befehl ruft die Firewallkonfiguration des Anwendungsgateways in $AppGW ab und speichert es dann in $FirewallConfig.
