...
## SYNOPSIS
Aktualisiert eine Tippkonfiguration für eine Netzwerkschnittstelle.
...
## BESCHREIBUNG
Die **Set-AzNetworkInterfaceTapConfig** aktualisiert eine Tippkonfiguration für eine Netzwerkschnittstelle.

## BEISPIELE

### Beispiel 1: Festlegen der TapConfiguration mit dem aktualisierten TapConfig-Namen
```
...
Die Konfiguration "NetworkInterface Tap"
