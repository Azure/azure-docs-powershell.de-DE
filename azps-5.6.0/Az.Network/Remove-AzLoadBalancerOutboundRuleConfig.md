...
## SYNOPSIS
Entfernt eine ausgehende Regelkonfiguration aus einem Load Balancer.
...
Der erste Befehl ruft den Load Balancer ab, der der ausgehenden Regelkonfiguration zugeordnet ist, die Sie entfernen möchten, und speichert ihn dann in der $slb Variablen.
Mit dem zweiten Befehl wird die zugeordnete ausgehende Regelkonfiguration aus dem Load Balancer entfernt.
