...
Das **Get-AzVirtualNetworkGateway-Cmdlet** gibt das Objekt Ihres Gateways in Azure basierend auf Name und Ressourcengruppenname zurück.
...
Löscht das Objekt des Virtuellen Netzwerkgateways mit dem Namen "myGateway" innerhalb der Ressourcengruppe "myRG". Hinweis: Sie müssen zuerst alle Verbindungen mit dem Virtual Network Gateway mithilfe des **Cmdlets Remove-AzVirtualNetworkGatewayConnection** löschen.
...
### -ResourceGroupName
Gibt den Namen der Ressourcengruppe an, die das Gateway für virtuelle Netzwerke enthält.
