...
## SYNOPSIS
Ruft die ARP-Tabelle aus einer ExpressRoute-Querverbindung ab.
...
## BESCHREIBUNG
Das **Get-AzExpressRouteCrossConnectionARPTable-Cmdlet** ruft die ARP-Tabelle aus beiden Schnittstellen einer ExpressRoute-Kreuzverbindung ab. Die TABELLE ARP enthält eine Zuordnung der IPv4-Adresse zu der MAC-Adresse für ein bestimmtes Peering. Sie können die ARP-Tabelle verwenden, um die Konfiguration und Konnektivität der Ebene 2 zu überprüfen.

## BEISPIELE

### Beispiel 1: Anzeigen der ARP-Tabelle für einen ExpressRoute-Peer
```
