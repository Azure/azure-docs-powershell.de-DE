...
## SYNOPSIS
Erstellt eine neue Peeringkonfiguration, die einem ExpressRoute-Schaltkreis hinzugefügt werden soll.
...
## BESCHREIBUNG
Das **Cmdlet New-AzExpressRouteCircuitPeeringConfig** fügt einem ExpressRoute-Schaltkreis eine Peeringkonfiguration hinzu. ExpressRoute-Schaltkreise verbinden Ihr lokales Netzwerk mit der Microsoft-Cloud, indem sie einen Konnektivitätsanbieter anstelle des öffentlichen Internets verwenden.
