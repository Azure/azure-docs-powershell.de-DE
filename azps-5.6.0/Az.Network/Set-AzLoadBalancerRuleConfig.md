...
## SYNOPSIS
Aktualisiert eine Regelkonfiguration für einen Load Balancer.
...
## BESCHREIBUNG
Das **Cmdlet Set-AzLoadBalancerRuleConfig** aktualisiert eine Regelkonfiguration für einen Load Balancer.

## BEISPIELE

### Beispiel 1: Ändern einer Konfiguration einer Lastenausgleichsregel
```
...
Der zweite Befehl verwendet den Pipelineoperator, um den Load Balancer in $slb an Add-AzLoadBalancerRuleConfig zu übergeben, wodurch ihm eine Regel mit dem Namen NewRule hinzugefügt wird.
...
Beachten Sie, dass die Konfiguration keine unverankerte IP-Adresse aktiviert, die durch den vorherigen Befehl aktiviert wurde.
...
Dieses Cmdlet aktualisiert eine Regelkonfiguration für den Load Balancer, den dieser Parameter angibt.
