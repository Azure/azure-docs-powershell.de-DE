...
## BESCHREIBUNG
Das **Cmdlet New-AzExpressRoutePortIdentity** erstellt ein lokales Azure ExpressRoutePort-Identitätsobjekt. Verwenden **Sie New-AzExpressRoutePort oder** **Set-AzExpressRoutePort,** um ihn Azure ExpressRoutePort zuzuordnen.
