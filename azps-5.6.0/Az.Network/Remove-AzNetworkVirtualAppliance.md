...
## SYNOPSIS
Entfernen Sie eine Virtuelle Netzwerkgeräteressource.
...
## BESCHREIBUNG
Mit Remove-AzNetworkVirtualAppliance befehl wird eine Virtuelle Netzwerkgerätressource entfernt.
...
Löschen Einer virtuellen Netzwerkgerätressource.
