...
## BESCHREIBUNG
Erstellt eine ExpressRoute-Verbindung zwischen einem lokalen ExpressRoute-Schaltkreis-BGP-Peering mit dem ExpressRoute-Gateway innerhalb eines virtuellen Hubs.
...
Mit dem vorstehenden Beispiel werden eine Ressourcengruppe, virtuelles WAN, virtuelles Netzwerk, virtueller Hub, ExpressRoute-Gateway und ein ExpressRoute-Schaltkreis mit privatem Peering in West Central US in der Ressourcengruppe "testRG" in Azure erstellt. Nachdem das Gateway erstellt wurde, wird es mithilfe des Befehls "New-AzExpressRouteConnection" mit dem ExpressRoute-Schaltkreis-Peering verbunden.
...
### -AuthorizationKey
Ein Vom Besitzer des ExpressRoute-Schaltkreises erhaltener Schlüssel, um eine Verbindung mit einem Gateway in einem anderen Abonnement herstellen zu können.
...
Die Ressourcen-ID des Express Route Circuit-Peerings, zu dem diese ExpressRoute-Gatewayverbindung erstellt werden soll.
