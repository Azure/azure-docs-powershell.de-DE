...
## BESCHREIBUNG
Das **Update-AzCustomIpPrefix-Cmdlet** ermöglicht es dem Benutzer, sein CustomIpPrefix in Betrieb zu geben oder außer Betrieb zu geben oder die Tags der Ressource zu bearbeiten.

## BEISPIELE

### Beispiel 1: Provision the CustomIpPrefix
```powershell
PS C:\> Update-AzCustomIpPrefix -Name $prefixName -ResourceGroupName $rgName -Commission
```

Mit dem oben angegebenen Befehl wird der Prozess der In commissioning des CustomIpPrefix gestartet.

### Beispiel 2: AußerBetriebsetzen des CustomIpPrefix
```powershell
PS C:\> Update-AzCustomIpPrefix -Name $prefixName -ResourceGroupName $rgName -Decommission
```

Mit dem obigen Befehl wird der De-Commissioning-Prozess des CustomIpPrefix gestartet.

### Beispiel 3: Aktualisieren von Tags für das CustomIpPrefix
```powershell
PS C:\> Update-AzCustomIpPrefix -Name $prefixName -ResourceGroupName $rgName -Tag $tags
```

Mit dem obigen Befehl werden die Tags für customIpPrefix aktualisiert.
...
### -InputObject
Das zu setzende CustomIpPrefix.
