...
Mit diesem Befehl wird eine einfache Anforderungsroutingregel namens Regel01 erstellt und das Ergebnis in der Variablen namens $Rule.

## PARAMETER

### -Back-EndAddressPool
Gibt den Back-End-Adresspool als -Objekt an, damit die Anforderungsroutingregel erstellt wird.
...
Gibt die Back-End-HTTP-Einstellungen als -Objekt an, damit die Anforderungsroutingregel erstellt wird.
...
### -HttpListenerId
Gibt die BACK-HTTP-Listener-ID für die Anforderungsroutingregel an, die erstellt werden soll.
