...
## SYNOPSIS
Ruft das Peering für virtuelle Netzwerke ab.
...
## BESCHREIBUNG
Das **Get-AzVirtualNetworkPeering-Cmdlet** ruft das Peering für virtuelle Netzwerke ab.
...
### -ResourceGroupName
Gibt den Ressourcengruppennamen an, zu dem das peering virtuelle Netzwerk gehört.
