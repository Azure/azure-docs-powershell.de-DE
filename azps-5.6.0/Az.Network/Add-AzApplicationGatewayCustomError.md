...
## BESCHREIBUNG
Das **Add-AzApplicationGatewayCustomError-Cmdlet** fügt einem Anwendungsgateway einen benutzerdefinierten Fehler hinzu.

## BEISPIELE

### Beispiel 1: Fügt benutzerdefinierten Fehler zur Ebene des Anwendungsgateways hinzu.
```powershell
...
Dieser Befehl fügt dem Anwendungsgateway einen benutzerdefinierten Fehler des http-Statuscodes 502 hinzu$appgw und gibt das aktualisierte Gateway zurück.

### Beispiel 2: Fügt der Listenerebene des Anwendungsgateways benutzerdefinierten Fehler hinzu.
```powershell
...
Dieser Befehl fügt dem Anwendungsgateway einen benutzerdefinierten Fehler von http-Statuscode 502 $appgw Listenerebene hinzu, und gibt das aktualisierte Gateway zurück.
