...
## BESCHREIBUNG
Das **Cmdlet Remove-AzApplicationGatewayUrlPathMapConfig** entfernt URL-Pfadzuordnungen zu einem Back-End-Serverpool.

## BEISPIELE

### Beispiel 1: Entfernen einer URL-Pfadzuordnung aus einem Anwendungsgateway
```
...
Mit dem zweiten Befehl wird die URL-Pfadzuordnung mit dem Namen "map01" aus dem Anwendungsgateway entfernt.
