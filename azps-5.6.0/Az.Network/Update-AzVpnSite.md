...
Mit dem oben genannten Wird eine Ressourcengruppe erstellt, virtuelles WAN in West US in der Ressourcengruppe "testRG" in Azure. 

Anschließend wird eine VpnSite erstellt, um eine Kundenverzweigung zu repräsentieren und sie mit dem virtuellen WAN zu verbinden.

Nachdem die Website erstellt wurde, aktualisiert sie die IpAddress der Website mithilfe des Befehls Set-AzVpnSite.

## PARAMETER

### -AddressSpace
Die Adresspräfixe des virtuellen Netzwerks.
Verwenden Sie dieses oder AddressSpaceObject, aber nicht beides.
...
### -BgpAsn
Der BGP-ASN für diese VpnWebsite.
...
### -BgpPeeringWeight
Die Gewichtung des BGP-Peerings für diese VpnSite.
...
### -IpAddress
DIE IP-Adresse des lokalen Netzwerkgateways.
...
### -O365Policy
Die Office 365-Verkehrsbruchrichtlinie für diese VpnWebsite.
...
### -VirtualWan
Der VirtualWan, mit dem diese VpnSite verbunden sein muss.
...
### -VirtualWanId
Die ResourceId VirtualWan, mit der diese VpnSite verbunden sein muss.
...
### -VirtualWanName
Der Name des VirtualWan, mit dem diese VpnSite verbunden sein muss.
...
Der Ressourcengruppenname des VirtualWan, mit dem diese VpnWebsite verbunden werden muss.
