...
Der zweite Befehl legt den HTTP-Listener für das Gateway so fest, dass die in $FIP 01 gespeicherte Front-End-Konfiguration mit dem HTTP-Protokoll für Port 80 verwendet wird.

### Beispiel 2: Hinzufügen eines HTTPS-Listeners mit SSL und HostNamen
```
PS C:\>$AppGw = Get-AzApplicationGateway -Name "ApplicationGateway01" -ResourceGroupName "ResourceGroup01"
...
Gibt an, ob für das Cmdlet eine Servernamenanzeige erforderlich ist.
