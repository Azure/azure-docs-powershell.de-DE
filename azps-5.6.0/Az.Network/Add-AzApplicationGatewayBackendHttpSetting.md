...
## BESCHREIBUNG
Das Add-AzApplicationGatewayBackendHttpSetting-Cmdlet fügt einem Anwendungsgateway Back-End-HTTP-Einstellungen hinzu.
...
Der erste Befehl ruft das Anwendungsgateway mit dem Namen ApplicationGateway01 ab, das zur Ressourcengruppe "ResourceGroup01" gehört, und speichert es in der $AppGw Variablen. Der zweite Befehl fügt dem Anwendungsgateway Back-End-HTTP-Einstellungen hinzu, setzt den Port auf 88 und das Protokoll auf HTTP und nennt die Einstellungen Einstellung02.
...
### -RequestTimeout
Gibt den Zeitsendwert für die Anforderung an.
