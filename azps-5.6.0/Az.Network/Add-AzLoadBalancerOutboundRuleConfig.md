...
## SYNOPSIS
Fügt einem Load Balancer eine ausgehende Regelkonfiguration hinzu.
...
## BESCHREIBUNG
Das **Add-AzLoadBalancerOutboundRuleConfig-Cmdlet** fügt einem Azure Load Balancer eine ausgehende Regelkonfiguration hinzu.

## BEISPIELE

### Beispiel 1: Hinzufügen einer ausgehenden Regelkonfiguration zu einem Load Balancer
```powershell
...
Der zweite Befehl verwendet den Pipelineoperator, um den Load Balancer in $slb an **Add-AzLoadBalancerOutboundRuleConfig zu** übergeben, wodurch dem Load Balancer eine ausgehende Regelkonfiguration hinzugefügt wird.
