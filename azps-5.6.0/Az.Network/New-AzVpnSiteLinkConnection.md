...
### -ConnectionBandwidth
Die Bandbreite, die von dieser Linkverbindung in Mbit/s verarbeitet werden muss.
...
### -EgressNatRule
Die Liste der ausstehenden NAT-Regeln, die diesem Link Verbindung zugeordnet sind.
...
### -EnableBgp
Aktivieren von BGP für diese Linkverbindung
...
### -IngressNatRule
Die Liste der ingress-NAT-Regeln, die diesem Link Verbindung zugeordnet sind.
...
### -IpSecPolicy
IpSec-Richtlinie, die für diese Linkverbindung in Betracht gezogen werden soll.
...
Verwenden Sie richtlinienbasierte Datenverkehrsauswahlen für diese Linkverbindung.
...
### -VpnSiteLink
Das Vpn-Websiteverknüpfungsobjekt, mit dem eine Verbindung hergestellt werden soll.
