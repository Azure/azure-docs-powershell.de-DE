...
## BESCHREIBUNG
Das **Update-AzVirtualRouterPeer-Cmdlet** aktualisiert einen VirtualRouter-Peer auf einen Azure VirtualRouter
...
### -InputObject
Das Peereingabeobjekt des virtuellen Routers.
...
### -PeerName
Der Name des peer virtuellen Routers.
...
### -ResourceId
Die Peerressourcen-ID des virtuellen Routers.
...
### -VirtualRouterName
Der virtuelle Router, in dem Peer vorhanden ist.
