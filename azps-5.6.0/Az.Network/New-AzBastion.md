...
## SYNOPSIS
Erstellt eine Ressource für ein Bollwerk.
...
## BESCHREIBUNG
Erstellt eine Ressource für ein Bollwerk. Dazu benötigen Sie eine öffentliche IP-Adresse und ein VirtualNetwork. In diesem VirtualNetwork muss ein Subnetz mit dem Namen AzureBastionSubnet vorhanden sein.Die pubic IP-Adresse muss mit Sku Standard erstellt werden.
...
### -Name
Der Name der Ressource für die Bastei.
...
### -PublicIpAddressId
Die öffentliche Ip-Adresse azure resource ID für "bastion".
...
### -PublicIpAddressName
Der Name der öffentlichen Ip-Adresse für die Ressource "Bollwerk".
...
Der Name der öffentlichen Ip-Adresse-Ressourcengruppe für "Bollwerk".
...
### -ResourceGroupName
Der Name der Ressourcengruppe, in dem Sie eine "Bastei" erstellen müssen.
...
### -VirtualNetwork
Das virtuelle Netzwerkobjekt für "Bollwerk".
...
### -VirtualNetworkId
Die Azure-Ressourcen-Id für das virtuelle Netzwerk für "Bollwerk".
...
### -VirtualNetworkName
Der Name der virtuellen Netzwerkressource für "Bollwerk".
...
Der Name der Virtuellen Netzwerkressourcengruppe für "Bollwerk".
