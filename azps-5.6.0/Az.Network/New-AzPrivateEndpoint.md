...
Das **New-AzPrivateEndpoint-Cmdlet** erstellt einen privaten Endpunkt.

## BEISPIELE

### Beispiel 1: Erstellen eines privaten Endpunkts

Im folgenden Beispiel wird ein privater Endpunkt mit einer bestimmten privaten Linkdienst-ID im angegebenen Subnetz in einem virtuellen Netzwerk erstellt.
...
Bitten Sie nicht um Bestätigung zum Überschreiben einer Ressource.
