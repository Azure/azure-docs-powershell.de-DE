...
Eine Back-End-Adresse kann als IP-Adresse, als vollqualifizierter Domänenname (FQDN) oder als IP-Konfigurations-ID angegeben werden.
...
Mit diesem Befehl wird ein Back-End-Adresspool namens Pool01 mithilfe der FQDNs von Back-End-Servern erstellt und in der $Pool gespeichert.
...
Mit diesem Befehl wird ein Back-End-Adresspool namens Pool02 mithilfe der IP-Adressen von Back-End-Servern erstellt und in der $Pool gespeichert.

## PARAMETER

### -Back-EndFqdns
Gibt eine Liste der Back-End-FQDNs an, die dieses Cmdlet dem Back-End-Serverpool zurät.
...
### -BackendIPAddresses
Gibt eine Liste der Back-End-IP-Adressen an, die dieses Cmdlet mit dem Back-End-Serverpool verknüpft.
