...
## SYNOPSIS
Entfernt eine ExpressRoute-Verbindungskonfiguration.
...
## BESCHREIBUNG
Das **Cmdlet Remove-AzExpressRouteCircuitConnectionConfig** entfernt eine ExpressRoute-Verbindungskonfiguration, die einem bestimmten ExpressRoute Circuit zugeordnet ist.
...
### Beispiel 3: Entfernen einer Verbindungskonfiguration aus einem ExpressRoute-Schaltkreis für eine bestimmte Adressfamilie
```
$circuit_init = Get-AzExpressRouteCircuit -Name $initiatingCircuitName -ResourceGroupName $rg
