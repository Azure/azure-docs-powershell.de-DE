...
## SYNOPSIS
Holen Sie sich verfügbare Servicedelegationen in der Region.
...
## BESCHREIBUNG
Mit **dem Get-AzAvailableServiceDelegation-Cmdlet** können Sie alle verfügbaren Dienstdelegationen für ein Subnetz am angegebenen Speicherort abrufen. In diesem Cmdlet wird *nicht* beschrieben, welche Delegation in einem einzelnen Subnetz möglicherweise gemeinsam vorhanden ist.

## BEISPIELE

### 1: Abrufen aller verfügbaren Dienstdelegationen
```powershell
