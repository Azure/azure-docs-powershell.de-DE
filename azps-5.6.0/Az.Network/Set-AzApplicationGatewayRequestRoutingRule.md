...
Der zweite Befehl ändert die Anforderungsroutingregel für das Anwendungsgateway, um die in der Variablen $Setting angegebenen Back-End-HTTP-Einstellungen, einen in der Variablen $Listener angegebenen HTTP-Listener und einen Back-End-Adresspool zu verwenden, der in der $Pool-Variable angegeben ist.

## PARAMETER

### -ApplicationGateway
Gibt das Anwendungsgatewayobjekt an, dem dieses Cmdlet eine Anforderungsroutingregel zurät.
