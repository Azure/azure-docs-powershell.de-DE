...
## SYNOPSIS
Entfernt eine IP-Konfiguration aus einem Anwendungsgateway.
...
## BESCHREIBUNG
Das **Cmdlet Remove-AzApplicationGatewayIPConfiguration** entfernt eine IP-Konfiguration aus einem Azure-Anwendungsgateway.

## BEISPIELE

### Beispiel 1: Entfernen einer IP-Konfiguration aus einem Azure-Anwendungsgateway
```
