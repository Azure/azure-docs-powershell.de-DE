...
Mit dem vorstehenden Beispiel wird eine Ressourcengruppe "testRG" in der Region "West US" und ein virtuelles Azure-WAN in dieser Ressourcengruppe in Azure erstellt. VirtualWan wird mit neuen Eigenschaften aktualisiert.

## PARAMETER

### -AllowBranchToBranchTraffic
Branch to branch traffic for VirtualWan zulassen.
...
Zulassen, dass vnet-Datenverkehr für VirtualWan verwendet wird.
