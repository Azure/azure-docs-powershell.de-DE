...
```
  ...
  In diesem Beispiel wird zuerst eine Ressourcengruppe als Container der zu erstellende Ressourcen erstellt. Anschließend wird eine Subnetzkonfiguration erstellt und zum Erstellen eines virtuellen Netzwerks verwendet. Die Add-AzVirtualNetworkSubnetConfig wird dann verwendet, um der Arbeitsspeicherdarstellung des virtuellen Netzwerks ein Subnetz hinzuzufügen. Der Set-AzVirtualNetwork aktualisiert das vorhandene virtuelle Netzwerk mit dem neuen Subnetz.
...
Dieses Beispiel ruft zuerst ein vorhandenes vnet ab.
...
Dieses Cmdlet fügt dem von diesem Parameter angegebenen Objekt eine Subnetzkonfiguration für virtuelle Netzwerke hinzu.
