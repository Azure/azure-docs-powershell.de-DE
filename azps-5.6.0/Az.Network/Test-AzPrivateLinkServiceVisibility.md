...
## SYNOPSIS
Die **Test-AzPrivateLinkServiceVisibility** überprüft, ob ein privater Linkdienst für die aktuelle Verwendung sichtbar ist.
...
### Beispiel 1: Überprüfen Sie, ob contoso.cloudapp.azure.com für die Verwendung verfügbar ist.
```
