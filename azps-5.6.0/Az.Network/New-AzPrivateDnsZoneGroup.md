...
Nachdem der private `test-pr-endpoint` Endpunkt erstellt wurde, erstellt das obige Beispiel eine DNS-Zonengruppe unter diesem privaten Endpunkt.
...
Eine Sammlung privater DNS-Zonenkonfigurationen der Gruppe "Private DNS-Zone".
