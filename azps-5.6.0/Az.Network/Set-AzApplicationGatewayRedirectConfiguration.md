...
## BESCHREIBUNG
**Das Cmdlet Set-AzApplicationGatewayRequestRoutingRule** ändert eine Umleitungskonfiguration.
...
Der zweite Befehl ändert die Umleitungskonfiguration für das Anwendungsgateway, um den Typ Permanent umzuleiten und eine Ziel-URL zu verwenden.

### Beispiel 2

Legt die Umleitungskonfiguration für ein vorhandenes Anwendungsgateway fest. (automatisch generiert)
...
### -TargetListenerID
ID des HTTP-Listeners zum Umleiten der Anforderung an
