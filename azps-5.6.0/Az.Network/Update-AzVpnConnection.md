...
Die VPN-Verbindung erstellt eine IPsec-Verbindung, die ein VPN-Gateway mit einem Remotekundenzweig verbindet, der in Azure als VPN-Website dargestellt wird.
...
Die Verbindung wird dann mithilfe des Befehls Set-AzVpnConnection aktualisiert, um eine neue IpSecPolicy zu verwenden.
...
Die Verbindung wird dann aktualisiert, um einen neuen freigegebenen Schlüssel mit dem sicheren Zeichenfolgenkonstrukt zu verwenden.
...
Verwenden Sie beim Initiieren der Verbindung die lokale Azure-IP-Adresse als Quelladresse.
