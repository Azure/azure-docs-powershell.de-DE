...
## SYNOPSIS
Erstellt eine eingehende NAT-Regelkonfiguration für einen Load Balancer.
...
## BESCHREIBUNG
Das **Cmdlet New-AzLoadBalancerInboundNatRuleConfig** erstellt eine Nat-Regelkonfiguration (Inbound Network Address Translation) für einen Azure Load Balancer.

## BEISPIELE

### Beispiel 1: Erstellen einer eingehenden NAT-Regelkonfiguration für einen Load Balancer
```
...
Mit dem dritten Befehl wird eine eingehende NAT-Regelkonfiguration mit dem Namen MyInboundNatRule mithilfe des Front-End-Objekts in $frontend.
Das TCP-Protokoll wird angegeben, und der Front-End-Port ist 3389, in diesem Fall identisch mit dem Back-End-Port.
...
Gibt die Dauer in Minuten an, für die der Zustand der Unterhaltungen in einem Lastenausgleich beibehalten wird.
