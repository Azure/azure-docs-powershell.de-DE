...
## SYNOPSIS
Fügt einer ExpressRoute-Querverbindung eine Peeringkonfiguration hinzu.
...
## BESCHREIBUNG
Das **Add-AzExpressRouteCrossConnectionPeering-Cmdlet** fügt einer ExpressRoute-Querverbindung eine Peeringkonfiguration hinzu. Beachten Sie, dass Sie nach dem Ausführen von **Add-AzExpressRouteCrossConnectionPeering** das cmdlet Set-AzExpressRouteCrossConnection aufrufen müssen, um die Konfiguration zu aktivieren.

## BEISPIELE

### Beispiel 1: Hinzufügen eines Peers zu einer vorhandenen ExpressRoute-Querverbindung
```
...
Die ExpressRoute-Querverbindung, die geändert wird. Dies ist ein Vom **Get-AzExpressRouteCrossConnection-Cmdlet** zurückgegebenes Azure-Objekt.
...
### -PeerASN
Die AS-Nummer Ihrer ExpressRoute-Querverbindung. Dies muss ein öffentlicher ASN sein, wenn der PeeringType AzurePublicPeering ist.
