...
## BESCHREIBUNG
Das New-AzDdosProtectionPlan-Cmdlet erstellt einen DDoS-Schutzplan.
...
Zuerst erstellen wir einen neuen DDoS Protection-Plan mit dem **Befehl New-AzDdosProtectionPlan.**
Anschließend erstellen wir ein neues virtuelles Netzwerk mit **New-AzVirtualNetwork** und geben die ID des neu erstellten Plans im Parameter **DdosProtectionPlanId an.** In diesem Fall können wir, da wir das virtuelle Netzwerk einem Plan zuordnen, auch den Parameter **EnableDdoSProtection angeben.**
...
Zuerst erstellen wir einen neuen DDoS Protection-Plan mit dem **Befehl New-AzDdosProtectionPlan.**
Zweitens erhalten wir die neueste Version des virtuellen Netzwerks, das wir dem Plan zuordnen möchten. Wir aktualisieren die -Eigenschaft **DdosProtectionPlan** mit einem **PSResourceId-Objekt,** das einen Verweis auf die ID des neu erstellten Plans enthält. Wenn wir in diesem Fall das virtuelle Netzwerk einem DDoS-Schutzplan zuordnen, können wir auch das Kennzeichen **EnableDdosProtection** auf true festlegen.
Schließlich wird der neue Zustand beibehalten, indem die lokale Variable in **Set-AzVirtualNetwork gesetzt wird.**
...
### -Location
Gibt den Speicherort des zu erstellenden DDoS-Schutzplans an.
...
### -Name
Gibt den Namen des zu erstellenden DDoS-Schutzplans an.
...
### -ResourceGroupName
Gibt die Ressourcengruppe des zu erstellenden DDoS-Schutzplans an.
