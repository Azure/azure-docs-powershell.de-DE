...
## BESCHREIBUNG
Entfernen der Nat Gateway-Ressource
...
### -Erzwingen
Bitten Sie nicht um Bestätigung, wenn Sie die Ressource löschen möchten.
...
### -ResourceId
Ressourcen-ID, die dem Nat-Gateway zugeordnet ist.
