...
## BESCHREIBUNG
Das **Get-AzStreamAnalyticsTransformation-Cmdlet** ruft Informationen zu einer Transformation ab, die in einem Stream Analytics-Auftrag definiert ist.

## BEISPIELE

### BEISPIEL 1: Informationen zu einer Datenstromanalysetransformation
```
PS C:\>Get-AzStreamAnalyticsTransformation -ResourceGroupName "StreamAnalytics-Default-West-US" -JobName "StreamingJob" -Name "StreamingJob"
```

Dieser Befehl gibt Informationen zur Transformation mit dem Namen StreamingJob für den Auftrag mit dem Namen StreamingJob zurück.
...
### -Name
Gibt den Namen der abzurufenden Azure Stream Analytics-Transformation an.
