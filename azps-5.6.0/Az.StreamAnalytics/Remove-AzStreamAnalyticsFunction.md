...
### Beispiel 1: Entfernen einer Stream Analytics-Funktion
```
PS C:\>Remove-AzStreamAnalyticsFunction -ResourceGroupName "StreamAnalytics-Default-West-US" -JobName "StreamJob22" -Name "ScoreTweet"
```

Mit diesem Befehl wird die Funktion "ScoreTweet" aus dem Auftrag mit dem Namen StreamJob22 entfernt.
...
Dieses Cmdlet löscht eine Funktion in der Ressourcengruppe, die von diesem Parameter angegeben wird.
