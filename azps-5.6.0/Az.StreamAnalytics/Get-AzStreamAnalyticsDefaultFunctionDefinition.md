...
## BESCHREIBUNG
Das **Get-AzStreamAnalyticsDefaultFunctionDefinition-Cmdlet** ruft die Standarddefinition einer Funktion in Azure Stream Analytics ab.
Sie können die Standarddefinition und das New-AzStreamAnalyticsFunction-Cmdlet verwenden, um eine Funktion zu erstellen.
...
Dieser Befehl ruft die Standarddefinition der Funktion mit dem Namen ScoreTweet ab, indem die in der Datei RetrieveDefaultDefinitionRequest.jsangegebenen Parameter verwendet werden.
...
### -Datei
Gibt den Pfad einer JSON-Datei an, die die JavaScript-Objekt-Notation (JSON)-Darstellung des Anforderungstexts für die Standardfunktionsdefinitionsanforderung zum Abrufen enthält.
...
Dieses Cmdlet ruft eine Funktionsdefinition für die Gruppe ab, die von diesem Parameter angegeben wird.
