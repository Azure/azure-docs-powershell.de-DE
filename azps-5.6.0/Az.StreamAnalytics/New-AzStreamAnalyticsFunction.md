...
Definieren Sie die -Funktion in einer JavaScript-Objekt-Notation (JSON-Datei).
Sie können den Namen der Funktion mithilfe des Parameters *Name* oder in der JSON-Datei angeben.
...
### Beispiel 1: Erstellen einer Stream Analytics-Funktion
```
PS C:\>New-AzStreamAnalyticsFunction -ResourceGroupName "StreamAnalytics-Default-West-US" -JobName "StreamJob07" -File "C:\Function07.json"
```

Mit diesem Befehl wird eine Funktion aus der Datei Function07.jserstellt.
Der Name der Funktion wird in der JSON-Datei gespeichert.

### Beispiel 2: Erstellen einer Stream Analytics-Funktion mit dem Namen ScoreTweet
```
...
### Beispiel 3: Ersetzen einer Stream analytics-Funktion
```
