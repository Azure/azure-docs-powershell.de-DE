...
Der erste Befehl verwendet das Get-AzStorageAccount-Cmdlet, um das Speicherkonto mit dem Namen Storage135 zu erhalten, das zu ResourceGroup001 gehört, und speichert das Ergebnis in der Variablen $StorageAccount.
Der zweite Befehl synchronisiert die Speicherkontoschlüssel für den Mediendienst  mit dem Namen MediaService001 mithilfe der Id-Eigenschaft, die in der $StorageAccount ist.

## PARAMETER

### -AccountName
Gibt den Namen des Mediendiensts an, den dieses Cmdlet synchronisiert.
