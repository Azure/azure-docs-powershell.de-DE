...
### Beispiel 1: Eingeben einer angegebenen PostgreSql-Konfiguration nach Name
```powershell
...
Dieses Cmdlet erhält die angegebene PostgreSql-Konfiguration nach Name.
...
In diesem Cmdlet werden alle Konfigurationen auf dem angegebenen PostgreSql-Server aufgeführt.
