...
Verwenden Update-AzPostSqlFlexibleServerConfiguration sie stattdessen, wenn Sie Serverparameter aktualisieren möchten, z. B. wait_timeout oder net_retry_count.
...
### Beispiel 1: Aktualisieren des PostgreSql-Servers nach Ressourcengruppe und Servername
```powershell
...
Dieses Cmdlet aktualisiert den PostgreSql-Server nach Ressourcengruppe und Servername.
...
### -Sku
Der Name der Sku, z. B. Burstable_B1ms, Standard_D2ds_v4
