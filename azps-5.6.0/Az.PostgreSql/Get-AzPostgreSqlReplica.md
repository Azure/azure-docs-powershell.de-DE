...
### Beispiel 1: Erhalten des PostgreSql-Serverreplikates nach Ressourcengruppe und Servername
```powershell
...
Dieses Cmdlet ruft das PostgreSql-Serverreplikate nach Ressourcengruppe und Servername ab.
