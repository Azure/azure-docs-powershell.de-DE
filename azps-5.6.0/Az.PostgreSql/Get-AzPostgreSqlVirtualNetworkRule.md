...
### Beispiel 1: Listet alle Regeln für virtuelles Netzwerk auf dem angegebenen PostgreSql-Server auf.
```powershell
...
In diesem Cmdlet werden alle Regeln für virtuelle Netzwerke im angegebenen PostgreSql-Server aufgeführt.

### Beispiel 2: Virtuelle Netzwerkregel nach Name erhalten
```powershell
...
Dieses Cmdlet ruft virtuelle Netzwerkregel nach Name ab.

### Beispiel 3: Virtuelle Netzwerkregel nach Identität erhalten
```powershell
...
Dieses Cmdlet ruft virtuelle Netzwerkregel nach Identität ab.
