...
### Beispiel 1: Entfernen des PostgreSql-Servers nach Ressourcengruppe und Servername
```powershell
PS C:\> Remove-AzPostgreSqlServer -ResourceGroupName PostgreSqlTestRG -Name PostgreSqlTestServer

```

Dieses Cmdlet entfernt den PostgreSql-Server nach resourceGroup- und Servername.

### Beispiel 2: Entfernen des PostgreSql-Servers nach Identität
```powershell
...
Diese Cmdlets entfernen den PostgreSql-Server nach Identität.
