...
### Beispiel 1: Entfernen der virtuellen Netzwerkregel des PostgreSql-Servers nach Name
```powershell
...
Diese Cmdlets entfernen die virtuelle Netzwerkregel des PostgreSql-Servers nach Identität.
