...
### Beispiel 1: Erstellen einer neuen virtuellen Netzwerkregel für postgreSql-Server
```powershell
...
Diese Cmdlets erstellen eine virtuelle Netzwerkregel für postgreSql-Server.
