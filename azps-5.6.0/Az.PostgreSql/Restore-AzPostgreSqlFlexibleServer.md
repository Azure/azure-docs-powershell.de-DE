...
### Beispiel 1: Wiederherstellen des PostgreSql-Servers mithilfe von PointInTime Restore
```powershell
...
### -RestorePointInTime
Der Zeitpunkt der Wiederherstellung aus (ISO8601-Format), z. B. 2017-04-26T02:10:00+08:00.
