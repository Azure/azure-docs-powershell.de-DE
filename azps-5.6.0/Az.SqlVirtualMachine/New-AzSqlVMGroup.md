...
## BESCHREIBUNG
Das New-AzSqlVMGroup-Cmdlet erstellt eine Azure SQL Gruppe virtueller Computer.
...
Erstellt eine neue Azure SQL Gruppe virtueller Computer mit der Testgruppe vm in der Ressourcengruppe ResourceGroup01.
...
Name, der zum Erstellen von Clustern verwendet wird
...
Name, der für den Betrieb von Clustern verwendet wird
...
Optionaler Pfad für fileshare witness
...
### -Angebot
SQL virtuellen Computergruppenangebot.
...
### -OuPath
Pfad der Organisationseinheit, in dem die Knoten und der Cluster vorhanden sind
...
### -SqlServiceAccount
Name, unter dem SQL dienst auf allen teilnehmenden SQL virtuellen Computern im Cluster ausgeführt wird
...
Primärschlüssel des Speicherkontos für Zeuge
