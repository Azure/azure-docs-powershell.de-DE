...
## SYNOPSIS
Erhalten Sie ein Angebot für die Reservierung. Dies wird an `New-AzReservation` den Kauf übergeben.
...
## BESCHREIBUNG
Berechnen sie den Preis für die Bestellung einer Reservierung.
...
Nach dem Herunterladen des Katalogs kann der Kunde das unterschiedliche Produkt je nach Standort erhalten. Überprüfen Sie anhand dieser Informationen den Preis ordnungsgemäß.
...
### -AppliedScopeType
Typ des angewendeten Bereichs zum Aktualisieren der Reservierung mit "Single" oder "Shared"
...
### -BillingPlan
Die für diese SKU verfügbaren Abrechnungsplanoptionen. "Monatlich" oder "Vorab"
...
### -DisplayName
Anzeigename für den Benutzer, um die Reservierung ganz einfach zu identifizieren.
...
### -InstanzFlexibilität
Typ der Instanzflexibilität zum Aktualisieren der Reservierung mit.
...
### -Quantity
Menge des Produkts zur Berechnung von Preis oder Einkauf.
...
### -Verlängern
Wenn Sie diesen Wert auf "true" festlegen, wird automatisch eine neue Reservierung zum Ablaufdatum kauft.
...
Typ der Ressource, für die der Skus bereitgestellt werden soll.
...
### -Sku
Sku-Name, Sku-Liste mithilfe des Befehls az reservierungskatalog anzeigen
