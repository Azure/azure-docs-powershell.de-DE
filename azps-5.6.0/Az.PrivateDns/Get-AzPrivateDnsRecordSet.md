...
Dieser Befehl ruft den Datensatzsatz des Datensatztyps A mit dem Namen www in der angegebenen Ressourcengruppe und privaten Zone ab und speichert ihn dann in der $RecordSet Variablen. Da die Parameter Name und RecordType angegeben werden, wird nur ein RecordSet-Objekt zurückgegeben.
...
Dieser Befehl ruft ein Array aller Datensatzsätze des Datensatztyps A in der privaten Zone mit dem Namen myzone.com in der Ressourcengruppe mit dem Namen MyResourceGroup ab und speichert sie dann in der $RecordSets-Variable.
...
### Beispiel 4: Alle Datensatzsätze in einer privaten Zone mithilfe eines PSPrivateDnsZone-Objekts
```powershell
...
Dieses Beispiel entspricht dem obigen Beispiel 3. Dieses Mal wird die private Zone mit einem privaten Zonenobjekt angegeben.
