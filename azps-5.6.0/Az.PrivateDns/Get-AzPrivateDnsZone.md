...
## BESCHREIBUNG
Das **Get-AzPrivateDnsZone-Cmdlet** ruft eine Zone (Private Domain Name System, DNS) aus der angegebenen Ressourcengruppe ab.
...
Sie können das **PrivateDnsZone-Objekt** verwenden, um die Zone zu aktualisieren, beispielsweise können Sie **ihr RecordSet-Objekte** hinzufügen.
...
In diesem Beispiel werden alle privaten DNS-Zonen in der angegebenen Ressourcengruppe ab- und dann in der $Zones gespeichert.
...
In diesem Beispiel werden alle privaten DNS-Zonen im aktuellen Azure-Abonnement ab- und dann in der $Zones gespeichert.
...
Wenn Sie auch den *Parameter ResourceGroupName* weglassen, ruft dieses Cmdlet alle privaten DNS-Zonen im aktuellen Azure-Abonnement ab.
