...
## BESCHREIBUNG
Das **Get-AzPrivateDnsVirtualNetworkLink-Cmdlet** ruft virtuelle Netzwerkverbindungen ab, die mit einer bestimmten privaten DNS-Zone verknüpft sind, aus der angegebenen Ressourcengruppe.
...
Sie können das **PSPrivateDnsVirtualNetworkLink-Objekt** verwenden, um den Link zu aktualisieren.

## BEISPIELE

### Beispiel 1: Erstellen eines virtuellen Netzwerklinks
```
...
In diesem Beispiel wird der mylink des virtuellen Netzwerks, der der Privaten DNS-Zone mit dem Namen myzone.com aus der angegebenen Ressourcengruppe zugeordnet ist, und speichert sie dann in der $Link-Variable.

### Beispiel 2: Alle Verknüpfungen, die einer Zone in einer Ressourcengruppe zugeordnet sind, erhalten.
```
...
In diesem Beispiel werden alle virtuellen Netzwerkverbindungen, die der Privaten DNS-Zone "myzone.com" in der angegebenen Ressourcengruppe zugeordnet sind, und dann in der Variablen $Links gespeichert.
...
### -Name
Gibt den Namen der zu erhaltenden virtuellen Netzwerkverknüpfung an.
...
### -ZoneName
Gibt den Namen der privaten DNS-Zone an, mit der die Virtuelle Netzwerkverknüpfung verknüpft ist.
