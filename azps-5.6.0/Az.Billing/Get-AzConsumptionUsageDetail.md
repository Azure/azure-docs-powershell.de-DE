...
## BESCHREIBUNG
Das **Get-AzConsumptionUsageDetail-Cmdlet** ruft Nutzungsdetails des Abonnements ab. 

## BEISPIELE

### Beispiel 1: Anzeigen von Nutzungsdetails mit erweitern von MeterDetails
```powershell
...
### Beispiel 3: Anzeigen von Nutzungsdetails von BillingPeriodName mit InstanceName-Filter
```powershell
...
### -BillingPeriodName
Name eines bestimmten Abrechnungszeitraums, um die Nutzungsdetails zu erhalten, die zugeordnet sind.
...
### -EndDate
Das Enddatum (in UTC) der zu filternden Verwendungen.
...
### -IncludeMeterDetails
Fügen Sie Zählerdetails in die Verwendungen ein.
