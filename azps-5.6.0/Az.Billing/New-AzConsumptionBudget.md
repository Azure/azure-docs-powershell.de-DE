...
## BESCHREIBUNG
Das New-AzConsumptionBudget-Cmdlet erstellt ein Budget in einem Abonnement oder einer Ressourcengruppe.
...
### -ContactRole
Kontaktrollen, an die die Budgetbenachrichtigung gesendet wird, wenn der Schwellenwert überschritten wird.
...
### -MeterFilter
Durch Kommas getrennte Liste der Meter, nach der gefiltert werden soll.
Erforderlich, wenn Kategorie verwendet wird.
...
### -NotificationKey
Schlüssel einer Benachrichtigung, die einem Budget zugeordnet ist und zum Erstellen einer Benachrichtigung mit aktivierter Benachrichtigung, Benachrichtigungsschwellenwert, Kontakt-E-Mails, Kontaktgruppen oder Kontaktrollen erforderlich ist.
...
Benachrichtigungen werden gesendet, wenn die Kosten oder die Nutzung den Schwellenwert überschritten haben.
...
Nicht vor drei Monaten für vierteljährliche Zeitkörner.
Nicht vor zwölf Monaten für Jahreszeitkörner.
Zukünftiges Startdatum nicht mehr als drei Monate.
