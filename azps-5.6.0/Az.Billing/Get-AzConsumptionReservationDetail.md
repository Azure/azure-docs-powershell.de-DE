...
## BESCHREIBUNG
Das **Get-AzConsumptionReservationDetail-Cmdlet** ruft Reservierungsdetails für den angegebenen Datumsbereich ab.

## BEISPIELE

### Beispiel 1: Erhalten von Reservierungsdetails mit Reservierungsauftrags-ID für angegebenen Datumsbereich
```powershell
...
### Beispiel 2: Erhalten von Reservierungsdetails mit Reservierungsauftrags-ID und Reservierungs-ID für angegebenen Datumsbereich
```powershell
...
### -EndDate
Die Enddaten (JJJJ-MM-DD in UTC) des Reservierungsdetails.
...
### -StartDate
Die Startdaten (JJJJ-MM-DD in UTC) des Reservierungsdetails.
