...
## BESCHREIBUNG
Das **Get-AzConsumptionMarketplace-Cmdlet** ruft Marketplaces des Abonnements ab.

## BEISPIELE

### Beispiel 1: Nutzung von Marktplätzen
```powershell
...
### Beispiel 2: Get marketplace usage with date range
```powershell
...
### Beispiel 3: Get marketplace usage of BillingPeriodName
```powershell
