...
## BESCHREIBUNG
Das **Get-AzConsumptionPriceSheet-Cmdlet** ruft Preisblätter des Abonnements ab.

## BEISPIELE

### Beispiel 1: Preisblätter erhalten
```powershell
...
### Beispiel 2: Erhalten von Preisblättern mit erweiterung von MeterDetails
```powershell
...
### Beispiel 3: Erhalten von Preisblättern von BillingPeriodName
```powershell
...
### Beispiel 4: Erhalten der fünf besten Datensätze von Preisblättern
```powershell
...
### -BillingPeriodName
Name eines bestimmten Abrechnungszeitraums, um die Preisblätter zu erhalten, die zugeordnet sind.
...
### -ExpandMeterDetail
Erweitern Sie die Preisblätter basierend auf MeterDetails.
