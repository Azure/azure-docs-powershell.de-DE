...
### Beispiel 1: Alle Instanzen unter einem SAP-Monitor erhalten
```powershell
...
### Beispiel 2: Erhalten einer Instanz des SAP-Monitors nach Name
```powershell
...
Dieser Befehl ruft eine Instanz des SAP-Monitors nach Namen ab.

### Beispiel 3: Erhalten einer Instanz des SAP-Monitors nach Objekt
```powershell
...
Dieser Befehl ruft eine Instanz des SAP-Monitors per Pipeline ab.
