...
## BESCHREIBUNG
Das **Get-AzIntegrationAccountAssembly-Cmdlet** erstellt eine neue Assembly in einem Integrationskonto.

## BEISPIELE

### Beispiel 1: Erstellen einer neuen Assembly mit einer lokalen Datei
```powershell
...
Erstellt eine neue Assembly mit der lokalen Datei, die sich im Dateipfad befindet, der in "$localAssemblyFilePath" enthalten ist.
...
### -AssemblyData
Die Bytedaten der Integrationskonto-Assembly.
