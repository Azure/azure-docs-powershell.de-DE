...
### Beispiel 1: Erstellen einer neuen Batchkonfiguration mit einer lokalen Datei
```powershell
...
Erstellt eine neue Batchkonfiguration mit der lokalen Datei, die sich im Dateipfad befindet, der in "$batchConfigurationFilePath" enthalten ist.

### Beispiel 2: Erstellen einer neuen Batchkonfiguration mit einer JSON-Zeichenfolge
```powershell
