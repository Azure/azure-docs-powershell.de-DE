...
## BESCHREIBUNG
Das **Cmdlet Set-AzIntegrationAccountAssembly** ändert eine Integrationskontoassemblet.

## BEISPIELE

### Beispiel 1: Ändern einer Assembly mithilfe der lokalen Datei
```powershell
...
Ändert die Assembly mit dem Namen "sampleAssembly" mithilfe des in "$assemblyContent" enthaltenen Bytearrays.
