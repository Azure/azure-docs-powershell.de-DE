...
## BESCHREIBUNG
Das **Cmdlet Set-AzIntegrationAccountAgreement** ändert einen Integrationskontovertrag.
Dieses Cmdlet gibt ein -Objekt zurück, das den Integrationskontovertrag darstellt.
Geben Sie den Namen des Integrationskontos, den Ressourcengruppennamen und den Vertragsnamen an.
...
### Beispiel 1: Aktualisieren eines Integrationskontovertrags
```powershell
...
Mit diesem Befehl wird ein Integrationskontovertrag in der angegebenen Azure-Ressourcengruppe aktualisiert.

### Beispiel 2

Ändert einen Integrationskontovertrag. (automatisch generiert)
...
### -AgreementContent
Gibt den Vertragsinhalt im JavaScript-Objekt-Notation(JSON)-Format für den Vertrag an.
...
### -AgreementName
Gibt den Namen des Integrationskontovertrags an.
...
### -AgreementType
Gibt den Typ des Integrationskontovertrags an.
...
Gibt einen Namens-Geschäftsidentitätsqualifizierer für den Gastpartner an.
...
Der Wert für den Gastidentitätsqualifizierer für das Integrationskonto.
...
Gibt einen Namens-Geschäftsidentitätsqualifizierer für den Hostpartner an.
...
Der Hostidentitätsqualifiziererwert für integrationskontovereinbarung.
