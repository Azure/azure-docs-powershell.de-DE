...
### Beispiel 1: Ändern eines Integrationskontoschemas
```
...
Mit diesem Befehl wird das Integrationskontoschema namens IntegrationAccountSchema43 geändert.
...
### -SchemaName
Gibt den Namen des Integrationskontoschemas an.
