...
## BESCHREIBUNG
Das **Get-AzIntegrationAccountAgreement-Cmdlet** erhält einen Integrationskontovertrag von einer Azure-Ressourcengruppe.
...
### Beispiel 1: Erhalten eines Integrationskontovertrags
```
...
Dieser Befehl ruft einen Integrationskontovertrag mit dem Namen IntegrationAccountAgreement06 ab.

### Beispiel 2: Erhalten von Integrationskontovereinbarungen nach Ressourcengruppenname
```
...
Dieser Befehl ruft die Integrationskontovereinbarungen nach Ressourcengruppennamen ab.

## PARAMETER

### -AgreementName
Gibt den Namen eines Integrationskontovertrags an.
