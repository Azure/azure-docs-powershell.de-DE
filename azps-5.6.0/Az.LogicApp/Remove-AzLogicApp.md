...
Der Befehl enthält den *Parameter Erzwingen,* der verhindert, dass der Befehl Sie zur Bestätigung einfordert.
...
### -ResourceGroupName
Gibt den Namen der Ressourcengruppe an, die die Logik-App enthält, die von diesem Cmdlet entfernt wird.
