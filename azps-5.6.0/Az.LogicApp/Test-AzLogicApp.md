...
## BESCHREIBUNG
Das **Test-AzLogicApp-Cmdlet** überprüft eine Logik-App-Definition in einer Ressourcengruppe.
Geben Sie den Namen der Logik-App, den Ressourcengruppennamen, den Standort, den Zustand, die Integrationskonto-ID oder parameter an.
...
Der Befehl gibt Definitions- und Parameterdateipfade an.
