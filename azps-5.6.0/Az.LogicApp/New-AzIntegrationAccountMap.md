...
Geben Sie den Namen des Integrationskontos, den Ressourcengruppennamen, den Kartennamen und die Kartendefinition an.
...
Mit diesem Befehl wird die Integrationskontozuordnung in der angegebenen Ressourcengruppe erstellt.
...
### -MapFilePath
Gibt den Dateipfad einer Definition für die Integrationskontozuordnung an. Geben Sie entweder diesen Parameter oder den *Parameter MapDefinition* an.
