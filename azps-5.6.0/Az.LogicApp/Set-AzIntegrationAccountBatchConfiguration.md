...
## BESCHREIBUNG
Das **Cmdlet Set-AzIntegrationAccountBatchConfiguration** ändert eine Batchkonfiguration eines Integrationskontos.

## BEISPIELE

### Beispiel 1: Ändern einer Batchkonfiguration mithilfe der lokalen Datei
```powershell
...
Ändern Sie eine Batchkonfiguration mit dem Namen "sampleBatchConfig" mithilfe der lokalen Datei, die sich im Dateipfad befindet, der in "$batchConfigurationFilePath" enthalten ist.
...
Ändern Sie eine Batchkonfiguration mit dem Namen "sampleBatchConfig" mithilfe der in "$batchConfigurationContent" enthaltenen JSON-Zeichenfolge.
...
Die Konfiguration der Batchkonfiguration des Integrationskontos.
...
Der Pfad für die Batchkonfiguration des Integrationskontos.
...
### -BatchGroupName
Name der Gruppengruppe für die Batchkonfiguration des Integrationskontos.
...
### -BatchSize
Batchkonfigurationsbatchgröße des Integrationskontos.
...
### -InputObject
Batchkonfiguration eines Integrationskontos.
...
### -MessageCount
Die Anzahl der Nachrichten für die Batchkonfiguration des Integrationskontos.
...
### -Metadaten
Die Metadaten für die Batchkonfiguration des Integrationskontos.
...
### -Name
Name der Batchkonfiguration des Integrationskontos.
...
### -ResourceId
Die Ressourcen-ID für die Batchkonfiguration des Integrationskontos.
...
### -ScheduleFrequency
Die Häufigkeit der Batchkonfiguration des Integrationskontos.
...
### -ScheduleInterval
Das Zeitintervall für die Batchkonfiguration des Integrationskontos.
...
### -ScheduleStartTime
Der Startzeitplan für die Batchkonfiguration des Integrationskontos.
...
### -ScheduleTimeZone
Zeitzone für die Batchkonfiguration des Integrationskontos.
