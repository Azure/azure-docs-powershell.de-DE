...
## BESCHREIBUNG
Das **Get-AzLogicAppTrigger-Cmdlet** ruft Trigger aus einer Logik-App ab.
...
### Beispiel 1: Herunterladen eines Triggers einer Logik-App
```
...
### Beispiel 2: Alle Trigger einer Logik-App herunterladen
```
