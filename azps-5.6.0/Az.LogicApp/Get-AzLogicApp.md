...
## BESCHREIBUNG
Das **Get-AzLogicApp-Cmdlet** ruft eine Logik-App ab.
...
### Beispiel 1: Herunterladen einer Logik-App aus einer Ressourcengruppe
```
...
Dieser Befehl ruft eine Logik-App aus der Ressourcengruppe "ResourceGroup11" ab.
