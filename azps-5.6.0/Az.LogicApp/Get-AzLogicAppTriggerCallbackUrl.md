...
## BESCHREIBUNG
Das **Get-AzLogicAppTriggerCallbackUrl-Cmdlet** ruft eine Logic App-Trigger-Rückruf-URL aus einer Ressourcengruppe ab.
...
### Beispiel 1: Aufrufen einer Logic App-Trigger-Rückruf-URL
```
...
Dieser Befehl ruft eine Rückruf-URL des Logic App-Triggers ab.
