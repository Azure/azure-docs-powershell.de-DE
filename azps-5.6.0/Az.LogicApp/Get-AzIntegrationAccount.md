...
## BESCHREIBUNG
Das **Get-AzIntegrationAccount-Cmdlet** ruft Integrationskonten aus einer Ressourcengruppe ab. Geben Sie einen Namen für ein Integrationskonto und einen Ressourcengruppennamen an.
...
### Beispiel 1: Erhalten eines Integrationskontos nach Name
```
...
Dieser Befehl ruft ein Integrationskonto namens IntegrationAccount31 aus der angegebenen Ressourcengruppe ab.

### Beispiel 2: Erhalten von Integrationskonten in einer Ressourcengruppe
```
...
Dieser Befehl ruft Integrationskonten aus einer Ressourcengruppe namens ResourceGroup11 ab.

### Beispiel 3: Alle Integrationskonten erhalten
```
...
Dieser Befehl ruft alle Integrationskonten in Ihrem Azure-Abonnement ab.
