...
# Az.LogicApp-Modul
## Beschreibung
In diesem Thema werden Hilfethemen für die Logic Apps-Cmdlets angezeigt.

## Az.LogicApp-Cmdlets
### [Get-AzIntegrationAccount](Get-AzIntegrationAccount.md)
Ruft Integrationskonten ab.
...
Ruft eine Integrationskonto assembly ab.

### [Get-AzIntegrationAccountBatchConfiguration](Get-AzIntegrationAccountBatchConfiguration.md)
Ruft eine Batchkonfiguration eines Integrationskontos ab.
...
Dieses Cmdlet ruft den aktuellen Wert der generierten Austauschsteuerelementnummer pro Vereinbarung ab.
...
Ruft Integrationskontopartner ab.
...
Ruft eine Logic App-Trigger-Rückruf-URL ab.
...
Erstellt eine Integrationskontozuordnung.

### [New-AzIntegrationAccountPartner](New-AzIntegrationAccountPartner.md)
Erstellt einen Integrationskontopartner.
...
Entfernt einen Integrationskontopartner.

### [Remove-AzIntegrationAccountReceivedIcn](Remove-AzIntegrationAccountReceivedIcn.md)
Dieses Cmdlet entfernt eine bestimmte empfangene Austauschkontrollnummer pro Vertrag und Steuerelementnummerwert.
...
Ändert die Batchkonfiguration eines Integrationskontos.

### [Set-AzIntegrationAccountCertificate](Set-AzIntegrationAccountCertificate.md)
Ändert ein Integrationskontozertifikat.

### [Set-AzIntegrationAccountGeneratedIcn](Set-AzIntegrationAccountGeneratedIcn.md)
Aktualisiert das integration account generated interchange control number (ICN) in der Azure-Ressourcengruppe.
...
Ändert einen Integrationskontopartner.

### [Set-AzIntegrationAccountReceivedIcn](Set-AzIntegrationAccountReceivedIcn.md)
Aktualisiert das integration account received interchange control number (ICN) in the Azure resource group.

### [Set-AzIntegrationAccountSchema](Set-AzIntegrationAccountSchema.md)
Ändert ein Integrationskontoschema.
