...
Geben Sie den Namen des Integrationskontos, den Ressourcengruppennamen, den Vertragsnamen, den Typ, den Partnernamen, die Partnerqualifizierer und den Vertragsinhalt an.
...
### Beispiel 1: Erstellen eines Integrationskontovertrags
```powershell
...
Mit diesem Befehl wird eine Integrationskontovereinbarung in der angegebenen Azure-Ressourcengruppe erstellt.
...
### -AgreementName
Gibt einen Namen für den Integrationskontovertrag an.
...
### -AgreementType
Gibt den Typ des Integrationskontovertrags an. Die zulässigen Werte für diesen Parameter sind:
- X12 
- AS2
- Edifact
