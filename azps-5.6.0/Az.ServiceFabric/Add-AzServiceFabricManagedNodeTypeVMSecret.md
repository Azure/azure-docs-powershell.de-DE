...
## BESCHREIBUNG
Fügen Sie dem Knotentyp den Zertifikatsgeheimnis hinzu. Der Geheimschlüssel muss in einem Azure Key Vault gespeichert werden. Weitere Informationen zum Schlüsseltresor finden Sie unter Was ist Azure Key Vault? (https://azure.microsoft.com/en-us/documentation/articles/key-vault-whatis/). Weitere Informationen zu den Cmdlets finden Sie unter Azure Key Vault Cmdlets ( in der Microsoft Developer Network-Bibliothek oder im Set-AzKeyVaultSecret https://msdn.microsoft.com/library/azure/dn868052.aspx) cmdlet.
...
Dieses Komma fügt einen Zertifikatschlüssel aus dem angegebenen Keyvault- und geheimen Bezeichner hinzu.
...
Mit diesem Komma wird ein Zertifikatschlüssel aus dem angegebenen Keyvault und dem geheimen Bezeichner mit Piping ergänzt.
...
Informationen zum Hinzufügen eines Geheimschlüssels zum Schlüsseltresor finden Sie unter Hinzufügen eines Schlüssels oder Eines Geheimschlüssels \[ zum Schlüsseltresor \] ( https://docs.microsoft.com/azure/key-vault/key-vault-get-started/#add) .
In diesem Fall muss Ihr Zertifikat die Base64-Codierung des folgenden #A0 sein, das in UTF-8 codiert ist: \<br\> \<br\> { \<br\> "data":" \<Base64-encoded-certificate\> ", \<br\> "dataType":"pfx", \<br\> "password":" \<pfx-file-password\> " \<br\> }/
...
### -SourceVaultId
Schlüssel-Tresor-Ressourcen-ID, die die Zertifikate enthält.
