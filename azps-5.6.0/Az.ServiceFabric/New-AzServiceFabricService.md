...
## BESCHREIBUNG
Dieses Cmdlet ermöglicht das Erstellen zustandsloser oder zustandsfreier Dienste unter der angegebenen Anwendung. Der Dienst sollte im Anwendungsmanifest beendet werden, und der Typ sollte mit dem im Manifest identisch sein. Der Anwendungsname sollte ein Präfix des Dienstnamens sein.
...
In diesem Beispiel wird ein neuer zustandsloser Dienst "testApp~testService1" mit der Instanzanzahl -1 (auf allen Knoten) erstellt.
...
In diesem Beispiel wird ein neuer Zustandsdienst "testApp~testService2" mit einem Ziel von 5 Knoten erstellt.
...
### -DefaultMoveCost
Geben Sie die Standardkosten für einen Verschieben an.
Höhere Kosten machen es weniger wahrscheinlich, dass der Clusterressourcen-Manager das Replikat verschiebt, wenn versucht wird, den Cluster im Gleichgewicht zu halten.
...
### -MinReplicaSetSize
Angeben der Mindestgröße des Replikatsatzs für den Dienst
...
Dienste, die dieses Modell verwenden, verfügen in der Regel über Daten, die innerhalb eines gebundenen Satzs bucketed werden können.
Einige gängige Beispiele für Datenfelder, die als benannte Partitionsschlüssel verwendet werden, sind Regionen, Postleitzahlen, Kundengruppen oder andere Geschäftsgrenzen.
...
Gibt an, dass der Dienst das Singletonpartitionsschema verwendet.
...
Angeben der Wartezeitdauer für den Wartezeitverlust für den Dienst
...
Angeben der Wartezeit für den Neustart des Replikats für den Dienst
...
Angeben der Dauer des Stand-by-Replikats für den Dienst
