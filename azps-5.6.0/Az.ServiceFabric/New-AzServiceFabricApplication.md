...
## BESCHREIBUNG
Dieses Cmdlet erstellt eine neue Service Fabric-Anwendung unter der angegebenen Ressourcengruppe und dem angegebenen Cluster. Der Parameter -PackageUrl kann zum Erstellen der Typversion verwendet werden. Wenn die Typversion bereits beendet wird, aber im Zustand "Fehlgeschlagen" angezeigt wird, fragt das Cmdlet, ob der Benutzer die Typversion neu erstellen möchte. Wenn der Vorgang im Zustand "Fehlgeschlagen" fortgesetzt wird, beendet der Befehl den Prozess und gibt eine Ausnahme aus.
...
In diesem Beispiel wird die Anwendung "testApp" unter der Ressourcengruppe "testRG" und dem Cluster "testCluster" erstellt. Der Anwendungstyp "TestAppType", Version "v1", sollte bereits im Cluster vorhanden sein, und die Anwendungsparameter sollten im Anwendungsmanifest definiert werden, andernfalls besteht ein Fehler beim Cmdlet.
...
In diesem Beispiel wird der Anwendungstyp "TestAppType"- Version "v1" mit der bereitgestellten Paket-URL erstellt. Danach wird der normale Prozess zum Erstellen der Anwendung fortgesetzt. Wenn die Anwendungstypversion bereits beendet wird und der Bereitstellungszustand in "Fehlgeschlagen" angezeigt wird, werden Sie aufgefordert, zu entscheiden, ob der Benutzer die Typversion neu erstellen möchte.
