...
## BESCHREIBUNG
Dieses Cmdlet erstellt eine verwaltete Clusterressource ohne Knotentypen. Zum Bootstrapen des Clusters Muss ein primärer Knotentyp hinzugefügt werden, verwenden [Sie New-AzServiceFabricManagedNodeType](./New-AzServiceFabricManagedNodeType.md).
...
Mit diesem Befehl wird eine Clusterressource mit standardmäßiger Sku erstellt.
...
Nur in Kombination mit ClientCertCommonName verwenden.
...
### -CodeVersion
Codeversion des Clusterdiensts.
Nur verwenden, wenn der Upgrademodus manuell ist.
...
### -Sku
Die Sku des Clusters, die Optionen sind Einfach: Es enthält mindestens 3 Startknoten und erlaubt nur 1 Knotentyp und Standard: Er enthält mindestens 5 Startknoten und ermöglicht mehrere Knotentypen.
...
### -UpgradeMode
Upgrademodus für Clusterdienst-Fabric-Code.
...
### -UseTestExtension
Wenn Angeben Der Cluster wird mit der Erweiterung "Diensttest vmss" verriert.
