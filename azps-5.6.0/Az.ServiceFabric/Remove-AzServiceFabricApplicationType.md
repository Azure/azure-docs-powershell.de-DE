...
## SYNOPSIS
Entfernen Sie service fabric einen Anwendungstyp aus dem Cluster. Dadurch werden alle Typversionen unter dieser Ressource entfernt. Unterstützt nur ARM bereitgestellten Anwendungstypen.
...
## BESCHREIBUNG
Dieses Cmdlet entfernt einen Anwendungstyp aus dem Cluster und entfernt alle Typversion unter dieser Ressource, aber alle Anwendungen unter dieser Ressource sollten entfernt werden, bevor Sie diesen Befehl ausführen.
...
In diesem Beispiel werden der Anwendungstyp "testAppType" und die ganze Version unter dem Beispiel entfernt. Wenn anwendungen mit diesem Typ erstellt wurden, wird mit dem Befehl eine Ausnahme ausgelöst.
...
### -Erzwingen
Entfernen Sie ohne Eingabeaufforderung.
...
### -InputObject
Die Ressource für den Anwendungstyp.
