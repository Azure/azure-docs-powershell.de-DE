...
## BESCHREIBUNG
Verwenden Sie **remove-AzServiceFabricNodeType,** um alle Knoten aus einem bestimmten Knotentyp und den Knotentyp aus einem Cluster zu entfernen. Dieser Befehl kann nicht zum Löschen des primären Knotentyps verwendet werden.
