...
## SYNOPSIS
Erstellen Sie einen neuen Vertrag für ressourcenspeicherort (in Gateways verwendet).
...
## BESCHREIBUNG
Das **Cmdlet New-AzApiManagementResourceLocationObject** erstellt einen neuen Ressourcenspeicherortvertrag (in Gateways verwendet).
