...
### Beispiel 1: Ändern des Geheimtipps für einen Anbieter
```powershell
...
Mit diesem Befehl wird der Anbieter geändert, der über die ID OICProvider01 verfügt.
Der Befehl gibt einen Geheimtipp für den Anbieter an.
...
### -PassThru
Gibt an, dass dieses Cmdlet den **PsApiManagementOpenIdConnectProvider** zurückgibt, den dieses Cmdlet ändert.
