...
Mit diesem Befehl wird ein API-Versionssatz erstellt, mit dem das Versionsschema und `Query` der Abfrageparameter festgelegt `api-version` werden.

## PARAMETER

### -ApiVersionSetId
Bezeichner für den neuen API-Versionssatz.
...
### -Beschreibung
Beschreibung des Api-Versionssets.
...
### -HeaderName
Der Wert "Header", der die Versionsinformationen enthält.
Wenn Versionsschemaheader ausgewählt ist, muss dieser Wert angegeben werden.
...
Wenn Die Versionsschemaabfrage ausgewählt ist, muss dieser Wert angegeben werden.
