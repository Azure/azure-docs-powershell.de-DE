...
## BESCHREIBUNG
Das **Cmdlet Remove-AzApiManagementSubscription** löscht ein vorhandenes Abonnement.
...
Mit diesem Befehl wird ein vorhandenes Abonnement gelöscht.
...
### -PassThru
Gibt an, dass dieses Cmdlet einen Wert von $True, wenn es erfolgreich ist, oder einen Wert von $false zurückgibt.
...
### -ResourceId
Arm ResourceId des Abonnements. Dieser Parameter ist erforderlich.
