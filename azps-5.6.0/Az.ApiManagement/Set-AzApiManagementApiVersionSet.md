...
Das **Cmdlet Set-AzApiManagementApiVersionSet** ändert einen Azure API Management API-Versionssatz.
...
### -PassThru
Wenn angegeben, wird die Instanz des Typs Microsoft.Azure.Commands.ApiManagement.ServiceManagement.Models.PsApiManagementApiVersionSet, der den geänderten apiVersionSet darstellt, in die Ausgabe geschrieben.
