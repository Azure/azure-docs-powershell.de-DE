...
## BESCHREIBUNG
Das **Cmdlet Update-AzApiManagementApiRelease** ändert eine Azure API Management API Release.

## BEISPIELE

### Beispiel 1: Aktualisiert eine API-Version für eine API-Überarbeitung
```powershell
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Update-AzApiManagementApiRelease -Context $ApiMgmtContext -ApiId "echo-api" -ReleaseId "echo-api-release" -Note "Releasing version 2 of the echo-api to public"
```

Mit diesem Befehl wird die `echo-api-release` API-Version der Api `echo-api` mit einer neuen Notiz aktualisiert.
...
### -PassThru
Wenn angegeben, wird die Instanz des Microsoft.Azure.Commands.ApiManagement.ServiceManagement.Models.PsApiManagementApiRelease-Typs angegeben, der den festgelegten API Release darstellt.
...
### -ReleaseId
Bezeichner für die Api Revision ReleaseId.
Dieser Parameter ist erforderlich.
