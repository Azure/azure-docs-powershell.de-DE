...
## SYNOPSIS
Entfernen einer bestimmten API-Überarbeitung
...
Mit diesem Befehl wird die 2-Überarbeitung der API echo-api aus dem API-Verwaltungsdienst entfernt. (automatisch generiert)
