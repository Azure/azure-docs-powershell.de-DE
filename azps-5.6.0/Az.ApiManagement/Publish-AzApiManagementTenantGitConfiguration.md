...
## SYNOPSIS
Veröffentlicht Änderungen aus einer Git-Verzweigung in die Konfigurationsdatenbank.
...
Alternativ können Sie die Änderungen in einer Git-Verzweigung ohne Veröffentlichung überprüfen.
...
Mit diesem Befehl werden die Änderungen aus der angegebenen Verzweigung in die Konfigurationsdatenbank veröffentlicht.
...
### -Branch
Gibt den Namen der Git-Verzweigung an, aus der dieses Cmdlet die Konfiguration in der Konfigurationsdatenbank bereitgestellt.
...
### -Erzwingen
Gibt an, dass mit diesem Cmdlet Abonnements für Produkte gelöscht werden, die in diesem Update gelöscht wurden.
