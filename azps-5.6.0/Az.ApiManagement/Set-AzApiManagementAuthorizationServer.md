...
## BESCHREIBUNG
Das **Cmdlet Set-AzApiManagementAuthorizationServer** ändert die Azure API Management-Autorisierungsserverdetails.
...
Mit diesem Befehl wird der angegebene API-Verwaltungsautorisierungsserver geändert.
...
### -ClientSecret
Gibt den Geheimtipp der Entwicklerkonsole an, bei der es sich um die Clientanwendung handelt.
...
### -TokenEndpointUrl
Gibt den Tokenendpunkt für Clients an, um Zugriffstoken im Austausch für die Präsentation von Autorisierungszuschüssen oder Aktualisierungstoken abzurufen.
