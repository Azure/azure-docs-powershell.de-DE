...
## BESCHREIBUNG
Das **Get-AzApiManagementApiRevision-Cmdlet** ruft die Details aller Überarbeitungen einer API ab.
...
Dieser Befehl ruft die ganze API-Überarbeitung der angegebenen API für bestimmten ApiManagement-Kontext ab.
