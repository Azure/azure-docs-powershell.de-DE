...
## BESCHREIBUNG
Befehl "Hilfser", um eine Instanz der PsApiManagementRegion zu erstellen.
...
Erstellt einen ApiManagement-Dienst von External VpnType in West US Region, mit einer zusätzlichen Region in Central US.

## PARAMETER

### -Kapazität
Sku-Kapazität des zusätzlichen Azure -API-Verwaltungsdiensts.
