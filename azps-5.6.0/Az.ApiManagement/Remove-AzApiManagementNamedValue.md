...
## SYNOPSIS
Entfernt einen benannten WERT für die API-Verwaltung.
...
## BESCHREIBUNG
Das **Cmdlet Remove-AzApiManagementNamedValue** entfernt ein Azure API Management **Named Value**.
...
Mit diesem Befehl wird der benannte Wert entfernt, der die ID-Eigenschaft11 hat.
