...
Das **Cmdlet Remove-AzAzureRmApiManagementApiRelease** entfernt eine vorhandene API Release.
...
Mit diesem Befehl wird die API-Version mit der angegebenen ApiId und ReleaseId entfernt.
