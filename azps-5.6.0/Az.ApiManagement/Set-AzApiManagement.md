...
Das **Set-AzApiManagement-Cmdlet** aktualisiert einen Azure-API-Verwaltungsdienst.
...
In diesem Beispiel wird eine Api-Verwaltungsinstanz abrufen, sie auf fünf Premiumeinheiten skaliert und dann der Premiumregion weitere drei Einheiten hinzufügt.
...
Mit diesem Befehl wird eine vorhandene API-Verwaltungsbereitstellung aktualisiert und mit einem externen *VpnType verbunden.*

### Beispiel 3: Erstellen und Initialisieren einer Instanz von PsApiManagementCustomHostNameConfiguration mit einem Secret from KeyVault Resource
```powershell
...
### -PassThru
Sendet aktualisiertes PsApiManagement an die Pipeline, wenn der Vorgang erfolgreich ausgeführt wird.
