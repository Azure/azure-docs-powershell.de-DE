...
Das **Cmdlet New-AzApiManagementBackendServiceFabric** erstellt ein -Objekt, das `PsApiManagementServiceFabric` im Cmdlet **New-AzApiManagementBackend** und **Set-AzApiManagementBackend** verwendet werden soll.
...
Clientzertifikat-Fingerabdruck für den Verwaltungsendpunkt.
...
Maximale Anzahl von Wiederholungen beim Auflösen einer Service Fabric-Partition.
