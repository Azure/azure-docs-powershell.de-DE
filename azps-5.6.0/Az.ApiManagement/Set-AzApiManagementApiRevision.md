...
## BESCHREIBUNG
Das **Cmdlet Set-AzApiManagementApiRevision** ändert eine Azure API Management API Revision.
...
Das Cmdlet aktualisiert die `2` Überarbeitung der API mit einer neuen `echo-api` Beschreibung, einem neuen Protokoll und einem neuen Pfad.
...
### -Name
Web-API-Name.
Öffentlicher Name der API, wie sie auf den Entwickler- und Administratorportalen angezeigt wird.
Dieser Parameter ist erforderlich.
