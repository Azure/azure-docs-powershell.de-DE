...
## SYNOPSIS
Ruft das ganze oder bestimmte API-Verwaltungsgateway ab.
...
## BESCHREIBUNG
Das **Get-AzApiManagementGateway-Cmdlet** ruft alle oder bestimmte API-Verwaltungsgateways ab.
...
Wenn angegeben, wird versucht, das Gateway durch den Bezeichner zu finden.
