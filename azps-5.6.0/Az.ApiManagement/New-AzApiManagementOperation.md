...
### -ApiRevision
Bezeichner der API-Überarbeitung. Dieser Parameter ist optional. Wenn nicht angegeben, wird der Vorgang an die aktuell aktive Api-Überarbeitung angefügt.
...
### -Antworten
Gibt ein Array möglicher Antworten auf DEN API-Verwaltungsvorgang an.
...
Wenn Sie diesen Parameter nicht angeben, wird ein Standardwert basierend auf *der UrlTemplate generiert.*
