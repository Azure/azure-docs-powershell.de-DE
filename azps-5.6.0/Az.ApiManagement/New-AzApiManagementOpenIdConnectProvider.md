...
## BESCHREIBUNG
Das **Cmdlet New-AzApiManagementOpenIdConnectProvider** erstellt in Azure API Management einen OpenID Connect-Anbieter.
...
### -ClientSecret
Gibt den Geheimtipp des Clients der Entwicklerkonsole an.
