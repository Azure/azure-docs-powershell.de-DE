...
### Beispiel 1: Entfernen einer vorhandenen Gatewayhostnamenkonfiguration
```powershell
...
Mit diesem Befehl wird eine vorhandene Gatewayhostnamekonfiguration entfernt, und der Benutzer wird nicht zur Bestätigung aufgefordert.
...
Bezeichner der vorhandenen Gatewayhostnamekonfiguration.
Dieser Parameter ist erforderlich.
