...
## BESCHREIBUNG
Das **Cmdlet Set-AzApiManagementLogger** ändert die Einstellungen eines Azure API **Management Loggers.**
...
Mit diesem Befehl wird ein Logger mit der ID Logger123 geändert.

### Beispiel 2

Ändert eine API-Verwaltungsprotokollierung. (automatisch generiert)
...
### -ConnectionString
Gibt eine Azure Event Hubs-Verbindungszeichenfolge an, die Richtlinienrechte für Senden enthält.
...
### -IsBuffered
Gibt an, dass die Datensätze im Logger vor der Veröffentlichung gepuffert werden.
