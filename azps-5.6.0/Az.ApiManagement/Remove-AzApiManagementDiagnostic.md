...
## SYNOPSIS
Entfernen Sie die Diagnoseentität aus dem Bereich "Global" oder "API-Ebene".
...
## BESCHREIBUNG
Das Cmdlet **Remove-AzApiManagementDiagnostic** entfernt die vom globalen Bereich oder einem Bereich `DiagnosticId` angegebene `ApiId` Diagnoseentität.
