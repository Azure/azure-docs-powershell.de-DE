...
## BESCHREIBUNG
Das **Get-AzApiManagementApi-Cmdlet** ruft mindestens eine Azure-API-Verwaltungs-APIs ab.
...
### -ApiId
Gibt die ID der zu erhaltenden API an.
...
### -GatewayId
Wenn angegeben, wird versucht, alle Gateway-APIs zu erhalten.
...
### -Name
Gibt den Namen der zu erhaltenden API an.
...
### -ProductId
Gibt die ID des Produkts an, für das die API bereitgestellt werden soll.
