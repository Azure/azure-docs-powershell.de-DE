...
## BESCHREIBUNG
Das Cmdlet **New-AzApiManagementSamplingSetting** erstellt eine neue Samplingeinstellung für die Diagnose

## BEISPIELE

### Beispiel 1: Erstellen einer einfachen Samplingeinstellung
```powershell
...
Erstellt eine Stichprobeneinstellung vom `Fixed` Typ mit Protokollierung für 100 % der Anforderungen/Antworten
...
### -SamplingPercentage
Rate of Sampling for Fixed Rate Sampling. Dieser Parameter ist optional.
