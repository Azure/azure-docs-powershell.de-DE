...
## BESCHREIBUNG
Das **Get-AzApiManagementApiRelease-Cmdlet** ruft eine oder mehrere Versionen der Azure API-Verwaltungs-API ab.
...
### -ResourceId
Arm Resource Identifier einer Api Release. Wenn angegeben, wird versucht, die API-Version durch den Bezeichner zu finden. Dieser Parameter ist erforderlich.
