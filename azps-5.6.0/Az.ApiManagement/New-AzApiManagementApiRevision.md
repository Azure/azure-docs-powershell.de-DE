...
Das **Cmdlet New-AzApiManagementApiRevision** erstellt eine API-Überarbeitung für eine vorhandene API im Kontext api-Verwaltung.
...
### -ApiRevisionDescription
Api-Überarbeitungsbeschreibung. Dieser Parameter ist optional.
...
### -ServiceUrl
Eine URL des Webdiensts, in der die API im Back-End-Dienst verfügbar wird. Diese URL wird nur von Azure API Management verwendet und nicht öffentlich gemacht. Muss 1 bis 2000 Zeichen lang sein. Dieser Parameter ist erforderlich.
...
### -SourceApiRevision
API-Revisionsbezeichner der Quell-API. Dieser Parameter ist optional.
