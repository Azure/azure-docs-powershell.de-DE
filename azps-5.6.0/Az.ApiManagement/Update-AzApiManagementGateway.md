...
## BESCHREIBUNG
Das **Update-AzApiManagementGateway-Cmdlet** konfiguriert ein API-Verwaltungsgateway.
...
### -PassThru
Wenn angegeben, wird die Instanz des Typs Microsoft.Azure.Commands.ApiManagement.ServiceManagement.Models.PsApiManagementGateway angegeben, der das geänderte Gateway darstellt.
