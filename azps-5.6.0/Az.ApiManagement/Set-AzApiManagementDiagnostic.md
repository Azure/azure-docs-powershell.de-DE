...
## SYNOPSIS
Ändert eine API-Verwaltungsdiagnose im Bereich "Global" oder "Api".
...
Mit diesem Befehl wird der angegebene Prozentsatz der Diagnosestichprobe von 100 % auf 50 % geändert.

### Beispiel 2

Ändert eine API-Verwaltungsdiagnose im Bereich "Global" oder "Api". (automatisch generiert)
...
### -AlwaysLog
Gibt an, welcher Nachrichtentyp nicht angewendet werden soll.
...
### -Back-EndSetting
Diagnoseeinstellung für eingehende/ausgehende Http-Nachrichten im Back-End. Dieser Parameter ist optional.
...
### -LoggerId
Bezeichner des Loggers, an den die Diagnose weitergeschoben werden soll.
Dieser Parameter ist erforderlich.
...
### -PassThru
Wenn angegeben, wird die Instanz des Microsoft.Azure.Commands.ApiManagement.ServiceManagement.Models.PsApiManagementDiagnostic-Typs angegeben, der den Satz Diagnostic darstellt.
...
### -ResourceId
Arm ResourceId der Diagnose- oder Apidiagnose. Dieser Parameter ist erforderlich.
