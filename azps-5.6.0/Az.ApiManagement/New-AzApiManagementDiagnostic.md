...
## SYNOPSIS
Erstellt eine neue Diagnose im Bereich "Global" oder "Api Scope".
...
## BESCHREIBUNG
Das Cmdlet **New-AzApiManagementDiagnostic** erstellt eine Diagnoseentität entweder im globalen Bereich oder im bestimmten Api-Bereich.

## BEISPIELE

### Beispiel 1: Erstellen eines neuen globalen Bereichs Diagnose
```powershell
...
Im obigen Beispiel wird eine Diagnose für die API erstellt, um die Kopfzeile und 100 Byte textkörper für `httpbin` den `azuremonitor` Logger zu protokollieren.
...
Wenn angegeben wird, wird die API-Scope-Richtlinie festgelegt.
