...
## SYNOPSIS
Ruft den Konnektivitätsstatus an die externen Ressourcen ab, von denen der Api-Verwaltungsdienst innerhalb des Clouddiensts abhängig ist. Dadurch werden auch die DNS-Server wie für cloudService sichtbar zurückgegeben.
