...
## BESCHREIBUNG
Das **Get-AzApiManagementApiSchema-Cmdlet** ruft die Details des API-Schemas ab.

## BEISPIELE

### Beispiel 1: Abrufen der Details aller Apischemas einer Api
```powershell
...
Dieser Befehl ruft alle API-Schemas ab, die einer Api für einen bestimmten `swagger-petstore-extensive` ApiManagement-Kontext zugeordnet sind.

### Beispiel 2: Abrufen des bestimmten Schemas, das einer Api zugeordnet ist
```powershell
PS D:\github\azure-powershell> $context = New-AzApiManagementContext -ResourceId /subscriptions/subid/resourceGroups/resourceGroupName/providers/Microsoft.ApiManagement/service/sdktestapim4163
...
Dieser Befehl ruft das API-Schema ab, das einer Api für einen bestimmten `5cc9cf67e6ed3b1154e638bd` `swagger-petstore-extensive` ApiManagement-Kontext zugeordnet ist.
...
### -ResourceId
Arm Resource Identifier eines Api-Schemas. Wenn angegeben, wird versucht, das Apischema durch den Bezeichner zu finden. Dieser Parameter ist erforderlich.
