...
## SYNOPSIS
Hier erhalten Sie die Konfigurationsdetails des Identitätsanbieters.
...
## BESCHREIBUNG
Hier erhalten Sie die Konfigurationsdetails des Identitätsanbieters.
ClientSecret wird nicht in ergebnisdetails einbezogen. Verwenden Sie **Get-AzApiManagementIdentityProviderClientSecret,** um den Geheimtipp des Clients zu erhalten.
...
Alle Identitätsanbieterkonfiguration für den Dienst erhalten.
...
### Beispiel 3: Holen Sie sich den AAD B2C-Typidentitätsanbieter.
```powershell
...
Wenn angegeben, wird versucht, die Konfiguration des Identitätsanbieters durch den Bezeichner zu finden.
