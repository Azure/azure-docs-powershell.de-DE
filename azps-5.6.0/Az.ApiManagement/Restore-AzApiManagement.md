...
## SYNOPSIS
Stellt einen API-Verwaltungsdienst aus dem angegebenen Azure-Speicherblob wieder bereit.
...
Mit diesem Befehl wird ein API-Verwaltungsdienst aus dem Azure-Speicherblob wiederhergestellt.
...
### -SourceBlobName
Gibt den Namen des Azure-Speichersicherungsquellenblobs an.
...
### -SourceContainerName
Gibt den Namen des Azure-Speichersicherungsquellencontainers an.
...
### -StorageContext
Gibt den Speicherverbindungskontext an.
