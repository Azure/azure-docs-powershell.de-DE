...
Mit diesem Befehl werden die Vorgangsdetails für die API-Verwaltung bestimmt.
...
### -ApiRevision
Bezeichner der API-Überarbeitung. Dieser Parameter ist optional. Wenn nicht angegeben, wird der Vorgang in der aktuell aktiven Api-Überarbeitung aktualisiert.
...
### -TemplateParameters
Gibt ein Array oder Parameter an, das im Parameter *UrlTemplate definiert ist.*
Wenn Sie keinen Wert angeben, wird ein Standardwert basierend auf der UrlTemplate generiert.
Verwenden Sie den -Parameter, um weitere Details zu Parametern wie Beschreibung, Typ und anderen möglichen Werten zu erhalten.
