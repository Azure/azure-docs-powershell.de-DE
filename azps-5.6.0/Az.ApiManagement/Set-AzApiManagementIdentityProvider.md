...
Das Cmdlet aktualisiert den Geheim geheimen Client des Facebook-Identitätsanbieters.
...
Dies sind App-ID für Facebook-Anmeldung, Client-ID für Google-Anmeldung, App-ID für Microsoft.
...
So handelt es sich z. B. um "App Secret for Facebook login", "API Key for Google login", "Public Key" für Microsoft.
...
### -SigninTenant
Signin Tenant to override in AAD B2C statt `common` tenant
