...
## SYNOPSIS
Sammeln Sie Protokolle aus einer Application-Insights Anwendung.
...
Mit diesem Befehl wird eine Datenquelle für Anwendungseinblicke einer bestimmten Anwendung in einem bestimmten Protokollanalysearbeitsbereich erstellt. Dies ermöglicht die Sammlung von Protokollen aus einer bestimmten Anwendung in den Arbeitsbereich für die Protokollanalyse.

### Beispiel 2: Arbeitsbereichsobjekt erhalten und Datenquelle für Anwendungseinblicke mit der Anwendungsressourcen-ID erstellen
```
...
Dieser Befehl veranschaulicht das Abrufen eines Log analytics-Arbeitsbereichsobjekts und anschließendes Übergeben der Ausgabe, um eine zugeordnete Datenquelle für Anwendungseinblicke über die Anwendungsressourcen-ID zu erstellen. 
...
### -Arbeitsbereich
Der Arbeitsbereich, der die Datenquelle enthält.
