...
## SYNOPSIS
Sammeln Sie das Azure Activity-Protokoll aus einem bestimmten Abonnement.
...
## BESCHREIBUNG
Die New-AzOperationalInsightsAzureActivityLogDataSource die Log Analytics zum Erfassen des Azure-Aktivitätsprotokolls aus einem bestimmten Abonnement aktivieren.
...
### -BackfillStartTime
Sie können protokolle aus einer Woche zurückfüllen.
