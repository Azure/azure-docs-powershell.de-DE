...
Mit diesem Befehl werden alle virtuellen Netzwerkregel unter einer MariaDB aufgeführt.

### Beispiel 2: Virtuelle Netzwerkregel unter einer MariaDB
```powershell
...
Dieser Befehl ruft virtuelle Netzwerkregel unter einer MariaDB ab.
