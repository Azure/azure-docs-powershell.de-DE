...
Überprüft eine Prüfpunkt-URL.

### [Disable-AzCdnCustomDomain](Disable-AzCdnCustomDomain.md)
Deaktiviert benutzerdefinierte Domäne HTTPS (veraltet).

### [Disable-AzCdnCustomDomainHttps](Disable-AzCdnCustomDomainHttps.md)
Deaktiviert benutzerdefinierte Domäne HTTPS.

### [Enable-AzCdnCustomDomain](Enable-AzCdnCustomDomain.md)
Aktiviert benutzerdefinierte Domäne HTTPS (veraltet).
...
Ruft eine CDN-Ursprungsgruppe ab.
...
Ruft die einmalige Anmelde-URL eines CDN-Profils ab.
...
Erstellt eine Übermittlungsrichtlinie.
...
Erstellt eine Bedingung für die Zustellungsregel.
...
Erstellt eine CDN-Ursprungsgruppe
...
Entfernt eine CDN-Ursprungsgruppe
...
Aktualisiert eine CDN-Ursprungsgruppe
