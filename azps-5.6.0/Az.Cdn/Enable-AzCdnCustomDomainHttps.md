...
## BESCHREIBUNG
Das **Cmdlet Enable-AzCdnCustomDomainHttps** ermöglicht die sichere HTTPS-Übermittlung einer benutzerdefinierten CDN-Domäne.
...
Aktivieren Sie die sichere Übermittlung der benutzerdefinierten Domäne.

## PARAMETER

### -CustomDomainName
Anzeigename der benutzerdefinierten Azure CDN-Domäne.
...
### -ResourceId
ResourceId der benutzerdefinierten Domäne
