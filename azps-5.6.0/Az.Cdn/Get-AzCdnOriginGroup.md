...
## BESCHREIBUNG
Das Get-AzCdnOriginGroup-Cmdlet ruft eine CDN-Ursprungsgruppe ab.
...
Mit diesem Befehl wird die Ursprungsgruppe innerhalb des angegebenen Endpunkts empfangen.
...
### -ResourceId
Ressourcen-ID für die Ursprungsgruppe
