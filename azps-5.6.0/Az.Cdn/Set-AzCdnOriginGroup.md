...
## SYNOPSIS
Aktualisiert die CDN-Ursprungsgruppe
...
## BESCHREIBUNG
Set-AzCdnOriginGroup wird die angegebene Ursprungsgruppe innerhalb des angegebenen Endpunkts aktualisiert. 
...
```
Dieses Cmdlet aktualisiert die Eigenschaft ProbeIntervalInSeconds in der Ursprungsgruppe. 
