...
## BESCHREIBUNG
Die New-AzCdnOriginGroup erstellt eine neue Ursprungsgruppe innerhalb des angegebenen Endpunkts. Wenn dies die erste Ursprungsgruppe für Endpunkt ist, muss auch die DefaultOriginGroup-Eigenschaft festgelegt werden.
...
```
Dieses Cmdlet erstellt eine neue Ursprungsgruppe innerhalb des angegebenen Endpunkts. Dabei werden die angegebenen Ursprungs-IDn als Herkunftssatz verwendet.

## PARAMETER

### -CdnOriginGroup
Das CDN-Ursprungsgruppenobjekt.
...
### -OriginGroupName
Azure CDN-Ursprungsgruppenname.
...
### -OriginId
Azure CDN-Ursprungsgruppen-IDs.
...
### -ProbePath
Der Pfad relativ zum Ursprung, der verwendet wird, um den Zustand des Ursprungs zu bestimmen.
...
### -ProbeProtocol
Protokoll, das für die Integritätsprobe verwendet werden soll.
