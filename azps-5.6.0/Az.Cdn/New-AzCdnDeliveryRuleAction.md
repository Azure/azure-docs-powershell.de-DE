...
### -Aktion
Aktion, die Sie ausführen müssen.
...
### -CacheBehavior
Zwischenspeicherverhalten für die Aktion
...
Zulässiges Format ist \[ d. \] hh:mm:ss
...
? und & werden automatisch hinzugefügt, sodass sie nicht enthalten sind.
...
### -Ziel
Definieren Sie die relative URL, zu der die oben genannten Anforderungen umgeschrieben werden sollen.
...
### -HeaderActionType
Ändern des Anforderungskopfs oder der Antwortkopfzeile
...
### -HeaderName
Name der zu ändernde Kopfzeile.
...
### -PreservePath
Ob der nicht übereinstimmende Pfad beibehalten werden soll.
...
### -QueryParameter
Abfrageparameter, die ein- oder ausgeschlossen werden (durch Kommas getrennt).
