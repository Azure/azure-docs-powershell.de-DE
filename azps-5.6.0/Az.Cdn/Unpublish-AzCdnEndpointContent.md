...
### -CdnEndpoint
Gibt den Endpunkt an, den dieses Cmdlet bereinigen soll.
...
### -EndpointName
Gibt den Namen des Endpunkts an, den dieses Cmdlet bereinigen soll.
...
### -PurgeContent
Gibt ein Array relativer Pfade für den Inhalt auf dem Ursprungsserver an, den dieses Cmdlet bereinigen soll.
