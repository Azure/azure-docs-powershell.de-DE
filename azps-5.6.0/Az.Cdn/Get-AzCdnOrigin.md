...
## BESCHREIBUNG
Das **Get-AzCdnOrigin-Cmdlet** ruft einen Azure Content Delivery Network (CDN)-Ursprungsserver und seine Konfigurationsdaten ab.
...
### -CdnEndpoint
Gibt das CDN-Endpunktobjekt an, zu dem der Ursprung gehört.
