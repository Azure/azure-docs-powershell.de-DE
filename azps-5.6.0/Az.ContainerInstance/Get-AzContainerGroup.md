...
## BESCHREIBUNG
Das **Get-AzContainerGroup-Cmdlet** ruft eine angegebene Containergruppe oder alle Containergruppen in einer Ressourcengruppe oder im Abonnement ab.

## BEISPIELE

### Beispiel 1: Ruft eine angegebene Containergruppe ab.
```
...
Der Befehl ruft die angegebene Containergruppe ab.

### Beispiel 2: Ruft Containergruppen in einer Ressourcengruppe ab
```
...
Der Befehl ruft die Containergruppen in der Ressourcengruppe `demo` ab.

### Beispiel 3: Ruft Containergruppen im aktuellen Abonnement ab
```
...
Der Befehl ruft die Containergruppen im aktuellen Abonnement ab.

### Beispiel 4: Ruft Containergruppen mithilfe der Ressourcen-ID ab.
```
...
Der Befehl ruft die Containergruppe mit der Ressourcen-ID ab.
