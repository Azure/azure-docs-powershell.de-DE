...
## BESCHREIBUNG
Das **Cmdlet Get-AzPolicyRemediation** ruft alle Richtlinienbehebungen in einem Bereich oder einer bestimmten Behebung ab.

## BEISPIELE

### Beispiel 1: Alle Richtliniensanierungen im aktuellen Abonnement erhalten
```
...
### Beispiel 2: Erhalten einer bestimmten Richtliniensanierung und der Bereitstellungsdetails
```
PS C:\> Get-AzPolicyRemediation -ResourceGroupName "myResourceGroup" -Name "remediation1" -IncludeDetail
```

Dieser Befehl ruft die Behebung mit dem Namen "remediation1" aus der Ressourcengruppe "myResourceGroup" ab. Die Details der ressourcen, die behoben werden sollen, werden einbezogen.
...
Dieser Befehl ruft maximal 10 Richtlinienbehebungen von einer Verwaltungsgruppe namens "mg1" ab. Es werden nur Richtlinienbehebungen für die angegebene Richtlinienzuordnung abgerufen.
...
### -IncludeDetail
Fügen Sie Details zu den Bereitstellungen ein, die durch die Behebung erstellt wurden.
