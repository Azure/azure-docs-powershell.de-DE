...
## SYNOPSIS
Aktualisiert eine Azure NetApp Files (ANF)-Momentaufnahmerichtlinie auf die optionalen bereitgestellten Modifizierer.
...
## BESCHREIBUNG
Das **Cmdlet Update-AzNetAppFilesSnapshotPolicy** ändert eine ANF-Snapshotrichtlinie.
...
Mit diesem Befehl wird die ANF-Sicherungsrichtlinie "MySnapshotPolicy" geändert, um die hourlySchedule zu erhalten.
