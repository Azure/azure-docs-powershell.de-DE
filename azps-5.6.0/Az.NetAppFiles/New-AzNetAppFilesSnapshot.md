...
## SYNOPSIS
Erstellt eine neue Momentaufnahme von Azure NetApp-Dateien (ANF).
...
## BESCHREIBUNG
Das **Cmdlet New-AzNetAppFilesSnapshot erstellt** eine ANF-Momentaufnahme.
...
Mit diesem Befehl wird die neue ANF-Momentaufnahme "MyAnfSnapshot" im Volume "MyAnfVolume" erstellt.
...
### -VolumeObject
Das Volume für das neue Snapshotobjekt
