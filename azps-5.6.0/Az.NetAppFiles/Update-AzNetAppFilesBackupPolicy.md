...
## SYNOPSIS
Aktualisiert eine Azure NetApp Files (ANF)-Sicherungsrichtlinie auf die optionalen bereitgestellten Modifikatoren.
...
Mit diesem Befehl wird die ANF-Sicherungsrichtlinie "MyBackupPolicy" so geändert, dass die angegebene DailyBackupsToKeep-Datei verwendet wird.
...
### -AccountObject
Das Kontoobjekt, das die zu aktualisierende Sicherungsrichtlinie enthält
...
### -DailyBackupsToKeep
Tägliche Sicherungen zählen zu behalten
...
Anzahl der monatlichen Sicherungen, die sie behalten müssen
...
### -WeeklyBackupsToKeep
Anzahl der wöchentlichen Sicherungen, die sie behalten müssen
...
### -YearlyBackupsToKeep
Anzahl der jährlichen Sicherungen, die sie behalten müssen
