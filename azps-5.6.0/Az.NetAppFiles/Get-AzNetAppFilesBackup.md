...
## SYNOPSIS
Ruft Details einer Azure NetApp Files (ANF)-Sicherung ab.
...
## BESCHREIBUNG
Das **Get-AzNetAppFilesBackup-Cmdlet** ruft Details einer ANF-Sicherung ab.
...
Dieser Befehl ruft den Backcup mit dem Namen "MyAnfAccount" aus dem Volume mit dem Namen "MyVolume" ab.
