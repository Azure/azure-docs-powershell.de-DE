...
## SYNOPSIS
Ruft Details einer Azure NetApp Files (ANF)-Snapshotrichtlinie ab.
...
## BESCHREIBUNG
Das **Cmdlet Get-AzNetAppFilesSnapshotPolicy** ruft Details einer ANF-Snapshotrichtlinie ab.
