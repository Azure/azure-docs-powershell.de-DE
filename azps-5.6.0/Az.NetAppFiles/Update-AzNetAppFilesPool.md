...
## SYNOPSIS
Aktualisiert einen Azure NetApp Files (ANF)-Pool entsprechend den optionalen Modifizierern, die bereitgestellt werden.
...
## BESCHREIBUNG
Das **Update-AzNetAppFilesPool-Cmdlet** ändert einen ANF-Pool.
...
Mit diesem Befehl wird der ANF-Pool "MyAnfPool" so geändert, dass er die angegebene Größe und QosType hat.
