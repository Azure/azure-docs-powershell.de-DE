...
## SYNOPSIS
Fortsetzen/Erneutes Synchronisieren der Verbindung auf dem Zielvolume Wenn der Vorgang auf dem Quellvolume verwendet wird, wird die Verbindung umgekehrt synchronisiert und von Quelle zu Ziel synchronisiert.
...
Mit diesem Befehl wird die ANF-Replikationsverbindung auf volume "MyDestinationAnfVolume" fortgesetzt.

## PARAMETER

### -AccountName
Der Name des ANF-Kontos des Replikationsvolumens
...
### -InputObject
Das neu zu synchronisierende ANF-Replikationszielvolumeobjekt
...
### -PassThru
Gibt zurück, ob eine Erneute Synchronisierung des angegebenen Replikationsvolumens ausgeführt wurde
...
### -PoolName
Der Name des ANF-Pools des Replikationsvolumes
