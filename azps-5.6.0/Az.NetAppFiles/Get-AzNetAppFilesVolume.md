...
## BESCHREIBUNG
Das **Get-AzNetAppFilesVolume-Cmdlet** ruft Details zu einem ANF-Volume ab.

## BEISPIELE

### Beispiel 1: Erhalten eines ANF-Volumes
```
...
### -PoolObject
Das Poolobjekt, das das zurückzukehrende Volume enthält
