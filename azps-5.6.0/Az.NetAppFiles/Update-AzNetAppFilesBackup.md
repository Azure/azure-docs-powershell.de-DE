...
## SYNOPSIS
Aktualisiert eine Azure NetApp Files (ANF)-Sicherung auf die optionalen Modifizierer, die bereitgestellt werden.
...
## BESCHREIBUNG
Das **Update-AzNetAppFilesBackup-Cmdlet** ändert eine ANF-Sicherung.
...
Dieser Befehl führt eine Aktualisierung der angegebenen Sicherung durch, um den Benutzernamen an die angegebene Zusicherung zu ändern.
...
### -InputObject
Das zu entfernende Snapshotobjekt
...
### -VolumeObject
Das Volumeobjekt, das die zurückzukehrende Sicherung enthält
