...
## BESCHREIBUNG
Das **Add-AzDnsRecordConfig-Cmdlet** fügt einem **RecordSet-Objekt** einen Dns-Eintrag (Domain Name System) hinzu.
Das **RecordSet-Objekt** ist ein Offlineobjekt, und Änderungen am -Objekt ändern die DNS-Antworten erst, nachdem Sie das Set-AzDnsRecordSet-Cmdlet ausgeführt haben, um die Änderung am Microsoft Azure -DNS-Dienst zu erhalten.
SOA-Einträge werden beim Erstellen einer DNS-Zone erstellt und entfernt, wenn die DNS-Zone gelöscht wird.
Sie können keine SOA-Einträge hinzufügen oder entfernen, sie aber bearbeiten.
...
In diesem Beispiel wird einem vorhandenen Datensatzsatz ein AAAA-Eintrag hinzufügt.
...
Da ein #A0 mindestens einen Datensatz enthalten kann, muss er zunächst ein leerer Datensatzsatz sein, oder vorhandene Datensätze müssen mit Remove-AzDnsRecordConfig entfernt werden.
...
Der Datensatzname "@" gibt einen Datensatz an, der am Scheitelpunkt der Zone festgelegt wurde.

### Beispiel 5: Hinzufügen eines NS-Eintrags zu einem Datensatzsatz
```
...
In diesem Beispiel wird einem vorhandenen Datensatzsatz ein NS-Eintrag hinzufügt.

### Beispiel 6: Hinzufügen eines PTR-Eintrags zu einem Datensatzsatz
```
...
### Beispiel 7: Hinzufügen eines SRV-Eintrags zu einem Datensatzsatz
```
...
### Beispiel 8: Hinzufügen eines TXT-Eintrags zu einem Datensatzsatz
```
...
### -RecordSet
Gibt das **zu bearbeitende RecordSet-Objekt** an.
