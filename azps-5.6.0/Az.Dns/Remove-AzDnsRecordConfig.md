...
### Beispiel 1: Entfernen eines A-Eintrags aus einem Datensatzsatz
```
...
In diesem Beispiel wird ein A-Eintrag aus einem vorhandenen Datensatzsatz entfernt.
...
In diesem Beispiel wird ein NS-Eintrag aus einem vorhandenen Datensatzsatz entfernt.
Wenn dies der einzige Datensatz im Datensatzsatz ist, ist das Ergebnis ein leerer Datensatzsatz.
Informationen zum vollständigen Entfernen eines Datensatzes finden Sie unter Remove-AzDnsRecordSet.
...
### -Nsdname
Gibt den Namenserver für einen Namenserverdatensatz (NS) an.
...
### -Ptrdname
Gibt den Zieldomänennamen eines Zeigerdatensatzs (PTR) an.
