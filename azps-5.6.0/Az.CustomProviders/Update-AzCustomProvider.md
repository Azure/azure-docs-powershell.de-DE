...
## SYNOPSIS
Aktualisiert einen vorhandenen benutzerdefinierten Ressourcenanbieter.
Der einzige Wert, der derzeit über PATCH aktualisiert werden kann, sind die Tags.
...
### Beispiel 1: Hinzufügen von Tags zu einem benutzerdefinierten Anbieter
```powershell
...
Aktualisieren Sie die Tags eines benutzerdefinierten Anbieters.

### Beispiel 2: Aktualisieren eines benutzerdefinierten Anbieters mit Piping
```powershell
...
Aktualisieren Sie einen benutzerdefinierten Anbieter mithilfe von Piping.
