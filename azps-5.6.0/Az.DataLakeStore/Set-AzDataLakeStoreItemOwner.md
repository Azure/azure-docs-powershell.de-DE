...
## BESCHREIBUNG
Das **Cmdlet Set-AzDataLakeStoreItemOwner** ändert den Besitzer einer Datei oder eines Ordners im Data Lake Store.

## BEISPIELE

### Beispiel 1: Festlegen des Besitzers für ein Element
```
PS C:\>Set-AzDataLakeStoreItemOwner -AccountName "ContosoADL" -Path / -Type User -Id (Get-AzADUser -Mail "PattiFuller@contoso.com").ObjectId
```

Mit diesem Befehl wird der Besitzer für das Stammverzeichnis auf "Patti Fuller" definiert.
...
### -ID
Gibt die Objekt-ID des AzureActive Directory-Benutzers, der Gruppe oder des Dienstprinzipal an, der als Besitzer verwendet werden soll.
...
### -Type
Gibt den Typ des besitzers an, der festgelegt werden soll.
