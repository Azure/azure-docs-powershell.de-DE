...
## BESCHREIBUNG
Das **Get-AzDataLakeStoreItemAclEntry-Cmdlet** ruft einen Eintrag (ACE) in der Zugriffssteuerungsliste (Access Control List, ACL) einer Datei oder eines Ordners im Data Lake Store ab.

## BEISPIELE

### Beispiel 1: ACL für einen Ordner erhalten
```
