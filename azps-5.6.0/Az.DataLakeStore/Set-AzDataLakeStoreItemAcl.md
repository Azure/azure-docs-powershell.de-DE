...
Der erste Befehl ruft die ACL für das Stammverzeichnis des ContosoADL-Kontos ab und speichert sie dann in der $ACL.
Mit dem zweiten Befehl wird die ACL für die Dateidatei Test.txt auf die in $ACL.

### Beispiel 2: Festlegen der ACL für den Ordner rekursiv
```
...
Der erste Befehl ruft die ACL für den Verzeichnisordner1 des ContosoADL-Kontos ab und speichert sie dann in der $ACL Variablen.
Mit dem zweiten Befehl wird die ACL rekursiv auf Ordner2 und deren Unterverzeichnissen und Dateien auf das Verzeichnis in $ACL.
...
### -Rekursieren
Gibt die ACL an, die rekursiv auf die untergeordneten Unterverzeichnisse und Dateien festgelegt werden soll
...
### -ShowProgress
Wenn der Status übergeben ist, wird der Status angezeigt. Gilt nur, wenn der rekursive Acl-Satz erledigt ist.
