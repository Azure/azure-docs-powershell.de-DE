...
## BESCHREIBUNG
Das **Add-AzDataLakeStoreFirewallRule-Cmdlet** fügt dem angegebenen Data Lake Store-Konto eine Firewallregel hinzu.
...
Dadurch wird eine neue Firewallregel namens "MyRule" im Konto "ContosoADL" mit einem IP-Bereich von 127.0.0.1 - 127.0.0.2 erstellt.

## PARAMETER

### -Konto
Das Data Lake Store-Konto, dem die Firewallregel hinzugefügt werden soll
...
### -Name
Der Name der hinzuzufügende Firewallregel.
...
### -ResourceGroupName
Name der Ressourcengruppe, unter der sich das Konto befindet, unter dem die Firewallregel hinzugefügt werden soll.
...
### -StartIpAddress
Der Start des gültigen IP-Bereichs für die Firewallregel
