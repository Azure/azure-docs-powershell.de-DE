...
Mit diesem Befehl wird ein Data Lake Store-Konto mit dem Namen ContosoADL für den Ost-US 2-Speicherort erstellt.

## PARAMETER

### -DefaultGroup
Gibt die Objekt-ID der AzureActive Directory-Gruppe an, die als Standardgruppenbesitzer für neue Dateien und Ordner verwendet werden soll.
...
### -DisableEncryption
Gibt an, dass auf das Konto keine Verschlüsselung angewendet wird.
...
### -Location
Gibt den Speicherort an, der für das Konto verwendet werden soll.
...
### -Name
Gibt den Namen des zu erstellenden Kontos an.
