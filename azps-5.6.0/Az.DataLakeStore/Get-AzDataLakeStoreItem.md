...
## BESCHREIBUNG
Das **Get-AzDataLakeStoreItem-Cmdlet** ruft die Details einer Datei oder eines Ordners im Data Lake Store ab.
...
Mit diesem Befehl werden die Details der Dateidatei Test.csv aus dem Data Lake Store.
...
### -Path
Gibt den Data Lake Store-Pfad an, über den Details zu einem Element ab dem Stammverzeichnis (/) angezeigt werden.
