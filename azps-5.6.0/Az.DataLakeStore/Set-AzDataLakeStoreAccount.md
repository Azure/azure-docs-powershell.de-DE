...
### Beispiel 1: Hinzufügen eines Tags zu einem Konto
```powershell
...
### -AllowAzureIpState
Optional können Sie IPs mit Ursprung in Azure über die Firewall zulassen/blockieren.
...
### -KeyVersion
Wenn der Verschlüsselungstyp Benutzer zugewiesen ist, kann der Benutzer seine Schlüsselversion mit diesem Parameter drehen.
...
### -Tier
Die gewünschte Verpflichtungsstufe für dieses Konto.
