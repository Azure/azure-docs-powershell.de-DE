...
## SYNOPSIS
Ruft die angegebenen Regeln für virtuelle Netzwerke im angegebenen Data Lake Store ab.
Wenn keine Regel für virtuelle Netzwerke angegeben ist, werden alle Regeln für das virtuelle Netzwerk für das Konto aufgeführt.
...
## BESCHREIBUNG
Das Get-AzDataLakeStoreVirtualNetworkRule-Cmdlet ruft die angegebenen Regeln für virtuelle Netzwerke im angegebenen Data Lake Store ab.
Wenn keine Regel für virtuelle Netzwerke angegeben ist, werden alle Regeln für das virtuelle Netzwerk für das Konto aufgeführt.
...
Gibt die Virtuelle Netzwerkregel mit dem Namen "myVNET" von Konto "dls" zurück.

## PARAMETER

### -Konto
Das Data Lake Store-Konto, aus dem die Regel für virtuelle Netzwerke
