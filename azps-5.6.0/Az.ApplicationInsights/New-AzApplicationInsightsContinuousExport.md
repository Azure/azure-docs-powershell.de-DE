...
Erstellen Sie eine neue Fortlaufende Exportkonfiguration für Anwendungseinblicke, um Dokumenttypen "Anforderung" und "Ablaufverfolgung" in den Speicher zu exportieren, die "testcontainer" im Speicherkonto "teststorageaccount" in der Ressourcengruppe "testgroup" enthalten. Das SAS-Token muss gültig sein und über schreibberechtigungen für den Container verfügen, andernfalls funktioniert das Feature für den kontinuierlichen Export nicht. Wenn das SAS-Token abgelaufen ist, funktioniert das Feature für den kontinuierlichen Export nicht mehr.
