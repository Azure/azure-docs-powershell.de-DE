...
### Beispiel 1 Entfernen einer Ressource für Anwendungseinblicke
```
PS C:\> Remove-AzApplicationInsights -ResourceGroupName "testgroup" -Name "test" -PassThru
True
```

Entfernen einer Ressource für Anwendungseinblicke mit dem Namen "Test" in der Ressourcengruppe "Testgruppe"
