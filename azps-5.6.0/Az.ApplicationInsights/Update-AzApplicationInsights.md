...
### Beispiel 1 Komponente "Anwendungseinblicke aktualisieren"
```powershell
Update-AzApplicationInsights -ResourceGroupName "rgName" -Name "aiName" -PublicNetworkAccessForIngestion "Disabled" -PublicNetworkAccessForQuery "Disabled"
```

Aktualisieren der Komponente "aiName" PublicNetworkAccessForIngestion/PublicNetworkAccessForQuery auf "Disabled"
...
Der Netzwerkzugriffstyp für den Zugriff auf application insights ingestion.
