...
## BESCHREIBUNG
Ressourcen für Anwendungseinblicke in einer Ressourcengruppe oder einer bestimmten Ressource

## BEISPIELE

### Beispiel 1 Ressourcen für Anwendungseinblicke
```
...
Ressourcen für Anwendungseinblicke mit dem Namen "Test" in der Ressourcengruppe "Testgruppe"

### Beispiel 2 Ressourcen für Anwendungseinblicke mit Informationen zum Preisplan
```
...
Ressourcen für Anwendungseinblicke erhalten und Preisplaninformationen für Die Ressource mit dem Namen "Test" in der Ressourcengruppe "Testgruppe" enthalten
...
### -Full
Wenn angegeben, werden der Preisplan/die tägliche Obergrenze und der Status der Komponente "Anwendungseinblicke" zurück angezeigt.
