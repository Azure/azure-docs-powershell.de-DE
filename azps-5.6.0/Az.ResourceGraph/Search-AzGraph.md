...
```
Eine Abfrage mit allen virtuellen Computern, die keine verwalteten Datenträger verwenden und Abonnementanzeigenamen enthält.
...
```
Eine Abfrage mit der Anzahl der Ressourcen nach Mandanten- und Abonnementanzeigenamen.
...
### -First
Die maximale Anzahl von Zurücksennungsobjekten. Zulässige Werte: 1-5000.
