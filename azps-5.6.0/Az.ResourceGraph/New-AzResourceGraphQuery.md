...
### Beispiel 1: Erstellen einer Ressourcendiagrammabfrage mit dem Abfrageparameter
```powershell
...
Mit diesem Befehl wird eine Ressourcendiagrammabfrage mit dem Abfrageparameter erstellt.

### Beispiel 2: Erstellen einer Ressourcendiagrammabfrage mit dem Dateiparameter
```powershell
