...
## SYNOPSIS
Löscht eine CosmosDB-Gremlin-Datenbank.
...
## BESCHREIBUNG
Das **Cmdlet Remove-AzCosmosDBGremlinDatabase** löscht eine CosmosDB-Gremlin-Datenbank.
...
Das Cmdlet gibt ein Objekt vom Typ bool(wenn -PassThru übergeben wird) zurück, das wahr ist, wenn das Löschen erfolgreich war.
...
### -PassThru
Um auf true festgelegt zu sein, wenn der Benutzer eine Ausgabe erhalten möchte.
Die Ausgabe ist true, wenn der Vorgang erfolgreich war und ein Fehler ausgelöst wird, wenn nicht.
