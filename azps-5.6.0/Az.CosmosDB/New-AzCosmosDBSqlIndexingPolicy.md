...
### -ExcludedPath
Array von Zeichenfolgen, die excludedPath enthalten(Gibt einen Pfad innerhalb eines JSON-Dokuments an, der im Azure Cosmos DB-Dienst ausgeschlossen werden soll.)  -Elemente.
...
### -IncludedPath
Array von Zeichenfolgen, die includedPath enthalten (Gibt einen Pfad in einem JSON-Dokument an, der in die Azure Cosmos DB-Dienstelemente einbezogen werden soll.)
...
Mögliche Werte sind: "Konsistent", "Lazy", "Keine"
