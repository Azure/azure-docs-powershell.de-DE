...
## SYNOPSIS
Aktualisieren von Regionen eines CosmosDB-Kontos.
...
## BESCHREIBUNG
Aktualisieren von Regionen eines CosmosDB-Kontos. Der Speicherort kann entweder als Objekt vom Typ PSLocation oder als Zeichenfolgen des Positionsnamens angegeben werden, die nach Failoverpriorität geordnet sind.
Der Parameter LocationObject erwartet, dass die Liste der aktuellen Speicherorte (eingeschlossene Failover prioritiies) von den neuen LocationObjects angefügt wird, die neuen Speicherorten entsprechend hinzugefügt werden.
Der Parameter Position erwartet die Liste der aktuellen Position (nach Failoverpriorität geordnet) und die neuen Speicherorte. Bitte beachten Sie, dass wir nur "Addition of Regions" unterstützen. Geben Sie entweder "Ort" oder "LocationObject" an.
...
### -Location
Name des speicherorts, der hinzugefügt werden soll.
