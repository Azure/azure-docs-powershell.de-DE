...
## SYNOPSIS
Löscht die CosmosDB Sql StoredProcedure.
...
## BESCHREIBUNG
Das **Cmdlet Remove-AzCosmosDBSqlStoredProcedure** löscht das CosmosDB Sql StoredProcedure, das dem angegebenen ResourceGroupName, AccountName und DatabaseName entspricht.
