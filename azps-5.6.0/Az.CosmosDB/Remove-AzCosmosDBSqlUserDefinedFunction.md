...
## SYNOPSIS
Löscht die Funktion "CosmosDB Sql UserDefinedFunction".
...
## BESCHREIBUNG
Das **Cmdlet Remove-AzCosmosDBSqlUserDefinedFunction** löscht das CosmosDB Sql UserDefinedFunction, das den angegebenen ResourceGroupName, AccountName und DatabaseName entspricht.
