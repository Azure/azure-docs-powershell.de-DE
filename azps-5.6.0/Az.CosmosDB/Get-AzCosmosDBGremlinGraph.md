...
## SYNOPSIS
Ruft die CosmosDB Gremlin Graph ab.
...
## BESCHREIBUNG
Das **Cmdlet Get-AzCosmosDBGremlinGraph** ruft die Eigenschaften von CosmosDB Gremlin Graph ab.
...
Ressourcenobjekt enthält IndexingPolicy, PartitionKey, DefaultTtl, UniqueKeyPolicy, ConflictResolutionPolicy, _rid, _ts, _etag.
