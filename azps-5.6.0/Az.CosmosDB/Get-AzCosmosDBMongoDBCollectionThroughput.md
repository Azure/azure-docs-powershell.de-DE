...
## SYNOPSIS
Ruft die Durchsatzeigenschaften von CosmosDB der MongoDB-Sammlung ab.
...
## BESCHREIBUNG
Das **Get-AzCosmosDBMongoDBCollectionThroughput-Cmdlet** ruft die Durchsatzeigenschaften der MongoDB-Sammlung ab.
...
### -InputObject
Wird dies angegeben, gibt das Cmdlet die Auflistung mit dem entsprechenden Durchsatzwert zurück.
