...
## SYNOPSIS
Erstellt eine neue CosmosDB-Kassandratabelle.
...
Verwenden New-AzCosmosDBCassandraSchema, um dieses Objekt zu erstellen.
...
### -Durchsatz
Der Durchsatz von Cassisy Keyspace (RU/s).
