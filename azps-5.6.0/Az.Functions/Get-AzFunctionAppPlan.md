...
### Beispiel 1: Alle Funktions-App-Pläne herunterladen.
```powershell
...
### Beispiel 2: Herunterladen von Funktions-App-Plänen nach Ressourcengruppenname.
```powershell
...
Dieser Befehl ruft Funktions-App-Pläne nach Ressourcengruppennamen ab.

### Beispiel 3: Herunterladen von Funktions-App-Plänen für die angegebenen Abonnements.
```powershell
...
### Beispiel 4: Herunterladen von Funktions-App-Plänen nach Standort.
```powershell
...
Dieser Befehl ruft Funktions-App-Pläne nach Standort ab.
