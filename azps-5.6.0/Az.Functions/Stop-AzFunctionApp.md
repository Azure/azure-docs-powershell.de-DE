...
### Beispiel 1: Holen Sie sich eine Funktions-App nach Namen, und beenden Sie sie.
```powershell
...
### -Erzwingen
Erzwingt das Cmdlet, die Funktions-App zu beenden, ohne zur Bestätigung aufgefordert zu werden.
