...
## SYNOPSIS
Ruft den Speicherort ab, an dem eine Funktions-App für den angegebenen Betriebssystem- und Plantyp verfügbar ist.
...
### Beispiel 1: Hier finden Sie die Speicherorte, an denen Premium für Windows verfügbar ist. Wenn keine Parameter angegeben werden, ist PlanType auf "Premium" und OSType auf "Windows" festgelegt.
```powershell
...
### Beispiel 2: Hier finden Sie die Speicherorte, an denen Premium für Linux verfügbar ist.
```powershell
...
### Beispiel 3: Hier finden Sie die Speicherorte, an denen "Verbrauch" für Windows verfügbar ist.
```powershell
...
### -OSType
Der Betriebssystemtyp für den Dienstplan.
