...
## SYNOPSIS
Erstellt einen Funktions-App-Dienstplan.
...
### Beispiel 1: Erstellen Sie einen Windows Premium-App-Plan in Westeuropa mit einer Burst-out-Funktion von bis zu 10 Instanzen.
```powershell
...
Mit diesem Befehl wird ein Windows Premium-App-Plan in Westeuropa mit einer Burst-Out-Funktion von bis zu 10 Instanzen erstellt.
