...
### Beispiel 1: Update function app hosting plan.
```powershell
...
Mit diesem Befehl wird eine verwaltete SystemAssigned-Identität für eine Funktions-App definiert.

### Beispiel 3: Update function app Application Insights.
```powershell
...
Mit diesem Befehl wird die App Application Insights aktualisiert.
...
Instrumentierungsschlüssel der App Insights, die hinzugefügt werden sollen.
...
### -IdentityType
Gibt den Identitätstyp an, der für die Funktions-App verwendet wird.
...
### -NoWait
Startet den Vorgang und gibt sofort zurück, bevor der Vorgang abgeschlossen ist.
