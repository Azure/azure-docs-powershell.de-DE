...
### Beispiel 1: Holen Sie sich eine Funktions-App nach Name, und starten Sie sie neu.
```powershell
PS C:\> Get-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName | Restart-AzFunctionApp -Force
```

Dieser Befehl ruft eine Funktions-App nach Namen ab und startet sie neu.
...
### -Erzwingen
Erzwingt das Cmdlet, die Funktions-App neu zu starten, ohne zur Bestätigung aufgefordert zu werden.
