...
### Beispiel 2: Festlegen einer Erweiterung mit über die Pipeline angegebenen Erweiterungsparametern
```powershell
...
Dadurch wird eine Erweiterung mit den Erweiterungsparametern festgelegt, die vom über die Pipeline übergebenen Objekt bereitgestellt werden.
