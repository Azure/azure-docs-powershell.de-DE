...
## SYNOPSIS
Erstellt ein WcfRelay im angegebenen Relay-Namespace.
...
## BESCHREIBUNG
Das New-AzWcfRelay-Cmdlet erstellt ein WcfRelay im angegebenen Relay-Namespace.
...
Erstellt einen neuen WcfRelay \` TestWCFRelay2 \` im angegebenen Relay-Namespace \` TestNameSpace-Relay. \`
...
Erstellt einen neuen WcfRelay \` TestWCFRelay \` im angegebenen Relay-Namespace \` TestNameSpace-Relay1. \`
...
true, wenn für dieses Relay Clientautorisierung erforderlich ist; andernfalls false
...
true, wenn Transportsicherheit für dieses Relay erforderlich ist; andernfalls false
...
### -UserMetadata
Ruft benutzermetadata ab oder legt diese als Platzhalter fest, um benutzerdefinierte Zeichenfolgendaten für den HybridConnection-Endpunkt zu speichern. sie kann zum Speichern beschreibender Daten verwendet werden, z. B. eine Liste von Teams, und deren Kontaktinformationen können auch benutzerdefinierte Konfigurationseinstellungen gespeichert werden.
