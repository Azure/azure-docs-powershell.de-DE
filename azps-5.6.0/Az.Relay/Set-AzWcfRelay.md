...
## SYNOPSIS
Aktualisiert die Beschreibung eines WcfRelays im angegebenen Relay-Namespace.
...
## BESCHREIBUNG
Das Set-AzWcfRelay cmdlet aktualisiert die Beschreibung für wcfRelay im angegebenen Relay-Namespace.
...
In diesem Beispiel wird die UserMetadata-Eigenschaft mit einem neuen Wert aktualisiert.
...
### -UserMetadata
Ruft benutzermetadata ab oder legt diese fest, um benutzerdefinierte Zeichenfolgendaten für den WcfRelay-Endpunkt zu speichern. sie kann zum Speichern beschreibender Daten verwendet werden, z. B. eine Liste von Teams, und deren Kontaktinformationen können auch benutzerdefinierte Konfigurationseinstellungen gespeichert werden.
