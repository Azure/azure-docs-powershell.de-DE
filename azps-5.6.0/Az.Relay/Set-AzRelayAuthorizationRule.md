...
## SYNOPSIS
Aktualisiert die angegebene Beschreibung der Autorisierungsregel für die angegebenen Relay-Entitäten (Namespace/WcfRelay/HybridConnection).
...
## BESCHREIBUNG
Das **Cmdlet Set-AzRelayAuthorizationRule** aktualisiert die Beschreibung für die angegebene Autorisierungsregel der angegebenen Relay-Entitäten (Namespace/WcfRelay/HybridConnection).
...
### Beispiel 1.2 – Namespace mit Dem Parameter "Rechte"
```
...
Fügt **Senden** den Zugriffsrechten der Autorisierungsregel `AuthoRule1` von WcfRelay `TestWCFRelay1` hinzu.

### Beispiel 2.2 – WcfRelay mit dem Parameter "Rechte"
```
...
Fügt **Senden** den Zugriffsrechten der Autorisierungsregel `AuthoRule1` der HybridConnection `TestHybridConnection` hinzu.
