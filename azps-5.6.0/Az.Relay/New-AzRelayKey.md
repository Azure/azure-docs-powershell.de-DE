...
## SYNOPSIS
Regeneriert die primären oder sekundären Verbindungszeichenfolgen für die angegebenen Relayentitäten (Namespace/WcfRelay/HybridConnection)
...
## BESCHREIBUNG
Das **New-AzRelayKey-Cmdlet** generiert die primären und sekundären Verbindungszeichenfolgen für die angegebenen Relayentitäten (Namespace/WcfRelay/HybridConnection).
...
Regeneriert die primären oder sekundären Verbindungszeichenfolgen für die angegebene Relay-Namespace Entität.
...
generiert die primären oder sekundären Verbindungszeichenfolgen für die angegebene Relay-Namespace Entität mit dem bereitgestellten Schlüsselwert
...
Regeneriert die primären oder sekundären Verbindungszeichenfolgen für die angegebene Relay-WcfRelay Entität.

### Beispiel 2.1 – WcfRelay KeyValue Provided
```
...
generiert die primären oder sekundären Verbindungszeichenfolgen für die angegebene Relay-WcfRelay Entität mit dem bereitgestellten Schlüsselwert
...
### Beispiel 3.1 – HybridConnection KeyValue Provided
```
...
generiert die primären oder sekundären Verbindungszeichenfolgen für die angegebene Relay-HybridConnection Entität mit dem bereitgestellten Schlüsselwert
...
### -RegenerateKey
Neu generieren von Schlüsseln – "PrimaryKey"/"SecondaryKey".
