...
## BESCHREIBUNG
Das **Get-AzRelayKey-Cmdlet** gibt die primären und sekundären Verbindungszeichenfolgen für die angegebenen Relay-Entitäten zurück (Namespace/WcfRelay/HybridConnection).
...
Primäre und sekundäre Verbindungszeichenfolge zu den angegebenen Relayentitäten (Namespace/WcfRelay/HybridConnection).
