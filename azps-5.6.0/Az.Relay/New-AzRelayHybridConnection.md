...
## SYNOPSIS
Erstellt eine HybridVerbindeung im angegebenen Relay-Namespace.
...
## BESCHREIBUNG
Das New-AzRelayHybridConnection-Cmdlet erstellt eine HybridConnection im angegebenen Relay-Namespace.
...
Erstellt einen neuen HybirdConnection \` TestHybirdConnection2 \` im angegebenen Relay-Namespace \` TestNameSpace-HybirdConnection. \`
...
Erstellt einen neuen HybirdConnection \` TestHybirdConnection1 \` im angegebenen Relay-Namespace \` TestNameSpace-HybirdConnection \` .
...
true, wenn eine Clientautorisierung für diese HybridConnections erforderlich ist; andernfalls false
