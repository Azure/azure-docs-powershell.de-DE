...
## Beschreibung
Das Cmdlet **New-AzureRmDataFactoryHub** erstellt einen Hub für Azure Data Factory in der angegebenen Azure-Ressourcengruppe und in der angegebenen Data Factory mit der angegebenen Datei Definition.
Nachdem Sie den Hub erstellt haben, können Sie ihn zum Speichern und verwalten verknüpfter Dienste in einer Gruppe verwenden, und Sie können dem Hub Pipelines hinzufügen.

## Beispiele

### Beispiel 1: Erstellen eines Hubs
```
...
Dieser Befehl erstellt einen Hub mit dem Namen ContosoDataHub in der Ressourcengruppe ADFResourceGroup und der Data Factory mit dem Namen ADFDataFactory.

## Parameter

### -DataFactory
Gibt ein **PSDataFactory** -Objekt an.
Dieses Cmdlet erstellt einen Hub für die Data Factory, den dieser Parameter angibt.
...
### -Datei
Gibt den vollständigen Pfad der JSON-Datei (JavaScript Object Notation) an, die die Beschreibung des Hubs enthält.
...
### -Force
Gibt an, dass dieses Cmdlet einen vorhandenen Hub ersetzt, ohne dass Sie zur Bestätigung aufgefordert werden.
...
### -Name
Gibt den Namen des zu erstellenden Hubs an.
...
Mit diesem Cmdlet wird ein Hub erstellt, der zu der Gruppe gehört, die dieser Parameter angibt.
