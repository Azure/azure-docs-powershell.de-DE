...
## Beschreibung
Das Cmdlet **Wait-AzureRmHDInsightJob** wartet auf den Abschluss oder Fehler eines Azure HDInsight-Auftrags.

## Beispiele

### Beispiel 1: warten auf den Abschluss oder Fehler eines Auftrags
```
PS C:\># Cluster info
...
### -TimeoutInSeconds
Die Gesamtwartezeit für den Abschluss des Auftrags in Sekunden.
...
Die Wartezeit zwischen Auftragsstatus Prüfungen in Sekunden.
...
### Zeichenfolge
Der Parameter "JobID" akzeptiert den Wert vom Typ "Zeichenfolge" aus der Pipeline.
