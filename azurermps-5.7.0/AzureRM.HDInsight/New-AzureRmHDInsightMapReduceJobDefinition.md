...
## Beschreibung
Das Cmdlet **New-AzureRmHDInsightMapReduceJobDefinition** definiert einen neuen MapReduce-Auftrag für die Verwendung mit einem Azure HDInsight-Cluster.
...
### -Libjar
Gibt die lib-Tiegel für den Auftrag an.
