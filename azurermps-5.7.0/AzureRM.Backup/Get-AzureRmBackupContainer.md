...
- Eine Azure Infrastructure as a Service (IaaS) Virtual Machine

Bevor eine Datenquelle oder ein Element von der Sicherung gesichert werden kann, müssen Sie den Container, in dem Sie gespeichert ist, beim Azure-Sicherungsdienst registrieren.
