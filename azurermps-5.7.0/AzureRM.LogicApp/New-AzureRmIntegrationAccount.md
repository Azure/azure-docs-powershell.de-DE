...
## Beschreibung
Mit dem Cmdlet **New-AzureRmIntegrationAccount** wird ein Integrations Konto erstellt.
Dieses Cmdlet gibt ein Objekt zurück, das das Integrations Konto darstellt. Geben Sie einen Namen, einen Speicherort, einen Ressourcengruppennamen und einen SKU-Namen an.
...
### Beispiel 1: Erstellen eines Integrations Kontos
```
...
Mit diesem Befehl wird ein Integrations Konto mit dem Namen IntegrationAccount31 in der angegebenen Ressourcengruppe erstellt.
