...
## Beschreibung
Das Cmdlet **New-AzureRmIntegrationAccountSchema** erstellt ein Schema für das Integrations Konto.
Dieses Cmdlet gibt ein Objekt zurück, das das Schema des Integrations Kontos darstellt.
Geben Sie den Namen des Integrations Kontos, den Ressourcengruppennamen, den Schemanamen und die Schema Definition an.
...
### Beispiel 1: Erstellen des Schemas für das Integrations Konto
```
...
Mit diesem Befehl wird das Schema des Integrations Kontos mit dem Namen IntegrationAccountSchema1 in der angegebenen Ressourcengruppe erstellt.

## Parameter

### -ContentType
Gibt einen Inhaltstyp für das Schema des Integrations Kontos an.
...
### -SchemaDefinition
Gibt ein Definitionsobjekt für das Schema des Integrations Kontos an.
Geben Sie entweder diesen Parameter oder den *SchemaFilePath* -Parameter an.
...
### -SchemaFilePath
Gibt den Dateipfad einer Definition für das Schema des Integrations Kontos an.
Geben Sie entweder diesen Parameter oder den *SchemaDefinition* -Parameter an.
...
### -Schemaname
Gibt einen Namen für das Schema des Integrations Kontos an.
...
### -SchemaType
Gibt den Typ für das Schema des Integrations Kontos an.
