...
## Beschreibung
Das Cmdlet **Remove-AzureRmRelayNamespace** entfernt den Namespace aus der angegebenen Ressourcengruppe.
...
Entfernt den Relay `TestNameSpace-Relay1` -Namespace aus der angegebenen Ressourcengruppe `Default-ServiceBus-WestUS` .
