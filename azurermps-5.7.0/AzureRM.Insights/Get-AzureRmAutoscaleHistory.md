...
## Beschreibung
Das Cmdlet " **Get-AzureRmAutoscaleHistory** " Ruft den Verlauf von Ereignissen ab, die sich auf eine AutoScale-Einstellung beziehen.

## Beispiele

### Beispiel 1: Abrufen aller Ereignisse, die einem Abonnement zugeordnet sind
```
PS C:\>Get-AzureRmAutoscaleHistory -StartTime 2015-02-09T18:35:00 -EndTime 2015-02-09T18:40:00 -DetailedOutput
```

Dieser Befehl ruft alle mit dem aktuellen Abonnement verknüpften Ereignisse mit der autoskala ab.
...
Dieser Befehl ruft alle Auto scale-bezogenen Ereignisse ab, die einer bestimmten Ressource zugeordnet sind, die durch die ID der Ressource identifiziert wird (im wesentlichen ResourceUri).
...
### -Resourcen-Nr
Gibt die Ressourcen-ID an, der die AutoScale-Einstellung zugeordnet ist.
...
Dieser Parameter ist optional.
Der Fehler ist eine leere Zeichenfolge (also kein Filter)
