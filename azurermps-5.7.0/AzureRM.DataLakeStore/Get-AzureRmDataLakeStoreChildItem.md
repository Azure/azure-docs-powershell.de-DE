...
## Beschreibung
Das Cmdlet " **Get-AzureRmDataLakeStoreChildItem** " Ruft die Liste der Elemente in einem Ordner im Data Lake Store ab.

## Beispiele

### Beispiel 1: Abrufen der untergeordneten Elemente für einen Ordner
```
PS C:\>Get-AzureRmDataLakeStoreChildItem -AccountName "ContosoADL" -Path "/MyFiles/"
```

Dieser Befehl ruft die untergeordneten Elemente für den Ordner "meine Dateien" ab.
...
### -Path
Gibt den Daten See-Speicherpfad des Ordners an, beginnend mit dem Stammverzeichnis (/).
...
Die Liste der Data Lake-Speicherdateien und-Ordner unter dem angegebenen Pfad.
