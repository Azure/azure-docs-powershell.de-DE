...
## Beschreibung
Das Cmdlet " **Satz-AzureRmDataLakeStoreItemOwner** " ändert den Besitzer einer Datei oder eines Ordners im Data Lake Store.
...
### Zeichenfolge
Wenn passthru angegeben ist, wird der aktualisierte Besitzer zurückgegeben.
