...
## Synopsis
Erstellt ein standortbasiertes Dienstkonto.
...
## Beschreibung
Das Cmdlet **New-AzureRmLocationBasedServicesAccount** erstellt ein Location based Services-Konto mit der angegebenen SKU.
...
Erstellt ein neues standortbasiertes Dienstkonto mit dem Namen "Mein Konto" in der Ressourcengruppe myresourcegroup mit der SKU S0 und einer Kategorie.
...
### -SkuName
Standortbasierter Dienstkonto-SKU-Name.
...
### -Tag
Kontokategorien für standortbasierte Dienste
...
Zum Erstellen eines Location based Services-Kontos muss eine Aufforderung zur Annahme von Ausdrücken beantwortet werden (siehe https://azure.microsoft.com/en-us/support/legal/preview-supplemental-terms/) .  Der Parameter-Force kann verwendet werden, um die Akzeptanz der Begriffe anzugeben.
