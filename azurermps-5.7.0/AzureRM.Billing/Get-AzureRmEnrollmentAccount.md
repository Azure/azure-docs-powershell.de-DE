...
## Beschreibung
Das Cmdlet " **Get-AzureRmEnrollmentAccount** " ruft Registrierungs Konten ab.
...
Abrufen aller verfügbaren Registrierungs Konten
...
Rufen Sie das registrierungskonto mit der angegebenen Objekt-ID ab.
...
### -ObjectID
Die ObjectID eines bestimmten Registrierungs Kontos, das abgerufen werden soll.
...
### System. Collections. Generic. List ' 1 [[Microsoft. Azure. Commands. Abrechnungs. Models. PSEnrollmentAccount; Microsoft. Azure. Commands. Billing; Version = 0.14.0.0; Kultur = neutral; PublicKeyToken = null]]
