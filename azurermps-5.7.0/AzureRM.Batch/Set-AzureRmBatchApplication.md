...
## Beschreibung
Das Cmdlet " **Satz-AzureRmBatchApplication** " ändert die Einstellungen für die angegebene Azure-Batch Anwendung.
...
Mit diesem Befehl wird geändert, ob die Llitware-Anwendung im ContosoBatch-Konto Updates zulässt.
