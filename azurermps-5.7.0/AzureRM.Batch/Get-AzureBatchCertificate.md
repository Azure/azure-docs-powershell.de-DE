...
## Beschreibung
Das Cmdlet " **Get-AzureBatchCertificate** " Ruft die Zertifikate im Azure-Batch Konto ab, das vom *batchcontext* -Parameter angegeben wird.
Um ein bestimmtes Zertifikat zu erhalten, geben Sie die Parameter *ThumbprintAlgorithm* und *Fingerabdruck* an.
Geben Sie den *Filter* -Parameter an, um die Zertifikate abzurufen, die einem OData-Filter (Open Data Protocol) entsprechen.

## Beispiele

### Beispiel 1: Abrufen eines Zertifikats nach dem Fingerabdruck
```
...
Dieser Befehl ruft ein einzelnes Zertifikat ab, das den angegebenen Fingerabdruck aufweist.
Der Zertifikat Fingerabdruck-Algorithmus ist SHA1.

### Beispiel 2: Abrufen gefilterter Zertifikate
```
...
Dieser Befehl ruft alle Zertifikate im aktiven Zustand vom Batch Konto ab.
...
### -MaxCount
Gibt die maximale Anzahl von Zertifikaten an, die zurückgegeben werden sollen.
