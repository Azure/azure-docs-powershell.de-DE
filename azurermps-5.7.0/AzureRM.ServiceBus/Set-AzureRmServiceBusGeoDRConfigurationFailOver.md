...
## Beschreibung
Das Cmdlet " **Satz-AzureRmServiceBusGeoDRConfigurationFailOver** " envokes Geo Dr-Failover, und konfigurieren Sie den Alias so, dass er auf den sekundären Namespace verweist.
...
Ruft das Failover für den Alias "SampleDRCongifName" auf, konfiguriert und verweist auf den sekundären Namespace "SampleNamespace_Secondary".
...
### -Inputobject
ServiceBus-GeoDR-Konfigurationsobjekt
...
### -Namespace
Namespace Name – sekundärer Namespace
