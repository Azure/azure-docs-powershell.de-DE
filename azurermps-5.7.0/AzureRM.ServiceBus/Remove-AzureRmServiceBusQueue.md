...
## Beschreibung
Das Cmdlet **Remove-AzureRmServiceBusQueue** entfernt die Warteschlange aus dem angegebenen ServiceBus-Namespace.
...
Entfernt die Warteschlange `SB-Queue_exampl1` aus dem Namespace `SB-Example1` .
