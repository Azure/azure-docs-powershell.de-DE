...
## Beschreibung
Das Cmdlet **Remove-AzureRmNetworkSecurityGroup** entfernt eine Azure Network Security-Gruppe.
...
### -ResourceGroupName
Gibt den Namen einer Ressourcengruppe an, aus der dieses Cmdlet eine Netzwerksicherheitsgruppe entfernt.
