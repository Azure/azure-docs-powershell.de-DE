...
## Beschreibung
**Das Cmdlet "Satz-AzureRmApplicationGatewayRequestRoutingRule"** ändert eine Umleitungs Konfiguration.
...
Mit dem zweiten Befehl wird die Umleitungs Konfiguration für das Anwendungsgateway geändert, um den Typ permanent umzuleiten und eine Ziel-URL zu verwenden.
...
### -TargetListener
HTTPListener zum Umleiten der Anforderung an
...
### -TargetListenerID
Die ID des Listener, an den die Anforderung umgeleitet werden soll
