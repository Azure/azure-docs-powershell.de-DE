...
## Beschreibung
Behebt und zeigt detaillierte Informationen zu Fehlern in der aktuellen PowerShell-Sitzung an, einschließlich der Fehler im Skript, in der Stapelüberwachung sowie in allen inneren und Aggregat Ausnahmen. Für Azure PowerShell-Fehler bietet zusätzliche Informationen zum Debuggen von Dienstproblemen, einschließlich vollständiger Details zur Anforderung und Serverantwort, die den Fehler verursacht haben.
...
Abrufen von Details zum letzten Fehler
...
Abrufen von Details zu allen Fehlern, die in der aktuellen Sitzung aufgetreten sind.
...
Abrufen von Details zum angegebenen Fehler
...
### -Fehler
Eine oder mehrere Fehlereinträge, die aufgelöst werden sollen.  Wenn keine Parameter angegeben werden, werden alle Fehler in der Sitzung aufgelöst.
...
Informationen zu einem PowerShell-Fehler, bei dem es sich nicht um einen Exception handelt.

### Microsoft. Azure. Commands. profile. Errors. AzureExceptionRecord
Informationen zu einem Fehler einschließlich detaillierter Informationen zu der Ausnahme, die den Fehler ausgelöst hat.

### Microsoft. Azure. Commands. profile. Errors. AzureRestExceptionRecord
Informationen zu Fehlern in der Cleint/Server-Kommunikation.  Dies enthält häufig wichtige Informationen zum Fehler vom Server.
