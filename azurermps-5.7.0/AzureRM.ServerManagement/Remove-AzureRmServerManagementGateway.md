...
## Beschreibung
Das Cmdlet **Remove-AzureRmServerManagementGateway** entfernt ein Azure Server-Verwaltungs Gateway.
...
### -Gateway
Gibt das Gateway an, das vom Cmdlet entfernt wird.

Dieser Parameter kann anstelle der *ResourceGroupName* -und der *GatewayName* -Parameter verwendet werden.
...
### -Gatewayname
Gibt den Namen des Gateways an, das vom Cmdlet entfernt wird.
...
## Notizen
* Bevor Sie dieses Cmdlet verwenden können, müssen alle Knoten im Gateway entfernt werden. Andernfalls tritt für dieses Cmdlet ein Fehler auf.
