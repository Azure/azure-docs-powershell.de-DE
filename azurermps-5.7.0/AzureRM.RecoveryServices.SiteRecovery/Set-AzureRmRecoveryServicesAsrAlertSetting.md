...
## Beschreibung
Das Cmdlet " **Satz-AzureRmRecoveryServicesAsrNotificationSetting** " konfiguriert Azure Site Recovery Notification-Einstellungen (e-Mail-Benachrichtigung) für den Tresor.
...
### -Gebietsschema-Nr
E-Mail-Sprache der Benachrichtigungs-/notifcation an Benutzer (unterstützte Kulturcodes von Microsoft). 
