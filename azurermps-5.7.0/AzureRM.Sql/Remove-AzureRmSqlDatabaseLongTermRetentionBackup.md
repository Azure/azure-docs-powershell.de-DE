...
## Beschreibung
Das Cmdlet **Remove-AzureRmSqlDatabaseLongTermRetentionBackup** löscht die angegebene Sicherung.

## Beispiele

### Beispiel 1: Löschen einer einzelnen Sicherung
```powershell
...
### Beispiel 2: Löschen aller Sicherungen für einen Speicherort
```powershell
...
Dieser Befehl löscht alle langfristigen Aufbewahrungs Sicherungen für den northeurope-Speicherort.
