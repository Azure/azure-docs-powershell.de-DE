...
## Beschreibung
Mit diesem Befehl wird der Server aktualisiert, auf den Alias verweist. 

Dieser Befehl muss während des Anmelde Abonnements ausgestellt werden, wenn sich der neue Server, auf den der Alias verweist, befindet.
