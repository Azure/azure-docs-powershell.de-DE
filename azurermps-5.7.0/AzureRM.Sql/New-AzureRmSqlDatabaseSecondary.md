...
### -Tags
Gibt die Schlüssel-Wert-Paare in Form einer Hashtabelle an, die mit der SQL-Datenbank-Replikationsverknüpfung verknüpft werden soll. Zum Beispiel:
...
Dieses Cmdlet gibt **ReplicationLink** -Objekte zurück.
