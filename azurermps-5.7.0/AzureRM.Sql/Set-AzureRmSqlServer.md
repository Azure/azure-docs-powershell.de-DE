...
### -Tags
Gibt ein Wörterbuch mit Tags an, die dieses Cmdlet dem Server anordnet. Schlüssel-Wert-Paare in Form einer Hashtabelle, die als Tags auf dem Server definiert ist. Zum Beispiel:
