...
## Beschreibung
Das Cmdlet " **Get-AzureRmSqlServerRecommendedAction** " Ruft eine oder mehrere Empfohlene Aktionen für einen Azure SQL Server Advisor ab.

## Beispiele

### Beispiel 1: Abrufen einer Liste aller empfohlenen Aktionen für einen bestimmten Ratgeber
```
...
Dieser Befehl ruft eine Liste aller empfohlenen Aktionen für den SQL Server Advisor mit dem Namen CreateIndex ab, der für den Server mit dem Namen "Wi-Runner-Australia-East" verfügbar ist.

### Beispiel 2: Abrufen einer einzelnen empfohlenen Aktion für einen Berater
```
...
Dieser Befehl ruft eine empfohlene Aktion mit dem Namen IR_ \[ test_schema \] _ \[ test_table_0 .0361551 \] _6C7AE8CC9C87E7FD5893 des Ratgebers mit dem Namen CreateIndex ab.

## Parameter

### -Advisorname
Gibt den Namen des Beraters an, für den dieses Cmdlet Aktionen anfordert.
...
### -ResourceGroupName
Gibt den Namen der Ressourcengruppe des Servers an, der diesen Server enthält.
...
### -Servername
Gibt den Namen des Servers an, zu dem der Berater gehört.
