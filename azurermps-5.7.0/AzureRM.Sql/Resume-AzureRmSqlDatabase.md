...
## Beschreibung
Mit dem Cmdlet **Resume-AzureRmSqlDatabase** wird eine Azure SQL Data Warehouse-Datenbank fortgesetzt.

## Beispiele

### Beispiel 1: Fortsetzen einer Azure SQL Data Warehouse-Datenbank
```
PS C:\>Resume-AzureRmSqlDatabase -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -DatabaseName "Database01"
```

Mit diesem Befehl wird eine angehaltene Azure SQL Data Warehouse-Datenbank fortgesetzt.
...
### -DatabaseName
Gibt den Namen der Datenbank an, die von diesem Cmdlet fortgesetzt wird.
...
### -Servername
Gibt den Namen des Servers an, der die Datenbank hostet, die von diesem Cmdlet fortgesetzt wird.
...
## Notizen
* Das Cmdlet **Resume-AzureRmSqlDatabase** funktioniert nur in Azure SQL Data Warehouse-Datenbanken. Dieser Vorgang wird in Azure SQL-Datenbank Basic-, Standard-und Premium-Editionen nicht unterstützt.
