...
## Beschreibung
Das Cmdlet " **Set-AzureRmSqlServerBackupLongTermRetentionVault** " legt das auf diesem Server registrierte Langzeit-Aufbewahrungs Depot fest.
...
### -Servername
Gibt den Server an, für den dieses Cmdlet einen Tresor festlegt.
