...
## Beschreibung
Das Cmdlet " **Get-AzureRmSqlServerDisasterRecoveryConfiguration** " Ruft eine SQL Database Server-System Wiederherstellungskonfiguration ab.
...
### -VirtualEndpointName
Gibt den Namen des virtuellen Endpunkts an.
