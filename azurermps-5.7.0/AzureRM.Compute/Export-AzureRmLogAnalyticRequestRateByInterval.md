...
## Beschreibung
Damit werden aggregierte Zahlen von Microsoft. Compute-API-aufrufen getrennt nach Erfolg, Fehler oder Drosselung in Zeitintervallen exportiert.
Die Protokolle können weiter nach drei Parametern gruppiert werden: GroupByOperationName, GroupByThrottlePolicy oder GroupByResourceName.
