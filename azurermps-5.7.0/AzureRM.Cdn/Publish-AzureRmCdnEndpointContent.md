...
## Beschreibung
Das Cmdlet " **Publish-AzureRmCdnEndpointContent** " lädt Inhalte von einem Ursprungsserver für den Azure Content Delivery Network (CDN)-Endpunkt.
...
### -CdnEndpoint
Sepcifies Sie den CDN-Endpunkt.
