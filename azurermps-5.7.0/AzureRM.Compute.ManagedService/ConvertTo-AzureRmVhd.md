...
## Synopsis
Konvertieren von Hyper-V VM in Azure unterstützte virtuelle Festplatten-Dateien
...
Konvertieren Sie die Hyper-V-VM mit dem Namen "Test" in Azure unterstützte virtuelle Festplatten-Dateien in den aktuellen Ordner.
...
### -ExportPath
Der Exportordner Pfad, in dem die Datenträgerdateien enthalten sind.
...
### -Force
Erzwingen des Exports, auch wenn vorhandener Ordner gefunden wird.
...
### -Vserver
Der Hyper-V-Server-DNS-Name mit "localhost" als Standardwert.
