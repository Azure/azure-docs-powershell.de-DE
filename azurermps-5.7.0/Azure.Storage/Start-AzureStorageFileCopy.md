...
## Beschreibung
Das Cmdlet **Start-AzureStorageFileCopy** beginnt mit dem Kopieren einer Quelldatei in eine Zieldatei.
...
Verwenden Sie **New-AzureStorageContext** , um einen Kontext zu erhalten.
...
Mithilfe des Get-AzureStorageBlob-Cmdlets können Sie ein Cloud-BLOB erstellen oder ein BLOB abrufen.
...
Sie können ein Cloud-BLOB-Containerobjekt erstellen oder das Get-AzureStorageContainer-Cmdlet verwenden.
...
### -SrcFile
Gibt ein **clouddatei** -Objekt an.
Mithilfe von **Get-AzureStorageFile** können Sie eine Cloud-Datei erstellen oder abrufen.
...
Mithilfe des Get-AzureStorageShare-Cmdlets können Sie eine Cloud-Dateifreigabe erstellen oder eine freigeben.
...
Der Parameter "SrcBlob" akzeptiert den Wert vom Typ "CloudBlob" aus der Pipeline.

### Clouddatei

Der Parameter "srcfile" akzeptiert den Wert vom Typ "clouddatei" aus der Pipeline.
