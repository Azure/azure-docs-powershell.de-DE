...
## Synopsis
Abrufen einer Abonnementdefinition

[!INCLUDE [migrate-to-az-banner](../../includes/migrate-to-az-banner.md)]

## Syntax

### Abonnementdefinitionen abrufen.
```
Get-AzureRmSubscriptionDefinition
```
...
Ruft alle Abonnementdefinitionen ab.
...
Ruft eine Abonnementdefinition mit dem Namen MyProdSubscription2 ab.

## Parameter

### -Name
Der Name der Abonnementdefinition, die abgerufen werden soll.
