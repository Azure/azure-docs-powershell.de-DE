...
## Beschreibung
Das Cmdlet **Remove-AzureRmContainerGroup** entfernt eine Containergruppe.

## Beispiele

### Beispiel 1: entfernt eine Containergruppe
```
PS C:\> Remove-AzureRmContainerGroup -ResourceGroupName MyResourceGroup -Name MyContainer
```

Dieser Befehl entfernt die angegebene Containergruppe.
