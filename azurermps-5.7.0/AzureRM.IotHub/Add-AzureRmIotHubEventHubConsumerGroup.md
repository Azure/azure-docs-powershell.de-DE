...
## Beschreibung
Erstellt eine Consumer-Gruppe in der Eventhub, die dem angegebenen IotHub zugeordnet ist.

## Beispiele

### Beispiel 1: Hinzufügen einer Consumer-Gruppe zum Telemetrie-eventhub
```
...
Fügt der eventhub für Telemetrie-Ereignisse im iothub mit dem Namen "myiothub" eine neue verbrauchergroup mit dem Namen "myconsumergroup" hinzu.

### Beispiel 2: Hinzufügen einer Consumer-Gruppe zum Vorgangs Überwachungs eventhub
```
...
Fügt der eventhub für Operations-Überwachungsereignisse im iothub mit dem Namen "myiothub" eine neue verbrauchergroup mit dem Namen "myconsumergroup" hinzu.
...
Der Name der EventHub-verbrauchergroup, die Sie hinzufügen möchten.
...
Der Name des EventHub-Endpunkts.
