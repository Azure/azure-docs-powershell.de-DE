...
## Beschreibung
Das Cmdlet " **Get-AzureRmOperationalInsightsSavedSearchResults** " gibt die Ergebnisse aus der Abfrage zurück, die durch die Such-ID angegeben wird.

## Beispiele

### Beispiel 1: Abrufen aller Suchergebnisse für eine gespeicherte Suche
```
...
Dieser Befehl ruft alle Suchergebnisse für eine gespeicherte Suche ab.
