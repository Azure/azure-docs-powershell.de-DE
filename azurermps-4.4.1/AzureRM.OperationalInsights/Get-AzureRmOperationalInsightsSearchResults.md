...
## Beschreibung
Das Cmdlet " **Get-AzureRmOperationalInsightsSearchResults** " gibt die Suchergebnisse auf der Grundlage der angegebenen Parameter zurück.
...
Das **PSSearchGetSearchResultsResponse** -Objekt enthält eine Value-Eigenschaft, die die Datensätze enthält, die von der Suche im JSON-Format zurückgegeben wurden, und ein Metadatenobjekt, das Informationen zu den Ergebnissen der Suche enthält.
