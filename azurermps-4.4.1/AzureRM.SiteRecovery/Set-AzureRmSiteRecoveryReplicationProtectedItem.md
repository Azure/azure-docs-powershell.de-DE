...
## Beschreibung
Das Cmdlet " **Set-AzureRmSiteRecoveryReplicationProtectedItem** " legt die Wiederherstellungseigenschaften für ein geschütztes Replikations Element fest.
...
### -LicenseType
Gibt die Auswahl des Lizenztyps für virtuelle Windows Server-Computer an, die über die Hybrid Nutzung Benefit migriert werden.
...
### -Name
Gibt den Namen der virtuellen Wiederherstellungs Maschine an.
...
### -RecoveryNetworkId
Gibt die ID des virtuellen Azure-Netzwerks an, für das mit diesem Cmdlet das geschützte Element erneut hergestellt wird.
...
Gibt den Namen des Subnets im virtuellen Recovery Azure-Netzwerk an, für das dieses Cmdlet das geschützte Element wiederhergestellt hat.
...
Gibt das geschütztes Element der Azure Site Recovery-Replikation an.
