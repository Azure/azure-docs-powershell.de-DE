...
## Beschreibung
Mit dem Cmdlet **New-AzureRMSiteRecoveryNetworkMapping** wird eine Zuordnung zwischen zwei virtuellen Netzwerken erstellt, und es wird ein Azure Site Recovery-Auftrag zurückgegeben, um ihn zu überwachen.
...
### ASRNetwork
Der Parameter "PrimaryNetwork" akzeptiert den Wert vom Typ "ASRNetwork" aus der Pipeline.
