...
## Beschreibung
Das Cmdlet " **Get-AzureRmSiteRecoveryStorageClassification** " ruft Speicher Klassifizierungen in Azure Site Recovery ab.
...
### -FriendlyName
Gibt den Anzeigenamen der speicherklassifizierung an, die dieses Cmdlet erhält.
...
### -Name
Gibt den Namen der speicherklassifizierung an, die dieses Cmdlet erhält.
