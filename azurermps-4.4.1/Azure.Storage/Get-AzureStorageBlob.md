...
### Beispiel 2: Abrufen eines BLOBs mithilfe der Pipeline
```
PS C:\>Get-AzureStorageContainer -Name container* | Get-AzureStorageBlob
```

Dieser Befehl verwendet die Pipeline, um einen BLOB abzurufen.

### Beispiel 3: Abrufen eines BLOB Nachnamens Präfix
```
PS C:\>Get-AzureStorageBlob -Container "ContainerName" -Prefix "blob"
```

Dieser Befehl verwendet ein Namenspräfix, um einen BLOB abzurufen.
