...
## Synopsis
Ruft den Status des Verschiebens von elastischen Datenbanken ab.
...
## Beschreibung
Das Cmdlet " **Get-AzureRmSqlDatabaseActivity** " Ruft den Status von elastischen Datenbanken ab, die in einen elastischen datenbankpool in Azure SQL-Datenbank verschoben werden.
...
### -Servername
Gibt den Namen des Microsoft SQL Server an, der den elastischen datenbankpool hostet.
