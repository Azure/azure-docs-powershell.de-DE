...
## Beschreibung
Das Cmdlet " **Set-AzureRmSqlDatabase** " legt Eigenschaften für eine Azure SQL-Datenbank fest.
Darüber hinaus können Sie den *ElasticPoolName* -Parameter angeben, um eine Datenbank in einen elastischen Pool zu verschieben.
Wenn sich eine Datenbank bereits in einem elastischen Pool befindet, können Sie den *RequestedServiceObjectiveName* -Parameter verwenden, um eine Leistungsstufe zuzuweisen.
...
Sie können entweder diesen Parameter oder *MaxSizeGB* angeben.
Lesen Sie den *MaxSizeGB* -Parameter für akzeptable Werte pro Edition.
