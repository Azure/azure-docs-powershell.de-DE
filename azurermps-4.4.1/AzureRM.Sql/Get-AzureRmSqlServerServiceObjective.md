...
## Beschreibung
Das Cmdlet " **Get-AzureRmSqlServerServiceObjective** " Ruft die verfügbaren Dienst Ziele für einen Azure SQL-Datenbankserver ab.
...
Dieser Befehl ruft die Dienst Ziele für den Server mit dem Namen Server01 und die Datenbank mit dem Namen database01 ab.

## Parameter

### -DatabaseName
Gibt den Namen einer Azure SQL-Datenbank an.
