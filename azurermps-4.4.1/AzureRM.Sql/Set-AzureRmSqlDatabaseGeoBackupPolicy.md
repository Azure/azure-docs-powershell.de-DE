...
## Beschreibung
Das Cmdlet " **Set-AzureRmSqlDatabaseGeoBackupPolicy** " legt die für eine Datenbank registrierte Geo-Sicherungsrichtlinie fest.
...
### -DatabaseName
Gibt den Namen der Datenbank an, für die dieses Cmdlet die Geo-Sicherungsrichtlinie festlegt.
...
### -Bundesland
Gibt den Zustand der Geo-Backup-Richtlinie an.
