...
## Beschreibung
Das Get-AzureRmSqlServerTransparentDataEncryptionProtector-Cmdlet ruft Informationen zur DSA-Beschützer ab.

## Beispiele

### --------------------------Beispiel 1: erhalten Sie die transparente Datenverschlüsselung (DSA) Protector--------------------------
```
