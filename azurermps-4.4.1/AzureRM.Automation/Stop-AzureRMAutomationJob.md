...
## Beschreibung
Das Cmdlet **Stop-AzureRmAutomationJob** beendet einen Azure-Automatisierungs Auftrag.
...
Gibt den Namen eines Automatisierungs Kontos an, in dem dieses Cmdlet einen Auftrag stoppt.
...
### -ID
Gibt die ID eines Auftrags an, der vom Cmdlet beendet wird.
