...
## Beschreibung
Das Cmdlet " **Get-AzureRmLogicAppTrigger** " ruft Trigger aus einer Logik-App ab.
Dieses Cmdlet gibt ein **WorkflowTrigger** -Objekt zurück.
Geben Sie den Workflow, die Ressourcengruppe und den Trigger an.
...
### Beispiel 1: Abrufen eines Triggers einer Logik-App
```
...
Dieser Befehl ruft den Trigger mit dem Namen Trigger01 aus der Logik-App mit dem Namen LogicApp05 ab.

### Beispiel 2: Abrufen aller Trigger einer Logik-App
```
...
Dieser Befehl ruft die Trigger der Logik-App mit dem Namen LogicApp07 ab.

## Parameter

### -Name
Gibt den Namen der Logik-APP an, aus der dieses Cmdlet einen Trigger erhält.
...
### -ResourceGroupName
Gibt den Namen einer Ressourcengruppe an, in der dieses Cmdlet einen Trigger erhält.
...
### -Triggername
Gibt den Namen des Triggers an, den dieses Cmdlet erhält.
