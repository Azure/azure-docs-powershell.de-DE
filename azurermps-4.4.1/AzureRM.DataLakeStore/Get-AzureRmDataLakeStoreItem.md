...
## Beschreibung
Das Cmdlet " **Get-AzureRmDataLakeStoreItem** " Ruft die Details einer Datei oder eines Ordners im Data Lake Store ab.
...
### DataLakeStoreItem
Die Datei oder der Ordner im angegebenen Pfad.
