...
### -Clean
Gibt an, dass dieser Vorgang den gesamten Inhalt des Zielordners entfernt und den Ordner aufrecht erhält.
Verwenden Sie diesen Parameter mit dem Parameter *recurse* .
