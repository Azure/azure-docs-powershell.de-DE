...
## Beschreibung
Das Cmdlet " **Satz-AzureRmServiceBusQueueAuthorizationRule** " aktualisiert die Beschreibung für die angegebene Autorisierungsregel der angegebenen ServiceBus-Warteschlange.
...
Fügt " **Manage** " den Zugriffsrechten der Autorisierungsregel `SBAuthoRule1` der Warteschlange hinzu `SB-Queue_exampl1` .

## Parameter

### -Authorizationrulename
Der Name der Autorisierungsregel. Erforderlich **, wenn-AuthruleObj** nicht angegeben ist.
...
### -AuthRuleObj
Das Service Bus-Warteschlangen Autorisierungsregel Objekt.
...
### -Rechte
Die Rechte; Beispiel: @ ("Listen", "Senden", "verwalten"). Erforderlich, wenn "AuthruleObj" nicht angegeben ist.
