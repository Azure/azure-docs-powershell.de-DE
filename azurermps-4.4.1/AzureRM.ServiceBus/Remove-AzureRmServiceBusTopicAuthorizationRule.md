...
## Beschreibung
Das Cmdlet **Remove-AzureRmServiceBusTopicAuthorizationRule** entfernt die Autorisierungsregel eines Themas aus dem angegebenen ServiceBus-Namespace.
...
Entfernt die Autorisierungsregel `SBTopicAuthoRule1` des Themas `SB-Topic_exampl1` aus dem Namespace `SB-Example1` .
