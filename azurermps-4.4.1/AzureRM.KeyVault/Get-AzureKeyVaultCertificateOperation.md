...
## Beschreibung
Das Cmdlet " **Get-AzureKeyVaultCertificateOperation** " Ruft den Status eines Zertifikat Vorgangs ab.

## Beispiele

### Beispiel 1: Abrufen des Status eines Zertifikat Vorgangs
```
...
Dieser Befehl ruft den Status des Zertifikat Vorgangs für TestCert01 im ContosoKV01-schlüsseltresor ab.
