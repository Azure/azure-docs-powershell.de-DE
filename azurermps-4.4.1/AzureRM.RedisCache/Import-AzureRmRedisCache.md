...
### -Dateien
Gibt die SAS-URLs von BLOBs an, deren Inhalt dieses Cmdlet in den Cache importiert. Sie können die SAS-URLs mithilfe der folgenden PowerShell-Befehle generieren:

$storageAccountContext = New-AzureStorageContext-StorageAccountName "Speichername"-StorageAccountKey "Schlüssel"

$sasKeyForBlob = New-AzureStorageBlobSASToken-Container "Containername"-BLOB "blobname"-Berechtigung "rwdl"-Startzeit ([System. DateTime]:: Now). AddMinutes (-15)-ExpiryTime ([System. DateTime]:: Now). AddHours (5)-Kontext $storageAccountContext-FullUri
