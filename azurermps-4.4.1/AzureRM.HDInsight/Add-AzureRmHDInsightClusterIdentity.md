...
## Beschreibung
Das Cmdlet **Add-AzureRmHDInsightClusterIdentity** fügt dem Azure HDInsight-Konfigurationsobjekt, das vom New-AzureRmHDInsightClusterConfig-Cmdlet erstellt wird, eine Clusteridentität hinzu.
...
### GUID
Der Parameter "ObjectID" akzeptiert den Wert vom Typ "GUID" aus der Pipeline.
