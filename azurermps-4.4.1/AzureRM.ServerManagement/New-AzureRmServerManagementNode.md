...
## Beschreibung
Das Cmdlet **New-AzureRmServerManagementNode** erstellt einen Azure Server Management-Knoten.
...
### -Computername
Gibt den Computernamen des Computers an, der verwaltet wird.
...
Gibt ein **PSCredential** -Objekt für die Verbindung mit dem Server Verwaltungsknoten an.
...
### -Gateway
Gibt das Gateway an, das den Knoten verwaltet.

Dieser Parameter kann anstelle der *ResourceGroupName* -, *GatewayName* -und *Location* -Parameter verwendet werden.
...
### -Gatewayname
Gibt den Namen des Gateways an, das auf den Knoten zugreift.
...
### -Standort
Gibt den Speicherort an, an dem dieses Cmdlet den Knoten erstellt.
...
### -ResourceGroupName
Gibt den Namen der Ressourcengruppe an, in der dieses Cmdlet den Knoten erstellt.
