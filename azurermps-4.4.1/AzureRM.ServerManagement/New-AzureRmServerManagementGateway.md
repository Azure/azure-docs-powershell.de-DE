...
### -AutoUpgrade
Gibt an, dass das Gateway automatisch ein Upgrade durchführt, wenn eine neue Version freigegeben wird.
...
Sie können mithilfe von Tags ein Gateway aus anderen Azure-Ressourcen identifizieren.
