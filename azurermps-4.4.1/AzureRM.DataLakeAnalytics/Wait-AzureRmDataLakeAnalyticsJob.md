...
## Beschreibung
Das **Wait-AzureRmDataLakeAnalyticsJob-** Cmdlet wartet darauf, dass ein Azure Data Lake-Analyse Auftrag abgeschlossen wird.

## Beispiele

### Beispiel 1: warten Sie, bis ein Auftrag abgeschlossen ist.
```
PS C:\>Wait-AzureRmDataLakeAnalyticsJob -Account "ContosoAdlAccount" -JobId "a0a78d72-3fa8-4564-9b18-6becb3fda48a"
```

Der folgende Befehl wartet auf den Auftrag mit der angegebenen ID, um ihn abzuschließen.
...
### -TimeoutInSeconds
Gibt die Anzahl der Sekunden an, die gewartet werden muss, bevor der Wait-Vorgang beendet wird.
...
Geben Sie an, wie viele Sekunden zwischen jeder Prüfung des Auftragsstatus verstreichen soll.
...
### JobInformation
Die endgültigen Auftragsdetails für den abgeschlossenen Auftrag.
