...
## Beschreibung
Das Cmdlet **Remove-AzureRmDataLakeAnalyticsCatalogSecret** löscht einen Azure Data Lake-Analyse Katalog Secret.

## Beispiele

### Beispiel 1: Entfernen eines Geheimnisses
```
PS C:\>Remove-AzureRmDataLakeAnalyticsCatalogSecret -Account "ContosoAdla" -DatabaseName "DatabaseName" -Name "SecretName"
```

Mit diesem Befehl wird der angegebene Data Lake-Analyse Katalog Secret entfernt.
...
### -Name
Gibt den Namen des Geheimnisses an.
