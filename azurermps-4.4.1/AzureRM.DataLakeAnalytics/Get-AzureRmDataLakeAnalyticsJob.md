...
### Alle in Ressourcengruppe und-Konto (Standard)
```
...
### JobInformation
Die angegebenen Informationen zu Auftragsinformationen

### Liste<JobInformation>
Die Liste der Aufträge im angegebenen Data Lake Analytics-Konto.
