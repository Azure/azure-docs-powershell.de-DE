...
### Aktualisieren Sie bestimmte Eigenschaften von.
```
...
### --------------------------Beispiel 2: Update auf Grundlage einer Webdienst Instanz--------------------------
@ {Paragraph = PS C: \\ \> }
...
### Webservice
Der Parameter "ServiceUpdates" akzeptiert den Wert vom Typ "Webservice" aus der Pipeline.
