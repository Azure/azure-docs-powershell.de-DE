...
### Standardparameter für das Entfernen einer Aktivitätsprotokoll Benachrichtigung
```
Remove-AzureRmActivityLogAlert -ResourceGroupName <String> -Name <String>
 [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Parameter zum Entfernen einer Aktivitätsprotokoll Benachrichtigung, die den Wert aus der Pipe nimmt
```
Remove-AzureRmActivityLogAlert -InputObject <PSActivityLogAlertResource>
 [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Parameter zum Entfernen einer Aktivitätsprotokoll Benachrichtigung, wobei der Wert der "einquellen-Nr" aus der Pipe genommen wird
```
