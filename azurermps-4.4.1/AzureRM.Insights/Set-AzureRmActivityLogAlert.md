...
### Standardparameter für die Benachrichtigung "Aktivitätsprotokoll festlegen"
```
...
### Parameter zum Festlegen einer Aktivitätsprotokoll Benachrichtigung, wobei der Wert der "einquellen-Nr" aus der Pipe genommen wird
```
...
### Parameter zum Festlegen einer Aktivitätsprotokoll Benachrichtigung, die den Wert aus der Pipe nimmt
```
