...
### Standardparameter für das Deaktivieren einer Aktivitätsprotokoll Benachrichtigung
```
Disable-AzureRmActivityLogAlert -Name <String> -ResourceGroupName <String>
 [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Parameter zum Deaktivieren einer Aktivitätsprotokoll Benachrichtigung, die den Wert aus der Pipe nimmt
```
Disable-AzureRmActivityLogAlert -InputObject <PSActivityLogAlertResource>
 [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Parameter zum Deaktivieren einer Aktivitätsprotokoll Benachrichtigung, wobei der Wert der Resourcen-Funktion aus der Pipe genommen wird
```
