...
## Beschreibung
Das Cmdlet " **festlegen-AzureRmApiManagementLogger** " ändert die Einstellungen einer Azure API-Verwaltungs **Protokollierung**.

## Beispiele

### Beispiel 1: Ändern einer Protokollierung
```
