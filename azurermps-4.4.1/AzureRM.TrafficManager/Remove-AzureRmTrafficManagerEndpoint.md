...
## Beschreibung
Mit dem Cmdlet **Remove-AzureRmTrafficManagerEndpoint** wird ein Endpunkt aus Azure Traffic Manager entfernt.

Dieses Cmdlet übergibt jede Änderung an den Traffic Manager-Dienst.
Verwenden Sie das Remove-AzureRmTrafficManagerEndpointConfig-Cmdlet, um mehrere Endpunkte aus einem lokalen Traffic Manager-Profilobjekt zu entfernen und Änderungen in einem einzelnen Vorgang zu übernehmen.
