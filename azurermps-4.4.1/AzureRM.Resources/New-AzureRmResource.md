...
### Die Ressource, die sich auf der Abonnementebene befindet.
```
New-AzureRmResource [-Location <String>] [-Kind <String>] [-Properties <PSObject>] [-Plan <Hashtable>]
...
### Die Ressource, die sich auf der Mandantenebene befindet.
```
New-AzureRmResource [-Location <String>] [-Kind <String>] [-Properties <PSObject>] [-Plan <Hashtable>]
 [-Sku <Hashtable>] [-Tag <Hashtable>] [-IsFullObject] -ResourceName <String> -ResourceType <String>
...
Gibt den Namen einer Erweiterungs Ressource für die Ressource an. Wenn Sie beispielsweise eine Datenbank angeben möchten, verwenden Sie das folgende Format:
...
Wenn es sich bei der Erweiterungs Ressource beispielsweise um eine Datenbank handelt, geben Sie den folgenden Typ an:
...
### -ResourceName
Gibt den Namen der Ressource an. Wenn Sie beispielsweise eine Datenbank angeben möchten, verwenden Sie das folgende Format:
