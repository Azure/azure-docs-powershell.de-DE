...
## Beschreibung
Das Cmdlet " **Satz-AzureRmResource** " ändert eine vorhandene Azure-Ressource.
...
Der erste Befehl ruft die Ressource mit dem Namen ContosoSite mithilfe des Get-AzureRmResource-Cmdlets ab und speichert Sie dann in der $Resource-Variablen.
...
Wenn beispielsweise die Erweiterungs Ressource eine Datenbank ist, geben Sie Folgendes an:
