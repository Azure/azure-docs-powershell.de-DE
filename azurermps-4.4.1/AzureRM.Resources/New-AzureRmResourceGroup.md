...
### Beispiel 2: Erstellen einer Ressourcengruppe mit Tags
```
...
Wenn Sie ein Tag hinzufügen oder ändern möchten, müssen Sie die Sammlung von Tags für die Ressourcengruppe ersetzen.
