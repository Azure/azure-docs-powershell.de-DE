...
### Der Parametersatz für verwaltete Anwendungsnamen. Standard
```
...
### Der Parametersatz der verwalteten Anwendungs-ID.
```
...
## Beschreibung
Das Cmdlet " **Satz-AzureRmManagedApplication** " aktualisiert verwaltete Anwendungen
