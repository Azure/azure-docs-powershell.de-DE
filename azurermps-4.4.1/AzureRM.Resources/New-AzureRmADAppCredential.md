...
Eine neue kennwortberechtigung wird einer vorhandenen Anwendung hinzugefügt.
In diesem Beispiel wird der angegebene Kennwortwert der Anwendung unter Verwendung der Application-Objekt-ID hinzugefügt.
...
Eine neue Schlüssel Berechtigung wird einer vorhandenen Anwendung hinzugefügt.
In diesem Beispiel wird das bereitgestellte Base64-codierte öffentliche X509-Zertifikat ("MyApp. cer") der Anwendung mithilfe von ApplicationId hinzugefügt.
...
### -ApplicationId
Die ID der Anwendung, der die Anmeldeinformationen hinzugefügt werden sollen.
...
Der Standardwert für das Anfangsdatum ist heute.
Bei einer "asymmetrischen" Art von Anmeldeinformationen muss dies auf ein oder nach dem Datum festgesetzt werden, ab dem das X509-Zertifikat gültig ist.
