...
### Der Parametersatz Liste alle Richtlinien Definitionen. Standard
```
Get-AzureRmPolicyDefinition [-ApiVersion <String>] [-Pre] [-DefaultProfile <IAzureContextContainer>]
 [-InformationAction <ActionPreference>] [-InformationVariable <String>] [<CommonParameters>]
```

### Der Parametersatz für den Richtlinien Definitionsnamen.
```
...
## Beschreibung
Das Cmdlet " **Get-AzureRmPolicyDefinition** " ruft alle Richtlinien Definitionen oder eine bestimmte Richtliniendefinition ab, die durch den Namen oder die ID identifiziert werden.

## Beispiele

### Beispiel 1: Abrufen der gesamten Richtliniendefinition
```
...
### Beispiel 2: Abrufen der Richtliniendefinition nach Name
```
PS C:\>Get-AzureRmPolicyDefinition -Name "VMPolicyDefinition"
```

Dieser Befehl ruft die Richtliniendefinition mit dem Namen VMPolicyDefinition ab.
