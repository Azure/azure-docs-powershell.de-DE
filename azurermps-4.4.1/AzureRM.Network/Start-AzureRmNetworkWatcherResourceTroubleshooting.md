...
## Beschreibung
Das Start-AzureRmNetworkWatcherResourceTroubleshooting-Cmdlet startet die Problembehandlung für eine Netzwerkressource in Azure und gibt Informationen zu potenziellen Problemen und Abschwächungen zurück. Derzeit werden virtuelle Netzwerkgateways und-Verbindungen unterstützt.

## Beispiele

### ---Beispiel 1: Starten der Problembehandlung auf einem virtuellen Netzwerk Gateway---
```
...
### -TargetResourceId
Gibt die Ressourcen-ID der zu behandelnden Ressource an. Beispielformat: "/Subscriptions/$ {Subscription-Nr}/resourceGroups/$ {resourceGroupName}/Providers/Microsoft.Network/Connections/$ {ConnectionName}"
