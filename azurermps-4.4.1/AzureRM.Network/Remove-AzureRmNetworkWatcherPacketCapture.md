...
## Beschreibung
Die Remove-AzureRmNetworkWatcherPacketCapture entfernt eine Sammlungs Ressource. Es wird empfohlen, Stop-AzureRmNetworkWatcherPacketCapture aufzurufen, bevor Sie Remove-AzureRmNetworkWatcherPacketCapture aufrufen. Wenn die Paket Aufnahmesitzung ausgeführt wird, wenn Remove-AzureRmNetworkWatcherPacketCapture aufgerufen wird, wird die Paketerfassung möglicherweise nicht gespeichert. Wenn die Sitzung vor dem Entfernen angehalten wird, wird die Cap-Datei, die die Aufnahmedaten enthält, nicht entfernt. 

## Beispiele

### ---Beispiel 1: Entfernen einer Paket Aufnahmesitzung--
```
Remove-AzureRmNetworkWatcherPacketCapture -NetworkWatcher $networkWatcher -PacketCaptureName "PacketCaptureTest"
```

In diesem Beispiel wird eine vorhandene Paket erfassungssitzung mit dem Namen "PacketCaptureTest" entfernt.
...
## Notizen
Schlüsselwörter: Azure, azurerm, arm, Resource, Management, Manager, Netzwerk, Netzwerk, Netzwerkmonitor, Paket, erfassen, Datenverkehr, entfernen
