...
## Beschreibung
Verwenden **Sie Add-AzureRmServiceFabricApplicationCertificate** , um ein Zertifikat für alle Knoten im Cluster zu installieren. Sie können ein Zertifikat angeben, das Sie bereits besitzen, oder das System für Sie erstellen, und es in einen neuen oder vorhandenen Azure Key Vault hochladen.
...
Der Ordnerpfad des neuen Zertifikats, das erstellt werden soll.
...
### -SecretIdentifier
Der vorhandene Azure Key Vault-geheim-URI.
