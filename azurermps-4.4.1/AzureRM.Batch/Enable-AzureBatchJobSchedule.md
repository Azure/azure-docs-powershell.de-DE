...
## Beschreibung
Das Cmdlet **enable-AzureBatchJobSchedule** aktiviert einen Azure-Batch Auftragszeitplan.
Nachdem Sie einen Projektplan aktiviert haben, können Aufträge entsprechend diesem Zeitplan erstellt werden.

## Beispiele

### Beispiel 1: Aktivieren eines Auftragszeitplans
```
...
### -ID
Gibt die ID des Auftragszeitplans an, den dieses Cmdlet aktiviert.
