...
## Beschreibung
Das Cmdlet **Stop-AzureBatchJob** beendet eine Azure-Batch Verarbeitung.
Mit diesem Befehl wird der Auftrag als erledigt markiert.

## Beispiele

### Beispiel 1: Beenden einer Stapelverarbeitung
```
...
Der Befehl gibt einen Grund an, den Sie zum Beenden des Auftrags ausgewählt haben.
...
### -ID
Gibt die ID des Auftrags an, der vom Cmdlet beendet wird.
...
### -TerminateReason
Gibt den Grund an, zu dem Sie den Auftrag beendet haben.
Dieses Cmdlet speichert diesen Text als **TerminateReason** -Eigenschaft des Auftrags.
