...
## Beschreibung
Aktualisieren eines vorhandenen Compute-Kontingents
...
### -Inputobject
Möglicherweise geändertes Compute-Kontingent hat das Formular Get-AzsComputeQuota zurückgegeben.
...
### -Resourcen-Nr
Die ID des Arm-Compute-Kontingents.
