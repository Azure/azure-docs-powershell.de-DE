...
## Beschreibung
Mit dem Cmdlet **Reset-AzRedisCache** werden die Knoten einer Azure-a-Cache-Instanz neu gestartet.

## Beispiele

### Beispiel 1: beide Knoten neu starten
```
PS C:\>Reset-AzRedisCache -ResourceGroupName "ResourceGroup13" -Name "RedisCache06" -RebootType "AllNodes" -Force
```

Dieser Befehl startet beide Knoten für den Cache mit dem Namen "RedisCache06" neu.
...
### -Reboottype
Gibt an, welche Knoten oder Knoten neu gestartet werden sollen.
...
### -Scherbe
Gibt die ID des Shard an, den dieses Cmdlet für einen Premium-Cache neu startet, wobei die Clusterfunktion aktiviert ist.
