...
Das Cmdlet **Backup-AzRecoveryServicesBackupItem** übernimmt eine Adhoc-Sicherung des geschützten Azure-sicherungselements. Mithilfe dieses Cmdlets können Sie unmittelbar nach der Aktivierung des Schutzes eine erste Sicherung durchführen oder eine Sicherung starten, wenn eine geplante Sicherung fehlschlägt. Dieses Cmdlet kann auch für die benutzerdefinierte Aufbewahrung mit oder ohne Ablaufdatum verwendet werden, um weitere Details zu finden. 
...
Startet eine Sicherung für ein Sicherungselement. automatisch
...
Gibt eine Ablaufzeit für den Wiederherstellungspunkt als DateTime-Objekt an, wenn kein Wert angegeben wird, der den Standardwert 30 Tage hat. Anwendbar auf VM, SQL (nur Copy-Full-Backup-Typ), AFS-Backup-Elemente.
