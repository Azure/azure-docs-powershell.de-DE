...
## Synopsis
Entfernt Datenträger zum Replikations geschützten Element.
...
## Beschreibung
Das Cmdlet **Remove-AzRecoveryServicesAsrReplicationProtectedItemDisk** entfernt den Datenträger aus dem geschützten Element der ASR-Replikation.
...
Starten Sie den Vorgang, um den angegebenen Datenträger aus dem Schutz-VM für nicht verwalteten Datenträger zu entfernen.
...
Starten Sie den Vorgang, um den angegebenen Datenträger aus dem Schutz VM für verwalteten Datenträger zu entfernen.
...
Startet den Vorgang, um den angegebenen Datenträger zu entfernen, und gibt den ASR-Auftrag zurück, der zum Nachvollziehen des geschützten Datenträger Vorgangs verwendet wird.
...
### -Inputobject
Das Eingabeobjekt für das Cmdlet: das Objekt der ASR-Replikations geschützten Elemente, das dem zu entfernenden Datenträger entspricht.
