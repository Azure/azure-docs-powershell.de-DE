...
## Beschreibung
Mit dem Cmdlet **enable-AzRecoveryServicesBackupProtection** können Sie die Sicherung durch Zuordnen einer Schutzrichtlinie zum Element aktivieren.
...
Aktiviert die Sicherung für ein Element mit einer angegebenen Sicherungsschutz Richtlinie. automatisch
...
### -ExclusionDisksList
Liste der Datenträger-LUNs, die in einer Sicherung ausgeschlossen werden sollen, und die restlichen werden automatisch eingeschlossen.
...
### -InclusionDisksList
Liste der Datenträger-LUNs, die in die Sicherung eingeschlossen werden sollen, und die restlichen werden automatisch ausgeschlossen, außer der Betriebssystem Diskette.
