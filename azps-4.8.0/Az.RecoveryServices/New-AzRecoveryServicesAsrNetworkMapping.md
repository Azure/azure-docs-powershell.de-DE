...
## Beschreibung
Das Cmdlet **New-AzRecoveryServicesAsrNetworkMapping** startet den Vorgang des Erstellens einer ASR-Netzwerkzuordnung zwischen zwei Netzwerken und gibt das ASR-Auftragsobjekt für den ASR-Auftrag zurück, der zum Nachvollziehen des Vorgangs verwendet wird.
...
### -AzureToAzure
Flag zum Erstellen eines AzureToAzure-Szenarios
...
### -PrimaryFabric
Gibt den ASR-Stoff an, in dem die Zuordnung erstellt werden soll.
