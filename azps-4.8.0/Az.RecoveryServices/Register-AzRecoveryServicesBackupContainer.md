...
Das Cmdlet registriert eine Azure VM als Container für die Arbeitsauslastung MSSQL.
...
### -Force
Register Container erzwingen (Bestätigungsdialogfeld wird verhindert). Dieser Parameter ist optional.
...
### -Workloadtype
Arbeits Auslastungs der Ressource. Der aktuell unterstützte Wert ist AzureVM, Windows Server, AzureFiles, MSSQL
