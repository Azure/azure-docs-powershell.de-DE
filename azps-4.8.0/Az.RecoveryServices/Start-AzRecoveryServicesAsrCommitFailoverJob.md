...
## Beschreibung
Mit dem Cmdlet " **Start-AzRecoveryServicesAsrCommitFailoverJob** " wird der Commit-Failoverprozess für ein Azure Site Recovery-Objekt nach einem Failover-Vorgang gestartet.
...
Startet die Commit-Failover-Aktion für ein Website Wiederherstellungs Objekt. automatisch
...
### -RecoveryPlan
Gibt ein ASR-Wiederherstellungsplan Objekt entsprechend dem Wiederherstellungsplan für Failover an.
...
Gibt ein geschütztes ASR-Replikations Element Objekt an, das dem zu failoverden Replikations geschützten Element entspricht.
