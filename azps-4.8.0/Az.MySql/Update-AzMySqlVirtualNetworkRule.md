...
### Beispiel 1: Aktualisieren der virtuellen MySQL-Netzwerkregel nach Namen
```powershell
...
Dieses Cmdlet aktualisiert die virtuelle MySQL-Netzwerkregel nach Namen.

### Beispiel 2: Aktualisieren der virtuellen MySQL-Netzwerkregel nach Identität.
```powershell
...
Diese Cmdlets aktualisieren die virtuelle MySQL-Netzwerkregel nach Identität.
