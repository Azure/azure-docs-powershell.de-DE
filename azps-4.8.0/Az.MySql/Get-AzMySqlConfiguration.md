...
### Beispiel 1: Auflisten aller Konfigurationen im angegebenen MySQL-Server
```powershell
...
Dieses Cmdlet listet alle Konfigurationen im angegebenen MySQL-Server auf.

### Beispiel 2: Abrufen der angegebenen MySQL-Konfiguration nach Name
```powershell
...
Dieses Cmdlet erhält die angegebene MySQL-Konfiguration nach Namen.
