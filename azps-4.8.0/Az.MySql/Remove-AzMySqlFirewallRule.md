...
### Beispiel 1: Entfernen der MySQL-Firewall-Regel nach Namen
```powershell
PS C:\> Remove-AzMySqlFirewallRule -Name rule -ResourceGroupName PowershellMySqlTest -ServerName mysql-test

```

Dieses Cmdlet entfernt die MySQL-Firewall-Regel nach Namen.

### Beispiel 2: Entfernen der MySQL-Firewall-Regel nach Identität
```powershell
...
Diese Cmdlets entfernen die MySQL-Firewall-Regel nach Identität.
