...
### Beispiel 1: Abrufen des MySQL-Server Replikats nach Ressourcengruppe und Servername
```powershell
...
Dieses Cmdlet ruft das MySQL-Server Replikat nach Ressourcengruppe und Servername ab.
