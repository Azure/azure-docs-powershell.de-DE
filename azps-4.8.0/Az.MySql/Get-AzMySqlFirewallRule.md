...
### Beispiel 1: Listet alle Firewallregeln auf dem angegebenen MySQL-Server auf
```powershell
...
Dieses Cmdlet listet alle Firewallregel auf, die sich auf dem angegebenen MySQL-Server befinden.
