...
### Beispiel 1: Erstellen eines neuen MySQL-Server Replikats
```powershell
...
Dieses Cmdlet erstellt ein neues MySQL Server-Replikat.

### Beispiel 2: Erstellen eines neuen MySQL-Server Replikats
```powershell
...
Dieses Cmdlet mit dem Parameter Master (Inputobject) erstellt ein neues MySQL Server-Replikat.
