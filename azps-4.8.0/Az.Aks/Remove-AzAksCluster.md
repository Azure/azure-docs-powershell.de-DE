...
### Löschen eines vorhandenen verwalteten Kubernetes-Clusters
```powershell
...
### -Force
Entfernen eines verwalteten Kubernetes-Clusters ohne Eingabeaufforderung
...
### -PassThru
Gibt WAHR zurück, wenn der Löschvorgang erfolgreich war
