...
### -NodeOsType
OsType, der zum Angeben des Betriebssystemtyps verwendet werden soll. Wählen Sie unter Linux und Windows aus. Standardmäßig für Linux.
...
Das für Windows-VMS zu verwendende Administratorkennwort, dessen Länge mindestens 12 sein muss, mit mindestens einem Kleinbuchstaben, also `[a-z]` einem `[A-Z]` und einem Sonderzeichen `[!@#$%^&*()]` .
