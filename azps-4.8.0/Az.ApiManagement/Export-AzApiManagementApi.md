...
## Beschreibung
Das Cmdlet **Export-AzApiManagementApi** exportiert eine Azure API-Verwaltungs-API in eine Datei in einem der unterstützten Formate.
...
### Beispiel 2: Exportieren einer API im OpenApi 3,0-Spezifikations Format als JSON-Dokument
```powershell
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
psdx_paramvalues WADL, WSDL, Prahlerei, OpenApi und OpenApiJson
