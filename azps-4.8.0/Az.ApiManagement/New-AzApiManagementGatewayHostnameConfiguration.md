...
## Beschreibung
Das Cmdlet **New-AzApiManagementGatewayHostnameConfiguration** erstellt einen Hostname-configuratin für das vorhandene Gateway.

## Beispiele

### Beispiel 1: Erstellen einer Hostname-Konfiguration für das vorhandene Gateway
```powershell
...
Dieser Befehl erstellt eine "H01"-Hostname-Konfiguration für ein "G01"-Gateway.
...
Bezeichner des neuen Gateway-Hostname confiuration.
...
Flag, um NegotiateClientCertificate zu erzwingen.
Dieser Parameter ist optional.
