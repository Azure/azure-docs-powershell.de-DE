...
### Beispiel 1: Abrufen eines Anbieter Client Geheimnisses mithilfe einer ID
```
...
Dieser Befehl ruft einen Client Schlüssel des Anbieters ab, der die ID OICProvider01.
