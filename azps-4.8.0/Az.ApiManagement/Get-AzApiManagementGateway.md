...
## Beschreibung
Das Cmdlet " **Get-AzApiManagementGateway** " Ruft das gesamte oder bestimmte API-Verwaltungs Gateway ab.
...
Mit diesem Befehl wird das Gateway 0123456789 abgerufen.
...
### -Gatewayserver
Bezeichner eines Gateways.
Wenn angegeben, wird versucht, Gateway anhand des Bezeichners zu finden.
