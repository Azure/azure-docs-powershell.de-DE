...
## Beschreibung
Das Cmdlet **Restore-AzApiManagement** stellt einen API-Verwaltungsdienst aus der angegebenen Sicherung wieder her, die sich in einem Azurestorage-BLOB befindet.

## Beispiele

### Beispiel 1: Wiederherstellen eines API-Verwaltungsdiensts
```
...
Mit diesem Befehl wird ein API-Verwaltungsdienst aus dem Azure Storage-BLOB wiederhergestellt.
...
### -Name
Gibt den Namen der API-Verwaltungsinstanz an, die mit der Sicherung wiederhergestellt wird.
...
### -SourceBlobName
Gibt den Namen des Azure Storage-Backup-Quell-BLOB an.
...
### -SourceContainerName
Gibt den Namen des Azure Storage-Sicherungs Quellcontainers an.
...
### -Storagecontext
Gibt den Speicher Verbindungskontext an.
