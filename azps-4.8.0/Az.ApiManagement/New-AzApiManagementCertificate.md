...
## Beschreibung
Das Cmdlet **New-AzApiManagementCertificate** erstellt ein Azure API-Verwaltungszertifikat.
...
Erstellt ein API-Verwaltungszertifikat, das während der Authentifizierung mit Back-End verwendet werden soll. automatisch
