...
## Beschreibung
Das Cmdlet **Add-AzApiManagementApiToGateway** fügt eine Azure API-Verwaltungs-API zu einem Gateway hinzu.
...
Mit diesem Befehl wird die angegebene API dem angegebenen Gateway hinzugefügt.
...
### -ProvisioningState
Bereitstellungsstatus (erstellt).
Dieser Parameter ist optional.
...
### System. Nullable ' 1 [[Microsoft. Azure. Commands. ApiManagement. Servicemanagement. Models. PsApiManagementGatewayApiProvisioningState, Microsoft. Azure. PowerShell. Cmdlets. ApiManagement. Servicemanagement; Version = 2.0.1.0; Kultur = neutral; PublicKeyToken = null]]
