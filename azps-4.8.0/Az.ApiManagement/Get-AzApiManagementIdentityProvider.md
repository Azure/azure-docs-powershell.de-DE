...
## Beschreibung
Rufen Sie die Konfigurationsdetails des Identitätsanbieters ab.
ClientSecret wird nicht in Ergebnisdetails eingeschlossen. Verwenden **Sie Get-AzApiManagementIdentityProviderClientSecret** , um Client Secret zu erhalten.
...
### Beispiel 2: Abrufen des Aad-Identitätsanbieters
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
### Beispiel 3: Abrufen des Aad B2C-Identitätsanbieters
```powershell
