...
## Beschreibung
Das Get-AzSqlDatabaseSensitivityRecommendation-Cmdlet gibt die empfohlenen Informationstypen und Vertraulichkeits Bezeichnungen von Spalten in der Datenbank zurück.

## Beispiele

### Beispiel 1: Abrufen empfohlener Informationstypen und Vertraulichkeits Beschriftungen einer Azure SQL-Datenbank.
```powershell
...
### Beispiel 2: Abrufen empfohlener Informationstypen und Vertraulichkeits Beschriftungen einer Azure SQL-Datenbank mithilfe von Piping.
```powershell
