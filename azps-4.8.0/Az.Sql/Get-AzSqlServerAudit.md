...
## Beschreibung
Das Cmdlet " **Get-AzSqlServerAudit** " Ruft die Überwachungseinstellungen eines Azure SQL Server ab.
Geben Sie die Parameter *ResourceGroupName* und Server *Name* an, um den Server zu identifizieren.

## Beispiele

### Beispiel 1: Abrufen der Überwachungseinstellungen eines Azure SQL Server
```
...
### Beispiel 2: Abrufen, durch Pipeline, die Überwachungseinstellungen eines Azure SQL Server
```
...
### Beispiel 3: Abrufen der Überwachungseinstellungen eines Azure SQL Server
```
PS C:\>Get-AzSqlServerAudit -ResourceGroupName "resourcegroup01" -ServerName "server01"
ServerName                          : server01
ResourceGroupName                   : resourcegroup01
