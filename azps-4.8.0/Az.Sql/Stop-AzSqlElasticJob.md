...
## Beschreibung
Das Stop-AzSqlElasticJob-Cmdlet beendet einen Auftrag mit einer ausgeführten Ausführung.
Gibt den aktuellen Status der Auftragsausführung zurück.

## Beispiele

### Beispiel 1: beendet einen Auftrag mit einer ausgeführten Auftragsausführung
```powershell
...
### -ParentObject
Das Datenbankobjekt des Agent-Steuerelements
...
### -ParentResourceId
Die Auftrags Ausführungsressourcen-ID
