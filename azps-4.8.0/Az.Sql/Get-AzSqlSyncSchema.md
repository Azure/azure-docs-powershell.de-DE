...
### Beispiel 1: Abrufen des Synchronisierungsschemas für eine Hub-Datenbank
```powershell
...
### Beispiel 2: Abrufen des Synchronisierungsschemas für eine Hub-Datenbank und Erweitern von Tabellen
```powershell
...
### Beispiel 3: Abrufen des Synchronisierungsschemas für eine Mitgliedsdatenbank
```powershell
