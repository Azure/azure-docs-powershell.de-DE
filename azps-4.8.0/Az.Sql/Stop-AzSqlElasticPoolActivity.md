...
## Beschreibung
Mit dem Cmdlet " **Stop-AzSqlElasticPoolActivity** " wird der asynchrone Aktualisierungsvorgang in einem elastischen Pool abgebrochen.

## Beispiele

### Beispiel 1: Abbrechen des asynchronen Aktualisierungsvorgangs in einem elastischen Pool
```
...
Mit diesem Befehl wird der asynchrone Aktualisierungsvorgang für den elastischen Pool abgebrochen.
