...
## Beschreibung
Das Add-AzSqlElasticJobStep-Cmdlet fügt einen Auftragsschritt zu einem Auftrag hinzu

## Beispiele

### Beispiel 1: Hinzufügen eines Schritts zu einem Auftrag
```powershell
...
Das Wiederholungsintervall zurück aus Multiplikator
