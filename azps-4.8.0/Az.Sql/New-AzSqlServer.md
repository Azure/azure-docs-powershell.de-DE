...
Dieser Befehl erstellt einen Azure SQL-Datenbankserver der Version 12.
...
### -ResourceGroupName
Gibt den Namen der Ressourcengruppe an, der das Cmdlet den Server zuweist.
...
### -Server Version vom
Gibt die Version des neuen Servers an. Die zulässigen Werte für diesen Parameter lauten: 2,0 und 12,0.
Geben Sie 2,0 an, um einen Server der Version 11 zu erstellen, oder 12,0, um einen Server der Version 12 zu erstellen.
...
Gibt die SQL-Datenbankserver-Administratoranmeldeinformationen für den neuen Server an. Verwenden Sie das Get-Credential-Cmdlet, um ein **PSCredential** -Objekt zu erhalten. Wenn Sie weitere Informationen wünschen, geben Sie `Get-Help
Get-Credential` .
