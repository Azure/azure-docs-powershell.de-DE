...
## Beschreibung
Das Cmdlet **Disable-AzSqlServerAdvancedDataSecurity** deaktiviert die erweiterte Datensicherheit auf einem Server.

## Beispiele

### Beispiel 1
### Beispiel 2: Deaktivieren der erweiterten Server Datensicherheit
```powershell
...
### Beispiel 3: Deaktivieren der erweiterten Server-Datensicherheit von Serverressourcen
```powershell
