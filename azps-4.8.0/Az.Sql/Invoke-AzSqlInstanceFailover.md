...
## Beschreibung
Das Cmdlet **Invoke-AzSqlInstanceFailover** Failover eine Azure SQL-verwaltete Instanz.
...
Mit diesem Befehl wird das primäre Replikat der Instanz mit dem Namen "ManagedInstance01" Failover.
...
Mit diesem Befehl wird das lesbare sekundäre Replikat der verwalteten Instanz "ManagedInstance01" Failover.
...
### -Name
Der Name der zu entfernenden Azure SQL-Instanz.
