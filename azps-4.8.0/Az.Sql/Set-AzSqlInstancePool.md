...
## Beschreibung
Das Cmdlet " **Satz-AzSqlInstancePool** " ändert die Eigenschaften eines Azure SQL-Instanzen Pools.

## Beispiele

### Beispiel 1: Einrichten eines Instanzen Pool-Lizenztyps
```powershell
...
Mit diesem Befehl werden die Lizenztypen und/oder-Tags für einen Instanzen Pool mit dem Namen instancePool0 festgelegt.

### Beispiel 2: Einrichten eines Instanzen Pool-Lizenztyps mithilfe eines Instanzen Pool Objekts
```powershell
...
Mit diesem Befehl werden die Lizenztypen und/oder-Tags für einen Instanzen Pool mithilfe eines Instanzen Pool Objekts festgelegt.

### Beispiel 3: Einrichten eines Lizenztyps für einen Instanzen Pool mithilfe einer Ressourcen-ID für einen Instanzen Pool
```powershell
...
### -Inputobject
Das Eingabeobjekt des Instanzen Pools.
