...
## Beschreibung
Das **Start-AzSqlInstanceDatabaseLogReplay-** Cmdlet initiiert den Start des Protokollwiedergabe Diensts.
...
Dieser Befehl erstellt eine neue verwaltete Datenbank und beginnt mit dem Wiederherstellen von Sicherungen aus dem angegebenen Container, bis Complete-AzSqlInstanceDatabaseLogReplay mit der gewünschten letzten Sicherung aufgerufen wird.

## Parameter

### -AutoCompleteRestore
Der Indikator, ob die Wiederherstellung nach Abschluss automatisch abgeschlossen werden soll.
...
### -Sortierung
Die Sortierung der zu verwendenden Instanzen Datenbank.
...
### -Name
Der Name der Instanzen Datenbank.
...
### -PassThru
Definiert, ob die Synchronisierungsgruppe zurückgegeben wird.
...
Das SAS-Token des Speichercontainers.
