...
## Beschreibung
Das Cmdlet " **Get-AzSqlInstancePool** " gibt Informationen zu einem oder mehreren Azure SQL-Instanzen Pools zurück.
Geben Sie den Namen eines Instanzen Pools an, um Informationen nur für diesen Instanzen Pool anzuzeigen.

## Beispiele

### Beispiel 1: Abrufen aller Instanzen Pools in einem Kundenabonnement
```powershell
...
Dieser Befehl ruft Informationen zu allen Instanzen Pools innerhalb des Kunden Abonnements ab.

### Beispiel 2: Abrufen aller Instanzen Pools in einer Ressourcengruppe
```powershell
...
Dieser Befehl ruft Informationen zu allen Instanzen Pools innerhalb der Ressourcengruppe resourcegroup01.

### Beispiel 3: Abrufen von Informationen zu einem Instanzen Pool
```powershell
...
Dieser Befehl ruft Informationen über den Instanz Pool instancePool0.

### Beispiel 4: Abrufen von Informationen zu einem Instanzen Pool mithilfe der Ressourcen-ID des Instanzen Pools
```powershell
...
Dieser Befehl ruft Informationen zum Instanzen Pool mit dem zugehörigen Ressourcenbezeichner ab.
