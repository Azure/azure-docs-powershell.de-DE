...
### Beispiel 1: Erstellen einer Regel zum Zulassen des gesamten HTTPS-Datenverkehrs von 10.0.0.0
```powershell
...
### Beispiel 2: Erstellen einer Regel zum Zulassen von Windows für 10.0.0.0/24-Subnetz
```powershell
