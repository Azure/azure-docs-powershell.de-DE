...
## Synopsis
Beendet den Paket Erfassungsvorgang auf einem VPN-Gateway.
...
## Beschreibung
Beendet den Paket Erfassungsvorgang auf einem VPN-Gateway und lädt das Ergebnis auf der angegebenen SasUrl des Speichercontainers hoch.
...
### -Inputobject
Das VPN-Gatewayobjekt, in dem die Paketerfassung gestartet werden soll.
...
### -Resourcen-Nr
Die Azure-Ressourcen-ID des VpnGateway, in dem die Paketerfassung gestartet werden soll.
...
[Anfang-AzVpnGatewayPacketCapture](./Start-AzVpnGatewayPacketCapture.md)