...
## Beschreibung
Das Cmdlet " **Get-AzLoadBalancer** " Ruft einen oder mehrere Azure-Lastenausgleichs Elemente ab, die in einer Ressourcengruppe enthalten sind.
...
### Beispiel 2: Auflisten von Lastenausgleichsfunktionen mithilfe von Filtern
```
...
Dieser Befehl ruft alle Load-Salden mit einem Namen ab, der mit "MyLoadBalancer" beginnt.
