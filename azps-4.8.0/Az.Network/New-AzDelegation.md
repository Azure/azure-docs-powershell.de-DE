...
## Beschreibung
Das Cmdlet **New-AzDelegation** erstellt eine Dienst Delegierung, die einem Subnetz hinzugefügt werden kann.
...
Das erste Cmdlet erstellt eine Delegierung, die einem Subnetz hinzugefügt werden kann, und speichert Sie in der $Delegation-Variablen. Das zweite und dritte Cmdlets rufen das Subnetz ab, das delegiert werden soll. Das vierte Cmdlet fügt die erstellte Delegierung dem Subnetz von Interesse hinzu, und das endgültige Cmdlet sendet die aktualisierte Konfiguration an den Server.
