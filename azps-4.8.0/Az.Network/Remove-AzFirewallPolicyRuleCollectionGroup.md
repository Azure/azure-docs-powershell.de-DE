...
## Beschreibung
Das Cmdlet " **Remove-AzFirewallPolicyRuleCollectionGroup** " entfernt eine Regel Sammlungs Gruppe aus einer Azure-Firewall-Richtlinie.
...
In diesem Beispiel wird die Firewall-Richtlinienregel Colelction Gruppe mit dem Namen "testRcGroup" im Firewall-Richtlinienobjekt entfernt $FP
...
In diesem Beispiel wird die Firewall-Richtlinienregel Colelction Gruppe mit dem Namen "testRcGroup" in der Firewall namens "fpName" frpm der Namen der ResourceGroup "testRg" entfernt
...
### -Inputobject
Gruppenobjekt für Firewall-Richtlinienregel Sammlung
