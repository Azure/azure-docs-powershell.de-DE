...
## Beschreibung
Das Cmdlet " **Remove-AzFirewallPolicy** " entfernt eine Azure-Firewall-Richtlinie.
...
In diesem Beispiel wird die Firewallrichtlinie mit dem Namen "FirewallPolicy" in der ResourceGroup "TestRg" entfernt
...
In diesem Beispiel wird die Firewall-Richtlinie durch die ID entfernt.
...
In diesem Beispiel wird die Firewall-Richtlinie entfernt $FP
