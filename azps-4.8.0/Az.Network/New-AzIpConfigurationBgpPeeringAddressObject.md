...
```
## Beschreibung
Das **New-AzIpConfigurationBgpPeeringAddressObject** erstellt ein IpConfigurationBgpPeeringAddressObject-Objekt, das die BgpPeeringAddresses-Eigenschaft in Ihrem virtuellen Netzwerk-Gateway-bgpsettings darstellt.
...
Im obigen Beispiel wird ein IpConfigurationBgpPeeringAddressObject erstellt. dieses neue Objekt wird zu gw1ipconfBgp1.
...
### -CustomAddress
Die CustomAddress-Liste für virtuelles Netzwerk-Gateway für BgpPeeringAddresses.
