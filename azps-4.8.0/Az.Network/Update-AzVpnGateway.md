...
## Beschreibung
Das Cmdlet **Update-AzVpnGateway** aktualisiert ein skalierbares VPN-Gateway.  
Bei einem Azure VPN-Gateway handelt es sich um eine Software definierte Konnektivität für Standort-zu-Standort-Verbindungen innerhalb des VirtualHub. Dieses Gateway ändert die Größe und skaliert basierend auf der vom Benutzer angegebenen Skalierungseinheit. Eine Verbindung kann über eine Verzweigung/Website, die als VPN-Website bezeichnet wird, zum skalierbaren Gateway eingerichtet werden. Jede Verbindung besteht aus zwei Active-Active Tunneln
...
Das obige wird eine Ressourcengruppe, virtuelles WAN, virtuelles Netzwerk, virtuelles Drehkreuz in West US in der Ressourcengruppe "testRG" in Azure erstellen. Anschließend wird ein VPN-Gateway im virtuellen Hub mit 2 Skalierungseinheiten erstellt.

Nachdem das Gateway erstellt wurde, wird Update-AzVpnGateway verwendet, um das Gateway auf 3 Skaleneinheiten zu aktualisieren.
...
Nachdem das Gateway erstellt wurde, verwendet es Set-AzVpnGateway, um BgpPeeringAddress zu aktualisieren.
...
### -BgpPeeringAddress
Die BGP-Peering Adressen für dieses VpnGateway bgpsettings.
...
### -VpnConnection
Die Liste der VpnConnections, die dieser VpnGateway haben muss.
...
### -VpnGatewayScaleUnit
Die Skalierungseinheit für diesen VpnGateway.
