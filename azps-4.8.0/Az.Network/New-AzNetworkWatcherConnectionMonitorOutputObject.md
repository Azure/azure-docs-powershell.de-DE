...
## Beschreibung
Das New-AzNetworkWatcherConnectionMonitorOutputObject-Cmdlet erstellt das Ausgabeziel Objekt des Verbindungs Monitors.
...
Geben Sie Folgendes ein: "Arbeitsbereich" WorkspaceSettings: {"WorkspaceResourceId": "MyWSResourceId"}
...
### -OutputType
Zieltyp für die Ausgabe des Verbindungs Monitors Derzeit wird nur \" Arbeitsbereich \" unterstützt.
...
### -WorkspaceResourceId
Ressourcen-ID des Protokollanalyse Arbeitsbereichs
