...
## Beschreibung
Das Cmdlet " **New-AzSecurityPartnerProvider** " erstellt ein Azure-SecurityPartnerProvider
...
### -VirtualHub
Die virtuelle Hub-ID, an die der Security-Partner-Anbieter angefügt ist
