...
## Beschreibung
Das Cmdlet " **New-AzIpAllocation** " erstellt ein Azure-IpAllocation
...
### -Force
Keine Bestätigung anfordern, wenn Sie eine Ressource außer Kraft setzen möchten
...
### -IpAllocationTag
Die Zuordnungs Tags der IP-Zuweisung
...
### -IpamAllocationId
Die IPAM-Zuordnungs-ID der IP-Zuweisung
...
### -Präfixlänge
Die Präfixlänge der IP-Zuweisung
...
### -Prefixtype
Der Präfixtyp der IP-Zuweisung
