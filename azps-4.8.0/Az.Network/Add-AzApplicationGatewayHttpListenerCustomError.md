...
## Beschreibung
Mit dem Cmdlet **Add-AzApplicationGatewayCustomError** wird ein benutzerdefinierter Fehler zu einem HTTP-Listener eines Anwendungs Gateways hinzugefügt.

## Beispiele

### Beispiel 1: Hinzufügen eines benutzerdefinierten Fehlers zur HTTP-Listener-Ebene
```powershell
...
Dieser Befehl fügt dem HTTP-Listener $Listener 01 einen benutzerdefinierten Fehler des HTTP-Statuscodes 502 hinzu und gibt den aktualisierten Listener zurück.
