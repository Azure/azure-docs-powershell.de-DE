...
New-AzExpressRouteGateway erstellt ein skalierbares Express Route-Gateway. Hierbei handelt es sich um Software definierte Konnektivität für On Premise to Azure innerhalb des VirtualHub. 

Dieses Gateway kann basierend auf der in diesem oder dem Set-AzExpressRouteGateway-Cmdlet angegebenen Skalierungseinheit skaliert werden. 

Eine Verbindung wird von einem lokalen Express Route-Schaltkreis mit dem skalierbaren Gateway eingerichtet.

Die ExpressRouteGateway befindet sich am gleichen Speicherort wie die referenzierte VirtualHub.
