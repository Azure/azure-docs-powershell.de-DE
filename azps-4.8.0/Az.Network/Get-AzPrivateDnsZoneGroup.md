...
## Beschreibung
Das Cmdlet " **Get-AzPrivateDnsZoneGroup** " ruft mindestens eine private DNS-Zonengruppe ab.

## Beispiele

### Beispiel 1: Abrufen der privaten DNS-Zonengruppe
```powershell
...
Im obigen Beispiel wird eine private DNS-Zonengruppe mit dem Namen dnsgroup1 in der Ressourcengruppe RG abgerufen.
