...
## Synopsis
Beendet den Paket Erfassungsvorgang für eine VPN-Verbindung
...
## Beschreibung
Beendet den Paket Erfassungsvorgang für eine VPN-Verbindung und lädt das Ergebnis auf der angegebenen SasUrl des Speichercontainers hoch.
...
### -Inputobject
Das VPN-Verbindungsobjekt, in dem die Paketerfassung gestartet werden soll.
...
### -LinkConnectionName
Die Namen der SiteLinkConnection.
...
### -Name
Der VPN-Verbindungsname, in dem die Paketerfassung gestartet werden soll.
...
### -Resourcen-Nr
Die Azure-Ressourcen-ID des VpnConnection, in dem die Paketerfassung gestartet werden soll.
...
### -SasUrl
SAS-URL für Stopp-Paketerfassung auf VPN.
...
[Anfang-AzVpnConnectionPacketCapture](./Start-AzVpnConnectionPacketCapture.md)