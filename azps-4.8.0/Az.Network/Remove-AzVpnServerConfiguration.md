...
Der obige Befehl entfernt eine vorhandene VpnServerConfiguration.
...
### -Inputobject
Das vpnServerConfiguration-Objekt, das gelöscht werden soll.
...
### -Name
Der vpnServerConfiguration-Name.
...
### -Resourcen-Nr
Die Azure-Ressourcen-ID für die vpnServerConfiguration, die gelöscht werden soll.
