...
## Synopsis
Generiert eine Zugriffstaste für den angegebenen Konfigurationsspeicher erneut.
...
### Beispiel 1: Erneutes Generieren des Schlüssels eines App-Konfigurationsspeichers
```powershell
...
Mit diesem Befehl wird der Schlüssel eines App-Konfigurationsspeichers neu generiert.

### Beispiel 2: Erneutes Generieren des Schlüssels eines App-Konfigurationsspeichers nach Objekt
```powershell
...
### -ID
Die ID des Schlüssels, der neu generiert werden soll.
