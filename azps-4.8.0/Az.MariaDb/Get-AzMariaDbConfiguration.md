...
### Beispiel 1: Auflisten der gesamten Konfiguration unter einem MariaDB
```powershell
...
Dieser Befehl listet alle Konfigurationen unter einem MariaDB auf.

### Beispiel 2: Abrufen einer Konfiguration von MariaDB
```powershell
...
Dieser Befehl ruft eine Konfiguration von MariaDB ab.
