...
## Beschreibung
Das Cmdlet " **Get-AzSynapseSparkSession** " Ruft Informationen zu einer Azure Synapse Analytics-Funk Sitzung ab.
...
Dieser Befehl ruft alle Spark-Sitzungen unter dem angegebenen Spark-Pool ab.
...
Dieser Befehl ruft die Spark-Sitzung mit der angegebenen Livius-ID ab.
...
Dieser Befehl ruft alle Spark-Sitzungen unter dem angegebenen Spark-Pool durch Pipeline ab.

## Parameter

### -ApplicationId
Die Anwendungs-ID der Sitzung.
