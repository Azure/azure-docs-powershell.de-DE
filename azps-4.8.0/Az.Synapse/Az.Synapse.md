...
# AZ. Synapse-Modul
## Beschreibung
In den Themen in diesem Abschnitt werden die Azure PowerShell-Cmdlets für Azure Synapse-Analysen dokumentiert.

## AZ. Synapse-Cmdlets
### [Add-AzSynapseTriggerSubscription](Add-AzSynapseTriggerSubscription.md)
Abonnieren Sie den Ereignisauslöser für externe Dienstereignisse.
...
Ruft eine Synapse Analytics-Firewall-Regel ab.
...
Ruft eine Synapse-Analyse Rollendefinition ab.

### [Get-AzSynapseSparkJob](Get-AzSynapseSparkJob.md)
Ruft eine Synapse Analytics Spark Job.

### [Get-AzSynapseSparkPool](Get-AzSynapseSparkPool.md)
Ruft ein Synapse Analytics-Spark-Pool ab.
...
Dieses Feature befindet sich in einer limitierten Vorschau, die anfänglich nur für bestimmte Abonnements zugänglich ist. Ruft eine Synapse Analytics SQL-Datenbank ab.

### [Get-AzSynapseSqlPool](Get-AzSynapseSqlPool.md)
Ruft einen Synapse Analytics SQL-Pool ab.
...
Abrufen des Status des Abonnements für den Ereignisauslöser für die angegebenen externen Dienstereignisse.

### [Get-AzSynapseWorkspace](Get-AzSynapseWorkspace.md)
Ruft einen Synapse-Analyse Arbeitsbereich ab.
...
### [Neu – AzSynapseFirewallRule](New-AzSynapseFirewallRule.md)
Erstellt eine Synapse Analytics-Firewall-Regel.

### [Neu – AzSynapseIntegrationRuntimeKey](New-AzSynapseIntegrationRuntimeKey.md)
Generieren Sie den selbst gehosteten Integrationslauf Zeitschlüssel erneut.

### [Neu – AzSynapseRoleAssignment](New-AzSynapseRoleAssignment.md)
Erstellt eine Synapse Analytics-Rollenzuweisung.

### [Neu – AzSynapseSparkPool](New-AzSynapseSparkPool.md)
Erstellt einen Spark-Pool für Synapse-Analysen.

### [Neu – AzSynapseSqlDatabase](New-AzSynapseSqlDatabase.md)
Dieses Feature befindet sich in einer limitierten Vorschau, die anfänglich nur für bestimmte Abonnements zugänglich ist. Erstellt eine Synapse Analytics SQL-Datenbank.

### [Neu – AzSynapseSqlPool](New-AzSynapseSqlPool.md)
Erstellt einen Synapse Analytics SQL-Pool.

### [Neu – AzSynapseWorkspace](New-AzSynapseWorkspace.md)
Erstellt einen Synapse-Analyse Arbeitsbereich.
...
Löscht eine Synapse Analytics-Firewall-Regel.
...
Dieses Feature befindet sich in einer limitierten Vorschau, die anfänglich nur für bestimmte Abonnements zugänglich ist. Löscht eine Synapse Analytics SQL-Datenbank.
...
Kündigen Sie den Ereignisauslöser für externe Dienstereignisse.

### [Remove-AzSynapseWorkspace](Remove-AzSynapseWorkspace.md)
Löscht einen Synapse-Analyse Arbeitsbereich.
...
### [Satz-AzSynapseIntegrationRuntime](Set-AzSynapseIntegrationRuntime.md)
Aktualisiert eine Integrationslaufzeit.

### [Satz-AzSynapseDataFlow](Set-AzSynapseDataFlow.md)
Erstellt oder aktualisiert einen Datenfluss im Arbeitsbereich.

### [Satz-AzSynapseDataset](Set-AzSynapseDataset.md)
Erstellt oder aktualisiert ein DataSet im Arbeitsbereich.

### [Satz-AzSynapseLinkedService](Set-AzSynapseLinkedService.md)
Verknüpft einen Datenspeicher oder einen clouddienst mit einem Arbeitsbereich.

### [Satz-AzSynapseNotebook](Set-AzSynapseNotebook.md)
Erstellt oder aktualisiert ein Notizbuch in einem Arbeitsbereich.

### [Satz-AzSynapsePipeline](Set-AzSynapsePipeline.md)
Erstellt eine Pipeline im Arbeitsbereich.

### [Satz-AzSynapseTrigger](Set-AzSynapseTrigger.md)
Erstellt einen Trigger in einem Arbeitsbereich.

### [Anfang-AzSynapseSparkSession](Start-AzSynapseSparkSession.md)
Startet eine Synapse Analytics Spark-Sitzung.

### [Anfang-AzSynapseTrigger](Start-AzSynapseTrigger.md)
...
Bricht eine Synapse Analytics Spark Job ab.

### [Stopp-AzSynapseSparkSession](Stop-AzSynapseSparkSession.md)
Stoppt eine Synapse Analytics Spark-Sitzung.
...
### [Synchronisieren-AzSynapseIntegrationRuntimeCredential](Sync-AzSynapseIntegrationRuntimeCredential.md)
...
Überprüft, ob ein Synapse Analytics-Spark-Pool vorhanden ist.

### [Test-AzSynapseSqlDatabase](Test-AzSynapseSqlDatabase.md)
Dieses Feature befindet sich in einer limitierten Vorschau, die anfänglich nur für bestimmte Abonnements zugänglich ist. Überprüft, ob eine Synapse Analytics SQL-Datenbank vorhanden ist.

### [Test-AzSynapseSqlPool](Test-AzSynapseSqlPool.md)
Überprüft, ob ein Synapse Analytics SQL-Pool vorhanden ist.
...
Aktualisiert eine Synapse Analytics-Firewall-Regel.
...
Dieses Feature befindet sich in einer limitierten Vorschau, die anfänglich nur für bestimmte Abonnements zugänglich ist. Aktualisiert eine Synapse Analytics SQL-Datenbank.
...
Aktualisiert einen Synapse-Analyse Arbeitsbereich.

### [Wait-AzSynapseSparkJob](Wait-AzSynapseSparkJob.md)
Wartet darauf, dass ein Synapse Analytics Spark-Auftrag abgeschlossen wird.
