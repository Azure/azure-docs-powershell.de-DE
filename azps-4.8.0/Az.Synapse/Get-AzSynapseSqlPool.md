...
## Beschreibung
Das Cmdlet " **Get-AzSynapseSqlPool** " Ruft Informationen zu einem Azure Synapse Analytics SQL-Pool ab.
...
Dieser Befehl ruft alle SQL-Pools unter einem Arbeitsbereich ab.
...
Dieser Befehl ruft den SQL-Pool unter Workspace ContosoWorkspace mit dem Namen ContosoSqlPool.
...
Dieser Befehl ruft alle SQL-Pools unter einem Arbeitsbereich durch Pipeline ab.
...
Mit diesem Befehl wird der SQL-Pool mit der angegebenen Ressourcen-ID abgerufen.
...
### -Version
[Diese Funktion befindet sich in einer limitierten Vorschau, die anfänglich nur für bestimmte Abonnements zugänglich ist.] Version des Synapse SQL-Pools. Beispiel: 2 oder 3.
