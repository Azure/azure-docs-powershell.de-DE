...
## Beschreibung
Erstellt ein PSHeaderAction-Objekt für die Erstellung des PSRulesEngineAction-Objekts.
...
### -HeaderActionType
Welche Art von Manipulation auf die Kopfzeile angewendet werden soll
...
### -Headername
Der Name des Headers, auf den diese Aktion angewendet werden soll.
...
### -Wert
Der Wert, mit dem der angegebene Headername aktualisiert werden soll.
Dieser Wert wird nicht verwendet, wenn es sich bei dem ActionType um DELETE handelt.
...
### Microsoft. Azure. Commands. Haustür. Models. PSHeaderAction
