...
## Beschreibung
Das Cmdlet **New-AzFrontDoorBackendpoolsSettingObject** erstellt ein neues PSBackendPoolsSettings-Objekt für die Erstellung von Haustür.

## Beispiele

### Beispiel 1: Erstellen eines BackendPoolsSettings-Objekts mit Standardeinstellungen
```powershell
...
Ob die Zertifikatnamen Überprüfung für HTTPS-Anforderungen an alle Back-End-Pools erzwungen werden soll.
Keine Auswirkungen auf nicht-HTTPS-Anforderungen.
...
Sende-und Empfangs Timeout bei der Weiterleitung der Anforderung an das Back-End. Wenn Timeout erreicht ist, schlägt die Anforderung fehl, und es wird zurückgegeben.
...
### Microsoft. Azure. Commands. Haustür. Models. PSBackendPoolsSetting
