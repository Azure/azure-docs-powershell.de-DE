...
### Beispiel 1: Erstellen einer PSRoutingRuleObject für die Erstellung von Haustüren mit einer Weiterleitungsregel
```powershell
...
### Beispiel 2: Erstellen einer PSRoutingRuleObject für die Erstellung von Haustüren mit einer Umleitungsregel
```powershell
...
### -RulesEngineName
Ein Verweis auf eine bestimmte Regelmodul Konfiguration, die auf diese Route angewendet werden soll.
