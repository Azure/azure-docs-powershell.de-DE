...
### Beispiel 1: Erstellen eines Windows Premium-App-Plans in West Europa mit Kapazitäts Ausbrüchen bis zu 10 Instanzen.
```powershell
...
Mit diesem Befehl wird ein Windows Premium-App-Plan in West Europa erstellt, in dem bis zu 10 Instanzen platzen können.
