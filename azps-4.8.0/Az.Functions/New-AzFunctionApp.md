...
### Beispiel 1: Erstellen einer Energieverbrauchs-PowerShell-Funktions-APP in Central US.
```powershell
...
Mit diesem Befehl wird eine APP für die Verbrauchs-PowerShell-Funktion in Central US erstellt.

### Beispiel 2: Erstellen einer PowerShell-Funktions-APP, die in einem Service Plan gehostet wird.
```powershell
PS C:\> New-AzFunctionApp -Name MyUniqueFunctionAppName `
                          -ResourceGroupName MyResourceGroupName `
                          -PlanName MyPlanName `
...
Mit diesem Befehl wird eine PowerShell-Funktions-APP erstellt, die in einem Service Plan gehostet wird.

### Beispiel 3: Erstellen einer Funktions-APP unter Verwendung eines privaten ACR-Bilds
```powershell
PS C:\> New-AzFunctionApp -Name MyUniqueFunctionAppName `
                          -ResourceGroupName MyResourceGroupName `
                          -PlanName MyPlanName `
...
Deaktivieren Sie das Erstellen von Anwendungs Einblicken während der Erstellung der Funktion app.
Es stehen keine Protokolle zur Verfügung.
...
### -DockerImageName
Nur für Linux.
Name des Container Bilds aus der Docker-Registrierung, z.b. Publisher/Image-Name: Tag.
...
Der Container Registrierungs Benutzername und das Kennwort.
Für private Registrierungen erforderlich.
...
### -Standort
Der Speicherort für den Verbrauchs Plan.
