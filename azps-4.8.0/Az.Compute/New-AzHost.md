...
## Beschreibung
Mit diesem Cmdlet wird ein Host erstellt.
...
Dieser Befehl erstellt einen Host der angegebenen SKU in der angegebenen Hostgruppe und der angegebenen Position.
...
Gibt an, ob der Host bei einem Fehler automatisch ersetzt werden soll. Der Wert wird standardmäßig auf "true" festgelegt, wenn er nicht bereitgestellt wird.
...
### -LicenseType
Gibt den Software-Lizenztyp an, der auf die VMs angewendet wird, die auf dem Host bereitgestellt werden. Mögliche Werte sind: None, Windows_Server_Hybrid und Windows_Server_Perpetual.  Der Standardwert ist None.
...
### -PlatformFaultDomain
Gibt die Anzahl der Plattform-fehlerdomäne des Hosts an.  Dann ist der Mindestwert 0 und der Höchstwert 2.
