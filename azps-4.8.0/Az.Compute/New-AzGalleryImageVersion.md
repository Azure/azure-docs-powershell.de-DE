...
Erstellen Sie eine Katalogbild Version mit Datenträger Bildverschlüsselung.
...
### -Datadiskimage
Datenträger Bilder.   z.b. @ {Source = @ {ID =<source_id>}; LUN = 1; SizeInGB = 100; HostCaching = "ReadOnly"}
...
### -OSDiskImage
OS-Datenträgerabbildung, beispielsweise @ {Source = @ {ID =<source_id>}; SizeInGB = 100; HostCaching = "ReadOnly"}
...
### -StorageAccountType
Gibt den Speicher Kontotyp an, der zum Speichern des Bilds verwendet werden soll. Diese Eigenschaft kann nicht aktualisiert werden. Verfügbare Werte sind Standard_LRS, Standard_ZRS und Premium_LRS.
