...
### Beispiel 2: Abrufen des VMImage-Objekts
```
...
### Beispiel 3: Abrufen von VMImage-Objekten
```
...
Dieser Befehl ruft alle Versionen von VMImage ab, die den angegebenen Werten entsprechen, und filtert über Version.
...
### -OrderBy
Gibt die Reihenfolge der zurückgegebenen Ergebnisse an. Als OData-Abfrage formatiert.
...
### -Top
Gibt die maximale Anzahl der zurückgegebenen virtuellen Computer Bilder an. 
