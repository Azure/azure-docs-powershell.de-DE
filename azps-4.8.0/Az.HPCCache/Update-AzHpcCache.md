...
## Beschreibung
Mit dem Cmdlet **Update-AzHpcCache** wird ein Azure HPC-Cache aktualisiert.
...
### -Force
Gibt an, dass das Cmdlet Sie nicht zur Bestätigung auffordert. Standardmäßig werden Sie von diesem Cmdlet aufgefordert, zu bestätigen, dass Sie den Cache aktualisieren möchten.
