...
Erstellen Sie eine neue Blueprint-Zuweisung der Blueprint-Definition `$blueprintObject` innerhalb des angegebenen Abonnements unter Verwendung des definierten Parameters und des Ressourcengruppen Wörterbuchs. Verwendet die vom System zugewiesene Identität. Der Speicherort definiert den Bereich zum Erstellen der verwalteten Identität.
...
Erstellen Sie eine neue Blueprint-Zuweisung der Blueprint-Definition `$blueprintObject` innerhalb des angegebenen Abonnements unter Verwendung des definierten Parameters und des Ressourcengruppen Wörterbuchs unter Verwendung der angegebenen vom Benutzer zugewiesenen Identitäts-ID.
...
Erstellen Sie eine neue Blueprint-Zuordnung der Blueprint-Definition `$blueprintObject` , die auf das angegebene Abonnement in der angegebenen Verwaltungsgruppe mit dem definierten Parameter ausgerichtet ist.

## Parameter

### -Zuordnungsdatei
Der Speicherort der Zuordnungsdatei im JSON-Format auf dem Datenträger.
...
### -Standort
Der Bereich, in dem die verwaltete Identität erstellt werden soll.
Weitere Informationen finden Sie unter aka.ms/blueprintmsi
...
Weitere Informationen finden Sie unter aka.ms/blueprintlocks
...
### -ManagementGroupId
Die ID der Verwaltungsgruppe, in der die Blueprint-Zuweisung (en) gespeichert werden soll.
...
Hashtable mit Parametern, die an das Artefakt der Ressourcengruppe übergeben werden sollen.
...
### -SecureString
Sicherer Zeichenfolgenparameter für keyvault-Ressourcen-ID, Name und Version.
...
### -Abonnement-Nr
Abonnement-ID, um die Blueprint-Definition zuzuweisen.
Dies kann eine durch trennzeichengetrennte Liste von Abonnement-Zeichenfolgen sein.
...
System zugewiesene Identität (MSI), um die Artefakte bereitzustellen.
...
Benutzer zugewiesene Identität (MSI), um die Artefakte bereitzustellen.
