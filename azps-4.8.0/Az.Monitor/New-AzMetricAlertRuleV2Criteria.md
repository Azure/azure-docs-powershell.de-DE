...
### Beispiel 4: Erstellen eines Webtest-Verfügbarkeits Kriteriums
...
Dieser Befehl erstellt ein Webtest-Verfügbarkeits Kriterium, das in einer Metrik-Warnungsregel verwendet werden kann.

## Parameter

### -ApplicationInsightsId
Die Ressourcen-ID für Application Insights.
...
### -FailedLocationCount
Die Mindestanzahl fehlgeschlagener Speicherorte, um eine Benachrichtigung auszulösen.
...
Ermöglicht das Erstellen einer Warnungsregel für eine benutzerdefinierte Metrik, die noch nicht ausgegeben wurde, indem die Metrik-Validierung übersprungen wird
...
### -Webtest
Parameter für die Verwendung des Verfügbarkeitskriterien-Typs wechseln
...
### -Webtest-Nr
Die Webtest-ID für Application Insights.
