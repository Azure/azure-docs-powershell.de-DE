...
## Beschreibung
Aktualisieren einer Warnungsregel für Protokolle durch Put-Semantik

## Beispiele

### Beispiel 1: nach Regelnamen einrichten
```powershell
...
### Beispiel 2: nach Eingabeobjekt setzen
```powershell
...
### Beispiel 3: nach Ressourcen-ID einrichten
```powershell
