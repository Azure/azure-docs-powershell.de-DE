...
## Beschreibung
Das Get-AzIotSecurityAnalytics-Cmdlet gibt eine Reihe von Sicherheitsanalysen einer bestimmten viel Sicherheitslösung zurück.
...
Holen Sie sich die deafult viel Security Analytics for Security-Lösung "MySolution" in der dasselbe Benuteroberflächenmodell-Gruppe "myresourcegroup"

## Parameter

### – Standard
Wenn vorhanden, rufen Sie den standardmäßigen Analyse Satz ab, und rufen Sie andernfalls die Liste aller Analyse Sätze ab.
