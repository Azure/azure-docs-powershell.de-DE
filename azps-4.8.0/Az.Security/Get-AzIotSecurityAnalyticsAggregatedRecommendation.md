...
## Beschreibung
Das Get-AzIotSecurityAnalyticsAggregatedAlert-Cmdlet gibt eine oder mehrere aggregierte Empfehlungen auf Geräten des viel-Hubs zurück. Der Name einer aggregierten Empfehlung ist der Typ
...
Abrufen der aggregierten Empfehlung "IoT_OpenPorts" in der Sicherheitslösung "MySolution" und Ressourcengruppe "myresourcegroup"
...
Abrufen einer Liste der aggregierten Empfehlungen in der Sicherheitslösung "MySolution" und Ressourcengruppe "myresourcegroup"
