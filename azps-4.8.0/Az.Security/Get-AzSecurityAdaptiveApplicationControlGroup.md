...
## Synopsis
Ruft eine Application Control VM/Server-Gruppe ab.
...
## Beschreibung
Steuerelemente für die Adaptive Anwendung werden automatisch vom Azure Security Center berechnet, verwenden Sie dieses Cmdlet, um eine VM/Server-Gruppe für die Anwendungssteuerung abzurufen.
...
### -AscLocation
Der Speicherort, an dem ASC die Daten des Abonnements speichert. kann von Get-Speicherorten abgerufen werden.
...
### -GroupName
Name einer Application Control-VM/Server-Gruppe.
