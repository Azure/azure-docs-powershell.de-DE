...
### -FilePath
Gibt den Pfad einer JSON-Datei an, die die Definition der SQL-Informationsschutz Richtlinie enthält.
...
### – Richtlinien
Gibt eine SQL-Informationsschutz-Richtliniendefinition an. Sie können einen Pfad einer JSON-Datei oder eine JSON-Formatzeichenfolge angeben, die die Richtlinie definiert.
