...
ms.locfileid: "94008965"
---
# <span data-ttu-id="91f69-101">Get-AzSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="91f69-101">Get-AzSecurityAlert</span></span>

## <span data-ttu-id="91f69-102">Synopsis</span><span class="sxs-lookup"><span data-stu-id="91f69-102">SYNOPSIS</span></span>
<span data-ttu-id="91f69-103">Ruft Sicherheitswarnungen ab, die vom Azure Security Center erkannt wurden.</span><span class="sxs-lookup"><span data-stu-id="91f69-103">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="91f69-104">Syntax</span><span class="sxs-lookup"><span data-stu-id="91f69-104">SYNTAX</span></span>

### <span data-ttu-id="91f69-105">SubscriptionScope (Standard)</span><span class="sxs-lookup"><span data-stu-id="91f69-105">SubscriptionScope (Default)</span></span>
```
Get-AzSecurityAlert [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="91f69-106">ResourceGroupScope</span><span class="sxs-lookup"><span data-stu-id="91f69-106">ResourceGroupScope</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="91f69-107">ResourceGroupLevelResource</span><span class="sxs-lookup"><span data-stu-id="91f69-107">ResourceGroupLevelResource</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> -Name <String> -Location <String>
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="91f69-108">SubscriptionLevelResource</span><span class="sxs-lookup"><span data-stu-id="91f69-108">SubscriptionLevelResource</span></span>
```
Get-AzSecurityAlert -Name <String> -Location <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### <span data-ttu-id="91f69-109">ResourceId</span><span class="sxs-lookup"><span data-stu-id="91f69-109">ResourceId</span></span>
```
Get-AzSecurityAlert -ResourceId <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

## <span data-ttu-id="91f69-110">Beschreibung</span><span class="sxs-lookup"><span data-stu-id="91f69-110">DESCRIPTION</span></span>
<span data-ttu-id="91f69-111">Ruft Sicherheitswarnungen ab, die vom Azure Security Center erkannt wurden.</span><span class="sxs-lookup"><span data-stu-id="91f69-111">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="91f69-112">Beispiele</span><span class="sxs-lookup"><span data-stu-id="91f69-112">EXAMPLES</span></span>

### <span data-ttu-id="91f69-113">Beispiel 1</span><span class="sxs-lookup"><span data-stu-id="91f69-113">Example 1</span></span>
```powershell
...
<span data-ttu-id="91f69-114">Ruft alle Sicherheitswarnungen ab, die für Ressourcen innerhalb eines Abonnements erkannt wurden.</span><span class="sxs-lookup"><span data-stu-id="91f69-114">Gets all the security alerts that were detected on resources inside a subscription</span></span>

### <span data-ttu-id="91f69-115">Beispiel 2</span><span class="sxs-lookup"><span data-stu-id="91f69-115">Example 2</span></span>
```powershell
...
<span data-ttu-id="91f69-116">Ruft alle Sicherheitswarnungen ab, die für Ressourcen innerhalb der Ressourcengruppe "myService1" erkannt wurden.</span><span class="sxs-lookup"><span data-stu-id="91f69-116">Gets all the security alerts that were detected on resources inside the "myService1" resource group</span></span>

### <span data-ttu-id="91f69-117">Beispiel 3</span><span class="sxs-lookup"><span data-stu-id="91f69-117">Example 3</span></span>
```powershell
...
<span data-ttu-id="91f69-118">Ruft eine bestimmte Sicherheitswarnung ab, die für Ressourcen innerhalb der Ressourcengruppe "myService1" erkannt wurde.</span><span class="sxs-lookup"><span data-stu-id="91f69-118">Gets a specific security alert that were detected on resources inside the "myService1" resource group</span></span>

## <span data-ttu-id="91f69-119">Parameter</span><span class="sxs-lookup"><span data-stu-id="91f69-119">PARAMETERS</span></span>

### <span data-ttu-id="91f69-120">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="91f69-120">-DefaultProfile</span></span>
<span data-ttu-id="91f69-121">Die für die Kommunikation mit Azure verwendeten Anmeldeinformationen, das Konto, den Mandanten und das Abonnement.</span><span class="sxs-lookup"><span data-stu-id="91f69-121">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="91f69-122">-Standort</span><span class="sxs-lookup"><span data-stu-id="91f69-122">-Location</span></span>
<span data-ttu-id="91f69-123">Lage.</span><span class="sxs-lookup"><span data-stu-id="91f69-123">Location.</span></span>
...
### <span data-ttu-id="91f69-124">-Name</span><span class="sxs-lookup"><span data-stu-id="91f69-124">-Name</span></span>
<span data-ttu-id="91f69-125">Ressourcenname</span><span class="sxs-lookup"><span data-stu-id="91f69-125">Resource name.</span></span>
...
### <span data-ttu-id="91f69-126">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="91f69-126">-ResourceGroupName</span></span>
<span data-ttu-id="91f69-127">Name der Ressourcengruppe.</span><span class="sxs-lookup"><span data-stu-id="91f69-127">Resource group name.</span></span>
...
### <span data-ttu-id="91f69-128">-Resourcen-Nr</span><span class="sxs-lookup"><span data-stu-id="91f69-128">-ResourceId</span></span>
<span data-ttu-id="91f69-129">Ressourcen-ID.</span><span class="sxs-lookup"><span data-stu-id="91f69-129">Resource ID.</span></span>
...
### <span data-ttu-id="91f69-130">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="91f69-130">CommonParameters</span></span>
<span data-ttu-id="91f69-131">Dieses Cmdlet unterstützt die allgemeinen Parameter:-Debug,-Fehler Aktion,-ErrorVariable,-InformationVariable,-Variable,-Puffer,-PipelineVariable,-Verbose,-Warning-Aktion und-WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="91f69-131">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="91f69-132">Weitere Informationen finden Sie unter [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span><span class="sxs-lookup"><span data-stu-id="91f69-132">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="91f69-133">Eingaben</span><span class="sxs-lookup"><span data-stu-id="91f69-133">INPUTS</span></span>

### <span data-ttu-id="91f69-134">System. String</span><span class="sxs-lookup"><span data-stu-id="91f69-134">System.String</span></span>

## <span data-ttu-id="91f69-135">Ausgaben</span><span class="sxs-lookup"><span data-stu-id="91f69-135">OUTPUTS</span></span>

### <span data-ttu-id="91f69-136">Microsoft. Azure. Commands. Security. Models. alerts. PSSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="91f69-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span></span>

## <span data-ttu-id="91f69-137">Notizen</span><span class="sxs-lookup"><span data-stu-id="91f69-137">NOTES</span></span>

## <span data-ttu-id="91f69-138">Verwandte Links</span><span class="sxs-lookup"><span data-stu-id="91f69-138">RELATED LINKS</span></span>
