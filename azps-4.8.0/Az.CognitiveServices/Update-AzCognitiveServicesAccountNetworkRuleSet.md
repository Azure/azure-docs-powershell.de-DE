...
## Beschreibung
Das Cmdlet **Update-AzCognitiveServicesAccountNetworkRuleSet** aktualisiert die NetworkRule-Eigenschaft eines kognitiven Dienstkontos.
...
### Beispiel 3: Bereinigen von NetworkRule-Regeln eines kognitiven Dienstkontos
```
...
Mit diesem Befehl werden Regeln für NetworkRule eines kognitiven Dienstkontos bereinigt (andere Eigenschaften werden nicht geändert).

## Parameter

### – Standardmäßig
NetworkRule-Standardwert für Cognitive Services-Konto Standardwert `Deny` .
...
### -IpRule
Cognitive Services-Konto NetworkRule IpRules.
...
### -VirtualNetworkRule
Cognitive Services-Konto NetworkRule VirtualNetworkRules.
