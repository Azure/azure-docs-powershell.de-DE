...
## Synopsis
Generieren einer neuen Instanz des Cognitive Services-Kontos ApiProperties
...
## Beschreibung
Erstellen Sie eine neue Instanz des kognitiven Dienstkonto-ApiProperties.
ApiProperties kann verwendet werden, wenn Sie ein neues Konto erstellen oder ein vorhandenes Konto aktualisieren.
...
Im obigen Beispiel wird ein QnAMaker-Konto mit API-Eigenschaft "QnaRuntimeEndpoint" erstellt.
