...
## Beschreibung
Das Cmdlet " **Get-AzDataBoxEdgeUser** " listet die Benutzer auf, die für ein Daten Feld-Edge-Gerät konfiguriert sind. Sie können den Namen in Parametern erwähnen, um Details zu einem bestimmten Benutzer abzurufen.
