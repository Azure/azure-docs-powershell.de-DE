...
## Beschreibung
Das Cmdlet " **Get-AzDataBoxEdgeDevice** " Ruft die Informationen zu den verfügbaren Edge-Geräten für Datenfelder ab. Sie können den Namen des Geräts zusammen mit dem Namen der Ressourcengruppe angeben, um die Informationen auf einem bestimmten Gerät abzurufen. 
...
### -Alert
Abrufen der Warnungen auf dem Daten Feld Edge/Gateway-Gerät
...
### -ExtendedInfo
Ruft zusätzliche Informationen für das angegebene Datenfeld Edge/Data Box-Gateway-Gerät ab.
...
### -NetworkSetting
Ruft die Netzwerkeinstellungen des angegebenen Daten Feld-Gateway-Geräts ab.
...
### -UpdateSummary
Ruft Informationen zur Verfügbarkeit von Updates auf der Grundlage des letzten Scans des Geräts ab. Außerdem werden Informationen zu allen laufenden Download-oder Installations Aufträgen auf dem Gerät abgerufen.
