...
## Beschreibung
Das Cmdlet **New-AzDataBoxEdgeOrder** erstellt eine neue Reihenfolge für ein Daten Feld-Edge-Gerät. Eine Daten Feld-Edge-Geräteressource muss zuerst erstellt werden, bevor eine Bestellung erstellt wird. Sie können Details wie Kontaktperson, Firmenname, e-Mail-Adresse, Anschrift usw. als Parameter für die Erstellung des Auftrags angeben.
...
### – E-Mail
Liste der e-Mails für den Empfang von Updates, akzeptiert maximal 10 e-Mails
