...
## Beschreibung
Rufen Sie eine Edge-Modul-Methode auf. Weitere Informationen finden Sie unter https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-direct-methods .
...
### -ConnectionTimeout
Die Anzahl der Sekunden, die gewartet werden soll, bis eine Verbindung erfolgreich hergestellt wurde.
...
### -Name
Der Name der Methode, die für dieses Gerätemodul aufgerufen werden soll.
...
### -Nutzlast
Die Nutzlast für die Methode, die für dieses Gerätemodul aufgerufen werden soll.
...
### -ResponseTimeOut
Die Anzahl der Sekunden, die gewartet werden soll, bis ein Ergebnis von der direkten Methode empfangen wird.
Der Standardwert ist 10.
