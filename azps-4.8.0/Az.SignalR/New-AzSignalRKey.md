...
### Erneutes Generieren des Primärschlüssels
```powershell
...
### -KeyType
Der Typ des Schlüssels, entweder primär oder sekundär.
...
### -PassThru
Gibt "true" zurück, wenn die Regenerierung erfolgreich abgeschlossen wurde.
