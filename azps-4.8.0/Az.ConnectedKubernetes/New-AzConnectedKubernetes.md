...
### Beispiel 1: Erstellen eines verbundenen kubernetes
```powershell
...
Dieser Befehl erstellt eine verbundene kubernetes.

### Beispiel 1: Erstellen einer verbundenen kubernetes mit Parametern kubeConfig und kubencontext
```powershell
...
Dieser Befehl erstellt eine verbundene kubernetes mit Parametern kubeConfig und kubencontext.
...
### -ResourceGroupName
Der Name der Ressourcengruppe, in der der kubernetes-Cluster registriert ist.
