...
### -Signer
Gibt das RFC7519-JSON-webtoken an, das einen Anspruch mit dem Namen "Maa-policyCertificate" enthält, dessen Wert ein RFC7517 JSON-Webschlüssel mit einem vertrauenswürdigen Signaturschlüssel ist, der entfernt werden soll.
