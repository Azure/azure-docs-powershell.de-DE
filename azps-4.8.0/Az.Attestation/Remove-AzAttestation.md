...
## Beschreibung
Das Remove-AzAttestation-Cmdlet löscht die angegebene Bescheinigung.
...
Löschen Sie den Zertifizierungsanbieter namens *pshtest3* in der Ressourcengruppe mit dem Namen *PSH-Test-RG* aus dem aktuellen Abonnement.
...
### -Inputobject
Bescheinigungs Objekt, das gelöscht werden soll
...
### -Name
Gibt den Namen der zu entfernenden Bescheinigung an.
...
### -ResourceGroupName
Gibt den Namen der Ressourcengruppe für die zu entfernende Azure-Bescheinigung an.
