...
## BEISPIELE
### Beispiel 1: Erhalten von Informationen zu allen Datenflüssen
```powershell
...
Dieser Befehl ruft Informationen über den Datenfluss namens "dataflow1" in der Daten factory namens WikiADF ab.
