...
### Beispiel 2: Erstellen einer Data Factory mit Repo-Konfigurationsdetails mithilfe eines vorhandenen Factory-Objekts
```
...
Mit diesem Befehl wird eine Data Factory mit dem Namen WikiADF in der Ressourcengruppe ADF in der eastus-Position mit Azure DevOps-Quell Code Verwaltungskonfiguration erstellt.

### Beispiel 3: Erstellen einer Data Factory mit GitHub-Repo-Konfigurationsdetails mithilfe eines neuen Factory-Objekts
```
...
Mit diesem Befehl wird eine Data Factory mit dem Namen WikiADF in der Ressourcengruppe ADF in der eastus-Position mit GitHub-Quellcodeverwaltungs-Konfiguration erstellt.
...
Das Wörterbuch, das die globalen Parameter der Data Factory enthält.
...
### -Hostname
Der Hostname für die GitHub-Repo-Konfiguration.
...
### -ProjectName
Der Projektname Azure DevOps für die Repo-Konfiguration.
...
### -Mandanten-Nr
Die Mandanten-ID für Azure DevOps Repo-Konfiguration.
