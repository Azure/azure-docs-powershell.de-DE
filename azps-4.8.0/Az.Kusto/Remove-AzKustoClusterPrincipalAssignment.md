...
### Beispiel 1: Löschen eines vorhandenen Kusto-Cluster-PrincipalAssignment nach Name
```powershell
...
Der obige Befehl löscht die PrincipalAssignment namens "kustoprincipal1" im Kusto-Cluster "testnewkustocluster".
