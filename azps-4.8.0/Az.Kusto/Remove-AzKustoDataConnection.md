...
### Beispiel 1: Löschen einer vorhandenen Datenverbindung nach Namen
```powershell
...
Der obige Befehl löscht die Datenverbindung mit dem Namen "mykustodataconnection" in der Datenbank "mykustodatabase" des vorhandenen Clusters "testnewkustocluster", der in der Ressourcengruppe "testrg" gefunden wurde.
