...
### Beispiel 1: Löschen einer vorhandenen Kusto-Datenbank-PrincipalAssignment nach Namen
```powershell
...
Der obige Befehl löscht die PrincipalAssignment namens "kustoprincipal1" in der Kusto-Datenbank "mykustodatabase".
