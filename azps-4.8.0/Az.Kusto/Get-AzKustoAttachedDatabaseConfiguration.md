...
Der obige Befehl listet alle AttachedDatabaseConfigurations im Cluster "testnewkustoclusterf" auf.

### Beispiel 2: Abrufen einer bestimmten AttachedDatabaseConfiguration in einem Cluster
```powershell
...
Der obige Befehl gibt den AttachedDatabaseConfigurations mit dem Namen "myfollowerconfiguration" im Cluster "testnewkustoclusterf" zurück.
