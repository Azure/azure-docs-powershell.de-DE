...
### Beispiel 1: Löschen eines vorhandenen AttachedDatabaseConfiguration nach Name
```powershell
...
Der obige Befehl löscht die im AttachedDatabaseConfiguration "myfollowerconfiguration" definierte Nachfolger Datenbank aus dem Cluster "testnewkustoclusterf".
