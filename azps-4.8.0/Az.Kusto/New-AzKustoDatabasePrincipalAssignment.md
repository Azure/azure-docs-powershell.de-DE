...
### Beispiel 1: Erstellen einer Kusto-Clusterdatenbank principalAssignment
```powershell
...
Mit dem obigen Befehl wird eine Kusto-Clusterdatenbank erstellt principalAssignment
...
### -Prinzipal-Nr
Die Prinzipal-ID, die dem Datenbankprinzipal zugewiesen ist.
Hierbei kann es sich um eine Benutzer-e-Mail, eine Anwendungs-ID oder einen Sicherheitsgruppen Namen handeln.
