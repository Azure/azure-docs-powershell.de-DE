...
### Beispiel 1: Entfernen eines Benutzers aus einer Group by-Objekt-ID
...
### Beispiel 2: Entfernen eines Benutzers aus einer Gruppe durch Verrohrung

```powershell
PS C:\> Get-AzADGroup -ObjectId 85F89C90-780E-4AA6-9F4F-6F268D322EEE | Remove-AzADGroupMember -MemberObjectId D9076BBC-D62C-4105-9C78-A7F5BC4A3405
```

Ruft die Gruppe mit der Objekt-ID "85F89C90-780E-4AA6-9F4F-6F268D322EEE" ab und leitet Sie an das Remove-AzADGroupMember-Cmdlet weiter, um den Benutzer zu dieser Gruppe zu entfernen.
...
### -GroupDisplayName
Der Anzeigename der Gruppe, aus der die Mitglieder entfernt werden sollen.
...
Der UPN der zu entfernenden Member (s).
