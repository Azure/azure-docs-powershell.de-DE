...
### Beispiel 1: Abrufen aller Aktionen für alle Anbieter
```powershell
PS C:\> Get-AzProviderOperation *
```

### Beispiel 2: Abrufen von Aktionen für einen bestimmten Ressourcenanbieter
```powershell
PS C:\> Get-AzProviderOperation Microsoft.Insights/*
```

### Beispiel 3: Abrufen aller Aktionen, die auf virtuellen Computern ausgeführt werden können
```powershell
