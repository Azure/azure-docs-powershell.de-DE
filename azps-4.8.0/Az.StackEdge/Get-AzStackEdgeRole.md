...
## Beschreibung
Das Cmdlet " **Get-AzStackEdgeRole** " Ruft die verfügbaren Rollen für ein Stack-Edge-Gerät ab. Sie können den Parameter Name erwähnen, um die Details einer bestimmten Rolle zu erhalten.
