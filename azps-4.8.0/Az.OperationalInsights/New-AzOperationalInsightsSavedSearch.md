...
Dieser Befehl erstellt eine neue gespeicherte Suche.
...
### -DisplayName
Gibt den Namen der gespeicherten Suchanzeige an.
...
### -FunctionAlias
Der Funktions-Alias, wenn Query als Funktion fungiert.
...
### -FunctionParameter
Die optionalen Funktionsparameter, wenn Query als Funktion fungiert. Der Wert sollte das folgende Format aufweisen: ' param-Name1: default_value1, param-Name2: Typ2 = default_value2 '. Weitere Beispiele und die richtige Syntax finden Sie unter https://docs.microsoft.com/en-us/azure/kusto/query/functions/user-defined-functions .
...
### -Tag
Die gespeicherten Suchkategorien.
