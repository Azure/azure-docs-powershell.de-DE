...
## Beschreibung
Das Cmdlet **enable-AzOperationalInsightsIISLogCollection** startet die Sammlung von Internet Informationsdienste (IIS)-Protokollen von verbundenen Computern in einem Arbeitsbereich.
