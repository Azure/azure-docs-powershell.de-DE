...
> [!Note]  
> Das Invoke-AzStorageSyncChangeDetection-Cmdlet erkennt keine Dateien, die in der Azure-Dateifreigabe gelöscht wurden. Wenn Dateien in der Azure-Dateifreigabe gelöscht werden, werden Sie beim Ausführen des [Änderungs Erkennungs Auftrags](https://docs.microsoft.com/azure/storage/files/storage-sync-files-troubleshoot?tabs=portal1%2Cazure-portal#afs-change-detection) erkannt.
