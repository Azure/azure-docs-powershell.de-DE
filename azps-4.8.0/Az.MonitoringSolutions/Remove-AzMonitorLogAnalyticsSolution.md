...
### Beispiel 1: Entfernen einer Monitor Protokollanalyse-Lösung nach Namen
```powershell
PS C:\> Remove-AzMonitorLogAnalyticsSolution  -ResourceGroupName azureps-manual-test -Name 'Containers(monitoringworkspace-2vob7n)'

```

Mit diesem Befehl wird eine Lösung für die Monitor Protokollanalyse nach Namen entfernt.

### Beispiel 2: Entfernen einer Monitor Protokollanalyse-Lösung nach Objekt
```powershell
...
Mit diesem Befehl wird eine Überwachungsprotokoll-Analyse Lösung nach Objekt entfernt.

### Beispiel 3: Entfernen einer Monitor Protokollanalyse-Lösung nach Pipeline
```powershell
PS C:\> $monitor = Get-AzMonitorLogAnalyticsSolution -ResourceGroupName azureps-manual-test -Name 'Containers(monitoringworkspace-asdehu)' | Remove-AzMonitorLogAnalyticsSolution

```

Dieser Befehl entfernt eine Überwachungsprotokoll Analyse Lösung nach Pipeline.
