...
## Beschreibung
Erstellen Sie eine Geräteregistrierung in einem Azure viel Hub-Device-Bereitstellungsdienst.
...
Erstellen einer Anmeldung mit dem Bestätigungs SymmetricKey
...
Erstellen Sie eine Registrierung mit TPM-Bestätigung.
...
Erstellen einer Registrierung mit dem Bestätigungs X509
...
Erstellen Sie eine Anmeldung mit dem Testat-Typ SymmetricKey und dem anfänglichen Twin-Zustand.

## Parameter

### -AllocationPolicy
Der Typ der Zuordnung für das Gerät, das dem Hub zugewiesen ist.
...
### -ApiVersion
Die API-Version des Bereitstellungs Diensts in der benutzerdefinierten Zuordnungsanforderung.
...
### -Erwünscht
Anfängliche Zwillings gewünschte Eigenschaften.
...
### -EdgeEnabled
Kennzeichen, das die Kanten Aktivierung angibt.
...
### -IotHub
Hostname des Ziel-Zahl-Hubs
Verwenden Sie die durch Leerzeichen getrennte Liste für mehrere viele Hubs.
...
### -PrimaryCAName
Der Name des primären Stammzertifizierungsstellen-Zertifikats.
Wenn die Bescheinigung mit einem Stammzertifizierungsstellen-Zertifikat erwünscht ist, muss ein Stammzertifizierungsstellen-Name bereitgestellt werden.
...
Base-64-Darstellung der Datei "X509 Certificate. cer" oder des PEM-Dateipfads.
...
### -Registrierungs-Nr
Individuelle Registrierungs-ID für die Registrierung.
...
### -ReprovisionPolicy
Gerätedaten, die bei der erneuten Bereitstellung an unterschiedlichen viel Hub gehandhabt werden sollen.
...
### -SecondaryCAName
Der Name des sekundären Stammzertifizierungsstellen-Zertifikats.
Wenn die Bescheinigung mit einem Stammzertifizierungsstellen-Zertifikat erwünscht ist, muss ein Stammzertifizierungsstellen-Name bereitgestellt werden.
...
### -StorageRootKey
TPM-Speicherstammschlüssel für ein TPM-Gerät.
...
### -WebhookUrl
Die webhook-URL, die für benutzerdefinierte Zuordnungsanforderungen verwendet wird.
