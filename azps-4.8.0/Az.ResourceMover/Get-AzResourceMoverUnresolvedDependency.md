...
### Beispiel 1: Abrufen einer Liste der unaufgelösten abhängigen Ressourcen
```powershell
...
Abrufen einer Liste der nicht aufgelöst abhängigen Ressourcen für eine Move-Sammlung.
