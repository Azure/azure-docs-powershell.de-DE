...
Erstellen Sie eine neue Move-Sammlung in einem Abonnement.
...
### -IdentityPrincipalId
Ruft die Prinzipal-ID ab oder legt diese fest.
...
### -IdentityTenantId
Ruft die Mandanten-ID ab oder legt diese fest.
...
### -IdentityType
Der Typ der Identität, die für den Bereichs Verschiebungs Dienst verwendet wird.
...
### -Standort
Die Geo-Position, an der die Ressource wohnt.
...
### -SourceRegion
Ruft den Quellbereich ab oder legt ihn fest.
...
### -TargetRegion
Ruft den Zielbereich ab oder legt ihn fest.
