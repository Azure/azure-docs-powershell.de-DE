...
### Beispiel 1: Überprüfen Sie die dependecies vor dem verwerfen der Ressourcen.
```powershell
...
Überprüfen Sie die dependecies vor dem verwerfen der Ressourcen.

### Beispiel 2: verwirft den Umzug der Ressourcen mit "MoveResource Name" als Eingabe
```powershell
...
Verwirft den Umzug der Ressourcen mit "MoveResource Name" als Eingabe.

### Beispiel 3: verwirft den Umzug der Ressourcen mit "SourceARMID" als Eingabe
```powershell
...
Verwirft den Umzug der Ressourcen mit "SourceARMID" als Eingabe.
