...
### Beispiel 1: Abrufen von Details zu allen Move-Auflistungen im Abonnement
```powershell
...
Hier erhalten Sie Informationen zu allen Move-Auflistungen im Abonnement.

### Beispiel 2: Abrufen von Details zur Move-Sammlung mit einem angegebenen Move-Sammlungsnamen im Abonnement
```powershell
...
Abrufen von Details zur Move-Sammlung mit dem angegebenen Move-Sammlungsnamen im Abonnement.

### Beispiel 3: Abrufen von Details zur Move-Sammlung mit einem angegebenen Ressourcengruppennamen im Abonnement
```powershell
...
Abrufen von Details zur Move-Sammlung mit einem angegebenen Ressourcengruppennamen im Abonnement.
