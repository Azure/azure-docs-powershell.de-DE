...
### Beispiel 1: Erstellen einer Instanz des SAP-Monitors anhand einer Zeichenfolge für Hana
```powershell
...
Dieser Befehl erstellt eine Instanz des SAP-Monitors durch eine Zeichenfolge für Hana.

### Beispiel 2: Erstellen einer Instanz des SAP-Monitors anhand des Schlüsseldepots für Hana
```powershell
...
Mit diesem Befehl wird eine Instanz des SAP-Monitors von Key Vault für Hana erstellt.
...
Die Ressourcen-ID des Schlüsseldepots, das die Hana-Anmeldeinformationen enthält.
...
Geheime Kennung für das Schlüsseldepot Secret, das die Hana-Anmeldeinformationen enthält.
...
### -Metadaten
Eine JSON-Zeichenfolge mit Metadaten der Anbieterinstanz.
