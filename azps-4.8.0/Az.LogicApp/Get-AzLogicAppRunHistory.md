...
### Beispiel 1: Abrufen des Ausführungsverlaufs einer Logik-App
```powershell
...
### Beispiel 2: Abrufen einer Logik-App-Ausführung
```powershell
...
Dieser Befehl ruft eine bestimmte Logik-App für die Logik-App mit dem Namen LogicApp03 ab.

### Beispiel 3

Dieser Befehl ruft den Ausführungsverlauf einer Logik-App mit dem Namen LogicApp03 ab. automatisch
...
### -RunName
Gibt den Ausführungs Namen einer Logik-APP an.
Mit diesem Cmdlet wird der von diesem Cmdlet festgelegte Workflow ausgeführt.
