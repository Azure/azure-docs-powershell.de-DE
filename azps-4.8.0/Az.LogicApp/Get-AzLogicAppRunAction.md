...
## Beschreibung
Das Cmdlet " **Get-AzLogicAppRunAction** " Ruft eine Aktion aus einer Logik-App-Ausführung ab.
...
### Beispiel 1: Abrufen einer Aktion aus einer Logik-App-Ausführung
```powershell
...
Dieser Befehl ruft eine bestimmte Logik-App-Aktion aus der Logik-App mit dem Namen LogicApp05 für den Run mit dem Namen LogicAppRun56 ab.

### Beispiel 2: Abrufen aller Aktionen aus einer Logic-App-Ausführung
```powershell
...
Dieser Befehl ruft alle Logik-App-Aktionen aus einem Run mit dem Namen LogicAppRun56 einer Logik-App mit dem Namen LogicApp05 ab.

### Beispiel 3

Dieser Befehl ruft alle Logik-App-Aktionen aus einem Run mit dem Namen LogicAppRun56 einer Logik-App mit dem Namen LogicApp05 ab. automatisch
...
### -Aktionsname
Gibt den Namen einer Aktion in einer Logic-APP an.
...
### -ResourceGroupName
Gibt den Namen einer Ressourcengruppe an, in der das Cmdlet eine Aktion erhält.
...
### -RunName
Gibt den Namen der Ausführung einer Logik-APP an.
