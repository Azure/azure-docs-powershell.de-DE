...
### Beispiel 1: Aktualisieren einer angegebenen Ereignisquelle anhand des Namens
```powershell
...
Mit diesem Befehl wird eine bestimmte Ereignisquelle aktualisiert.

### Beispiel 3: Aktualisieren einer angegebenen Ereignisquelle nach Objekt
```powershell
...
### -Tag
Schlüssel-Wert-Paare zusätzlicher Eigenschaften für die Ereignisquelle.
