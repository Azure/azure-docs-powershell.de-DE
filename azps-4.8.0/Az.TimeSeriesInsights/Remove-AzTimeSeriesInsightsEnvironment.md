...
### Beispiel 1: Entfernen einer Zeitreihen Einblicke-Umgebung nach Namen
```powershell
PS C:\> Remove-AzTimeSeriesInsightsEnvironment -ResourceGroupName testgroup -Name tsill

```

Mit diesem Befehl wird eine Zeitreihen Einblicke-Umgebung entfernt.

### Beispiel 2: Entfernen einer Zeitreihen Einblicke-Umgebung nach Objekt
```powershell
