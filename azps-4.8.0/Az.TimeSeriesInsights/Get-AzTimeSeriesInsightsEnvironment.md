...
### Beispiel 1: Abrufen einer Zeitreihen Einblicke-Umgebung
```powershell
...
Mit diesem Befehl wird eine Zeitreihen Einblicke-Umgebung abgerufen.

### Beispiel 2: Auflisten aller Zeitreihen Einblicke in Umgebungen
```powershell
...
Dieser Befehl listet alle Zeitreihen Einblicke-Umgebungen in einer Ressourcengruppe auf.

### Beispiel 3: Abrufen einer Zeitreihen Einblicke-Umgebung nach Objekt
```powershell
...
Dieser Befehl ruft eine Zeitreihen Einblicke-Umgebungen ab.
...
### – Erweitern
Beim Festlegen von $Expand = Status wird der Status der internen Dienste der Umgebung im Time Series Insights-Dienst berücksichtigt.
