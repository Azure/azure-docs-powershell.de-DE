...
### Beispiel 1: Entfernen einer angegebenen Ereignisquelle nach Namen
```powershell
PS C:\> Remove-AzTimeSeriesInsightsEventSource -EnvironmentName tsitest001 -Name iots001 -ResourceGroupName testgroup

```

Dadurch wird eine bestimmte Ereignisquelle entfernt.

### Beispiel 2: Entfernen einer angegebenen Ereignisquelle nach Objekt
```powershell
