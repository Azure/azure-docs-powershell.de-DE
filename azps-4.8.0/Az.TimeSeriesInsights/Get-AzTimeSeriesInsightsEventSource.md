...
### Beispiel 1: Auflisten aller Ereignisquellen unter der angegebenen Umgebung
```powershell
...
Dieser Befehl listet alle Ereignisquellen in den angegebenen Umgebungen auf.

### Beispiel 2: Abrufen einer angegebenen Ereignisquelle anhand des Namens
```powershell
...
Mit diesem Befehl wird eine bestimmte Ereignisquelle abgerufen.

### Beispiel 3: Abrufen einer angegebenen Ereignisquelle nach Objekt
```powershell
...
### -Name
Der Name der Ereignisquelle für Zeitreihen Einblicke, die der angegebenen Umgebung zugeordnet ist.
