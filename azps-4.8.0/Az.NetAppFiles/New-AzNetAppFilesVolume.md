...
### Beispiel 1: Erstellen eines ANF-Volumes
```
...
Dieser Befehl erstellt das neue ANF-Volumen "MyAnfVolume" innerhalb des Pools "MyAnfPool".
...
### -ExportPolicy
Ein Hashtable-Array, das die Export Richtlinie darstellt
...
### -Poolobject
Der Pool für das neue Volumen Objekt
...
### -ReplicationObject
Ein Hashtable-Array, das das Replication-Objekt darstellt
...
### -Snapshot-Nr
Erstellen eines Volumes aus einer Momentaufnahme UUID v4 oder Ressourcen-ID, mit der der Snapshot identifiziert wird
