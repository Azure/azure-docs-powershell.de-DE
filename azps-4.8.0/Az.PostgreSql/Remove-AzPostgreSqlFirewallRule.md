...
### Beispiel 1: Entfernen der PostgreSQL-Firewall-Regel nach Namen
```powershell
PS C:\> Remove-AzPostgreSqlFirewallRule -Name rule -ResourceGroupName PostgreSqlTestRG -ServerName PostgreSqlTestServer

```

Dieses Cmdlet entfernt die PostgreSQL-Firewall-Regel nach Namen.

### Beispiel 2: Entfernen der PostgreSQL-Firewall-Regel nach Identität
```powershell
...
Diese Cmdlets entfernen die PostgreSQL-Firewall-Regel nach Identität.
