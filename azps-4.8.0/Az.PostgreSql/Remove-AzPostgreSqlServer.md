...
### Beispiel 1: Entfernen des PostgreSQL-Servers nach ResourceGroup und Servername
```powershell
PS C:\> Remove-AzPostgreSqlServer -ResourceGroupName PostgreSqlTestRG -Name PostgreSqlTestServer

```

Mit diesem Cmdlet wird der PostgreSQL-Server nach ResourceGroup und Servername entfernt.
