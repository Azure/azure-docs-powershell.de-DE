...
### Beispiel 1: Aktualisieren der PostgreSQL-Firewall-Regel nach Namen
```powershell
...
Dieses Cmdlet aktualisiert die Regel der PostgreSQL-Firewall nach Namen.

### Beispiel 2: Aktualisieren der PostgreSQL-Firewall-Regel nach Identität.
```powershell
...
Diese Cmdlets aktualisieren die PostgreSQL-Firewall-Regel nach Identität.

### Beispiel 3: Aktualisieren der PostgreSQL-Firewall-Regel by-ClientIPAddress
```powershell
...
Diese Cmdlets aktualisieren die ClientIPAddress-Regel für die PostgreSQL-Firewall.
