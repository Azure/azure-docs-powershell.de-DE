...
### Beispiel 1: Listet alle virtuellen Netzwerkregeln auf dem angegebenen PostgreSQL-Server auf
```powershell
...
Mit diesem Cmdlet werden alle virtuellen Netzwerkregeln auf dem angegebenen PostgreSQL-Server aufgelistet.
