...
### Beispiel 1: Erstellen einer neuen virtuellen Netzwerkregel für den PostgreSQL-Server
```powershell
...
Mit diesen Cmdlets wird eine virtuelle PostgreSQL-Server-Netzwerkregel erstellt.
