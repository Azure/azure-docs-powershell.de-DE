...
### Beispiel 1: Listet alle Firewallregeln auf dem angegebenen PostgreSQL-Server auf
```powershell
...
Dieses Cmdlet listet alle Firewallregel auf, die sich auf dem angegebenen PostgreSQL-Server befinden.

### Beispiel 2: Abrufen der Firewallregel nach Name
```powershell
...
Dieses Cmdlet ruft die Firewall-Regel nach Namen ab.

### Beispiel 3: Abrufen der Firewall-Regel nach Identität
```powershell
...
Dieses Cmdlet ruft die Firewall-Regel nach Identität ab.
