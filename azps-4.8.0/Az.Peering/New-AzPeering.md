...
### -MicrosoftNetwork
Wählen Sie das Microsoft-Netzwerk aus, mit dem Sie einen Peer durchsuchen möchten.
...
Verwenden Sie den Namen Get-AzPeeringLocation-Kind- \<kind\> Stadt als Schlüssel.
