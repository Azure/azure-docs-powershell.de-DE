...
### Abrufen von Peering und Erstellen eines registrierten Präfixes
```powershell
PS C:\>$peering = Get-AzPeering -ResourceGroupName $resourceGroupName -Name $name
PS C:\>$peering | New-AzPeeringRegisteredPrefix -Name $asnName -Asn $asn
```

Rufen Sie das Peering ab, dem Sie ein registriertes Präfix hinzufügen möchten. Übergeben Sie diese dann an die Unifiedgroup.
