...
## Beschreibung
Das Cmdlet **Add-AzKeyVaultNetworkRule** gewährt oder beschränkt den Zugriff auf einen schlüsseltresor auf eine Reihe von Anrufern, die von Ihren IP-Adressen oder dem virtuellen Netzwerk, dem Sie angehören, gekennzeichnet sind. Die Regel hat das Potenzial, den Zugriff für andere Benutzer, Anwendungen oder Sicherheitsgruppen, denen Berechtigungen über die Zugriffsrichtlinie gewährt wurden, zu beschränken.

Beachten Sie bitte, dass jeder IP-Bereich innerhalb `10.0.0.0–10.255.255.255` (Private IP-Adressen) nicht zum Hinzufügen von Netzwerkregeln verwendet werden kann.
...
Dieser Befehl fügt dem angegebenen Tresor eine Netzwerkregel hinzu, die den Zugriff auf die angegebene IP-Adresse aus dem virtuellen Netzwerk ermöglicht, das von $myNetworkResId identifiziert wird.
