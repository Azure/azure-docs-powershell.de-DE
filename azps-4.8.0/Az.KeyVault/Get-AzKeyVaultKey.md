...
Sie können den öffentlichen Schlüssel eines RSA-Schlüssels herunterladen, indem Sie den `-OutFile` Parameter angeben.
Dies ist ein Schritt beim Importieren von HSM-geschützten Schlüsseln in Azure Key Vault. Sieh https://docs.microsoft.com/en-us/azure/key-vault/keys/hsm-protected-keys
