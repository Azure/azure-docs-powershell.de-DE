...
## Beschreibung
Erstellen Sie ein Objekt, das die Netzwerkregel Einstellungen darstellt, die beim Erstellen eines Tresors verwendet werden können.
...
Erstellen eines neuen Tresors und Angeben von Netzwerkregeln zum Zulassen des Zugriffs auf die angegebene IP-Adresse aus dem virtuellen Netzwerk, das von $myNetworkResId identifiziert wird.
