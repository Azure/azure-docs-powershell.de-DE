...
## Beschreibung
Verwenden Sie dieses Cmdlet, um den Schweregrad, den Status oder die Kundenkontakt Details eines Support Tickets zu aktualisieren. Beachten Sie, dass das Aktualisieren des Schweregrads oder des Status eines Support Tickets nicht zulässig ist, wenn das Ticket einem Supporttechniker zugewiesen wird. Wenn Sie den Schweregrad oder den Status nach der ticketzuweisung aktualisieren möchten, wenden Sie sich an den Supporttechniker, indem Sie eine Mitteilung über das Ticket senden.

## Beispiele

### Beispiel 1: Update des Schweregrads des Support Tickets
```powershell
...
### Beispiel 2: Status des Support Tickets aktualisieren.
```powershell
...
### Beispiel 3: Aktualisieren Sie die Kontaktdetails des Support Tickets, indem Sie Kontaktobjekt angeben.
```powershell
...
### Beispiel 4: Update des Schweregrads des Support-Tickets durch Piping Support Ticket-Objekt.
```powershell
...
### Beispiel 5: Aktualisieren Sie die Kontaktdetails des Support Tickets, indem Sie einzelne kontaktparameter angeben.
```powershell
...
### Beispiel 6: Aktualisieren des Status des Support Tickets durch das Rohrleitungs Support-Ticket Objekt.
```powershell
...
Aktualisieren Sie die Kontaktinformationen auf Supportticket.
...
### -Inputobject
Supportticket-Ressourcenobjekt, das vom Cmdlet aktualisiert wird.
...
### -Name
Der Name der vom Cmdlet aktualisierten Supportticket-Ressource.
...
### -Schweregrad
Update Schweregrad von Supportticket.
...
### -Status
Update Status von Supportticket.
