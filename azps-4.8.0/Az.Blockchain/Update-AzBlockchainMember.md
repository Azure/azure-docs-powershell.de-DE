...
### Beispiel 1: Aktualisieren eines blockchain-Mitglieds
```powershell
...
Mit diesem Befehl wird ein blockchain-Mitglied aktualisiert.

### Beispiel 2: Aktualisieren eines blockchain-Mitglieds
```powershell
...
### -FirewallRule
Ruft die Firewallregeln ab oder legt diese fest.
Informationen zum Erstellen finden Sie unter Abschnitt "Notizen" für FIREWALLRULE-Eigenschaften und Erstellen einer Hashtabelle.
...
### -Kennwort
Legt das Kennwort für den Transaktions Knoten-DNS-Endpunkt Basic Auth fest.
...
FIREWALLRULE <IFirewallRule [] >: Ruft die Firewallregeln ab oder legt diese fest.
