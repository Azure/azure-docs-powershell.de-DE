...
### Beispiel 1: Erstellen eines blockchain-Transaktions Knotens
```powershell
...
Mit diesem Befehl wird ein blockchain-Transaktions Knoten erstellt.
...
### -Standort
Ruft die Position des Transaktions Knotens ab oder legt diese fest.
