...
### Beispiel 1: Erstellen eines neuen blockchain-Mitglieds
```powershell
...
Dieser Befehl erstellt ein neues blockchain-Mitglied.
...
### -Konsortium
Ruft das Konsortium für das blockchain-Element ab oder legt dieses fest.
...
Legt das Kennwort des verwalteten Consortium-Verwaltungskontos fest.
...
Ruft den Anzeigenamen des Mitglieds im Konsortium ab.
...
### -ConsortiumRole
Ruft die Rolle des Mitglieds im Konsortium ab.
...
### -FirewallRule
Ruft Firewallregeln zum Erstellen ab oder legt diese fest, lesen Sie den Abschnitt "Notizen" für FIREWALLRULE-Eigenschaften, und erstellen Sie eine Hashtabelle.
...
### -Standort
Der Geo-Speicherort des blockchain-Diensts.
...
### -Kennwort
Legt das grundlegende Auth-Kennwort des blockchain-Members fest.
...
### -Protokoll
Ruft das blockchain-Protokoll ab oder legt dieses fest.
...
### -SKU
Ruft den SKU-Namen ab oder legt ihn fest.
...
### -SkuTier
Abrufen oder Festlegen der SKU-Ebene
...
### -Tag
Tags des Diensts, bei denen es sich um eine Liste von Schlüsselwert Paaren handelt, die die Ressource beschreiben.
...
Ruft die Kapazität des Knotens ab oder legt diese fest.
...
FIREWALLRULE <IFirewallRule [] >: Ruft Firewallregeln ab oder legt Sie fest.
  - `[EndIPAddress <String>]`: Ruft die End-IP-Adresse des Firewall-Regelbereichs ab oder legt diese fest.
  - `[RuleName <String>]`: Ruft den Namen der Firewallregeln ab oder legt ihn fest.
  - `[StartIPAddress <String>]`: Ruft die Start-IP-Adresse des Firewall-Regelbereichs ab oder legt diese fest.
