...
### Beispiel 1: Abrufen eines virtuellen Windows-Desktop-Worksapce nach Name
```powershell
...
Dieser Befehl ruft einen virtuellen Windows-Desktop Arbeitsbereich in einer Ressourcengruppe ab.

### Beispiel 2: Auflisten von Windows-virtuellen Desktop Arbeitsbereichen
```powershell
...
Dieser Befehl listet einen virtuellen Windows-Desktop Arbeitsbereich in einer Ressourcengruppe auf.
