...
### Beispiel 1: Aktualisieren einer virtuellen Windows-Desktop Anwendung
```powershell
...
Mit diesem Befehl wird eine virtuelle Windows-Desktop Anwendung in einer Applicaton-Gruppe aktualisiert.
