...
### Beispiel 1: Erstellen eines Windows Virtual Desktop-Registrierungs Tokens
```powershell
...
Mit diesem Befehl wird ein Windows Virtual Desktop-Registrierungs Token in einem Host Pool erstellt.
