...
### Beispiel 1: Aktualisieren eines Windows Virtual Desktop-SessionHost nach Name
```powershell
...
Mit diesem Befehl wird ein Windows Virtual Desktop-SessionHost in einem Host Pool aktualisiert.
