...
### Beispiel 1: Löschen einer virtuellen Windows-Desktop Anwendung nach Namen
```powershell
PS C:\> Remove-AzWvdApplication -ResourceGroupName ResourceGroupName -ApplicationGroupName ApplicationGroupName -Name ApplicationName
```

Dieser Befehl löscht eine virtuelle Windows-Desktop Anwendung in einer Applicaton-Gruppe.
