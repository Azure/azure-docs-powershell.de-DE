...
### Beispiel 1: Aufheben der Registrierung einer Windows Virtual Desktop-Anwendungsgruppe
```powershell
...
Mit diesem Befehl wird die Registrierung einer Windows Virtual Desktop-Anwendungsgruppe für einen Arbeitsbereich aufgehoben.

## Parameter

### -ApplicationGroupPath
ResourceGroupName-Pfad
