...
## Beschreibung
Das Cmdlet " **Get-AzDataShareAccount** " Ruft Informationen zu DataShare-Konten in einer Azure-Abonnement/-Ressourcengruppe ab.
Wenn Sie den Namen eines Kontos angeben, ruft dieses Cmdlet Informationen zu diesem datshare-Konto ab.
Wenn Sie keinen Namen angeben, ruft dieses Cmdlet Informationen zu allen DataShare-Konten in einer Azure-Abonnement/-Ressourcengruppe ab.
...
Dieser Befehl zeigt Informationen zu allen DataShare-Konten im Azure-Abonnement an.
