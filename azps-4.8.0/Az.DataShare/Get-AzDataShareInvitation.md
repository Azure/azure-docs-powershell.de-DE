...
## Beschreibung
Das Cmdlet " **Get-AzDataShareInvitation** " Ruft Informationen zu Einladungen auf, die in der Datenfreigabe hinzugefügt wurden. Wenn Sie den Namen der Einladung angeben, ruft dieses Cmdlet Informationen zur Einladung ab. Wenn Sie keinen Namen angeben, ruft dieses Cmdlet Informationen zu allen Einladungen in einer Freigabe ab.
...
Dieser Befehl enthält Informationen zu Einladungs-AdsInvitation, die in Datenfreigabe-AdsShare vorhanden sind.
...
### -Name
Name der Einladung zu Azure Data Freigabe
...
### -Resourcen-Nr
Die Ressourcen-ID der Azure Data Share-Einladung
