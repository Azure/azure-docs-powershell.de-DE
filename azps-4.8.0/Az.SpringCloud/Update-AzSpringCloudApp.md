...
### Beispiel 1: Aktualisieren der APP für die Frühlings Wolke nach Namen.
```powershell
...
Aktualisieren Sie die APP für die Frühlings Wolke nach Namen.

### Beispiel 2: Aktualisieren der APP für die Frühlings Wolke aus Pipe
```powershell
...
Aktualisieren Sie die APP für die Frühlings Wolke aus Pipe.

## Parameter

### -ActiveDeploymentName
Name der aktiven Bereitstellung der APP
...
### -FQDN
Vollständig qualifizierter DNS-Name.
...
### -Standort
Die Geo-Position der Anwendung, immer identisch mit der übergeordneten Ressource
...
Bereitstellungspfad des beständigen Datenträgers
...
Größe des beständigen Datenträgers in GB
...
### -Öffentlich
Gibt an, ob die APP öffentlichen Endpunkt verfügbar macht.
