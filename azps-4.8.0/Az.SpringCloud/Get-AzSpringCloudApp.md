...
### Beispiel 1: Abrufen der APP für die Frühlings Wolke nach Namen.
```powershell
...
Holen Sie sich die APP für die Frühlings Wolke nach Namen.

### Beispiel 2: Auflisten aller apps unter einem bestimmten Spring Cloud-Dienst.
```powershell
...
Listen Sie alle apps unter einem bestimmten Spring Cloud-Dienst auf.
