...
### Beispiel 1: Entfernen Sie die APP für die Frühlings Wolke nach dem Namen.
```powershell
PS C:\> Remove-AzSpringCloudApp -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service -AppName gateway
```

Entfernen Sie die APP für die Frühlings Wolke nach Namen.

### Beispiel 2: Entfernen Sie die APP für die Frühlings Wolke aus Pipe.
```powershell
PS C:\> Get-AzSpringCloudApp -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service -AppName gateway | Remove-AzSpringCloudApp
```

Entfernen Sie die Frühlings Wolke-App aus Pipe.
