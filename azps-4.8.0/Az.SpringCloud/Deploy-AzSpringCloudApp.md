...
### Beispiel 1: Bereitstellen des lokalen kompilierten jar-Diensts nach Namen.
```powershell
...
Bereitstellen des lokalen kompilierten jar-Diensts nach Name
...
### -JarPath
Der Pfad des jar muss deploied sein.
