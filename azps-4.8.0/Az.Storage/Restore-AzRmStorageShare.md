...
## Beschreibung
Das Cmdlet **Restore-AzRmStorageShare** stellt eine gelöschte Dateifreigabe innerhalb einer gültigen Aufbewahrungstage wieder her, wenn die Option "Soft Delete freigeben" aktiviert ist.
...
### -DeletedShareVersion
Gelöschte Freigabe Version, die von wiederhergestellt wird.
...
### -Name
Gelöschter Freigabe Name, der wiederhergestellt wird.
