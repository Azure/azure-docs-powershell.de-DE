...
Dieser Befehl entfernt eine einzelne BLOBs-Verion mit der Versions-Nr.

### Beispiel 5: Entfernen eines einzelnen BLOB-Snapshots
```
PS C:\> Remove-AzStorageBlob -Container "containername" -Blob blob1 -SnapshotTime "2020-07-06T06:56:06.8588431Z"
```

Mit diesem Befehl wird ein einzelner BLOB-Snapshot mit Snapshotzeit entfernt.
...
Sie können das Get-AzStorageContainer-Cmdlet verwenden, um es abzurufen.
