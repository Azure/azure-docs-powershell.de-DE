...
## Beschreibung
Das Cmdlet " **Get-AzStorageFileServiceProperty** " Ruft die Diensteigenschaften für Azure Storage-Dateidienste ab.

## Beispiele

### Beispiel 1: Abrufen der Azure Storage File Services-Eigenschaft eines angegebenen speicherkontos
```powershell
...
Dieser Befehl ruft die Eigenschaft "Dateidienste" eines angegebenen speicherkontos ab.
