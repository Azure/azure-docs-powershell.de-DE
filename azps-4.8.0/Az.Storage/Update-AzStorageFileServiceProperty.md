...
## Beschreibung
Das Cmdlet **Update-AzStorageFileServiceProperty** ändert die Diensteigenschaften für den Azure Storage-Dateidienst.

## Beispiele

### Beispiel 1: Aktivieren von Dateifreigabe-softdelete
```powershell
...
Dieser Befehl aktiviert Dateifreigabe-softdelete löschen mit Aufbewahrungs Tagen als 5
...
Aktivieren Sie Freigabe Aufbewahrungsrichtlinie für das Speicherkonto freigeben, indem Sie auf $true festlegen, Aufbewahrungsrichtlinie für Freigabe löschen deaktivieren, indem Sie auf $false festlegen.
...
### -Resourcen-Nr
Geben Sie eine Ressourcen-ID des speicherkontos oder eine Ressourcen-ID für Dateidienst Eigenschaften ein.
...
### -ShareRetentionDays
Legt die Anzahl der Aufbewahrungstage für das Freigabe-DeleteRetentionPolicy fest.
Der Wert sollte nur festgesetzt werden, wenn die Aufbewahrungsrichtlinie für Freigabe löschen aktiviert ist.
