...
### Beispiel 5: Abrufen aller BLOBs in einem Container einschließlich BLOB-Version
```
...
Dieser Befehl ruft alle BLOBs in einem Container auf, einschließlich BLOB-Version.
...
Dieser Befehl ruft eine einzelne BLOBs-Verion mit Versions-Nr ab.

### Beispiel 7: Abrufen eines einzelnen BLOB-Snapshots
```
...
Mit diesem Befehl wird ein einzelner BLOB-Snapshot mit Snapshotzeit abgerufen.
...
Wenn für diesen Parameter ein Wert angegeben wird, listet das Cmdlet alle Blobs mit Namen auf, die diesem Parameter entsprechen. Dieser Parameter unterstützt Platzhalter an einer beliebigen Stelle in der Zeichenfolge.
...
### -IncludeVersion
BLOB-Versionen werden nur aufgelistet, wenn dieser Parameter vorhanden ist, standardmäßig erhalten BLOB keine BLOB-Versionen.
