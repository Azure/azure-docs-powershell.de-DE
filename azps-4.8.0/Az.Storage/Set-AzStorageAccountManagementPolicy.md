...
## Beschreibung
Das Cmdlet " **festlegen-AzStorageAccountManagementPolicy** " erstellt oder ändert die Verwaltungsrichtlinie eines Azure Storage-Kontos.

## Beispiele

### Beispiel 1: Erstellen oder aktualisieren Sie die Verwaltungsrichtlinie eines speicherkontos mit ManagementPolicy-Regel Objekten.
```
...
Dieser Befehl erstellt zunächst zwei ManagementPolicy-Regel Objekte, erstellt oder aktualisiert dann die Verwaltungsrichtlinie eines speicherkontos mit den 2 ManagementPolicy-Regel Objekten.

### Beispiel 2: Erstellen oder aktualisieren Sie die Verwaltungsrichtlinie eines speicherkontos mit einer JSON-Format Richtlinie.
```
...
Mit diesem Befehl wird die Verwaltungsrichtlinie eines speicherkontos mit einer JSON-Format Richtlinie erstellt oder aktualisiert.

### Beispiel 3: Rufen Sie die Verwaltungsrichtlinie von einem Speicherkonto ab, und legen Sie Sie dann auf ein anderes Speicherkonto vor.
```
...
Mit diesem Befehl wird zunächst die Verwaltungsrichtlinie von einem Speicherkonto abgerufen und dann auf ein anderes Speicherkonto gesetzt.
...
### – Richtlinien
Zu Festlegender Verwaltungsrichtlinien Objekt
...
### -Rule
Die Verwaltungsrichtlinien Regeln. Rufen Sie das Objekt mit New-AzStorageAccountManagementPolicyRule-Cmdlet ab.
