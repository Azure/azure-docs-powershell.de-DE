...
## Beschreibung
Das Cmdlet " **Get-AzStorageBlobQueryResult** " wendet eine einfache SQL-Anweisung (Structured Query Language) auf den Inhalt eines BLOBs an und speichert die abgefragte Teilmenge der Daten in einer lokalen Datei.
...
Dieser Befehl fragt eine BLOB-succsssfully mit der Eingabekonfiguration als CSV ab und gibt die Ausgabekonfiguration als JSON aus und speichert die Ausgabe in der lokalen Datei "c:\resultfile.jsein".

### Beispiel 2: Abfragen eines BLOB-Snapshots
```powershell
...
Dieser Befehl ruft zunächst ein BLOB-Objekt für den BLOB-Snapshot ab, fragt dann den BLOB-Snapshot ab und zeigt den Fehler "Ergebnis einbeziehen" an.
...
### -Force
Erzwingen, dass die vorhandene Datei überschrieben wird.
...
Die Konfiguration, die zum Behandeln des Abfrageeingabe Texts verwendet wurde. Erstellen Sie ein Konfigurationsobjekt, das mit New-AzStorageBlobQueryConfig.
...
Die Konfiguration, die zum Behandeln des Abfrageausgabe Texts verwendet wurde. Erstellen Sie ein Konfigurationsobjekt, das mit New-AzStorageBlobQueryConfig.
...
### -PassThru
Gibt zurück, ob der angegebene BLOB erfolgreich abgefragt wurde.
...
### -QueryString
Abfragezeichenfolge, weitere Details finden Sie unter: https://docs.microsoft.com/en-us/azure/storage/blobs/query-acceleration-sql-reference
