...
## Synopsis
Erstellt einen neuen Benutzer, dem eine Identität zugewiesen wurde, oder aktualisiert eine vorhandene Benutzer zugewiesene Identität.
...
## Beschreibung
Das Cmdlet **New-AzUserAssignedIdentity** erstellt eine neue Benutzer zugewiesene Identität. Bei Verwendung mit einer bereits vorhandenen Identität wurde die Identität aktualisiert.
Wenn Sie der Identität Azure Resource Manager-Tags hinzufügen möchten, verwenden Sie das Set-AzResource-Cmdlet.

## Beispiele

### Beispiel 1
Dieses Beispiel-Cmdlet erstellt einen neuen Benutzer, dem die Identität mit dem Namen **id1** unter Ressourcengruppe **PSRG** am Speicherort der ResourceGroup zugewiesen ist.
...
### Beispiel 2
Dieses Beispiel-Cmdlet erstellt einen neuen Benutzer, dem eine Identität mit dem Namen **id1** unter der Ressourcengruppe **PSRG** in der Region westus zugewiesen ist.
...
### -Standort
Der Name des Azure-Bereichs, in dem die Identität erstellt werden soll.
...
### -Tag
Die Azure Resource Manager-Tags, die der Identität zugeordnet sind.
