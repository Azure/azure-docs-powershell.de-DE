...
Tags werden als Inline-Hashtable dargestellt.

### Beispiel 2: Aktualisieren von Dashboard-Tags mithilfe der Pipeline
```powershell
...
Aktualisieren Sie die Tags in einem Dashboard, das mit Get-AzPortalDashboard wiederholt werden soll.
Dies kann verwendet werden, um die Tags über ein einzelnes Dashboard oder mehrere dashboardfs zu aktualisieren.
