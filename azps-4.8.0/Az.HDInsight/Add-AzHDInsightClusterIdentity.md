...
## Beschreibung
Das Cmdlet **Add-AzHDInsightClusterIdentity** fügt dem Azure HDInsight-Konfigurationsobjekt, das vom New-AzHDInsightClusterConfig-Cmdlet erstellt wird, eine Clusteridentität hinzu.

## Beispiele

### Beispiel 1: Hinzufügen von Cluster Identitätsinformationen zum Cluster Konfigurationsobjekt
```
...
Dieser Befehl fügt dem Cluster mit dem Namen "Your-Hadoop-001" Cluster-Identitätsinformationen hinzu, sodass der Cluster auf Azure Data Lake Store zugreifen kann.
...
### -ApplicationId
Die Dienstprinzipal-Anwendungs-ID für den Zugriff auf Azure Data Lake.
