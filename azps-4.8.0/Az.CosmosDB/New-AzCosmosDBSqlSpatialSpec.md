...
## Synopsis
Erstellt ein neues Objekt vom Typ PSSpatialSpec. Sie kann als Parameterwert für "AzCosmosDBSqlIndexingPolicy" übergeben werden.
...
## Beschreibung
Erstellt ein Objekt, das dem SpatialSpec der SQL-API entspricht.
