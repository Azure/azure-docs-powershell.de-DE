...
## Synopsis
Erstellt ein neues Objekt vom Typ PSCompositePath. Sie kann als Parameterwert für "AzCosmosDBGremlinGraph" übergeben werden.
...
## Beschreibung
Das Objekt, das dem CompositePath der Gremlin-API entspricht.
...
### -Bestellung
Ruft die Sortierreihenfolge für zusammengesetzte Pfade ab oder legt diese fest.
Mögliche Werte sind: "Aufsteigend", "absteigend"
...
### -Path
Der Pfad, auf den das Indizierungs Verhalten angewendet werden soll.
Index Pfade beginnen in der Regel mit "root" und enden mit Platzhalter (/Pfad/*).
