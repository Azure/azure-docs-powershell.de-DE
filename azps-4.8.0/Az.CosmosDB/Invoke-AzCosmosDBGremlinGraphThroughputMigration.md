...
## Synopsis
Verwenden Sie diese Vorgehensweise, um den AutoScale-Durchsatz auf manuellen Durchsatz zu migrieren und umgekehrt.
...
## Beschreibung
ThroughpyteType Parameter definiert den Durchsatz, zu dem Sie migrieren möchten.
...
### -Durchsatztyp
Der durchsatztyp, zu dem migriert werden soll.
Mögliche Werte sind: AutoScale, manuell.
