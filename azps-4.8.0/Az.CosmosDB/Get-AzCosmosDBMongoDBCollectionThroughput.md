...
## Synopsis
Ruft die CosmosDB-Durchsatz Eigenschaften der MongoDB-Sammlung ab.
...
## Beschreibung
Das Cmdlet " **Get-AzCosmosDBMongoDBCollectionThroughput** " Ruft die Durchsatz Eigenschaften der MongoDB-Sammlung ab.
...
### -Inputobject
Wenn Sie dann bereitgestellt werden, gibt das Cmdlet die Auflistung mit dem entsprechenden Durchsatz zurück.
