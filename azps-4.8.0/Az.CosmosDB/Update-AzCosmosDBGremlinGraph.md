...
ConflictResolutionPolicy-Objekt vom Typ PSConflictResolutionPolicy, wenn diese Einstellung als ConflictResolutionPolicy des Containers angegeben ist.
...
Kann die Werte haben: LastWriterWins, Benutzerdefiniert, manuell.
...
, Die bereitgestellt werden soll, wenn der Typ LastWriterWins ist.
...
, Die bereitgestellt werden soll, wenn der Typ Benutzerdefiniert ist.
...
### -IndexingPolicy
Indizierungs Richtlinienobjekt vom Typ Microsoft. Azure. Commands. CosmosDB. PSIndexingPolicy.
...
### -PartitionKeyKind
Die Art des für die Partitionierung verwendeten Algorithmus.
...
### -PartitionKeyPath
Partitionsschlüssel Pfad, beispielsweise "/Address/ZipCode".
...
### -PartitionKeyVersion
Die Version der Partitionsschlüssel Definition
...
### -UniqueKeyPolicy
UniqueKeyPolicy-Objekt vom Typ Microsoft. Azure. Commands. CosmosDB. PSUniqueKeyPolicy.
