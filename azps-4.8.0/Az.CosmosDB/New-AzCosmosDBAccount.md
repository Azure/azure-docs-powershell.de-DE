...
### -IpRule
Firewall-Unterstützung. Gibt den Satz von IP-Adressen oder IP-Adressbereichen in CIDR-Form an, der als zulässige Liste von Client-IPS für ein bestimmtes Daten Bank Konto hinzugefügt werden soll.
...
### -Server Version vom
Server Version vom, gültig nur bei MongoDB-Konten.
