...
### -Automatisch
Bool, um anzugeben, ob die Indizierungs Richtlinie automatisch ist
...
### -CompositePath
Array von Array von Objekten vom Typ Microsoft. Azure. Commands. CosmosDB. PSCompositePath
...
### -ExcludedPath
Array von Zeichenfolgen mit excludedPath (gibt einen Pfad in einem JSON-Dokument an, der im Azure Cosmos DB-Dienst ausgeschlossen werden soll)  Elemente.
...
### -IncludedPath
Array von Zeichenfolgen mit includedPath (gibt einen Pfad in einem JSON-Dokument an, der in die Azure Cosmos DB Service.)-Elemente eingeschlossen werden soll.
...
### -IndexingMode
Gibt den Indizierungs Modus an.
Mögliche Werte sind "konsistent", "faul", "keine".
...
### -SpatialSpec
Array von Objekten des Typs "Microsoft. Azure. Commands. CosmosDB. PSSpatialSpec"
