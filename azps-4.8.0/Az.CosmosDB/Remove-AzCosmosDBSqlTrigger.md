...
## Beschreibung
Mit dem Cmdlet **Remove-AzCosmosDBSqlTrigger** wird der CosmosDB-SQL-Trigger gelöscht, der den angegebenen ResourceGroupName, Accountname und DATABASENAME entspricht.
