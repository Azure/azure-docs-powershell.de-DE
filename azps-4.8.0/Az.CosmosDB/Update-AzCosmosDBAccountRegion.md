...
## Beschreibung
Aktualisieren von Bereichen eines CosmosDB-Kontos Der Speicherort kann entweder als Objekt vom Typ PSLocation oder als Zeichenfolgen mit dem Positionsnamen angegeben werden, die nach der Failover-Priorität geordnet sind.
Der locationobject-Parameter erwartet, dass die Liste der aktuellen Speicherorte (einschließlich der Failover-prioritiies) vom neuen LocationObjects entsprechend den neuen Speicherorten angefügt wird, die hinzugefügt werden sollen.
Location-Parameter erwartet die Liste des aktuellen Speicherorts (geordnet nach Failover-Priorität) und den neuen Speicherorten. Bitte beachten Sie, dass wir nur das Hinzufügen von Regionen unterstützen. Geben Sie entweder Location oder locationobject an.
...
### -Standort
Der Name des hinzuzufügenden Speicherorts.
