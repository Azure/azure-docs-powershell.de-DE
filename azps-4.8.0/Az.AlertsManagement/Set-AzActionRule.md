...
## Beschreibung
Mit " **AzActionRule** " wird eine Aktionsregel erstellt oder aktualisiert.
...
Mit diesem Cmdlet wird eine Aktionsregel für Unterdrückung mit einem Abonnement Bereich erstellt.
...
Mit diesem Cmdlet wird eine Aktionsregel für eine Aktionsgruppe mit einer Liste von Ressourcengruppen Bereich erstellt.
...
Mit diesem Cmdlet wird eine Aktionsregel für Diagnoseeinstellungen mit einem Ressourcenbereich erstellt.

## Parameter

### -ActionGroupId
Die Gruppen-ID der Aktion, die benachrichtigt werden soll.
...
Erwartetes Format-{ \<operation\> : \<comma separated list of values\> } für zB.
Enthält: Smartgroups
...
Erwartetes Format-{ \<operation\> : \<comma separated list of values\> } für zB.
Equals: Plattform, Protokollanalyse
...
### -ReccurenceType
Gibt die Dauer an, zu der die Unterdrückung angewendet werden soll.
...
### -ReccurentValue
Reccurent-Werte (falls zutreffend). Im Fall von Weekly- \[ 1, 2 \] bei monatlichen- \[ 1, 3, 5, 30\]
...
### -Scope
Durch trennzeichengetrennte Liste von Werten
...
### -SuppressionEndTime
Endzeit des Unterdrückungs Zeitraums.
Das Format 12/09/2018 06:00:00 + sollte im Fall von Reccurent Unterdrückung Schedule-einmal, täglich, wöchentlich oder monatlich erwähnt werden.
