...
### Beispiel 1: Entfernen der Datenbank "MySql" nach Name
```powershell
PS C:\> Remove-AzMySqlFlexibleServerDatabase -Name databasetest -ResourceGroupName PowershellMySqlTest -ServerName mysql-test
```

Mit diesem Cmdlet wird die MeineSql-Datenbank nach Name entfernt.

### Beispiel 2: Entfernen der Datenbank "MySql" nach Identität
```powershell
...
Diese Cmdlets entfernen die MeineSql-Datenbank nach Identität.
