...
### Beispiel 1: Starten des Servers nach Ressourcenname
```powershell
PS C:\> Start-AzMySqlFlexibleServer -ResourceGroupName PowershellMySqlTest -Name mysql-test
```

Starten des Servers nach Name

### Beispiel 2: Starten des Servers nach Identität
```powershell
...
Starten des Servers nach Identität
