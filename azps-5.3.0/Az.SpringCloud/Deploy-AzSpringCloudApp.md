...
### Beispiel 1: Bereitstellen von lokal kompilierten Jars nach Name.
```powershell
...
Stellen Sie lokal kompilierte Jar zum Service nach Name zur Verfügung.
...
### -JarPath
Der Pfad des Glases muss verdingt werden.
