...
### Beispiel 1: Aktualisieren der Cloudbereitstellung im Frühling nach Name.
```powershell
...
Aktualisieren Sie die Bereitstellung der Cloud im Frühling nach Name.

### Beispiel 2: Aktualisieren der Quell-Cloud-Bereitstellung von Pipe.
```powershell
...
Aktualisieren Sie die Bereitstellung der Cloud im Frühling von Pipe aus.
...
### -MemoryInGb
Erforderliche Speichergröße in GB
...
### -SourceArtifactSelector
Selektor für das Artefakt, das für die Bereitstellung für Projekte mit mehreren Modulen verwendet werden soll.
Dies sollte der relative Pfad zum Zielmodul/-projekt sein.
...
### -SourceRelativePath
Relativer Pfad des Speichers, in dem die Quelle gespeichert wird
