...
### Beispiel 1: Aktualisieren des Quell-Cloud-Diensts nach Name.
```powershell
...
Aktualisieren Sie den Clouddienst "Spring Spring" nach Name.

### Beispiel 2: Aktualisieren des Clouddiensts "Spring Spring" über Pipe.
```powershell
