...
### Beispiel 1: Quell-Cloud-Dienst nach Name erhalten
```powershell
...
### Beispiel 2: Listen Sie den ganzen Quell-Cloud-Dienst unter der Ressourcengruppe auf.
```powershell
...
Listen Sie den sämtlichen Quell-Cloud-Dienst unter der Ressourcengruppe auf.
