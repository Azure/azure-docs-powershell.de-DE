...
### Beispiel 1: Erhalten einer Liste der nicht aufgelösten abhängigen Ressourcen
```powershell
...
Hier erhalten Sie eine Liste der nicht aufgelösten abhängigen Ressourcen für eine Move-Auflistung.
