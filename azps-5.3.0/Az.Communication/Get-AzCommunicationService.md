...
## SYNOPSIS
Holen Sie sich den CommunicationService und dessen Eigenschaften.
...
### Beispiel 2: Erhalten von Informationen zu einer angegebenen Azure-Kommunikationsressource
```powershell
...
Gibt die Informationen für eine ACS-Ressource zurück, wenn ein übereinstimmender bereitgestellter Parameter gefunden wird.
