...
### Beispiel 1: Entfernen eines App-Konfigurationsspeichers
```powershell
PS C:\> Remove-AzAppConfigurationStore -Name appconfig-test03 -ResourceGroupName lucas-manual-test

```

Mit diesem Befehl wird ein App-Konfigurationsspeicher entfernt.

### Beispiel 2: Entfernen eines App-Konfigurationsspeichers
```powershell
