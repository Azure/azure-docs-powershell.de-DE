...
## BESCHREIBUNG
Das Remove-AzDataMigrationProject cmdlet entfernt ein Azure Database Migration Service-Projekt aus Azure. Durch das Bereitstellen des Parameters "DeleteRunningTask" werden alle Azure Database Migration Service-Aufgaben entfernt, die dem Projekt zugeordnet sind, das entfernt wird. 
...
Im vorstehenden Beispiel wird das Azure Database Migration Service-Projekt namens "myDMProject" basierend auf dem Namen als Eingabeparameter aus Azure entfernt.
...
Im vorstehenden Beispiel wird das Azure Database Migration Service-Projekt basierend auf dem Objekt "PSProject" als Eingabeparameter entfernt.
