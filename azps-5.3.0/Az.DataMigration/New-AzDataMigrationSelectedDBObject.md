...
## BESCHREIBUNG
Das New-AzDataMigrationSelectedDB erstellt ein Datenbankinformationsobjekt, das Informationen zu Quell- und Zieldatenbanken sowie die Tabellenzuordnungen für die Migration enthält. Dieses Cmdlet kann als Parameter mit dem cmdlet New-AzDataMigrationTask verwendet werden.
...
### -BackupFileShare
Dateifreigabe, in der die Quellserverdatenbankdateien für diese Datenbank gesichert werden sollten.
Verwenden Sie diese Einstellung, um Dateifreigabeinformationen für jede Datenbank außer Kraft zu setzen.
Verwenden Sie einen vollqualifizierten Domänennamen für den Server.
...
Festlegen, dass die Datenbank vor der Migration lesbar ist
...
Legen Sie den Migrationstyp SQL Server auf SQL DB Migration.
...
### -MigrateSqlServerSqlDbMi
Legen Sie den Migrationstyp SQL Server auf SQL DB MI Migration.
...
### -TableMap
Zuordnung von Quelle zu Zieltabellen
