...
## BESCHREIBUNG
Das New-AzDataMigrationTask erstellt eine Datenmigrationsaufgabe. Dieses Cmdlet übernimmt Parameter für den Vorgangstypenumerator, die Azure-Ressourcengruppe, den Namen des zugeordneten Azure-Datenbankmigrationsdiensts und Project als Eingabe. 
...
### -MigrationValidation 
Aufgabenantwortobjekt nach Überprüfungsaufruf, optional, aber empfohlen.
...
### -Wait
Gibt an, ob auf den Abschluss eines Vorgangs gewartet werden soll. Wenn das Kennzeichen festgelegt ist, überprüft die Überprüfung alle ein Sekunden, bis die Aufgabe abgeschlossen ist, und kehren Sie zu den Aufgabeneigenschaften zurück, in denen die Ausgabe oder der Fehler überprüft werden kann. 
```yaml
