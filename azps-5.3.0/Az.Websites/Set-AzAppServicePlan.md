...
### Beispiel 1: Ändern eines App -Serviceplans
```powershell
PS C:\>Set-AzAppServicePlan -ResourceGroupName "Default-Web-WestUS" -Name "ContosoASP" -PerSiteScaling $true
```

Mit diesem Befehl wird die Option "PerSiteScaling" für den App -Dienstplan namens "ContosoASP" auf "true" festgelegt, der zur Ressourcengruppe "Default-Web-WestUS" gehört.
