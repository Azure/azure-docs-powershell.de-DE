...
## BESCHREIBUNG
Das **Cmdlet "New-AzWebAppDatabaseBackupSetting"** erstellt eine neue Azure Web App-Sicherungseinstellung.
...
Erstellt eine Datenbanksicherungseinstellung (Verbindungszeichenfolge) vom Typ SqlAzure für die angegebene App "ContosoWebApp", die sich innerhalb der Ressourcengruppe "Default-Web-WestUS" befindet.

### Beispiel 2

Das New-AzWebAppDatabaseBackupSetting A0 erstellt eine neue Azure Web App-Sicherungseinstellung. (automatisch generiert)
...
### -DatabaseType
Datenbanktyp (z. B. "SqlAzure" oder "MySql")
