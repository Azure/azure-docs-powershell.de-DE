...
## BESCHREIBUNG
Erstellt ein Objekt, das einen Azure -Speicherpfad repräsentiert, der in einer Web App bereitgestellt werden soll.
...
Beispiel: myfilestorageaccount.file.core.windows.net
...
### -MountPath
Pfad im Container, in dem die von ShareName angegebene Freigabe verfügbar gemacht wird
...
### -Name
Der Bezeichner der Azure Storage-Eigenschaft.
muss innerhalb der Web App oder des Slot eindeutig sein
...
### -ShareName
Name der Freigabe, die im Container angezeigt werden soll
...
### -Type
Typ des Azure Storage-Kontos.
Windows Containers unterstützt nur Azure-Dateien.
