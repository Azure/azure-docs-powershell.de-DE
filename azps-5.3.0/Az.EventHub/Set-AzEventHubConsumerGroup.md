...
## BESCHREIBUNG
Das Set-AzEventHubConsumerGroup aktualisiert die angegebene Consumergruppe "Ereignishubs".
...
Legt die Benutzermetadaten der Consumergruppe \` "MyConsumerGroupName" auf \` "Testen" fest.
