...
## BESCHREIBUNG
Das Set-AzEventHubAuthorizationRule aktualisiert die angegebene Autorisierungsregel für den angegebenen Ereignishub.
...
Aktualisiert die Autorisierungsregel "MyAuthRuleName", um dem Ereignishub "MyEventHubName" Die Berechtigung "Verwalten" zu gewähren, die durch den \` \` \` \` Namespace \` "MyNamespaceName" begrenzt \` ist.
