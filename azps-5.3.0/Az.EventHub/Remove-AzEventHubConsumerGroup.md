...
## BESCHREIBUNG
Das Remove-AzEventHubConsumerGroup cmdlet entfernt und löscht die angegebene Consumergruppe aus dem angegebenen Ereignishub.
...
Löscht die Consumergruppe \` "MyConsumerGroupName" aus dem \` Ereignishub \` "MyEventHubName", der auf den \` \` Namespace "MyNamespaceName" \` begrenzt ist.
...
### Beispiel 5: ResourceId mithilfe der Zeichenfolge
```powershell
