...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzApiManagementGatewayHostnameConfiguration"** entfernt eine Hostnamenkonfiguration aus dem vorhandenen Gateway.

## BEISPIELE

### Beispiel 1: Entfernen einer vorhandenen Konfiguration des Hostnamens eines Gateways
```powershell
...
Dieser Befehl entfernt eine vorhandene Konfiguration des Hostnamens des Gateways und fordert den Benutzer nicht zur Bestätigung auf.
...
Bezeichner der vorhandenen Konfiguration des Gatewayhostnamens.
Dieser Parameter ist erforderlich.
...
### -InputObject
Instanz von PsApiManagementGatewayHostnameConfiguration. Dieser Parameter ist erforderlich.
...
### -ResourceId
Arm ResourceId der GatewayHostnameConfiguration. Dieser Parameter ist erforderlich.
