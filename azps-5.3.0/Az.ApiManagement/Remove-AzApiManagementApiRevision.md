...
## BESCHREIBUNG
Das Cmdlet **"Remove-AzApiManagementApiRevision"** entfernt eine bestimmte API-Überarbeitung.

## BEISPIELE

### Beispiel 1: Entfernen einer API-Überarbeitung
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Remove-AzAzureRmApiManagementApiRevision -Context $apimContext -ApiId "echo-api" -ApiRevision "2"
```

Mit diesem Befehl wird die `2` Überarbeitung der API aus dem `echo-api` API-Verwaltungsdienst entfernt.

### Beispiel 2

Mit diesem Befehl wird die 2-Version der API-Echo-API aus dem API-Verwaltungsdienst entfernt. (automatisch generiert)
...
### -ApiRevision
Bezeichner der API-Überarbeitung. Dieser Parameter ist erforderlich.
