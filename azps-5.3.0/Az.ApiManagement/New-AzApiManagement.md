...
### Beispiel 2: Erstellen eines Standarddiensts mit drei Einheiten
```powershell
...
Dieser Befehl erstellt einen Premium-API-Verwaltungsdienst in einem virtuellen Azure-Netzwerk-Subnetz, das einen extern gerichteten Gatewayendpunkt mit einer Masterregion in den USA hat.
...
- "Intern" (ApiManagement Deployment wird in einem virtuellen Netzwerk eingerichtet, das einen Endpunkt mit Intranetaus gerichtet hat)
