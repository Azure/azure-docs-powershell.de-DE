...
## BESCHREIBUNG
Das **Cmdlet "New-AzApiManagementLogger"** erstellt einen Azure API-Verwaltungsprotokollger. 

## BEISPIELE

### Beispiel 1: Erstellen eines Protokollgers
```powershell
...
### -ConnectionString
Gibt eine Azure-Ereignishubs-Verbindungszeichenfolge an, die mit folgendem beginnt: `Endpoint=endpoint and key from Azure classic portal`
Der Schlüssel mit den Senderechten in der Verbindungszeichenfolge muss konfiguriert werden.
...
### -IsBuffered
Gibt an, ob die Datensätze im Protokollger vor der Veröffentlichung gepuffert werden.
