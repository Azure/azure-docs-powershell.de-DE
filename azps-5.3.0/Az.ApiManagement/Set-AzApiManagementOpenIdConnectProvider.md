...
## BESCHREIBUNG
Das **Cmdlet Set-AzApiManagementOpenIdConnectProvider** ändert einen OpenID Connect-Anbieter in Azure API Management.

## BEISPIELE

### Beispiel 1: Ändern des geheimen Clientgeheimnis für einen Anbieter
```powershell
...
Dieser Befehl ändert den Anbieter mit der ID OICProvider01.
Der Befehl gibt einen geheimen Clientgeheimnis für den Anbieter an.

### Beispiel 2

Ändert einen OpenID Connect-Anbieter. (automatisch generiert)
...
### -ClientSecret
Gibt den geheimen Clientgeheimnis der Entwicklerkonsole an.
...
Gibt eine ID für den Anbieter an, den dieses Cmdlet ändert.
...
### -PassThru
Gibt an, dass dieses Cmdlet den von diesem Cmdlet geänderten **PsApiManagementOpenIdConnectProvider** zurückgibt.
