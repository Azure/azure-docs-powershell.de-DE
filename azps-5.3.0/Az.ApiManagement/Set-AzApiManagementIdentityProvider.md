...
Das Cmdlet aktualisiert den geheimen Clientgeheimnis des Facebook-Identitätsanbieters.
...
Dabei handelt es sich um die App-ID für die Facebook-Anmeldung, die Client-ID für die Google-Anmeldung, die App-ID für Microsoft.
...
### -PassThru
Gibt an, dass dieses Cmdlet den von diesem Cmdlet geänderten  **PsApiManagementIdentityProvider** zurückgibt.
...
### -Type
Id eines vorhandenen Identitätsanbieters.
Dieser Parameter ist erforderlich.
