...
### Beispiel 1: Mandantenzugriff aktivieren
```
...
Geben Sie einen Wert für $True, den Sie aktivieren oder $False deaktivieren möchten.
...
### -PassThru
Gibt an, dass dieses Cmdlet das von diesem Cmdlet geänderte **"PsApiManagementAccessInformation"** zurückgibt.
