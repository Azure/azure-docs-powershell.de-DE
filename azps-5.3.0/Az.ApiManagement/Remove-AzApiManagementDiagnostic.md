...
## BESCHREIBUNG
Das Cmdlet **"Remove-AzApiManagementDiagnostic"** entfernt die diagnoseentität, die aus dem globalen Bereich oder einem `DiagnosticId` Bereich angegeben `ApiId` ist.
...
In diesem Beispiel wird das `applicationinsights` Diagnosetool aus dem Api-Verwaltungsdienst entfernt.
