...
### Beispiel 2: Erstellen eines Produkts, für das ein Abonnement und eine Genehmigung erforderlich sind
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
Mit diesem Befehl wird der Benachrichtigungszeitraum auf 10 Tage definiert.
...
Dieser Parameter ist standardmäßig auf **$False.**
