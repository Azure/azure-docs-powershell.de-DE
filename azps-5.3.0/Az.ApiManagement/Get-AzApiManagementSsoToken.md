...
## BESCHREIBUNG
Das **Cmdlet "Get-AzApiManagementSsoToken"** gibt einen Link (URL) zurück, der ein SSO (Single Sign-On)-Token zu einem bereitgestellten Verwaltungsportal eines API-Verwaltungsdiensts enthält.
