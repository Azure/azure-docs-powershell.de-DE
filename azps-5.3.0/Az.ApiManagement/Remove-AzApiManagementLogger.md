...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzApiManagementLogger"** entfernt einen Azure API Management **Logger.**

## BEISPIELE

### Beispiel 1: Entfernen eines Protokollgers
```
...
### -LoggerId
Gibt die ID des zu entfernenden Loggers an.
