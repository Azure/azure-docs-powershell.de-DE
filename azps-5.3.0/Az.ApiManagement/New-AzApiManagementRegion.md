...
Erstellt einen ApiManagement-Dienst von "External VpnType" in der Region "USA, Westen" mit einer zusätzlichen Region in der Mitte der USA.

## PARAMETERS

### -Capacity
SKU-Kapazität der zusätzlichen Region des Azure API-Verwaltungsdiensts.
