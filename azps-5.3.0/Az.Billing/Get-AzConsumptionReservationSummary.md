...
### Beispiel 2: Erhalten von Reservierungszusammenfassungen mit Reservierungsauftrags-ID und Reservierungs-ID für monatliches Körnern
```powershell
...
### Beispiel 3: Erhalten von Reservierungszusammenfassungen mit der Reservierungsauftrags-ID für tagesdurchschnittliches Körnerdatum
```powershell
