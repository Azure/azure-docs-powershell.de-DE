...
## BESCHREIBUNG
Das **Cmdlet "Get-AzConsumptionReservationDetail"** ruft Reservierungsdetails für den angegebenen Datumsbereich ab.

## BEISPIELE

### Beispiel 1: Erhalten von Reservierungsdetails mit Reservierungsauftrags-ID für den angegebenen Datumsbereich
```powershell
...
### Beispiel 2: Erhalten von Reservierungsdetails mit Reservierungsauftrags-ID und Reservierungs-ID für den angegebenen Datumsbereich
```powershell
...
### -EndDate
Die Enddaten (JJJJ-MM-DD in UTC) der Reservierungsdetails.
...
### -StartDate
Die Startdaten (JJJJ-MM-DD in UTC) der Reservierungsdetails.
