...
### Beispiel 1: Neustarten des PostgreSql-Servers nach Ressourcengruppe und Servername
```powershell
PS C:\> Restart-AzPostgreSqlServer -ResourceGroupName PostgreSqlTestRG -Name PostgreSqlTestServer

```

Mit diesem Cmdlet wird der Server von PostgreSql nach Ressourcengruppe und Servername neu gestartet.
...
Diese Cmdlets starten den Server von PostgreSql nach Identität neu.
