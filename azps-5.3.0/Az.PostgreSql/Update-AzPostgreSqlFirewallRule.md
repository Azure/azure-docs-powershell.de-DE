...
### Beispiel 1: Aktualisieren der PostgreSql-Firewallregel nach Name
```powershell
...
Dieses Cmdlet aktualisiert die PostgreSql-Firewallregel nach Name.

### Beispiel 2: Aktualisieren der PostgreSql-Firewallregel nach Identität.
```powershell
...
Diese Cmdlets aktualisieren die PostgreSql-Firewallregel nach Identität.

### Beispiel 3: Aktualisieren der PostgreSql-Firewallregel von "-ClientIPAddress".
```powershell
...
Diese Cmdlets aktualisieren die PostgreSql-Firewallregel von "-ClientIPAddress".
