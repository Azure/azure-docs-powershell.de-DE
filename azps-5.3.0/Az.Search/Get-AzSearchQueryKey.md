...
## BESCHREIBUNG
Das **Cmdlet "Get-AzSearchQueryKey"** ruft die Abfrageschlüssel des Azure -Suchdiensts ab.
...
Das Beispiel ruft alle Abfrageschlüssel des Azure Search Service(en) ab.
