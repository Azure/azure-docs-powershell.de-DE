...
## BESCHREIBUNG
Das **Cmdlet "Start-AzDataFactoryV2Trigger"** startet einen Trigger in einer Datenfactory. Wenn sich der Trigger im Zustand "Stopped" befindet, startet das Cmdlet den Trigger und ruft schließlich Pipelines basierend auf seiner Definition auf. Wenn sich der Trigger bereits im Zustand "Gestartet" befindet, hat dieses Cmdlet keine Auswirkung. Wenn der Parameter "Force" angegeben ist, fordert das Cmdlet vor dem Starten des Triggers keine Eingabeaufforderung an.
...
Startet einen Trigger namens "ScheduledTrigger" in der Daten factory "WikiADF".
