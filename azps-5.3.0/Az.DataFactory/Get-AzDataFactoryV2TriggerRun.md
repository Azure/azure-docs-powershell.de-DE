...
## BESCHREIBUNG
Der **Befehl "Get-AzDataFactoryV2TriggerRun"** gibt ausführliche Informationen zu Triggerläufen für den angegebenen Trigger im angegebenen Zeitrahmen zurück.

## BEISPIELE

### Beispiel 1: Informationen zur Triggerauslösung
```
...
Dieser Befehl zeigt Informationen zu "WikiTrigger"-Ausgeführten in der Factory "WikiADF", die zwischen "2017-09-01" und "2019-09-30" begonnen hat.
...
Die Zeit, zu oder nach der die Ausführung des Triggers im ISO8601-Format gestartet wurde.
...
Die Zeit, zu der oder vor der die Ausführung des Triggers im ISO8601-Format gestartet wurde.
