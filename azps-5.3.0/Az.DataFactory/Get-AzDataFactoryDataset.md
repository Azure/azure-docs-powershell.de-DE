...
## BESCHREIBUNG
Das **Cmdlet "Get-AzDataFactoryDataset"** ruft Informationen zu Datasets in Azure Data Factory ab.
...
Dieser Befehl ruft Informationen zu allen Datasets in der Daten factory namens WikiADF ab.

### Beispiel 2: Erhalten von Informationen zu einem bestimmten Dataset
```
...
Dieser Befehl ruft Informationen über das Dataset mit dem Namen DAWikipediaClickEvents in der Daten factory namens WikiADF ab.

### Beispiel 3: Den Speicherort für ein bestimmtes Dataset erhalten
```
...
Dieser Befehl ruft Informationen für das Dataset mit dem Namen DAWikipediaClickEvents in der Daten factory  namens WikiADF ab und verwendet dann die Standardmäßige Punktformatierung, um den Mit diesem Dataset verknüpften Speicherort anzuzeigen.
Weisen Sie alternativ die Ausgabe des **Cmdlets "Get-AzDataFactoryDataset"** einer Variablen zu, und verwenden Sie dann die Punkt-Notation, um die Standorteigenschaft anzuzeigen, die dem in dieser Variable gespeicherten Datasetobjekt zugeordnet ist.

## PARAMETERS

### -DataFactory
Gibt ein **"PSDataFactory"-Objekt** an.
Dieses Cmdlet ruft Datasets ab, die zu der von diesem Parameter angegebenen Daten factory gehören.
