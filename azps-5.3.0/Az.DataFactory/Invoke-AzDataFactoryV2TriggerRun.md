...
## BESCHREIBUNG
Der **Befehl "Invoke-AzDataFactoryV2TriggerRun"** startet eine weitere Instanz eines Triggers, der mit einer neuen Trigger-Ausführungs-ID ausgeführt wird.
...
### -PassThru
Bei Angabe des Cmdlets "true" für den Fall, dass der Vorgang erfolgreich ist.
