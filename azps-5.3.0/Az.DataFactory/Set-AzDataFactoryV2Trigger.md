...
Erstellen Sie einen neuen Trigger namens "ScheduledTrigger" in der Daten factory "WikiADF". Der Trigger wird im Zustand "Stopped" erstellt, d. h., er wird nicht sofort gestartet. Ein Trigger kann mit dem `Start-AzDataFactoryV2Trigger` Cmdlet gestartet werden.
