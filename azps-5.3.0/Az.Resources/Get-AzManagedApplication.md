...
## SYNOPSIS
Bekommt verwaltete Anwendungen
...
## BESCHREIBUNG
Das **Cmdlet "Get-AzManagedApplication"** ruft verwaltete Anwendungen ab

## BEISPIELE

### Beispiel 1: Alle verwalteten Anwendungen unter einer Ressourcengruppe erhalten
```
