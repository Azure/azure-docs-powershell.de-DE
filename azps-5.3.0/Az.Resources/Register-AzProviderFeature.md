...
## BESCHREIBUNG
Das **Cmdlet "Register-AzProviderFeature"** registriert ein Azure-Anbieterfeature in Ihrem Konto.
...
Dadurch wird Ihrem Konto das Feature "AllowApplicationSecurityGroups" für Microsoft.Network hinzufügt.
...
### -FeatureName
Gibt den Namen des Features an, das von diesem Cmdlet registriert wird.
...
### -ProviderNamespace
Gibt einen Namespace an, für den dieses Cmdlet ein Anbieterfeature registriert.
