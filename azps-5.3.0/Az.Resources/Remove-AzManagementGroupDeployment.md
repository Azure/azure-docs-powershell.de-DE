...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzManagementGroupDeployment"** entfernt eine Azure-Bereitstellung für eine Verwaltungsgruppe und alle zugehörigen Vorgänge.
...
Mit diesem Befehl wird die Bereitstellung "RolesDeployment" bei der Verwaltungsgruppe "myMG" entfernt.

### Beispiel 2: Erhalten und Entfernen einer Bereitstellung
```
