...
### Beispiel 1: Entfernen der Richtliniensatzdefinition nach Ressourcen-ID
```
...
Der Befehl speichert sie in der $PolicySetDefinition Variable.
Mit dem zweiten Befehl wird die von der Eigenschaft **"ResourceId"** des $PolicySetDefinition.
...
### -InputObject
Das zu entfernende Richtliniensatzdefinitionsobjekt, das von einem anderen Cmdlet ausgegeben wurde.
...
### -ManagementGroupName
Der Name der Verwaltungsgruppe der zu löschende Richtliniensatzdefinition.
...
### -SubscriptionId
Die Abonnement-ID der zu löschende Definition des Richtliniensets.
