...
Wenn Sie einer bestimmten Ressourcengruppe in einem Abonnement Zugriff gewähren möchten, weisen Sie dem Ressourcengruppenbereich eine Rolle zu.
...
c.
ResourceName, ResourceType, ResourceGroupName und (optional) ParentResource – zum Angeben einer bestimmten Ressource innerhalb einer Ressourcengruppe, für die der Zugriff gewährt werden soll.
...
### -ApplicationId
Die Anwendungs-ID des Dienstpreises
