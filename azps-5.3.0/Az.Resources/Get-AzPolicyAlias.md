...
Richtlinienaliase werden von der Azure-Richtlinie verwendet, um auf Ressourcentypeigenschaften zu verweisen.
...
Listet alle Anbieterressourcentypen auf, deren Ressourcentyp "virtuell" entspricht, einschließlich der ohne Aliase.
...
Listet alle Anbieterressourcentypen auf, die einen Alias enthalten, der mit "virtuell" übereinstimmen.
...
### -ListAvailable
Wird in die Ausgabe übereinstimmender Elemente mit und ohne Aliase ein.
...
* Zusätzliche Eigenschaften sind in der Ausgabe verfügbar und können angezeigt werden, indem die Ausgabe in die Ausgabe pipiert `Format-List` wird. Zum Beispiel: `Get-AzPolicyAlias -NamespaceMatch 'Web' -ResourceTypeMatch site -PathMatch cert | Format-List`
