...
### Beispiel 3: Richtliniensatzdefinition aus dem Abonnement nach Name erhalten
```
...
### Beispiel 4: Alle benutzerdefinierten Richtliniensatzdefinitionen von der Verwaltungsgruppe erhalten
```
