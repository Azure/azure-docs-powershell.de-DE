...
## BESCHREIBUNG
Exportiert eine bestimmte Version einer Vorlagenspezifikation in das lokale Dateisystem.
...
Exportiert Version 'v1.0' der Vorlagenspezifikation mit dem Namen 'MyTemplateSpec' innerhalb der Ressourcengruppe 'myRG' in den lokalen Ausgabeordner "v1".
...
Exportiert Version 'v1.0' der Vorlagenspezifikation mit dem Namen 'MyTemplateSpec' innerhalb der Ressourcengruppe 'myRG' von subscription subId in den lokalen Ausgabeordner \{ \} "v1".
