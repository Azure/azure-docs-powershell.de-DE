...
## BESCHREIBUNG
Das **Cmdlet "Get-AzResourceProvider"** erhält einen Azure-Ressourcenanbieter.

## BEISPIELE

### Beispiel 1: Alle Ressourcenanbieter erhalten, die mit dem aktuellen Abonnement registriert sind
...
### Beispiel 2: Alle Ressourcenanbieterdetails aus dem angegebenen ProviderNamespace erhalten
...
### Beispiel 3: Alle Ressourcenanbieterdetails aus dem angegebenen "ProviderNamespace"-Array erhalten
...
### -ListAvailable
Gibt an, dass dieser Vorgang alle verfügbaren Ressourcenanbieter erhält.
