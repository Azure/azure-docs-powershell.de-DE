...
## BESCHREIBUNG
Das New-AzADSpCredential cmdlet kann zum Hinzufügen neuer Anmeldeinformationen oder zum Rollup der Anmeldeinformationen für einen Dienstprinzipal verwendet werden.
Der Dienstprinzipal wird durch Angabe der Objekt-ID oder des Dienstprinzipalnamens identifiziert.

## BEISPIELE

### Beispiel 1: Erstellen neuer Anmeldeinformationen für den Dienstprinzipal mithilfe eines generierten Kennworts
...
Dem vorhandenen Dienstprinzipal wird ein neues Kennwort mit der Objekt-ID '1f99cf81-0146-4f4e-beae-2007d0668476' hinzugefügt.

### Beispiel 2: Erstellen neuer Anmeldeinformationen für den Dienstprinzipal mithilfe eines Zertifikats
...
### Beispiel 3: Erstellen neuer Anmeldeinformationen für den Dienstprinzipal mithilfe der Piping
...
Ruft den Dienstprinzipal mit der Objekt-ID '1f99cf81-0146-4f4e-beae-2007d0668476' ab und gibt diese an die New-AzADSpCredential weiter, um eine neue Dienstprinzipalanmeldeinformationen für diesen Dienstprinzipal mit einem generierten Kennwort zu erstellen.
...
Der Standardmäßige Enddatumswert liegt ein Jahr nach heute.
Bei Anmeldeinformationen vom Typ "asymmetrischer Art" muss dies auf das Datum oder vor dem Datum festgelegt werden, an dem das X509-Zertifikat gültig ist.
...
### -ObjectId
Die Objekt-ID des Dienstprinzipal, dem die Anmeldeinformationen hinzugefügt werden.
...
Der Name (SPN) des Dienstprinzipal, dem die Anmeldeinformationen hinzugefügt werden.
...
Bei Anmeldeinformationen vom Typ "asymmetrischer Art" muss dies auf das Datum oder nach dem Datum festgelegt werden, ab dem das X509-Zertifikat gültig ist.
...
### Microsoft.Azure.Commands.ActiveDirectory.WAHLDServicePrincipal
...
### Microsoft.Azure.Commands.Resources.Models.Authorization.STARBDCredentialWrapper
