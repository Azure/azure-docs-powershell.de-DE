...
Es kann potenziell geheime Daten protokollieren und verfügbar machen, z. B. Kennwörter, die in der Ressourceneigenschaft verwendet werden, oder listKeys-Vorgänge, die beim Abrufen der **Bereitstellungsvorgänge** zurückgegeben werden.
