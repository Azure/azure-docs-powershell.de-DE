...
## BESCHREIBUNG
Das Remove-AzADAppCredential cmdlet kann verwendet werden, um im Falle eines Kompromisses oder als Teil des Ablaufs des Anmeldeinformationsschlüsselrollovers einen Anmeldeinformationsschlüssel aus einer Anwendung zu entfernen.
Die Anwendung wird durch Angabe der Objekt-ID oder der AppId identifiziert.
Die zu entfernende Anmeldeinformationen werden anhand ihrer Schlüssel-ID identifiziert.
...
### Beispiel 3: Entfernen aller Anmeldeinformationen mithilfe der Piping

```powershell
PS C:\> Get-AzADApplication -ObjectId 7663d3fb-6f86-4352-9e6d-cf9d50d5ee82 | Remove-AzADAppCredential
```

Ruft die Anwendung mit der Objekt-ID '7663d3fb-6f86-4352-9e6d-cf9d50d5ee82' ab und gibt diese an das cmdlet Remove-AzADAppCredential weiter und entfernt alle Anmeldeinformationen aus dieser Anwendung.
...
Die Schlüssel-IDs für die Anwendung können mit dem cmdlet Get-AzADAppCredential ermittelt werden.
