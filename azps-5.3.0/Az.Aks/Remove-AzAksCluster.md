...
### Löschen eines vorhandenen verwalteten Kubernetes-Cluster
```powershell
...
### -Force
Entfernen des verwalteten Cluster "Kubernetes" ohne Eingabeaufforderung
...
### -PassThru
Gibt "true" zurück, wenn das Löschen erfolgreich ist.
