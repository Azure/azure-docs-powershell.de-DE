...
### Erstellen des Windows Server-Containers auf einem AKS
```powershell
...
### -ClusterObject
Geben Sie das Clusterobjekt an, in dem ein Knotenpool erstellt werden soll.
...
### -Force
Erstellen eines Knotenpools auch dann, wenn er bereits vorhanden ist
...
### -OsType
OsType, der zum Angeben des Betriebssystemtyps verwendet wird.
...
ScaleSetEvictionPolicy zum Angeben der Entfernungsrichtlinie für den Skalierungssatz des virtuellen Computers mit niedriger Priorität.
...
### -ScaleSetPriority
ScaleSetPriority zum Angeben der Priorität des Skalierungsskalens für einen virtuellen Computer.
Standardmäßig auf "Normal" festgelegt.
...
### -VmSetType
Stellt Die Typen eines Knotenpools dar.
