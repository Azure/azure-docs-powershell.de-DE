...
## BESCHREIBUNG
Das **Cmdlet "Add-AzDataLakeStoreFirewallRule"** fügt dem angegebenen Data Lake Store-Konto eine Firewallregel hinzu.
...
Dadurch wird eine neue Firewallregel namens "MyRule" im Konto "ContosoADL" mit einem IP-Bereich von 127.0.0.1 bis 127.0.0.2 erstellt.
...
### -ResourceGroupName
Name der Ressourcengruppe, unter der die Firewallregel hinzugefügt werden soll.
