...
Sie können die Datenträgernutzung und die Verwendung des ACL für alle Unterverzeichnisse und Dateien unter "/a" erhalten. IncludeFile stellt sicher, dass die Verwendung auch für Dateien gemeldet wird
...
### -HideConsistentAcl
Zeigen Sie keine Verzeichnisunterstruktur an, wenn die ACLs in der gesamten Unterstruktur gleich sind. Dadurch sind nur die Pfade leichter zu erkennen, bis zu denen sich die ACLs unterscheiden. Wenn beispielsweise alle Dateien und Ordner unter "/a/b" identisch sind, zeigen Sie nicht die Unterstruktur "/a/b" an, und geben Sie einfach "/a/b" mit "True" in der Spalte "Consistent ACL" ein, wenn "IncludeFiles" nicht festgelegt ist, da eine konsistente Acl nicht ermittelt werden kann, ohne dass Acl für die Dateien abgerufen werden.
...
### -SaveToAdl
Wenn sie übergeben wird, wird die Dumpdatei in ADL gespeichert.
