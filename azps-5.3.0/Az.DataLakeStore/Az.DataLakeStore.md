...
## Beschreibung
Die Themen in diesem Abschnitt dokumentieren die Azure -PowerShell-Cmdlets für Azure Data Lake Store im Azure Resource Manager (ARM)-Framework. Die Cmdlets sind im Namespace "Microsoft.Azure.Commands.DataLakeStore" vorhanden. Diese Cmdlets funktionieren nur bei Azure Data Lake Storage Gen1-Konten.
