...
### Beispiel 1: Erhalten der untergeordneten Elemente für einen Ordner
```
PS C:\>Get-AzDataLakeStoreChildItem -AccountName "ContosoADL" -Path "/MyFiles/"
```

Dieser Befehl ruft die untergeordneten Elemente für den Ordner "MyFiles" ab.
...
### -Path
Gibt den Data Lake Store-Pfad des Ordners an, beginnend mit dem Stammverzeichnis (/).
