...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzDataLakeStoreTrustedIdProvider"** entfernt den angegebenen vertrauenswürdigen Identitätsanbieter im angegebenen Data Lake Store.

## BEISPIELE

### Beispiel 1: Entfernen eines vertrauenswürdigen Identitätsanbieters
```
...
### -Konto
Das Data Lake Store-Konto, aus dem der vertrauenswürdige Identitätsanbieter entfernt werden soll
...
### -ResourceGroupName
Gibt den Namen der Ressourcengruppe an, die das Konto enthält, von dem der vertrauenswürdige Identitätsanbieter entfernt werden soll.
