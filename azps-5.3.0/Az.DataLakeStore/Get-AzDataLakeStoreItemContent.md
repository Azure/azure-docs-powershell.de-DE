...
Mit diesem Befehl wird der Inhalt der Datei MyFile.txt contosoADL-Konto gespeichert.

### Beispiel 2: Erstellen der ersten beiden Zeilen einer Datei
```
PS C:\>Get-AzDataLakeStoreItemContent -AccountName "ContosoADL" -Path "/MyFile.txt" -Head 2
```

Mit diesem Befehl werden die ersten beiden zeilenweise getrennten Zeilen in der Datei MyFile.txt ContosoADL-Konto.
...
### -Head
Die Anzahl der Zeilen (durch Trennzeichen in neuer Zeile) vom Anfang der Datei bis zur Vorschau. Wenn in den ersten 4 MB daten keine neue Zeile gefunden wird, werden nur diese Daten zurückgegeben.
