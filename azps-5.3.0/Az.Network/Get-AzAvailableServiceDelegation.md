...
## BESCHREIBUNG
Mit **dem Cmdlet "Get-AzAvailableServiceDelegation"** können Sie alle verfügbaren Dienstdienste für ein Subnetz am angegebenen Standort abrufen. Dieses Cmdlet beschreibt *nicht,* welche Subnetze in einem einzelnen Subnetz vorhanden sein können.

## BEISPIELE

### 1: Abrufen aller verfügbaren Dienste
```powershell
