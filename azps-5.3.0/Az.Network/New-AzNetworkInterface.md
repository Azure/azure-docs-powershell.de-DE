...
Der dritte Befehl erstellt eine Netzwerkschnittstelle namens "NetworkInterface1", die die in der Variablen namens "$IPconfig" gespeicherte Netzwerkschnittstellen-IP-Konfiguration $IPconfig.
...
### -Force
Erzwingt die Erstellung der Netzwerkschnittstelle auch dann, wenn bereits eine Netzwerkschnittstelle mit demselben Namen vorhanden ist.
