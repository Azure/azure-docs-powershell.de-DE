...
## BESCHREIBUNG
**Das Cmdlet "New-AzApplicationGatewayIdentity"** erstellt ein Anwendungsgateway-Identitätsobjekt.
...
In diesem Beispiel erstellen wir eine vom Benutzer zugewiesene Identität und verweisen dann in einem Identitätsobjekt darauf, das mit dem Anwendungsgateway verwendet wird.
