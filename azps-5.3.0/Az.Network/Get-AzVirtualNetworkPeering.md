...
### Beispiel 1: Erstellen eines Peerings zwischen zwei virtuellen Netzwerken
```
...
### Beispiel 2: Alle Peerings im virtuellen Netzwerk erhalten
```
...
### -VirtualNetworkName
Gibt den Namen des virtuellen Netzwerks an, den dieses Cmdlet erhält.
