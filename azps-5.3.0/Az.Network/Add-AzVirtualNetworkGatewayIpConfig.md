...
## BESCHREIBUNG
Das **Cmdlet "Add-AzVirtualNetworkGatewayIpConfig"** fügt einem virtuellen Netzwerkgateway eine IP-Konfiguration hinzu.
...
### -Name
Gibt den Namen der hinzuzufügenden Gateway-IP-Konfiguration an.
...
Dieses Cmdlet ändert das von Ihnen **festgelegte PSVirtualNetworkGateway-Objekt.**
Sie können das cmdlet Get-AzVirtualNetworkGateway verwenden, um ein **PSVirtualNetworkGateway-Objekt abzurufen.**
