...
```
Im vorstehenden Beispiel wird eine neue Routingkonfiguration erstellt und statische Routen in der Routingkonfiguration mit dem nächsten Hop als angegebene IP-Adresse erstellt. Diese Routingkonfiguration kann dann als Parameter "-RoutingConfiguration" New-AzVirtualHubVnetConnection an den Befehl "New-AzVirtualHubVnetConnection übergeben werden.
...
Das virtuelle Remotenetzwerk, mit dem diese virtuelle Hubnetzwerkverbindung verbunden ist.
