...
## SYNOPSIS
Dieser Befehl ermöglicht es den Benutzern, zusätzlich zu einigen zusätzlichen Einstellungen, die Benutzer möglicherweise konfigurieren müssen, z. B. einige Stammzertifikate, das Vpn-Profilpaket basierend auf vorkonfigurierten Vpn-Einstellungen auf dem VPN-Gateway zu erstellen.
...
## BESCHREIBUNG
dies ermöglicht es den Benutzern, zusätzlich zu einigen zusätzlichen Einstellungen, die Benutzer möglicherweise konfigurieren müssen, z. B. einige Stammzertifikate, das Vpn-Profilpaket basierend auf vorkonfigurierten Vpn-Einstellungen auf dem VPN-Gateway zu erstellen.
