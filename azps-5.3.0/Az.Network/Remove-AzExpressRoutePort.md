...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzExpressRoutePort"** entfernt einen ExpressRoutePort.
...
Entfernt die Ressource "ExpressRoutePort" mit "ResourceId" $id.
