...
## SYNOPSIS
Ruft die Konfiguration eines privaten Links für ein Anwendungsgateway ab.
...
## BESCHREIBUNG
Das **Cmdlet "Get-AzApplicationGatewayPrivateLinkConfiguration"** ruft die Konfiguration eines privaten Links eines Anwendungsgateways ab.

## BEISPIELE

### Beispiel 1: Erhalten einer angegebenen Konfiguration für private Links
```powershell
...
Der zweite Befehl ruft die Konfiguration für private Links mit dem Namen "privateLinkConfig01" aus $AppGw und speichert sie in der $PrivateLinkConfiguration Variable.

### Beispiel 2: Erhalten einer Liste der Konfiguration privater Links
```powershell
PS C:\>$AppGw = Get-AzApplicationGateway -Name "ApplicationGateway01" -ResourceGroupName "ResourceGroup01"
...
Der erste Befehl ruft ein Anwendungsgateway namens ApplicationGateway01 aus der Ressourcengruppe "ResourceGroup01" ab und speichert es in der $AppGw Variable.
Der zweite Befehl ruft alle Konfigurationen privater Links aus $AppGw und speichert sie in der $PrivateLinkConfigurations Variable.
...
### -Name
Der Name der Konfiguration "privateLink" des Anwendungsgateways
