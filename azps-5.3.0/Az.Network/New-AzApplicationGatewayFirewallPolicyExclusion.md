...
## BESCHREIBUNG
Das **Cmdlet "New-AzApplicationGatewayFirewallPolicyExclusion"** enthält eine neue Ausschlussregelliste für die Firewallrichtlinie.
...
Mit diesem Befehl wird ein neuer Ausschlusseintrag für die Variable "RequestHeaderNames" und den Operator "StartsWith" und die Auswahl namens xyz erstellt. Der Ausschlusseintrag wird im $exclusionEntry.
...
### -Selector
Wenn "Variable" eine Sammlung ist, wird der Operator verwendet, um anzugeben, für welche Elemente in der Sammlung dieser Ausschluss gilt.
...
### Microsoft.Azure.Commands.Network.Models.PSApplicationGatewayFirewallPolicyExklion
