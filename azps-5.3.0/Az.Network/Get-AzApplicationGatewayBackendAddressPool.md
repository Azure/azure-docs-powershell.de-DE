...
## BESCHREIBUNG
Das **Cmdlet "Get-AzApplicationGatewayBackendAddressPool"** ruft eine oder mehrere Back-End-Adresspoolkonfigurationen von einem Anwendungsgateway ab.

## BEISPIELE

### Beispiel 1: Einen angegebenen Back-End-Serverpool erhalten
```
...
Der zweite Befehl ruft den Back-End-Adresspool ab, der $AppGw "Pool01" zugeordnet ist, und speichert ihn in der $BackendPool Variable.

### Beispiel 2: Erhalten einer Liste des Back-End-Serverpools
```
PS C:\>$AppGw = Get-AzApplicationGateway -Name "ApplicationGateway01" -ResourceGroupName "ResourceGroup01"
...
Der erste Befehl ruft das Anwendungsgateway mit dem Namen ApplicationGateway01 in der Ressourcengruppe "ResourceGroup01" ab und speichert es in der $AppGw Variable.
Der zweite Befehl ruft eine Liste der Back-End-Adresspools ab, die $AppGw zugeordnet sind, und speichert die Liste in der $BackendPools Variable.

## PARAMETERS

### -ApplicationGateway
Das **Cmdlet "Get-AzApplicationGatewayBackendAddressPool"** ruft einen Back-End-Adresspool für ein Anwendungsgateway ab.
