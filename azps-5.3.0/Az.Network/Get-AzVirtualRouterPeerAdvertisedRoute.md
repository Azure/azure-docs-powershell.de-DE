...
## SYNOPSIS
Liste der Routen, die von einem bestimmten virtuellen Router peer angekündigt werden
...
## BESCHREIBUNG
Geben Sie einem virtuellen Router-Peer entweder nach Name oder Objekt eine Aufzählung der Routen an, die von einem bestimmten virtuellen Router an den Peer angekündigt werden.
...
### -PeerName
Name des Peers des virtuellen Routers
...
### -ResourceGroupName
Name der Virtuellen Router-Peer-Ressourcengruppe
