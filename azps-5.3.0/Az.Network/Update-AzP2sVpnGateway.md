...
## BESCHREIBUNG
Mit dem **Cmdlet "Update-AzP2sVpnGateway"** können Sie ein vorhandenes P2SVpnGateway unter VirtualHub mit dem neuen VpnClientAddressPool oder dem neuen VpnServerConfiguration oder der Änderung von VpnGatewayScaleUnit aktualisieren.
...
Mit **dem Cmdlet "Update-AzP2sVpnGateway"** können Sie ein vorhandenes P2SVpnGateway unter VirtualHub mit dem neuen VpnClientAddressPool aktualisieren. Wenn "Point to site client" eine Verbindung mit diesem P2SVpnGateway herstellt, wird dem Client eine der ip-Adressen von "VpnClientAddressPool" zugewiesen.

### Beispiel 2

Aktualisieren Sie ein vorhandenes P2SVpnGateway unter VirtualHub für die Punkt-zu-Website-Konnektivität. (automatisch generiert)
...
Aktivieren der Internetsicherheitsflag für diese P2SVpnGateway-Verbindungen
...
Deaktivieren des Internetsicherheitsflags für diese P2SVpnGateway-Verbindungen
