...
## BESCHREIBUNG
Mit **dem Cmdlet "Disconnect-AzP2sVpnGatewayVpnConnection"** können Sie die Verbindung zu einem aktuellen Punkt zur Website von P2SVpnGateway trennen.
...
### -ResourceId
Ressourcen-ID des virtuellen P2s-Netzwerkgateways
