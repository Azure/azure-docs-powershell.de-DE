...
## BESCHREIBUNG
Das **Cmdlet "Add-AzNetworkInterfaceIpConfig"** fügt einer Azure-Netzwerkschnittstelle eine Netzwerkschnittstellen-IP-Konfiguration hinzu.
...
In diesem Beispiel erstellen wir eine neue Netzwerkschnittstelle "MyNetworkInterface", die zu einem Subnetz im neuen virtuellen Netzwerk MyVNET gehört. Außerdem wird eine leere Anwendungssicherheitsgruppe "MyASG" erstellt, die den IP-Konfigurationen in der Netzwerkschnittstelle zugeordnet wird. Sobald beide Objekte erstellt wurden, verknüpfen wir die Standard-IP-Konfiguration mit dem MyASG-Objekt. Schließlich erstellen wir eine neue IP-Konfiguration in der Netzwerkschnittstelle, die ebenfalls mit dem Anwendungssicherheitsgruppenobjekt verknüpft ist.
...
Dieses Cmdlet erstellt einen Verweis auf ein Subnetz, in dem diese Konfiguration der Netzwerkschnittstelle erstellt wird.
