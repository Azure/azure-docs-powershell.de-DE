...
## BESCHREIBUNG
Das **Cmdlet "New-AzLoadBalancerRuleConfig"** erstellt eine Regelkonfiguration für einen Azure-Lastenausgleich.
...
Die ersten drei Befehle richten eine öffentliche IP, ein Front-End und eine Sonde für die Regelkonfiguration im vierten Befehl ein. Der vierte Befehl erstellt eine neue Regel namens "MyLBrule" mit bestimmten Spezifikationen.
...
### -Back-EndPort
Gibt den Back-End-Port für Datenverkehr an, der mit dieser Konfiguration der Lastenausgleichsregel übereinstimmen soll.
...
### -Name
Gibt den Namen der Lastenausgleichsregel an, die von diesem Cmdlet erstellt wird.
...
### -Protocol
Gibt das Protokoll an, das einer Load Balancer-Regelkonfiguration entsprechen soll.
