...
### 1: Entfernen eines Subnetzes aus einem virtuellen Netzwerk und Aktualisieren des virtuellen Netzwerks
```
...
### -Name
Gibt den Namen der zu entfernenden Subnetzkonfiguration an.
...
### -VirtualNetwork
Gibt das **VirtualNetwork-Objekt** an, das die zu entfernende Subnetzkonfiguration enthält.
