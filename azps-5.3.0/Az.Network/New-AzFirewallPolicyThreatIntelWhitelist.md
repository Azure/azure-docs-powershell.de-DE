...
## BESCHREIBUNG
Das **Cmdlet "New-AzFirewallPolicyThreatIntelWhitelist"** erstellt ein intel whitelist-Threat-Objekt, das beim Erstellen oder Festlegen einer Azure-Firewallrichtlinie verwendet werden kann.
...
In diesem Beispiel wird eine Intel Whitelist für Bedrohungen erstellt, die eine FQDN-Whitelist eines Eintrags und eine Ip-Adress-Whitelist mit zwei Einträgen enthält.
...
### -FQDN
FQDNs der Threat Intel Whitelist
...
### -IpAddress
Die IP-Adressen der Intel Whitelist für Threat
