...
Im vorstehenden Beispiel wird die DNS-Zone und dann die Konfiguration der DNS-Zone erstellt. `New-AzPrivateDnsZone` Das Cmdlet az.privateDns zeigt sich als Beweis.
