...
## BESCHREIBUNG
Das **Cmdlet Set-AzExpressRouteCrossConnection** speichert die geänderte ExpressRoute-Querverbindung mit Azure.

## BEISPIELE

### Beispiel 1: Ändern des Bereitstellungsstatus eines Dienstanbieters für eine ExpressRoute-Kreuzverbindung
```
...
### -Name
Der Name der Expressrouten-Kreuzverbindung.
...
### -Peerings
Die Liste der Peerings für die Querverbindung
...
Die Hinweise des Dienstanbieters
...
Der Dienstanbieterbereitstellungszustand, der festgelegt werden soll
