...
## BESCHREIBUNG
Das New-AzNetworkWatcherConnectionMonitorTestConfigurationObject erstellt eine Testkonfiguration für den Verbindungsmonitor.
...
Name: httpTC TestFrequencySec : 120 PreferredIPVersion : ProtocolConfiguration : { "Port": 443, "Methode": "GET", "RequestHeaders": [ { "Name": "Allow", "Value": "GET" } ], "ValidStatusCodeRanges": [ "2xx", "300-308" ], "PreferHTTPS": true } SuccessThreshold : { "ChecksFailedPercent": 20, "RoundTripTimeMs": 30 } 
...
### -PreferredIPVersion
Die bevorzugte IP-Version, die bei der Testauswertung verwendet werden soll. Je nach anderen Parametern kann der Verbindungsmonitor eine andere Version verwenden.
...
Die Parameter, die für die Testauswertung über ein Protokoll verwendet werden.
...
Der maximale Prozentsatz der fehlgeschlagenen Prüfungen, der für einen Test als erfolgreich ausgewertet werden kann.
