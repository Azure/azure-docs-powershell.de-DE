...
Erstellt ein ManagedRuleSet mit "ruleSetType" als $ruleSetType, "ruleSetVersion" als $ruleSetVersion und "RuleGroupOverrides" als Liste mit Ganzen als $ruleGroupOverride 1, $ruleGroupOverride 2 Das neue "ManagedRuleSet" wird $managedRuleSet
...
### -RuleGroupOverride
Außerkraftsetzungen von Regelgruppen
...
### -RuleSetVersion
Angeben von "RuleSetVersion" in einem managedRuleSet
