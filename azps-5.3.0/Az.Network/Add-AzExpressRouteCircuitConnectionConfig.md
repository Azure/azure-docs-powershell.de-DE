...
### Beispiel 2: Hinzufügen einer Verbindungskonfiguration mit einer Leitung zu einem vorhandenen "ExpressRoute-Schaltkreis"
```
$circuit_peer = Get-AzExpressRouteCircuit -Name $peeringCircuitName -ResourceGroupName $rg
$addressSpace = '60.0.0.0/29'
...
```
### -AddressPrefixType
Damit wird die Adressfamilie angegeben, zu der das Adresspräfix gehört.
