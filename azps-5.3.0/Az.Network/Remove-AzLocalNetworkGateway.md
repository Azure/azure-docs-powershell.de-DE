...
Das **Cmdlet "Remove-AzLocalNetworkGateway"** löscht das Objekt, das Ihr lokales Gateway darstellt, basierend auf "Name" und "Ressourcengruppenname".

## BEISPIELE

### Beispiel 1: Löschen eines lokalen Netzwerkgateways
```powershell
Remove-AzLocalNetworkGateway -Name myLocalGW -ResourceGroupName myRG
```

Löscht das Objekt des lokalen Netzwerkgateways mit dem Namen "myLocalGW" in der Ressourcengruppe "myRG". Hinweis: Sie müssen zuerst alle Verbindungen mit dem lokalen Netzwerkgateway mithilfe des **Cmdlets "Remove-AzVirtualNetworkGatewayConnection"** löschen.
...
### -Name
Gibt den Namen des lokalen Netzwerkgateways an, das von diesem Cmdlet entfernt wird.
