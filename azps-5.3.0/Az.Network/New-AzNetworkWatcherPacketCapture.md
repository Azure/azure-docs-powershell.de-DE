...
Die Länge der Paketerfassungssitzungen kann über eine Zeiteinschränkung oder größenbeschränkung konfiguriert werden. Die Menge der für jedes Paket erfassten Daten kann ebenfalls konfiguriert werden.
Filter können auf eine bestimmte Paketaufnahmesitzung angewendet werden, sodass Sie den Pakettyp anpassen können, der erfasst wird. Filter können Pakete für lokale und Remote-IP-Adressen & Adressbereichen, lokale Ports und Remoteports & Portbereichen und das zu erfassende Protokoll auf Sitzungsebene einschränken. Filter können zusammensetzbar sein, und es können mehrere Filter angewendet werden, um die Granularität der Erfassung zu erhalten.
