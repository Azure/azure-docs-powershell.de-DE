...
ms.locfileid: "98472046"
---
# <span data-ttu-id="7c48b-101">Get-AzSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="7c48b-101">Get-AzSecurityAlert</span></span>

## <span data-ttu-id="7c48b-102">SYNOPSIS</span><span class="sxs-lookup"><span data-stu-id="7c48b-102">SYNOPSIS</span></span>
<span data-ttu-id="7c48b-103">Ruft Sicherheitswarnungen ab, die vom Azure Security Center erkannt wurden</span><span class="sxs-lookup"><span data-stu-id="7c48b-103">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="7c48b-104">SYNTAX</span><span class="sxs-lookup"><span data-stu-id="7c48b-104">SYNTAX</span></span>

### <span data-ttu-id="7c48b-105">SubscriptionScope (Standard)</span><span class="sxs-lookup"><span data-stu-id="7c48b-105">SubscriptionScope (Default)</span></span>
```
Get-AzSecurityAlert [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="7c48b-106">ResourceGroupScope</span><span class="sxs-lookup"><span data-stu-id="7c48b-106">ResourceGroupScope</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="7c48b-107">ResourceGroupLevelResource</span><span class="sxs-lookup"><span data-stu-id="7c48b-107">ResourceGroupLevelResource</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> -Name <String> -Location <String>
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="7c48b-108">SubscriptionLevelResource</span><span class="sxs-lookup"><span data-stu-id="7c48b-108">SubscriptionLevelResource</span></span>
```
Get-AzSecurityAlert -Name <String> -Location <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### <span data-ttu-id="7c48b-109">ResourceId</span><span class="sxs-lookup"><span data-stu-id="7c48b-109">ResourceId</span></span>
```
Get-AzSecurityAlert -ResourceId <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

## <span data-ttu-id="7c48b-110">BESCHREIBUNG</span><span class="sxs-lookup"><span data-stu-id="7c48b-110">DESCRIPTION</span></span>
<span data-ttu-id="7c48b-111">Ruft Sicherheitswarnungen ab, die vom Azure Security Center erkannt wurden</span><span class="sxs-lookup"><span data-stu-id="7c48b-111">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="7c48b-112">BEISPIELE</span><span class="sxs-lookup"><span data-stu-id="7c48b-112">EXAMPLES</span></span>

### <span data-ttu-id="7c48b-113">Beispiel 1</span><span class="sxs-lookup"><span data-stu-id="7c48b-113">Example 1</span></span>
```powershell
...
<span data-ttu-id="7c48b-114">Ruft alle Sicherheitswarnungen ab, die für Ressourcen in einem Abonnement erkannt wurden.</span><span class="sxs-lookup"><span data-stu-id="7c48b-114">Gets all the security alerts that were detected on resources inside a subscription</span></span>

### <span data-ttu-id="7c48b-115">Beispiel 2</span><span class="sxs-lookup"><span data-stu-id="7c48b-115">Example 2</span></span>
```powershell
...
<span data-ttu-id="7c48b-116">Ruft alle Sicherheitswarnungen ab, die für Ressourcen in der Ressourcengruppe "myService1" erkannt wurden.</span><span class="sxs-lookup"><span data-stu-id="7c48b-116">Gets all the security alerts that were detected on resources inside the "myService1" resource group</span></span>

### <span data-ttu-id="7c48b-117">Beispiel 3</span><span class="sxs-lookup"><span data-stu-id="7c48b-117">Example 3</span></span>
```powershell
...
<span data-ttu-id="7c48b-118">Ruft eine bestimmte Sicherheitswarnung ab, die für Ressourcen in der Ressourcengruppe "myService1" erkannt wurde</span><span class="sxs-lookup"><span data-stu-id="7c48b-118">Gets a specific security alert that were detected on resources inside the "myService1" resource group</span></span>

## <span data-ttu-id="7c48b-119">PARAMETERS</span><span class="sxs-lookup"><span data-stu-id="7c48b-119">PARAMETERS</span></span>

### <span data-ttu-id="7c48b-120">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="7c48b-120">-DefaultProfile</span></span>
<span data-ttu-id="7c48b-121">Die Anmeldeinformationen, das Konto, den Mandanten und das Abonnement, die für die Kommunikation mit Azure verwendet werden.</span><span class="sxs-lookup"><span data-stu-id="7c48b-121">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="7c48b-122">-Location</span><span class="sxs-lookup"><span data-stu-id="7c48b-122">-Location</span></span>
<span data-ttu-id="7c48b-123">"Ort" aus.</span><span class="sxs-lookup"><span data-stu-id="7c48b-123">Location.</span></span>
...
### <span data-ttu-id="7c48b-124">-Name</span><span class="sxs-lookup"><span data-stu-id="7c48b-124">-Name</span></span>
<span data-ttu-id="7c48b-125">Ressourcenname.</span><span class="sxs-lookup"><span data-stu-id="7c48b-125">Resource name.</span></span>
...
### <span data-ttu-id="7c48b-126">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="7c48b-126">-ResourceGroupName</span></span>
<span data-ttu-id="7c48b-127">Ressourcengruppenname.</span><span class="sxs-lookup"><span data-stu-id="7c48b-127">Resource group name.</span></span>
...
### <span data-ttu-id="7c48b-128">-ResourceId</span><span class="sxs-lookup"><span data-stu-id="7c48b-128">-ResourceId</span></span>
<span data-ttu-id="7c48b-129">Ressourcen-ID.</span><span class="sxs-lookup"><span data-stu-id="7c48b-129">Resource ID.</span></span>
...
### <span data-ttu-id="7c48b-130">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="7c48b-130">CommonParameters</span></span>
<span data-ttu-id="7c48b-131">Dieses Cmdlet unterstützt die allgemeinen Parameter: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction und -WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="7c48b-131">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="7c48b-132">Weitere Informationen finden Sie unter [about_CommonParameters.](http://go.microsoft.com/fwlink/?LinkID=113216)</span><span class="sxs-lookup"><span data-stu-id="7c48b-132">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="7c48b-133">EINGABEN</span><span class="sxs-lookup"><span data-stu-id="7c48b-133">INPUTS</span></span>

### <span data-ttu-id="7c48b-134">System.String</span><span class="sxs-lookup"><span data-stu-id="7c48b-134">System.String</span></span>

## <span data-ttu-id="7c48b-135">AUSGABEN</span><span class="sxs-lookup"><span data-stu-id="7c48b-135">OUTPUTS</span></span>

### <span data-ttu-id="7c48b-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="7c48b-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span></span>

## <span data-ttu-id="7c48b-137">HINWEISE</span><span class="sxs-lookup"><span data-stu-id="7c48b-137">NOTES</span></span>

## <span data-ttu-id="7c48b-138">LINKS ZU VERWANDTEN THEMEN</span><span class="sxs-lookup"><span data-stu-id="7c48b-138">RELATED LINKS</span></span>
