...
## BESCHREIBUNG
Aktualisiert die Arbeitsbereichseinstellungen für das Abonnement.
Der konfigurierte Arbeitsbereich enthält die Sicherheitsdaten, die vom Azure Log Analytics-Agent gesammelt wurden, der in VMs in diesem Abonnement installiert ist.
...
Legt den Arbeitsbereich "myWorkspace" so fest, dass er alle Sicherheitsdaten enthält, die vom Azure Log Analytics-Agent gesammelt wurden.
