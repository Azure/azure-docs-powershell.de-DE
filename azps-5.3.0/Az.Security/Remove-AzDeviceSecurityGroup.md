...
## BESCHREIBUNG
Mit Remove-AzDeviceSecurityGroup A0 wird eine gerätesicherheitsgruppe gelöscht, die in der Sicherheitslösung "iot" definiert ist.
...
Löschen Sie die Gerätesicherheitsgruppe "MySecurityGroup" des iot-Hubs mit der Ressourcen-ID "/subscriptions/XXXXXXXX-XXXX-XXXXX-XXXX-XXXXXXXXXXXX/resourceGroups/MyResourceGroup/providers/Microsoft.Devices/IotHubs/MyHub".
