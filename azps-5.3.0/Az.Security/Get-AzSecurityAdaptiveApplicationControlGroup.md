...
## SYNOPSIS
Ruft eine VM/Server-Gruppe für die Anwendungssteuerung ab.
...
## BESCHREIBUNG
Steuerelemente für adaptive Anwendungen werden automatisch vom Azure Security Center berechnet. Verwenden Sie dieses Cmdlet, um eine VM/Server-Gruppe für das Anwendungssteuerelement zu erhalten.
...
### -AscLocation
Der Speicherort, an dem ASC die Daten des Abonnements speichert. aus "Speicherorte abrufen" abgerufen werden können.
...
### -GroupName
Name einer VM/Server-Gruppe für das Anwendungssteuerelement.
