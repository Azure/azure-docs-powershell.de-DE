...
## BESCHREIBUNG
Das Update-AzContainerRegistryCredential cmdlet generiert erneut Anmeldeinformationen für eine Containerregistrierung.

## BEISPIELE

### Beispiel 1: Erneutererieren von Anmeldeinformationen für eine Containerregistrierung
```powershell
...
Mit diesem Befehl werden anmeldeinformationen für die angegebene Containerregistrierung erneut generiert.
Der Administratorbenutzer muss für die Containerregistrierung "MyRegistry" aktiviert sein, \` \` um Anmeldeinformationen neu zu erstellen.
...
### -PasswordName
Der Name des Kennworts, das erneut generiert werden soll.
Zulässige Werte: Kennwort, Kennwort2.
