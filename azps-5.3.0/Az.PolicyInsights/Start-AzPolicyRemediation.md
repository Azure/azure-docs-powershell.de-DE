...
Mit diesem Befehl wird eine neue Richtlinienbehebung in der Ressourcengruppe "myRG" für die angegebene Richtlinienzuordnung erstellt. Durch die Richtlinienzuweisung wird eine Definition für einen Richtliniensatz (auch als Initiative bekannt) zugewiesen. Die Referenz-ID der Richtliniendefinition gibt an, welche Richtlinie innerhalb der Initiative behoben werden soll.
