...
### Beispiel 1: Benennen Sie eine Funktions-App, und beenden Sie sie.
```powershell
PS C:\> Get-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName | Stop-AzFunctionApp -Force
```

Dieser Befehl ruft eine Funktions-App nach Name ab und beendet sie.

### Beispiel 2: Beenden einer Funktions-App nach Name.
```powershell
PS C:\> Stop-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName -Force
```

Mit diesem Befehl wird eine Funktions-App nach Name beendet.
...
### -Force
Erzwingt das Cmdlet, die Funktions-App ohne Bestätigungsaufforderung zu beenden.
