...
# Az.Functions Module
## Beschreibung
Microsoft Azure PowerShell – Azure Functions-Dienst-Cmdlets für Azure Resource Manager in Windows PowerShell und PowerShell Core.\n\nFor information on Azure Functions, please visit the following: https://docs.microsoft.com/azure/azure-functions/
...
Ruft den Ort ab, an dem eine Funktions-App für das angegebene Betriebssystem und den Plantyp verfügbar ist.

### [Get-AzFunctionAppPlan](Get-AzFunctionAppPlan.md)
Holen Sie sich Funktions-Apps-Pläne in einem Abonnement.
...
Ruft die im angegebenen Bereich "RP" verfügbare SystemAssignedIdentity ab.

### [GetAzWebAppConfig](GetAzWebAppConfig.md)


### [Get-AzWebAppFunctionKey](Get-AzWebAppFunctionKey.md)
Beschreibung der Funktionstasten für "Get" für eine Funktion auf einer Website oder an einem Bereitstellungsplatz.
...
Beschreibung für "Ruft die Konfigurationsreferenz-App-Einstellungen und den Status einer App ab"

### [Get-AzWebAppSyncStatus](Get-AzWebAppSyncStatus.md)
Beschreibung zu dieser Beschreibung: Ermöglicht das Aufrufen über Powershell und ARM Vorlage.
...
Erstellt einen Funktions-App-Serviceplan.
...
Beschreibung der Triggermetadaten für die Synchronisierungsfunktion in der Verwaltungsdatenbank
