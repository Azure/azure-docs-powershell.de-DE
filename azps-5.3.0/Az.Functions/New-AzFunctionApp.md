...
### Beispiel 1: Erstellen einer konsumieren PowerShell-Funktions-App in der Mitte der USA.
```powershell
...
Dieser Befehl erstellt eine konsumierte PowerShell-Funktions-App in der Mitte der USA.
...
### Beispiel 3: Erstellen einer Funktions-App mit einem privaten ACR-Bild.
```powershell
PS C:\> New-AzFunctionApp -Name MyUniqueFunctionAppName `
                          -ResourceGroupName MyResourceGroupName `
                          -PlanName MyPlanName `
...
Mit diesem Befehl wird eine Funktions-App erstellt, die ein privates ACR-Bild verwendet.
...
Deaktivieren Sie das Erstellen von Ressourcen für Anwendungseinblicke während der Erstellung der Funktions-App.
Es sind keine Protokolle verfügbar.
...
### -DockerImageName
Nur Linux.
Container image name from Docker Registry, z. B. publisher/image-name:tag.
...
Der Benutzername und das Kennwort der Containerregistrierung.
Erforderlich für private Registrierungen.
...
Die zulässigen Werte für diesen Parameter sind: - SystemAssigned - UserAssigned
