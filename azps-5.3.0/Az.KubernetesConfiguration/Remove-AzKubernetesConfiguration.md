...
INPUTOBJECT <IKubernetesConfigurationIdentity> : Identity Parameter
  - `[ClusterName <String>]`: Der Name des Kubernetclusters.
  - `[ClusterResourceName <String>]`: Der Name der Clusterressource "Kubernetes" – entweder "managedClusters" (für AKS-Cluster) oder "connectedClusters" (für "OnPrem K8S"-Cluster).
