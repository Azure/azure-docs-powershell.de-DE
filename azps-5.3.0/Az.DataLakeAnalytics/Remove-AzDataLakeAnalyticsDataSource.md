...
Mit diesem Befehl wird die Datenquelle mit dem Namen "AzureStorage01" aus dem Konto "ContosoAdlAccount" entfernt.
...
### -DataLakeStore
Gibt den Namen des zu entfernenden AzureData Lake Store-Kontos an.
