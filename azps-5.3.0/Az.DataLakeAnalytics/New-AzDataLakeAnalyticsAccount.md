...
## BESCHREIBUNG
Das **Cmdlet "New-AzDataLakeAnalyticsAccount"** erstellt ein Azure Data Lake Analytics-Konto.
...
Mit diesem Befehl wird ein Data Lake Analytics-Konto namens "ContosoAdlAccount" erstellt, das den "ContosoAdlStore-Datenspeicher" in der Ressourcengruppe "ContosoOrg" verwendet.

## PARAMETERS

### -DefaultDataLakeStore
Gibt den Namen des Data Lake Store-Kontos an, das als Standarddatenquelle festgelegt werden soll.
...
Derzeit wird nur "OST US 2" unterstützt.
...
### -MaxAnalyticsUnits
Die optional maximal unterstützten Analyseeinheiten für dieses Konto.
...
### -MaxJobCount
Die optionalen maximal unterstützten Aufträge, die unter dem Konto gleichzeitig ausgeführt werden. Ist keine angegeben, wird standardmäßig "3" verwendet.
...
### -QueryStoreRetention
Die optionale Anzahl von Tagen, in der Auftragsmetadaten aufbewahrt werden. Ist keine Angabe angegeben, beträgt der Standardwert 30 Tage.
...
Verwenden Sie zum Erstellen einer Ressourcengruppe das New-AzResourceGroup Cmdlet.
...
### -Tag
Ein Zeichenfolgenverzeichnis der diesem Konto zugeordneten Tags
...
### -Tier
Das gewünschte Verpflichtungsstufen für dieses Konto.
