...
## BESCHREIBUNG
Das **Cmdlet "Get-AzLogicAppTriggerCallbackUrl"** ruft eine Rückruf-URL für die Logik-App-Trigger aus einer Ressourcengruppe ab.
Dieses Cmdlet gibt ein **WorkflowTriggerCallbackUrl-Objekt** zurück, das die Rückruf-URL darstellt.
Geben Sie den Namen der Ressourcengruppe, den Namen der Logik-App und den Triggernamen an.
...
### Beispiel 1: Rufen Sie die Rückruf-URL für den Trigger einer Logik-App ab.
```
...
Dieser Befehl ruft eine Rückruf-URL für den Trigger der Logik-App ab.
