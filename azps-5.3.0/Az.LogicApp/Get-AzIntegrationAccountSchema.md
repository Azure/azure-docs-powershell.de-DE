...
## BESCHREIBUNG
Das **Cmdlet "Get-AzIntegrationAccountSchema"** ruft Schemas für Integrationskonten ab.
Angeben des Namens des Integrationskontos, des Ressourcengruppennamens und des Schemanamens
...
### Beispiel 1: Erhalten eines Integrationskontoschemas
```
...
Dieser Befehl ruft das Integrationskontoschema namens "IntegrationAccountSchema43" ab.

### Beispiel 2: Erhalten von Schemas für Integrationskonto für eine Ressourcengruppe
```
...
Dieser Befehl ruft die Schemas für das Integrationskonto für die Ressourcengruppe mit dem Namen "ResourceGroup11" ab.
