...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzIntegrationAccount"** entfernt ein Integrationskonto aus einer Ressourcengruppe.
...
### Beispiel 1: Entfernen eines Integrationskontos
```
PS C:\>Remove-AzIntegrationAccount -ResourceGroupName "ResourceGroup11" -Name "IntegrationAccount31" -Force
```

Mit diesem Befehl wird ein Integrationskonto namens "IntegrationAccount31" entfernt.
