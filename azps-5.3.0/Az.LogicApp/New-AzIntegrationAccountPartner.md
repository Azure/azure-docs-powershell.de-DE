...
## BESCHREIBUNG
Das **Cmdlet "New-AzIntegrationAccountPartner"** erstellt einen Integrationskontopartner.
Dieses Cmdlet gibt ein Objekt zurück, das den Integrationskontopartner darstellt.
Geben Sie den Namen des Integrationskontos, den Namen der Ressourcengruppe, den Partnernamen und die Partneridentitäten an.
...
### Beispiel 1: Erstellen eines Integrationskontopartners
```
...
Mit diesem Befehl wird der Integrationskontopartner "IntegrationAccountPartner22" in der angegebenen Ressourcengruppe erstellt.
...
### -PartnerName
Gibt einen Namen für den Partner für das Integrationskonto an.
