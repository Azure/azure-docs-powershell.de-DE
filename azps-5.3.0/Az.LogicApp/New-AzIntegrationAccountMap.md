...
## BESCHREIBUNG
Das **Cmdlet "New-AzIntegrationAccountMap"** erstellt eine Integrationskontozuordnung.
Dieses Cmdlet gibt ein Objekt zurück, das die Zuordnung des Integrationskontos darstellt.
Angeben des Namens des Integrationskontos, des Ressourcengruppennamens, des Kartennamens und der Zuordnungsdefinition.
...
### Beispiel 1: Erstellen einer Integrationskontozuordnung
```powershell
...
Mit diesem Befehl wird die Zuordnung des Integrationskontos in der angegebenen Ressourcengruppe erstellt.
Der Befehl gibt eine Zuordnungsdefinition an, die in der $MapContent durch einen vorherigen Befehl gespeichert wurde.

### Beispiel 2

Erstellt eine Integrationskontozuordnung. (automatisch generiert)
...
Geben Sie entweder diesen Parameter oder den *Parameter "MapFilePath"* an.
...
### -MapFilePath
Gibt den Dateipfad einer Definition für die Zuordnung des Integrationskontos an. Geben Sie entweder diesen Parameter oder den *Parameter "MapDefinition"* an.
...
### -MapName
Gibt einen Namen für die Zuordnung des Integrationskontos an.
...
### -Name
Gibt einen Namen für das Integrationskonto an.
