...
## BESCHREIBUNG
Das **Cmdlet Set-AzIntegrationAccountCertificate** ändert ein Integrationskontozertifikat.
Dieses Cmdlet gibt ein Objekt zurück, das das Zertifikat des Integrationskontos darstellt.
Angeben des Namens des Integrationskontos, des Ressourcengruppennamens und des Zertifikatnamens.
...
### Beispiel 1: Ändern eines Zertifikats für ein Integrationskonto
```
...
Mit diesem Befehl wird das Zertifikat für das Integrationskonto in der angegebenen Ressourcengruppe geändert.

## PARAMETERS

### -CertificateName
Gibt den Namen eines Zertifikats für ein Integrationskonto an.
...
### -KeyName
Gibt den Namen eines Zertifikatschlüssels im Schlüsseltresor an.
