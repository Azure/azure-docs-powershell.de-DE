...
Dieser Befehl ruft eine bestimmte Logik-App-Aktion aus der Logik-App namens LogicApp05 für die Ausführung mit dem Namen "LogicAppRun56" ab.

### Beispiel 2: Alle Aktionen aus einer ausgeführten Logik-App erhalten
```powershell
...
Dieser Befehl ruft alle Aktionen der Logik-App aus einer Ausführung namens "LogicAppRun56" einer Logik-App mit dem Namen "LogicApp05" ab.

### Beispiel 3

Dieser Befehl ruft alle Aktionen der Logik-App aus einer Ausführung namens "LogicAppRun56" einer Logik-App mit dem Namen "LogicApp05" ab. (automatisch generiert)
