...
### Beispiel 1: Entfernen eines verbundenen Kubernets
```powershell
PS C:\> Remove-AzConnectedKubernetes -ResourceGroupName azureps-manual-test -ClusterName ps-connaks-t01

```

Mit diesem Befehl wird ein verbundenes Kubernets entfernt.

### Beispiel 2: Entfernen eines verbundenen Kubernets nach Objekt
```powershell
