...
## BESCHREIBUNG
Erstellen Sie ein neues Artefakt. Es gibt zwei Möglichkeiten zum Erstellen eines Artefakts: entweder über ein Artefakt-JSON als Eingabedatei oder durch Bereitstellen von Inlineparametern für das Artefakt. Während für die JSON-Methode kein Typ des Artefakts erforderlich ist, um inlineparametermethode bereitgestellt zu werden, muss der Benutzer den Typ des Artefakts über den Parameter "-Type" bereitstellen.
...
Erstellen Sie ein neues Artefakt mithilfe einer Artefakt-JSON-Datei.
...
Erstellen Sie ein neues Artefakt mithilfe von Inlineparametern.
...
Erstellen Sie ein neues Artefakt mithilfe einer ARM Vorlagendatei.
...
Hashtable der Parameter, die an das Richtliniendefinitionsartefakt übergeben werden.
...
### -ResourceGroupName
Der Name der Ressourcengruppe, unter der sich das Artefakt befindet.
