...
## BESCHREIBUNG
Erstellt regionale Azure Machine Learning-Eigenschaften für einen vorhandenen Webdienst.

## BEISPIELE

### Beispiel 1: Hinzufügen neuer regionaler Eigenschaften für "USA, Mitte, Westen"

```
Add-AzMlWebServiceRegionalProperty -ResourceGroupName "myresourcegroup" -Name "mywebservicename" -Region westcentralus
```

Mit diesem Beispielbefehl wird eine regionale Eigenschaft für einen Webdienst in der Region "West Central US" erstellt.
...
### -Region
Die Region, in der die Webdiensteigenschaften erstellt werden.
