...
Erstellt ein Objekt vom Typ "Quelle". (automatisch generiert)
...
### -AuthorizedResource
Die Liste der autorisierten Ressourcen für diese Warnung
...
### -DataSourceId
Die Datenquelle, für die diese Benachrichtigung erstellt wird
...
### -QueryType
Abfragetyp – derzeit unterstützte Werte: ResultCount
