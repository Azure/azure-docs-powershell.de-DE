...
## BESCHREIBUNG
Das **Cmdlet "Add-AzAutoscaleSetting"** erstellt eine Autoskaleneinstellung.
...
### Beispiel 1: Erstellen einer Einstellung für die Automatische Skalierung
```
...
Die ersten beiden Befehle verwenden ["New-AzAutoscaleRule",](https://docs.microsoft.com/en-us/powershell/module/az.monitor/new-azautoscalerule) um zwei Regeln für die Autoskalieren zu erstellen: $Rule 1 und $Rule 2.
Der dritte und vierte Befehl verwenden ["New-AzAutoscaleProfile"](https://docs.microsoft.com/en-us/powershell/module/az.monitor/new-azautoscaleprofile) zum Erstellen von Autoskalenprofilen ($Profile 1 und $Profile 2) mit $Rule 1 und $Rule 2.
Der letzte Befehl erstellt eine Einstellung für die Automatische Skala unter Verwendung der Profile in $Profile 1 und $Profile 2.

## PARAMETERS

### -AutoscaleProfile
Gibt eine Liste der Profile an, die der Einstellung für die Autoskala hinzugefügt werden $Null, um kein Profil hinzuzufügen.
...
### -DisableSetting
Deaktiviert eine vorhandene Einstellung für die Automatische Skala.
...
### -InputObject
Die vollständige Spezifikation eines AutoScaleSetting
...
### -Location
Gibt die Position der Einstellung für die Autoskala an.
...
### -Name
Gibt den Namen der zu erstellenden Einstellung für die Autoskala an.
...
### -Benachrichtigung
Gibt eine Liste von durch Kommas getrennten Benachrichtigungen an.
...
### -ResourceGroupName
Gibt den Namen der Ressourcengruppe für die Ressource an, die der Einstellung "Autoskala" zugeordnet ist.
...
### -TargetResourceId
Gibt die ID der Ressource an, die automatisch entskaliert werden soll.
