...
## SYNOPSIS
Fügt eine auf V2 basierende (nicht klassische) metrische Warnungsregel hinzu oder aktualisiert diese.
...
## BESCHREIBUNG
Fügt eine auf **V2 basierende metrische Warnungsregel (nicht klassische)** hinzu oder aktualisiert diese. Die hinzugefügte Regel ist einer Ressourcengruppe zugeordnet und hat einen Namen. Dieses Cmdlet implementiert das ShouldProcess-Muster, d. h., es kann eine Bestätigung vom Benutzer anfordern, bevor die Ressource tatsächlich erstellt, geändert oder entfernt wird.

## BEISPIELE

### Beispiel 1: Hinzufügen einer metrischen Warnungsregel zu einem virtuellen Computer
...
Mit diesem Befehl wird eine metrische Warnungsregel für alle virtuellen Computer im Abonnement erstellt, die sich in Eastus befinden.

### Beispiel 3: Deaktivieren einer metrischen Warnungsregel
```powershell
...
### -ActionGroupId
Die Id der Aktionsgruppe für die Regel
...
### -Beschreibung
Beschreibung der metrischen Warnungsregel
...
### -Häufigkeit
Die Auswertungshäufigkeit für die Regel
...
### -Schweregrad
Der Schweregrad für die metrische Warnungsregel
...
### -TargetResourceRegion
Zielressourcenregion für die Regel
...
### -TargetResourceScope
Der Zielressourcenbereich für die Regel
...
### -WindowSize
Die Fenstergröße für die Regel
