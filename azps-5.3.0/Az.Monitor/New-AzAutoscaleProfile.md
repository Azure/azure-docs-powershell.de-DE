...
Der erste Befehl erstellt eine Regel mit dem Namen "Anforderungen" und speichert sie dann in der $Rule Variable.
Der zweite Befehl erstellt ein Profil mit dem Namen "SecondProfileName" mit einem wiederkehrenden Zeitplan unter Verwendung der Regel in $Rule.
...
Der letzte Befehl erstellt anhand der Regeln in "Regel1" und "Regel2" ein Profil namens "SecondProfileName" und speichert es dann in der $Profile 2-Variable.
...
Der erste Befehl erstellt eine Regel mit dem Namen "Anforderungen" und speichert sie dann in der $Rule Variable.
Der zweite Befehl erstellt ein Profil ohne einen Zeitplan oder ein festes Datum und speichert es dann in der $Profile Variable.
