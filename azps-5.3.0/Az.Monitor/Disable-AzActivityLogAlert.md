...
## BESCHREIBUNG
Das **Cmdlet "Disable-AzActivityLogAlert"** deaktiviert und ermöglicht das Festlegen seiner Tags.
...
### -InputObject
Legt die Eigenschaft "InputObject"-Tags des Aufrufs fest, um den erforderlichen Namen, den Namen der Ressourcengruppe und die optionalen Tageigenschaften zu extrahieren.
