...
### Beispiel 1: Aktualisieren der Firewallregel "MariaDB"
```powershell
...
Mit diesem Befehl wird eine Firewallregel für MariaDB aktualisiert.
...
### Beispiel 3: Aktualisieren der MariaDB-Firewallregel nach "-ClientIPAddress".
```powershell
PS C:\> $ID = "/subscriptions/<SubscriptionId>/resourceGroups/mariadb-test-qu5ov0/providers/Microsoft.DBforMariaDB/servers/mariadb-test-4rmtig/firewallRules/fr-cfgl3y"
...
Das Cmdlet aktualisiert die MariaDB-Firewallregel von "-ClientIPAddress".
