...
### Beispiel 1: Auflisten aller Firewallregeln unter einer MariaDB
```powershell
...
Dieser Befehl listet alle "Girewall"-Regeln unter einer MariaDB auf.

### Beispiel 2: Erhalten einer Firewallregel unter einer MariaDB
```powershell
...
Dieser Befehl ruft eine Firewallregel unter einer MariaDB ab.
