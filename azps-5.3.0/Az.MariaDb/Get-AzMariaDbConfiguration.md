...
ms.locfileid: "98472307"
---
# <span data-ttu-id="2c0ed-101">Get-AzMariaDbConfiguration</span><span class="sxs-lookup"><span data-stu-id="2c0ed-101">Get-AzMariaDbConfiguration</span></span>

## <span data-ttu-id="2c0ed-102">SYNOPSIS</span><span class="sxs-lookup"><span data-stu-id="2c0ed-102">SYNOPSIS</span></span>
<span data-ttu-id="2c0ed-103">Ruft Informationen zu einer Serverkonfiguration ab.</span><span class="sxs-lookup"><span data-stu-id="2c0ed-103">Gets information about a configuration of server.</span></span>

## <span data-ttu-id="2c0ed-104">SYNTAX</span><span class="sxs-lookup"><span data-stu-id="2c0ed-104">SYNTAX</span></span>

### <span data-ttu-id="2c0ed-105">Liste (Standard)</span><span class="sxs-lookup"><span data-stu-id="2c0ed-105">List (Default)</span></span>
```
Get-AzMariaDbConfiguration -ResourceGroupName <String> -ServerName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### <span data-ttu-id="2c0ed-106">Erhalten</span><span class="sxs-lookup"><span data-stu-id="2c0ed-106">Get</span></span>
```
Get-AzMariaDbConfiguration -Name <String> -ResourceGroupName <String> -ServerName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### <span data-ttu-id="2c0ed-107">GetViaIdentity</span><span class="sxs-lookup"><span data-stu-id="2c0ed-107">GetViaIdentity</span></span>
```
Get-AzMariaDbConfiguration -InputObject <IMariaDbIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

## <span data-ttu-id="2c0ed-108">BESCHREIBUNG</span><span class="sxs-lookup"><span data-stu-id="2c0ed-108">DESCRIPTION</span></span>
<span data-ttu-id="2c0ed-109">Ruft Informationen zu einer Serverkonfiguration ab.</span><span class="sxs-lookup"><span data-stu-id="2c0ed-109">Gets information about a configuration of server.</span></span>

## <span data-ttu-id="2c0ed-110">BEISPIELE</span><span class="sxs-lookup"><span data-stu-id="2c0ed-110">EXAMPLES</span></span>

### <span data-ttu-id="2c0ed-111">Beispiel 1: Auflisten aller Konfigurationen unter einer MariaDB</span><span class="sxs-lookup"><span data-stu-id="2c0ed-111">Example 1: List all configuration under a MariaDB</span></span>
```powershell
...
<span data-ttu-id="2c0ed-112">Dieser Befehl listet alle Konfigurationen unter einer MariaDB auf.</span><span class="sxs-lookup"><span data-stu-id="2c0ed-112">This command lists all configuration under a MariaDB.</span></span>

### <span data-ttu-id="2c0ed-113">Beispiel 2: Erhalten einer Konfiguration von MariaDB</span><span class="sxs-lookup"><span data-stu-id="2c0ed-113">Example 2: Get a configuration of MariaDB</span></span>
```powershell
...
<span data-ttu-id="2c0ed-114">Dieser Befehl ruft eine Konfiguration von MariaDB ab.</span><span class="sxs-lookup"><span data-stu-id="2c0ed-114">This command gets a configuration of MariaDB.</span></span>

## <span data-ttu-id="2c0ed-115">PARAMETERS</span><span class="sxs-lookup"><span data-stu-id="2c0ed-115">PARAMETERS</span></span>

### <span data-ttu-id="2c0ed-116">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="2c0ed-116">-DefaultProfile</span></span>
<span data-ttu-id="2c0ed-117">Die Anmeldeinformationen, das Konto, den Mandanten und das Abonnement, die für die Kommunikation mit Azure verwendet werden.</span><span class="sxs-lookup"><span data-stu-id="2c0ed-117">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="2c0ed-118">-InputObject</span><span class="sxs-lookup"><span data-stu-id="2c0ed-118">-InputObject</span></span>
<span data-ttu-id="2c0ed-119">Identity Parameter To construct, see NOTES section for INPUTOBJECT properties and create a hash table.</span><span class="sxs-lookup"><span data-stu-id="2c0ed-119">Identity Parameter To construct, see NOTES section for INPUTOBJECT properties and create a hash table.</span></span>
...
### <span data-ttu-id="2c0ed-120">-Name</span><span class="sxs-lookup"><span data-stu-id="2c0ed-120">-Name</span></span>
<span data-ttu-id="2c0ed-121">Der Name der Serverkonfiguration.</span><span class="sxs-lookup"><span data-stu-id="2c0ed-121">The name of the server configuration.</span></span>
...
### <span data-ttu-id="2c0ed-122">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="2c0ed-122">-ResourceGroupName</span></span>
<span data-ttu-id="2c0ed-123">Der Name der Ressourcengruppe, die die Ressource enthält.</span><span class="sxs-lookup"><span data-stu-id="2c0ed-123">The name of the resource group that contains the resource.</span></span>
<span data-ttu-id="2c0ed-124">Sie können diesen Wert über die Azure Resource Manager-API oder das Portal abrufen.</span><span class="sxs-lookup"><span data-stu-id="2c0ed-124">You can obtain this value from the Azure Resource Manager API or the portal.</span></span>
...
### <span data-ttu-id="2c0ed-125">-ServerName</span><span class="sxs-lookup"><span data-stu-id="2c0ed-125">-ServerName</span></span>
<span data-ttu-id="2c0ed-126">Der Name des Servers.</span><span class="sxs-lookup"><span data-stu-id="2c0ed-126">The name of the server.</span></span>
...
### <span data-ttu-id="2c0ed-127">-SubscriptionId</span><span class="sxs-lookup"><span data-stu-id="2c0ed-127">-SubscriptionId</span></span>
<span data-ttu-id="2c0ed-128">Die Abonnement-ID, die ein Azure-Abonnement identifiziert.</span><span class="sxs-lookup"><span data-stu-id="2c0ed-128">The subscription ID that identifies an Azure subscription.</span></span>
...
### <span data-ttu-id="2c0ed-129">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="2c0ed-129">CommonParameters</span></span>
<span data-ttu-id="2c0ed-130">Dieses Cmdlet unterstützt die allgemeinen Parameter: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction und -WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="2c0ed-130">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="2c0ed-131">Weitere Informationen finden Sie unter [about_CommonParameters.](http://go.microsoft.com/fwlink/?LinkID=113216)</span><span class="sxs-lookup"><span data-stu-id="2c0ed-131">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="2c0ed-132">EINGABEN</span><span class="sxs-lookup"><span data-stu-id="2c0ed-132">INPUTS</span></span>

### <span data-ttu-id="2c0ed-133">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.IMariaDbIdentity</span><span class="sxs-lookup"><span data-stu-id="2c0ed-133">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.IMariaDbIdentity</span></span>

## <span data-ttu-id="2c0ed-134">AUSGABEN</span><span class="sxs-lookup"><span data-stu-id="2c0ed-134">OUTPUTS</span></span>

### <span data-ttu-id="2c0ed-135">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.Api20180601Preview.IConfiguration</span><span class="sxs-lookup"><span data-stu-id="2c0ed-135">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.Api20180601Preview.IConfiguration</span></span>

## <span data-ttu-id="2c0ed-136">HINWEISE</span><span class="sxs-lookup"><span data-stu-id="2c0ed-136">NOTES</span></span>

<span data-ttu-id="2c0ed-137">ALIASE</span><span class="sxs-lookup"><span data-stu-id="2c0ed-137">ALIASES</span></span>

<span data-ttu-id="2c0ed-138">KOMPLEXE PARAMETEREIGENSCHAFTEN</span><span class="sxs-lookup"><span data-stu-id="2c0ed-138">COMPLEX PARAMETER PROPERTIES</span></span>

<span data-ttu-id="2c0ed-139">Erstellen Sie zum Erstellen der unten beschriebenen Parameter eine Hashtabelle mit den entsprechenden Eigenschaften.</span><span class="sxs-lookup"><span data-stu-id="2c0ed-139">To create the parameters described below, construct a hash table containing the appropriate properties.</span></span> <span data-ttu-id="2c0ed-140">Um Informationen zu Hashtabellen zu erhalten, führen Sie Get-Help about_Hash_Tables.</span><span class="sxs-lookup"><span data-stu-id="2c0ed-140">For information on hash tables, run Get-Help about_Hash_Tables.</span></span>


<span data-ttu-id="2c0ed-141">INPUTOBJECT <IMariaDbIdentity> : Identity Parameter</span><span class="sxs-lookup"><span data-stu-id="2c0ed-141">INPUTOBJECT <IMariaDbIdentity>: Identity Parameter</span></span>
  - <span data-ttu-id="2c0ed-142">`[ConfigurationName <String>]`: Der Name der Serverkonfiguration.</span><span class="sxs-lookup"><span data-stu-id="2c0ed-142">`[ConfigurationName <String>]`: The name of the server configuration.</span></span>
  - <span data-ttu-id="2c0ed-143">`[DatabaseName <String>]`: Der Name der Datenbank.</span><span class="sxs-lookup"><span data-stu-id="2c0ed-143">`[DatabaseName <String>]`: The name of the database.</span></span>
  - <span data-ttu-id="2c0ed-144">`[FirewallRuleName <String>]`: Der Name der Serverfirewallregel.</span><span class="sxs-lookup"><span data-stu-id="2c0ed-144">`[FirewallRuleName <String>]`: The name of the server firewall rule.</span></span>
  - <span data-ttu-id="2c0ed-145">`[Id <String>]`: Ressourcenidentitätspfad</span><span class="sxs-lookup"><span data-stu-id="2c0ed-145">`[Id <String>]`: Resource identity path</span></span>
  - <span data-ttu-id="2c0ed-146">`[LocationName <String>]`: Der Name des Speicherorts.</span><span class="sxs-lookup"><span data-stu-id="2c0ed-146">`[LocationName <String>]`: The name of the location.</span></span>
  - <span data-ttu-id="2c0ed-147">`[ResourceGroupName <String>]`: Der Name der Ressourcengruppe, die die Ressource enthält.</span><span class="sxs-lookup"><span data-stu-id="2c0ed-147">`[ResourceGroupName <String>]`: The name of the resource group that contains the resource.</span></span> <span data-ttu-id="2c0ed-148">Sie können diesen Wert über die Azure Resource Manager-API oder das Portal abrufen.</span><span class="sxs-lookup"><span data-stu-id="2c0ed-148">You can obtain this value from the Azure Resource Manager API or the portal.</span></span>
  - <span data-ttu-id="2c0ed-149">`[SecurityAlertPolicyName <SecurityAlertPolicyName?>]`: Der Name der Sicherheitswarnungsrichtlinie.</span><span class="sxs-lookup"><span data-stu-id="2c0ed-149">`[SecurityAlertPolicyName <SecurityAlertPolicyName?>]`: The name of the security alert policy.</span></span>
  - <span data-ttu-id="2c0ed-150">`[ServerName <String>]`: Der Name des Servers.</span><span class="sxs-lookup"><span data-stu-id="2c0ed-150">`[ServerName <String>]`: The name of the server.</span></span>
  - <span data-ttu-id="2c0ed-151">`[SubscriptionId <String>]`: Die Abonnement-ID, die ein Azure-Abonnement identifiziert.</span><span class="sxs-lookup"><span data-stu-id="2c0ed-151">`[SubscriptionId <String>]`: The subscription ID that identifies an Azure subscription.</span></span>
  - <span data-ttu-id="2c0ed-152">`[VirtualNetworkRuleName <String>]`: Der Name der Regel für das virtuelle Netzwerk.</span><span class="sxs-lookup"><span data-stu-id="2c0ed-152">`[VirtualNetworkRuleName <String>]`: The name of the virtual network rule.</span></span>

## <span data-ttu-id="2c0ed-153">LINKS ZU VERWANDTEN THEMEN</span><span class="sxs-lookup"><span data-stu-id="2c0ed-153">RELATED LINKS</span></span>
