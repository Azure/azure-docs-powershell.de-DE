...
## BESCHREIBUNG
Das Entfernen eines Serverendpunkts ist ein destruktiver Vorgang. Dieser Serverspeicherort beendet die Synchronisierung. Dieser Vorgang sollte nicht zum Beheben von Synchronisierungsproblemen ausgeführt werden. Wenn dieser Serverspeicherort (inkl. seine Dateien) derselben Synchronisierungsgruppe wie ein Serverendpunkt erneut hinzugefügt wird, kann dies zu Konfliktdateien und anderen unbeabsichtigten Folgen führen. Dieser Befehl ist nur für die Außerbetriebnahme vorgesehen.
...
Mit diesem Befehl wird der Serverendpunkt entfernt.
...
### -Force
Liefern Sie "-Force", um die Bestätigung dieses Befehls zu überspringen.
...
### -InputObject
ServerEndpoint-Eingabeobjekt, das normalerweise über die Pipeline übergeben wird.
