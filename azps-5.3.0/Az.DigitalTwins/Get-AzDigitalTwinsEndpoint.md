...
### Beispiel 1: Auflisten von AzDigitalTwinsEndpoint in "ResourceGroup"
```powershell
...
Auflisten aller AzDigitalTwinsEndpoints nach ResourceGroupName

### Beispiel 2: Erhalten von AzDigitalTwinsEndpoint nach EndpointName
```powershell
...
Herunterladen von AzDigitalTwinsEndpoint nach EndpointName in ResourceGroup

### Beispiel 3: Get AzDigitalTwinsEndpoint by 'AzDigitalTwinsEndpoint' Object
```powershell
...
AzDigitalTwinsEndpoint von 'AzDigitalTwinsEndpoint' Object
