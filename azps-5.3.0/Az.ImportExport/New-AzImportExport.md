...
Gibt an, ob die Manifestdateien auf den Laufwerken in blockierte BLOBS kopiert werden sollen.
...
### -BlobListBlobPath
Eine Auflistung von BLOB-Pfad-Zeichenfolgen.
...
Eine Sammlung von Zeichenfolgen mit BLOB-Präfix.
...
Ein BLOB-Pfad, der auf einen Block-BLOB verweist, der eine Liste von BLOB-Namen enthält, die aufgrund des unzureichenden Laufwerkspeichers nicht exportiert wurden.
...
Das Bundesland oder die Provinz, das bzw. die bei der Rückgabe der Laufwerke zu verwenden ist.
...
DRIVELIST <IDriveStatus[]>: Liste von bis zu zehn Laufwerken, die in diesem Auftrag enthalten sind. Die Laufwerkliste ist ein erforderliches Element für einen Importauftrag. für Exportaufträge nicht angegeben.
