...
## SYNOPSIS
Gibt Informationen zur Verwendung SQL Azure-Instanzpools zurück.
...
## BESCHREIBUNG
Das **Cmdlet "Get-AzSqlInstancePoolUsage"** gibt Informationen zurück, die von einem Azure SQL-Instanzpool verwendet werden.

## BEISPIELE

### Beispiel 1: Ruft die Verwendung eines Azure SQL -Instanzpools ab.
```powershell
...
Ruft die Verwendung für azure SQL Instanzpoolinstanzinstanzinstanzpool0 ab.

### Beispiel 2: Ruft die Verwendung eines Azure SQL-Instanzpools mithilfe eines Instanzpoolobjekts ab.
```powershell
...
Ruft die Verwendung des Azure SQL Instanzpoolinstanzinstanzpool0 mithilfe eines Instanzpoolobjekts ab.

### Beispiel 3: Ruft die Verwendung eines Azure SQL-Instanzpools mithilfe einer Ressourcen-ID des Instanzpools ab.
```powershell
...
Ruft die Verwendung des Azure SQL Instanzpoolinstanzinstanzpool0 mithilfe eines Ressourcenbezeichners des Instanzpools ab.

### Beispiel 3: Ruft die Verwendung eines Azure SQL-Instanzpools mit einer Aufschlüsselung der Nutzungen verwalteter Instanzen innerhalb des Pools ab.
```powershell
...
Ruft die Verwendung des Azure SQL Instanzpoolinstanzinstanzpool0 zusammen mit den Verwendungen der verwalteten Instanzen in instancepool0 ab.
...
### -Expand1
Flag, das angibt, ob die Nutzung dieses Instanzpools mit der Nutzung der Kinder erweitert werden soll.
...
### -InstancePool
Das übergeordnete Instanzpoolobjekt.
...
### -Name
Der Name des verwalteten Instanzpools.
