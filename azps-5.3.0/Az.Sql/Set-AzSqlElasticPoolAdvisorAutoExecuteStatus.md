...
## BESCHREIBUNG
Das **Cmdlet "Set-AzSqlElasticPoolAdvisorAutoExecuteStatus"** legt die Eigenschaft für die automatische Ausführung für einen Azure SQL Pool Advisor fest.
...
Dieser Befehl legt den Status der automatischen Ausführung eines Beraters namens CreateIndex auf aktiviert fest.

## PARAMETERS

### -AdvisorName
Gibt den Namen des Beraters an, für den dieses Cmdlet den Status der automatischen Ausführung aktualisiert.
...
### -AutoExecuteStatus
Gibt einen neuen Wert an, für den dieses Cmdlet den Status der automatischen Ausführung aktualisiert.
