...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzSqlSyncMember"** entfernt ein Azure SQL Database Sync Member.

## BEISPIELE

### Beispiel 1: Entfernen eines Synchronisierungsmitglieds
```
...
Mit diesem Befehl wird das Azure SQL-Datenbanksynchronisierungsmember namens "syncMember01" entfernt.
...
### -PassThru
Definiert, ob das entfernte Synchronisierungsmmitglied zurückgeben wird.
