...
## BESCHREIBUNG
Das **Cmdlet "Get-AzSqlElasticPoolRecommendedAction"** ruft eine oder mehrere empfohlene Aktionen für einen Azure SQL Poolratgeber ab.

## BEISPIELE

### Beispiel 1: Auflisten aller empfohlenen Aktionen für einen Berater
```
...
Dieser Befehl ruft eine Liste aller empfohlenen Aktionen des Beraters "CreateIndex" ab, der für den Pool mit dem Namen WIPool verfügbar ist.

### Beispiel 2: Erhalten einer einzigen empfohlenen Aktion für einen Berater
```
...
Dieser Befehl ruft die empfohlene Aktion mit dem Namen IR_ \[ test_schema \] _ \[ test_table_0.0361551 _6C7AE8CC9C87E7FD5893 des Beraters \] "CreateIndex" ab.

## PARAMETERS

### -AdvisorName
Gibt den Namen des Beraters an, für den dieses Cmdlet empfohlene Aktionen anfordert.
...
### -PoolName
Gibt den Namen des Poolpools an, für den dieses Cmdlet empfohlene Aktionen anfordert.
...
Gibt den Namen der empfohlenen Aktion an, die dieses Cmdlet erhält.
...
## HINWEISE
* Schlüsselwörter: azure, azurerm, arm, resource, management, manager, sql,pool, mssql, advisor, recommendedaction
