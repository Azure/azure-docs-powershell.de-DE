...
Geben Sie den Namen eines Servers an, um Informationen nur für diesen Server zu sehen.
...
### Beispiel 4: Erhalten aller Instanzen von SQL Server, die einer Ressourcengruppe mithilfe der Filterung zugewiesen wurden
```
