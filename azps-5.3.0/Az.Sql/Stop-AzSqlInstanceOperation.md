...
## BESCHREIBUNG
Das Stop-AzSqlInstanceOperation cmdlet beendet den Vorgang mit dem angegebenen Vorgangsnamen in SQL verwalteten Instanz.

## BEISPIELE

### Beispiel 1: Erhalten eines bestimmten Vorgangs
```powershell
...
Dieser Befehl beendet den Vorgang mit dem Namen 'd0f5bef5-e2b1-4ef8-bb42-2e54073874f9' für eine verwaltete SQL Instanz.

### Beispiel 2: Verwenden der Vorgangsressourcen-ID
```powershell
