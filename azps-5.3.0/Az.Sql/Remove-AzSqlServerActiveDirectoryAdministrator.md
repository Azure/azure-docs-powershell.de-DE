...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzSqlServerActiveDirectoryAdministrator"** entfernt einen Azure Active Directory (Azure AD)-Administrator für AzureSQL Server im aktuellen Abonnement.
...
Mit diesem Befehl wird der Azure -AD-Administrator für den Server namens Server01 entfernt, der der Ressourcengruppe "ResourceGroup01" zugeordnet ist.
...
### -ServerName
Gibt den Namen des Felds SQL Server für das dieses Cmdlet einen Administrator entfernt.
