...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzSqlSyncGroup"** entfernt eine Azure SQL Database Sync Group.
...
Mit diesem Befehl wird die Azure SQL-Datenbanksynchronisierungsgruppe namens "syncGroup01" entfernt.
...
### -PassThru
Definiert, ob die entfernte Synchronisierungsgruppe zurückgeben wird.
