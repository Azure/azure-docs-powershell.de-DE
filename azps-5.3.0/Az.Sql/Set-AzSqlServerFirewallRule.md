...
## BESCHREIBUNG
Das **Cmdlet Set-AzSqlServerFirewallRule** ändert eine Firewallregel in einem Azure SQL-Datenbankserver.

## BEISPIELE

### Beispiel 1: Ändern einer Firewallregel
```
...
Mit diesem Befehl wird eine Firewallregel namens "Regel01" auf dem Server "Server01" geändert.
Der Befehl ändert die Start- und End-IP-Adressen.
...
### -FirewallRuleName
Gibt den Namen der Firewallregel an, die von diesem Cmdlet geändert wird.
