...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzSqlInstanceActiveDirectoryAdministrator"** entfernt einen Azure Active Directory (Azure AD)-Administrator für eine azureSQL-verwaltete Instanz im aktuellen Abonnement.
...
Mit diesem Befehl wird der Azure AD-Administrator für die verwaltete Instanz namens "ManagedInstanceName01" entfernt, die der Ressourcengruppe "ResourceGroup01" zugeordnet ist.
...
Mit diesem Befehl wird der Azure AD-Administrator aus dem verwalteten Instanzobjekt entfernt.
...
Mit diesem Befehl wird der Azure AD-Administrator mit dem Ressourcenbezeichner für verwaltete Instanzen entfernt.
...
### -PassThru
Definiert, ob der entfernte Ad-Administrator zurückgeben werden soll.
