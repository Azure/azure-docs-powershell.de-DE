...
### -MinimalTlsVersion
Die minimale TLS-Version, die für Sql Server erzwungen werden muss
...
### -PublicNetworkAccess
Verwendet eine Kennzeichnung(en), die aktiviert/deaktiviert ist, um anzugeben, ob der Zugriff auf den Server im öffentlichen Netzwerk zulässig ist.
...
### -SqlAdministratorPassword
Gibt ein neues Kennwort als **SecureString für** den Datenbankserveradministrator an. Verwenden Sie zum **Abrufen von SecureString** das Get-Credential Cmdlet. Weitere Informationen erhalten Sie, wenn Sie " `Get-Help
