...
## BESCHREIBUNG
Den spezifischen Azure SQL Server-DNS-Alias erhalten oder alle Server-DNS-Aliase für den Server auflisten
...
Erhält Server-DNS-Alias, der durch den Server- und Aliasnamen angegeben wird.
