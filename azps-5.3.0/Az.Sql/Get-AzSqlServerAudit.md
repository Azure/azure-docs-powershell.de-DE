...
## BESCHREIBUNG
Das **Cmdlet "Get-AzSqlServerAudit"** ruft die Überwachungseinstellungen eines Azure SQL ab.
Geben Sie die *Parameter "ResourceGroupName"* und *"ServerName"* an, um den Server zu identifizieren.

## BEISPIELE

### Beispiel 1: Erhalten der Überwachungseinstellungen eines Azure SQL Servers
```
...
### Beispiel 2: Erhalten der Überwachungseinstellungen eines Azure SQL Pipeline
```
...
### Beispiel 3: Erhalten der Überwachungseinstellungen eines Azure SQL Servers
```
PS C:\>Get-AzSqlServerAudit -ResourceGroupName "resourcegroup01" -ServerName "server01"
ServerName                          : server01
ResourceGroupName                   : resourcegroup01
