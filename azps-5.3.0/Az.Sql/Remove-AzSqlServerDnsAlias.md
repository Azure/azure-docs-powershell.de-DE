...
### Entfernen eines Server-DNS-Alias aus Den Eingabeparametern des Cmdlets
```
Remove-AzSqlServerDnsAlias -Name <String> -ServerName <String> [-ResourceGroupName] <String> [-Force] [-AsJob]
 [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Entfernen eines Server-Dns-Alias aus der AzureSqlServerDnsAliasModel-Instanzdefinition
```
...
## BESCHREIBUNG
Mit diesen Befehlen wird der Azure SQL Server-DNS-Alias vom Server entfernt, und der Server bleibt intakt.
...
Entfernt den Azure SQL Server-DNS-Alias mit dem Namen "aliasName" vom Server mit dem Namenservername.
...
### -InputObject
Das zu entfernende Server-DNS-Aliasobjekt
...
### -Name
Azure Sql Server-Dns-Aliasname
...
### -ResourceId
Die Ressourcen-ID des zu entfernende Server-Dns-Aliasobjekts
