...
## BESCHREIBUNG
Das Clear-AzSqlServerAdvancedThreatProtectionSetting entfernt die erweiterten Threat Protection-Einstellungen von einem Azure SQL Server.
Um dieses Cmdlet zu verwenden, geben Sie die Parameter "ResourceGroupName" und "ServerName" an, um den Server zu identifizieren, von dem dieses Cmdlet die Einstellungen entfernt.
...
Mit diesem Befehl werden die erweiterten Threat Protection-Einstellungen von einem Server namens Server01 entfernt.
