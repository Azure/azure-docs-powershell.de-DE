...
### Beispiel 10: Deaktivieren des Sendens von Überwachungsdatensätzen einer Azure SQL-Datenbank an BLOB-Speicher und Aktivieren des Sendens zur Protokollanalyse.
```powershell
