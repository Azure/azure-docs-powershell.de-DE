...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzSqlElasticPool"** löscht einen Azure SQL Database-Pool.

## BEISPIELE

### Beispiel 1: Löschen eines Pool im Pool
```
PS C:\>Remove-AzSqlElasticPool -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -ElasticPoolName "ElasticPool01"
```

Mit diesem Befehl wird ein Pool mit dem Namen "PoolsPool01" gelöscht.
...
### -PoolName
Gibt den Namen des Pool für den Pool an, der von diesem Cmdlet gelöscht wird.
