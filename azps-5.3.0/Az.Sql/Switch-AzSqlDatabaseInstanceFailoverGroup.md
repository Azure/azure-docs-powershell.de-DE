...
## BESCHREIBUNG
Dieser Befehl tauscht die Rollen der verwalteten Instanzen in einer Instanz failovergruppe aus, indem ein Failover zum angegebenen sekundären Bereich fehlt, wodurch er zur neuen primären Region wird. Alle neuen TDS-Sitzungen, die mit dem primären Endpunkt verbunden sind, werden automatisch an die neue primäre Region umgeroutet. 
...
Führen Sie einen Failovervorgang aus, der Datenverlust ermöglicht, indem sie in die Instanz failovergruppe pipiert.
...
### -AllowDataLoss
Schließen Sie den Failover ab, auch wenn dies zu Datenverlust führen kann.
Dadurch kann der Failover fortgesetzt werden, auch wenn eine primäre Datenbank nicht verfügbar ist.
...
### -InputObject
Das zu wechselnde Instanz-Failovergruppenobjekt
...
### -ResourceId
Die Ressourcen-ID der zu wechselnde Instanz failovergruppe.
