...
## SYNOPSIS
Ruft azure AD only authentication for a specific SQL Server.
...
## BESCHREIBUNG
Das **Cmdlet "Get-AzSqlServerActiveDirectoryOnlyAuthentication"** ruft im aktuellen Abonnement nur die Authentifizierungsanforderung für Azure Active Directory (Azure AD) für einen AzureSQL Server ab.
...
Dieser Befehl ruft nur die Authentifizierungsanforderung für Azure Active Directory (Azure AD) für einen AzureSQL-Server namens Server01 ab, der einer Ressourcengruppe mit dem Namen "ResourceGroup01" zugeordnet ist.
...
### -ServerName
Der Name des Azure SQL Server, in dem nur die Azure Active Directory-Authentifizierung aktiv ist.
