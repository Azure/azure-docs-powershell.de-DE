...
## BESCHREIBUNG
Das **Cmdlet "Update-AzSqlSyncGroup"** ändert die Eigenschaften eines Azure SQL Database Sync Member.
...
Mit diesem Befehl wird das Administratorkennwort für die Memberdatenbank zurückgesetzt.
...
Gibt an, ob beim Herstellen einer Verbindung mit diesem Synchronisierungsmitglied ein privater Link verwendet werden soll.
