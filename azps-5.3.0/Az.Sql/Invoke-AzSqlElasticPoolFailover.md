...
## BESCHREIBUNG
Das Invoke-AzSqlElasticPoolFailover A0 über einen Pool im Pool. Der Failover erfolgt für alle Datenbanken im Pool des Pool, nachdem dieses Cmdlet ausgeführt wurde.
...
Mit diesem Befehl wird ein Failover des Pool "FailoverPool01" auf dem Server namens "Server01" ausgeführt.  Dies bedeutet, dass der Failover für alle Datenbanken im Pool mit dem Namen "FailoverPool01" erfolgt.
...
### -PoolName
Der Name des azure SQL Pool, der entfernt werden soll.
...
### -ServerName
Der Name des Azure SQL Server, in dem sich der Pool "Pool" befindet.
