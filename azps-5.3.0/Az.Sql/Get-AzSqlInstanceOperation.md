...
## BESCHREIBUNG
Das Get-AzSqlInstanceOperation cmdlet ruft Informationen zu den Vorgängen in einer verwalteten instanz SQL ab. Sie können alle Vorgänge in einer verwalteten Instanz oder einen bestimmten Vorgang anzeigen, indem Sie den Namen des Vorgangs eingeben.

## BEISPIELE

### Beispiel 1: Alle Vorgänge der Instanz erhalten
```powershell
...
Dieser Befehl ruft alle Vorgänge als verwaltete SQL ab.

### Beispiel 2: Erhalten eines bestimmten Vorgangs
```powershell
...
Dieser Befehl ruft den Vorgang mit dem Namen '5870c6d8-6703-4b27-8ae4-687b4ca7caea' für eine verwaltete instanz SQL ab.

### Beispiel 3: Verwenden der Vorgangsressourcen-ID
```powershell
...
Dieser Befehl ruft den Vorgang mit id '/subscriptions/a8c9a924-06c0-4bde-9788-e7b1370969e1/resourceGroups/ps3753/providers Microsoft.Sql/managedInstances/ps3698/operations/5870c6d8-6703-4b27-8ae4-687b4ca7caea'.
...
### -ResourceId
Der Ressourcenbezeichner für den Verwalteten Instanzvorgang.
