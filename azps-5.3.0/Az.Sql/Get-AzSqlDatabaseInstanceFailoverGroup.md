...
## BESCHREIBUNG
Ruft eine bestimmte Instanz failovergruppe ab oder listet die Instanz failovergruppen in einer Region unter dem Abonnement des Benutzers auf.

Beide Regionen in der Instanz failovergruppe können zum Ausführen des Befehls verwendet werden. Die zurückgegebenen Werte geben den Status der verwalteten Instanzen in dieser Region im Hinblick auf die Instanz failovergruppe wieder.
...
Listet alle Failovergruppen in der Region auf.
...
Sie erhalten eine bestimmte Instanz-Failovergruppe.
...
### -Name
Der Name der abzurufende Instanz failovergruppe.
