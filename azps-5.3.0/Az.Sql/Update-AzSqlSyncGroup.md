...
## BESCHREIBUNG
Das **Cmdlet "Update-AzSqlSyncGroup"** ändert die Eigenschaften einer Azure SQL-Datenbanksynchronisierungsgruppe.
...
Gibt an, ob beim Herstellen einer Verbindung mit dem Hub dieser Synchronisierungsgruppe eine private Linkverbindung verwendet werden soll.
