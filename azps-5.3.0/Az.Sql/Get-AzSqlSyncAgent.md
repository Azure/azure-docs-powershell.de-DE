...
## BESCHREIBUNG
Das **Cmdlet "Get-AzSqlSyncAgent"** gibt Informationen zu einem oder mehreren Azure SQL Sync Agents zurück.
Geben Sie den Namen eines Synchronisierungs-Agents an, um nur Informationen zu diesem Synchronisierungs-Agent zu sehen.

## BEISPIELE

### Beispiel 1: Erhalten aller Instanzen von Azure SQL-Synchronisierungs-Agent, die einem Azure SQL Server
```
...
Dieser Befehl ruft Informationen zu allen Azure SQL-Synchronisierungs-Agents ab, die einem Azure-SQL Server.

### Beispiel 2: Informationen zu einem Azure SQL-Synchronisierungs-Agent
```
...
Dieser Befehl ruft Informationen zum Azure SQL-Datenbanksynchronisierungs-Agent mit dem Namen "SyncAgent01" ab.

### Beispiel 3: Erhalten aller Instanzen von Azure SQL-Synchronisierungs-Agent, der einem Azure SQL Server mithilfe der Filterung zugewiesen wurde
```
...
Dieser Befehl ruft Informationen zu allen Azure SQL-Synchronisierungs-Agents ab, die einem Azure SQL Server, die mit "SyncAgent" beginnen.
