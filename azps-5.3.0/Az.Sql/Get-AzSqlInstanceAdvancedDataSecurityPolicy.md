...
## BESCHREIBUNG
Das **Cmdlet "Get-AzSqlInstanceAdvancedDataSecurityPolicy"** ruft die Advanced Data Security-Richtlinie einer verwalteten Instanz ab.

## BEISPIELE

### Beispiel 1: Verwaltete Instanz Advanced Data Security
```powershell
...
### Beispiel 2: Ruft die verwaltete Instanz Advanced Data Security aus einer verwalteten Instanzressource ab.
```powershell
