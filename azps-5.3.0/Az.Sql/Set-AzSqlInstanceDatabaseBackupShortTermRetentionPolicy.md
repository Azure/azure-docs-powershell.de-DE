...
## BESCHREIBUNG
Das **Cmdlet "Set-AzSqlInstanceDatabaseBackupShortTermRetentionPolicy"** ruft die kurzfristige Aufbewahrungsrichtlinie ab, die in dieser Datenbank registriert ist.
...
Mit diesem Befehl wird die kurzfristige Aufbewahrungsrichtlinie für Datenbank01 auf 35 Tage definiert.
...
Mit diesem Befehl wird die kurzfristige Aufbewahrungsrichtlinie für Datenbank01 über die Piping in einem Datenbankobjekt auf 35 Tage definiert.
...
Mit diesem Befehl wird die kurzfristige Aufbewahrungsrichtlinie für alle gelöschten Datenbanken namens DB1 über die Piping in einem gelöschten Datenbankobjekt definiert. Beachten Sie, dass Sie den Aufbewahrungszeitraum für gelöschte Datenbanken nur verringern können.
...
### -DeletionDate
Das Löschdatum der Azure SQL-Instanzdatenbank zum Abrufen von Sicherungen mit Genauigkeit in Millisekunden (z. B. 2016-02-23T00:21:22.847Z)
...
### -InputObject
Das Live- oder gelöschte Datenbankobjekt, für das die Richtlinie festgelegt bzw. für das die Richtlinie festgelegt werden soll.
...
### -InstanceName
Der Name der Azure SQL verwalteten Instanz, in der sich die Datenbank befindet.
