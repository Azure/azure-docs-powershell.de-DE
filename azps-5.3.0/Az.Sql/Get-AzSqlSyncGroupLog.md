...
## BESCHREIBUNG
Das **Cmdlet "Get-AzSqlSyncGroupLog"** gibt die Protokolle einer Azure SQL Database Sync Group zurück.

## BEISPIELE

### Beispiel 1: Erfassen der Protokolle einer Azure SQL-Synchronisierungsgruppe
```
...
### -EndTime
Die Endzeit der zu abfragende Protokolle.
...
### -LogLevel
Der Typ der zu abfragende Protokolle.
...
### -StartTime
Die Startzeit der zu abfragende Protokolle.
