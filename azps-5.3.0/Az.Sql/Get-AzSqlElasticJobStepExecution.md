...
## BESCHREIBUNG
Das Get-AzSqlElasticJobStepExecution cmdlet ruft eine oder mehrere Ausführungen von Auftragsschritten aus einer Auftragsausführung ab.

## BEISPIELE

### Beispiel 1: Ruft eine oder mehrere Ausführungsschritte eines Auftrags ab.
```
...
### Beispiel 2: Ruft eine oder mehrere Ausführungen von Auftragsschritten aus der Ausführung eines Auftrags ab und filtert nach Schrittname.
```
PS C:\> $je = Get-AzSqlElasticJobExecution -ResourceGroupName rg -ServerName elasticjobserver -AgentName agent -JobName job1 -JobExecutionId 3bcfc912-20b2-411d-a2b7-6265d13fe272
...
### -Aktiv
Zum Filtern nach aktiven Ausführungen kennzeichnen.
...
### -CreateTimeMax
Maximale Zeit nach Erstellungszeit filtern
...
### -ParentResourceId
Die Ressourcen-ID für die Ausführung des Auftrags.
...
### Microsoft.Azure.Commands.Sql.BenchmarkJobs.Model.AzureSqlElasticJobExecutionModel
