...
## BESCHREIBUNG
Das **Cmdlet "Get-AzSqlDatabaseActivity"** ruft den Status von Datenbankvorgängen in Azure SQL ab.

## BEISPIELE

### Beispiel 1: Erhalten des Status für alle SQL Datenbankinstanzen
```
PS C:\>Get-AzSqlDatabaseActivity -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -ElasticPoolName "ElasticPool01"
```

Dieser Befehl gibt den Vorgangsstatus aller SQL Datenbankinstanzen in einem Pool namens "Poolpool 1" zurück.

### Beispiel 2: Erhalten des Status für alle SQL Datenbankvorgänge
```
...
### -PoolName
Gibt den Namen des Datenbankpools der Datenbank an, für den dieses Cmdlet den Status erhält.
...
### -ServerName
Gibt den Namen des Microsoft SQL Server an, das die Datenbank hostet.
