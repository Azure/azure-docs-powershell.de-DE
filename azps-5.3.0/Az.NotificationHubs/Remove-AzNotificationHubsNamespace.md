...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzNotificationHubsNamespace"** entfernt einen Benachrichtigungshub-Namespace aus ihrer Bereitstellung.
...
### Beispiel 1: Entfernen eines Benachrichtigungshub-Namespaces
```
PS C:\>Remove-AzNotificationHubsNamespace -Namespace "ContosoNamespace" -ResourceGroup "ContosoNotificationsGroup"
```

Mit diesem Befehl wird der Namespace "ContosoNamespace" entfernt.
