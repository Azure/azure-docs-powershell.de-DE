...
## BESCHREIBUNG
Das **Cmdlet "New-AzNetAppFilesActiveDirectory"** erstellt eine neue Sicherungsrichtlinie für ein ANF-Konto.
...
Dieser Befehl erstellt die neue ANF-Sicherungsrichtlinie für das ANF-Konto mit dem Namen "MyAccount".
...
### -AccountObject
Das Objekt "Account" für die neue Sicherungsrichtlinie
...
### -Enabled
Die Eigenschaft, die zu entscheiden ist, ob die Richtlinie aktiviert ist oder nicht
