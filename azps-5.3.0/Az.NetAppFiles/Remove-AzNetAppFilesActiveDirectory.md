...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzNetAppFilesActiveDirectory"** löscht eine ANF Active Directory-Konfiguration.
...
Mit diesem Befehl wird die neue ANF Active Directory-Konfiguration mit dem Namen "MyADName" gelöscht.
...
### -PassThru
Zurückgeben, ob das angegebene Active Directory erfolgreich entfernt wurde
