...
Dieser Befehl entfernt einen Redis Enterprise-Cache und zeigt an, ob der Vorgang erfolgreich war.

### Beispiel 2: Entfernen eines Redis Enterprise-Caches, ohne dass das Ergebnis angezeigt wird
```powershell
