...
### Beispiel 1: Erhalten von Datenbankzugriffsschlüsseln
```powershell
...
Dieser Befehl ruft die geheimen Zugriffstasten ab, die zum Authentifizieren von Verbindungen mit der Datenbank des Redis Enterprise-Caches namens "MyCache" verwendet werden.
