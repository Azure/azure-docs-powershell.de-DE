...
Mit diesem Befehl wird eine Datenbankdatei in die Datenbank des Redis Enterprise-Caches namens "MyCache" importiert.

### Beispiel 2: Importieren einer Datenbank (unter Verwendung des Beispieldateinamens)
```powershell
#[SuppressMessage("Microsoft.Security", "CS002:SecretInNextLine", Justification="Invalid SAS token")]
...
### -SasUri
SAS-URI für das ziel-BLOB, aus dem importiert werden soll
