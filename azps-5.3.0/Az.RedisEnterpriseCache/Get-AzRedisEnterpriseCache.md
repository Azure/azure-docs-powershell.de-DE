...
### Beispiel 1: Erhalten eines Redis Enterprise-Caches nach Name
```powershell
...
Dieser Befehl ruft den Redis Enterprise-Cache namens "MyCache" ab.

### Beispiel 2: Jeden Redis -Enterprise-Cache in einer Ressourcengruppe erhalten
```powershell
...
Dieser Befehl ruft jeden Redis Enterprise-Cache in der angegebenen Ressourcengruppe ab.
