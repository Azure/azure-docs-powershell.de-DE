...
### Beispiel 1: Aktualisieren eines virtuellen Desktops in Windows
```powershell
...
Mit diesem Befehl wird ein virtueller Windows-Desktop-Desktop in einer Anwendungsgruppe aktualisiert.
