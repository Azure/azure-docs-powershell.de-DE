...
### Beispiel 1: Aktualisieren einer virtuellen Windows-Desktopanwendung
```powershell
...
Mit diesem Befehl wird eine virtuelle Windows-Desktopanwendung in einer Anwendungsgruppe aktualisiert.
...
### -CommandLineSetting
Gibt an, ob diese veröffentlichte Anwendung mit Vom Client bereitgestellten Befehlszeilenargumenten, Befehlszeilenargumenten, die zum Zeitpunkt der Veröffentlichung angegeben werden, oder überhaupt nicht mit Befehlszeilenargumenten gestartet werden kann.
