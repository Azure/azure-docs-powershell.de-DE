...
### Beispiel 1: Löschen einer Windows Virtual Desktop UserSession nach Name
```powershell
...
Mit diesem Befehl wird eine Windows Virtual Desktop UserSession in einem Sitzungshost gelöscht.
...
### -Force
Erzwingen Sie die Anmeldung des Kennzeichens von "userSession".
