...
### Beispiel 1: Erhalten eines virtuellen Desktopdesktops für Windows nach Name
```powershell
...
Dieser Befehl ruft einen virtuellen Windows-Desktop-Desktop in einer Anwendungsgruppe ab.

### Beispiel 2: Auflisten der virtuellen Desktopdesktops von Windows
```powershell
...
In diesem Befehl werden die virtuellen Desktopdesktops in einer Anwendungsgruppe aufgeführt.
...
### -Name
Der Name des Desktops in der angegebenen Desktopgruppe
