...
### Beispiel 1: Erhalten eines Tokens für die Registrierung des virtuellen Windows-Desktops
```powershell
...
Dieser Befehl ruft ein Windows Virtual Desktop Registration Token in einem Hostpool ab.
