...
### Beispiel 1: Erweitert den angegebenen Bildpfad und ruft Paketmetadaten aus der AppxManifest.xml
```powershell
...
Dieser Befehl gibt metadaten von MSIX Package zurück, die im angegebenen Bildpfad gefunden wurden.
...
### -MsixImageUri
Stellt einen URI dar, der sich auf "MSIX Image To construct" bezieht. Informationen finden Sie im Abschnitt "NOTES" für #A0 und erstellen eine Hashtabelle.
...
MSIXIMAGEURI <IMsixImageUri> : Stellt einen URI dar, der auf das MSIX Image verweist.
