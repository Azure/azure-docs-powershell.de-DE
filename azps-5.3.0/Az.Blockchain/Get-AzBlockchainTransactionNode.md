...
### Beispiel 1: Auflisten von Transaktionsknoten für ein Mitglied
```powershell
...
Dieser Befehl listet Transaktionsknoten für ein mitglied auf.

### Beispiel 2: Erhalten eines Transaktionsknotens
```powershell
...
Dieser Befehl ruft einen Transaktionsknoten ab.

### Beispiel 3: Erhalten eines Transaktionsknotens
```powershell
