...
### Beispiel 1: Neuer generieren von API-Schlüsseln für ein Mitglied unter Verwendung des Namens
```powershell
...
Mit diesem Befehl werden die API-Schlüssel für ein Mitglied erneut generiert, indem der Name, die Ressourcengruppe verwendet wird.

### Beispiel 2: Neuer generieren von API-Schlüsseln für ein Mitglied mit Idenity
```powershell
PS C:\> $keyPair = Get-AzBlockchainMemberApiKey -BlockchainMemberName myblockchainhlqc92 -ResourceGroupName bc-rg
...
Mit diesem Befehl werden die API-Schlüssel für ein Mitglied einer Person mithilfe der Identität erneut generiert.
...
### -KeyName
Ruft den Namen des API-Schlüssels ab oder legt den Namen fest.
...
### -Value
Ruft den Wert des API-Schlüssels ab oder legt den Wert fest.
