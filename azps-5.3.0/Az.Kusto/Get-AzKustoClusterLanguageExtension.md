...
### Beispiel 1: Auflisten aller für einen Cluster festgelegten Spracherweiterungen
```powershell
...
Der oben aufgeführte Befehl gibt eine Liste der Spracherweiterungen zurück, die innerhalb von KQL-Abfragen ausgeführt werden können.
