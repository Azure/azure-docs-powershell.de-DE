...
### Beispiel 1: Liste der berechtigten SKUs
```powershell
...
Im obigen Befehl werden die geeigneten SKUs aufgeführt.

### Beispiel 2: Listet die geeigneten SKUs für einen bestimmten Cluster auf.
```powershell
...
Der oben aufgeführte Befehl listet die geeigneten SKUs für bestimmte Cluster auf.
