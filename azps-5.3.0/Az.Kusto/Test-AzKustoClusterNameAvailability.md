...
### Beispiel 1: Überprüfen der Verfügbarkeit eines verwendeten Namens eines Kusto-Clusters
```powershell
...
Der oben aufgeführte Befehl gibt zurück, ob ein Kusto-Cluster mit dem Namen "testnewkustocluster" in der Region "Ost US" vorhanden ist.

### Beispiel 2: Überprüfen der Verfügbarkeit eines nicht verwendeten Namens eines Kusto-Clusters
```powershell
...
Der oben aufgeführte Befehl gibt zurück, ob ein Kusto-Cluster namens "availablekustocluster" in der Region "Ost US" vorhanden ist.
...
### -Type
Der Ressourcentyp "Microsoft.Kusto/cluster".
