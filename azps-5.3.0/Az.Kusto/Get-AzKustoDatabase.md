...
### Beispiel 1: Auflisten aller Datenbanken in einem Cluster nach Namen
```powershell
...
Der oben aufgeführte Befehl gibt die Datenbank "Kusto" mit dem Namen "mykustodatabase" im Cluster "testnewkustocluster" zurück, der in der Ressourcengruppe "testrg" gefunden wurde.
