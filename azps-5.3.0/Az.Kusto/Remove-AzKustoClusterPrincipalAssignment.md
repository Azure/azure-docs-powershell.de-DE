...
### Beispiel 1: Löschen einer vorhandenen PrincipalAssignment für den Kusto-Cluster nach Name
```powershell
...
Der obige Befehl löscht das PrincipalAssignment namens "kustoprincipal1" im Kusto-Cluster "testnewkustocluster".
