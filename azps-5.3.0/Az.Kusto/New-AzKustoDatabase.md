...
### Beispiel 1: Erstellen einer neuen "Kusto"-Datenbank nach Name
```powershell
...
Mit dem oben angegebenen Befehl wird eine neue "kusto"-Datenbank namens "mykustodatabase" im vorhandenen Cluster "testnewkustocluster" erstellt, der in der Ressourcengruppe "testrg" gefunden wurde.
