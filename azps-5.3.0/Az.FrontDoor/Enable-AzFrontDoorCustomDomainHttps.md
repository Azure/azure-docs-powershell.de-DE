...
## BESCHREIBUNG
Mit **"Enable-AzFrontDcustomDomainHttps"** wird HTTPS für eine benutzerdefinierte Domäne aktiviert.

## BEISPIELE

### Beispiel 1: Aktivieren von HTTPS für eine benutzerdefinierte Domäne mit "FrontD ganznamename" und "ResourceGroupName" mithilfe eines verwalteten Zertifikats von Front Door.
```powershell
...
Aktivieren Sie HTTPS für eine benutzerdefinierte Domäne "frontendpointname1-custom-xyz", die teil von "frontd door1" in der Ressourcengruppe "resourcegroup1" ist, indem Sie ein von Front Door verwaltetes Zertifikat verwenden.

### Beispiel 2: Aktivieren von HTTPS für eine benutzerdefinierte Domäne mit "FrontD ganznamename" und "ResourceGroupName" mithilfe eines eigenen Zertifikats im Schlüsseltresor.
```powershell
...
### Beispiel 3: Aktivieren von HTTPS für eine benutzerdefinierte Domäne mit einem PSFrontendEndpoint-Objekt mithilfe eines verwalteten Zertifikats von Front Door.
```powershell
...
Aktivieren Sie HTTPS für eine benutzerdefinierte Domäne mit einem PSFrontendEndpoint-Objekt mithilfe eines verwalteten Zertifikats von Front Door.

### Beispiel 4: Aktivieren von HTTPS für eine benutzerdefinierte Domäne mit Ressourcen-ID mithilfe eines verwalteten Zertifikats von Front Door.
```powershell
...
Aktivieren Sie HTTPS für eine benutzerdefinierte Domäne "frontendpointname1-custom-xyz" mit ressourcen-id $resourceId mit verwalteten Zertifikaten von Front Door.
...
### -InputObject
Das zu aktualisierende Frontend-Endpunkt-Objekt.
...
### -ResourceId
Ressourcen-ID des Endpunkts von Eingangstüren zum Aktivieren von https
...
### -SecretVersion
Die Version des geheimen Schlüsseltresor, der die vollständige Zertifikat-PFX darstellt
...
### -VaultId
Die Schlüsseltresor-ID mit dem SSL-Zertifikat
