...
### -ForwardingProtocol
Das Protokoll, das von dieser Regel verwendet wird, wenn Datenverkehr an Back-End-Ends weitergeleitet wird.
...
### Microsoft.Azure.Commands.FrontD selbst.Models.PSRulesEngineAction
