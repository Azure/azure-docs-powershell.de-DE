...
### Beispiel 1: Onboarding des Computers, den Sie als verbundenen Computer haben
```powershell
...
Hinweis: Derzeit wird nur Windows als Ziel unterstützt.
...
### -Proxy
Der URI für den zu verwendende Proxyserver
...
### -PSSession
Wenn angegeben, wird der Befehl, der Computer in Azure einhauft, in den einzelnen PSSessions ausgeführt.
