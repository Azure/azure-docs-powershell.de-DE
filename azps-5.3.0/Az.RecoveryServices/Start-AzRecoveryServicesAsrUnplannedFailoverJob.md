...
## BESCHREIBUNG
Das **Cmdlet "Start-AzRecoveryServicesAsrUnplannedFailoverJob"** startet einen nicht geplanten Failover eines geschützten Elements oder Wiederherstellungsplans für die Azure-Websitewiederherstellungsreplikation.
Sie können mithilfe des Cmdlets "Get-AzRecoveryServicesAsrJob überprüfen, ob der Auftrag erfolgreich war.
...
Startet den nicht geplanten Failovervorgang für den Wiederherstellungsplan mit den angegebenen Parametern und gibt den ASR-Auftrag zurück, mit dem der Vorgang nachverfolgt wird.

### Beispiel 2

Startet einen nicht geplanten Failovervorgang. (automatisch generiert)
...
Gibt den Dateipfad des primären Zertifikats für die Datenverschlüsselung für den Failover des geschützten Elements an.
...
Gibt den Dateipfad des sekundären Zertifikats für die Datenverschlüsselung für den Failover des geschützten Elements an.
...
Führen Sie den Vorgang auf der Quellseite aus, bevor Sie einen ungeplanten Failover starten.
...
### -RecoveryPoint
Gibt einen benutzerdefinierten Wiederherstellungspunkt für den Failover des geschützten Computers an.
...
### -RecoveryTag
Gibt das Wiederherstellungstag für den Failover an.
...
Gibt ein geschütztes Element für die Azure-Websitewiederherstellungsreplikation an.
