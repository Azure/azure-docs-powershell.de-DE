...
## BESCHREIBUNG
Das **Cmdlet "New-AzRecoveryServicesAsrProtectionContainerMapping"** erstellt eine Azure Site Recovery Protection-Containerzuordnung, indem die angegebene Replikationsrichtlinie dem angegebenen Schutzcontainer zugeordnet wird.
...
Startet die Erstellung der Schutzcontainerzuordnung mit den angegebenen Parametern und gibt den ASR-Auftrag zurück, mit dem der Vorgang nachverfolgt wird.
...
### -Name
Gibt den Namen der Zuordnung "Schutzcontainer" an.
...
### -Policy
Gibt das ASR-Replikationsrichtlinienobjekt für die Replikationsrichtlinie an, die in der Zuordnung verwendet werden soll.
...
Gibt das ASR-Schutzcontainerobjekt für den primären Schutzcontainer an, der in der Zuordnung verwendet werden soll.
...
Gibt das ASR-Schutzcontainerobjekt für den Wiederherstellungsschutzcontainer an, der in der Zuordnung verwendet werden soll (wird verwendet, wenn es auf einen Wiederherstellungsspeicherort repliziert wird, der nicht Azure ist).
