...
## BESCHREIBUNG
Das **Cmdlet "Set-AzRecoveryServicesBackupProperty"** legt sicherungsspeichereigenschaften für einen Wiederherstellungsdiensttresor fest.

## BEISPIELE

### Beispiel 1: Festlegen des Speichers von GeoRedundant für einen Tresor
```
...
Der zweite Befehl legt die Sicherungsspeicherredundanz für $Vault 01 auf GeoRedundant fest.

## PARAMETERS

### -BackupStorageRedundancy
Gibt den Typ der Sicherungsspeicherredundanz an.
