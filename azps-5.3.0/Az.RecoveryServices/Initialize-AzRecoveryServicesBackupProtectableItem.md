...
## SYNOPSIS
Dieser Befehl löst die Ermittlung ungeschützter Elemente des angegebenen Workloadtyps im angegebenen Container aus. Wenn die Anwendung DB nicht automatisch geschützt ist, verwenden Sie diesen Befehl, um neue PSP zu ermitteln, sobald sie hinzugefügt werden, und zum Schutz fortzufahren.
...
## BESCHREIBUNG
Das Cmdlet fragt nach bestimmten Workloads in einem Container ab. Dadurch wird ein Vorgang ausgelöst, der schützende Elemente erstellt.
...
Dieser Befehl löst die Ermittlung aller ungeschützten Elemente des angegebenen Workloadtyps im angegebenen Container aus. (automatisch generiert)
