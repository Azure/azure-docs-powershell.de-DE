...
Startet den Vorgang zum Erstellen von replikationsgeschützten Element für das angegebene asR-geschützte Element und gibt den ASR-Auftrag zurück, der zum Nachverfolgen des Vorgangs verwendet wird (vmWare zu Azure-Szenario).
...
Startet den replikationsgeschützten Elementerstellungsvorgang für das angegebene asR-geschützte Element und gibt den ASR-Auftrag zurück, mit dem der Vorgang nachverfolgt wird (Azure-zu-Azure-Szenario).
...
Startet den Vorgang zum Erstellen eines replikationsgeschützten Elements für die angegebene VmId und gibt den ASR-Auftrag zurück, mit dem der Vorgang nachverfolgt wird (Azure-zu-Azure-Szenario).
...
### -Name
Gibt einen Namen für das geschützte Element der ASR-Replikation an. Der Name muss innerhalb des Tresors eindeutig sein.
