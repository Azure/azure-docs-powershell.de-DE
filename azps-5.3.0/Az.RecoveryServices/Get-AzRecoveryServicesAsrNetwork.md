...
## BESCHREIBUNG
Das **Cmdlet "Get-AzRecoveryServicesAsrNetwork"** ruft Informationen zu Azure Site Recovery Networks für den aktuellen Azure Site Recovery Vault ab.
...
### -FriendlyName
Anzeigename des Netzwerk-ASR-Objekts.
