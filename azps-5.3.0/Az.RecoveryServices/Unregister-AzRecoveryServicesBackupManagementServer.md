...
Mit diesem Cmdlet werden Verweise auf die Server entfernt, deren Registrierung im Tresor aufgehoben wird.
...
Der erste Befehl ruft den Sicherungsverwaltungsserver mit dem Namen dpmserver01.contoso.com und speichert ihn dann in der $BMS Variable.
Mit dem zweiten Befehl wird die Registrierung des SCDPM-Servers aus dem Tresor aufgehoben.

### Beispiel 2

Die Registrierung eines SCDPM- oder Sicherungsservers aus dem Tresor wird aufgehoben. (automatisch generiert)
...
Der Sicherungscontainer für die Wiederherstellungsdienste.
