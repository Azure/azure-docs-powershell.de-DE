...
Dieser Befehl ruft Metadaten für alle KONFIGURATIONen des DSC-Knotens im Automatisierungskonto "Contoso17" ab, das von der KONFIGURATION "ContosoConfiguration" generiert wurde.

### Beispiel 3: Abgerufene Konfiguration eines DSC-Knotens nach Name
```
...
Dieses Cmdlet ruft Metadaten für die Konfigurationen von DSC-Knoten in der Ressourcengruppe ab, die dieser Parameter angibt.
