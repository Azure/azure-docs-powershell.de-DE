...
## BESCHREIBUNG
Das **Cmdlet "Import-AzAutomationDscConfiguration"** importiert eine Konfiguration der APS Desired State Configuration (DSC) in die Azure-Automatisierung.
...
Mit diesem Befehl wird die DSC-Konfiguration in der Datei namens "client.ps1 in das Automatisierungskonto namens "Contoso17" importiert. Der Befehl gibt den Parameter *"Force"* an. Wenn eine DSC-Konfiguration vorhanden ist, wird sie durch diesen Befehl ersetzt.
...
### -LogVerbose
Gibt an, ob mit diesem Cmdlet die ausführliche Protokollierung für Kompilierungsaufträge dieser DSC-Konfiguration aktiviert oder deaktiviert wird. Geben Sie einen Wert für $True, um die ausführliche Protokollierung zu aktivieren oder $False, um sie zu deaktivieren.
...
### -SourcePath
Gibt den Pfad des Skripts wps_2 an, das die DSC-Konfiguration enthält, die von diesem Cmdlet importiert wird.
