...
## BESCHREIBUNG
Das New-AzAutomationSourceControl erstellt eine Konfiguration, um mein Azure-Automatisierungskonto mit VSTS TFVC, VSTS Git oder GitHub zu verknüpfen.

## BEISPIELE

### Beispiel 1
Erstellen Sie eine Quellcodeverwaltungskonfiguration, um mein Azure-Automatisierungskonto mit meinem VSTS -TFVC-Projekt zu verknüpfen. Bei EINEM TFVC-Projekt gibt es keine Verzweigungen, daher wird der Parameter "Branch" nicht angegeben.
...
### Beispiel 2
Erstellen Sie eine Quellcodeverwaltungskonfiguration, um mein Azure-Automatisierungskonto mit meinem VSTS-Git-Projekt zu verknüpfen.
...
### Beispiel 3
Erstellen Sie eine Quellcodeverwaltungskonfiguration, um mein Azure-Automatisierungskonto mit meinem GitHub-Projekt zu verknüpfen.
...
### -Branch
Die Verzweigung des Quellcodeverwaltungssteuerelements.
...
### -Beschreibung
Beschreibung des Quellcodeverwaltungssteuerelements
...
Wenn "DoNotPublishRunbook" festgelegt ist, bedeutet dies, dass Benutzerlaufbücher als "Entwurf" importiert werden.
...
### -RepositoryUrl
Die Repository-URL des Quellcodeverwaltungssteuerelements.
...
### -SourceType
Der Typ des Quellcodeverwaltungssteuerelements.
