...
## BESCHREIBUNG
Die Get-AzAutomationSoftwareUpdateConfiguration gibt eine Liste der Softwareupdatekonfigurationen zurück. Um eine bestimmte Softwareupdatekonfiguration zu erhalten, geben Sie den Namensparameter an. Sie können auch Softwareupdatekonfigurationen für einen bestimmten virtuellen Azure-Computer auflisten, indem Sie die Azure-Ressourcen-ID für diesen virtuellen Computer angeben.

## BEISPIELE

### Beispiel 1
Holen Sie sich eine Updatekonfiguration für die Azure-Automatisierungssoftware nach Name.
