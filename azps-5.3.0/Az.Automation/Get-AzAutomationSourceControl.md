...
## BESCHREIBUNG
Das Get-AzAutomationSourceControl cmdlet ruft die Automatisierungsquellensteuerelemente ab.
Um ein bestimmtes Quellsteuerelement zu erhalten, geben Sie dessen Namen an.

## BEISPIELE

### Beispiel 1
Dieser Befehl ruft ein Automatisierungsquellensteuerelement namens VSTSNative im Konto mit dem Namen "devAccount" ab.
