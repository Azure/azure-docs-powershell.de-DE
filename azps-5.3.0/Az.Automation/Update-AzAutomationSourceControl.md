...
## BESCHREIBUNG
Das Update-AzAutomationSourceControl cmdlet ändert den Wert eines Felds in einem Quellcodeverwaltungssteuerelement in der Azure-Automatisierung.

## BEISPIELE

### Beispiel 1
Mit diesen Befehlen wird das Feld "PublishRunbook" für das Azure -Automatisierungs-Quellsteuerelement mit dem Namen VSTSNative im Konto mit dem Namen "devAccount" auf "false" gesetzt.
...
### -Name
Der Name des Quellcodeverwaltungssteuerelements.
