...
### -Wait
Zeigt an, dass dieses Cmdlet wartet, bis ein Auftrag abgeschlossen, angehalten oder fehlgeschlagen ist, und gibt dann die Steuerung an Azure PowerShell zurück.
