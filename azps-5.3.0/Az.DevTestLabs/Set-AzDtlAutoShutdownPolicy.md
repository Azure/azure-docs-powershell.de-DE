...
## BESCHREIBUNG
Das **Cmdlet "Set-AzDtlAutoShutdownPolicy"** legt die Richtlinie für das automatische Herunterfahren einer Übung fest, die alle virtuellen Computer im Labor zu einer bestimmten Zeit des Tages automatisch heruntergefahren.
...
### -LabName
Gibt den Namen der Übungseinheit an, für die dieses Cmdlet die Richtlinie für automatisches Herunterfahren festgelegt.
...
### -Time
Gibt die Uhrzeit als **"DateTime"-Objekt** an, zu der die virtuellen Computer im Labor heruntergefahren werden müssen.
