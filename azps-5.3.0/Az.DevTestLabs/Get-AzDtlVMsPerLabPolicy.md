...
## BESCHREIBUNG
Das **Cmdlet "Get-AzDtlVMsPerLabPolicy"** ruft die Richtlinie für virtuelle Computer pro Labor ab, mit der Sie die Gesamtzahl der in einem Labor zulässigen virtuellen Computer festlegen können.
Das Cmdlet gibt den Status "Aktiviert" oder "Deaktiviert" der Richtlinie sowie die Gesamtzahl der in der Übungseinheit zulässigen virtuellen Computer zurück, die Sie in der Richtlinie festgelegt haben.
...
### -LabName
Gibt den Namen der Übung an, für die dieses Cmdlet die virtuellen Computer erhält.
