...
## BESCHREIBUNG
Das **Cmdlet "Set-AzDtlVMsPerLabPolicy"** legt die Richtlinie für virtuelle Computer pro Labor fest, mit der die Gesamtzahl virtueller Computer festgelegt wird, die in einem Labor zulässig sind.
...
### -Disable
Gibt an, dass mit diesem Cmdlet die Richtlinie der Übungseinheit deaktiviert wird.
...
### -LabName
Gibt den Namen der Übung an, für die dieses Cmdlet die Richtlinie für virtuelle Computer pro Labor festgelegt.
...
### -MaxVMs
Gibt die maximale Anzahl virtueller Computer an, die in der Übung erstellt werden können.
