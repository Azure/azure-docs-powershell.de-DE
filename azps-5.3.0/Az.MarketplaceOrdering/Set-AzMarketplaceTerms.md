...
## BESCHREIBUNG
Das **Cmdlet "Set-AzMarketplaceTerms"** speichert das Objekt "terms" für ein angegebenes Publisher-ID(Publisher-), Angebots-ID(Produkt) und Plan-ID(Name)-Tupel.

## BEISPIELE

### Beispiel 1
Herausgebervertrag für Marketplace
...
### Beispiel 2
Legen Sie den Herausgebervertrag auf "Akzeptieren" festgelegt. Den Wert für den Parameter "Terms" aus dem Cmdlet "Get-AzMarketplaceTerms"
...
### -Accept
Übergeben Sie dies, um die rechtlichen Bedingungen zu akzeptieren.
...
### -InputObject
Im Cmdlet zurückgegebenes Get-AzMarketplaceTerms Konditionenobjekt. Dies ist ein obligatorischer Parameter, wenn "Accepted"-Parameter "true" ist.
...
### -Name
Planen Sie die Zeichenfolge des bereitgestellten Bilds.
...
### -Produkt
Angebotsbezeichnerzeichenfolge des bereitgestellten Bilds.
...
### -Publisher
Herausgeberbezeichnerzeichenfolge des bereitgestellten Bilds.
...
### -Reject
Übergeben Sie dies, um die rechtlichen Bedingungen abzulehnen.
