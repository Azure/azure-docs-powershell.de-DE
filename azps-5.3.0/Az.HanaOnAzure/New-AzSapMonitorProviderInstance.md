...
### Beispiel 1: Erstellen einer Instanz des SAP Monitor nach Zeichenfolge für HANA
```powershell
...
Mit diesem Befehl wird eine Instanz des SAP-Monitors nach Schlüsseltresor für HANA erstellt.
