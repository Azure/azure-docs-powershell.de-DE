...
### Beispiel 2: Aktualisieren der Größe der privaten Cloud durch Eingabeobjekt
```powershell
...
Aktualisieren der Größe der privaten Cloud durch Eingabeobjekt
...
IDENTITYSOURCE <IIdentitySource[]>: vCenter Single Sign On Identity Sources
  - `[Alias <String>]`: Der Name der Domäne NETERGEBNISS
  - `[BaseGroupDn <String>]`: Der distinguished base distinguished name for groups
  - `[BaseUserDn <String>]`: Der Distinguished Base Name für Benutzer
