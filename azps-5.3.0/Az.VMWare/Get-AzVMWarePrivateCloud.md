...
### Beispiel 1: Auflisten der privaten Cloud im Abonnement
```powershell
...
Private Cloud unter Abonnement auflisten

### Beispiel 2: Auflisten der privaten Cloud unter der Ressourcengruppe
```powershell
...
Auflisten der privaten Cloud unter der Ressourcengruppe

### Beispiel 3: Private Cloud erhalten
```powershell
...
Holen Sie sich die private Cloud
