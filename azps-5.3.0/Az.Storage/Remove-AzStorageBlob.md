...
### Beispiel 1: Entfernen eines Speicher-BLOB nach Name
```
...
### Beispiel 2: Entfernen eines Speicher-BLOB mithilfe der Pipeline
```
...
Dieser Befehl verwendet das Platzhalterzeichen Sternchen (*) und die Pipeline, um das BLOB oder die BLOB abzurufen, und entfernt diese dann.
...
Mit diesem Befehl wird ein einzelner BLOBS-Verion mit VersionId entfernt.
...
Sie können das Get-AzStorageContainer cmdlet verwenden, um es zu erhalten.
...
Sie können das cmdlet New-AzStorageContext zum Erstellen verwenden.
...
### -DeleteSnapshot
Gibt an, dass alle Momentaufnahmen gelöscht werden, aber nicht das Basis-BLOB.
Wenn dieser Parameter nicht angegeben wird, werden das Basis-BLOB und seine Momentaufnahmen zusammen gelöscht.
...
### -Force
Gibt an, dass dieses Cmdlet den BLOB und dessen Momentaufnahme ohne Bestätigung entfernt.
...
Gibt das zu lesende Azure-Profil für das Cmdlet an.
Wenn nichts angegeben ist, liest das Cmdlet aus dem Standardprofil.
