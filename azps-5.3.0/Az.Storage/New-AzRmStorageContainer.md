...
## BESCHREIBUNG
Das **Cmdlet "New-AzRmStorageContainer"** erstellt einen Speicher-BLOB-Container.
...
Mit diesem Befehl wird ein Speicher-BLOB-Container mit dem Namen des Speicherkontos und dem Containernamen mit Metadaten erstellt.

### Beispiel 2: Erstellen eines Speicher-BLOB-Containers mit Speicherkontoobjekt und Containername, mit öffentlichem Zugriff als BLOB
```
PS C:\>$accountObject = Get-AzStorageAccount -ResourceGroupName "myResourceGroup" -AccountName "myStorageAccount"
PS C:\>New-AzRmStorageContainer -StorageAccount $accountObject -ContainerName "myContainer" -PublicAccess Blob
```

Mit diesem Befehl wird ein Speicher-BLOB-Container mit Speicherkontoobjekt und Containername mit öffentlichem Zugriff als BLOB erstellt.

### Beispiel 3: Erstellen eines Speichercontainers mit Einstellung "EncryptionScope"
```
...
Mit diesem Befehl wird ein Speichercontainer mit einem defalt encryptionScope erstellt und die Außerkraftsetzung des Verschlüsselungsbereichs vom Container standardmäßig blockiert.
Zeigen Sie dann die zugehörigen Containereigenschaften an.
...
Blocküberschreibung des Verschlüsselungsbereichs vom Container standardmäßig.
