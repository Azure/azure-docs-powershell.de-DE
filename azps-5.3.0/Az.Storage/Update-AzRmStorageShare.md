...
### Beispiel 1: Ändert die Metadaten einer Speicherdateifreigabe und das Freigabekontingent mit dem Namen des Speicherkontos und dem Freigabenamen.
```
...
Dieser Befehl ändert die Metadaten und das Freigabekontingent einer Speicherdatei mit dem Namen des Speicherkontos und dem Freigabenamen und zeigt das Änderungsergebnis mit dem zurückgegebenen Dateifreigabeobjekt an.
...
Mit diesem Befehl werden Die Metadaten einer Speicherdateifreigabe mit Speicherkontoobjekt und Freigabename geändert.
...
Mit diesem Befehl wird das Freigabekontingent für alle Speicherdateifreigaben in einem Speicherkonto mit Pipeline als 5.000 GIB geändert.
...
### -AccessTier
Zugriffsebene für bestimmte Freigaben. Bei einem "StorageV2"-Konto kann zwischen TransactionOptimized (Standard), Hot und Cool ausgewählt werden. "FileStorage"-Konto kann "Premium" auswählen.
