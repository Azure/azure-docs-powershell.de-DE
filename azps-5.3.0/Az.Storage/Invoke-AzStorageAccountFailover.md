...
Dieser Befehl überprüft die letzte Synchronisierungszeit eines Speicherkontos und ruft dann den Failover des Kontos auf. Der sekundäre Cluster wird nach dem Failover primär. Da der Failover sehr lange dauert, empfehlen Sie, ihn im Back-End mit dem Parameter "-Asjob" auszuführen, und warten Sie dann, bis der Auftrag abgeschlossen ist.
