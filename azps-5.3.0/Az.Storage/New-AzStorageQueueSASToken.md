...
## BESCHREIBUNG
Das **Cmdlet "New-AzStorageQueueSASToken"** generiert das Token für die Signatur für den freigegebenen Zugriff für eine Azure-Speicherwarteschlange.

## BEISPIELE

### Beispiel 1: Generieren eines Warteschlangen-SAS-Tokens mit der vollen Berechtigung
```
PS C:\>New-AzStorageQueueSASToken -Name "Test" -Permission raup
```

In diesem Beispiel wird ein Warteschlangen-SAS-Token mit allen Berechtigungen generiert.

## PARAMETERS

### -Context
Gibt den Azure -Speicherkontext an.
Sie können sie mit einem New-AzStorageContext erstellen.
...
### -ExpiryTime
Gibt an, wann die Signatur für den freigegebenen Zugriff nicht mehr gültig ist.
...
### -Policy
Gibt eine Azure-Richtlinie für gespeicherten Zugriff an.
...
### -StartTime
Gibt an, wann die Signatur für den freigegebenen Zugriff gültig wird.
