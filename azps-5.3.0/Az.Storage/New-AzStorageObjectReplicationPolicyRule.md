...
## BESCHREIBUNG
Das **Cmdlet "Get-AzStorageObjectReplicationPolicy"** erstellt eine Richtlinie für die Objektreplikation, die im Set-AzStorageObjectReplicationPolicy verwendet wird.

## BEISPIELE

### Beispiel 1: Erstellen einer Regel für die Objektreplikationsrichtlinie, die nur ein Quell- und Zielkonto enthält, und Anzeigen der Eigenschaften
```
...
Mit diesem Befehl wird eine Regel für die Objektreplikationrichtlinie erstellt, die nur das Quell- und Zielkonto enthält, und die Eigenschaften werden angezeigt.

### Beispiel 2: Erstellen einer Richtlinie für die Objektreplikation mit allen Eigenschaften und Anzeigen der Eigenschaften
```
...
Mit diesem Befehl wird eine Richtlinie für die Objektreplikation mit allen Eigenschaften befehlen und deren Eigenschaften angezeigt.
...
### -MinCreationTime
Blobs, die nach dieser Zeit erstellt wurden, werden an das Ziel repliziert.
...
### -RuleId
Regel-ID der Objektreplikation.
