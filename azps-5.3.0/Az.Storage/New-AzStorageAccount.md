...
Erhalten Sie dann die Eigenschaften des Speicherkontos, und zeigen Sie den Verschlüsselungsschlüsseltyp von Warteschlangen- und Tabellendienst sowie den Wert der RequireInfrastructureEncryption an.
...
Mit dem Befehl "Konto erstellen" mit "MinimumTlsVersion" und "AllowBlobPublicAccess" werden die zwei Eigenschaften des erstellten Kontos angezeigt. 
...
- StorageV2. Allgemeine Version 2 (GPv2) Speicherkonto, das Blobs, Tabellen, Warteschlangen, Dateien und Datenträger unterstützt, mit erweiterten Features wie Daten tiering.
...
### -Location
Gibt den Speicherort des Speicherkontos an, das erstellt werden soll.
...
Der Dienst verwendet eine sekundäre Verschlüsselungsebene mit plattform verwalteten Schlüsseln für ruhede Daten.
