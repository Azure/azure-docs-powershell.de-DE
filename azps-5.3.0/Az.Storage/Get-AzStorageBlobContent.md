...
Wenn der BLOB-Name für den lokalen Computer nicht gültig ist, wird er von diesem Cmdlet nach Möglichkeit automatisch aufgelöst.
...
In diesem Beispiel werden das Sternchen und die Pipeline zum Suchen und Herunterladen von BLOB-Inhalten verwendet.

### Beispiel 4: Herunterladen eines BLOB-Objekts, Speichern des Objekts in einer Variablen und anschließendes Herunterladen von BLOB-Inhalt mit dem BLOB-Objekt
```
PS C:\>$blob = Get-AzStorageBlob -Container containername -Blob blobname 
PS C:\>Get-AzStorageBlobContent -CloudBlob $blob.ICloudBlob -Destination "C:\test"
```

In diesem Beispiel wird zuerst ein BLOB-Objekt heruntergeladen und in einer Variablen gespeichert, und dann wird der BLOB-Inhalt mit dem BLOB-Objekt heruntergeladen. 
...
Sie können sie erstellen oder das cmdlet Get-AzStorageContainer verwenden.
...
### -Container
Gibt den Namen des Containers an, der den blob enthält, den Sie herunterladen möchten.
...
### -Destination
Gibt den Speicherort an, an dem die heruntergeladene Datei gespeichert werden soll.
...
### -Force
Überschreibt eine vorhandene Datei ohne Bestätigung.
...
## HINWEISE
* Wenn der BLOB-Name für den lokalen Computer ungültig ist, wird er von diesem Cmdlet autoresolviert, sofern dies möglich ist.
