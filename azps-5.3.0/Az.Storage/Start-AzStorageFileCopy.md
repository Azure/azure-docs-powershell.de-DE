...
### Beispiel 1: Starten des Kopiervorgangs von Datei zu Datei mithilfe von Freigabename und Dateiname
```
...
Mit diesem Befehl wird ein Kopiervorgang von Datei zu Datei gestartet.
Der Befehl gibt den Freigabenamen und den Dateinamen an.

### Beispiel 2: Starten des Kopiervorgangs von BLOB zu Datei mithilfe des Containernamens und des BLOB-Namens
```
...
Dieser Befehl startet einen Kopiervorgang von BLOB in Datei.
Der Befehl gibt den Containernamen und den BLOB-Namen an.

## PARAMETERS

### -AbsoluteUri
Gibt den URI der Quelldatei an.
Wenn für den Quellspeicherort Anmeldeinformationen erforderlich sind, müssen Sie eine angeben.
...
### -DestContext
Gibt den Azure Storage-Kontext des Ziels an.
...
### -DestFilePath
Gibt den Pfad der Zieldatei relativ zur Zielfreigabe an.
...
Sie können ein Cloud-BLOB erstellen oder eines mithilfe des cmdlets Get-AzStorageBlob abrufen.
...
Sie können Cloud-BLOB-Container-Objekt erstellen oder das cmdlet Get-AzStorageContainer verwenden.
...
### -SrcFile
Gibt ein **CloudFile-Objekt** an.
Sie können eine Clouddatei erstellen oder eine abrufen, indem Sie **"Get-AzStorageFile" verwenden.**
...
### -SrcFilePath
Gibt den Pfad der Quelldatei relativ zum Quellverzeichnis oder zur Quellfreigabe an.
...
### -SrcShare
Gibt ein Clouddateifreigabeobjekt an.
Sie können eine Clouddateifreigabe erstellen oder sie mithilfe des cmdlets Get-AzStorageShare abrufen.
