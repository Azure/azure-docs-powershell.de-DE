...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzRmStorageContainer"** entfernt einen Speicher-BLOB-Container.

## BEISPIELE

### Beispiel 1: Entfernen eines Speicher-BLOB-Containers mit dem Namen des Speicherkontos und dem Containernamen
```
PS C:\>Remove-AzRmStorageContainer -ResourceGroupName "myResourceGroup" -AccountName "myStorageAccount" -ContainerName "myContainer"
```

Mit diesem Befehl wird ein Speicher-BLOB-Container mit dem Namen des Speicherkontos und dem Containernamen entfernt.

### Beispiel 2: Entfernen eines Speicher-BLOB-Containers mit Speicherkontoobjekt und Containername
```
PS C:\>$accountObject = Get-AzStorageAccount -ResourceGroupName "myResourceGroup" -AccountName "myStorageAccount"
PS C:\>Remove-AzRmStorageContainer -StorageAccount $accountObject -ContainerName "myContainer"
```

Mit diesem Befehl wird ein Speicher-BLOB-Container mit speicherkontoobjekt und Containername entfernt.

### Beispiel 3: Entfernen aller Speicher-BLOB-Container in einem Speicherkonto mit Pipeline
```
PS C:\>Get-AzStorageContainer -ResourceGroupName "myResourceGroup" -AccountName "myStorageAccount" | Remove-AzRmStorageContainer -Force
```

Mit diesem Befehl werden alle Speicher-BLOB-Container in einem Speicherkonto mit Pipeline entfernt.
...
### -Force
Erzwingen des Entfernens des Containers und des sämtlichen Inhalts
