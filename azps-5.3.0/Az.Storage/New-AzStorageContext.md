...
Dieser Befehl erstellt einen Kontext mithilfe des lokalen Entwicklungsspeicherkontos.
...
### Beispiel 10: Erstellen eines Kontexts mithilfe der OAuth Authentication
```
...
### -Local
Gibt an, dass dieses Cmdlet mit dem lokalen Entwicklungsspeicherkonto einen Kontext erstellt.
