...
Erstellen Sie den Schlüssel erneut, der \' "key1'\" der "Event Grid \` domain1" \` in der Ressourcengruppe \` "MyResourceGroupName" \` entspricht.
...
Erstellen Sie den Schlüssel erneut, der \' "key2'\" der "Event Grid domain1" in der Ressourcengruppe \` \` \` "MyResourceGroupName" entspricht, und verwenden Sie dabei die \` vollständige Ressourcen-ID.
...
### -Name
Der Name des Schlüssels, der erneut generiert werden muss
