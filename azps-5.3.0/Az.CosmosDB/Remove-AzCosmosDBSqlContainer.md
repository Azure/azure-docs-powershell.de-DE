...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzCosmosDBSqlContainer"** löscht den Sql Container", der den angegebenen Ressourcengruppennamen, "AccountName", "DatabaseName" und "ContainerName" entspricht.
