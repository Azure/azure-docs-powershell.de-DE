...
## SYNOPSIS
Ruft den Sql Container "DessDB Sql Container" ab.
...
## BESCHREIBUNG
Das **Cmdlet "Get-AzCosmosDBSqlContainer"** ruft die Liste aller vorhandenen "DessDB Sql Containers" für einen bestimmten ResourceGroupName, AccountName und DatabaseName ab und ruft einen einzelnen DurchlaufsDB -Sql-Container für einen angegebenen ResourceGroupName, AccountName, DatabaseName und ContainerName ab.
