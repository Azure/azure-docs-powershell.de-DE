...
## SYNOPSIS
Ruft eine Tabelle des UnternsDB Unterhingen ab.
...
## BESCHREIBUNG
Das **Cmdlet "Get-AzCosmosDBCass untableTable"** erstellt ein neues oder aktualisiert einen vorhandenen Ausrinnentastespace.
...
{{ Get-AzCosmosDBCassandraTable ruft die Eigenschaften eines vorhandenen Tastaturschlüsselspaces ab. Sie können die Ressource erweitern, um die Eigenschaften DefaultTtl, Schema, _etag, _ts, _rid zu erhalten.}}
