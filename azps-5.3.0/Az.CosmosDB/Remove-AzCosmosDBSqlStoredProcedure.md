...
## SYNOPSIS
Löscht das Sql StoredProcedure-Element".
...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzCosmosDBSqlStoredProcedure"** löscht das SkriptsDB Sql StoredProcedure, das den angegebenen Angaben "ResourceGroupName", "AccountName" und "DatabaseName" entspricht.
