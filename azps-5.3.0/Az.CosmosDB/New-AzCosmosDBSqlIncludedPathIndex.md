...
## SYNOPSIS
Erstellt ein neues Objekt vom Typ "PSIndexes". Sie kann als Parameterwert für "Set-AzCosmosDBSqlIncludedPath" übergeben werden.
...
## BESCHREIBUNG
Objekt, das den Indizes von IncludedPath der Sql-API entspricht.
