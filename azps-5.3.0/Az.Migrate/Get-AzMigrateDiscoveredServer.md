...
## SYNOPSIS
"Alle ermittelten Server in einem Migrieren-Projekt erhalten" aus.
...
Holen Sie sich alle Server in einem Migrieren-Projekt.
...
### Beispiel 3: Liste in einem Gerät
```powershell
...
Listen Sie alle Server für ein Gerät in einem Projekt auf.

### Beispiel 4: Ein Gerät verwenden
```powershell
...
ListenServer in einem Projekt migrieren und Antworten mit Anzeigenamen filtern

### Beispiel 6: Auflisten in einem Gerät und Filtern nach Anzeigename
```powershell
...
Listenserver für ein Gerät in einem Migrieren eines Projekts und Filtern von Antworten mit Anzeigename.

## PARAMETERS

### -ApplianceName
Gibt den Namen des Geräts an.
Dies ist intern einer Website zu ordnet.
...
### -ProjectName
Gibt den Namen des Projekts für die Migration an.
