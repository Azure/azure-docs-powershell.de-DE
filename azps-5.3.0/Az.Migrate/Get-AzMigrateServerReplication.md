...
## SYNOPSIS
Ruft die Details des replizierbaren Servers ab.
...
"Nach ID erhalten" aus.

### Beispiel 2: Alles im Projekt nach ID auflisten.
```powershell
...
### Beispiel 2: Auflisten aller Projektnamen.
```powershell
...
### -ProjectName
Gibt das Projekt "Azure Migrate" im aktuellen Abonnement an.
...
### -TargetObjectID
Gibt den replizierbaren Server an.
