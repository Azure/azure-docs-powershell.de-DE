...
## SYNOPSIS
Erstellt ein Objekt zum Aktualisieren der NIC-Eigenschaften eines replizierbaren Servers.
...
Erstellt ein Aktualisierungsobjekt für NIC.
...
### -TargetNicIP
Gibt die IP innerhalb des Zielsubnetzs an, das für die NIC verwendet werden soll.
...
### -TargetNicSubnet
Gibt den Subnetznamen für die NIC im virtuellen Zielnetzwerk an, zu dem der Server migriert werden muss.
