...
INPUTOBJECT : Gibt den Replikatserver an, für den <IMigrationItem> die Testmigration initiiert werden muss. Das Serverobjekt kann mithilfe des cmdlets Get-AzMigrateServerReplication abgerufen werden.
