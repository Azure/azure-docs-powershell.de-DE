...
## BESCHREIBUNG
Das **Cmdlet "Get-AzBatchJobStatistic"** ruft Zusammenfassungsstatistiken zur Lebensdauer für alle Aufträge in einem Azure -Batchkonto ab.
Statistiken werden für alle Aufträge aggregiert, die jemals im Konto vorhanden waren, von der Kontoerstellung bis zur letzten Aktualisierungszeit der Statistiken.

## BEISPIELE

### Beispiel 1: Erhalten von Zusammenfassungsstatistiken für alle Aufträge
```
...
Der zweite Befehl ruft die Zusammenfassungsstatistiken für alle Aufträge ab.
