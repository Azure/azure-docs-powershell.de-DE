...
## BESCHREIBUNG
Das **Cmdlet "Test-AzBatchAutoScale"** ruft das Ergebnis einer automatischen Skalierungsformel für den angegebenen Pool ab.

## BEISPIELE

### Beispiel 1: Auswerten einer Autoskalenformel für einen Pool
```
...
Mit dem zweiten Befehl wird die Autoskalenformel für den Pool ausgewertet, der die ID "ContosoPool" enthält.
Der letzte Befehl zeigt die **Ergebnisse mithilfe der** standardmäßigen Punktsyntax an.
...
### -ID
Gibt die Objekt-ID des Pools an, für den die automatische Skalierung testiert werden soll.
