...
## BESCHREIBUNG
Das **Cmdlet "Set-AzBatchComputeNodeUser"** ändert die Eigenschaften eines Benutzerkontos für einen Azure Batch-Rechenknoten.
...
Mit diesem Befehl wird das Benutzerkonto "PFuller" für den Rechenknoten geändert, der die angegebene ID im Pool "ContosoPool" hat.
Der Befehl ändert das Kontokennwort und die Ablaufzeit.
...
### -ComputeNodeId
Gibt die ID des Rechenknotens an, für den dieses Cmdlet ausgeführt wird.
...
### -PoolId
Gibt die ID des Pools an, der den Rechenknoten enthält, für den dieses Cmdlet ausgeführt wird.
