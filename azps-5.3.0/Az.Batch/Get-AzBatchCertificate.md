...
## BESCHREIBUNG
Das **Cmdlet "Get-AzBatchCertificate"** ruft die Zertifikate im Azure -Batchkonto ab, die vom *Parameter "BatchContext"* angegeben werden.
Um ein bestimmtes Zertifikat zu erhalten, geben Sie die Parameter *"ThumbprintAlgorithm"* und *"Thumbprint"* an.
Geben Sie den *Filterparameter* an, um die Zertifikate zu erhalten, die einem Open Data Protocol (OData)-Filter entsprechen.
...
Dieser Befehl ruft ein einzelnes Zertifikat mit dem angegebenen Fingerabdruck ab.
Der Fingerabdruckalgorithmus für das Zertifikat ist "sha1".

### Beispiel 2: Erhalten gefilterter Zertifikate
```
...
### -MaxCount
Gibt die maximale Anzahl von zurückzukehrenden Zertifikaten an.
