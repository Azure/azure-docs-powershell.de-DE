...
## BESCHREIBUNG
Das **Cmdlet "Get-AzBatchPoolStatistic"** ruft die Lebensdauerstatistiken für alle Pools im angegebenen Konto ab.
Statistiken werden in allen Pools aggregiert, die jemals im Konto vorhanden waren, von der Kontoerstellung bis zur letzten Aktualisierungszeit der Statistiken.

## BEISPIELE

### Beispiel 1: Erhalten von Ressourcenstatistiken für alle Pools in einem Konto
```
...
Der zweite Befehl ruft die Statistik aller Pools im angegebenen Konto ab und speichert sie dann im $PoolStatistics.
Der letzte Befehl zeigt die **Eigenschaft "ResourceStatistics"** von $PoolStatistics.
