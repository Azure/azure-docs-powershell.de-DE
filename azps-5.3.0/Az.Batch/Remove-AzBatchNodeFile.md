...
Diese Datei ist der Aufgabe zugeordnet, die die ID Task26 unter dem Auftrag "Job-000001" enthält.
...
### -ComputeNodeId
Gibt die ID des Rechenknotens an, der die vom Cmdlet gelöschte Batchknotendatei enthält.
...
Verwenden Sie zum **Abrufen einer PSNodeFile** das Get-AzBatchNodeFile-Cmdlet.
