...
Sie können den Parameter *"Id"* verwenden, um einen einzelnen Pool zu erhalten, oder Sie können den Parameter *"Filter"* verwenden, um die Pools zu erhalten, die einem Open Data Protocol (OData)-Filter entsprechen.
