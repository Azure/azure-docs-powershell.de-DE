...
### Beispiel 1: Löschen einer Batchaufgabe nach ID
```
PS C:\>Remove-AzBatchTask -JobId "Job-000001" -Id "Task23" -BatchContext $Context
```

Mit diesem Befehl wird eine Aufgabe gelöscht, die die ID Task23 unter dem Auftrag mit der ID Job-0000001 hat.
...
### Beispiel 2: Löschen einer Batchaufgabe mithilfe der Pipeline ohne Bestätigung
```
PS C:\>Get-AzBatchTask -JobId "Job-000001" -Id "Task26" -BatchContext $Context | Remove-AzBatchTask -Force -BatchContext $Context
```

Mit diesem Befehl wird mithilfe des Cmdlets **"Get-AzBatchTask"** die Aufgabe "Batch" mit der ID Task26 in dem Auftrag mit der ID Job-000001 erhalten.
Der Befehl übergibt diese Aufgabe mithilfe des Pipelineoperators an das aktuelle Cmdlet.
Mit dem Befehl wird diese Aufgabe gelöscht.
...
### -ID
Gibt die ID der Aufgabe an, die von diesem Cmdlet gelöscht wird.
...
### -InputObject
Gibt die Aufgabe an, die mit diesem Cmdlet gelöscht wird.
Verwenden Sie zum Abrufen **eines PSCloudTask-Objekts** das Get-AzBatchTask-Cmdlet.
