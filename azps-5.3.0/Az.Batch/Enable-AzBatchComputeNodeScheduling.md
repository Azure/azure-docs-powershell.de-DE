...
Diese Sammlung wird dann an das **Cmdlet "Enable-AzBatchComputeNodeScheduling"** weiterverteilt, das die Aufgabenplanung für jeden Rechenknoten in der Sammlung ermöglicht.
...
### -ID
Gibt die ID des Rechenknotens an, in dem die Aufgabenplanung aktiviert ist.
