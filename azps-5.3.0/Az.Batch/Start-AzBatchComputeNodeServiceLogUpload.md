...
## SYNOPSIS
Laden Sie Protokolldateien des Compute Node Service in einen Azure Storage-Container hoch.
...
## BESCHREIBUNG
Dieses Cmdlet sammelt Azure Batch-Dienstprotokolldateien von Rechenknoten, wenn ein Fehler auftritt und Sie an die Unterstützung von Azure eskalieren möchten. Die Azure Batch-Dienstprotokolldateien sollten mit der Unterstützung von Azure geteilt werden, um Debuggingprobleme mit dem Batchdienst zu unterstützen. 
...
Laden Sie die Am oder nach Mitternacht des 1. Januar 2018 geschriebenen Compute Node-Dienstprotokolle hoch, die aus dem Computeknoten mit der Pool-ID des Pools, in dem sich der Rechenknoten befindet, und der Computeknoten-ID (Compute Node ID) erhalten wurden.
...
Laden Sie die Protokolle des Compute Node Service hoch, die am oder nach dem 1. Januar 2018 (Mitternacht) und vor dem 10. Januar 2018 (Mitternacht) geschrieben wurden, die aus dem Computeknoten mit der angegebenen Pool-ID des Pools, in dem sich der Rechenknoten befindet, und der Computeknoten-ID erhalten wurden.
...
Laden Sie am oder nach dem 1. Januar 2018 Mitternacht und vor dem 10. Januar 2018 Mitternacht geschriebene Protokolle des Compute Node Service hoch, die aus dem Computeknotenobjekt erhalten wurden.
...
Bei verwendung der Authentifizierung mit freigegebenen Schlüsseln wird standardmäßig der primäre Zugriffsschlüssel verwendet.
