...
## BESCHREIBUNG
Das **Cmdlet "New-AzBatchJobSchedule"** erstellt einen Auftragszeitplan im Azure Batch-Dienst.
Der *Parameter "BatchAccountContext"* gibt das Konto an, in dem dieses Cmdlet den Zeitplan erstellt.

## BEISPIELE

### Beispiel 1: Erstellen eines Stellenplans
```
...
In diesem Beispiel wird ein Stellenplan erstellt.
Die ersten fünf Befehle erstellen und ändern **psSchedule-,** **PSJobSpecification-** und **PSPoolInformation-Objekte.**
Für die Befehle werden das New-Object und die standardmäßige Azure New-Object verwendet.
Die Befehle speichern diese Objekte in den $Schedule und $JobSpecification Variablen.
Der letzte Befehl erstellt einen Auftragszeitplan mit der ID "JobSchedule17".
Mit diesem Zeitplan werden Aufträge mit einem Wiederholungsintervall von einem Tag erstellt.
Die Aufträge werden für den Pool ausgeführt, der die ID "ContosoPool06" hat, wie im fünften Befehl angegeben.
...
### -ID
Gibt die ID des Auftragsplans an, den dieses Cmdlet erstellt.
...
### -Metadata
Gibt Metadaten als Schlüssel/Wert-Paare an, die dem Auftragszeitplan hinzugefügt werden.
