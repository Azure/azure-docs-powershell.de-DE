...
### Beispiel 1: Erstellen einer Insightsumgebung für Zeitreihen der Generation 1
```powershell
...
Mit diesem Befehl wird eine Umgebung zum Aufblick von Zeitreihen der Generation 1 erstellt.

### Beispiel 2: Erstellen einer Insightsumgebung für Zeitreihen der Generation 2
```powershell
...
Dieser Befehl erstellt eine Umgebung zum Aufblick von Zeitreihen der Generation 2.
...
Für Umgebungen der Generation 1 kann dieser Wert geändert werden, um das Skalieren von Umgebungen nach deren Erstellen zu unterstützen.
...
Informationen zum Erstellen finden Sie im Abschnitt "NOTES" zu "PARTITIONKEYPROPERTY"-Eigenschaften und zum Erstellen einer Hashtabelle.
...
### -StorageAccountKey
Der Wert des Verwaltungsschlüssels, der dem Time Series Insights-Dienst Schreibzugriff auf das Speicherkonto gewährt.
...
### -StorageAccountName
Der Name des Speicherkontos, das die langfristigen Daten der Umgebung enthalten soll.
...
Das Verhalten, das der Time Series Insights-Dienst nutzen sollte, wenn die Kapazität der Umgebung überschritten wurde
...
Die Liste der Ereigniseigenschaften, die verwendet wird, um die Zeitreihen-ID der Umgebung zu definieren. Informationen zum Erstellen finden Sie im Abschnitt "NOTES" zu den #A0 und zum Erstellen einer Hashtabelle.
...
ISO8601-Zeitraum, der die Anzahl der Tage anzahlt, für die die Ereignisse der Umgebung für die Abfrage aus dem Warmspeicher verfügbar sind.
...
TIMESERIESIDPROPERTY <ITimeSeriesIdProperty[]>: Die Liste der Ereigniseigenschaften, mit denen die Zeitreihen-ID der Umgebung definiert wird.
  - `[Name <String>]`: Der Name der Eigenschaft.
  - `[Type <PropertyType?>]`: Der Typ der Eigenschaft.
