...
### Beispiel 1: Entfernen eines vnet-Peerings von Databinnen nach Name
```powershell
PS C:\> Remove-AzDatabricksVNetPeering -WorkspaceName databricks-test01 -ResourceGroupName lucas-manual-test -Name vnetpeering-t01

```

Mit diesem Befehl wird ein vnet-Peering von Databinnen nach Name entfernt.

### Beispiel 2: Entfernen eines vnet-Peerings von Databinnen und Daten nach Objekt
```powershell
PS C:\> Get-AzDatabricksVNetPeering -ResourceGroupName lucas-manual-test -WorkspaceName databricks-test01 -PeeringName MyPeering-test01 | Remove-AzDatabricksVNetPeering

```

Mit diesem Befehl wird ein vnet-Peering von Databinnen nach Objekt entfernt.
