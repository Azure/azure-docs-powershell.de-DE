...
### Beispiel 1: Auflisten aller vnet-Peerings unter einem Databsdatum
```powershell
...
Dieser Befehl listet alle vnet-Peerings unter einem Datab bestimmten Peer auf.

### Beispiel 2: Erhalten eines vnet-Peerings
```powershell
...
Dieser Befehl ruft ein vnet-Peering ab.

### Beispiel 3: Erhalten eines vnet-Peerings nach Objekt
```powershell
...
Dieser Befehl ruft ein vnet-Peering nach Objekt ab.
