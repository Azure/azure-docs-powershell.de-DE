...
## SYNOPSIS
Aktualisieren Sie einen dedizierten HSM im angegebenen Abonnement.
...
### Beispiel 1: Aktualisieren des Parametertags des dedizierten HSM nach Name
```powershell
...
Mit diesem Befehl wird das Parametertag des dedicated HSM nach Name aktualisiert.

### Beispiel 2: Aktualisieren des Parametertags des dedicated HSM nach Objekt
```powershell
...
Mit diesem Befehl wird das Parametertag des dedicated HSM nach Objekt aktualisiert.
