...
## BESCHREIBUNG
Erstellt einen neuen IotHub.
Sie können IotHub mit den Standardeigenschaften erstellen oder die Eingabeeigenschaften angeben.
...
Erstellt einen neuen IotHub mit dem Namen "myiothub" der SKU "S1", Kapazität 1 und Standort "northeurope", der in den Tags enthalten ist.

### Beispiel 2 Erstellen eines neuen IotHub mit dem MaxDeliveryCount der CloudToDevice-Warteschlange, die auf 20 festgelegt ist
```
PS C:\> New-AzIotHub -ResourceGroupName "myresourcegroup" -Name "myiothub" -SkuName "S1" -Units 1 -Location "northeurope" -Properties $properties
```

Erstellt einen neuen IotHub mit dem Namen "myiothub" der SKU "S1", Kapazität 1 und Standort "northeurope" mit erweiterten Eingabeeigenschaften, die durch $properties.
...
### -Tag
IoT-Hubinstanztags. Eigenschaftentasche in Schlüssel-Wert-Paaren in Form einer Hashtabelle.
