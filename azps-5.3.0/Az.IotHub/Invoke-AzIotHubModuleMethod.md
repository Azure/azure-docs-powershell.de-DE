...
## BESCHREIBUNG
Rufen Sie eine Edgemodulmethode auf. Weitere https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-direct-methods Informationen finden Sie hier.
...
### -ConnectionTimeOut
Anzahl der Sekunden, die gewartet werden muss, bis eine Verbindung hergestellt wurde.
...
### -Name
Der Name der Methode, die in diesem Gerätemodul aufgerufen werden soll.
...
### -Payload
Die Nutzlast für die methode, die in diesem Gerätemodul aufgerufen werden soll.
...
### -ResponseTimeOut
Anzahl der Sekunden, die gewartet werden muss, bis ein Ergebnis von der direkten Methode empfangen wurde.
Der Standardwert ist 10.
