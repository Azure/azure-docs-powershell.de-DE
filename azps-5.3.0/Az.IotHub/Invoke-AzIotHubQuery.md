...
## BESCHREIBUNG
Fragen Sie einen IoT Hub ab, indem Sie eine leistungsfähige SQL sprache verwenden, um Informationen zu Geräte- und Modulmodulen, Aufträgen und Nachrichtenrouting abzurufen.
Weitere https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-query-language Informationen finden Sie hier.
...
Fragen Sie alle Gerätedaten in einem Azure IoT Hub ab.
...
Fragen Sie Top-2-Moduldaten auf einem Zielgerät ab.
...
### -Top
Maximale Anzahl der zurückzukehrenden Elemente.
Standardmäßig hat die Abfrage keine Obergrenze.
