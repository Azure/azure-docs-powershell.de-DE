...
## BESCHREIBUNG
Erstellen Sie in einem IoT Hub ein Gerät mit einem anderen Autorisierungstyp.
...
Erstellen Sie ein edgefähiges IoT-Gerät mit Standardautorisierung (geteilter privater Schlüssel).
...
Erstellen Sie ein Gerät mit Stammzertifizierungsstelle mit deaktivierten Status und Grund.
...
Erstellen Sie ein edgefähiges IoT-Gerät, und fügen Sie diesem untergeordnete Geräte hinzu.
...
Erstellen Sie ein IoT-Gerät, und legen Sie dessen übergeordnetes Gerät festgelegt.
...
### -Children
Die Liste der untergeordneten Geräte (durch Kommas getrennt) enthält nur Geräte, die keine Edgegeräte sind.
...
### -PrimaryThumbprint
Expliziter selbst signierter Zertifikatdrückdruck zur Verwendung für den Primärschlüssel.
...
### -SecondaryThumbprint
Explizites selbst signiertes Zertifikatdrückdruck zur Verwendung für den sekundären Schlüssel.
...
### -Status
Legen Sie den Gerätestatus beim Erstellen des Geräts ein.
...
### Microsoft.Azure.Commands.Management.IotHub.Models.PSDEntfernung
