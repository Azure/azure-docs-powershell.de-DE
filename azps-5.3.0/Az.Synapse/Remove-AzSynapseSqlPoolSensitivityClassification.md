...
## SYNOPSIS
Entfernt die Informationstypen und Vertraulichkeitsbezeichnungen von Spalten im SQL Pool.
...
## BESCHREIBUNG
Mit Remove-AzSynapseSqlPoolSensitivityClassification A0 werden die Informationstypen und Vertraulichkeitsbeschriftungen von Spalten im SQL entfernt.

## BEISPIELE

### Beispiel 1: Entfernen des Informationstyps und der Vertraulichkeitsbezeichnung einer Spalte in einem Azure Synapse SQL Pool.
```powershell
...
### Beispiel 2: Entfernen aktueller Informationstypen und Vertraulichkeitsbeschriftungen von Spalten in einem Azure Synapse SQL mit Piping.
```powershell
...
### Beispiel 3: Entfernen des Informationstyps und der Vertraulichkeitsbezeichnung einer Spalte in einem Azure Synapse SQL mithilfe von Piping.
```powershell
