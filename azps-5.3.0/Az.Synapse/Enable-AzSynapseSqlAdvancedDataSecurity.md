...
## BESCHREIBUNG
Das **Cmdlet Enable-AzSynapseSqlAdvancedDataSecurity** aktiviert Advanced Data Security in einem Arbeitsbereich. Advanced Data Security ist ein einheitliches Sicherheitspaket mit Datenklassifizierung, Sicherheitsrisikobewertung und Advanced Threat Protection für Ihren Arbeitsbereich. (Es wird automatisch ein neues Speicherkonto erstellt, um Sicherheitsrisikobewertungen zu sparen. Wenn zu diesem Zweck zuvor ein Speicherkonto erstellt wurde, wird es stattdessen verwendet.)
...
Dieser Befehl aktiviert die erweiterte Datensicherheit des Arbeitsbereichs.
...
Mit diesem Befehl wird die erweiterte Datensicherheit des Arbeitsbereichs über die Pipeline aktiviert.
...
Mit diesem Befehl wird advanced Data Security für den Arbeitsbereich über Pipeline aktiviert, und die Sicherheitsrisikobewertung wird nicht automatisch aktiviert.
...
Aktivieren Sie die Sicherheitsrisikobewertung nicht automatisch (dadurch wird kein Speicherkonto erstellt).
