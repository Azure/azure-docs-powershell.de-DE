...
Mit diesem Befehl wird ein Notizbuch aus der Datei "notebook.ipynb" erstellt oder aktualisiert, das an "ContosoSparkPool" anfügen und im Arbeitsbereich "ContosoWorkspace" zwei Executoren verwendet.
...
### -ExecutorSize
Die Anzahl des Kerns und des Arbeitsspeichers, der für die Im angegebenen Sparkpool für den Auftrag zugeordneten Executoren verwendet werden soll.
