...
## BESCHREIBUNG
Das **Cmdlet "Set-AzSynapseTrigger"** erstellt einen Trigger in einem Arbeitsbereich. Trigger werden im Zustand "Beendet" erstellt, d. h., sie beginnen nicht sofort mit dem Aufrufen von Pipelines, auf die sie verweisen.
...
Erstellen Sie im Arbeitsbereich "ContosoWorkspace" einen neuen Trigger namens "ContosoTrigger". Der Trigger wird im Zustand "Stopped" erstellt, d. h., er wird nicht sofort gestartet. Ein Trigger kann mit dem `Start-AzDataFactoryV2Trigger` Cmdlet gestartet werden.
...
Erstellen Sie einen neuen Trigger namens "ContosoTrigger" im Arbeitsbereich "ContosoWorkspace" über die Pipeline. Der Trigger wird im Zustand "Stopped" erstellt, d. h., er wird nicht sofort gestartet. Ein Trigger kann mit dem `Start-AzDataFactoryV2Trigger` Cmdlet gestartet werden.
