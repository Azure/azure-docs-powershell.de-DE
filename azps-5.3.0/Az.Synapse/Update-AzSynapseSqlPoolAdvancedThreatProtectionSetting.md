...
## BESCHREIBUNG
Das **Cmdlet "Update-AzSynapseSqlPoolAdvancedThreatProtectionSetting"** legt eine erweiterte Threat Protection-Einstellung für einen Azure Synapse Analytics SQL fest.
Um erweiterten Bedrohungsschutz für einen SQL müssen für diesen Pool Überwachungseinstellungen SQL werden.
...
Dieser Befehl legt die erweiterten Threat Protection-Einstellungen für einen SQL "ContosoSqlPool" unter dem Arbeitsbereich "ContosoWorkspace" fest.
...
### -EmailAdmin
Definiert, ob Administratoren eine E-Mail senden möchten.
...
Auszuschließende Erkennungstypen.
...
Eine durch Semikolons getrennte Liste der E-Mail-Adressen, an die die Benachrichtigungen gesendet werden sollen.
