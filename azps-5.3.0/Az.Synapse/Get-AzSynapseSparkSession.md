...
## BESCHREIBUNG
Das **Cmdlet "Get-AzSynapseSparkSession"** ruft Informationen zu einer Azure Synapse Analytics Spark-Sitzung ab.
...
Dieser Befehl ruft alle Spark-Sitzungen unter dem angegebenen Sparkpool ab.
...
Dieser Befehl ruft die Sparksitzung mit der angegebenen unaufdingsigen ID ab.
...
Dieser Befehl ruft alle Spark-Sitzungen unter dem angegebenen Sparkpool über die Pipeline ab.

## PARAMETERS

### -ApplicationId
Der Anwendungsbezeichner der Sitzung.
