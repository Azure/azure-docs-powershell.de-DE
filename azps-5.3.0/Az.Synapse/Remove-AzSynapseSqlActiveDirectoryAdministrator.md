...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzSynapseSqlActiveDirectoryAdministrator"** entfernt einen Azure Active Directory (Azure AD)-Administrator für Azure Synapse Analytics Workspace.
...
Mit diesem Befehl wird der Azure AD-Administrator für den Arbeitsbereich "ContosoWorkspace" entfernt.
