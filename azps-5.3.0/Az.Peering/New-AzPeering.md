...
Erstellen eines neuen direkten Peerings mit einer einzelnen Verbindung in der Einrichtung in Seattle mithilfe von PeerAsn 65000
...
### Konvertieren von älterem Peering in ARM Peering
```powershell
#Gets the ASN
PS C:> $asn = Get-AzPeerAsn -PeerName Contoso
...
### -DirectConnection
Erstellen Sie neue direkte Verbindungen, indem Sie New-AzExchangePeeringConnection und das Pipe zu diesem Befehl verwenden.
...
### -ExchangeConnection
Erstellen Sie neue Exchange-Verbindungen, indem Sie New-AzExchangePeeringConnection und das Pipe an diesen Befehl weiter ausführen.
...
### -MicrosoftNetwork
Wählen Sie das Microsoft-Netzwerk aus, mit dem Sie peeren möchten.
...
### -PeeringLocation
Der physische Standort ist anders als in der Azure-Region.
Verwenden Get-AzPeeringLocation "-Kind" \<kind\> den Namen "Ort" als Schlüssel.
...
### -SKU
Wählen Sie Basic_Direct_Free oder Premium_Direct_Free aus, es sei denn, Sie müssen explizit eine andere Option auswählen.
...
### -Tag
Die Tags, die dem Microsoft-Peeringdienst zugeordnet werden müssen.
