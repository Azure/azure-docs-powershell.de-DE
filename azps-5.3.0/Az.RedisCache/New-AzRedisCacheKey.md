...
## BESCHREIBUNG
Das **Cmdlet "New-AzRedisCacheKey"** generiert den Zugriffsschlüssel eines Azure Redis Cache erneut.

## BEISPIELE

### Beispiel 1: Erneutererieren eines Primärschlüssels
```
...
Mit diesem Befehl wird der Primärschlüssel eines Redis Cache erneut generiert.

### Beispiel 2: Erneutererieren eines sekundären Schlüssels
```
...
Mit diesem Befehl wird der sekundäre Schlüssel eines Redis Cache erneut generiert.
...
### -KeyType
Gibt an, ob der primäre oder sekundäre Zugriffsschlüssel erneut generiert werden soll.
...
### -Name
Gibt den Namen des Caches von Redis an.
