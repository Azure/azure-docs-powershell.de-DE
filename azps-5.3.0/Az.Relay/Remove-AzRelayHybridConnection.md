...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzRelayHybridConnection"** entfernt die HybridVerbindung aus dem angegebenen Relay-Namespace.
...
Entfernt die HybridVerbindung `TestHybridConnection` aus dem `TestNameSpace-Relay1` Namespace.
