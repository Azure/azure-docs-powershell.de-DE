...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzWcfRelay"** entfernt "WcfRelay" aus dem angegebenen Relay-Namespace.
...
Entfernt "WcfRelay" `TestWCFRelay1` aus dem `TestNameSpace-Relay1` Namespace.
