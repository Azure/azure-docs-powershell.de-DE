...
## BESCHREIBUNG
Das **Cmdlet "New-AzRelayAuthorizationRule"** erstellt eine neue Autorisierungsregel für die angegebenen Relayentitäten (Namespace/WcfRelay/HybridConnection).
...
Erstellt `AuthoRule1` mit **Listenrechten** für den `TestNameSpace-Relay1` Namespace.
...
Erstellt eine `AuthoRule1` Autorisierungsregel **mit Listenrechten** für wcfRelay. `TestWCFRelay1`
...
Erstellt `AuthoRule1` mit **Listenrechten** für die `TestHybridConnection` Hybridverbindung.
