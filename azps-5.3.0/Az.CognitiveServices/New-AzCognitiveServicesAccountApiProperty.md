...
## SYNOPSIS
Generieren einer neuen Instanz der Cognitive Services-Konto-ApiProperties
...
## BESCHREIBUNG
Generieren Sie eine neue Instanz der Cognitive Services-Konto-ApiProperties.
ApiProperties kann beim Erstellen eines neuen Kontos oder Aktualisieren eines vorhandenen Kontos verwendet werden.
ApiProperties ist für bestimmte Kontotypen erforderlich.
...
Im obigen Beispiel wird ein QnAMaker-Konto mit der API-Eigenschaft "QnaRuntimeEndpoint" erstellt.
