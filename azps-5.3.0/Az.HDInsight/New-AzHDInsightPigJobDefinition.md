...
## BESCHREIBUNG
Das **Cmdlet "New-AzHDInsightPigJobDefinition"** definiert ein Jobobjekt für ein Schwein zur Verwendung mit einem Azure HDInsight-Cluster.

## BEISPIELE

### Beispiel 1: Erstellen einer Jobdefinition für ein Schwein
```
PS C:\># Cluster info
...
Mit diesem Befehl wird eine Jobdefinition für ein Schwein erstellt.
