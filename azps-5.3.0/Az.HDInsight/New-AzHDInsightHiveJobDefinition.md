...
## BESCHREIBUNG
Das **Cmdlet "New-AzHDInsightHiveJobDefinition"** definiert ein Jobobjekt "Strukture" zur Verwendung mit einem Azure HDInsight-Cluster.

## BEISPIELE

### Beispiel 1: Erstellen einer Struktur
```
PS C:\># Cluster info
...
### -File
Gibt den Pfad zu einer Datei an, die die zu ausführende Abfrage enthält.
Die Datei muss für das Speicherkonto verfügbar sein, das dem Cluster zugeordnet ist.
