...
## BESCHREIBUNG
Das **Cmdlet "New-AzHDInsightSqoopJobDefinition"** definiert ein Sqoop-Auftragsobjekt für die Verwendung mit einem Azure HDInsight-Cluster.

## BEISPIELE

### Beispiel 1: Erstellen einer Definition eines Sqoop-Auftrags
```
PS C:\># Cluster info
...
Dieser Befehl erstellt eine Sqoop-Auftragsdefinition.

## PARAMETERS

### -Command
Gibt den Befehl "Sqoop" an.
