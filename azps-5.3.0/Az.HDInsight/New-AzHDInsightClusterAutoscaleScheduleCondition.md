...
## BESCHREIBUNG
Das **Cmdlet "New-AzHDInsightClusterAutoscaleScheduleCondition"** erstellt eine zeitplanbasierte Autoskalierungsbedingung.
...
Dieser Befehl erstellt eine Bedingung, in der jeden Montag, Mittwoch um 09:00 Uhr, die Automatische Skalierung des Clusters auf 5 Workerknoten ausgeführt wird.

### Beispiel 2: Aktivieren der zeitplanbasierten Autoskala eines Clusters mit Autoskalen-Bedingung.
```powershell
...
### -Day
Ruft die Tage des Zeitplans für die Automatische Skalierung ab oder legt diese Bedingung fest.
...
### -Time
Ruft die Zeit der Zeitplanbedingung für die Automatische Skalierung ab oder legt sie fest.
...
### -WorkerNodeCount
Ruft die Zeitplan-Workernode-Anzahl der Zeitplanbedingung für die Automatische Skalierung ab oder legt sie fest.
