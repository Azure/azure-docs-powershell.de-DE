...
## BESCHREIBUNG
Das **Cmdlet "Add-AzHDInsightStorage"** fügt dem azure-HDInsight-Konfigurationsobjekt, das vom cmdlet "New-AzHDInsightClusterConfig erstellt wurde, einen Azure Storage-Kontoeintrag hinzu.

## BEISPIELE

### Beispiel 1: Hinzufügen eines Azure -Speicherschlüssels zum Clusterkonfigurationsobjekt
```
...
Mit diesem Befehl wird der Konfiguration "HDInsight" ein Blob Storage-Kontoeintrag mit dem Namen "your-hadoop-001" hinzufügt.
