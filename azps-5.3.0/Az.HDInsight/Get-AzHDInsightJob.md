...
## BESCHREIBUNG
Das **Cmdlet "Get-AzHDInsightJob"** ruft die letzten Aufträge für einen angegebenen Azure -HDInsight-Cluster in umgekehrter chronologischer Reihenfolge ab, mit dem letzten Auftrag ganz oben in der Liste.
Erhalten Sie einen bestimmten Auftrag, indem Sie den *Parameter "JobId"* angeben.

## BEISPIELE

### Beispiel 1: Aktuelle Aufträge für einen bestimmten Azure -HDInsight-Cluster erhalten
```
PS C:\># Cluster info
...
Dieser Befehl ruft alle zuletzt verwendeten Aufträge für den Cluster namens "Ihr-Hadoop-001" ab.
...
### -JobId
Gibt die Auftrags-ID des zu erhaltenden Auftrags an.
...
### -NumOfJobs
Gibt die Anzahl der abzurufenden Aufträge an.
