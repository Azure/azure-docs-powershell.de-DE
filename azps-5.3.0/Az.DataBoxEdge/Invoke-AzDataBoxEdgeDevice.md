...
## BESCHREIBUNG
Das **Cmdlet Invoke-AzDataBoxEdgeDevice** ruft Aktionen zum Überprüfen, Herunterladen und Installieren der Updates auf dem Data Box Edge-Gerät auf. Eine automatische Überprüfung wird täglich auf dem Gerät ausgeführt. Sie können die Überprüfung explizit auslösen, indem Sie dieses Cmdlet ausführen.
...
### -FetchUpdate
Lädt die Updates auf einem Datenfeld-Edge-/Gatewaygerät herunter.
...
### -InstallUpdate
Installiert die Updates auf dem Datenfeld-Edge-/Gatewaygerät.
...
### -ScanForUpdate
Sucht auf einem Datenfeld-Edge-/Gatewaygerät nach Updates.
