...
## BESCHREIBUNG
Das **Cmdlet "Get-AzDataBoxEdgeRole"** ruft die verfügbaren IoT-Rollen für ein Data Box-Edgegerät ab. Sie können den Parameter "Name" erwähnen, um die Details einer bestimmten IoT-Rolle anzuzeigen.
