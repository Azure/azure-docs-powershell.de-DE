...
## BESCHREIBUNG
Die **Get-AzUserAssignedIdentity** ruft vorhandene Benutzeridentitäten ab.

## BEISPIELE

### Beispiel 1
Dieses Beispiel-Cmdlet ruft die "User Assigned Identity" mit "name **ID1"** unter der Ressourcengruppe **"PSRG" ab.**
...
### Beispiel 2
Dieses Beispiel-Cmdlet ruft alle vom Benutzer zugewiesenen Identitäten unter der Ressourcengruppe **PSRG ab.**
...
### Beispiel 3
Dieses Beispiel-Cmdlet ruft alle vom Benutzer zugewiesenen Identitäten unter dem Abonnement ab.
