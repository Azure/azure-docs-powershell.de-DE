...
Der erste Befehl erstellt ein Bildobjekt und speichert es dann in der $imageConfig Variable.
Mit den nächsten drei Befehlen werden den Variablen $osDiskVhdUri, $dataDiskVhdUri 1 und $dataDiskVhdUri 2 Pfade des Betriebssystemdatenträgers zugewiesen. Dieser Ansatz ist nur zur Lesbarkeit der folgenden Befehle.
...
### -HyperVGeneration
Gibt den HyperVGeneration-Typ für den virtuellen Computer an, der aus dem Bild erstellt wird.  Zulässige Werte sind V1 und V2.
...
Gibt die Quell-ID des virtuellen Computers an.
...
### -ZoneResilient
Aktivieren sie eine stabile Zone
