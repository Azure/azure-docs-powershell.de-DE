...
Gibt das Virtuelle Computerskalen-VM-Objekt an, dem ein Datenträger hinzugefügt werden soll.
Sie können das **Cmdlet "Get-AzVmssVM"** verwenden, um ein Virtual Machine Scale Set -VM-Objekt zu erhalten.
