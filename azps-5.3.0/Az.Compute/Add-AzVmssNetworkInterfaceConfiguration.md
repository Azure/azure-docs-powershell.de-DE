...
## BESCHREIBUNG
Das **Cmdlet "Add-AzVmssNetworkInterfaceConfiguration"** fügt dem Virtual Machine Scale Set (VMSS) eine Netzwerkschnittstellenkonfiguration hinzu.

## BEISPIELE

### Beispiel 1: Hinzufügen einer Netzwerkschnittstellenkonfiguration zu VMSS
```
PS C:\> Add-AzVmssNetworkInterfaceConfiguration -VirtualMachineScaleSet $VMSS -Name "Test" -Primary $True -IPConfiguration $IPCfg
```

Dieser Befehl fügt dem VMSS eine Netzwerkschnittstellenkonfiguration hinzu.
...
Gibt an, ob die Netzwerkschnittstelle netzwerkfähig ist.
...
### -Primary
Gibt an, ob Netzwerkschnittstellen, die aus der Konfiguration der Netzwerkschnittstelle erstellt werden, das primäre Netzwerkinformationscenter (Network Information Center, NIC) des virtuellen Computers sein.
