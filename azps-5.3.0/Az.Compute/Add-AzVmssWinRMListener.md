...
## BESCHREIBUNG
Das **Cmdlet "Add-AzVmssWinRMListener"** fügt dem Virtual Machine Scale Set (VMSS) einen Windows Remote Management (WinRM)-Listener hinzu.

## BEISPIELE

### Beispiel 1: Hinzufügen eines WinRM-Listeners zu VMSS
```
...
In diesem Beispiel wird der VMSS ein WinRM-Listener hinzufügt.
Der erste Befehl verwendet das **Cmdlet "New-AzVmssConfig",** um ein VMSS-Konfigurationsobjekt zu erstellen, und speichert das Ergebnis in der Variablen namens $VMSS.
Der zweite Befehl fügt dem VMSS einen HTTP-Protokoll-WinRM-Listener mit dem Zertifikat unter der angegebenen URL hinzu.
