...
Windows: Der **#A0** wird möglicherweise nicht angegeben. In diesem Fall ist der Vorgang standardmäßig auf "Alle" festgelegt. Wenn der Parameter "VolumeType" für einen virtuellen Computer in Windows vorhanden ist, muss er auf "All" oder "OS" festgelegt sein.
