...
Dieser Befehl setzt den Dienst für automatische Reparaturen auf der VMSS "vmss1" in der Ressourcengruppe "rg" an.
...
Dieser Befehl setzt den Dienst für automatische Reparaturen auf der VMSS "vmss1" in der Ressourcengruppe "rg" fort.

## PARAMETERS

### -Aktion
Die aktion, die ausgeführt werden soll.  Mögliche Werte: "Fortsetzen", "Anhalten".
...
### -InputObject
Das lokale Objekt des Skalierungssets für den virtuellen Computer.
