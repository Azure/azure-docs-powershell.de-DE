...
## BESCHREIBUNG
Das **Cmdlet Set-AzVmssStorageProfile** legt die Speicherprofileigenschaften für den Virtual Machine Scale Set (VMSS) fest.

## BEISPIELE

### Beispiel 1: Festlegen der Speicherprofileigenschaften für die VMSS
```
...
### -DataDisk
Gibt das Datendatenträgerobjekt an.
...
### -OsDiskCreateOption
Gibt an, wie dieses Cmdlet die virtuellen Computer der VMSS erstellt.
Die zulässigen Werte für diesen Parameter sind:
- Anfügen: Dieser Wert wird verwendet, wenn Sie einen speziellen Datenträger zum Erstellen des virtuellen COMPUTERSSS-Computers verwenden. 
- FromImage : Dieser Wert wird verwendet, wenn Sie ein Bild zum Erstellen des virtuellen Computers VMSS verwenden.
Wenn Sie ein Plattformbild verwenden, verwenden Sie auch den *imageReference-Parameter.*
...
Verwenden Sie zum Abrufen des Objekts das New-AzVmssConfig Objekt.
