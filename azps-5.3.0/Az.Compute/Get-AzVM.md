...
## BESCHREIBUNG
Das **Get-AzVM-Cmdlet** ruft die Modellansicht oder Instanzansicht eines virtuellen Azure-Computers ab.
...
Geben Sie *den Parameter "Status"* an, um die Instanzansicht eines virtuellen Computers anstelle der Standardansicht zu erhalten.

## BEISPIELE

### Beispiel 1: Erhalten von Modell- und Instanzansichtseigenschaften
```
...
Dieser Befehl ruft die Modellansichts- und Instanzansichtseigenschaften des virtuellen Computers namens VirtualMachine07 ab.

### Beispiel 2: Erhalten von Eigenschaften der Instanzansicht
```
...
Dieser Befehl ruft Eigenschaften des virtuellen Computers namens "VirtualMachine07" ab.
Dieser Befehl gibt den Parameter *"Status"* an.
Daher ruft der Befehl nur die Eigenschaften der Instanzansicht ab.

### Beispiel 3: Erhalten von Eigenschaften für alle virtuellen Computer in einer Ressourcengruppe
```
...
Dieser Befehl ruft Eigenschaften für alle virtuellen Computer in der Ressourcengruppe namens "ResourceGroup11" ab.

### Beispiel 4: Erhalten aller virtuellen Computer in Ihrem Abonnement
```
PS C:\> Get-AzVM
...
### Beispiel 5: Alle virtuellen Computer am Speicherort erhalten.
```
...
Dieser Befehl ruft alle virtuellen Computer in der Region "USA, Westen" ab.

### Beispiel 6: Erhalten aller virtuellen Computer mithilfe der Filterung
```
...
Dieser Befehl ruft alle virtuellen Computer in Ihrem Abonnement ab, die mit "test" beginnen.
...
Gültige Werte sind: -- Kompakt: zeigt nur Eigenschaften der obersten Ebene an – Erweitern: zeigt alle Eigenschaften auf allen Ebenen an.
...
### -Location
Gibt einen Speicherort an, an dem die virtuellen Computer aufgeführt werden.
...
### -Name
Gibt den Namen des zu erhaltenden virtuellen Computers an.
