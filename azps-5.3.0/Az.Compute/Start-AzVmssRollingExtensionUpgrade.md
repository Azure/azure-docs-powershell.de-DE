...
## SYNOPSIS
Dieses Cmdlet startet ein rolliertes Upgrade für alle Erweiterungen des angegebenen Virtual Machine Scale Set auf die neueste verfügbare Version. 
...
## BESCHREIBUNG
Startet ein Rollupgrade, um alle Erweiterungen auf diesem Maßstab des virtuellen Computers auf die neueste verfügbare Version zu verschieben.
Erweiterungen, auf denen bereits die neueste verfügbare Version ausgeführt wird, sind nicht betroffen.
...
In diesem Beispiel wird der vorhandene VM-Skalierungssatz "MyVmssName" bekommt und eine Erweiterung hinzufügt. Der letzte Befehl führt den Upgradeprozess für den Erweiterungsrollup aus. 
...
### -ResourceId
Die Ressourcen-ID des VM-Skalierungssatzobjekts. 
...
Das Objekt für den VM-Skalierungssatz.
...
### -VMScaleSetName
Der Name des VM-Skalierungssets.
