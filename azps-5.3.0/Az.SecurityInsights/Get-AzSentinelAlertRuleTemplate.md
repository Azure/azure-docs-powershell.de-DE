...
## BESCHREIBUNG
Das **Cmdlet "Get-AzSentinelAlertRuleTemplate"** ruft eine Warnungsregelvorlage aus dem angegebenen Arbeitsbereich ab.
Wenn Sie den Parameter *"AlertRuleTemplateId"* angeben, wird ein einzelnes **"AlertRuleTemplate"-Objekt** zurückgegeben.
Wenn Sie den Parameter *"AlertRuleTemplateId"* nicht angeben, wird ein Array zurückgegeben, das alle Warnungsregelvorlagen im angegebenen Arbeitsbereich enthält.
Sie können das **"AlertRuleTemplate"-Objekt** verwenden, um eine neue Warnungsregel zu erstellen.
...
Dieses Beispiel ruft alle **AlertRuleTemplates** im angegebenen Arbeitsbereich ab und speichert sie dann in der $AlertRuleTemplates Variable.
...
In diesem Beispiel wird **eine "AlertRuleTemplate"** im angegebenen Arbeitsbereich ab- und dann in der $AlertRuleTemplate gespeichert.

## PARAMETERS

### -AlertRuleTemplateId
Vorlagen-Benachrichtigungsregel-ID.
