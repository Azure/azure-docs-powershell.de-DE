...
Sie müssen einen der Parameter angeben, z. B. "-AzureActiveDirectory", um die Art der zu erstellende Warnungsregel anzugeben.  Jede Art hat unterschiedliche erforderliche Parameter.
...
Hinweis: Nicht alle im Portal verfügbaren Datenconnectors sind über API verfügbar.
...
In diesem Beispiel wird ein **DataConnector** für Azure Security Center im angegebenen Arbeitsbereich erstellt und dann in der $DataConnector gespeichert.
...
In diesem Beispiel wird ein **DataConnector** für Microsoft Cloud App Security im angegebenen Arbeitsbereich erstellt und dann in der $DataConnector gespeichert.
...
### -AwsRoleArn
Data Connector AWS RoleConnector
...
### -MicrosoftCloudAppSecurity
Datenconnector Microsoft Cloud App Security
