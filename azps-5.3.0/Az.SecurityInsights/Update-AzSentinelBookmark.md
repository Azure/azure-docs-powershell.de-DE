...
## BESCHREIBUNG
Das **Cmdlet "Update-AzSentinelBookmark"** aktualisiert die Textmarke im angegebenen Arbeitsbereich.
Sie können ein **Lesezeichenobjekt** als Parameter oder mithilfe des Pipelineoperators übergeben, oder Sie können die erforderlichen *BookmarkId-Parameter* angeben.
...
Der Befehl aktualisiert die Textmarke durch Festlegen der *Eigenschaft "Notes".*  Alle anderen Vorteile bleiben gleich.
...
Der erste Befehl ruft die Textmarke nach *BookmarkId* aus dem angegebenen Arbeitsbereich ab und speichert sie dann in der $Bookmark Variable.
Mit dem zweiten Befehl wird die Eigenschaft "Notes" aktualisiert.   Alle anderen Vorteile bleiben gleich.
...
### -DisplayName
Anzeigename der Textmarkeregel.
...
### -IncidentInfo
Vorfallinformationen als Lesezeichen hinzufügen.
