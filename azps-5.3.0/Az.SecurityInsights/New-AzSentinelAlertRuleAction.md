...
## BESCHREIBUNG
Das **Cmdlet "New-AzSentinelAlertRuleAction"** erstellt eine automatisierte Antwort für eine Warnungsregel im angegebenen Arbeitsbereich.
Sie müssen die Resorce-ID der Logik-App und den Trigger-URI bereitstellen, die im Logik-App-Modul gefunden werden können.
...
In diesem Beispiel wird anhand der Eigenschaften der Logik-App ein **AlertRuleAction** für die angegebene Warnungsregel erstellt und dann in der $AlertRuleAction gespeichert.
