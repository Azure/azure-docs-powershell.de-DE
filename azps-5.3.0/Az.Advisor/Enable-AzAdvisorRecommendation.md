...
## SYNOPSIS
Aktiviert Azure Advisor Empfehlung(en).
...
## BESCHREIBUNG
Dieses Cmdlet aktiviert eine zuvor unterdrückte Empfehlung. Sie können auch alle mit einer Empfehlung verbundenen Risiken entfernen.
...
Entfernt alle Empfehlungen für die angegebene Empfehlung mit dem Namen "recommendation_id".
...
Entfernt alle Ausblendungen für die gegebene Empfehlung(n), die aus der Pipeline übergeben wurden.
