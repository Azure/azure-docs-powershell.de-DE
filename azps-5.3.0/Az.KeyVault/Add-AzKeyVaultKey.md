...
### Beispiel 7: Generieren eines Schlüsselwechselschlüssels (KEY Exchange Key, KEK) für das Feature "Eigenen Schlüssel mitbringen" (BYOK)
...
Die zulässigen Werte für diesen Parameter sind eine durch Kommas getrennte Liste von Schlüsselvorgängen gemäß der [JSON Web Key (JWK)-Spezifikation:](http://go.microsoft.com/fwlink/?LinkID=613300)
- Verschlüsseln
- entschlüsseln
- wrapKey
- unwrapKey
