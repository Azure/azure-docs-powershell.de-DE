...
## BESCHREIBUNG
Das **Cmdlet "New-AzKeyVaultCertificateAdministratorDetail"** erstellt ein Detailobjekt für den Speicherzertifikatadministrator.

## BEISPIELE

### Beispiel 1: Erstellen eines Detailobjekts für den Zertifikatadministrator
```
...
Mit diesem Befehl wird ein Detailobjekt für den Speicherzertifikatadministrator erstellt und dann in der $AdminDetails gespeichert.
...
### -EmailAddress
Gibt die E-Mail-Adresse für den Zertifikatadministrator an.
...
### -FirstName
Gibt den Vornamen des Zertifikatadministrators an.
...
### -LastName
Gibt den Nachnamen des Zertifikatadministrators an.
...
### -PhoneNumber
Gibt die Telefonnummer des Zertifikatadministrators an.
