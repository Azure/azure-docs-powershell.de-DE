...
## SYNOPSIS
Sichern Sie ein Zertifikat in einem Schlüsseltresor.
...
- Sie haben ein Zertifikat mithilfe des Schlüsseltresor erstellt und möchten nun das Objekt in eine andere Region von Azure klonen, damit Sie es in allen Instanzen Der verteilten Anwendung verwenden können.
...
Dieser Befehl erstellt eine Sicherung des Zertifikats namens $cert. Name im Tresor namens $cert. VaultName in eine Datei mit dem Namen "Backup.blob", und überschreiben die Datei, sofern sie bereits vorhanden ist.
