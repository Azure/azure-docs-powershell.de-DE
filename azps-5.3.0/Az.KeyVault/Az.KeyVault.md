...
# Az.KeyVault Module
## Beschreibung
In diesem Thema werden Hilfethemen für die Azure Key Vault-Cmdlets angezeigt.

## Az.KeyVault-Cmdlets
### [Add-AzKeyVaultCertificate](Add-AzKeyVaultCertificate.md)
Fügt einem Schlüsseltresor ein Zertifikat hinzu.
...
Fügt eine Regel hinzu, die den Zugriff auf einen Schlüsseltresor basierend auf der Internetadresse des Clients einschränken soll.

### [Backup-AzKeyVault](Backup-AzKeyVault.md)
Vollständige Sicherung eines verwalteten HSM.
...
Sichern Sie einen geheimen Schlüssel in einem Schlüsseltresor.
...
Ruft Kontakte ab, die für Zertifikatbenachrichtigungen für einen Schlüsseltresor registriert sind.
...
Ruft Key Vault verwaltete Azure Storage-Konten ab.

### [Get-AzKeyVaultManagedStorageSasDefinition](Get-AzKeyVaultManagedStorageSasDefinition.md)
Ruft die SAS-Definitionen für den Schlüsseltresor verwalteter Speicher ab.
...
Listen Sie Rollendefinitionen eines bestimmten verwalteten HSM in einem bestimmten Bereich auf.
...
Löscht einen Kontakt, der für Zertifikatbenachrichtigungen registriert ist, aus einem Schlüsseltresor.
...
Stellt einen verwalteten HSM vollständig aus einer Sicherung wieder her.
...
Bricht einen Zertifikatvorgang im Schlüsseltresor ab.

### [Undo-AzKeyVaultCertificateRemoval](Undo-AzKeyVaultCertificateRemoval.md)
Stellt ein gelöschtes Zertifikat in einem Schlüsseltresor in einen aktiven Zustand wiederher.
...
Stellt ein zuvor gelöschtes, von KeyVault verwaltetes Speicherkonto wiederher.

### [Undo-AzKeyVaultManagedStorageSasDefinitionRemoval](Undo-AzKeyVaultManagedStorageSasDefinitionRemoval.md)
Stellt eine zuvor gelöschte SAS-Definition für verwalteten KeyVault-Speicher wiederher.

### [Undo-AzKeyVaultRemoval](Undo-AzKeyVaultRemoval.md)
Stellt einen gelöschten Schlüsseltresor in einen aktiven Zustand wiederher.
...
Aktualisieren Sie den Zustand eines in Azure verwalteten HSM.

### [Update-AzKeyVaultManagedStorageAccount](Update-AzKeyVaultManagedStorageAccount.md)
Aktualisieren bearbeitbarer Attribute eines verwalteten Azure Speicherkontos im Schlüsseltresor

### [Update-AzKeyVaultManagedStorageAccountKey](Update-AzKeyVaultManagedStorageAccountKey.md)
Generiert den angegebenen Schlüssel des verwalteten Azure -Speicherkontos im Schlüsseltresor erneut.
