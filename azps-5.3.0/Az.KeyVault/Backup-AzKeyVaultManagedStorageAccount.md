...
- Sie haben ein Konto für verwalteten Speicher mithilfe des Schlüsseltresor erstellt und möchten nun das Objekt in eine andere Azure-Region klonen, sodass Sie es in allen Instanzen der verteilten Anwendung verwenden können.
...
### Beispiel 3: Sichern eines zuvor abgerufenen verwalteten Speicherkontos unter einem angegebenen Dateinamen, überschreiben die Zieldatei ohne Eingabeaufforderung.
```powershell
