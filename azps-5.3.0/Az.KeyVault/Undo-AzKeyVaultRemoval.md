...
## BESCHREIBUNG
Das **Cmdlet "Undo-AzKeyVaultRemoval"** stellt einen zuvor gelöschten Schlüsseltresor wiederher. Der wiederhergestellte Tresor ist nach der Wiederherstellung aktiv.
...
Mit diesem Befehl wird der Schlüsseltresor "MyKeyVault" wiederhergestellt, der zuvor aus der Region "eastus2" und der Ressourcengruppe "MyResourceGroup" gelöscht wurde, in einen aktiven und verwendbaren Zustand. Außerdem werden die Tags durch ein neues Tag ersetzt.
...
### -Location
Gibt den gelöschten Tresor an, der in der ursprünglichen Region von Azure gespeichert wurde.
