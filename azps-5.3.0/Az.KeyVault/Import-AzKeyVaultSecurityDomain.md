...
Zuerst müssen die Schlüssel bereitgestellt werden, um die Daten der Sicherheitsdomäne zu entschlüsseln.
Anschließend stellt der **Befehl "Import-AzKeyVaultSecurityDomain"** die zuvor gesicherten Daten der Sicherheitsdomäne mithilfe dieser Schlüssel auf einem verwalteten HSM wieder zurück.
...
### -Keys
Informationen zu den Schlüsseln, die zum Entschlüsseln der Daten der Sicherheitsdomäne verwendet werden.
Sehen Sie sich Beispiele für deren Bau an.
