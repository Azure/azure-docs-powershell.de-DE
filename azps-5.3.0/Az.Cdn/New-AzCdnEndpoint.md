...
## BESCHREIBUNG
Das **Cmdlet "New-AzCdnEndpoint"** erstellt einen Azure Content Delivery Network (CDN)-Endpunkt.
...
Gibt ein Array von Inhaltstypen an, die vom Edgeknoten zum Client komprimiert werden.
...
### -DefaultOriginGroup
Die standardmäßige Origin-Gruppe.
...
### -DeliveryPolicy
Die Zustellungsrichtlinie für diesen Endpunkt.
...
### -GeoFilters
Die Liste der Geofilter, die für diesen Endpunkt gelten.
...
### -IsHttpAllowed
Gibt an, ob der Endpunkt den HTTP-Datenverkehr aktiviert.
...
### -IsHttpsAllowed
Gibt an, ob der Endpunkt den HTTPS-Datenverkehr aktiviert.
...
### -OptimizationType
Gibt alle Optimierungen an, die dieser Endpunkt bietet.
...
Die Anzahl von Sekunden zwischen integritätsintepunkts.
...
Der Pfad relativ zum Ursprung, der zur Ermittlung der Integrität des Ursprungs verwendet wird.
...
Protokoll, das für integritätsintepunkt verwendet werden soll.
...
Der Typ der von der Integritätsintepunktanforderung vorgenommenen Anforderung.
...
### -OriginHostHeader
Gibt den Kopf des Endpunkts des Ursprungshosts an.
...
### -ProbePath
Gibt den Beispielpfad für die dynamische Websitebeschleunigung an.
...
### -Tag
Die Tags, die dem Azure CDN-Endpunkt zugeordnet werden.
