...
## BESCHREIBUNG
Das **Cmdlet "Remove-AzCdnCustomDomain"** entfernt die benutzerdefinierte Domäne von einem Azure Content Delivery Network (CDN)-Endpunkt.
...
### -CdnCustomDomain
Gibt die benutzerdefinierte Domäne an, die von diesem Cmdlet entfernt wird.
...
### -CustomDomainName
Gibt den Ressourcennamen der benutzerdefinierten Domäne an, die von diesem Cmdlet entfernt wird.
...
### -ResourceGroupName
Gibt den Namen der Ressourcengruppe an, aus der mit diesem Cmdlet eine benutzerdefinierte Domäne entfernt wird.
