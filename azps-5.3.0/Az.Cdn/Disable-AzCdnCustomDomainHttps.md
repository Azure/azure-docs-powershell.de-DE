...
## BESCHREIBUNG
Das **Cmdlet "Disable-AzCdnCustomDomainHttps"** deaktiviert die sichere Bereitstellung einer benutzerdefinierten CDN-Domäne durch HTTPS.
...
Deaktivieren Sie die sichere Übermittlung der benutzerdefinierten Domäne.
