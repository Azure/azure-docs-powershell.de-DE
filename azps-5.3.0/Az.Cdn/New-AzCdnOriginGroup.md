...
```
Dieses Cmdlet erstellt eine neue Origin-Gruppe innerhalb des angegebenen Endpunkts. Dabei werden die angegebenen Origin-ID-Kennungen als Ursprung verwendet.
