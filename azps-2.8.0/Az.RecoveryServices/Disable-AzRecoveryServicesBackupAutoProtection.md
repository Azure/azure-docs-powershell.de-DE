...
Das erste Cmdlet deaktiviert die Richtlinie für den Sicherungsschutz.

## Parameter

### -BackupManagementType
Sicherungs Verwaltungstyp der Ressource (Beispiel: MAB, DPM).
...
### -Workloadtype
Arbeits Auslastungs der Ressource (Beispiel: AzureVM, Windows Server, AzureFiles).
