...
## Beschreibung
Das Cmdlet " **Get-AzIntegrationAccountCallbackUrl** " Ruft eine Integrations Konto-Rückruf-URL aus einer Ressourcengruppe ab.
Dieses Cmdlet gibt ein **CallbackUrl** -Objekt zurück, das die Rückruf-URL für das Integrations Konto darstellt.
Geben Sie den Namen des Integrations Kontos und die Ressourcengruppe an.
...
### Beispiel 1: Abrufen einer Integrations Konto-Rückruf-URL
```
...
Dieser Befehl ruft eine Integrations Konto-Rückruf-URL ab.
