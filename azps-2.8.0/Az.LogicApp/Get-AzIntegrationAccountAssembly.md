...
## Beschreibung
Das Cmdlet " **Get-AzIntegrationAccountAssembly** " Ruft eine Assembly von einem Integrations Konto ab.

## Beispiele

### Beispiel 1: Abrufen einer Assembly anhand von Parametern
```powershell
...
Rufen Sie eine Assembly mit dem Namen "SampleAssembly" ab, die sich im Integrations Konto "sampleIntegrationAccount" befindet, das in der Ressourcengruppe "sampleResourceGroup" enthalten ist.

### Beispiel 2: Auflisten aller Assemblys in einem Integrations Konto nach Parametern
```powershell
...
Rufen Sie alle Assemblys ab, die sich im Integrations Konto "sampleIntegrationAccount" befinden, das in der Ressourcengruppe "sampleResourceGroup" enthalten ist.
