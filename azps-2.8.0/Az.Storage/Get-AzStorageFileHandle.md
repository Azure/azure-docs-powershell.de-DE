...
## Beschreibung
Das Cmdlet " **Get-AzStorageFileHandle** " listet Dateihandles einer Dateifreigabe oder eines Dateiverzeichnisses oder einer Datei auf.

## Beispiele

### Beispiel 1: Auflisten aller Dateihandles für eine Dateifreigabe rekursiv und Sortieren nach ClientIp und OpenTime
```
...
Dieser Befehl listet Dateihandles für eine Dateifreigabe auf und sortiert die Ausgabe nach ClientIp und dann nach OpenTime.

### Beispiel 2: Auflisten der ersten 2 Dateihandles für ein Dateiverzeichnis rekursiv 
```
...
Dieser Befehl listet die ersten zwei Dateihandles in einem Dateiverzeichnis rekursiv auf.

### Beispiel 3: Auflisten der 3rd-to-6-Dateihandles für eine Datei 
```
...
Dieser Befehl listet die 3rd-to-6-Dateihandles für eine Datei auf.
...
### -Datei
Das clouddatei-Objekt hat die Datei zum Auflisten von Dateihandles angegeben.
...
### -IncludeTotalCount
Gibt die Anzahl der Objekte in der Datengruppe (eine ganze Zahl), gefolgt von den Objekten, an. Wenn das Cmdlet die Gesamtanzahl nicht ermitteln kann, gibt es "unbekannte Gesamtanzahl" zurück.
