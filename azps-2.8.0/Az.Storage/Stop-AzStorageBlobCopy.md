...
## Beschreibung
Das Cmdlet **Stop-AzStorageBlobCopy** beendet einen Kopiervorgang auf das angegebene Ziel-BLOB.
...
In diesem Beispiel wird der Kopiervorgang beendet, indem der Container in der Pipeline vom Get-AzStorageBlob-Cmdlet übergeben wird.
...
Sie können das Objekt erstellen oder das Get-AzStorageContainer-Cmdlet verwenden.
...
Sie können den Kontext mithilfe des New-AzStorageContext-Cmdlets erstellen.
