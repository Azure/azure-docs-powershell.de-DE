...
### Beispiel 6: Erstellen eines speicherkontos mit Azure-Dateien Aad DS-Authentifizierung.
```
...
Dieser Befehl erstellt ein Speicherkonto mit Azure-Dateien Aad DS-Authentifizierung.
