...
## Beschreibung
Das Cmdlet " **Get-AzSearchQueryKey** " ruft Abfrage Schlüssel (s) des Azure Search-Diensts ab.
...
Im Beispiel werden alle Abfrage Schlüssel (s) des Azure-Suchdiensts abgerufen.
