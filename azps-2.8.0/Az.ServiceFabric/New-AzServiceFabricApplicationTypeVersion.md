...
## Beschreibung
Dieses Cmdlet erstellt unter Verwendung des in-PackageUrl angegebenen Pakets eine neue Version des Anwendungstyps, auf die über einen Ruhe Endpunkt zugegriffen werden kann, damit Azure Resource Manager während der Bereitstellung verwendet werden kann, und die Anwendung verpackt und mit der Erweiterung. sfpkg gezippt enthält. Mit diesem Befehl wird der Anwendungstyp erstellt, wenn er noch nicht vorhanden ist.
...
In diesem Beispiel wird eine Anwendungstypen Version "V1" unter Typ "testAppType" erstellt. Die Version im Anwendungsmanifest, die im Paket enthalten ist, sollte die gleiche Version wie die in-Version angegebene Version aufweisen.
