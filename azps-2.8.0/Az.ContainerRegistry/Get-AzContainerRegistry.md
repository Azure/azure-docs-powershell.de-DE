...
## Beschreibung
Das Get-AzContainerRegistry-Cmdlet ruft eine angegebene Container Registrierung oder alle Container Register in einer Ressourcengruppe oder dem Abonnement ab.

## Beispiele

### Beispiel 1: Abrufen einer angegebenen Container Registrierung
```powershell
...
Dieser Befehl ruft die angegebene Container Registrierung ab.

### Beispiel 2: Abrufen aller Container Register in einer Ressourcengruppe
```powershell
...
Dieser Befehl ruft alle Container Register in einer Ressourcengruppe ab.

### Beispiel 3: Abrufen aller Container Register im Abonnement
```powershell
...
Dieser Befehl ruft alle Container Register im Abonnement ab.
...
### -IncludeDetail
Zeigen Sie weitere Details zur Container Registrierung an.
