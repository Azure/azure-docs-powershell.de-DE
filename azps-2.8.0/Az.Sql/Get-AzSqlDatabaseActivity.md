...
## Beschreibung
Das Cmdlet " **Get-AzSqlDatabaseActivity** " Ruft den Status von Datenbankvorgängen in Azure SQL-Datenbank ab.

## Beispiele

### Beispiel 1: Abrufen des Status für alle SQL-Datenbankinstanzen
```
PS C:\>Get-AzSqlDatabaseActivity -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -ElasticPoolName "ElasticPool01"
```

Dieser Befehl gibt den Vorgangsstatus aller SQL-Datenbankinstanzen in einem elastischen Pool mit dem Namen "ElasticPool01" zurück.

### Beispiel 2: Abrufen des Status für alle SQL-Datenbankvorgänge
```
PS C:\>Get-AzSqlDatabaseActivity -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -DatabaseName "Database01"
```

Dieser Befehl gibt den Status aller SQL-Datenbankvorgänge in einer Datenbank zurück.

## Parameter

### -DatabaseName
Gibt den Namen der Datenbank an, für die dieses Cmdlet den Status erhält.
...
### -ElasticPoolName
Gibt den Namen des elastischen Daten Bank Pools an, für den dieses Cmdlet den Status erhält.
...
### -Vorgangs-Nr
Gibt die ID des Vorgangs an, den dieses Cmdlet erhält.
...
### -Servername
Gibt den Namen des Microsoft SQL Server an, der die Datenbank hostet.
