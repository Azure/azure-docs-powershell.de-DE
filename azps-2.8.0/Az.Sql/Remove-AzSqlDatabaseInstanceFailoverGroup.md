...
### Entfernen einer Instanz-Failover-Gruppe aus der Ressourcen-ID
```
Remove-AzSqlDatabaseInstanceFailoverGroup [-Location] <String> [-ResourceId] <String> [-Force]
 [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Entfernen einer Instanz-Failover-Gruppe aus der AzureSqlInstanceFailoverGroupModel-Instanzen Definition
```
