...
## Beschreibung
Das Add-AzSqlElasticJobTarget-Cmdlet fügt eine Zielressource zu einer Zielgruppe hinzu.

## Beispiele

### Beispiel 1: Hinzufügen eines Server Ziels
```
...
### Beispiel 2 – Hinzufügen eines Daten Bank Ziels
```
PS C:\> $tg = Get-AzSqlElasticJobTargetGroup -ResourceGroupName rg -ServerName elasticjobserver -Name tg1
...
### Beispiel 3: Hinzufügen eines elastischen Pool Ziels
```
...
### Beispiel 4: Hinzufügen eines Shard-Karten Ziels
```
PS C:\> $tg = Get-AzSqlElasticJobTargetGroup -ResourceGroupName rg -ServerName elasticjobserver -Name tg1
...
Fügt einer Zielgruppe ein Ziel (Server, elastischer Pool, Datenbank und Shard-Karte) hinzu.
...
### -ElasticPoolName
Zielname des elastischen Pools
...
Anmelde Informations Name aktualisieren
...
### -ShardMapName
Name des Splitter Karten-Ziels
