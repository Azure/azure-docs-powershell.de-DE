...
### Einrichten einer Instanz-Failover-Gruppe aus der Ressourcen-ID
```
...
### Festlegen einer Instanz-failovergruppe aus der AzureSqlInstanceFailoverGroupModel-Instanzen Definition
```
