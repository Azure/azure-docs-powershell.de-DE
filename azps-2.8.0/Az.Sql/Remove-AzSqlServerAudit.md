...
### Beispiel 1: Entfernen der Überwachungseinstellungen eines Azure SQL Server
```
PS C:\>Remove-AzSqlServerAudit -ResourceGroupName "resourcegroup01" -ServerName "server01"
```

### Beispiel 2: entfernen, durch Pipeline, die Überwachungseinstellungen eines Azure SQL Server
```
