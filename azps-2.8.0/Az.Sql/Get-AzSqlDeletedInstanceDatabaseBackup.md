...
## Beschreibung
Das Cmdlet " **Get-AzSqlDeletedInstanceDatabaseBackup** " Ruft eine angegebene gelöschte SQL-Instanzen Datenbank-Sicherung ab, die Sie wiederherstellen können, oder alle gelöschten Sicherungen, die wiederhergestellt werden können.
Dieses Cmdlet wird auch vom SQL instance Stretch-Datenbankdienst auf Azure unterstützt.
