...
## Beschreibung
Das Cmdlet " **Get-AzSqlSyncMember** " gibt Informationen zu einem oder mehreren Azure SQL-Daten Bank Synchronisierungs Mitgliedern zurück.
...
### Beispiel 3: Abrufen aller Instanzen des Azure SQL-Synchronisierungs Elements, das einer Synchronisierungsgruppe mithilfe von Filtern zugewiesen ist
```
...
Dieser Befehl ruft Informationen zu allen Azure SQL-Daten Bank Synchronisierungs Mitgliedern ab, die der Synchronisierungsgruppen-SyncGroup01 zugeordnet sind, die mit "SyncMember" beginnen.
