...
### Wechseln einer Instanz-Failover-Gruppe von der Ressourcen-ID
```
Switch-AzSqlDatabaseInstanceFailoverGroup [-Location] <String> [-ResourceId] <String> [-AllowDataLoss]
 [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Wechseln einer Instanz-Failover-Gruppe aus der AzureSqlInstanceFailoverGroupModel-Instanzen Definition
```
