...
Dieser Befehl ruft alle API-Revision der angegebenen API für einen bestimmten ApiManagement-Kontext ab.

## Parameter

### -ApiId
API-Bezeichner, dessen Überarbeitungen wir auflisten möchten.
