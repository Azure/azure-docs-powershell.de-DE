...
Dieser Befehl ruft alle Schlüssel ab, die zuvor gelöscht, aber nicht gelöscht wurden, im Schlüsseltresor "Contoso".

### Beispiel 6: Ruft den wichtigsten ITPfx-Server ab, der gelöscht, aber nicht für diesen Schlüsseltresor gelöscht wurde.
```powershell
