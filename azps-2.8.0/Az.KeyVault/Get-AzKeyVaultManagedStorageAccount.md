...
### Beispiel 3: Auflisten aller wichtigen Vault-verwalteten Speicherkonten mithilfe von Filtern
```powershell
...
Listet alle Konten auf, deren Schlüssel durch Vault "myvault" verwaltet werden, die mit "Test" beginnen.
