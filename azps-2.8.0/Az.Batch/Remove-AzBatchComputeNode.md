...
## Beschreibung
Das Cmdlet **Remove-AzBatchComputeNode** entfernt Azure Batch Compute-Knoten aus einem Pool.
...
Dieser Befehl ruft den Compute-Knoten ab, der über die angegebene ID aus Pool verfügt, die über die ID-Pool07 mit dem Get-AzBatchComputeNode-Cmdlet verfügt.
