...
Dieser Befehl beendet den virtuellen Computer mit dem Namen VirtualMachine07 in ResourceGroup11.
...
### -SkipShutdown
So fordern Sie ein nicht anmutiges VM-Herunterfahren an, wenn die VM bereitgestellt wird.
...
### -StayProvisioned
Das Cmdlet beendet alle virtuellen Computer innerhalb des VMSS, gibt diese jedoch nicht aus. Das Konto wird für die angehalten virtuellen Computer berechnet.
