...
Es handelt sich um die Base64-Codierung des folgenden JSON-Objekts, das in UTF-8 codiert ist: {"Data": " \< Base64-codiert-Certificate \> ", "DataType": "PFX", "Kennwort": " \< PFX-Datei-Kennwort \> "}
