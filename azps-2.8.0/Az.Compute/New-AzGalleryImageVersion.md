...
### -StorageAccountType
Gibt den Speicher Kontotyp an, der zum Speichern des Bilds verwendet werden soll. Diese Eigenschaft kann nicht aktualisiert werden. Verfügbare Werte sind Standard_LRS und Standard_ZRS.
