...
## Beschreibung
Das Cmdlet **New-AzServiceBusAuthorizationRule** erstellt eine neue Autorisierungsregel für den angegebenen ServiceBus-Namespace oder-Wartebereich oder das angegebene Thema.
...
Erstellt `AuthoRule1` mit **Listen** -und **Sende** rechten für den Namespace `SB-Example1` .
...
Erstellt `AuthoRule1` mit **Listen** -und **Sende** rechten für die Warteschlange `SBQueue` .
...
Erstellt `AuthoRule1` mit **Listen** -und **Sende** rechten für das Thema `SBTopic` .
