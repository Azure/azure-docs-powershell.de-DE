...
## Beschreibung
Die **vollständigen AzServiceBusMigration-** Cmdlets setzen die Migration von Standard-zu Premium-Namespace als abgeschlossen fest, und Verbindungszeichenfolgen des Standardnamespace verweisen nun auf den Premium-Namespace.
...
Legt die Migration des Namespace "NamespaceStandardMigration" als abgeschlossen fest.
...
### -Inputobject
Service Bus-Migrations Konfiguration – Standard Namespace-Objekt
...
### -Resourcen-Nr
Service Bus-Migration – Standard Namespace-Ressourcen-ID
