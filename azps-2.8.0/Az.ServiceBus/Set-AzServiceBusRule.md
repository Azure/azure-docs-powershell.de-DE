...
## Beschreibung
Das Cmdlet " **Satz-AzServiceBusRule** " aktualisiert die Beschreibung für die angegebene Regel des angegebenen Abonnements.
...
Aktualisiert den SQL **-Ausdruck MySQL Expression = "Bedingung"** der Regel `SBRule` des Abonnements `SBSubscription` im Thema `SBTopic`
