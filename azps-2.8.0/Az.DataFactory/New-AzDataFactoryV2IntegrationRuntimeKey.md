...
## Beschreibung
Das Cmdlet **New-AzDataFactoryV2IntegrationRuntimeKey** regeneriert den Integrationslauf Zeitschlüssel mit dem Schlüsselnamen, der durch den Parameter "keyname" angegeben wird. Der vorherige Schlüssel ist ungültig.
...
Das Cmdlet generiert den Schlüssel "authKey2" für die Integrationslaufzeit mit dem Namen "Test-SelfHost-IR" neu.
...
### -KeyName
Der Authentifizierungsschlüssel Name der selbst gehosteten Integrationslaufzeit.
