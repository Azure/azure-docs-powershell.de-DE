...
## Beschreibung
Das Cmdlet **Remove-AzDataFactoryV2Trigger** entfernt einen Trigger aus einer Data Factory. Wenn der Parameter _Force_ angegeben wird, wird das Cmdlet vor dem Entfernen des Triggers nicht angezeigt.
...
Entfernen Sie einen Trigger mit dem Namen "ScheduledTrigger" aus der Data Factory "WikiADF".
...
### -Inputobject
Das zu entfernende Trigger-Objekt.
