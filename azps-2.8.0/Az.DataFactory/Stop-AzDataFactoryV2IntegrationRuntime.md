...
## Beschreibung
Das Cmdlet **Stop-AzDataFactoryV2IntegrationRuntime** beendet eine verwaltete dedizierte Integrationslaufzeit im Zustand "Started", die vom Cmdlet Start-AzDataFactoryV2IntegrationRuntime gestartet wurde. Die Ressourcen werden freigegeben, und der Status wird an "gestoppt" übertragen.

## Beispiele

### Beispiel 1: Beenden einer verwalteten Integrationslaufzeit, die sich im Zustand "gestartet" befindet.
```
...
Die verwaltete Integrationslaufzeit "Test-reserlved-IR" befindet sich im Zustand "gestartet". Nach dem Ausführen Stop-AzDataFactoryV2IntegrationRuntime-Cmdlets werden die Ressourcen freigegeben, und der Zustand wird an "stopped" übertragen.
...
[Anfang-AzDataFactoryV2IntegrationRuntime]()
