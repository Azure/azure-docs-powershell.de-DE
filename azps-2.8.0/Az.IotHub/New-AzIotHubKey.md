...
### Beispiel 1 regenerieren des Primärschlüssels
```
...
Neu generierter Primärschlüssel für die Autorisierungsrichtlinie "testKey" eines Azure viel-Hubs.

### Beispiel 2 tauschen von Schlüsseln
```
...
Tauschen Sie die Schlüssel für die Autorisierungsrichtlinie "testKey" eines Azure-viel-Hubs aus.
