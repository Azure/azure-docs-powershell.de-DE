...
## Beschreibung
Erstellt ein Objekt vom Typ Trigger Condition.
Dieses Objekt soll an den Befehl übergeben werden, der ein Warnungs Aktionsobjekt erstellt.
...
### -MetricTrigger
Trigger-Bedingung für metrische Abfrageregel
...
### -Threshold
Der Schwellenwert, über dem die Benachrichtigung ausgelöst wird
...
### -ThresholdOperator
Der Schwellenwert Operator: GreaterThan, LessThan oder gleich
