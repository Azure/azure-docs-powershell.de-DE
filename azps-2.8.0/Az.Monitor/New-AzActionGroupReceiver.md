...
### -ArmRoleReceiver
Erstellen eines ArmRoleReceiver
...
der URI, in dem webhooks gesendet werden sollen.
...
Erstellen eines AzureAppPushReceiver
...
### -Verbindungs-Nr
die ITSM-Verbindungs-ID dieses Receivers
...
die Funktions-APP-Quell Code Funktion
...
### -IsGlobalRunbook
Gibt an, ob es sich bei dieser Instanz um eine globale runbooks
...
### -LogicAppReceiver
Erstellen eines LogicAppReceiver
...
### -Region
der ITSM-Bereich dieses Receivers
...
### -TicketConfiguration
der ITSM-TicketConfiguration dieses Receivers
...
### -UseAadAuth
das zu verwendende Flag zum Hinzufügen von auth
...
Das Kennzeichen, ob ein allgemeines Warnungs Schema verwendet werden soll. Dieser Wert wird neglectedfor SMS, Azure App Push, ITSM und Voice Receivers sein.
...
### -VoiceCountryCode
Die Landesvorwahl des Voice-Receivers
...
### -VoicePhoneNumber
Die Telefonnummer des sprach Empfängers
...
### -VoiceReceiver
Erstellen eines sprach Empfängers
...
### -Arbeitsbereichs-Nr
die ITSM-Arbeitsbereichs-ID dieses Receivers
