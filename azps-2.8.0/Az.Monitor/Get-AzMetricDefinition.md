...
### Beispiel 1: Abrufen von metrischen Definitionen für eine Ressource
```
...
Dieser Befehl ruft die Metrik-Definitionen für die angegebene Ressource ab.

### Beispiel 2: Abrufen von metrischen Definitionen mit detaillierter Ausgabe
```
...
### Beispiel 3: Abrufen von metrischen Definitionen nach Name
```
...
Dieser Befehl ruft Definitionen für die BytesSent-und CpuTime-Metrik ab.
Die Ausgabe ist detailliert.
...
### -MetricNamespace
Gibt den metrischen Namespace an, für den metrische Definitionen abgefragt werden sollen.
