...
## Beschreibung
Das Set-AzDefault-Cmdlet fügt die Standardwerte im aktuellen Kontext hinzu oder ändert diese.
...
Dieser Befehl legt die Standardressourcen Gruppe auf die vom Benutzer angegebene Ressourcengruppe fest.
...
### -Force
Erstellen einer neuen Ressourcengruppe, wenn der angegebene Standard nicht vorhanden ist
...
### -ResourceGroupName
Name der Ressourcengruppe, die als Standard eingestellt ist
