...
ms.locfileid: "93824860"
---
# <span data-ttu-id="2ce00-101">Get-AzSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="2ce00-101">Get-AzSecurityAlert</span></span>

## <span data-ttu-id="2ce00-102">Synopsis</span><span class="sxs-lookup"><span data-stu-id="2ce00-102">SYNOPSIS</span></span>
<span data-ttu-id="2ce00-103">Ruft Sicherheitswarnungen ab, die vom Azure Security Center erkannt wurden.</span><span class="sxs-lookup"><span data-stu-id="2ce00-103">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="2ce00-104">Syntax</span><span class="sxs-lookup"><span data-stu-id="2ce00-104">SYNTAX</span></span>

### <span data-ttu-id="2ce00-105">SubscriptionScope (Standard)</span><span class="sxs-lookup"><span data-stu-id="2ce00-105">SubscriptionScope (Default)</span></span>
```
Get-AzSecurityAlert [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="2ce00-106">ResourceGroupScope</span><span class="sxs-lookup"><span data-stu-id="2ce00-106">ResourceGroupScope</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="2ce00-107">ResourceGroupLevelResource</span><span class="sxs-lookup"><span data-stu-id="2ce00-107">ResourceGroupLevelResource</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> -Name <String> -Location <String>
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="2ce00-108">SubscriptionLevelResource</span><span class="sxs-lookup"><span data-stu-id="2ce00-108">SubscriptionLevelResource</span></span>
```
Get-AzSecurityAlert -Name <String> -Location <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### <span data-ttu-id="2ce00-109">ResourceId</span><span class="sxs-lookup"><span data-stu-id="2ce00-109">ResourceId</span></span>
```
Get-AzSecurityAlert -ResourceId <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

## <span data-ttu-id="2ce00-110">Beschreibung</span><span class="sxs-lookup"><span data-stu-id="2ce00-110">DESCRIPTION</span></span>
<span data-ttu-id="2ce00-111">Ruft Sicherheitswarnungen ab, die vom Azure Security Center erkannt wurden.</span><span class="sxs-lookup"><span data-stu-id="2ce00-111">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="2ce00-112">Beispiele</span><span class="sxs-lookup"><span data-stu-id="2ce00-112">EXAMPLES</span></span>

### <span data-ttu-id="2ce00-113">Beispiel 1</span><span class="sxs-lookup"><span data-stu-id="2ce00-113">Example 1</span></span>
```powershell
...
<span data-ttu-id="2ce00-114">Ruft alle Sicherheitswarnungen ab, die für Ressourcen innerhalb eines Abonnements erkannt wurden.</span><span class="sxs-lookup"><span data-stu-id="2ce00-114">Gets all the security alerts that were detected on resources inside a subscription</span></span>

### <span data-ttu-id="2ce00-115">Beispiel 2</span><span class="sxs-lookup"><span data-stu-id="2ce00-115">Example 2</span></span>
```powershell
...
<span data-ttu-id="2ce00-116">Ruft alle Sicherheitswarnungen ab, die für Ressourcen innerhalb der Ressourcengruppe "myService1" erkannt wurden.</span><span class="sxs-lookup"><span data-stu-id="2ce00-116">Gets all the security alerts that were detected on resources inside the "myService1" resource group</span></span>

### <span data-ttu-id="2ce00-117">Beispiel 3</span><span class="sxs-lookup"><span data-stu-id="2ce00-117">Example 3</span></span>
```powershell
...
<span data-ttu-id="2ce00-118">Ruft eine bestimmte Sicherheitswarnung ab, die für Ressourcen innerhalb der Ressourcengruppe "myService1" erkannt wurde.</span><span class="sxs-lookup"><span data-stu-id="2ce00-118">Gets a specific security alert that were detected on resources inside the "myService1" resource group</span></span>

## <span data-ttu-id="2ce00-119">Parameter</span><span class="sxs-lookup"><span data-stu-id="2ce00-119">PARAMETERS</span></span>

### <span data-ttu-id="2ce00-120">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="2ce00-120">-DefaultProfile</span></span>
<span data-ttu-id="2ce00-121">Die für die Kommunikation mit Azure verwendeten Anmeldeinformationen, das Konto, den Mandanten und das Abonnement.</span><span class="sxs-lookup"><span data-stu-id="2ce00-121">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="2ce00-122">-Standort</span><span class="sxs-lookup"><span data-stu-id="2ce00-122">-Location</span></span>
<span data-ttu-id="2ce00-123">Lage.</span><span class="sxs-lookup"><span data-stu-id="2ce00-123">Location.</span></span>
...
### <span data-ttu-id="2ce00-124">-Name</span><span class="sxs-lookup"><span data-stu-id="2ce00-124">-Name</span></span>
<span data-ttu-id="2ce00-125">Ressourcenname</span><span class="sxs-lookup"><span data-stu-id="2ce00-125">Resource name.</span></span>
...
### <span data-ttu-id="2ce00-126">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="2ce00-126">-ResourceGroupName</span></span>
<span data-ttu-id="2ce00-127">Name der Ressourcengruppe.</span><span class="sxs-lookup"><span data-stu-id="2ce00-127">Resource group name.</span></span>
...
### <span data-ttu-id="2ce00-128">-Resourcen-Nr</span><span class="sxs-lookup"><span data-stu-id="2ce00-128">-ResourceId</span></span>
<span data-ttu-id="2ce00-129">Ressourcen-ID.</span><span class="sxs-lookup"><span data-stu-id="2ce00-129">Resource ID.</span></span>
...
### <span data-ttu-id="2ce00-130">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="2ce00-130">CommonParameters</span></span>
<span data-ttu-id="2ce00-131">Dieses Cmdlet unterstützt die allgemeinen Parameter:-Debug,-Fehler Aktion,-ErrorVariable,-InformationVariable,-Variable,-Puffer,-PipelineVariable,-Verbose,-Warning-Aktion und-WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="2ce00-131">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="2ce00-132">Weitere Informationen finden Sie unter about_CommonParameters ( https://go.microsoft.com/fwlink/?LinkID=113216) .</span><span class="sxs-lookup"><span data-stu-id="2ce00-132">For more information, see about_CommonParameters (https://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="2ce00-133">Eingaben</span><span class="sxs-lookup"><span data-stu-id="2ce00-133">INPUTS</span></span>

### <span data-ttu-id="2ce00-134">System. String</span><span class="sxs-lookup"><span data-stu-id="2ce00-134">System.String</span></span>

## <span data-ttu-id="2ce00-135">Ausgaben</span><span class="sxs-lookup"><span data-stu-id="2ce00-135">OUTPUTS</span></span>

### <span data-ttu-id="2ce00-136">Microsoft. Azure. Commands. Security. Models. alerts. PSSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="2ce00-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span></span>

## <span data-ttu-id="2ce00-137">Notizen</span><span class="sxs-lookup"><span data-stu-id="2ce00-137">NOTES</span></span>

## <span data-ttu-id="2ce00-138">Verwandte Links</span><span class="sxs-lookup"><span data-stu-id="2ce00-138">RELATED LINKS</span></span>
