...
## Beschreibung
Mit dem Cmdlet **Get-AzAutomationDscNodeConfigurationDeployment** wird eine APS-Knoten Konfiguration (Desired State Configuration, DSC) in Azure Automation bereitgestellt.

## Beispiele

### Beispiel 1: Abrufen aller Bereitstellungs Zeitpläne
```
...
### Beispiel 2: Abrufen eines Bereitstellungszeitplans
```
...
### -JobScheduleId
Gibt die ID des Auftragszeitplans für einen vorhandenen geplanten Bereitstellungsauftrag an.
