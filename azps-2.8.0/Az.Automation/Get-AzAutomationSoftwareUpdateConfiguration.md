...
## Beschreibung
Die Get-AzAutomationSoftwareUpdateConfiguration gibt eine Liste der Software Update Konfigurationen zurück. Um eine bestimmte Software Update Konfiguration zu erhalten, geben Sie den Parameter Name an. Sie können auch Software Update Konfigurationen auflisten, die auf bestimmte Azure Virtual Machine ausgerichtet sind, indem Sie die Azure-Ressourcen-ID für diesen virtuellen Computer angeben.

## Beispiele

### Beispiel 1
Erhalten Sie eine Azure Automation-Software Update Konfiguration nach Namen.
...
### -Name
Der Name der Software Update Konfiguration.
