...
## Beschreibung
**Das Cmdlet New-AzApplicationGatewayRewriteRule** erstellt eine Rewrite-Regel für ein Azure Application-Gateway.

## Beispiele

### Beispiel 1: Erstellen einer Rewrite-Regel für ein Anwendungsgateway
```powershell
PS C:\> $rule = New-AzApplicationGatewayRewriteRule -Name rule1 -ActionSet $action -RuleSequence 101 -Condition $condition
```

Dieser Befehl erstellt eine Rewrite-Regel mit dem Namen rule1 und speichert das Ergebnis in der Variablen mit dem Namen $Rule.

## Parameter

### -Actionset
Aktionsset der Regel zum Umschreiben
...
### -Bedingung
Bedingung für die Ausführung der umschreibungs Regel
...
### -RuleSequence
Die Regelreihenfolge dieser umschreibungs Regel in der Regelgruppe "neu schreiben"
