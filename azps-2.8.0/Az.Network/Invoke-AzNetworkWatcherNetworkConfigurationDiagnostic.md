...
## Beschreibung
Das Invoke-AzNetworkWatcherNetworkConfigurationDiagnostic-Cmdlet ruft die Netzwerk Konfigurationsdiagnose Sitzung für angegebene Netzwerkprofile auf der Zielressource auf.
...
### -Profil
Liste der Diagnose Profile für die Netzwerkkonfiguration.
...
### -TargetResourceId
Die ID der Zielressource, um die Netzwerk Konfigurationsdiagnose durchzuführen.
Gültige Optionen sind VM, Network Interface, VMSS/Network Interface und Application Gateway.
...
Akzeptierte Werte sind "Normal", "Mindestwert", "voll".
