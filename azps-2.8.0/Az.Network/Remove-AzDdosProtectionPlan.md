...
Anschließend wird der neue Zustand beibehalten, indem die lokale Variable in **AzVirtualNetwork**. An diesem Punkt ist der Plan nicht mehr dem virtuellen Netzwerk zugeordnet.
Wenn dies der letzte mit dem Plan verknüpfte ist, können wir den DDoS-Schutzplan mithilfe des Befehls Remove-AzDdosProtectionPlan entfernen.
