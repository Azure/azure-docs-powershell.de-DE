...
## Beschreibung
Das Cmdlet " **Get-AzNetAppFilesSnapshot** " ruft Details zu einem ANF-Snapshot ab.

## Beispiele

### Beispiel 1: Abrufen eines ANF-Snapshots
```
...
Dieser Befehl ruft den Snapshot mit dem Namen MyAnfSnapshot aus dem Volume "MyAnfVolume" ab.
...
### -Volumeobject
Das Volume-Objekt, das den zurückzugebenden Snapshot enthält
