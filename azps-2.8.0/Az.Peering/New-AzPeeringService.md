...
Erstellt ein Peering-Dienstobjekt mit dem Anbieter und dem Peering-Speicherort. Verwendung in Verbindung mit `Get-AzPeeringServiceProvider` und `Get-AzPeeringServiceLocation`
...
### -PeeringLocation
Der physikalische Standort, der sich vom Azure-Bereich unterscheidet. Verwenden von Get-AzPeeringServiceLocation [-Country <country> ]
...
Der Name des Peering-Dienstanbieters.
Verwenden des Get-AzPeeringServiceProvider-Cmdlets für eine Liste
...
### -Tag
Die Tags, die dem Microsoft Inputobject-Dienst zugeordnet werden sollen.
