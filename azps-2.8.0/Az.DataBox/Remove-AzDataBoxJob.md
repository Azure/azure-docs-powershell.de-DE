...
## Beschreibung
Das Cmdlet **Remove-AzDataBoxJob** wird verwendet, um einen fertigen DataBox-Auftrag aus der Liste der DataBox-Aufträge zu löschen.
...
Löscht den angegebenen DataBox-Auftrag
...
Löschen des angegebenen DataBox-Auftrags ohne Bestätigung
...
### -Force
Entfernen ohne Bestätigung erzwingen
