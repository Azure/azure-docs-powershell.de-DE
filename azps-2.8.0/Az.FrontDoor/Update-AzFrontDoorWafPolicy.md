...
## Beschreibung
Das Cmdlet **Update-AzFrontDoorWafPolicy** aktualisiert eine vorhandene WAF-Richtlinie. Wenn keine Eingabeparameter bereitgestellt werden, werden alte Parameter aus der vorhandenen WAF-Richtlinie verwendet.
...
Aktualisieren eines vorhandenen benutzerdefinierten WAF-Richtlinien Codes
...
Aktualisieren eines vorhandenen WAF-Richtlinienmodus
...
Aktualisieren einer vorhandenen WAF-Richtlinie mit aktiviertem Status und Modus.
...
[Neu – AzFrontDoorWafPolicy](./New-AzFrontDoorWafPolicy.md) 
 ...
 [Neu – AzFrontDoorWafCustomRuleObject](./New-AzFrontDoorWafManagedRuleObject.md)
