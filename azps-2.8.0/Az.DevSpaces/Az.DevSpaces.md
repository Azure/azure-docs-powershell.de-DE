...
# AZ. Module
## Beschreibung
Befehle für die Interaktion mit Azure-Unterdomänen-Controller.

## AZ.,-Cmdlets
### [Get-AzDevSpacesController](Get-AzDevSpacesController.md)
Abrufen oder Auflisten des Azure-Domänencontrollers

### [Neu – AzDevSpacesController](New-AzDevSpacesController.md)
Erstellen Sie einen neuen Azure-Bereiche-Controller.

### [Remove-AzDevSpacesController](Remove-AzDevSpacesController.md)
Löschen Sie einen "ein"-Controller.
