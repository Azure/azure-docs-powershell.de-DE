...
ms.locfileid: "94004891"
---
# <span data-ttu-id="50554-101">Get-AzSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="50554-101">Get-AzSecurityAlert</span></span>

## <span data-ttu-id="50554-102">Synopsis</span><span class="sxs-lookup"><span data-stu-id="50554-102">SYNOPSIS</span></span>
<span data-ttu-id="50554-103">Ruft Sicherheitswarnungen ab, die vom Azure Security Center erkannt wurden.</span><span class="sxs-lookup"><span data-stu-id="50554-103">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="50554-104">Syntax</span><span class="sxs-lookup"><span data-stu-id="50554-104">SYNTAX</span></span>

### <span data-ttu-id="50554-105">SubscriptionScope (Standard)</span><span class="sxs-lookup"><span data-stu-id="50554-105">SubscriptionScope (Default)</span></span>
```
Get-AzSecurityAlert [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="50554-106">ResourceGroupScope</span><span class="sxs-lookup"><span data-stu-id="50554-106">ResourceGroupScope</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="50554-107">ResourceGroupLevelResource</span><span class="sxs-lookup"><span data-stu-id="50554-107">ResourceGroupLevelResource</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> -Name <String> -Location <String>
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="50554-108">SubscriptionLevelResource</span><span class="sxs-lookup"><span data-stu-id="50554-108">SubscriptionLevelResource</span></span>
```
Get-AzSecurityAlert -Name <String> -Location <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### <span data-ttu-id="50554-109">ResourceId</span><span class="sxs-lookup"><span data-stu-id="50554-109">ResourceId</span></span>
```
Get-AzSecurityAlert -ResourceId <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

## <span data-ttu-id="50554-110">Beschreibung</span><span class="sxs-lookup"><span data-stu-id="50554-110">DESCRIPTION</span></span>
<span data-ttu-id="50554-111">Ruft Sicherheitswarnungen ab, die vom Azure Security Center erkannt wurden.</span><span class="sxs-lookup"><span data-stu-id="50554-111">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="50554-112">Beispiele</span><span class="sxs-lookup"><span data-stu-id="50554-112">EXAMPLES</span></span>

### <span data-ttu-id="50554-113">Beispiel 1</span><span class="sxs-lookup"><span data-stu-id="50554-113">Example 1</span></span>
```powershell
...
<span data-ttu-id="50554-114">Ruft alle Sicherheitswarnungen ab, die für Ressourcen innerhalb eines Abonnements erkannt wurden.</span><span class="sxs-lookup"><span data-stu-id="50554-114">Gets all the security alerts that were detected on resources inside a subscription</span></span>

### <span data-ttu-id="50554-115">Beispiel 2</span><span class="sxs-lookup"><span data-stu-id="50554-115">Example 2</span></span>
```powershell
...
<span data-ttu-id="50554-116">Ruft alle Sicherheitswarnungen ab, die für Ressourcen innerhalb der Ressourcengruppe "myService1" erkannt wurden.</span><span class="sxs-lookup"><span data-stu-id="50554-116">Gets all the security alerts that were detected on resources inside the "myService1" resource group</span></span>

### <span data-ttu-id="50554-117">Beispiel 3</span><span class="sxs-lookup"><span data-stu-id="50554-117">Example 3</span></span>
```powershell
...
<span data-ttu-id="50554-118">Ruft eine bestimmte Sicherheitswarnung ab, die für Ressourcen innerhalb der Ressourcengruppe "myService1" erkannt wurde.</span><span class="sxs-lookup"><span data-stu-id="50554-118">Gets a specific security alert that were detected on resources inside the "myService1" resource group</span></span>

## <span data-ttu-id="50554-119">Parameter</span><span class="sxs-lookup"><span data-stu-id="50554-119">PARAMETERS</span></span>

### <span data-ttu-id="50554-120">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="50554-120">-DefaultProfile</span></span>
<span data-ttu-id="50554-121">Die für die Kommunikation mit Azure verwendeten Anmeldeinformationen, das Konto, den Mandanten und das Abonnement.</span><span class="sxs-lookup"><span data-stu-id="50554-121">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="50554-122">-Standort</span><span class="sxs-lookup"><span data-stu-id="50554-122">-Location</span></span>
<span data-ttu-id="50554-123">Lage.</span><span class="sxs-lookup"><span data-stu-id="50554-123">Location.</span></span>
...
### <span data-ttu-id="50554-124">-Name</span><span class="sxs-lookup"><span data-stu-id="50554-124">-Name</span></span>
<span data-ttu-id="50554-125">Ressourcenname</span><span class="sxs-lookup"><span data-stu-id="50554-125">Resource name.</span></span>
...
### <span data-ttu-id="50554-126">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="50554-126">-ResourceGroupName</span></span>
<span data-ttu-id="50554-127">Name der Ressourcengruppe.</span><span class="sxs-lookup"><span data-stu-id="50554-127">Resource group name.</span></span>
...
### <span data-ttu-id="50554-128">-Resourcen-Nr</span><span class="sxs-lookup"><span data-stu-id="50554-128">-ResourceId</span></span>
<span data-ttu-id="50554-129">Ressourcen-ID.</span><span class="sxs-lookup"><span data-stu-id="50554-129">Resource ID.</span></span>
...
### <span data-ttu-id="50554-130">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="50554-130">CommonParameters</span></span>
<span data-ttu-id="50554-131">Dieses Cmdlet unterstützt die allgemeinen Parameter:-Debug,-Fehler Aktion,-ErrorVariable,-InformationVariable,-Variable,-Puffer,-PipelineVariable,-Verbose,-Warning-Aktion und-WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="50554-131">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="50554-132">Weitere Informationen finden Sie unter about_CommonParameters ( http://go.microsoft.com/fwlink/?LinkID=113216) .</span><span class="sxs-lookup"><span data-stu-id="50554-132">For more information, see about_CommonParameters (http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="50554-133">Eingaben</span><span class="sxs-lookup"><span data-stu-id="50554-133">INPUTS</span></span>

### <span data-ttu-id="50554-134">System. String</span><span class="sxs-lookup"><span data-stu-id="50554-134">System.String</span></span>

## <span data-ttu-id="50554-135">Ausgaben</span><span class="sxs-lookup"><span data-stu-id="50554-135">OUTPUTS</span></span>

### <span data-ttu-id="50554-136">Microsoft. Azure. Commands. Security. Models. alerts. PSSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="50554-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span></span>

## <span data-ttu-id="50554-137">Notizen</span><span class="sxs-lookup"><span data-stu-id="50554-137">NOTES</span></span>

## <span data-ttu-id="50554-138">Verwandte Links</span><span class="sxs-lookup"><span data-stu-id="50554-138">RELATED LINKS</span></span>
