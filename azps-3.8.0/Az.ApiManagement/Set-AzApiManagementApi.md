...
In diesem Beispiel wird eine API zu einem vorhandenen API-Versions Satz hinzugefügt.

### Beispiel 3 Ändern des Back-End-serviceUrl, auf das die API zeigt
```powershell
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
In diesem Beispiel wird das serviceUrl aktualisiert `echo-api` , auf das verwiesen wird.
