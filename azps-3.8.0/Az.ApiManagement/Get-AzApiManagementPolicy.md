...
## Beschreibung
Das Cmdlet " **Get-AzApiManagementPolicy** " Ruft die angegebene Bereichs Richtlinie ab.
...
### Beispiel 5: Abrufen der Mandanten Bereichs Richtlinie im RawXml-Format
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
Dieser Befehl ruft die Richtlinie für den MANDANTENBEREICH im nicht-XML-Escapezeichen-Format ab.
...
### -ApiRevision
Bezeichner der API-Überarbeitung. Dieser Parameter ist optional. Wenn Sie nicht angegeben wird, wird die Richtlinie aus der aktuell aktiven API-Revision abgerufen.
