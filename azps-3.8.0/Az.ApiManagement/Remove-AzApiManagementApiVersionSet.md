...
Das Cmdlet **Remove-AzAzureRmApiManagementApiVersionSet** entfernt eine vorhandene API-Versionsgruppe.

## Beispiele

### Beispiel 1: Entfernen einer API-Versionsgruppe
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Remove-AzApiManagementApiVersionSet -Context $apimContext -ApiVersionSetId "query-param-set"
```

Dieser Befehl entfernt die API-Versionsgruppe mit dem angegebenen ApiVersionSetId.

## Parameter

### -ApiVersionSetId
Bezeichner der API-Versionsgruppe.
...
### -Resourcen-Nr
Arm-ApiVersionSet. Dieser Parameter ist erforderlich.
