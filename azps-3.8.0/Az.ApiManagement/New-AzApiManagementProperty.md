...
## Beschreibung
Das Cmdlet **New-AzApiManagementProperty** erstellt eine Azure API-Verwaltungs **Eigenschaft**.
...
### -Tag
Tags, die mit der Eigenschaft verknüpft werden sollen. Dieser Parameter ist optional.
