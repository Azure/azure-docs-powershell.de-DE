...
## Beschreibung
Das Cmdlet **Remove-AzApiManagementDiagnostic** entfernt die diagnostische Entität, die vom `DiagnosticId` globalen Bereich oder einem Bereich angegeben wird. `ApiId`

## Beispiele

### Beispiel 1: Entfernen der Diagnose Entität
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Remove-AzApiManagementDiagnostic -Context $apimContext -DiagnosticId "applicationinsights"
```

In diesem Beispiel wird die Diagnose des `applicationinsights` API-Verwaltungsdiensts entfernt.
...
### -Resourcen-Nr
Arm-Resourcen-Diagnose. Dieser Parameter ist erforderlich.
