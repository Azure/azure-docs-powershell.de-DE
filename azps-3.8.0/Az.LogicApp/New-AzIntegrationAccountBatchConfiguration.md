...
## Beschreibung
Das Cmdlet " **Get-AzIntegrationAccountBatchConfiguration** " erstellt eine neue batchkonfiguration in einem Integrations Konto.
...
Erstellt eine neue batchkonfiguration unter Verwendung der lokalen Datei, die sich im Dateipfad befindet, der in "$batchConfigurationFilePath" enthalten ist.
