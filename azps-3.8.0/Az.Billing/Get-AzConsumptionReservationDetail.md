...
## Beschreibung
Das Cmdlet " **Get-AzConsumptionReservationDetail** " ruft Reservierungsdetails für den bereitgestellten Datumsbereich ab.

## Beispiele

### Beispiel 1: Abrufen von Reservierungsdetails mit der Reservierungs Auftrags-ID für den bereitgestellten Datumsbereich
```powershell
...
### Beispiel 2: Abrufen von Reservierungsdetails mit der Reservierungs Auftrags-ID und der Reservierungs-ID für den bereitgestellten Datumsbereich
```powershell
...
### -Enddate
Die Enddaten (yyyy-mm-tt in UTC) des Reservierungsdetails.
...
### -StartDate
Die Startdaten (yyyy-mm-tt in UTC) des Reservierungsdetails.
...
### Microsoft. Azure. Commands. Verbrauch. Models. PSReservationDetail
