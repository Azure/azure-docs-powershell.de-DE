...
## Beschreibung
Das Cmdlet " **Get-AzConsumptionReservationSummary** " erhält Reservierungs Zusammenfassungen für das tägliche oder monatliche Korn.

## Beispiele

### Beispiel 1: Abrufen von Reservierungs Zusammenfassungen mit der Reservierungs Auftrags-ID für monatliches Getreide
```powershell
...
### Beispiel 2: Abrufen von Reservierungs Zusammenfassungen mit der Reservierungs Auftrags-ID und der Reservierungs-ID für monatliches Getreide
```powershell
...
### Beispiel 3: Abrufen von Reservierungs Zusammenfassungen mit der Reservierungs Auftrags-ID für das tägliche Korn, vorausgesetzt, Datumsbereich
```powershell
...
### Beispiel 4: Abrufen von Reservierungs Zusammenfassungen mit der Reservierungs Auftrags-ID und der Reservierungs-ID für das tägliche Getreide bereitgestellte Datumsbereich
```powershell
...
### -Enddate
Die Enddaten (yyyy-mm-tt in UTC) der Reservierungs Zusammenfassung, die nur für das tägliche Korn erforderlich sind.
...
### -Grain
Das Zeit Korn der Reservierungs Zusammenfassung kann täglich oder monatlich sein.
...
### -Reservierungs-Nr.
Der Bezeichner einer Reservierung innerhalb einer Reservierungs Reihenfolge.
...
### -ReservationOrderId
Der Bezeichner eines Reservierungs Kaufs.
...
### -StartDate
Die Startdaten (yyyy-mm-tt in UTC) der Reservierungs Zusammenfassung, die nur für das tägliche Korn erforderlich sind.
...
### Microsoft. Azure. Commands. Verbrauch. Models. PSReservationSummary
