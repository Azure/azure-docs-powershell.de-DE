...
## Beschreibung
Erstellen Sie ein neues Artefakt. Es gibt zwei Möglichkeiten zum Erstellen eines Artefakts: entweder über ein Artefakt JSON als Eingabedatei oder durch die Bereitstellung von Inline Parametern für das Artefakt. Während die JSON-Methode den Typ des zu bereitzustellenden Artefakts nicht erfordert, erfordert die Inline Parameter-Methode, dass der Benutzer den Typ des durch-type-Parameters des Artefakts bereitstellt.
...
Erstellen Sie ein neues Artefakt über eine JSON-artefaktdatei.
...
Erstellen Sie ein neues Artefakt über Inline Parameter.
...
Erstellen Sie ein neues Artefakt über eine Arm-Vorlagendatei.

## Parameter

### -Artefaktdatei
Der Speicherort der artefaktdatei im JSON-Format auf dem Datenträger.
...
Hashtable mit Parametern, die an das Richtlinien Definitions Artefakt übergeben werden sollen.
...
### -ResourceGroupName
Der Name der Ressourcengruppe, unter der das Artefakt sein wird.
...
Liste der Prinzipal-IDs für Rollendefinitionen.
...
### -Vorlagendatei
Der Speicherort der Arm-Vorlagendatei auf dem Datenträger.
...
Der Speicherort der Parameterdatei für Arm-Vorlagen auf dem Datenträger.
...
### -Typ
Der Typ des Artefakts.
Es gibt 3 Unterstützte Typen: RoleAssignmentArtifact, PolicyAssignmentArtifact, TemplateArtifact.
...
### Microsoft. Azure. Management. Blueprint. Models. Artefakt
