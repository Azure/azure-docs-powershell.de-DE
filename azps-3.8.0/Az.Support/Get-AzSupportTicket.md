...
### Beispiel 3: Abrufen der ersten 2 Support Tickets nach Status gefiltert
```powershell
...
### Beispiel 3: Abrufen aller Support Tickets, die sich im geöffneten Zustand befinden und nach dem 20. Dezember 2019 erstellt wurden
```powershell
