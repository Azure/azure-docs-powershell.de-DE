...
## Beschreibung
Das Cmdlet **Start-AzDataFactoryV2IntegrationRuntime** startet eine verwaltete dedizierte Integrationslaufzeit. Die Ressource wird bereitgestellt, und nach dem Vorgang wird der Zustand "gestartet".

## Beispiele

### Beispiel 1: Starten einer Integrationslaufzeit
```
...
Mit diesem Cmdlet wird eine verwaltete dedizierte Integrationslaufzeit mit dem Namen "Test-dediziert-IR" gestartet.
