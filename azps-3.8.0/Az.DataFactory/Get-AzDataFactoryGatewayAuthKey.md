...
## Beschreibung
Das Cmdlet " **Get-AzDataFactoryGatewayAuthKey** " Ruft den Gateway-Authentifizierungsschlüssel für ein angegebenes Azure Data Factory-Gateway ab.
Sie registrieren das Gateway mit einem clouddienst, indem Sie diesen key1 oder key2 dieses auth-Schlüssels verwenden.

## Beispiele

### Beispiel 1: Ruft den auth-Schlüssel eines Gateways ab
```
...
Dieser Befehl ruft den Gateway-Authentifizierungsschlüssel für das Data Factory-Gateway mit dem Namen mygateway ab.
