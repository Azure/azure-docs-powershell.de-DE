...
## Beschreibung
Mit dem Cmdlet **Get-AzRecoveryServicesBackupProtectableItem werden** die geschützten Elemente in einem Container oder ein Wert in Azure Backup und der Schutzstatus der Elemente abgerufen.
...
Der erste Befehl ruft den Container des Typs MSSQL ab und speichert ihn dann in der $Container-Variablen.
Der zweite Befehl ruft das Sicherungselement in $Container ab und speichert es dann in der $Item Variablen.
...
### -Name
Gibt den Namen der Datenbank, der Instanz oder der Verfügbarkeits Kategorie an.
...
Die Arm-ID einer Instanz oder AG angegeben.
