...
Entfernt die Ereignis Raster Domäne Topic \` THEMA1 hat \` Unterdomänen \` domain1 \` in der Ressourcengruppe \` MyResourceGroupName \` .
...
### -Resourcen-Nr
Ressourcenbezeichner, der das Thema der Ereignis Raster Domäne darstellt.
