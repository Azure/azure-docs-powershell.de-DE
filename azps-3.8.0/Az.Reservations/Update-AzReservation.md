...
## Beschreibung
Aktualisiert die angewendeten Bereiche von `Reservation` .
...
Aktualisiert die AppliedScopeType des angegebenen `Reservation` in Single und InstanceFlexibility auf ein.
...
Aktualisiert die AppliedScopeType des angegebenen `Reservation` freigegebenen und InstanceFlexibility auf aus.

## Parameter

### -AppliedScope
Abonnement-Nr für diese `Reservation` Anwendung
...
### -InstanceFlexibility
Wenn vorhanden, wird der InstanceFlexibility-Wert der `Reservation` . Wenn nicht angegeben, bleibt der vorhandene Wert unverändert.
...
### -Reservierungs-Nr.
Die ID des `Reservation` zu aktualisierendes
...
### -ReservationOrderId
Die ID des `ReservationOrder` zu aktualisierendes
