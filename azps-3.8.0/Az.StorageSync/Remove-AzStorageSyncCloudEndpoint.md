...
## Beschreibung
Mit diesem Befehl wird der angegebene Cloud-Endpunkt aus einer Synchronisierungsgruppe gelöscht. Die Azure-Dateifreigabe die Verweise auf den cloudbasierten Endpunkt bleiben durch diesen Prozess unberührt. Dieser Befehl ist nur für die Außerbetriebnahme vorgesehen. Das Entfernen eines Cloud-Endpunkts ist ein zerstörerischer Vorgang. Server Endpunkte können nicht synchronisiert werden, ohne dass mindestens ein Cloud-Endpunkt vorhanden ist. Dieser Vorgang sollte nicht zum Beheben von Synchronisierungsproblemen ausgeführt werden. Wenn diese Azure-Dateifreigabe erneut zur gleichen Synchronisierungsgruppe wie ein Cloud-Endpunkt hinzugefügt wird, kann dies zu Konfliktdateien und anderen unbeabsichtigten Folgen führen.
...
Mit diesem Befehl wird der Cloud-Endpunkt entfernt.
...
### -Inputobject
CloudEndpoint-Eingabeobjekt, das normalerweise durch die Pipeline übergeben wird.
