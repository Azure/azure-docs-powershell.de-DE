...
## Beschreibung
Das Cmdlet **Remove-AzDataLakeStoreItemAclEntry** entfernt einen Eintrag (ACE) aus der Zugriffssteuerungsliste (ACL) einer Datei oder eines Ordners im Data Lake Store.
...
Dieser Befehl entfernt das Benutzer-Ass für Patti Fuller aus dem ContosoADL-Konto.
...
### Beispiel 3: Entfernen von Berechtigungen für ein Ass rekursiv mithilfe des ACL-Objekts
```
...
Dieser Befehl entfernt das Benutzer-Ass für Patti Fuller aus dem Stammverzeichnis und rekursiv aus allen Unterverzeichnissen und Dateien für das Konto ContosoADL.
...
### -ACL
Gibt das ACL-Objekt an, das die zu entfernende Einträge enthält.
...
### -Parallelität
Die Anzahl von Dateien/Verzeichnissen, die parallel verarbeitet werden. Optional: ein angemessener Standardwert wird ausgewählt.
...
### – Standard
Gibt an, dass dieser Vorgang das Standard-Ass aus der angegebenen ACL entfernt.
...
### -ID
Gibt die Objekt-ID des AzureActive-Verzeichnis Benutzers, der Gruppe oder des Dienst Prinzipals an, für den ein ACE entfernt werden soll.
...
### -Path
Gibt den Daten See-Speicherpfad des Elements an, aus dem ein ACE entfernt werden soll, beginnend mit dem Stammverzeichnis (/).
...
### -Progress
Wenn übergeben, wird der Status Status angezeigt. Gilt nur, wenn die rekursive ACL-Entfernung abgeschlossen ist.
