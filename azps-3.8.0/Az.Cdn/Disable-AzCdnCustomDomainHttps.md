...
## Beschreibung
Das Cmdlet **Disable-AzCdnCustomDomainHttps** deaktiviert die gesicherte HTTPS-Zustellung einer benutzerdefinierten CDN-Domäne.
...
Deaktivieren Sie die sichere Zustellung der benutzerdefinierten Domäne.

## Parameter

### -CustomDomainName
Benutzerdefinierter Azure CDN-Domänen Anzeigename
...
### -PassThru
Gibt das Objekt zurück, wenn angegeben.
...
### -Resourcen-Nr
Resourcen-Nr der benutzerdefinierten Domäne
