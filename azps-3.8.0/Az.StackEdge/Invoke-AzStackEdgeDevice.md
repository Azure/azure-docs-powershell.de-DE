...
## Beschreibung
Das Cmdlet **Invoke-AzStackEdgeDevice** ruft Aktionen auf, um die Updates auf dem Stack-Edge-Gerät zu überprüfen, herunterzuladen und zu installieren. Eine automatische Überprüfung wird täglich auf dem Gerät ausgeführt, und Sie können den Scan explizit auslösen, indem Sie dieses Cmdlet ausführen.
...
### -FetchUpdate
Herunterladen der Updates auf einem Stack Edge/Gateway-Gerät
...
### -InstallUpdate
Installiert die Updates auf dem Stack Edge/Gateway-Gerät
...
### -ScanForUpdate
Sucht nach Updates auf einem Stack Edge/Gateway-Gerät.
