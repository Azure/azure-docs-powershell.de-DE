...
## Beschreibung
Das Cmdlet **New-AzStackEdgeUser** erstellt einen neuen Benutzer für das Stack-Edge-Gerät. Die Erstellung von nur Benutzertypen `Share` wird unterstützt.
...
### -Kennwort
Kennwort, als sichere Zeichenfolge bereitstellen
