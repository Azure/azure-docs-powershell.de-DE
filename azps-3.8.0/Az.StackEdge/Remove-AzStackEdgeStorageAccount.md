...
## Beschreibung
Das Cmdlet **Remove-AzStackEdgeStorageAccount** entfernt ein zugeordnetes Edge-Speicherkonto für ein Stack-Edge-Gerät. Sie können den Namen des Edge-speicherkontos angeben, das als Parameter im Cmdlet entfernt werden soll.
