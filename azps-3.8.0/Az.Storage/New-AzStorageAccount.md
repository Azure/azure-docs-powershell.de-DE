...
### Beispiel 8: Erstellen eines speicherkontos mit Warteschlangen-und tabellendienst verwenden Sie den Konto bezogenen Verschlüsselungsschlüssel.
```
...
Mit diesem Befehl wird ein Speicherkonto mit Warteschlange und tabellendienst erstellt. verwenden Sie den Konto bezogenen Verschlüsselungsschlüssel, damit Warteschlange und Tabelle denselben Verschlüsselungsschlüssel mit BLOB-und Dateidienst verwenden. Rufen Sie dann die Eigenschaften des speicherkontos ab, und zeigen Sie den Verschlüsselungs-KeyType der Warteschlange und des Tabellen Diensts an.
