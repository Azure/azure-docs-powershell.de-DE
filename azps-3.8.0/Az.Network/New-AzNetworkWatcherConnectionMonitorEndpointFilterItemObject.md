...
## Beschreibung
Das New-AzNetworkWatcherConnectionMonitorEndpointFilterItemObject-Cmdlet erstellt Endpunkt Filterelement.
...
Geben Sie Folgendes ein: AgentAddress AbschnittFür-Adresse: 10.0.0.1

## Parameter

### -Adresse
Die Adresse des Filterelements.
...
### -Typ
Der Typ des Elements, das im Filter enthalten ist. Derzeit wird nur "AgentAddress AbschnittFür" unterstützt.
