...
Nachdem die Website erstellt wurde, wird Sie mit dem Befehl Remove-AzVpnSite sofort entfernt.
...
Identisch mit Beispiel 1, aber hier erfolgt die Entfernung mithilfe der geleiteten Ausgabe von Get-AzVpnSite.
...
### -Inputobject
Das vpnSite-Objekt, das gelöscht werden soll.
...
### -Resourcen-Nr
Die Azure-Ressourcen-ID für die vpnSite, die gelöscht werden soll.
