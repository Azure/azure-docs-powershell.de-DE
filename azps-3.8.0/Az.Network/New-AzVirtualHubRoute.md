...
Das obige wird ein virtuelles Hub-Routing-Objekt erstellen, das in die virtuelle Hub-Route-Tabelle aufgenommen werden kann.

Die virtuelle Hub-Route ist ein in-Memory-Objekt, das zum Erstellen eines VirtualHubRouteTable-Objekts verwendet werden kann.

## Parameter

### -AddressPrefix
Liste der Adresspräfixe
...
### -NextHopIpAddress
Die IPAddress für den nächsten Hop.
