...
## Beschreibung
Das Cmdlet " **Satz-AzPrivateLinkService** " aktualisiert einen Dienst für private Links.

## Beispiele

### 1: erstellt einen privaten Link Dienst und aktualisiert dessen
```
...
In diesem Beispiel wird ein privater Link Dienst namens mypls erstellt. Anschließend wird die ipConfigurations-Datei vom speicherresidenten ipConfiguratiuon-Objekt ersetzt. Das Set-AzPrivateLinkService-Cmdlet wird dann verwendet, um den geänderten Dienstzustand des privaten Verbindungs Diensts auf der Dienstseite zu schreiben. 
...
### -PrivateLinkService
Gibt ein privates Link Dienstobjekt an, das den Zustand darstellt, in dem der private Link Dienst festgelegt werden soll.
