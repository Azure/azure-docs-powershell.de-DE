...
### 1: Abrufen eines privaten Endpunkts
```
...
Dieser Befehl ruft den privaten Endpunkt mit dem Namen MyPrivateEndpoint1 in der Ressourcengruppe ab TestResourceGroup

### 2: Auflisten aller privaten Endpunkte in der ResourceGroup
```
...
Dieser Befehl ruft alle privaten Endpunkte in der Ressourcengruppe TestResourceGroup
