...
## Beschreibung
Das Cmdlet " **Get-AzNetworkSecurityGroup** " Ruft eine Azure Network Security-Gruppe ab.

## Beispiele

### 1: Abrufen einer vorhandenen Netzwerksicherheitsgruppe
```
...
Dieser Befehl gibt den Inhalt der Azure Network Security-Gruppe "nsg1" in der Ressourcengruppe "RG1" zurück.

### 2: Auflisten vorhandener Netzwerk Sicherheitsgruppen mithilfe von Filtern
```
...
Dieser Befehl gibt Inhalte von Azure Network Security-Gruppen zurück, die mit "NSG" beginnen.
