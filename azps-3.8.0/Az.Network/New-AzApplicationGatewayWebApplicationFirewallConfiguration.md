...
## Beschreibung
Das Cmdlet **New-AzApplicationGatewayWebApplicationFirewallConfiguration** erstellt eine WAF-Konfiguration (Web Application Firewall) für ein Azure Application-Gateway.
...
### -FileUploadLimitInMb
Maximale Dateiupload-Grenze in MB.
...
### -RequestBodyCheck
Ob der Anforderungstext aktiviert ist oder nicht.
