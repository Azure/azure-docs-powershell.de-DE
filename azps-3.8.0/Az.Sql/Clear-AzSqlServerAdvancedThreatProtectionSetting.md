...
## Beschreibung
Das Clear-AzSqlServerAdvancedThreatProtectionSetting-Cmdlet entfernt die erweiterten Einstellungen für den Bedrohungsschutz von einem Azure SQL Server.
Um dieses Cmdlet zu verwenden, geben Sie die Parameter ResourceGroupName und Servername an, um den Server zu identifizieren, auf dem dieses Cmdlet die Einstellungen entfernt.
...
Mit diesem Befehl werden die erweiterten Bedrohungsschutz Einstellungen von einem Server namens "Server01" entfernt.
