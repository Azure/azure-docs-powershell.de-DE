...
## Beschreibung
Das Cmdlet " **Satz-AzSqlDatabaseAudit** " ändert die Überwachungseinstellungen einer Azure SQL-Datenbank.
...
### Beispiel 3,1: Aktivieren der BLOB-Speicher Überwachungsrichtlinie einer Azure SQL-Datenbank mit erweiterter Filterung mithilfe eines T-SQL-Prädikats
```
...
### Beispiel 3,2: Entfernen der erweiterten Filtereinstellung aus der Überwachungsrichtlinie einer Azure SQL-Datenbank
```
...
### Beispiel 4: Aktivieren der Ereignis-Hub-Überwachungsrichtlinie einer Azure SQL-Datenbank
```
...
### Beispiel 5: Deaktivieren der Ereignis-Hub-Überwachungsrichtlinie einer Azure SQL-Datenbank
```
...
### Beispiel 6: Aktivieren der Überwachungsrichtlinie für die Protokollanalyse einer Azure SQL-Datenbank
```
...
### Beispiel 7: Deaktivieren der Überwachungsrichtlinie für die Protokollanalyse einer Azure SQL-Datenbank
```
...
### Beispiel 8: Deaktivieren Sie die Protokollanalyse-Überwachungsrichtlinie einer Azure SQL-Datenbank durch Pipeline.
```
...
### Beispiel 9: Deaktivieren Sie das Senden von Überwachungsdatensätzen einer Azure SQL-Datenbank an den BLOB-Speicher, und aktivieren Sie das Senden an die Protokollanalyse.
```
...
### Beispiel 10: Aktivieren Sie das Senden von Überwachungsdatensätzen einer Azure SQL-Datenbank an BLOB-Speicher, Ereignis-Hub und Protokollanalyse.
```
...
Erhalten  
Referenzen  
Die allgemeine Form zum Definieren einer zu überwachenden Aktion lautet: [Aktion] auf [Objekt] nach [Principal] Beachten Sie, dass [Objekt] im obigen Format auf ein Objekt wie eine Tabelle, eine Sicht oder eine gespeicherte Prozedur oder auf eine gesamte Datenbank oder ein ganzes Schema verweisen kann. In den letzten Fällen werden die Formulare Database:: [DBName] und Schema:: [SchemaName] verwendet.
Zum Beispiel:  
