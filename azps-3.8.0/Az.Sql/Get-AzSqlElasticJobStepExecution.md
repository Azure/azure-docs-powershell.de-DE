...
## Beschreibung
Das Get-AzSqlElasticJobStepExecution-Cmdlet ruft einen oder mehrere Auftragsschritt Ausführungen aus einer Auftragsausführung ab.

## Beispiele

### Beispiel 1 – Ruft einen oder mehrere Auftragsschritt Ausführungen aus einer Auftragsausführung ab
```
...
### Beispiel 2 – Ruft einen oder mehrere Auftragsschritt Ausführungen aus einer Auftragsausführung ab, wobei nach Schrittname gefiltert wird
```
PS C:\> $je = Get-AzSqlElasticJobExecution -ResourceGroupName rg -ServerName elasticjobserver -AgentName agent -JobName job1 -JobExecutionId 3bcfc912-20b2-411d-a2b7-6265d13fe272
