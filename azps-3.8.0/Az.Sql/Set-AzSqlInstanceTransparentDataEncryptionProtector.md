...
## Beschreibung
Das Set-AzSqlInstanceTransparentDataEncryptionProtector-Cmdlet legt die DSA-Beschützer für eine verwaltete SQL-Instanz fest. Durch Ändern des DSA-Protector-Typs wird der Protector gedreht.
...
Dieser Befehl aktualisiert den Typ des DSA-Beschützers einer verwalteten Instanz in Dienst verwaltet.
...
Mit diesem Befehl wird die angegebene verwaltete Instanz so aktualisiert, dass der Schlüsselspeicher Schlüssel der verwalteten Instanz mit der ID ' https://contoso.vault.azure.net/keys/contosokey/01234567890123456789012345678901 ' als DSA-Beschützer verwendet wird.

### Beispiel 3: Einrichten des transparenten Daten Verschlüsselungsschutz-Typs auf Azure Key Vault mithilfe eines verwalteten Instanzen Objekts
```powershell
...
### Beispiel 4: Einrichten des transparenten Daten Verschlüsselungs Protector-Typs auf Azure Key Vault mithilfe der Ressourcen-ID
```powershell
PS C:\> $managedInstance = Get-AzSqlInstance -Name 'ContosoManagedInstanceName' -ResourceGroupName 'ContosoResourceGroup'
...
### Beispiel 5: Einrichten des transparenten Daten Verschlüsselungsschutz-Typs auf Azure Key Vault mithilfe von Piping
```powershell
PS C:\> $managedInstance = Get-AzSqlInstance -Name 'ContosoManagedInstanceName' -ResourceGroupName 'ContosoResourceGroup'
...
### -Typ
Der Azure SQL-Datenbank-Daten Verschlüsselungsschutz-Typ
