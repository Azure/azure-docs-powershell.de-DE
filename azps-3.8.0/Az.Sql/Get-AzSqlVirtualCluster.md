...
## Beschreibung
Das Cmdlet " **Get-AzSqlVirtualCluster** " gibt Informationen zu einem oder mehreren virtuellen Azure SQL-Clustern zurück.
Geben Sie den Namen eines virtuellen Clusters an, um Informationen nur für diesen Cluster anzuzeigen.

## Beispiele

### Beispiel 1: Abrufen aller virtuellen Cluster, die einer Ressourcengruppe zugeordnet sind
```powershell
...
Dieser Befehl ruft Informationen zu allen virtuellen Clustern ab, die der Ressourcengruppe ResourceGroup01 zugeordnet sind.

### Beispiel 2: Abrufen von Informationen zu einem bestimmten virtuellen Cluster
```
...
Dieser Befehl ruft Informationen zum virtuellen Cluster VirtualCluster1 in der Ressourcengruppe ResourceGroup01.
...
### -Name
Der Name des virtuellen Clusters.
