...
## Beschreibung
Das Stop-AzSqlInstanceOperation-Cmdlet beendet den Vorgang mit dem angegebenen Vorgangsnamen in einer verwalteten SQL-Instanz.

## Beispiele

### Beispiel 1: Abrufen eines bestimmten Vorgangs
```powershell
...
Dieser Befehl beendet den Vorgang mit dem Namen "d0f5bef5-e2b1-4ef8-BB42-2e54073874f9" auf einer verwalteten SQL-Instanz.

### Beispiel 2: Verwenden der Vorgangs Ressourcen-ID
```powershell
...
Dieser Befehl beendet den Vorgang mit der Ressourcen-ID $managedInstanceOperation. ID.

### Beispiel 3: Verwenden des Vorgangs Objekts
```powershell
...
Mit diesem Befehl wird der Vorgang mit Objekt $managedInstanceOperation beendet.
...
### -Inputobject
Der Vorgang, der abgebrochen werden soll
...
### -Resourcen-Nr
Die Ressourcen-ID des zu beendenden Vorgangs Objekts
