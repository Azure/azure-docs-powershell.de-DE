...
### Beispiel 1
### Beispiel 1 – Deaktivieren der erweiterten Datensicherheit für den Server
```powershell
...
### Beispiel 2: Deaktivieren der erweiterten Datensicherheit des Servers von der Server Ressource
```powershell
