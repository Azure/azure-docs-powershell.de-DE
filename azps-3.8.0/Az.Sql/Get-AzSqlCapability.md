...
## Beschreibung
Das Cmdlet " **Get-AzSqlCapability** " Ruft die Azure SQL-Datenbankfunktionen ab, die für das aktuelle Abonnement für einen Bereich verfügbar sind.
...
Weitere Informationen finden Sie unter Azure-Bereiche http://azure.microsoft.com/en-us/regions/ ( http://azure.microsoft.com/en-us/regions/) .
