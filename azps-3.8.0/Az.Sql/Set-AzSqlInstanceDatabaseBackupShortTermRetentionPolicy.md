...
## Beschreibung
Das Cmdlet " **Satz-AzSqlInstanceDatabaseBackupShortTermRetentionPolicy** " Ruft die für diese Datenbank registrierte kurzfristige Aufbewahrungsrichtlinie ab.
Die Richtlinie ist der Aufbewahrungszeitraum in Tagen für Point-in-Time-Wiederherstellungs Sicherungen.
...
Mit diesem Befehl wird die kurzfristige Aufbewahrungsrichtlinie für Database01 auf 35 Tage festgelegt.
...
Mit diesem Befehl wird die kurzfristige Aufbewahrungsrichtlinie für Database01 auf 35 Tage über die Rohrverlegung in einem Datenbankobjekt festgelegt.
...
Dieser Befehl legt die kurzfristige Aufbewahrungsrichtlinie für alle gelöschten Datenbanken mit dem Namen "degressiv" über die Rohrverlegung in einem gelöschten Datenbankobjekt fest. Hinweis Sie können den Aufbewahrungszeitraum für gelöschte Datenbanken nur reduzieren.

## Parameter

### -DatabaseName
Der Name der Azure SQL-Instanzen Datenbank, für die Sicherungen abgerufen werden sollen.
...
### -DeletionDate
Das Löschdatum der Azure SQL-Instanzen Datenbank zum Abrufen von Sicherungen für, mit Millisekunden-Genauigkeit (z. b. 2016-02-23T00:21:22.847 z)
...
### -Inputobject
Das Live-oder gelöschte Datenbankobjekt, für das die Richtlinie abgerufen/gesetzt werden soll.
...
### -InstanceName
Der Name der verwalteten Azure SQL-Instanz, in der sich die Datenbank befindet.
...
### -Resourcen-Nr
Die Ressourcen-ID für kurzfristige Aufbewahrungsrichtlinien.
