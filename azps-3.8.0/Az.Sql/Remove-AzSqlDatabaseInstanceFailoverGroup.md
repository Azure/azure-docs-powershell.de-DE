...
## Beschreibung
Mit diesem Befehl wird die Failoverclusterinstanz mit dem angegebenen Namen entfernt, sodass alle Datenbanken intakt bleiben. Der Listener-Endpunkt wird aus DNS aufgehoben.

Der primäre Bereich der Instanz-Failover-Gruppe sollte zum Ausführen des Befehls verwendet werden.
...
Entfernen Sie eine Instanz-Failover-Gruppe.
...
### -Inputobject
Das zu entfernende Instanzen-Failover-Gruppenobjekt
...
### -Name
Der Name der zu entfernenden Instanz-Failover-Gruppe.
...
### -PassThru
Gibt an, ob die Ausgabe der Cmdlet-Ausführung übergeben werden soll.
...
### -Resourcen-Nr
Die Ressourcen-ID der zu entfernenden Instanz-Failover-Gruppe.
