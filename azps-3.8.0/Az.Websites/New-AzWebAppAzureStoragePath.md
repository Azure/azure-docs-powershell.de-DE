...
## Beschreibung
Erstellt ein Objekt, das einen Azure-Speicherpfad darstellt, der in einer Web-App bereitgestellt werden soll.
...
### -AccessKey
Zugriffstaste für das Azure-Speicherkonto
...
Z. b.: myfilestorageaccount.File.Core.Windows.net
...
### -MountPath
Der Pfad im Container, in dem die von ShareName angegebene Freigabe verfügbar gemacht wird
...
### -Name
Der Bezeichner der Azure-Speichereigenschaft.
Muss innerhalb der Web-App oder des Slots eindeutig sein
...
### -Freigabename
Der Name der Freigabe, die im Container bereitgestellt werden soll
...
### -Typ
Der Typ des Azure-speicherkontos.
Windows-Container unterstützt nur Azure-Dateien.
