...
## Synopsis
Entfernen Sie eine Routingregel aus dem Steckplatz.
...
## Beschreibung
Das Cmdlet **Remove-AzWebAppTrafficRouting** entfernt eine Routingregel aus einem Azure Web App-Steckplatz.

## Beispiele

### Beispiel 1 entfernt die spezifische Routingregel aus dem Webablage-Steckplatz
```powershell
PS C:\> Remove-AzWebAppTrafficRouting -ResourceGroupName "Default-Web-WestUS" -WebAppName "ContosoSite"  -RuleName 'Stg'
```

Mit diesem Befehl wird eine Routingregel für einen bestimmten webaktions Steckplatz entfernt.
