...
## Beschreibung
Mit dem Cmdlet **Add-AzVmssDataDisk** wird der VMSS-Instanz (Virtual Machine Scale Sets) ein Daten Datenträger hinzugefügt.
...
### -DiskIOPSReadWrite
Gibt die Read-Write IOPS für den verwalteten Datenträger an. Sollte nur verwendet werden, wenn StorageAccountType UltraSSD_LRS ist. Wenn keine Angabe erfolgt, wird ein Standardwert auf Grundlage von diskSizeGB zugewiesen.
...
### -DiskMBpsReadWrite
Gibt die Bandbreite in MB pro Sekunde für den verwalteten Datenträger an. Sollte nur verwendet werden, wenn StorageAccountType UltraSSD_LRS ist. Wenn keine Angabe erfolgt, wird ein Standardwert auf Grundlage von diskSizeGB zugewiesen.
