...
### Beispiel 2: Abrufen aller Container Dienste
```
...
Dieser Befehl ruft alle Container Dienste im Abonnement ab.

### Beispiel 3: Abrufen aller Container Dienste in der Ressourcengruppe
```
...
Dieser Befehl ruft alle Container Dienste in ResourceGroup17 ab.

### Beispiel 4: Abrufen aller Container Dienste mithilfe von Filter
```
...
Dieser Befehl ruft alle Container Dienste ab, die mit "CSResourceGroup1" beginnen.
