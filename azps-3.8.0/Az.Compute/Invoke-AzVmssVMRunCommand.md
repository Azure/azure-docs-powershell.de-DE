...
## Beschreibung
Aufrufen eines Befehls "ausführen" auf dem virtuellen Computer mit Skalierungs Satz
...
Rufen Sie einen Ausführungsbefehl von RunPowerShellScript auf, indem Sie das Skript "sample.ps1" und die Parameter für die ID "0" VM im Skalierungs Satz der virtuellen Maschine "vmssname" in der Ressourcengruppe "rgname" überschreiben.
...
### -InstanceId
Die Instanz-ID des VM-Skalierungs Satzes für virtuelle Maschinen.
...
Das VM-Objekt "Scale" des PS-virtuellen Computers
...
### -VMScaleSetName
Der Name des VM-Skalierungs Satzes für virtuelle Maschinen.
