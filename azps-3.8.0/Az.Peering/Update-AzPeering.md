...
### MD5-Authentifizierungsschlüssel aktualisieren
```powershell
...
Legt die Verwendung für peeringdienst-Kennzeichnung fest
...
Legt die IPv4-Adresse für einen Exchange-Peering mithilfe von "resourcecode" fest
...
### -DirectConnection
Erstellen Sie eine neue direkte Verbindung mithilfe der New-AzDirectPeeringConnectionObject und der Pipe an diesen Befehl.
...
### -ExchangeConnection
Erstellen Sie eine neue Exchange-Verbindung mithilfe der New-AzExchangePeeringConnectionObject und der Pipe an diesen Befehl.
