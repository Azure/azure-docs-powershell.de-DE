...
## Beschreibung
Das Cmdlet **Invoke-AzDataBoxEdgeDevice** ruft Aktionen zum Überprüfen, herunterladen und Installieren der Updates auf dem Daten Feld Edge-Gerät auf. Eine automatische Überprüfung wird täglich auf dem Gerät ausgeführt, und Sie können den Scan explizit auslösen, indem Sie dieses Cmdlet ausführen.
...
### -DeviceObject
Bitte geben Sie das entsprechende Device-Objekt an
...
### -FetchUpdate
Herunterladen der Updates auf einem Daten Feld-Edge/Gateway-Gerät
...
### -InstallUpdate
Installiert die Updates auf dem Daten Feld-Edge/Gateway-Gerät
...
### -ScanForUpdate
Sucht nach Updates auf einem Daten Feld-Edge/Gateway-Gerät.
