...
## Beschreibung
Das Cmdlet **Invoke-AzDataBoxEdgeShare** ruft Aktion auf, um Daten auf einer Freigabe auf einem Daten Feld-Edge-Gerät zu aktualisieren.
...
### -RefreshData
Aktualisieren von Freigabe Metadaten mit den Daten aus der Cloud
