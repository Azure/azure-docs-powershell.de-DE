...
## Beschreibung
Das Cmdlet " **Get-AzDataBoxEdgeJob** " Ruft die aktiven Aufträge auf einem Daten Feld-Edge-Gerät ab. Sie können den Parameter Name erwähnen, um Details zu einem bestimmten Job abzurufen.
...
### -Name
Name des Auftrags, in der Regel eine GUID
