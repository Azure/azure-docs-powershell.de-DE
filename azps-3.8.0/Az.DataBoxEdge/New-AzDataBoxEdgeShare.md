...
## Beschreibung
Das Cmdlet **New-AzDataBoxEdgeShare** erstellt eine neue Freigabe auf dem Daten Feld-Edge-Gerät.
...
### -CloudShare
Vorhandenen StorageAccountCredential-Ressourcennamen angeben
...
### -Containername
Container Name (auf der Grundlage des angegebenen Datenformats steht dieser Name für Azure files/Pageblob/Block BLOB)
...
### -DataFormat
Daten Format setzen Ex: PageBlob, BlobBlob
...
### -NFS
AccessProtocol im Fall der Erstellung von Freigabe
...
### -UserAccessRight
Bereitstellen des Zugriffsrechts zusammen mit vorhandenen Benutzernamen für den Zugriff auf SMB-Freigabe Typen für Ex: @ (@ {"username" = "User-Name-1"; " AccessRight "=" Read "}, @ {" username "=" User-Name-2 ";" AccessRight "=" Read "}, @ {" username "=" User-Name-3 ";" AccessRight "=" Benutzerdefiniert "})
