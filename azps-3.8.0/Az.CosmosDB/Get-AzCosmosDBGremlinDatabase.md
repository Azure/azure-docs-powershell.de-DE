...
## Synopsis
Ruft die CosmosDB Gremlin-Datenbank ab.
...
## Beschreibung
Das Cmdlet " **Get-AzCosmosDBGremlinDatabase** " Ruft die CosmosDB Gremlin-Datenbank ab.
...
Das Ressourcenobjekt enthält _rid, _ts, _etag.
...
### -Detailliert
Wenn Sie dann bereitgestellt werden, gibt das Cmdlet die Datenbank mit dem entsprechenden Durchsatz zurück.
