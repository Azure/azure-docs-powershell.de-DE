...
## Synopsis
Legt den CosmosDB Cassandra-Keyspace fest.
...
## Beschreibung
Das Cmdlet " **Set-AzCosmosDBCassandraKeyspace** " legt den CosmosDB-Cassandra-Keyspace fest.
...
Das Ressourcenobjekt enthält die Werte der _rid, _ts _etag Eigenschaften.
