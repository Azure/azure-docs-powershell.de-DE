...
## Synopsis
Erstellt ein neues Objekt vom Typ PSIndexes. Sie kann als Parameterwert für "AzCosmosDBGremlinIncludedPath" übergeben werden.
...
## Beschreibung
Das Objekt, das den IncludedPath's-Indizes der Gremlin-API entspricht.
...
### -Datentyp
Der Datentyp, auf den das Indizierungs Verhalten angewendet wird.
Mögliche Werte sind: ' Zeichenfolge ', ' Zahl ', ' Punkt ', ' Polygon ', ' LineString ', ' MultiPolygon '
...
### -Art
Gibt den Typ des Indexes an.
Mögliche Werte sind: "Hash", "Bereich", "räumlich"
