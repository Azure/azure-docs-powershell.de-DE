...
## Synopsis
Erstellt ein neues Objekt vom Typ PSSqlConflictResolutionPolicy. Sie kann als Parameterwert für "AzCosmosDBSqlContainer" übergeben werden.
...
## Beschreibung
Das Objekt, das dem ConflictResolutionPolicy der SQL-API entspricht.
