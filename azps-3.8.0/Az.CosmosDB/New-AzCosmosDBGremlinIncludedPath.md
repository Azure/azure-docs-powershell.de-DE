...
## Synopsis
Erstellt ein neues Objekt vom Typ PSIncludedPath. Sie kann als Parameterwert für "AzCosmosDBGremlinGraph" übergeben werden.
...
## Beschreibung
Das Objekt, das dem IncludedPath der Gremlin-API entspricht.
