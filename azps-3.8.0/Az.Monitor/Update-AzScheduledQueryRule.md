...
## Beschreibung
Aktualisiert eine Protokoll Warnungsregel, die nur die "Enabled"-Eigenschaft aktualisiert, wird durch diesen Befehl unterstützt.
Informationen zum Aktualisieren weiterer Eigenschaften finden Sie unter Befehl "Satz-AzScheduledQueryRule".

## Beispiele

### Beispiel 1 – Aktualisieren des Regel namens
```powershell
...
### Beispiel 2 – Update nach Eingabeobjekt
```powershell
...
### Beispiel 3 – Update nach Ressourcen-ID
```powershell
