...
## Beschreibung
Erstellt ein Objekt vom Typ Azns-Aktionsgruppe.
Dieses Objekt soll an den Befehl übergeben werden, der die Warnungsregel für Protokolle erstellt.
...
### -ActionGroup
Die Liste der Aktionsgruppen, an die eine Benachrichtigung gesendet werden soll
...
Die angepasste webhook-Nutzlast
...
### -EmailSubject
E-Mail-Betreff der Benachrichtigung
