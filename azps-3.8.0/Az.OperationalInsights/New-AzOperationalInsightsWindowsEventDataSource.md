...
## Beschreibung
Das Cmdlet **New-AzOperationalInsightsWindowsEventDataSource** fügt eine Datenquelle hinzu, die Windows-Ereignisprotokolle von verbundenen Computern, auf denen das BetriebssystemWindows ausgeführt wird, in Azure Operating Insights sammelt.

## Beispiele

### Beispiel 1: Erstellen einer System Windows-Ereignisdaten Quelle
```
$EventLogNames       = @()
...
### -CollectWarnings
Gibt an, dass operative Einblicke Warnmeldungen sammelt.
