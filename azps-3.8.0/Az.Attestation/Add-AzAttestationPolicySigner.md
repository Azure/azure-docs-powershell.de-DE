...
### -Signer
Gibt das RFC7519-JSON-webtoken an, das einen Anspruch mit dem Namen "AAS-policyCertificate" enthält, dessen Wert ein RFC7517 JSON-Webschlüssel mit einem neuen vertrauenswürdigen Signaturschlüssel ist, der hinzugefügt werden soll.
