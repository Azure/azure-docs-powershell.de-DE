...
### -AbsoluteUri
Absoluter URI für die Quelle. Beachten Sie, dass die Anmeldeinformationen im URI bereitgestellt werden sollten, wenn für die Quelle ein any erforderlich ist.
...
### -CloudBlob
CloudBlob-Objekt aus Azure Storage-Client Bibliothek. Sie können Sie erstellen oder Get-AzureStorageBlob Cmdlet verwenden.
...
### -CloudBlobContainer
CloudBlobContainer-Objekt aus Azure Storage-Client Bibliothek. Sie können Sie erstellen oder Get-AzureStorageContainer Cmdlet verwenden.
...
### -Context
Ursprünglicher Azure-Speicherkontext. Sie können es über New-AzureStorageContext-Cmdlet erstellen.
...
### -Destcontext
Ziel-Azure-Speicherkontext. Sie können es über New-AzureStorageContext-Cmdlet erstellen.
