...
## Beschreibung
Das Cmdlet **Remove-AzureRmResourceLock** entfernt eine Azure-Ressourcensperre.
...
Dieser Befehl entfernt die Sperre mit dem Namen ContosoSiteLock.
...
### -Sperre
Gibt die ID der Sperre an, die vom Cmdlet entfernt wird.
...
### -LockName
Gibt den Namen der Sperre an, die vom Cmdlet entfernt wird.
